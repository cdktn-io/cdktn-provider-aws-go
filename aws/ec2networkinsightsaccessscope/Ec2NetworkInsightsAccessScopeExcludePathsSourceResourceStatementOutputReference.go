...
func (j *jsiiProxy_Ec2NetworkInsightsAccessScopeExcludePathsSourceResourceStatementOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewEc2NetworkInsightsAccessScopeExcludePathsSourceResourceStatementOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) Ec2NetworkInsightsAccessScopeExcludePathsSourceResourceStatementOutputReference {
	_init_.Initialize()

	if err := validateNewEc2NetworkInsightsAccessScopeExcludePathsSourceResourceStatementOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func NewEc2NetworkInsightsAccessScopeExcludePathsSourceResourceStatementOutputReference_Override(e Ec2NetworkInsightsAccessScopeExcludePathsSourceResourceStatementOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_Ec2NetworkInsightsAccessScopeExcludePathsSourceResourceStatementOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (e *jsiiProxy_Ec2NetworkInsightsAccessScopeExcludePathsSourceResourceStatementOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (e *jsiiProxy_Ec2NetworkInsightsAccessScopeExcludePathsSourceResourceStatementOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (e *jsiiProxy_Ec2NetworkInsightsAccessScopeExcludePathsSourceResourceStatementOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (e *jsiiProxy_Ec2NetworkInsightsAccessScopeExcludePathsSourceResourceStatementOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
