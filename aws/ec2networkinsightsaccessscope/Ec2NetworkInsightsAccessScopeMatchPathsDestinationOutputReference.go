...
type Ec2NetworkInsightsAccessScopeMatchPathsDestinationOutputReference interface {
	...
	PacketHeaderStatement() Ec2NetworkInsightsAccessScopeMatchPathsDestinationPacketHeaderStatementList
	PacketHeaderStatementInput() interface{}
	ResourceStatement() Ec2NetworkInsightsAccessScopeMatchPathsDestinationResourceStatementList
...
func (j *jsiiProxy_Ec2NetworkInsightsAccessScopeMatchPathsDestinationOutputReference) PacketHeaderStatement() Ec2NetworkInsightsAccessScopeMatchPathsDestinationPacketHeaderStatementList {
	var returns Ec2NetworkInsightsAccessScopeMatchPathsDestinationPacketHeaderStatementList
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_Ec2NetworkInsightsAccessScopeMatchPathsDestinationOutputReference) ResourceStatement() Ec2NetworkInsightsAccessScopeMatchPathsDestinationResourceStatementList {
	var returns Ec2NetworkInsightsAccessScopeMatchPathsDestinationResourceStatementList
	_jsii_.Get(
		j,
		"resourceStatement",
		&returns,
...
func (j *jsiiProxy_Ec2NetworkInsightsAccessScopeMatchPathsDestinationOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewEc2NetworkInsightsAccessScopeMatchPathsDestinationOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) Ec2NetworkInsightsAccessScopeMatchPathsDestinationOutputReference {
	_init_.Initialize()

	if err := validateNewEc2NetworkInsightsAccessScopeMatchPathsDestinationOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func NewEc2NetworkInsightsAccessScopeMatchPathsDestinationOutputReference_Override(e Ec2NetworkInsightsAccessScopeMatchPathsDestinationOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_Ec2NetworkInsightsAccessScopeMatchPathsDestinationOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (e *jsiiProxy_Ec2NetworkInsightsAccessScopeMatchPathsDestinationOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (e *jsiiProxy_Ec2NetworkInsightsAccessScopeMatchPathsDestinationOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (e *jsiiProxy_Ec2NetworkInsightsAccessScopeMatchPathsDestinationOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (e *jsiiProxy_Ec2NetworkInsightsAccessScopeMatchPathsDestinationOutputReference) PutPacketHeaderStatement(value interface{}) {
...
func (e *jsiiProxy_Ec2NetworkInsightsAccessScopeMatchPathsDestinationOutputReference) PutResourceStatement(value interface{}) {
...
func (e *jsiiProxy_Ec2NetworkInsightsAccessScopeMatchPathsDestinationOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
