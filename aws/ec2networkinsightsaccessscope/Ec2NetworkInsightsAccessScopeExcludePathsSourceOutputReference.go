...
type Ec2NetworkInsightsAccessScopeExcludePathsSourceOutputReference interface {
	...
	PacketHeaderStatement() Ec2NetworkInsightsAccessScopeExcludePathsSourcePacketHeaderStatementList
	PacketHeaderStatementInput() interface{}
	ResourceStatement() Ec2NetworkInsightsAccessScopeExcludePathsSourceResourceStatementList
...
func (j *jsiiProxy_Ec2NetworkInsightsAccessScopeExcludePathsSourceOutputReference) PacketHeaderStatement() Ec2NetworkInsightsAccessScopeExcludePathsSourcePacketHeaderStatementList {
	var returns Ec2NetworkInsightsAccessScopeExcludePathsSourcePacketHeaderStatementList
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_Ec2NetworkInsightsAccessScopeExcludePathsSourceOutputReference) ResourceStatement() Ec2NetworkInsightsAccessScopeExcludePathsSourceResourceStatementList {
	var returns Ec2NetworkInsightsAccessScopeExcludePathsSourceResourceStatementList
	_jsii_.Get(
		j,
		"resourceStatement",
		&returns,
...
func (j *jsiiProxy_Ec2NetworkInsightsAccessScopeExcludePathsSourceOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewEc2NetworkInsightsAccessScopeExcludePathsSourceOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) Ec2NetworkInsightsAccessScopeExcludePathsSourceOutputReference {
	_init_.Initialize()

	if err := validateNewEc2NetworkInsightsAccessScopeExcludePathsSourceOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func NewEc2NetworkInsightsAccessScopeExcludePathsSourceOutputReference_Override(e Ec2NetworkInsightsAccessScopeExcludePathsSourceOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_Ec2NetworkInsightsAccessScopeExcludePathsSourceOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (e *jsiiProxy_Ec2NetworkInsightsAccessScopeExcludePathsSourceOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (e *jsiiProxy_Ec2NetworkInsightsAccessScopeExcludePathsSourceOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (e *jsiiProxy_Ec2NetworkInsightsAccessScopeExcludePathsSourceOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (e *jsiiProxy_Ec2NetworkInsightsAccessScopeExcludePathsSourceOutputReference) PutPacketHeaderStatement(value interface{}) {
...
func (e *jsiiProxy_Ec2NetworkInsightsAccessScopeExcludePathsSourceOutputReference) PutResourceStatement(value interface{}) {
...
func (e *jsiiProxy_Ec2NetworkInsightsAccessScopeExcludePathsSourceOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
