...
func (j *jsiiProxy_Ec2NetworkInsightsAccessScopeMatchPathsSourcePacketHeaderStatementOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewEc2NetworkInsightsAccessScopeMatchPathsSourcePacketHeaderStatementOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) Ec2NetworkInsightsAccessScopeMatchPathsSourcePacketHeaderStatementOutputReference {
	_init_.Initialize()

	if err := validateNewEc2NetworkInsightsAccessScopeMatchPathsSourcePacketHeaderStatementOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func NewEc2NetworkInsightsAccessScopeMatchPathsSourcePacketHeaderStatementOutputReference_Override(e Ec2NetworkInsightsAccessScopeMatchPathsSourcePacketHeaderStatementOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_Ec2NetworkInsightsAccessScopeMatchPathsSourcePacketHeaderStatementOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (e *jsiiProxy_Ec2NetworkInsightsAccessScopeMatchPathsSourcePacketHeaderStatementOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (e *jsiiProxy_Ec2NetworkInsightsAccessScopeMatchPathsSourcePacketHeaderStatementOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (e *jsiiProxy_Ec2NetworkInsightsAccessScopeMatchPathsSourcePacketHeaderStatementOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (e *jsiiProxy_Ec2NetworkInsightsAccessScopeMatchPathsSourcePacketHeaderStatementOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
