...
func (d *jsiiProxy_DmsEndpointTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DmsEndpointTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
