...
func (d *jsiiProxy_DmsEndpointKinesisSettingsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DmsEndpointKinesisSettingsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
