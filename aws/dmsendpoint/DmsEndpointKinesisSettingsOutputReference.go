...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/dmsendpoint/internal"
...
func (j *jsiiProxy_DmsEndpointKinesisSettingsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDmsEndpointKinesisSettingsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) DmsEndpointKinesisSettingsOutputReference {
	_init_.Initialize()
...
func NewDmsEndpointKinesisSettingsOutputReference_Override(d DmsEndpointKinesisSettingsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_DmsEndpointKinesisSettingsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DmsEndpointKinesisSettingsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DmsEndpointKinesisSettingsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (d *jsiiProxy_DmsEndpointKinesisSettingsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DmsEndpointKinesisSettingsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
