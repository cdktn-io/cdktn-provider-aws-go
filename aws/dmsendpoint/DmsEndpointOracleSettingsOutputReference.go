...
func (j *jsiiProxy_DmsEndpointOracleSettingsOutputReference) TerraformResource() cdktf.IInterpolatingParent {
...
func NewDmsEndpointOracleSettingsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) DmsEndpointOracleSettingsOutputReference {
	_init_.Initialize()
...
func NewDmsEndpointOracleSettingsOutputReference_Override(d DmsEndpointOracleSettingsOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_DmsEndpointOracleSettingsOutputReference)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (d *jsiiProxy_DmsEndpointOracleSettingsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DmsEndpointOracleSettingsOutputReference) InterpolationAsList() cdktf.IResolvable {
	var returns cdktf.IResolvable
...
func (d *jsiiProxy_DmsEndpointOracleSettingsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DmsEndpointOracleSettingsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
