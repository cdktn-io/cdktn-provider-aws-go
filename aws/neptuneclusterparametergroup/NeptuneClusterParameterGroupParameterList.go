...
func (j *jsiiProxy_NeptuneClusterParameterGroupParameterList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewNeptuneClusterParameterGroupParameterList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) NeptuneClusterParameterGroupParameterList {
	_init_.Initialize()
...
func NewNeptuneClusterParameterGroupParameterList_Override(n NeptuneClusterParameterGroupParameterList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_NeptuneClusterParameterGroupParameterList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (n *jsiiProxy_NeptuneClusterParameterGroupParameterList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (n *jsiiProxy_NeptuneClusterParameterGroupParameterList) Resolve(context cdktn.IResolveContext) interface{} {
