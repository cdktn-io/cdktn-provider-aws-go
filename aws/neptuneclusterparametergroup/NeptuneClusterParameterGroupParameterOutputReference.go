...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/neptuneclusterparametergroup/internal"
...
func (j *jsiiProxy_NeptuneClusterParameterGroupParameterOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewNeptuneClusterParameterGroupParameterOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) NeptuneClusterParameterGroupParameterOutputReference {
	_init_.Initialize()
...
func NewNeptuneClusterParameterGroupParameterOutputReference_Override(n NeptuneClusterParameterGroupParameterOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_NeptuneClusterParameterGroupParameterOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (n *jsiiProxy_NeptuneClusterParameterGroupParameterOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (n *jsiiProxy_NeptuneClusterParameterGroupParameterOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (n *jsiiProxy_NeptuneClusterParameterGroupParameterOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (n *jsiiProxy_NeptuneClusterParameterGroupParameterOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
