...
func (c *jsiiProxy_CognitoUserPoolSchemaStringAttributeConstraintsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CognitoUserPoolSchemaStringAttributeConstraintsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
