...
func (j *jsiiProxy_CognitoUserPoolLambdaConfigCustomSmsSenderOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewCognitoUserPoolLambdaConfigCustomSmsSenderOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) CognitoUserPoolLambdaConfigCustomSmsSenderOutputReference {
	_init_.Initialize()

	if err := validateNewCognitoUserPoolLambdaConfigCustomSmsSenderOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewCognitoUserPoolLambdaConfigCustomSmsSenderOutputReference_Override(c CognitoUserPoolLambdaConfigCustomSmsSenderOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_CognitoUserPoolLambdaConfigCustomSmsSenderOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_CognitoUserPoolLambdaConfigCustomSmsSenderOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CognitoUserPoolLambdaConfigCustomSmsSenderOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (c *jsiiProxy_CognitoUserPoolLambdaConfigCustomSmsSenderOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CognitoUserPoolLambdaConfigCustomSmsSenderOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
