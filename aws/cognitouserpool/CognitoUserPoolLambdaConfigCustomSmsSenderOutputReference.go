...
func (c *jsiiProxy_CognitoUserPoolLambdaConfigCustomSmsSenderOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CognitoUserPoolLambdaConfigCustomSmsSenderOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
