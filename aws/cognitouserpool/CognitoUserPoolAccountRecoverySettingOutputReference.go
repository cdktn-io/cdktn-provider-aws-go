...
func (j *jsiiProxy_CognitoUserPoolAccountRecoverySettingOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewCognitoUserPoolAccountRecoverySettingOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) CognitoUserPoolAccountRecoverySettingOutputReference {
	_init_.Initialize()
...
func NewCognitoUserPoolAccountRecoverySettingOutputReference_Override(c CognitoUserPoolAccountRecoverySettingOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_CognitoUserPoolAccountRecoverySettingOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_CognitoUserPoolAccountRecoverySettingOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CognitoUserPoolAccountRecoverySettingOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (c *jsiiProxy_CognitoUserPoolAccountRecoverySettingOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CognitoUserPoolAccountRecoverySettingOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
