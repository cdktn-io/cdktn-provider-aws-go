...
func (c *jsiiProxy_CognitoUserPoolSoftwareTokenMfaConfigurationOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CognitoUserPoolSoftwareTokenMfaConfigurationOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
