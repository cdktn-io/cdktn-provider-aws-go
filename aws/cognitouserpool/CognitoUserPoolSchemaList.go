...
func (j *jsiiProxy_CognitoUserPoolSchemaList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewCognitoUserPoolSchemaList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) CognitoUserPoolSchemaList {
	_init_.Initialize()
...
func NewCognitoUserPoolSchemaList_Override(c CognitoUserPoolSchemaList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_CognitoUserPoolSchemaList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_CognitoUserPoolSchemaList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (c *jsiiProxy_CognitoUserPoolSchemaList) Resolve(context cdktn.IResolveContext) interface{} {
