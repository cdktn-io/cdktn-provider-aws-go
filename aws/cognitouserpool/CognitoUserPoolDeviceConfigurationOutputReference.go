...
func (c *jsiiProxy_CognitoUserPoolDeviceConfigurationOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CognitoUserPoolDeviceConfigurationOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
