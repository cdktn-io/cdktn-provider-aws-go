...
func (j *jsiiProxy_CognitoUserPoolAccountRecoverySettingRecoveryMechanismList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewCognitoUserPoolAccountRecoverySettingRecoveryMechanismList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) CognitoUserPoolAccountRecoverySettingRecoveryMechanismList {
	_init_.Initialize()
...
func NewCognitoUserPoolAccountRecoverySettingRecoveryMechanismList_Override(c CognitoUserPoolAccountRecoverySettingRecoveryMechanismList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_CognitoUserPoolAccountRecoverySettingRecoveryMechanismList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_CognitoUserPoolAccountRecoverySettingRecoveryMechanismList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (c *jsiiProxy_CognitoUserPoolAccountRecoverySettingRecoveryMechanismList) Resolve(context cdktn.IResolveContext) interface{} {
