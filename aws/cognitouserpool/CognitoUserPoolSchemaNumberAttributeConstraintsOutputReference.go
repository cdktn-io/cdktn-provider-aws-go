...
func (c *jsiiProxy_CognitoUserPoolSchemaNumberAttributeConstraintsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CognitoUserPoolSchemaNumberAttributeConstraintsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
