...
func (n *jsiiProxy_NetworkfirewallFirewall) validatePutAvailabilityZoneMappingParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*NetworkfirewallFirewallAvailabilityZoneMapping; received %#v (a %T)", value, value)
		}
	}
...
func (n *jsiiProxy_NetworkfirewallFirewall) validatePutSubnetMappingParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*NetworkfirewallFirewallSubnetMapping; received %#v (a %T)", value, value)
		}
	}
