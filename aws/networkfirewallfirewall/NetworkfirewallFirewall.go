...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/networkfirewall_firewall aws_networkfirewall_firewall}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/networkfirewall_firewall aws_networkfirewall_firewall} Resource.
...
func (n *jsiiProxy_NetworkfirewallFirewall) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (n *jsiiProxy_NetworkfirewallFirewall) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (n *jsiiProxy_NetworkfirewallFirewall) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
