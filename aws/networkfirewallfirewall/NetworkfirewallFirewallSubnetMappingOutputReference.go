...
func (n *jsiiProxy_NetworkfirewallFirewallSubnetMappingOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (n *jsiiProxy_NetworkfirewallFirewallSubnetMappingOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
