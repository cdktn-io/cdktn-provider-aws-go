...
func (j *jsiiProxy_NetworkfirewallFirewallFirewallStatusList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewNetworkfirewallFirewallFirewallStatusList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) NetworkfirewallFirewallFirewallStatusList {
	_init_.Initialize()
...
func NewNetworkfirewallFirewallFirewallStatusList_Override(n NetworkfirewallFirewallFirewallStatusList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_NetworkfirewallFirewallFirewallStatusList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (n *jsiiProxy_NetworkfirewallFirewallFirewallStatusList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (n *jsiiProxy_NetworkfirewallFirewallFirewallStatusList) Resolve(context cdktn.IResolveContext) interface{} {
