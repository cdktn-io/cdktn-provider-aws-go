...
func (j *jsiiProxy_NetworkfirewallFirewallFirewallStatusSyncStatesAttachmentList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewNetworkfirewallFirewallFirewallStatusSyncStatesAttachmentList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) NetworkfirewallFirewallFirewallStatusSyncStatesAttachmentList {
	_init_.Initialize()
...
func NewNetworkfirewallFirewallFirewallStatusSyncStatesAttachmentList_Override(n NetworkfirewallFirewallFirewallStatusSyncStatesAttachmentList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_NetworkfirewallFirewallFirewallStatusSyncStatesAttachmentList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (n *jsiiProxy_NetworkfirewallFirewallFirewallStatusSyncStatesAttachmentList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (n *jsiiProxy_NetworkfirewallFirewallFirewallStatusSyncStatesAttachmentList) Resolve(context cdktn.IResolveContext) interface{} {
