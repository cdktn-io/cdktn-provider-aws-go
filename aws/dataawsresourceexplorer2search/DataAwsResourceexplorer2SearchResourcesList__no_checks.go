...
func (d *jsiiProxy_DataAwsResourceexplorer2SearchResourcesList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
	return nil
}

func (d *jsiiProxy_DataAwsResourceexplorer2SearchResourcesList) validateGetParameters(index *float64) error {
	return nil
}
...
func (j *jsiiProxy_DataAwsResourceexplorer2SearchResourcesList) validateSetTerraformAttributeParameters(val *string) error {
	return nil
}
...
func (j *jsiiProxy_DataAwsResourceexplorer2SearchResourcesList) validateSetWrapsSetParameters(val *bool) error {
	return nil
}
