...
func (d *jsiiProxy_DataAwsSsmcontactsRotationRecurrenceOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataAwsSsmcontactsRotationRecurrenceOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
