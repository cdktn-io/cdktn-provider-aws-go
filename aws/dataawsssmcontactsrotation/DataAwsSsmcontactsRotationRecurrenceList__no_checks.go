...
func (d *jsiiProxy_DataAwsSsmcontactsRotationRecurrenceList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
	return nil
}

func (d *jsiiProxy_DataAwsSsmcontactsRotationRecurrenceList) validateGetParameters(index *float64) error {
	return nil
}
...
func (j *jsiiProxy_DataAwsSsmcontactsRotationRecurrenceList) validateSetTerraformAttributeParameters(val *string) error {
	return nil
}
...
func (j *jsiiProxy_DataAwsSsmcontactsRotationRecurrenceList) validateSetWrapsSetParameters(val *bool) error {
	return nil
}
