...
func (j *jsiiProxy_DataAwsSsmcontactsRotationRecurrenceMonthlySettingsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsSsmcontactsRotationRecurrenceMonthlySettingsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsSsmcontactsRotationRecurrenceMonthlySettingsList {
	_init_.Initialize()
...
func NewDataAwsSsmcontactsRotationRecurrenceMonthlySettingsList_Override(d DataAwsSsmcontactsRotationRecurrenceMonthlySettingsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsSsmcontactsRotationRecurrenceMonthlySettingsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsSsmcontactsRotationRecurrenceMonthlySettingsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsSsmcontactsRotationRecurrenceMonthlySettingsList) Resolve(context cdktn.IResolveContext) interface{} {
