...
func (j *jsiiProxy_WafregionalXssMatchSetXssMatchTupleList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewWafregionalXssMatchSetXssMatchTupleList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) WafregionalXssMatchSetXssMatchTupleList {
	_init_.Initialize()
...
func NewWafregionalXssMatchSetXssMatchTupleList_Override(w WafregionalXssMatchSetXssMatchTupleList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_WafregionalXssMatchSetXssMatchTupleList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (w *jsiiProxy_WafregionalXssMatchSetXssMatchTupleList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (w *jsiiProxy_WafregionalXssMatchSetXssMatchTupleList) Resolve(context cdktn.IResolveContext) interface{} {
