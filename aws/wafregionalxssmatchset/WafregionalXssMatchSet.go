...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v22/wafregionalxssmatchset/internal"
...
func WafregionalXssMatchSet_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (w *jsiiProxy_WafregionalXssMatchSet) ImportFrom(id *string, provider cdktf.TerraformProvider) {
