...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/wafregionalxssmatchset/internal"
...
func (j *jsiiProxy_WafregionalXssMatchSet) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_WafregionalXssMatchSet) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_WafregionalXssMatchSet) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_WafregionalXssMatchSet) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_WafregionalXssMatchSet) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_WafregionalXssMatchSet) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_WafregionalXssMatchSet) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/wafregional_xss_match_set aws_wafregional_xss_match_set} Resource.
func NewWafregionalXssMatchSet(scope constructs.Construct, id *string, config *WafregionalXssMatchSetConfig) WafregionalXssMatchSet {
	...
	if err := validateNewWafregionalXssMatchSetParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_WafregionalXssMatchSet)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_WafregionalXssMatchSet)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_WafregionalXssMatchSet)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_WafregionalXssMatchSet)SetRegion(val *string) {
...
func WafregionalXssMatchSet_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateWafregionalXssMatchSet_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func WafregionalXssMatchSet_IsConstruct(x interface{}) *bool {
	...
	if err := validateWafregionalXssMatchSet_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func WafregionalXssMatchSet_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateWafregionalXssMatchSet_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func WafregionalXssMatchSet_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateWafregionalXssMatchSet_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (w *jsiiProxy_WafregionalXssMatchSet) AddMoveTarget(moveTarget *string) {
...
func (w *jsiiProxy_WafregionalXssMatchSet) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_WafregionalXssMatchSet) HasResourceMove() interface{} {
	var returns interface{}
...
func (w *jsiiProxy_WafregionalXssMatchSet) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (w *jsiiProxy_WafregionalXssMatchSet) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_WafregionalXssMatchSet) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (w *jsiiProxy_WafregionalXssMatchSet) MoveFromId(id *string) {
...
func (w *jsiiProxy_WafregionalXssMatchSet) MoveTo(moveTarget *string, index interface{}) {
...
func (w *jsiiProxy_WafregionalXssMatchSet) MoveToId(id *string) {
...
func (w *jsiiProxy_WafregionalXssMatchSet) PutXssMatchTuple(value interface{}) {
	if err := w.validatePutXssMatchTupleParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		w,
...
func (w *jsiiProxy_WafregionalXssMatchSet) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (w *jsiiProxy_WafregionalXssMatchSet) ResetRegion() {
	_jsii_.InvokeVoid(
		w,
		"resetRegion",
		nil, // no parameters
...
func (w *jsiiProxy_WafregionalXssMatchSet) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (w *jsiiProxy_WafregionalXssMatchSet) ToHclTerraform() interface{} {
	var returns interface{}
...
func (w *jsiiProxy_WafregionalXssMatchSet) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
