...
func (j *jsiiProxy_DataAwsWorkspacesWorkspaceWorkspacePropertiesList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsWorkspacesWorkspaceWorkspacePropertiesList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsWorkspacesWorkspaceWorkspacePropertiesList {
	_init_.Initialize()
...
func NewDataAwsWorkspacesWorkspaceWorkspacePropertiesList_Override(d DataAwsWorkspacesWorkspaceWorkspacePropertiesList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsWorkspacesWorkspaceWorkspacePropertiesList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsWorkspacesWorkspaceWorkspacePropertiesList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsWorkspacesWorkspaceWorkspacePropertiesList) Resolve(context cdktn.IResolveContext) interface{} {
