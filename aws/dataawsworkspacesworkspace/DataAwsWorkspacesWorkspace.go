...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/dataawsworkspacesworkspace/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/data-sources/workspaces_workspace aws_workspaces_workspace}.
type DataAwsWorkspacesWorkspace interface {
	...
	RegionInput() *string
	RootVolumeEncryptionEnabled() cdktn.IResolvable
	State() *string
	...
	UserVolumeEncryptionEnabled() cdktn.IResolvable
...
func (j *jsiiProxy_DataAwsWorkspacesWorkspace) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsWorkspacesWorkspace) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsWorkspacesWorkspace) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsWorkspacesWorkspace) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsWorkspacesWorkspace) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DataAwsWorkspacesWorkspace) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_DataAwsWorkspacesWorkspace) RootVolumeEncryptionEnabled() cdktn.IResolvable {
...
func (j *jsiiProxy_DataAwsWorkspacesWorkspace) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DataAwsWorkspacesWorkspace) UserVolumeEncryptionEnabled() cdktn.IResolvable {
	var returns cdktn.IResolvable
	_jsii_.Get(
		j,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/data-sources/workspaces_workspace aws_workspaces_workspace} Data Source.
...
func (j *jsiiProxy_DataAwsWorkspacesWorkspace)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsWorkspacesWorkspace)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsWorkspacesWorkspace)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_DataAwsWorkspacesWorkspace)SetRegion(val *string) {
...
// Generates CDKTN code for importing a DataAwsWorkspacesWorkspace resource upon running "cdktn plan <stack-name>".
func DataAwsWorkspacesWorkspace_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateDataAwsWorkspacesWorkspace_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataAwsWorkspacesWorkspace) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsWorkspacesWorkspace) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsWorkspacesWorkspace) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsWorkspacesWorkspace) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsWorkspacesWorkspace) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
