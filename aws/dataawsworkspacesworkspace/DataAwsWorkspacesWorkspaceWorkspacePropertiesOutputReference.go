...
func (d *jsiiProxy_DataAwsWorkspacesWorkspaceWorkspacePropertiesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataAwsWorkspacesWorkspaceWorkspacePropertiesOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
