...
func (j *jsiiProxy_BedrockagentFlowDefinitionConnectionConfigurationDataList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_BedrockagentFlowDefinitionConnectionConfigurationDataList) InternalValue() interface{} {
...
func (j *jsiiProxy_BedrockagentFlowDefinitionConnectionConfigurationDataList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_BedrockagentFlowDefinitionConnectionConfigurationDataList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (j *jsiiProxy_BedrockagentFlowDefinitionConnectionConfigurationDataList)SetInternalValue(val interface{}) {
...
func (j *jsiiProxy_BedrockagentFlowDefinitionConnectionConfigurationDataList)SetTerraformAttribute(val *string) {
...
func (j *jsiiProxy_BedrockagentFlowDefinitionConnectionConfigurationDataList)SetWrapsSet(val *bool) {
...
func (b *jsiiProxy_BedrockagentFlowDefinitionConnectionConfigurationDataList) ComputeFqn() *string {
	var returns *string
...
func (b *jsiiProxy_BedrockagentFlowDefinitionConnectionConfigurationDataList) Get(index *float64) BedrockagentFlowDefinitionConnectionConfigurationDataOutputReference {
	if err := b.validateGetParameters(index); err != nil {
		panic(err)
	}
	var returns BedrockagentFlowDefinitionConnectionConfigurationDataOutputReference
...
func (b *jsiiProxy_BedrockagentFlowDefinitionConnectionConfigurationDataList) ToString() *string {
	var returns *string
