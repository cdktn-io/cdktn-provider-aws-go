...
func (b *jsiiProxy_BedrockagentFlowDefinitionNodeConfigurationPromptSourceConfigurationInlineTemplateConfigurationChatToolConfigurationToolChoiceToolList) validateResolveParameters(context cdktf.IResolveContext) error {
	return nil
}
