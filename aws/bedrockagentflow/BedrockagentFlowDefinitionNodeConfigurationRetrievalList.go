...
func (j *jsiiProxy_BedrockagentFlowDefinitionNodeConfigurationRetrievalList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewBedrockagentFlowDefinitionNodeConfigurationRetrievalList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) BedrockagentFlowDefinitionNodeConfigurationRetrievalList {
	_init_.Initialize()
...
func NewBedrockagentFlowDefinitionNodeConfigurationRetrievalList_Override(b BedrockagentFlowDefinitionNodeConfigurationRetrievalList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_BedrockagentFlowDefinitionNodeConfigurationRetrievalList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (b *jsiiProxy_BedrockagentFlowDefinitionNodeConfigurationRetrievalList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (b *jsiiProxy_BedrockagentFlowDefinitionNodeConfigurationRetrievalList) Resolve(context cdktn.IResolveContext) interface{} {
