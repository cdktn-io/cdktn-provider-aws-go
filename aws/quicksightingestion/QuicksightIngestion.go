...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/quicksightingestion/internal"
...
func (j *jsiiProxy_QuicksightIngestion) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_QuicksightIngestion) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_QuicksightIngestion) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_QuicksightIngestion) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_QuicksightIngestion) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_QuicksightIngestion)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_QuicksightIngestion)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_QuicksightIngestion)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func QuicksightIngestion_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (q *jsiiProxy_QuicksightIngestion) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (q *jsiiProxy_QuicksightIngestion) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (q *jsiiProxy_QuicksightIngestion) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (q *jsiiProxy_QuicksightIngestion) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (q *jsiiProxy_QuicksightIngestion) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (q *jsiiProxy_QuicksightIngestion) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
