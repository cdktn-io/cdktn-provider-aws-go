...
func init() {
	_jsii_.RegisterClass(
		"@cdktn/provider-aws.resiliencehubv2Assertion.Resiliencehubv2Assertion",
		reflect.TypeOf((*Resiliencehubv2Assertion)(nil)).Elem(),
		[]_jsii_.Member{
		...
		func() interface{} {
			j := jsiiProxy_Resiliencehubv2Assertion{}
			_jsii_.InitJsiiProxy(&j.Type__cdktnTerraformResource)
			return &j
		},
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-aws.resiliencehubv2Assertion.Resiliencehubv2AssertionConfig",
		reflect.TypeOf((*Resiliencehubv2AssertionConfig)(nil)).Elem(),
	)
}
