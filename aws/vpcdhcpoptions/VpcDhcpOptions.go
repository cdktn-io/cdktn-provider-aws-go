...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/vpcdhcpoptions/internal"
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/vpc_dhcp_options aws_vpc_dhcp_options} Resource.
...
func (v *jsiiProxy_VpcDhcpOptions) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (v *jsiiProxy_VpcDhcpOptions) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (v *jsiiProxy_VpcDhcpOptions) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
