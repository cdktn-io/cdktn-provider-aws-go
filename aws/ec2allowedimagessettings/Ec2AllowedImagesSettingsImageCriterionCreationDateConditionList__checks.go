...
func (e *jsiiProxy_Ec2AllowedImagesSettingsImageCriterionCreationDateConditionList) validateResolveParameters(context cdktn.IResolveContext) error {
	if context == nil {
...
func (j *jsiiProxy_Ec2AllowedImagesSettingsImageCriterionCreationDateConditionList) validateSetTerraformResourceParameters(val cdktn.IInterpolatingParent) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func validateNewEc2AllowedImagesSettingsImageCriterionCreationDateConditionListParameters(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) error {
