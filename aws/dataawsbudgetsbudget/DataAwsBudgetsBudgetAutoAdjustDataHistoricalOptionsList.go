...
func (j *jsiiProxy_DataAwsBudgetsBudgetAutoAdjustDataHistoricalOptionsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsBudgetsBudgetAutoAdjustDataHistoricalOptionsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsBudgetsBudgetAutoAdjustDataHistoricalOptionsList {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-aws.dataAwsBudgetsBudget.DataAwsBudgetsBudgetAutoAdjustDataHistoricalOptionsList",
...
func NewDataAwsBudgetsBudgetAutoAdjustDataHistoricalOptionsList_Override(d DataAwsBudgetsBudgetAutoAdjustDataHistoricalOptionsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsBudgetsBudgetAutoAdjustDataHistoricalOptionsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsBudgetsBudgetAutoAdjustDataHistoricalOptionsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsBudgetsBudgetAutoAdjustDataHistoricalOptionsList) Resolve(context cdktn.IResolveContext) interface{} {
