...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/data-sources/budgets_budget aws_budgets_budget}.
type DataAwsBudgetsBudget interface {
	...
	BudgetExceeded() cdktn.IResolvable
...
func (j *jsiiProxy_DataAwsBudgetsBudget) BudgetExceeded() cdktn.IResolvable {
...
func (j *jsiiProxy_DataAwsBudgetsBudget) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsBudgetsBudget) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsBudgetsBudget) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsBudgetsBudget) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsBudgetsBudget) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/data-sources/budgets_budget aws_budgets_budget} Data Source.
func NewDataAwsBudgetsBudget(scope constructs.Construct, id *string, config *DataAwsBudgetsBudgetConfig) DataAwsBudgetsBudget {
	...
	_jsii_.Create(
		"@cdktn/provider-aws.dataAwsBudgetsBudget.DataAwsBudgetsBudget",
...
func (j *jsiiProxy_DataAwsBudgetsBudget)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsBudgetsBudget)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsBudgetsBudget)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsBudgetsBudget_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsBudgetsBudget) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsBudgetsBudget) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsBudgetsBudget) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsBudgetsBudget) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
