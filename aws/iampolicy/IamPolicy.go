...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/iampolicy/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/iam_policy aws_iam_policy}.
...
func (j *jsiiProxy_IamPolicy) AttachmentCount() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"attachmentCount",
...
func (j *jsiiProxy_IamPolicy) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_IamPolicy) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_IamPolicy) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_IamPolicy) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_IamPolicy) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/iam_policy aws_iam_policy} Resource.
...
func (j *jsiiProxy_IamPolicy)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_IamPolicy)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_IamPolicy)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func IamPolicy_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (i *jsiiProxy_IamPolicy) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (i *jsiiProxy_IamPolicy) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (i *jsiiProxy_IamPolicy) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (i *jsiiProxy_IamPolicy) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (i *jsiiProxy_IamPolicy) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (i *jsiiProxy_IamPolicy) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
