...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/dxprivatevirtualinterface/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.64.0/docs/resources/dx_private_virtual_interface aws_dx_private_virtual_interface}.
...
func (j *jsiiProxy_DxPrivateVirtualInterface) BgpAsnLong() *string {
	var returns *string
	_jsii_.Get(
		j,
		"bgpAsnLong",
...
func (j *jsiiProxy_DxPrivateVirtualInterface) BgpAsnLongInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"bgpAsnLongInput",
...
func (j *jsiiProxy_DxPrivateVirtualInterface) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DxPrivateVirtualInterface) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DxPrivateVirtualInterface) JumboFrameCapable() cdktn.IResolvable {
...
func (j *jsiiProxy_DxPrivateVirtualInterface) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DxPrivateVirtualInterface) PrefixPoolAllocatedCountIpv4() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DxPrivateVirtualInterface) PrefixPoolAllocatedCountIpv4Input() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DxPrivateVirtualInterface) PrefixPoolAllocatedCountIpv6() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DxPrivateVirtualInterface) PrefixPoolAllocatedCountIpv6Input() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DxPrivateVirtualInterface) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DxPrivateVirtualInterface) RateLimit() *string {
	var returns *string
	_jsii_.Get(
		j,
		"rateLimit",
...
func (j *jsiiProxy_DxPrivateVirtualInterface) RateLimitInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"rateLimitInput",
...
func (j *jsiiProxy_DxPrivateVirtualInterface) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.64.0/docs/resources/dx_private_virtual_interface aws_dx_private_virtual_interface} Resource.
...
func (j *jsiiProxy_DxPrivateVirtualInterface)SetBgpAsnLong(val *string) {
...
func (j *jsiiProxy_DxPrivateVirtualInterface)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DxPrivateVirtualInterface)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DxPrivateVirtualInterface)SetPrefixPoolAllocatedCountIpv4(val *float64) {
...
func (j *jsiiProxy_DxPrivateVirtualInterface)SetPrefixPoolAllocatedCountIpv6(val *float64) {
...
func (j *jsiiProxy_DxPrivateVirtualInterface)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_DxPrivateVirtualInterface)SetRateLimit(val *string) {
...
func DxPrivateVirtualInterface_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DxPrivateVirtualInterface) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DxPrivateVirtualInterface) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (d *jsiiProxy_DxPrivateVirtualInterface) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DxPrivateVirtualInterface) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (d *jsiiProxy_DxPrivateVirtualInterface) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DxPrivateVirtualInterface) ResetBgpAsn() {
	_jsii_.InvokeVoid(
		d,
		"resetBgpAsn",
		nil, // no parameters
...
func (d *jsiiProxy_DxPrivateVirtualInterface) ResetBgpAsnLong() {
	_jsii_.InvokeVoid(
		d,
		"resetBgpAsnLong",
		nil, // no parameters
...
func (d *jsiiProxy_DxPrivateVirtualInterface) ResetPrefixPoolAllocatedCountIpv4() {
	_jsii_.InvokeVoid(
		d,
		"resetPrefixPoolAllocatedCountIpv4",
		nil, // no parameters
...
func (d *jsiiProxy_DxPrivateVirtualInterface) ResetPrefixPoolAllocatedCountIpv6() {
	_jsii_.InvokeVoid(
		d,
		"resetPrefixPoolAllocatedCountIpv6",
		nil, // no parameters
...
func (d *jsiiProxy_DxPrivateVirtualInterface) ResetRateLimit() {
	_jsii_.InvokeVoid(
		d,
		"resetRateLimit",
		nil, // no parameters
...
func (d *jsiiProxy_DxPrivateVirtualInterface) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
