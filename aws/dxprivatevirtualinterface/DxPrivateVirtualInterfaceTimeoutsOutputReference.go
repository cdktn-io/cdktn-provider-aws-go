...
func (j *jsiiProxy_DxPrivateVirtualInterfaceTimeoutsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDxPrivateVirtualInterfaceTimeoutsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) DxPrivateVirtualInterfaceTimeoutsOutputReference {
	_init_.Initialize()

	if err := validateNewDxPrivateVirtualInterfaceTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewDxPrivateVirtualInterfaceTimeoutsOutputReference_Override(d DxPrivateVirtualInterfaceTimeoutsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_DxPrivateVirtualInterfaceTimeoutsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DxPrivateVirtualInterfaceTimeoutsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DxPrivateVirtualInterfaceTimeoutsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (d *jsiiProxy_DxPrivateVirtualInterfaceTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DxPrivateVirtualInterfaceTimeoutsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
