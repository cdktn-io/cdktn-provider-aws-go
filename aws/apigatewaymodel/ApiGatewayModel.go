...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/apigatewaymodel/internal"
...
func (j *jsiiProxy_ApiGatewayModel) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_ApiGatewayModel) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_ApiGatewayModel) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_ApiGatewayModel) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_ApiGatewayModel) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_ApiGatewayModel) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_ApiGatewayModel) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func NewApiGatewayModel(scope constructs.Construct, id *string, config *ApiGatewayModelConfig) ApiGatewayModel {
	...
	_jsii_.Create(
		"@cdktn/provider-aws.apiGatewayModel.ApiGatewayModel",
...
func (j *jsiiProxy_ApiGatewayModel)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_ApiGatewayModel)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_ApiGatewayModel)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_ApiGatewayModel)SetRegion(val *string) {
...
func ApiGatewayModel_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (a *jsiiProxy_ApiGatewayModel) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_ApiGatewayModel) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (a *jsiiProxy_ApiGatewayModel) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_ApiGatewayModel) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (a *jsiiProxy_ApiGatewayModel) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (a *jsiiProxy_ApiGatewayModel) ResetRegion() {
	_jsii_.InvokeVoid(
		a,
		"resetRegion",
		nil, // no parameters
...
func (a *jsiiProxy_ApiGatewayModel) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
