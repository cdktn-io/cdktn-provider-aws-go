...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/identitystore_user aws_identitystore_user}.
...
func (j *jsiiProxy_IdentitystoreUser) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_IdentitystoreUser) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_IdentitystoreUser) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_IdentitystoreUser) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_IdentitystoreUser) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/identitystore_user aws_identitystore_user} Resource.
...
func (j *jsiiProxy_IdentitystoreUser)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_IdentitystoreUser)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_IdentitystoreUser)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func IdentitystoreUser_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateIdentitystoreUser_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (i *jsiiProxy_IdentitystoreUser) AddMoveTarget(moveTarget *string) {
...
func (i *jsiiProxy_IdentitystoreUser) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (i *jsiiProxy_IdentitystoreUser) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (i *jsiiProxy_IdentitystoreUser) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (i *jsiiProxy_IdentitystoreUser) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (i *jsiiProxy_IdentitystoreUser) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (i *jsiiProxy_IdentitystoreUser) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
