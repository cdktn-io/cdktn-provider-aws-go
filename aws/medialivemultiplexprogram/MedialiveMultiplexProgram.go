...
func (j *jsiiProxy_MedialiveMultiplexProgram) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_MedialiveMultiplexProgram) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_MedialiveMultiplexProgram) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_MedialiveMultiplexProgram) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_MedialiveMultiplexProgram) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_MedialiveMultiplexProgram) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_MedialiveMultiplexProgram) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_MedialiveMultiplexProgram)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_MedialiveMultiplexProgram)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_MedialiveMultiplexProgram)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_MedialiveMultiplexProgram)SetRegion(val *string) {
...
func MedialiveMultiplexProgram_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (m *jsiiProxy_MedialiveMultiplexProgram) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MedialiveMultiplexProgram) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (m *jsiiProxy_MedialiveMultiplexProgram) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MedialiveMultiplexProgram) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (m *jsiiProxy_MedialiveMultiplexProgram) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (m *jsiiProxy_MedialiveMultiplexProgram) ResetRegion() {
	_jsii_.InvokeVoid(
		m,
		"resetRegion",
		nil, // no parameters
...
func (m *jsiiProxy_MedialiveMultiplexProgram) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
