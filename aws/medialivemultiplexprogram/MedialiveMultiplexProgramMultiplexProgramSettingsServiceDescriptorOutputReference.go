...
func (m *jsiiProxy_MedialiveMultiplexProgramMultiplexProgramSettingsServiceDescriptorOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (m *jsiiProxy_MedialiveMultiplexProgramMultiplexProgramSettingsServiceDescriptorOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
