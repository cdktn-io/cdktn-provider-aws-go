...
func (m *jsiiProxy_MedialiveMultiplexProgram) validatePutMultiplexProgramSettingsParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*MedialiveMultiplexProgramMultiplexProgramSettings; received %#v (a %T)", value, value)
		}
	}
