...
type CloudfrontVpcOriginConfig struct {
	...
	// timeouts block.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.32.1/docs/resources/cloudfront_vpc_origin#timeouts CloudfrontVpcOrigin#timeouts}
