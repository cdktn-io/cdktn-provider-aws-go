...
func (j *jsiiProxy_CloudfrontVpcOriginVpcOriginEndpointConfigOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewCloudfrontVpcOriginVpcOriginEndpointConfigOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) CloudfrontVpcOriginVpcOriginEndpointConfigOutputReference {
	_init_.Initialize()
...
func NewCloudfrontVpcOriginVpcOriginEndpointConfigOutputReference_Override(c CloudfrontVpcOriginVpcOriginEndpointConfigOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_CloudfrontVpcOriginVpcOriginEndpointConfigOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_CloudfrontVpcOriginVpcOriginEndpointConfigOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CloudfrontVpcOriginVpcOriginEndpointConfigOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (c *jsiiProxy_CloudfrontVpcOriginVpcOriginEndpointConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CloudfrontVpcOriginVpcOriginEndpointConfigOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
