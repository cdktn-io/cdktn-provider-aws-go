...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/cleanrooms_collaboration aws_cleanrooms_collaboration}.
...
func (j *jsiiProxy_CleanroomsCollaboration) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_CleanroomsCollaboration) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_CleanroomsCollaboration) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_CleanroomsCollaboration) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_CleanroomsCollaboration) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/cleanrooms_collaboration aws_cleanrooms_collaboration} Resource.
...
func (j *jsiiProxy_CleanroomsCollaboration)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_CleanroomsCollaboration)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_CleanroomsCollaboration)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func CleanroomsCollaboration_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (c *jsiiProxy_CleanroomsCollaboration) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CleanroomsCollaboration) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (c *jsiiProxy_CleanroomsCollaboration) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CleanroomsCollaboration) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_CleanroomsCollaboration) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
