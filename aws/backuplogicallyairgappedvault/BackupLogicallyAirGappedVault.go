...
func (b *jsiiProxy_BackupLogicallyAirGappedVault) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (b *jsiiProxy_BackupLogicallyAirGappedVault) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
