...
func (j *jsiiProxy_BackupLogicallyAirGappedVault) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_BackupLogicallyAirGappedVault) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_BackupLogicallyAirGappedVault) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_BackupLogicallyAirGappedVault) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_BackupLogicallyAirGappedVault) TagsAll() cdktf.StringMap {
...
func (j *jsiiProxy_BackupLogicallyAirGappedVault) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_BackupLogicallyAirGappedVault)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_BackupLogicallyAirGappedVault)SetLifecycle(val *cdktf.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_BackupLogicallyAirGappedVault)SetProvider(val cdktf.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func BackupLogicallyAirGappedVault_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (b *jsiiProxy_BackupLogicallyAirGappedVault) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (b *jsiiProxy_BackupLogicallyAirGappedVault) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (b *jsiiProxy_BackupLogicallyAirGappedVault) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
