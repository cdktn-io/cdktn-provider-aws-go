...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/dataawssfnactivity/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/data-sources/sfn_activity aws_sfn_activity}.
...
func (j *jsiiProxy_DataAwsSfnActivity) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsSfnActivity) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsSfnActivity) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsSfnActivity) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsSfnActivity) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DataAwsSfnActivity) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_DataAwsSfnActivity) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/data-sources/sfn_activity aws_sfn_activity} Data Source.
...
func (j *jsiiProxy_DataAwsSfnActivity)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsSfnActivity)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsSfnActivity)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_DataAwsSfnActivity)SetRegion(val *string) {
...
// Generates CDKTN code for importing a DataAwsSfnActivity resource upon running "cdktn plan <stack-name>".
func DataAwsSfnActivity_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsSfnActivity) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsSfnActivity) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsSfnActivity) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsSfnActivity) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsSfnActivity) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
