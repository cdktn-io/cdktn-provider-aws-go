...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/redshiftserverlesssnapshot/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/redshiftserverless_snapshot aws_redshiftserverless_snapshot}.
...
func (j *jsiiProxy_RedshiftserverlessSnapshot) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_RedshiftserverlessSnapshot) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/redshiftserverless_snapshot aws_redshiftserverless_snapshot} Resource.
...
func (j *jsiiProxy_RedshiftserverlessSnapshot)SetRegion(val *string) {
...
func (r *jsiiProxy_RedshiftserverlessSnapshot) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (r *jsiiProxy_RedshiftserverlessSnapshot) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (r *jsiiProxy_RedshiftserverlessSnapshot) ResetRegion() {
	_jsii_.InvokeVoid(
		r,
		"resetRegion",
		nil, // no parameters
...
func (r *jsiiProxy_RedshiftserverlessSnapshot) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
