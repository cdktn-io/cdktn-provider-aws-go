...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/ssoadmin_permission_set aws_ssoadmin_permission_set}.
...
func (j *jsiiProxy_SsoadminPermissionSet) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_SsoadminPermissionSet) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_SsoadminPermissionSet) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_SsoadminPermissionSet) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_SsoadminPermissionSet) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/ssoadmin_permission_set aws_ssoadmin_permission_set} Resource.
...
func (j *jsiiProxy_SsoadminPermissionSet)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_SsoadminPermissionSet)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_SsoadminPermissionSet)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func SsoadminPermissionSet_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (s *jsiiProxy_SsoadminPermissionSet) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SsoadminPermissionSet) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_SsoadminPermissionSet) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SsoadminPermissionSet) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_SsoadminPermissionSet) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_SsoadminPermissionSet) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
