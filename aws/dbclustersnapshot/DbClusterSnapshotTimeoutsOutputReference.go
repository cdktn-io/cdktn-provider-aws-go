...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v21/dbclustersnapshot/internal"
...
func (j *jsiiProxy_DbClusterSnapshotTimeoutsOutputReference) TerraformResource() cdktf.IInterpolatingParent {
...
func NewDbClusterSnapshotTimeoutsOutputReference_Override(d DbClusterSnapshotTimeoutsOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (d *jsiiProxy_DbClusterSnapshotTimeoutsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DbClusterSnapshotTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DbClusterSnapshotTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
