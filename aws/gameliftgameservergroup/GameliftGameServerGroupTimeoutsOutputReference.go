...
func (g *jsiiProxy_GameliftGameServerGroupTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GameliftGameServerGroupTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
