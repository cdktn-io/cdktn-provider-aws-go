...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/prometheusworkspace/internal"
...
func (j *jsiiProxy_PrometheusWorkspace) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_PrometheusWorkspace) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_PrometheusWorkspace) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_PrometheusWorkspace) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_PrometheusWorkspace) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/prometheus_workspace aws_prometheus_workspace} Resource.
...
func (j *jsiiProxy_PrometheusWorkspace)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_PrometheusWorkspace)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_PrometheusWorkspace)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func PrometheusWorkspace_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (p *jsiiProxy_PrometheusWorkspace) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PrometheusWorkspace) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (p *jsiiProxy_PrometheusWorkspace) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PrometheusWorkspace) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (p *jsiiProxy_PrometheusWorkspace) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (p *jsiiProxy_PrometheusWorkspace) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
