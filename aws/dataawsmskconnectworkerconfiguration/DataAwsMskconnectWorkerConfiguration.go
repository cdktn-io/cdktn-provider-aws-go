...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/dataawsmskconnectworkerconfiguration/internal"
...
func (j *jsiiProxy_DataAwsMskconnectWorkerConfiguration) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsMskconnectWorkerConfiguration) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsMskconnectWorkerConfiguration) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsMskconnectWorkerConfiguration) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsMskconnectWorkerConfiguration) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DataAwsMskconnectWorkerConfiguration) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_DataAwsMskconnectWorkerConfiguration) Tags() *map[string]*string {
...
func (j *jsiiProxy_DataAwsMskconnectWorkerConfiguration) TagsInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsInput",
...
func (j *jsiiProxy_DataAwsMskconnectWorkerConfiguration) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DataAwsMskconnectWorkerConfiguration)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsMskconnectWorkerConfiguration)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsMskconnectWorkerConfiguration)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_DataAwsMskconnectWorkerConfiguration)SetRegion(val *string) {
...
func (j *jsiiProxy_DataAwsMskconnectWorkerConfiguration)SetTags(val *map[string]*string) {
...
func DataAwsMskconnectWorkerConfiguration_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsMskconnectWorkerConfiguration) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsMskconnectWorkerConfiguration) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsMskconnectWorkerConfiguration) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsMskconnectWorkerConfiguration) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsMskconnectWorkerConfiguration) ResetTags() {
	_jsii_.InvokeVoid(
		d,
		"resetTags",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsMskconnectWorkerConfiguration) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
