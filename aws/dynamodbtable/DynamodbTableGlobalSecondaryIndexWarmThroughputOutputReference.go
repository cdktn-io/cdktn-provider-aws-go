...
func (d *jsiiProxy_DynamodbTableGlobalSecondaryIndexWarmThroughputOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DynamodbTableGlobalSecondaryIndexWarmThroughputOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
