...
func (j *jsiiProxy_DynamodbTableOnDemandThroughputOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDynamodbTableOnDemandThroughputOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) DynamodbTableOnDemandThroughputOutputReference {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-aws.dynamodbTable.DynamodbTableOnDemandThroughputOutputReference",
...
func NewDynamodbTableOnDemandThroughputOutputReference_Override(d DynamodbTableOnDemandThroughputOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_DynamodbTableOnDemandThroughputOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DynamodbTableOnDemandThroughputOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DynamodbTableOnDemandThroughputOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (d *jsiiProxy_DynamodbTableOnDemandThroughputOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DynamodbTableOnDemandThroughputOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
