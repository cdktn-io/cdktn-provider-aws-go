...
func (d *jsiiProxy_DynamodbTableServerSideEncryptionOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DynamodbTableServerSideEncryptionOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
