...
func (d *jsiiProxy_DynamodbTableTtlOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DynamodbTableTtlOutputReference) ResetAttributeName() {
	_jsii_.InvokeVoid(
		d,
		"resetAttributeName",
		nil, // no parameters
...
func (d *jsiiProxy_DynamodbTableTtlOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
