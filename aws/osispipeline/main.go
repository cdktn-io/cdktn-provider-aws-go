...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "bufferOptionsInput", GoGetter: "BufferOptionsInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "maxUnitsInput", GoGetter: "MaxUnitsInput"},
			_jsii_.MemberProperty{JsiiProperty: "minUnits", GoGetter: "MinUnits"},
			_jsii_.MemberProperty{JsiiProperty: "minUnitsInput", GoGetter: "MinUnitsInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetBufferOptions", GoMethod: "ResetBufferOptions"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "persistentBufferEnabled", GoGetter: "PersistentBufferEnabled"},
			_jsii_.MemberProperty{JsiiProperty: "persistentBufferEnabledInput", GoGetter: "PersistentBufferEnabledInput"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
		...
		func() interface{} {
			j := jsiiProxy_OsisPipelineBufferOptionsOutputReference{}
	...
	_jsii_.RegisterClass(
		...
		func() interface{} {
			j := jsiiProxy_OsisPipelineEncryptionAtRestOptionsList{}
			_jsii_.InitJsiiProxy(&j.Type__cdktfComplexList)
			return &j
		},
	)
	_jsii_.RegisterClass(
		...
		func() interface{} {
			j := jsiiProxy_OsisPipelineEncryptionAtRestOptionsOutputReference{}
			_jsii_.InitJsiiProxy(&j.Type__cdktfComplexObject)
			return &j
		},
	)
	...
	_jsii_.RegisterClass(
		...
		func() interface{} {
			j := jsiiProxy_OsisPipelineLogPublishingOptionsCloudwatchLogDestinationOutputReference{}
			_jsii_.InitJsiiProxy(&j.Type__cdktfComplexObject)
			return &j
		},
	)
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "interpolationAsList", GoMethod: "InterpolationAsList"},
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "isLoggingEnabled", GoGetter: "IsLoggingEnabled"},
			_jsii_.MemberProperty{JsiiProperty: "isLoggingEnabledInput", GoGetter: "IsLoggingEnabledInput"},
			_jsii_.MemberMethod{JsiiMethod: "putCloudwatchLogDestination", GoMethod: "PutCloudwatchLogDestination"},
			_jsii_.MemberMethod{JsiiMethod: "resetCloudwatchLogDestination", GoMethod: "ResetCloudwatchLogDestination"},
			_jsii_.MemberMethod{JsiiMethod: "resetIsLoggingEnabled", GoMethod: "ResetIsLoggingEnabled"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetVpcEndpointManagement", GoMethod: "ResetVpcEndpointManagement"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			...
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
			_jsii_.MemberProperty{JsiiProperty: "vpcEndpointManagement", GoGetter: "VpcEndpointManagement"},
