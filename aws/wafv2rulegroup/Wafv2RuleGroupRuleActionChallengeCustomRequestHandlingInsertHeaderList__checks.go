...
func (w *jsiiProxy_Wafv2RuleGroupRuleActionChallengeCustomRequestHandlingInsertHeaderList) validateGetParameters(index *float64) error {
	if index == nil {
...
func (j *jsiiProxy_Wafv2RuleGroupRuleActionChallengeCustomRequestHandlingInsertHeaderList) validateSetTerraformAttributeParameters(val *string) error {
	if val == nil {
...
func (j *jsiiProxy_Wafv2RuleGroupRuleActionChallengeCustomRequestHandlingInsertHeaderList) validateSetWrapsSetParameters(val *bool) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
