...
func (j *jsiiProxy_DataAwsEcsService) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsEcsService) EnableEcsManagedTags() cdktn.IResolvable {
...
func (j *jsiiProxy_DataAwsEcsService) EnableExecuteCommand() cdktn.IResolvable {
	var returns cdktn.IResolvable
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataAwsEcsService) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsEcsService) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsEcsService) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsEcsService) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/data-sources/ecs_service aws_ecs_service} Data Source.
...
func (j *jsiiProxy_DataAwsEcsService)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsEcsService)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsEcsService)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsEcsService_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsEcsService) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsEcsService) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsEcsService) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsEcsService) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
