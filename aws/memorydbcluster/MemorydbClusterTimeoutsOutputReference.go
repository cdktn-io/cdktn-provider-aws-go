...
func (m *jsiiProxy_MemorydbClusterTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (m *jsiiProxy_MemorydbClusterTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
