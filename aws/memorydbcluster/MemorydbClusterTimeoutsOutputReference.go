...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/memorydbcluster/internal"
...
func (j *jsiiProxy_MemorydbClusterTimeoutsOutputReference) ComplexObjectIndex() interface{} {
...
func (j *jsiiProxy_MemorydbClusterTimeoutsOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_MemorydbClusterTimeoutsOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_MemorydbClusterTimeoutsOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_MemorydbClusterTimeoutsOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_MemorydbClusterTimeoutsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewMemorydbClusterTimeoutsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) MemorydbClusterTimeoutsOutputReference {
	_init_.Initialize()

	if err := validateNewMemorydbClusterTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewMemorydbClusterTimeoutsOutputReference_Override(m MemorydbClusterTimeoutsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_MemorydbClusterTimeoutsOutputReference)SetComplexObjectIndex(val interface{}) {
...
func (j *jsiiProxy_MemorydbClusterTimeoutsOutputReference)SetComplexObjectIsFromSet(val *bool) {
...
func (j *jsiiProxy_MemorydbClusterTimeoutsOutputReference)SetInternalValue(val interface{}) {
...
func (j *jsiiProxy_MemorydbClusterTimeoutsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (m *jsiiProxy_MemorydbClusterTimeoutsOutputReference) ComputeFqn() *string {
	var returns *string
...
func (m *jsiiProxy_MemorydbClusterTimeoutsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MemorydbClusterTimeoutsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (m *jsiiProxy_MemorydbClusterTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MemorydbClusterTimeoutsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
...
func (m *jsiiProxy_MemorydbClusterTimeoutsOutputReference) ToString() *string {
	var returns *string
