...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/dataawscloudtrailserviceaccount/internal"
...
func (j *jsiiProxy_DataAwsCloudtrailServiceAccount) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsCloudtrailServiceAccount) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsCloudtrailServiceAccount) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsCloudtrailServiceAccount) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsCloudtrailServiceAccount) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/data-sources/cloudtrail_service_account aws_cloudtrail_service_account} Data Source.
...
func (j *jsiiProxy_DataAwsCloudtrailServiceAccount)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsCloudtrailServiceAccount)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsCloudtrailServiceAccount)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsCloudtrailServiceAccount_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsCloudtrailServiceAccount) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsCloudtrailServiceAccount) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsCloudtrailServiceAccount) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsCloudtrailServiceAccount) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
