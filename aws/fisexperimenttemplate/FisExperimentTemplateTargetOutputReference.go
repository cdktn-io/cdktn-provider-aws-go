...
func (f *jsiiProxy_FisExperimentTemplateTargetOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (f *jsiiProxy_FisExperimentTemplateTargetOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
