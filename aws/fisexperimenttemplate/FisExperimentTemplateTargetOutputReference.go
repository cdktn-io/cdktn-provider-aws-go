...
func (j *jsiiProxy_FisExperimentTemplateTargetOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewFisExperimentTemplateTargetOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) FisExperimentTemplateTargetOutputReference {
	_init_.Initialize()
...
func NewFisExperimentTemplateTargetOutputReference_Override(f FisExperimentTemplateTargetOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_FisExperimentTemplateTargetOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (f *jsiiProxy_FisExperimentTemplateTargetOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (f *jsiiProxy_FisExperimentTemplateTargetOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (f *jsiiProxy_FisExperimentTemplateTargetOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (f *jsiiProxy_FisExperimentTemplateTargetOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
