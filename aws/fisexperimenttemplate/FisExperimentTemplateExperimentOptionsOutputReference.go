...
func (j *jsiiProxy_FisExperimentTemplateExperimentOptionsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewFisExperimentTemplateExperimentOptionsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) FisExperimentTemplateExperimentOptionsOutputReference {
	_init_.Initialize()
...
func NewFisExperimentTemplateExperimentOptionsOutputReference_Override(f FisExperimentTemplateExperimentOptionsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_FisExperimentTemplateExperimentOptionsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (f *jsiiProxy_FisExperimentTemplateExperimentOptionsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (f *jsiiProxy_FisExperimentTemplateExperimentOptionsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (f *jsiiProxy_FisExperimentTemplateExperimentOptionsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (f *jsiiProxy_FisExperimentTemplateExperimentOptionsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
