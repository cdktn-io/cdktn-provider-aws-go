...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v23/dataawsramresourceshare/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.34.0/docs/data-sources/ram_resource_share aws_ram_resource_share}.
...
func (j *jsiiProxy_DataAwsRamResourceShare) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsRamResourceShare) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsRamResourceShare) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsRamResourceShare) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsRamResourceShare) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DataAwsRamResourceShare) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_DataAwsRamResourceShare) ResourceArns() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"resourceArns",
...
func (j *jsiiProxy_DataAwsRamResourceShare) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.34.0/docs/data-sources/ram_resource_share aws_ram_resource_share} Data Source.
...
func (j *jsiiProxy_DataAwsRamResourceShare)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsRamResourceShare)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsRamResourceShare)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_DataAwsRamResourceShare)SetRegion(val *string) {
...
func DataAwsRamResourceShare_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsRamResourceShare) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsRamResourceShare) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsRamResourceShare) ResetName() {
	_jsii_.InvokeVoid(
		d,
		"resetName",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsRamResourceShare) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsRamResourceShare) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
