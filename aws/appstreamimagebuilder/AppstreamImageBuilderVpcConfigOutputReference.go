...
func (a *jsiiProxy_AppstreamImageBuilderVpcConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_AppstreamImageBuilderVpcConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
