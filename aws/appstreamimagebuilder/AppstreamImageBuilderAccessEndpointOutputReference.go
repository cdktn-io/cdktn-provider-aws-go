...
func (a *jsiiProxy_AppstreamImageBuilderAccessEndpointOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_AppstreamImageBuilderAccessEndpointOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
