...
func (j *jsiiProxy_AppstreamImageBuilder) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_AppstreamImageBuilder) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/appstream_image_builder aws_appstream_image_builder} Resource.
...
func (j *jsiiProxy_AppstreamImageBuilder)SetRegion(val *string) {
...
func (a *jsiiProxy_AppstreamImageBuilder) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (a *jsiiProxy_AppstreamImageBuilder) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (a *jsiiProxy_AppstreamImageBuilder) ResetRegion() {
	_jsii_.InvokeVoid(
		a,
		"resetRegion",
		nil, // no parameters
...
func (a *jsiiProxy_AppstreamImageBuilder) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
