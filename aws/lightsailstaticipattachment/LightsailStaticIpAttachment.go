...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/lightsailstaticipattachment/internal"
...
func (j *jsiiProxy_LightsailStaticIpAttachment) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_LightsailStaticIpAttachment) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_LightsailStaticIpAttachment) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_LightsailStaticIpAttachment) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_LightsailStaticIpAttachment) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/lightsail_static_ip_attachment aws_lightsail_static_ip_attachment} Resource.
...
func (j *jsiiProxy_LightsailStaticIpAttachment)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_LightsailStaticIpAttachment)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_LightsailStaticIpAttachment)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func LightsailStaticIpAttachment_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (l *jsiiProxy_LightsailStaticIpAttachment) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LightsailStaticIpAttachment) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (l *jsiiProxy_LightsailStaticIpAttachment) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LightsailStaticIpAttachment) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (l *jsiiProxy_LightsailStaticIpAttachment) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (l *jsiiProxy_LightsailStaticIpAttachment) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
