...
func (d *jsiiProxy_DataAwsIamPolicyDocumentStatementOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataAwsIamPolicyDocumentStatementOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
