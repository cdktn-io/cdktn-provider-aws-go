...
type CloudfrontDistributionLoggingConfig struct {
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.32.1/docs/resources/cloudfront_distribution#bucket CloudfrontDistribution#bucket}.
