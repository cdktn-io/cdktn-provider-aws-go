...
func (c *jsiiProxy_CloudfrontDistributionCustomErrorResponseOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CloudfrontDistributionCustomErrorResponseOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
