...
func (c *jsiiProxy_CloudfrontDistributionOriginOriginShieldOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CloudfrontDistributionOriginOriginShieldOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
