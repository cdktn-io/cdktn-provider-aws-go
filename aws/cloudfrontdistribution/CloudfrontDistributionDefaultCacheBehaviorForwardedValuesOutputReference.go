...
func (c *jsiiProxy_CloudfrontDistributionDefaultCacheBehaviorForwardedValuesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CloudfrontDistributionDefaultCacheBehaviorForwardedValuesOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
