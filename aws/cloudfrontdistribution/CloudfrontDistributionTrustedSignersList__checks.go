...
func (c *jsiiProxy_CloudfrontDistributionTrustedSignersList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (c *jsiiProxy_CloudfrontDistributionTrustedSignersList) validateResolveParameters(context cdktf.IResolveContext) error {
	if context == nil {
