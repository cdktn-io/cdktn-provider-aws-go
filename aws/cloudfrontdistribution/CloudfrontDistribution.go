...
type CloudfrontDistribution interface {
	...
	LoggingV1Enabled() cdktf.IResolvable
	// The tree node.
...
func (j *jsiiProxy_CloudfrontDistribution) LoggingV1Enabled() cdktf.IResolvable {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.31.0/docs/resources/cloudfront_distribution aws_cloudfront_distribution} Resource.
