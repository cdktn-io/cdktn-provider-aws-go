...
func (j *jsiiProxy_CloudfrontDistributionTrustedKeyGroupsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewCloudfrontDistributionTrustedKeyGroupsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) CloudfrontDistributionTrustedKeyGroupsList {
	_init_.Initialize()
...
func NewCloudfrontDistributionTrustedKeyGroupsList_Override(c CloudfrontDistributionTrustedKeyGroupsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_CloudfrontDistributionTrustedKeyGroupsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_CloudfrontDistributionTrustedKeyGroupsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (c *jsiiProxy_CloudfrontDistributionTrustedKeyGroupsList) Resolve(context cdktn.IResolveContext) interface{} {
