...
func (j *jsiiProxy_CloudfrontDistributionOriginGroupMemberList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_CloudfrontDistributionOriginGroupMemberList) InternalValue() interface{} {
...
func (j *jsiiProxy_CloudfrontDistributionOriginGroupMemberList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_CloudfrontDistributionOriginGroupMemberList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (j *jsiiProxy_CloudfrontDistributionOriginGroupMemberList)SetInternalValue(val interface{}) {
...
func (j *jsiiProxy_CloudfrontDistributionOriginGroupMemberList)SetTerraformAttribute(val *string) {
...
func (j *jsiiProxy_CloudfrontDistributionOriginGroupMemberList)SetWrapsSet(val *bool) {
...
func (c *jsiiProxy_CloudfrontDistributionOriginGroupMemberList) ComputeFqn() *string {
	var returns *string
...
func (c *jsiiProxy_CloudfrontDistributionOriginGroupMemberList) Get(index *float64) CloudfrontDistributionOriginGroupMemberOutputReference {
	if err := c.validateGetParameters(index); err != nil {
		panic(err)
	}
	var returns CloudfrontDistributionOriginGroupMemberOutputReference
...
func (c *jsiiProxy_CloudfrontDistributionOriginGroupMemberList) ToString() *string {
	var returns *string
