...
func (j *jsiiProxy_DataAwsGlueConnection) AthenaProperties() cdktn.StringMap {
...
func (j *jsiiProxy_DataAwsGlueConnection) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsGlueConnection) ConnectionProperties() cdktn.StringMap {
	var returns cdktn.StringMap
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataAwsGlueConnection) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsGlueConnection) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsGlueConnection) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsGlueConnection) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DataAwsGlueConnection)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsGlueConnection)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsGlueConnection)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsGlueConnection_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsGlueConnection) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsGlueConnection) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsGlueConnection) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsGlueConnection) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
