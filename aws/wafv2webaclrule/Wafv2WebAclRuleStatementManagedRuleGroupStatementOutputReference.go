...
type Wafv2WebAclRuleStatementManagedRuleGroupStatementOutputReference interface {
	...
	ScopeDownStatement() Wafv2WebAclRuleStatementManagedRuleGroupStatementScopeDownStatementList
...
func (j *jsiiProxy_Wafv2WebAclRuleStatementManagedRuleGroupStatementOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_Wafv2WebAclRuleStatementManagedRuleGroupStatementOutputReference) ScopeDownStatement() Wafv2WebAclRuleStatementManagedRuleGroupStatementScopeDownStatementList {
	var returns Wafv2WebAclRuleStatementManagedRuleGroupStatementScopeDownStatementList
	_jsii_.Get(
		j,
		"scopeDownStatement",
		&returns,
...
func (j *jsiiProxy_Wafv2WebAclRuleStatementManagedRuleGroupStatementOutputReference) ScopeDownStatementInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_Wafv2WebAclRuleStatementManagedRuleGroupStatementOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewWafv2WebAclRuleStatementManagedRuleGroupStatementOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) Wafv2WebAclRuleStatementManagedRuleGroupStatementOutputReference {
	_init_.Initialize()

	if err := validateNewWafv2WebAclRuleStatementManagedRuleGroupStatementOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
	j := jsiiProxy_Wafv2WebAclRuleStatementManagedRuleGroupStatementOutputReference{}

	_jsii_.Create(
		"@cdktn/provider-aws.wafv2WebAclRule.Wafv2WebAclRuleStatementManagedRuleGroupStatementOutputReference",
...
func NewWafv2WebAclRuleStatementManagedRuleGroupStatementOutputReference_Override(w Wafv2WebAclRuleStatementManagedRuleGroupStatementOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_Wafv2WebAclRuleStatementManagedRuleGroupStatementOutputReference)SetInternalValue(val interface{}) {
...
func (j *jsiiProxy_Wafv2WebAclRuleStatementManagedRuleGroupStatementOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (w *jsiiProxy_Wafv2WebAclRuleStatementManagedRuleGroupStatementOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_Wafv2WebAclRuleStatementManagedRuleGroupStatementOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (w *jsiiProxy_Wafv2WebAclRuleStatementManagedRuleGroupStatementOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_Wafv2WebAclRuleStatementManagedRuleGroupStatementOutputReference) PutScopeDownStatement(value interface{}) {
...
func (w *jsiiProxy_Wafv2WebAclRuleStatementManagedRuleGroupStatementOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
