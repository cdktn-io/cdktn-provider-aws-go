...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/configdeliverychannel/internal"
...
func (j *jsiiProxy_ConfigDeliveryChannel) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_ConfigDeliveryChannel) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_ConfigDeliveryChannel) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_ConfigDeliveryChannel) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_ConfigDeliveryChannel) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_ConfigDeliveryChannel) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_ConfigDeliveryChannel) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/config_delivery_channel aws_config_delivery_channel} Resource.
...
func (j *jsiiProxy_ConfigDeliveryChannel)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_ConfigDeliveryChannel)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_ConfigDeliveryChannel)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_ConfigDeliveryChannel)SetRegion(val *string) {
...
func ConfigDeliveryChannel_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (c *jsiiProxy_ConfigDeliveryChannel) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_ConfigDeliveryChannel) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (c *jsiiProxy_ConfigDeliveryChannel) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_ConfigDeliveryChannel) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_ConfigDeliveryChannel) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (c *jsiiProxy_ConfigDeliveryChannel) ResetRegion() {
	_jsii_.InvokeVoid(
		c,
		"resetRegion",
		nil, // no parameters
...
func (c *jsiiProxy_ConfigDeliveryChannel) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
