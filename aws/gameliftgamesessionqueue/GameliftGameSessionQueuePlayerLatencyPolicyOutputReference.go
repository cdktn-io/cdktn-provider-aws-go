...
func (j *jsiiProxy_GameliftGameSessionQueuePlayerLatencyPolicyOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewGameliftGameSessionQueuePlayerLatencyPolicyOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) GameliftGameSessionQueuePlayerLatencyPolicyOutputReference {
	_init_.Initialize()

	if err := validateNewGameliftGameSessionQueuePlayerLatencyPolicyOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
	j := jsiiProxy_GameliftGameSessionQueuePlayerLatencyPolicyOutputReference{}

	_jsii_.Create(
		"@cdktn/provider-aws.gameliftGameSessionQueue.GameliftGameSessionQueuePlayerLatencyPolicyOutputReference",
...
func NewGameliftGameSessionQueuePlayerLatencyPolicyOutputReference_Override(g GameliftGameSessionQueuePlayerLatencyPolicyOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_GameliftGameSessionQueuePlayerLatencyPolicyOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (g *jsiiProxy_GameliftGameSessionQueuePlayerLatencyPolicyOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GameliftGameSessionQueuePlayerLatencyPolicyOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (g *jsiiProxy_GameliftGameSessionQueuePlayerLatencyPolicyOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GameliftGameSessionQueuePlayerLatencyPolicyOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
