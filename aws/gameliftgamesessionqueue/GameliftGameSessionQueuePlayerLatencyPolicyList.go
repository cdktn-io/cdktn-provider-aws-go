...
func (j *jsiiProxy_GameliftGameSessionQueuePlayerLatencyPolicyList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewGameliftGameSessionQueuePlayerLatencyPolicyList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) GameliftGameSessionQueuePlayerLatencyPolicyList {
	_init_.Initialize()
...
func NewGameliftGameSessionQueuePlayerLatencyPolicyList_Override(g GameliftGameSessionQueuePlayerLatencyPolicyList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_GameliftGameSessionQueuePlayerLatencyPolicyList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (g *jsiiProxy_GameliftGameSessionQueuePlayerLatencyPolicyList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (g *jsiiProxy_GameliftGameSessionQueuePlayerLatencyPolicyList) Resolve(context cdktn.IResolveContext) interface{} {
