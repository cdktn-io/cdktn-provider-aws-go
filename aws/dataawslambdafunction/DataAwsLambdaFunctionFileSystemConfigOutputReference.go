...
func (d *jsiiProxy_DataAwsLambdaFunctionFileSystemConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataAwsLambdaFunctionFileSystemConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
