...
func (d *jsiiProxy_DataAwsLambdaFunctionDeadLetterConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataAwsLambdaFunctionDeadLetterConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
