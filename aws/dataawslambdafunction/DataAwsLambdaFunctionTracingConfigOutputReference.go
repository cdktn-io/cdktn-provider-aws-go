...
func (d *jsiiProxy_DataAwsLambdaFunctionTracingConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataAwsLambdaFunctionTracingConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
