...
func (j *jsiiProxy_DataAwsLambdaFunctionDeadLetterConfigList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsLambdaFunctionDeadLetterConfigList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsLambdaFunctionDeadLetterConfigList {
	_init_.Initialize()

	if err := validateNewDataAwsLambdaFunctionDeadLetterConfigListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewDataAwsLambdaFunctionDeadLetterConfigList_Override(d DataAwsLambdaFunctionDeadLetterConfigList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsLambdaFunctionDeadLetterConfigList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsLambdaFunctionDeadLetterConfigList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsLambdaFunctionDeadLetterConfigList) Resolve(context cdktn.IResolveContext) interface{} {
