...
func (d *jsiiProxy_DataAwsLambdaFunctionEnvironmentOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataAwsLambdaFunctionEnvironmentOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
