...
func (d *jsiiProxy_DataAwsLambdaFunctionFileSystemConfigList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsLambdaFunctionFileSystemConfigList) Resolve(context cdktf.IResolveContext) interface{} {
