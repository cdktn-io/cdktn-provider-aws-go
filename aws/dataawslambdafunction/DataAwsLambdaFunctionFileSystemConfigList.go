...
func (j *jsiiProxy_DataAwsLambdaFunctionFileSystemConfigList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsLambdaFunctionFileSystemConfigList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsLambdaFunctionFileSystemConfigList {
	_init_.Initialize()

	if err := validateNewDataAwsLambdaFunctionFileSystemConfigListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewDataAwsLambdaFunctionFileSystemConfigList_Override(d DataAwsLambdaFunctionFileSystemConfigList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsLambdaFunctionFileSystemConfigList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsLambdaFunctionFileSystemConfigList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsLambdaFunctionFileSystemConfigList) Resolve(context cdktn.IResolveContext) interface{} {
