...
func (d *jsiiProxy_DataAwsLambdaFunctionEnvironmentList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsLambdaFunctionEnvironmentList) Resolve(context cdktf.IResolveContext) interface{} {
