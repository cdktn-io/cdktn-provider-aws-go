...
func (j *jsiiProxy_DataAwsLambdaFunctionEnvironmentList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsLambdaFunctionEnvironmentList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsLambdaFunctionEnvironmentList {
	_init_.Initialize()

	if err := validateNewDataAwsLambdaFunctionEnvironmentListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewDataAwsLambdaFunctionEnvironmentList_Override(d DataAwsLambdaFunctionEnvironmentList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsLambdaFunctionEnvironmentList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsLambdaFunctionEnvironmentList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsLambdaFunctionEnvironmentList) Resolve(context cdktn.IResolveContext) interface{} {
