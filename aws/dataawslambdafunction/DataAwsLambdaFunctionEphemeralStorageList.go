...
func (j *jsiiProxy_DataAwsLambdaFunctionEphemeralStorageList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsLambdaFunctionEphemeralStorageList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsLambdaFunctionEphemeralStorageList {
	_init_.Initialize()
...
func NewDataAwsLambdaFunctionEphemeralStorageList_Override(d DataAwsLambdaFunctionEphemeralStorageList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsLambdaFunctionEphemeralStorageList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsLambdaFunctionEphemeralStorageList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsLambdaFunctionEphemeralStorageList) Resolve(context cdktn.IResolveContext) interface{} {
