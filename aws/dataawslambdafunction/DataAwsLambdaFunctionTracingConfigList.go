...
func (j *jsiiProxy_DataAwsLambdaFunctionTracingConfigList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsLambdaFunctionTracingConfigList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsLambdaFunctionTracingConfigList {
	_init_.Initialize()
...
func NewDataAwsLambdaFunctionTracingConfigList_Override(d DataAwsLambdaFunctionTracingConfigList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsLambdaFunctionTracingConfigList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsLambdaFunctionTracingConfigList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsLambdaFunctionTracingConfigList) Resolve(context cdktn.IResolveContext) interface{} {
