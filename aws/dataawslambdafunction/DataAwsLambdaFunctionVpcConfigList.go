...
func (j *jsiiProxy_DataAwsLambdaFunctionVpcConfigList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsLambdaFunctionVpcConfigList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsLambdaFunctionVpcConfigList {
	_init_.Initialize()
...
func NewDataAwsLambdaFunctionVpcConfigList_Override(d DataAwsLambdaFunctionVpcConfigList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsLambdaFunctionVpcConfigList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsLambdaFunctionVpcConfigList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsLambdaFunctionVpcConfigList) Resolve(context cdktn.IResolveContext) interface{} {
