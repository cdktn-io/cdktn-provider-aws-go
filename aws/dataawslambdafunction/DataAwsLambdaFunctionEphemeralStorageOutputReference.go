...
func (j *jsiiProxy_DataAwsLambdaFunctionEphemeralStorageOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsLambdaFunctionEphemeralStorageOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) DataAwsLambdaFunctionEphemeralStorageOutputReference {
	_init_.Initialize()

	if err := validateNewDataAwsLambdaFunctionEphemeralStorageOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func NewDataAwsLambdaFunctionEphemeralStorageOutputReference_Override(d DataAwsLambdaFunctionEphemeralStorageOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsLambdaFunctionEphemeralStorageOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsLambdaFunctionEphemeralStorageOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsLambdaFunctionEphemeralStorageOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (d *jsiiProxy_DataAwsLambdaFunctionEphemeralStorageOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsLambdaFunctionEphemeralStorageOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
