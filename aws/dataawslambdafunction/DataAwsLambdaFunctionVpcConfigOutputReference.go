...
func (d *jsiiProxy_DataAwsLambdaFunctionVpcConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataAwsLambdaFunctionVpcConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
