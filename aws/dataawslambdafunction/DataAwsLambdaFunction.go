...
type DataAwsLambdaFunction interface {
	...
	Arn() *string
	CapacityProviderConfig() DataAwsLambdaFunctionCapacityProviderConfigList
	// Experimental.
	...
	Description() *string
	DurableConfig() DataAwsLambdaFunctionDurableConfigList
...
func (j *jsiiProxy_DataAwsLambdaFunction) CapacityProviderConfig() DataAwsLambdaFunctionCapacityProviderConfigList {
	var returns DataAwsLambdaFunctionCapacityProviderConfigList
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataAwsLambdaFunction) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsLambdaFunction) CodeSha256() *string {
	var returns *string
	_jsii_.Get(
		j,
		"codeSha256",
...
func (j *jsiiProxy_DataAwsLambdaFunction) DurableConfig() DataAwsLambdaFunctionDurableConfigList {
	var returns DataAwsLambdaFunctionDurableConfigList
	_jsii_.Get(
		j,
		"durableConfig",
		&returns,
...
func (j *jsiiProxy_DataAwsLambdaFunction) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsLambdaFunction) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsLambdaFunction) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsLambdaFunction) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DataAwsLambdaFunction) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_DataAwsLambdaFunction) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DataAwsLambdaFunction)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsLambdaFunction)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsLambdaFunction)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_DataAwsLambdaFunction)SetRegion(val *string) {
...
func DataAwsLambdaFunction_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsLambdaFunction) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsLambdaFunction) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsLambdaFunction) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsLambdaFunction) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsLambdaFunction) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
