...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*LicensemanagerGrantAccepter)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "grantArn", GoGetter: "GrantArn"},
			_jsii_.MemberProperty{JsiiProperty: "grantArnInput", GoGetter: "GrantArnInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "parentArn", GoGetter: "ParentArn"},
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-aws.licensemanagerGrantAccepter.LicensemanagerGrantAccepterConfig",
		reflect.TypeOf((*LicensemanagerGrantAccepterConfig)(nil)).Elem(),
	)
}
