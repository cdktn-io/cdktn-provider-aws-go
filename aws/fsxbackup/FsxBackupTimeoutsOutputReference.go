...
func (f *jsiiProxy_FsxBackupTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (f *jsiiProxy_FsxBackupTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
