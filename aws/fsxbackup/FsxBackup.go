...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/fsxbackup/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/fsx_backup aws_fsx_backup}.
...
func (j *jsiiProxy_FsxBackup) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_FsxBackup) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_FsxBackup) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_FsxBackup) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_FsxBackup) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_FsxBackup) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_FsxBackup) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/fsx_backup aws_fsx_backup} Resource.
...
func (j *jsiiProxy_FsxBackup)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_FsxBackup)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_FsxBackup)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_FsxBackup)SetRegion(val *string) {
...
func FsxBackup_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateFsxBackup_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (f *jsiiProxy_FsxBackup) AddMoveTarget(moveTarget *string) {
...
func (f *jsiiProxy_FsxBackup) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (f *jsiiProxy_FsxBackup) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (f *jsiiProxy_FsxBackup) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (f *jsiiProxy_FsxBackup) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (f *jsiiProxy_FsxBackup) MoveFromId(id *string) {
...
func (f *jsiiProxy_FsxBackup) MoveToId(id *string) {
...
func (f *jsiiProxy_FsxBackup) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (f *jsiiProxy_FsxBackup) ResetRegion() {
	_jsii_.InvokeVoid(
		f,
		"resetRegion",
		nil, // no parameters
...
func (f *jsiiProxy_FsxBackup) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
