...
func (d *jsiiProxy_DataAwsOrganizationsOrganizationalUnitDescendantOrganizationalUnitsChildrenOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataAwsOrganizationsOrganizationalUnitDescendantOrganizationalUnitsChildrenOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
