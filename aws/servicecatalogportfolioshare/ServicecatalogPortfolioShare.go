...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/servicecatalogportfolioshare/internal"
...
func (j *jsiiProxy_ServicecatalogPortfolioShare) Accepted() cdktn.IResolvable {
...
func (j *jsiiProxy_ServicecatalogPortfolioShare) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_ServicecatalogPortfolioShare) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_ServicecatalogPortfolioShare) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_ServicecatalogPortfolioShare) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_ServicecatalogPortfolioShare) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/servicecatalog_portfolio_share aws_servicecatalog_portfolio_share} Resource.
...
func (j *jsiiProxy_ServicecatalogPortfolioShare)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_ServicecatalogPortfolioShare)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_ServicecatalogPortfolioShare)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func ServicecatalogPortfolioShare_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (s *jsiiProxy_ServicecatalogPortfolioShare) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_ServicecatalogPortfolioShare) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_ServicecatalogPortfolioShare) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_ServicecatalogPortfolioShare) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_ServicecatalogPortfolioShare) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_ServicecatalogPortfolioShare) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
