...
func (s *jsiiProxy_SsmincidentsResponsePlanIncidentTemplateOutputReference) validatePutNotificationTargetParameters(value interface{}) error {
	if value == nil {
	...
	case *[]*SsmincidentsResponsePlanIncidentTemplateNotificationTarget:
		value := value.(*[]*SsmincidentsResponsePlanIncidentTemplateNotificationTarget)
	...
	case []*SsmincidentsResponsePlanIncidentTemplateNotificationTarget:
		value_ := value.([]*SsmincidentsResponsePlanIncidentTemplateNotificationTarget)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*SsmincidentsResponsePlanIncidentTemplateNotificationTarget; received %#v (a %T)", value, value)
		}
	}
...
func (s *jsiiProxy_SsmincidentsResponsePlanIncidentTemplateOutputReference) validateResolveParameters(context cdktf.IResolveContext) error {
	if context == nil {
...
func (j *jsiiProxy_SsmincidentsResponsePlanIncidentTemplateOutputReference) validateSetIncidentTagsParameters(val *map[string]*string) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func (j *jsiiProxy_SsmincidentsResponsePlanIncidentTemplateOutputReference) validateSetInternalValueParameters(val *SsmincidentsResponsePlanIncidentTemplate) error {
