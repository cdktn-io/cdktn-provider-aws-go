...
func (s *jsiiProxy_SsmincidentsResponsePlanIncidentTemplateOutputReference) validatePutNotificationTargetParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*SsmincidentsResponsePlanIncidentTemplateNotificationTarget; received %#v (a %T)", value, value)
		}
	}
