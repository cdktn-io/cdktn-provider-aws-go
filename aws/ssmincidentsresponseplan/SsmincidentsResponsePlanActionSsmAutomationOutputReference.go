...
func (j *jsiiProxy_SsmincidentsResponsePlanActionSsmAutomationOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewSsmincidentsResponsePlanActionSsmAutomationOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) SsmincidentsResponsePlanActionSsmAutomationOutputReference {
	_init_.Initialize()
...
func NewSsmincidentsResponsePlanActionSsmAutomationOutputReference_Override(s SsmincidentsResponsePlanActionSsmAutomationOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_SsmincidentsResponsePlanActionSsmAutomationOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_SsmincidentsResponsePlanActionSsmAutomationOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SsmincidentsResponsePlanActionSsmAutomationOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (s *jsiiProxy_SsmincidentsResponsePlanActionSsmAutomationOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SsmincidentsResponsePlanActionSsmAutomationOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
