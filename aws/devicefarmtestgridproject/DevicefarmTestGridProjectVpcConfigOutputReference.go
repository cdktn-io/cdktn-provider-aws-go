...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v22/devicefarmtestgridproject/internal"
...
func (d *jsiiProxy_DevicefarmTestGridProjectVpcConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DevicefarmTestGridProjectVpcConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
