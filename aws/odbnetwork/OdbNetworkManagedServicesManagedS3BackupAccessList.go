...
func (j *jsiiProxy_OdbNetworkManagedServicesManagedS3BackupAccessList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewOdbNetworkManagedServicesManagedS3BackupAccessList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) OdbNetworkManagedServicesManagedS3BackupAccessList {
	_init_.Initialize()
...
func NewOdbNetworkManagedServicesManagedS3BackupAccessList_Override(o OdbNetworkManagedServicesManagedS3BackupAccessList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_OdbNetworkManagedServicesManagedS3BackupAccessList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (o *jsiiProxy_OdbNetworkManagedServicesManagedS3BackupAccessList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (o *jsiiProxy_OdbNetworkManagedServicesManagedS3BackupAccessList) Resolve(context cdktn.IResolveContext) interface{} {
