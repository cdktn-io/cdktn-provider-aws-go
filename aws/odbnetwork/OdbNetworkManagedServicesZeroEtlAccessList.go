...
func (j *jsiiProxy_OdbNetworkManagedServicesZeroEtlAccessList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewOdbNetworkManagedServicesZeroEtlAccessList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) OdbNetworkManagedServicesZeroEtlAccessList {
	_init_.Initialize()
...
func NewOdbNetworkManagedServicesZeroEtlAccessList_Override(o OdbNetworkManagedServicesZeroEtlAccessList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_OdbNetworkManagedServicesZeroEtlAccessList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (o *jsiiProxy_OdbNetworkManagedServicesZeroEtlAccessList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (o *jsiiProxy_OdbNetworkManagedServicesZeroEtlAccessList) Resolve(context cdktn.IResolveContext) interface{} {
