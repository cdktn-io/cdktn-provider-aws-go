...
func (j *jsiiProxy_OdbNetworkManagedServicesList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewOdbNetworkManagedServicesList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) OdbNetworkManagedServicesList {
	_init_.Initialize()
...
func NewOdbNetworkManagedServicesList_Override(o OdbNetworkManagedServicesList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_OdbNetworkManagedServicesList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (o *jsiiProxy_OdbNetworkManagedServicesList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (o *jsiiProxy_OdbNetworkManagedServicesList) Resolve(context cdktn.IResolveContext) interface{} {
