...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/dataawslambdacodesigningconfig/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/data-sources/lambda_code_signing_config aws_lambda_code_signing_config}.
...
func (j *jsiiProxy_DataAwsLambdaCodeSigningConfig) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsLambdaCodeSigningConfig) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsLambdaCodeSigningConfig) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsLambdaCodeSigningConfig) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsLambdaCodeSigningConfig) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DataAwsLambdaCodeSigningConfig) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_DataAwsLambdaCodeSigningConfig) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/data-sources/lambda_code_signing_config aws_lambda_code_signing_config} Data Source.
...
func (j *jsiiProxy_DataAwsLambdaCodeSigningConfig)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsLambdaCodeSigningConfig)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsLambdaCodeSigningConfig)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_DataAwsLambdaCodeSigningConfig)SetRegion(val *string) {
...
func DataAwsLambdaCodeSigningConfig_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateDataAwsLambdaCodeSigningConfig_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataAwsLambdaCodeSigningConfig) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsLambdaCodeSigningConfig) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsLambdaCodeSigningConfig) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsLambdaCodeSigningConfig) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsLambdaCodeSigningConfig) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
