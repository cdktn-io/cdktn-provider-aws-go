...
func (d *jsiiProxy_DataAwsLambdaCodeSigningConfigAllowedPublishersList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsLambdaCodeSigningConfigAllowedPublishersList) Resolve(context cdktf.IResolveContext) interface{} {
