...
func (j *jsiiProxy_DataAwsLambdaCodeSigningConfigPoliciesList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsLambdaCodeSigningConfigPoliciesList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsLambdaCodeSigningConfigPoliciesList {
	_init_.Initialize()
...
func NewDataAwsLambdaCodeSigningConfigPoliciesList_Override(d DataAwsLambdaCodeSigningConfigPoliciesList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsLambdaCodeSigningConfigPoliciesList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsLambdaCodeSigningConfigPoliciesList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsLambdaCodeSigningConfigPoliciesList) Resolve(context cdktn.IResolveContext) interface{} {
