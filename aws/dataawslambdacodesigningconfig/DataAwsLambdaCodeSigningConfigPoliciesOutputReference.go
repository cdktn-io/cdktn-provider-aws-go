...
func (j *jsiiProxy_DataAwsLambdaCodeSigningConfigPoliciesOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsLambdaCodeSigningConfigPoliciesOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) DataAwsLambdaCodeSigningConfigPoliciesOutputReference {
	_init_.Initialize()

	if err := validateNewDataAwsLambdaCodeSigningConfigPoliciesOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func NewDataAwsLambdaCodeSigningConfigPoliciesOutputReference_Override(d DataAwsLambdaCodeSigningConfigPoliciesOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsLambdaCodeSigningConfigPoliciesOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsLambdaCodeSigningConfigPoliciesOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsLambdaCodeSigningConfigPoliciesOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (d *jsiiProxy_DataAwsLambdaCodeSigningConfigPoliciesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsLambdaCodeSigningConfigPoliciesOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
