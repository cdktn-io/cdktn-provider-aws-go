...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/ecr_repository aws_ecr_repository}.
...
func (j *jsiiProxy_EcrRepository) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_EcrRepository) EncryptionConfiguration() EcrRepositoryEncryptionConfigurationList {
	var returns EcrRepositoryEncryptionConfigurationList
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_EcrRepository) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_EcrRepository) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_EcrRepository) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_EcrRepository) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_EcrRepository) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_EcrRepository) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_EcrRepository) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/ecr_repository aws_ecr_repository} Resource.
...
func (j *jsiiProxy_EcrRepository)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_EcrRepository)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_EcrRepository)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_EcrRepository)SetRegion(val *string) {
...
func EcrRepository_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (e *jsiiProxy_EcrRepository) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (e *jsiiProxy_EcrRepository) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (e *jsiiProxy_EcrRepository) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (e *jsiiProxy_EcrRepository) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (e *jsiiProxy_EcrRepository) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (e *jsiiProxy_EcrRepository) ResetForceDelete() {
	_jsii_.InvokeVoid(
		e,
		"resetForceDelete",
		nil, // no parameters
...
func (e *jsiiProxy_EcrRepository) ResetId() {
	_jsii_.InvokeVoid(
		e,
		"resetId",
		nil, // no parameters
...
func (e *jsiiProxy_EcrRepository) ResetRegion() {
	_jsii_.InvokeVoid(
		e,
		"resetRegion",
		nil, // no parameters
...
func (e *jsiiProxy_EcrRepository) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
