...
func (e *jsiiProxy_EcrRepository) validatePutEncryptionConfigurationParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*EcrRepositoryEncryptionConfiguration; received %#v (a %T)", value, value)
		}
	}
...
func (e *jsiiProxy_EcrRepository) validatePutImageTagMutabilityExclusionFilterParameters(value interface{}) error {
	...
	case *[]*EcrRepositoryImageTagMutabilityExclusionFilter:
		value := value.(*[]*EcrRepositoryImageTagMutabilityExclusionFilter)
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
			}
	...
	case []*EcrRepositoryImageTagMutabilityExclusionFilter:
		value_ := value.([]*EcrRepositoryImageTagMutabilityExclusionFilter)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*EcrRepositoryImageTagMutabilityExclusionFilter; received %#v (a %T)", value, value)
		}
	}
