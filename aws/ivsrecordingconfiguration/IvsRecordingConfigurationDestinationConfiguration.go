...
type IvsRecordingConfigurationDestinationConfiguration struct {
	// s3 block.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.49.0/docs/resources/ivs_recording_configuration#s3 IvsRecordingConfiguration#s3}
