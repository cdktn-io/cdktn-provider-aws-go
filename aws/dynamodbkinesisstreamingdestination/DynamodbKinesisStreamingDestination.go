...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/dynamodbkinesisstreamingdestination/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/dynamodb_kinesis_streaming_destination aws_dynamodb_kinesis_streaming_destination}.
...
func (j *jsiiProxy_DynamodbKinesisStreamingDestination) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DynamodbKinesisStreamingDestination) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DynamodbKinesisStreamingDestination) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DynamodbKinesisStreamingDestination) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DynamodbKinesisStreamingDestination) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DynamodbKinesisStreamingDestination) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_DynamodbKinesisStreamingDestination) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/dynamodb_kinesis_streaming_destination aws_dynamodb_kinesis_streaming_destination} Resource.
func NewDynamodbKinesisStreamingDestination(scope constructs.Construct, id *string, config *DynamodbKinesisStreamingDestinationConfig) DynamodbKinesisStreamingDestination {
	...
	_jsii_.Create(
		"@cdktn/provider-aws.dynamodbKinesisStreamingDestination.DynamodbKinesisStreamingDestination",
...
func (j *jsiiProxy_DynamodbKinesisStreamingDestination)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DynamodbKinesisStreamingDestination)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DynamodbKinesisStreamingDestination)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_DynamodbKinesisStreamingDestination)SetRegion(val *string) {
...
func DynamodbKinesisStreamingDestination_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DynamodbKinesisStreamingDestination) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DynamodbKinesisStreamingDestination) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (d *jsiiProxy_DynamodbKinesisStreamingDestination) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DynamodbKinesisStreamingDestination) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (d *jsiiProxy_DynamodbKinesisStreamingDestination) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DynamodbKinesisStreamingDestination) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
...
func (d *jsiiProxy_DynamodbKinesisStreamingDestination) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
