...
func (d *jsiiProxy_DataAwsConnectUserHierarchyStructureHierarchyStructureLevelTwoList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsConnectUserHierarchyStructureHierarchyStructureLevelTwoList) Resolve(context cdktf.IResolveContext) interface{} {
