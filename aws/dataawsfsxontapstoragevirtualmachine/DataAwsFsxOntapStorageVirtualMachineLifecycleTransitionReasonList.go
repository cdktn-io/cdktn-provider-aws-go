...
func (d *jsiiProxy_DataAwsFsxOntapStorageVirtualMachineLifecycleTransitionReasonList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsFsxOntapStorageVirtualMachineLifecycleTransitionReasonList) Resolve(context cdktf.IResolveContext) interface{} {
