...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/data-sources/fsx_ontap_storage_virtual_machine aws_fsx_ontap_storage_virtual_machine}.
...
func (j *jsiiProxy_DataAwsFsxOntapStorageVirtualMachine) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsFsxOntapStorageVirtualMachine) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsFsxOntapStorageVirtualMachine) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsFsxOntapStorageVirtualMachine) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsFsxOntapStorageVirtualMachine) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/data-sources/fsx_ontap_storage_virtual_machine aws_fsx_ontap_storage_virtual_machine} Data Source.
...
func (j *jsiiProxy_DataAwsFsxOntapStorageVirtualMachine)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsFsxOntapStorageVirtualMachine)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsFsxOntapStorageVirtualMachine)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsFsxOntapStorageVirtualMachine_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsFsxOntapStorageVirtualMachine) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsFsxOntapStorageVirtualMachine) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsFsxOntapStorageVirtualMachine) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsFsxOntapStorageVirtualMachine) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataAwsFsxOntapStorageVirtualMachine) ToHclTerraform() interface{} {
	var returns interface{}
...
func (d *jsiiProxy_DataAwsFsxOntapStorageVirtualMachine) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
