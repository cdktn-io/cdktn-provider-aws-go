...
func (d *jsiiProxy_DataAwsSsmcontactsPlanStageList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
	return nil
}

func (d *jsiiProxy_DataAwsSsmcontactsPlanStageList) validateGetParameters(index *float64) error {
	return nil
}
...
func (j *jsiiProxy_DataAwsSsmcontactsPlanStageList) validateSetTerraformAttributeParameters(val *string) error {
	return nil
}
...
func (j *jsiiProxy_DataAwsSsmcontactsPlanStageList) validateSetWrapsSetParameters(val *bool) error {
	return nil
}
