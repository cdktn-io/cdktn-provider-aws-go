...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/cognitouserpooldomain/internal"
...
func (j *jsiiProxy_CognitoUserPoolDomain) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_CognitoUserPoolDomain) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_CognitoUserPoolDomain) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_CognitoUserPoolDomain) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_CognitoUserPoolDomain) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_CognitoUserPoolDomain) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_CognitoUserPoolDomain) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/cognito_user_pool_domain aws_cognito_user_pool_domain} Resource.
...
func (j *jsiiProxy_CognitoUserPoolDomain)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_CognitoUserPoolDomain)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_CognitoUserPoolDomain)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_CognitoUserPoolDomain)SetRegion(val *string) {
...
func CognitoUserPoolDomain_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (c *jsiiProxy_CognitoUserPoolDomain) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CognitoUserPoolDomain) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (c *jsiiProxy_CognitoUserPoolDomain) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CognitoUserPoolDomain) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_CognitoUserPoolDomain) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (c *jsiiProxy_CognitoUserPoolDomain) ResetRegion() {
	_jsii_.InvokeVoid(
		c,
		"resetRegion",
		nil, // no parameters
...
func (c *jsiiProxy_CognitoUserPoolDomain) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
