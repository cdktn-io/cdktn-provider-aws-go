...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v24/networkfirewallloggingconfiguration/internal"
...
func (j *jsiiProxy_NetworkfirewallLoggingConfigurationLoggingConfigurationOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewNetworkfirewallLoggingConfigurationLoggingConfigurationOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) NetworkfirewallLoggingConfigurationLoggingConfigurationOutputReference {
	_init_.Initialize()

	if err := validateNewNetworkfirewallLoggingConfigurationLoggingConfigurationOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewNetworkfirewallLoggingConfigurationLoggingConfigurationOutputReference_Override(n NetworkfirewallLoggingConfigurationLoggingConfigurationOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_NetworkfirewallLoggingConfigurationLoggingConfigurationOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (n *jsiiProxy_NetworkfirewallLoggingConfigurationLoggingConfigurationOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (n *jsiiProxy_NetworkfirewallLoggingConfigurationLoggingConfigurationOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (n *jsiiProxy_NetworkfirewallLoggingConfigurationLoggingConfigurationOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (n *jsiiProxy_NetworkfirewallLoggingConfigurationLoggingConfigurationOutputReference) PutLogDestinationConfig(value interface{}) {
	if err := n.validatePutLogDestinationConfigParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		n,
...
func (n *jsiiProxy_NetworkfirewallLoggingConfigurationLoggingConfigurationOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
