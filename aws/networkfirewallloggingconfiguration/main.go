...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "enableMonitoringDashboard", GoGetter: "EnableMonitoringDashboard"},
			_jsii_.MemberProperty{JsiiProperty: "enableMonitoringDashboardInput", GoGetter: "EnableMonitoringDashboardInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetEnableMonitoringDashboard", GoMethod: "ResetEnableMonitoringDashboard"},
