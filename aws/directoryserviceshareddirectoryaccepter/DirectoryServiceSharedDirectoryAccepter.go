...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/directoryserviceshareddirectoryaccepter/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/directory_service_shared_directory_accepter aws_directory_service_shared_directory_accepter}.
...
func (j *jsiiProxy_DirectoryServiceSharedDirectoryAccepter) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DirectoryServiceSharedDirectoryAccepter) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DirectoryServiceSharedDirectoryAccepter) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DirectoryServiceSharedDirectoryAccepter) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DirectoryServiceSharedDirectoryAccepter) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DirectoryServiceSharedDirectoryAccepter) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_DirectoryServiceSharedDirectoryAccepter) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/directory_service_shared_directory_accepter aws_directory_service_shared_directory_accepter} Resource.
...
func (j *jsiiProxy_DirectoryServiceSharedDirectoryAccepter)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DirectoryServiceSharedDirectoryAccepter)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DirectoryServiceSharedDirectoryAccepter)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_DirectoryServiceSharedDirectoryAccepter)SetRegion(val *string) {
...
// Generates CDKTN code for importing a DirectoryServiceSharedDirectoryAccepter resource upon running "cdktn plan <stack-name>".
func DirectoryServiceSharedDirectoryAccepter_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateDirectoryServiceSharedDirectoryAccepter_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DirectoryServiceSharedDirectoryAccepter) AddMoveTarget(moveTarget *string) {
...
func (d *jsiiProxy_DirectoryServiceSharedDirectoryAccepter) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DirectoryServiceSharedDirectoryAccepter) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (d *jsiiProxy_DirectoryServiceSharedDirectoryAccepter) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DirectoryServiceSharedDirectoryAccepter) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (d *jsiiProxy_DirectoryServiceSharedDirectoryAccepter) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DirectoryServiceSharedDirectoryAccepter) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
...
func (d *jsiiProxy_DirectoryServiceSharedDirectoryAccepter) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
