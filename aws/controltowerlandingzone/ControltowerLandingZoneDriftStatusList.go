...
func (j *jsiiProxy_ControltowerLandingZoneDriftStatusList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewControltowerLandingZoneDriftStatusList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ControltowerLandingZoneDriftStatusList {
	_init_.Initialize()
...
func NewControltowerLandingZoneDriftStatusList_Override(c ControltowerLandingZoneDriftStatusList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ControltowerLandingZoneDriftStatusList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_ControltowerLandingZoneDriftStatusList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (c *jsiiProxy_ControltowerLandingZoneDriftStatusList) Resolve(context cdktn.IResolveContext) interface{} {
