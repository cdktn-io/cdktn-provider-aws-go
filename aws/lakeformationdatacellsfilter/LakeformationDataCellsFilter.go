...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/lakeformation_data_cells_filter aws_lakeformation_data_cells_filter}.
type LakeformationDataCellsFilter interface {
	...
	PutTableData(value interface{})
	PutTimeouts(value *LakeformationDataCellsFilterTimeouts)
...
func (j *jsiiProxy_LakeformationDataCellsFilter) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_LakeformationDataCellsFilter) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_LakeformationDataCellsFilter) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_LakeformationDataCellsFilter) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_LakeformationDataCellsFilter) TableDataInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"tableDataInput",
...
func (j *jsiiProxy_LakeformationDataCellsFilter) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_LakeformationDataCellsFilter) Timeouts() LakeformationDataCellsFilterTimeoutsOutputReference {
	var returns LakeformationDataCellsFilterTimeoutsOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
func (j *jsiiProxy_LakeformationDataCellsFilter) TimeoutsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"timeoutsInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/lakeformation_data_cells_filter aws_lakeformation_data_cells_filter} Resource.
...
func (j *jsiiProxy_LakeformationDataCellsFilter)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_LakeformationDataCellsFilter)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_LakeformationDataCellsFilter)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func LakeformationDataCellsFilter_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (l *jsiiProxy_LakeformationDataCellsFilter) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LakeformationDataCellsFilter) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (l *jsiiProxy_LakeformationDataCellsFilter) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LakeformationDataCellsFilter) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (l *jsiiProxy_LakeformationDataCellsFilter) PutTableData(value interface{}) {
	if err := l.validatePutTableDataParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		l,
...
func (l *jsiiProxy_LakeformationDataCellsFilter) PutTimeouts(value *LakeformationDataCellsFilterTimeouts) {
...
func (l *jsiiProxy_LakeformationDataCellsFilter) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (l *jsiiProxy_LakeformationDataCellsFilter) ResetTableData() {
	_jsii_.InvokeVoid(
		l,
		"resetTableData",
		nil, // no parameters
...
func (l *jsiiProxy_LakeformationDataCellsFilter) ResetTimeouts() {
	_jsii_.InvokeVoid(
		l,
		"resetTimeouts",
		nil, // no parameters
...
func (l *jsiiProxy_LakeformationDataCellsFilter) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
