...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/defaultsubnet/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/default_subnet aws_default_subnet}.
...
func (j *jsiiProxy_DefaultSubnet) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DefaultSubnet) ExistingDefaultSubnet() cdktn.IResolvable {
...
func (j *jsiiProxy_DefaultSubnet) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DefaultSubnet) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DefaultSubnet) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DefaultSubnet) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/default_subnet aws_default_subnet} Resource.
...
func (j *jsiiProxy_DefaultSubnet)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DefaultSubnet)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DefaultSubnet)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DefaultSubnet_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DefaultSubnet) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DefaultSubnet) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (d *jsiiProxy_DefaultSubnet) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DefaultSubnet) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (d *jsiiProxy_DefaultSubnet) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DefaultSubnet) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
