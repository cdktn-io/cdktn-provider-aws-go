...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/accountprimarycontact/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/account_primary_contact aws_account_primary_contact}.
...
func (j *jsiiProxy_AccountPrimaryContact) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_AccountPrimaryContact) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_AccountPrimaryContact) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_AccountPrimaryContact) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_AccountPrimaryContact) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/account_primary_contact aws_account_primary_contact} Resource.
...
func (j *jsiiProxy_AccountPrimaryContact)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_AccountPrimaryContact)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_AccountPrimaryContact)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func AccountPrimaryContact_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (a *jsiiProxy_AccountPrimaryContact) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AccountPrimaryContact) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (a *jsiiProxy_AccountPrimaryContact) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AccountPrimaryContact) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (a *jsiiProxy_AccountPrimaryContact) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
