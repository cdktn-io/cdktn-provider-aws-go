...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/ecsaccountsettingdefault/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/ecs_account_setting_default aws_ecs_account_setting_default}.
...
func (j *jsiiProxy_EcsAccountSettingDefault) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_EcsAccountSettingDefault) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_EcsAccountSettingDefault) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_EcsAccountSettingDefault) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_EcsAccountSettingDefault) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/ecs_account_setting_default aws_ecs_account_setting_default} Resource.
func NewEcsAccountSettingDefault(scope constructs.Construct, id *string, config *EcsAccountSettingDefaultConfig) EcsAccountSettingDefault {
	...
	_jsii_.Create(
		"@cdktn/provider-aws.ecsAccountSettingDefault.EcsAccountSettingDefault",
...
func (j *jsiiProxy_EcsAccountSettingDefault)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_EcsAccountSettingDefault)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_EcsAccountSettingDefault)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func EcsAccountSettingDefault_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (e *jsiiProxy_EcsAccountSettingDefault) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (e *jsiiProxy_EcsAccountSettingDefault) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (e *jsiiProxy_EcsAccountSettingDefault) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (e *jsiiProxy_EcsAccountSettingDefault) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (e *jsiiProxy_EcsAccountSettingDefault) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
