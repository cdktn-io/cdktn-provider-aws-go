...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/transfer_server aws_transfer_server}.
...
func (j *jsiiProxy_TransferServer) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_TransferServer) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_TransferServer) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_TransferServer) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/transfer_server aws_transfer_server} Resource.
...
func (j *jsiiProxy_TransferServer)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_TransferServer)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_TransferServer)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func TransferServer_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (t *jsiiProxy_TransferServer) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (t *jsiiProxy_TransferServer) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (t *jsiiProxy_TransferServer) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (t *jsiiProxy_TransferServer) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (t *jsiiProxy_TransferServer) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (t *jsiiProxy_TransferServer) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
