...
func (j *jsiiProxy_TransferServerWorkflowDetailsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewTransferServerWorkflowDetailsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) TransferServerWorkflowDetailsOutputReference {
	_init_.Initialize()
...
func NewTransferServerWorkflowDetailsOutputReference_Override(t TransferServerWorkflowDetailsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_TransferServerWorkflowDetailsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (t *jsiiProxy_TransferServerWorkflowDetailsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (t *jsiiProxy_TransferServerWorkflowDetailsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (t *jsiiProxy_TransferServerWorkflowDetailsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (t *jsiiProxy_TransferServerWorkflowDetailsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
