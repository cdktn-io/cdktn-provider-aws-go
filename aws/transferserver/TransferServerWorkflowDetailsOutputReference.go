...
func (t *jsiiProxy_TransferServerWorkflowDetailsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (t *jsiiProxy_TransferServerWorkflowDetailsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
