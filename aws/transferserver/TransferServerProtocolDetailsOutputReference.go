...
func (t *jsiiProxy_TransferServerProtocolDetailsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (t *jsiiProxy_TransferServerProtocolDetailsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
