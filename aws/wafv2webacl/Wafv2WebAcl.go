...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/wafv2_web_acl aws_wafv2_web_acl}.
...
func (j *jsiiProxy_Wafv2WebAcl) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_Wafv2WebAcl) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_Wafv2WebAcl) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_Wafv2WebAcl) NamePrefix() *string {
	var returns *string
	_jsii_.Get(
		j,
		"namePrefix",
...
func (j *jsiiProxy_Wafv2WebAcl) NamePrefixInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"namePrefixInput",
...
func (j *jsiiProxy_Wafv2WebAcl) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_Wafv2WebAcl) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_Wafv2WebAcl) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_Wafv2WebAcl) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/wafv2_web_acl aws_wafv2_web_acl} Resource.
...
func (j *jsiiProxy_Wafv2WebAcl)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_Wafv2WebAcl)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_Wafv2WebAcl)SetNamePrefix(val *string) {
...
func (j *jsiiProxy_Wafv2WebAcl)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_Wafv2WebAcl)SetRegion(val *string) {
...
func Wafv2WebAcl_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (w *jsiiProxy_Wafv2WebAcl) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_Wafv2WebAcl) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (w *jsiiProxy_Wafv2WebAcl) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_Wafv2WebAcl) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (w *jsiiProxy_Wafv2WebAcl) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (w *jsiiProxy_Wafv2WebAcl) ResetName() {
	_jsii_.InvokeVoid(
		w,
		"resetName",
		nil, // no parameters
...
func (w *jsiiProxy_Wafv2WebAcl) ResetNamePrefix() {
	_jsii_.InvokeVoid(
		w,
		"resetNamePrefix",
		nil, // no parameters
...
func (w *jsiiProxy_Wafv2WebAcl) ResetRegion() {
	_jsii_.InvokeVoid(
		w,
		"resetRegion",
		nil, // no parameters
...
func (w *jsiiProxy_Wafv2WebAcl) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
