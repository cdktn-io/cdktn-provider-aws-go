...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/connectquickconnect/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/connect_quick_connect aws_connect_quick_connect}.
...
func (j *jsiiProxy_ConnectQuickConnect) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_ConnectQuickConnect) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_ConnectQuickConnect) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_ConnectQuickConnect) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_ConnectQuickConnect) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/connect_quick_connect aws_connect_quick_connect} Resource.
...
func (j *jsiiProxy_ConnectQuickConnect)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_ConnectQuickConnect)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_ConnectQuickConnect)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func ConnectQuickConnect_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateConnectQuickConnect_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (c *jsiiProxy_ConnectQuickConnect) AddMoveTarget(moveTarget *string) {
...
func (c *jsiiProxy_ConnectQuickConnect) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_ConnectQuickConnect) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (c *jsiiProxy_ConnectQuickConnect) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_ConnectQuickConnect) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_ConnectQuickConnect) MoveFromId(id *string) {
...
func (c *jsiiProxy_ConnectQuickConnect) MoveToId(id *string) {
...
func (c *jsiiProxy_ConnectQuickConnect) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
