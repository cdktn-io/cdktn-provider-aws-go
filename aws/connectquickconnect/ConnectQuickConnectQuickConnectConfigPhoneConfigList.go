...
func (c *jsiiProxy_ConnectQuickConnectQuickConnectConfigPhoneConfigList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (c *jsiiProxy_ConnectQuickConnectQuickConnectConfigPhoneConfigList) Resolve(context cdktf.IResolveContext) interface{} {
