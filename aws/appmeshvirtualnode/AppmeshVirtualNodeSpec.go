...
type AppmeshVirtualNodeSpec struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.32.1/docs/resources/appmesh_virtual_node#backend_defaults AppmeshVirtualNode#backend_defaults}
	...
	// logging block.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.32.1/docs/resources/appmesh_virtual_node#logging AppmeshVirtualNode#logging}
	Logging *AppmeshVirtualNodeSpecLogging `field:"optional" json:"logging" yaml:"logging"`
	// service_discovery block.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.32.1/docs/resources/appmesh_virtual_node#service_discovery AppmeshVirtualNode#service_discovery}
