...
func (a *jsiiProxy_AppmeshVirtualNodeSpecListenerTimeoutHttpOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_AppmeshVirtualNodeSpecListenerTimeoutHttpOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
