...
func (a *jsiiProxy_AppmeshVirtualNodeSpecListenerList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (a *jsiiProxy_AppmeshVirtualNodeSpecListenerList) validateGetParameters(index *float64) error {
	if index == nil {
...
func (j *jsiiProxy_AppmeshVirtualNodeSpecListenerList) validateSetInternalValueParameters(val interface{}) error {
	switch val.(type) {
	...
	case []*AppmeshVirtualNodeSpecListener:
		val_ := val.([]*AppmeshVirtualNodeSpecListener)
		val := &val_
		for idx_97dfc6, v := range *val {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
				return err
...
func (j *jsiiProxy_AppmeshVirtualNodeSpecListenerList) validateSetTerraformAttributeParameters(val *string) error {
	if val == nil {
...
func (j *jsiiProxy_AppmeshVirtualNodeSpecListenerList) validateSetWrapsSetParameters(val *bool) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
