...
type AppmeshVirtualNodeSpecListenerTimeout struct {
	// grpc block.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.32.1/docs/resources/appmesh_virtual_node#grpc AppmeshVirtualNode#grpc}
