...
type AppmeshVirtualNodeSpecBackendVirtualServiceClientPolicy struct {
	// tls block.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.39.0/docs/resources/appmesh_virtual_node#tls AppmeshVirtualNode#tls}
