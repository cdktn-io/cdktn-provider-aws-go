...
func (k *jsiiProxy_KinesisFirehoseDeliveryStreamOpensearchserverlessConfigurationProcessingConfigurationProcessorsParametersList) Resolve(context cdktf.IResolveContext) interface{} {
