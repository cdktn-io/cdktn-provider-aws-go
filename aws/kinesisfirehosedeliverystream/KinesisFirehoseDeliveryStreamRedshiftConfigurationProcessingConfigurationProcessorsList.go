...
func (j *jsiiProxy_KinesisFirehoseDeliveryStreamRedshiftConfigurationProcessingConfigurationProcessorsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewKinesisFirehoseDeliveryStreamRedshiftConfigurationProcessingConfigurationProcessorsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) KinesisFirehoseDeliveryStreamRedshiftConfigurationProcessingConfigurationProcessorsList {
	_init_.Initialize()
...
func NewKinesisFirehoseDeliveryStreamRedshiftConfigurationProcessingConfigurationProcessorsList_Override(k KinesisFirehoseDeliveryStreamRedshiftConfigurationProcessingConfigurationProcessorsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_KinesisFirehoseDeliveryStreamRedshiftConfigurationProcessingConfigurationProcessorsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (k *jsiiProxy_KinesisFirehoseDeliveryStreamRedshiftConfigurationProcessingConfigurationProcessorsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (k *jsiiProxy_KinesisFirehoseDeliveryStreamRedshiftConfigurationProcessingConfigurationProcessorsList) Resolve(context cdktn.IResolveContext) interface{} {
