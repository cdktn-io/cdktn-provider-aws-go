...
func (k *jsiiProxy_KinesisFirehoseDeliveryStreamIcebergConfigurationProcessingConfigurationProcessorsParametersList) Resolve(context cdktf.IResolveContext) interface{} {
