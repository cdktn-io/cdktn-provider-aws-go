...
func (l *jsiiProxy_LakeformationResourceLfTagsDatabaseOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LakeformationResourceLfTagsDatabaseOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
