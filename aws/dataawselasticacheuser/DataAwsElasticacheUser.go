...
func (j *jsiiProxy_DataAwsElasticacheUser) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsElasticacheUser) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsElasticacheUser) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsElasticacheUser) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsElasticacheUser) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DataAwsElasticacheUser)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsElasticacheUser)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsElasticacheUser)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsElasticacheUser_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsElasticacheUser) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsElasticacheUser) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsElasticacheUser) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsElasticacheUser) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
