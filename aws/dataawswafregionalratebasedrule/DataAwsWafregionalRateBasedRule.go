...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/dataawswafregionalratebasedrule/internal"
...
func (j *jsiiProxy_DataAwsWafregionalRateBasedRule) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsWafregionalRateBasedRule) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsWafregionalRateBasedRule) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsWafregionalRateBasedRule) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsWafregionalRateBasedRule) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DataAwsWafregionalRateBasedRule) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_DataAwsWafregionalRateBasedRule) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/data-sources/wafregional_rate_based_rule aws_wafregional_rate_based_rule} Data Source.
...
func (j *jsiiProxy_DataAwsWafregionalRateBasedRule)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsWafregionalRateBasedRule)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsWafregionalRateBasedRule)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_DataAwsWafregionalRateBasedRule)SetRegion(val *string) {
...
func DataAwsWafregionalRateBasedRule_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsWafregionalRateBasedRule) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsWafregionalRateBasedRule) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsWafregionalRateBasedRule) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsWafregionalRateBasedRule) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsWafregionalRateBasedRule) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
