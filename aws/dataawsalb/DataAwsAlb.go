...
func (j *jsiiProxy_DataAwsAlb) EnablePrefixForIpv6SourceNat() *string {
	var returns *string
	_jsii_.Get(
		j,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/data-sources/alb aws_alb} Data Source.
...
func (d *jsiiProxy_DataAwsAlb) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsAlb) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
