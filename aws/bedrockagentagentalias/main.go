...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "agentAliasId", GoGetter: "AgentAliasId"},
			_jsii_.MemberProperty{JsiiProperty: "agentAliasName", GoGetter: "AgentAliasName"},
			_jsii_.MemberProperty{JsiiProperty: "agentAliasNameInput", GoGetter: "AgentAliasNameInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetRoutingConfiguration", GoMethod: "ResetRoutingConfiguration"},
	...
	_jsii_.RegisterClass(
		...
		func() interface{} {
			j := jsiiProxy_BedrockagentAgentAliasRoutingConfigurationOutputReference{}
