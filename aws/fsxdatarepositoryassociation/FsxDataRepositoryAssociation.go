...
func (j *jsiiProxy_FsxDataRepositoryAssociation) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_FsxDataRepositoryAssociation) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/fsx_data_repository_association aws_fsx_data_repository_association} Resource.
...
func (j *jsiiProxy_FsxDataRepositoryAssociation)SetRegion(val *string) {
...
func (f *jsiiProxy_FsxDataRepositoryAssociation) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (f *jsiiProxy_FsxDataRepositoryAssociation) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (f *jsiiProxy_FsxDataRepositoryAssociation) ResetRegion() {
	_jsii_.InvokeVoid(
		f,
		"resetRegion",
		nil, // no parameters
...
func (f *jsiiProxy_FsxDataRepositoryAssociation) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
