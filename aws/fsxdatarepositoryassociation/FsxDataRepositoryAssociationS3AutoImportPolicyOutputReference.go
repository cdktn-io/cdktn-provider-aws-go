...
func (j *jsiiProxy_FsxDataRepositoryAssociationS3AutoImportPolicyOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewFsxDataRepositoryAssociationS3AutoImportPolicyOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) FsxDataRepositoryAssociationS3AutoImportPolicyOutputReference {
	_init_.Initialize()
...
func NewFsxDataRepositoryAssociationS3AutoImportPolicyOutputReference_Override(f FsxDataRepositoryAssociationS3AutoImportPolicyOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_FsxDataRepositoryAssociationS3AutoImportPolicyOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (f *jsiiProxy_FsxDataRepositoryAssociationS3AutoImportPolicyOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (f *jsiiProxy_FsxDataRepositoryAssociationS3AutoImportPolicyOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (f *jsiiProxy_FsxDataRepositoryAssociationS3AutoImportPolicyOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (f *jsiiProxy_FsxDataRepositoryAssociationS3AutoImportPolicyOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
