...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/fsxdatarepositoryassociation/internal"
...
func (j *jsiiProxy_FsxDataRepositoryAssociationS3AutoExportPolicyOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewFsxDataRepositoryAssociationS3AutoExportPolicyOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) FsxDataRepositoryAssociationS3AutoExportPolicyOutputReference {
	_init_.Initialize()

	if err := validateNewFsxDataRepositoryAssociationS3AutoExportPolicyOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewFsxDataRepositoryAssociationS3AutoExportPolicyOutputReference_Override(f FsxDataRepositoryAssociationS3AutoExportPolicyOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_FsxDataRepositoryAssociationS3AutoExportPolicyOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (f *jsiiProxy_FsxDataRepositoryAssociationS3AutoExportPolicyOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (f *jsiiProxy_FsxDataRepositoryAssociationS3AutoExportPolicyOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (f *jsiiProxy_FsxDataRepositoryAssociationS3AutoExportPolicyOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (f *jsiiProxy_FsxDataRepositoryAssociationS3AutoExportPolicyOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
