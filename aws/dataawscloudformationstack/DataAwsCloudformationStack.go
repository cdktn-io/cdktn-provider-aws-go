...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/dataawscloudformationstack/internal"
...
func (j *jsiiProxy_DataAwsCloudformationStack) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsCloudformationStack) DisableRollback() cdktn.IResolvable {
...
func (j *jsiiProxy_DataAwsCloudformationStack) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsCloudformationStack) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsCloudformationStack) Outputs() cdktn.StringMap {
...
func (j *jsiiProxy_DataAwsCloudformationStack) Parameters() cdktn.StringMap {
	var returns cdktn.StringMap
	_jsii_.Get(
		j,
		"parameters",
...
func (j *jsiiProxy_DataAwsCloudformationStack) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsCloudformationStack) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DataAwsCloudformationStack)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsCloudformationStack)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsCloudformationStack)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsCloudformationStack_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsCloudformationStack) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsCloudformationStack) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsCloudformationStack) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsCloudformationStack) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
