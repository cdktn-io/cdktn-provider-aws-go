...
func (v *jsiiProxy_VpclatticeResourceConfigurationResourceConfigurationDefinitionDnsResourceList) validateResolveParameters(context cdktn.IResolveContext) error {
	if context == nil {
...
func (j *jsiiProxy_VpclatticeResourceConfigurationResourceConfigurationDefinitionDnsResourceList) validateSetTerraformResourceParameters(val cdktn.IInterpolatingParent) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func validateNewVpclatticeResourceConfigurationResourceConfigurationDefinitionDnsResourceListParameters(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) error {
