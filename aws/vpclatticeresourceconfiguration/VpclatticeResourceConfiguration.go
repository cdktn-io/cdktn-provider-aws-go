...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.52.0/docs/resources/vpclattice_resource_configuration aws_vpclattice_resource_configuration}.
type VpclatticeResourceConfiguration interface {
	...
	SetResourceGatewayIdentifier(val *string)
...
func (j *jsiiProxy_VpclatticeResourceConfiguration) AllowAssociationToShareableServiceNetworkInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"allowAssociationToShareableServiceNetworkInput",
		&returns,
	)
	return returns
}
...
func (j *jsiiProxy_VpclatticeResourceConfiguration) Protocol() *string {
	var returns *string
	_jsii_.Get(
		j,
		"protocol",
...
func (j *jsiiProxy_VpclatticeResourceConfiguration) ProtocolInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"protocolInput",
...
func (j *jsiiProxy_VpclatticeResourceConfiguration) ResourceGatewayIdentifier() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_VpclatticeResourceConfiguration) ResourceGatewayIdentifierInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"resourceGatewayIdentifierInput",
		&returns,
	)
	return returns
}

func (j *jsiiProxy_VpclatticeResourceConfiguration) Tags() *map[string]*string {
...
func (j *jsiiProxy_VpclatticeResourceConfiguration) TagsInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsInput",
...
func (j *jsiiProxy_VpclatticeResourceConfiguration) Timeouts() VpclatticeResourceConfigurationTimeoutsOutputReference {
	var returns VpclatticeResourceConfigurationTimeoutsOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
func (j *jsiiProxy_VpclatticeResourceConfiguration) TimeoutsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"timeoutsInput",
...
func (j *jsiiProxy_VpclatticeResourceConfiguration) Type() *string {
	var returns *string
	_jsii_.Get(
		j,
		"type",
...
func (j *jsiiProxy_VpclatticeResourceConfiguration) TypeInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"typeInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.52.0/docs/resources/vpclattice_resource_configuration aws_vpclattice_resource_configuration} Resource.
...
func (j *jsiiProxy_VpclatticeResourceConfiguration)SetAllowAssociationToShareableServiceNetwork(val interface{}) {
	if err := j.validateSetAllowAssociationToShareableServiceNetworkParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_VpclatticeResourceConfiguration)SetProtocol(val *string) {
...
func (j *jsiiProxy_VpclatticeResourceConfiguration)SetResourceGatewayIdentifier(val *string) {
	if err := j.validateSetResourceGatewayIdentifierParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_VpclatticeResourceConfiguration)SetTags(val *map[string]*string) {
...
func (j *jsiiProxy_VpclatticeResourceConfiguration)SetType(val *string) {
...
func (v *jsiiProxy_VpclatticeResourceConfiguration) PutResourceConfigurationDefinition(value interface{}) {
...
func (v *jsiiProxy_VpclatticeResourceConfiguration) PutTimeouts(value *VpclatticeResourceConfigurationTimeouts) {
...
func (v *jsiiProxy_VpclatticeResourceConfiguration) ResetAllowAssociationToShareableServiceNetwork() {
	_jsii_.InvokeVoid(
		v,
		"resetAllowAssociationToShareableServiceNetwork",
		nil, // no parameters
...
func (v *jsiiProxy_VpclatticeResourceConfiguration) ResetProtocol() {
	_jsii_.InvokeVoid(
		v,
		"resetProtocol",
		nil, // no parameters
...
func (v *jsiiProxy_VpclatticeResourceConfiguration) ResetResourceGatewayIdentifier() {
	_jsii_.InvokeVoid(
		v,
		"resetResourceGatewayIdentifier",
		nil, // no parameters
...
func (v *jsiiProxy_VpclatticeResourceConfiguration) ResetTimeouts() {
	_jsii_.InvokeVoid(
		v,
		"resetTimeouts",
		nil, // no parameters
...
func (v *jsiiProxy_VpclatticeResourceConfiguration) ResetType() {
	_jsii_.InvokeVoid(
		v,
		"resetType",
		nil, // no parameters
