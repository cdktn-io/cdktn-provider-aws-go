...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/dataawsdbsnapshot/internal"
...
func (j *jsiiProxy_DataAwsDbSnapshot) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsDbSnapshot) Encrypted() cdktn.IResolvable {
...
func (j *jsiiProxy_DataAwsDbSnapshot) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsDbSnapshot) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsDbSnapshot) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsDbSnapshot) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/data-sources/db_snapshot aws_db_snapshot} Data Source.
...
func (j *jsiiProxy_DataAwsDbSnapshot)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsDbSnapshot)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsDbSnapshot)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsDbSnapshot_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsDbSnapshot) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsDbSnapshot) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsDbSnapshot) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsDbSnapshot) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
