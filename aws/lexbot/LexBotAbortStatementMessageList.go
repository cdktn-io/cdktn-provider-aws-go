...
func (j *jsiiProxy_LexBotAbortStatementMessageList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewLexBotAbortStatementMessageList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) LexBotAbortStatementMessageList {
	_init_.Initialize()
...
func NewLexBotAbortStatementMessageList_Override(l LexBotAbortStatementMessageList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_LexBotAbortStatementMessageList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (l *jsiiProxy_LexBotAbortStatementMessageList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (l *jsiiProxy_LexBotAbortStatementMessageList) Resolve(context cdktn.IResolveContext) interface{} {
