...
func (l *jsiiProxy_LexBotIntentOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LexBotIntentOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
