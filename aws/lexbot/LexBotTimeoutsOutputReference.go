...
func (l *jsiiProxy_LexBotTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LexBotTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
