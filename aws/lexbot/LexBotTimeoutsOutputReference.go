...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/lexbot/internal"
...
func (j *jsiiProxy_LexBotTimeoutsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewLexBotTimeoutsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) LexBotTimeoutsOutputReference {
	_init_.Initialize()
...
func NewLexBotTimeoutsOutputReference_Override(l LexBotTimeoutsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_LexBotTimeoutsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (l *jsiiProxy_LexBotTimeoutsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LexBotTimeoutsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (l *jsiiProxy_LexBotTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LexBotTimeoutsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
