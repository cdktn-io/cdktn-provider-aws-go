...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/lex_bot aws_lex_bot} Resource.
...
func (l *jsiiProxy_LexBot) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (l *jsiiProxy_LexBot) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (l *jsiiProxy_LexBot) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
