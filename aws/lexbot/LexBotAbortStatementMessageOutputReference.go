...
func (l *jsiiProxy_LexBotAbortStatementMessageOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LexBotAbortStatementMessageOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
