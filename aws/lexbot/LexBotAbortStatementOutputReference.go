...
func (l *jsiiProxy_LexBotAbortStatementOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LexBotAbortStatementOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
