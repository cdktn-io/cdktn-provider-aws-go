...
func (j *jsiiProxy_LexBotIntentList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewLexBotIntentList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) LexBotIntentList {
	_init_.Initialize()

	if err := validateNewLexBotIntentListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewLexBotIntentList_Override(l LexBotIntentList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_LexBotIntentList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (l *jsiiProxy_LexBotIntentList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (l *jsiiProxy_LexBotIntentList) Resolve(context cdktn.IResolveContext) interface{} {
