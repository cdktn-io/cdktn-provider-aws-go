...
func (l *jsiiProxy_LexBotIntentList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (l *jsiiProxy_LexBotIntentList) Resolve(context cdktf.IResolveContext) interface{} {
