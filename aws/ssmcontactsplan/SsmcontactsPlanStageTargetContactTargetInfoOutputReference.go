...
func (s *jsiiProxy_SsmcontactsPlanStageTargetContactTargetInfoOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_SsmcontactsPlanStageTargetContactTargetInfoOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
