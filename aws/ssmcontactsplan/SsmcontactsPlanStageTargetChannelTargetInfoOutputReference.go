...
func (s *jsiiProxy_SsmcontactsPlanStageTargetChannelTargetInfoOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_SsmcontactsPlanStageTargetChannelTargetInfoOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
