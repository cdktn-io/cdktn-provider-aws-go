...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v22/sesv2configurationseteventdestination/internal"
...
func (s *jsiiProxy_Sesv2ConfigurationSetEventDestinationEventDestinationEventBridgeDestinationOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_Sesv2ConfigurationSetEventDestinationEventDestinationEventBridgeDestinationOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
