...
func (c *jsiiProxy_CloudfrontMultitenantDistribution) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_CloudfrontMultitenantDistribution) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
