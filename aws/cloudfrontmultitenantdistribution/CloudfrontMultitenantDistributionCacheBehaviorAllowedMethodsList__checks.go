...
func (c *jsiiProxy_CloudfrontMultitenantDistributionCacheBehaviorAllowedMethodsList) validateResolveParameters(context cdktn.IResolveContext) error {
	if context == nil {
...
func (j *jsiiProxy_CloudfrontMultitenantDistributionCacheBehaviorAllowedMethodsList) validateSetTerraformResourceParameters(val cdktn.IInterpolatingParent) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func validateNewCloudfrontMultitenantDistributionCacheBehaviorAllowedMethodsListParameters(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) error {
