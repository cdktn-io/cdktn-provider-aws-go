...
type CloudfrontMultitenantDistributionOriginCustomOriginConfigOutputReference interface {
	...
	OriginMtlsConfig() CloudfrontMultitenantDistributionOriginCustomOriginConfigOriginMtlsConfigList
...
func (j *jsiiProxy_CloudfrontMultitenantDistributionOriginCustomOriginConfigOutputReference) OriginMtlsConfig() CloudfrontMultitenantDistributionOriginCustomOriginConfigOriginMtlsConfigList {
	var returns CloudfrontMultitenantDistributionOriginCustomOriginConfigOriginMtlsConfigList
	_jsii_.Get(
		j,
		"originMtlsConfig",
		&returns,
...
func (j *jsiiProxy_CloudfrontMultitenantDistributionOriginCustomOriginConfigOutputReference) OriginMtlsConfigInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CloudfrontMultitenantDistributionOriginCustomOriginConfigOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewCloudfrontMultitenantDistributionOriginCustomOriginConfigOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) CloudfrontMultitenantDistributionOriginCustomOriginConfigOutputReference {
	_init_.Initialize()
...
func NewCloudfrontMultitenantDistributionOriginCustomOriginConfigOutputReference_Override(c CloudfrontMultitenantDistributionOriginCustomOriginConfigOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_CloudfrontMultitenantDistributionOriginCustomOriginConfigOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_CloudfrontMultitenantDistributionOriginCustomOriginConfigOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CloudfrontMultitenantDistributionOriginCustomOriginConfigOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (c *jsiiProxy_CloudfrontMultitenantDistributionOriginCustomOriginConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CloudfrontMultitenantDistributionOriginCustomOriginConfigOutputReference) PutOriginMtlsConfig(value interface{}) {
...
func (c *jsiiProxy_CloudfrontMultitenantDistributionOriginCustomOriginConfigOutputReference) ResetOriginMtlsConfig() {
	_jsii_.InvokeVoid(
		c,
		"resetOriginMtlsConfig",
		nil, // no parameters
...
func (c *jsiiProxy_CloudfrontMultitenantDistributionOriginCustomOriginConfigOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
