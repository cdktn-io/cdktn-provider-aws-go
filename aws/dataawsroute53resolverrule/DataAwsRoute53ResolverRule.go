...
type DataAwsRoute53ResolverRule interface {
	...
	TargetIps() DataAwsRoute53ResolverRuleTargetIpsList
	// Experimental.
...
func (j *jsiiProxy_DataAwsRoute53ResolverRule) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsRoute53ResolverRule) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsRoute53ResolverRule) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsRoute53ResolverRule) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsRoute53ResolverRule) TargetIps() DataAwsRoute53ResolverRuleTargetIpsList {
	var returns DataAwsRoute53ResolverRuleTargetIpsList
	_jsii_.Get(
		j,
		"targetIps",
		&returns,
...
func (j *jsiiProxy_DataAwsRoute53ResolverRule) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.50.0/docs/data-sources/route53_resolver_rule aws_route53_resolver_rule} Data Source.
func NewDataAwsRoute53ResolverRule(scope constructs.Construct, id *string, config *DataAwsRoute53ResolverRuleConfig) DataAwsRoute53ResolverRule {
	...
	_jsii_.Create(
		"@cdktn/provider-aws.dataAwsRoute53ResolverRule.DataAwsRoute53ResolverRule",
...
func (j *jsiiProxy_DataAwsRoute53ResolverRule)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsRoute53ResolverRule)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsRoute53ResolverRule)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsRoute53ResolverRule_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsRoute53ResolverRule) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsRoute53ResolverRule) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
