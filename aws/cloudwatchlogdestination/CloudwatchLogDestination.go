...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/cloudwatchlogdestination/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/cloudwatch_log_destination aws_cloudwatch_log_destination}.
...
func (j *jsiiProxy_CloudwatchLogDestination) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_CloudwatchLogDestination) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_CloudwatchLogDestination) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_CloudwatchLogDestination) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_CloudwatchLogDestination) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_CloudwatchLogDestination) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_CloudwatchLogDestination) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_CloudwatchLogDestination) Tags() *map[string]*string {
...
func (j *jsiiProxy_CloudwatchLogDestination) TagsAll() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsAll",
...
func (j *jsiiProxy_CloudwatchLogDestination) TagsAllInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsAllInput",
...
func (j *jsiiProxy_CloudwatchLogDestination) TagsInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsInput",
...
func (j *jsiiProxy_CloudwatchLogDestination) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/cloudwatch_log_destination aws_cloudwatch_log_destination} Resource.
func NewCloudwatchLogDestination(scope constructs.Construct, id *string, config *CloudwatchLogDestinationConfig) CloudwatchLogDestination {
	...
	if err := validateNewCloudwatchLogDestinationParameters(scope, id, config); err != nil {
		panic(err)
	}
	j := jsiiProxy_CloudwatchLogDestination{}

	_jsii_.Create(
		"@cdktn/provider-aws.cloudwatchLogDestination.CloudwatchLogDestination",
...
func (j *jsiiProxy_CloudwatchLogDestination)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_CloudwatchLogDestination)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_CloudwatchLogDestination)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_CloudwatchLogDestination)SetRegion(val *string) {
...
// Generates CDKTN code for importing a CloudwatchLogDestination resource upon running "cdktn plan <stack-name>".
func CloudwatchLogDestination_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateCloudwatchLogDestination_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (c *jsiiProxy_CloudwatchLogDestination) AddMoveTarget(moveTarget *string) {
...
func (c *jsiiProxy_CloudwatchLogDestination) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CloudwatchLogDestination) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (c *jsiiProxy_CloudwatchLogDestination) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CloudwatchLogDestination) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_CloudwatchLogDestination) MoveFromId(id *string) {
...
func (c *jsiiProxy_CloudwatchLogDestination) MoveToId(id *string) {
...
func (c *jsiiProxy_CloudwatchLogDestination) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (c *jsiiProxy_CloudwatchLogDestination) ResetId() {
	_jsii_.InvokeVoid(
		c,
		"resetId",
		nil, // no parameters
...
func (c *jsiiProxy_CloudwatchLogDestination) ResetRegion() {
	_jsii_.InvokeVoid(
		c,
		"resetRegion",
		nil, // no parameters
...
func (c *jsiiProxy_CloudwatchLogDestination) ResetTags() {
	_jsii_.InvokeVoid(
		c,
		"resetTags",
		nil, // no parameters
...
func (c *jsiiProxy_CloudwatchLogDestination) ResetTagsAll() {
	_jsii_.InvokeVoid(
		c,
		"resetTagsAll",
		nil, // no parameters
...
func (c *jsiiProxy_CloudwatchLogDestination) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
