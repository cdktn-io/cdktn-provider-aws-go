...
func (j *jsiiProxy_BatchSchedulingPolicyFairSharePolicyShareDistributionList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewBatchSchedulingPolicyFairSharePolicyShareDistributionList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) BatchSchedulingPolicyFairSharePolicyShareDistributionList {
	_init_.Initialize()

	if err := validateNewBatchSchedulingPolicyFairSharePolicyShareDistributionListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewBatchSchedulingPolicyFairSharePolicyShareDistributionList_Override(b BatchSchedulingPolicyFairSharePolicyShareDistributionList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_BatchSchedulingPolicyFairSharePolicyShareDistributionList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (b *jsiiProxy_BatchSchedulingPolicyFairSharePolicyShareDistributionList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (b *jsiiProxy_BatchSchedulingPolicyFairSharePolicyShareDistributionList) Resolve(context cdktn.IResolveContext) interface{} {
