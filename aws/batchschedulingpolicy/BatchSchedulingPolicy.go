...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/batchschedulingpolicy/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/batch_scheduling_policy aws_batch_scheduling_policy}.
...
func (j *jsiiProxy_BatchSchedulingPolicy) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_BatchSchedulingPolicy) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_BatchSchedulingPolicy) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_BatchSchedulingPolicy) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_BatchSchedulingPolicy) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_BatchSchedulingPolicy) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/batch_scheduling_policy aws_batch_scheduling_policy} Resource.
func NewBatchSchedulingPolicy(scope constructs.Construct, id *string, config *BatchSchedulingPolicyConfig) BatchSchedulingPolicy {
	...
	if err := validateNewBatchSchedulingPolicyParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_BatchSchedulingPolicy)SetCount(val interface{}) {
...
func (j *jsiiProxy_BatchSchedulingPolicy)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_BatchSchedulingPolicy)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_BatchSchedulingPolicy)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func BatchSchedulingPolicy_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateBatchSchedulingPolicy_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func BatchSchedulingPolicy_IsConstruct(x interface{}) *bool {
	...
	if err := validateBatchSchedulingPolicy_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (b *jsiiProxy_BatchSchedulingPolicy) AddMoveTarget(moveTarget *string) {
...
func (b *jsiiProxy_BatchSchedulingPolicy) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (b *jsiiProxy_BatchSchedulingPolicy) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (b *jsiiProxy_BatchSchedulingPolicy) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (b *jsiiProxy_BatchSchedulingPolicy) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (b *jsiiProxy_BatchSchedulingPolicy) PutFairSharePolicy(value *BatchSchedulingPolicyFairSharePolicy) {
	if err := b.validatePutFairSharePolicyParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		b,
...
func (b *jsiiProxy_BatchSchedulingPolicy) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (b *jsiiProxy_BatchSchedulingPolicy) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (b *jsiiProxy_BatchSchedulingPolicy) ToHclTerraform() interface{} {
	var returns interface{}
...
func (b *jsiiProxy_BatchSchedulingPolicy) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
