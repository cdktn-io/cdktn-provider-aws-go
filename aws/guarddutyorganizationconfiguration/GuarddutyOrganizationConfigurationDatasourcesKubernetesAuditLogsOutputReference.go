...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/guarddutyorganizationconfiguration/internal"
...
func (j *jsiiProxy_GuarddutyOrganizationConfigurationDatasourcesKubernetesAuditLogsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewGuarddutyOrganizationConfigurationDatasourcesKubernetesAuditLogsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) GuarddutyOrganizationConfigurationDatasourcesKubernetesAuditLogsOutputReference {
	_init_.Initialize()

	if err := validateNewGuarddutyOrganizationConfigurationDatasourcesKubernetesAuditLogsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewGuarddutyOrganizationConfigurationDatasourcesKubernetesAuditLogsOutputReference_Override(g GuarddutyOrganizationConfigurationDatasourcesKubernetesAuditLogsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_GuarddutyOrganizationConfigurationDatasourcesKubernetesAuditLogsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (g *jsiiProxy_GuarddutyOrganizationConfigurationDatasourcesKubernetesAuditLogsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GuarddutyOrganizationConfigurationDatasourcesKubernetesAuditLogsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (g *jsiiProxy_GuarddutyOrganizationConfigurationDatasourcesKubernetesAuditLogsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GuarddutyOrganizationConfigurationDatasourcesKubernetesAuditLogsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
