...
func (j *jsiiProxy_GuarddutyOrganizationConfigurationDatasourcesS3LogsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewGuarddutyOrganizationConfigurationDatasourcesS3LogsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) GuarddutyOrganizationConfigurationDatasourcesS3LogsOutputReference {
	_init_.Initialize()

	if err := validateNewGuarddutyOrganizationConfigurationDatasourcesS3LogsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewGuarddutyOrganizationConfigurationDatasourcesS3LogsOutputReference_Override(g GuarddutyOrganizationConfigurationDatasourcesS3LogsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_GuarddutyOrganizationConfigurationDatasourcesS3LogsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (g *jsiiProxy_GuarddutyOrganizationConfigurationDatasourcesS3LogsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GuarddutyOrganizationConfigurationDatasourcesS3LogsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (g *jsiiProxy_GuarddutyOrganizationConfigurationDatasourcesS3LogsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GuarddutyOrganizationConfigurationDatasourcesS3LogsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
