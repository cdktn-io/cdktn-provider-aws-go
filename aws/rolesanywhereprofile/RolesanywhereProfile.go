...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/rolesanywhereprofile/internal"
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/rolesanywhere_profile aws_rolesanywhere_profile} Resource.
...
func (r *jsiiProxy_RolesanywhereProfile) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (r *jsiiProxy_RolesanywhereProfile) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (r *jsiiProxy_RolesanywhereProfile) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
