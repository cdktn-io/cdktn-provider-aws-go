...
func (j *jsiiProxy_IotDomainConfiguration) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_IotDomainConfiguration) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.50.0/docs/resources/iot_domain_configuration aws_iot_domain_configuration} Resource.
...
func (j *jsiiProxy_IotDomainConfiguration)SetRegion(val *string) {
...
func (i *jsiiProxy_IotDomainConfiguration) ResetRegion() {
	_jsii_.InvokeVoid(
		i,
		"resetRegion",
		nil, // no parameters
