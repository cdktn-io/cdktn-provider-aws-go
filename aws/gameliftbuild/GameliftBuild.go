...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v22/gameliftbuild/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.31.0/docs/resources/gamelift_build aws_gamelift_build}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.31.0/docs/resources/gamelift_build aws_gamelift_build} Resource.
...
func GameliftBuild_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
