...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/gameliftbuild/internal"
...
func (j *jsiiProxy_GameliftBuild) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_GameliftBuild) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_GameliftBuild) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_GameliftBuild) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_GameliftBuild) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/gamelift_build aws_gamelift_build} Resource.
func NewGameliftBuild(scope constructs.Construct, id *string, config *GameliftBuildConfig) GameliftBuild {
	...
	_jsii_.Create(
		"@cdktn/provider-aws.gameliftBuild.GameliftBuild",
...
func (j *jsiiProxy_GameliftBuild)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_GameliftBuild)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_GameliftBuild)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func GameliftBuild_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateGameliftBuild_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
// Experimental.
func GameliftBuild_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateGameliftBuild_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func GameliftBuild_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateGameliftBuild_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (g *jsiiProxy_GameliftBuild) AddMoveTarget(moveTarget *string) {
...
func (g *jsiiProxy_GameliftBuild) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GameliftBuild) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (g *jsiiProxy_GameliftBuild) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GameliftBuild) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GameliftBuild) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (g *jsiiProxy_GameliftBuild) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
