...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v21/sagemakerapp/internal"
...
func (s *jsiiProxy_SagemakerAppResourceSpecOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_SagemakerAppResourceSpecOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
