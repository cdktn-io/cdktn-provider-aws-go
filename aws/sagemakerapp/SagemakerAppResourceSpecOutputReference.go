...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v23/sagemakerapp/internal"
...
func (j *jsiiProxy_SagemakerAppResourceSpecOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewSagemakerAppResourceSpecOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) SagemakerAppResourceSpecOutputReference {
	_init_.Initialize()
...
func NewSagemakerAppResourceSpecOutputReference_Override(s SagemakerAppResourceSpecOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_SagemakerAppResourceSpecOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_SagemakerAppResourceSpecOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SagemakerAppResourceSpecOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (s *jsiiProxy_SagemakerAppResourceSpecOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SagemakerAppResourceSpecOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
