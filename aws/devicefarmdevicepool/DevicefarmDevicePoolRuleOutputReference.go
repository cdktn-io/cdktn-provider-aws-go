...
func (d *jsiiProxy_DevicefarmDevicePoolRuleOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DevicefarmDevicePoolRuleOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
