...
func (j *jsiiProxy_DevicefarmDevicePoolRuleList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDevicefarmDevicePoolRuleList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DevicefarmDevicePoolRuleList {
	_init_.Initialize()

	if err := validateNewDevicefarmDevicePoolRuleListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewDevicefarmDevicePoolRuleList_Override(d DevicefarmDevicePoolRuleList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DevicefarmDevicePoolRuleList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DevicefarmDevicePoolRuleList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DevicefarmDevicePoolRuleList) Resolve(context cdktn.IResolveContext) interface{} {
