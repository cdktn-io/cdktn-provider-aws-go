...
func (j *jsiiProxy_DevicefarmDevicePool) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DevicefarmDevicePool) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DevicefarmDevicePool) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DevicefarmDevicePool) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DevicefarmDevicePool) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/devicefarm_device_pool aws_devicefarm_device_pool} Resource.
...
func (j *jsiiProxy_DevicefarmDevicePool)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DevicefarmDevicePool)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DevicefarmDevicePool)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DevicefarmDevicePool_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DevicefarmDevicePool) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DevicefarmDevicePool) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (d *jsiiProxy_DevicefarmDevicePool) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DevicefarmDevicePool) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (d *jsiiProxy_DevicefarmDevicePool) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DevicefarmDevicePool) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
