...
func (j *jsiiProxy_Route53DomainsDomainNameServerList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewRoute53DomainsDomainNameServerList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) Route53DomainsDomainNameServerList {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-aws.route53DomainsDomain.Route53DomainsDomainNameServerList",
...
func NewRoute53DomainsDomainNameServerList_Override(r Route53DomainsDomainNameServerList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_Route53DomainsDomainNameServerList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (r *jsiiProxy_Route53DomainsDomainNameServerList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (r *jsiiProxy_Route53DomainsDomainNameServerList) Resolve(context cdktn.IResolveContext) interface{} {
