...
func (j *jsiiProxy_Route53DomainsDomainTechContactList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewRoute53DomainsDomainTechContactList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) Route53DomainsDomainTechContactList {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-aws.route53DomainsDomain.Route53DomainsDomainTechContactList",
...
func NewRoute53DomainsDomainTechContactList_Override(r Route53DomainsDomainTechContactList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_Route53DomainsDomainTechContactList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (r *jsiiProxy_Route53DomainsDomainTechContactList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (r *jsiiProxy_Route53DomainsDomainTechContactList) Resolve(context cdktn.IResolveContext) interface{} {
