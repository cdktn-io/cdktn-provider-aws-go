...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/apigatewayv2routeresponse/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/apigatewayv2_route_response aws_apigatewayv2_route_response}.
...
func (j *jsiiProxy_Apigatewayv2RouteResponse) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_Apigatewayv2RouteResponse) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_Apigatewayv2RouteResponse) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_Apigatewayv2RouteResponse) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_Apigatewayv2RouteResponse) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_Apigatewayv2RouteResponse) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_Apigatewayv2RouteResponse) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/apigatewayv2_route_response aws_apigatewayv2_route_response} Resource.
...
func (j *jsiiProxy_Apigatewayv2RouteResponse)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_Apigatewayv2RouteResponse)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_Apigatewayv2RouteResponse)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_Apigatewayv2RouteResponse)SetRegion(val *string) {
...
func Apigatewayv2RouteResponse_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateApigatewayv2RouteResponse_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
// Experimental.
func Apigatewayv2RouteResponse_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateApigatewayv2RouteResponse_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func Apigatewayv2RouteResponse_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateApigatewayv2RouteResponse_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (a *jsiiProxy_Apigatewayv2RouteResponse) AddMoveTarget(moveTarget *string) {
...
func (a *jsiiProxy_Apigatewayv2RouteResponse) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_Apigatewayv2RouteResponse) HasResourceMove() interface{} {
	var returns interface{}
...
func (a *jsiiProxy_Apigatewayv2RouteResponse) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (a *jsiiProxy_Apigatewayv2RouteResponse) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_Apigatewayv2RouteResponse) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (a *jsiiProxy_Apigatewayv2RouteResponse) MoveFromId(id *string) {
...
func (a *jsiiProxy_Apigatewayv2RouteResponse) MoveTo(moveTarget *string, index interface{}) {
...
func (a *jsiiProxy_Apigatewayv2RouteResponse) MoveToId(id *string) {
...
func (a *jsiiProxy_Apigatewayv2RouteResponse) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (a *jsiiProxy_Apigatewayv2RouteResponse) ResetRegion() {
	_jsii_.InvokeVoid(
		a,
		"resetRegion",
		nil, // no parameters
...
func (a *jsiiProxy_Apigatewayv2RouteResponse) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (a *jsiiProxy_Apigatewayv2RouteResponse) ToHclTerraform() interface{} {
	var returns interface{}
...
func (a *jsiiProxy_Apigatewayv2RouteResponse) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
