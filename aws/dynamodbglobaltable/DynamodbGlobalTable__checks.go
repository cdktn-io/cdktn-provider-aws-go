...
func (d *jsiiProxy_DynamodbGlobalTable) validateMarkWriteOnlyAttributeParameters(value interface{}) error {
	if value == nil {
		return fmt.Errorf("parameter value is required, but nil was provided")
	}
...
func (d *jsiiProxy_DynamodbGlobalTable) validatePutReplicaParameters(value interface{}) error {
	if value == nil {
		return fmt.Errorf("parameter value is required, but nil was provided")
	}
	switch value.(type) {
	...
	case *[]*DynamodbGlobalTableReplica:
		value := value.(*[]*DynamodbGlobalTableReplica)
	...
	case []*DynamodbGlobalTableReplica:
		value_ := value.([]*DynamodbGlobalTableReplica)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*DynamodbGlobalTableReplica; received %#v (a %T)", value, value)
		}
	}
...
func (d *jsiiProxy_DynamodbGlobalTable) validatePutTimeoutsParameters(value *DynamodbGlobalTableTimeouts) error {
	if value == nil {
		return fmt.Errorf("parameter value is required, but nil was provided")
	}
...
func (d *jsiiProxy_DynamodbGlobalTable) validateRegisterProviderFeatureUsageParameters(feature cdktn.ProviderFeature) error {
	if feature == "" {
...
func (j *jsiiProxy_DynamodbGlobalTable) validateSetIdParameters(val *string) error {
	if val == nil {
...
func (j *jsiiProxy_DynamodbGlobalTable) validateSetLifecycleParameters(val *cdktn.TerraformResourceLifecycle) error {
	if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
		return err
	}
...
func (j *jsiiProxy_DynamodbGlobalTable) validateSetNameParameters(val *string) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
