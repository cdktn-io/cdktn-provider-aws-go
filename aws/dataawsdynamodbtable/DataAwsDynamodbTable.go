...
func (j *jsiiProxy_DataAwsDynamodbTable) OnDemandThroughput() DataAwsDynamodbTableOnDemandThroughputList {
	var returns DataAwsDynamodbTableOnDemandThroughputList
	_jsii_.Get(
		j,
		"onDemandThroughput",
		&returns,
...
func (j *jsiiProxy_DataAwsDynamodbTable) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DataAwsDynamodbTable) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/data-sources/dynamodb_table aws_dynamodb_table} Data Source.
...
func (j *jsiiProxy_DataAwsDynamodbTable)SetRegion(val *string) {
...
func (d *jsiiProxy_DataAwsDynamodbTable) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsDynamodbTable) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsDynamodbTable) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
