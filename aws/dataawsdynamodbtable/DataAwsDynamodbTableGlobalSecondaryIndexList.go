...
func (j *jsiiProxy_DataAwsDynamodbTableGlobalSecondaryIndexList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsDynamodbTableGlobalSecondaryIndexList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsDynamodbTableGlobalSecondaryIndexList {
	_init_.Initialize()
...
func NewDataAwsDynamodbTableGlobalSecondaryIndexList_Override(d DataAwsDynamodbTableGlobalSecondaryIndexList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsDynamodbTableGlobalSecondaryIndexList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsDynamodbTableGlobalSecondaryIndexList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsDynamodbTableGlobalSecondaryIndexList) Resolve(context cdktn.IResolveContext) interface{} {
