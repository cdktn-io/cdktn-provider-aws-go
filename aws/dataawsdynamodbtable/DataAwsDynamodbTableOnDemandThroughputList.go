...
func (j *jsiiProxy_DataAwsDynamodbTableOnDemandThroughputList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewDataAwsDynamodbTableOnDemandThroughputList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsDynamodbTableOnDemandThroughputList {
	_init_.Initialize()
...
func NewDataAwsDynamodbTableOnDemandThroughputList_Override(d DataAwsDynamodbTableOnDemandThroughputList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsDynamodbTableOnDemandThroughputList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsDynamodbTableOnDemandThroughputList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsDynamodbTableOnDemandThroughputList) Resolve(context cdktf.IResolveContext) interface{} {
