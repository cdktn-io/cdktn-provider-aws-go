...
func (j *jsiiProxy_ChimeVoiceConnectorOrigination) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_ChimeVoiceConnectorOrigination) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_ChimeVoiceConnectorOrigination) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_ChimeVoiceConnectorOrigination) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_ChimeVoiceConnectorOrigination) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_ChimeVoiceConnectorOrigination)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_ChimeVoiceConnectorOrigination)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_ChimeVoiceConnectorOrigination)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func ChimeVoiceConnectorOrigination_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (c *jsiiProxy_ChimeVoiceConnectorOrigination) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_ChimeVoiceConnectorOrigination) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (c *jsiiProxy_ChimeVoiceConnectorOrigination) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_ChimeVoiceConnectorOrigination) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_ChimeVoiceConnectorOrigination) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (c *jsiiProxy_ChimeVoiceConnectorOrigination) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
