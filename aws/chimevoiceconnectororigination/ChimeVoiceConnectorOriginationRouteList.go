...
func (c *jsiiProxy_ChimeVoiceConnectorOriginationRouteList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (c *jsiiProxy_ChimeVoiceConnectorOriginationRouteList) Resolve(context cdktf.IResolveContext) interface{} {
