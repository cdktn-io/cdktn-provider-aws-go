...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/chimevoiceconnectororigination/internal"
...
func (j *jsiiProxy_ChimeVoiceConnectorOriginationRouteList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewChimeVoiceConnectorOriginationRouteList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ChimeVoiceConnectorOriginationRouteList {
	_init_.Initialize()

	if err := validateNewChimeVoiceConnectorOriginationRouteListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
	j := jsiiProxy_ChimeVoiceConnectorOriginationRouteList{}

	_jsii_.Create(
		"@cdktn/provider-aws.chimeVoiceConnectorOrigination.ChimeVoiceConnectorOriginationRouteList",
...
func NewChimeVoiceConnectorOriginationRouteList_Override(c ChimeVoiceConnectorOriginationRouteList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ChimeVoiceConnectorOriginationRouteList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_ChimeVoiceConnectorOriginationRouteList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (c *jsiiProxy_ChimeVoiceConnectorOriginationRouteList) Resolve(context cdktn.IResolveContext) interface{} {
