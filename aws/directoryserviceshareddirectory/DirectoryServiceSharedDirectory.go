...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/directory_service_shared_directory aws_directory_service_shared_directory}.
...
func (j *jsiiProxy_DirectoryServiceSharedDirectory) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DirectoryServiceSharedDirectory) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DirectoryServiceSharedDirectory) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DirectoryServiceSharedDirectory) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DirectoryServiceSharedDirectory) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/directory_service_shared_directory aws_directory_service_shared_directory} Resource.
...
func (j *jsiiProxy_DirectoryServiceSharedDirectory)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DirectoryServiceSharedDirectory)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DirectoryServiceSharedDirectory)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DirectoryServiceSharedDirectory_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DirectoryServiceSharedDirectory) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DirectoryServiceSharedDirectory) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (d *jsiiProxy_DirectoryServiceSharedDirectory) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DirectoryServiceSharedDirectory) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (d *jsiiProxy_DirectoryServiceSharedDirectory) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DirectoryServiceSharedDirectory) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
