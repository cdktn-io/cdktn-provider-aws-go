...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v22/directoryserviceshareddirectory/internal"
...
func (d *jsiiProxy_DirectoryServiceSharedDirectoryTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DirectoryServiceSharedDirectoryTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
