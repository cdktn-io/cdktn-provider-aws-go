...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/ec2transitgatewayroutetable/internal"
...
func (j *jsiiProxy_Ec2TransitGatewayRouteTable) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_Ec2TransitGatewayRouteTable) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/ec2_transit_gateway_route_table aws_ec2_transit_gateway_route_table} Resource.
...
func (j *jsiiProxy_Ec2TransitGatewayRouteTable)SetRegion(val *string) {
...
func (e *jsiiProxy_Ec2TransitGatewayRouteTable) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (e *jsiiProxy_Ec2TransitGatewayRouteTable) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (e *jsiiProxy_Ec2TransitGatewayRouteTable) ResetRegion() {
	_jsii_.InvokeVoid(
		e,
		"resetRegion",
		nil, // no parameters
...
func (e *jsiiProxy_Ec2TransitGatewayRouteTable) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
