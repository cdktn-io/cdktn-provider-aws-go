...
func (j *jsiiProxy_SsmMaintenanceWindowTargetTargetsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewSsmMaintenanceWindowTargetTargetsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) SsmMaintenanceWindowTargetTargetsOutputReference {
	_init_.Initialize()
...
func NewSsmMaintenanceWindowTargetTargetsOutputReference_Override(s SsmMaintenanceWindowTargetTargetsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_SsmMaintenanceWindowTargetTargetsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_SsmMaintenanceWindowTargetTargetsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SsmMaintenanceWindowTargetTargetsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (s *jsiiProxy_SsmMaintenanceWindowTargetTargetsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SsmMaintenanceWindowTargetTargetsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
