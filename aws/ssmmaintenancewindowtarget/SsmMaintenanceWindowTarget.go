...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/ssmmaintenancewindowtarget/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/ssm_maintenance_window_target aws_ssm_maintenance_window_target}.
...
func (j *jsiiProxy_SsmMaintenanceWindowTarget) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_SsmMaintenanceWindowTarget) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_SsmMaintenanceWindowTarget) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_SsmMaintenanceWindowTarget) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_SsmMaintenanceWindowTarget) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/ssm_maintenance_window_target aws_ssm_maintenance_window_target} Resource.
...
func (j *jsiiProxy_SsmMaintenanceWindowTarget)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_SsmMaintenanceWindowTarget)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_SsmMaintenanceWindowTarget)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func SsmMaintenanceWindowTarget_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateSsmMaintenanceWindowTarget_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_SsmMaintenanceWindowTarget) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_SsmMaintenanceWindowTarget) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SsmMaintenanceWindowTarget) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_SsmMaintenanceWindowTarget) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SsmMaintenanceWindowTarget) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_SsmMaintenanceWindowTarget) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_SsmMaintenanceWindowTarget) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
