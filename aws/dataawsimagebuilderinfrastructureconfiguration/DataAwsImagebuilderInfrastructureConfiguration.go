...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/data-sources/imagebuilder_infrastructure_configuration aws_imagebuilder_infrastructure_configuration}.
...
func (j *jsiiProxy_DataAwsImagebuilderInfrastructureConfiguration) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DataAwsImagebuilderInfrastructureConfiguration) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/data-sources/imagebuilder_infrastructure_configuration aws_imagebuilder_infrastructure_configuration} Data Source.
...
func (j *jsiiProxy_DataAwsImagebuilderInfrastructureConfiguration)SetRegion(val *string) {
...
func (d *jsiiProxy_DataAwsImagebuilderInfrastructureConfiguration) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsImagebuilderInfrastructureConfiguration) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsImagebuilderInfrastructureConfiguration) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
