...
func (d *jsiiProxy_DataAwsImagebuilderInfrastructureConfigurationLoggingList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsImagebuilderInfrastructureConfigurationLoggingList) Resolve(context cdktf.IResolveContext) interface{} {
