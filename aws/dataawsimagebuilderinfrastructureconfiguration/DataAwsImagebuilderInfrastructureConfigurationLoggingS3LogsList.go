...
func (j *jsiiProxy_DataAwsImagebuilderInfrastructureConfigurationLoggingS3LogsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsImagebuilderInfrastructureConfigurationLoggingS3LogsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsImagebuilderInfrastructureConfigurationLoggingS3LogsList {
	_init_.Initialize()
...
func NewDataAwsImagebuilderInfrastructureConfigurationLoggingS3LogsList_Override(d DataAwsImagebuilderInfrastructureConfigurationLoggingS3LogsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsImagebuilderInfrastructureConfigurationLoggingS3LogsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsImagebuilderInfrastructureConfigurationLoggingS3LogsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsImagebuilderInfrastructureConfigurationLoggingS3LogsList) Resolve(context cdktn.IResolveContext) interface{} {
