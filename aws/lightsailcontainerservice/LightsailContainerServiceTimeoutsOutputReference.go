...
func (l *jsiiProxy_LightsailContainerServiceTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LightsailContainerServiceTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
