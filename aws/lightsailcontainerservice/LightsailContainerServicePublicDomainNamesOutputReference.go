...
func (l *jsiiProxy_LightsailContainerServicePublicDomainNamesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LightsailContainerServicePublicDomainNamesOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
