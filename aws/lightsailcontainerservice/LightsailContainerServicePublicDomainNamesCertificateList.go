...
func (j *jsiiProxy_LightsailContainerServicePublicDomainNamesCertificateList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewLightsailContainerServicePublicDomainNamesCertificateList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) LightsailContainerServicePublicDomainNamesCertificateList {
	_init_.Initialize()
...
func NewLightsailContainerServicePublicDomainNamesCertificateList_Override(l LightsailContainerServicePublicDomainNamesCertificateList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_LightsailContainerServicePublicDomainNamesCertificateList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (l *jsiiProxy_LightsailContainerServicePublicDomainNamesCertificateList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (l *jsiiProxy_LightsailContainerServicePublicDomainNamesCertificateList) Resolve(context cdktn.IResolveContext) interface{} {
