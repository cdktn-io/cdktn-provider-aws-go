...
type Resiliencehubv2ServicePermissionModelOutputReference interface {
	...
	CrossAccountRole() Resiliencehubv2ServicePermissionModelCrossAccountRoleList
	...
	PutCrossAccountRole(value interface{})
...
func (j *jsiiProxy_Resiliencehubv2ServicePermissionModelOutputReference) CrossAccountRole() Resiliencehubv2ServicePermissionModelCrossAccountRoleList {
	var returns Resiliencehubv2ServicePermissionModelCrossAccountRoleList
	_jsii_.Get(
		j,
		"crossAccountRole",
		&returns,
...
func (j *jsiiProxy_Resiliencehubv2ServicePermissionModelOutputReference) CrossAccountRoleInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func NewResiliencehubv2ServicePermissionModelOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) Resiliencehubv2ServicePermissionModelOutputReference {
	_init_.Initialize()

	if err := validateNewResiliencehubv2ServicePermissionModelOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func NewResiliencehubv2ServicePermissionModelOutputReference_Override(r Resiliencehubv2ServicePermissionModelOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (r *jsiiProxy_Resiliencehubv2ServicePermissionModelOutputReference) PutCrossAccountRole(value interface{}) {
	if err := r.validatePutCrossAccountRoleParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		r,
...
func (r *jsiiProxy_Resiliencehubv2ServicePermissionModelOutputReference) ResetCrossAccountRole() {
	_jsii_.InvokeVoid(
		r,
		"resetCrossAccountRole",
		nil, // no parameters
