...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/dataawsssoadminpermissionset/internal"
...
func (j *jsiiProxy_DataAwsSsoadminPermissionSet) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsSsoadminPermissionSet) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsSsoadminPermissionSet) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsSsoadminPermissionSet) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsSsoadminPermissionSet) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/data-sources/ssoadmin_permission_set aws_ssoadmin_permission_set} Data Source.
func NewDataAwsSsoadminPermissionSet(scope constructs.Construct, id *string, config *DataAwsSsoadminPermissionSetConfig) DataAwsSsoadminPermissionSet {
	...
	_jsii_.Create(
		"@cdktn/provider-aws.dataAwsSsoadminPermissionSet.DataAwsSsoadminPermissionSet",
...
func (j *jsiiProxy_DataAwsSsoadminPermissionSet)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsSsoadminPermissionSet)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsSsoadminPermissionSet)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsSsoadminPermissionSet_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsSsoadminPermissionSet) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsSsoadminPermissionSet) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsSsoadminPermissionSet) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsSsoadminPermissionSet) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
