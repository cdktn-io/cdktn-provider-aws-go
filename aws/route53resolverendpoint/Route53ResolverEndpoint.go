...
func (j *jsiiProxy_Route53ResolverEndpoint) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_Route53ResolverEndpoint) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_Route53ResolverEndpoint) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_Route53ResolverEndpoint) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_Route53ResolverEndpoint) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_Route53ResolverEndpoint) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_Route53ResolverEndpoint) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/route53_resolver_endpoint aws_route53_resolver_endpoint} Resource.
...
func (j *jsiiProxy_Route53ResolverEndpoint)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_Route53ResolverEndpoint)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_Route53ResolverEndpoint)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_Route53ResolverEndpoint)SetRegion(val *string) {
...
func Route53ResolverEndpoint_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateRoute53ResolverEndpoint_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
// Experimental.
func Route53ResolverEndpoint_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateRoute53ResolverEndpoint_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func Route53ResolverEndpoint_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateRoute53ResolverEndpoint_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (r *jsiiProxy_Route53ResolverEndpoint) AddMoveTarget(moveTarget *string) {
...
func (r *jsiiProxy_Route53ResolverEndpoint) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (r *jsiiProxy_Route53ResolverEndpoint) HasResourceMove() interface{} {
	var returns interface{}
...
func (r *jsiiProxy_Route53ResolverEndpoint) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (r *jsiiProxy_Route53ResolverEndpoint) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (r *jsiiProxy_Route53ResolverEndpoint) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (r *jsiiProxy_Route53ResolverEndpoint) MoveFromId(id *string) {
...
func (r *jsiiProxy_Route53ResolverEndpoint) MoveTo(moveTarget *string, index interface{}) {
...
func (r *jsiiProxy_Route53ResolverEndpoint) MoveToId(id *string) {
...
func (r *jsiiProxy_Route53ResolverEndpoint) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (r *jsiiProxy_Route53ResolverEndpoint) ResetRegion() {
	_jsii_.InvokeVoid(
		r,
		"resetRegion",
		nil, // no parameters
...
func (r *jsiiProxy_Route53ResolverEndpoint) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
