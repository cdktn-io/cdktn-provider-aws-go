...
func (j *jsiiProxy_RekognitionStreamProcessorDataSharingPreferenceList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewRekognitionStreamProcessorDataSharingPreferenceList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) RekognitionStreamProcessorDataSharingPreferenceList {
	_init_.Initialize()
...
func NewRekognitionStreamProcessorDataSharingPreferenceList_Override(r RekognitionStreamProcessorDataSharingPreferenceList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_RekognitionStreamProcessorDataSharingPreferenceList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (r *jsiiProxy_RekognitionStreamProcessorDataSharingPreferenceList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (r *jsiiProxy_RekognitionStreamProcessorDataSharingPreferenceList) Resolve(context cdktn.IResolveContext) interface{} {
