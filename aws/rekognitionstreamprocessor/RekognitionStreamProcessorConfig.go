...
type RekognitionStreamProcessorConfig struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.32.1/docs/resources/rekognition_stream_processor#name RekognitionStreamProcessor#name}
	Name *string `field:"required" json:"name" yaml:"name"`
	// The Amazon Resource Number (ARN) of the IAM role that allows access to the stream processor.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.32.1/docs/resources/rekognition_stream_processor#role_arn RekognitionStreamProcessor#role_arn}
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.32.1/docs/resources/rekognition_stream_processor#kms_key_id RekognitionStreamProcessor#kms_key_id}
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.32.1/docs/resources/rekognition_stream_processor#region RekognitionStreamProcessor#region}
	...
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.32.1/docs/resources/rekognition_stream_processor#tags RekognitionStreamProcessor#tags}.
	Tags *map[string]*string `field:"optional" json:"tags" yaml:"tags"`
	// timeouts block.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.32.1/docs/resources/rekognition_stream_processor#timeouts RekognitionStreamProcessor#timeouts}
