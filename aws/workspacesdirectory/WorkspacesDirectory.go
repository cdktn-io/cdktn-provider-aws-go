...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/workspaces_directory aws_workspaces_directory} Resource.
...
func (w *jsiiProxy_WorkspacesDirectory) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (w *jsiiProxy_WorkspacesDirectory) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (w *jsiiProxy_WorkspacesDirectory) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
