...
func (w *jsiiProxy_WorkspacesDirectoryWorkspaceCreationPropertiesOutputReference) validateResolveParameters(context cdktf.IResolveContext) error {
	if context == nil {
...
func (j *jsiiProxy_WorkspacesDirectoryWorkspaceCreationPropertiesOutputReference) validateSetInternalValueParameters(val *WorkspacesDirectoryWorkspaceCreationProperties) error {
