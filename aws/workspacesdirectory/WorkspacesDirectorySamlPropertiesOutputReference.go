...
func (w *jsiiProxy_WorkspacesDirectorySamlPropertiesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (w *jsiiProxy_WorkspacesDirectorySamlPropertiesOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
