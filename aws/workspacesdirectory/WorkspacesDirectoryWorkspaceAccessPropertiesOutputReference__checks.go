...
func (j *jsiiProxy_WorkspacesDirectoryWorkspaceAccessPropertiesOutputReference) validateSetInternalValueParameters(val *WorkspacesDirectoryWorkspaceAccessProperties) error {
