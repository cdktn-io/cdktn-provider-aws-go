...
func (j *jsiiProxy_DataAwsAppmeshGatewayRouteSpecHttpRouteActionRewriteHostnameList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsAppmeshGatewayRouteSpecHttpRouteActionRewriteHostnameList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsAppmeshGatewayRouteSpecHttpRouteActionRewriteHostnameList {
	_init_.Initialize()
...
func NewDataAwsAppmeshGatewayRouteSpecHttpRouteActionRewriteHostnameList_Override(d DataAwsAppmeshGatewayRouteSpecHttpRouteActionRewriteHostnameList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsAppmeshGatewayRouteSpecHttpRouteActionRewriteHostnameList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsAppmeshGatewayRouteSpecHttpRouteActionRewriteHostnameList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsAppmeshGatewayRouteSpecHttpRouteActionRewriteHostnameList) Resolve(context cdktn.IResolveContext) interface{} {
