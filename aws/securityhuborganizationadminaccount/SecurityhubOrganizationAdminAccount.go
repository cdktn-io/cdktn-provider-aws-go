...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/securityhuborganizationadminaccount/internal"
...
func (j *jsiiProxy_SecurityhubOrganizationAdminAccount) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_SecurityhubOrganizationAdminAccount) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_SecurityhubOrganizationAdminAccount) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_SecurityhubOrganizationAdminAccount) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_SecurityhubOrganizationAdminAccount) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_SecurityhubOrganizationAdminAccount) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_SecurityhubOrganizationAdminAccount) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_SecurityhubOrganizationAdminAccount) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/securityhub_organization_admin_account aws_securityhub_organization_admin_account} Resource.
func NewSecurityhubOrganizationAdminAccount(scope constructs.Construct, id *string, config *SecurityhubOrganizationAdminAccountConfig) SecurityhubOrganizationAdminAccount {
	...
	if err := validateNewSecurityhubOrganizationAdminAccountParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_SecurityhubOrganizationAdminAccount)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_SecurityhubOrganizationAdminAccount)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_SecurityhubOrganizationAdminAccount)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_SecurityhubOrganizationAdminAccount)SetRegion(val *string) {
...
func SecurityhubOrganizationAdminAccount_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateSecurityhubOrganizationAdminAccount_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_SecurityhubOrganizationAdminAccount) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_SecurityhubOrganizationAdminAccount) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SecurityhubOrganizationAdminAccount) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_SecurityhubOrganizationAdminAccount) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SecurityhubOrganizationAdminAccount) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_SecurityhubOrganizationAdminAccount) MoveFromId(id *string) {
...
func (s *jsiiProxy_SecurityhubOrganizationAdminAccount) MoveToId(id *string) {
...
func (s *jsiiProxy_SecurityhubOrganizationAdminAccount) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_SecurityhubOrganizationAdminAccount) ResetId() {
	_jsii_.InvokeVoid(
		s,
		"resetId",
		nil, // no parameters
...
func (s *jsiiProxy_SecurityhubOrganizationAdminAccount) ResetRegion() {
	_jsii_.InvokeVoid(
		s,
		"resetRegion",
		nil, // no parameters
...
func (s *jsiiProxy_SecurityhubOrganizationAdminAccount) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
