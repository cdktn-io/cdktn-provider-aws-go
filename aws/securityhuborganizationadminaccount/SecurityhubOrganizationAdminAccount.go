...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v22/securityhuborganizationadminaccount/internal"
...
func (j *jsiiProxy_SecurityhubOrganizationAdminAccount) ForEach() cdktf.ITerraformIterator {
...
func SecurityhubOrganizationAdminAccount_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (s *jsiiProxy_SecurityhubOrganizationAdminAccount) ImportFrom(id *string, provider cdktf.TerraformProvider) {
