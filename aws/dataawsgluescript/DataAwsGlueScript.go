...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.37.0/docs/data-sources/glue_script aws_glue_script}.
...
func (j *jsiiProxy_DataAwsGlueScript) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsGlueScript) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsGlueScript) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsGlueScript) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsGlueScript) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.37.0/docs/data-sources/glue_script aws_glue_script} Data Source.
...
func (j *jsiiProxy_DataAwsGlueScript)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsGlueScript)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsGlueScript)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsGlueScript_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsGlueScript) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsGlueScript) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsGlueScript) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
