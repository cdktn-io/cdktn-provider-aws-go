...
func (r *jsiiProxy_RedshiftClusterTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (r *jsiiProxy_RedshiftClusterTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
