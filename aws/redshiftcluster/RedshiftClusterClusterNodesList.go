...
func (j *jsiiProxy_RedshiftClusterClusterNodesList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewRedshiftClusterClusterNodesList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) RedshiftClusterClusterNodesList {
	_init_.Initialize()
...
func NewRedshiftClusterClusterNodesList_Override(r RedshiftClusterClusterNodesList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_RedshiftClusterClusterNodesList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (r *jsiiProxy_RedshiftClusterClusterNodesList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (r *jsiiProxy_RedshiftClusterClusterNodesList) Resolve(context cdktn.IResolveContext) interface{} {
