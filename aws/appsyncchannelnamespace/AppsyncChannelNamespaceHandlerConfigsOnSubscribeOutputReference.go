...
func (j *jsiiProxy_AppsyncChannelNamespaceHandlerConfigsOnSubscribeOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewAppsyncChannelNamespaceHandlerConfigsOnSubscribeOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) AppsyncChannelNamespaceHandlerConfigsOnSubscribeOutputReference {
	_init_.Initialize()
...
func NewAppsyncChannelNamespaceHandlerConfigsOnSubscribeOutputReference_Override(a AppsyncChannelNamespaceHandlerConfigsOnSubscribeOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_AppsyncChannelNamespaceHandlerConfigsOnSubscribeOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (a *jsiiProxy_AppsyncChannelNamespaceHandlerConfigsOnSubscribeOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AppsyncChannelNamespaceHandlerConfigsOnSubscribeOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (a *jsiiProxy_AppsyncChannelNamespaceHandlerConfigsOnSubscribeOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AppsyncChannelNamespaceHandlerConfigsOnSubscribeOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
