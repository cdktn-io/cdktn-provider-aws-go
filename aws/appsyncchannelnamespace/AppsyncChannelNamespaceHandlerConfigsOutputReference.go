...
func (j *jsiiProxy_AppsyncChannelNamespaceHandlerConfigsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewAppsyncChannelNamespaceHandlerConfigsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) AppsyncChannelNamespaceHandlerConfigsOutputReference {
	_init_.Initialize()
...
func NewAppsyncChannelNamespaceHandlerConfigsOutputReference_Override(a AppsyncChannelNamespaceHandlerConfigsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_AppsyncChannelNamespaceHandlerConfigsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (a *jsiiProxy_AppsyncChannelNamespaceHandlerConfigsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AppsyncChannelNamespaceHandlerConfigsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (a *jsiiProxy_AppsyncChannelNamespaceHandlerConfigsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AppsyncChannelNamespaceHandlerConfigsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
