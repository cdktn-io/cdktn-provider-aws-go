...
func (j *jsiiProxy_SecuritylakeAwsLogSourceSourceOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewSecuritylakeAwsLogSourceSourceOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) SecuritylakeAwsLogSourceSourceOutputReference {
	_init_.Initialize()
...
func NewSecuritylakeAwsLogSourceSourceOutputReference_Override(s SecuritylakeAwsLogSourceSourceOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_SecuritylakeAwsLogSourceSourceOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_SecuritylakeAwsLogSourceSourceOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SecuritylakeAwsLogSourceSourceOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (s *jsiiProxy_SecuritylakeAwsLogSourceSourceOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SecuritylakeAwsLogSourceSourceOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
