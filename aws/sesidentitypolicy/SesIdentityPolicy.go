...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v21/sesidentitypolicy/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.28.0/docs/resources/ses_identity_policy aws_ses_identity_policy}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.28.0/docs/resources/ses_identity_policy aws_ses_identity_policy} Resource.
...
func SesIdentityPolicy_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (s *jsiiProxy_SesIdentityPolicy) ImportFrom(id *string, provider cdktf.TerraformProvider) {
