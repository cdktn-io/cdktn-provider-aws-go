...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/chimevoiceconnector/internal"
...
func (j *jsiiProxy_ChimeVoiceConnector) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_ChimeVoiceConnector) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_ChimeVoiceConnector) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_ChimeVoiceConnector) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_ChimeVoiceConnector) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_ChimeVoiceConnector)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_ChimeVoiceConnector)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_ChimeVoiceConnector)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func ChimeVoiceConnector_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (c *jsiiProxy_ChimeVoiceConnector) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_ChimeVoiceConnector) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (c *jsiiProxy_ChimeVoiceConnector) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_ChimeVoiceConnector) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_ChimeVoiceConnector) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (c *jsiiProxy_ChimeVoiceConnector) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
