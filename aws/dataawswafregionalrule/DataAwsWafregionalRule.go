...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/dataawswafregionalrule/internal"
...
func (j *jsiiProxy_DataAwsWafregionalRule) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsWafregionalRule) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsWafregionalRule) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsWafregionalRule) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsWafregionalRule) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DataAwsWafregionalRule)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsWafregionalRule)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsWafregionalRule)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsWafregionalRule_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsWafregionalRule) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsWafregionalRule) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsWafregionalRule) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsWafregionalRule) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
