...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/ecrpublicrepository/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/ecrpublic_repository aws_ecrpublic_repository}.
...
func (j *jsiiProxy_EcrpublicRepository) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_EcrpublicRepository) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_EcrpublicRepository) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_EcrpublicRepository) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_EcrpublicRepository) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_EcrpublicRepository) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_EcrpublicRepository) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/ecrpublic_repository aws_ecrpublic_repository} Resource.
...
func (j *jsiiProxy_EcrpublicRepository)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_EcrpublicRepository)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_EcrpublicRepository)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_EcrpublicRepository)SetRegion(val *string) {
...
func EcrpublicRepository_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (e *jsiiProxy_EcrpublicRepository) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (e *jsiiProxy_EcrpublicRepository) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (e *jsiiProxy_EcrpublicRepository) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (e *jsiiProxy_EcrpublicRepository) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (e *jsiiProxy_EcrpublicRepository) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (e *jsiiProxy_EcrpublicRepository) ResetRegion() {
	_jsii_.InvokeVoid(
		e,
		"resetRegion",
		nil, // no parameters
...
func (e *jsiiProxy_EcrpublicRepository) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
