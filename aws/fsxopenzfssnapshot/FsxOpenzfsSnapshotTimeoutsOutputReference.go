...
func (f *jsiiProxy_FsxOpenzfsSnapshotTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (f *jsiiProxy_FsxOpenzfsSnapshotTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
