...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/wafregionalgeomatchset/internal"
...
func (j *jsiiProxy_WafregionalGeoMatchSet) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_WafregionalGeoMatchSet) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_WafregionalGeoMatchSet) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_WafregionalGeoMatchSet) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_WafregionalGeoMatchSet) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/wafregional_geo_match_set aws_wafregional_geo_match_set} Resource.
...
func (j *jsiiProxy_WafregionalGeoMatchSet)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_WafregionalGeoMatchSet)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_WafregionalGeoMatchSet)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func WafregionalGeoMatchSet_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (w *jsiiProxy_WafregionalGeoMatchSet) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_WafregionalGeoMatchSet) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (w *jsiiProxy_WafregionalGeoMatchSet) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_WafregionalGeoMatchSet) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (w *jsiiProxy_WafregionalGeoMatchSet) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (w *jsiiProxy_WafregionalGeoMatchSet) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
