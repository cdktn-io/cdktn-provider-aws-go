...
func (j *jsiiProxy_WafregionalGeoMatchSetGeoMatchConstraintList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewWafregionalGeoMatchSetGeoMatchConstraintList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) WafregionalGeoMatchSetGeoMatchConstraintList {
	_init_.Initialize()
...
func NewWafregionalGeoMatchSetGeoMatchConstraintList_Override(w WafregionalGeoMatchSetGeoMatchConstraintList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_WafregionalGeoMatchSetGeoMatchConstraintList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (w *jsiiProxy_WafregionalGeoMatchSetGeoMatchConstraintList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (w *jsiiProxy_WafregionalGeoMatchSetGeoMatchConstraintList) Resolve(context cdktn.IResolveContext) interface{} {
