...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/codepipeline_custom_action_type aws_codepipeline_custom_action_type} Resource.
...
func (c *jsiiProxy_CodepipelineCustomActionType) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_CodepipelineCustomActionType) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (c *jsiiProxy_CodepipelineCustomActionType) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
