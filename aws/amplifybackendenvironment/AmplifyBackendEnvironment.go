...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/amplifybackendenvironment/internal"
...
func (j *jsiiProxy_AmplifyBackendEnvironment) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_AmplifyBackendEnvironment) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_AmplifyBackendEnvironment) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_AmplifyBackendEnvironment) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_AmplifyBackendEnvironment) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/amplify_backend_environment aws_amplify_backend_environment} Resource.
...
func (j *jsiiProxy_AmplifyBackendEnvironment)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_AmplifyBackendEnvironment)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_AmplifyBackendEnvironment)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func AmplifyBackendEnvironment_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (a *jsiiProxy_AmplifyBackendEnvironment) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AmplifyBackendEnvironment) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (a *jsiiProxy_AmplifyBackendEnvironment) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AmplifyBackendEnvironment) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (a *jsiiProxy_AmplifyBackendEnvironment) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (a *jsiiProxy_AmplifyBackendEnvironment) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
