...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/dataawsefsmounttarget/internal"
...
func (j *jsiiProxy_DataAwsEfsMountTarget) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DataAwsEfsMountTarget) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/data-sources/efs_mount_target aws_efs_mount_target} Data Source.
...
func (j *jsiiProxy_DataAwsEfsMountTarget)SetRegion(val *string) {
...
func (d *jsiiProxy_DataAwsEfsMountTarget) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsEfsMountTarget) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsEfsMountTarget) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
