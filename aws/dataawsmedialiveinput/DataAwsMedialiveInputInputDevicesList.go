...
func (j *jsiiProxy_DataAwsMedialiveInputInputDevicesList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsMedialiveInputInputDevicesList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsMedialiveInputInputDevicesList {
	_init_.Initialize()
...
func NewDataAwsMedialiveInputInputDevicesList_Override(d DataAwsMedialiveInputInputDevicesList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsMedialiveInputInputDevicesList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsMedialiveInputInputDevicesList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsMedialiveInputInputDevicesList) Resolve(context cdktn.IResolveContext) interface{} {
