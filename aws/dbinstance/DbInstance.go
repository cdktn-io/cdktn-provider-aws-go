...
func (j *jsiiProxy_DbInstance) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DbInstance) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DbInstance) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DbInstance) PasswordWo() *string {
	var returns *string
	_jsii_.Get(
		j,
		"passwordWo",
...
func (j *jsiiProxy_DbInstance) PasswordWoInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"passwordWoInput",
...
func (j *jsiiProxy_DbInstance) PasswordWoVersion() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"passwordWoVersion",
...
func (j *jsiiProxy_DbInstance) PasswordWoVersionInput() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DbInstance) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DbInstance) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DbInstance) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_DbInstance) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/db_instance aws_db_instance} Resource.
...
func (j *jsiiProxy_DbInstance)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DbInstance)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DbInstance)SetPasswordWo(val *string) {
...
func (j *jsiiProxy_DbInstance)SetPasswordWoVersion(val *float64) {
...
func (j *jsiiProxy_DbInstance)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_DbInstance)SetRegion(val *string) {
...
func DbInstance_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DbInstance) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DbInstance) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (d *jsiiProxy_DbInstance) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DbInstance) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (d *jsiiProxy_DbInstance) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DbInstance) ResetPasswordWo() {
	_jsii_.InvokeVoid(
		d,
		"resetPasswordWo",
		nil, // no parameters
...
func (d *jsiiProxy_DbInstance) ResetPasswordWoVersion() {
	_jsii_.InvokeVoid(
		d,
		"resetPasswordWoVersion",
		nil, // no parameters
...
func (d *jsiiProxy_DbInstance) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
...
func (d *jsiiProxy_DbInstance) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
