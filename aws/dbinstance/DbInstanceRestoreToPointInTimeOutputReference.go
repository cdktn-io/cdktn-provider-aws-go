...
func (d *jsiiProxy_DbInstanceRestoreToPointInTimeOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DbInstanceRestoreToPointInTimeOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
