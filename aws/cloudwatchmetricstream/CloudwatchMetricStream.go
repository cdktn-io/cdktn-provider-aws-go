...
func (c *jsiiProxy_CloudwatchMetricStream) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_CloudwatchMetricStream) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (c *jsiiProxy_CloudwatchMetricStream) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
