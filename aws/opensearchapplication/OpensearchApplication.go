...
func (j *jsiiProxy_OpensearchApplication) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_OpensearchApplication) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_OpensearchApplication) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_OpensearchApplication) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_OpensearchApplication) TagsAll() cdktf.StringMap {
...
func (j *jsiiProxy_OpensearchApplication) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.32.1/docs/resources/opensearch_application aws_opensearch_application} Resource.
...
func (j *jsiiProxy_OpensearchApplication)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_OpensearchApplication)SetLifecycle(val *cdktf.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_OpensearchApplication)SetProvider(val cdktf.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func OpensearchApplication_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (o *jsiiProxy_OpensearchApplication) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (o *jsiiProxy_OpensearchApplication) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (o *jsiiProxy_OpensearchApplication) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
