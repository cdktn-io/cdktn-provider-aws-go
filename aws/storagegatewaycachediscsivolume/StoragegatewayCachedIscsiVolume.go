...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/storagegatewaycachediscsivolume/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/storagegateway_cached_iscsi_volume aws_storagegateway_cached_iscsi_volume}.
...
func (j *jsiiProxy_StoragegatewayCachedIscsiVolume) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_StoragegatewayCachedIscsiVolume) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/storagegateway_cached_iscsi_volume aws_storagegateway_cached_iscsi_volume} Resource.
...
func (j *jsiiProxy_StoragegatewayCachedIscsiVolume)SetRegion(val *string) {
...
func (s *jsiiProxy_StoragegatewayCachedIscsiVolume) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_StoragegatewayCachedIscsiVolume) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_StoragegatewayCachedIscsiVolume) ResetRegion() {
	_jsii_.InvokeVoid(
		s,
		"resetRegion",
		nil, // no parameters
...
func (s *jsiiProxy_StoragegatewayCachedIscsiVolume) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
