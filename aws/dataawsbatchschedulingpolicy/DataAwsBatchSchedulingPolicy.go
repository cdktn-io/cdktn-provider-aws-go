...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/dataawsbatchschedulingpolicy/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/data-sources/batch_scheduling_policy aws_batch_scheduling_policy}.
...
func (j *jsiiProxy_DataAwsBatchSchedulingPolicy) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsBatchSchedulingPolicy) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsBatchSchedulingPolicy) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsBatchSchedulingPolicy) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsBatchSchedulingPolicy) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DataAwsBatchSchedulingPolicy) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_DataAwsBatchSchedulingPolicy) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/data-sources/batch_scheduling_policy aws_batch_scheduling_policy} Data Source.
...
func (j *jsiiProxy_DataAwsBatchSchedulingPolicy)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsBatchSchedulingPolicy)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsBatchSchedulingPolicy)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_DataAwsBatchSchedulingPolicy)SetRegion(val *string) {
...
func DataAwsBatchSchedulingPolicy_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateDataAwsBatchSchedulingPolicy_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataAwsBatchSchedulingPolicy) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsBatchSchedulingPolicy) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsBatchSchedulingPolicy) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsBatchSchedulingPolicy) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsBatchSchedulingPolicy) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
