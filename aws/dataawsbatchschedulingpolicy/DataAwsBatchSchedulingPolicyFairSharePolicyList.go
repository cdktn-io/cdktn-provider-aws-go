...
func (j *jsiiProxy_DataAwsBatchSchedulingPolicyFairSharePolicyList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsBatchSchedulingPolicyFairSharePolicyList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsBatchSchedulingPolicyFairSharePolicyList {
	_init_.Initialize()
...
func NewDataAwsBatchSchedulingPolicyFairSharePolicyList_Override(d DataAwsBatchSchedulingPolicyFairSharePolicyList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsBatchSchedulingPolicyFairSharePolicyList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsBatchSchedulingPolicyFairSharePolicyList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsBatchSchedulingPolicyFairSharePolicyList) Resolve(context cdktn.IResolveContext) interface{} {
