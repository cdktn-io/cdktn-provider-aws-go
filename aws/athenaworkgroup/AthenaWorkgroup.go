...
func (j *jsiiProxy_AthenaWorkgroup) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_AthenaWorkgroup) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_AthenaWorkgroup) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_AthenaWorkgroup) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_AthenaWorkgroup) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_AthenaWorkgroup) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_AthenaWorkgroup) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/athena_workgroup aws_athena_workgroup} Resource.
...
func (j *jsiiProxy_AthenaWorkgroup)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_AthenaWorkgroup)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_AthenaWorkgroup)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_AthenaWorkgroup)SetRegion(val *string) {
...
func AthenaWorkgroup_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (a *jsiiProxy_AthenaWorkgroup) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AthenaWorkgroup) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (a *jsiiProxy_AthenaWorkgroup) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AthenaWorkgroup) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (a *jsiiProxy_AthenaWorkgroup) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (a *jsiiProxy_AthenaWorkgroup) ResetRegion() {
	_jsii_.InvokeVoid(
		a,
		"resetRegion",
		nil, // no parameters
...
func (a *jsiiProxy_AthenaWorkgroup) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
