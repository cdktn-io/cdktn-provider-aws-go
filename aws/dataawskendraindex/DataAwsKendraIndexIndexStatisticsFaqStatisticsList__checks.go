...
func (d *jsiiProxy_DataAwsKendraIndexIndexStatisticsFaqStatisticsList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (d *jsiiProxy_DataAwsKendraIndexIndexStatisticsFaqStatisticsList) validateResolveParameters(context cdktf.IResolveContext) error {
	if context == nil {
