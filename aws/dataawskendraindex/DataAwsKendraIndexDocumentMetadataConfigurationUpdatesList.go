...
func (d *jsiiProxy_DataAwsKendraIndexDocumentMetadataConfigurationUpdatesList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsKendraIndexDocumentMetadataConfigurationUpdatesList) Resolve(context cdktf.IResolveContext) interface{} {
