...
func (j *jsiiProxy_DataAwsKendraIndexDocumentMetadataConfigurationUpdatesList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsKendraIndexDocumentMetadataConfigurationUpdatesList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsKendraIndexDocumentMetadataConfigurationUpdatesList {
	_init_.Initialize()
...
func NewDataAwsKendraIndexDocumentMetadataConfigurationUpdatesList_Override(d DataAwsKendraIndexDocumentMetadataConfigurationUpdatesList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsKendraIndexDocumentMetadataConfigurationUpdatesList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsKendraIndexDocumentMetadataConfigurationUpdatesList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsKendraIndexDocumentMetadataConfigurationUpdatesList) Resolve(context cdktn.IResolveContext) interface{} {
