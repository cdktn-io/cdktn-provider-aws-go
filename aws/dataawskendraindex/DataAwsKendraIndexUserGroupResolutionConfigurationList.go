...
func (j *jsiiProxy_DataAwsKendraIndexUserGroupResolutionConfigurationList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsKendraIndexUserGroupResolutionConfigurationList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsKendraIndexUserGroupResolutionConfigurationList {
	_init_.Initialize()
...
func NewDataAwsKendraIndexUserGroupResolutionConfigurationList_Override(d DataAwsKendraIndexUserGroupResolutionConfigurationList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsKendraIndexUserGroupResolutionConfigurationList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsKendraIndexUserGroupResolutionConfigurationList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsKendraIndexUserGroupResolutionConfigurationList) Resolve(context cdktn.IResolveContext) interface{} {
