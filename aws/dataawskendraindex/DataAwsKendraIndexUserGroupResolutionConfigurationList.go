...
func (d *jsiiProxy_DataAwsKendraIndexUserGroupResolutionConfigurationList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsKendraIndexUserGroupResolutionConfigurationList) Resolve(context cdktf.IResolveContext) interface{} {
