...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/pinpointbaiduchannel/internal"
...
func (j *jsiiProxy_PinpointBaiduChannel) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_PinpointBaiduChannel) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_PinpointBaiduChannel) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_PinpointBaiduChannel) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_PinpointBaiduChannel) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_PinpointBaiduChannel)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_PinpointBaiduChannel)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_PinpointBaiduChannel)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func PinpointBaiduChannel_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (p *jsiiProxy_PinpointBaiduChannel) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PinpointBaiduChannel) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (p *jsiiProxy_PinpointBaiduChannel) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PinpointBaiduChannel) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (p *jsiiProxy_PinpointBaiduChannel) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (p *jsiiProxy_PinpointBaiduChannel) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
