...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*Pinpointsmsvoicev2Pool)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-aws.pinpointsmsvoicev2Pool.Pinpointsmsvoicev2PoolConfig",
		reflect.TypeOf((*Pinpointsmsvoicev2PoolConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-aws.pinpointsmsvoicev2Pool.Pinpointsmsvoicev2PoolTimeouts",
		reflect.TypeOf((*Pinpointsmsvoicev2PoolTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-aws.pinpointsmsvoicev2Pool.Pinpointsmsvoicev2PoolTimeoutsOutputReference",
		reflect.TypeOf((*Pinpointsmsvoicev2PoolTimeoutsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
