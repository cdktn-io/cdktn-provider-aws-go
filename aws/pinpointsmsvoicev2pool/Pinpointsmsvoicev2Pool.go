...
func (p *jsiiProxy_Pinpointsmsvoicev2Pool) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (p *jsiiProxy_Pinpointsmsvoicev2Pool) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
