...
func (t *jsiiProxy_TransferAccess) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (t *jsiiProxy_TransferAccess) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
