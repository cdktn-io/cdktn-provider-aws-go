...
func (j *jsiiProxy_TransferAccessHomeDirectoryMappingsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewTransferAccessHomeDirectoryMappingsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) TransferAccessHomeDirectoryMappingsList {
	_init_.Initialize()
...
func NewTransferAccessHomeDirectoryMappingsList_Override(t TransferAccessHomeDirectoryMappingsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_TransferAccessHomeDirectoryMappingsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (t *jsiiProxy_TransferAccessHomeDirectoryMappingsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (t *jsiiProxy_TransferAccessHomeDirectoryMappingsList) Resolve(context cdktn.IResolveContext) interface{} {
