...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v22/transferaccess/internal"
...
func (t *jsiiProxy_TransferAccessHomeDirectoryMappingsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (t *jsiiProxy_TransferAccessHomeDirectoryMappingsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
