...
func (g *jsiiProxy_GluePartitionStorageDescriptorSerDeInfoOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GluePartitionStorageDescriptorSerDeInfoOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
