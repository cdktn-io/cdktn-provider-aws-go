...
func (j *jsiiProxy_DataAwsEcrRepositoryCreationTemplate) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DataAwsEcrRepositoryCreationTemplate) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/data-sources/ecr_repository_creation_template aws_ecr_repository_creation_template} Data Source.
...
func (j *jsiiProxy_DataAwsEcrRepositoryCreationTemplate)SetRegion(val *string) {
...
func (d *jsiiProxy_DataAwsEcrRepositoryCreationTemplate) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsEcrRepositoryCreationTemplate) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
