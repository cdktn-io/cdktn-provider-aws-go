...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/iamaccountpasswordpolicy/internal"
...
func (j *jsiiProxy_IamAccountPasswordPolicy) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_IamAccountPasswordPolicy) ExpirePasswords() cdktn.IResolvable {
...
func (j *jsiiProxy_IamAccountPasswordPolicy) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_IamAccountPasswordPolicy) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_IamAccountPasswordPolicy) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_IamAccountPasswordPolicy) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_IamAccountPasswordPolicy)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_IamAccountPasswordPolicy)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_IamAccountPasswordPolicy)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func IamAccountPasswordPolicy_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (i *jsiiProxy_IamAccountPasswordPolicy) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (i *jsiiProxy_IamAccountPasswordPolicy) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (i *jsiiProxy_IamAccountPasswordPolicy) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (i *jsiiProxy_IamAccountPasswordPolicy) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (i *jsiiProxy_IamAccountPasswordPolicy) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (i *jsiiProxy_IamAccountPasswordPolicy) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
