...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*CloudtrailOrganizationDelegatedAdminAccount)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-aws.cloudtrailOrganizationDelegatedAdminAccount.CloudtrailOrganizationDelegatedAdminAccountConfig",
		reflect.TypeOf((*CloudtrailOrganizationDelegatedAdminAccountConfig)(nil)).Elem(),
	)
}
