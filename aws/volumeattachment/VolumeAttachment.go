...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/volumeattachment/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/volume_attachment aws_volume_attachment}.
...
func (j *jsiiProxy_VolumeAttachment) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_VolumeAttachment) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_VolumeAttachment) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_VolumeAttachment) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_VolumeAttachment) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_VolumeAttachment) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_VolumeAttachment) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/volume_attachment aws_volume_attachment} Resource.
...
func (j *jsiiProxy_VolumeAttachment)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_VolumeAttachment)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_VolumeAttachment)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_VolumeAttachment)SetRegion(val *string) {
...
// Generates CDKTN code for importing a VolumeAttachment resource upon running "cdktn plan <stack-name>".
func VolumeAttachment_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (v *jsiiProxy_VolumeAttachment) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (v *jsiiProxy_VolumeAttachment) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (v *jsiiProxy_VolumeAttachment) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (v *jsiiProxy_VolumeAttachment) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (v *jsiiProxy_VolumeAttachment) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (v *jsiiProxy_VolumeAttachment) ResetRegion() {
	_jsii_.InvokeVoid(
		v,
		"resetRegion",
		nil, // no parameters
...
func (v *jsiiProxy_VolumeAttachment) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
