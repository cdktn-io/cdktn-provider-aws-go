...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "hybridAccessEnabledInput", GoGetter: "HybridAccessEnabledInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetHybridAccessEnabled", GoMethod: "ResetHybridAccessEnabled"},
