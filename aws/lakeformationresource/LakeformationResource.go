...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/lakeformationresource/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/lakeformation_resource aws_lakeformation_resource}.
...
func (j *jsiiProxy_LakeformationResource) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_LakeformationResource) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_LakeformationResource) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_LakeformationResource) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_LakeformationResource) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/lakeformation_resource aws_lakeformation_resource} Resource.
...
func (j *jsiiProxy_LakeformationResource)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_LakeformationResource)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_LakeformationResource)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func LakeformationResource_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (l *jsiiProxy_LakeformationResource) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LakeformationResource) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (l *jsiiProxy_LakeformationResource) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LakeformationResource) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (l *jsiiProxy_LakeformationResource) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (l *jsiiProxy_LakeformationResource) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
