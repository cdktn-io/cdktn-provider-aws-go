...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/dataawscognitouserpools/internal"
...
func (j *jsiiProxy_DataAwsCognitoUserPools) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsCognitoUserPools) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsCognitoUserPools) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsCognitoUserPools) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsCognitoUserPools) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/data-sources/cognito_user_pools aws_cognito_user_pools} Data Source.
...
func (j *jsiiProxy_DataAwsCognitoUserPools)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsCognitoUserPools)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsCognitoUserPools)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsCognitoUserPools_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsCognitoUserPools) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsCognitoUserPools) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsCognitoUserPools) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsCognitoUserPools) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
