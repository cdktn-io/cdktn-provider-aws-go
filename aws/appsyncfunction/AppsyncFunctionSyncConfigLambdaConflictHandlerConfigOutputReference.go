...
func (j *jsiiProxy_AppsyncFunctionSyncConfigLambdaConflictHandlerConfigOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewAppsyncFunctionSyncConfigLambdaConflictHandlerConfigOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) AppsyncFunctionSyncConfigLambdaConflictHandlerConfigOutputReference {
	_init_.Initialize()

	if err := validateNewAppsyncFunctionSyncConfigLambdaConflictHandlerConfigOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewAppsyncFunctionSyncConfigLambdaConflictHandlerConfigOutputReference_Override(a AppsyncFunctionSyncConfigLambdaConflictHandlerConfigOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_AppsyncFunctionSyncConfigLambdaConflictHandlerConfigOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (a *jsiiProxy_AppsyncFunctionSyncConfigLambdaConflictHandlerConfigOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AppsyncFunctionSyncConfigLambdaConflictHandlerConfigOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (a *jsiiProxy_AppsyncFunctionSyncConfigLambdaConflictHandlerConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AppsyncFunctionSyncConfigLambdaConflictHandlerConfigOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
