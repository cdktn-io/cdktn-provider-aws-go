...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v21/appsyncfunction/internal"
...
func (a *jsiiProxy_AppsyncFunctionSyncConfigLambdaConflictHandlerConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_AppsyncFunctionSyncConfigLambdaConflictHandlerConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
