...
func (j *jsiiProxy_AppsyncFunctionSyncConfigOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewAppsyncFunctionSyncConfigOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) AppsyncFunctionSyncConfigOutputReference {
	_init_.Initialize()

	if err := validateNewAppsyncFunctionSyncConfigOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewAppsyncFunctionSyncConfigOutputReference_Override(a AppsyncFunctionSyncConfigOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_AppsyncFunctionSyncConfigOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (a *jsiiProxy_AppsyncFunctionSyncConfigOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AppsyncFunctionSyncConfigOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (a *jsiiProxy_AppsyncFunctionSyncConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AppsyncFunctionSyncConfigOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
