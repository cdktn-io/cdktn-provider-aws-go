...
func (a *jsiiProxy_AppsyncFunctionSyncConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_AppsyncFunctionSyncConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
