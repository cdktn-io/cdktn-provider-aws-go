...
func (q *jsiiProxy_QuicksightDataSourceParametersSnowflakeOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (q *jsiiProxy_QuicksightDataSourceParametersSnowflakeOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
