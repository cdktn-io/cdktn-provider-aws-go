...
func (q *jsiiProxy_QuicksightDataSourceParametersTeradataOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (q *jsiiProxy_QuicksightDataSourceParametersTeradataOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
