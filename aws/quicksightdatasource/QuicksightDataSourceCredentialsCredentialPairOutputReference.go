...
func (q *jsiiProxy_QuicksightDataSourceCredentialsCredentialPairOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (q *jsiiProxy_QuicksightDataSourceCredentialsCredentialPairOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
