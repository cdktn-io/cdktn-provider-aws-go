...
func (j *jsiiProxy_QuicksightDataSourceCredentialsCredentialPairOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewQuicksightDataSourceCredentialsCredentialPairOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) QuicksightDataSourceCredentialsCredentialPairOutputReference {
	_init_.Initialize()

	if err := validateNewQuicksightDataSourceCredentialsCredentialPairOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewQuicksightDataSourceCredentialsCredentialPairOutputReference_Override(q QuicksightDataSourceCredentialsCredentialPairOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_QuicksightDataSourceCredentialsCredentialPairOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (q *jsiiProxy_QuicksightDataSourceCredentialsCredentialPairOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (q *jsiiProxy_QuicksightDataSourceCredentialsCredentialPairOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (q *jsiiProxy_QuicksightDataSourceCredentialsCredentialPairOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (q *jsiiProxy_QuicksightDataSourceCredentialsCredentialPairOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
