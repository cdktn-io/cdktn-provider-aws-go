...
func (q *jsiiProxy_QuicksightDataSourceParametersMariaDbOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (q *jsiiProxy_QuicksightDataSourceParametersMariaDbOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
