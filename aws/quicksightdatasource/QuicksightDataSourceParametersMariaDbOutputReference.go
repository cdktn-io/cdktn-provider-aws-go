...
func (j *jsiiProxy_QuicksightDataSourceParametersMariaDbOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewQuicksightDataSourceParametersMariaDbOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) QuicksightDataSourceParametersMariaDbOutputReference {
	_init_.Initialize()

	if err := validateNewQuicksightDataSourceParametersMariaDbOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewQuicksightDataSourceParametersMariaDbOutputReference_Override(q QuicksightDataSourceParametersMariaDbOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_QuicksightDataSourceParametersMariaDbOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (q *jsiiProxy_QuicksightDataSourceParametersMariaDbOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (q *jsiiProxy_QuicksightDataSourceParametersMariaDbOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (q *jsiiProxy_QuicksightDataSourceParametersMariaDbOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (q *jsiiProxy_QuicksightDataSourceParametersMariaDbOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
