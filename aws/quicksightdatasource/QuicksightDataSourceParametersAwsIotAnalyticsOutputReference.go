...
func (q *jsiiProxy_QuicksightDataSourceParametersAwsIotAnalyticsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (q *jsiiProxy_QuicksightDataSourceParametersAwsIotAnalyticsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
