...
func (j *jsiiProxy_QuicksightDataSourceParametersAwsIotAnalyticsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewQuicksightDataSourceParametersAwsIotAnalyticsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) QuicksightDataSourceParametersAwsIotAnalyticsOutputReference {
	_init_.Initialize()
...
func NewQuicksightDataSourceParametersAwsIotAnalyticsOutputReference_Override(q QuicksightDataSourceParametersAwsIotAnalyticsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_QuicksightDataSourceParametersAwsIotAnalyticsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (q *jsiiProxy_QuicksightDataSourceParametersAwsIotAnalyticsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (q *jsiiProxy_QuicksightDataSourceParametersAwsIotAnalyticsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (q *jsiiProxy_QuicksightDataSourceParametersAwsIotAnalyticsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (q *jsiiProxy_QuicksightDataSourceParametersAwsIotAnalyticsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
