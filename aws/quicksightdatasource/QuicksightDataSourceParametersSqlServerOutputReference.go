...
func (q *jsiiProxy_QuicksightDataSourceParametersSqlServerOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (q *jsiiProxy_QuicksightDataSourceParametersSqlServerOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
