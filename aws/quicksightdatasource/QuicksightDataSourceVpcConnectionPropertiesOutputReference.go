...
func (q *jsiiProxy_QuicksightDataSourceVpcConnectionPropertiesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (q *jsiiProxy_QuicksightDataSourceVpcConnectionPropertiesOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
