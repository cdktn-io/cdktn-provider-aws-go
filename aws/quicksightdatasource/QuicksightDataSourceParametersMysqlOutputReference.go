...
func (q *jsiiProxy_QuicksightDataSourceParametersMysqlOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (q *jsiiProxy_QuicksightDataSourceParametersMysqlOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
