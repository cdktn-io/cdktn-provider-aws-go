...
func (q *jsiiProxy_QuicksightDataSourceParametersTwitterOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (q *jsiiProxy_QuicksightDataSourceParametersTwitterOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
