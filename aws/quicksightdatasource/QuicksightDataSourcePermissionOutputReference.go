...
func (q *jsiiProxy_QuicksightDataSourcePermissionOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (q *jsiiProxy_QuicksightDataSourcePermissionOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
