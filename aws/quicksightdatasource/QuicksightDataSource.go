...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/quicksight_data_source aws_quicksight_data_source}.
...
func (j *jsiiProxy_QuicksightDataSource) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_QuicksightDataSource) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_QuicksightDataSource) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_QuicksightDataSource) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_QuicksightDataSource) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/quicksight_data_source aws_quicksight_data_source} Resource.
...
func (j *jsiiProxy_QuicksightDataSource)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_QuicksightDataSource)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_QuicksightDataSource)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func QuicksightDataSource_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateQuicksightDataSource_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (q *jsiiProxy_QuicksightDataSource) AddMoveTarget(moveTarget *string) {
...
func (q *jsiiProxy_QuicksightDataSource) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (q *jsiiProxy_QuicksightDataSource) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (q *jsiiProxy_QuicksightDataSource) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (q *jsiiProxy_QuicksightDataSource) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (q *jsiiProxy_QuicksightDataSource) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (q *jsiiProxy_QuicksightDataSource) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
