...
func (q *jsiiProxy_QuicksightDataSourceParametersPostgresqlOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (q *jsiiProxy_QuicksightDataSourceParametersPostgresqlOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
