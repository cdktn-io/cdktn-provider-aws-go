...
func (q *jsiiProxy_QuicksightDataSourceParametersJiraOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (q *jsiiProxy_QuicksightDataSourceParametersJiraOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
