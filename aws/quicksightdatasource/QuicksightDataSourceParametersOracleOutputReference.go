...
func (q *jsiiProxy_QuicksightDataSourceParametersOracleOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (q *jsiiProxy_QuicksightDataSourceParametersOracleOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
