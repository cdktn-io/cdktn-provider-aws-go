...
func (j *jsiiProxy_CloudformationStackSetAutoDeploymentOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewCloudformationStackSetAutoDeploymentOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) CloudformationStackSetAutoDeploymentOutputReference {
	_init_.Initialize()
...
func NewCloudformationStackSetAutoDeploymentOutputReference_Override(c CloudformationStackSetAutoDeploymentOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_CloudformationStackSetAutoDeploymentOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_CloudformationStackSetAutoDeploymentOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CloudformationStackSetAutoDeploymentOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (c *jsiiProxy_CloudformationStackSetAutoDeploymentOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CloudformationStackSetAutoDeploymentOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
