...
func (c *jsiiProxy_CloudformationStackSetAutoDeploymentOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CloudformationStackSetAutoDeploymentOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
