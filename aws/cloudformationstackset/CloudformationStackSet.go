...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v22/cloudformationstackset/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.32.1/docs/resources/cloudformation_stack_set aws_cloudformation_stack_set}.
...
func (j *jsiiProxy_CloudformationStackSet) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_CloudformationStackSet) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.32.1/docs/resources/cloudformation_stack_set aws_cloudformation_stack_set} Resource.
...
func (j *jsiiProxy_CloudformationStackSet)SetRegion(val *string) {
...
func (c *jsiiProxy_CloudformationStackSet) ResetRegion() {
	_jsii_.InvokeVoid(
		c,
		"resetRegion",
		nil, // no parameters
