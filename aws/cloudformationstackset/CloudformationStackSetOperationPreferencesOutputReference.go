...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v24/cloudformationstackset/internal"
...
func (j *jsiiProxy_CloudformationStackSetOperationPreferencesOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewCloudformationStackSetOperationPreferencesOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) CloudformationStackSetOperationPreferencesOutputReference {
	_init_.Initialize()
...
func NewCloudformationStackSetOperationPreferencesOutputReference_Override(c CloudformationStackSetOperationPreferencesOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_CloudformationStackSetOperationPreferencesOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_CloudformationStackSetOperationPreferencesOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CloudformationStackSetOperationPreferencesOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (c *jsiiProxy_CloudformationStackSetOperationPreferencesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CloudformationStackSetOperationPreferencesOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
