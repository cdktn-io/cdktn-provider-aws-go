...
func (c *jsiiProxy_CloudformationStackSetTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CloudformationStackSetTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
