...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/lightsail_instance aws_lightsail_instance}.
...
func (j *jsiiProxy_LightsailInstance) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_LightsailInstance) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/lightsail_instance aws_lightsail_instance} Resource.
...
func (j *jsiiProxy_LightsailInstance)SetRegion(val *string) {
...
func (l *jsiiProxy_LightsailInstance) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (l *jsiiProxy_LightsailInstance) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (l *jsiiProxy_LightsailInstance) ResetRegion() {
	_jsii_.InvokeVoid(
		l,
		"resetRegion",
		nil, // no parameters
...
func (l *jsiiProxy_LightsailInstance) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
