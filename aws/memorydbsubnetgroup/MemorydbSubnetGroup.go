...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/memorydbsubnetgroup/internal"
...
func (j *jsiiProxy_MemorydbSubnetGroup) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_MemorydbSubnetGroup) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_MemorydbSubnetGroup) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_MemorydbSubnetGroup) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_MemorydbSubnetGroup) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/memorydb_subnet_group aws_memorydb_subnet_group} Resource.
...
func (j *jsiiProxy_MemorydbSubnetGroup)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_MemorydbSubnetGroup)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_MemorydbSubnetGroup)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func MemorydbSubnetGroup_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (m *jsiiProxy_MemorydbSubnetGroup) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MemorydbSubnetGroup) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (m *jsiiProxy_MemorydbSubnetGroup) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MemorydbSubnetGroup) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (m *jsiiProxy_MemorydbSubnetGroup) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (m *jsiiProxy_MemorydbSubnetGroup) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
