...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/cloudwatcheventrule/internal"
...
func (j *jsiiProxy_CloudwatchEventRule) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_CloudwatchEventRule) ForceDestroy() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"forceDestroy",
...
func (j *jsiiProxy_CloudwatchEventRule) ForceDestroyInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"forceDestroyInput",
...
func (j *jsiiProxy_CloudwatchEventRule) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_CloudwatchEventRule) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_CloudwatchEventRule) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_CloudwatchEventRule) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_CloudwatchEventRule) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_CloudwatchEventRule) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_CloudwatchEventRule)SetForceDestroy(val interface{}) {
...
func (j *jsiiProxy_CloudwatchEventRule)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_CloudwatchEventRule)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_CloudwatchEventRule)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_CloudwatchEventRule)SetRegion(val *string) {
...
func CloudwatchEventRule_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (c *jsiiProxy_CloudwatchEventRule) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CloudwatchEventRule) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (c *jsiiProxy_CloudwatchEventRule) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CloudwatchEventRule) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_CloudwatchEventRule) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (c *jsiiProxy_CloudwatchEventRule) ResetForceDestroy() {
	_jsii_.InvokeVoid(
		c,
		"resetForceDestroy",
		nil, // no parameters
...
func (c *jsiiProxy_CloudwatchEventRule) ResetRegion() {
	_jsii_.InvokeVoid(
		c,
		"resetRegion",
		nil, // no parameters
...
func (c *jsiiProxy_CloudwatchEventRule) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
