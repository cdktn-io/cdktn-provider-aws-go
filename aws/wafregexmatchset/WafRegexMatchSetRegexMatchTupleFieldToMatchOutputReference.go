...
func NewWafRegexMatchSetRegexMatchTupleFieldToMatchOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) WafRegexMatchSetRegexMatchTupleFieldToMatchOutputReference {
	_init_.Initialize()
...
func NewWafRegexMatchSetRegexMatchTupleFieldToMatchOutputReference_Override(w WafRegexMatchSetRegexMatchTupleFieldToMatchOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (w *jsiiProxy_WafRegexMatchSetRegexMatchTupleFieldToMatchOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (w *jsiiProxy_WafRegexMatchSetRegexMatchTupleFieldToMatchOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
