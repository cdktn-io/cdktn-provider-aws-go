...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v23/wafregexmatchset/internal"
...
func (j *jsiiProxy_WafRegexMatchSetRegexMatchTupleFieldToMatchOutputReference) ComplexObjectIndex() interface{} {
...
func (j *jsiiProxy_WafRegexMatchSetRegexMatchTupleFieldToMatchOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_WafRegexMatchSetRegexMatchTupleFieldToMatchOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_WafRegexMatchSetRegexMatchTupleFieldToMatchOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_WafRegexMatchSetRegexMatchTupleFieldToMatchOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewWafRegexMatchSetRegexMatchTupleFieldToMatchOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) WafRegexMatchSetRegexMatchTupleFieldToMatchOutputReference {
	_init_.Initialize()

	if err := validateNewWafRegexMatchSetRegexMatchTupleFieldToMatchOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewWafRegexMatchSetRegexMatchTupleFieldToMatchOutputReference_Override(w WafRegexMatchSetRegexMatchTupleFieldToMatchOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_WafRegexMatchSetRegexMatchTupleFieldToMatchOutputReference)SetComplexObjectIndex(val interface{}) {
...
func (j *jsiiProxy_WafRegexMatchSetRegexMatchTupleFieldToMatchOutputReference)SetComplexObjectIsFromSet(val *bool) {
...
func (j *jsiiProxy_WafRegexMatchSetRegexMatchTupleFieldToMatchOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (w *jsiiProxy_WafRegexMatchSetRegexMatchTupleFieldToMatchOutputReference) ComputeFqn() *string {
	var returns *string
...
func (w *jsiiProxy_WafRegexMatchSetRegexMatchTupleFieldToMatchOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_WafRegexMatchSetRegexMatchTupleFieldToMatchOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (w *jsiiProxy_WafRegexMatchSetRegexMatchTupleFieldToMatchOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_WafRegexMatchSetRegexMatchTupleFieldToMatchOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
...
func (w *jsiiProxy_WafRegexMatchSetRegexMatchTupleFieldToMatchOutputReference) ToString() *string {
	var returns *string
