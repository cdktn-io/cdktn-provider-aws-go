...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v21/iamrolepolicyattachment/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.28.0/docs/resources/iam_role_policy_attachment aws_iam_role_policy_attachment}.
...
func (j *jsiiProxy_IamRolePolicyAttachment) ForEach() cdktf.ITerraformIterator {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.28.0/docs/resources/iam_role_policy_attachment aws_iam_role_policy_attachment} Resource.
...
func (j *jsiiProxy_IamRolePolicyAttachment)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func IamRolePolicyAttachment_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (i *jsiiProxy_IamRolePolicyAttachment) ImportFrom(id *string, provider cdktf.TerraformProvider) {
