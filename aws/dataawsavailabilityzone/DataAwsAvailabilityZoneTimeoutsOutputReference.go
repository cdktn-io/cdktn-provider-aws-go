...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/dataawsavailabilityzone/internal"
...
func (j *jsiiProxy_DataAwsAvailabilityZoneTimeoutsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsAvailabilityZoneTimeoutsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) DataAwsAvailabilityZoneTimeoutsOutputReference {
	_init_.Initialize()

	if err := validateNewDataAwsAvailabilityZoneTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewDataAwsAvailabilityZoneTimeoutsOutputReference_Override(d DataAwsAvailabilityZoneTimeoutsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsAvailabilityZoneTimeoutsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsAvailabilityZoneTimeoutsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsAvailabilityZoneTimeoutsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (d *jsiiProxy_DataAwsAvailabilityZoneTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsAvailabilityZoneTimeoutsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
