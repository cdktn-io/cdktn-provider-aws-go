...
func (j *jsiiProxy_DataAwsAvailabilityZoneFilterList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsAvailabilityZoneFilterList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsAvailabilityZoneFilterList {
	_init_.Initialize()
...
func NewDataAwsAvailabilityZoneFilterList_Override(d DataAwsAvailabilityZoneFilterList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsAvailabilityZoneFilterList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsAvailabilityZoneFilterList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsAvailabilityZoneFilterList) Resolve(context cdktn.IResolveContext) interface{} {
