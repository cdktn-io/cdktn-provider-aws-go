...
func (j *jsiiProxy_DataAwsAvailabilityZone) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsAvailabilityZone) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsAvailabilityZone) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsAvailabilityZone) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsAvailabilityZone) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/data-sources/availability_zone aws_availability_zone} Data Source.
...
func (j *jsiiProxy_DataAwsAvailabilityZone)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsAvailabilityZone)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsAvailabilityZone)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsAvailabilityZone_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsAvailabilityZone) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsAvailabilityZone) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsAvailabilityZone) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsAvailabilityZone) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
