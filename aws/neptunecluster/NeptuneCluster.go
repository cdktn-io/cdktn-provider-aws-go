...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/neptunecluster/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/neptune_cluster aws_neptune_cluster}.
...
func (j *jsiiProxy_NeptuneCluster) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_NeptuneCluster) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_NeptuneCluster) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_NeptuneCluster) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_NeptuneCluster) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/neptune_cluster aws_neptune_cluster} Resource.
...
func (j *jsiiProxy_NeptuneCluster)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_NeptuneCluster)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_NeptuneCluster)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func NeptuneCluster_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (n *jsiiProxy_NeptuneCluster) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (n *jsiiProxy_NeptuneCluster) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (n *jsiiProxy_NeptuneCluster) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (n *jsiiProxy_NeptuneCluster) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (n *jsiiProxy_NeptuneCluster) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (n *jsiiProxy_NeptuneCluster) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
