...
func (n *jsiiProxy_NeptuneClusterTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (n *jsiiProxy_NeptuneClusterTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
