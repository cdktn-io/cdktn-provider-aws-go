...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v21/neptunecluster/internal"
...
func (n *jsiiProxy_NeptuneClusterServerlessV2ScalingConfigurationOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (n *jsiiProxy_NeptuneClusterServerlessV2ScalingConfigurationOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
