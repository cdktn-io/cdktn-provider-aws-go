...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/redshiftclusteriamroles/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/redshift_cluster_iam_roles aws_redshift_cluster_iam_roles}.
...
func (j *jsiiProxy_RedshiftClusterIamRoles) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_RedshiftClusterIamRoles) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_RedshiftClusterIamRoles) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_RedshiftClusterIamRoles) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_RedshiftClusterIamRoles) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/redshift_cluster_iam_roles aws_redshift_cluster_iam_roles} Resource.
...
func (j *jsiiProxy_RedshiftClusterIamRoles)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_RedshiftClusterIamRoles)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_RedshiftClusterIamRoles)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func RedshiftClusterIamRoles_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (r *jsiiProxy_RedshiftClusterIamRoles) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (r *jsiiProxy_RedshiftClusterIamRoles) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (r *jsiiProxy_RedshiftClusterIamRoles) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (r *jsiiProxy_RedshiftClusterIamRoles) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (r *jsiiProxy_RedshiftClusterIamRoles) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (r *jsiiProxy_RedshiftClusterIamRoles) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
