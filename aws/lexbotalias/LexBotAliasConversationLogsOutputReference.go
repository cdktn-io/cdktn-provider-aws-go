...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v21/lexbotalias/internal"
...
func (l *jsiiProxy_LexBotAliasConversationLogsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LexBotAliasConversationLogsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
