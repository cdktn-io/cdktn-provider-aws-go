...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v24/lexbotalias/internal"
...
func (j *jsiiProxy_LexBotAliasConversationLogsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewLexBotAliasConversationLogsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) LexBotAliasConversationLogsOutputReference {
	_init_.Initialize()

	if err := validateNewLexBotAliasConversationLogsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewLexBotAliasConversationLogsOutputReference_Override(l LexBotAliasConversationLogsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_LexBotAliasConversationLogsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (l *jsiiProxy_LexBotAliasConversationLogsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LexBotAliasConversationLogsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (l *jsiiProxy_LexBotAliasConversationLogsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LexBotAliasConversationLogsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
