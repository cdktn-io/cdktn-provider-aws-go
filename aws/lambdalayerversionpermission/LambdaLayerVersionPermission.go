...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/lambdalayerversionpermission/internal"
...
func (j *jsiiProxy_LambdaLayerVersionPermission) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_LambdaLayerVersionPermission) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_LambdaLayerVersionPermission) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_LambdaLayerVersionPermission) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_LambdaLayerVersionPermission) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/lambda_layer_version_permission aws_lambda_layer_version_permission} Resource.
...
func (j *jsiiProxy_LambdaLayerVersionPermission)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_LambdaLayerVersionPermission)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_LambdaLayerVersionPermission)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func LambdaLayerVersionPermission_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (l *jsiiProxy_LambdaLayerVersionPermission) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LambdaLayerVersionPermission) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (l *jsiiProxy_LambdaLayerVersionPermission) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LambdaLayerVersionPermission) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (l *jsiiProxy_LambdaLayerVersionPermission) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (l *jsiiProxy_LambdaLayerVersionPermission) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
