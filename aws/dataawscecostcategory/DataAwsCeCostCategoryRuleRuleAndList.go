...
func (j *jsiiProxy_DataAwsCeCostCategoryRuleRuleAndList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsCeCostCategoryRuleRuleAndList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsCeCostCategoryRuleRuleAndList {
	_init_.Initialize()
...
func NewDataAwsCeCostCategoryRuleRuleAndList_Override(d DataAwsCeCostCategoryRuleRuleAndList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsCeCostCategoryRuleRuleAndList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsCeCostCategoryRuleRuleAndList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsCeCostCategoryRuleRuleAndList) Resolve(context cdktn.IResolveContext) interface{} {
