...
func (j *jsiiProxy_DataAwsCeCostCategoryRuleRuleOrAndTagsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsCeCostCategoryRuleRuleOrAndTagsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsCeCostCategoryRuleRuleOrAndTagsList {
	_init_.Initialize()
...
func NewDataAwsCeCostCategoryRuleRuleOrAndTagsList_Override(d DataAwsCeCostCategoryRuleRuleOrAndTagsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsCeCostCategoryRuleRuleOrAndTagsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsCeCostCategoryRuleRuleOrAndTagsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsCeCostCategoryRuleRuleOrAndTagsList) Resolve(context cdktn.IResolveContext) interface{} {
