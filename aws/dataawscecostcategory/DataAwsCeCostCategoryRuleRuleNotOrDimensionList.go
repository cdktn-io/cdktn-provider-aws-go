...
func (j *jsiiProxy_DataAwsCeCostCategoryRuleRuleNotOrDimensionList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsCeCostCategoryRuleRuleNotOrDimensionList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsCeCostCategoryRuleRuleNotOrDimensionList {
	_init_.Initialize()
...
func NewDataAwsCeCostCategoryRuleRuleNotOrDimensionList_Override(d DataAwsCeCostCategoryRuleRuleNotOrDimensionList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsCeCostCategoryRuleRuleNotOrDimensionList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsCeCostCategoryRuleRuleNotOrDimensionList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsCeCostCategoryRuleRuleNotOrDimensionList) Resolve(context cdktn.IResolveContext) interface{} {
