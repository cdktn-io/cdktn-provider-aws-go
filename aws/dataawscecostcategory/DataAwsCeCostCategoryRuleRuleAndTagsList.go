...
func (d *jsiiProxy_DataAwsCeCostCategoryRuleRuleAndTagsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsCeCostCategoryRuleRuleAndTagsList) Resolve(context cdktf.IResolveContext) interface{} {
