...
func (j *jsiiProxy_DataAwsCeCostCategoryRuleRuleAndTagsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsCeCostCategoryRuleRuleAndTagsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsCeCostCategoryRuleRuleAndTagsList {
	_init_.Initialize()
...
func NewDataAwsCeCostCategoryRuleRuleAndTagsList_Override(d DataAwsCeCostCategoryRuleRuleAndTagsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsCeCostCategoryRuleRuleAndTagsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsCeCostCategoryRuleRuleAndTagsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsCeCostCategoryRuleRuleAndTagsList) Resolve(context cdktn.IResolveContext) interface{} {
