...
func (j *jsiiProxy_DataAwsCeCostCategoryRuleRuleOrAndDimensionList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsCeCostCategoryRuleRuleOrAndDimensionList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsCeCostCategoryRuleRuleOrAndDimensionList {
	_init_.Initialize()
...
func NewDataAwsCeCostCategoryRuleRuleOrAndDimensionList_Override(d DataAwsCeCostCategoryRuleRuleOrAndDimensionList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsCeCostCategoryRuleRuleOrAndDimensionList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsCeCostCategoryRuleRuleOrAndDimensionList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsCeCostCategoryRuleRuleOrAndDimensionList) Resolve(context cdktn.IResolveContext) interface{} {
