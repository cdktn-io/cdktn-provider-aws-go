...
func (j *jsiiProxy_QuicksightDataSetLogicalTableMapSourceOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewQuicksightDataSetLogicalTableMapSourceOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) QuicksightDataSetLogicalTableMapSourceOutputReference {
	_init_.Initialize()
...
func NewQuicksightDataSetLogicalTableMapSourceOutputReference_Override(q QuicksightDataSetLogicalTableMapSourceOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_QuicksightDataSetLogicalTableMapSourceOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (q *jsiiProxy_QuicksightDataSetLogicalTableMapSourceOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (q *jsiiProxy_QuicksightDataSetLogicalTableMapSourceOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (q *jsiiProxy_QuicksightDataSetLogicalTableMapSourceOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (q *jsiiProxy_QuicksightDataSetLogicalTableMapSourceOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
