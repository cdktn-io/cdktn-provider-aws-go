...
func (q *jsiiProxy_QuicksightDataSetDataSetUsageConfigurationOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (q *jsiiProxy_QuicksightDataSetDataSetUsageConfigurationOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
