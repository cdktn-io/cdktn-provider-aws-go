...
func (j *jsiiProxy_QuicksightDataSetFieldFoldersList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewQuicksightDataSetFieldFoldersList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) QuicksightDataSetFieldFoldersList {
	_init_.Initialize()
...
func NewQuicksightDataSetFieldFoldersList_Override(q QuicksightDataSetFieldFoldersList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_QuicksightDataSetFieldFoldersList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (q *jsiiProxy_QuicksightDataSetFieldFoldersList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (q *jsiiProxy_QuicksightDataSetFieldFoldersList) Resolve(context cdktn.IResolveContext) interface{} {
