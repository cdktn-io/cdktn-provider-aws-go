...
func (j *jsiiProxy_QuicksightDataSetPhysicalTableMapCustomSqlColumnsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewQuicksightDataSetPhysicalTableMapCustomSqlColumnsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) QuicksightDataSetPhysicalTableMapCustomSqlColumnsOutputReference {
	_init_.Initialize()
...
func NewQuicksightDataSetPhysicalTableMapCustomSqlColumnsOutputReference_Override(q QuicksightDataSetPhysicalTableMapCustomSqlColumnsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_QuicksightDataSetPhysicalTableMapCustomSqlColumnsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (q *jsiiProxy_QuicksightDataSetPhysicalTableMapCustomSqlColumnsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (q *jsiiProxy_QuicksightDataSetPhysicalTableMapCustomSqlColumnsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (q *jsiiProxy_QuicksightDataSetPhysicalTableMapCustomSqlColumnsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (q *jsiiProxy_QuicksightDataSetPhysicalTableMapCustomSqlColumnsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
