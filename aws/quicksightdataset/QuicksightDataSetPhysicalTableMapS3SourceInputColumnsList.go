...
func (j *jsiiProxy_QuicksightDataSetPhysicalTableMapS3SourceInputColumnsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewQuicksightDataSetPhysicalTableMapS3SourceInputColumnsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) QuicksightDataSetPhysicalTableMapS3SourceInputColumnsList {
	_init_.Initialize()
...
func NewQuicksightDataSetPhysicalTableMapS3SourceInputColumnsList_Override(q QuicksightDataSetPhysicalTableMapS3SourceInputColumnsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_QuicksightDataSetPhysicalTableMapS3SourceInputColumnsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (q *jsiiProxy_QuicksightDataSetPhysicalTableMapS3SourceInputColumnsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (q *jsiiProxy_QuicksightDataSetPhysicalTableMapS3SourceInputColumnsList) Resolve(context cdktn.IResolveContext) interface{} {
