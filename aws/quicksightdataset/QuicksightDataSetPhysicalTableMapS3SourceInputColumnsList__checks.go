...
func (j *jsiiProxy_QuicksightDataSetPhysicalTableMapS3SourceInputColumnsList) validateSetInternalValueParameters(val interface{}) error {
	switch val.(type) {
...
func (j *jsiiProxy_QuicksightDataSetPhysicalTableMapS3SourceInputColumnsList) validateSetTerraformAttributeParameters(val *string) error {
	if val == nil {
...
func (j *jsiiProxy_QuicksightDataSetPhysicalTableMapS3SourceInputColumnsList) validateSetTerraformResourceParameters(val cdktf.IInterpolatingParent) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func (j *jsiiProxy_QuicksightDataSetPhysicalTableMapS3SourceInputColumnsList) validateSetWrapsSetParameters(val *bool) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func validateNewQuicksightDataSetPhysicalTableMapS3SourceInputColumnsListParameters(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) error {
