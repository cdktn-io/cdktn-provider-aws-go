...
func (j *jsiiProxy_QuicksightDataSetPhysicalTableMapS3SourceOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewQuicksightDataSetPhysicalTableMapS3SourceOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) QuicksightDataSetPhysicalTableMapS3SourceOutputReference {
	_init_.Initialize()
...
func NewQuicksightDataSetPhysicalTableMapS3SourceOutputReference_Override(q QuicksightDataSetPhysicalTableMapS3SourceOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_QuicksightDataSetPhysicalTableMapS3SourceOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (q *jsiiProxy_QuicksightDataSetPhysicalTableMapS3SourceOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (q *jsiiProxy_QuicksightDataSetPhysicalTableMapS3SourceOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (q *jsiiProxy_QuicksightDataSetPhysicalTableMapS3SourceOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (q *jsiiProxy_QuicksightDataSetPhysicalTableMapS3SourceOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
