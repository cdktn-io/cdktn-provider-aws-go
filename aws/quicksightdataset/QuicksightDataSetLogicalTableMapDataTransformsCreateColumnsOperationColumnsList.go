...
func (j *jsiiProxy_QuicksightDataSetLogicalTableMapDataTransformsCreateColumnsOperationColumnsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewQuicksightDataSetLogicalTableMapDataTransformsCreateColumnsOperationColumnsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) QuicksightDataSetLogicalTableMapDataTransformsCreateColumnsOperationColumnsList {
	_init_.Initialize()
...
func NewQuicksightDataSetLogicalTableMapDataTransformsCreateColumnsOperationColumnsList_Override(q QuicksightDataSetLogicalTableMapDataTransformsCreateColumnsOperationColumnsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_QuicksightDataSetLogicalTableMapDataTransformsCreateColumnsOperationColumnsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (q *jsiiProxy_QuicksightDataSetLogicalTableMapDataTransformsCreateColumnsOperationColumnsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (q *jsiiProxy_QuicksightDataSetLogicalTableMapDataTransformsCreateColumnsOperationColumnsList) Resolve(context cdktn.IResolveContext) interface{} {
