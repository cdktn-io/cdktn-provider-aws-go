...
func (j *jsiiProxy_QuicksightDataSetLogicalTableMapDataTransformsTagColumnOperationOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewQuicksightDataSetLogicalTableMapDataTransformsTagColumnOperationOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) QuicksightDataSetLogicalTableMapDataTransformsTagColumnOperationOutputReference {
	_init_.Initialize()
...
func NewQuicksightDataSetLogicalTableMapDataTransformsTagColumnOperationOutputReference_Override(q QuicksightDataSetLogicalTableMapDataTransformsTagColumnOperationOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_QuicksightDataSetLogicalTableMapDataTransformsTagColumnOperationOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (q *jsiiProxy_QuicksightDataSetLogicalTableMapDataTransformsTagColumnOperationOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (q *jsiiProxy_QuicksightDataSetLogicalTableMapDataTransformsTagColumnOperationOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (q *jsiiProxy_QuicksightDataSetLogicalTableMapDataTransformsTagColumnOperationOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (q *jsiiProxy_QuicksightDataSetLogicalTableMapDataTransformsTagColumnOperationOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
