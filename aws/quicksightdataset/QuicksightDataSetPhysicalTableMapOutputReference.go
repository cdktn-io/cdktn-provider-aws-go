...
func (j *jsiiProxy_QuicksightDataSetPhysicalTableMapOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewQuicksightDataSetPhysicalTableMapOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) QuicksightDataSetPhysicalTableMapOutputReference {
	_init_.Initialize()
...
func NewQuicksightDataSetPhysicalTableMapOutputReference_Override(q QuicksightDataSetPhysicalTableMapOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_QuicksightDataSetPhysicalTableMapOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (q *jsiiProxy_QuicksightDataSetPhysicalTableMapOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (q *jsiiProxy_QuicksightDataSetPhysicalTableMapOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (q *jsiiProxy_QuicksightDataSetPhysicalTableMapOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (q *jsiiProxy_QuicksightDataSetPhysicalTableMapOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
