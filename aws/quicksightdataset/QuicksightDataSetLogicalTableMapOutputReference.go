...
func (j *jsiiProxy_QuicksightDataSetLogicalTableMapOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewQuicksightDataSetLogicalTableMapOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) QuicksightDataSetLogicalTableMapOutputReference {
	_init_.Initialize()
...
func NewQuicksightDataSetLogicalTableMapOutputReference_Override(q QuicksightDataSetLogicalTableMapOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_QuicksightDataSetLogicalTableMapOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (q *jsiiProxy_QuicksightDataSetLogicalTableMapOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (q *jsiiProxy_QuicksightDataSetLogicalTableMapOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (q *jsiiProxy_QuicksightDataSetLogicalTableMapOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (q *jsiiProxy_QuicksightDataSetLogicalTableMapOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
