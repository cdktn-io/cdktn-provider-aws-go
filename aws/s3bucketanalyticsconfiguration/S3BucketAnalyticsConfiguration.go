...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/s3_bucket_analytics_configuration aws_s3_bucket_analytics_configuration}.
...
func (j *jsiiProxy_S3BucketAnalyticsConfiguration) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_S3BucketAnalyticsConfiguration) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_S3BucketAnalyticsConfiguration) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_S3BucketAnalyticsConfiguration) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_S3BucketAnalyticsConfiguration) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/s3_bucket_analytics_configuration aws_s3_bucket_analytics_configuration} Resource.
...
func (j *jsiiProxy_S3BucketAnalyticsConfiguration)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_S3BucketAnalyticsConfiguration)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_S3BucketAnalyticsConfiguration)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func S3BucketAnalyticsConfiguration_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (s *jsiiProxy_S3BucketAnalyticsConfiguration) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_S3BucketAnalyticsConfiguration) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_S3BucketAnalyticsConfiguration) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_S3BucketAnalyticsConfiguration) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_S3BucketAnalyticsConfiguration) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_S3BucketAnalyticsConfiguration) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
