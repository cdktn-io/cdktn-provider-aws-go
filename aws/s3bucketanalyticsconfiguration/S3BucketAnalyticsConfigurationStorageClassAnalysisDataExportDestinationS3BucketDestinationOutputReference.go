...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v22/s3bucketanalyticsconfiguration/internal"
...
func (s *jsiiProxy_S3BucketAnalyticsConfigurationStorageClassAnalysisDataExportDestinationS3BucketDestinationOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_S3BucketAnalyticsConfigurationStorageClassAnalysisDataExportDestinationS3BucketDestinationOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
