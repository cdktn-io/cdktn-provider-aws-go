...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/apigatewayresource/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/api_gateway_resource aws_api_gateway_resource}.
...
func (j *jsiiProxy_ApiGatewayResource) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_ApiGatewayResource) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_ApiGatewayResource) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_ApiGatewayResource) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_ApiGatewayResource) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_ApiGatewayResource) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_ApiGatewayResource) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/api_gateway_resource aws_api_gateway_resource} Resource.
func NewApiGatewayResource(scope constructs.Construct, id *string, config *ApiGatewayResourceConfig) ApiGatewayResource {
	...
	_jsii_.Create(
		"@cdktn/provider-aws.apiGatewayResource.ApiGatewayResource",
...
func (j *jsiiProxy_ApiGatewayResource)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_ApiGatewayResource)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_ApiGatewayResource)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_ApiGatewayResource)SetRegion(val *string) {
...
func ApiGatewayResource_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateApiGatewayResource_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
// Experimental.
func ApiGatewayResource_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateApiGatewayResource_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func ApiGatewayResource_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateApiGatewayResource_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (a *jsiiProxy_ApiGatewayResource) AddMoveTarget(moveTarget *string) {
...
func (a *jsiiProxy_ApiGatewayResource) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_ApiGatewayResource) HasResourceMove() interface{} {
	var returns interface{}
...
func (a *jsiiProxy_ApiGatewayResource) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (a *jsiiProxy_ApiGatewayResource) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_ApiGatewayResource) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (a *jsiiProxy_ApiGatewayResource) MoveFromId(id *string) {
...
func (a *jsiiProxy_ApiGatewayResource) MoveTo(moveTarget *string, index interface{}) {
...
func (a *jsiiProxy_ApiGatewayResource) MoveToId(id *string) {
...
func (a *jsiiProxy_ApiGatewayResource) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (a *jsiiProxy_ApiGatewayResource) ResetRegion() {
	_jsii_.InvokeVoid(
		a,
		"resetRegion",
		nil, // no parameters
...
func (a *jsiiProxy_ApiGatewayResource) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (a *jsiiProxy_ApiGatewayResource) ToHclTerraform() interface{} {
	var returns interface{}
...
func (a *jsiiProxy_ApiGatewayResource) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
