...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/dataawslexbot/internal"
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/data-sources/lex_bot aws_lex_bot} Data Source.
...
func (d *jsiiProxy_DataAwsLexBot) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsLexBot) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
