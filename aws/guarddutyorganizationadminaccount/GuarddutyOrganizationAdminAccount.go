...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/guarddutyorganizationadminaccount/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/guardduty_organization_admin_account aws_guardduty_organization_admin_account}.
...
func (j *jsiiProxy_GuarddutyOrganizationAdminAccount) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_GuarddutyOrganizationAdminAccount) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_GuarddutyOrganizationAdminAccount) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_GuarddutyOrganizationAdminAccount) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_GuarddutyOrganizationAdminAccount) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_GuarddutyOrganizationAdminAccount) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_GuarddutyOrganizationAdminAccount) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/guardduty_organization_admin_account aws_guardduty_organization_admin_account} Resource.
func NewGuarddutyOrganizationAdminAccount(scope constructs.Construct, id *string, config *GuarddutyOrganizationAdminAccountConfig) GuarddutyOrganizationAdminAccount {
	...
	_jsii_.Create(
		"@cdktn/provider-aws.guarddutyOrganizationAdminAccount.GuarddutyOrganizationAdminAccount",
...
func (j *jsiiProxy_GuarddutyOrganizationAdminAccount)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_GuarddutyOrganizationAdminAccount)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_GuarddutyOrganizationAdminAccount)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_GuarddutyOrganizationAdminAccount)SetRegion(val *string) {
...
// Generates CDKTN code for importing a GuarddutyOrganizationAdminAccount resource upon running "cdktn plan <stack-name>".
func GuarddutyOrganizationAdminAccount_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (g *jsiiProxy_GuarddutyOrganizationAdminAccount) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GuarddutyOrganizationAdminAccount) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (g *jsiiProxy_GuarddutyOrganizationAdminAccount) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GuarddutyOrganizationAdminAccount) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GuarddutyOrganizationAdminAccount) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (g *jsiiProxy_GuarddutyOrganizationAdminAccount) ResetRegion() {
	_jsii_.InvokeVoid(
		g,
		"resetRegion",
		nil, // no parameters
...
func (g *jsiiProxy_GuarddutyOrganizationAdminAccount) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
