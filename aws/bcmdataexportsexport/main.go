...
func init() {
	_jsii_.RegisterClass(
		...
		func() interface{} {
			j := jsiiProxy_BcmdataexportsExport{}
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetTableConfigurations", GoMethod: "ResetTableConfigurations"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "tableConfigurations", GoGetter: "TableConfigurations"},
			_jsii_.MemberProperty{JsiiProperty: "tableConfigurationsInput", GoGetter: "TableConfigurationsInput"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
		},
		func() interface{} {
			j := jsiiProxy_BcmdataexportsExportExportDataQueryOutputReference{}
	...
	_jsii_.RegisterClass(
		...
		func() interface{} {
			j := jsiiProxy_BcmdataexportsExportExportDestinationConfigurationsS3DestinationList{}
			_jsii_.InitJsiiProxy(&j.Type__cdktfComplexList)
			return &j
		},
	)
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "interpolationAsList", GoMethod: "InterpolationAsList"},
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "putS3OutputConfigurations", GoMethod: "PutS3OutputConfigurations"},
			_jsii_.MemberMethod{JsiiMethod: "resetS3OutputConfigurations", GoMethod: "ResetS3OutputConfigurations"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			...
			_jsii_.MemberProperty{JsiiProperty: "s3OutputConfigurations", GoGetter: "S3OutputConfigurations"},
			_jsii_.MemberProperty{JsiiProperty: "s3OutputConfigurationsInput", GoGetter: "S3OutputConfigurationsInput"},
	...
	_jsii_.RegisterClass(
		...
		func() interface{} {
			j := jsiiProxy_BcmdataexportsExportExportList{}
			_jsii_.InitJsiiProxy(&j.Type__cdktfComplexList)
			return &j
		},
	)
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
			_jsii_.MemberProperty{JsiiProperty: "dataQuery", GoGetter: "DataQuery"},
			_jsii_.MemberProperty{JsiiProperty: "dataQueryInput", GoGetter: "DataQueryInput"},
			_jsii_.MemberProperty{JsiiProperty: "description", GoGetter: "Description"},
			_jsii_.MemberProperty{JsiiProperty: "descriptionInput", GoGetter: "DescriptionInput"},
			_jsii_.MemberProperty{JsiiProperty: "destinationConfigurations", GoGetter: "DestinationConfigurations"},
			_jsii_.MemberProperty{JsiiProperty: "destinationConfigurationsInput", GoGetter: "DestinationConfigurationsInput"},
			_jsii_.MemberProperty{JsiiProperty: "exportArn", GoGetter: "ExportArn"},
			_jsii_.MemberProperty{JsiiProperty: "fqn", GoGetter: "Fqn"},
			_jsii_.MemberMethod{JsiiMethod: "getAnyMapAttribute", GoMethod: "GetAnyMapAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getBooleanAttribute", GoMethod: "GetBooleanAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getBooleanMapAttribute", GoMethod: "GetBooleanMapAttribute"},
			...
			_jsii_.MemberMethod{JsiiMethod: "putDataQuery", GoMethod: "PutDataQuery"},
			_jsii_.MemberMethod{JsiiMethod: "putDestinationConfigurations", GoMethod: "PutDestinationConfigurations"},
			_jsii_.MemberMethod{JsiiMethod: "putRefreshCadence", GoMethod: "PutRefreshCadence"},
			_jsii_.MemberProperty{JsiiProperty: "refreshCadence", GoGetter: "RefreshCadence"},
			_jsii_.MemberProperty{JsiiProperty: "refreshCadenceInput", GoGetter: "RefreshCadenceInput"},
			_jsii_.MemberMethod{JsiiMethod: "resetDataQuery", GoMethod: "ResetDataQuery"},
			_jsii_.MemberMethod{JsiiMethod: "resetDescription", GoMethod: "ResetDescription"},
			_jsii_.MemberMethod{JsiiMethod: "resetDestinationConfigurations", GoMethod: "ResetDestinationConfigurations"},
			_jsii_.MemberMethod{JsiiMethod: "resetRefreshCadence", GoMethod: "ResetRefreshCadence"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
	...
	_jsii_.RegisterClass(
		...
		func() interface{} {
			j := jsiiProxy_BcmdataexportsExportExportRefreshCadenceOutputReference{}
			_jsii_.InitJsiiProxy(&j.Type__cdktfComplexObject)
			return &j
		},
	)
