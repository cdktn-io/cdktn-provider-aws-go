...
func (b *jsiiProxy_BcmdataexportsExportExportDestinationConfigurationsS3DestinationS3OutputConfigurationsList) Resolve(context cdktf.IResolveContext) interface{} {
