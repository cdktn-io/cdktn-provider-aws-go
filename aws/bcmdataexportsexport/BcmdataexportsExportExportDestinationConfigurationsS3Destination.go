...
type BcmdataexportsExportExportDestinationConfigurationsS3Destination struct {
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.32.1/docs/resources/bcmdataexports_export#s3_bucket BcmdataexportsExport#s3_bucket}.
	S3Bucket *string `field:"required" json:"s3Bucket" yaml:"s3Bucket"`
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.32.1/docs/resources/bcmdataexports_export#s3_prefix BcmdataexportsExport#s3_prefix}.
	S3Prefix *string `field:"required" json:"s3Prefix" yaml:"s3Prefix"`
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.32.1/docs/resources/bcmdataexports_export#s3_region BcmdataexportsExport#s3_region}.
