...
func (j *jsiiProxy_DataAwsSsoadminPrincipalApplicationAssignmentsApplicationAssignmentsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsSsoadminPrincipalApplicationAssignmentsApplicationAssignmentsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsSsoadminPrincipalApplicationAssignmentsApplicationAssignmentsList {
	_init_.Initialize()
...
func NewDataAwsSsoadminPrincipalApplicationAssignmentsApplicationAssignmentsList_Override(d DataAwsSsoadminPrincipalApplicationAssignmentsApplicationAssignmentsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsSsoadminPrincipalApplicationAssignmentsApplicationAssignmentsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsSsoadminPrincipalApplicationAssignmentsApplicationAssignmentsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsSsoadminPrincipalApplicationAssignmentsApplicationAssignmentsList) Resolve(context cdktn.IResolveContext) interface{} {
