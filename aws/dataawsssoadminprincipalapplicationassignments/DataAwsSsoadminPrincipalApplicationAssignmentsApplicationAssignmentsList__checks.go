...
func (d *jsiiProxy_DataAwsSsoadminPrincipalApplicationAssignmentsApplicationAssignmentsList) validateResolveParameters(context cdktn.IResolveContext) error {
	if context == nil {
...
func (j *jsiiProxy_DataAwsSsoadminPrincipalApplicationAssignmentsApplicationAssignmentsList) validateSetTerraformResourceParameters(val cdktn.IInterpolatingParent) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func validateNewDataAwsSsoadminPrincipalApplicationAssignmentsApplicationAssignmentsListParameters(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) error {
