...
func (d *jsiiProxy_DataAwsSsoadminPrincipalApplicationAssignmentsApplicationAssignmentsList) validateResolveParameters(context cdktf.IResolveContext) error {
	return nil
}
