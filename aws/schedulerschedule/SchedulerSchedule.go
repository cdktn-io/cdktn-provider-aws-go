...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/scheduler_schedule aws_scheduler_schedule}.
...
func (j *jsiiProxy_SchedulerSchedule) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_SchedulerSchedule) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_SchedulerSchedule) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_SchedulerSchedule) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_SchedulerSchedule) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_SchedulerSchedule) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_SchedulerSchedule) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/scheduler_schedule aws_scheduler_schedule} Resource.
...
func (j *jsiiProxy_SchedulerSchedule)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_SchedulerSchedule)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_SchedulerSchedule)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_SchedulerSchedule)SetRegion(val *string) {
...
func SchedulerSchedule_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (s *jsiiProxy_SchedulerSchedule) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SchedulerSchedule) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_SchedulerSchedule) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SchedulerSchedule) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_SchedulerSchedule) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_SchedulerSchedule) ResetRegion() {
	_jsii_.InvokeVoid(
		s,
		"resetRegion",
		nil, // no parameters
...
func (s *jsiiProxy_SchedulerSchedule) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
