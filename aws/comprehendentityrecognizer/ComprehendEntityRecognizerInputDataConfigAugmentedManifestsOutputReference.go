...
func (c *jsiiProxy_ComprehendEntityRecognizerInputDataConfigAugmentedManifestsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ComprehendEntityRecognizerInputDataConfigAugmentedManifestsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
