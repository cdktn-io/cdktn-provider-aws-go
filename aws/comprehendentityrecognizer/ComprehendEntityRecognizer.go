...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/comprehend_entity_recognizer aws_comprehend_entity_recognizer}.
...
func (j *jsiiProxy_ComprehendEntityRecognizer) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_ComprehendEntityRecognizer) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/comprehend_entity_recognizer aws_comprehend_entity_recognizer} Resource.
...
func (j *jsiiProxy_ComprehendEntityRecognizer)SetRegion(val *string) {
...
func (c *jsiiProxy_ComprehendEntityRecognizer) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_ComprehendEntityRecognizer) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (c *jsiiProxy_ComprehendEntityRecognizer) ResetRegion() {
	_jsii_.InvokeVoid(
		c,
		"resetRegion",
		nil, // no parameters
...
func (c *jsiiProxy_ComprehendEntityRecognizer) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
