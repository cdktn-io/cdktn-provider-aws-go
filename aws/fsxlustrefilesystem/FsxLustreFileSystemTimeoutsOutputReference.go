...
func (f *jsiiProxy_FsxLustreFileSystemTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (f *jsiiProxy_FsxLustreFileSystemTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
