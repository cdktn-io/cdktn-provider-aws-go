...
type FsxLustreFileSystemConfig struct {
	...
	DataReadCacheConfiguration *FsxLustreFileSystemDataReadCacheConfiguration `field:"optional" json:"dataReadCacheConfiguration" yaml:"dataReadCacheConfiguration"`
