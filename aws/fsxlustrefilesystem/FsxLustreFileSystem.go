...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/fsx_lustre_file_system aws_fsx_lustre_file_system}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/fsx_lustre_file_system aws_fsx_lustre_file_system} Resource.
...
func (f *jsiiProxy_FsxLustreFileSystem) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (f *jsiiProxy_FsxLustreFileSystem) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (f *jsiiProxy_FsxLustreFileSystem) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
