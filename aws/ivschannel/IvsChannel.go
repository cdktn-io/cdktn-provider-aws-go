...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/ivschannel/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/ivs_channel aws_ivs_channel}.
...
func (j *jsiiProxy_IvsChannel) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_IvsChannel) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_IvsChannel) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_IvsChannel) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_IvsChannel) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/ivs_channel aws_ivs_channel} Resource.
...
func (j *jsiiProxy_IvsChannel)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_IvsChannel)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_IvsChannel)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func IvsChannel_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (i *jsiiProxy_IvsChannel) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (i *jsiiProxy_IvsChannel) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (i *jsiiProxy_IvsChannel) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (i *jsiiProxy_IvsChannel) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (i *jsiiProxy_IvsChannel) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (i *jsiiProxy_IvsChannel) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
