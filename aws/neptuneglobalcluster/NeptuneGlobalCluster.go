...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v22/neptuneglobalcluster/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.31.0/docs/resources/neptune_global_cluster aws_neptune_global_cluster}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.31.0/docs/resources/neptune_global_cluster aws_neptune_global_cluster} Resource.
...
func NeptuneGlobalCluster_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
