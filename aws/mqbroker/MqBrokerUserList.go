...
func (j *jsiiProxy_MqBrokerUserList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewMqBrokerUserList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) MqBrokerUserList {
	_init_.Initialize()
...
func NewMqBrokerUserList_Override(m MqBrokerUserList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_MqBrokerUserList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (m *jsiiProxy_MqBrokerUserList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (m *jsiiProxy_MqBrokerUserList) Resolve(context cdktn.IResolveContext) interface{} {
