...
func (m *jsiiProxy_MqBrokerInstancesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (m *jsiiProxy_MqBrokerInstancesOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
