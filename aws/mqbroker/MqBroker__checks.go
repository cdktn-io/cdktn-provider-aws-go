...
func (m *jsiiProxy_MqBroker) validatePutUserParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*MqBrokerUser; received %#v (a %T)", value, value)
		}
	}
