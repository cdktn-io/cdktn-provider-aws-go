...
func (m *jsiiProxy_MqBrokerEncryptionOptionsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (m *jsiiProxy_MqBrokerEncryptionOptionsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
