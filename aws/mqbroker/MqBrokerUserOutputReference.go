...
func (j *jsiiProxy_MqBrokerUserOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewMqBrokerUserOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) MqBrokerUserOutputReference {
	_init_.Initialize()

	if err := validateNewMqBrokerUserOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func NewMqBrokerUserOutputReference_Override(m MqBrokerUserOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_MqBrokerUserOutputReference)SetConsoleAccess(val interface{}) {
	if err := j.validateSetConsoleAccessParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_MqBrokerUserOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (m *jsiiProxy_MqBrokerUserOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MqBrokerUserOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (m *jsiiProxy_MqBrokerUserOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MqBrokerUserOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
