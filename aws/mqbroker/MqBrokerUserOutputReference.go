...
func (m *jsiiProxy_MqBrokerUserOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (m *jsiiProxy_MqBrokerUserOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
