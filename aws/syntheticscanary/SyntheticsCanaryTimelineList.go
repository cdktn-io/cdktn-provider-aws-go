...
func (s *jsiiProxy_SyntheticsCanaryTimelineList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (s *jsiiProxy_SyntheticsCanaryTimelineList) Resolve(context cdktf.IResolveContext) interface{} {
