...
func (j *jsiiProxy_SyntheticsCanaryTimelineList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewSyntheticsCanaryTimelineList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) SyntheticsCanaryTimelineList {
	_init_.Initialize()

	if err := validateNewSyntheticsCanaryTimelineListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewSyntheticsCanaryTimelineList_Override(s SyntheticsCanaryTimelineList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_SyntheticsCanaryTimelineList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_SyntheticsCanaryTimelineList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (s *jsiiProxy_SyntheticsCanaryTimelineList) Resolve(context cdktn.IResolveContext) interface{} {
