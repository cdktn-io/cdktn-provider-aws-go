...
func (s *jsiiProxy_SyntheticsCanaryScheduleOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_SyntheticsCanaryScheduleOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
