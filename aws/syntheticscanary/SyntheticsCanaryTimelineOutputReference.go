...
func (s *jsiiProxy_SyntheticsCanaryTimelineOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_SyntheticsCanaryTimelineOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
