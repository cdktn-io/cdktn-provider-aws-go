...
func (j *jsiiProxy_SyntheticsCanaryArtifactConfigOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewSyntheticsCanaryArtifactConfigOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) SyntheticsCanaryArtifactConfigOutputReference {
	_init_.Initialize()
...
func NewSyntheticsCanaryArtifactConfigOutputReference_Override(s SyntheticsCanaryArtifactConfigOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_SyntheticsCanaryArtifactConfigOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_SyntheticsCanaryArtifactConfigOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SyntheticsCanaryArtifactConfigOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (s *jsiiProxy_SyntheticsCanaryArtifactConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SyntheticsCanaryArtifactConfigOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
