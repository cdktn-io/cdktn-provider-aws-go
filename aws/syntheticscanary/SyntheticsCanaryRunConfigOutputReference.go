...
func (s *jsiiProxy_SyntheticsCanaryRunConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_SyntheticsCanaryRunConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
