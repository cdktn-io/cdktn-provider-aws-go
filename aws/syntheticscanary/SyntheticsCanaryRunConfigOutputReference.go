...
func (j *jsiiProxy_SyntheticsCanaryRunConfigOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewSyntheticsCanaryRunConfigOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) SyntheticsCanaryRunConfigOutputReference {
	_init_.Initialize()
...
func NewSyntheticsCanaryRunConfigOutputReference_Override(s SyntheticsCanaryRunConfigOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_SyntheticsCanaryRunConfigOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_SyntheticsCanaryRunConfigOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SyntheticsCanaryRunConfigOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (s *jsiiProxy_SyntheticsCanaryRunConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SyntheticsCanaryRunConfigOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
