...
func (j *jsiiProxy_SyntheticsCanaryArtifactConfigS3EncryptionOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewSyntheticsCanaryArtifactConfigS3EncryptionOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) SyntheticsCanaryArtifactConfigS3EncryptionOutputReference {
	_init_.Initialize()
...
func NewSyntheticsCanaryArtifactConfigS3EncryptionOutputReference_Override(s SyntheticsCanaryArtifactConfigS3EncryptionOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_SyntheticsCanaryArtifactConfigS3EncryptionOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_SyntheticsCanaryArtifactConfigS3EncryptionOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SyntheticsCanaryArtifactConfigS3EncryptionOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (s *jsiiProxy_SyntheticsCanaryArtifactConfigS3EncryptionOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SyntheticsCanaryArtifactConfigS3EncryptionOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
