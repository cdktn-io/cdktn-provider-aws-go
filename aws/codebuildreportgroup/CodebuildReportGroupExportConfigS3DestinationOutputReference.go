...
func (j *jsiiProxy_CodebuildReportGroupExportConfigS3DestinationOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewCodebuildReportGroupExportConfigS3DestinationOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) CodebuildReportGroupExportConfigS3DestinationOutputReference {
	_init_.Initialize()
...
func NewCodebuildReportGroupExportConfigS3DestinationOutputReference_Override(c CodebuildReportGroupExportConfigS3DestinationOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_CodebuildReportGroupExportConfigS3DestinationOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_CodebuildReportGroupExportConfigS3DestinationOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CodebuildReportGroupExportConfigS3DestinationOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (c *jsiiProxy_CodebuildReportGroupExportConfigS3DestinationOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CodebuildReportGroupExportConfigS3DestinationOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
