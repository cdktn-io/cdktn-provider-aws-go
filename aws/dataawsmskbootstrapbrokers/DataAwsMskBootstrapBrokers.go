...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/dataawsmskbootstrapbrokers/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/data-sources/msk_bootstrap_brokers aws_msk_bootstrap_brokers}.
...
func (j *jsiiProxy_DataAwsMskBootstrapBrokers) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsMskBootstrapBrokers) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsMskBootstrapBrokers) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsMskBootstrapBrokers) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsMskBootstrapBrokers) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/data-sources/msk_bootstrap_brokers aws_msk_bootstrap_brokers} Data Source.
func NewDataAwsMskBootstrapBrokers(scope constructs.Construct, id *string, config *DataAwsMskBootstrapBrokersConfig) DataAwsMskBootstrapBrokers {
	...
	_jsii_.Create(
		"@cdktn/provider-aws.dataAwsMskBootstrapBrokers.DataAwsMskBootstrapBrokers",
...
func (j *jsiiProxy_DataAwsMskBootstrapBrokers)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsMskBootstrapBrokers)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsMskBootstrapBrokers)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
// Generates CDKTN code for importing a DataAwsMskBootstrapBrokers resource upon running "cdktn plan <stack-name>".
func DataAwsMskBootstrapBrokers_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsMskBootstrapBrokers) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsMskBootstrapBrokers) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsMskBootstrapBrokers) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsMskBootstrapBrokers) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
