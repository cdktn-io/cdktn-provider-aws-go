...
func (j *jsiiProxy_DataAwsCognitoUserPoolLambdaConfigOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsCognitoUserPoolLambdaConfigOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) DataAwsCognitoUserPoolLambdaConfigOutputReference {
	_init_.Initialize()
...
func NewDataAwsCognitoUserPoolLambdaConfigOutputReference_Override(d DataAwsCognitoUserPoolLambdaConfigOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsCognitoUserPoolLambdaConfigOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsCognitoUserPoolLambdaConfigOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsCognitoUserPoolLambdaConfigOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (d *jsiiProxy_DataAwsCognitoUserPoolLambdaConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsCognitoUserPoolLambdaConfigOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
