...
func (d *jsiiProxy_DataAwsCognitoUserPoolAdminCreateUserConfigInviteMessageTemplateOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataAwsCognitoUserPoolAdminCreateUserConfigInviteMessageTemplateOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
