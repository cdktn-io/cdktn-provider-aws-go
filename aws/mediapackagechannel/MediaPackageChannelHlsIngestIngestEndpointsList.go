...
func (j *jsiiProxy_MediaPackageChannelHlsIngestIngestEndpointsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewMediaPackageChannelHlsIngestIngestEndpointsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) MediaPackageChannelHlsIngestIngestEndpointsList {
	_init_.Initialize()
...
func NewMediaPackageChannelHlsIngestIngestEndpointsList_Override(m MediaPackageChannelHlsIngestIngestEndpointsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_MediaPackageChannelHlsIngestIngestEndpointsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (m *jsiiProxy_MediaPackageChannelHlsIngestIngestEndpointsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (m *jsiiProxy_MediaPackageChannelHlsIngestIngestEndpointsList) Resolve(context cdktn.IResolveContext) interface{} {
