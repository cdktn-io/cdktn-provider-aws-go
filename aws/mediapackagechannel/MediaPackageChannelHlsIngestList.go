...
func (j *jsiiProxy_MediaPackageChannelHlsIngestList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewMediaPackageChannelHlsIngestList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) MediaPackageChannelHlsIngestList {
	_init_.Initialize()
...
func NewMediaPackageChannelHlsIngestList_Override(m MediaPackageChannelHlsIngestList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_MediaPackageChannelHlsIngestList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (m *jsiiProxy_MediaPackageChannelHlsIngestList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (m *jsiiProxy_MediaPackageChannelHlsIngestList) Resolve(context cdktn.IResolveContext) interface{} {
