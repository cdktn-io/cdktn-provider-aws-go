...
func (j *jsiiProxy_TransferConnector) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_TransferConnector) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_TransferConnector)SetRegion(val *string) {
...
func (t *jsiiProxy_TransferConnector) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (t *jsiiProxy_TransferConnector) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (t *jsiiProxy_TransferConnector) ResetRegion() {
	_jsii_.InvokeVoid(
		t,
		"resetRegion",
		nil, // no parameters
...
func (t *jsiiProxy_TransferConnector) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
