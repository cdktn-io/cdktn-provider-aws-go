...
func (j *jsiiProxy_TransferConnectorEgressConfigVpcLatticeOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewTransferConnectorEgressConfigVpcLatticeOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) TransferConnectorEgressConfigVpcLatticeOutputReference {
	_init_.Initialize()
...
func NewTransferConnectorEgressConfigVpcLatticeOutputReference_Override(t TransferConnectorEgressConfigVpcLatticeOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_TransferConnectorEgressConfigVpcLatticeOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (t *jsiiProxy_TransferConnectorEgressConfigVpcLatticeOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (t *jsiiProxy_TransferConnectorEgressConfigVpcLatticeOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (t *jsiiProxy_TransferConnectorEgressConfigVpcLatticeOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (t *jsiiProxy_TransferConnectorEgressConfigVpcLatticeOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
