...
func (s *jsiiProxy_SagemakerHumanTaskUiUiTemplateOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_SagemakerHumanTaskUiUiTemplateOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
