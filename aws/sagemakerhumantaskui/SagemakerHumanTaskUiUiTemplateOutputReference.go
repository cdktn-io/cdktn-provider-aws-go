...
func (j *jsiiProxy_SagemakerHumanTaskUiUiTemplateOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewSagemakerHumanTaskUiUiTemplateOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) SagemakerHumanTaskUiUiTemplateOutputReference {
	_init_.Initialize()
...
func NewSagemakerHumanTaskUiUiTemplateOutputReference_Override(s SagemakerHumanTaskUiUiTemplateOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_SagemakerHumanTaskUiUiTemplateOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_SagemakerHumanTaskUiUiTemplateOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SagemakerHumanTaskUiUiTemplateOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (s *jsiiProxy_SagemakerHumanTaskUiUiTemplateOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SagemakerHumanTaskUiUiTemplateOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
