...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/sagemakerhumantaskui/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/sagemaker_human_task_ui aws_sagemaker_human_task_ui}.
...
func (j *jsiiProxy_SagemakerHumanTaskUi) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_SagemakerHumanTaskUi) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_SagemakerHumanTaskUi) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_SagemakerHumanTaskUi) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_SagemakerHumanTaskUi) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/sagemaker_human_task_ui aws_sagemaker_human_task_ui} Resource.
...
func (j *jsiiProxy_SagemakerHumanTaskUi)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_SagemakerHumanTaskUi)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_SagemakerHumanTaskUi)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func SagemakerHumanTaskUi_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateSagemakerHumanTaskUi_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_SagemakerHumanTaskUi) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_SagemakerHumanTaskUi) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SagemakerHumanTaskUi) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_SagemakerHumanTaskUi) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SagemakerHumanTaskUi) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_SagemakerHumanTaskUi) MoveFromId(id *string) {
...
func (s *jsiiProxy_SagemakerHumanTaskUi) MoveToId(id *string) {
...
func (s *jsiiProxy_SagemakerHumanTaskUi) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_SagemakerHumanTaskUi) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
