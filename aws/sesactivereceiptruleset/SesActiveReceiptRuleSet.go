...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/sesactivereceiptruleset/internal"
...
func (j *jsiiProxy_SesActiveReceiptRuleSet) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_SesActiveReceiptRuleSet) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_SesActiveReceiptRuleSet) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_SesActiveReceiptRuleSet) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_SesActiveReceiptRuleSet) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/ses_active_receipt_rule_set aws_ses_active_receipt_rule_set} Resource.
func NewSesActiveReceiptRuleSet(scope constructs.Construct, id *string, config *SesActiveReceiptRuleSetConfig) SesActiveReceiptRuleSet {
	...
	_jsii_.Create(
		"@cdktn/provider-aws.sesActiveReceiptRuleSet.SesActiveReceiptRuleSet",
...
func (j *jsiiProxy_SesActiveReceiptRuleSet)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_SesActiveReceiptRuleSet)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_SesActiveReceiptRuleSet)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func SesActiveReceiptRuleSet_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (s *jsiiProxy_SesActiveReceiptRuleSet) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SesActiveReceiptRuleSet) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_SesActiveReceiptRuleSet) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SesActiveReceiptRuleSet) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_SesActiveReceiptRuleSet) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_SesActiveReceiptRuleSet) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
