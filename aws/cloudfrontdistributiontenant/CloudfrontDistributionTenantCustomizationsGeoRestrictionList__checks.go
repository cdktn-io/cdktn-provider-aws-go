...
func (c *jsiiProxy_CloudfrontDistributionTenantCustomizationsGeoRestrictionList) validateResolveParameters(context cdktf.IResolveContext) error {
	if context == nil {
...
func (j *jsiiProxy_CloudfrontDistributionTenantCustomizationsGeoRestrictionList) validateSetTerraformResourceParameters(val cdktf.IInterpolatingParent) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func validateNewCloudfrontDistributionTenantCustomizationsGeoRestrictionListParameters(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) error {
