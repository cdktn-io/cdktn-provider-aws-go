...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/xraysamplingrule/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/xray_sampling_rule aws_xray_sampling_rule}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/xray_sampling_rule aws_xray_sampling_rule} Resource.
...
func (x *jsiiProxy_XraySamplingRule) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (x *jsiiProxy_XraySamplingRule) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (x *jsiiProxy_XraySamplingRule) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
