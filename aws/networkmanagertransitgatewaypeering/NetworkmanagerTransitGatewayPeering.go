...
func (j *jsiiProxy_NetworkmanagerTransitGatewayPeering) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_NetworkmanagerTransitGatewayPeering) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_NetworkmanagerTransitGatewayPeering) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_NetworkmanagerTransitGatewayPeering) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_NetworkmanagerTransitGatewayPeering) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_NetworkmanagerTransitGatewayPeering)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_NetworkmanagerTransitGatewayPeering)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_NetworkmanagerTransitGatewayPeering)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func NetworkmanagerTransitGatewayPeering_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (n *jsiiProxy_NetworkmanagerTransitGatewayPeering) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (n *jsiiProxy_NetworkmanagerTransitGatewayPeering) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (n *jsiiProxy_NetworkmanagerTransitGatewayPeering) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (n *jsiiProxy_NetworkmanagerTransitGatewayPeering) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (n *jsiiProxy_NetworkmanagerTransitGatewayPeering) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (n *jsiiProxy_NetworkmanagerTransitGatewayPeering) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
