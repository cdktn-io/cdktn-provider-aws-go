...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/s3controlaccesspointpolicy/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/s3control_access_point_policy aws_s3control_access_point_policy}.
...
func (j *jsiiProxy_S3ControlAccessPointPolicy) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_S3ControlAccessPointPolicy) Connection() interface{} {
...
func (j *jsiiProxy_S3ControlAccessPointPolicy) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_S3ControlAccessPointPolicy) HasPublicAccessPolicy() cdktn.IResolvable {
...
func (j *jsiiProxy_S3ControlAccessPointPolicy) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_S3ControlAccessPointPolicy) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_S3ControlAccessPointPolicy) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_S3ControlAccessPointPolicy) Provisioners() *[]interface{} {
	var returns *[]interface{}
	_jsii_.Get(
		j,
		"provisioners",
...
func (j *jsiiProxy_S3ControlAccessPointPolicy) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/s3control_access_point_policy aws_s3control_access_point_policy} Resource.
func NewS3ControlAccessPointPolicy(scope constructs.Construct, id *string, config *S3ControlAccessPointPolicyConfig) S3ControlAccessPointPolicy {
	...
	if err := validateNewS3ControlAccessPointPolicyParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_S3ControlAccessPointPolicy)SetConnection(val interface{}) {
...
func (j *jsiiProxy_S3ControlAccessPointPolicy)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_S3ControlAccessPointPolicy)SetId(val *string) {
...
func (j *jsiiProxy_S3ControlAccessPointPolicy)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_S3ControlAccessPointPolicy)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_S3ControlAccessPointPolicy)SetProvisioners(val *[]interface{}) {
...
func S3ControlAccessPointPolicy_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateS3ControlAccessPointPolicy_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func S3ControlAccessPointPolicy_IsConstruct(x interface{}) *bool {
	...
	if err := validateS3ControlAccessPointPolicy_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func S3ControlAccessPointPolicy_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateS3ControlAccessPointPolicy_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func S3ControlAccessPointPolicy_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateS3ControlAccessPointPolicy_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (s *jsiiProxy_S3ControlAccessPointPolicy) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_S3ControlAccessPointPolicy) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_S3ControlAccessPointPolicy) HasResourceMove() interface{} {
	var returns interface{}
...
func (s *jsiiProxy_S3ControlAccessPointPolicy) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_S3ControlAccessPointPolicy) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_S3ControlAccessPointPolicy) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_S3ControlAccessPointPolicy) MoveFromId(id *string) {
...
func (s *jsiiProxy_S3ControlAccessPointPolicy) MoveTo(moveTarget *string, index interface{}) {
...
func (s *jsiiProxy_S3ControlAccessPointPolicy) MoveToId(id *string) {
...
func (s *jsiiProxy_S3ControlAccessPointPolicy) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_S3ControlAccessPointPolicy) ResetId() {
	_jsii_.InvokeVoid(
		s,
		"resetId",
		nil, // no parameters
...
func (s *jsiiProxy_S3ControlAccessPointPolicy) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (s *jsiiProxy_S3ControlAccessPointPolicy) ToHclTerraform() interface{} {
	var returns interface{}
...
func (s *jsiiProxy_S3ControlAccessPointPolicy) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
