...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v21/vpcendpointsecuritygroupassociation/internal"
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.28.0/docs/resources/vpc_endpoint_security_group_association aws_vpc_endpoint_security_group_association} Resource.
...
func VpcEndpointSecurityGroupAssociation_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (v *jsiiProxy_VpcEndpointSecurityGroupAssociation) ImportFrom(id *string, provider cdktf.TerraformProvider) {
