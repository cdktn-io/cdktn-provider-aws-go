...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/vpcendpointsecuritygroupassociation/internal"
...
func (j *jsiiProxy_VpcEndpointSecurityGroupAssociation) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_VpcEndpointSecurityGroupAssociation) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_VpcEndpointSecurityGroupAssociation) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_VpcEndpointSecurityGroupAssociation) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_VpcEndpointSecurityGroupAssociation) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_VpcEndpointSecurityGroupAssociation) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/vpc_endpoint_security_group_association aws_vpc_endpoint_security_group_association} Resource.
func NewVpcEndpointSecurityGroupAssociation(scope constructs.Construct, id *string, config *VpcEndpointSecurityGroupAssociationConfig) VpcEndpointSecurityGroupAssociation {
	...
	_jsii_.Create(
		"@cdktn/provider-aws.vpcEndpointSecurityGroupAssociation.VpcEndpointSecurityGroupAssociation",
...
func (j *jsiiProxy_VpcEndpointSecurityGroupAssociation)SetCount(val interface{}) {
...
func (j *jsiiProxy_VpcEndpointSecurityGroupAssociation)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_VpcEndpointSecurityGroupAssociation)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_VpcEndpointSecurityGroupAssociation)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func VpcEndpointSecurityGroupAssociation_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateVpcEndpointSecurityGroupAssociation_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (v *jsiiProxy_VpcEndpointSecurityGroupAssociation) AddMoveTarget(moveTarget *string) {
...
func (v *jsiiProxy_VpcEndpointSecurityGroupAssociation) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (v *jsiiProxy_VpcEndpointSecurityGroupAssociation) HasResourceMove() interface{} {
	var returns interface{}
...
func (v *jsiiProxy_VpcEndpointSecurityGroupAssociation) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (v *jsiiProxy_VpcEndpointSecurityGroupAssociation) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (v *jsiiProxy_VpcEndpointSecurityGroupAssociation) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (v *jsiiProxy_VpcEndpointSecurityGroupAssociation) MoveFromId(id *string) {
...
func (v *jsiiProxy_VpcEndpointSecurityGroupAssociation) MoveTo(moveTarget *string, index interface{}) {
...
func (v *jsiiProxy_VpcEndpointSecurityGroupAssociation) MoveToId(id *string) {
...
func (v *jsiiProxy_VpcEndpointSecurityGroupAssociation) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (v *jsiiProxy_VpcEndpointSecurityGroupAssociation) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (v *jsiiProxy_VpcEndpointSecurityGroupAssociation) ToHclTerraform() interface{} {
	var returns interface{}
...
func (v *jsiiProxy_VpcEndpointSecurityGroupAssociation) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
