...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/sfn_state_machine aws_sfn_state_machine} Resource.
...
func (s *jsiiProxy_SfnStateMachine) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_SfnStateMachine) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_SfnStateMachine) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
