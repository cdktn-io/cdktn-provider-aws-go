...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/dataawsapigatewayv2export/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/data-sources/apigatewayv2_export aws_apigatewayv2_export}.
...
func (j *jsiiProxy_DataAwsApigatewayv2Export) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsApigatewayv2Export) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsApigatewayv2Export) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsApigatewayv2Export) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsApigatewayv2Export) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DataAwsApigatewayv2Export) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_DataAwsApigatewayv2Export) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/data-sources/apigatewayv2_export aws_apigatewayv2_export} Data Source.
...
func (j *jsiiProxy_DataAwsApigatewayv2Export)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsApigatewayv2Export)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsApigatewayv2Export)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_DataAwsApigatewayv2Export)SetRegion(val *string) {
...
func DataAwsApigatewayv2Export_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsApigatewayv2Export) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsApigatewayv2Export) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsApigatewayv2Export) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsApigatewayv2Export) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsApigatewayv2Export) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
