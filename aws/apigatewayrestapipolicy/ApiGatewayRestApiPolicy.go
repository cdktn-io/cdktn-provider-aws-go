...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/apigatewayrestapipolicy/internal"
...
func (j *jsiiProxy_ApiGatewayRestApiPolicy) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_ApiGatewayRestApiPolicy) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_ApiGatewayRestApiPolicy) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_ApiGatewayRestApiPolicy) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_ApiGatewayRestApiPolicy) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_ApiGatewayRestApiPolicy) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_ApiGatewayRestApiPolicy) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/api_gateway_rest_api_policy aws_api_gateway_rest_api_policy} Resource.
func NewApiGatewayRestApiPolicy(scope constructs.Construct, id *string, config *ApiGatewayRestApiPolicyConfig) ApiGatewayRestApiPolicy {
	...
	if err := validateNewApiGatewayRestApiPolicyParameters(scope, id, config); err != nil {
		panic(err)
	}
	j := jsiiProxy_ApiGatewayRestApiPolicy{}

	_jsii_.Create(
		"@cdktn/provider-aws.apiGatewayRestApiPolicy.ApiGatewayRestApiPolicy",
...
func (j *jsiiProxy_ApiGatewayRestApiPolicy)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_ApiGatewayRestApiPolicy)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_ApiGatewayRestApiPolicy)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_ApiGatewayRestApiPolicy)SetRegion(val *string) {
...
func ApiGatewayRestApiPolicy_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateApiGatewayRestApiPolicy_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func ApiGatewayRestApiPolicy_IsConstruct(x interface{}) *bool {
	...
	if err := validateApiGatewayRestApiPolicy_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func ApiGatewayRestApiPolicy_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateApiGatewayRestApiPolicy_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func ApiGatewayRestApiPolicy_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateApiGatewayRestApiPolicy_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (a *jsiiProxy_ApiGatewayRestApiPolicy) AddMoveTarget(moveTarget *string) {
...
func (a *jsiiProxy_ApiGatewayRestApiPolicy) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_ApiGatewayRestApiPolicy) HasResourceMove() interface{} {
	var returns interface{}
...
func (a *jsiiProxy_ApiGatewayRestApiPolicy) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (a *jsiiProxy_ApiGatewayRestApiPolicy) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_ApiGatewayRestApiPolicy) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (a *jsiiProxy_ApiGatewayRestApiPolicy) MoveFromId(id *string) {
...
func (a *jsiiProxy_ApiGatewayRestApiPolicy) MoveTo(moveTarget *string, index interface{}) {
...
func (a *jsiiProxy_ApiGatewayRestApiPolicy) MoveToId(id *string) {
...
func (a *jsiiProxy_ApiGatewayRestApiPolicy) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (a *jsiiProxy_ApiGatewayRestApiPolicy) ResetRegion() {
	_jsii_.InvokeVoid(
		a,
		"resetRegion",
		nil, // no parameters
...
func (a *jsiiProxy_ApiGatewayRestApiPolicy) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (a *jsiiProxy_ApiGatewayRestApiPolicy) ToHclTerraform() interface{} {
	var returns interface{}
...
func (a *jsiiProxy_ApiGatewayRestApiPolicy) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
