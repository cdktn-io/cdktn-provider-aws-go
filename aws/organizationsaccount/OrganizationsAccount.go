...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/organizationsaccount/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/organizations_account aws_organizations_account}.
...
func (j *jsiiProxy_OrganizationsAccount) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_OrganizationsAccount) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_OrganizationsAccount) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_OrganizationsAccount) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_OrganizationsAccount) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/organizations_account aws_organizations_account} Resource.
...
func (j *jsiiProxy_OrganizationsAccount)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_OrganizationsAccount)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_OrganizationsAccount)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func OrganizationsAccount_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (o *jsiiProxy_OrganizationsAccount) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (o *jsiiProxy_OrganizationsAccount) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (o *jsiiProxy_OrganizationsAccount) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (o *jsiiProxy_OrganizationsAccount) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (o *jsiiProxy_OrganizationsAccount) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (o *jsiiProxy_OrganizationsAccount) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
