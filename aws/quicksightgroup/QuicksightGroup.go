...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/quicksightgroup/internal"
...
func (j *jsiiProxy_QuicksightGroup) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_QuicksightGroup) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_QuicksightGroup) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_QuicksightGroup) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_QuicksightGroup) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/quicksight_group aws_quicksight_group} Resource.
...
func (j *jsiiProxy_QuicksightGroup)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_QuicksightGroup)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_QuicksightGroup)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func QuicksightGroup_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (q *jsiiProxy_QuicksightGroup) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (q *jsiiProxy_QuicksightGroup) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (q *jsiiProxy_QuicksightGroup) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (q *jsiiProxy_QuicksightGroup) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (q *jsiiProxy_QuicksightGroup) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (q *jsiiProxy_QuicksightGroup) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
