...
func (j *jsiiProxy_DataAwsAppmeshRouteSpecHttpRouteMatchQueryParameterList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsAppmeshRouteSpecHttpRouteMatchQueryParameterList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsAppmeshRouteSpecHttpRouteMatchQueryParameterList {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-aws.dataAwsAppmeshRoute.DataAwsAppmeshRouteSpecHttpRouteMatchQueryParameterList",
...
func NewDataAwsAppmeshRouteSpecHttpRouteMatchQueryParameterList_Override(d DataAwsAppmeshRouteSpecHttpRouteMatchQueryParameterList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsAppmeshRouteSpecHttpRouteMatchQueryParameterList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsAppmeshRouteSpecHttpRouteMatchQueryParameterList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsAppmeshRouteSpecHttpRouteMatchQueryParameterList) Resolve(context cdktn.IResolveContext) interface{} {
