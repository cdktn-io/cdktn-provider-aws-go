...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/configconfigurationrecorderstatus/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/config_configuration_recorder_status aws_config_configuration_recorder_status}.
...
func (j *jsiiProxy_ConfigConfigurationRecorderStatus) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_ConfigConfigurationRecorderStatus) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_ConfigConfigurationRecorderStatus) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_ConfigConfigurationRecorderStatus) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_ConfigConfigurationRecorderStatus) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/config_configuration_recorder_status aws_config_configuration_recorder_status} Resource.
func NewConfigConfigurationRecorderStatus(scope constructs.Construct, id *string, config *ConfigConfigurationRecorderStatusConfig) ConfigConfigurationRecorderStatus {
	...
	_jsii_.Create(
		"@cdktn/provider-aws.configConfigurationRecorderStatus.ConfigConfigurationRecorderStatus",
...
func (j *jsiiProxy_ConfigConfigurationRecorderStatus)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_ConfigConfigurationRecorderStatus)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_ConfigConfigurationRecorderStatus)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func ConfigConfigurationRecorderStatus_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateConfigConfigurationRecorderStatus_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (c *jsiiProxy_ConfigConfigurationRecorderStatus) AddMoveTarget(moveTarget *string) {
...
func (c *jsiiProxy_ConfigConfigurationRecorderStatus) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_ConfigConfigurationRecorderStatus) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (c *jsiiProxy_ConfigConfigurationRecorderStatus) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_ConfigConfigurationRecorderStatus) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_ConfigConfigurationRecorderStatus) MoveFromId(id *string) {
...
func (c *jsiiProxy_ConfigConfigurationRecorderStatus) MoveToId(id *string) {
...
func (c *jsiiProxy_ConfigConfigurationRecorderStatus) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (c *jsiiProxy_ConfigConfigurationRecorderStatus) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
