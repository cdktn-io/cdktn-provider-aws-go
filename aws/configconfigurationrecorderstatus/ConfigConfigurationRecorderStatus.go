...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v21/configconfigurationrecorderstatus/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.28.0/docs/resources/config_configuration_recorder_status aws_config_configuration_recorder_status}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.28.0/docs/resources/config_configuration_recorder_status aws_config_configuration_recorder_status} Resource.
...
func ConfigConfigurationRecorderStatus_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (c *jsiiProxy_ConfigConfigurationRecorderStatus) ImportFrom(id *string, provider cdktf.TerraformProvider) {
