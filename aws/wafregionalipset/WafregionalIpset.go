...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/wafregional_ipset aws_wafregional_ipset}.
...
func (j *jsiiProxy_WafregionalIpset) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_WafregionalIpset) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_WafregionalIpset) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_WafregionalIpset) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_WafregionalIpset) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/wafregional_ipset aws_wafregional_ipset} Resource.
...
func (j *jsiiProxy_WafregionalIpset)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_WafregionalIpset)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_WafregionalIpset)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func WafregionalIpset_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (w *jsiiProxy_WafregionalIpset) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_WafregionalIpset) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (w *jsiiProxy_WafregionalIpset) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_WafregionalIpset) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (w *jsiiProxy_WafregionalIpset) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
