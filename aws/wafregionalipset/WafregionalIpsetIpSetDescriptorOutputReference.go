...
func (j *jsiiProxy_WafregionalIpsetIpSetDescriptorOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewWafregionalIpsetIpSetDescriptorOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) WafregionalIpsetIpSetDescriptorOutputReference {
	_init_.Initialize()
...
func NewWafregionalIpsetIpSetDescriptorOutputReference_Override(w WafregionalIpsetIpSetDescriptorOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_WafregionalIpsetIpSetDescriptorOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (w *jsiiProxy_WafregionalIpsetIpSetDescriptorOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_WafregionalIpsetIpSetDescriptorOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (w *jsiiProxy_WafregionalIpsetIpSetDescriptorOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_WafregionalIpsetIpSetDescriptorOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
