...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v21/wafregionalipset/internal"
...
func (w *jsiiProxy_WafregionalIpsetIpSetDescriptorList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (w *jsiiProxy_WafregionalIpsetIpSetDescriptorList) Resolve(context cdktf.IResolveContext) interface{} {
