...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v23/wafregionalipset/internal"
...
func (j *jsiiProxy_WafregionalIpsetIpSetDescriptorList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewWafregionalIpsetIpSetDescriptorList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) WafregionalIpsetIpSetDescriptorList {
	_init_.Initialize()

	if err := validateNewWafregionalIpsetIpSetDescriptorListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewWafregionalIpsetIpSetDescriptorList_Override(w WafregionalIpsetIpSetDescriptorList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_WafregionalIpsetIpSetDescriptorList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (w *jsiiProxy_WafregionalIpsetIpSetDescriptorList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (w *jsiiProxy_WafregionalIpsetIpSetDescriptorList) Resolve(context cdktn.IResolveContext) interface{} {
