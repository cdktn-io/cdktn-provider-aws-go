...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/appconfigconfigurationprofile/internal"
...
func (j *jsiiProxy_AppconfigConfigurationProfile) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_AppconfigConfigurationProfile) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_AppconfigConfigurationProfile) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_AppconfigConfigurationProfile) KmsKeyIdentifier() *string {
	var returns *string
	_jsii_.Get(
		j,
		"kmsKeyIdentifier",
...
func (j *jsiiProxy_AppconfigConfigurationProfile) KmsKeyIdentifierInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_AppconfigConfigurationProfile) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_AppconfigConfigurationProfile) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_AppconfigConfigurationProfile) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_AppconfigConfigurationProfile) Type() *string {
	var returns *string
	_jsii_.Get(
		j,
		"type",
...
func (j *jsiiProxy_AppconfigConfigurationProfile) TypeInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"typeInput",
...
func (j *jsiiProxy_AppconfigConfigurationProfile) Validator() AppconfigConfigurationProfileValidatorList {
	var returns AppconfigConfigurationProfileValidatorList
	_jsii_.Get(
		j,
		"validator",
		&returns,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/appconfig_configuration_profile aws_appconfig_configuration_profile} Resource.
func NewAppconfigConfigurationProfile(scope constructs.Construct, id *string, config *AppconfigConfigurationProfileConfig) AppconfigConfigurationProfile {
	...
	if err := validateNewAppconfigConfigurationProfileParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_AppconfigConfigurationProfile)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_AppconfigConfigurationProfile)SetKmsKeyIdentifier(val *string) {
...
func (j *jsiiProxy_AppconfigConfigurationProfile)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_AppconfigConfigurationProfile)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func AppconfigConfigurationProfile_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateAppconfigConfigurationProfile_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (a *jsiiProxy_AppconfigConfigurationProfile) AddMoveTarget(moveTarget *string) {
...
func (a *jsiiProxy_AppconfigConfigurationProfile) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AppconfigConfigurationProfile) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (a *jsiiProxy_AppconfigConfigurationProfile) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AppconfigConfigurationProfile) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (a *jsiiProxy_AppconfigConfigurationProfile) MoveFromId(id *string) {
...
func (a *jsiiProxy_AppconfigConfigurationProfile) MoveToId(id *string) {
...
func (a *jsiiProxy_AppconfigConfigurationProfile) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (a *jsiiProxy_AppconfigConfigurationProfile) ResetId() {
	_jsii_.InvokeVoid(
		a,
		"resetId",
		nil, // no parameters
...
func (a *jsiiProxy_AppconfigConfigurationProfile) ResetKmsKeyIdentifier() {
	_jsii_.InvokeVoid(
		a,
		"resetKmsKeyIdentifier",
		nil, // no parameters
...
func (a *jsiiProxy_AppconfigConfigurationProfile) ResetType() {
	_jsii_.InvokeVoid(
		a,
		"resetType",
		nil, // no parameters
...
func (a *jsiiProxy_AppconfigConfigurationProfile) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
