...
func (c *jsiiProxy_CodebuildWebhookPullRequestBuildPolicyOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CodebuildWebhookPullRequestBuildPolicyOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
