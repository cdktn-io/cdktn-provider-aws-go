...
func (j *jsiiProxy_CodebuildWebhook) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_CodebuildWebhook) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_CodebuildWebhook) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_CodebuildWebhook) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_CodebuildWebhook) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_CodebuildWebhook) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_CodebuildWebhook) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/codebuild_webhook aws_codebuild_webhook} Resource.
...
func (j *jsiiProxy_CodebuildWebhook)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_CodebuildWebhook)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_CodebuildWebhook)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_CodebuildWebhook)SetRegion(val *string) {
...
func CodebuildWebhook_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (c *jsiiProxy_CodebuildWebhook) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CodebuildWebhook) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (c *jsiiProxy_CodebuildWebhook) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CodebuildWebhook) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_CodebuildWebhook) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (c *jsiiProxy_CodebuildWebhook) ResetRegion() {
	_jsii_.InvokeVoid(
		c,
		"resetRegion",
		nil, // no parameters
...
func (c *jsiiProxy_CodebuildWebhook) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
