...
func (j *jsiiProxy_CodebuildWebhookFilterGroupFilterList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewCodebuildWebhookFilterGroupFilterList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) CodebuildWebhookFilterGroupFilterList {
	_init_.Initialize()
...
func NewCodebuildWebhookFilterGroupFilterList_Override(c CodebuildWebhookFilterGroupFilterList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_CodebuildWebhookFilterGroupFilterList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_CodebuildWebhookFilterGroupFilterList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (c *jsiiProxy_CodebuildWebhookFilterGroupFilterList) Resolve(context cdktn.IResolveContext) interface{} {
