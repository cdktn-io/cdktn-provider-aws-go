...
func (j *jsiiProxy_CodebuildWebhookFilterGroupFilterOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewCodebuildWebhookFilterGroupFilterOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) CodebuildWebhookFilterGroupFilterOutputReference {
	_init_.Initialize()
...
func NewCodebuildWebhookFilterGroupFilterOutputReference_Override(c CodebuildWebhookFilterGroupFilterOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_CodebuildWebhookFilterGroupFilterOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_CodebuildWebhookFilterGroupFilterOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CodebuildWebhookFilterGroupFilterOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (c *jsiiProxy_CodebuildWebhookFilterGroupFilterOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CodebuildWebhookFilterGroupFilterOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
