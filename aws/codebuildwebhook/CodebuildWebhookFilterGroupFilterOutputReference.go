...
func (c *jsiiProxy_CodebuildWebhookFilterGroupFilterOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CodebuildWebhookFilterGroupFilterOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
