...
func (j *jsiiProxy_CodebuildWebhookFilterGroupList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewCodebuildWebhookFilterGroupList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) CodebuildWebhookFilterGroupList {
	_init_.Initialize()
...
func NewCodebuildWebhookFilterGroupList_Override(c CodebuildWebhookFilterGroupList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_CodebuildWebhookFilterGroupList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_CodebuildWebhookFilterGroupList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (c *jsiiProxy_CodebuildWebhookFilterGroupList) Resolve(context cdktn.IResolveContext) interface{} {
