...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/ecrrepositorypolicy/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/ecr_repository_policy aws_ecr_repository_policy}.
...
func (j *jsiiProxy_EcrRepositoryPolicy) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_EcrRepositoryPolicy) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_EcrRepositoryPolicy) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_EcrRepositoryPolicy) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_EcrRepositoryPolicy) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_EcrRepositoryPolicy) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_EcrRepositoryPolicy) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/ecr_repository_policy aws_ecr_repository_policy} Resource.
...
func (j *jsiiProxy_EcrRepositoryPolicy)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_EcrRepositoryPolicy)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_EcrRepositoryPolicy)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_EcrRepositoryPolicy)SetRegion(val *string) {
...
// Generates CDKTN code for importing a EcrRepositoryPolicy resource upon running "cdktn plan <stack-name>".
func EcrRepositoryPolicy_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (e *jsiiProxy_EcrRepositoryPolicy) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (e *jsiiProxy_EcrRepositoryPolicy) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (e *jsiiProxy_EcrRepositoryPolicy) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (e *jsiiProxy_EcrRepositoryPolicy) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (e *jsiiProxy_EcrRepositoryPolicy) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (e *jsiiProxy_EcrRepositoryPolicy) ResetRegion() {
	_jsii_.InvokeVoid(
		e,
		"resetRegion",
		nil, // no parameters
...
func (e *jsiiProxy_EcrRepositoryPolicy) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
