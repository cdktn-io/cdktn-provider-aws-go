...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/sesconfigurationset/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/ses_configuration_set aws_ses_configuration_set}.
...
func (j *jsiiProxy_SesConfigurationSet) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_SesConfigurationSet) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/ses_configuration_set aws_ses_configuration_set} Resource.
...
func (j *jsiiProxy_SesConfigurationSet)SetRegion(val *string) {
...
func (s *jsiiProxy_SesConfigurationSet) ResetRegion() {
	_jsii_.InvokeVoid(
		s,
		"resetRegion",
		nil, // no parameters
