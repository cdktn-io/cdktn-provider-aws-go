...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/dmss3endpoint/internal"
...
func (j *jsiiProxy_DmsS3Endpoint) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DmsS3Endpoint) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DmsS3Endpoint) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DmsS3Endpoint) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DmsS3Endpoint) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DmsS3Endpoint)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DmsS3Endpoint)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DmsS3Endpoint)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DmsS3Endpoint_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DmsS3Endpoint) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DmsS3Endpoint) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (d *jsiiProxy_DmsS3Endpoint) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DmsS3Endpoint) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (d *jsiiProxy_DmsS3Endpoint) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DmsS3Endpoint) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
