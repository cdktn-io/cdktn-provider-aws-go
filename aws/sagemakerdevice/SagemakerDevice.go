...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/sagemakerdevice/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/sagemaker_device aws_sagemaker_device}.
...
func (j *jsiiProxy_SagemakerDevice) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_SagemakerDevice) Connection() interface{} {
...
func (j *jsiiProxy_SagemakerDevice) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_SagemakerDevice) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_SagemakerDevice) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_SagemakerDevice) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_SagemakerDevice) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_SagemakerDevice) Provisioners() *[]interface{} {
	var returns *[]interface{}
	_jsii_.Get(
		j,
		"provisioners",
...
func (j *jsiiProxy_SagemakerDevice) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_SagemakerDevice) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_SagemakerDevice) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/sagemaker_device aws_sagemaker_device} Resource.
func NewSagemakerDevice(scope constructs.Construct, id *string, config *SagemakerDeviceConfig) SagemakerDevice {
	_init_.Initialize()

	if err := validateNewSagemakerDeviceParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_SagemakerDevice)SetConnection(val interface{}) {
...
func (j *jsiiProxy_SagemakerDevice)SetCount(val interface{}) {
...
func (j *jsiiProxy_SagemakerDevice)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_SagemakerDevice)SetId(val *string) {
...
func (j *jsiiProxy_SagemakerDevice)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_SagemakerDevice)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_SagemakerDevice)SetProvisioners(val *[]interface{}) {
...
func (j *jsiiProxy_SagemakerDevice)SetRegion(val *string) {
...
func SagemakerDevice_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateSagemakerDevice_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func SagemakerDevice_IsConstruct(x interface{}) *bool {
	...
	if err := validateSagemakerDevice_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func SagemakerDevice_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateSagemakerDevice_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func SagemakerDevice_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateSagemakerDevice_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (s *jsiiProxy_SagemakerDevice) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_SagemakerDevice) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SagemakerDevice) HasResourceMove() interface{} {
	var returns interface{}
...
func (s *jsiiProxy_SagemakerDevice) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_SagemakerDevice) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SagemakerDevice) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_SagemakerDevice) MoveFromId(id *string) {
...
func (s *jsiiProxy_SagemakerDevice) MoveTo(moveTarget *string, index interface{}) {
...
func (s *jsiiProxy_SagemakerDevice) MoveToId(id *string) {
...
func (s *jsiiProxy_SagemakerDevice) PutDevice(value *SagemakerDeviceDevice) {
	if err := s.validatePutDeviceParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		s,
...
func (s *jsiiProxy_SagemakerDevice) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_SagemakerDevice) ResetId() {
	_jsii_.InvokeVoid(
		s,
		"resetId",
		nil, // no parameters
...
func (s *jsiiProxy_SagemakerDevice) ResetRegion() {
	_jsii_.InvokeVoid(
		s,
		"resetRegion",
		nil, // no parameters
...
func (s *jsiiProxy_SagemakerDevice) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (s *jsiiProxy_SagemakerDevice) ToHclTerraform() interface{} {
	var returns interface{}
...
func (s *jsiiProxy_SagemakerDevice) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
