...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v22/sagemakerdevice/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.31.0/docs/resources/sagemaker_device aws_sagemaker_device}.
...
func (j *jsiiProxy_SagemakerDevice) ForEach() cdktf.ITerraformIterator {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.31.0/docs/resources/sagemaker_device aws_sagemaker_device} Resource.
...
func (j *jsiiProxy_SagemakerDevice)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func SagemakerDevice_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (s *jsiiProxy_SagemakerDevice) ImportFrom(id *string, provider cdktf.TerraformProvider) {
