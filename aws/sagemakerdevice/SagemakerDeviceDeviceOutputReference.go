...
func (j *jsiiProxy_SagemakerDeviceDeviceOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_SagemakerDeviceDeviceOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_SagemakerDeviceDeviceOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_SagemakerDeviceDeviceOutputReference)SetComplexObjectIndex(val interface{}) {
...
func (j *jsiiProxy_SagemakerDeviceDeviceOutputReference)SetComplexObjectIsFromSet(val *bool) {
...
func (j *jsiiProxy_SagemakerDeviceDeviceOutputReference)SetIotThingName(val *string) {
	if err := j.validateSetIotThingNameParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (s *jsiiProxy_SagemakerDeviceDeviceOutputReference) ComputeFqn() *string {
	var returns *string
...
func (s *jsiiProxy_SagemakerDeviceDeviceOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_SagemakerDeviceDeviceOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
...
func (s *jsiiProxy_SagemakerDeviceDeviceOutputReference) ToString() *string {
	var returns *string
