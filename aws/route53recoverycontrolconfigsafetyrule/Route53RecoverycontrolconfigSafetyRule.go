...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/route53recoverycontrolconfigsafetyrule/internal"
...
func (j *jsiiProxy_Route53RecoverycontrolconfigSafetyRule) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_Route53RecoverycontrolconfigSafetyRule) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_Route53RecoverycontrolconfigSafetyRule) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_Route53RecoverycontrolconfigSafetyRule) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_Route53RecoverycontrolconfigSafetyRule) Tags() *map[string]*string {
...
func (j *jsiiProxy_Route53RecoverycontrolconfigSafetyRule) TagsAll() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsAll",
...
func (j *jsiiProxy_Route53RecoverycontrolconfigSafetyRule) TagsAllInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsAllInput",
...
func (j *jsiiProxy_Route53RecoverycontrolconfigSafetyRule) TagsInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsInput",
...
func (j *jsiiProxy_Route53RecoverycontrolconfigSafetyRule) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/route53recoverycontrolconfig_safety_rule aws_route53recoverycontrolconfig_safety_rule} Resource.
...
func (j *jsiiProxy_Route53RecoverycontrolconfigSafetyRule)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_Route53RecoverycontrolconfigSafetyRule)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_Route53RecoverycontrolconfigSafetyRule)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_Route53RecoverycontrolconfigSafetyRule)SetTags(val *map[string]*string) {
...
func (j *jsiiProxy_Route53RecoverycontrolconfigSafetyRule)SetTagsAll(val *map[string]*string) {
...
func Route53RecoverycontrolconfigSafetyRule_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (r *jsiiProxy_Route53RecoverycontrolconfigSafetyRule) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (r *jsiiProxy_Route53RecoverycontrolconfigSafetyRule) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (r *jsiiProxy_Route53RecoverycontrolconfigSafetyRule) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (r *jsiiProxy_Route53RecoverycontrolconfigSafetyRule) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (r *jsiiProxy_Route53RecoverycontrolconfigSafetyRule) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (r *jsiiProxy_Route53RecoverycontrolconfigSafetyRule) ResetTags() {
	_jsii_.InvokeVoid(
		r,
		"resetTags",
		nil, // no parameters
...
func (r *jsiiProxy_Route53RecoverycontrolconfigSafetyRule) ResetTagsAll() {
	_jsii_.InvokeVoid(
		r,
		"resetTagsAll",
		nil, // no parameters
...
func (r *jsiiProxy_Route53RecoverycontrolconfigSafetyRule) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
