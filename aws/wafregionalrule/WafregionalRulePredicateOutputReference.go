...
func (w *jsiiProxy_WafregionalRulePredicateOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (w *jsiiProxy_WafregionalRulePredicateOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
