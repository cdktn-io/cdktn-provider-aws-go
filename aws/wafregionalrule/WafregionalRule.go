...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/wafregionalrule/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/wafregional_rule aws_wafregional_rule}.
...
func (j *jsiiProxy_WafregionalRule) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_WafregionalRule) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_WafregionalRule) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_WafregionalRule) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_WafregionalRule) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/wafregional_rule aws_wafregional_rule} Resource.
...
func (j *jsiiProxy_WafregionalRule)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_WafregionalRule)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_WafregionalRule)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func WafregionalRule_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (w *jsiiProxy_WafregionalRule) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_WafregionalRule) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (w *jsiiProxy_WafregionalRule) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_WafregionalRule) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (w *jsiiProxy_WafregionalRule) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
