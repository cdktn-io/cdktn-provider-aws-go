...
func (j *jsiiProxy_WafregionalRulePredicateList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewWafregionalRulePredicateList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) WafregionalRulePredicateList {
	_init_.Initialize()
...
func NewWafregionalRulePredicateList_Override(w WafregionalRulePredicateList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_WafregionalRulePredicateList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (w *jsiiProxy_WafregionalRulePredicateList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (w *jsiiProxy_WafregionalRulePredicateList) Resolve(context cdktn.IResolveContext) interface{} {
