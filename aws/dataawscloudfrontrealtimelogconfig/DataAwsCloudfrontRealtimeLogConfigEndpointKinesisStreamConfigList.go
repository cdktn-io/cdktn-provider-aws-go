...
func (j *jsiiProxy_DataAwsCloudfrontRealtimeLogConfigEndpointKinesisStreamConfigList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsCloudfrontRealtimeLogConfigEndpointKinesisStreamConfigList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsCloudfrontRealtimeLogConfigEndpointKinesisStreamConfigList {
	_init_.Initialize()
...
func NewDataAwsCloudfrontRealtimeLogConfigEndpointKinesisStreamConfigList_Override(d DataAwsCloudfrontRealtimeLogConfigEndpointKinesisStreamConfigList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsCloudfrontRealtimeLogConfigEndpointKinesisStreamConfigList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsCloudfrontRealtimeLogConfigEndpointKinesisStreamConfigList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsCloudfrontRealtimeLogConfigEndpointKinesisStreamConfigList) Resolve(context cdktn.IResolveContext) interface{} {
