...
func (s *jsiiProxy_SsoadminApplicationPortalOptionsSignInOptionsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (s *jsiiProxy_SsoadminApplicationPortalOptionsSignInOptionsList) Resolve(context cdktf.IResolveContext) interface{} {
