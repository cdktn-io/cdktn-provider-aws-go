...
func (j *jsiiProxy_AppsyncDatasourceElasticsearchConfigOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewAppsyncDatasourceElasticsearchConfigOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) AppsyncDatasourceElasticsearchConfigOutputReference {
	_init_.Initialize()

	if err := validateNewAppsyncDatasourceElasticsearchConfigOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewAppsyncDatasourceElasticsearchConfigOutputReference_Override(a AppsyncDatasourceElasticsearchConfigOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_AppsyncDatasourceElasticsearchConfigOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (a *jsiiProxy_AppsyncDatasourceElasticsearchConfigOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AppsyncDatasourceElasticsearchConfigOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (a *jsiiProxy_AppsyncDatasourceElasticsearchConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AppsyncDatasourceElasticsearchConfigOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
