...
func (a *jsiiProxy_AppsyncDatasourceElasticsearchConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_AppsyncDatasourceElasticsearchConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
