...
func (a *jsiiProxy_AppsyncDatasourceHttpConfigAuthorizationConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_AppsyncDatasourceHttpConfigAuthorizationConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
