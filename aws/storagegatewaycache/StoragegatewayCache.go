...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/storagegatewaycache/internal"
...
func (j *jsiiProxy_StoragegatewayCache) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_StoragegatewayCache) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_StoragegatewayCache) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_StoragegatewayCache) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_StoragegatewayCache) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_StoragegatewayCache) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_StoragegatewayCache) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/storagegateway_cache aws_storagegateway_cache} Resource.
...
func (j *jsiiProxy_StoragegatewayCache)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_StoragegatewayCache)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_StoragegatewayCache)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_StoragegatewayCache)SetRegion(val *string) {
...
func StoragegatewayCache_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (s *jsiiProxy_StoragegatewayCache) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_StoragegatewayCache) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_StoragegatewayCache) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_StoragegatewayCache) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_StoragegatewayCache) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_StoragegatewayCache) ResetRegion() {
	_jsii_.InvokeVoid(
		s,
		"resetRegion",
		nil, // no parameters
...
func (s *jsiiProxy_StoragegatewayCache) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
