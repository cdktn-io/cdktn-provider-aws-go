...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/data-sources/backup_plan aws_backup_plan}.
type DataAwsBackupPlan interface {
	...
	ScanSetting() DataAwsBackupPlanScanSettingList
...
func (j *jsiiProxy_DataAwsBackupPlan) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsBackupPlan) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsBackupPlan) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_DataAwsBackupPlan) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsBackupPlan) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsBackupPlan) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DataAwsBackupPlan) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_DataAwsBackupPlan) ScanSetting() DataAwsBackupPlanScanSettingList {
	var returns DataAwsBackupPlanScanSettingList
	_jsii_.Get(
		j,
		"scanSetting",
		&returns,
...
func (j *jsiiProxy_DataAwsBackupPlan) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/data-sources/backup_plan aws_backup_plan} Data Source.
func NewDataAwsBackupPlan(scope constructs.Construct, id *string, config *DataAwsBackupPlanConfig) DataAwsBackupPlan {
	_init_.Initialize()

	if err := validateNewDataAwsBackupPlanParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_DataAwsBackupPlan)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsBackupPlan)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsBackupPlan)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_DataAwsBackupPlan)SetRegion(val *string) {
...
func DataAwsBackupPlan_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateDataAwsBackupPlan_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataAwsBackupPlan) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsBackupPlan) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsBackupPlan) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsBackupPlan) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsBackupPlan) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsBackupPlan) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
