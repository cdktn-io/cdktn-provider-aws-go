...
func (d *jsiiProxy_DataAwsBackupPlanRuleList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
	return nil
}

func (d *jsiiProxy_DataAwsBackupPlanRuleList) validateGetParameters(index *float64) error {
	return nil
}
...
func (j *jsiiProxy_DataAwsBackupPlanRuleList) validateSetTerraformAttributeParameters(val *string) error {
	return nil
}
...
func (j *jsiiProxy_DataAwsBackupPlanRuleList) validateSetWrapsSetParameters(val *bool) error {
	return nil
}
