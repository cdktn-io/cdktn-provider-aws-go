...
func (d *jsiiProxy_DataAwsMskClusterBrokerNodeGroupInfoConnectivityInfoVpcConnectivityClientAuthenticationSaslList) Resolve(context cdktf.IResolveContext) interface{} {
