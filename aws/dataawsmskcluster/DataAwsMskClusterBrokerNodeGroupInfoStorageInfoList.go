...
func (j *jsiiProxy_DataAwsMskClusterBrokerNodeGroupInfoStorageInfoList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsMskClusterBrokerNodeGroupInfoStorageInfoList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsMskClusterBrokerNodeGroupInfoStorageInfoList {
	_init_.Initialize()
...
func NewDataAwsMskClusterBrokerNodeGroupInfoStorageInfoList_Override(d DataAwsMskClusterBrokerNodeGroupInfoStorageInfoList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsMskClusterBrokerNodeGroupInfoStorageInfoList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsMskClusterBrokerNodeGroupInfoStorageInfoList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsMskClusterBrokerNodeGroupInfoStorageInfoList) Resolve(context cdktn.IResolveContext) interface{} {
