...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/data-sources/msk_cluster aws_msk_cluster}.
type DataAwsMskCluster interface {
	...
	BrokerNodeGroupInfo() DataAwsMskClusterBrokerNodeGroupInfoList
	// Experimental.
...
func (j *jsiiProxy_DataAwsMskCluster) BrokerNodeGroupInfo() DataAwsMskClusterBrokerNodeGroupInfoList {
	var returns DataAwsMskClusterBrokerNodeGroupInfoList
	_jsii_.Get(
		j,
		"brokerNodeGroupInfo",
		&returns,
...
func (j *jsiiProxy_DataAwsMskCluster) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsMskCluster) ClusterUuid() *string {
	var returns *string
	_jsii_.Get(
		j,
		"clusterUuid",
...
func (j *jsiiProxy_DataAwsMskCluster) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsMskCluster) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsMskCluster) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsMskCluster) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DataAwsMskCluster) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_DataAwsMskCluster) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/data-sources/msk_cluster aws_msk_cluster} Data Source.
...
func (j *jsiiProxy_DataAwsMskCluster)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsMskCluster)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsMskCluster)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_DataAwsMskCluster)SetRegion(val *string) {
...
func DataAwsMskCluster_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsMskCluster) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsMskCluster) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsMskCluster) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsMskCluster) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsMskCluster) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
