...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/dataawscloudfrontconnectiongroup/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/data-sources/cloudfront_connection_group aws_cloudfront_connection_group}.
...
func (j *jsiiProxy_DataAwsCloudfrontConnectionGroup) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsCloudfrontConnectionGroup) Enabled() cdktn.IResolvable {
...
func (j *jsiiProxy_DataAwsCloudfrontConnectionGroup) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsCloudfrontConnectionGroup) Ipv6Enabled() cdktn.IResolvable {
	var returns cdktn.IResolvable
	_jsii_.Get(
		j,
		"ipv6Enabled",
...
func (j *jsiiProxy_DataAwsCloudfrontConnectionGroup) IsDefault() cdktn.IResolvable {
	var returns cdktn.IResolvable
	_jsii_.Get(
		j,
		"isDefault",
...
func (j *jsiiProxy_DataAwsCloudfrontConnectionGroup) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsCloudfrontConnectionGroup) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsCloudfrontConnectionGroup) Tags() cdktn.StringMap {
...
func (j *jsiiProxy_DataAwsCloudfrontConnectionGroup) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/data-sources/cloudfront_connection_group aws_cloudfront_connection_group} Data Source.
...
func (j *jsiiProxy_DataAwsCloudfrontConnectionGroup)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsCloudfrontConnectionGroup)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsCloudfrontConnectionGroup)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsCloudfrontConnectionGroup_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsCloudfrontConnectionGroup) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsCloudfrontConnectionGroup) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsCloudfrontConnectionGroup) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsCloudfrontConnectionGroup) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
