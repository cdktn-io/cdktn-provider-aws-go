...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*EbsVolumeCopy)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-aws.ebsVolumeCopy.EbsVolumeCopyConfig",
		reflect.TypeOf((*EbsVolumeCopyConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-aws.ebsVolumeCopy.EbsVolumeCopyTimeouts",
		reflect.TypeOf((*EbsVolumeCopyTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-aws.ebsVolumeCopy.EbsVolumeCopyTimeoutsOutputReference",
		reflect.TypeOf((*EbsVolumeCopyTimeoutsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
