...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/dmseventsubscription/internal"
...
func (j *jsiiProxy_DmsEventSubscription) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DmsEventSubscription) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DmsEventSubscription) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DmsEventSubscription) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DmsEventSubscription) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DmsEventSubscription) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_DmsEventSubscription) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/dms_event_subscription aws_dms_event_subscription} Resource.
...
func (j *jsiiProxy_DmsEventSubscription)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DmsEventSubscription)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DmsEventSubscription)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_DmsEventSubscription)SetRegion(val *string) {
...
func DmsEventSubscription_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DmsEventSubscription) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DmsEventSubscription) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (d *jsiiProxy_DmsEventSubscription) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DmsEventSubscription) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (d *jsiiProxy_DmsEventSubscription) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DmsEventSubscription) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
...
func (d *jsiiProxy_DmsEventSubscription) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
