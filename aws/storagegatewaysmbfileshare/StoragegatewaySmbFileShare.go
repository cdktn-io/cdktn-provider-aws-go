...
func (j *jsiiProxy_StoragegatewaySmbFileShare) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_StoragegatewaySmbFileShare) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_StoragegatewaySmbFileShare) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_StoragegatewaySmbFileShare) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_StoragegatewaySmbFileShare) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/storagegateway_smb_file_share aws_storagegateway_smb_file_share} Resource.
...
func (j *jsiiProxy_StoragegatewaySmbFileShare)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_StoragegatewaySmbFileShare)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_StoragegatewaySmbFileShare)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func StoragegatewaySmbFileShare_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (s *jsiiProxy_StoragegatewaySmbFileShare) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_StoragegatewaySmbFileShare) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_StoragegatewaySmbFileShare) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_StoragegatewaySmbFileShare) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_StoragegatewaySmbFileShare) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_StoragegatewaySmbFileShare) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
