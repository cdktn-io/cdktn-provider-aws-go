...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v22/storagegatewaysmbfileshare/internal"
...
func (s *jsiiProxy_StoragegatewaySmbFileShareTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_StoragegatewaySmbFileShareTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
