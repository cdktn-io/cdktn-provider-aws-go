...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/quicksightgroupmembership/internal"
...
func (j *jsiiProxy_QuicksightGroupMembership) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_QuicksightGroupMembership) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_QuicksightGroupMembership) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_QuicksightGroupMembership) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_QuicksightGroupMembership) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func NewQuicksightGroupMembership(scope constructs.Construct, id *string, config *QuicksightGroupMembershipConfig) QuicksightGroupMembership {
	...
	_jsii_.Create(
		"@cdktn/provider-aws.quicksightGroupMembership.QuicksightGroupMembership",
...
func (j *jsiiProxy_QuicksightGroupMembership)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_QuicksightGroupMembership)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_QuicksightGroupMembership)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func QuicksightGroupMembership_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (q *jsiiProxy_QuicksightGroupMembership) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (q *jsiiProxy_QuicksightGroupMembership) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (q *jsiiProxy_QuicksightGroupMembership) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (q *jsiiProxy_QuicksightGroupMembership) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (q *jsiiProxy_QuicksightGroupMembership) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (q *jsiiProxy_QuicksightGroupMembership) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
