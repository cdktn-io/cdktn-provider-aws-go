...
func (j *jsiiProxy_WafregionalRateBasedRule) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_WafregionalRateBasedRule) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_WafregionalRateBasedRule) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_WafregionalRateBasedRule) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_WafregionalRateBasedRule) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_WafregionalRateBasedRule) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_WafregionalRateBasedRule) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/wafregional_rate_based_rule aws_wafregional_rate_based_rule} Resource.
func NewWafregionalRateBasedRule(scope constructs.Construct, id *string, config *WafregionalRateBasedRuleConfig) WafregionalRateBasedRule {
	...
	_jsii_.Create(
		"@cdktn/provider-aws.wafregionalRateBasedRule.WafregionalRateBasedRule",
...
func (j *jsiiProxy_WafregionalRateBasedRule)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_WafregionalRateBasedRule)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_WafregionalRateBasedRule)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_WafregionalRateBasedRule)SetRegion(val *string) {
...
func WafregionalRateBasedRule_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (w *jsiiProxy_WafregionalRateBasedRule) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_WafregionalRateBasedRule) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (w *jsiiProxy_WafregionalRateBasedRule) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_WafregionalRateBasedRule) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (w *jsiiProxy_WafregionalRateBasedRule) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (w *jsiiProxy_WafregionalRateBasedRule) ResetRegion() {
	_jsii_.InvokeVoid(
		w,
		"resetRegion",
		nil, // no parameters
