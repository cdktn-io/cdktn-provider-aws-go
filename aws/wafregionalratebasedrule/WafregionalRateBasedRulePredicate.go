...
type WafregionalRateBasedRulePredicate struct {
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.32.1/docs/resources/wafregional_rate_based_rule#data_id WafregionalRateBasedRule#data_id}.
