...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/wafregionalratebasedrule/internal"
...
func (j *jsiiProxy_WafregionalRateBasedRulePredicateList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewWafregionalRateBasedRulePredicateList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) WafregionalRateBasedRulePredicateList {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-aws.wafregionalRateBasedRule.WafregionalRateBasedRulePredicateList",
...
func NewWafregionalRateBasedRulePredicateList_Override(w WafregionalRateBasedRulePredicateList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_WafregionalRateBasedRulePredicateList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (w *jsiiProxy_WafregionalRateBasedRulePredicateList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (w *jsiiProxy_WafregionalRateBasedRulePredicateList) Resolve(context cdktn.IResolveContext) interface{} {
