...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v21/wafregionalratebasedrule/internal"
...
func (w *jsiiProxy_WafregionalRateBasedRulePredicateList) Resolve(context cdktf.IResolveContext) interface{} {
