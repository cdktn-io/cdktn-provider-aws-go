...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/dataawscloudfrontoriginaccessidentity/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/data-sources/cloudfront_origin_access_identity aws_cloudfront_origin_access_identity}.
...
func (j *jsiiProxy_DataAwsCloudfrontOriginAccessIdentity) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsCloudfrontOriginAccessIdentity) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsCloudfrontOriginAccessIdentity) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsCloudfrontOriginAccessIdentity) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsCloudfrontOriginAccessIdentity) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/data-sources/cloudfront_origin_access_identity aws_cloudfront_origin_access_identity} Data Source.
func NewDataAwsCloudfrontOriginAccessIdentity(scope constructs.Construct, id *string, config *DataAwsCloudfrontOriginAccessIdentityConfig) DataAwsCloudfrontOriginAccessIdentity {
	...
	if err := validateNewDataAwsCloudfrontOriginAccessIdentityParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_DataAwsCloudfrontOriginAccessIdentity)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsCloudfrontOriginAccessIdentity)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsCloudfrontOriginAccessIdentity)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsCloudfrontOriginAccessIdentity_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsCloudfrontOriginAccessIdentity) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsCloudfrontOriginAccessIdentity) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsCloudfrontOriginAccessIdentity) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsCloudfrontOriginAccessIdentity) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
