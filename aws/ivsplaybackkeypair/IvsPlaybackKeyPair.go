...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/ivs_playback_key_pair aws_ivs_playback_key_pair}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/ivs_playback_key_pair aws_ivs_playback_key_pair} Resource.
...
func (i *jsiiProxy_IvsPlaybackKeyPair) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (i *jsiiProxy_IvsPlaybackKeyPair) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (i *jsiiProxy_IvsPlaybackKeyPair) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
