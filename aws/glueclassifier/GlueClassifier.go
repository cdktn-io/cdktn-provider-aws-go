...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.31.0/docs/resources/glue_classifier aws_glue_classifier}.
...
func (j *jsiiProxy_GlueClassifier) ForEach() cdktf.ITerraformIterator {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.31.0/docs/resources/glue_classifier aws_glue_classifier} Resource.
...
func GlueClassifier_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (g *jsiiProxy_GlueClassifier) ImportFrom(id *string, provider cdktf.TerraformProvider) {
