...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/glueclassifier/internal"
...
func (j *jsiiProxy_GlueClassifier) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_GlueClassifier) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_GlueClassifier) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_GlueClassifier) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_GlueClassifier) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_GlueClassifier) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_GlueClassifier) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_GlueClassifier) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/glue_classifier aws_glue_classifier} Resource.
func NewGlueClassifier(scope constructs.Construct, id *string, config *GlueClassifierConfig) GlueClassifier {
	_init_.Initialize()

	if err := validateNewGlueClassifierParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_GlueClassifier)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_GlueClassifier)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_GlueClassifier)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_GlueClassifier)SetRegion(val *string) {
...
func GlueClassifier_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateGlueClassifier_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (g *jsiiProxy_GlueClassifier) AddMoveTarget(moveTarget *string) {
...
func (g *jsiiProxy_GlueClassifier) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GlueClassifier) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (g *jsiiProxy_GlueClassifier) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GlueClassifier) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GlueClassifier) MoveFromId(id *string) {
...
func (g *jsiiProxy_GlueClassifier) MoveToId(id *string) {
...
func (g *jsiiProxy_GlueClassifier) PutCsvClassifier(value *GlueClassifierCsvClassifier) {
	if err := g.validatePutCsvClassifierParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		g,
...
func (g *jsiiProxy_GlueClassifier) PutGrokClassifier(value *GlueClassifierGrokClassifier) {
	if err := g.validatePutGrokClassifierParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		g,
...
func (g *jsiiProxy_GlueClassifier) PutJsonClassifier(value *GlueClassifierJsonClassifier) {
	if err := g.validatePutJsonClassifierParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		g,
...
func (g *jsiiProxy_GlueClassifier) PutXmlClassifier(value *GlueClassifierXmlClassifier) {
	if err := g.validatePutXmlClassifierParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		g,
...
func (g *jsiiProxy_GlueClassifier) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (g *jsiiProxy_GlueClassifier) ResetId() {
	_jsii_.InvokeVoid(
		g,
		"resetId",
		nil, // no parameters
...
func (g *jsiiProxy_GlueClassifier) ResetRegion() {
	_jsii_.InvokeVoid(
		g,
		"resetRegion",
		nil, // no parameters
...
func (g *jsiiProxy_GlueClassifier) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
