...
func (g *jsiiProxy_GlueClassifierGrokClassifierOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GlueClassifierGrokClassifierOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
