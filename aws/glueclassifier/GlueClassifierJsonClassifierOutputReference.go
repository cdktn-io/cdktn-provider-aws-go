...
func (g *jsiiProxy_GlueClassifierJsonClassifierOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GlueClassifierJsonClassifierOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
