...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/dataawsecrimage/internal"
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/data-sources/ecr_image aws_ecr_image} Data Source.
...
func (d *jsiiProxy_DataAwsEcrImage) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
