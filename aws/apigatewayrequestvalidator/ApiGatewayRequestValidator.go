...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v22/apigatewayrequestvalidator/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.31.0/docs/resources/api_gateway_request_validator aws_api_gateway_request_validator}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.31.0/docs/resources/api_gateway_request_validator aws_api_gateway_request_validator} Resource.
...
func ApiGatewayRequestValidator_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (a *jsiiProxy_ApiGatewayRequestValidator) ImportFrom(id *string, provider cdktf.TerraformProvider) {
