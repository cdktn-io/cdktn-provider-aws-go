...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/apigatewayrequestvalidator/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/api_gateway_request_validator aws_api_gateway_request_validator}.
...
func (j *jsiiProxy_ApiGatewayRequestValidator) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_ApiGatewayRequestValidator) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_ApiGatewayRequestValidator) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_ApiGatewayRequestValidator) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_ApiGatewayRequestValidator) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_ApiGatewayRequestValidator) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_ApiGatewayRequestValidator) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/api_gateway_request_validator aws_api_gateway_request_validator} Resource.
...
func (j *jsiiProxy_ApiGatewayRequestValidator)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_ApiGatewayRequestValidator)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_ApiGatewayRequestValidator)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_ApiGatewayRequestValidator)SetRegion(val *string) {
...
func ApiGatewayRequestValidator_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateApiGatewayRequestValidator_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
// Experimental.
func ApiGatewayRequestValidator_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateApiGatewayRequestValidator_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func ApiGatewayRequestValidator_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateApiGatewayRequestValidator_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (a *jsiiProxy_ApiGatewayRequestValidator) AddMoveTarget(moveTarget *string) {
...
func (a *jsiiProxy_ApiGatewayRequestValidator) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_ApiGatewayRequestValidator) HasResourceMove() interface{} {
	var returns interface{}
...
func (a *jsiiProxy_ApiGatewayRequestValidator) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (a *jsiiProxy_ApiGatewayRequestValidator) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_ApiGatewayRequestValidator) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (a *jsiiProxy_ApiGatewayRequestValidator) MoveFromId(id *string) {
...
func (a *jsiiProxy_ApiGatewayRequestValidator) MoveTo(moveTarget *string, index interface{}) {
...
func (a *jsiiProxy_ApiGatewayRequestValidator) MoveToId(id *string) {
...
func (a *jsiiProxy_ApiGatewayRequestValidator) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (a *jsiiProxy_ApiGatewayRequestValidator) ResetRegion() {
	_jsii_.InvokeVoid(
		a,
		"resetRegion",
		nil, // no parameters
...
func (a *jsiiProxy_ApiGatewayRequestValidator) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (a *jsiiProxy_ApiGatewayRequestValidator) ToHclTerraform() interface{} {
	var returns interface{}
...
func (a *jsiiProxy_ApiGatewayRequestValidator) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
