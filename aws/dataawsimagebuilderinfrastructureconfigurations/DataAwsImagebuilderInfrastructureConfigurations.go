...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/dataawsimagebuilderinfrastructureconfigurations/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/data-sources/imagebuilder_infrastructure_configurations aws_imagebuilder_infrastructure_configurations}.
...
func (j *jsiiProxy_DataAwsImagebuilderInfrastructureConfigurations) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsImagebuilderInfrastructureConfigurations) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsImagebuilderInfrastructureConfigurations) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsImagebuilderInfrastructureConfigurations) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsImagebuilderInfrastructureConfigurations) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DataAwsImagebuilderInfrastructureConfigurations) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_DataAwsImagebuilderInfrastructureConfigurations) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/data-sources/imagebuilder_infrastructure_configurations aws_imagebuilder_infrastructure_configurations} Data Source.
...
func (j *jsiiProxy_DataAwsImagebuilderInfrastructureConfigurations)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsImagebuilderInfrastructureConfigurations)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsImagebuilderInfrastructureConfigurations)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_DataAwsImagebuilderInfrastructureConfigurations)SetRegion(val *string) {
...
func DataAwsImagebuilderInfrastructureConfigurations_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsImagebuilderInfrastructureConfigurations) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsImagebuilderInfrastructureConfigurations) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsImagebuilderInfrastructureConfigurations) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsImagebuilderInfrastructureConfigurations) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsImagebuilderInfrastructureConfigurations) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
