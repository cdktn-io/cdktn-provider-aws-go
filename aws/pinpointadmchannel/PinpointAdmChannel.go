...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/pinpointadmchannel/internal"
...
func (j *jsiiProxy_PinpointAdmChannel) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_PinpointAdmChannel) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_PinpointAdmChannel) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_PinpointAdmChannel) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_PinpointAdmChannel) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_PinpointAdmChannel) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_PinpointAdmChannel) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_PinpointAdmChannel)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_PinpointAdmChannel)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_PinpointAdmChannel)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_PinpointAdmChannel)SetRegion(val *string) {
...
func PinpointAdmChannel_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (p *jsiiProxy_PinpointAdmChannel) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PinpointAdmChannel) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (p *jsiiProxy_PinpointAdmChannel) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PinpointAdmChannel) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (p *jsiiProxy_PinpointAdmChannel) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (p *jsiiProxy_PinpointAdmChannel) ResetRegion() {
	_jsii_.InvokeVoid(
		p,
		"resetRegion",
		nil, // no parameters
...
func (p *jsiiProxy_PinpointAdmChannel) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
