...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/dynamodbtablereplica/internal"
...
func (j *jsiiProxy_DynamodbTableReplicaA) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DynamodbTableReplicaA) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DynamodbTableReplicaA) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DynamodbTableReplicaA) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DynamodbTableReplicaA) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/dynamodb_table_replica aws_dynamodb_table_replica} Resource.
...
func (j *jsiiProxy_DynamodbTableReplicaA)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DynamodbTableReplicaA)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DynamodbTableReplicaA)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DynamodbTableReplicaA_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DynamodbTableReplicaA) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DynamodbTableReplicaA) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (d *jsiiProxy_DynamodbTableReplicaA) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DynamodbTableReplicaA) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (d *jsiiProxy_DynamodbTableReplicaA) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
