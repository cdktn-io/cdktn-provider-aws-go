...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/pinpointapnssandboxchannel/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/pinpoint_apns_sandbox_channel aws_pinpoint_apns_sandbox_channel}.
...
func (j *jsiiProxy_PinpointApnsSandboxChannel) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_PinpointApnsSandboxChannel) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_PinpointApnsSandboxChannel) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_PinpointApnsSandboxChannel) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_PinpointApnsSandboxChannel) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/pinpoint_apns_sandbox_channel aws_pinpoint_apns_sandbox_channel} Resource.
func NewPinpointApnsSandboxChannel(scope constructs.Construct, id *string, config *PinpointApnsSandboxChannelConfig) PinpointApnsSandboxChannel {
	...
	if err := validateNewPinpointApnsSandboxChannelParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_PinpointApnsSandboxChannel)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_PinpointApnsSandboxChannel)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_PinpointApnsSandboxChannel)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func PinpointApnsSandboxChannel_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validatePinpointApnsSandboxChannel_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (p *jsiiProxy_PinpointApnsSandboxChannel) AddMoveTarget(moveTarget *string) {
...
func (p *jsiiProxy_PinpointApnsSandboxChannel) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PinpointApnsSandboxChannel) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (p *jsiiProxy_PinpointApnsSandboxChannel) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PinpointApnsSandboxChannel) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (p *jsiiProxy_PinpointApnsSandboxChannel) MoveFromId(id *string) {
...
func (p *jsiiProxy_PinpointApnsSandboxChannel) MoveToId(id *string) {
...
func (p *jsiiProxy_PinpointApnsSandboxChannel) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (p *jsiiProxy_PinpointApnsSandboxChannel) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
