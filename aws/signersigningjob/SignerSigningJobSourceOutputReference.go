...
func (j *jsiiProxy_SignerSigningJobSourceOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_SignerSigningJobSourceOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_SignerSigningJobSourceOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_SignerSigningJobSourceOutputReference)SetComplexObjectIndex(val interface{}) {
...
func (j *jsiiProxy_SignerSigningJobSourceOutputReference)SetComplexObjectIsFromSet(val *bool) {
...
func (s *jsiiProxy_SignerSigningJobSourceOutputReference) ComputeFqn() *string {
	var returns *string
...
func (s *jsiiProxy_SignerSigningJobSourceOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_SignerSigningJobSourceOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
...
func (s *jsiiProxy_SignerSigningJobSourceOutputReference) ToString() *string {
	var returns *string
