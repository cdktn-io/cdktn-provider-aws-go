...
func (j *jsiiProxy_SignerSigningJob) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_SignerSigningJob) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_SignerSigningJob) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_SignerSigningJob) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_SignerSigningJob) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_SignerSigningJob) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_SignerSigningJob) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/signer_signing_job aws_signer_signing_job} Resource.
...
func (j *jsiiProxy_SignerSigningJob)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_SignerSigningJob)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_SignerSigningJob)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_SignerSigningJob)SetRegion(val *string) {
...
func SignerSigningJob_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (s *jsiiProxy_SignerSigningJob) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SignerSigningJob) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_SignerSigningJob) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SignerSigningJob) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_SignerSigningJob) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_SignerSigningJob) ResetRegion() {
	_jsii_.InvokeVoid(
		s,
		"resetRegion",
		nil, // no parameters
...
func (s *jsiiProxy_SignerSigningJob) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
