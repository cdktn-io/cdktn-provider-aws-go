...
func (j *jsiiProxy_DataAwsTimestreamwriteTableSchemaCompositePartitionKeyList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsTimestreamwriteTableSchemaCompositePartitionKeyList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsTimestreamwriteTableSchemaCompositePartitionKeyList {
	_init_.Initialize()
...
func NewDataAwsTimestreamwriteTableSchemaCompositePartitionKeyList_Override(d DataAwsTimestreamwriteTableSchemaCompositePartitionKeyList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsTimestreamwriteTableSchemaCompositePartitionKeyList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsTimestreamwriteTableSchemaCompositePartitionKeyList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsTimestreamwriteTableSchemaCompositePartitionKeyList) Resolve(context cdktn.IResolveContext) interface{} {
