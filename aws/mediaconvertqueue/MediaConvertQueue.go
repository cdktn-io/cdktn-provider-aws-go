...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/mediaconvertqueue/internal"
...
func (j *jsiiProxy_MediaConvertQueue) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_MediaConvertQueue) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_MediaConvertQueue) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_MediaConvertQueue) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_MediaConvertQueue) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_MediaConvertQueue)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_MediaConvertQueue)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_MediaConvertQueue)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func MediaConvertQueue_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (m *jsiiProxy_MediaConvertQueue) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MediaConvertQueue) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (m *jsiiProxy_MediaConvertQueue) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MediaConvertQueue) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (m *jsiiProxy_MediaConvertQueue) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (m *jsiiProxy_MediaConvertQueue) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
