...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v22/dataawsrdscluster/internal"
...
func (d *jsiiProxy_DataAwsRdsClusterMasterUserSecretList) Resolve(context cdktf.IResolveContext) interface{} {
