...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v23/dataawsrdscluster/internal"
...
func (j *jsiiProxy_DataAwsRdsClusterMasterUserSecretList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsRdsClusterMasterUserSecretList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsRdsClusterMasterUserSecretList {
	_init_.Initialize()
...
func NewDataAwsRdsClusterMasterUserSecretList_Override(d DataAwsRdsClusterMasterUserSecretList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsRdsClusterMasterUserSecretList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsRdsClusterMasterUserSecretList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsRdsClusterMasterUserSecretList) Resolve(context cdktn.IResolveContext) interface{} {
