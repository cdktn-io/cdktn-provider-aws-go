...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/glue_crawler aws_glue_crawler} Resource.
...
func (g *jsiiProxy_GlueCrawler) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GlueCrawler) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (g *jsiiProxy_GlueCrawler) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
