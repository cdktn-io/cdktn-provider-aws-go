...
func (j *jsiiProxy_GlueCrawlerRecrawlPolicyOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewGlueCrawlerRecrawlPolicyOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) GlueCrawlerRecrawlPolicyOutputReference {
	_init_.Initialize()
...
func NewGlueCrawlerRecrawlPolicyOutputReference_Override(g GlueCrawlerRecrawlPolicyOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_GlueCrawlerRecrawlPolicyOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (g *jsiiProxy_GlueCrawlerRecrawlPolicyOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GlueCrawlerRecrawlPolicyOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (g *jsiiProxy_GlueCrawlerRecrawlPolicyOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GlueCrawlerRecrawlPolicyOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
