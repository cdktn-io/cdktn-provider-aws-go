...
func (g *jsiiProxy_GlueCrawlerCatalogTargetOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GlueCrawlerCatalogTargetOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
