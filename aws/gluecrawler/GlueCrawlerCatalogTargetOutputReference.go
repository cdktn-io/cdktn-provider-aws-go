...
func (j *jsiiProxy_GlueCrawlerCatalogTargetOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewGlueCrawlerCatalogTargetOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) GlueCrawlerCatalogTargetOutputReference {
	_init_.Initialize()
...
func NewGlueCrawlerCatalogTargetOutputReference_Override(g GlueCrawlerCatalogTargetOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_GlueCrawlerCatalogTargetOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (g *jsiiProxy_GlueCrawlerCatalogTargetOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GlueCrawlerCatalogTargetOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (g *jsiiProxy_GlueCrawlerCatalogTargetOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GlueCrawlerCatalogTargetOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
