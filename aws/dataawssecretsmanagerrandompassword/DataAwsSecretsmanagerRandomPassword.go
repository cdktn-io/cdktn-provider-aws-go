...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v23/dataawssecretsmanagerrandompassword/internal"
...
func (j *jsiiProxy_DataAwsSecretsmanagerRandomPassword) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsSecretsmanagerRandomPassword) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsSecretsmanagerRandomPassword) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsSecretsmanagerRandomPassword) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsSecretsmanagerRandomPassword) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DataAwsSecretsmanagerRandomPassword)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsSecretsmanagerRandomPassword)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsSecretsmanagerRandomPassword)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsSecretsmanagerRandomPassword_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsSecretsmanagerRandomPassword) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsSecretsmanagerRandomPassword) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsSecretsmanagerRandomPassword) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
