...
func (j *jsiiProxy_IotBillingGroupMetadataList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewIotBillingGroupMetadataList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) IotBillingGroupMetadataList {
	_init_.Initialize()
...
func NewIotBillingGroupMetadataList_Override(i IotBillingGroupMetadataList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_IotBillingGroupMetadataList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (i *jsiiProxy_IotBillingGroupMetadataList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (i *jsiiProxy_IotBillingGroupMetadataList) Resolve(context cdktf.IResolveContext) interface{} {
