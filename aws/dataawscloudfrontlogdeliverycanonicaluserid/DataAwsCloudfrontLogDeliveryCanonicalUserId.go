...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/dataawscloudfrontlogdeliverycanonicaluserid/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/data-sources/cloudfront_log_delivery_canonical_user_id aws_cloudfront_log_delivery_canonical_user_id}.
...
func (j *jsiiProxy_DataAwsCloudfrontLogDeliveryCanonicalUserId) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsCloudfrontLogDeliveryCanonicalUserId) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsCloudfrontLogDeliveryCanonicalUserId) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsCloudfrontLogDeliveryCanonicalUserId) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsCloudfrontLogDeliveryCanonicalUserId) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/data-sources/cloudfront_log_delivery_canonical_user_id aws_cloudfront_log_delivery_canonical_user_id} Data Source.
...
func (j *jsiiProxy_DataAwsCloudfrontLogDeliveryCanonicalUserId)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsCloudfrontLogDeliveryCanonicalUserId)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsCloudfrontLogDeliveryCanonicalUserId)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsCloudfrontLogDeliveryCanonicalUserId_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsCloudfrontLogDeliveryCanonicalUserId) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsCloudfrontLogDeliveryCanonicalUserId) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsCloudfrontLogDeliveryCanonicalUserId) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsCloudfrontLogDeliveryCanonicalUserId) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
