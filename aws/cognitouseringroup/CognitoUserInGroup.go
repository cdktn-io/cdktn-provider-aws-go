...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/cognitouseringroup/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/cognito_user_in_group aws_cognito_user_in_group}.
...
func (j *jsiiProxy_CognitoUserInGroup) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_CognitoUserInGroup) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_CognitoUserInGroup) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_CognitoUserInGroup) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_CognitoUserInGroup) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_CognitoUserInGroup) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_CognitoUserInGroup) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/cognito_user_in_group aws_cognito_user_in_group} Resource.
func NewCognitoUserInGroup(scope constructs.Construct, id *string, config *CognitoUserInGroupConfig) CognitoUserInGroup {
	...
	_jsii_.Create(
		"@cdktn/provider-aws.cognitoUserInGroup.CognitoUserInGroup",
...
func (j *jsiiProxy_CognitoUserInGroup)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_CognitoUserInGroup)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_CognitoUserInGroup)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_CognitoUserInGroup)SetRegion(val *string) {
...
// Generates CDKTN code for importing a CognitoUserInGroup resource upon running "cdktn plan <stack-name>".
func CognitoUserInGroup_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (c *jsiiProxy_CognitoUserInGroup) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CognitoUserInGroup) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (c *jsiiProxy_CognitoUserInGroup) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CognitoUserInGroup) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_CognitoUserInGroup) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (c *jsiiProxy_CognitoUserInGroup) ResetRegion() {
	_jsii_.InvokeVoid(
		c,
		"resetRegion",
		nil, // no parameters
...
func (c *jsiiProxy_CognitoUserInGroup) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
