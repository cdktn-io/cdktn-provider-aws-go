...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/acmpcapermission/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/acmpca_permission aws_acmpca_permission}.
...
func (j *jsiiProxy_AcmpcaPermission) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_AcmpcaPermission) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_AcmpcaPermission) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_AcmpcaPermission) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_AcmpcaPermission) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_AcmpcaPermission) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_AcmpcaPermission) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/acmpca_permission aws_acmpca_permission} Resource.
func NewAcmpcaPermission(scope constructs.Construct, id *string, config *AcmpcaPermissionConfig) AcmpcaPermission {
	_init_.Initialize()

	if err := validateNewAcmpcaPermissionParameters(scope, id, config); err != nil {
		panic(err)
	}
	j := jsiiProxy_AcmpcaPermission{}

	_jsii_.Create(
		"@cdktn/provider-aws.acmpcaPermission.AcmpcaPermission",
...
func (j *jsiiProxy_AcmpcaPermission)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_AcmpcaPermission)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_AcmpcaPermission)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_AcmpcaPermission)SetRegion(val *string) {
...
func AcmpcaPermission_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateAcmpcaPermission_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (a *jsiiProxy_AcmpcaPermission) AddMoveTarget(moveTarget *string) {
...
func (a *jsiiProxy_AcmpcaPermission) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AcmpcaPermission) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (a *jsiiProxy_AcmpcaPermission) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AcmpcaPermission) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (a *jsiiProxy_AcmpcaPermission) MoveFromId(id *string) {
...
func (a *jsiiProxy_AcmpcaPermission) MoveToId(id *string) {
...
func (a *jsiiProxy_AcmpcaPermission) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (a *jsiiProxy_AcmpcaPermission) ResetRegion() {
	_jsii_.InvokeVoid(
		a,
		"resetRegion",
		nil, // no parameters
...
func (a *jsiiProxy_AcmpcaPermission) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
