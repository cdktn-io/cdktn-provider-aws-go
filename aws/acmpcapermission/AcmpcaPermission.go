...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v21/acmpcapermission/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.28.0/docs/resources/acmpca_permission aws_acmpca_permission}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.28.0/docs/resources/acmpca_permission aws_acmpca_permission} Resource.
...
func AcmpcaPermission_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (a *jsiiProxy_AcmpcaPermission) ImportFrom(id *string, provider cdktf.TerraformProvider) {
