...
func (j *jsiiProxy_Lexv2ModelsSlotValueElicitationSettingWaitAndContinueSpecificationList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewLexv2ModelsSlotValueElicitationSettingWaitAndContinueSpecificationList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) Lexv2ModelsSlotValueElicitationSettingWaitAndContinueSpecificationList {
	_init_.Initialize()
...
func NewLexv2ModelsSlotValueElicitationSettingWaitAndContinueSpecificationList_Override(l Lexv2ModelsSlotValueElicitationSettingWaitAndContinueSpecificationList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_Lexv2ModelsSlotValueElicitationSettingWaitAndContinueSpecificationList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (l *jsiiProxy_Lexv2ModelsSlotValueElicitationSettingWaitAndContinueSpecificationList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (l *jsiiProxy_Lexv2ModelsSlotValueElicitationSettingWaitAndContinueSpecificationList) Resolve(context cdktf.IResolveContext) interface{} {
