...
func (j *jsiiProxy_Lexv2ModelsSlotValueElicitationSettingPromptSpecificationList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewLexv2ModelsSlotValueElicitationSettingPromptSpecificationList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) Lexv2ModelsSlotValueElicitationSettingPromptSpecificationList {
	_init_.Initialize()
...
func NewLexv2ModelsSlotValueElicitationSettingPromptSpecificationList_Override(l Lexv2ModelsSlotValueElicitationSettingPromptSpecificationList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_Lexv2ModelsSlotValueElicitationSettingPromptSpecificationList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (l *jsiiProxy_Lexv2ModelsSlotValueElicitationSettingPromptSpecificationList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (l *jsiiProxy_Lexv2ModelsSlotValueElicitationSettingPromptSpecificationList) Resolve(context cdktf.IResolveContext) interface{} {
