...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "hubDescription", GoGetter: "HubDescription"},
			_jsii_.MemberProperty{JsiiProperty: "hubDescriptionInput", GoGetter: "HubDescriptionInput"},
			_jsii_.MemberProperty{JsiiProperty: "hubDisplayName", GoGetter: "HubDisplayName"},
			_jsii_.MemberProperty{JsiiProperty: "hubDisplayNameInput", GoGetter: "HubDisplayNameInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "hubSearchKeywords", GoGetter: "HubSearchKeywords"},
			_jsii_.MemberProperty{JsiiProperty: "hubSearchKeywordsInput", GoGetter: "HubSearchKeywordsInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetHubDisplayName", GoMethod: "ResetHubDisplayName"},
			_jsii_.MemberMethod{JsiiMethod: "resetHubSearchKeywords", GoMethod: "ResetHubSearchKeywords"},
			_jsii_.MemberMethod{JsiiMethod: "resetId", GoMethod: "ResetId"},
			_jsii_.MemberMethod{JsiiMethod: "resetOverrideLogicalId", GoMethod: "ResetOverrideLogicalId"},
			_jsii_.MemberMethod{JsiiMethod: "resetRegion", GoMethod: "ResetRegion"},
			_jsii_.MemberMethod{JsiiMethod: "resetS3StorageConfig", GoMethod: "ResetS3StorageConfig"},
