...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/route53resolverruleassociation/internal"
...
func (j *jsiiProxy_Route53ResolverRuleAssociation) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_Route53ResolverRuleAssociation) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_Route53ResolverRuleAssociation) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_Route53ResolverRuleAssociation) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_Route53ResolverRuleAssociation) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_Route53ResolverRuleAssociation) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_Route53ResolverRuleAssociation) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_Route53ResolverRuleAssociation)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_Route53ResolverRuleAssociation)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_Route53ResolverRuleAssociation)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_Route53ResolverRuleAssociation)SetRegion(val *string) {
...
func Route53ResolverRuleAssociation_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (r *jsiiProxy_Route53ResolverRuleAssociation) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (r *jsiiProxy_Route53ResolverRuleAssociation) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (r *jsiiProxy_Route53ResolverRuleAssociation) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (r *jsiiProxy_Route53ResolverRuleAssociation) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (r *jsiiProxy_Route53ResolverRuleAssociation) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (r *jsiiProxy_Route53ResolverRuleAssociation) ResetRegion() {
	_jsii_.InvokeVoid(
		r,
		"resetRegion",
		nil, // no parameters
...
func (r *jsiiProxy_Route53ResolverRuleAssociation) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
