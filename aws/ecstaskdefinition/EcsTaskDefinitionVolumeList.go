...
func (e *jsiiProxy_EcsTaskDefinitionVolumeList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (e *jsiiProxy_EcsTaskDefinitionVolumeList) Resolve(context cdktf.IResolveContext) interface{} {
