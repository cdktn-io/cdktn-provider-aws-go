...
func (j *jsiiProxy_EcsTaskDefinitionVolumeList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewEcsTaskDefinitionVolumeList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) EcsTaskDefinitionVolumeList {
	_init_.Initialize()
...
func NewEcsTaskDefinitionVolumeList_Override(e EcsTaskDefinitionVolumeList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_EcsTaskDefinitionVolumeList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (e *jsiiProxy_EcsTaskDefinitionVolumeList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (e *jsiiProxy_EcsTaskDefinitionVolumeList) Resolve(context cdktn.IResolveContext) interface{} {
