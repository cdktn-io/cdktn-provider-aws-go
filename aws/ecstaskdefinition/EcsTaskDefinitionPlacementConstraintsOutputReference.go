...
func (j *jsiiProxy_EcsTaskDefinitionPlacementConstraintsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewEcsTaskDefinitionPlacementConstraintsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) EcsTaskDefinitionPlacementConstraintsOutputReference {
	_init_.Initialize()
...
func NewEcsTaskDefinitionPlacementConstraintsOutputReference_Override(e EcsTaskDefinitionPlacementConstraintsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_EcsTaskDefinitionPlacementConstraintsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (e *jsiiProxy_EcsTaskDefinitionPlacementConstraintsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (e *jsiiProxy_EcsTaskDefinitionPlacementConstraintsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (e *jsiiProxy_EcsTaskDefinitionPlacementConstraintsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (e *jsiiProxy_EcsTaskDefinitionPlacementConstraintsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
