...
func (e *jsiiProxy_EcsTaskDefinitionEphemeralStorageOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (e *jsiiProxy_EcsTaskDefinitionEphemeralStorageOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
