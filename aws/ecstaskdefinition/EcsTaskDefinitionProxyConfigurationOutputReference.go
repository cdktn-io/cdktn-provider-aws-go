...
func (j *jsiiProxy_EcsTaskDefinitionProxyConfigurationOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewEcsTaskDefinitionProxyConfigurationOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) EcsTaskDefinitionProxyConfigurationOutputReference {
	_init_.Initialize()
...
func NewEcsTaskDefinitionProxyConfigurationOutputReference_Override(e EcsTaskDefinitionProxyConfigurationOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_EcsTaskDefinitionProxyConfigurationOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (e *jsiiProxy_EcsTaskDefinitionProxyConfigurationOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (e *jsiiProxy_EcsTaskDefinitionProxyConfigurationOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (e *jsiiProxy_EcsTaskDefinitionProxyConfigurationOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (e *jsiiProxy_EcsTaskDefinitionProxyConfigurationOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
