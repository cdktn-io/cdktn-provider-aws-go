...
func (e *jsiiProxy_EcsTaskDefinition) validateMarkWriteOnlyAttributeParameters(value interface{}) error {
	if value == nil {
		return fmt.Errorf("parameter value is required, but nil was provided")
	}
...
func (e *jsiiProxy_EcsTaskDefinition) validatePutPlacementConstraintsParameters(value interface{}) error {
	...
	case *[]*EcsTaskDefinitionPlacementConstraints:
		value := value.(*[]*EcsTaskDefinitionPlacementConstraints)
	...
	case []*EcsTaskDefinitionPlacementConstraints:
		value_ := value.([]*EcsTaskDefinitionPlacementConstraints)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*EcsTaskDefinitionPlacementConstraints; received %#v (a %T)", value, value)
		}
	}
...
func (e *jsiiProxy_EcsTaskDefinition) validatePutVolumeParameters(value interface{}) error {
	...
	case *[]*EcsTaskDefinitionVolume:
		value := value.(*[]*EcsTaskDefinitionVolume)
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
			}
	...
	case []*EcsTaskDefinitionVolume:
		value_ := value.([]*EcsTaskDefinitionVolume)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*EcsTaskDefinitionVolume; received %#v (a %T)", value, value)
		}
	}
...
func (e *jsiiProxy_EcsTaskDefinition) validateRegisterProviderFeatureUsageParameters(feature cdktn.ProviderFeature) error {
	if feature == "" {
...
func (j *jsiiProxy_EcsTaskDefinition) validateSetLifecycleParameters(val *cdktn.TerraformResourceLifecycle) error {
	if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
		return err
	}
