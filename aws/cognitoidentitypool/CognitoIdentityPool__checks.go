...
func (c *jsiiProxy_CognitoIdentityPool) validatePutCognitoIdentityProvidersParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*CognitoIdentityPoolCognitoIdentityProviders; received %#v (a %T)", value, value)
		}
	}
