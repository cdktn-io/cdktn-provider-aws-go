...
func (j *jsiiProxy_CognitoIdentityPoolCognitoIdentityProvidersList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewCognitoIdentityPoolCognitoIdentityProvidersList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) CognitoIdentityPoolCognitoIdentityProvidersList {
	_init_.Initialize()
...
func NewCognitoIdentityPoolCognitoIdentityProvidersList_Override(c CognitoIdentityPoolCognitoIdentityProvidersList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_CognitoIdentityPoolCognitoIdentityProvidersList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_CognitoIdentityPoolCognitoIdentityProvidersList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (c *jsiiProxy_CognitoIdentityPoolCognitoIdentityProvidersList) Resolve(context cdktn.IResolveContext) interface{} {
