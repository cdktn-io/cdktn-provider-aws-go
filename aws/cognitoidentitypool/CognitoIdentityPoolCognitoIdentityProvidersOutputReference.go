...
func (j *jsiiProxy_CognitoIdentityPoolCognitoIdentityProvidersOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewCognitoIdentityPoolCognitoIdentityProvidersOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) CognitoIdentityPoolCognitoIdentityProvidersOutputReference {
	_init_.Initialize()
...
func NewCognitoIdentityPoolCognitoIdentityProvidersOutputReference_Override(c CognitoIdentityPoolCognitoIdentityProvidersOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_CognitoIdentityPoolCognitoIdentityProvidersOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_CognitoIdentityPoolCognitoIdentityProvidersOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CognitoIdentityPoolCognitoIdentityProvidersOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (c *jsiiProxy_CognitoIdentityPoolCognitoIdentityProvidersOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CognitoIdentityPoolCognitoIdentityProvidersOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
