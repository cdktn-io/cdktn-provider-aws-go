...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/connectcontactflowmodule/internal"
...
func (j *jsiiProxy_ConnectContactFlowModule) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_ConnectContactFlowModule) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_ConnectContactFlowModule) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_ConnectContactFlowModule) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_ConnectContactFlowModule) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/connect_contact_flow_module aws_connect_contact_flow_module} Resource.
...
func (j *jsiiProxy_ConnectContactFlowModule)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_ConnectContactFlowModule)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_ConnectContactFlowModule)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func ConnectContactFlowModule_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (c *jsiiProxy_ConnectContactFlowModule) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_ConnectContactFlowModule) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (c *jsiiProxy_ConnectContactFlowModule) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_ConnectContactFlowModule) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_ConnectContactFlowModule) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (c *jsiiProxy_ConnectContactFlowModule) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
