...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/dataawsmskkafkaversion/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/msk_kafka_version aws_msk_kafka_version}.
...
func (j *jsiiProxy_DataAwsMskKafkaVersion) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsMskKafkaVersion) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsMskKafkaVersion) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsMskKafkaVersion) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsMskKafkaVersion) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/msk_kafka_version aws_msk_kafka_version} Data Source.
...
func (j *jsiiProxy_DataAwsMskKafkaVersion)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsMskKafkaVersion)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsMskKafkaVersion)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsMskKafkaVersion_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateDataAwsMskKafkaVersion_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataAwsMskKafkaVersion) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsMskKafkaVersion) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsMskKafkaVersion) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsMskKafkaVersion) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataAwsMskKafkaVersion) ToHclTerraform() interface{} {
	var returns interface{}
...
func (d *jsiiProxy_DataAwsMskKafkaVersion) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
