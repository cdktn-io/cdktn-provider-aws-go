...
func (j *jsiiProxy_BackupPlan) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_BackupPlan) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_BackupPlan) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_BackupPlan) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_BackupPlan) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_BackupPlan) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_BackupPlan) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/backup_plan aws_backup_plan} Resource.
...
func (j *jsiiProxy_BackupPlan)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_BackupPlan)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_BackupPlan)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_BackupPlan)SetRegion(val *string) {
...
func BackupPlan_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateBackupPlan_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (b *jsiiProxy_BackupPlan) AddMoveTarget(moveTarget *string) {
...
func (b *jsiiProxy_BackupPlan) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (b *jsiiProxy_BackupPlan) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (b *jsiiProxy_BackupPlan) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (b *jsiiProxy_BackupPlan) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (b *jsiiProxy_BackupPlan) MoveFromId(id *string) {
...
func (b *jsiiProxy_BackupPlan) MoveToId(id *string) {
...
func (b *jsiiProxy_BackupPlan) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (b *jsiiProxy_BackupPlan) ResetRegion() {
	_jsii_.InvokeVoid(
		b,
		"resetRegion",
		nil, // no parameters
...
func (b *jsiiProxy_BackupPlan) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
