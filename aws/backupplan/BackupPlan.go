...
func BackupPlan_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (b *jsiiProxy_BackupPlan) ImportFrom(id *string, provider cdktf.TerraformProvider) {
