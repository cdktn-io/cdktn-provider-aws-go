...
func (b *jsiiProxy_BackupPlanRuleLifecycleOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (b *jsiiProxy_BackupPlanRuleLifecycleOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
