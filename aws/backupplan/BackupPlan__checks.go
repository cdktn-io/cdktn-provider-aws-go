...
func (b *jsiiProxy_BackupPlan) validatePutAdvancedBackupSettingParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*BackupPlanAdvancedBackupSetting; received %#v (a %T)", value, value)
		}
	}
...
func (b *jsiiProxy_BackupPlan) validatePutRuleParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*BackupPlanRule; received %#v (a %T)", value, value)
		}
	}
...
func (b *jsiiProxy_BackupPlan) validatePutScanSettingParameters(value interface{}) error {
	...
	case *[]*BackupPlanScanSetting:
		value := value.(*[]*BackupPlanScanSetting)
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
			}
	...
	case []*BackupPlanScanSetting:
		value_ := value.([]*BackupPlanScanSetting)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*BackupPlanScanSetting; received %#v (a %T)", value, value)
		}
	}
...
func (j *jsiiProxy_BackupPlan) validateSetRegionParameters(val *string) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
