...
func (a *jsiiProxy_AlbListenerRuleConditionOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_AlbListenerRuleConditionOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
