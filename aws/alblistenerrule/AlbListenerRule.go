...
func (j *jsiiProxy_AlbListenerRule) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_AlbListenerRule) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_AlbListenerRule) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_AlbListenerRule) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_AlbListenerRule) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_AlbListenerRule) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_AlbListenerRule) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/alb_listener_rule aws_alb_listener_rule} Resource.
...
func (j *jsiiProxy_AlbListenerRule)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_AlbListenerRule)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_AlbListenerRule)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_AlbListenerRule)SetRegion(val *string) {
...
func AlbListenerRule_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateAlbListenerRule_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (a *jsiiProxy_AlbListenerRule) AddMoveTarget(moveTarget *string) {
...
func (a *jsiiProxy_AlbListenerRule) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AlbListenerRule) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (a *jsiiProxy_AlbListenerRule) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AlbListenerRule) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (a *jsiiProxy_AlbListenerRule) MoveFromId(id *string) {
...
func (a *jsiiProxy_AlbListenerRule) MoveToId(id *string) {
...
func (a *jsiiProxy_AlbListenerRule) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (a *jsiiProxy_AlbListenerRule) ResetRegion() {
	_jsii_.InvokeVoid(
		a,
		"resetRegion",
		nil, // no parameters
...
func (a *jsiiProxy_AlbListenerRule) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
