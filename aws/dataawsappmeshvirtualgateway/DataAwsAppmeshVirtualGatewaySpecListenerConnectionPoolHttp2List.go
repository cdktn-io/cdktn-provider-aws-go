...
func (j *jsiiProxy_DataAwsAppmeshVirtualGatewaySpecListenerConnectionPoolHttp2List) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsAppmeshVirtualGatewaySpecListenerConnectionPoolHttp2List(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsAppmeshVirtualGatewaySpecListenerConnectionPoolHttp2List {
	_init_.Initialize()
...
func NewDataAwsAppmeshVirtualGatewaySpecListenerConnectionPoolHttp2List_Override(d DataAwsAppmeshVirtualGatewaySpecListenerConnectionPoolHttp2List, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsAppmeshVirtualGatewaySpecListenerConnectionPoolHttp2List)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsAppmeshVirtualGatewaySpecListenerConnectionPoolHttp2List) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsAppmeshVirtualGatewaySpecListenerConnectionPoolHttp2List) Resolve(context cdktn.IResolveContext) interface{} {
