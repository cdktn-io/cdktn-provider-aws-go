...
func (j *jsiiProxy_DataAwsAppmeshVirtualGatewaySpecListenerTlsCertificateList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsAppmeshVirtualGatewaySpecListenerTlsCertificateList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsAppmeshVirtualGatewaySpecListenerTlsCertificateList {
	_init_.Initialize()
...
func NewDataAwsAppmeshVirtualGatewaySpecListenerTlsCertificateList_Override(d DataAwsAppmeshVirtualGatewaySpecListenerTlsCertificateList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsAppmeshVirtualGatewaySpecListenerTlsCertificateList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsAppmeshVirtualGatewaySpecListenerTlsCertificateList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsAppmeshVirtualGatewaySpecListenerTlsCertificateList) Resolve(context cdktn.IResolveContext) interface{} {
