...
func (j *jsiiProxy_DataAwsAppmeshVirtualGatewaySpecListenerConnectionPoolGrpcList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsAppmeshVirtualGatewaySpecListenerConnectionPoolGrpcList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsAppmeshVirtualGatewaySpecListenerConnectionPoolGrpcList {
	_init_.Initialize()
...
func NewDataAwsAppmeshVirtualGatewaySpecListenerConnectionPoolGrpcList_Override(d DataAwsAppmeshVirtualGatewaySpecListenerConnectionPoolGrpcList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsAppmeshVirtualGatewaySpecListenerConnectionPoolGrpcList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsAppmeshVirtualGatewaySpecListenerConnectionPoolGrpcList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsAppmeshVirtualGatewaySpecListenerConnectionPoolGrpcList) Resolve(context cdktn.IResolveContext) interface{} {
