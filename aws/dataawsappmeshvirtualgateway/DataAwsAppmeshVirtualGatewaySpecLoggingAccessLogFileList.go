...
func (j *jsiiProxy_DataAwsAppmeshVirtualGatewaySpecLoggingAccessLogFileList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsAppmeshVirtualGatewaySpecLoggingAccessLogFileList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsAppmeshVirtualGatewaySpecLoggingAccessLogFileList {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-aws.dataAwsAppmeshVirtualGateway.DataAwsAppmeshVirtualGatewaySpecLoggingAccessLogFileList",
...
func NewDataAwsAppmeshVirtualGatewaySpecLoggingAccessLogFileList_Override(d DataAwsAppmeshVirtualGatewaySpecLoggingAccessLogFileList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsAppmeshVirtualGatewaySpecLoggingAccessLogFileList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsAppmeshVirtualGatewaySpecLoggingAccessLogFileList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsAppmeshVirtualGatewaySpecLoggingAccessLogFileList) Resolve(context cdktn.IResolveContext) interface{} {
