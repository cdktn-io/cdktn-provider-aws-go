...
func (d *jsiiProxy_DataAwsAppmeshVirtualGatewaySpecLoggingAccessLogFileList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsAppmeshVirtualGatewaySpecLoggingAccessLogFileList) Resolve(context cdktf.IResolveContext) interface{} {
