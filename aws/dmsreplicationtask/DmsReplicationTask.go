...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/dmsreplicationtask/internal"
...
func (j *jsiiProxy_DmsReplicationTask) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DmsReplicationTask) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DmsReplicationTask) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DmsReplicationTask) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DmsReplicationTask) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/dms_replication_task aws_dms_replication_task} Resource.
...
func (j *jsiiProxy_DmsReplicationTask)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DmsReplicationTask)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DmsReplicationTask)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DmsReplicationTask_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DmsReplicationTask) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DmsReplicationTask) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (d *jsiiProxy_DmsReplicationTask) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DmsReplicationTask) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (d *jsiiProxy_DmsReplicationTask) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
