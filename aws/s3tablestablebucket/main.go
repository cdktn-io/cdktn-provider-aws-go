...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "maintenanceConfiguration", GoGetter: "MaintenanceConfiguration"},
			_jsii_.MemberProperty{JsiiProperty: "maintenanceConfigurationInput", GoGetter: "MaintenanceConfigurationInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "putMaintenanceConfiguration", GoMethod: "PutMaintenanceConfiguration"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetMaintenanceConfiguration", GoMethod: "ResetMaintenanceConfiguration"},
	...
	_jsii_.RegisterClass(
		...
		func() interface{} {
			j := jsiiProxy_S3TablesTableBucketEncryptionConfigurationOutputReference{}
	...
	_jsii_.RegisterClass(
		...
		func() interface{} {
			j := jsiiProxy_S3TablesTableBucketMaintenanceConfigurationIcebergUnreferencedFileRemovalOutputReference{}
			_jsii_.InitJsiiProxy(&j.Type__cdktfComplexObject)
			return &j
		},
	)
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetUnreferencedDays", GoMethod: "ResetUnreferencedDays"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
			_jsii_.MemberProperty{JsiiProperty: "unreferencedDays", GoGetter: "UnreferencedDays"},
			_jsii_.MemberProperty{JsiiProperty: "unreferencedDaysInput", GoGetter: "UnreferencedDaysInput"},
		},
		func() interface{} {
			j := jsiiProxy_S3TablesTableBucketMaintenanceConfigurationIcebergUnreferencedFileRemovalSettingsOutputReference{}
			_jsii_.InitJsiiProxy(&j.Type__cdktfComplexObject)
			return &j
		},
	)
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "getStringAttribute", GoMethod: "GetStringAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getStringMapAttribute", GoMethod: "GetStringMapAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "icebergUnreferencedFileRemoval", GoGetter: "IcebergUnreferencedFileRemoval"},
			_jsii_.MemberProperty{JsiiProperty: "icebergUnreferencedFileRemovalInput", GoGetter: "IcebergUnreferencedFileRemovalInput"},
			_jsii_.MemberProperty{JsiiProperty: "internalValue", GoGetter: "InternalValue"},
			_jsii_.MemberMethod{JsiiMethod: "interpolationAsList", GoMethod: "InterpolationAsList"},
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "putIcebergUnreferencedFileRemoval", GoMethod: "PutIcebergUnreferencedFileRemoval"},
			_jsii_.MemberMethod{JsiiMethod: "resetIcebergUnreferencedFileRemoval", GoMethod: "ResetIcebergUnreferencedFileRemoval"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
		...
		func() interface{} {
			j := jsiiProxy_S3TablesTableBucketMaintenanceConfigurationOutputReference{}
			_jsii_.InitJsiiProxy(&j.Type__cdktfComplexObject)
			return &j
		},
	)
