...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetTargetControlPort", GoMethod: "ResetTargetControlPort"},
			...
			_jsii_.MemberProperty{JsiiProperty: "targetControlPortInput", GoGetter: "TargetControlPortInput"},
