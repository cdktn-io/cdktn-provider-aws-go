...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/vpc/internal"
...
func (j *jsiiProxy_Vpc) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_Vpc) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_Vpc) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_Vpc) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_Vpc) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/vpc aws_vpc} Resource.
...
func (j *jsiiProxy_Vpc)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_Vpc)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_Vpc)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func Vpc_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (v *jsiiProxy_Vpc) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (v *jsiiProxy_Vpc) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (v *jsiiProxy_Vpc) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (v *jsiiProxy_Vpc) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (v *jsiiProxy_Vpc) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (v *jsiiProxy_Vpc) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
