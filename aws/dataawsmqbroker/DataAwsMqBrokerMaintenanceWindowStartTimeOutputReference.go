...
func (d *jsiiProxy_DataAwsMqBrokerMaintenanceWindowStartTimeOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataAwsMqBrokerMaintenanceWindowStartTimeOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
