...
func (d *jsiiProxy_DataAwsMqBrokerConfigurationOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataAwsMqBrokerConfigurationOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
