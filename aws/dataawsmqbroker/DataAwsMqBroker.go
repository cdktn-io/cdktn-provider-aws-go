...
func (j *jsiiProxy_DataAwsMqBroker) AutoMinorVersionUpgrade() cdktn.IResolvable {
...
func (j *jsiiProxy_DataAwsMqBroker) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsMqBroker) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsMqBroker) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsMqBroker) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsMqBroker) PubliclyAccessible() cdktn.IResolvable {
	var returns cdktn.IResolvable
	_jsii_.Get(
		j,
		"publiclyAccessible",
...
func (j *jsiiProxy_DataAwsMqBroker) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DataAwsMqBroker) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_DataAwsMqBroker) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.35.1/docs/data-sources/mq_broker aws_mq_broker} Data Source.
...
func (j *jsiiProxy_DataAwsMqBroker)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsMqBroker)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsMqBroker)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_DataAwsMqBroker)SetRegion(val *string) {
...
func DataAwsMqBroker_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsMqBroker) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsMqBroker) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsMqBroker) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsMqBroker) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
