...
func (d *jsiiProxy_DataAwsMqBrokerLogsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsMqBrokerLogsList) Resolve(context cdktf.IResolveContext) interface{} {
