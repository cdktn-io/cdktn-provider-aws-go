...
func (j *jsiiProxy_DataAwsMqBrokerLogsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsMqBrokerLogsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsMqBrokerLogsList {
	_init_.Initialize()

	if err := validateNewDataAwsMqBrokerLogsListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewDataAwsMqBrokerLogsList_Override(d DataAwsMqBrokerLogsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsMqBrokerLogsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsMqBrokerLogsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsMqBrokerLogsList) Resolve(context cdktn.IResolveContext) interface{} {
