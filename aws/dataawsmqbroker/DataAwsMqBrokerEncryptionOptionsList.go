...
func (j *jsiiProxy_DataAwsMqBrokerEncryptionOptionsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsMqBrokerEncryptionOptionsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsMqBrokerEncryptionOptionsList {
	_init_.Initialize()

	if err := validateNewDataAwsMqBrokerEncryptionOptionsListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewDataAwsMqBrokerEncryptionOptionsList_Override(d DataAwsMqBrokerEncryptionOptionsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsMqBrokerEncryptionOptionsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsMqBrokerEncryptionOptionsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsMqBrokerEncryptionOptionsList) Resolve(context cdktn.IResolveContext) interface{} {
