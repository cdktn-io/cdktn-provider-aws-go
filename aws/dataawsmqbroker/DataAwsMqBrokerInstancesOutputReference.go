...
func (d *jsiiProxy_DataAwsMqBrokerInstancesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataAwsMqBrokerInstancesOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
