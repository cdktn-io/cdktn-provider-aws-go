...
func (j *jsiiProxy_DataAwsMqBrokerLdapServerMetadataList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsMqBrokerLdapServerMetadataList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsMqBrokerLdapServerMetadataList {
	_init_.Initialize()
...
func NewDataAwsMqBrokerLdapServerMetadataList_Override(d DataAwsMqBrokerLdapServerMetadataList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsMqBrokerLdapServerMetadataList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsMqBrokerLdapServerMetadataList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsMqBrokerLdapServerMetadataList) Resolve(context cdktn.IResolveContext) interface{} {
