...
func (j *jsiiProxy_DataAwsMqBrokerUserList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsMqBrokerUserList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsMqBrokerUserList {
	_init_.Initialize()
...
func NewDataAwsMqBrokerUserList_Override(d DataAwsMqBrokerUserList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsMqBrokerUserList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsMqBrokerUserList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsMqBrokerUserList) Resolve(context cdktn.IResolveContext) interface{} {
