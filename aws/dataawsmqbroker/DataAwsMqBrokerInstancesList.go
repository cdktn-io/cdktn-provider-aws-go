...
func (j *jsiiProxy_DataAwsMqBrokerInstancesList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsMqBrokerInstancesList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsMqBrokerInstancesList {
	_init_.Initialize()
...
func NewDataAwsMqBrokerInstancesList_Override(d DataAwsMqBrokerInstancesList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsMqBrokerInstancesList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsMqBrokerInstancesList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsMqBrokerInstancesList) Resolve(context cdktn.IResolveContext) interface{} {
