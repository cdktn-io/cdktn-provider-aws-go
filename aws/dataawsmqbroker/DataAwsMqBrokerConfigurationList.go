...
func (j *jsiiProxy_DataAwsMqBrokerConfigurationList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsMqBrokerConfigurationList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsMqBrokerConfigurationList {
	_init_.Initialize()
...
func NewDataAwsMqBrokerConfigurationList_Override(d DataAwsMqBrokerConfigurationList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsMqBrokerConfigurationList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsMqBrokerConfigurationList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsMqBrokerConfigurationList) Resolve(context cdktn.IResolveContext) interface{} {
