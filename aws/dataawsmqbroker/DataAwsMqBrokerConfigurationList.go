...
func (d *jsiiProxy_DataAwsMqBrokerConfigurationList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsMqBrokerConfigurationList) Resolve(context cdktf.IResolveContext) interface{} {
