...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v21/sagemakermodelpackagegrouppolicy/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.28.0/docs/resources/sagemaker_model_package_group_policy aws_sagemaker_model_package_group_policy}.
...
func (j *jsiiProxy_SagemakerModelPackageGroupPolicy) ForEach() cdktf.ITerraformIterator {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.28.0/docs/resources/sagemaker_model_package_group_policy aws_sagemaker_model_package_group_policy} Resource.
...
func (j *jsiiProxy_SagemakerModelPackageGroupPolicy)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func SagemakerModelPackageGroupPolicy_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (s *jsiiProxy_SagemakerModelPackageGroupPolicy) ImportFrom(id *string, provider cdktf.TerraformProvider) {
