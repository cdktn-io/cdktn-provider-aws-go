...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/sagemakermodelpackagegrouppolicy/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/sagemaker_model_package_group_policy aws_sagemaker_model_package_group_policy}.
...
func (j *jsiiProxy_SagemakerModelPackageGroupPolicy) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_SagemakerModelPackageGroupPolicy) Connection() interface{} {
...
func (j *jsiiProxy_SagemakerModelPackageGroupPolicy) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_SagemakerModelPackageGroupPolicy) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_SagemakerModelPackageGroupPolicy) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_SagemakerModelPackageGroupPolicy) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_SagemakerModelPackageGroupPolicy) Provisioners() *[]interface{} {
	var returns *[]interface{}
	_jsii_.Get(
		j,
		"provisioners",
...
func (j *jsiiProxy_SagemakerModelPackageGroupPolicy) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/sagemaker_model_package_group_policy aws_sagemaker_model_package_group_policy} Resource.
func NewSagemakerModelPackageGroupPolicy(scope constructs.Construct, id *string, config *SagemakerModelPackageGroupPolicyConfig) SagemakerModelPackageGroupPolicy {
	...
	if err := validateNewSagemakerModelPackageGroupPolicyParameters(scope, id, config); err != nil {
		panic(err)
	}
	j := jsiiProxy_SagemakerModelPackageGroupPolicy{}

	_jsii_.Create(
		"@cdktn/provider-aws.sagemakerModelPackageGroupPolicy.SagemakerModelPackageGroupPolicy",
...
func (j *jsiiProxy_SagemakerModelPackageGroupPolicy)SetConnection(val interface{}) {
...
func (j *jsiiProxy_SagemakerModelPackageGroupPolicy)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_SagemakerModelPackageGroupPolicy)SetId(val *string) {
...
func (j *jsiiProxy_SagemakerModelPackageGroupPolicy)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_SagemakerModelPackageGroupPolicy)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_SagemakerModelPackageGroupPolicy)SetProvisioners(val *[]interface{}) {
...
func SagemakerModelPackageGroupPolicy_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateSagemakerModelPackageGroupPolicy_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func SagemakerModelPackageGroupPolicy_IsConstruct(x interface{}) *bool {
	...
	if err := validateSagemakerModelPackageGroupPolicy_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func SagemakerModelPackageGroupPolicy_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateSagemakerModelPackageGroupPolicy_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func SagemakerModelPackageGroupPolicy_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateSagemakerModelPackageGroupPolicy_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (s *jsiiProxy_SagemakerModelPackageGroupPolicy) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_SagemakerModelPackageGroupPolicy) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SagemakerModelPackageGroupPolicy) HasResourceMove() interface{} {
	var returns interface{}
...
func (s *jsiiProxy_SagemakerModelPackageGroupPolicy) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_SagemakerModelPackageGroupPolicy) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SagemakerModelPackageGroupPolicy) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_SagemakerModelPackageGroupPolicy) MoveFromId(id *string) {
...
func (s *jsiiProxy_SagemakerModelPackageGroupPolicy) MoveTo(moveTarget *string, index interface{}) {
...
func (s *jsiiProxy_SagemakerModelPackageGroupPolicy) MoveToId(id *string) {
...
func (s *jsiiProxy_SagemakerModelPackageGroupPolicy) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_SagemakerModelPackageGroupPolicy) ResetId() {
	_jsii_.InvokeVoid(
		s,
		"resetId",
		nil, // no parameters
...
func (s *jsiiProxy_SagemakerModelPackageGroupPolicy) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (s *jsiiProxy_SagemakerModelPackageGroupPolicy) ToHclTerraform() interface{} {
	var returns interface{}
...
func (s *jsiiProxy_SagemakerModelPackageGroupPolicy) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
