...
func (j *jsiiProxy_QuicksightRefreshScheduleScheduleScheduleFrequencyRefreshOnDayList) TerraformResource() cdktf.IInterpolatingParent {
...
func (j *jsiiProxy_QuicksightRefreshScheduleScheduleScheduleFrequencyRefreshOnDayList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (q *jsiiProxy_QuicksightRefreshScheduleScheduleScheduleFrequencyRefreshOnDayList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (q *jsiiProxy_QuicksightRefreshScheduleScheduleScheduleFrequencyRefreshOnDayList) Resolve(context cdktf.IResolveContext) interface{} {
