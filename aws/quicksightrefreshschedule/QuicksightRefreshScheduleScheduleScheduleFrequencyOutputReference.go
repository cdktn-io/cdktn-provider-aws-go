...
func (j *jsiiProxy_QuicksightRefreshScheduleScheduleScheduleFrequencyOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewQuicksightRefreshScheduleScheduleScheduleFrequencyOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) QuicksightRefreshScheduleScheduleScheduleFrequencyOutputReference {
	_init_.Initialize()
...
func NewQuicksightRefreshScheduleScheduleScheduleFrequencyOutputReference_Override(q QuicksightRefreshScheduleScheduleScheduleFrequencyOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_QuicksightRefreshScheduleScheduleScheduleFrequencyOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (q *jsiiProxy_QuicksightRefreshScheduleScheduleScheduleFrequencyOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (q *jsiiProxy_QuicksightRefreshScheduleScheduleScheduleFrequencyOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (q *jsiiProxy_QuicksightRefreshScheduleScheduleScheduleFrequencyOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (q *jsiiProxy_QuicksightRefreshScheduleScheduleScheduleFrequencyOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
