...
func (j *jsiiProxy_QuicksightRefreshScheduleScheduleScheduleFrequencyList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewQuicksightRefreshScheduleScheduleScheduleFrequencyList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) QuicksightRefreshScheduleScheduleScheduleFrequencyList {
	_init_.Initialize()
...
func NewQuicksightRefreshScheduleScheduleScheduleFrequencyList_Override(q QuicksightRefreshScheduleScheduleScheduleFrequencyList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_QuicksightRefreshScheduleScheduleScheduleFrequencyList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (q *jsiiProxy_QuicksightRefreshScheduleScheduleScheduleFrequencyList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (q *jsiiProxy_QuicksightRefreshScheduleScheduleScheduleFrequencyList) Resolve(context cdktn.IResolveContext) interface{} {
