...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/cloudfrontoriginaccessidentity/internal"
...
func (c *jsiiProxy_CloudfrontOriginAccessIdentity) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_CloudfrontOriginAccessIdentity) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (c *jsiiProxy_CloudfrontOriginAccessIdentity) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
