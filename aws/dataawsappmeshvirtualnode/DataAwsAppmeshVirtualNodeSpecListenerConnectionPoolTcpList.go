...
func (j *jsiiProxy_DataAwsAppmeshVirtualNodeSpecListenerConnectionPoolTcpList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsAppmeshVirtualNodeSpecListenerConnectionPoolTcpList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsAppmeshVirtualNodeSpecListenerConnectionPoolTcpList {
	_init_.Initialize()
...
func NewDataAwsAppmeshVirtualNodeSpecListenerConnectionPoolTcpList_Override(d DataAwsAppmeshVirtualNodeSpecListenerConnectionPoolTcpList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsAppmeshVirtualNodeSpecListenerConnectionPoolTcpList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsAppmeshVirtualNodeSpecListenerConnectionPoolTcpList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsAppmeshVirtualNodeSpecListenerConnectionPoolTcpList) Resolve(context cdktn.IResolveContext) interface{} {
