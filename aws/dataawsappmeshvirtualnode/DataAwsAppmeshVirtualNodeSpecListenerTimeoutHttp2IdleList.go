...
func (d *jsiiProxy_DataAwsAppmeshVirtualNodeSpecListenerTimeoutHttp2IdleList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsAppmeshVirtualNodeSpecListenerTimeoutHttp2IdleList) Resolve(context cdktf.IResolveContext) interface{} {
