...
func (j *jsiiProxy_DataAwsAppmeshVirtualNodeSpecListenerTlsCertificateAcmList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewDataAwsAppmeshVirtualNodeSpecListenerTlsCertificateAcmList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsAppmeshVirtualNodeSpecListenerTlsCertificateAcmList {
	_init_.Initialize()
...
func NewDataAwsAppmeshVirtualNodeSpecListenerTlsCertificateAcmList_Override(d DataAwsAppmeshVirtualNodeSpecListenerTlsCertificateAcmList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsAppmeshVirtualNodeSpecListenerTlsCertificateAcmList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsAppmeshVirtualNodeSpecListenerTlsCertificateAcmList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsAppmeshVirtualNodeSpecListenerTlsCertificateAcmList) Resolve(context cdktf.IResolveContext) interface{} {
