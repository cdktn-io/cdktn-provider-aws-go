...
func (j *jsiiProxy_DataAwsAppmeshVirtualNodeSpecListenerTlsCertificateSdsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsAppmeshVirtualNodeSpecListenerTlsCertificateSdsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsAppmeshVirtualNodeSpecListenerTlsCertificateSdsList {
	_init_.Initialize()
...
func NewDataAwsAppmeshVirtualNodeSpecListenerTlsCertificateSdsList_Override(d DataAwsAppmeshVirtualNodeSpecListenerTlsCertificateSdsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsAppmeshVirtualNodeSpecListenerTlsCertificateSdsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsAppmeshVirtualNodeSpecListenerTlsCertificateSdsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsAppmeshVirtualNodeSpecListenerTlsCertificateSdsList) Resolve(context cdktn.IResolveContext) interface{} {
