...
func (j *jsiiProxy_DataAwsAppmeshVirtualNodeSpecListenerConnectionPoolHttpList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsAppmeshVirtualNodeSpecListenerConnectionPoolHttpList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsAppmeshVirtualNodeSpecListenerConnectionPoolHttpList {
	_init_.Initialize()
...
func NewDataAwsAppmeshVirtualNodeSpecListenerConnectionPoolHttpList_Override(d DataAwsAppmeshVirtualNodeSpecListenerConnectionPoolHttpList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsAppmeshVirtualNodeSpecListenerConnectionPoolHttpList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsAppmeshVirtualNodeSpecListenerConnectionPoolHttpList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsAppmeshVirtualNodeSpecListenerConnectionPoolHttpList) Resolve(context cdktn.IResolveContext) interface{} {
