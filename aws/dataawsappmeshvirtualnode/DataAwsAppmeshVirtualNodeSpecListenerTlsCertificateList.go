...
func (j *jsiiProxy_DataAwsAppmeshVirtualNodeSpecListenerTlsCertificateList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsAppmeshVirtualNodeSpecListenerTlsCertificateList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsAppmeshVirtualNodeSpecListenerTlsCertificateList {
	_init_.Initialize()
...
func NewDataAwsAppmeshVirtualNodeSpecListenerTlsCertificateList_Override(d DataAwsAppmeshVirtualNodeSpecListenerTlsCertificateList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsAppmeshVirtualNodeSpecListenerTlsCertificateList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsAppmeshVirtualNodeSpecListenerTlsCertificateList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsAppmeshVirtualNodeSpecListenerTlsCertificateList) Resolve(context cdktn.IResolveContext) interface{} {
