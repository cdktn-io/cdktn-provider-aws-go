...
func (d *jsiiProxy_DataAwsAppmeshVirtualNodeSpecListenerOutlierDetectionIntervalList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsAppmeshVirtualNodeSpecListenerOutlierDetectionIntervalList) Resolve(context cdktf.IResolveContext) interface{} {
