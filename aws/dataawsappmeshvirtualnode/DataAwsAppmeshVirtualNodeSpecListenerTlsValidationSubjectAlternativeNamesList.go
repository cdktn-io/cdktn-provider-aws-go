...
func (d *jsiiProxy_DataAwsAppmeshVirtualNodeSpecListenerTlsValidationSubjectAlternativeNamesList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsAppmeshVirtualNodeSpecListenerTlsValidationSubjectAlternativeNamesList) Resolve(context cdktf.IResolveContext) interface{} {
