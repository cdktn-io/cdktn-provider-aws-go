...
func (j *jsiiProxy_DataAwsAppmeshVirtualNodeSpecListenerTimeoutGrpcIdleList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsAppmeshVirtualNodeSpecListenerTimeoutGrpcIdleList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsAppmeshVirtualNodeSpecListenerTimeoutGrpcIdleList {
	_init_.Initialize()
...
func NewDataAwsAppmeshVirtualNodeSpecListenerTimeoutGrpcIdleList_Override(d DataAwsAppmeshVirtualNodeSpecListenerTimeoutGrpcIdleList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsAppmeshVirtualNodeSpecListenerTimeoutGrpcIdleList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsAppmeshVirtualNodeSpecListenerTimeoutGrpcIdleList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsAppmeshVirtualNodeSpecListenerTimeoutGrpcIdleList) Resolve(context cdktn.IResolveContext) interface{} {
