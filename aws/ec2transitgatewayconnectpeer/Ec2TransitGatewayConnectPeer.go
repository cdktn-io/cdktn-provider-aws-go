...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/ec2transitgatewayconnectpeer/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/ec2_transit_gateway_connect_peer aws_ec2_transit_gateway_connect_peer}.
...
func (j *jsiiProxy_Ec2TransitGatewayConnectPeer) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_Ec2TransitGatewayConnectPeer) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/ec2_transit_gateway_connect_peer aws_ec2_transit_gateway_connect_peer} Resource.
...
func (j *jsiiProxy_Ec2TransitGatewayConnectPeer)SetRegion(val *string) {
...
func (e *jsiiProxy_Ec2TransitGatewayConnectPeer) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (e *jsiiProxy_Ec2TransitGatewayConnectPeer) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (e *jsiiProxy_Ec2TransitGatewayConnectPeer) ResetRegion() {
	_jsii_.InvokeVoid(
		e,
		"resetRegion",
		nil, // no parameters
...
func (e *jsiiProxy_Ec2TransitGatewayConnectPeer) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
