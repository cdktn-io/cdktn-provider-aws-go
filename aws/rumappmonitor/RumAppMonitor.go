...
func (j *jsiiProxy_RumAppMonitor) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_RumAppMonitor) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_RumAppMonitor) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_RumAppMonitor) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_RumAppMonitor) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_RumAppMonitor) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_RumAppMonitor) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/rum_app_monitor aws_rum_app_monitor} Resource.
...
func (j *jsiiProxy_RumAppMonitor)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_RumAppMonitor)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_RumAppMonitor)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_RumAppMonitor)SetRegion(val *string) {
...
func RumAppMonitor_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateRumAppMonitor_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (r *jsiiProxy_RumAppMonitor) AddMoveTarget(moveTarget *string) {
...
func (r *jsiiProxy_RumAppMonitor) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (r *jsiiProxy_RumAppMonitor) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (r *jsiiProxy_RumAppMonitor) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (r *jsiiProxy_RumAppMonitor) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (r *jsiiProxy_RumAppMonitor) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (r *jsiiProxy_RumAppMonitor) ResetRegion() {
	_jsii_.InvokeVoid(
		r,
		"resetRegion",
		nil, // no parameters
...
func (r *jsiiProxy_RumAppMonitor) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
