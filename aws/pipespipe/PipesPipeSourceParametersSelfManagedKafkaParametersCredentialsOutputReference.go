...
func (p *jsiiProxy_PipesPipeSourceParametersSelfManagedKafkaParametersCredentialsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (p *jsiiProxy_PipesPipeSourceParametersSelfManagedKafkaParametersCredentialsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
