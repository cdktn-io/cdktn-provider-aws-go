...
func (j *jsiiProxy_PipesPipeTargetParametersSqsQueueParametersOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewPipesPipeTargetParametersSqsQueueParametersOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) PipesPipeTargetParametersSqsQueueParametersOutputReference {
	_init_.Initialize()
...
func NewPipesPipeTargetParametersSqsQueueParametersOutputReference_Override(p PipesPipeTargetParametersSqsQueueParametersOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_PipesPipeTargetParametersSqsQueueParametersOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (p *jsiiProxy_PipesPipeTargetParametersSqsQueueParametersOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PipesPipeTargetParametersSqsQueueParametersOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (p *jsiiProxy_PipesPipeTargetParametersSqsQueueParametersOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PipesPipeTargetParametersSqsQueueParametersOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
