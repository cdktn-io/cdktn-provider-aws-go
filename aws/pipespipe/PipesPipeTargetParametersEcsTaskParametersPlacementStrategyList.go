...
func (j *jsiiProxy_PipesPipeTargetParametersEcsTaskParametersPlacementStrategyList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewPipesPipeTargetParametersEcsTaskParametersPlacementStrategyList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) PipesPipeTargetParametersEcsTaskParametersPlacementStrategyList {
	_init_.Initialize()
...
func NewPipesPipeTargetParametersEcsTaskParametersPlacementStrategyList_Override(p PipesPipeTargetParametersEcsTaskParametersPlacementStrategyList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_PipesPipeTargetParametersEcsTaskParametersPlacementStrategyList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (p *jsiiProxy_PipesPipeTargetParametersEcsTaskParametersPlacementStrategyList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (p *jsiiProxy_PipesPipeTargetParametersEcsTaskParametersPlacementStrategyList) Resolve(context cdktn.IResolveContext) interface{} {
