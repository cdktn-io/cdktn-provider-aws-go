...
func (p *jsiiProxy_PipesPipeSourceParametersOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (p *jsiiProxy_PipesPipeSourceParametersOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
