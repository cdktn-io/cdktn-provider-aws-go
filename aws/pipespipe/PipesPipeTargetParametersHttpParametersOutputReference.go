...
func (j *jsiiProxy_PipesPipeTargetParametersHttpParametersOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewPipesPipeTargetParametersHttpParametersOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) PipesPipeTargetParametersHttpParametersOutputReference {
	_init_.Initialize()
...
func NewPipesPipeTargetParametersHttpParametersOutputReference_Override(p PipesPipeTargetParametersHttpParametersOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_PipesPipeTargetParametersHttpParametersOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (p *jsiiProxy_PipesPipeTargetParametersHttpParametersOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PipesPipeTargetParametersHttpParametersOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (p *jsiiProxy_PipesPipeTargetParametersHttpParametersOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PipesPipeTargetParametersHttpParametersOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
