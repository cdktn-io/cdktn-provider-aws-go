...
func (j *jsiiProxy_PipesPipeLogConfigurationS3LogDestinationOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewPipesPipeLogConfigurationS3LogDestinationOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) PipesPipeLogConfigurationS3LogDestinationOutputReference {
	_init_.Initialize()
...
func NewPipesPipeLogConfigurationS3LogDestinationOutputReference_Override(p PipesPipeLogConfigurationS3LogDestinationOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_PipesPipeLogConfigurationS3LogDestinationOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (p *jsiiProxy_PipesPipeLogConfigurationS3LogDestinationOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PipesPipeLogConfigurationS3LogDestinationOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (p *jsiiProxy_PipesPipeLogConfigurationS3LogDestinationOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PipesPipeLogConfigurationS3LogDestinationOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
