...
func (p *jsiiProxy_PipesPipeLogConfigurationS3LogDestinationOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (p *jsiiProxy_PipesPipeLogConfigurationS3LogDestinationOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
