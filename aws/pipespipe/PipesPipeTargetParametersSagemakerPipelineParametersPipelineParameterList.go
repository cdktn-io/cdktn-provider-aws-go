...
func (j *jsiiProxy_PipesPipeTargetParametersSagemakerPipelineParametersPipelineParameterList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewPipesPipeTargetParametersSagemakerPipelineParametersPipelineParameterList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) PipesPipeTargetParametersSagemakerPipelineParametersPipelineParameterList {
	_init_.Initialize()
...
func NewPipesPipeTargetParametersSagemakerPipelineParametersPipelineParameterList_Override(p PipesPipeTargetParametersSagemakerPipelineParametersPipelineParameterList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_PipesPipeTargetParametersSagemakerPipelineParametersPipelineParameterList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (p *jsiiProxy_PipesPipeTargetParametersSagemakerPipelineParametersPipelineParameterList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (p *jsiiProxy_PipesPipeTargetParametersSagemakerPipelineParametersPipelineParameterList) Resolve(context cdktn.IResolveContext) interface{} {
