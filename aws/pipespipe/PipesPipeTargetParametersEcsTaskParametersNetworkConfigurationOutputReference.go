...
func (j *jsiiProxy_PipesPipeTargetParametersEcsTaskParametersNetworkConfigurationOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewPipesPipeTargetParametersEcsTaskParametersNetworkConfigurationOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) PipesPipeTargetParametersEcsTaskParametersNetworkConfigurationOutputReference {
	_init_.Initialize()
...
func NewPipesPipeTargetParametersEcsTaskParametersNetworkConfigurationOutputReference_Override(p PipesPipeTargetParametersEcsTaskParametersNetworkConfigurationOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_PipesPipeTargetParametersEcsTaskParametersNetworkConfigurationOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (p *jsiiProxy_PipesPipeTargetParametersEcsTaskParametersNetworkConfigurationOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PipesPipeTargetParametersEcsTaskParametersNetworkConfigurationOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (p *jsiiProxy_PipesPipeTargetParametersEcsTaskParametersNetworkConfigurationOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PipesPipeTargetParametersEcsTaskParametersNetworkConfigurationOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
