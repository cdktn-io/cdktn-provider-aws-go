...
func (p *jsiiProxy_PipesPipeSourceParametersKinesisStreamParametersOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (p *jsiiProxy_PipesPipeSourceParametersKinesisStreamParametersOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
