...
func (j *jsiiProxy_PipesPipeTargetParametersBatchJobParametersContainerOverridesEnvironmentList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewPipesPipeTargetParametersBatchJobParametersContainerOverridesEnvironmentList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) PipesPipeTargetParametersBatchJobParametersContainerOverridesEnvironmentList {
	_init_.Initialize()
...
func NewPipesPipeTargetParametersBatchJobParametersContainerOverridesEnvironmentList_Override(p PipesPipeTargetParametersBatchJobParametersContainerOverridesEnvironmentList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_PipesPipeTargetParametersBatchJobParametersContainerOverridesEnvironmentList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (p *jsiiProxy_PipesPipeTargetParametersBatchJobParametersContainerOverridesEnvironmentList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (p *jsiiProxy_PipesPipeTargetParametersBatchJobParametersContainerOverridesEnvironmentList) Resolve(context cdktn.IResolveContext) interface{} {
