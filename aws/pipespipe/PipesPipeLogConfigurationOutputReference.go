...
func (j *jsiiProxy_PipesPipeLogConfigurationOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewPipesPipeLogConfigurationOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) PipesPipeLogConfigurationOutputReference {
	_init_.Initialize()
...
func NewPipesPipeLogConfigurationOutputReference_Override(p PipesPipeLogConfigurationOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_PipesPipeLogConfigurationOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (p *jsiiProxy_PipesPipeLogConfigurationOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PipesPipeLogConfigurationOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (p *jsiiProxy_PipesPipeLogConfigurationOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PipesPipeLogConfigurationOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
