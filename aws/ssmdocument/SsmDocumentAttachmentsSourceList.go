...
func (j *jsiiProxy_SsmDocumentAttachmentsSourceList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewSsmDocumentAttachmentsSourceList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) SsmDocumentAttachmentsSourceList {
	_init_.Initialize()
...
func NewSsmDocumentAttachmentsSourceList_Override(s SsmDocumentAttachmentsSourceList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_SsmDocumentAttachmentsSourceList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_SsmDocumentAttachmentsSourceList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (s *jsiiProxy_SsmDocumentAttachmentsSourceList) Resolve(context cdktn.IResolveContext) interface{} {
