...
func (j *jsiiProxy_SsmDocument) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_SsmDocument) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_SsmDocument) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_SsmDocument) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_SsmDocument) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/ssm_document aws_ssm_document} Resource.
...
func (j *jsiiProxy_SsmDocument)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_SsmDocument)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_SsmDocument)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func SsmDocument_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (s *jsiiProxy_SsmDocument) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SsmDocument) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_SsmDocument) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SsmDocument) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_SsmDocument) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_SsmDocument) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
