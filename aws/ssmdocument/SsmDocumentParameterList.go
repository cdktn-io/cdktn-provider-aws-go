...
func (j *jsiiProxy_SsmDocumentParameterList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewSsmDocumentParameterList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) SsmDocumentParameterList {
	_init_.Initialize()
...
func NewSsmDocumentParameterList_Override(s SsmDocumentParameterList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_SsmDocumentParameterList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_SsmDocumentParameterList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (s *jsiiProxy_SsmDocumentParameterList) Resolve(context cdktn.IResolveContext) interface{} {
