...
func (c *jsiiProxy_CloudfrontContinuousDeploymentPolicy) validatePutStagingDistributionDnsNamesParameters(value interface{}) error {
	if value == nil {
		return fmt.Errorf("parameter value is required, but nil was provided")
	}
	switch value.(type) {
	...
	case *[]*CloudfrontContinuousDeploymentPolicyStagingDistributionDnsNames:
		value := value.(*[]*CloudfrontContinuousDeploymentPolicyStagingDistributionDnsNames)
	...
	case []*CloudfrontContinuousDeploymentPolicyStagingDistributionDnsNames:
		value_ := value.([]*CloudfrontContinuousDeploymentPolicyStagingDistributionDnsNames)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*CloudfrontContinuousDeploymentPolicyStagingDistributionDnsNames; received %#v (a %T)", value, value)
		}
	}
...
func (c *jsiiProxy_CloudfrontContinuousDeploymentPolicy) validatePutTrafficConfigParameters(value interface{}) error {
	...
	case cdktf.IResolvable:
		// ok
	case *[]*CloudfrontContinuousDeploymentPolicyTrafficConfig:
		value := value.(*[]*CloudfrontContinuousDeploymentPolicyTrafficConfig)
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
			}
	...
	case []*CloudfrontContinuousDeploymentPolicyTrafficConfig:
		value_ := value.([]*CloudfrontContinuousDeploymentPolicyTrafficConfig)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*CloudfrontContinuousDeploymentPolicyTrafficConfig; received %#v (a %T)", value, value)
		}
	}
...
func (j *jsiiProxy_CloudfrontContinuousDeploymentPolicy) validateSetEnabledParameters(val interface{}) error {
	if val == nil {
...
func (j *jsiiProxy_CloudfrontContinuousDeploymentPolicy) validateSetLifecycleParameters(val *cdktf.TerraformResourceLifecycle) error {
	if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
		return err
	}
