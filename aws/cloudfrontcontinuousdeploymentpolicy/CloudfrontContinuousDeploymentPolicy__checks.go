...
func (c *jsiiProxy_CloudfrontContinuousDeploymentPolicy) validatePutStagingDistributionDnsNamesParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*CloudfrontContinuousDeploymentPolicyStagingDistributionDnsNames; received %#v (a %T)", value, value)
		}
	}
...
func (c *jsiiProxy_CloudfrontContinuousDeploymentPolicy) validatePutTrafficConfigParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*CloudfrontContinuousDeploymentPolicyTrafficConfig; received %#v (a %T)", value, value)
		}
	}
