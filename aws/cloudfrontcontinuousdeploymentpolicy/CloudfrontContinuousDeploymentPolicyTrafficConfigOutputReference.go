...
func (c *jsiiProxy_CloudfrontContinuousDeploymentPolicyTrafficConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CloudfrontContinuousDeploymentPolicyTrafficConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
