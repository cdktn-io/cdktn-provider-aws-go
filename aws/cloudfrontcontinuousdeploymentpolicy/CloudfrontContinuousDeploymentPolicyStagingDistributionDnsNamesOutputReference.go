...
func (c *jsiiProxy_CloudfrontContinuousDeploymentPolicyStagingDistributionDnsNamesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CloudfrontContinuousDeploymentPolicyStagingDistributionDnsNamesOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
