...
func (s *jsiiProxy_SagemakerFlowDefinitionOutputConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_SagemakerFlowDefinitionOutputConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
