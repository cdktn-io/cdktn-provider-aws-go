...
func (s *jsiiProxy_SagemakerFlowDefinitionHumanLoopActivationConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_SagemakerFlowDefinitionHumanLoopActivationConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
