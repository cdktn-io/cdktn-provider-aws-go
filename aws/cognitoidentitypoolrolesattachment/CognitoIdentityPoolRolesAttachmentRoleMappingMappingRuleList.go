...
func (j *jsiiProxy_CognitoIdentityPoolRolesAttachmentRoleMappingMappingRuleList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewCognitoIdentityPoolRolesAttachmentRoleMappingMappingRuleList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) CognitoIdentityPoolRolesAttachmentRoleMappingMappingRuleList {
	_init_.Initialize()
...
func NewCognitoIdentityPoolRolesAttachmentRoleMappingMappingRuleList_Override(c CognitoIdentityPoolRolesAttachmentRoleMappingMappingRuleList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_CognitoIdentityPoolRolesAttachmentRoleMappingMappingRuleList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_CognitoIdentityPoolRolesAttachmentRoleMappingMappingRuleList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (c *jsiiProxy_CognitoIdentityPoolRolesAttachmentRoleMappingMappingRuleList) Resolve(context cdktn.IResolveContext) interface{} {
