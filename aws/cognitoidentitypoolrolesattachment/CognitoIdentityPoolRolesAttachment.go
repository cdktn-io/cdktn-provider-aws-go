...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v21/cognitoidentitypoolrolesattachment/internal"
...
func CognitoIdentityPoolRolesAttachment_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (c *jsiiProxy_CognitoIdentityPoolRolesAttachment) ImportFrom(id *string, provider cdktf.TerraformProvider) {
