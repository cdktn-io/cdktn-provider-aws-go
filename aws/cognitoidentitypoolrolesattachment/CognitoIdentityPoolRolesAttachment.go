...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/cognitoidentitypoolrolesattachment/internal"
...
func (j *jsiiProxy_CognitoIdentityPoolRolesAttachment) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_CognitoIdentityPoolRolesAttachment) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_CognitoIdentityPoolRolesAttachment) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_CognitoIdentityPoolRolesAttachment) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_CognitoIdentityPoolRolesAttachment) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_CognitoIdentityPoolRolesAttachment) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_CognitoIdentityPoolRolesAttachment) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_CognitoIdentityPoolRolesAttachment)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_CognitoIdentityPoolRolesAttachment)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_CognitoIdentityPoolRolesAttachment)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_CognitoIdentityPoolRolesAttachment)SetRegion(val *string) {
...
func CognitoIdentityPoolRolesAttachment_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateCognitoIdentityPoolRolesAttachment_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (c *jsiiProxy_CognitoIdentityPoolRolesAttachment) AddMoveTarget(moveTarget *string) {
...
func (c *jsiiProxy_CognitoIdentityPoolRolesAttachment) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CognitoIdentityPoolRolesAttachment) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (c *jsiiProxy_CognitoIdentityPoolRolesAttachment) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CognitoIdentityPoolRolesAttachment) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_CognitoIdentityPoolRolesAttachment) MoveFromId(id *string) {
...
func (c *jsiiProxy_CognitoIdentityPoolRolesAttachment) MoveToId(id *string) {
...
func (c *jsiiProxy_CognitoIdentityPoolRolesAttachment) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (c *jsiiProxy_CognitoIdentityPoolRolesAttachment) ResetRegion() {
	_jsii_.InvokeVoid(
		c,
		"resetRegion",
		nil, // no parameters
...
func (c *jsiiProxy_CognitoIdentityPoolRolesAttachment) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
