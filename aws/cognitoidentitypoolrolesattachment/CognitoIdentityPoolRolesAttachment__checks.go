...
func (c *jsiiProxy_CognitoIdentityPoolRolesAttachment) validatePutRoleMappingParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*CognitoIdentityPoolRolesAttachmentRoleMapping; received %#v (a %T)", value, value)
		}
	}
