...
func (j *jsiiProxy_CognitoIdentityPoolRolesAttachmentRoleMappingList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewCognitoIdentityPoolRolesAttachmentRoleMappingList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) CognitoIdentityPoolRolesAttachmentRoleMappingList {
	_init_.Initialize()
...
func NewCognitoIdentityPoolRolesAttachmentRoleMappingList_Override(c CognitoIdentityPoolRolesAttachmentRoleMappingList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_CognitoIdentityPoolRolesAttachmentRoleMappingList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_CognitoIdentityPoolRolesAttachmentRoleMappingList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (c *jsiiProxy_CognitoIdentityPoolRolesAttachmentRoleMappingList) Resolve(context cdktn.IResolveContext) interface{} {
