...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/iotthing/internal"
...
func (j *jsiiProxy_IotThing) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_IotThing) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_IotThing) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_IotThing) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_IotThing) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_IotThing) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_IotThing) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_IotThing)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_IotThing)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_IotThing)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_IotThing)SetRegion(val *string) {
...
func IotThing_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (i *jsiiProxy_IotThing) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (i *jsiiProxy_IotThing) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (i *jsiiProxy_IotThing) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (i *jsiiProxy_IotThing) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (i *jsiiProxy_IotThing) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (i *jsiiProxy_IotThing) ResetRegion() {
	_jsii_.InvokeVoid(
		i,
		"resetRegion",
		nil, // no parameters
...
func (i *jsiiProxy_IotThing) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
