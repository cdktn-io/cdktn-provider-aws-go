...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/memorydbparametergroup/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/memorydb_parameter_group aws_memorydb_parameter_group}.
...
func (j *jsiiProxy_MemorydbParameterGroup) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_MemorydbParameterGroup) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_MemorydbParameterGroup) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_MemorydbParameterGroup) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_MemorydbParameterGroup) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_MemorydbParameterGroup) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_MemorydbParameterGroup) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/memorydb_parameter_group aws_memorydb_parameter_group} Resource.
...
func (j *jsiiProxy_MemorydbParameterGroup)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_MemorydbParameterGroup)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_MemorydbParameterGroup)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_MemorydbParameterGroup)SetRegion(val *string) {
...
func MemorydbParameterGroup_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (m *jsiiProxy_MemorydbParameterGroup) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MemorydbParameterGroup) HasResourceMove() interface{} {
	var returns interface{}
...
func (m *jsiiProxy_MemorydbParameterGroup) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (m *jsiiProxy_MemorydbParameterGroup) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MemorydbParameterGroup) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (m *jsiiProxy_MemorydbParameterGroup) MoveFromId(id *string) {
...
func (m *jsiiProxy_MemorydbParameterGroup) MoveToId(id *string) {
...
func (m *jsiiProxy_MemorydbParameterGroup) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (m *jsiiProxy_MemorydbParameterGroup) ResetRegion() {
	_jsii_.InvokeVoid(
		m,
		"resetRegion",
		nil, // no parameters
...
func (m *jsiiProxy_MemorydbParameterGroup) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (m *jsiiProxy_MemorydbParameterGroup) ToHclTerraform() interface{} {
	var returns interface{}
...
func (m *jsiiProxy_MemorydbParameterGroup) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
