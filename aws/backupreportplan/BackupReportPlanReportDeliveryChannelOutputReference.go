...
func (b *jsiiProxy_BackupReportPlanReportDeliveryChannelOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (b *jsiiProxy_BackupReportPlanReportDeliveryChannelOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
