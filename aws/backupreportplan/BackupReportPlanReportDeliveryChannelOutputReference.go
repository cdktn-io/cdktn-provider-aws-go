...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/backupreportplan/internal"
...
func (j *jsiiProxy_BackupReportPlanReportDeliveryChannelOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewBackupReportPlanReportDeliveryChannelOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) BackupReportPlanReportDeliveryChannelOutputReference {
	_init_.Initialize()
...
func NewBackupReportPlanReportDeliveryChannelOutputReference_Override(b BackupReportPlanReportDeliveryChannelOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_BackupReportPlanReportDeliveryChannelOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (b *jsiiProxy_BackupReportPlanReportDeliveryChannelOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (b *jsiiProxy_BackupReportPlanReportDeliveryChannelOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (b *jsiiProxy_BackupReportPlanReportDeliveryChannelOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (b *jsiiProxy_BackupReportPlanReportDeliveryChannelOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
