...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/amplify_domain_association aws_amplify_domain_association}.
...
func (j *jsiiProxy_AmplifyDomainAssociation) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_AmplifyDomainAssociation) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_AmplifyDomainAssociation) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_AmplifyDomainAssociation) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_AmplifyDomainAssociation) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_AmplifyDomainAssociation) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_AmplifyDomainAssociation) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/amplify_domain_association aws_amplify_domain_association} Resource.
...
func (j *jsiiProxy_AmplifyDomainAssociation)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_AmplifyDomainAssociation)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_AmplifyDomainAssociation)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_AmplifyDomainAssociation)SetRegion(val *string) {
...
func AmplifyDomainAssociation_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (a *jsiiProxy_AmplifyDomainAssociation) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AmplifyDomainAssociation) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (a *jsiiProxy_AmplifyDomainAssociation) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AmplifyDomainAssociation) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (a *jsiiProxy_AmplifyDomainAssociation) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (a *jsiiProxy_AmplifyDomainAssociation) ResetRegion() {
	_jsii_.InvokeVoid(
		a,
		"resetRegion",
		nil, // no parameters
...
func (a *jsiiProxy_AmplifyDomainAssociation) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
