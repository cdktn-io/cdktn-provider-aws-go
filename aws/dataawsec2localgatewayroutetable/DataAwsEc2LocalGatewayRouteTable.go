...
func (j *jsiiProxy_DataAwsEc2LocalGatewayRouteTable) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsEc2LocalGatewayRouteTable) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsEc2LocalGatewayRouteTable) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsEc2LocalGatewayRouteTable) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsEc2LocalGatewayRouteTable) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DataAwsEc2LocalGatewayRouteTable)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsEc2LocalGatewayRouteTable)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsEc2LocalGatewayRouteTable)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsEc2LocalGatewayRouteTable_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsEc2LocalGatewayRouteTable) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsEc2LocalGatewayRouteTable) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsEc2LocalGatewayRouteTable) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsEc2LocalGatewayRouteTable) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
