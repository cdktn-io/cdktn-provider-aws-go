...
func (j *jsiiProxy_DataAwsVpclatticeServiceDnsEntryList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsVpclatticeServiceDnsEntryList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsVpclatticeServiceDnsEntryList {
	_init_.Initialize()
...
func NewDataAwsVpclatticeServiceDnsEntryList_Override(d DataAwsVpclatticeServiceDnsEntryList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsVpclatticeServiceDnsEntryList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsVpclatticeServiceDnsEntryList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsVpclatticeServiceDnsEntryList) Resolve(context cdktn.IResolveContext) interface{} {
