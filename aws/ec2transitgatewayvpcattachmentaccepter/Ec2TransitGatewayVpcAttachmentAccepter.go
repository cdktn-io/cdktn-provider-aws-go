...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/ec2transitgatewayvpcattachmentaccepter/internal"
...
func (j *jsiiProxy_Ec2TransitGatewayVpcAttachmentAccepter) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_Ec2TransitGatewayVpcAttachmentAccepter) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_Ec2TransitGatewayVpcAttachmentAccepter) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_Ec2TransitGatewayVpcAttachmentAccepter) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_Ec2TransitGatewayVpcAttachmentAccepter) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/ec2_transit_gateway_vpc_attachment_accepter aws_ec2_transit_gateway_vpc_attachment_accepter} Resource.
...
func (j *jsiiProxy_Ec2TransitGatewayVpcAttachmentAccepter)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_Ec2TransitGatewayVpcAttachmentAccepter)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_Ec2TransitGatewayVpcAttachmentAccepter)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func Ec2TransitGatewayVpcAttachmentAccepter_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (e *jsiiProxy_Ec2TransitGatewayVpcAttachmentAccepter) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (e *jsiiProxy_Ec2TransitGatewayVpcAttachmentAccepter) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (e *jsiiProxy_Ec2TransitGatewayVpcAttachmentAccepter) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (e *jsiiProxy_Ec2TransitGatewayVpcAttachmentAccepter) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (e *jsiiProxy_Ec2TransitGatewayVpcAttachmentAccepter) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (e *jsiiProxy_Ec2TransitGatewayVpcAttachmentAccepter) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
