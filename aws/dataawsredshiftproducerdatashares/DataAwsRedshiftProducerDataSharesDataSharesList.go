...
func (j *jsiiProxy_DataAwsRedshiftProducerDataSharesDataSharesList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsRedshiftProducerDataSharesDataSharesList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsRedshiftProducerDataSharesDataSharesList {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-aws.dataAwsRedshiftProducerDataShares.DataAwsRedshiftProducerDataSharesDataSharesList",
...
func NewDataAwsRedshiftProducerDataSharesDataSharesList_Override(d DataAwsRedshiftProducerDataSharesDataSharesList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsRedshiftProducerDataSharesDataSharesList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsRedshiftProducerDataSharesDataSharesList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsRedshiftProducerDataSharesDataSharesList) Resolve(context cdktn.IResolveContext) interface{} {
