...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/elasticacheusergroup/internal"
...
func (j *jsiiProxy_ElasticacheUserGroup) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_ElasticacheUserGroup) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_ElasticacheUserGroup) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_ElasticacheUserGroup) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_ElasticacheUserGroup) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_ElasticacheUserGroup) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_ElasticacheUserGroup) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/elasticache_user_group aws_elasticache_user_group} Resource.
...
func (j *jsiiProxy_ElasticacheUserGroup)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_ElasticacheUserGroup)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_ElasticacheUserGroup)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_ElasticacheUserGroup)SetRegion(val *string) {
...
func ElasticacheUserGroup_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (e *jsiiProxy_ElasticacheUserGroup) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (e *jsiiProxy_ElasticacheUserGroup) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (e *jsiiProxy_ElasticacheUserGroup) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (e *jsiiProxy_ElasticacheUserGroup) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (e *jsiiProxy_ElasticacheUserGroup) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (e *jsiiProxy_ElasticacheUserGroup) ResetRegion() {
	_jsii_.InvokeVoid(
		e,
		"resetRegion",
		nil, // no parameters
...
func (e *jsiiProxy_ElasticacheUserGroup) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
