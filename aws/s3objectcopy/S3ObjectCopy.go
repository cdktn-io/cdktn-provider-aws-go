...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/s3_object_copy aws_s3_object_copy} Resource.
...
func (s *jsiiProxy_S3ObjectCopy) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_S3ObjectCopy) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_S3ObjectCopy) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
