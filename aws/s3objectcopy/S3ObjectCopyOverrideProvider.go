...
type S3ObjectCopyOverrideProvider struct {
	// default_tags block.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.39.0/docs/resources/s3_object_copy#default_tags S3ObjectCopy#default_tags}
