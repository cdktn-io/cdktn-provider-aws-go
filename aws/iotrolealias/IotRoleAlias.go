...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/iotrolealias/internal"
...
func (j *jsiiProxy_IotRoleAlias) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_IotRoleAlias) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_IotRoleAlias) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_IotRoleAlias) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_IotRoleAlias) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/iot_role_alias aws_iot_role_alias} Resource.
...
func (j *jsiiProxy_IotRoleAlias)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_IotRoleAlias)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_IotRoleAlias)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func IotRoleAlias_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (i *jsiiProxy_IotRoleAlias) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (i *jsiiProxy_IotRoleAlias) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (i *jsiiProxy_IotRoleAlias) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (i *jsiiProxy_IotRoleAlias) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (i *jsiiProxy_IotRoleAlias) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (i *jsiiProxy_IotRoleAlias) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
