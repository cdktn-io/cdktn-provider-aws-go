...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/connectsecurityprofile/internal"
...
func (j *jsiiProxy_ConnectSecurityProfile) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_ConnectSecurityProfile) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_ConnectSecurityProfile) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_ConnectSecurityProfile) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_ConnectSecurityProfile) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_ConnectSecurityProfile) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_ConnectSecurityProfile) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/connect_security_profile aws_connect_security_profile} Resource.
...
func (j *jsiiProxy_ConnectSecurityProfile)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_ConnectSecurityProfile)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_ConnectSecurityProfile)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_ConnectSecurityProfile)SetRegion(val *string) {
...
func ConnectSecurityProfile_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (c *jsiiProxy_ConnectSecurityProfile) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_ConnectSecurityProfile) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (c *jsiiProxy_ConnectSecurityProfile) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_ConnectSecurityProfile) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_ConnectSecurityProfile) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (c *jsiiProxy_ConnectSecurityProfile) ResetRegion() {
	_jsii_.InvokeVoid(
		c,
		"resetRegion",
		nil, // no parameters
...
func (c *jsiiProxy_ConnectSecurityProfile) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
