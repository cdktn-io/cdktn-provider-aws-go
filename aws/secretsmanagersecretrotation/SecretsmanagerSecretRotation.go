...
type SecretsmanagerSecretRotation interface {
	...
	ExternalSecretRotationMetadata() SecretsmanagerSecretRotationExternalSecretRotationMetadataList
...
func (j *jsiiProxy_SecretsmanagerSecretRotation) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_SecretsmanagerSecretRotation) ExternalSecretRotationMetadata() SecretsmanagerSecretRotationExternalSecretRotationMetadataList {
	var returns SecretsmanagerSecretRotationExternalSecretRotationMetadataList
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_SecretsmanagerSecretRotation) ExternalSecretRotationMetadataInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_SecretsmanagerSecretRotation) ExternalSecretRotationRoleArn() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_SecretsmanagerSecretRotation) ExternalSecretRotationRoleArnInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_SecretsmanagerSecretRotation) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_SecretsmanagerSecretRotation) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_SecretsmanagerSecretRotation) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_SecretsmanagerSecretRotation) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_SecretsmanagerSecretRotation)SetExternalSecretRotationRoleArn(val *string) {
...
func (j *jsiiProxy_SecretsmanagerSecretRotation)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_SecretsmanagerSecretRotation)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_SecretsmanagerSecretRotation)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func SecretsmanagerSecretRotation_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (s *jsiiProxy_SecretsmanagerSecretRotation) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SecretsmanagerSecretRotation) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_SecretsmanagerSecretRotation) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SecretsmanagerSecretRotation) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_SecretsmanagerSecretRotation) PutExternalSecretRotationMetadata(value interface{}) {
...
func (s *jsiiProxy_SecretsmanagerSecretRotation) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_SecretsmanagerSecretRotation) ResetExternalSecretRotationMetadata() {
	_jsii_.InvokeVoid(
		s,
		"resetExternalSecretRotationMetadata",
		nil, // no parameters
...
func (s *jsiiProxy_SecretsmanagerSecretRotation) ResetExternalSecretRotationRoleArn() {
	_jsii_.InvokeVoid(
		s,
		"resetExternalSecretRotationRoleArn",
		nil, // no parameters
...
func (s *jsiiProxy_SecretsmanagerSecretRotation) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
