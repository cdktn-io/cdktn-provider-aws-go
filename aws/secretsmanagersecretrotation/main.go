...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-aws.secretsmanagerSecretRotation.SecretsmanagerSecretRotationExternalSecretRotationMetadata",
		reflect.TypeOf((*SecretsmanagerSecretRotationExternalSecretRotationMetadata)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-aws.secretsmanagerSecretRotation.SecretsmanagerSecretRotationExternalSecretRotationMetadataList",
		reflect.TypeOf((*SecretsmanagerSecretRotationExternalSecretRotationMetadataList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		"@cdktn/provider-aws.secretsmanagerSecretRotation.SecretsmanagerSecretRotationExternalSecretRotationMetadataOutputReference",
		reflect.TypeOf((*SecretsmanagerSecretRotationExternalSecretRotationMetadataOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
		...
		func() interface{} {
			j := jsiiProxy_SecretsmanagerSecretRotationExternalSecretRotationMetadataOutputReference{}
