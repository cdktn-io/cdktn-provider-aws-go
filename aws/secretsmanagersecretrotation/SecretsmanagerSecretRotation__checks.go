...
func (s *jsiiProxy_SecretsmanagerSecretRotation) validatePutExternalSecretRotationMetadataParameters(value interface{}) error {
	...
	case *[]*SecretsmanagerSecretRotationExternalSecretRotationMetadata:
		value := value.(*[]*SecretsmanagerSecretRotationExternalSecretRotationMetadata)
	...
	case []*SecretsmanagerSecretRotationExternalSecretRotationMetadata:
		value_ := value.([]*SecretsmanagerSecretRotationExternalSecretRotationMetadata)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*SecretsmanagerSecretRotationExternalSecretRotationMetadata; received %#v (a %T)", value, value)
		}
	}
