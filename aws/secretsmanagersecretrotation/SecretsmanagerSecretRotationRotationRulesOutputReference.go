...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v24/secretsmanagersecretrotation/internal"
...
func (j *jsiiProxy_SecretsmanagerSecretRotationRotationRulesOutputReference) Duration() *string {
	var returns *string
	_jsii_.Get(
		j,
		"duration",
...
func (j *jsiiProxy_SecretsmanagerSecretRotationRotationRulesOutputReference) DurationInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"durationInput",
...
func (j *jsiiProxy_SecretsmanagerSecretRotationRotationRulesOutputReference) ScheduleExpression() *string {
	var returns *string
	_jsii_.Get(
		j,
		"scheduleExpression",
...
func (j *jsiiProxy_SecretsmanagerSecretRotationRotationRulesOutputReference) ScheduleExpressionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_SecretsmanagerSecretRotationRotationRulesOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewSecretsmanagerSecretRotationRotationRulesOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) SecretsmanagerSecretRotationRotationRulesOutputReference {
	_init_.Initialize()
...
func NewSecretsmanagerSecretRotationRotationRulesOutputReference_Override(s SecretsmanagerSecretRotationRotationRulesOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_SecretsmanagerSecretRotationRotationRulesOutputReference)SetDuration(val *string) {
...
func (j *jsiiProxy_SecretsmanagerSecretRotationRotationRulesOutputReference)SetScheduleExpression(val *string) {
...
func (j *jsiiProxy_SecretsmanagerSecretRotationRotationRulesOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_SecretsmanagerSecretRotationRotationRulesOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SecretsmanagerSecretRotationRotationRulesOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (s *jsiiProxy_SecretsmanagerSecretRotationRotationRulesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SecretsmanagerSecretRotationRotationRulesOutputReference) ResetAutomaticallyAfterDays() {
	_jsii_.InvokeVoid(
		s,
		"resetAutomaticallyAfterDays",
		nil, // no parameters
...
func (s *jsiiProxy_SecretsmanagerSecretRotationRotationRulesOutputReference) ResetDuration() {
	_jsii_.InvokeVoid(
		s,
		"resetDuration",
		nil, // no parameters
...
func (s *jsiiProxy_SecretsmanagerSecretRotationRotationRulesOutputReference) ResetScheduleExpression() {
	_jsii_.InvokeVoid(
		s,
		"resetScheduleExpression",
		nil, // no parameters
...
func (s *jsiiProxy_SecretsmanagerSecretRotationRotationRulesOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
