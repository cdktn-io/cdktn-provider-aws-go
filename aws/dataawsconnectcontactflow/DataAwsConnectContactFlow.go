...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/dataawsconnectcontactflow/internal"
...
func (j *jsiiProxy_DataAwsConnectContactFlow) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsConnectContactFlow) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsConnectContactFlow) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsConnectContactFlow) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsConnectContactFlow) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/data-sources/connect_contact_flow aws_connect_contact_flow} Data Source.
...
func (j *jsiiProxy_DataAwsConnectContactFlow)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsConnectContactFlow)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsConnectContactFlow)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsConnectContactFlow_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsConnectContactFlow) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsConnectContactFlow) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsConnectContactFlow) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsConnectContactFlow) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
