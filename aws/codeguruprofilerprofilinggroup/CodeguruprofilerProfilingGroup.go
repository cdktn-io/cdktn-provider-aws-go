...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/codeguruprofilerprofilinggroup/internal"
...
type CodeguruprofilerProfilingGroup interface {
	...
	AgentOrchestrationConfigInput() interface{}
	Arn() *string
	// Experimental.
	...
	PutAgentOrchestrationConfig(value interface{})
...
func (j *jsiiProxy_CodeguruprofilerProfilingGroup) AgentOrchestrationConfig() CodeguruprofilerProfilingGroupAgentOrchestrationConfigList {
	var returns CodeguruprofilerProfilingGroupAgentOrchestrationConfigList
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CodeguruprofilerProfilingGroup) AgentOrchestrationConfigInput() interface{} {
...
func (j *jsiiProxy_CodeguruprofilerProfilingGroup) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_CodeguruprofilerProfilingGroup) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_CodeguruprofilerProfilingGroup) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_CodeguruprofilerProfilingGroup) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_CodeguruprofilerProfilingGroup) NameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nameInput",
...
func (j *jsiiProxy_CodeguruprofilerProfilingGroup) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_CodeguruprofilerProfilingGroup) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_CodeguruprofilerProfilingGroup) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_CodeguruprofilerProfilingGroup) Tags() *map[string]*string {
...
func (j *jsiiProxy_CodeguruprofilerProfilingGroup) TagsAll() cdktn.StringMap {
...
func (j *jsiiProxy_CodeguruprofilerProfilingGroup) TagsInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsInput",
...
func (j *jsiiProxy_CodeguruprofilerProfilingGroup) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/codeguruprofiler_profiling_group aws_codeguruprofiler_profiling_group} Resource.
func NewCodeguruprofilerProfilingGroup(scope constructs.Construct, id *string, config *CodeguruprofilerProfilingGroupConfig) CodeguruprofilerProfilingGroup {
	...
	_jsii_.Create(
		"@cdktn/provider-aws.codeguruprofilerProfilingGroup.CodeguruprofilerProfilingGroup",
...
func (j *jsiiProxy_CodeguruprofilerProfilingGroup)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_CodeguruprofilerProfilingGroup)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_CodeguruprofilerProfilingGroup)SetName(val *string) {
...
func (j *jsiiProxy_CodeguruprofilerProfilingGroup)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_CodeguruprofilerProfilingGroup)SetRegion(val *string) {
...
func (j *jsiiProxy_CodeguruprofilerProfilingGroup)SetTags(val *map[string]*string) {
...
func CodeguruprofilerProfilingGroup_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (c *jsiiProxy_CodeguruprofilerProfilingGroup) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CodeguruprofilerProfilingGroup) HasResourceMove() interface{} {
	var returns interface{}
...
func (c *jsiiProxy_CodeguruprofilerProfilingGroup) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (c *jsiiProxy_CodeguruprofilerProfilingGroup) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CodeguruprofilerProfilingGroup) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_CodeguruprofilerProfilingGroup) MoveFromId(id *string) {
...
func (c *jsiiProxy_CodeguruprofilerProfilingGroup) MoveToId(id *string) {
...
func (c *jsiiProxy_CodeguruprofilerProfilingGroup) PutAgentOrchestrationConfig(value interface{}) {
	if err := c.validatePutAgentOrchestrationConfigParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		c,
		"putAgentOrchestrationConfig",
		[]interface{}{value},
	)
}

func (c *jsiiProxy_CodeguruprofilerProfilingGroup) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (c *jsiiProxy_CodeguruprofilerProfilingGroup) ResetAgentOrchestrationConfig() {
	_jsii_.InvokeVoid(
		c,
		"resetAgentOrchestrationConfig",
		nil, // no parameters
...
func (c *jsiiProxy_CodeguruprofilerProfilingGroup) ResetRegion() {
	_jsii_.InvokeVoid(
		c,
		"resetRegion",
		nil, // no parameters
...
func (c *jsiiProxy_CodeguruprofilerProfilingGroup) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (c *jsiiProxy_CodeguruprofilerProfilingGroup) ToHclTerraform() interface{} {
	var returns interface{}
...
func (c *jsiiProxy_CodeguruprofilerProfilingGroup) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
