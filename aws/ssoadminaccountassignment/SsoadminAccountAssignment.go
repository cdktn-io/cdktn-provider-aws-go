...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/ssoadminaccountassignment/internal"
...
func (j *jsiiProxy_SsoadminAccountAssignment) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_SsoadminAccountAssignment) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_SsoadminAccountAssignment) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_SsoadminAccountAssignment) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_SsoadminAccountAssignment) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_SsoadminAccountAssignment) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_SsoadminAccountAssignment) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_SsoadminAccountAssignment)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_SsoadminAccountAssignment)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_SsoadminAccountAssignment)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_SsoadminAccountAssignment)SetRegion(val *string) {
...
func SsoadminAccountAssignment_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (s *jsiiProxy_SsoadminAccountAssignment) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SsoadminAccountAssignment) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_SsoadminAccountAssignment) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SsoadminAccountAssignment) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_SsoadminAccountAssignment) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_SsoadminAccountAssignment) ResetRegion() {
	_jsii_.InvokeVoid(
		s,
		"resetRegion",
		nil, // no parameters
...
func (s *jsiiProxy_SsoadminAccountAssignment) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
