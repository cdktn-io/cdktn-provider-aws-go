...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/dataawssnstopic/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/sns_topic aws_sns_topic}.
...
func (j *jsiiProxy_DataAwsSnsTopic) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsSnsTopic) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsSnsTopic) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsSnsTopic) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsSnsTopic) TagsInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsInput",
...
func (j *jsiiProxy_DataAwsSnsTopic) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/sns_topic aws_sns_topic} Data Source.
func NewDataAwsSnsTopic(scope constructs.Construct, id *string, config *DataAwsSnsTopicConfig) DataAwsSnsTopic {
	_init_.Initialize()

	if err := validateNewDataAwsSnsTopicParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_DataAwsSnsTopic)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsSnsTopic)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsSnsTopic)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_DataAwsSnsTopic)SetTags(val *map[string]*string) {
...
func DataAwsSnsTopic_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateDataAwsSnsTopic_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func DataAwsSnsTopic_IsConstruct(x interface{}) *bool {
	...
	if err := validateDataAwsSnsTopic_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataAwsSnsTopic_IsTerraformDataSource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataAwsSnsTopic_IsTerraformDataSourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataAwsSnsTopic_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataAwsSnsTopic_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (d *jsiiProxy_DataAwsSnsTopic) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsSnsTopic) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsSnsTopic) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsSnsTopic) ResetTags() {
	_jsii_.InvokeVoid(
		d,
		"resetTags",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsSnsTopic) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataAwsSnsTopic) ToHclTerraform() interface{} {
	var returns interface{}
...
func (d *jsiiProxy_DataAwsSnsTopic) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
