...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/route53resolverfirewallrulegroup/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/route53_resolver_firewall_rule_group aws_route53_resolver_firewall_rule_group}.
...
func (j *jsiiProxy_Route53ResolverFirewallRuleGroup) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_Route53ResolverFirewallRuleGroup) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_Route53ResolverFirewallRuleGroup) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_Route53ResolverFirewallRuleGroup) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_Route53ResolverFirewallRuleGroup) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_Route53ResolverFirewallRuleGroup) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_Route53ResolverFirewallRuleGroup) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_Route53ResolverFirewallRuleGroup) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/route53_resolver_firewall_rule_group aws_route53_resolver_firewall_rule_group} Resource.
func NewRoute53ResolverFirewallRuleGroup(scope constructs.Construct, id *string, config *Route53ResolverFirewallRuleGroupConfig) Route53ResolverFirewallRuleGroup {
	...
	_jsii_.Create(
		"@cdktn/provider-aws.route53ResolverFirewallRuleGroup.Route53ResolverFirewallRuleGroup",
...
func (j *jsiiProxy_Route53ResolverFirewallRuleGroup)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_Route53ResolverFirewallRuleGroup)SetId(val *string) {
...
func (j *jsiiProxy_Route53ResolverFirewallRuleGroup)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_Route53ResolverFirewallRuleGroup)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_Route53ResolverFirewallRuleGroup)SetRegion(val *string) {
...
func Route53ResolverFirewallRuleGroup_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (r *jsiiProxy_Route53ResolverFirewallRuleGroup) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (r *jsiiProxy_Route53ResolverFirewallRuleGroup) HasResourceMove() interface{} {
	var returns interface{}
...
func (r *jsiiProxy_Route53ResolverFirewallRuleGroup) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (r *jsiiProxy_Route53ResolverFirewallRuleGroup) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (r *jsiiProxy_Route53ResolverFirewallRuleGroup) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (r *jsiiProxy_Route53ResolverFirewallRuleGroup) MoveFromId(id *string) {
...
func (r *jsiiProxy_Route53ResolverFirewallRuleGroup) MoveToId(id *string) {
...
func (r *jsiiProxy_Route53ResolverFirewallRuleGroup) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (r *jsiiProxy_Route53ResolverFirewallRuleGroup) ResetId() {
	_jsii_.InvokeVoid(
		r,
		"resetId",
		nil, // no parameters
...
func (r *jsiiProxy_Route53ResolverFirewallRuleGroup) ResetRegion() {
	_jsii_.InvokeVoid(
		r,
		"resetRegion",
		nil, // no parameters
...
func (r *jsiiProxy_Route53ResolverFirewallRuleGroup) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (r *jsiiProxy_Route53ResolverFirewallRuleGroup) ToHclTerraform() interface{} {
	var returns interface{}
...
func (r *jsiiProxy_Route53ResolverFirewallRuleGroup) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
