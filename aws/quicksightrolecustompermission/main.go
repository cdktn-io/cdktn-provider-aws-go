...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*QuicksightRoleCustomPermission)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-aws.quicksightRoleCustomPermission.QuicksightRoleCustomPermissionConfig",
		reflect.TypeOf((*QuicksightRoleCustomPermissionConfig)(nil)).Elem(),
	)
}
