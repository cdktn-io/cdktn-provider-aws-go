...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/directoryserviceconditionalforwarder/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/directory_service_conditional_forwarder aws_directory_service_conditional_forwarder}.
...
func (j *jsiiProxy_DirectoryServiceConditionalForwarder) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DirectoryServiceConditionalForwarder) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DirectoryServiceConditionalForwarder) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DirectoryServiceConditionalForwarder) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DirectoryServiceConditionalForwarder) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/directory_service_conditional_forwarder aws_directory_service_conditional_forwarder} Resource.
...
func (j *jsiiProxy_DirectoryServiceConditionalForwarder)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DirectoryServiceConditionalForwarder)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DirectoryServiceConditionalForwarder)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DirectoryServiceConditionalForwarder_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DirectoryServiceConditionalForwarder) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DirectoryServiceConditionalForwarder) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (d *jsiiProxy_DirectoryServiceConditionalForwarder) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DirectoryServiceConditionalForwarder) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (d *jsiiProxy_DirectoryServiceConditionalForwarder) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DirectoryServiceConditionalForwarder) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
