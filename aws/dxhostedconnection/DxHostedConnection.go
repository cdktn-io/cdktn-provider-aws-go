...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/dxhostedconnection/internal"
...
func (j *jsiiProxy_DxHostedConnection) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DxHostedConnection) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DxHostedConnection) JumboFrameCapable() cdktn.IResolvable {
...
func (j *jsiiProxy_DxHostedConnection) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DxHostedConnection) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DxHostedConnection) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DxHostedConnection)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DxHostedConnection)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DxHostedConnection)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DxHostedConnection_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DxHostedConnection) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DxHostedConnection) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (d *jsiiProxy_DxHostedConnection) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DxHostedConnection) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (d *jsiiProxy_DxHostedConnection) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DxHostedConnection) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
