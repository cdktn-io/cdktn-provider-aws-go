...
func (j *jsiiProxy_RedshiftSnapshotCopy) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_RedshiftSnapshotCopy) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_RedshiftSnapshotCopy) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_RedshiftSnapshotCopy) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_RedshiftSnapshotCopy) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.32.1/docs/resources/redshift_snapshot_copy aws_redshift_snapshot_copy} Resource.
...
func (j *jsiiProxy_RedshiftSnapshotCopy)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_RedshiftSnapshotCopy)SetLifecycle(val *cdktf.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_RedshiftSnapshotCopy)SetProvider(val cdktf.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func RedshiftSnapshotCopy_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (r *jsiiProxy_RedshiftSnapshotCopy) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (r *jsiiProxy_RedshiftSnapshotCopy) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (r *jsiiProxy_RedshiftSnapshotCopy) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
