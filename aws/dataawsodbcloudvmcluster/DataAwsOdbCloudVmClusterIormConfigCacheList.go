...
func (j *jsiiProxy_DataAwsOdbCloudVmClusterIormConfigCacheList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewDataAwsOdbCloudVmClusterIormConfigCacheList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsOdbCloudVmClusterIormConfigCacheList {
	_init_.Initialize()
...
func NewDataAwsOdbCloudVmClusterIormConfigCacheList_Override(d DataAwsOdbCloudVmClusterIormConfigCacheList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsOdbCloudVmClusterIormConfigCacheList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsOdbCloudVmClusterIormConfigCacheList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsOdbCloudVmClusterIormConfigCacheList) Resolve(context cdktf.IResolveContext) interface{} {
