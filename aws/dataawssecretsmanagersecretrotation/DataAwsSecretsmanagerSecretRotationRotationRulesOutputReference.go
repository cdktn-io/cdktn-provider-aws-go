...
func (d *jsiiProxy_DataAwsSecretsmanagerSecretRotationRotationRulesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataAwsSecretsmanagerSecretRotationRotationRulesOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
