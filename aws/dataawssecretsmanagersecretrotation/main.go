...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-aws.dataAwsSecretsmanagerSecretRotation.DataAwsSecretsmanagerSecretRotationExternalSecretRotationMetadata",
		reflect.TypeOf((*DataAwsSecretsmanagerSecretRotationExternalSecretRotationMetadata)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsSecretsmanagerSecretRotationExternalSecretRotationMetadataList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsSecretsmanagerSecretRotationExternalSecretRotationMetadataOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
