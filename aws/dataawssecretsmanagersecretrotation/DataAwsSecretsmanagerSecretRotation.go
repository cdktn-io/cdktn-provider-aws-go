...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/dataawssecretsmanagersecretrotation/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/data-sources/secretsmanager_secret_rotation aws_secretsmanager_secret_rotation}.
type DataAwsSecretsmanagerSecretRotation interface {
	...
	ExternalSecretRotationMetadata() DataAwsSecretsmanagerSecretRotationExternalSecretRotationMetadataList
...
func (j *jsiiProxy_DataAwsSecretsmanagerSecretRotation) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsSecretsmanagerSecretRotation) ExternalSecretRotationMetadata() DataAwsSecretsmanagerSecretRotationExternalSecretRotationMetadataList {
	var returns DataAwsSecretsmanagerSecretRotationExternalSecretRotationMetadataList
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataAwsSecretsmanagerSecretRotation) ExternalSecretRotationRoleArn() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataAwsSecretsmanagerSecretRotation) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsSecretsmanagerSecretRotation) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsSecretsmanagerSecretRotation) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsSecretsmanagerSecretRotation) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DataAwsSecretsmanagerSecretRotation) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_DataAwsSecretsmanagerSecretRotation) RotationEnabled() cdktn.IResolvable {
...
func (j *jsiiProxy_DataAwsSecretsmanagerSecretRotation) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/data-sources/secretsmanager_secret_rotation aws_secretsmanager_secret_rotation} Data Source.
...
func (j *jsiiProxy_DataAwsSecretsmanagerSecretRotation)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsSecretsmanagerSecretRotation)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsSecretsmanagerSecretRotation)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_DataAwsSecretsmanagerSecretRotation)SetRegion(val *string) {
...
func DataAwsSecretsmanagerSecretRotation_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateDataAwsSecretsmanagerSecretRotation_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
// Experimental.
func DataAwsSecretsmanagerSecretRotation_IsTerraformDataSource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataAwsSecretsmanagerSecretRotation_IsTerraformDataSourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataAwsSecretsmanagerSecretRotation_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataAwsSecretsmanagerSecretRotation_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (d *jsiiProxy_DataAwsSecretsmanagerSecretRotation) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsSecretsmanagerSecretRotation) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsSecretsmanagerSecretRotation) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsSecretsmanagerSecretRotation) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsSecretsmanagerSecretRotation) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataAwsSecretsmanagerSecretRotation) ToHclTerraform() interface{} {
	var returns interface{}
...
func (d *jsiiProxy_DataAwsSecretsmanagerSecretRotation) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
