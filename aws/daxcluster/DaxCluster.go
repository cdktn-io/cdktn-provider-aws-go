...
func (j *jsiiProxy_DaxCluster) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DaxCluster) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DaxCluster) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DaxCluster) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DaxCluster) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/dax_cluster aws_dax_cluster} Resource.
...
func (j *jsiiProxy_DaxCluster)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DaxCluster)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DaxCluster)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DaxCluster_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DaxCluster) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DaxCluster) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (d *jsiiProxy_DaxCluster) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DaxCluster) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (d *jsiiProxy_DaxCluster) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DaxCluster) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
