...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v23/dataawspartition/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.40.0/docs/data-sources/partition aws_partition}.
...
func (j *jsiiProxy_DataAwsPartition) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsPartition) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsPartition) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsPartition) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsPartition) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.40.0/docs/data-sources/partition aws_partition} Data Source.
...
func (j *jsiiProxy_DataAwsPartition)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsPartition)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsPartition)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsPartition_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsPartition) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsPartition) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
