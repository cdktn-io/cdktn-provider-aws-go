...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/dataawspartition/internal"
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/data-sources/partition aws_partition} Data Source.
...
func (d *jsiiProxy_DataAwsPartition) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
