...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/cloudwatcheventarchive/internal"
...
func (j *jsiiProxy_CloudwatchEventArchive) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_CloudwatchEventArchive) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_CloudwatchEventArchive) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_CloudwatchEventArchive) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_CloudwatchEventArchive) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/cloudwatch_event_archive aws_cloudwatch_event_archive} Resource.
...
func (j *jsiiProxy_CloudwatchEventArchive)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_CloudwatchEventArchive)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_CloudwatchEventArchive)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func CloudwatchEventArchive_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (c *jsiiProxy_CloudwatchEventArchive) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CloudwatchEventArchive) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (c *jsiiProxy_CloudwatchEventArchive) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CloudwatchEventArchive) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_CloudwatchEventArchive) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (c *jsiiProxy_CloudwatchEventArchive) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
