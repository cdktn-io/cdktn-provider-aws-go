...
func (c *jsiiProxy_ConnectInstance) validateAddMoveTargetParameters(moveTarget *string) error {
	return nil
}
...
func (c *jsiiProxy_ConnectInstance) validateImportFromParameters(id *string) error {
	return nil
}
...
func (c *jsiiProxy_ConnectInstance) validateMoveToIdParameters(id *string) error {
	return nil
}
...
func validateConnectInstance_GenerateConfigForImportParameters(scope constructs.Construct, importToId *string, importFromId *string) error {
	return nil
}
...
func (j *jsiiProxy_ConnectInstance) validateSetRegionParameters(val *string) error {
	return nil
}
