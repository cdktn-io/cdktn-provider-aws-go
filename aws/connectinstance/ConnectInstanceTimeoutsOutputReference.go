...
func (c *jsiiProxy_ConnectInstanceTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ConnectInstanceTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
