...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.40.0/docs/data-sources/servicecatalog_portfolio_constraints aws_servicecatalog_portfolio_constraints}.
...
func (j *jsiiProxy_DataAwsServicecatalogPortfolioConstraints) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsServicecatalogPortfolioConstraints) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsServicecatalogPortfolioConstraints) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsServicecatalogPortfolioConstraints) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsServicecatalogPortfolioConstraints) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.40.0/docs/data-sources/servicecatalog_portfolio_constraints aws_servicecatalog_portfolio_constraints} Data Source.
...
func (j *jsiiProxy_DataAwsServicecatalogPortfolioConstraints)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsServicecatalogPortfolioConstraints)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsServicecatalogPortfolioConstraints)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsServicecatalogPortfolioConstraints_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsServicecatalogPortfolioConstraints) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsServicecatalogPortfolioConstraints) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsServicecatalogPortfolioConstraints) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
