...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/dataawsimagebuildercomponent/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/data-sources/imagebuilder_component aws_imagebuilder_component}.
...
func (j *jsiiProxy_DataAwsImagebuilderComponent) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsImagebuilderComponent) Encrypted() cdktn.IResolvable {
...
func (j *jsiiProxy_DataAwsImagebuilderComponent) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsImagebuilderComponent) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsImagebuilderComponent) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsImagebuilderComponent) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DataAwsImagebuilderComponent) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_DataAwsImagebuilderComponent) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/data-sources/imagebuilder_component aws_imagebuilder_component} Data Source.
...
func (j *jsiiProxy_DataAwsImagebuilderComponent)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsImagebuilderComponent)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsImagebuilderComponent)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_DataAwsImagebuilderComponent)SetRegion(val *string) {
...
func DataAwsImagebuilderComponent_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateDataAwsImagebuilderComponent_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
// Experimental.
func DataAwsImagebuilderComponent_IsTerraformDataSource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataAwsImagebuilderComponent_IsTerraformDataSourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataAwsImagebuilderComponent_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataAwsImagebuilderComponent_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (d *jsiiProxy_DataAwsImagebuilderComponent) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsImagebuilderComponent) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsImagebuilderComponent) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsImagebuilderComponent) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsImagebuilderComponent) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataAwsImagebuilderComponent) ToHclTerraform() interface{} {
	var returns interface{}
...
func (d *jsiiProxy_DataAwsImagebuilderComponent) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
