...
func (j *jsiiProxy_SecurityhubInsightFiltersThreatIntelIndicatorTypeList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewSecurityhubInsightFiltersThreatIntelIndicatorTypeList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) SecurityhubInsightFiltersThreatIntelIndicatorTypeList {
	_init_.Initialize()
...
func NewSecurityhubInsightFiltersThreatIntelIndicatorTypeList_Override(s SecurityhubInsightFiltersThreatIntelIndicatorTypeList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_SecurityhubInsightFiltersThreatIntelIndicatorTypeList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (s *jsiiProxy_SecurityhubInsightFiltersThreatIntelIndicatorTypeList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (s *jsiiProxy_SecurityhubInsightFiltersThreatIntelIndicatorTypeList) Resolve(context cdktf.IResolveContext) interface{} {
