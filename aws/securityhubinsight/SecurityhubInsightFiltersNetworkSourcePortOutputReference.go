...
func (j *jsiiProxy_SecurityhubInsightFiltersNetworkSourcePortOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewSecurityhubInsightFiltersNetworkSourcePortOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) SecurityhubInsightFiltersNetworkSourcePortOutputReference {
	_init_.Initialize()
...
func NewSecurityhubInsightFiltersNetworkSourcePortOutputReference_Override(s SecurityhubInsightFiltersNetworkSourcePortOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_SecurityhubInsightFiltersNetworkSourcePortOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_SecurityhubInsightFiltersNetworkSourcePortOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SecurityhubInsightFiltersNetworkSourcePortOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (s *jsiiProxy_SecurityhubInsightFiltersNetworkSourcePortOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SecurityhubInsightFiltersNetworkSourcePortOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
