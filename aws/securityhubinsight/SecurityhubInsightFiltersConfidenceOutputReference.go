...
func (j *jsiiProxy_SecurityhubInsightFiltersConfidenceOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewSecurityhubInsightFiltersConfidenceOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) SecurityhubInsightFiltersConfidenceOutputReference {
	_init_.Initialize()
...
func NewSecurityhubInsightFiltersConfidenceOutputReference_Override(s SecurityhubInsightFiltersConfidenceOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_SecurityhubInsightFiltersConfidenceOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_SecurityhubInsightFiltersConfidenceOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SecurityhubInsightFiltersConfidenceOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (s *jsiiProxy_SecurityhubInsightFiltersConfidenceOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SecurityhubInsightFiltersConfidenceOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
