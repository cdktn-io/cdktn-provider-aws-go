...
func (s *jsiiProxy_SecurityhubInsightFiltersConfidenceOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_SecurityhubInsightFiltersConfidenceOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
