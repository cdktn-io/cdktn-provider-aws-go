...
func (j *jsiiProxy_SecurityhubInsightFiltersResourceAwsIamAccessKeyCreatedAtList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewSecurityhubInsightFiltersResourceAwsIamAccessKeyCreatedAtList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) SecurityhubInsightFiltersResourceAwsIamAccessKeyCreatedAtList {
	_init_.Initialize()
...
func NewSecurityhubInsightFiltersResourceAwsIamAccessKeyCreatedAtList_Override(s SecurityhubInsightFiltersResourceAwsIamAccessKeyCreatedAtList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_SecurityhubInsightFiltersResourceAwsIamAccessKeyCreatedAtList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_SecurityhubInsightFiltersResourceAwsIamAccessKeyCreatedAtList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (s *jsiiProxy_SecurityhubInsightFiltersResourceAwsIamAccessKeyCreatedAtList) Resolve(context cdktn.IResolveContext) interface{} {
