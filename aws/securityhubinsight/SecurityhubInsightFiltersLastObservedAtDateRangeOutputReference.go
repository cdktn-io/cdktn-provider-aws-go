...
func (j *jsiiProxy_SecurityhubInsightFiltersLastObservedAtDateRangeOutputReference) ComplexObjectIndex() interface{} {
...
func (j *jsiiProxy_SecurityhubInsightFiltersLastObservedAtDateRangeOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_SecurityhubInsightFiltersLastObservedAtDateRangeOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_SecurityhubInsightFiltersLastObservedAtDateRangeOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_SecurityhubInsightFiltersLastObservedAtDateRangeOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewSecurityhubInsightFiltersLastObservedAtDateRangeOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) SecurityhubInsightFiltersLastObservedAtDateRangeOutputReference {
	_init_.Initialize()

	if err := validateNewSecurityhubInsightFiltersLastObservedAtDateRangeOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewSecurityhubInsightFiltersLastObservedAtDateRangeOutputReference_Override(s SecurityhubInsightFiltersLastObservedAtDateRangeOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_SecurityhubInsightFiltersLastObservedAtDateRangeOutputReference)SetComplexObjectIndex(val interface{}) {
...
func (j *jsiiProxy_SecurityhubInsightFiltersLastObservedAtDateRangeOutputReference)SetComplexObjectIsFromSet(val *bool) {
...
func (j *jsiiProxy_SecurityhubInsightFiltersLastObservedAtDateRangeOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_SecurityhubInsightFiltersLastObservedAtDateRangeOutputReference) ComputeFqn() *string {
	var returns *string
...
func (s *jsiiProxy_SecurityhubInsightFiltersLastObservedAtDateRangeOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SecurityhubInsightFiltersLastObservedAtDateRangeOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (s *jsiiProxy_SecurityhubInsightFiltersLastObservedAtDateRangeOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SecurityhubInsightFiltersLastObservedAtDateRangeOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
...
func (s *jsiiProxy_SecurityhubInsightFiltersLastObservedAtDateRangeOutputReference) ToString() *string {
	var returns *string
