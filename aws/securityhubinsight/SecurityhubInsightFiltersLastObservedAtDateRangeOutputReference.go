...
func NewSecurityhubInsightFiltersLastObservedAtDateRangeOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) SecurityhubInsightFiltersLastObservedAtDateRangeOutputReference {
	_init_.Initialize()
...
func NewSecurityhubInsightFiltersLastObservedAtDateRangeOutputReference_Override(s SecurityhubInsightFiltersLastObservedAtDateRangeOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (s *jsiiProxy_SecurityhubInsightFiltersLastObservedAtDateRangeOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_SecurityhubInsightFiltersLastObservedAtDateRangeOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
