...
func (j *jsiiProxy_SecurityhubInsightFiltersResourceAwsS3BucketOwnerNameList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewSecurityhubInsightFiltersResourceAwsS3BucketOwnerNameList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) SecurityhubInsightFiltersResourceAwsS3BucketOwnerNameList {
	_init_.Initialize()
...
func NewSecurityhubInsightFiltersResourceAwsS3BucketOwnerNameList_Override(s SecurityhubInsightFiltersResourceAwsS3BucketOwnerNameList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_SecurityhubInsightFiltersResourceAwsS3BucketOwnerNameList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_SecurityhubInsightFiltersResourceAwsS3BucketOwnerNameList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (s *jsiiProxy_SecurityhubInsightFiltersResourceAwsS3BucketOwnerNameList) Resolve(context cdktn.IResolveContext) interface{} {
