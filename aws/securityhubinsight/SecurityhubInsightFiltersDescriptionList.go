...
func (j *jsiiProxy_SecurityhubInsightFiltersDescriptionList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewSecurityhubInsightFiltersDescriptionList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) SecurityhubInsightFiltersDescriptionList {
	_init_.Initialize()
...
func NewSecurityhubInsightFiltersDescriptionList_Override(s SecurityhubInsightFiltersDescriptionList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_SecurityhubInsightFiltersDescriptionList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_SecurityhubInsightFiltersDescriptionList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (s *jsiiProxy_SecurityhubInsightFiltersDescriptionList) Resolve(context cdktn.IResolveContext) interface{} {
