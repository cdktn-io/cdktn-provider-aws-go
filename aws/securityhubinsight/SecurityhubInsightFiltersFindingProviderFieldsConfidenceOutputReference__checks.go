...
func (s *jsiiProxy_SecurityhubInsightFiltersFindingProviderFieldsConfidenceOutputReference) validateResolveParameters(context cdktf.IResolveContext) error {
	if context == nil {
...
func (j *jsiiProxy_SecurityhubInsightFiltersFindingProviderFieldsConfidenceOutputReference) validateSetEqParameters(val *string) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func (j *jsiiProxy_SecurityhubInsightFiltersFindingProviderFieldsConfidenceOutputReference) validateSetGteParameters(val *string) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func (j *jsiiProxy_SecurityhubInsightFiltersFindingProviderFieldsConfidenceOutputReference) validateSetInternalValueParameters(val interface{}) error {
	...
	case *SecurityhubInsightFiltersFindingProviderFieldsConfidence:
		val := val.(*SecurityhubInsightFiltersFindingProviderFieldsConfidence)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case SecurityhubInsightFiltersFindingProviderFieldsConfidence:
		val_ := val.(SecurityhubInsightFiltersFindingProviderFieldsConfidence)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktf.IResolvable, *SecurityhubInsightFiltersFindingProviderFieldsConfidence; received %#v (a %T)", val, val)
		}
	}
...
func (j *jsiiProxy_SecurityhubInsightFiltersFindingProviderFieldsConfidenceOutputReference) validateSetLteParameters(val *string) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
