...
func (j *jsiiProxy_SecurityhubInsightFiltersResourceAwsIamAccessKeyUserNameList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewSecurityhubInsightFiltersResourceAwsIamAccessKeyUserNameList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) SecurityhubInsightFiltersResourceAwsIamAccessKeyUserNameList {
	_init_.Initialize()
...
func NewSecurityhubInsightFiltersResourceAwsIamAccessKeyUserNameList_Override(s SecurityhubInsightFiltersResourceAwsIamAccessKeyUserNameList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_SecurityhubInsightFiltersResourceAwsIamAccessKeyUserNameList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_SecurityhubInsightFiltersResourceAwsIamAccessKeyUserNameList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (s *jsiiProxy_SecurityhubInsightFiltersResourceAwsIamAccessKeyUserNameList) Resolve(context cdktn.IResolveContext) interface{} {
