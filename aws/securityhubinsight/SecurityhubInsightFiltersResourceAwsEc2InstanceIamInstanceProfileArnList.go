...
func (j *jsiiProxy_SecurityhubInsightFiltersResourceAwsEc2InstanceIamInstanceProfileArnList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewSecurityhubInsightFiltersResourceAwsEc2InstanceIamInstanceProfileArnList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) SecurityhubInsightFiltersResourceAwsEc2InstanceIamInstanceProfileArnList {
	_init_.Initialize()
...
func NewSecurityhubInsightFiltersResourceAwsEc2InstanceIamInstanceProfileArnList_Override(s SecurityhubInsightFiltersResourceAwsEc2InstanceIamInstanceProfileArnList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_SecurityhubInsightFiltersResourceAwsEc2InstanceIamInstanceProfileArnList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (s *jsiiProxy_SecurityhubInsightFiltersResourceAwsEc2InstanceIamInstanceProfileArnList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (s *jsiiProxy_SecurityhubInsightFiltersResourceAwsEc2InstanceIamInstanceProfileArnList) Resolve(context cdktf.IResolveContext) interface{} {
