...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v22/ec2subnetcidrreservation/internal"
...
func Ec2SubnetCidrReservation_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (e *jsiiProxy_Ec2SubnetCidrReservation) ImportFrom(id *string, provider cdktf.TerraformProvider) {
