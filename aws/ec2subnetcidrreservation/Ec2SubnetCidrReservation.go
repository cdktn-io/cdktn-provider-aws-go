...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/ec2subnetcidrreservation/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/ec2_subnet_cidr_reservation aws_ec2_subnet_cidr_reservation}.
...
func (j *jsiiProxy_Ec2SubnetCidrReservation) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_Ec2SubnetCidrReservation) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_Ec2SubnetCidrReservation) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_Ec2SubnetCidrReservation) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_Ec2SubnetCidrReservation) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/ec2_subnet_cidr_reservation aws_ec2_subnet_cidr_reservation} Resource.
...
func (j *jsiiProxy_Ec2SubnetCidrReservation)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_Ec2SubnetCidrReservation)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_Ec2SubnetCidrReservation)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func Ec2SubnetCidrReservation_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateEc2SubnetCidrReservation_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (e *jsiiProxy_Ec2SubnetCidrReservation) AddMoveTarget(moveTarget *string) {
...
func (e *jsiiProxy_Ec2SubnetCidrReservation) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (e *jsiiProxy_Ec2SubnetCidrReservation) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (e *jsiiProxy_Ec2SubnetCidrReservation) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (e *jsiiProxy_Ec2SubnetCidrReservation) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (e *jsiiProxy_Ec2SubnetCidrReservation) MoveFromId(id *string) {
...
func (e *jsiiProxy_Ec2SubnetCidrReservation) MoveToId(id *string) {
...
func (e *jsiiProxy_Ec2SubnetCidrReservation) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (e *jsiiProxy_Ec2SubnetCidrReservation) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
