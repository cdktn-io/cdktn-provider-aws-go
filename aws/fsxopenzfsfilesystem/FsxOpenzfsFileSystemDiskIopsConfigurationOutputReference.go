...
func (f *jsiiProxy_FsxOpenzfsFileSystemDiskIopsConfigurationOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (f *jsiiProxy_FsxOpenzfsFileSystemDiskIopsConfigurationOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
