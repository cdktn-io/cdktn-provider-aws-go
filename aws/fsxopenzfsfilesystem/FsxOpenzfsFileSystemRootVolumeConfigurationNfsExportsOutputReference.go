...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v24/fsxopenzfsfilesystem/internal"
...
func (j *jsiiProxy_FsxOpenzfsFileSystemRootVolumeConfigurationNfsExportsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewFsxOpenzfsFileSystemRootVolumeConfigurationNfsExportsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) FsxOpenzfsFileSystemRootVolumeConfigurationNfsExportsOutputReference {
	_init_.Initialize()
...
func NewFsxOpenzfsFileSystemRootVolumeConfigurationNfsExportsOutputReference_Override(f FsxOpenzfsFileSystemRootVolumeConfigurationNfsExportsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_FsxOpenzfsFileSystemRootVolumeConfigurationNfsExportsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (f *jsiiProxy_FsxOpenzfsFileSystemRootVolumeConfigurationNfsExportsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (f *jsiiProxy_FsxOpenzfsFileSystemRootVolumeConfigurationNfsExportsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (f *jsiiProxy_FsxOpenzfsFileSystemRootVolumeConfigurationNfsExportsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (f *jsiiProxy_FsxOpenzfsFileSystemRootVolumeConfigurationNfsExportsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
