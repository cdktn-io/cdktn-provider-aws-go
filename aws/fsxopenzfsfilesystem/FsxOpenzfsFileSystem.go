...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/fsx_openzfs_file_system aws_fsx_openzfs_file_system} Resource.
...
func (f *jsiiProxy_FsxOpenzfsFileSystem) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (f *jsiiProxy_FsxOpenzfsFileSystem) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (f *jsiiProxy_FsxOpenzfsFileSystem) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
