...
func (f *jsiiProxy_FsxOpenzfsFileSystemTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (f *jsiiProxy_FsxOpenzfsFileSystemTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
