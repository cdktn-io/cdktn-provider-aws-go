...
func (r *jsiiProxy_Resourceexplorer2View) validatePutFiltersParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*Resourceexplorer2ViewFilters; received %#v (a %T)", value, value)
		}
	}
...
func (r *jsiiProxy_Resourceexplorer2View) validatePutIncludedPropertyParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*Resourceexplorer2ViewIncludedProperty; received %#v (a %T)", value, value)
		}
	}
