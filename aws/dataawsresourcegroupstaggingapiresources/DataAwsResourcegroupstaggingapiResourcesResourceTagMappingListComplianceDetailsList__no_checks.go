...
func (d *jsiiProxy_DataAwsResourcegroupstaggingapiResourcesResourceTagMappingListComplianceDetailsList) validateResolveParameters(context cdktf.IResolveContext) error {
	return nil
}
