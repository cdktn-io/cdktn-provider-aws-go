...
func (s *jsiiProxy_SagemakerMonitoringScheduleMonitoringScheduleConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_SagemakerMonitoringScheduleMonitoringScheduleConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
