...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/sagemaker_monitoring_schedule aws_sagemaker_monitoring_schedule}.
...
func (j *jsiiProxy_SagemakerMonitoringSchedule) Arn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"arn",
...
func (j *jsiiProxy_SagemakerMonitoringSchedule) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_SagemakerMonitoringSchedule) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_SagemakerMonitoringSchedule) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_SagemakerMonitoringSchedule) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_SagemakerMonitoringSchedule) MonitoringScheduleConfigInput() *SagemakerMonitoringScheduleMonitoringScheduleConfig {
...
func (j *jsiiProxy_SagemakerMonitoringSchedule) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_SagemakerMonitoringSchedule) NameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nameInput",
...
func (j *jsiiProxy_SagemakerMonitoringSchedule) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_SagemakerMonitoringSchedule) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_SagemakerMonitoringSchedule) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_SagemakerMonitoringSchedule) Tags() *map[string]*string {
...
func (j *jsiiProxy_SagemakerMonitoringSchedule) TagsAll() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsAll",
...
func (j *jsiiProxy_SagemakerMonitoringSchedule) TagsAllInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsAllInput",
...
func (j *jsiiProxy_SagemakerMonitoringSchedule) TagsInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsInput",
...
func (j *jsiiProxy_SagemakerMonitoringSchedule) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/sagemaker_monitoring_schedule aws_sagemaker_monitoring_schedule} Resource.
...
func (j *jsiiProxy_SagemakerMonitoringSchedule)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_SagemakerMonitoringSchedule)SetId(val *string) {
...
func (j *jsiiProxy_SagemakerMonitoringSchedule)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_SagemakerMonitoringSchedule)SetName(val *string) {
...
func (j *jsiiProxy_SagemakerMonitoringSchedule)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_SagemakerMonitoringSchedule)SetRegion(val *string) {
...
func (j *jsiiProxy_SagemakerMonitoringSchedule)SetTags(val *map[string]*string) {
...
func (j *jsiiProxy_SagemakerMonitoringSchedule)SetTagsAll(val *map[string]*string) {
...
func SagemakerMonitoringSchedule_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (s *jsiiProxy_SagemakerMonitoringSchedule) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SagemakerMonitoringSchedule) HasResourceMove() interface{} {
	var returns interface{}
...
func (s *jsiiProxy_SagemakerMonitoringSchedule) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_SagemakerMonitoringSchedule) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SagemakerMonitoringSchedule) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_SagemakerMonitoringSchedule) MoveFromId(id *string) {
...
func (s *jsiiProxy_SagemakerMonitoringSchedule) MoveToId(id *string) {
...
func (s *jsiiProxy_SagemakerMonitoringSchedule) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_SagemakerMonitoringSchedule) ResetId() {
	_jsii_.InvokeVoid(
		s,
		"resetId",
		nil, // no parameters
...
func (s *jsiiProxy_SagemakerMonitoringSchedule) ResetName() {
	_jsii_.InvokeVoid(
		s,
		"resetName",
		nil, // no parameters
...
func (s *jsiiProxy_SagemakerMonitoringSchedule) ResetRegion() {
	_jsii_.InvokeVoid(
		s,
		"resetRegion",
		nil, // no parameters
...
func (s *jsiiProxy_SagemakerMonitoringSchedule) ResetTagsAll() {
	_jsii_.InvokeVoid(
		s,
		"resetTagsAll",
		nil, // no parameters
...
func (s *jsiiProxy_SagemakerMonitoringSchedule) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (s *jsiiProxy_SagemakerMonitoringSchedule) ToHclTerraform() interface{} {
	var returns interface{}
...
func (s *jsiiProxy_SagemakerMonitoringSchedule) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
