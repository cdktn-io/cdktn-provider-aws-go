...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/appsyncapikey/internal"
...
func (j *jsiiProxy_AppsyncApiKey) ApiKeyId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"apiKeyId",
...
func (j *jsiiProxy_AppsyncApiKey) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_AppsyncApiKey) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_AppsyncApiKey) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_AppsyncApiKey) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_AppsyncApiKey) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_AppsyncApiKey) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_AppsyncApiKey) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/appsync_api_key aws_appsync_api_key} Resource.
...
func (j *jsiiProxy_AppsyncApiKey)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_AppsyncApiKey)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_AppsyncApiKey)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_AppsyncApiKey)SetRegion(val *string) {
...
func AppsyncApiKey_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (a *jsiiProxy_AppsyncApiKey) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AppsyncApiKey) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (a *jsiiProxy_AppsyncApiKey) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AppsyncApiKey) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (a *jsiiProxy_AppsyncApiKey) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (a *jsiiProxy_AppsyncApiKey) ResetRegion() {
	_jsii_.InvokeVoid(
		a,
		"resetRegion",
		nil, // no parameters
...
func (a *jsiiProxy_AppsyncApiKey) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
