...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/sagemakerstudiolifecycleconfig/internal"
...
func (j *jsiiProxy_SagemakerStudioLifecycleConfig) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_SagemakerStudioLifecycleConfig) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_SagemakerStudioLifecycleConfig) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_SagemakerStudioLifecycleConfig) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_SagemakerStudioLifecycleConfig) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_SagemakerStudioLifecycleConfig) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_SagemakerStudioLifecycleConfig) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_SagemakerStudioLifecycleConfig)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_SagemakerStudioLifecycleConfig)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_SagemakerStudioLifecycleConfig)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_SagemakerStudioLifecycleConfig)SetRegion(val *string) {
...
func SagemakerStudioLifecycleConfig_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (s *jsiiProxy_SagemakerStudioLifecycleConfig) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SagemakerStudioLifecycleConfig) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_SagemakerStudioLifecycleConfig) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SagemakerStudioLifecycleConfig) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_SagemakerStudioLifecycleConfig) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_SagemakerStudioLifecycleConfig) ResetRegion() {
	_jsii_.InvokeVoid(
		s,
		"resetRegion",
		nil, // no parameters
...
func (s *jsiiProxy_SagemakerStudioLifecycleConfig) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
