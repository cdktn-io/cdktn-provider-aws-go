...
func (j *jsiiProxy_Apigatewayv2RouteRequestParameterList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewApigatewayv2RouteRequestParameterList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) Apigatewayv2RouteRequestParameterList {
	_init_.Initialize()
...
func NewApigatewayv2RouteRequestParameterList_Override(a Apigatewayv2RouteRequestParameterList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_Apigatewayv2RouteRequestParameterList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (a *jsiiProxy_Apigatewayv2RouteRequestParameterList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (a *jsiiProxy_Apigatewayv2RouteRequestParameterList) Resolve(context cdktn.IResolveContext) interface{} {
