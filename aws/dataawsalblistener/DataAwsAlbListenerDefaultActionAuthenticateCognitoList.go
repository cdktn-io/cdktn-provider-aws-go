...
func (j *jsiiProxy_DataAwsAlbListenerDefaultActionAuthenticateCognitoList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsAlbListenerDefaultActionAuthenticateCognitoList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsAlbListenerDefaultActionAuthenticateCognitoList {
	_init_.Initialize()
...
func NewDataAwsAlbListenerDefaultActionAuthenticateCognitoList_Override(d DataAwsAlbListenerDefaultActionAuthenticateCognitoList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsAlbListenerDefaultActionAuthenticateCognitoList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsAlbListenerDefaultActionAuthenticateCognitoList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsAlbListenerDefaultActionAuthenticateCognitoList) Resolve(context cdktn.IResolveContext) interface{} {
