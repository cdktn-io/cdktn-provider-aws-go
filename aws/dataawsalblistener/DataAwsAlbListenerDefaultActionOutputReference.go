...
func (d *jsiiProxy_DataAwsAlbListenerDefaultActionOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataAwsAlbListenerDefaultActionOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
