...
func (l *jsiiProxy_LightsailInstancePublicPortsPortInfoOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LightsailInstancePublicPortsPortInfoOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
