...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/lightsailinstancepublicports/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/lightsail_instance_public_ports aws_lightsail_instance_public_ports}.
...
func (j *jsiiProxy_LightsailInstancePublicPorts) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_LightsailInstancePublicPorts) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_LightsailInstancePublicPorts) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_LightsailInstancePublicPorts) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_LightsailInstancePublicPorts) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_LightsailInstancePublicPorts) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_LightsailInstancePublicPorts) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/lightsail_instance_public_ports aws_lightsail_instance_public_ports} Resource.
...
func (j *jsiiProxy_LightsailInstancePublicPorts)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_LightsailInstancePublicPorts)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_LightsailInstancePublicPorts)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_LightsailInstancePublicPorts)SetRegion(val *string) {
...
func LightsailInstancePublicPorts_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (l *jsiiProxy_LightsailInstancePublicPorts) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LightsailInstancePublicPorts) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (l *jsiiProxy_LightsailInstancePublicPorts) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LightsailInstancePublicPorts) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (l *jsiiProxy_LightsailInstancePublicPorts) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (l *jsiiProxy_LightsailInstancePublicPorts) ResetRegion() {
	_jsii_.InvokeVoid(
		l,
		"resetRegion",
		nil, // no parameters
...
func (l *jsiiProxy_LightsailInstancePublicPorts) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
