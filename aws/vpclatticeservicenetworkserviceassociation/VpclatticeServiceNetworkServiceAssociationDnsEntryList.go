...
func (v *jsiiProxy_VpclatticeServiceNetworkServiceAssociationDnsEntryList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (v *jsiiProxy_VpclatticeServiceNetworkServiceAssociationDnsEntryList) Resolve(context cdktf.IResolveContext) interface{} {
