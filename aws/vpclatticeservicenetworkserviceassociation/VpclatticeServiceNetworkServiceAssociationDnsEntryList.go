...
func (j *jsiiProxy_VpclatticeServiceNetworkServiceAssociationDnsEntryList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewVpclatticeServiceNetworkServiceAssociationDnsEntryList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) VpclatticeServiceNetworkServiceAssociationDnsEntryList {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-aws.vpclatticeServiceNetworkServiceAssociation.VpclatticeServiceNetworkServiceAssociationDnsEntryList",
...
func NewVpclatticeServiceNetworkServiceAssociationDnsEntryList_Override(v VpclatticeServiceNetworkServiceAssociationDnsEntryList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_VpclatticeServiceNetworkServiceAssociationDnsEntryList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (v *jsiiProxy_VpclatticeServiceNetworkServiceAssociationDnsEntryList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (v *jsiiProxy_VpclatticeServiceNetworkServiceAssociationDnsEntryList) Resolve(context cdktn.IResolveContext) interface{} {
