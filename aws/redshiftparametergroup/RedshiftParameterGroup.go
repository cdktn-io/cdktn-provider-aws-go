...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v22/redshiftparametergroup/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.31.0/docs/resources/redshift_parameter_group aws_redshift_parameter_group}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.31.0/docs/resources/redshift_parameter_group aws_redshift_parameter_group} Resource.
...
func RedshiftParameterGroup_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (r *jsiiProxy_RedshiftParameterGroup) ImportFrom(id *string, provider cdktf.TerraformProvider) {
