...
func (j *jsiiProxy_RedshiftParameterGroupParameterList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewRedshiftParameterGroupParameterList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) RedshiftParameterGroupParameterList {
	_init_.Initialize()
...
func NewRedshiftParameterGroupParameterList_Override(r RedshiftParameterGroupParameterList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_RedshiftParameterGroupParameterList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (r *jsiiProxy_RedshiftParameterGroupParameterList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (r *jsiiProxy_RedshiftParameterGroupParameterList) Resolve(context cdktn.IResolveContext) interface{} {
