...
func (e *jsiiProxy_ElastictranscoderPreset) validatePutVideoWatermarksParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*ElastictranscoderPresetVideoWatermarks; received %#v (a %T)", value, value)
		}
	}
