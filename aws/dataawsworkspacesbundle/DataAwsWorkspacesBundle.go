...
func (j *jsiiProxy_DataAwsWorkspacesBundle) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsWorkspacesBundle) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsWorkspacesBundle) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsWorkspacesBundle) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsWorkspacesBundle) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/data-sources/workspaces_bundle aws_workspaces_bundle} Data Source.
...
func (j *jsiiProxy_DataAwsWorkspacesBundle)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsWorkspacesBundle)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsWorkspacesBundle)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsWorkspacesBundle_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsWorkspacesBundle) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsWorkspacesBundle) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsWorkspacesBundle) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsWorkspacesBundle) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
