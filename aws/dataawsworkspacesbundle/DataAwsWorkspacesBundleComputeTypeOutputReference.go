...
func (d *jsiiProxy_DataAwsWorkspacesBundleComputeTypeOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataAwsWorkspacesBundleComputeTypeOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
