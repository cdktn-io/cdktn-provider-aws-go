...
func (d *jsiiProxy_DataAwsWorkspacesBundleRootStorageOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataAwsWorkspacesBundleRootStorageOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
