...
func (j *jsiiProxy_DataAwsWorkspacesBundleUserStorageList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsWorkspacesBundleUserStorageList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsWorkspacesBundleUserStorageList {
	_init_.Initialize()
...
func NewDataAwsWorkspacesBundleUserStorageList_Override(d DataAwsWorkspacesBundleUserStorageList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsWorkspacesBundleUserStorageList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsWorkspacesBundleUserStorageList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsWorkspacesBundleUserStorageList) Resolve(context cdktn.IResolveContext) interface{} {
