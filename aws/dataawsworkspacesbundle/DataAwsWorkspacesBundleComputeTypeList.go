...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v24/dataawsworkspacesbundle/internal"
...
func (j *jsiiProxy_DataAwsWorkspacesBundleComputeTypeList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsWorkspacesBundleComputeTypeList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsWorkspacesBundleComputeTypeList {
	_init_.Initialize()
...
func NewDataAwsWorkspacesBundleComputeTypeList_Override(d DataAwsWorkspacesBundleComputeTypeList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsWorkspacesBundleComputeTypeList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsWorkspacesBundleComputeTypeList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsWorkspacesBundleComputeTypeList) Resolve(context cdktn.IResolveContext) interface{} {
