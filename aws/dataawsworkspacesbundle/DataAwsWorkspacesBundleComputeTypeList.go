...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v21/dataawsworkspacesbundle/internal"
...
func (d *jsiiProxy_DataAwsWorkspacesBundleComputeTypeList) Resolve(context cdktf.IResolveContext) interface{} {
