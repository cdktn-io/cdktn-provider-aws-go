...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v22/docdbclusterparametergroup/internal"
...
func (j *jsiiProxy_DocdbClusterParameterGroup) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_DocdbClusterParameterGroup)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func DocdbClusterParameterGroup_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
