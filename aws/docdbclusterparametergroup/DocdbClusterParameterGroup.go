...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/docdbclusterparametergroup/internal"
...
func (j *jsiiProxy_DocdbClusterParameterGroup) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DocdbClusterParameterGroup) Connection() interface{} {
...
func (j *jsiiProxy_DocdbClusterParameterGroup) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DocdbClusterParameterGroup) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_DocdbClusterParameterGroup) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DocdbClusterParameterGroup) Parameter() DocdbClusterParameterGroupParameterList {
	var returns DocdbClusterParameterGroupParameterList
	_jsii_.Get(
		j,
		"parameter",
		&returns,
...
func (j *jsiiProxy_DocdbClusterParameterGroup) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DocdbClusterParameterGroup) Provisioners() *[]interface{} {
	var returns *[]interface{}
	_jsii_.Get(
		j,
		"provisioners",
...
func (j *jsiiProxy_DocdbClusterParameterGroup) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DocdbClusterParameterGroup) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_DocdbClusterParameterGroup) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/docdb_cluster_parameter_group aws_docdb_cluster_parameter_group} Resource.
func NewDocdbClusterParameterGroup(scope constructs.Construct, id *string, config *DocdbClusterParameterGroupConfig) DocdbClusterParameterGroup {
	...
	if err := validateNewDocdbClusterParameterGroupParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_DocdbClusterParameterGroup)SetConnection(val interface{}) {
...
func (j *jsiiProxy_DocdbClusterParameterGroup)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DocdbClusterParameterGroup)SetId(val *string) {
...
func (j *jsiiProxy_DocdbClusterParameterGroup)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DocdbClusterParameterGroup)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_DocdbClusterParameterGroup)SetProvisioners(val *[]interface{}) {
...
func (j *jsiiProxy_DocdbClusterParameterGroup)SetRegion(val *string) {
...
func DocdbClusterParameterGroup_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateDocdbClusterParameterGroup_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func DocdbClusterParameterGroup_IsConstruct(x interface{}) *bool {
	...
	if err := validateDocdbClusterParameterGroup_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DocdbClusterParameterGroup_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDocdbClusterParameterGroup_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DocdbClusterParameterGroup_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDocdbClusterParameterGroup_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (d *jsiiProxy_DocdbClusterParameterGroup) AddMoveTarget(moveTarget *string) {
...
func (d *jsiiProxy_DocdbClusterParameterGroup) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DocdbClusterParameterGroup) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (d *jsiiProxy_DocdbClusterParameterGroup) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DocdbClusterParameterGroup) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (d *jsiiProxy_DocdbClusterParameterGroup) PutParameter(value interface{}) {
...
func (d *jsiiProxy_DocdbClusterParameterGroup) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DocdbClusterParameterGroup) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
...
func (d *jsiiProxy_DocdbClusterParameterGroup) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
...
func (d *jsiiProxy_DocdbClusterParameterGroup) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DocdbClusterParameterGroup) ToHclTerraform() interface{} {
	var returns interface{}
...
func (d *jsiiProxy_DocdbClusterParameterGroup) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
