...
func (j *jsiiProxy_GlueTriggerPredicateOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewGlueTriggerPredicateOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) GlueTriggerPredicateOutputReference {
	_init_.Initialize()
...
func NewGlueTriggerPredicateOutputReference_Override(g GlueTriggerPredicateOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_GlueTriggerPredicateOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (g *jsiiProxy_GlueTriggerPredicateOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GlueTriggerPredicateOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (g *jsiiProxy_GlueTriggerPredicateOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GlueTriggerPredicateOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
