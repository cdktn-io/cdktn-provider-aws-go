...
func (j *jsiiProxy_GlueTriggerTimeoutsOutputReference) Update() *string {
	var returns *string
	_jsii_.Get(
		j,
		"update",
...
func (j *jsiiProxy_GlueTriggerTimeoutsOutputReference) UpdateInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"updateInput",
...
func (j *jsiiProxy_GlueTriggerTimeoutsOutputReference)SetUpdate(val *string) {
...
func (g *jsiiProxy_GlueTriggerTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GlueTriggerTimeoutsOutputReference) ResetUpdate() {
	_jsii_.InvokeVoid(
		g,
		"resetUpdate",
		nil, // no parameters
...
func (g *jsiiProxy_GlueTriggerTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
