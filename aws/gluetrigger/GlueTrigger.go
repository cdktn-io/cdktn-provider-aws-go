...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/glue_trigger aws_glue_trigger}.
...
func (j *jsiiProxy_GlueTrigger) Actions() GlueTriggerActionsList {
	var returns GlueTriggerActionsList
	_jsii_.Get(
		j,
		"actions",
		&returns,
...
func (j *jsiiProxy_GlueTrigger) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_GlueTrigger) EventBatchingCondition() GlueTriggerEventBatchingConditionList {
	var returns GlueTriggerEventBatchingConditionList
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_GlueTrigger) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_GlueTrigger) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_GlueTrigger) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_GlueTrigger) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_GlueTrigger) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_GlueTrigger) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_GlueTrigger) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/glue_trigger aws_glue_trigger} Resource.
func NewGlueTrigger(scope constructs.Construct, id *string, config *GlueTriggerConfig) GlueTrigger {
	_init_.Initialize()

	if err := validateNewGlueTriggerParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_GlueTrigger)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_GlueTrigger)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_GlueTrigger)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_GlueTrigger)SetRegion(val *string) {
...
func GlueTrigger_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateGlueTrigger_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (g *jsiiProxy_GlueTrigger) AddMoveTarget(moveTarget *string) {
...
func (g *jsiiProxy_GlueTrigger) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GlueTrigger) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (g *jsiiProxy_GlueTrigger) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GlueTrigger) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GlueTrigger) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (g *jsiiProxy_GlueTrigger) ResetEventBatchingCondition() {
	_jsii_.InvokeVoid(
		g,
		"resetEventBatchingCondition",
		nil, // no parameters
...
func (g *jsiiProxy_GlueTrigger) ResetId() {
	_jsii_.InvokeVoid(
		g,
		"resetId",
		nil, // no parameters
...
func (g *jsiiProxy_GlueTrigger) ResetRegion() {
	_jsii_.InvokeVoid(
		g,
		"resetRegion",
		nil, // no parameters
...
func (g *jsiiProxy_GlueTrigger) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
