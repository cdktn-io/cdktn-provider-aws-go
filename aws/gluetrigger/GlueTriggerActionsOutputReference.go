...
func (j *jsiiProxy_GlueTriggerActionsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewGlueTriggerActionsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) GlueTriggerActionsOutputReference {
	_init_.Initialize()
...
func NewGlueTriggerActionsOutputReference_Override(g GlueTriggerActionsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_GlueTriggerActionsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (g *jsiiProxy_GlueTriggerActionsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GlueTriggerActionsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (g *jsiiProxy_GlueTriggerActionsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GlueTriggerActionsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
