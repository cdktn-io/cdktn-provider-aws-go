...
func (j *jsiiProxy_GlueTriggerPredicateConditionsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewGlueTriggerPredicateConditionsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) GlueTriggerPredicateConditionsOutputReference {
	_init_.Initialize()
...
func NewGlueTriggerPredicateConditionsOutputReference_Override(g GlueTriggerPredicateConditionsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_GlueTriggerPredicateConditionsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (g *jsiiProxy_GlueTriggerPredicateConditionsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GlueTriggerPredicateConditionsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (g *jsiiProxy_GlueTriggerPredicateConditionsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GlueTriggerPredicateConditionsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
