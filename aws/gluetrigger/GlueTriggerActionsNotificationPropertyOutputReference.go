...
func (j *jsiiProxy_GlueTriggerActionsNotificationPropertyOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewGlueTriggerActionsNotificationPropertyOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) GlueTriggerActionsNotificationPropertyOutputReference {
	_init_.Initialize()
...
func NewGlueTriggerActionsNotificationPropertyOutputReference_Override(g GlueTriggerActionsNotificationPropertyOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_GlueTriggerActionsNotificationPropertyOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (g *jsiiProxy_GlueTriggerActionsNotificationPropertyOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GlueTriggerActionsNotificationPropertyOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (g *jsiiProxy_GlueTriggerActionsNotificationPropertyOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GlueTriggerActionsNotificationPropertyOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
