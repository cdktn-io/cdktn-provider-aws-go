...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/accessanalyzerarchiverule/internal"
...
func (j *jsiiProxy_AccessanalyzerArchiveRuleFilterList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewAccessanalyzerArchiveRuleFilterList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) AccessanalyzerArchiveRuleFilterList {
	_init_.Initialize()
...
func NewAccessanalyzerArchiveRuleFilterList_Override(a AccessanalyzerArchiveRuleFilterList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_AccessanalyzerArchiveRuleFilterList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (a *jsiiProxy_AccessanalyzerArchiveRuleFilterList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (a *jsiiProxy_AccessanalyzerArchiveRuleFilterList) Resolve(context cdktn.IResolveContext) interface{} {
