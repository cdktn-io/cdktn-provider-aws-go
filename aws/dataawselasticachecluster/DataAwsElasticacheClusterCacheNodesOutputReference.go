...
func (d *jsiiProxy_DataAwsElasticacheClusterCacheNodesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataAwsElasticacheClusterCacheNodesOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
