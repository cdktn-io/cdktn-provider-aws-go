...
func (d *jsiiProxy_DataAwsElasticacheClusterLogDeliveryConfigurationOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataAwsElasticacheClusterLogDeliveryConfigurationOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
