...
func (f *jsiiProxy_FlowLogDestinationOptionsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (f *jsiiProxy_FlowLogDestinationOptionsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
