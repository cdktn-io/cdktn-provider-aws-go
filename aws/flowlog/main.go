...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "putTagFieldSpecification", GoMethod: "PutTagFieldSpecification"},
			_jsii_.MemberProperty{JsiiProperty: "rawOverrides", GoGetter: "RawOverrides"},
			_jsii_.MemberProperty{JsiiProperty: "region", GoGetter: "Region"},
			_jsii_.MemberProperty{JsiiProperty: "regionalNatGatewayId", GoGetter: "RegionalNatGatewayId"},
			_jsii_.MemberProperty{JsiiProperty: "regionalNatGatewayIdInput", GoGetter: "RegionalNatGatewayIdInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetRegionalNatGatewayId", GoMethod: "ResetRegionalNatGatewayId"},
			_jsii_.MemberMethod{JsiiMethod: "resetSubnetId", GoMethod: "ResetSubnetId"},
			_jsii_.MemberMethod{JsiiMethod: "resetTagFieldSpecification", GoMethod: "ResetTagFieldSpecification"},
			...
			_jsii_.MemberProperty{JsiiProperty: "tagFieldSpecification", GoGetter: "TagFieldSpecification"},
			_jsii_.MemberProperty{JsiiProperty: "tagFieldSpecificationInput", GoGetter: "TagFieldSpecificationInput"},
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-aws.flowLog.FlowLogTagFieldSpecification",
		reflect.TypeOf((*FlowLogTagFieldSpecification)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-aws.flowLog.FlowLogTagFieldSpecificationList",
		reflect.TypeOf((*FlowLogTagFieldSpecificationList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*FlowLogTagFieldSpecificationOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
