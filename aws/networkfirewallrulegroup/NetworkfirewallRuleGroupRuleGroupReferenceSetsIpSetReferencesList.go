...
func (j *jsiiProxy_NetworkfirewallRuleGroupRuleGroupReferenceSetsIpSetReferencesList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewNetworkfirewallRuleGroupRuleGroupReferenceSetsIpSetReferencesList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) NetworkfirewallRuleGroupRuleGroupReferenceSetsIpSetReferencesList {
	_init_.Initialize()
...
func NewNetworkfirewallRuleGroupRuleGroupReferenceSetsIpSetReferencesList_Override(n NetworkfirewallRuleGroupRuleGroupReferenceSetsIpSetReferencesList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_NetworkfirewallRuleGroupRuleGroupReferenceSetsIpSetReferencesList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (n *jsiiProxy_NetworkfirewallRuleGroupRuleGroupReferenceSetsIpSetReferencesList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (n *jsiiProxy_NetworkfirewallRuleGroupRuleGroupReferenceSetsIpSetReferencesList) Resolve(context cdktn.IResolveContext) interface{} {
