...
func (j *jsiiProxy_NetworkfirewallRuleGroupRuleGroupRulesSourceStatefulRuleList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewNetworkfirewallRuleGroupRuleGroupRulesSourceStatefulRuleList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) NetworkfirewallRuleGroupRuleGroupRulesSourceStatefulRuleList {
	_init_.Initialize()
...
func NewNetworkfirewallRuleGroupRuleGroupRulesSourceStatefulRuleList_Override(n NetworkfirewallRuleGroupRuleGroupRulesSourceStatefulRuleList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_NetworkfirewallRuleGroupRuleGroupRulesSourceStatefulRuleList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (n *jsiiProxy_NetworkfirewallRuleGroupRuleGroupRulesSourceStatefulRuleList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (n *jsiiProxy_NetworkfirewallRuleGroupRuleGroupRulesSourceStatefulRuleList) Resolve(context cdktn.IResolveContext) interface{} {
