...
func (j *jsiiProxy_NetworkfirewallRuleGroupRuleGroupRuleVariablesPortSetsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewNetworkfirewallRuleGroupRuleGroupRuleVariablesPortSetsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) NetworkfirewallRuleGroupRuleGroupRuleVariablesPortSetsList {
	_init_.Initialize()
...
func NewNetworkfirewallRuleGroupRuleGroupRuleVariablesPortSetsList_Override(n NetworkfirewallRuleGroupRuleGroupRuleVariablesPortSetsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_NetworkfirewallRuleGroupRuleGroupRuleVariablesPortSetsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (n *jsiiProxy_NetworkfirewallRuleGroupRuleGroupRuleVariablesPortSetsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (n *jsiiProxy_NetworkfirewallRuleGroupRuleGroupRuleVariablesPortSetsList) Resolve(context cdktn.IResolveContext) interface{} {
