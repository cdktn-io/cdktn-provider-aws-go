...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/docdb_cluster_instance aws_docdb_cluster_instance} Resource.
...
func (d *jsiiProxy_DocdbClusterInstance) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (d *jsiiProxy_DocdbClusterInstance) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DocdbClusterInstance) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
