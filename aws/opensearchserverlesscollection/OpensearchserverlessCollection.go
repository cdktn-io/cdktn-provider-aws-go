...
func (o *jsiiProxy_OpensearchserverlessCollection) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (o *jsiiProxy_OpensearchserverlessCollection) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
