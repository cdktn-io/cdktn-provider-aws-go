...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/directoryservicetrust/internal"
...
func (j *jsiiProxy_DirectoryServiceTrust) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DirectoryServiceTrust) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DirectoryServiceTrust) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DirectoryServiceTrust) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DirectoryServiceTrust) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DirectoryServiceTrust)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DirectoryServiceTrust)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DirectoryServiceTrust)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DirectoryServiceTrust_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DirectoryServiceTrust) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DirectoryServiceTrust) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (d *jsiiProxy_DirectoryServiceTrust) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DirectoryServiceTrust) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (d *jsiiProxy_DirectoryServiceTrust) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DirectoryServiceTrust) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
