...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetRevisionId", GoMethod: "ResetRevisionId"},
			_jsii_.MemberMethod{JsiiMethod: "resetTimeouts", GoMethod: "ResetTimeouts"},
			_jsii_.MemberProperty{JsiiProperty: "revisionId", GoGetter: "RevisionId"},
			_jsii_.MemberProperty{JsiiProperty: "revisionIdInput", GoGetter: "RevisionIdInput"},
		...
		func() interface{} {
			j := jsiiProxy_PrometheusResourcePolicy{}
	...
	_jsii_.RegisterClass(
		...
		func() interface{} {
			j := jsiiProxy_PrometheusResourcePolicyTimeoutsOutputReference{}
