...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/servicecatalogserviceaction/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/servicecatalog_service_action aws_servicecatalog_service_action}.
type ServicecatalogServiceAction interface {
	...
	PutTimeouts(value *ServicecatalogServiceActionTimeouts)
...
func (j *jsiiProxy_ServicecatalogServiceAction) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_ServicecatalogServiceAction) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_ServicecatalogServiceAction) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_ServicecatalogServiceAction) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_ServicecatalogServiceAction) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_ServicecatalogServiceAction) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_ServicecatalogServiceAction) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_ServicecatalogServiceAction) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_ServicecatalogServiceAction) Timeouts() ServicecatalogServiceActionTimeoutsOutputReference {
	var returns ServicecatalogServiceActionTimeoutsOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/servicecatalog_service_action aws_servicecatalog_service_action} Resource.
func NewServicecatalogServiceAction(scope constructs.Construct, id *string, config *ServicecatalogServiceActionConfig) ServicecatalogServiceAction {
	...
	if err := validateNewServicecatalogServiceActionParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_ServicecatalogServiceAction)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_ServicecatalogServiceAction)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_ServicecatalogServiceAction)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_ServicecatalogServiceAction)SetRegion(val *string) {
...
func ServicecatalogServiceAction_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateServicecatalogServiceAction_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_ServicecatalogServiceAction) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_ServicecatalogServiceAction) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_ServicecatalogServiceAction) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_ServicecatalogServiceAction) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_ServicecatalogServiceAction) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_ServicecatalogServiceAction) PutTimeouts(value *ServicecatalogServiceActionTimeouts) {
...
func (s *jsiiProxy_ServicecatalogServiceAction) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_ServicecatalogServiceAction) ResetId() {
	_jsii_.InvokeVoid(
		s,
		"resetId",
		nil, // no parameters
...
func (s *jsiiProxy_ServicecatalogServiceAction) ResetRegion() {
	_jsii_.InvokeVoid(
		s,
		"resetRegion",
		nil, // no parameters
...
func (s *jsiiProxy_ServicecatalogServiceAction) ResetTimeouts() {
	_jsii_.InvokeVoid(
		s,
		"resetTimeouts",
		nil, // no parameters
...
func (s *jsiiProxy_ServicecatalogServiceAction) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
