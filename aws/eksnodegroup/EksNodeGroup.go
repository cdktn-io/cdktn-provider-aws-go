...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/eks_node_group aws_eks_node_group}.
...
func (j *jsiiProxy_EksNodeGroup) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_EksNodeGroup) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/eks_node_group aws_eks_node_group} Resource.
...
func (j *jsiiProxy_EksNodeGroup)SetRegion(val *string) {
...
func (e *jsiiProxy_EksNodeGroup) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (e *jsiiProxy_EksNodeGroup) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (e *jsiiProxy_EksNodeGroup) ResetRegion() {
	_jsii_.InvokeVoid(
		e,
		"resetRegion",
		nil, // no parameters
...
func (e *jsiiProxy_EksNodeGroup) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
