...
func (j *jsiiProxy_EksNodeGroupLaunchTemplateOutputReference) ComplexObjectIndex() interface{} {
...
func (j *jsiiProxy_EksNodeGroupLaunchTemplateOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_EksNodeGroupLaunchTemplateOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_EksNodeGroupLaunchTemplateOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_EksNodeGroupLaunchTemplateOutputReference) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_EksNodeGroupLaunchTemplateOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewEksNodeGroupLaunchTemplateOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) EksNodeGroupLaunchTemplateOutputReference {
	_init_.Initialize()

	if err := validateNewEksNodeGroupLaunchTemplateOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewEksNodeGroupLaunchTemplateOutputReference_Override(e EksNodeGroupLaunchTemplateOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_EksNodeGroupLaunchTemplateOutputReference)SetComplexObjectIndex(val interface{}) {
...
func (j *jsiiProxy_EksNodeGroupLaunchTemplateOutputReference)SetComplexObjectIsFromSet(val *bool) {
...
func (j *jsiiProxy_EksNodeGroupLaunchTemplateOutputReference)SetId(val *string) {
...
func (j *jsiiProxy_EksNodeGroupLaunchTemplateOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (e *jsiiProxy_EksNodeGroupLaunchTemplateOutputReference) ComputeFqn() *string {
	var returns *string
...
func (e *jsiiProxy_EksNodeGroupLaunchTemplateOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (e *jsiiProxy_EksNodeGroupLaunchTemplateOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (e *jsiiProxy_EksNodeGroupLaunchTemplateOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (e *jsiiProxy_EksNodeGroupLaunchTemplateOutputReference) ResetId() {
	_jsii_.InvokeVoid(
		e,
		"resetId",
		nil, // no parameters
...
func (e *jsiiProxy_EksNodeGroupLaunchTemplateOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
...
func (e *jsiiProxy_EksNodeGroupLaunchTemplateOutputReference) ToString() *string {
	var returns *string
