...
func (j *jsiiProxy_CodebuildFleet) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_CodebuildFleet) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_CodebuildFleet) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_CodebuildFleet) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_CodebuildFleet) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/codebuild_fleet aws_codebuild_fleet} Resource.
...
func (j *jsiiProxy_CodebuildFleet)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_CodebuildFleet)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_CodebuildFleet)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func CodebuildFleet_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (c *jsiiProxy_CodebuildFleet) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CodebuildFleet) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (c *jsiiProxy_CodebuildFleet) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CodebuildFleet) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_CodebuildFleet) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (c *jsiiProxy_CodebuildFleet) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
