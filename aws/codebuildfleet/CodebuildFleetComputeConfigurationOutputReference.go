...
func (j *jsiiProxy_CodebuildFleetComputeConfigurationOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewCodebuildFleetComputeConfigurationOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) CodebuildFleetComputeConfigurationOutputReference {
	_init_.Initialize()
...
func NewCodebuildFleetComputeConfigurationOutputReference_Override(c CodebuildFleetComputeConfigurationOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_CodebuildFleetComputeConfigurationOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_CodebuildFleetComputeConfigurationOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CodebuildFleetComputeConfigurationOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (c *jsiiProxy_CodebuildFleetComputeConfigurationOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CodebuildFleetComputeConfigurationOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
