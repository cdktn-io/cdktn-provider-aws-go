...
func (j *jsiiProxy_CodebuildFleetScalingConfigurationTargetTrackingScalingConfigsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewCodebuildFleetScalingConfigurationTargetTrackingScalingConfigsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) CodebuildFleetScalingConfigurationTargetTrackingScalingConfigsOutputReference {
	_init_.Initialize()
...
func NewCodebuildFleetScalingConfigurationTargetTrackingScalingConfigsOutputReference_Override(c CodebuildFleetScalingConfigurationTargetTrackingScalingConfigsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_CodebuildFleetScalingConfigurationTargetTrackingScalingConfigsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_CodebuildFleetScalingConfigurationTargetTrackingScalingConfigsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CodebuildFleetScalingConfigurationTargetTrackingScalingConfigsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (c *jsiiProxy_CodebuildFleetScalingConfigurationTargetTrackingScalingConfigsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CodebuildFleetScalingConfigurationTargetTrackingScalingConfigsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
