...
func (d *jsiiProxy_DataAwsConnectHoursOfOperationConfigAList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
	return nil
}

func (d *jsiiProxy_DataAwsConnectHoursOfOperationConfigAList) validateGetParameters(index *float64) error {
	return nil
}
...
func (j *jsiiProxy_DataAwsConnectHoursOfOperationConfigAList) validateSetTerraformAttributeParameters(val *string) error {
	return nil
}
...
func (j *jsiiProxy_DataAwsConnectHoursOfOperationConfigAList) validateSetWrapsSetParameters(val *bool) error {
	return nil
}
