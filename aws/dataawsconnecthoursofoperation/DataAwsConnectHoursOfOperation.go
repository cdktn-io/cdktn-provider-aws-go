...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v23/dataawsconnecthoursofoperation/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.39.0/docs/data-sources/connect_hours_of_operation aws_connect_hours_of_operation}.
...
func (j *jsiiProxy_DataAwsConnectHoursOfOperation) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsConnectHoursOfOperation) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsConnectHoursOfOperation) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsConnectHoursOfOperation) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsConnectHoursOfOperation) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DataAwsConnectHoursOfOperation) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_DataAwsConnectHoursOfOperation) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.39.0/docs/data-sources/connect_hours_of_operation aws_connect_hours_of_operation} Data Source.
...
func (j *jsiiProxy_DataAwsConnectHoursOfOperation)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsConnectHoursOfOperation)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsConnectHoursOfOperation)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_DataAwsConnectHoursOfOperation)SetRegion(val *string) {
...
func DataAwsConnectHoursOfOperation_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsConnectHoursOfOperation) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsConnectHoursOfOperation) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsConnectHoursOfOperation) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsConnectHoursOfOperation) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
