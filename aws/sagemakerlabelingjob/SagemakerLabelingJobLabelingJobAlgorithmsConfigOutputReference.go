...
func (j *jsiiProxy_SagemakerLabelingJobLabelingJobAlgorithmsConfigOutputReference) TerraformResource() cdktf.IInterpolatingParent {
...
func NewSagemakerLabelingJobLabelingJobAlgorithmsConfigOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) SagemakerLabelingJobLabelingJobAlgorithmsConfigOutputReference {
	_init_.Initialize()
...
func NewSagemakerLabelingJobLabelingJobAlgorithmsConfigOutputReference_Override(s SagemakerLabelingJobLabelingJobAlgorithmsConfigOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_SagemakerLabelingJobLabelingJobAlgorithmsConfigOutputReference)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (s *jsiiProxy_SagemakerLabelingJobLabelingJobAlgorithmsConfigOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_SagemakerLabelingJobLabelingJobAlgorithmsConfigOutputReference) InterpolationAsList() cdktf.IResolvable {
	var returns cdktf.IResolvable
...
func (s *jsiiProxy_SagemakerLabelingJobLabelingJobAlgorithmsConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_SagemakerLabelingJobLabelingJobAlgorithmsConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
