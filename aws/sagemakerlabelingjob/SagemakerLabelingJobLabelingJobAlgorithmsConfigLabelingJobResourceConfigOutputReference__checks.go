...
func (s *jsiiProxy_SagemakerLabelingJobLabelingJobAlgorithmsConfigLabelingJobResourceConfigOutputReference) validatePutVpcConfigParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*SagemakerLabelingJobLabelingJobAlgorithmsConfigLabelingJobResourceConfigVpcConfig; received %#v (a %T)", value, value)
		}
	}
