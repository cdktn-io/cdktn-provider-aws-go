...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/servicecatalogportfolio/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/servicecatalog_portfolio aws_servicecatalog_portfolio}.
...
func (j *jsiiProxy_ServicecatalogPortfolio) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_ServicecatalogPortfolio) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_ServicecatalogPortfolio) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_ServicecatalogPortfolio) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_ServicecatalogPortfolio) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_ServicecatalogPortfolio) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_ServicecatalogPortfolio) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/servicecatalog_portfolio aws_servicecatalog_portfolio} Resource.
...
func (j *jsiiProxy_ServicecatalogPortfolio)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_ServicecatalogPortfolio)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_ServicecatalogPortfolio)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_ServicecatalogPortfolio)SetRegion(val *string) {
...
func ServicecatalogPortfolio_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateServicecatalogPortfolio_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_ServicecatalogPortfolio) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_ServicecatalogPortfolio) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_ServicecatalogPortfolio) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_ServicecatalogPortfolio) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_ServicecatalogPortfolio) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_ServicecatalogPortfolio) MoveFromId(id *string) {
...
func (s *jsiiProxy_ServicecatalogPortfolio) MoveToId(id *string) {
...
func (s *jsiiProxy_ServicecatalogPortfolio) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_ServicecatalogPortfolio) ResetRegion() {
	_jsii_.InvokeVoid(
		s,
		"resetRegion",
		nil, // no parameters
...
func (s *jsiiProxy_ServicecatalogPortfolio) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
