...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v22/servicecatalogportfolio/internal"
...
func ServicecatalogPortfolio_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (s *jsiiProxy_ServicecatalogPortfolio) ImportFrom(id *string, provider cdktf.TerraformProvider) {
