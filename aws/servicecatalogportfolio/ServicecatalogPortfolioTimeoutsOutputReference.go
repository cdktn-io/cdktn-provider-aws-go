...
func (s *jsiiProxy_ServicecatalogPortfolioTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_ServicecatalogPortfolioTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
