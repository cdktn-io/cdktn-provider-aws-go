...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*Sesv2TenantResourceAssociation)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-aws.sesv2TenantResourceAssociation.Sesv2TenantResourceAssociationConfig",
		reflect.TypeOf((*Sesv2TenantResourceAssociationConfig)(nil)).Elem(),
	)
}
