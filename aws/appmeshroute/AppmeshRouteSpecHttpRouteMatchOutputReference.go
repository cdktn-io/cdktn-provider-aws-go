...
func (a *jsiiProxy_AppmeshRouteSpecHttpRouteMatchOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_AppmeshRouteSpecHttpRouteMatchOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
