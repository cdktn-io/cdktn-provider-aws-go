...
func (a *jsiiProxy_AppmeshRouteSpecHttpRouteRetryPolicyOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_AppmeshRouteSpecHttpRouteRetryPolicyOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
