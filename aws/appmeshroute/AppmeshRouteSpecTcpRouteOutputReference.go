...
func (a *jsiiProxy_AppmeshRouteSpecTcpRouteOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_AppmeshRouteSpecTcpRouteOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
