...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v23/dataawssecretsmanagersecret/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.40.0/docs/data-sources/secretsmanager_secret aws_secretsmanager_secret}.
...
func (j *jsiiProxy_DataAwsSecretsmanagerSecret) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsSecretsmanagerSecret) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsSecretsmanagerSecret) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsSecretsmanagerSecret) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsSecretsmanagerSecret) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DataAwsSecretsmanagerSecret) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_DataAwsSecretsmanagerSecret) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.40.0/docs/data-sources/secretsmanager_secret aws_secretsmanager_secret} Data Source.
func NewDataAwsSecretsmanagerSecret(scope constructs.Construct, id *string, config *DataAwsSecretsmanagerSecretConfig) DataAwsSecretsmanagerSecret {
	...
	_jsii_.Create(
		"@cdktn/provider-aws.dataAwsSecretsmanagerSecret.DataAwsSecretsmanagerSecret",
...
func (j *jsiiProxy_DataAwsSecretsmanagerSecret)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsSecretsmanagerSecret)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsSecretsmanagerSecret)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_DataAwsSecretsmanagerSecret)SetRegion(val *string) {
...
// Generates CDKTN code for importing a DataAwsSecretsmanagerSecret resource upon running "cdktn plan <stack-name>".
func DataAwsSecretsmanagerSecret_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateDataAwsSecretsmanagerSecret_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
// Experimental.
func DataAwsSecretsmanagerSecret_IsTerraformDataSource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataAwsSecretsmanagerSecret_IsTerraformDataSourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataAwsSecretsmanagerSecret_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataAwsSecretsmanagerSecret_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (d *jsiiProxy_DataAwsSecretsmanagerSecret) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsSecretsmanagerSecret) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsSecretsmanagerSecret) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsSecretsmanagerSecret) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataAwsSecretsmanagerSecret) ToHclTerraform() interface{} {
	var returns interface{}
...
func (d *jsiiProxy_DataAwsSecretsmanagerSecret) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
