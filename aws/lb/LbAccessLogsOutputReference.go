...
func (j *jsiiProxy_LbAccessLogsOutputReference) ComplexObjectIndex() interface{} {
...
func (j *jsiiProxy_LbAccessLogsOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_LbAccessLogsOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_LbAccessLogsOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_LbAccessLogsOutputReference)SetComplexObjectIndex(val interface{}) {
...
func (j *jsiiProxy_LbAccessLogsOutputReference)SetComplexObjectIsFromSet(val *bool) {
...
func (l *jsiiProxy_LbAccessLogsOutputReference) ComputeFqn() *string {
	var returns *string
...
func (l *jsiiProxy_LbAccessLogsOutputReference) GetAnyMapAttribute(terraformAttribute *string) *map[string]interface{} {
...
func (l *jsiiProxy_LbAccessLogsOutputReference) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (l *jsiiProxy_LbAccessLogsOutputReference) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (l *jsiiProxy_LbAccessLogsOutputReference) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (l *jsiiProxy_LbAccessLogsOutputReference) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (l *jsiiProxy_LbAccessLogsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LbAccessLogsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
...
func (l *jsiiProxy_LbAccessLogsOutputReference) ToString() *string {
	var returns *string
