...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/lb aws_lb}.
type Lb interface {
	...
	IpamPools() LbIpamPoolsOutputReference
	IpamPoolsInput() *LbIpamPools
	// Experimental.
...
func (j *jsiiProxy_Lb) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_Lb) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_Lb) IpamPools() LbIpamPoolsOutputReference {
	var returns LbIpamPoolsOutputReference
	_jsii_.Get(
		j,
		"ipamPools",
		&returns,
...
func (j *jsiiProxy_Lb) IpamPoolsInput() *LbIpamPools {
	var returns *LbIpamPools
	_jsii_.Get(
		j,
		"ipamPoolsInput",
		&returns,
...
func (j *jsiiProxy_Lb) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_Lb) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_Lb) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_Lb) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_Lb) SecondaryIpsAutoAssignedPerSubnet() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_Lb) SecondaryIpsAutoAssignedPerSubnetInput() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_Lb) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/lb aws_lb} Resource.
...
func (j *jsiiProxy_Lb)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_Lb)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_Lb)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_Lb)SetRegion(val *string) {
...
func (j *jsiiProxy_Lb)SetSecondaryIpsAutoAssignedPerSubnet(val *float64) {
...
func Lb_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (l *jsiiProxy_Lb) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_Lb) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (l *jsiiProxy_Lb) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_Lb) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (l *jsiiProxy_Lb) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (l *jsiiProxy_Lb) ResetIpamPools() {
	_jsii_.InvokeVoid(
		l,
		"resetIpamPools",
		nil, // no parameters
...
func (l *jsiiProxy_Lb) ResetRegion() {
	_jsii_.InvokeVoid(
		l,
		"resetRegion",
		nil, // no parameters
...
func (l *jsiiProxy_Lb) ResetSecondaryIpsAutoAssignedPerSubnet() {
	_jsii_.InvokeVoid(
		l,
		"resetSecondaryIpsAutoAssignedPerSubnet",
		nil, // no parameters
...
func (l *jsiiProxy_Lb) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
