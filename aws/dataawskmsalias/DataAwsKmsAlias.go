...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/dataawskmsalias/internal"
...
func (j *jsiiProxy_DataAwsKmsAlias) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsKmsAlias) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsKmsAlias) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsKmsAlias) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsKmsAlias) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DataAwsKmsAlias)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsKmsAlias)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsKmsAlias)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsKmsAlias_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsKmsAlias) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsKmsAlias) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsKmsAlias) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsKmsAlias) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
