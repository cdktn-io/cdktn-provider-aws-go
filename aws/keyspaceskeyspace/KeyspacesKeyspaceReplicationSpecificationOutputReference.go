...
func (k *jsiiProxy_KeyspacesKeyspaceReplicationSpecificationOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (k *jsiiProxy_KeyspacesKeyspaceReplicationSpecificationOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
