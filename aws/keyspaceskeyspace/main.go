...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "putReplicationSpecification", GoMethod: "PutReplicationSpecification"},
			...
			_jsii_.MemberProperty{JsiiProperty: "replicationSpecificationInput", GoGetter: "ReplicationSpecificationInput"},
			_jsii_.MemberMethod{JsiiMethod: "resetId", GoMethod: "ResetId"},
			_jsii_.MemberMethod{JsiiMethod: "resetOverrideLogicalId", GoMethod: "ResetOverrideLogicalId"},
			_jsii_.MemberMethod{JsiiMethod: "resetRegion", GoMethod: "ResetRegion"},
			_jsii_.MemberMethod{JsiiMethod: "resetReplicationSpecification", GoMethod: "ResetReplicationSpecification"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "replicationStrategy", GoGetter: "ReplicationStrategy"},
			_jsii_.MemberProperty{JsiiProperty: "replicationStrategyInput", GoGetter: "ReplicationStrategyInput"},
			_jsii_.MemberMethod{JsiiMethod: "resetRegionList", GoMethod: "ResetRegionList"},
			_jsii_.MemberMethod{JsiiMethod: "resetReplicationStrategy", GoMethod: "ResetReplicationStrategy"},
