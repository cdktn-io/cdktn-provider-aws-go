...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/ssmmaintenancewindow/internal"
...
func (j *jsiiProxy_SsmMaintenanceWindow) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_SsmMaintenanceWindow) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_SsmMaintenanceWindow)SetRegion(val *string) {
...
func (s *jsiiProxy_SsmMaintenanceWindow) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_SsmMaintenanceWindow) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_SsmMaintenanceWindow) ResetRegion() {
	_jsii_.InvokeVoid(
		s,
		"resetRegion",
		nil, // no parameters
...
func (s *jsiiProxy_SsmMaintenanceWindow) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
