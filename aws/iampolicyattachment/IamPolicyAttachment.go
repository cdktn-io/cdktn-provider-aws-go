...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/iampolicyattachment/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/iam_policy_attachment aws_iam_policy_attachment}.
...
func (j *jsiiProxy_IamPolicyAttachment) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_IamPolicyAttachment) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_IamPolicyAttachment) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_IamPolicyAttachment) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_IamPolicyAttachment) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/iam_policy_attachment aws_iam_policy_attachment} Resource.
...
func (j *jsiiProxy_IamPolicyAttachment)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_IamPolicyAttachment)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_IamPolicyAttachment)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func IamPolicyAttachment_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (i *jsiiProxy_IamPolicyAttachment) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (i *jsiiProxy_IamPolicyAttachment) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (i *jsiiProxy_IamPolicyAttachment) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (i *jsiiProxy_IamPolicyAttachment) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (i *jsiiProxy_IamPolicyAttachment) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (i *jsiiProxy_IamPolicyAttachment) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
