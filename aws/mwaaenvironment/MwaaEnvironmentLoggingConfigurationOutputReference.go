...
func (j *jsiiProxy_MwaaEnvironmentLoggingConfigurationOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewMwaaEnvironmentLoggingConfigurationOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) MwaaEnvironmentLoggingConfigurationOutputReference {
	_init_.Initialize()
...
func NewMwaaEnvironmentLoggingConfigurationOutputReference_Override(m MwaaEnvironmentLoggingConfigurationOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_MwaaEnvironmentLoggingConfigurationOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (m *jsiiProxy_MwaaEnvironmentLoggingConfigurationOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MwaaEnvironmentLoggingConfigurationOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (m *jsiiProxy_MwaaEnvironmentLoggingConfigurationOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MwaaEnvironmentLoggingConfigurationOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
