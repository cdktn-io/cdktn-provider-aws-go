...
func (j *jsiiProxy_MwaaEnvironmentLastUpdatedErrorList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewMwaaEnvironmentLastUpdatedErrorList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) MwaaEnvironmentLastUpdatedErrorList {
	_init_.Initialize()
...
func NewMwaaEnvironmentLastUpdatedErrorList_Override(m MwaaEnvironmentLastUpdatedErrorList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_MwaaEnvironmentLastUpdatedErrorList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (m *jsiiProxy_MwaaEnvironmentLastUpdatedErrorList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (m *jsiiProxy_MwaaEnvironmentLastUpdatedErrorList) Resolve(context cdktn.IResolveContext) interface{} {
