...
func (j *jsiiProxy_MwaaEnvironmentLastUpdatedList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewMwaaEnvironmentLastUpdatedList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) MwaaEnvironmentLastUpdatedList {
	_init_.Initialize()
...
func NewMwaaEnvironmentLastUpdatedList_Override(m MwaaEnvironmentLastUpdatedList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_MwaaEnvironmentLastUpdatedList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (m *jsiiProxy_MwaaEnvironmentLastUpdatedList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (m *jsiiProxy_MwaaEnvironmentLastUpdatedList) Resolve(context cdktn.IResolveContext) interface{} {
