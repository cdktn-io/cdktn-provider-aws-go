...
func (j *jsiiProxy_WafRateBasedRule) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_WafRateBasedRule) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_WafRateBasedRule) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_WafRateBasedRule) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_WafRateBasedRule) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/waf_rate_based_rule aws_waf_rate_based_rule} Resource.
...
func (j *jsiiProxy_WafRateBasedRule)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_WafRateBasedRule)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_WafRateBasedRule)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func WafRateBasedRule_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (w *jsiiProxy_WafRateBasedRule) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_WafRateBasedRule) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (w *jsiiProxy_WafRateBasedRule) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_WafRateBasedRule) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (w *jsiiProxy_WafRateBasedRule) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (w *jsiiProxy_WafRateBasedRule) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
