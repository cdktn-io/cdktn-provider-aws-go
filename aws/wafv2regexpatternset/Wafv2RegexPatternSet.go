...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/wafv2regexpatternset/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/wafv2_regex_pattern_set aws_wafv2_regex_pattern_set}.
...
func (j *jsiiProxy_Wafv2RegexPatternSet) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_Wafv2RegexPatternSet) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_Wafv2RegexPatternSet) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_Wafv2RegexPatternSet) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_Wafv2RegexPatternSet) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/wafv2_regex_pattern_set aws_wafv2_regex_pattern_set} Resource.
...
func (j *jsiiProxy_Wafv2RegexPatternSet)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_Wafv2RegexPatternSet)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_Wafv2RegexPatternSet)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func Wafv2RegexPatternSet_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (w *jsiiProxy_Wafv2RegexPatternSet) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_Wafv2RegexPatternSet) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (w *jsiiProxy_Wafv2RegexPatternSet) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_Wafv2RegexPatternSet) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (w *jsiiProxy_Wafv2RegexPatternSet) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (w *jsiiProxy_Wafv2RegexPatternSet) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
