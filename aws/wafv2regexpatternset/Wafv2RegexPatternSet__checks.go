...
func (w *jsiiProxy_Wafv2RegexPatternSet) validatePutRegularExpressionParameters(value interface{}) error {
	...
	case *[]*Wafv2RegexPatternSetRegularExpression:
		value := value.(*[]*Wafv2RegexPatternSetRegularExpression)
	...
	case []*Wafv2RegexPatternSetRegularExpression:
		value_ := value.([]*Wafv2RegexPatternSetRegularExpression)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*Wafv2RegexPatternSetRegularExpression; received %#v (a %T)", value, value)
		}
	}
