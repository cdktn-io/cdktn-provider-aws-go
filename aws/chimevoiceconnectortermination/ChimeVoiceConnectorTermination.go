...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/chimevoiceconnectortermination/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/chime_voice_connector_termination aws_chime_voice_connector_termination}.
...
func (j *jsiiProxy_ChimeVoiceConnectorTermination) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_ChimeVoiceConnectorTermination) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/chime_voice_connector_termination aws_chime_voice_connector_termination} Resource.
...
func (j *jsiiProxy_ChimeVoiceConnectorTermination)SetRegion(val *string) {
...
func (c *jsiiProxy_ChimeVoiceConnectorTermination) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_ChimeVoiceConnectorTermination) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (c *jsiiProxy_ChimeVoiceConnectorTermination) ResetRegion() {
	_jsii_.InvokeVoid(
		c,
		"resetRegion",
		nil, // no parameters
...
func (c *jsiiProxy_ChimeVoiceConnectorTermination) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
