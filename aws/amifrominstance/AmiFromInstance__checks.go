...
func (a *jsiiProxy_AmiFromInstance) validatePutEbsBlockDeviceParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*AmiFromInstanceEbsBlockDevice; received %#v (a %T)", value, value)
		}
	}
...
func (a *jsiiProxy_AmiFromInstance) validatePutEphemeralBlockDeviceParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*AmiFromInstanceEphemeralBlockDevice; received %#v (a %T)", value, value)
		}
	}
