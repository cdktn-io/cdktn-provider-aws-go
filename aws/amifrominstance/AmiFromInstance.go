...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/ami_from_instance aws_ami_from_instance}.
...
func (j *jsiiProxy_AmiFromInstance) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_AmiFromInstance) EnaSupport() cdktn.IResolvable {
...
func (j *jsiiProxy_AmiFromInstance) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_AmiFromInstance) LastLaunchedTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"lastLaunchedTime",
...
func (j *jsiiProxy_AmiFromInstance) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_AmiFromInstance) ManageEbsSnapshots() cdktn.IResolvable {
	var returns cdktn.IResolvable
	_jsii_.Get(
		j,
		"manageEbsSnapshots",
...
func (j *jsiiProxy_AmiFromInstance) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_AmiFromInstance) Public() cdktn.IResolvable {
	var returns cdktn.IResolvable
	_jsii_.Get(
		j,
		"public",
...
func (j *jsiiProxy_AmiFromInstance) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_AmiFromInstance) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_AmiFromInstance) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/ami_from_instance aws_ami_from_instance} Resource.
func NewAmiFromInstance(scope constructs.Construct, id *string, config *AmiFromInstanceConfig) AmiFromInstance {
	...
	_jsii_.Create(
		"@cdktn/provider-aws.amiFromInstance.AmiFromInstance",
...
func (j *jsiiProxy_AmiFromInstance)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_AmiFromInstance)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_AmiFromInstance)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_AmiFromInstance)SetRegion(val *string) {
...
func AmiFromInstance_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (a *jsiiProxy_AmiFromInstance) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AmiFromInstance) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (a *jsiiProxy_AmiFromInstance) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AmiFromInstance) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (a *jsiiProxy_AmiFromInstance) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (a *jsiiProxy_AmiFromInstance) ResetRegion() {
	_jsii_.InvokeVoid(
		a,
		"resetRegion",
		nil, // no parameters
...
func (a *jsiiProxy_AmiFromInstance) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
