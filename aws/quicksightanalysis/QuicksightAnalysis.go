...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/quicksight_analysis aws_quicksight_analysis}.
...
func (j *jsiiProxy_QuicksightAnalysis) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_QuicksightAnalysis) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_QuicksightAnalysis) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_QuicksightAnalysis) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_QuicksightAnalysis) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/quicksight_analysis aws_quicksight_analysis} Resource.
...
func (j *jsiiProxy_QuicksightAnalysis)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_QuicksightAnalysis)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_QuicksightAnalysis)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func QuicksightAnalysis_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (q *jsiiProxy_QuicksightAnalysis) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (q *jsiiProxy_QuicksightAnalysis) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (q *jsiiProxy_QuicksightAnalysis) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (q *jsiiProxy_QuicksightAnalysis) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (q *jsiiProxy_QuicksightAnalysis) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (q *jsiiProxy_QuicksightAnalysis) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
