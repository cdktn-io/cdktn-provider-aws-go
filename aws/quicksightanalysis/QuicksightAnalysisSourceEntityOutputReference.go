...
func (j *jsiiProxy_QuicksightAnalysisSourceEntityOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewQuicksightAnalysisSourceEntityOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) QuicksightAnalysisSourceEntityOutputReference {
	_init_.Initialize()
...
func NewQuicksightAnalysisSourceEntityOutputReference_Override(q QuicksightAnalysisSourceEntityOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_QuicksightAnalysisSourceEntityOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (q *jsiiProxy_QuicksightAnalysisSourceEntityOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (q *jsiiProxy_QuicksightAnalysisSourceEntityOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (q *jsiiProxy_QuicksightAnalysisSourceEntityOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (q *jsiiProxy_QuicksightAnalysisSourceEntityOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
