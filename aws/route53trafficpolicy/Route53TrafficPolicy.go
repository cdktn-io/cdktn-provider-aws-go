...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/route53trafficpolicy/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/route53_traffic_policy aws_route53_traffic_policy}.
...
func (j *jsiiProxy_Route53TrafficPolicy) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_Route53TrafficPolicy) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_Route53TrafficPolicy) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_Route53TrafficPolicy) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_Route53TrafficPolicy) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/route53_traffic_policy aws_route53_traffic_policy} Resource.
...
func (j *jsiiProxy_Route53TrafficPolicy)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_Route53TrafficPolicy)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_Route53TrafficPolicy)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func Route53TrafficPolicy_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (r *jsiiProxy_Route53TrafficPolicy) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (r *jsiiProxy_Route53TrafficPolicy) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (r *jsiiProxy_Route53TrafficPolicy) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (r *jsiiProxy_Route53TrafficPolicy) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (r *jsiiProxy_Route53TrafficPolicy) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (r *jsiiProxy_Route53TrafficPolicy) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
