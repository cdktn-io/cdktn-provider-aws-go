...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/dxgatewayassociation/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/dx_gateway_association aws_dx_gateway_association}.
...
func (j *jsiiProxy_DxGatewayAssociation) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DxGatewayAssociation) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DxGatewayAssociation) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DxGatewayAssociation) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DxGatewayAssociation) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/dx_gateway_association aws_dx_gateway_association} Resource.
...
func (j *jsiiProxy_DxGatewayAssociation)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DxGatewayAssociation)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DxGatewayAssociation)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DxGatewayAssociation_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateDxGatewayAssociation_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DxGatewayAssociation) AddMoveTarget(moveTarget *string) {
...
func (d *jsiiProxy_DxGatewayAssociation) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DxGatewayAssociation) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (d *jsiiProxy_DxGatewayAssociation) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DxGatewayAssociation) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (d *jsiiProxy_DxGatewayAssociation) MoveFromId(id *string) {
...
func (d *jsiiProxy_DxGatewayAssociation) MoveToId(id *string) {
...
func (d *jsiiProxy_DxGatewayAssociation) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DxGatewayAssociation) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
