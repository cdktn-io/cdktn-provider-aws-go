...
func (a *jsiiProxy_AppmeshVirtualServiceSpecProviderOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_AppmeshVirtualServiceSpecProviderOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
