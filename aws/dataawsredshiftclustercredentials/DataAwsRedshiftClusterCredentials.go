...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/dataawsredshiftclustercredentials/internal"
...
func (j *jsiiProxy_DataAwsRedshiftClusterCredentials) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsRedshiftClusterCredentials) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsRedshiftClusterCredentials) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsRedshiftClusterCredentials) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsRedshiftClusterCredentials) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/data-sources/redshift_cluster_credentials aws_redshift_cluster_credentials} Data Source.
...
func (j *jsiiProxy_DataAwsRedshiftClusterCredentials)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsRedshiftClusterCredentials)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsRedshiftClusterCredentials)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsRedshiftClusterCredentials_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsRedshiftClusterCredentials) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsRedshiftClusterCredentials) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsRedshiftClusterCredentials) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsRedshiftClusterCredentials) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
