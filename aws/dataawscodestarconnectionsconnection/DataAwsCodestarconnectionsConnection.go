...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/dataawscodestarconnectionsconnection/internal"
...
func (j *jsiiProxy_DataAwsCodestarconnectionsConnection) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsCodestarconnectionsConnection) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsCodestarconnectionsConnection) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsCodestarconnectionsConnection) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsCodestarconnectionsConnection) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/data-sources/codestarconnections_connection aws_codestarconnections_connection} Data Source.
func NewDataAwsCodestarconnectionsConnection(scope constructs.Construct, id *string, config *DataAwsCodestarconnectionsConnectionConfig) DataAwsCodestarconnectionsConnection {
	...
	_jsii_.Create(
		"@cdktn/provider-aws.dataAwsCodestarconnectionsConnection.DataAwsCodestarconnectionsConnection",
...
func (j *jsiiProxy_DataAwsCodestarconnectionsConnection)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsCodestarconnectionsConnection)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsCodestarconnectionsConnection)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsCodestarconnectionsConnection_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsCodestarconnectionsConnection) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsCodestarconnectionsConnection) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsCodestarconnectionsConnection) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsCodestarconnectionsConnection) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
