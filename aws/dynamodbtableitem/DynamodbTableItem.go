...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/dynamodbtableitem/internal"
...
func (j *jsiiProxy_DynamodbTableItem) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DynamodbTableItem) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DynamodbTableItem) HashKeyValue() *string {
	var returns *string
	_jsii_.Get(
		j,
		"hashKeyValue",
...
func (j *jsiiProxy_DynamodbTableItem) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DynamodbTableItem) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DynamodbTableItem) RangeKeyValue() *string {
	var returns *string
	_jsii_.Get(
		j,
		"rangeKeyValue",
...
func (j *jsiiProxy_DynamodbTableItem) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/dynamodb_table_item aws_dynamodb_table_item} Resource.
...
func (j *jsiiProxy_DynamodbTableItem)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DynamodbTableItem)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DynamodbTableItem)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DynamodbTableItem_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DynamodbTableItem) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DynamodbTableItem) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (d *jsiiProxy_DynamodbTableItem) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DynamodbTableItem) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (d *jsiiProxy_DynamodbTableItem) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DynamodbTableItem) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
