...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/ec2localgatewayroutetablevirtualinterfacegroupassociation/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/ec2_local_gateway_route_table_virtual_interface_group_association aws_ec2_local_gateway_route_table_virtual_interface_group_association}.
...
func (j *jsiiProxy_Ec2LocalGatewayRouteTableVirtualInterfaceGroupAssociation) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_Ec2LocalGatewayRouteTableVirtualInterfaceGroupAssociation) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_Ec2LocalGatewayRouteTableVirtualInterfaceGroupAssociation) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_Ec2LocalGatewayRouteTableVirtualInterfaceGroupAssociation) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_Ec2LocalGatewayRouteTableVirtualInterfaceGroupAssociation) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_Ec2LocalGatewayRouteTableVirtualInterfaceGroupAssociation) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_Ec2LocalGatewayRouteTableVirtualInterfaceGroupAssociation) Tags() *map[string]*string {
...
func (j *jsiiProxy_Ec2LocalGatewayRouteTableVirtualInterfaceGroupAssociation) TagsAll() cdktn.StringMap {
...
func (j *jsiiProxy_Ec2LocalGatewayRouteTableVirtualInterfaceGroupAssociation) TagsInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsInput",
...
func (j *jsiiProxy_Ec2LocalGatewayRouteTableVirtualInterfaceGroupAssociation) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/ec2_local_gateway_route_table_virtual_interface_group_association aws_ec2_local_gateway_route_table_virtual_interface_group_association} Resource.
func NewEc2LocalGatewayRouteTableVirtualInterfaceGroupAssociation(scope constructs.Construct, id *string, config *Ec2LocalGatewayRouteTableVirtualInterfaceGroupAssociationConfig) Ec2LocalGatewayRouteTableVirtualInterfaceGroupAssociation {
	...
	_jsii_.Create(
		"@cdktn/provider-aws.ec2LocalGatewayRouteTableVirtualInterfaceGroupAssociation.Ec2LocalGatewayRouteTableVirtualInterfaceGroupAssociation",
...
func (j *jsiiProxy_Ec2LocalGatewayRouteTableVirtualInterfaceGroupAssociation)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_Ec2LocalGatewayRouteTableVirtualInterfaceGroupAssociation)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_Ec2LocalGatewayRouteTableVirtualInterfaceGroupAssociation)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_Ec2LocalGatewayRouteTableVirtualInterfaceGroupAssociation)SetRegion(val *string) {
...
func (j *jsiiProxy_Ec2LocalGatewayRouteTableVirtualInterfaceGroupAssociation)SetTags(val *map[string]*string) {
...
func Ec2LocalGatewayRouteTableVirtualInterfaceGroupAssociation_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (e *jsiiProxy_Ec2LocalGatewayRouteTableVirtualInterfaceGroupAssociation) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (e *jsiiProxy_Ec2LocalGatewayRouteTableVirtualInterfaceGroupAssociation) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (e *jsiiProxy_Ec2LocalGatewayRouteTableVirtualInterfaceGroupAssociation) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (e *jsiiProxy_Ec2LocalGatewayRouteTableVirtualInterfaceGroupAssociation) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (e *jsiiProxy_Ec2LocalGatewayRouteTableVirtualInterfaceGroupAssociation) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (e *jsiiProxy_Ec2LocalGatewayRouteTableVirtualInterfaceGroupAssociation) ResetRegion() {
	_jsii_.InvokeVoid(
		e,
		"resetRegion",
		nil, // no parameters
...
func (e *jsiiProxy_Ec2LocalGatewayRouteTableVirtualInterfaceGroupAssociation) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
