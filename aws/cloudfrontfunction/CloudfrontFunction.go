...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/cloudfrontfunction/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/cloudfront_function aws_cloudfront_function}.
...
func (j *jsiiProxy_CloudfrontFunction) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_CloudfrontFunction) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_CloudfrontFunction) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_CloudfrontFunction) Provider() cdktn.TerraformProvider {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/cloudfront_function aws_cloudfront_function} Resource.
...
func (j *jsiiProxy_CloudfrontFunction)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_CloudfrontFunction)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_CloudfrontFunction)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func CloudfrontFunction_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateCloudfrontFunction_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (c *jsiiProxy_CloudfrontFunction) AddMoveTarget(moveTarget *string) {
...
func (c *jsiiProxy_CloudfrontFunction) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CloudfrontFunction) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (c *jsiiProxy_CloudfrontFunction) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CloudfrontFunction) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_CloudfrontFunction) MoveFromId(id *string) {
...
func (c *jsiiProxy_CloudfrontFunction) MoveToId(id *string) {
...
func (c *jsiiProxy_CloudfrontFunction) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (c *jsiiProxy_CloudfrontFunction) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
