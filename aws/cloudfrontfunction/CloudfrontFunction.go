...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v22/cloudfrontfunction/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.31.0/docs/resources/cloudfront_function aws_cloudfront_function}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.31.0/docs/resources/cloudfront_function aws_cloudfront_function} Resource.
...
func CloudfrontFunction_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (c *jsiiProxy_CloudfrontFunction) ImportFrom(id *string, provider cdktf.TerraformProvider) {
