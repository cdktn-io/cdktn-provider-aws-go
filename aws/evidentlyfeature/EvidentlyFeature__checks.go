...
func (e *jsiiProxy_EvidentlyFeature) validateMoveToIdParameters(id *string) error {
	if id == nil {
		return fmt.Errorf("parameter id is required, but nil was provided")
	}
...
func (e *jsiiProxy_EvidentlyFeature) validatePutVariationsParameters(value interface{}) error {
	...
	case *[]*EvidentlyFeatureVariations:
		value := value.(*[]*EvidentlyFeatureVariations)
	...
	case []*EvidentlyFeatureVariations:
		value_ := value.([]*EvidentlyFeatureVariations)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*EvidentlyFeatureVariations; received %#v (a %T)", value, value)
		}
	}
