...
func (j *jsiiProxy_EvidentlyFeatureEvaluationRulesList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewEvidentlyFeatureEvaluationRulesList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) EvidentlyFeatureEvaluationRulesList {
	_init_.Initialize()
...
func NewEvidentlyFeatureEvaluationRulesList_Override(e EvidentlyFeatureEvaluationRulesList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_EvidentlyFeatureEvaluationRulesList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (e *jsiiProxy_EvidentlyFeatureEvaluationRulesList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (e *jsiiProxy_EvidentlyFeatureEvaluationRulesList) Resolve(context cdktn.IResolveContext) interface{} {
