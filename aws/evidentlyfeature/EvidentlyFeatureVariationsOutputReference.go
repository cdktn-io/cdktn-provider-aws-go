...
func (j *jsiiProxy_EvidentlyFeatureVariationsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewEvidentlyFeatureVariationsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) EvidentlyFeatureVariationsOutputReference {
	_init_.Initialize()
...
func NewEvidentlyFeatureVariationsOutputReference_Override(e EvidentlyFeatureVariationsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_EvidentlyFeatureVariationsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (e *jsiiProxy_EvidentlyFeatureVariationsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (e *jsiiProxy_EvidentlyFeatureVariationsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (e *jsiiProxy_EvidentlyFeatureVariationsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (e *jsiiProxy_EvidentlyFeatureVariationsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
