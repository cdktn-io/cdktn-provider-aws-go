...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v21/workspaceswebbrowsersettings/internal"
...
func (j *jsiiProxy_WorkspaceswebBrowserSettings) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_WorkspaceswebBrowserSettings) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_WorkspaceswebBrowserSettings) Tags() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tags",
...
func (j *jsiiProxy_WorkspaceswebBrowserSettings) TagsAll() cdktf.StringMap {
...
func (j *jsiiProxy_WorkspaceswebBrowserSettings) TagsInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsInput",
...
func (j *jsiiProxy_WorkspaceswebBrowserSettings)SetRegion(val *string) {
...
func (j *jsiiProxy_WorkspaceswebBrowserSettings)SetTags(val *map[string]*string) {
...
func (w *jsiiProxy_WorkspaceswebBrowserSettings) ResetRegion() {
	_jsii_.InvokeVoid(
		w,
		"resetRegion",
		nil, // no parameters
