...
func (j *jsiiProxy_DataAwsEc2InstanceTypes) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsEc2InstanceTypes) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsEc2InstanceTypes) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsEc2InstanceTypes) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsEc2InstanceTypes) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DataAwsEc2InstanceTypes) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_DataAwsEc2InstanceTypes) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DataAwsEc2InstanceTypes)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsEc2InstanceTypes)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsEc2InstanceTypes)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_DataAwsEc2InstanceTypes)SetRegion(val *string) {
...
func DataAwsEc2InstanceTypes_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsEc2InstanceTypes) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsEc2InstanceTypes) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsEc2InstanceTypes) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsEc2InstanceTypes) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsEc2InstanceTypes) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
