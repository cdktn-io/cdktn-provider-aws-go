...
func (j *jsiiProxy_DataAwsDatapipelinePipelineDefinition) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsDatapipelinePipelineDefinition) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsDatapipelinePipelineDefinition) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsDatapipelinePipelineDefinition) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsDatapipelinePipelineDefinition) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func NewDataAwsDatapipelinePipelineDefinition(scope constructs.Construct, id *string, config *DataAwsDatapipelinePipelineDefinitionConfig) DataAwsDatapipelinePipelineDefinition {
	...
	_jsii_.Create(
		"@cdktn/provider-aws.dataAwsDatapipelinePipelineDefinition.DataAwsDatapipelinePipelineDefinition",
...
func (j *jsiiProxy_DataAwsDatapipelinePipelineDefinition)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsDatapipelinePipelineDefinition)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsDatapipelinePipelineDefinition)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsDatapipelinePipelineDefinition_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsDatapipelinePipelineDefinition) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsDatapipelinePipelineDefinition) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsDatapipelinePipelineDefinition) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsDatapipelinePipelineDefinition) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
