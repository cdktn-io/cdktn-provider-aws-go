...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/dxgatewayassociationproposal/internal"
...
func (j *jsiiProxy_DxGatewayAssociationProposal) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DxGatewayAssociationProposal) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DxGatewayAssociationProposal) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DxGatewayAssociationProposal) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DxGatewayAssociationProposal) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DxGatewayAssociationProposal) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_DxGatewayAssociationProposal) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/dx_gateway_association_proposal aws_dx_gateway_association_proposal} Resource.
...
func (j *jsiiProxy_DxGatewayAssociationProposal)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DxGatewayAssociationProposal)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DxGatewayAssociationProposal)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_DxGatewayAssociationProposal)SetRegion(val *string) {
...
func DxGatewayAssociationProposal_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DxGatewayAssociationProposal) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DxGatewayAssociationProposal) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (d *jsiiProxy_DxGatewayAssociationProposal) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DxGatewayAssociationProposal) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (d *jsiiProxy_DxGatewayAssociationProposal) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DxGatewayAssociationProposal) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
...
func (d *jsiiProxy_DxGatewayAssociationProposal) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
