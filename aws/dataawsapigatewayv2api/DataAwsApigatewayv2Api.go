...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/dataawsapigatewayv2api/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/data-sources/apigatewayv2_api aws_apigatewayv2_api}.
...
func (j *jsiiProxy_DataAwsApigatewayv2Api) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsApigatewayv2Api) DisableExecuteApiEndpoint() cdktn.IResolvable {
...
func (j *jsiiProxy_DataAwsApigatewayv2Api) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsApigatewayv2Api) IpAddressType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ipAddressType",
...
func (j *jsiiProxy_DataAwsApigatewayv2Api) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsApigatewayv2Api) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsApigatewayv2Api) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/data-sources/apigatewayv2_api aws_apigatewayv2_api} Data Source.
...
func (j *jsiiProxy_DataAwsApigatewayv2Api)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsApigatewayv2Api)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsApigatewayv2Api)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsApigatewayv2Api_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateDataAwsApigatewayv2Api_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataAwsApigatewayv2Api) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsApigatewayv2Api) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsApigatewayv2Api) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsApigatewayv2Api) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
