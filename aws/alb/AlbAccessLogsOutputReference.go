...
func (a *jsiiProxy_AlbAccessLogsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_AlbAccessLogsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
