...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "enablePrefixForIpv6SourceNatInput", GoGetter: "EnablePrefixForIpv6SourceNatInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetEnablePrefixForIpv6SourceNat", GoMethod: "ResetEnablePrefixForIpv6SourceNat"},
