...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/alb aws_alb}.
type Alb interface {
	...
	HealthCheckLogs() AlbHealthCheckLogsOutputReference
	HealthCheckLogsInput() *AlbHealthCheckLogs
	Id() *string
	SetId(val *string)
	IdInput() *string
	IdleTimeout() *float64
	...
	PutHealthCheckLogs(value *AlbHealthCheckLogs)
...
func (j *jsiiProxy_Alb) HealthCheckLogs() AlbHealthCheckLogsOutputReference {
	var returns AlbHealthCheckLogsOutputReference
	_jsii_.Get(
		j,
		"healthCheckLogs",
		&returns,
...
func (j *jsiiProxy_Alb) HealthCheckLogsInput() *AlbHealthCheckLogs {
	var returns *AlbHealthCheckLogs
	_jsii_.Get(
		j,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/alb aws_alb} Resource.
...
func (a *jsiiProxy_Alb) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (a *jsiiProxy_Alb) PutHealthCheckLogs(value *AlbHealthCheckLogs) {
...
func (a *jsiiProxy_Alb) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (a *jsiiProxy_Alb) ResetHealthCheckLogs() {
	_jsii_.InvokeVoid(
		a,
		"resetHealthCheckLogs",
		nil, // no parameters
...
func (a *jsiiProxy_Alb) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
