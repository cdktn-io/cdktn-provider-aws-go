...
func (a *jsiiProxy_AlbSubnetMappingOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_AlbSubnetMappingOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
