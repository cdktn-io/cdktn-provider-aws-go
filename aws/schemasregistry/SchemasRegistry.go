...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v21/schemasregistry/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.28.0/docs/resources/schemas_registry aws_schemas_registry}.
...
func (j *jsiiProxy_SchemasRegistry) ForEach() cdktf.ITerraformIterator {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.28.0/docs/resources/schemas_registry aws_schemas_registry} Resource.
...
func (j *jsiiProxy_SchemasRegistry)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func SchemasRegistry_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (s *jsiiProxy_SchemasRegistry) ImportFrom(id *string, provider cdktf.TerraformProvider) {
