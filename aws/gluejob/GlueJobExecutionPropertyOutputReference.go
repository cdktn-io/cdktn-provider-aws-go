...
func (j *jsiiProxy_GlueJobExecutionPropertyOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewGlueJobExecutionPropertyOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) GlueJobExecutionPropertyOutputReference {
	_init_.Initialize()
...
func NewGlueJobExecutionPropertyOutputReference_Override(g GlueJobExecutionPropertyOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_GlueJobExecutionPropertyOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (g *jsiiProxy_GlueJobExecutionPropertyOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GlueJobExecutionPropertyOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (g *jsiiProxy_GlueJobExecutionPropertyOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GlueJobExecutionPropertyOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
