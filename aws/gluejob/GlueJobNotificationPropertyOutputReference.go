...
func (j *jsiiProxy_GlueJobNotificationPropertyOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewGlueJobNotificationPropertyOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) GlueJobNotificationPropertyOutputReference {
	_init_.Initialize()
...
func NewGlueJobNotificationPropertyOutputReference_Override(g GlueJobNotificationPropertyOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_GlueJobNotificationPropertyOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (g *jsiiProxy_GlueJobNotificationPropertyOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GlueJobNotificationPropertyOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (g *jsiiProxy_GlueJobNotificationPropertyOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GlueJobNotificationPropertyOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
