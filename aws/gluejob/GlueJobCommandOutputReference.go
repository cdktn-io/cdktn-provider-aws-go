...
func (g *jsiiProxy_GlueJobCommandOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GlueJobCommandOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
