...
func (j *jsiiProxy_GlueJobCommandOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewGlueJobCommandOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) GlueJobCommandOutputReference {
	_init_.Initialize()
...
func NewGlueJobCommandOutputReference_Override(g GlueJobCommandOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_GlueJobCommandOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (g *jsiiProxy_GlueJobCommandOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GlueJobCommandOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (g *jsiiProxy_GlueJobCommandOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GlueJobCommandOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
