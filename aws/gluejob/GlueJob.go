...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/glue_job aws_glue_job}.
...
func (j *jsiiProxy_GlueJob) JobMode() *string {
	var returns *string
	_jsii_.Get(
		j,
		"jobMode",
...
func (j *jsiiProxy_GlueJob) JobModeInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"jobModeInput",
...
func (j *jsiiProxy_GlueJob) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_GlueJob) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/glue_job aws_glue_job} Resource.
...
func (j *jsiiProxy_GlueJob)SetJobMode(val *string) {
...
func (j *jsiiProxy_GlueJob)SetRegion(val *string) {
...
func (g *jsiiProxy_GlueJob) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GlueJob) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (g *jsiiProxy_GlueJob) ResetJobMode() {
	_jsii_.InvokeVoid(
		g,
		"resetJobMode",
		nil, // no parameters
...
func (g *jsiiProxy_GlueJob) ResetRegion() {
	_jsii_.InvokeVoid(
		g,
		"resetRegion",
		nil, // no parameters
...
func (g *jsiiProxy_GlueJob) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
