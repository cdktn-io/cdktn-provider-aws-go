...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/servicediscoveryinstance/internal"
...
func (j *jsiiProxy_ServiceDiscoveryInstance) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_ServiceDiscoveryInstance) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_ServiceDiscoveryInstance) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_ServiceDiscoveryInstance) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_ServiceDiscoveryInstance) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_ServiceDiscoveryInstance) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_ServiceDiscoveryInstance) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_ServiceDiscoveryInstance)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_ServiceDiscoveryInstance)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_ServiceDiscoveryInstance)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_ServiceDiscoveryInstance)SetRegion(val *string) {
...
func ServiceDiscoveryInstance_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (s *jsiiProxy_ServiceDiscoveryInstance) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_ServiceDiscoveryInstance) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_ServiceDiscoveryInstance) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_ServiceDiscoveryInstance) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_ServiceDiscoveryInstance) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_ServiceDiscoveryInstance) ResetRegion() {
	_jsii_.InvokeVoid(
		s,
		"resetRegion",
		nil, // no parameters
...
func (s *jsiiProxy_ServiceDiscoveryInstance) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
