...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/devicefarmnetworkprofile/internal"
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/devicefarm_network_profile aws_devicefarm_network_profile} Resource.
...
func (d *jsiiProxy_DevicefarmNetworkProfile) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (d *jsiiProxy_DevicefarmNetworkProfile) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DevicefarmNetworkProfile) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
