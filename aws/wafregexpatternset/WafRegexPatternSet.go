...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/wafregexpatternset/internal"
...
func (j *jsiiProxy_WafRegexPatternSet) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_WafRegexPatternSet) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_WafRegexPatternSet) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_WafRegexPatternSet) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_WafRegexPatternSet) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/waf_regex_pattern_set aws_waf_regex_pattern_set} Resource.
...
func (j *jsiiProxy_WafRegexPatternSet)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_WafRegexPatternSet)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_WafRegexPatternSet)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func WafRegexPatternSet_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateWafRegexPatternSet_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
// Experimental.
func WafRegexPatternSet_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateWafRegexPatternSet_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func WafRegexPatternSet_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateWafRegexPatternSet_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (w *jsiiProxy_WafRegexPatternSet) AddMoveTarget(moveTarget *string) {
...
func (w *jsiiProxy_WafRegexPatternSet) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_WafRegexPatternSet) HasResourceMove() interface{} {
	var returns interface{}
...
func (w *jsiiProxy_WafRegexPatternSet) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (w *jsiiProxy_WafRegexPatternSet) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_WafRegexPatternSet) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (w *jsiiProxy_WafRegexPatternSet) MoveFromId(id *string) {
...
func (w *jsiiProxy_WafRegexPatternSet) MoveTo(moveTarget *string, index interface{}) {
...
func (w *jsiiProxy_WafRegexPatternSet) MoveToId(id *string) {
...
func (w *jsiiProxy_WafRegexPatternSet) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (w *jsiiProxy_WafRegexPatternSet) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (w *jsiiProxy_WafRegexPatternSet) ToHclTerraform() interface{} {
	var returns interface{}
...
func (w *jsiiProxy_WafRegexPatternSet) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
