...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v22/wafregexpatternset/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.31.0/docs/resources/waf_regex_pattern_set aws_waf_regex_pattern_set}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.31.0/docs/resources/waf_regex_pattern_set aws_waf_regex_pattern_set} Resource.
...
func WafRegexPatternSet_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (w *jsiiProxy_WafRegexPatternSet) ImportFrom(id *string, provider cdktf.TerraformProvider) {
