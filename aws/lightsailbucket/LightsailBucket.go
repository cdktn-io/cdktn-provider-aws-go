...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/lightsailbucket/internal"
...
func (j *jsiiProxy_LightsailBucket) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_LightsailBucket) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_LightsailBucket) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_LightsailBucket) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_LightsailBucket) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_LightsailBucket)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_LightsailBucket)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_LightsailBucket)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func LightsailBucket_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (l *jsiiProxy_LightsailBucket) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LightsailBucket) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (l *jsiiProxy_LightsailBucket) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LightsailBucket) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (l *jsiiProxy_LightsailBucket) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (l *jsiiProxy_LightsailBucket) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
