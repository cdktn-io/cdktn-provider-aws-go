...
func (j *jsiiProxy_DataAwsLexSlotTypeEnumerationValueOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsLexSlotTypeEnumerationValueOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) DataAwsLexSlotTypeEnumerationValueOutputReference {
	_init_.Initialize()

	if err := validateNewDataAwsLexSlotTypeEnumerationValueOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func NewDataAwsLexSlotTypeEnumerationValueOutputReference_Override(d DataAwsLexSlotTypeEnumerationValueOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsLexSlotTypeEnumerationValueOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsLexSlotTypeEnumerationValueOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsLexSlotTypeEnumerationValueOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (d *jsiiProxy_DataAwsLexSlotTypeEnumerationValueOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsLexSlotTypeEnumerationValueOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
