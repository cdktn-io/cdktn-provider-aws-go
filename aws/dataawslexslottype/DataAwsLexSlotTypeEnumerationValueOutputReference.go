...
func (d *jsiiProxy_DataAwsLexSlotTypeEnumerationValueOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataAwsLexSlotTypeEnumerationValueOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
