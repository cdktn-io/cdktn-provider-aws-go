...
func (j *jsiiProxy_DataAwsLexSlotTypeEnumerationValueList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsLexSlotTypeEnumerationValueList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsLexSlotTypeEnumerationValueList {
	_init_.Initialize()
...
func NewDataAwsLexSlotTypeEnumerationValueList_Override(d DataAwsLexSlotTypeEnumerationValueList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsLexSlotTypeEnumerationValueList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsLexSlotTypeEnumerationValueList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsLexSlotTypeEnumerationValueList) Resolve(context cdktn.IResolveContext) interface{} {
