...
func (e *jsiiProxy_Ec2Fleet) validatePutFleetInstanceSetParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*Ec2FleetFleetInstanceSet; received %#v (a %T)", value, value)
		}
	}
...
func (e *jsiiProxy_Ec2Fleet) validatePutLaunchTemplateConfigParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*Ec2FleetLaunchTemplateConfig; received %#v (a %T)", value, value)
		}
	}
...
func (j *jsiiProxy_Ec2Fleet) validateSetLifecycleParameters(val *cdktn.TerraformResourceLifecycle) error {
	if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
		return err
	}
