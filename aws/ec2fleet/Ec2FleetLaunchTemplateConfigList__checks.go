...
func (e *jsiiProxy_Ec2FleetLaunchTemplateConfigList) validateResolveParameters(context cdktn.IResolveContext) error {
	if context == nil {
...
func (j *jsiiProxy_Ec2FleetLaunchTemplateConfigList) validateSetInternalValueParameters(val interface{}) error {
	...
	case []*Ec2FleetLaunchTemplateConfig:
		val_ := val.([]*Ec2FleetLaunchTemplateConfig)
		val := &val_
		for idx_97dfc6, v := range *val {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktn.IResolvable, *[]*Ec2FleetLaunchTemplateConfig; received %#v (a %T)", val, val)
		}
	}
...
func (j *jsiiProxy_Ec2FleetLaunchTemplateConfigList) validateSetTerraformResourceParameters(val cdktn.IInterpolatingParent) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func validateNewEc2FleetLaunchTemplateConfigListParameters(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) error {
