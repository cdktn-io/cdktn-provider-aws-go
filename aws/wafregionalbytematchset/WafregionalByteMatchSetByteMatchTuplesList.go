...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v22/wafregionalbytematchset/internal"
...
func (w *jsiiProxy_WafregionalByteMatchSetByteMatchTuplesList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (w *jsiiProxy_WafregionalByteMatchSetByteMatchTuplesList) Resolve(context cdktf.IResolveContext) interface{} {
