...
func (j *jsiiProxy_WafregionalByteMatchSetByteMatchTuplesList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewWafregionalByteMatchSetByteMatchTuplesList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) WafregionalByteMatchSetByteMatchTuplesList {
	_init_.Initialize()

	if err := validateNewWafregionalByteMatchSetByteMatchTuplesListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewWafregionalByteMatchSetByteMatchTuplesList_Override(w WafregionalByteMatchSetByteMatchTuplesList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_WafregionalByteMatchSetByteMatchTuplesList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (w *jsiiProxy_WafregionalByteMatchSetByteMatchTuplesList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (w *jsiiProxy_WafregionalByteMatchSetByteMatchTuplesList) Resolve(context cdktn.IResolveContext) interface{} {
