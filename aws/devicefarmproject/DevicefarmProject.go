...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/devicefarmproject/internal"
...
func (j *jsiiProxy_DevicefarmProject) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DevicefarmProject) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DevicefarmProject) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DevicefarmProject) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DevicefarmProject) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func NewDevicefarmProject(scope constructs.Construct, id *string, config *DevicefarmProjectConfig) DevicefarmProject {
	...
	_jsii_.Create(
		"@cdktn/provider-aws.devicefarmProject.DevicefarmProject",
...
func (j *jsiiProxy_DevicefarmProject)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DevicefarmProject)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DevicefarmProject)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DevicefarmProject_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DevicefarmProject) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DevicefarmProject) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (d *jsiiProxy_DevicefarmProject) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DevicefarmProject) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (d *jsiiProxy_DevicefarmProject) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DevicefarmProject) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
