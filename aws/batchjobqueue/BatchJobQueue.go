...
type BatchJobQueue interface {
	...
	Id() *string
	JobStateTimeLimitAction() BatchJobQueueJobStateTimeLimitActionList
	JobStateTimeLimitActionInput() interface{}
	// Experimental.
	...
	PutJobStateTimeLimitAction(value interface{})
...
func (j *jsiiProxy_BatchJobQueue) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_BatchJobQueue) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_BatchJobQueue) JobStateTimeLimitAction() BatchJobQueueJobStateTimeLimitActionList {
	var returns BatchJobQueueJobStateTimeLimitActionList
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_BatchJobQueue) JobStateTimeLimitActionInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"jobStateTimeLimitActionInput",
		&returns,
	)
	return returns
}

func (j *jsiiProxy_BatchJobQueue) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_BatchJobQueue) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_BatchJobQueue) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_BatchJobQueue) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_BatchJobQueue) TagsAll() cdktn.StringMap {
...
func (j *jsiiProxy_BatchJobQueue) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_BatchJobQueue)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_BatchJobQueue)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_BatchJobQueue)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_BatchJobQueue)SetRegion(val *string) {
...
func BatchJobQueue_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (b *jsiiProxy_BatchJobQueue) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (b *jsiiProxy_BatchJobQueue) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (b *jsiiProxy_BatchJobQueue) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (b *jsiiProxy_BatchJobQueue) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (b *jsiiProxy_BatchJobQueue) PutJobStateTimeLimitAction(value interface{}) {
	if err := b.validatePutJobStateTimeLimitActionParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		b,
		"putJobStateTimeLimitAction",
		[]interface{}{value},
	)
}
...
func (b *jsiiProxy_BatchJobQueue) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (b *jsiiProxy_BatchJobQueue) ResetJobStateTimeLimitAction() {
	_jsii_.InvokeVoid(
		b,
		"resetJobStateTimeLimitAction",
		nil, // no parameters
...
func (b *jsiiProxy_BatchJobQueue) ResetRegion() {
	_jsii_.InvokeVoid(
		b,
		"resetRegion",
		nil, // no parameters
...
func (b *jsiiProxy_BatchJobQueue) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
