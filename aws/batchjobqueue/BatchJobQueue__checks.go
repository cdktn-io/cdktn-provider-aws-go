...
func (b *jsiiProxy_BatchJobQueue) validatePutComputeEnvironmentOrderParameters(value interface{}) error {
	...
	case cdktn.IResolvable:
		// ok
	case *[]*BatchJobQueueComputeEnvironmentOrder:
		value := value.(*[]*BatchJobQueueComputeEnvironmentOrder)
	...
	case []*BatchJobQueueComputeEnvironmentOrder:
		value_ := value.([]*BatchJobQueueComputeEnvironmentOrder)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*BatchJobQueueComputeEnvironmentOrder; received %#v (a %T)", value, value)
		}
	}
...
func (b *jsiiProxy_BatchJobQueue) validatePutJobStateTimeLimitActionParameters(value interface{}) error {
	...
	case *[]*BatchJobQueueJobStateTimeLimitAction:
		value := value.(*[]*BatchJobQueueJobStateTimeLimitAction)
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
			}
	...
	case []*BatchJobQueueJobStateTimeLimitAction:
		value_ := value.([]*BatchJobQueueJobStateTimeLimitAction)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*BatchJobQueueJobStateTimeLimitAction; received %#v (a %T)", value, value)
		}
	}
