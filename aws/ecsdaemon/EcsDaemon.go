...
func (e *jsiiProxy_EcsDaemon) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (e *jsiiProxy_EcsDaemon) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
