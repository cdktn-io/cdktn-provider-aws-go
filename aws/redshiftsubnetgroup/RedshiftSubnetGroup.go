...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/redshiftsubnetgroup/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/redshift_subnet_group aws_redshift_subnet_group}.
...
func (j *jsiiProxy_RedshiftSubnetGroup) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_RedshiftSubnetGroup) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_RedshiftSubnetGroup) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_RedshiftSubnetGroup) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_RedshiftSubnetGroup) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_RedshiftSubnetGroup) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_RedshiftSubnetGroup) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/redshift_subnet_group aws_redshift_subnet_group} Resource.
func NewRedshiftSubnetGroup(scope constructs.Construct, id *string, config *RedshiftSubnetGroupConfig) RedshiftSubnetGroup {
	...
	_jsii_.Create(
		"@cdktn/provider-aws.redshiftSubnetGroup.RedshiftSubnetGroup",
...
func (j *jsiiProxy_RedshiftSubnetGroup)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_RedshiftSubnetGroup)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_RedshiftSubnetGroup)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_RedshiftSubnetGroup)SetRegion(val *string) {
...
// Generates CDKTN code for importing a RedshiftSubnetGroup resource upon running "cdktn plan <stack-name>".
func RedshiftSubnetGroup_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (r *jsiiProxy_RedshiftSubnetGroup) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (r *jsiiProxy_RedshiftSubnetGroup) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (r *jsiiProxy_RedshiftSubnetGroup) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (r *jsiiProxy_RedshiftSubnetGroup) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (r *jsiiProxy_RedshiftSubnetGroup) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (r *jsiiProxy_RedshiftSubnetGroup) ResetRegion() {
	_jsii_.InvokeVoid(
		r,
		"resetRegion",
		nil, // no parameters
...
func (r *jsiiProxy_RedshiftSubnetGroup) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
