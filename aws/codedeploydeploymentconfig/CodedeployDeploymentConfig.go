...
func (j *jsiiProxy_CodedeployDeploymentConfig) Arn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"arn",
...
func (j *jsiiProxy_CodedeployDeploymentConfig) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_CodedeployDeploymentConfig) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_CodedeployDeploymentConfig) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_CodedeployDeploymentConfig) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_CodedeployDeploymentConfig) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_CodedeployDeploymentConfig) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_CodedeployDeploymentConfig) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/codedeploy_deployment_config aws_codedeploy_deployment_config} Resource.
...
func (j *jsiiProxy_CodedeployDeploymentConfig)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_CodedeployDeploymentConfig)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_CodedeployDeploymentConfig)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_CodedeployDeploymentConfig)SetRegion(val *string) {
...
func CodedeployDeploymentConfig_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (c *jsiiProxy_CodedeployDeploymentConfig) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CodedeployDeploymentConfig) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (c *jsiiProxy_CodedeployDeploymentConfig) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CodedeployDeploymentConfig) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_CodedeployDeploymentConfig) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (c *jsiiProxy_CodedeployDeploymentConfig) ResetRegion() {
	_jsii_.InvokeVoid(
		c,
		"resetRegion",
		nil, // no parameters
...
func (c *jsiiProxy_CodedeployDeploymentConfig) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
