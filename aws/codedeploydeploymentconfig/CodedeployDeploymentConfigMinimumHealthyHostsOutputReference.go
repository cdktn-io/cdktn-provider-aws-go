...
func (j *jsiiProxy_CodedeployDeploymentConfigMinimumHealthyHostsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewCodedeployDeploymentConfigMinimumHealthyHostsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) CodedeployDeploymentConfigMinimumHealthyHostsOutputReference {
	_init_.Initialize()
...
func NewCodedeployDeploymentConfigMinimumHealthyHostsOutputReference_Override(c CodedeployDeploymentConfigMinimumHealthyHostsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_CodedeployDeploymentConfigMinimumHealthyHostsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_CodedeployDeploymentConfigMinimumHealthyHostsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CodedeployDeploymentConfigMinimumHealthyHostsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (c *jsiiProxy_CodedeployDeploymentConfigMinimumHealthyHostsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CodedeployDeploymentConfigMinimumHealthyHostsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
