...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/dataawscloudwatcheventconnection/internal"
...
func (j *jsiiProxy_DataAwsCloudwatchEventConnection) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsCloudwatchEventConnection) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsCloudwatchEventConnection) KmsKeyIdentifier() *string {
	var returns *string
	_jsii_.Get(
		j,
		"kmsKeyIdentifier",
...
func (j *jsiiProxy_DataAwsCloudwatchEventConnection) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsCloudwatchEventConnection) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsCloudwatchEventConnection) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DataAwsCloudwatchEventConnection) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_DataAwsCloudwatchEventConnection) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/data-sources/cloudwatch_event_connection aws_cloudwatch_event_connection} Data Source.
func NewDataAwsCloudwatchEventConnection(scope constructs.Construct, id *string, config *DataAwsCloudwatchEventConnectionConfig) DataAwsCloudwatchEventConnection {
	...
	_jsii_.Create(
		"@cdktn/provider-aws.dataAwsCloudwatchEventConnection.DataAwsCloudwatchEventConnection",
...
func (j *jsiiProxy_DataAwsCloudwatchEventConnection)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsCloudwatchEventConnection)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsCloudwatchEventConnection)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_DataAwsCloudwatchEventConnection)SetRegion(val *string) {
...
func DataAwsCloudwatchEventConnection_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsCloudwatchEventConnection) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsCloudwatchEventConnection) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsCloudwatchEventConnection) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsCloudwatchEventConnection) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsCloudwatchEventConnection) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
