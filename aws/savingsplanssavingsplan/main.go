...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*SavingsplansSavingsPlan)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-aws.savingsplansSavingsPlan.SavingsplansSavingsPlanConfig",
		reflect.TypeOf((*SavingsplansSavingsPlanConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-aws.savingsplansSavingsPlan.SavingsplansSavingsPlanTimeouts",
		reflect.TypeOf((*SavingsplansSavingsPlanTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-aws.savingsplansSavingsPlan.SavingsplansSavingsPlanTimeoutsOutputReference",
		reflect.TypeOf((*SavingsplansSavingsPlanTimeoutsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
		...
		func() interface{} {
			j := jsiiProxy_SavingsplansSavingsPlanTimeoutsOutputReference{}
