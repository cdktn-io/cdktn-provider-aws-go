...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/savingsplanssavingsplan/internal"
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/savingsplans_savings_plan aws_savingsplans_savings_plan} Resource.
...
func (s *jsiiProxy_SavingsplansSavingsPlan) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_SavingsplansSavingsPlan) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
