...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/dataawselasticbeanstalkhostedzone/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/data-sources/elastic_beanstalk_hosted_zone aws_elastic_beanstalk_hosted_zone}.
...
func (j *jsiiProxy_DataAwsElasticBeanstalkHostedZone) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsElasticBeanstalkHostedZone) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsElasticBeanstalkHostedZone) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsElasticBeanstalkHostedZone) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsElasticBeanstalkHostedZone) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/data-sources/elastic_beanstalk_hosted_zone aws_elastic_beanstalk_hosted_zone} Data Source.
...
func (j *jsiiProxy_DataAwsElasticBeanstalkHostedZone)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsElasticBeanstalkHostedZone)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsElasticBeanstalkHostedZone)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsElasticBeanstalkHostedZone_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsElasticBeanstalkHostedZone) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsElasticBeanstalkHostedZone) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsElasticBeanstalkHostedZone) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsElasticBeanstalkHostedZone) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
