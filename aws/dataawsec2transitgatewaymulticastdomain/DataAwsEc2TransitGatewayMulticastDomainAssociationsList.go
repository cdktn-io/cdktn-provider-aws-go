...
func (d *jsiiProxy_DataAwsEc2TransitGatewayMulticastDomainAssociationsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsEc2TransitGatewayMulticastDomainAssociationsList) Resolve(context cdktf.IResolveContext) interface{} {
