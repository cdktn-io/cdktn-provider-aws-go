...
func (j *jsiiProxy_DataAwsEc2TransitGatewayMulticastDomainAssociationsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsEc2TransitGatewayMulticastDomainAssociationsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsEc2TransitGatewayMulticastDomainAssociationsList {
	_init_.Initialize()
...
func NewDataAwsEc2TransitGatewayMulticastDomainAssociationsList_Override(d DataAwsEc2TransitGatewayMulticastDomainAssociationsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsEc2TransitGatewayMulticastDomainAssociationsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsEc2TransitGatewayMulticastDomainAssociationsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsEc2TransitGatewayMulticastDomainAssociationsList) Resolve(context cdktn.IResolveContext) interface{} {
