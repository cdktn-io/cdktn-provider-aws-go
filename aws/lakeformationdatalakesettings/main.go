...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "readOnlyAdminsInput", GoGetter: "ReadOnlyAdminsInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetReadOnlyAdmins", GoMethod: "ResetReadOnlyAdmins"},
