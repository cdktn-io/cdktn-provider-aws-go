...
func (l *jsiiProxy_LakeformationDataLakeSettingsCreateTableDefaultPermissionsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LakeformationDataLakeSettingsCreateTableDefaultPermissionsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
