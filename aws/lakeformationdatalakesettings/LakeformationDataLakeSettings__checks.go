...
func (l *jsiiProxy_LakeformationDataLakeSettings) validatePutCreateDatabaseDefaultPermissionsParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*LakeformationDataLakeSettingsCreateDatabaseDefaultPermissions; received %#v (a %T)", value, value)
		}
	}
...
func (l *jsiiProxy_LakeformationDataLakeSettings) validatePutCreateTableDefaultPermissionsParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*LakeformationDataLakeSettingsCreateTableDefaultPermissions; received %#v (a %T)", value, value)
		}
	}
