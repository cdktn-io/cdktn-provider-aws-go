...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/route53recoveryreadinessreadinesscheck/internal"
...
func (j *jsiiProxy_Route53RecoveryreadinessReadinessCheck) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_Route53RecoveryreadinessReadinessCheck) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_Route53RecoveryreadinessReadinessCheck) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_Route53RecoveryreadinessReadinessCheck) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_Route53RecoveryreadinessReadinessCheck) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func NewRoute53RecoveryreadinessReadinessCheck(scope constructs.Construct, id *string, config *Route53RecoveryreadinessReadinessCheckConfig) Route53RecoveryreadinessReadinessCheck {
	...
	_jsii_.Create(
		"@cdktn/provider-aws.route53RecoveryreadinessReadinessCheck.Route53RecoveryreadinessReadinessCheck",
...
func (j *jsiiProxy_Route53RecoveryreadinessReadinessCheck)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_Route53RecoveryreadinessReadinessCheck)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_Route53RecoveryreadinessReadinessCheck)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func Route53RecoveryreadinessReadinessCheck_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (r *jsiiProxy_Route53RecoveryreadinessReadinessCheck) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (r *jsiiProxy_Route53RecoveryreadinessReadinessCheck) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (r *jsiiProxy_Route53RecoveryreadinessReadinessCheck) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (r *jsiiProxy_Route53RecoveryreadinessReadinessCheck) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (r *jsiiProxy_Route53RecoveryreadinessReadinessCheck) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (r *jsiiProxy_Route53RecoveryreadinessReadinessCheck) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
