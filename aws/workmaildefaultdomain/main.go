...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*WorkmailDefaultDomain)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-aws.workmailDefaultDomain.WorkmailDefaultDomainConfig",
		reflect.TypeOf((*WorkmailDefaultDomainConfig)(nil)).Elem(),
	)
}
