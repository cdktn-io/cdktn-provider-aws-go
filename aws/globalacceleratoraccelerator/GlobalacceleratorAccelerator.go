...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/globalacceleratoraccelerator/internal"
...
func (j *jsiiProxy_GlobalacceleratorAccelerator) Arn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"arn",
...
func (j *jsiiProxy_GlobalacceleratorAccelerator) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_GlobalacceleratorAccelerator) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_GlobalacceleratorAccelerator) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_GlobalacceleratorAccelerator) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_GlobalacceleratorAccelerator) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/globalaccelerator_accelerator aws_globalaccelerator_accelerator} Resource.
...
func (j *jsiiProxy_GlobalacceleratorAccelerator)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_GlobalacceleratorAccelerator)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_GlobalacceleratorAccelerator)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func GlobalacceleratorAccelerator_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (g *jsiiProxy_GlobalacceleratorAccelerator) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GlobalacceleratorAccelerator) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (g *jsiiProxy_GlobalacceleratorAccelerator) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GlobalacceleratorAccelerator) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GlobalacceleratorAccelerator) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (g *jsiiProxy_GlobalacceleratorAccelerator) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
