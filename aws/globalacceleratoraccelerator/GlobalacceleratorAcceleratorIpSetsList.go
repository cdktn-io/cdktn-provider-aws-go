...
func (j *jsiiProxy_GlobalacceleratorAcceleratorIpSetsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewGlobalacceleratorAcceleratorIpSetsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) GlobalacceleratorAcceleratorIpSetsList {
	_init_.Initialize()
...
func NewGlobalacceleratorAcceleratorIpSetsList_Override(g GlobalacceleratorAcceleratorIpSetsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_GlobalacceleratorAcceleratorIpSetsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (g *jsiiProxy_GlobalacceleratorAcceleratorIpSetsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (g *jsiiProxy_GlobalacceleratorAcceleratorIpSetsList) Resolve(context cdktn.IResolveContext) interface{} {
