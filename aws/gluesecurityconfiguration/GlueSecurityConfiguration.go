...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/gluesecurityconfiguration/internal"
...
func (j *jsiiProxy_GlueSecurityConfiguration) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_GlueSecurityConfiguration) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_GlueSecurityConfiguration) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_GlueSecurityConfiguration) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_GlueSecurityConfiguration) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/glue_security_configuration aws_glue_security_configuration} Resource.
...
func (j *jsiiProxy_GlueSecurityConfiguration)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_GlueSecurityConfiguration)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_GlueSecurityConfiguration)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func GlueSecurityConfiguration_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (g *jsiiProxy_GlueSecurityConfiguration) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GlueSecurityConfiguration) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (g *jsiiProxy_GlueSecurityConfiguration) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GlueSecurityConfiguration) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GlueSecurityConfiguration) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (g *jsiiProxy_GlueSecurityConfiguration) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
