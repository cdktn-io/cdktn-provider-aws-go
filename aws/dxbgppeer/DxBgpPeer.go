...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/dxbgppeer/internal"
...
func (j *jsiiProxy_DxBgpPeer) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DxBgpPeer) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DxBgpPeer) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DxBgpPeer) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DxBgpPeer) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DxBgpPeer) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_DxBgpPeer) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/dx_bgp_peer aws_dx_bgp_peer} Resource.
...
func (j *jsiiProxy_DxBgpPeer)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DxBgpPeer)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DxBgpPeer)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_DxBgpPeer)SetRegion(val *string) {
...
func DxBgpPeer_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DxBgpPeer) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DxBgpPeer) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (d *jsiiProxy_DxBgpPeer) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DxBgpPeer) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (d *jsiiProxy_DxBgpPeer) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DxBgpPeer) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
...
func (d *jsiiProxy_DxBgpPeer) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
