...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/ami aws_ami}.
type Ami interface {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/ami aws_ami} Resource.
...
func (a *jsiiProxy_Ami) AddMoveTarget(moveTarget *string) {
...
func (a *jsiiProxy_Ami) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (a *jsiiProxy_Ami) MoveFromId(id *string) {
...
func (a *jsiiProxy_Ami) MoveToId(id *string) {
...
func (a *jsiiProxy_Ami) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (a *jsiiProxy_Ami) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
