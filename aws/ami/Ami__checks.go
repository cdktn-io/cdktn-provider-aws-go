...
func (a *jsiiProxy_Ami) validatePutEbsBlockDeviceParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*AmiEbsBlockDevice; received %#v (a %T)", value, value)
		}
	}
...
func (a *jsiiProxy_Ami) validatePutEphemeralBlockDeviceParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*AmiEphemeralBlockDevice; received %#v (a %T)", value, value)
		}
	}
