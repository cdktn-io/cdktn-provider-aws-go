...
func (j *jsiiProxy_VerifiedpermissionsIdentitySourceConfigurationOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewVerifiedpermissionsIdentitySourceConfigurationOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) VerifiedpermissionsIdentitySourceConfigurationOutputReference {
	_init_.Initialize()
...
func NewVerifiedpermissionsIdentitySourceConfigurationOutputReference_Override(v VerifiedpermissionsIdentitySourceConfigurationOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_VerifiedpermissionsIdentitySourceConfigurationOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (v *jsiiProxy_VerifiedpermissionsIdentitySourceConfigurationOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (v *jsiiProxy_VerifiedpermissionsIdentitySourceConfigurationOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (v *jsiiProxy_VerifiedpermissionsIdentitySourceConfigurationOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (v *jsiiProxy_VerifiedpermissionsIdentitySourceConfigurationOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
