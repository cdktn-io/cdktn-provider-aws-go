...
func (j *jsiiProxy_VerifiedpermissionsIdentitySourceConfigurationCognitoUserPoolConfigurationList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewVerifiedpermissionsIdentitySourceConfigurationCognitoUserPoolConfigurationList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) VerifiedpermissionsIdentitySourceConfigurationCognitoUserPoolConfigurationList {
	_init_.Initialize()
...
func NewVerifiedpermissionsIdentitySourceConfigurationCognitoUserPoolConfigurationList_Override(v VerifiedpermissionsIdentitySourceConfigurationCognitoUserPoolConfigurationList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_VerifiedpermissionsIdentitySourceConfigurationCognitoUserPoolConfigurationList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (v *jsiiProxy_VerifiedpermissionsIdentitySourceConfigurationCognitoUserPoolConfigurationList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (v *jsiiProxy_VerifiedpermissionsIdentitySourceConfigurationCognitoUserPoolConfigurationList) Resolve(context cdktn.IResolveContext) interface{} {
