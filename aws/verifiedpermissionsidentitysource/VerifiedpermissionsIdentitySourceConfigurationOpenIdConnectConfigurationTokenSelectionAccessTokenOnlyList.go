...
func (v *jsiiProxy_VerifiedpermissionsIdentitySourceConfigurationOpenIdConnectConfigurationTokenSelectionAccessTokenOnlyList) Resolve(context cdktf.IResolveContext) interface{} {
