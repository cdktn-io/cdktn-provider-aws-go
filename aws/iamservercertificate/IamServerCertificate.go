...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/iam_server_certificate aws_iam_server_certificate}.
...
func (j *jsiiProxy_IamServerCertificate) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_IamServerCertificate) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_IamServerCertificate) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_IamServerCertificate) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_IamServerCertificate) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/iam_server_certificate aws_iam_server_certificate} Resource.
...
func (j *jsiiProxy_IamServerCertificate)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_IamServerCertificate)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_IamServerCertificate)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func IamServerCertificate_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (i *jsiiProxy_IamServerCertificate) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (i *jsiiProxy_IamServerCertificate) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (i *jsiiProxy_IamServerCertificate) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (i *jsiiProxy_IamServerCertificate) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (i *jsiiProxy_IamServerCertificate) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (i *jsiiProxy_IamServerCertificate) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
