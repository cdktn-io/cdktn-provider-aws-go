...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/cloudfrontkeygroup/internal"
...
func (j *jsiiProxy_CloudfrontKeyGroup) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_CloudfrontKeyGroup) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_CloudfrontKeyGroup) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_CloudfrontKeyGroup) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_CloudfrontKeyGroup) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func NewCloudfrontKeyGroup(scope constructs.Construct, id *string, config *CloudfrontKeyGroupConfig) CloudfrontKeyGroup {
	...
	_jsii_.Create(
		"@cdktn/provider-aws.cloudfrontKeyGroup.CloudfrontKeyGroup",
...
func (j *jsiiProxy_CloudfrontKeyGroup)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_CloudfrontKeyGroup)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_CloudfrontKeyGroup)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func CloudfrontKeyGroup_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (c *jsiiProxy_CloudfrontKeyGroup) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CloudfrontKeyGroup) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (c *jsiiProxy_CloudfrontKeyGroup) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CloudfrontKeyGroup) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_CloudfrontKeyGroup) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (c *jsiiProxy_CloudfrontKeyGroup) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
