...
func (v *jsiiProxy_VpcIpamPoolCidrCidrAuthorizationContextOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (v *jsiiProxy_VpcIpamPoolCidrCidrAuthorizationContextOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
