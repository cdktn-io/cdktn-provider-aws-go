...
func (j *jsiiProxy_VpcIpamPoolCidr) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_VpcIpamPoolCidr) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_VpcIpamPoolCidr) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_VpcIpamPoolCidr) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_VpcIpamPoolCidr) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_VpcIpamPoolCidr) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_VpcIpamPoolCidr) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_VpcIpamPoolCidr)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_VpcIpamPoolCidr)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_VpcIpamPoolCidr)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_VpcIpamPoolCidr)SetRegion(val *string) {
...
func VpcIpamPoolCidr_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (v *jsiiProxy_VpcIpamPoolCidr) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (v *jsiiProxy_VpcIpamPoolCidr) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (v *jsiiProxy_VpcIpamPoolCidr) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (v *jsiiProxy_VpcIpamPoolCidr) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (v *jsiiProxy_VpcIpamPoolCidr) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (v *jsiiProxy_VpcIpamPoolCidr) ResetRegion() {
	_jsii_.InvokeVoid(
		v,
		"resetRegion",
		nil, // no parameters
...
func (v *jsiiProxy_VpcIpamPoolCidr) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
