...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/networkmanager_connect_peer aws_networkmanager_connect_peer}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/networkmanager_connect_peer aws_networkmanager_connect_peer} Resource.
...
func (n *jsiiProxy_NetworkmanagerConnectPeer) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (n *jsiiProxy_NetworkmanagerConnectPeer) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (n *jsiiProxy_NetworkmanagerConnectPeer) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
