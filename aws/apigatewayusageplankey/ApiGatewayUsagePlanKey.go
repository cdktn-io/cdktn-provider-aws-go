...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/apigatewayusageplankey/internal"
...
func (j *jsiiProxy_ApiGatewayUsagePlanKey) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_ApiGatewayUsagePlanKey) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_ApiGatewayUsagePlanKey) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_ApiGatewayUsagePlanKey) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_ApiGatewayUsagePlanKey) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_ApiGatewayUsagePlanKey) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_ApiGatewayUsagePlanKey) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/api_gateway_usage_plan_key aws_api_gateway_usage_plan_key} Resource.
...
func (j *jsiiProxy_ApiGatewayUsagePlanKey)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_ApiGatewayUsagePlanKey)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_ApiGatewayUsagePlanKey)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_ApiGatewayUsagePlanKey)SetRegion(val *string) {
...
func ApiGatewayUsagePlanKey_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (a *jsiiProxy_ApiGatewayUsagePlanKey) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_ApiGatewayUsagePlanKey) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (a *jsiiProxy_ApiGatewayUsagePlanKey) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_ApiGatewayUsagePlanKey) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (a *jsiiProxy_ApiGatewayUsagePlanKey) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (a *jsiiProxy_ApiGatewayUsagePlanKey) ResetRegion() {
	_jsii_.InvokeVoid(
		a,
		"resetRegion",
		nil, // no parameters
...
func (a *jsiiProxy_ApiGatewayUsagePlanKey) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
