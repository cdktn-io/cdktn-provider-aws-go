...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v21/inspectorassessmenttemplate/internal"
...
func (i *jsiiProxy_InspectorAssessmentTemplateEventSubscriptionOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (i *jsiiProxy_InspectorAssessmentTemplateEventSubscriptionOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
