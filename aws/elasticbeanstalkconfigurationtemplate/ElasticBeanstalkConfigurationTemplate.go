...
func (j *jsiiProxy_ElasticBeanstalkConfigurationTemplate) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_ElasticBeanstalkConfigurationTemplate) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_ElasticBeanstalkConfigurationTemplate) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_ElasticBeanstalkConfigurationTemplate) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_ElasticBeanstalkConfigurationTemplate) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/elastic_beanstalk_configuration_template aws_elastic_beanstalk_configuration_template} Resource.
...
func (j *jsiiProxy_ElasticBeanstalkConfigurationTemplate)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_ElasticBeanstalkConfigurationTemplate)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_ElasticBeanstalkConfigurationTemplate)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func ElasticBeanstalkConfigurationTemplate_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (e *jsiiProxy_ElasticBeanstalkConfigurationTemplate) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (e *jsiiProxy_ElasticBeanstalkConfigurationTemplate) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (e *jsiiProxy_ElasticBeanstalkConfigurationTemplate) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (e *jsiiProxy_ElasticBeanstalkConfigurationTemplate) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (e *jsiiProxy_ElasticBeanstalkConfigurationTemplate) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (e *jsiiProxy_ElasticBeanstalkConfigurationTemplate) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
