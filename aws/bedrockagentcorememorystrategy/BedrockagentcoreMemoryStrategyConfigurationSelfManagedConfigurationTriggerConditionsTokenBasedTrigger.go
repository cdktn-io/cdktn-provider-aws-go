...
type BedrockagentcoreMemoryStrategyConfigurationSelfManagedConfigurationTriggerConditionsTokenBasedTrigger struct {
	...
	TokenCount *float64 `field:"required" json:"tokenCount" yaml:"tokenCount"`
}
