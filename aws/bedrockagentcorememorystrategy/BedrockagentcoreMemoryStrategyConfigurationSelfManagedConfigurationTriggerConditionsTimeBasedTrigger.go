...
type BedrockagentcoreMemoryStrategyConfigurationSelfManagedConfigurationTriggerConditionsTimeBasedTrigger struct {
	...
	IdleSessionTimeout *float64 `field:"required" json:"idleSessionTimeout" yaml:"idleSessionTimeout"`
}
