...
func (j *jsiiProxy_DataAwsOrganizationsDelegatedServices) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsOrganizationsDelegatedServices) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsOrganizationsDelegatedServices) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsOrganizationsDelegatedServices) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsOrganizationsDelegatedServices) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/data-sources/organizations_delegated_services aws_organizations_delegated_services} Data Source.
...
func (j *jsiiProxy_DataAwsOrganizationsDelegatedServices)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsOrganizationsDelegatedServices)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsOrganizationsDelegatedServices)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsOrganizationsDelegatedServices_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsOrganizationsDelegatedServices) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsOrganizationsDelegatedServices) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsOrganizationsDelegatedServices) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsOrganizationsDelegatedServices) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
