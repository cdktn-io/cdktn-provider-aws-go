...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v22/s3controlmultiregionaccesspoint/internal"
...
func (s *jsiiProxy_S3ControlMultiRegionAccessPointDetailsPublicAccessBlockOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_S3ControlMultiRegionAccessPointDetailsPublicAccessBlockOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
