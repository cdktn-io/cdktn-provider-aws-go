...
func (j *jsiiProxy_RdsReservedInstanceRecurringChargesList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewRdsReservedInstanceRecurringChargesList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) RdsReservedInstanceRecurringChargesList {
	_init_.Initialize()
...
func NewRdsReservedInstanceRecurringChargesList_Override(r RdsReservedInstanceRecurringChargesList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_RdsReservedInstanceRecurringChargesList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (r *jsiiProxy_RdsReservedInstanceRecurringChargesList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (r *jsiiProxy_RdsReservedInstanceRecurringChargesList) Resolve(context cdktn.IResolveContext) interface{} {
