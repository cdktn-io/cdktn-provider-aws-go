...
func (d *jsiiProxy_DataAwsLaunchTemplateNetworkInterfacesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataAwsLaunchTemplateNetworkInterfacesOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
