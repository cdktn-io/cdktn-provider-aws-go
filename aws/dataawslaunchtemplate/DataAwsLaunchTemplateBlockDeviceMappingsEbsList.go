...
func (d *jsiiProxy_DataAwsLaunchTemplateBlockDeviceMappingsEbsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsLaunchTemplateBlockDeviceMappingsEbsList) Resolve(context cdktf.IResolveContext) interface{} {
