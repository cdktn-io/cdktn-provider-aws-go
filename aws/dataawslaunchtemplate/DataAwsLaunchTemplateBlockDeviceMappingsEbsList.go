...
func (j *jsiiProxy_DataAwsLaunchTemplateBlockDeviceMappingsEbsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsLaunchTemplateBlockDeviceMappingsEbsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsLaunchTemplateBlockDeviceMappingsEbsList {
	_init_.Initialize()
...
func NewDataAwsLaunchTemplateBlockDeviceMappingsEbsList_Override(d DataAwsLaunchTemplateBlockDeviceMappingsEbsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsLaunchTemplateBlockDeviceMappingsEbsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsLaunchTemplateBlockDeviceMappingsEbsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsLaunchTemplateBlockDeviceMappingsEbsList) Resolve(context cdktn.IResolveContext) interface{} {
