...
func (j *jsiiProxy_DataAwsLaunchTemplateCapacityReservationSpecificationList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsLaunchTemplateCapacityReservationSpecificationList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsLaunchTemplateCapacityReservationSpecificationList {
	_init_.Initialize()
...
func NewDataAwsLaunchTemplateCapacityReservationSpecificationList_Override(d DataAwsLaunchTemplateCapacityReservationSpecificationList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsLaunchTemplateCapacityReservationSpecificationList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsLaunchTemplateCapacityReservationSpecificationList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsLaunchTemplateCapacityReservationSpecificationList) Resolve(context cdktn.IResolveContext) interface{} {
