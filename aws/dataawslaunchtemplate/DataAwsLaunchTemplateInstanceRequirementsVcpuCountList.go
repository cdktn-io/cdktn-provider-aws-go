...
func (j *jsiiProxy_DataAwsLaunchTemplateInstanceRequirementsVcpuCountList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsLaunchTemplateInstanceRequirementsVcpuCountList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsLaunchTemplateInstanceRequirementsVcpuCountList {
	_init_.Initialize()
...
func NewDataAwsLaunchTemplateInstanceRequirementsVcpuCountList_Override(d DataAwsLaunchTemplateInstanceRequirementsVcpuCountList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsLaunchTemplateInstanceRequirementsVcpuCountList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsLaunchTemplateInstanceRequirementsVcpuCountList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsLaunchTemplateInstanceRequirementsVcpuCountList) Resolve(context cdktn.IResolveContext) interface{} {
