...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.52.0/docs/data-sources/launch_template aws_launch_template}.
...
func (j *jsiiProxy_DataAwsLaunchTemplate) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsLaunchTemplate) DisableApiStop() cdktn.IResolvable {
...
func (j *jsiiProxy_DataAwsLaunchTemplate) DisableApiTermination() cdktn.IResolvable {
	var returns cdktn.IResolvable
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataAwsLaunchTemplate) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsLaunchTemplate) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsLaunchTemplate) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsLaunchTemplate) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.52.0/docs/data-sources/launch_template aws_launch_template} Data Source.
...
func (j *jsiiProxy_DataAwsLaunchTemplate)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsLaunchTemplate)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsLaunchTemplate)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsLaunchTemplate_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsLaunchTemplate) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsLaunchTemplate) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsLaunchTemplate) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
