...
func (i *jsiiProxy_InternetmonitorMonitorHealthEventsConfigOutputReference) validateResolveParameters(context cdktf.IResolveContext) error {
	if context == nil {
...
func (j *jsiiProxy_InternetmonitorMonitorHealthEventsConfigOutputReference) validateSetInternalValueParameters(val *InternetmonitorMonitorHealthEventsConfig) error {
...
func (j *jsiiProxy_InternetmonitorMonitorHealthEventsConfigOutputReference) validateSetTerraformResourceParameters(val cdktf.IInterpolatingParent) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func validateNewInternetmonitorMonitorHealthEventsConfigOutputReferenceParameters(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) error {
