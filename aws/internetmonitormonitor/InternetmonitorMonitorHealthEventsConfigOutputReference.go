...
type InternetmonitorMonitorHealthEventsConfigOutputReference interface {
	...
	// Experimental.
	Fqn() *string
	InternalValue() *InternetmonitorMonitorHealthEventsConfig
	SetInternalValue(val *InternetmonitorMonitorHealthEventsConfig)
...
func (j *jsiiProxy_InternetmonitorMonitorHealthEventsConfigOutputReference) InternalValue() *InternetmonitorMonitorHealthEventsConfig {
...
func (j *jsiiProxy_InternetmonitorMonitorHealthEventsConfigOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewInternetmonitorMonitorHealthEventsConfigOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) InternetmonitorMonitorHealthEventsConfigOutputReference {
	_init_.Initialize()
...
func NewInternetmonitorMonitorHealthEventsConfigOutputReference_Override(i InternetmonitorMonitorHealthEventsConfigOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_InternetmonitorMonitorHealthEventsConfigOutputReference)SetInternalValue(val *InternetmonitorMonitorHealthEventsConfig) {
...
func (j *jsiiProxy_InternetmonitorMonitorHealthEventsConfigOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (i *jsiiProxy_InternetmonitorMonitorHealthEventsConfigOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (i *jsiiProxy_InternetmonitorMonitorHealthEventsConfigOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (i *jsiiProxy_InternetmonitorMonitorHealthEventsConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (i *jsiiProxy_InternetmonitorMonitorHealthEventsConfigOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
