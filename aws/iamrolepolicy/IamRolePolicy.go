...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/iamrolepolicy/internal"
...
func (j *jsiiProxy_IamRolePolicy) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_IamRolePolicy) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_IamRolePolicy) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_IamRolePolicy) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_IamRolePolicy) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/iam_role_policy aws_iam_role_policy} Resource.
func NewIamRolePolicy(scope constructs.Construct, id *string, config *IamRolePolicyConfig) IamRolePolicy {
	...
	_jsii_.Create(
		"@cdktn/provider-aws.iamRolePolicy.IamRolePolicy",
...
func (j *jsiiProxy_IamRolePolicy)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_IamRolePolicy)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_IamRolePolicy)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func IamRolePolicy_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (i *jsiiProxy_IamRolePolicy) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (i *jsiiProxy_IamRolePolicy) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (i *jsiiProxy_IamRolePolicy) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (i *jsiiProxy_IamRolePolicy) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (i *jsiiProxy_IamRolePolicy) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (i *jsiiProxy_IamRolePolicy) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
