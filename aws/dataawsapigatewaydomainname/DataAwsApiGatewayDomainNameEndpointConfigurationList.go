...
func (j *jsiiProxy_DataAwsApiGatewayDomainNameEndpointConfigurationList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsApiGatewayDomainNameEndpointConfigurationList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsApiGatewayDomainNameEndpointConfigurationList {
	_init_.Initialize()
...
func NewDataAwsApiGatewayDomainNameEndpointConfigurationList_Override(d DataAwsApiGatewayDomainNameEndpointConfigurationList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsApiGatewayDomainNameEndpointConfigurationList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsApiGatewayDomainNameEndpointConfigurationList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsApiGatewayDomainNameEndpointConfigurationList) Resolve(context cdktn.IResolveContext) interface{} {
