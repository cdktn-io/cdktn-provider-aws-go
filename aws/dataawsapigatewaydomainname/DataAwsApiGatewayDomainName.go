...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/dataawsapigatewaydomainname/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/data-sources/api_gateway_domain_name aws_api_gateway_domain_name}.
...
func (j *jsiiProxy_DataAwsApiGatewayDomainName) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsApiGatewayDomainName) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsApiGatewayDomainName) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsApiGatewayDomainName) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsApiGatewayDomainName) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DataAwsApiGatewayDomainName) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_DataAwsApiGatewayDomainName) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/data-sources/api_gateway_domain_name aws_api_gateway_domain_name} Data Source.
func NewDataAwsApiGatewayDomainName(scope constructs.Construct, id *string, config *DataAwsApiGatewayDomainNameConfig) DataAwsApiGatewayDomainName {
	...
	if err := validateNewDataAwsApiGatewayDomainNameParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_DataAwsApiGatewayDomainName)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsApiGatewayDomainName)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsApiGatewayDomainName)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_DataAwsApiGatewayDomainName)SetRegion(val *string) {
...
func DataAwsApiGatewayDomainName_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateDataAwsApiGatewayDomainName_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataAwsApiGatewayDomainName) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsApiGatewayDomainName) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsApiGatewayDomainName) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsApiGatewayDomainName) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsApiGatewayDomainName) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
