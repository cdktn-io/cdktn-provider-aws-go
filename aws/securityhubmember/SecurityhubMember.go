...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/securityhubmember/internal"
...
func (j *jsiiProxy_SecurityhubMember) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_SecurityhubMember) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_SecurityhubMember) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_SecurityhubMember) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_SecurityhubMember) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/securityhub_member aws_securityhub_member} Resource.
...
func (j *jsiiProxy_SecurityhubMember)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_SecurityhubMember)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_SecurityhubMember)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func SecurityhubMember_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (s *jsiiProxy_SecurityhubMember) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SecurityhubMember) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_SecurityhubMember) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SecurityhubMember) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_SecurityhubMember) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_SecurityhubMember) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
