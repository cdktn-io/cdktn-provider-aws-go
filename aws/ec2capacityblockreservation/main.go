...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "capacityBlockOfferingIdInput", GoGetter: "CapacityBlockOfferingIdInput"},
	...
	_jsii_.RegisterClass(
		...
		func() interface{} {
			j := jsiiProxy_Ec2CapacityBlockReservationTimeoutsOutputReference{}
