...
func (j *jsiiProxy_NetworkfirewallTlsInspectionConfigurationTlsInspectionConfigurationList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewNetworkfirewallTlsInspectionConfigurationTlsInspectionConfigurationList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) NetworkfirewallTlsInspectionConfigurationTlsInspectionConfigurationList {
	_init_.Initialize()
...
func NewNetworkfirewallTlsInspectionConfigurationTlsInspectionConfigurationList_Override(n NetworkfirewallTlsInspectionConfigurationTlsInspectionConfigurationList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_NetworkfirewallTlsInspectionConfigurationTlsInspectionConfigurationList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (n *jsiiProxy_NetworkfirewallTlsInspectionConfigurationTlsInspectionConfigurationList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (n *jsiiProxy_NetworkfirewallTlsInspectionConfigurationTlsInspectionConfigurationList) Resolve(context cdktn.IResolveContext) interface{} {
