...
func (j *jsiiProxy_NetworkfirewallTlsInspectionConfiguration) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_NetworkfirewallTlsInspectionConfiguration) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_NetworkfirewallTlsInspectionConfiguration) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_NetworkfirewallTlsInspectionConfiguration) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_NetworkfirewallTlsInspectionConfiguration) TagsAll() cdktn.StringMap {
...
func (j *jsiiProxy_NetworkfirewallTlsInspectionConfiguration) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/networkfirewall_tls_inspection_configuration aws_networkfirewall_tls_inspection_configuration} Resource.
...
func (j *jsiiProxy_NetworkfirewallTlsInspectionConfiguration)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_NetworkfirewallTlsInspectionConfiguration)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_NetworkfirewallTlsInspectionConfiguration)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func NetworkfirewallTlsInspectionConfiguration_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (n *jsiiProxy_NetworkfirewallTlsInspectionConfiguration) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (n *jsiiProxy_NetworkfirewallTlsInspectionConfiguration) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (n *jsiiProxy_NetworkfirewallTlsInspectionConfiguration) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (n *jsiiProxy_NetworkfirewallTlsInspectionConfiguration) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (n *jsiiProxy_NetworkfirewallTlsInspectionConfiguration) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
