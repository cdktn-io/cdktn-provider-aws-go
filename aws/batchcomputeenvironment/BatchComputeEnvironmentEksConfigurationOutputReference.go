...
func (j *jsiiProxy_BatchComputeEnvironmentEksConfigurationOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewBatchComputeEnvironmentEksConfigurationOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) BatchComputeEnvironmentEksConfigurationOutputReference {
	_init_.Initialize()
...
func NewBatchComputeEnvironmentEksConfigurationOutputReference_Override(b BatchComputeEnvironmentEksConfigurationOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_BatchComputeEnvironmentEksConfigurationOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (b *jsiiProxy_BatchComputeEnvironmentEksConfigurationOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (b *jsiiProxy_BatchComputeEnvironmentEksConfigurationOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (b *jsiiProxy_BatchComputeEnvironmentEksConfigurationOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (b *jsiiProxy_BatchComputeEnvironmentEksConfigurationOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
