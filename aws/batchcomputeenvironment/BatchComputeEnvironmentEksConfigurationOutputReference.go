...
func (b *jsiiProxy_BatchComputeEnvironmentEksConfigurationOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (b *jsiiProxy_BatchComputeEnvironmentEksConfigurationOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
