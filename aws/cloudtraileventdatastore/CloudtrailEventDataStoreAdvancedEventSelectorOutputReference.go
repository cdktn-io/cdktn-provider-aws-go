...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/cloudtraileventdatastore/internal"
...
func (j *jsiiProxy_CloudtrailEventDataStoreAdvancedEventSelectorOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewCloudtrailEventDataStoreAdvancedEventSelectorOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) CloudtrailEventDataStoreAdvancedEventSelectorOutputReference {
	_init_.Initialize()

	if err := validateNewCloudtrailEventDataStoreAdvancedEventSelectorOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func NewCloudtrailEventDataStoreAdvancedEventSelectorOutputReference_Override(c CloudtrailEventDataStoreAdvancedEventSelectorOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_CloudtrailEventDataStoreAdvancedEventSelectorOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_CloudtrailEventDataStoreAdvancedEventSelectorOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CloudtrailEventDataStoreAdvancedEventSelectorOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (c *jsiiProxy_CloudtrailEventDataStoreAdvancedEventSelectorOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CloudtrailEventDataStoreAdvancedEventSelectorOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
