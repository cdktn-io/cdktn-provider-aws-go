...
func (j *jsiiProxy_CloudtrailEventDataStore) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_CloudtrailEventDataStore) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_CloudtrailEventDataStore)SetRegion(val *string) {
...
func (c *jsiiProxy_CloudtrailEventDataStore) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_CloudtrailEventDataStore) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (c *jsiiProxy_CloudtrailEventDataStore) ResetRegion() {
	_jsii_.InvokeVoid(
		c,
		"resetRegion",
		nil, // no parameters
...
func (c *jsiiProxy_CloudtrailEventDataStore) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
