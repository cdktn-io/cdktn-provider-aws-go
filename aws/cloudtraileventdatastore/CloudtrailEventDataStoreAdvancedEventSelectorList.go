...
func (j *jsiiProxy_CloudtrailEventDataStoreAdvancedEventSelectorList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewCloudtrailEventDataStoreAdvancedEventSelectorList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) CloudtrailEventDataStoreAdvancedEventSelectorList {
	_init_.Initialize()
...
func NewCloudtrailEventDataStoreAdvancedEventSelectorList_Override(c CloudtrailEventDataStoreAdvancedEventSelectorList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_CloudtrailEventDataStoreAdvancedEventSelectorList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_CloudtrailEventDataStoreAdvancedEventSelectorList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (c *jsiiProxy_CloudtrailEventDataStoreAdvancedEventSelectorList) Resolve(context cdktn.IResolveContext) interface{} {
