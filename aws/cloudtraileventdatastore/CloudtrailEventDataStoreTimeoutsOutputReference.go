...
func (c *jsiiProxy_CloudtrailEventDataStoreTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CloudtrailEventDataStoreTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
