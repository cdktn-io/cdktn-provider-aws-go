...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v22/fsxontapstoragevirtualmachine/internal"
...
func (f *jsiiProxy_FsxOntapStorageVirtualMachineEndpointsIscsiList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (f *jsiiProxy_FsxOntapStorageVirtualMachineEndpointsIscsiList) Resolve(context cdktf.IResolveContext) interface{} {
