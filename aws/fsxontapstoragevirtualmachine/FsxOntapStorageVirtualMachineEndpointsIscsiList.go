...
func (j *jsiiProxy_FsxOntapStorageVirtualMachineEndpointsIscsiList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewFsxOntapStorageVirtualMachineEndpointsIscsiList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) FsxOntapStorageVirtualMachineEndpointsIscsiList {
	_init_.Initialize()

	if err := validateNewFsxOntapStorageVirtualMachineEndpointsIscsiListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewFsxOntapStorageVirtualMachineEndpointsIscsiList_Override(f FsxOntapStorageVirtualMachineEndpointsIscsiList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_FsxOntapStorageVirtualMachineEndpointsIscsiList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (f *jsiiProxy_FsxOntapStorageVirtualMachineEndpointsIscsiList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (f *jsiiProxy_FsxOntapStorageVirtualMachineEndpointsIscsiList) Resolve(context cdktn.IResolveContext) interface{} {
