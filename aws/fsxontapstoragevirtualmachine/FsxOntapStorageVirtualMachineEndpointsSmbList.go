...
func (j *jsiiProxy_FsxOntapStorageVirtualMachineEndpointsSmbList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewFsxOntapStorageVirtualMachineEndpointsSmbList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) FsxOntapStorageVirtualMachineEndpointsSmbList {
	_init_.Initialize()
...
func NewFsxOntapStorageVirtualMachineEndpointsSmbList_Override(f FsxOntapStorageVirtualMachineEndpointsSmbList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_FsxOntapStorageVirtualMachineEndpointsSmbList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (f *jsiiProxy_FsxOntapStorageVirtualMachineEndpointsSmbList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (f *jsiiProxy_FsxOntapStorageVirtualMachineEndpointsSmbList) Resolve(context cdktn.IResolveContext) interface{} {
