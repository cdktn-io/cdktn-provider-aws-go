...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/fsxontapstoragevirtualmachine/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/fsx_ontap_storage_virtual_machine aws_fsx_ontap_storage_virtual_machine}.
...
func (j *jsiiProxy_FsxOntapStorageVirtualMachine) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_FsxOntapStorageVirtualMachine) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_FsxOntapStorageVirtualMachine) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_FsxOntapStorageVirtualMachine) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_FsxOntapStorageVirtualMachine) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/fsx_ontap_storage_virtual_machine aws_fsx_ontap_storage_virtual_machine} Resource.
...
func (j *jsiiProxy_FsxOntapStorageVirtualMachine)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_FsxOntapStorageVirtualMachine)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_FsxOntapStorageVirtualMachine)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func FsxOntapStorageVirtualMachine_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (f *jsiiProxy_FsxOntapStorageVirtualMachine) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (f *jsiiProxy_FsxOntapStorageVirtualMachine) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (f *jsiiProxy_FsxOntapStorageVirtualMachine) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (f *jsiiProxy_FsxOntapStorageVirtualMachine) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (f *jsiiProxy_FsxOntapStorageVirtualMachine) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (f *jsiiProxy_FsxOntapStorageVirtualMachine) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
