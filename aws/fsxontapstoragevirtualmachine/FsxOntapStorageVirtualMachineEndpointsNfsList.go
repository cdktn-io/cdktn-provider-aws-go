...
func (j *jsiiProxy_FsxOntapStorageVirtualMachineEndpointsNfsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewFsxOntapStorageVirtualMachineEndpointsNfsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) FsxOntapStorageVirtualMachineEndpointsNfsList {
	_init_.Initialize()
...
func NewFsxOntapStorageVirtualMachineEndpointsNfsList_Override(f FsxOntapStorageVirtualMachineEndpointsNfsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_FsxOntapStorageVirtualMachineEndpointsNfsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (f *jsiiProxy_FsxOntapStorageVirtualMachineEndpointsNfsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (f *jsiiProxy_FsxOntapStorageVirtualMachineEndpointsNfsList) Resolve(context cdktn.IResolveContext) interface{} {
