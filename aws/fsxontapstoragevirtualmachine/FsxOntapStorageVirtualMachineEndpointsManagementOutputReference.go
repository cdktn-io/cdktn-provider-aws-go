...
func (j *jsiiProxy_FsxOntapStorageVirtualMachineEndpointsManagementOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewFsxOntapStorageVirtualMachineEndpointsManagementOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) FsxOntapStorageVirtualMachineEndpointsManagementOutputReference {
	_init_.Initialize()
...
func NewFsxOntapStorageVirtualMachineEndpointsManagementOutputReference_Override(f FsxOntapStorageVirtualMachineEndpointsManagementOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_FsxOntapStorageVirtualMachineEndpointsManagementOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (f *jsiiProxy_FsxOntapStorageVirtualMachineEndpointsManagementOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (f *jsiiProxy_FsxOntapStorageVirtualMachineEndpointsManagementOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (f *jsiiProxy_FsxOntapStorageVirtualMachineEndpointsManagementOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (f *jsiiProxy_FsxOntapStorageVirtualMachineEndpointsManagementOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
