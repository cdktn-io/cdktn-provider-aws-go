...
func (j *jsiiProxy_DataAwsBackupReportPlanReportDeliveryChannelList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsBackupReportPlanReportDeliveryChannelList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsBackupReportPlanReportDeliveryChannelList {
	_init_.Initialize()
...
func NewDataAwsBackupReportPlanReportDeliveryChannelList_Override(d DataAwsBackupReportPlanReportDeliveryChannelList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsBackupReportPlanReportDeliveryChannelList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsBackupReportPlanReportDeliveryChannelList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsBackupReportPlanReportDeliveryChannelList) Resolve(context cdktn.IResolveContext) interface{} {
