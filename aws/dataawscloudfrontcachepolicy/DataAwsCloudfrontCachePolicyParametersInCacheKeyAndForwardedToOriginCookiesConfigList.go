...
func (d *jsiiProxy_DataAwsCloudfrontCachePolicyParametersInCacheKeyAndForwardedToOriginCookiesConfigList) Resolve(context cdktf.IResolveContext) interface{} {
