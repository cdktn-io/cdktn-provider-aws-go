...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/data-sources/cloudfront_cache_policy aws_cloudfront_cache_policy}.
...
func (j *jsiiProxy_DataAwsCloudfrontCachePolicy) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsCloudfrontCachePolicy) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsCloudfrontCachePolicy) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsCloudfrontCachePolicy) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsCloudfrontCachePolicy) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/data-sources/cloudfront_cache_policy aws_cloudfront_cache_policy} Data Source.
...
func (j *jsiiProxy_DataAwsCloudfrontCachePolicy)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsCloudfrontCachePolicy)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsCloudfrontCachePolicy)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
// Generates CDKTN code for importing a DataAwsCloudfrontCachePolicy resource upon running "cdktn plan <stack-name>".
func DataAwsCloudfrontCachePolicy_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsCloudfrontCachePolicy) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsCloudfrontCachePolicy) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsCloudfrontCachePolicy) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
