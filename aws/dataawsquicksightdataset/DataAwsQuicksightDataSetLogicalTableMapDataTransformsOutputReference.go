...
func (d *jsiiProxy_DataAwsQuicksightDataSetLogicalTableMapDataTransformsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataAwsQuicksightDataSetLogicalTableMapDataTransformsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
