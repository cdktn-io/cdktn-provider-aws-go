...
func (d *jsiiProxy_DataAwsQuicksightDataSetLogicalTableMapDataTransformsTagColumnOperationTagsColumnDescriptionList) validateResolveParameters(context cdktf.IResolveContext) error {
	if context == nil {
