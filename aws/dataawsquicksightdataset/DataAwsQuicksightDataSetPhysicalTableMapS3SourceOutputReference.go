...
func (d *jsiiProxy_DataAwsQuicksightDataSetPhysicalTableMapS3SourceOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataAwsQuicksightDataSetPhysicalTableMapS3SourceOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
