...
func (d *jsiiProxy_DataAwsQuicksightDataSetPhysicalTableMapCustomSqlList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsQuicksightDataSetPhysicalTableMapCustomSqlList) Resolve(context cdktf.IResolveContext) interface{} {
