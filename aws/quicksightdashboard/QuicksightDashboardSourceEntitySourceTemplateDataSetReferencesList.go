...
func (j *jsiiProxy_QuicksightDashboardSourceEntitySourceTemplateDataSetReferencesList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewQuicksightDashboardSourceEntitySourceTemplateDataSetReferencesList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) QuicksightDashboardSourceEntitySourceTemplateDataSetReferencesList {
	_init_.Initialize()
...
func NewQuicksightDashboardSourceEntitySourceTemplateDataSetReferencesList_Override(q QuicksightDashboardSourceEntitySourceTemplateDataSetReferencesList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_QuicksightDashboardSourceEntitySourceTemplateDataSetReferencesList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (q *jsiiProxy_QuicksightDashboardSourceEntitySourceTemplateDataSetReferencesList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (q *jsiiProxy_QuicksightDashboardSourceEntitySourceTemplateDataSetReferencesList) Resolve(context cdktn.IResolveContext) interface{} {
