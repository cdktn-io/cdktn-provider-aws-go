...
func (q *jsiiProxy_QuicksightDashboardDashboardPublishOptionsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (q *jsiiProxy_QuicksightDashboardDashboardPublishOptionsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
