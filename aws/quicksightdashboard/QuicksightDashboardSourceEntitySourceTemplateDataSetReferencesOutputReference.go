...
func (q *jsiiProxy_QuicksightDashboardSourceEntitySourceTemplateDataSetReferencesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (q *jsiiProxy_QuicksightDashboardSourceEntitySourceTemplateDataSetReferencesOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
