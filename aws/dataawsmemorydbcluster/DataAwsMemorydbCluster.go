...
func (j *jsiiProxy_DataAwsMemorydbCluster) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DataAwsMemorydbCluster) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/data-sources/memorydb_cluster aws_memorydb_cluster} Data Source.
...
func (j *jsiiProxy_DataAwsMemorydbCluster)SetRegion(val *string) {
...
func (d *jsiiProxy_DataAwsMemorydbCluster) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsMemorydbCluster) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
