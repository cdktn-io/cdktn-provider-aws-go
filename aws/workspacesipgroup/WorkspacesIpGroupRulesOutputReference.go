...
func (j *jsiiProxy_WorkspacesIpGroupRulesOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewWorkspacesIpGroupRulesOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) WorkspacesIpGroupRulesOutputReference {
	_init_.Initialize()
...
func NewWorkspacesIpGroupRulesOutputReference_Override(w WorkspacesIpGroupRulesOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_WorkspacesIpGroupRulesOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (w *jsiiProxy_WorkspacesIpGroupRulesOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_WorkspacesIpGroupRulesOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (w *jsiiProxy_WorkspacesIpGroupRulesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_WorkspacesIpGroupRulesOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
