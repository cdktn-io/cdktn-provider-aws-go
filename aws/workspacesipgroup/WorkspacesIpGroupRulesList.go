...
func (j *jsiiProxy_WorkspacesIpGroupRulesList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewWorkspacesIpGroupRulesList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) WorkspacesIpGroupRulesList {
	_init_.Initialize()
...
func NewWorkspacesIpGroupRulesList_Override(w WorkspacesIpGroupRulesList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_WorkspacesIpGroupRulesList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (w *jsiiProxy_WorkspacesIpGroupRulesList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (w *jsiiProxy_WorkspacesIpGroupRulesList) Resolve(context cdktn.IResolveContext) interface{} {
