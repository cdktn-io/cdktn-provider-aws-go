...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/snstopic/internal"
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/sns_topic aws_sns_topic} Resource.
...
func (s *jsiiProxy_SnsTopic) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_SnsTopic) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_SnsTopic) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
