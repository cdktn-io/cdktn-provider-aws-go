...
func (j *jsiiProxy_AuditmanagerAssessment) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_AuditmanagerAssessment) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_AuditmanagerAssessment) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_AuditmanagerAssessment) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_AuditmanagerAssessment) TagsAll() cdktn.StringMap {
...
func (j *jsiiProxy_AuditmanagerAssessment) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/auditmanager_assessment aws_auditmanager_assessment} Resource.
...
func (j *jsiiProxy_AuditmanagerAssessment)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_AuditmanagerAssessment)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_AuditmanagerAssessment)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func AuditmanagerAssessment_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (a *jsiiProxy_AuditmanagerAssessment) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AuditmanagerAssessment) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (a *jsiiProxy_AuditmanagerAssessment) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AuditmanagerAssessment) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (a *jsiiProxy_AuditmanagerAssessment) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (a *jsiiProxy_AuditmanagerAssessment) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
