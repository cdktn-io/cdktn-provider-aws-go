...
func (j *jsiiProxy_AuditmanagerAssessmentRolesAllList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewAuditmanagerAssessmentRolesAllList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) AuditmanagerAssessmentRolesAllList {
	_init_.Initialize()
...
func NewAuditmanagerAssessmentRolesAllList_Override(a AuditmanagerAssessmentRolesAllList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_AuditmanagerAssessmentRolesAllList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (a *jsiiProxy_AuditmanagerAssessmentRolesAllList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (a *jsiiProxy_AuditmanagerAssessmentRolesAllList) Resolve(context cdktn.IResolveContext) interface{} {
