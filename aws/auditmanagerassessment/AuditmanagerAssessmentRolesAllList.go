...
func (a *jsiiProxy_AuditmanagerAssessmentRolesAllList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (a *jsiiProxy_AuditmanagerAssessmentRolesAllList) Resolve(context cdktf.IResolveContext) interface{} {
