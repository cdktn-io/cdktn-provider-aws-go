...
func (j *jsiiProxy_AuditmanagerAssessmentAssessmentReportsDestinationList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewAuditmanagerAssessmentAssessmentReportsDestinationList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) AuditmanagerAssessmentAssessmentReportsDestinationList {
	_init_.Initialize()
...
func NewAuditmanagerAssessmentAssessmentReportsDestinationList_Override(a AuditmanagerAssessmentAssessmentReportsDestinationList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_AuditmanagerAssessmentAssessmentReportsDestinationList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (a *jsiiProxy_AuditmanagerAssessmentAssessmentReportsDestinationList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (a *jsiiProxy_AuditmanagerAssessmentAssessmentReportsDestinationList) Resolve(context cdktn.IResolveContext) interface{} {
