...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/dataawsacmpcacertificate/internal"
...
func (j *jsiiProxy_DataAwsAcmpcaCertificate) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsAcmpcaCertificate) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsAcmpcaCertificate) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsAcmpcaCertificate) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsAcmpcaCertificate) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/data-sources/acmpca_certificate aws_acmpca_certificate} Data Source.
...
func (j *jsiiProxy_DataAwsAcmpcaCertificate)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsAcmpcaCertificate)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsAcmpcaCertificate)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsAcmpcaCertificate_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsAcmpcaCertificate) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsAcmpcaCertificate) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsAcmpcaCertificate) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsAcmpcaCertificate) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
