...
func (j *jsiiProxy_DataAwsCognitoUserPoolClientAnalyticsConfigurationList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsCognitoUserPoolClientAnalyticsConfigurationList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsCognitoUserPoolClientAnalyticsConfigurationList {
	_init_.Initialize()
...
func NewDataAwsCognitoUserPoolClientAnalyticsConfigurationList_Override(d DataAwsCognitoUserPoolClientAnalyticsConfigurationList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsCognitoUserPoolClientAnalyticsConfigurationList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsCognitoUserPoolClientAnalyticsConfigurationList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsCognitoUserPoolClientAnalyticsConfigurationList) Resolve(context cdktn.IResolveContext) interface{} {
