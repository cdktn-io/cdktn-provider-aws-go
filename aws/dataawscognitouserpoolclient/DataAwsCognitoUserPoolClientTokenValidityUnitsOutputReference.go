...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v21/dataawscognitouserpoolclient/internal"
...
func (d *jsiiProxy_DataAwsCognitoUserPoolClientTokenValidityUnitsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataAwsCognitoUserPoolClientTokenValidityUnitsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
