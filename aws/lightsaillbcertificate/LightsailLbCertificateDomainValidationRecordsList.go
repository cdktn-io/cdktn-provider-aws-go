...
func (j *jsiiProxy_LightsailLbCertificateDomainValidationRecordsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewLightsailLbCertificateDomainValidationRecordsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) LightsailLbCertificateDomainValidationRecordsList {
	_init_.Initialize()
...
func NewLightsailLbCertificateDomainValidationRecordsList_Override(l LightsailLbCertificateDomainValidationRecordsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_LightsailLbCertificateDomainValidationRecordsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (l *jsiiProxy_LightsailLbCertificateDomainValidationRecordsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (l *jsiiProxy_LightsailLbCertificateDomainValidationRecordsList) Resolve(context cdktn.IResolveContext) interface{} {
