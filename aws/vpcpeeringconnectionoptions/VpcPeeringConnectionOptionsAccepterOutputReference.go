...
func (v *jsiiProxy_VpcPeeringConnectionOptionsAccepterOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (v *jsiiProxy_VpcPeeringConnectionOptionsAccepterOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
