...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/acmcertificatevalidation/internal"
...
func (j *jsiiProxy_AcmCertificateValidation) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_AcmCertificateValidation) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_AcmCertificateValidation) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_AcmCertificateValidation) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_AcmCertificateValidation) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/acm_certificate_validation aws_acm_certificate_validation} Resource.
...
func (j *jsiiProxy_AcmCertificateValidation)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_AcmCertificateValidation)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_AcmCertificateValidation)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func AcmCertificateValidation_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (a *jsiiProxy_AcmCertificateValidation) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AcmCertificateValidation) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (a *jsiiProxy_AcmCertificateValidation) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AcmCertificateValidation) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (a *jsiiProxy_AcmCertificateValidation) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (a *jsiiProxy_AcmCertificateValidation) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
