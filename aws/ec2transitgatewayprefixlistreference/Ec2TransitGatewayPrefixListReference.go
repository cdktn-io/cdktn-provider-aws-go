...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/ec2transitgatewayprefixlistreference/internal"
...
func (j *jsiiProxy_Ec2TransitGatewayPrefixListReference) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_Ec2TransitGatewayPrefixListReference) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_Ec2TransitGatewayPrefixListReference) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_Ec2TransitGatewayPrefixListReference) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_Ec2TransitGatewayPrefixListReference) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/ec2_transit_gateway_prefix_list_reference aws_ec2_transit_gateway_prefix_list_reference} Resource.
func NewEc2TransitGatewayPrefixListReference(scope constructs.Construct, id *string, config *Ec2TransitGatewayPrefixListReferenceConfig) Ec2TransitGatewayPrefixListReference {
	...
	_jsii_.Create(
		"@cdktn/provider-aws.ec2TransitGatewayPrefixListReference.Ec2TransitGatewayPrefixListReference",
...
func (j *jsiiProxy_Ec2TransitGatewayPrefixListReference)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_Ec2TransitGatewayPrefixListReference)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_Ec2TransitGatewayPrefixListReference)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func Ec2TransitGatewayPrefixListReference_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (e *jsiiProxy_Ec2TransitGatewayPrefixListReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (e *jsiiProxy_Ec2TransitGatewayPrefixListReference) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (e *jsiiProxy_Ec2TransitGatewayPrefixListReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (e *jsiiProxy_Ec2TransitGatewayPrefixListReference) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (e *jsiiProxy_Ec2TransitGatewayPrefixListReference) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (e *jsiiProxy_Ec2TransitGatewayPrefixListReference) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
