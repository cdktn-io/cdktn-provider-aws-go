...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/vpcipampreviewnextcidr/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/vpc_ipam_preview_next_cidr aws_vpc_ipam_preview_next_cidr}.
...
func (j *jsiiProxy_VpcIpamPreviewNextCidr) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_VpcIpamPreviewNextCidr) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_VpcIpamPreviewNextCidr) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_VpcIpamPreviewNextCidr) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_VpcIpamPreviewNextCidr) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_VpcIpamPreviewNextCidr) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_VpcIpamPreviewNextCidr) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/vpc_ipam_preview_next_cidr aws_vpc_ipam_preview_next_cidr} Resource.
...
func (j *jsiiProxy_VpcIpamPreviewNextCidr)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_VpcIpamPreviewNextCidr)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_VpcIpamPreviewNextCidr)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_VpcIpamPreviewNextCidr)SetRegion(val *string) {
...
func VpcIpamPreviewNextCidr_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (v *jsiiProxy_VpcIpamPreviewNextCidr) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (v *jsiiProxy_VpcIpamPreviewNextCidr) HasResourceMove() interface{} {
	var returns interface{}
...
func (v *jsiiProxy_VpcIpamPreviewNextCidr) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (v *jsiiProxy_VpcIpamPreviewNextCidr) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (v *jsiiProxy_VpcIpamPreviewNextCidr) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (v *jsiiProxy_VpcIpamPreviewNextCidr) MoveFromId(id *string) {
...
func (v *jsiiProxy_VpcIpamPreviewNextCidr) MoveToId(id *string) {
...
func (v *jsiiProxy_VpcIpamPreviewNextCidr) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (v *jsiiProxy_VpcIpamPreviewNextCidr) ResetRegion() {
	_jsii_.InvokeVoid(
		v,
		"resetRegion",
		nil, // no parameters
...
func (v *jsiiProxy_VpcIpamPreviewNextCidr) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (v *jsiiProxy_VpcIpamPreviewNextCidr) ToHclTerraform() interface{} {
	var returns interface{}
...
func (v *jsiiProxy_VpcIpamPreviewNextCidr) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
