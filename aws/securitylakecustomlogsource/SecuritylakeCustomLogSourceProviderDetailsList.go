...
func (j *jsiiProxy_SecuritylakeCustomLogSourceProviderDetailsList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_SecuritylakeCustomLogSourceProviderDetailsList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_SecuritylakeCustomLogSourceProviderDetailsList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (j *jsiiProxy_SecuritylakeCustomLogSourceProviderDetailsList)SetTerraformAttribute(val *string) {
...
func (j *jsiiProxy_SecuritylakeCustomLogSourceProviderDetailsList)SetWrapsSet(val *bool) {
...
func (s *jsiiProxy_SecuritylakeCustomLogSourceProviderDetailsList) ComputeFqn() *string {
	var returns *string
...
func (s *jsiiProxy_SecuritylakeCustomLogSourceProviderDetailsList) Get(index *float64) SecuritylakeCustomLogSourceProviderDetailsOutputReference {
	if err := s.validateGetParameters(index); err != nil {
		panic(err)
	}
	var returns SecuritylakeCustomLogSourceProviderDetailsOutputReference
...
func (s *jsiiProxy_SecuritylakeCustomLogSourceProviderDetailsList) ToString() *string {
	var returns *string
