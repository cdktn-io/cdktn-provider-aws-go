...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v21/codepipelinewebhook/internal"
...
func (j *jsiiProxy_CodepipelineWebhookFilterOutputReference)SetMatchEquals(val *string) {
	if err := j.validateSetMatchEqualsParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (c *jsiiProxy_CodepipelineWebhookFilterOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CodepipelineWebhookFilterOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
