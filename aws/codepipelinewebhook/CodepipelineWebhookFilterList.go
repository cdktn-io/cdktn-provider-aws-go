...
func (j *jsiiProxy_CodepipelineWebhookFilterList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewCodepipelineWebhookFilterList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) CodepipelineWebhookFilterList {
	_init_.Initialize()
...
func NewCodepipelineWebhookFilterList_Override(c CodepipelineWebhookFilterList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_CodepipelineWebhookFilterList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_CodepipelineWebhookFilterList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (c *jsiiProxy_CodepipelineWebhookFilterList) Resolve(context cdktn.IResolveContext) interface{} {
