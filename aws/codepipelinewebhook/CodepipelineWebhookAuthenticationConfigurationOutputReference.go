...
func (c *jsiiProxy_CodepipelineWebhookAuthenticationConfigurationOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CodepipelineWebhookAuthenticationConfigurationOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
