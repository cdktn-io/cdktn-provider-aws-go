...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v23/codepipelinewebhook/internal"
...
func (j *jsiiProxy_CodepipelineWebhookAuthenticationConfigurationOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewCodepipelineWebhookAuthenticationConfigurationOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) CodepipelineWebhookAuthenticationConfigurationOutputReference {
	_init_.Initialize()
...
func NewCodepipelineWebhookAuthenticationConfigurationOutputReference_Override(c CodepipelineWebhookAuthenticationConfigurationOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_CodepipelineWebhookAuthenticationConfigurationOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_CodepipelineWebhookAuthenticationConfigurationOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CodepipelineWebhookAuthenticationConfigurationOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (c *jsiiProxy_CodepipelineWebhookAuthenticationConfigurationOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CodepipelineWebhookAuthenticationConfigurationOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
