...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/iamopenidconnectprovider/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/iam_openid_connect_provider aws_iam_openid_connect_provider}.
...
func (j *jsiiProxy_IamOpenidConnectProvider) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_IamOpenidConnectProvider) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_IamOpenidConnectProvider) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_IamOpenidConnectProvider) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_IamOpenidConnectProvider) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/iam_openid_connect_provider aws_iam_openid_connect_provider} Resource.
...
func (j *jsiiProxy_IamOpenidConnectProvider)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_IamOpenidConnectProvider)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_IamOpenidConnectProvider)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func IamOpenidConnectProvider_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateIamOpenidConnectProvider_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (i *jsiiProxy_IamOpenidConnectProvider) AddMoveTarget(moveTarget *string) {
...
func (i *jsiiProxy_IamOpenidConnectProvider) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (i *jsiiProxy_IamOpenidConnectProvider) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (i *jsiiProxy_IamOpenidConnectProvider) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (i *jsiiProxy_IamOpenidConnectProvider) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (i *jsiiProxy_IamOpenidConnectProvider) MoveFromId(id *string) {
...
func (i *jsiiProxy_IamOpenidConnectProvider) MoveToId(id *string) {
...
func (i *jsiiProxy_IamOpenidConnectProvider) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (i *jsiiProxy_IamOpenidConnectProvider) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
