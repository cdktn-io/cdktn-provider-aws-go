...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v22/iamopenidconnectprovider/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.31.0/docs/resources/iam_openid_connect_provider aws_iam_openid_connect_provider}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.31.0/docs/resources/iam_openid_connect_provider aws_iam_openid_connect_provider} Resource.
...
func IamOpenidConnectProvider_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (i *jsiiProxy_IamOpenidConnectProvider) ImportFrom(id *string, provider cdktf.TerraformProvider) {
