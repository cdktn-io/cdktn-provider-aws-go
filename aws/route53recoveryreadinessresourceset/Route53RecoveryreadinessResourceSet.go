...
func (j *jsiiProxy_Route53RecoveryreadinessResourceSet) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_Route53RecoveryreadinessResourceSet) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_Route53RecoveryreadinessResourceSet) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_Route53RecoveryreadinessResourceSet) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_Route53RecoveryreadinessResourceSet) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/route53recoveryreadiness_resource_set aws_route53recoveryreadiness_resource_set} Resource.
...
func (j *jsiiProxy_Route53RecoveryreadinessResourceSet)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_Route53RecoveryreadinessResourceSet)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_Route53RecoveryreadinessResourceSet)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func Route53RecoveryreadinessResourceSet_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (r *jsiiProxy_Route53RecoveryreadinessResourceSet) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (r *jsiiProxy_Route53RecoveryreadinessResourceSet) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (r *jsiiProxy_Route53RecoveryreadinessResourceSet) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (r *jsiiProxy_Route53RecoveryreadinessResourceSet) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (r *jsiiProxy_Route53RecoveryreadinessResourceSet) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (r *jsiiProxy_Route53RecoveryreadinessResourceSet) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
