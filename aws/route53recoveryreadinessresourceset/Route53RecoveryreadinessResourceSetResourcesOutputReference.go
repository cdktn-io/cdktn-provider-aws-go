...
func (j *jsiiProxy_Route53RecoveryreadinessResourceSetResourcesOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewRoute53RecoveryreadinessResourceSetResourcesOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) Route53RecoveryreadinessResourceSetResourcesOutputReference {
	_init_.Initialize()
...
func NewRoute53RecoveryreadinessResourceSetResourcesOutputReference_Override(r Route53RecoveryreadinessResourceSetResourcesOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_Route53RecoveryreadinessResourceSetResourcesOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (r *jsiiProxy_Route53RecoveryreadinessResourceSetResourcesOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (r *jsiiProxy_Route53RecoveryreadinessResourceSetResourcesOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (r *jsiiProxy_Route53RecoveryreadinessResourceSetResourcesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (r *jsiiProxy_Route53RecoveryreadinessResourceSetResourcesOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
