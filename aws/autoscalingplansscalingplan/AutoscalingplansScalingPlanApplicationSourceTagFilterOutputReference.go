...
func (a *jsiiProxy_AutoscalingplansScalingPlanApplicationSourceTagFilterOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_AutoscalingplansScalingPlanApplicationSourceTagFilterOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
