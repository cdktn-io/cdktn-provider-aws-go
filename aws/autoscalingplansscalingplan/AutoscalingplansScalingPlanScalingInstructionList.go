...
func (j *jsiiProxy_AutoscalingplansScalingPlanScalingInstructionList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewAutoscalingplansScalingPlanScalingInstructionList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) AutoscalingplansScalingPlanScalingInstructionList {
	_init_.Initialize()
...
func NewAutoscalingplansScalingPlanScalingInstructionList_Override(a AutoscalingplansScalingPlanScalingInstructionList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_AutoscalingplansScalingPlanScalingInstructionList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (a *jsiiProxy_AutoscalingplansScalingPlanScalingInstructionList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (a *jsiiProxy_AutoscalingplansScalingPlanScalingInstructionList) Resolve(context cdktn.IResolveContext) interface{} {
