...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/autoscalingplansscalingplan/internal"
...
func (j *jsiiProxy_AutoscalingplansScalingPlan) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_AutoscalingplansScalingPlan) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_AutoscalingplansScalingPlan) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_AutoscalingplansScalingPlan) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_AutoscalingplansScalingPlan) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_AutoscalingplansScalingPlan) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_AutoscalingplansScalingPlan) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/autoscalingplans_scaling_plan aws_autoscalingplans_scaling_plan} Resource.
func NewAutoscalingplansScalingPlan(scope constructs.Construct, id *string, config *AutoscalingplansScalingPlanConfig) AutoscalingplansScalingPlan {
	...
	if err := validateNewAutoscalingplansScalingPlanParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_AutoscalingplansScalingPlan)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_AutoscalingplansScalingPlan)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_AutoscalingplansScalingPlan)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_AutoscalingplansScalingPlan)SetRegion(val *string) {
...
func AutoscalingplansScalingPlan_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateAutoscalingplansScalingPlan_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (a *jsiiProxy_AutoscalingplansScalingPlan) AddMoveTarget(moveTarget *string) {
...
func (a *jsiiProxy_AutoscalingplansScalingPlan) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AutoscalingplansScalingPlan) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (a *jsiiProxy_AutoscalingplansScalingPlan) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AutoscalingplansScalingPlan) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (a *jsiiProxy_AutoscalingplansScalingPlan) MoveFromId(id *string) {
...
func (a *jsiiProxy_AutoscalingplansScalingPlan) MoveToId(id *string) {
...
func (a *jsiiProxy_AutoscalingplansScalingPlan) PutApplicationSource(value *AutoscalingplansScalingPlanApplicationSource) {
	if err := a.validatePutApplicationSourceParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		a,
...
func (a *jsiiProxy_AutoscalingplansScalingPlan) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (a *jsiiProxy_AutoscalingplansScalingPlan) ResetRegion() {
	_jsii_.InvokeVoid(
		a,
		"resetRegion",
		nil, // no parameters
...
func (a *jsiiProxy_AutoscalingplansScalingPlan) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
