...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v22/autoscalingplansscalingplan/internal"
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.31.0/docs/resources/autoscalingplans_scaling_plan aws_autoscalingplans_scaling_plan} Resource.
...
func AutoscalingplansScalingPlan_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (a *jsiiProxy_AutoscalingplansScalingPlan) ImportFrom(id *string, provider cdktf.TerraformProvider) {
