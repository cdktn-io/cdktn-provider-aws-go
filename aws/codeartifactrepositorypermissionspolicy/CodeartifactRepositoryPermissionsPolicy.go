...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/codeartifactrepositorypermissionspolicy/internal"
...
func (j *jsiiProxy_CodeartifactRepositoryPermissionsPolicy) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_CodeartifactRepositoryPermissionsPolicy) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_CodeartifactRepositoryPermissionsPolicy) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_CodeartifactRepositoryPermissionsPolicy) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_CodeartifactRepositoryPermissionsPolicy) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_CodeartifactRepositoryPermissionsPolicy) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_CodeartifactRepositoryPermissionsPolicy) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func NewCodeartifactRepositoryPermissionsPolicy(scope constructs.Construct, id *string, config *CodeartifactRepositoryPermissionsPolicyConfig) CodeartifactRepositoryPermissionsPolicy {
	...
	_jsii_.Create(
		"@cdktn/provider-aws.codeartifactRepositoryPermissionsPolicy.CodeartifactRepositoryPermissionsPolicy",
...
func (j *jsiiProxy_CodeartifactRepositoryPermissionsPolicy)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_CodeartifactRepositoryPermissionsPolicy)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_CodeartifactRepositoryPermissionsPolicy)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_CodeartifactRepositoryPermissionsPolicy)SetRegion(val *string) {
...
func CodeartifactRepositoryPermissionsPolicy_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (c *jsiiProxy_CodeartifactRepositoryPermissionsPolicy) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CodeartifactRepositoryPermissionsPolicy) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (c *jsiiProxy_CodeartifactRepositoryPermissionsPolicy) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CodeartifactRepositoryPermissionsPolicy) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_CodeartifactRepositoryPermissionsPolicy) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (c *jsiiProxy_CodeartifactRepositoryPermissionsPolicy) ResetRegion() {
	_jsii_.InvokeVoid(
		c,
		"resetRegion",
		nil, // no parameters
...
func (c *jsiiProxy_CodeartifactRepositoryPermissionsPolicy) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
