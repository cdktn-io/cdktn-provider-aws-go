...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v21/dataawscloudcontrolapiresource/internal"
...
func (j *jsiiProxy_DataAwsCloudcontrolapiResource) ForEach() cdktf.ITerraformIterator {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.28.0/docs/data-sources/cloudcontrolapi_resource aws_cloudcontrolapi_resource} Data Source.
...
func DataAwsCloudcontrolapiResource_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
