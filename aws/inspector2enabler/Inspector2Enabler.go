...
func (j *jsiiProxy_Inspector2Enabler) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_Inspector2Enabler) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_Inspector2Enabler) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_Inspector2Enabler) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_Inspector2Enabler) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_Inspector2Enabler) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_Inspector2Enabler) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/inspector2_enabler aws_inspector2_enabler} Resource.
...
func (j *jsiiProxy_Inspector2Enabler)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_Inspector2Enabler)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_Inspector2Enabler)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_Inspector2Enabler)SetRegion(val *string) {
...
func Inspector2Enabler_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (i *jsiiProxy_Inspector2Enabler) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (i *jsiiProxy_Inspector2Enabler) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (i *jsiiProxy_Inspector2Enabler) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (i *jsiiProxy_Inspector2Enabler) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (i *jsiiProxy_Inspector2Enabler) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (i *jsiiProxy_Inspector2Enabler) ResetRegion() {
	_jsii_.InvokeVoid(
		i,
		"resetRegion",
		nil, // no parameters
...
func (i *jsiiProxy_Inspector2Enabler) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
