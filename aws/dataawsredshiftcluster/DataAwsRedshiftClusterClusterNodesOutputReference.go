...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v24/dataawsredshiftcluster/internal"
...
func (j *jsiiProxy_DataAwsRedshiftClusterClusterNodesOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsRedshiftClusterClusterNodesOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) DataAwsRedshiftClusterClusterNodesOutputReference {
	_init_.Initialize()

	if err := validateNewDataAwsRedshiftClusterClusterNodesOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func NewDataAwsRedshiftClusterClusterNodesOutputReference_Override(d DataAwsRedshiftClusterClusterNodesOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsRedshiftClusterClusterNodesOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsRedshiftClusterClusterNodesOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsRedshiftClusterClusterNodesOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (d *jsiiProxy_DataAwsRedshiftClusterClusterNodesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsRedshiftClusterClusterNodesOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
