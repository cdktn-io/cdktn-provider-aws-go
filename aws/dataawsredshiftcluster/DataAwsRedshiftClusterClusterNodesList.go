...
func (j *jsiiProxy_DataAwsRedshiftClusterClusterNodesList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsRedshiftClusterClusterNodesList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsRedshiftClusterClusterNodesList {
	_init_.Initialize()

	if err := validateNewDataAwsRedshiftClusterClusterNodesListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewDataAwsRedshiftClusterClusterNodesList_Override(d DataAwsRedshiftClusterClusterNodesList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsRedshiftClusterClusterNodesList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsRedshiftClusterClusterNodesList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsRedshiftClusterClusterNodesList) Resolve(context cdktn.IResolveContext) interface{} {
