...
func (j *jsiiProxy_Ec2ClientVpnEndpoint) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_Ec2ClientVpnEndpoint) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_Ec2ClientVpnEndpoint)SetRegion(val *string) {
...
func (e *jsiiProxy_Ec2ClientVpnEndpoint) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (e *jsiiProxy_Ec2ClientVpnEndpoint) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (e *jsiiProxy_Ec2ClientVpnEndpoint) ResetRegion() {
	_jsii_.InvokeVoid(
		e,
		"resetRegion",
		nil, // no parameters
...
func (e *jsiiProxy_Ec2ClientVpnEndpoint) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
