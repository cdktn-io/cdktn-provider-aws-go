...
type Ec2ClientVpnEndpointConfig struct {
	...
	TransitGatewayConfiguration *Ec2ClientVpnEndpointTransitGatewayConfiguration `field:"optional" json:"transitGatewayConfiguration" yaml:"transitGatewayConfiguration"`
