...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/dataawsconnectbotassociation/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/data-sources/connect_bot_association aws_connect_bot_association}.
...
func (j *jsiiProxy_DataAwsConnectBotAssociation) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsConnectBotAssociation) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsConnectBotAssociation) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_DataAwsConnectBotAssociation) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsConnectBotAssociation) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsConnectBotAssociation) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/data-sources/connect_bot_association aws_connect_bot_association} Data Source.
func NewDataAwsConnectBotAssociation(scope constructs.Construct, id *string, config *DataAwsConnectBotAssociationConfig) DataAwsConnectBotAssociation {
	...
	if err := validateNewDataAwsConnectBotAssociationParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_DataAwsConnectBotAssociation)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsConnectBotAssociation)SetId(val *string) {
...
func (j *jsiiProxy_DataAwsConnectBotAssociation)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsConnectBotAssociation)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsConnectBotAssociation_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateDataAwsConnectBotAssociation_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func DataAwsConnectBotAssociation_IsConstruct(x interface{}) *bool {
	...
	if err := validateDataAwsConnectBotAssociation_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataAwsConnectBotAssociation_IsTerraformDataSource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataAwsConnectBotAssociation_IsTerraformDataSourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataAwsConnectBotAssociation_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataAwsConnectBotAssociation_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (d *jsiiProxy_DataAwsConnectBotAssociation) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsConnectBotAssociation) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsConnectBotAssociation) PutLexBot(value *DataAwsConnectBotAssociationLexBot) {
	if err := d.validatePutLexBotParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		d,
...
func (d *jsiiProxy_DataAwsConnectBotAssociation) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsConnectBotAssociation) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsConnectBotAssociation) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataAwsConnectBotAssociation) ToHclTerraform() interface{} {
	var returns interface{}
...
func (d *jsiiProxy_DataAwsConnectBotAssociation) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
