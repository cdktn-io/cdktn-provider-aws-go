...
func (a *jsiiProxy_AppflowFlowSourceFlowConfigSourceConnectorPropertiesSapoDataOutputReference) validateResolveParameters(context cdktf.IResolveContext) error {
	if context == nil {
