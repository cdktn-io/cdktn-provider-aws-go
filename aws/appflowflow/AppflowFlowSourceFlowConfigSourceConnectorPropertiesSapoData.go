...
type AppflowFlowSourceFlowConfigSourceConnectorPropertiesSapoData struct {
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.39.0/docs/resources/appflow_flow#object_path AppflowFlow#object_path}.
	ObjectPath *string `field:"required" json:"objectPath" yaml:"objectPath"`
	// pagination_config block.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.39.0/docs/resources/appflow_flow#pagination_config AppflowFlow#pagination_config}
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.39.0/docs/resources/appflow_flow#parallelism_config AppflowFlow#parallelism_config}
