...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/appflow_flow aws_appflow_flow}.
...
func (j *jsiiProxy_AppflowFlow) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_AppflowFlow) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_AppflowFlow) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_AppflowFlow) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_AppflowFlow) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/appflow_flow aws_appflow_flow} Resource.
...
func (j *jsiiProxy_AppflowFlow)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_AppflowFlow)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_AppflowFlow)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func AppflowFlow_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (a *jsiiProxy_AppflowFlow) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AppflowFlow) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (a *jsiiProxy_AppflowFlow) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AppflowFlow) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (a *jsiiProxy_AppflowFlow) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (a *jsiiProxy_AppflowFlow) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
