...
type AppflowFlowMetadataCatalogConfig struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.35.1/docs/resources/appflow_flow#glue_data_catalog AppflowFlow#glue_data_catalog}
