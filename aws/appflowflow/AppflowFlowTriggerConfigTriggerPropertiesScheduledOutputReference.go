...
func (a *jsiiProxy_AppflowFlowTriggerConfigTriggerPropertiesScheduledOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_AppflowFlowTriggerConfigTriggerPropertiesScheduledOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
