...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v23/athenadatabase/internal"
...
func (j *jsiiProxy_AthenaDatabaseEncryptionConfigurationOutputReference) ComplexObjectIndex() interface{} {
...
func (j *jsiiProxy_AthenaDatabaseEncryptionConfigurationOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_AthenaDatabaseEncryptionConfigurationOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_AthenaDatabaseEncryptionConfigurationOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_AthenaDatabaseEncryptionConfigurationOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewAthenaDatabaseEncryptionConfigurationOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) AthenaDatabaseEncryptionConfigurationOutputReference {
	_init_.Initialize()

	if err := validateNewAthenaDatabaseEncryptionConfigurationOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewAthenaDatabaseEncryptionConfigurationOutputReference_Override(a AthenaDatabaseEncryptionConfigurationOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_AthenaDatabaseEncryptionConfigurationOutputReference)SetComplexObjectIndex(val interface{}) {
...
func (j *jsiiProxy_AthenaDatabaseEncryptionConfigurationOutputReference)SetComplexObjectIsFromSet(val *bool) {
...
func (j *jsiiProxy_AthenaDatabaseEncryptionConfigurationOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (a *jsiiProxy_AthenaDatabaseEncryptionConfigurationOutputReference) ComputeFqn() *string {
	var returns *string
...
func (a *jsiiProxy_AthenaDatabaseEncryptionConfigurationOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AthenaDatabaseEncryptionConfigurationOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (a *jsiiProxy_AthenaDatabaseEncryptionConfigurationOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AthenaDatabaseEncryptionConfigurationOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
...
func (a *jsiiProxy_AthenaDatabaseEncryptionConfigurationOutputReference) ToString() *string {
	var returns *string
