...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v22/athenadatabase/internal"
...
func NewAthenaDatabaseEncryptionConfigurationOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) AthenaDatabaseEncryptionConfigurationOutputReference {
	_init_.Initialize()
...
func NewAthenaDatabaseEncryptionConfigurationOutputReference_Override(a AthenaDatabaseEncryptionConfigurationOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (a *jsiiProxy_AthenaDatabaseEncryptionConfigurationOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_AthenaDatabaseEncryptionConfigurationOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
