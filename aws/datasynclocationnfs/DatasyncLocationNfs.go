...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/datasynclocationnfs/internal"
...
func (j *jsiiProxy_DatasyncLocationNfs) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DatasyncLocationNfs) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DatasyncLocationNfs) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DatasyncLocationNfs) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DatasyncLocationNfs) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/datasync_location_nfs aws_datasync_location_nfs} Resource.
...
func (j *jsiiProxy_DatasyncLocationNfs)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DatasyncLocationNfs)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DatasyncLocationNfs)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DatasyncLocationNfs_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DatasyncLocationNfs) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DatasyncLocationNfs) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (d *jsiiProxy_DatasyncLocationNfs) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DatasyncLocationNfs) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (d *jsiiProxy_DatasyncLocationNfs) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DatasyncLocationNfs) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
