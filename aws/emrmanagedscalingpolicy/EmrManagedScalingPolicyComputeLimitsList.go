...
func (e *jsiiProxy_EmrManagedScalingPolicyComputeLimitsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (e *jsiiProxy_EmrManagedScalingPolicyComputeLimitsList) Resolve(context cdktf.IResolveContext) interface{} {
