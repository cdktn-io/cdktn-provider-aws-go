...
type MskconnectWorkerConfiguration interface {
	...
	PutTimeouts(value *MskconnectWorkerConfigurationTimeouts)
...
func (j *jsiiProxy_MskconnectWorkerConfiguration) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_MskconnectWorkerConfiguration) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_MskconnectWorkerConfiguration) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_MskconnectWorkerConfiguration) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_MskconnectWorkerConfiguration) TagsAll() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsAll",
...
func (j *jsiiProxy_MskconnectWorkerConfiguration) TagsAllInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsAllInput",
...
func (j *jsiiProxy_MskconnectWorkerConfiguration) TagsInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsInput",
...
func (j *jsiiProxy_MskconnectWorkerConfiguration) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_MskconnectWorkerConfiguration) Timeouts() MskconnectWorkerConfigurationTimeoutsOutputReference {
	var returns MskconnectWorkerConfigurationTimeoutsOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
func (j *jsiiProxy_MskconnectWorkerConfiguration) TimeoutsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"timeoutsInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/mskconnect_worker_configuration aws_mskconnect_worker_configuration} Resource.
...
func (j *jsiiProxy_MskconnectWorkerConfiguration)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_MskconnectWorkerConfiguration)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_MskconnectWorkerConfiguration)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_MskconnectWorkerConfiguration)SetTags(val *map[string]*string) {
...
func (j *jsiiProxy_MskconnectWorkerConfiguration)SetTagsAll(val *map[string]*string) {
...
func MskconnectWorkerConfiguration_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (m *jsiiProxy_MskconnectWorkerConfiguration) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MskconnectWorkerConfiguration) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (m *jsiiProxy_MskconnectWorkerConfiguration) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MskconnectWorkerConfiguration) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (m *jsiiProxy_MskconnectWorkerConfiguration) PutTimeouts(value *MskconnectWorkerConfigurationTimeouts) {
...
func (m *jsiiProxy_MskconnectWorkerConfiguration) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (m *jsiiProxy_MskconnectWorkerConfiguration) ResetTags() {
	_jsii_.InvokeVoid(
		m,
		"resetTags",
		nil, // no parameters
...
func (m *jsiiProxy_MskconnectWorkerConfiguration) ResetTagsAll() {
	_jsii_.InvokeVoid(
		m,
		"resetTagsAll",
		nil, // no parameters
...
func (m *jsiiProxy_MskconnectWorkerConfiguration) ResetTimeouts() {
	_jsii_.InvokeVoid(
		m,
		"resetTimeouts",
		nil, // no parameters
...
func (m *jsiiProxy_MskconnectWorkerConfiguration) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
