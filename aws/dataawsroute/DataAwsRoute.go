...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/dataawsroute/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/data-sources/route aws_route}.
...
func (j *jsiiProxy_DataAwsRoute) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsRoute) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsRoute) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsRoute) OdbNetworkArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"odbNetworkArn",
...
func (j *jsiiProxy_DataAwsRoute) OdbNetworkArnInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"odbNetworkArnInput",
...
func (j *jsiiProxy_DataAwsRoute) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsRoute) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/data-sources/route aws_route} Data Source.
...
func (j *jsiiProxy_DataAwsRoute)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsRoute)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsRoute)SetOdbNetworkArn(val *string) {
...
func (j *jsiiProxy_DataAwsRoute)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsRoute_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsRoute) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsRoute) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsRoute) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsRoute) ResetOdbNetworkArn() {
	_jsii_.InvokeVoid(
		d,
		"resetOdbNetworkArn",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsRoute) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
