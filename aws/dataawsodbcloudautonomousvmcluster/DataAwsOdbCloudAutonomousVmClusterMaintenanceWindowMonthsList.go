...
func (j *jsiiProxy_DataAwsOdbCloudAutonomousVmClusterMaintenanceWindowMonthsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsOdbCloudAutonomousVmClusterMaintenanceWindowMonthsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsOdbCloudAutonomousVmClusterMaintenanceWindowMonthsList {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-aws.dataAwsOdbCloudAutonomousVmCluster.DataAwsOdbCloudAutonomousVmClusterMaintenanceWindowMonthsList",
...
func NewDataAwsOdbCloudAutonomousVmClusterMaintenanceWindowMonthsList_Override(d DataAwsOdbCloudAutonomousVmClusterMaintenanceWindowMonthsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsOdbCloudAutonomousVmClusterMaintenanceWindowMonthsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsOdbCloudAutonomousVmClusterMaintenanceWindowMonthsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsOdbCloudAutonomousVmClusterMaintenanceWindowMonthsList) Resolve(context cdktn.IResolveContext) interface{} {
