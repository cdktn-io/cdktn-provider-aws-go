...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/sesreceiptfilter/internal"
...
func (j *jsiiProxy_SesReceiptFilter) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_SesReceiptFilter) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_SesReceiptFilter) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_SesReceiptFilter) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_SesReceiptFilter) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_SesReceiptFilter)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_SesReceiptFilter)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_SesReceiptFilter)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func SesReceiptFilter_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (s *jsiiProxy_SesReceiptFilter) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SesReceiptFilter) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_SesReceiptFilter) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SesReceiptFilter) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_SesReceiptFilter) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_SesReceiptFilter) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
