...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "kubernetesGroups", GoGetter: "KubernetesGroups"},
			_jsii_.MemberProperty{JsiiProperty: "kubernetesGroupsInput", GoGetter: "KubernetesGroupsInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetKubernetesGroups", GoMethod: "ResetKubernetesGroups"},
