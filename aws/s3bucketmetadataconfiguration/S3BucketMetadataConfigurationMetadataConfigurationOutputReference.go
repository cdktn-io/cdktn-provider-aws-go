...
func (s *jsiiProxy_S3BucketMetadataConfigurationMetadataConfigurationOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_S3BucketMetadataConfigurationMetadataConfigurationOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
