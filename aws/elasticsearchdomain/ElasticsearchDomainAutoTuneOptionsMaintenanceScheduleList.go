...
func (j *jsiiProxy_ElasticsearchDomainAutoTuneOptionsMaintenanceScheduleList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewElasticsearchDomainAutoTuneOptionsMaintenanceScheduleList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ElasticsearchDomainAutoTuneOptionsMaintenanceScheduleList {
	_init_.Initialize()

	if err := validateNewElasticsearchDomainAutoTuneOptionsMaintenanceScheduleListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewElasticsearchDomainAutoTuneOptionsMaintenanceScheduleList_Override(e ElasticsearchDomainAutoTuneOptionsMaintenanceScheduleList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ElasticsearchDomainAutoTuneOptionsMaintenanceScheduleList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (e *jsiiProxy_ElasticsearchDomainAutoTuneOptionsMaintenanceScheduleList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (e *jsiiProxy_ElasticsearchDomainAutoTuneOptionsMaintenanceScheduleList) Resolve(context cdktn.IResolveContext) interface{} {
