...
func (e *jsiiProxy_ElasticsearchDomainNodeToNodeEncryptionOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (e *jsiiProxy_ElasticsearchDomainNodeToNodeEncryptionOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
