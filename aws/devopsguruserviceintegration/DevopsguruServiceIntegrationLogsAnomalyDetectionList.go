...
func (j *jsiiProxy_DevopsguruServiceIntegrationLogsAnomalyDetectionList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDevopsguruServiceIntegrationLogsAnomalyDetectionList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DevopsguruServiceIntegrationLogsAnomalyDetectionList {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-aws.devopsguruServiceIntegration.DevopsguruServiceIntegrationLogsAnomalyDetectionList",
...
func NewDevopsguruServiceIntegrationLogsAnomalyDetectionList_Override(d DevopsguruServiceIntegrationLogsAnomalyDetectionList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DevopsguruServiceIntegrationLogsAnomalyDetectionList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DevopsguruServiceIntegrationLogsAnomalyDetectionList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DevopsguruServiceIntegrationLogsAnomalyDetectionList) Resolve(context cdktn.IResolveContext) interface{} {
