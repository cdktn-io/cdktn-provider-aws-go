...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/vpcipampoolcidrallocation/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/vpc_ipam_pool_cidr_allocation aws_vpc_ipam_pool_cidr_allocation}.
...
func (j *jsiiProxy_VpcIpamPoolCidrAllocation) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_VpcIpamPoolCidrAllocation) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_VpcIpamPoolCidrAllocation) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_VpcIpamPoolCidrAllocation) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_VpcIpamPoolCidrAllocation) Tags() *map[string]*string {
...
func (j *jsiiProxy_VpcIpamPoolCidrAllocation) TagsAll() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsAll",
...
func (j *jsiiProxy_VpcIpamPoolCidrAllocation) TagsAllInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsAllInput",
...
func (j *jsiiProxy_VpcIpamPoolCidrAllocation) TagsInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsInput",
...
func (j *jsiiProxy_VpcIpamPoolCidrAllocation) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/vpc_ipam_pool_cidr_allocation aws_vpc_ipam_pool_cidr_allocation} Resource.
func NewVpcIpamPoolCidrAllocation(scope constructs.Construct, id *string, config *VpcIpamPoolCidrAllocationConfig) VpcIpamPoolCidrAllocation {
	...
	_jsii_.Create(
		"@cdktn/provider-aws.vpcIpamPoolCidrAllocation.VpcIpamPoolCidrAllocation",
...
func (j *jsiiProxy_VpcIpamPoolCidrAllocation)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_VpcIpamPoolCidrAllocation)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_VpcIpamPoolCidrAllocation)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_VpcIpamPoolCidrAllocation)SetTags(val *map[string]*string) {
...
func (j *jsiiProxy_VpcIpamPoolCidrAllocation)SetTagsAll(val *map[string]*string) {
...
func VpcIpamPoolCidrAllocation_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (v *jsiiProxy_VpcIpamPoolCidrAllocation) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (v *jsiiProxy_VpcIpamPoolCidrAllocation) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (v *jsiiProxy_VpcIpamPoolCidrAllocation) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (v *jsiiProxy_VpcIpamPoolCidrAllocation) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (v *jsiiProxy_VpcIpamPoolCidrAllocation) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (v *jsiiProxy_VpcIpamPoolCidrAllocation) ResetTags() {
	_jsii_.InvokeVoid(
		v,
		"resetTags",
		nil, // no parameters
...
func (v *jsiiProxy_VpcIpamPoolCidrAllocation) ResetTagsAll() {
	_jsii_.InvokeVoid(
		v,
		"resetTagsAll",
		nil, // no parameters
...
func (v *jsiiProxy_VpcIpamPoolCidrAllocation) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
