...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v21/glaciervaultlock/internal"
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.28.0/docs/resources/glacier_vault_lock aws_glacier_vault_lock} Resource.
...
func GlacierVaultLock_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (g *jsiiProxy_GlacierVaultLock) ImportFrom(id *string, provider cdktf.TerraformProvider) {
