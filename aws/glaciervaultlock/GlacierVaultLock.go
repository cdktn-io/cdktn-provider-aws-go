...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/glaciervaultlock/internal"
...
func (j *jsiiProxy_GlacierVaultLock) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_GlacierVaultLock) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_GlacierVaultLock) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_GlacierVaultLock) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_GlacierVaultLock) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_GlacierVaultLock) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_GlacierVaultLock) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/glacier_vault_lock aws_glacier_vault_lock} Resource.
func NewGlacierVaultLock(scope constructs.Construct, id *string, config *GlacierVaultLockConfig) GlacierVaultLock {
	_init_.Initialize()

	if err := validateNewGlacierVaultLockParameters(scope, id, config); err != nil {
		panic(err)
	}
	j := jsiiProxy_GlacierVaultLock{}

	_jsii_.Create(
		"@cdktn/provider-aws.glacierVaultLock.GlacierVaultLock",
...
func (j *jsiiProxy_GlacierVaultLock)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_GlacierVaultLock)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_GlacierVaultLock)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_GlacierVaultLock)SetRegion(val *string) {
...
func GlacierVaultLock_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateGlacierVaultLock_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (g *jsiiProxy_GlacierVaultLock) AddMoveTarget(moveTarget *string) {
...
func (g *jsiiProxy_GlacierVaultLock) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GlacierVaultLock) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (g *jsiiProxy_GlacierVaultLock) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GlacierVaultLock) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GlacierVaultLock) MoveFromId(id *string) {
...
func (g *jsiiProxy_GlacierVaultLock) MoveToId(id *string) {
...
func (g *jsiiProxy_GlacierVaultLock) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (g *jsiiProxy_GlacierVaultLock) ResetRegion() {
	_jsii_.InvokeVoid(
		g,
		"resetRegion",
		nil, // no parameters
...
func (g *jsiiProxy_GlacierVaultLock) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
