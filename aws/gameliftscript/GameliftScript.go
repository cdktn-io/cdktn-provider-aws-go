...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/gameliftscript/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/gamelift_script aws_gamelift_script}.
...
func (j *jsiiProxy_GameliftScript) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_GameliftScript) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_GameliftScript) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_GameliftScript) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_GameliftScript) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_GameliftScript) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_GameliftScript) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/gamelift_script aws_gamelift_script} Resource.
...
func (j *jsiiProxy_GameliftScript)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_GameliftScript)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_GameliftScript)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_GameliftScript)SetRegion(val *string) {
...
func GameliftScript_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateGameliftScript_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (g *jsiiProxy_GameliftScript) AddMoveTarget(moveTarget *string) {
...
func (g *jsiiProxy_GameliftScript) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GameliftScript) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (g *jsiiProxy_GameliftScript) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GameliftScript) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GameliftScript) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (g *jsiiProxy_GameliftScript) ResetRegion() {
	_jsii_.InvokeVoid(
		g,
		"resetRegion",
		nil, // no parameters
...
func (g *jsiiProxy_GameliftScript) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
