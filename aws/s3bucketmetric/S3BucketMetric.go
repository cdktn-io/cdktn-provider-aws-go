...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v21/s3bucketmetric/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.28.0/docs/resources/s3_bucket_metric aws_s3_bucket_metric}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.28.0/docs/resources/s3_bucket_metric aws_s3_bucket_metric} Resource.
...
func S3BucketMetric_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (s *jsiiProxy_S3BucketMetric) ImportFrom(id *string, provider cdktf.TerraformProvider) {
