...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/s3bucketmetric/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/s3_bucket_metric aws_s3_bucket_metric}.
...
func (j *jsiiProxy_S3BucketMetric) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_S3BucketMetric) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_S3BucketMetric) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_S3BucketMetric) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_S3BucketMetric) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_S3BucketMetric) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_S3BucketMetric) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/s3_bucket_metric aws_s3_bucket_metric} Resource.
...
func (j *jsiiProxy_S3BucketMetric)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_S3BucketMetric)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_S3BucketMetric)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_S3BucketMetric)SetRegion(val *string) {
...
func S3BucketMetric_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateS3BucketMetric_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_S3BucketMetric) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_S3BucketMetric) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_S3BucketMetric) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_S3BucketMetric) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_S3BucketMetric) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_S3BucketMetric) MoveFromId(id *string) {
...
func (s *jsiiProxy_S3BucketMetric) MoveToId(id *string) {
...
func (s *jsiiProxy_S3BucketMetric) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_S3BucketMetric) ResetRegion() {
	_jsii_.InvokeVoid(
		s,
		"resetRegion",
		nil, // no parameters
...
func (s *jsiiProxy_S3BucketMetric) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
