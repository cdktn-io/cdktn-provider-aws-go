...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/dataawscalleridentity/internal"
...
func (j *jsiiProxy_DataAwsCallerIdentity) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsCallerIdentity) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsCallerIdentity) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsCallerIdentity) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsCallerIdentity) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/data-sources/caller_identity aws_caller_identity} Data Source.
...
func (j *jsiiProxy_DataAwsCallerIdentity)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsCallerIdentity)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsCallerIdentity)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsCallerIdentity_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsCallerIdentity) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsCallerIdentity) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsCallerIdentity) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsCallerIdentity) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
