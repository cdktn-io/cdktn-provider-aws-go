...
func (j *jsiiProxy_Elb) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_Elb) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_Elb) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_Elb) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_Elb) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_Elb) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_Elb) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/elb aws_elb} Resource.
...
func (j *jsiiProxy_Elb)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_Elb)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_Elb)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_Elb)SetRegion(val *string) {
...
func Elb_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (e *jsiiProxy_Elb) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (e *jsiiProxy_Elb) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (e *jsiiProxy_Elb) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (e *jsiiProxy_Elb) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (e *jsiiProxy_Elb) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (e *jsiiProxy_Elb) ResetRegion() {
	_jsii_.InvokeVoid(
		e,
		"resetRegion",
		nil, // no parameters
...
func (e *jsiiProxy_Elb) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
