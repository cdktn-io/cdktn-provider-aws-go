...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/ec2clientvpnroute/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/ec2_client_vpn_route aws_ec2_client_vpn_route}.
...
func (j *jsiiProxy_Ec2ClientVpnRoute) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_Ec2ClientVpnRoute) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_Ec2ClientVpnRoute) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_Ec2ClientVpnRoute) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_Ec2ClientVpnRoute) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_Ec2ClientVpnRoute) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_Ec2ClientVpnRoute) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/ec2_client_vpn_route aws_ec2_client_vpn_route} Resource.
...
func (j *jsiiProxy_Ec2ClientVpnRoute)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_Ec2ClientVpnRoute)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_Ec2ClientVpnRoute)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_Ec2ClientVpnRoute)SetRegion(val *string) {
...
func Ec2ClientVpnRoute_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (e *jsiiProxy_Ec2ClientVpnRoute) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (e *jsiiProxy_Ec2ClientVpnRoute) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (e *jsiiProxy_Ec2ClientVpnRoute) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (e *jsiiProxy_Ec2ClientVpnRoute) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (e *jsiiProxy_Ec2ClientVpnRoute) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (e *jsiiProxy_Ec2ClientVpnRoute) ResetRegion() {
	_jsii_.InvokeVoid(
		e,
		"resetRegion",
		nil, // no parameters
...
func (e *jsiiProxy_Ec2ClientVpnRoute) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
