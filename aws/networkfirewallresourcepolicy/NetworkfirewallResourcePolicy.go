...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/networkfirewallresourcepolicy/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/networkfirewall_resource_policy aws_networkfirewall_resource_policy}.
...
func (j *jsiiProxy_NetworkfirewallResourcePolicy) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_NetworkfirewallResourcePolicy) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_NetworkfirewallResourcePolicy) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_NetworkfirewallResourcePolicy) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_NetworkfirewallResourcePolicy) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_NetworkfirewallResourcePolicy) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_NetworkfirewallResourcePolicy) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/networkfirewall_resource_policy aws_networkfirewall_resource_policy} Resource.
func NewNetworkfirewallResourcePolicy(scope constructs.Construct, id *string, config *NetworkfirewallResourcePolicyConfig) NetworkfirewallResourcePolicy {
	...
	_jsii_.Create(
		"@cdktn/provider-aws.networkfirewallResourcePolicy.NetworkfirewallResourcePolicy",
...
func (j *jsiiProxy_NetworkfirewallResourcePolicy)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_NetworkfirewallResourcePolicy)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_NetworkfirewallResourcePolicy)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_NetworkfirewallResourcePolicy)SetRegion(val *string) {
...
// Generates CDKTN code for importing a NetworkfirewallResourcePolicy resource upon running "cdktn plan <stack-name>".
func NetworkfirewallResourcePolicy_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (n *jsiiProxy_NetworkfirewallResourcePolicy) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (n *jsiiProxy_NetworkfirewallResourcePolicy) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (n *jsiiProxy_NetworkfirewallResourcePolicy) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (n *jsiiProxy_NetworkfirewallResourcePolicy) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (n *jsiiProxy_NetworkfirewallResourcePolicy) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (n *jsiiProxy_NetworkfirewallResourcePolicy) ResetRegion() {
	_jsii_.InvokeVoid(
		n,
		"resetRegion",
		nil, // no parameters
...
func (n *jsiiProxy_NetworkfirewallResourcePolicy) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
