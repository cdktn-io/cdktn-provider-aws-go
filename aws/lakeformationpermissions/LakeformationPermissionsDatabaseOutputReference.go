...
func (l *jsiiProxy_LakeformationPermissionsDatabaseOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LakeformationPermissionsDatabaseOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
