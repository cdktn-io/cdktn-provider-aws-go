...
func (l *jsiiProxy_LakeformationPermissionsLfTagPolicyExpressionOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LakeformationPermissionsLfTagPolicyExpressionOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
