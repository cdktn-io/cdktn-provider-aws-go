...
func (l *jsiiProxy_LakeformationPermissionsDataLocationOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LakeformationPermissionsDataLocationOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
