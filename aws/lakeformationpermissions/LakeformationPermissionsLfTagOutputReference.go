...
func (l *jsiiProxy_LakeformationPermissionsLfTagOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LakeformationPermissionsLfTagOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
