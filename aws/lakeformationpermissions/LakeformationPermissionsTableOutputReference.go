...
func (l *jsiiProxy_LakeformationPermissionsTableOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LakeformationPermissionsTableOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
