...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-aws.ephemeralAwsKmsSecrets.EphemeralAwsKmsSecretsConfig",
		reflect.TypeOf((*EphemeralAwsKmsSecretsConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-aws.ephemeralAwsKmsSecrets.EphemeralAwsKmsSecretsSecret",
		reflect.TypeOf((*EphemeralAwsKmsSecretsSecret)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-aws.ephemeralAwsKmsSecrets.EphemeralAwsKmsSecretsSecretList",
		reflect.TypeOf((*EphemeralAwsKmsSecretsSecretList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*EphemeralAwsKmsSecretsSecretOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
