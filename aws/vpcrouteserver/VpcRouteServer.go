...
func (j *jsiiProxy_VpcRouteServer) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_VpcRouteServer) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_VpcRouteServer) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_VpcRouteServer) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_VpcRouteServer) TagsAll() cdktf.StringMap {
...
func (j *jsiiProxy_VpcRouteServer) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_VpcRouteServer)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_VpcRouteServer)SetLifecycle(val *cdktf.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_VpcRouteServer)SetProvider(val cdktf.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func VpcRouteServer_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (v *jsiiProxy_VpcRouteServer) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (v *jsiiProxy_VpcRouteServer) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (v *jsiiProxy_VpcRouteServer) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
