...
func (v *jsiiProxy_VpcRouteServer) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (v *jsiiProxy_VpcRouteServer) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
