...
func (j *jsiiProxy_VerifiedpermissionsPolicyDefinitionOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewVerifiedpermissionsPolicyDefinitionOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) VerifiedpermissionsPolicyDefinitionOutputReference {
	_init_.Initialize()
...
func NewVerifiedpermissionsPolicyDefinitionOutputReference_Override(v VerifiedpermissionsPolicyDefinitionOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_VerifiedpermissionsPolicyDefinitionOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (v *jsiiProxy_VerifiedpermissionsPolicyDefinitionOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (v *jsiiProxy_VerifiedpermissionsPolicyDefinitionOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (v *jsiiProxy_VerifiedpermissionsPolicyDefinitionOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (v *jsiiProxy_VerifiedpermissionsPolicyDefinitionOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
