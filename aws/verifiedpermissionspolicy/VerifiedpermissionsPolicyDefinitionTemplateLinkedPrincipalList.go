...
func (j *jsiiProxy_VerifiedpermissionsPolicyDefinitionTemplateLinkedPrincipalList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewVerifiedpermissionsPolicyDefinitionTemplateLinkedPrincipalList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) VerifiedpermissionsPolicyDefinitionTemplateLinkedPrincipalList {
	_init_.Initialize()
...
func NewVerifiedpermissionsPolicyDefinitionTemplateLinkedPrincipalList_Override(v VerifiedpermissionsPolicyDefinitionTemplateLinkedPrincipalList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_VerifiedpermissionsPolicyDefinitionTemplateLinkedPrincipalList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (v *jsiiProxy_VerifiedpermissionsPolicyDefinitionTemplateLinkedPrincipalList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (v *jsiiProxy_VerifiedpermissionsPolicyDefinitionTemplateLinkedPrincipalList) Resolve(context cdktn.IResolveContext) interface{} {
