...
func (j *jsiiProxy_VerifiedpermissionsPolicyDefinitionTemplateLinkedList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewVerifiedpermissionsPolicyDefinitionTemplateLinkedList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) VerifiedpermissionsPolicyDefinitionTemplateLinkedList {
	_init_.Initialize()
...
func NewVerifiedpermissionsPolicyDefinitionTemplateLinkedList_Override(v VerifiedpermissionsPolicyDefinitionTemplateLinkedList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_VerifiedpermissionsPolicyDefinitionTemplateLinkedList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (v *jsiiProxy_VerifiedpermissionsPolicyDefinitionTemplateLinkedList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (v *jsiiProxy_VerifiedpermissionsPolicyDefinitionTemplateLinkedList) Resolve(context cdktf.IResolveContext) interface{} {
