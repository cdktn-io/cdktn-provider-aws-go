...
func (d *jsiiProxy_DataAwsWafv2RegexPatternSetRegularExpressionList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsWafv2RegexPatternSetRegularExpressionList) Resolve(context cdktf.IResolveContext) interface{} {
