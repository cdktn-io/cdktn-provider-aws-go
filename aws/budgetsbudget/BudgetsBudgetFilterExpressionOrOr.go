...
type BudgetsBudgetFilterExpressionOrOr struct {
	...
	CostCategories *BudgetsBudgetFilterExpressionOrOrCostCategories `field:"optional" json:"costCategories" yaml:"costCategories"`
	// dimensions block.
	//
	...
	Dimensions *BudgetsBudgetFilterExpressionOrOrDimensions `field:"optional" json:"dimensions" yaml:"dimensions"`
	// tags block.
	//
	...
	Tags *BudgetsBudgetFilterExpressionOrOrTags `field:"optional" json:"tags" yaml:"tags"`
}
