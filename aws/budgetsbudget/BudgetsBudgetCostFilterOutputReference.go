...
func (b *jsiiProxy_BudgetsBudgetCostFilterOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (b *jsiiProxy_BudgetsBudgetCostFilterOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
