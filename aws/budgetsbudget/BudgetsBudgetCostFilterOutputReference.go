...
func (j *jsiiProxy_BudgetsBudgetCostFilterOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewBudgetsBudgetCostFilterOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) BudgetsBudgetCostFilterOutputReference {
	_init_.Initialize()
...
func NewBudgetsBudgetCostFilterOutputReference_Override(b BudgetsBudgetCostFilterOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_BudgetsBudgetCostFilterOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (b *jsiiProxy_BudgetsBudgetCostFilterOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (b *jsiiProxy_BudgetsBudgetCostFilterOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (b *jsiiProxy_BudgetsBudgetCostFilterOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (b *jsiiProxy_BudgetsBudgetCostFilterOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
