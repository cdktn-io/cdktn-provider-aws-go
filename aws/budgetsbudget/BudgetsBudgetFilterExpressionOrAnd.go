...
type BudgetsBudgetFilterExpressionOrAnd struct {
	...
	CostCategories *BudgetsBudgetFilterExpressionOrAndCostCategories `field:"optional" json:"costCategories" yaml:"costCategories"`
	// dimensions block.
	//
	...
	Dimensions *BudgetsBudgetFilterExpressionOrAndDimensions `field:"optional" json:"dimensions" yaml:"dimensions"`
	// tags block.
	//
	...
	Tags *BudgetsBudgetFilterExpressionOrAndTags `field:"optional" json:"tags" yaml:"tags"`
}
