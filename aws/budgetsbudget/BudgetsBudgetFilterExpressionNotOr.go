...
type BudgetsBudgetFilterExpressionNotOr struct {
	...
	CostCategories *BudgetsBudgetFilterExpressionNotOrCostCategories `field:"optional" json:"costCategories" yaml:"costCategories"`
	// dimensions block.
	//
	...
	Dimensions *BudgetsBudgetFilterExpressionNotOrDimensions `field:"optional" json:"dimensions" yaml:"dimensions"`
	// tags block.
	//
	...
	Tags *BudgetsBudgetFilterExpressionNotOrTags `field:"optional" json:"tags" yaml:"tags"`
}
