...
func (j *jsiiProxy_BudgetsBudgetNotificationList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewBudgetsBudgetNotificationList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) BudgetsBudgetNotificationList {
	_init_.Initialize()
...
func NewBudgetsBudgetNotificationList_Override(b BudgetsBudgetNotificationList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_BudgetsBudgetNotificationList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (b *jsiiProxy_BudgetsBudgetNotificationList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (b *jsiiProxy_BudgetsBudgetNotificationList) Resolve(context cdktn.IResolveContext) interface{} {
