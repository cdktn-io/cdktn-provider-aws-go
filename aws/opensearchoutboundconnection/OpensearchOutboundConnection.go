...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/opensearch_outbound_connection aws_opensearch_outbound_connection}.
...
func (j *jsiiProxy_OpensearchOutboundConnection) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_OpensearchOutboundConnection) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_OpensearchOutboundConnection) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_OpensearchOutboundConnection) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_OpensearchOutboundConnection) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_OpensearchOutboundConnection) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_OpensearchOutboundConnection) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/opensearch_outbound_connection aws_opensearch_outbound_connection} Resource.
...
func (j *jsiiProxy_OpensearchOutboundConnection)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_OpensearchOutboundConnection)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_OpensearchOutboundConnection)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_OpensearchOutboundConnection)SetRegion(val *string) {
...
func OpensearchOutboundConnection_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (o *jsiiProxy_OpensearchOutboundConnection) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (o *jsiiProxy_OpensearchOutboundConnection) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (o *jsiiProxy_OpensearchOutboundConnection) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (o *jsiiProxy_OpensearchOutboundConnection) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (o *jsiiProxy_OpensearchOutboundConnection) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (o *jsiiProxy_OpensearchOutboundConnection) ResetRegion() {
	_jsii_.InvokeVoid(
		o,
		"resetRegion",
		nil, // no parameters
