...
func (a *jsiiProxy_AlbListenerMutualAuthenticationOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_AlbListenerMutualAuthenticationOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
