...
func (j *jsiiProxy_SsoadminCustomerManagedPolicyAttachment) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_SsoadminCustomerManagedPolicyAttachment) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_SsoadminCustomerManagedPolicyAttachment) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_SsoadminCustomerManagedPolicyAttachment) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_SsoadminCustomerManagedPolicyAttachment) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_SsoadminCustomerManagedPolicyAttachment) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_SsoadminCustomerManagedPolicyAttachment) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/ssoadmin_customer_managed_policy_attachment aws_ssoadmin_customer_managed_policy_attachment} Resource.
func NewSsoadminCustomerManagedPolicyAttachment(scope constructs.Construct, id *string, config *SsoadminCustomerManagedPolicyAttachmentConfig) SsoadminCustomerManagedPolicyAttachment {
	...
	_jsii_.Create(
		"@cdktn/provider-aws.ssoadminCustomerManagedPolicyAttachment.SsoadminCustomerManagedPolicyAttachment",
...
func (j *jsiiProxy_SsoadminCustomerManagedPolicyAttachment)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_SsoadminCustomerManagedPolicyAttachment)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_SsoadminCustomerManagedPolicyAttachment)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_SsoadminCustomerManagedPolicyAttachment)SetRegion(val *string) {
...
func SsoadminCustomerManagedPolicyAttachment_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (s *jsiiProxy_SsoadminCustomerManagedPolicyAttachment) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SsoadminCustomerManagedPolicyAttachment) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_SsoadminCustomerManagedPolicyAttachment) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SsoadminCustomerManagedPolicyAttachment) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_SsoadminCustomerManagedPolicyAttachment) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_SsoadminCustomerManagedPolicyAttachment) ResetRegion() {
	_jsii_.InvokeVoid(
		s,
		"resetRegion",
		nil, // no parameters
...
func (s *jsiiProxy_SsoadminCustomerManagedPolicyAttachment) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
