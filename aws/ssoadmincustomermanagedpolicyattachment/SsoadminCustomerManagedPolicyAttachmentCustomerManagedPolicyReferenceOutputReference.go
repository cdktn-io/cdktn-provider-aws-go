...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v21/ssoadmincustomermanagedpolicyattachment/internal"
...
func (s *jsiiProxy_SsoadminCustomerManagedPolicyAttachmentCustomerManagedPolicyReferenceOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_SsoadminCustomerManagedPolicyAttachmentCustomerManagedPolicyReferenceOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
