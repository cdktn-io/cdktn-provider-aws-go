...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/snssmspreferences/internal"
...
func (j *jsiiProxy_SnsSmsPreferences) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_SnsSmsPreferences) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_SnsSmsPreferences) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_SnsSmsPreferences) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_SnsSmsPreferences) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_SnsSmsPreferences) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_SnsSmsPreferences) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/sns_sms_preferences aws_sns_sms_preferences} Resource.
...
func (j *jsiiProxy_SnsSmsPreferences)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_SnsSmsPreferences)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_SnsSmsPreferences)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_SnsSmsPreferences)SetRegion(val *string) {
...
func SnsSmsPreferences_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (s *jsiiProxy_SnsSmsPreferences) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SnsSmsPreferences) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_SnsSmsPreferences) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SnsSmsPreferences) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_SnsSmsPreferences) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_SnsSmsPreferences) ResetRegion() {
	_jsii_.InvokeVoid(
		s,
		"resetRegion",
		nil, // no parameters
...
func (s *jsiiProxy_SnsSmsPreferences) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
