...
func (j *jsiiProxy_SpotFleetRequestLaunchSpecificationEphemeralBlockDeviceList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewSpotFleetRequestLaunchSpecificationEphemeralBlockDeviceList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) SpotFleetRequestLaunchSpecificationEphemeralBlockDeviceList {
	_init_.Initialize()
...
func NewSpotFleetRequestLaunchSpecificationEphemeralBlockDeviceList_Override(s SpotFleetRequestLaunchSpecificationEphemeralBlockDeviceList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_SpotFleetRequestLaunchSpecificationEphemeralBlockDeviceList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_SpotFleetRequestLaunchSpecificationEphemeralBlockDeviceList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (s *jsiiProxy_SpotFleetRequestLaunchSpecificationEphemeralBlockDeviceList) Resolve(context cdktn.IResolveContext) interface{} {
