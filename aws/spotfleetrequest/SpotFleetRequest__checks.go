...
func (s *jsiiProxy_SpotFleetRequest) validatePutLaunchSpecificationParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*SpotFleetRequestLaunchSpecification; received %#v (a %T)", value, value)
		}
	}
...
func (s *jsiiProxy_SpotFleetRequest) validatePutLaunchTemplateConfigParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*SpotFleetRequestLaunchTemplateConfig; received %#v (a %T)", value, value)
		}
	}
