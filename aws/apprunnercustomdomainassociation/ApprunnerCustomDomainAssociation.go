...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/apprunnercustomdomainassociation/internal"
...
func (j *jsiiProxy_ApprunnerCustomDomainAssociation) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_ApprunnerCustomDomainAssociation) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_ApprunnerCustomDomainAssociation) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_ApprunnerCustomDomainAssociation) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_ApprunnerCustomDomainAssociation) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/apprunner_custom_domain_association aws_apprunner_custom_domain_association} Resource.
...
func (j *jsiiProxy_ApprunnerCustomDomainAssociation)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_ApprunnerCustomDomainAssociation)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_ApprunnerCustomDomainAssociation)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func ApprunnerCustomDomainAssociation_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (a *jsiiProxy_ApprunnerCustomDomainAssociation) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_ApprunnerCustomDomainAssociation) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (a *jsiiProxy_ApprunnerCustomDomainAssociation) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_ApprunnerCustomDomainAssociation) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (a *jsiiProxy_ApprunnerCustomDomainAssociation) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (a *jsiiProxy_ApprunnerCustomDomainAssociation) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
