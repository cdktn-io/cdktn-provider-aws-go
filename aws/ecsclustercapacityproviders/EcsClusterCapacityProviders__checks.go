...
func (e *jsiiProxy_EcsClusterCapacityProviders) validatePutDefaultCapacityProviderStrategyParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*EcsClusterCapacityProvidersDefaultCapacityProviderStrategy; received %#v (a %T)", value, value)
		}
	}
