...
func (d *jsiiProxy_DataAwsEc2NetworkInsightsAnalysisReturnPathComponentsOutboundHeaderSourcePortRangesList) Resolve(context cdktf.IResolveContext) interface{} {
