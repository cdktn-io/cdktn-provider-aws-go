...
func (d *jsiiProxy_DataAwsEc2NetworkInsightsAnalysisExplanationsSourceVpcList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsEc2NetworkInsightsAnalysisExplanationsSourceVpcList) Resolve(context cdktf.IResolveContext) interface{} {
