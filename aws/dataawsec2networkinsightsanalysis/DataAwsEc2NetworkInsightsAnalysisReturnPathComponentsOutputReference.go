...
func (d *jsiiProxy_DataAwsEc2NetworkInsightsAnalysisReturnPathComponentsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataAwsEc2NetworkInsightsAnalysisReturnPathComponentsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
