...
func (d *jsiiProxy_DataAwsEc2NetworkInsightsAnalysisForwardPathComponentsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataAwsEc2NetworkInsightsAnalysisForwardPathComponentsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
