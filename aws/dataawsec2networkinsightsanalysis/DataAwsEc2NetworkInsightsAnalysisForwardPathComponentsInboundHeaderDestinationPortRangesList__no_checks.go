...
func (d *jsiiProxy_DataAwsEc2NetworkInsightsAnalysisForwardPathComponentsInboundHeaderDestinationPortRangesList) validateResolveParameters(context cdktf.IResolveContext) error {
	return nil
}
