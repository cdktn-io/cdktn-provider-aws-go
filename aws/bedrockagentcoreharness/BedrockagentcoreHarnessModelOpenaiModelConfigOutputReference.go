...
func NewBedrockagentcoreHarnessModelOpenaiModelConfigOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) BedrockagentcoreHarnessModelOpenaiModelConfigOutputReference {
	_init_.Initialize()

	if err := validateNewBedrockagentcoreHarnessModelOpenaiModelConfigOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func NewBedrockagentcoreHarnessModelOpenaiModelConfigOutputReference_Override(b BedrockagentcoreHarnessModelOpenaiModelConfigOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
