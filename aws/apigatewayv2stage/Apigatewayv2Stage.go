...
func (j *jsiiProxy_Apigatewayv2Stage) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_Apigatewayv2Stage) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_Apigatewayv2Stage) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_Apigatewayv2Stage) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_Apigatewayv2Stage) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/apigatewayv2_stage aws_apigatewayv2_stage} Resource.
...
func (j *jsiiProxy_Apigatewayv2Stage)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_Apigatewayv2Stage)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_Apigatewayv2Stage)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func Apigatewayv2Stage_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (a *jsiiProxy_Apigatewayv2Stage) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_Apigatewayv2Stage) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (a *jsiiProxy_Apigatewayv2Stage) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_Apigatewayv2Stage) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (a *jsiiProxy_Apigatewayv2Stage) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (a *jsiiProxy_Apigatewayv2Stage) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
