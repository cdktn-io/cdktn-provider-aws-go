...
func (j *jsiiProxy_Apigatewayv2StageRouteSettingsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewApigatewayv2StageRouteSettingsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) Apigatewayv2StageRouteSettingsList {
	_init_.Initialize()
...
func NewApigatewayv2StageRouteSettingsList_Override(a Apigatewayv2StageRouteSettingsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_Apigatewayv2StageRouteSettingsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (a *jsiiProxy_Apigatewayv2StageRouteSettingsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (a *jsiiProxy_Apigatewayv2StageRouteSettingsList) Resolve(context cdktn.IResolveContext) interface{} {
