...
func (a *jsiiProxy_Apigatewayv2StageAccessLogSettingsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_Apigatewayv2StageAccessLogSettingsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
