...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/apigatewayv2stage/internal"
...
func (j *jsiiProxy_Apigatewayv2StageAccessLogSettingsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewApigatewayv2StageAccessLogSettingsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) Apigatewayv2StageAccessLogSettingsOutputReference {
	_init_.Initialize()

	if err := validateNewApigatewayv2StageAccessLogSettingsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewApigatewayv2StageAccessLogSettingsOutputReference_Override(a Apigatewayv2StageAccessLogSettingsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_Apigatewayv2StageAccessLogSettingsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (a *jsiiProxy_Apigatewayv2StageAccessLogSettingsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_Apigatewayv2StageAccessLogSettingsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (a *jsiiProxy_Apigatewayv2StageAccessLogSettingsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_Apigatewayv2StageAccessLogSettingsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
