...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/globalacceleratorcustomroutingaccelerator/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/globalaccelerator_custom_routing_accelerator aws_globalaccelerator_custom_routing_accelerator}.
...
func (j *jsiiProxy_GlobalacceleratorCustomRoutingAccelerator) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_GlobalacceleratorCustomRoutingAccelerator) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_GlobalacceleratorCustomRoutingAccelerator) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_GlobalacceleratorCustomRoutingAccelerator) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_GlobalacceleratorCustomRoutingAccelerator) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/globalaccelerator_custom_routing_accelerator aws_globalaccelerator_custom_routing_accelerator} Resource.
func NewGlobalacceleratorCustomRoutingAccelerator(scope constructs.Construct, id *string, config *GlobalacceleratorCustomRoutingAcceleratorConfig) GlobalacceleratorCustomRoutingAccelerator {
	...
	_jsii_.Create(
		"@cdktn/provider-aws.globalacceleratorCustomRoutingAccelerator.GlobalacceleratorCustomRoutingAccelerator",
...
func (j *jsiiProxy_GlobalacceleratorCustomRoutingAccelerator)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_GlobalacceleratorCustomRoutingAccelerator)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_GlobalacceleratorCustomRoutingAccelerator)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func GlobalacceleratorCustomRoutingAccelerator_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateGlobalacceleratorCustomRoutingAccelerator_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (g *jsiiProxy_GlobalacceleratorCustomRoutingAccelerator) AddMoveTarget(moveTarget *string) {
...
func (g *jsiiProxy_GlobalacceleratorCustomRoutingAccelerator) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GlobalacceleratorCustomRoutingAccelerator) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (g *jsiiProxy_GlobalacceleratorCustomRoutingAccelerator) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GlobalacceleratorCustomRoutingAccelerator) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GlobalacceleratorCustomRoutingAccelerator) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (g *jsiiProxy_GlobalacceleratorCustomRoutingAccelerator) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (g *jsiiProxy_GlobalacceleratorCustomRoutingAccelerator) ToHclTerraform() interface{} {
	var returns interface{}
...
func (g *jsiiProxy_GlobalacceleratorCustomRoutingAccelerator) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
