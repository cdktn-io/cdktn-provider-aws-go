...
func (j *jsiiProxy_GlobalacceleratorCustomRoutingAcceleratorIpSetsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewGlobalacceleratorCustomRoutingAcceleratorIpSetsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) GlobalacceleratorCustomRoutingAcceleratorIpSetsList {
	_init_.Initialize()
...
func NewGlobalacceleratorCustomRoutingAcceleratorIpSetsList_Override(g GlobalacceleratorCustomRoutingAcceleratorIpSetsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_GlobalacceleratorCustomRoutingAcceleratorIpSetsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (g *jsiiProxy_GlobalacceleratorCustomRoutingAcceleratorIpSetsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (g *jsiiProxy_GlobalacceleratorCustomRoutingAcceleratorIpSetsList) Resolve(context cdktn.IResolveContext) interface{} {
