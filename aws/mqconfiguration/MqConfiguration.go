...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/mqconfiguration/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/mq_configuration aws_mq_configuration}.
...
func (j *jsiiProxy_MqConfiguration) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_MqConfiguration) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_MqConfiguration) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_MqConfiguration) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_MqConfiguration) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_MqConfiguration) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_MqConfiguration) SkipDestroy() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"skipDestroy",
...
func (j *jsiiProxy_MqConfiguration) SkipDestroyInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"skipDestroyInput",
...
func (j *jsiiProxy_MqConfiguration) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/mq_configuration aws_mq_configuration} Resource.
...
func (j *jsiiProxy_MqConfiguration)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_MqConfiguration)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_MqConfiguration)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_MqConfiguration)SetRegion(val *string) {
...
func (j *jsiiProxy_MqConfiguration)SetSkipDestroy(val interface{}) {
...
func MqConfiguration_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateMqConfiguration_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (m *jsiiProxy_MqConfiguration) AddMoveTarget(moveTarget *string) {
...
func (m *jsiiProxy_MqConfiguration) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MqConfiguration) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (m *jsiiProxy_MqConfiguration) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MqConfiguration) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (m *jsiiProxy_MqConfiguration) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (m *jsiiProxy_MqConfiguration) ResetRegion() {
	_jsii_.InvokeVoid(
		m,
		"resetRegion",
		nil, // no parameters
...
func (m *jsiiProxy_MqConfiguration) ResetSkipDestroy() {
	_jsii_.InvokeVoid(
		m,
		"resetSkipDestroy",
		nil, // no parameters
...
func (m *jsiiProxy_MqConfiguration) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
