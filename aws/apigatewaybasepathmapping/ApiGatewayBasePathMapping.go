...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/apigatewaybasepathmapping/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/api_gateway_base_path_mapping aws_api_gateway_base_path_mapping}.
...
func (j *jsiiProxy_ApiGatewayBasePathMapping) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_ApiGatewayBasePathMapping) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_ApiGatewayBasePathMapping) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_ApiGatewayBasePathMapping) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_ApiGatewayBasePathMapping) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_ApiGatewayBasePathMapping) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_ApiGatewayBasePathMapping) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/api_gateway_base_path_mapping aws_api_gateway_base_path_mapping} Resource.
func NewApiGatewayBasePathMapping(scope constructs.Construct, id *string, config *ApiGatewayBasePathMappingConfig) ApiGatewayBasePathMapping {
	...
	_jsii_.Create(
		"@cdktn/provider-aws.apiGatewayBasePathMapping.ApiGatewayBasePathMapping",
...
func (j *jsiiProxy_ApiGatewayBasePathMapping)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_ApiGatewayBasePathMapping)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_ApiGatewayBasePathMapping)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_ApiGatewayBasePathMapping)SetRegion(val *string) {
...
func ApiGatewayBasePathMapping_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateApiGatewayBasePathMapping_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (a *jsiiProxy_ApiGatewayBasePathMapping) AddMoveTarget(moveTarget *string) {
...
func (a *jsiiProxy_ApiGatewayBasePathMapping) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_ApiGatewayBasePathMapping) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (a *jsiiProxy_ApiGatewayBasePathMapping) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_ApiGatewayBasePathMapping) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (a *jsiiProxy_ApiGatewayBasePathMapping) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (a *jsiiProxy_ApiGatewayBasePathMapping) ResetRegion() {
	_jsii_.InvokeVoid(
		a,
		"resetRegion",
		nil, // no parameters
...
func (a *jsiiProxy_ApiGatewayBasePathMapping) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
