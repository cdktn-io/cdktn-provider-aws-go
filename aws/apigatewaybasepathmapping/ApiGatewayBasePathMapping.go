...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v22/apigatewaybasepathmapping/internal"
...
func ApiGatewayBasePathMapping_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
