...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/dataawsservicediscoverydnsnamespace/internal"
...
func (d *jsiiProxy_DataAwsServiceDiscoveryDnsNamespace) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsServiceDiscoveryDnsNamespace) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
