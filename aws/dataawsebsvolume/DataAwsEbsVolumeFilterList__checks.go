...
func (d *jsiiProxy_DataAwsEbsVolumeFilterList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (j *jsiiProxy_DataAwsEbsVolumeFilterList) validateSetInternalValueParameters(val interface{}) error {
	...
	case *[]*DataAwsEbsVolumeFilter:
		val := val.(*[]*DataAwsEbsVolumeFilter)
	...
	case []*DataAwsEbsVolumeFilter:
		val_ := val.([]*DataAwsEbsVolumeFilter)
		val := &val_
		for idx_97dfc6, v := range *val {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktn.IResolvable, *[]*DataAwsEbsVolumeFilter; received %#v (a %T)", val, val)
		}
	}
