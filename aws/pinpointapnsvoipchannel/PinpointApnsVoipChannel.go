...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/pinpointapnsvoipchannel/internal"
...
func (p *jsiiProxy_PinpointApnsVoipChannel) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (p *jsiiProxy_PinpointApnsVoipChannel) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (p *jsiiProxy_PinpointApnsVoipChannel) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
