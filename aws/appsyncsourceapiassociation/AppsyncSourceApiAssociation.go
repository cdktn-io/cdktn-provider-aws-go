...
func (a *jsiiProxy_AppsyncSourceApiAssociation) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (a *jsiiProxy_AppsyncSourceApiAssociation) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
