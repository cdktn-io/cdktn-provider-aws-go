...
func (j *jsiiProxy_ElasticacheClusterCacheNodesList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewElasticacheClusterCacheNodesList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ElasticacheClusterCacheNodesList {
	_init_.Initialize()
...
func NewElasticacheClusterCacheNodesList_Override(e ElasticacheClusterCacheNodesList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ElasticacheClusterCacheNodesList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (e *jsiiProxy_ElasticacheClusterCacheNodesList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (e *jsiiProxy_ElasticacheClusterCacheNodesList) Resolve(context cdktn.IResolveContext) interface{} {
