...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-aws.dxLag.DxLagRateLimiterStatus",
		reflect.TypeOf((*DxLagRateLimiterStatus)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-aws.dxLag.DxLagRateLimiterStatusList",
		reflect.TypeOf((*DxLagRateLimiterStatusList)(nil)).Elem(),
		[]_jsii_.Member{
		...
		func() interface{} {
			j := jsiiProxy_DxLagRateLimiterStatusList{}
			_jsii_.InitJsiiProxy(&j.Type__cdktnComplexList)
			return &j
		},
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-aws.dxLag.DxLagRateLimiterStatusOutputReference",
		reflect.TypeOf((*DxLagRateLimiterStatusOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
		...
		func() interface{} {
			j := jsiiProxy_DxLagRateLimiterStatusOutputReference{}
