...
func (j *jsiiProxy_DxLag) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DxLag) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DxLag) JumboFrameCapable() cdktn.IResolvable {
...
func (j *jsiiProxy_DxLag) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DxLag) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DxLag) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DxLag)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DxLag)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DxLag)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DxLag_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DxLag) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DxLag) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (d *jsiiProxy_DxLag) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DxLag) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (d *jsiiProxy_DxLag) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DxLag) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
