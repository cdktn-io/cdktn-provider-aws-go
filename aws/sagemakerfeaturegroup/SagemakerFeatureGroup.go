...
func (j *jsiiProxy_SagemakerFeatureGroup) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_SagemakerFeatureGroup) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_SagemakerFeatureGroup) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_SagemakerFeatureGroup) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_SagemakerFeatureGroup) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/sagemaker_feature_group aws_sagemaker_feature_group} Resource.
...
func (j *jsiiProxy_SagemakerFeatureGroup)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_SagemakerFeatureGroup)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_SagemakerFeatureGroup)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func SagemakerFeatureGroup_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (s *jsiiProxy_SagemakerFeatureGroup) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SagemakerFeatureGroup) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_SagemakerFeatureGroup) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SagemakerFeatureGroup) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_SagemakerFeatureGroup) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_SagemakerFeatureGroup) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
