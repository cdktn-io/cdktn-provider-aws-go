...
func (j *jsiiProxy_SagemakerFeatureGroupThroughputConfigOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewSagemakerFeatureGroupThroughputConfigOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) SagemakerFeatureGroupThroughputConfigOutputReference {
	_init_.Initialize()
...
func NewSagemakerFeatureGroupThroughputConfigOutputReference_Override(s SagemakerFeatureGroupThroughputConfigOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_SagemakerFeatureGroupThroughputConfigOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_SagemakerFeatureGroupThroughputConfigOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SagemakerFeatureGroupThroughputConfigOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (s *jsiiProxy_SagemakerFeatureGroupThroughputConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SagemakerFeatureGroupThroughputConfigOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
