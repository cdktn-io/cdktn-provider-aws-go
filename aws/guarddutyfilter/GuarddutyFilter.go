...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/guarddutyfilter/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/guardduty_filter aws_guardduty_filter}.
...
func (j *jsiiProxy_GuarddutyFilter) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_GuarddutyFilter) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_GuarddutyFilter) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_GuarddutyFilter) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_GuarddutyFilter) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_GuarddutyFilter) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_GuarddutyFilter) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/guardduty_filter aws_guardduty_filter} Resource.
...
func (j *jsiiProxy_GuarddutyFilter)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_GuarddutyFilter)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_GuarddutyFilter)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_GuarddutyFilter)SetRegion(val *string) {
...
func GuarddutyFilter_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateGuarddutyFilter_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (g *jsiiProxy_GuarddutyFilter) AddMoveTarget(moveTarget *string) {
...
func (g *jsiiProxy_GuarddutyFilter) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GuarddutyFilter) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (g *jsiiProxy_GuarddutyFilter) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GuarddutyFilter) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GuarddutyFilter) MoveFromId(id *string) {
...
func (g *jsiiProxy_GuarddutyFilter) MoveToId(id *string) {
...
func (g *jsiiProxy_GuarddutyFilter) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (g *jsiiProxy_GuarddutyFilter) ResetRegion() {
	_jsii_.InvokeVoid(
		g,
		"resetRegion",
		nil, // no parameters
...
func (g *jsiiProxy_GuarddutyFilter) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
