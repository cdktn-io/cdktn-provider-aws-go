...
func (j *jsiiProxy_GuarddutyFilterFindingCriteriaOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewGuarddutyFilterFindingCriteriaOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) GuarddutyFilterFindingCriteriaOutputReference {
	_init_.Initialize()

	if err := validateNewGuarddutyFilterFindingCriteriaOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewGuarddutyFilterFindingCriteriaOutputReference_Override(g GuarddutyFilterFindingCriteriaOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_GuarddutyFilterFindingCriteriaOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (g *jsiiProxy_GuarddutyFilterFindingCriteriaOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GuarddutyFilterFindingCriteriaOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (g *jsiiProxy_GuarddutyFilterFindingCriteriaOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GuarddutyFilterFindingCriteriaOutputReference) PutCriterion(value interface{}) {
	if err := g.validatePutCriterionParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		g,
...
func (g *jsiiProxy_GuarddutyFilterFindingCriteriaOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
