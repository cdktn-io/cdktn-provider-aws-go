...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/codestarnotificationsnotificationrule/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/codestarnotifications_notification_rule aws_codestarnotifications_notification_rule}.
...
func (j *jsiiProxy_CodestarnotificationsNotificationRule) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_CodestarnotificationsNotificationRule) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_CodestarnotificationsNotificationRule) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_CodestarnotificationsNotificationRule) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_CodestarnotificationsNotificationRule) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_CodestarnotificationsNotificationRule) Target() CodestarnotificationsNotificationRuleTargetList {
	var returns CodestarnotificationsNotificationRuleTargetList
	_jsii_.Get(
		j,
		"target",
		&returns,
...
func (j *jsiiProxy_CodestarnotificationsNotificationRule) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/codestarnotifications_notification_rule aws_codestarnotifications_notification_rule} Resource.
func NewCodestarnotificationsNotificationRule(scope constructs.Construct, id *string, config *CodestarnotificationsNotificationRuleConfig) CodestarnotificationsNotificationRule {
	...
	if err := validateNewCodestarnotificationsNotificationRuleParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CodestarnotificationsNotificationRule)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_CodestarnotificationsNotificationRule)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_CodestarnotificationsNotificationRule)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func CodestarnotificationsNotificationRule_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateCodestarnotificationsNotificationRule_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (c *jsiiProxy_CodestarnotificationsNotificationRule) AddMoveTarget(moveTarget *string) {
...
func (c *jsiiProxy_CodestarnotificationsNotificationRule) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CodestarnotificationsNotificationRule) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (c *jsiiProxy_CodestarnotificationsNotificationRule) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CodestarnotificationsNotificationRule) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_CodestarnotificationsNotificationRule) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (c *jsiiProxy_CodestarnotificationsNotificationRule) ResetId() {
	_jsii_.InvokeVoid(
		c,
		"resetId",
		nil, // no parameters
...
func (c *jsiiProxy_CodestarnotificationsNotificationRule) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
