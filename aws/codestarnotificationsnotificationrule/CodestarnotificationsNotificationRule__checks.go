...
func (c *jsiiProxy_CodestarnotificationsNotificationRule) validatePutTargetParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*CodestarnotificationsNotificationRuleTarget; received %#v (a %T)", value, value)
		}
	}
