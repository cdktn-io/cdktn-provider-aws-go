...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/sqsqueuepolicy/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/sqs_queue_policy aws_sqs_queue_policy}.
...
func (j *jsiiProxy_SqsQueuePolicy) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_SqsQueuePolicy) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_SqsQueuePolicy) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_SqsQueuePolicy) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_SqsQueuePolicy) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_SqsQueuePolicy) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_SqsQueuePolicy) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/sqs_queue_policy aws_sqs_queue_policy} Resource.
func NewSqsQueuePolicy(scope constructs.Construct, id *string, config *SqsQueuePolicyConfig) SqsQueuePolicy {
	_init_.Initialize()

	if err := validateNewSqsQueuePolicyParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_SqsQueuePolicy)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_SqsQueuePolicy)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_SqsQueuePolicy)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_SqsQueuePolicy)SetRegion(val *string) {
...
// Generates CDKTN code for importing a SqsQueuePolicy resource upon running "cdktn plan <stack-name>".
func SqsQueuePolicy_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateSqsQueuePolicy_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func SqsQueuePolicy_IsConstruct(x interface{}) *bool {
	...
	if err := validateSqsQueuePolicy_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func SqsQueuePolicy_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateSqsQueuePolicy_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func SqsQueuePolicy_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateSqsQueuePolicy_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (s *jsiiProxy_SqsQueuePolicy) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_SqsQueuePolicy) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SqsQueuePolicy) HasResourceMove() interface{} {
	var returns interface{}
...
func (s *jsiiProxy_SqsQueuePolicy) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_SqsQueuePolicy) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SqsQueuePolicy) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_SqsQueuePolicy) MoveFromId(id *string) {
...
func (s *jsiiProxy_SqsQueuePolicy) MoveTo(moveTarget *string, index interface{}) {
...
func (s *jsiiProxy_SqsQueuePolicy) MoveToId(id *string) {
...
func (s *jsiiProxy_SqsQueuePolicy) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_SqsQueuePolicy) ResetRegion() {
	_jsii_.InvokeVoid(
		s,
		"resetRegion",
		nil, // no parameters
...
func (s *jsiiProxy_SqsQueuePolicy) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (s *jsiiProxy_SqsQueuePolicy) ToHclTerraform() interface{} {
	var returns interface{}
...
func (s *jsiiProxy_SqsQueuePolicy) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
