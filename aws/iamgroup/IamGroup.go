...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/iamgroup/internal"
...
func (j *jsiiProxy_IamGroup) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_IamGroup) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_IamGroup) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_IamGroup) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_IamGroup) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/iam_group aws_iam_group} Resource.
...
func (j *jsiiProxy_IamGroup)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_IamGroup)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_IamGroup)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func IamGroup_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (i *jsiiProxy_IamGroup) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (i *jsiiProxy_IamGroup) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (i *jsiiProxy_IamGroup) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (i *jsiiProxy_IamGroup) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (i *jsiiProxy_IamGroup) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (i *jsiiProxy_IamGroup) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
