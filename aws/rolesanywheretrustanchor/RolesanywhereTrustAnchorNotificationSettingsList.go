...
func (j *jsiiProxy_RolesanywhereTrustAnchorNotificationSettingsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewRolesanywhereTrustAnchorNotificationSettingsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) RolesanywhereTrustAnchorNotificationSettingsList {
	_init_.Initialize()
...
func NewRolesanywhereTrustAnchorNotificationSettingsList_Override(r RolesanywhereTrustAnchorNotificationSettingsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_RolesanywhereTrustAnchorNotificationSettingsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (r *jsiiProxy_RolesanywhereTrustAnchorNotificationSettingsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (r *jsiiProxy_RolesanywhereTrustAnchorNotificationSettingsList) Resolve(context cdktn.IResolveContext) interface{} {
