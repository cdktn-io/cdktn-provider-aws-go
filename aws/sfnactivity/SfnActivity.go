...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/sfnactivity/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/sfn_activity aws_sfn_activity}.
...
func (j *jsiiProxy_SfnActivity) Arn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"arn",
...
func (j *jsiiProxy_SfnActivity) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_SfnActivity) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_SfnActivity) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_SfnActivity) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_SfnActivity) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_SfnActivity) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_SfnActivity) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/sfn_activity aws_sfn_activity} Resource.
...
func (j *jsiiProxy_SfnActivity)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_SfnActivity)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_SfnActivity)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_SfnActivity)SetRegion(val *string) {
...
func SfnActivity_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateSfnActivity_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_SfnActivity) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_SfnActivity) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SfnActivity) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_SfnActivity) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SfnActivity) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_SfnActivity) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_SfnActivity) ResetRegion() {
	_jsii_.InvokeVoid(
		s,
		"resetRegion",
		nil, // no parameters
...
func (s *jsiiProxy_SfnActivity) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
