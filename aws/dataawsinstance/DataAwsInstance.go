...
func (j *jsiiProxy_DataAwsInstance) LaunchTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"launchTime",
...
func (j *jsiiProxy_DataAwsInstance) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DataAwsInstance) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.34.0/docs/data-sources/instance aws_instance} Data Source.
...
func (j *jsiiProxy_DataAwsInstance)SetRegion(val *string) {
...
func (d *jsiiProxy_DataAwsInstance) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsInstance) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
