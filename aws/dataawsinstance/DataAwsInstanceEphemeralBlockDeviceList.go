...
func (j *jsiiProxy_DataAwsInstanceEphemeralBlockDeviceList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsInstanceEphemeralBlockDeviceList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsInstanceEphemeralBlockDeviceList {
	_init_.Initialize()
...
func NewDataAwsInstanceEphemeralBlockDeviceList_Override(d DataAwsInstanceEphemeralBlockDeviceList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsInstanceEphemeralBlockDeviceList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsInstanceEphemeralBlockDeviceList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsInstanceEphemeralBlockDeviceList) Resolve(context cdktn.IResolveContext) interface{} {
