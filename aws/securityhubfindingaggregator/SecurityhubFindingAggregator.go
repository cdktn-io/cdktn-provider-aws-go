...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/securityhubfindingaggregator/internal"
...
func (j *jsiiProxy_SecurityhubFindingAggregator) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_SecurityhubFindingAggregator) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_SecurityhubFindingAggregator) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_SecurityhubFindingAggregator) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_SecurityhubFindingAggregator)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_SecurityhubFindingAggregator)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_SecurityhubFindingAggregator)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func SecurityhubFindingAggregator_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (s *jsiiProxy_SecurityhubFindingAggregator) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SecurityhubFindingAggregator) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_SecurityhubFindingAggregator) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SecurityhubFindingAggregator) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_SecurityhubFindingAggregator) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_SecurityhubFindingAggregator) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
