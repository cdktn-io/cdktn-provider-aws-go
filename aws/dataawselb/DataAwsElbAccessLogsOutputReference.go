...
func (d *jsiiProxy_DataAwsElbAccessLogsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataAwsElbAccessLogsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
