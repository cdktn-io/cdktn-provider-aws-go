...
func (j *jsiiProxy_DataAwsElb) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DataAwsElb) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_DataAwsElb)SetRegion(val *string) {
...
func (d *jsiiProxy_DataAwsElb) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsElb) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsElb) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
