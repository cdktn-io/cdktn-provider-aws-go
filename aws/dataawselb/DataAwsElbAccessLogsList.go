...
func (j *jsiiProxy_DataAwsElbAccessLogsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsElbAccessLogsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsElbAccessLogsList {
	_init_.Initialize()
...
func NewDataAwsElbAccessLogsList_Override(d DataAwsElbAccessLogsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsElbAccessLogsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsElbAccessLogsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsElbAccessLogsList) Resolve(context cdktn.IResolveContext) interface{} {
