...
func (d *jsiiProxy_DataAwsElbListenerOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataAwsElbListenerOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
