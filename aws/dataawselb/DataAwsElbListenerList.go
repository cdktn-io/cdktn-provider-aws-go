...
func (j *jsiiProxy_DataAwsElbListenerList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsElbListenerList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsElbListenerList {
	_init_.Initialize()
...
func NewDataAwsElbListenerList_Override(d DataAwsElbListenerList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsElbListenerList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsElbListenerList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsElbListenerList) Resolve(context cdktn.IResolveContext) interface{} {
