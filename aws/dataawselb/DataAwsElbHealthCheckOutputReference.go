...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v21/dataawselb/internal"
...
func (d *jsiiProxy_DataAwsElbHealthCheckOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataAwsElbHealthCheckOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
