...
func (j *jsiiProxy_DataAwsElbHealthCheckList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsElbHealthCheckList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsElbHealthCheckList {
	_init_.Initialize()
...
func NewDataAwsElbHealthCheckList_Override(d DataAwsElbHealthCheckList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsElbHealthCheckList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsElbHealthCheckList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsElbHealthCheckList) Resolve(context cdktn.IResolveContext) interface{} {
