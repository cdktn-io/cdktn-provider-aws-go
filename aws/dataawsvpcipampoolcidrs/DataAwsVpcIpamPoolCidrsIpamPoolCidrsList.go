...
func (j *jsiiProxy_DataAwsVpcIpamPoolCidrsIpamPoolCidrsList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_DataAwsVpcIpamPoolCidrsIpamPoolCidrsList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_DataAwsVpcIpamPoolCidrsIpamPoolCidrsList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (j *jsiiProxy_DataAwsVpcIpamPoolCidrsIpamPoolCidrsList)SetTerraformAttribute(val *string) {
...
func (j *jsiiProxy_DataAwsVpcIpamPoolCidrsIpamPoolCidrsList)SetWrapsSet(val *bool) {
...
func (d *jsiiProxy_DataAwsVpcIpamPoolCidrsIpamPoolCidrsList) ComputeFqn() *string {
	var returns *string
...
func (d *jsiiProxy_DataAwsVpcIpamPoolCidrsIpamPoolCidrsList) Get(index *float64) DataAwsVpcIpamPoolCidrsIpamPoolCidrsOutputReference {
	if err := d.validateGetParameters(index); err != nil {
		panic(err)
	}
	var returns DataAwsVpcIpamPoolCidrsIpamPoolCidrsOutputReference
...
func (d *jsiiProxy_DataAwsVpcIpamPoolCidrsIpamPoolCidrsList) ToString() *string {
	var returns *string
