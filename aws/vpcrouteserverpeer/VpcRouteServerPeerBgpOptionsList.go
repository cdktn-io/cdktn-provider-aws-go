...
func (j *jsiiProxy_VpcRouteServerPeerBgpOptionsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewVpcRouteServerPeerBgpOptionsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) VpcRouteServerPeerBgpOptionsList {
	_init_.Initialize()
...
func NewVpcRouteServerPeerBgpOptionsList_Override(v VpcRouteServerPeerBgpOptionsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_VpcRouteServerPeerBgpOptionsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (v *jsiiProxy_VpcRouteServerPeerBgpOptionsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (v *jsiiProxy_VpcRouteServerPeerBgpOptionsList) Resolve(context cdktn.IResolveContext) interface{} {
