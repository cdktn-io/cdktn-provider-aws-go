...
func (j *jsiiProxy_BedrockagentKnowledgeBase) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_BedrockagentKnowledgeBase) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_BedrockagentKnowledgeBase) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_BedrockagentKnowledgeBase) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_BedrockagentKnowledgeBase) TagsAll() cdktf.StringMap {
...
func (j *jsiiProxy_BedrockagentKnowledgeBase) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.32.1/docs/resources/bedrockagent_knowledge_base aws_bedrockagent_knowledge_base} Resource.
...
func (j *jsiiProxy_BedrockagentKnowledgeBase)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_BedrockagentKnowledgeBase)SetLifecycle(val *cdktf.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_BedrockagentKnowledgeBase)SetProvider(val cdktf.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func BedrockagentKnowledgeBase_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (b *jsiiProxy_BedrockagentKnowledgeBase) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (b *jsiiProxy_BedrockagentKnowledgeBase) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (b *jsiiProxy_BedrockagentKnowledgeBase) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
