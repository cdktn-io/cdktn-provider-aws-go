...
func (b *jsiiProxy_BedrockagentKnowledgeBaseStorageConfigurationRdsConfigurationFieldMappingOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
