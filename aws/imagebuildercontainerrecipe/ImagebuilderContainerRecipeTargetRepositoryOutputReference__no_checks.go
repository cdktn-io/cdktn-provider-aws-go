...
func (i *jsiiProxy_ImagebuilderContainerRecipeTargetRepositoryOutputReference) validateResolveParameters(context cdktf.IResolveContext) error {
	return nil
}
...
func (j *jsiiProxy_ImagebuilderContainerRecipeTargetRepositoryOutputReference) validateSetInternalValueParameters(val *ImagebuilderContainerRecipeTargetRepository) error {
	return nil
}
