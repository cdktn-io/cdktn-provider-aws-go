...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/ecrregistryscanningconfiguration/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/ecr_registry_scanning_configuration aws_ecr_registry_scanning_configuration}.
...
func (j *jsiiProxy_EcrRegistryScanningConfiguration) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_EcrRegistryScanningConfiguration) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_EcrRegistryScanningConfiguration) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_EcrRegistryScanningConfiguration) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_EcrRegistryScanningConfiguration) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/ecr_registry_scanning_configuration aws_ecr_registry_scanning_configuration} Resource.
...
func (j *jsiiProxy_EcrRegistryScanningConfiguration)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_EcrRegistryScanningConfiguration)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_EcrRegistryScanningConfiguration)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func EcrRegistryScanningConfiguration_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (e *jsiiProxy_EcrRegistryScanningConfiguration) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (e *jsiiProxy_EcrRegistryScanningConfiguration) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (e *jsiiProxy_EcrRegistryScanningConfiguration) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (e *jsiiProxy_EcrRegistryScanningConfiguration) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (e *jsiiProxy_EcrRegistryScanningConfiguration) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (e *jsiiProxy_EcrRegistryScanningConfiguration) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
