...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/cloudsearchdomainserviceaccesspolicy/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/cloudsearch_domain_service_access_policy aws_cloudsearch_domain_service_access_policy}.
...
func (j *jsiiProxy_CloudsearchDomainServiceAccessPolicy) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_CloudsearchDomainServiceAccessPolicy) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_CloudsearchDomainServiceAccessPolicy) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_CloudsearchDomainServiceAccessPolicy) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_CloudsearchDomainServiceAccessPolicy) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_CloudsearchDomainServiceAccessPolicy) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_CloudsearchDomainServiceAccessPolicy) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/cloudsearch_domain_service_access_policy aws_cloudsearch_domain_service_access_policy} Resource.
func NewCloudsearchDomainServiceAccessPolicy(scope constructs.Construct, id *string, config *CloudsearchDomainServiceAccessPolicyConfig) CloudsearchDomainServiceAccessPolicy {
	...
	_jsii_.Create(
		"@cdktn/provider-aws.cloudsearchDomainServiceAccessPolicy.CloudsearchDomainServiceAccessPolicy",
...
func (j *jsiiProxy_CloudsearchDomainServiceAccessPolicy)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_CloudsearchDomainServiceAccessPolicy)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_CloudsearchDomainServiceAccessPolicy)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_CloudsearchDomainServiceAccessPolicy)SetRegion(val *string) {
...
func CloudsearchDomainServiceAccessPolicy_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (c *jsiiProxy_CloudsearchDomainServiceAccessPolicy) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CloudsearchDomainServiceAccessPolicy) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (c *jsiiProxy_CloudsearchDomainServiceAccessPolicy) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CloudsearchDomainServiceAccessPolicy) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_CloudsearchDomainServiceAccessPolicy) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (c *jsiiProxy_CloudsearchDomainServiceAccessPolicy) ResetRegion() {
	_jsii_.InvokeVoid(
		c,
		"resetRegion",
		nil, // no parameters
...
func (c *jsiiProxy_CloudsearchDomainServiceAccessPolicy) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
