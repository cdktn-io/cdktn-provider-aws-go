...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/dbsnapshot/internal"
...
func (j *jsiiProxy_DbSnapshot) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DbSnapshot) Encrypted() cdktn.IResolvable {
...
func (j *jsiiProxy_DbSnapshot) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DbSnapshot) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DbSnapshot) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DbSnapshot) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/db_snapshot aws_db_snapshot} Resource.
func NewDbSnapshot(scope constructs.Construct, id *string, config *DbSnapshotConfig) DbSnapshot {
	...
	_jsii_.Create(
		"@cdktn/provider-aws.dbSnapshot.DbSnapshot",
...
func (j *jsiiProxy_DbSnapshot)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DbSnapshot)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DbSnapshot)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DbSnapshot_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DbSnapshot) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DbSnapshot) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (d *jsiiProxy_DbSnapshot) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DbSnapshot) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (d *jsiiProxy_DbSnapshot) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DbSnapshot) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
