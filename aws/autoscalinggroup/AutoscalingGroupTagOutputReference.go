...
func (a *jsiiProxy_AutoscalingGroupTagOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_AutoscalingGroupTagOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
