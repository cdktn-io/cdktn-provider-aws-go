...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/autoscaling_group aws_autoscaling_group}.
type AutoscalingGroup interface {
	...
	InstanceLifecyclePolicy() AutoscalingGroupInstanceLifecyclePolicyOutputReference
	InstanceLifecyclePolicyInput() *AutoscalingGroupInstanceLifecyclePolicy
	...
	PutInstanceLifecyclePolicy(value *AutoscalingGroupInstanceLifecyclePolicy)
...
func (j *jsiiProxy_AutoscalingGroup) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_AutoscalingGroup) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_AutoscalingGroup) InstanceLifecyclePolicy() AutoscalingGroupInstanceLifecyclePolicyOutputReference {
	var returns AutoscalingGroupInstanceLifecyclePolicyOutputReference
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_AutoscalingGroup) InstanceLifecyclePolicyInput() *AutoscalingGroupInstanceLifecyclePolicy {
...
func (j *jsiiProxy_AutoscalingGroup) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_AutoscalingGroup) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_AutoscalingGroup) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/autoscaling_group aws_autoscaling_group} Resource.
...
func (j *jsiiProxy_AutoscalingGroup)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_AutoscalingGroup)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_AutoscalingGroup)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func AutoscalingGroup_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (a *jsiiProxy_AutoscalingGroup) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AutoscalingGroup) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (a *jsiiProxy_AutoscalingGroup) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AutoscalingGroup) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (a *jsiiProxy_AutoscalingGroup) PutInstanceLifecyclePolicy(value *AutoscalingGroupInstanceLifecyclePolicy) {
...
func (a *jsiiProxy_AutoscalingGroup) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (a *jsiiProxy_AutoscalingGroup) ResetInstanceLifecyclePolicy() {
	_jsii_.InvokeVoid(
		a,
		"resetInstanceLifecyclePolicy",
		nil, // no parameters
...
func (a *jsiiProxy_AutoscalingGroup) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
