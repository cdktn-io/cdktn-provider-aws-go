...
func (j *jsiiProxy_AutoscalingGroupTimeoutsOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_AutoscalingGroupTimeoutsOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_AutoscalingGroupTimeoutsOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_AutoscalingGroupTimeoutsOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_AutoscalingGroupTimeoutsOutputReference) Update() *string {
	var returns *string
	_jsii_.Get(
		j,
		"update",
...
func (j *jsiiProxy_AutoscalingGroupTimeoutsOutputReference) UpdateInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"updateInput",
...
func (j *jsiiProxy_AutoscalingGroupTimeoutsOutputReference)SetComplexObjectIndex(val interface{}) {
...
func (j *jsiiProxy_AutoscalingGroupTimeoutsOutputReference)SetComplexObjectIsFromSet(val *bool) {
...
func (j *jsiiProxy_AutoscalingGroupTimeoutsOutputReference)SetInternalValue(val interface{}) {
...
func (j *jsiiProxy_AutoscalingGroupTimeoutsOutputReference)SetUpdate(val *string) {
...
func (a *jsiiProxy_AutoscalingGroupTimeoutsOutputReference) ComputeFqn() *string {
	var returns *string
...
func (a *jsiiProxy_AutoscalingGroupTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_AutoscalingGroupTimeoutsOutputReference) ResetUpdate() {
	_jsii_.InvokeVoid(
		a,
		"resetUpdate",
		nil, // no parameters
...
func (a *jsiiProxy_AutoscalingGroupTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
...
func (a *jsiiProxy_AutoscalingGroupTimeoutsOutputReference) ToString() *string {
	var returns *string
