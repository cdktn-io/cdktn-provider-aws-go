...
func (l *jsiiProxy_LbTargetGroupTargetGroupHealthOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LbTargetGroupTargetGroupHealthOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
