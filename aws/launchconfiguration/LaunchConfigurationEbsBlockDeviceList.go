...
func (l *jsiiProxy_LaunchConfigurationEbsBlockDeviceList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (l *jsiiProxy_LaunchConfigurationEbsBlockDeviceList) Resolve(context cdktf.IResolveContext) interface{} {
