...
func (j *jsiiProxy_LaunchConfigurationEbsBlockDeviceList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewLaunchConfigurationEbsBlockDeviceList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) LaunchConfigurationEbsBlockDeviceList {
	_init_.Initialize()

	if err := validateNewLaunchConfigurationEbsBlockDeviceListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewLaunchConfigurationEbsBlockDeviceList_Override(l LaunchConfigurationEbsBlockDeviceList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_LaunchConfigurationEbsBlockDeviceList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (l *jsiiProxy_LaunchConfigurationEbsBlockDeviceList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (l *jsiiProxy_LaunchConfigurationEbsBlockDeviceList) Resolve(context cdktn.IResolveContext) interface{} {
