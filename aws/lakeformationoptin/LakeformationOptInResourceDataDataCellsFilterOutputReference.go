...
func (l *jsiiProxy_LakeformationOptInResourceDataDataCellsFilterOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LakeformationOptInResourceDataDataCellsFilterOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
