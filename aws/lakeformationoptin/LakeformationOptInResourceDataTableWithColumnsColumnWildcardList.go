...
func (j *jsiiProxy_LakeformationOptInResourceDataTableWithColumnsColumnWildcardList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewLakeformationOptInResourceDataTableWithColumnsColumnWildcardList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) LakeformationOptInResourceDataTableWithColumnsColumnWildcardList {
	_init_.Initialize()
...
func NewLakeformationOptInResourceDataTableWithColumnsColumnWildcardList_Override(l LakeformationOptInResourceDataTableWithColumnsColumnWildcardList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_LakeformationOptInResourceDataTableWithColumnsColumnWildcardList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (l *jsiiProxy_LakeformationOptInResourceDataTableWithColumnsColumnWildcardList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (l *jsiiProxy_LakeformationOptInResourceDataTableWithColumnsColumnWildcardList) Resolve(context cdktf.IResolveContext) interface{} {
