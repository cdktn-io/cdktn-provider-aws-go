...
func (l *jsiiProxy_LakeformationOptInResourceDataLfTagPolicyOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LakeformationOptInResourceDataLfTagPolicyOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
