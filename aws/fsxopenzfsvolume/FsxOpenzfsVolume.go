...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/fsxopenzfsvolume/internal"
...
func (j *jsiiProxy_FsxOpenzfsVolume) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_FsxOpenzfsVolume) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_FsxOpenzfsVolume) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_FsxOpenzfsVolume) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_FsxOpenzfsVolume) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/fsx_openzfs_volume aws_fsx_openzfs_volume} Resource.
...
func (j *jsiiProxy_FsxOpenzfsVolume)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_FsxOpenzfsVolume)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_FsxOpenzfsVolume)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func FsxOpenzfsVolume_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (f *jsiiProxy_FsxOpenzfsVolume) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (f *jsiiProxy_FsxOpenzfsVolume) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (f *jsiiProxy_FsxOpenzfsVolume) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (f *jsiiProxy_FsxOpenzfsVolume) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (f *jsiiProxy_FsxOpenzfsVolume) MoveFromId(id *string) {
...
func (f *jsiiProxy_FsxOpenzfsVolume) MoveToId(id *string) {
...
func (f *jsiiProxy_FsxOpenzfsVolume) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
