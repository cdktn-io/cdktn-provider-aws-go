...
func (f *jsiiProxy_FsxOpenzfsVolumeTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (f *jsiiProxy_FsxOpenzfsVolumeTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
