...
func (j *jsiiProxy_FsxOpenzfsVolumeUserAndGroupQuotasOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewFsxOpenzfsVolumeUserAndGroupQuotasOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) FsxOpenzfsVolumeUserAndGroupQuotasOutputReference {
	_init_.Initialize()
...
func NewFsxOpenzfsVolumeUserAndGroupQuotasOutputReference_Override(f FsxOpenzfsVolumeUserAndGroupQuotasOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_FsxOpenzfsVolumeUserAndGroupQuotasOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (f *jsiiProxy_FsxOpenzfsVolumeUserAndGroupQuotasOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (f *jsiiProxy_FsxOpenzfsVolumeUserAndGroupQuotasOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (f *jsiiProxy_FsxOpenzfsVolumeUserAndGroupQuotasOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (f *jsiiProxy_FsxOpenzfsVolumeUserAndGroupQuotasOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
