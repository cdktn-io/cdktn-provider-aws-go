...
func (f *jsiiProxy_FsxOpenzfsVolumeNfsExportsClientConfigurationsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (f *jsiiProxy_FsxOpenzfsVolumeNfsExportsClientConfigurationsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
