...
func (j *jsiiProxy_FsxOpenzfsVolumeUserAndGroupQuotasList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewFsxOpenzfsVolumeUserAndGroupQuotasList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) FsxOpenzfsVolumeUserAndGroupQuotasList {
	_init_.Initialize()
...
func NewFsxOpenzfsVolumeUserAndGroupQuotasList_Override(f FsxOpenzfsVolumeUserAndGroupQuotasList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_FsxOpenzfsVolumeUserAndGroupQuotasList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (f *jsiiProxy_FsxOpenzfsVolumeUserAndGroupQuotasList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (f *jsiiProxy_FsxOpenzfsVolumeUserAndGroupQuotasList) Resolve(context cdktn.IResolveContext) interface{} {
