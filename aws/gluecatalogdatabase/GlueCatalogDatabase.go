...
func (j *jsiiProxy_GlueCatalogDatabase) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_GlueCatalogDatabase) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_GlueCatalogDatabase) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_GlueCatalogDatabase) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_GlueCatalogDatabase) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/glue_catalog_database aws_glue_catalog_database} Resource.
...
func (j *jsiiProxy_GlueCatalogDatabase)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_GlueCatalogDatabase)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_GlueCatalogDatabase)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func GlueCatalogDatabase_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (g *jsiiProxy_GlueCatalogDatabase) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GlueCatalogDatabase) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (g *jsiiProxy_GlueCatalogDatabase) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GlueCatalogDatabase) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GlueCatalogDatabase) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (g *jsiiProxy_GlueCatalogDatabase) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
