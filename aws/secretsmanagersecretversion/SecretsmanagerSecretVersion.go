...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/secretsmanagersecretversion/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/secretsmanager_secret_version aws_secretsmanager_secret_version}.
type SecretsmanagerSecretVersion interface {
	...
	HasSecretStringWo() cdktn.IResolvable
	Id() *string
	SetId(val *string)
	IdInput() *string
	// Experimental.
...
func (j *jsiiProxy_SecretsmanagerSecretVersion) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_SecretsmanagerSecretVersion) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_SecretsmanagerSecretVersion) HasSecretStringWo() cdktn.IResolvable {
...
func (j *jsiiProxy_SecretsmanagerSecretVersion) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_SecretsmanagerSecretVersion) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_SecretsmanagerSecretVersion) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/secretsmanager_secret_version aws_secretsmanager_secret_version} Resource.
...
func (j *jsiiProxy_SecretsmanagerSecretVersion)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_SecretsmanagerSecretVersion)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_SecretsmanagerSecretVersion)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func SecretsmanagerSecretVersion_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (s *jsiiProxy_SecretsmanagerSecretVersion) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SecretsmanagerSecretVersion) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_SecretsmanagerSecretVersion) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SecretsmanagerSecretVersion) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_SecretsmanagerSecretVersion) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_SecretsmanagerSecretVersion) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
