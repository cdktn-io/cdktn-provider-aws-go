...
func (d *jsiiProxy_DataAwsAuditmanagerControlControlMappingSourcesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataAwsAuditmanagerControlControlMappingSourcesOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
