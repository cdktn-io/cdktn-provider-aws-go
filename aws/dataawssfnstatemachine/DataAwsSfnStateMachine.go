...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/dataawssfnstatemachine/internal"
...
func (j *jsiiProxy_DataAwsSfnStateMachine) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsSfnStateMachine) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsSfnStateMachine) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsSfnStateMachine) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsSfnStateMachine) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DataAwsSfnStateMachine) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_DataAwsSfnStateMachine) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func NewDataAwsSfnStateMachine(scope constructs.Construct, id *string, config *DataAwsSfnStateMachineConfig) DataAwsSfnStateMachine {
	...
	_jsii_.Create(
		"@cdktn/provider-aws.dataAwsSfnStateMachine.DataAwsSfnStateMachine",
...
func (j *jsiiProxy_DataAwsSfnStateMachine)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsSfnStateMachine)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsSfnStateMachine)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_DataAwsSfnStateMachine)SetRegion(val *string) {
...
func DataAwsSfnStateMachine_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsSfnStateMachine) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsSfnStateMachine) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsSfnStateMachine) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsSfnStateMachine) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsSfnStateMachine) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
