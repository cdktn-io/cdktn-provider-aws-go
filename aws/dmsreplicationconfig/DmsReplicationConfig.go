...
func (j *jsiiProxy_DmsReplicationConfig) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DmsReplicationConfig) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.51.0/docs/resources/dms_replication_config aws_dms_replication_config} Resource.
...
func (j *jsiiProxy_DmsReplicationConfig)SetRegion(val *string) {
...
func (d *jsiiProxy_DmsReplicationConfig) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
