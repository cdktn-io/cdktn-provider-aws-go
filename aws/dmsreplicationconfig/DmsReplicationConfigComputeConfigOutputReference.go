...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v23/dmsreplicationconfig/internal"
...
func (j *jsiiProxy_DmsReplicationConfigComputeConfigOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDmsReplicationConfigComputeConfigOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) DmsReplicationConfigComputeConfigOutputReference {
	_init_.Initialize()
...
func NewDmsReplicationConfigComputeConfigOutputReference_Override(d DmsReplicationConfigComputeConfigOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_DmsReplicationConfigComputeConfigOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DmsReplicationConfigComputeConfigOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DmsReplicationConfigComputeConfigOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (d *jsiiProxy_DmsReplicationConfigComputeConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DmsReplicationConfigComputeConfigOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
