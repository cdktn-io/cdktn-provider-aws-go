...
type CloudwatchEventBus interface {
	...
	LogConfig() CloudwatchEventBusLogConfigOutputReference
	LogConfigInput() *CloudwatchEventBusLogConfig
	Name() *string
	SetName(val *string)
	NameInput() *string
	// The tree node.
	...
	PutLogConfig(value *CloudwatchEventBusLogConfig)
...
func (j *jsiiProxy_CloudwatchEventBus) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_CloudwatchEventBus) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_CloudwatchEventBus) DescriptionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"descriptionInput",
...
func (j *jsiiProxy_CloudwatchEventBus) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_CloudwatchEventBus) KmsKeyIdentifier() *string {
	var returns *string
	_jsii_.Get(
		j,
		"kmsKeyIdentifier",
...
func (j *jsiiProxy_CloudwatchEventBus) KmsKeyIdentifierInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CloudwatchEventBus) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_CloudwatchEventBus) LogConfig() CloudwatchEventBusLogConfigOutputReference {
	var returns CloudwatchEventBusLogConfigOutputReference
	_jsii_.Get(
		j,
		"logConfig",
		&returns,
...
func (j *jsiiProxy_CloudwatchEventBus) LogConfigInput() *CloudwatchEventBusLogConfig {
...
func (j *jsiiProxy_CloudwatchEventBus) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_CloudwatchEventBus) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_CloudwatchEventBus) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_CloudwatchEventBus) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_CloudwatchEventBus)SetDescription(val *string) {
...
func (j *jsiiProxy_CloudwatchEventBus)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_CloudwatchEventBus)SetKmsKeyIdentifier(val *string) {
...
func (j *jsiiProxy_CloudwatchEventBus)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_CloudwatchEventBus)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_CloudwatchEventBus)SetRegion(val *string) {
...
func CloudwatchEventBus_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (c *jsiiProxy_CloudwatchEventBus) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CloudwatchEventBus) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (c *jsiiProxy_CloudwatchEventBus) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CloudwatchEventBus) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_CloudwatchEventBus) PutLogConfig(value *CloudwatchEventBusLogConfig) {
...
func (c *jsiiProxy_CloudwatchEventBus) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (c *jsiiProxy_CloudwatchEventBus) ResetDescription() {
	_jsii_.InvokeVoid(
		c,
		"resetDescription",
		nil, // no parameters
...
func (c *jsiiProxy_CloudwatchEventBus) ResetKmsKeyIdentifier() {
	_jsii_.InvokeVoid(
		c,
		"resetKmsKeyIdentifier",
		nil, // no parameters
...
func (c *jsiiProxy_CloudwatchEventBus) ResetLogConfig() {
	_jsii_.InvokeVoid(
		c,
		"resetLogConfig",
		nil, // no parameters
...
func (c *jsiiProxy_CloudwatchEventBus) ResetRegion() {
	_jsii_.InvokeVoid(
		c,
		"resetRegion",
		nil, // no parameters
...
func (c *jsiiProxy_CloudwatchEventBus) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
