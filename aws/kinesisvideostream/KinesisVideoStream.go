...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/kinesisvideostream/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/kinesis_video_stream aws_kinesis_video_stream}.
...
func (j *jsiiProxy_KinesisVideoStream) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_KinesisVideoStream) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_KinesisVideoStream) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_KinesisVideoStream) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_KinesisVideoStream) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_KinesisVideoStream) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_KinesisVideoStream) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/kinesis_video_stream aws_kinesis_video_stream} Resource.
...
func (j *jsiiProxy_KinesisVideoStream)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_KinesisVideoStream)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_KinesisVideoStream)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_KinesisVideoStream)SetRegion(val *string) {
...
func KinesisVideoStream_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (k *jsiiProxy_KinesisVideoStream) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (k *jsiiProxy_KinesisVideoStream) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (k *jsiiProxy_KinesisVideoStream) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (k *jsiiProxy_KinesisVideoStream) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (k *jsiiProxy_KinesisVideoStream) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (k *jsiiProxy_KinesisVideoStream) ResetRegion() {
	_jsii_.InvokeVoid(
		k,
		"resetRegion",
		nil, // no parameters
...
func (k *jsiiProxy_KinesisVideoStream) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
