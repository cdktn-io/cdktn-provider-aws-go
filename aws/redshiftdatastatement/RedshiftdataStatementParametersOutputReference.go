...
func (j *jsiiProxy_RedshiftdataStatementParametersOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewRedshiftdataStatementParametersOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) RedshiftdataStatementParametersOutputReference {
	_init_.Initialize()

	if err := validateNewRedshiftdataStatementParametersOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func NewRedshiftdataStatementParametersOutputReference_Override(r RedshiftdataStatementParametersOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_RedshiftdataStatementParametersOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (r *jsiiProxy_RedshiftdataStatementParametersOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (r *jsiiProxy_RedshiftdataStatementParametersOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (r *jsiiProxy_RedshiftdataStatementParametersOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (r *jsiiProxy_RedshiftdataStatementParametersOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
