...
func (j *jsiiProxy_RedshiftdataStatementParametersList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewRedshiftdataStatementParametersList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) RedshiftdataStatementParametersList {
	_init_.Initialize()
...
func NewRedshiftdataStatementParametersList_Override(r RedshiftdataStatementParametersList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_RedshiftdataStatementParametersList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (r *jsiiProxy_RedshiftdataStatementParametersList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (r *jsiiProxy_RedshiftdataStatementParametersList) Resolve(context cdktn.IResolveContext) interface{} {
