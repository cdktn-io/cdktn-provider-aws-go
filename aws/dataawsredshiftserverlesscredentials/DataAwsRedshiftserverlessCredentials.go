...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/dataawsredshiftserverlesscredentials/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/data-sources/redshiftserverless_credentials aws_redshiftserverless_credentials}.
...
func (j *jsiiProxy_DataAwsRedshiftserverlessCredentials) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsRedshiftserverlessCredentials) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsRedshiftserverlessCredentials) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsRedshiftserverlessCredentials) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsRedshiftserverlessCredentials) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DataAwsRedshiftserverlessCredentials) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_DataAwsRedshiftserverlessCredentials) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/data-sources/redshiftserverless_credentials aws_redshiftserverless_credentials} Data Source.
...
func (j *jsiiProxy_DataAwsRedshiftserverlessCredentials)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsRedshiftserverlessCredentials)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsRedshiftserverlessCredentials)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_DataAwsRedshiftserverlessCredentials)SetRegion(val *string) {
...
func DataAwsRedshiftserverlessCredentials_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateDataAwsRedshiftserverlessCredentials_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataAwsRedshiftserverlessCredentials) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsRedshiftserverlessCredentials) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsRedshiftserverlessCredentials) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsRedshiftserverlessCredentials) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsRedshiftserverlessCredentials) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataAwsRedshiftserverlessCredentials) ToHclTerraform() interface{} {
	var returns interface{}
...
func (d *jsiiProxy_DataAwsRedshiftserverlessCredentials) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
