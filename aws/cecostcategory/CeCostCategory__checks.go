...
func (c *jsiiProxy_CeCostCategory) validatePutRuleParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*CeCostCategoryRule; received %#v (a %T)", value, value)
		}
	}
...
func (c *jsiiProxy_CeCostCategory) validatePutSplitChargeRuleParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*CeCostCategorySplitChargeRule; received %#v (a %T)", value, value)
		}
	}
