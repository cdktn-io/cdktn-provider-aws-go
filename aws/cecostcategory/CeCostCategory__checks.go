...
func (c *jsiiProxy_CeCostCategory) validatePutRuleParameters(value interface{}) error {
	...
	case *[]*CeCostCategoryRule:
		value := value.(*[]*CeCostCategoryRule)
	...
	case []*CeCostCategoryRule:
		value_ := value.([]*CeCostCategoryRule)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*CeCostCategoryRule; received %#v (a %T)", value, value)
		}
	}
...
func (c *jsiiProxy_CeCostCategory) validatePutSplitChargeRuleParameters(value interface{}) error {
	...
	case *[]*CeCostCategorySplitChargeRule:
		value := value.(*[]*CeCostCategorySplitChargeRule)
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
			}
	...
	case []*CeCostCategorySplitChargeRule:
		value_ := value.([]*CeCostCategorySplitChargeRule)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*CeCostCategorySplitChargeRule; received %#v (a %T)", value, value)
		}
	}
