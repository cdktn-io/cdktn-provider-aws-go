...
func (j *jsiiProxy_CeCostCategoryRuleRuleOrOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewCeCostCategoryRuleRuleOrOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) CeCostCategoryRuleRuleOrOutputReference {
	_init_.Initialize()
...
func NewCeCostCategoryRuleRuleOrOutputReference_Override(c CeCostCategoryRuleRuleOrOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_CeCostCategoryRuleRuleOrOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_CeCostCategoryRuleRuleOrOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CeCostCategoryRuleRuleOrOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (c *jsiiProxy_CeCostCategoryRuleRuleOrOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CeCostCategoryRuleRuleOrOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
