...
type CeCostCategoryRuleRuleAndOutputReference interface {
	cdktn.ComplexObject
	And() CeCostCategoryRuleRuleAndAndList
	AndInput() interface{}
	...
	Not() CeCostCategoryRuleRuleAndNotOutputReference
	NotInput() *CeCostCategoryRuleRuleAndNot
	Or() CeCostCategoryRuleRuleAndOrList
	OrInput() interface{}
	...
	PutNot(value *CeCostCategoryRuleRuleAndNot)
...
func (j *jsiiProxy_CeCostCategoryRuleRuleAndOutputReference) And() CeCostCategoryRuleRuleAndAndList {
	var returns CeCostCategoryRuleRuleAndAndList
	_jsii_.Get(
		j,
		"and",
		&returns,
...
func (j *jsiiProxy_CeCostCategoryRuleRuleAndOutputReference) AndInput() interface{} {
...
func (j *jsiiProxy_CeCostCategoryRuleRuleAndOutputReference) Not() CeCostCategoryRuleRuleAndNotOutputReference {
	var returns CeCostCategoryRuleRuleAndNotOutputReference
	_jsii_.Get(
		j,
		"not",
		&returns,
...
func (j *jsiiProxy_CeCostCategoryRuleRuleAndOutputReference) NotInput() *CeCostCategoryRuleRuleAndNot {
...
func (j *jsiiProxy_CeCostCategoryRuleRuleAndOutputReference) Or() CeCostCategoryRuleRuleAndOrList {
	var returns CeCostCategoryRuleRuleAndOrList
	_jsii_.Get(
		j,
		"or",
		&returns,
...
func (j *jsiiProxy_CeCostCategoryRuleRuleAndOutputReference) OrInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"orInput",
...
func (j *jsiiProxy_CeCostCategoryRuleRuleAndOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewCeCostCategoryRuleRuleAndOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) CeCostCategoryRuleRuleAndOutputReference {
	_init_.Initialize()
...
func NewCeCostCategoryRuleRuleAndOutputReference_Override(c CeCostCategoryRuleRuleAndOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_CeCostCategoryRuleRuleAndOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_CeCostCategoryRuleRuleAndOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CeCostCategoryRuleRuleAndOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (c *jsiiProxy_CeCostCategoryRuleRuleAndOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CeCostCategoryRuleRuleAndOutputReference) PutAnd(value interface{}) {
...
func (c *jsiiProxy_CeCostCategoryRuleRuleAndOutputReference) PutNot(value *CeCostCategoryRuleRuleAndNot) {
...
func (c *jsiiProxy_CeCostCategoryRuleRuleAndOutputReference) PutOr(value interface{}) {
...
func (c *jsiiProxy_CeCostCategoryRuleRuleAndOutputReference) ResetAnd() {
	_jsii_.InvokeVoid(
		c,
		"resetAnd",
		nil, // no parameters
...
func (c *jsiiProxy_CeCostCategoryRuleRuleAndOutputReference) ResetNot() {
	_jsii_.InvokeVoid(
		c,
		"resetNot",
		nil, // no parameters
...
func (c *jsiiProxy_CeCostCategoryRuleRuleAndOutputReference) ResetOr() {
	_jsii_.InvokeVoid(
		c,
		"resetOr",
		nil, // no parameters
...
func (c *jsiiProxy_CeCostCategoryRuleRuleAndOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
