...
func (c *jsiiProxy_CeCostCategoryRuleRuleAndAndCostCategoryOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CeCostCategoryRuleRuleAndAndCostCategoryOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
