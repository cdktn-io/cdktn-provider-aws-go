...
func (c *jsiiProxy_CeCostCategoryRuleRuleOrNotOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CeCostCategoryRuleRuleOrNotOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
