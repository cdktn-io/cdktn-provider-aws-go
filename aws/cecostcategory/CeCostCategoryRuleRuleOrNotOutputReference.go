...
func (j *jsiiProxy_CeCostCategoryRuleRuleOrNotOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewCeCostCategoryRuleRuleOrNotOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) CeCostCategoryRuleRuleOrNotOutputReference {
	_init_.Initialize()
...
func NewCeCostCategoryRuleRuleOrNotOutputReference_Override(c CeCostCategoryRuleRuleOrNotOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_CeCostCategoryRuleRuleOrNotOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_CeCostCategoryRuleRuleOrNotOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CeCostCategoryRuleRuleOrNotOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (c *jsiiProxy_CeCostCategoryRuleRuleOrNotOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CeCostCategoryRuleRuleOrNotOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
