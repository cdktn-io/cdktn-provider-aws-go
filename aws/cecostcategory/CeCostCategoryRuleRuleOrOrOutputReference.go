...
func (c *jsiiProxy_CeCostCategoryRuleRuleOrOrOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CeCostCategoryRuleRuleOrOrOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
