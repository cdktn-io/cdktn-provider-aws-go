...
func (c *jsiiProxy_CeCostCategoryRuleRuleAndCostCategoryOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CeCostCategoryRuleRuleAndCostCategoryOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
