...
func (c *jsiiProxy_CloudwatchEventConnectionAuthParametersOauthOauthHttpParametersBodyList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (c *jsiiProxy_CloudwatchEventConnectionAuthParametersOauthOauthHttpParametersBodyList) Resolve(context cdktf.IResolveContext) interface{} {
