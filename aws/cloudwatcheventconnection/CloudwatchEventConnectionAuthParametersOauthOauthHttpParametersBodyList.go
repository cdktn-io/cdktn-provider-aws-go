...
func (j *jsiiProxy_CloudwatchEventConnectionAuthParametersOauthOauthHttpParametersBodyList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewCloudwatchEventConnectionAuthParametersOauthOauthHttpParametersBodyList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) CloudwatchEventConnectionAuthParametersOauthOauthHttpParametersBodyList {
	_init_.Initialize()

	if err := validateNewCloudwatchEventConnectionAuthParametersOauthOauthHttpParametersBodyListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewCloudwatchEventConnectionAuthParametersOauthOauthHttpParametersBodyList_Override(c CloudwatchEventConnectionAuthParametersOauthOauthHttpParametersBodyList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_CloudwatchEventConnectionAuthParametersOauthOauthHttpParametersBodyList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_CloudwatchEventConnectionAuthParametersOauthOauthHttpParametersBodyList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (c *jsiiProxy_CloudwatchEventConnectionAuthParametersOauthOauthHttpParametersBodyList) Resolve(context cdktn.IResolveContext) interface{} {
