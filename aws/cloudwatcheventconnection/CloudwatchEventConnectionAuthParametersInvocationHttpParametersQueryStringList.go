...
func (j *jsiiProxy_CloudwatchEventConnectionAuthParametersInvocationHttpParametersQueryStringList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewCloudwatchEventConnectionAuthParametersInvocationHttpParametersQueryStringList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) CloudwatchEventConnectionAuthParametersInvocationHttpParametersQueryStringList {
	_init_.Initialize()

	if err := validateNewCloudwatchEventConnectionAuthParametersInvocationHttpParametersQueryStringListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewCloudwatchEventConnectionAuthParametersInvocationHttpParametersQueryStringList_Override(c CloudwatchEventConnectionAuthParametersInvocationHttpParametersQueryStringList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_CloudwatchEventConnectionAuthParametersInvocationHttpParametersQueryStringList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_CloudwatchEventConnectionAuthParametersInvocationHttpParametersQueryStringList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (c *jsiiProxy_CloudwatchEventConnectionAuthParametersInvocationHttpParametersQueryStringList) Resolve(context cdktn.IResolveContext) interface{} {
