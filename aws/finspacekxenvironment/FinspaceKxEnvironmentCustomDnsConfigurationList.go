...
func (j *jsiiProxy_FinspaceKxEnvironmentCustomDnsConfigurationList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewFinspaceKxEnvironmentCustomDnsConfigurationList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) FinspaceKxEnvironmentCustomDnsConfigurationList {
	_init_.Initialize()
...
func NewFinspaceKxEnvironmentCustomDnsConfigurationList_Override(f FinspaceKxEnvironmentCustomDnsConfigurationList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_FinspaceKxEnvironmentCustomDnsConfigurationList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (f *jsiiProxy_FinspaceKxEnvironmentCustomDnsConfigurationList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (f *jsiiProxy_FinspaceKxEnvironmentCustomDnsConfigurationList) Resolve(context cdktn.IResolveContext) interface{} {
