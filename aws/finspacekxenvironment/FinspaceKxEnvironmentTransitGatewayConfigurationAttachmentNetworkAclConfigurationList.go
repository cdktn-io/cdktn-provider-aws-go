...
func (f *jsiiProxy_FinspaceKxEnvironmentTransitGatewayConfigurationAttachmentNetworkAclConfigurationList) Resolve(context cdktf.IResolveContext) interface{} {
