...
func (j *jsiiProxy_GrafanaWorkspace) KmsKeyId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"kmsKeyId",
...
func (j *jsiiProxy_GrafanaWorkspace) KmsKeyIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"kmsKeyIdInput",
...
func (j *jsiiProxy_GrafanaWorkspace) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_GrafanaWorkspace) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/grafana_workspace aws_grafana_workspace} Resource.
...
func (j *jsiiProxy_GrafanaWorkspace)SetKmsKeyId(val *string) {
...
func (j *jsiiProxy_GrafanaWorkspace)SetRegion(val *string) {
...
func (g *jsiiProxy_GrafanaWorkspace) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GrafanaWorkspace) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (g *jsiiProxy_GrafanaWorkspace) ResetKmsKeyId() {
	_jsii_.InvokeVoid(
		g,
		"resetKmsKeyId",
		nil, // no parameters
...
func (g *jsiiProxy_GrafanaWorkspace) ResetRegion() {
	_jsii_.InvokeVoid(
		g,
		"resetRegion",
		nil, // no parameters
...
func (g *jsiiProxy_GrafanaWorkspace) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
