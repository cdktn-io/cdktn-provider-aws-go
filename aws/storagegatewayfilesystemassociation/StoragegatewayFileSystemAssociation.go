...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/storagegateway_file_system_association aws_storagegateway_file_system_association}.
...
func (j *jsiiProxy_StoragegatewayFileSystemAssociation) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_StoragegatewayFileSystemAssociation) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_StoragegatewayFileSystemAssociation) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_StoragegatewayFileSystemAssociation) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_StoragegatewayFileSystemAssociation) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_StoragegatewayFileSystemAssociation) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_StoragegatewayFileSystemAssociation) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/storagegateway_file_system_association aws_storagegateway_file_system_association} Resource.
...
func (j *jsiiProxy_StoragegatewayFileSystemAssociation)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_StoragegatewayFileSystemAssociation)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_StoragegatewayFileSystemAssociation)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_StoragegatewayFileSystemAssociation)SetRegion(val *string) {
...
func StoragegatewayFileSystemAssociation_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (s *jsiiProxy_StoragegatewayFileSystemAssociation) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_StoragegatewayFileSystemAssociation) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_StoragegatewayFileSystemAssociation) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_StoragegatewayFileSystemAssociation) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_StoragegatewayFileSystemAssociation) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_StoragegatewayFileSystemAssociation) ResetRegion() {
	_jsii_.InvokeVoid(
		s,
		"resetRegion",
		nil, // no parameters
...
func (s *jsiiProxy_StoragegatewayFileSystemAssociation) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
