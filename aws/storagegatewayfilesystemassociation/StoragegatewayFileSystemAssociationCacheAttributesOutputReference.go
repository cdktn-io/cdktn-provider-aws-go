...
func (s *jsiiProxy_StoragegatewayFileSystemAssociationCacheAttributesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_StoragegatewayFileSystemAssociationCacheAttributesOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
