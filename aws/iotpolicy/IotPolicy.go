...
func (j *jsiiProxy_IotPolicy) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_IotPolicy) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_IotPolicy) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_IotPolicy) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_IotPolicy) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_IotPolicy) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_IotPolicy) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_IotPolicy) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/iot_policy aws_iot_policy} Resource.
func NewIotPolicy(scope constructs.Construct, id *string, config *IotPolicyConfig) IotPolicy {
	_init_.Initialize()

	if err := validateNewIotPolicyParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_IotPolicy)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_IotPolicy)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_IotPolicy)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_IotPolicy)SetRegion(val *string) {
...
func IotPolicy_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateIotPolicy_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (i *jsiiProxy_IotPolicy) AddMoveTarget(moveTarget *string) {
...
func (i *jsiiProxy_IotPolicy) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (i *jsiiProxy_IotPolicy) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (i *jsiiProxy_IotPolicy) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (i *jsiiProxy_IotPolicy) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (i *jsiiProxy_IotPolicy) MoveFromId(id *string) {
...
func (i *jsiiProxy_IotPolicy) MoveToId(id *string) {
...
func (i *jsiiProxy_IotPolicy) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (i *jsiiProxy_IotPolicy) ResetRegion() {
	_jsii_.InvokeVoid(
		i,
		"resetRegion",
		nil, // no parameters
...
func (i *jsiiProxy_IotPolicy) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
