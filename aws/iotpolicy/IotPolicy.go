...
func (j *jsiiProxy_IotPolicy) ForEach() cdktf.ITerraformIterator {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.28.0/docs/resources/iot_policy aws_iot_policy} Resource.
...
func IotPolicy_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (i *jsiiProxy_IotPolicy) ImportFrom(id *string, provider cdktf.TerraformProvider) {
