...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v23/dataawsec2localgatewayvirtualinterfacegroups/internal"
...
func (j *jsiiProxy_DataAwsEc2LocalGatewayVirtualInterfaceGroups) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsEc2LocalGatewayVirtualInterfaceGroups) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsEc2LocalGatewayVirtualInterfaceGroups) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsEc2LocalGatewayVirtualInterfaceGroups) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsEc2LocalGatewayVirtualInterfaceGroups) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DataAwsEc2LocalGatewayVirtualInterfaceGroups) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_DataAwsEc2LocalGatewayVirtualInterfaceGroups) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DataAwsEc2LocalGatewayVirtualInterfaceGroups)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsEc2LocalGatewayVirtualInterfaceGroups)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsEc2LocalGatewayVirtualInterfaceGroups)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_DataAwsEc2LocalGatewayVirtualInterfaceGroups)SetRegion(val *string) {
...
func DataAwsEc2LocalGatewayVirtualInterfaceGroups_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsEc2LocalGatewayVirtualInterfaceGroups) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsEc2LocalGatewayVirtualInterfaceGroups) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsEc2LocalGatewayVirtualInterfaceGroups) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsEc2LocalGatewayVirtualInterfaceGroups) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
