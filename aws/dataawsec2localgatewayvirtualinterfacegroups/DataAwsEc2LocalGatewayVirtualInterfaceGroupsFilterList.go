...
func (j *jsiiProxy_DataAwsEc2LocalGatewayVirtualInterfaceGroupsFilterList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsEc2LocalGatewayVirtualInterfaceGroupsFilterList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsEc2LocalGatewayVirtualInterfaceGroupsFilterList {
	_init_.Initialize()
...
func NewDataAwsEc2LocalGatewayVirtualInterfaceGroupsFilterList_Override(d DataAwsEc2LocalGatewayVirtualInterfaceGroupsFilterList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsEc2LocalGatewayVirtualInterfaceGroupsFilterList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsEc2LocalGatewayVirtualInterfaceGroupsFilterList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsEc2LocalGatewayVirtualInterfaceGroupsFilterList) Resolve(context cdktn.IResolveContext) interface{} {
