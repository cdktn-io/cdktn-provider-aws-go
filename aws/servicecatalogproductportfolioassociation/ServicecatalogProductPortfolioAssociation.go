...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/servicecatalogproductportfolioassociation/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/servicecatalog_product_portfolio_association aws_servicecatalog_product_portfolio_association}.
...
func (j *jsiiProxy_ServicecatalogProductPortfolioAssociation) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_ServicecatalogProductPortfolioAssociation) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_ServicecatalogProductPortfolioAssociation) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_ServicecatalogProductPortfolioAssociation) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_ServicecatalogProductPortfolioAssociation) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/servicecatalog_product_portfolio_association aws_servicecatalog_product_portfolio_association} Resource.
func NewServicecatalogProductPortfolioAssociation(scope constructs.Construct, id *string, config *ServicecatalogProductPortfolioAssociationConfig) ServicecatalogProductPortfolioAssociation {
	...
	_jsii_.Create(
		"@cdktn/provider-aws.servicecatalogProductPortfolioAssociation.ServicecatalogProductPortfolioAssociation",
...
func (j *jsiiProxy_ServicecatalogProductPortfolioAssociation)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_ServicecatalogProductPortfolioAssociation)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_ServicecatalogProductPortfolioAssociation)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func ServicecatalogProductPortfolioAssociation_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateServicecatalogProductPortfolioAssociation_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_ServicecatalogProductPortfolioAssociation) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_ServicecatalogProductPortfolioAssociation) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_ServicecatalogProductPortfolioAssociation) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_ServicecatalogProductPortfolioAssociation) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_ServicecatalogProductPortfolioAssociation) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_ServicecatalogProductPortfolioAssociation) MoveFromId(id *string) {
...
func (s *jsiiProxy_ServicecatalogProductPortfolioAssociation) MoveToId(id *string) {
...
func (s *jsiiProxy_ServicecatalogProductPortfolioAssociation) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_ServicecatalogProductPortfolioAssociation) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
