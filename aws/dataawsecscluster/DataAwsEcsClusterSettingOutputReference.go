...
func (d *jsiiProxy_DataAwsEcsClusterSettingOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataAwsEcsClusterSettingOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
