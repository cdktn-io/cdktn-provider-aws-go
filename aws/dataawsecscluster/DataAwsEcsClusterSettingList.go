...
func (j *jsiiProxy_DataAwsEcsClusterSettingList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsEcsClusterSettingList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsEcsClusterSettingList {
	_init_.Initialize()

	if err := validateNewDataAwsEcsClusterSettingListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewDataAwsEcsClusterSettingList_Override(d DataAwsEcsClusterSettingList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsEcsClusterSettingList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsEcsClusterSettingList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsEcsClusterSettingList) Resolve(context cdktn.IResolveContext) interface{} {
