...
func (d *jsiiProxy_DataAwsEcsClusterSettingList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsEcsClusterSettingList) Resolve(context cdktf.IResolveContext) interface{} {
