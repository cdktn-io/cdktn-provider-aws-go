...
func (j *jsiiProxy_GlobalacceleratorCustomRoutingListenerPortRangeList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewGlobalacceleratorCustomRoutingListenerPortRangeList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) GlobalacceleratorCustomRoutingListenerPortRangeList {
	_init_.Initialize()
...
func NewGlobalacceleratorCustomRoutingListenerPortRangeList_Override(g GlobalacceleratorCustomRoutingListenerPortRangeList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_GlobalacceleratorCustomRoutingListenerPortRangeList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (g *jsiiProxy_GlobalacceleratorCustomRoutingListenerPortRangeList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (g *jsiiProxy_GlobalacceleratorCustomRoutingListenerPortRangeList) Resolve(context cdktf.IResolveContext) interface{} {
