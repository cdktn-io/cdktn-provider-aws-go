...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/data-sources/db_instance aws_db_instance}.
...
func (j *jsiiProxy_DataAwsDbInstance) DatabaseInsightsMode() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataAwsDbInstance) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DataAwsDbInstance) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/data-sources/db_instance aws_db_instance} Data Source.
...
func (j *jsiiProxy_DataAwsDbInstance)SetRegion(val *string) {
...
func (d *jsiiProxy_DataAwsDbInstance) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsDbInstance) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsDbInstance) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
