...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/dataawscloudwatchloggroups/internal"
...
func (j *jsiiProxy_DataAwsCloudwatchLogGroups) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsCloudwatchLogGroups) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsCloudwatchLogGroups) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsCloudwatchLogGroups) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsCloudwatchLogGroups) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/data-sources/cloudwatch_log_groups aws_cloudwatch_log_groups} Data Source.
func NewDataAwsCloudwatchLogGroups(scope constructs.Construct, id *string, config *DataAwsCloudwatchLogGroupsConfig) DataAwsCloudwatchLogGroups {
	...
	_jsii_.Create(
		"@cdktn/provider-aws.dataAwsCloudwatchLogGroups.DataAwsCloudwatchLogGroups",
...
func (j *jsiiProxy_DataAwsCloudwatchLogGroups)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsCloudwatchLogGroups)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsCloudwatchLogGroups)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsCloudwatchLogGroups_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsCloudwatchLogGroups) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsCloudwatchLogGroups) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsCloudwatchLogGroups) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
