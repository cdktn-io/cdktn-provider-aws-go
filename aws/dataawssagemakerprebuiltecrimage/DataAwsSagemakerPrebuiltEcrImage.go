...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/dataawssagemakerprebuiltecrimage/internal"
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/data-sources/sagemaker_prebuilt_ecr_image aws_sagemaker_prebuilt_ecr_image} Data Source.
...
func (d *jsiiProxy_DataAwsSagemakerPrebuiltEcrImage) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsSagemakerPrebuiltEcrImage) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
