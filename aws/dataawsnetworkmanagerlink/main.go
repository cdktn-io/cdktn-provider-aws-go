...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-aws.dataAwsNetworkmanagerLink.DataAwsNetworkmanagerLinkBandwidth",
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-aws.dataAwsNetworkmanagerLink.DataAwsNetworkmanagerLinkConfig",
