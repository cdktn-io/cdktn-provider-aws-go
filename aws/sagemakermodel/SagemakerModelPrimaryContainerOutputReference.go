...
type SagemakerModelPrimaryContainerOutputReference interface {
	cdktn.ComplexObject
	AdditionalModelDataSource() SagemakerModelPrimaryContainerAdditionalModelDataSourceList
...
func (j *jsiiProxy_SagemakerModelPrimaryContainerOutputReference) AdditionalModelDataSource() SagemakerModelPrimaryContainerAdditionalModelDataSourceList {
	var returns SagemakerModelPrimaryContainerAdditionalModelDataSourceList
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_SagemakerModelPrimaryContainerOutputReference) AdditionalModelDataSourceInput() interface{} {
...
func (j *jsiiProxy_SagemakerModelPrimaryContainerOutputReference) ModelPackageName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"modelPackageName",
...
func (j *jsiiProxy_SagemakerModelPrimaryContainerOutputReference) ModelPackageNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_SagemakerModelPrimaryContainerOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewSagemakerModelPrimaryContainerOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) SagemakerModelPrimaryContainerOutputReference {
	_init_.Initialize()
...
func NewSagemakerModelPrimaryContainerOutputReference_Override(s SagemakerModelPrimaryContainerOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_SagemakerModelPrimaryContainerOutputReference)SetModelPackageName(val *string) {
...
func (j *jsiiProxy_SagemakerModelPrimaryContainerOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_SagemakerModelPrimaryContainerOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SagemakerModelPrimaryContainerOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (s *jsiiProxy_SagemakerModelPrimaryContainerOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SagemakerModelPrimaryContainerOutputReference) PutAdditionalModelDataSource(value interface{}) {
...
func (s *jsiiProxy_SagemakerModelPrimaryContainerOutputReference) ResetAdditionalModelDataSource() {
	_jsii_.InvokeVoid(
		s,
		"resetAdditionalModelDataSource",
		nil, // no parameters
...
func (s *jsiiProxy_SagemakerModelPrimaryContainerOutputReference) ResetImage() {
	_jsii_.InvokeVoid(
		s,
		"resetImage",
		nil, // no parameters
...
func (s *jsiiProxy_SagemakerModelPrimaryContainerOutputReference) ResetModelPackageName() {
	_jsii_.InvokeVoid(
		s,
		"resetModelPackageName",
		nil, // no parameters
...
func (s *jsiiProxy_SagemakerModelPrimaryContainerOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
