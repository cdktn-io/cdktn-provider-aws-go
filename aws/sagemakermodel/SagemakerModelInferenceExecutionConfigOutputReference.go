...
func (j *jsiiProxy_SagemakerModelInferenceExecutionConfigOutputReference) ComplexObjectIndex() interface{} {
...
func (j *jsiiProxy_SagemakerModelInferenceExecutionConfigOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_SagemakerModelInferenceExecutionConfigOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_SagemakerModelInferenceExecutionConfigOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_SagemakerModelInferenceExecutionConfigOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewSagemakerModelInferenceExecutionConfigOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) SagemakerModelInferenceExecutionConfigOutputReference {
	_init_.Initialize()

	if err := validateNewSagemakerModelInferenceExecutionConfigOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewSagemakerModelInferenceExecutionConfigOutputReference_Override(s SagemakerModelInferenceExecutionConfigOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_SagemakerModelInferenceExecutionConfigOutputReference)SetComplexObjectIndex(val interface{}) {
...
func (j *jsiiProxy_SagemakerModelInferenceExecutionConfigOutputReference)SetComplexObjectIsFromSet(val *bool) {
...
func (j *jsiiProxy_SagemakerModelInferenceExecutionConfigOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_SagemakerModelInferenceExecutionConfigOutputReference) ComputeFqn() *string {
	var returns *string
...
func (s *jsiiProxy_SagemakerModelInferenceExecutionConfigOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SagemakerModelInferenceExecutionConfigOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (s *jsiiProxy_SagemakerModelInferenceExecutionConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SagemakerModelInferenceExecutionConfigOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
...
func (s *jsiiProxy_SagemakerModelInferenceExecutionConfigOutputReference) ToString() *string {
	var returns *string
