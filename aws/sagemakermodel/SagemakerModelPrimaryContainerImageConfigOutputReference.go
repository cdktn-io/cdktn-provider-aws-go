...
func (s *jsiiProxy_SagemakerModelPrimaryContainerImageConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_SagemakerModelPrimaryContainerImageConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
