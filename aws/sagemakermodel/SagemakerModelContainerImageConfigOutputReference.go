...
func (s *jsiiProxy_SagemakerModelContainerImageConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_SagemakerModelContainerImageConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
