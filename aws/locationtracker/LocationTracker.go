...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/locationtracker/internal"
...
func (j *jsiiProxy_LocationTracker) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_LocationTracker) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_LocationTracker) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_LocationTracker) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_LocationTracker) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/location_tracker aws_location_tracker} Resource.
...
func (j *jsiiProxy_LocationTracker)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_LocationTracker)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_LocationTracker)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func LocationTracker_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (l *jsiiProxy_LocationTracker) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LocationTracker) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (l *jsiiProxy_LocationTracker) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LocationTracker) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (l *jsiiProxy_LocationTracker) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (l *jsiiProxy_LocationTracker) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
