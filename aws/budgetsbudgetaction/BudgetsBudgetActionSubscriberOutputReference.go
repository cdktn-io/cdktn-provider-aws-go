...
func (b *jsiiProxy_BudgetsBudgetActionSubscriberOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (b *jsiiProxy_BudgetsBudgetActionSubscriberOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
