...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/budgetsbudgetaction/internal"
...
func (j *jsiiProxy_BudgetsBudgetAction) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_BudgetsBudgetAction) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_BudgetsBudgetAction) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_BudgetsBudgetAction) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_BudgetsBudgetAction) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/budgets_budget_action aws_budgets_budget_action} Resource.
...
func (j *jsiiProxy_BudgetsBudgetAction)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_BudgetsBudgetAction)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_BudgetsBudgetAction)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func BudgetsBudgetAction_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (b *jsiiProxy_BudgetsBudgetAction) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (b *jsiiProxy_BudgetsBudgetAction) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (b *jsiiProxy_BudgetsBudgetAction) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (b *jsiiProxy_BudgetsBudgetAction) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (b *jsiiProxy_BudgetsBudgetAction) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
