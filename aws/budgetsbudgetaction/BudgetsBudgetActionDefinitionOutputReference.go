...
func (b *jsiiProxy_BudgetsBudgetActionDefinitionOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (b *jsiiProxy_BudgetsBudgetActionDefinitionOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
