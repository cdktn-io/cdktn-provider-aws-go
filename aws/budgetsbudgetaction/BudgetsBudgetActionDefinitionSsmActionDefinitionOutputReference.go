...
func (b *jsiiProxy_BudgetsBudgetActionDefinitionSsmActionDefinitionOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (b *jsiiProxy_BudgetsBudgetActionDefinitionSsmActionDefinitionOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
