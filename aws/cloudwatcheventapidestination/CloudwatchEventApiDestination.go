...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/cloudwatcheventapidestination/internal"
...
func (j *jsiiProxy_CloudwatchEventApiDestination) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_CloudwatchEventApiDestination) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_CloudwatchEventApiDestination) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_CloudwatchEventApiDestination) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_CloudwatchEventApiDestination) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_CloudwatchEventApiDestination) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_CloudwatchEventApiDestination) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/cloudwatch_event_api_destination aws_cloudwatch_event_api_destination} Resource.
...
func (j *jsiiProxy_CloudwatchEventApiDestination)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_CloudwatchEventApiDestination)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_CloudwatchEventApiDestination)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_CloudwatchEventApiDestination)SetRegion(val *string) {
...
func CloudwatchEventApiDestination_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (c *jsiiProxy_CloudwatchEventApiDestination) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CloudwatchEventApiDestination) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (c *jsiiProxy_CloudwatchEventApiDestination) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CloudwatchEventApiDestination) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_CloudwatchEventApiDestination) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (c *jsiiProxy_CloudwatchEventApiDestination) ResetRegion() {
	_jsii_.InvokeVoid(
		c,
		"resetRegion",
		nil, // no parameters
...
func (c *jsiiProxy_CloudwatchEventApiDestination) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
