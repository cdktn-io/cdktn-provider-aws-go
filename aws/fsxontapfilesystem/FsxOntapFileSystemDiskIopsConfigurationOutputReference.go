...
func (f *jsiiProxy_FsxOntapFileSystemDiskIopsConfigurationOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (f *jsiiProxy_FsxOntapFileSystemDiskIopsConfigurationOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
