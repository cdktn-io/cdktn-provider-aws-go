...
func (j *jsiiProxy_FsxOntapFileSystemEndpointsInterclusterList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewFsxOntapFileSystemEndpointsInterclusterList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) FsxOntapFileSystemEndpointsInterclusterList {
	_init_.Initialize()
...
func NewFsxOntapFileSystemEndpointsInterclusterList_Override(f FsxOntapFileSystemEndpointsInterclusterList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_FsxOntapFileSystemEndpointsInterclusterList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (f *jsiiProxy_FsxOntapFileSystemEndpointsInterclusterList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (f *jsiiProxy_FsxOntapFileSystemEndpointsInterclusterList) Resolve(context cdktn.IResolveContext) interface{} {
