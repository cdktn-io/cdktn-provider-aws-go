...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/fsx_ontap_file_system aws_fsx_ontap_file_system} Resource.
...
func (f *jsiiProxy_FsxOntapFileSystem) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (f *jsiiProxy_FsxOntapFileSystem) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (f *jsiiProxy_FsxOntapFileSystem) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
