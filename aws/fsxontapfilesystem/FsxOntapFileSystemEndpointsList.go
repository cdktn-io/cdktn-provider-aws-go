...
func (j *jsiiProxy_FsxOntapFileSystemEndpointsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewFsxOntapFileSystemEndpointsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) FsxOntapFileSystemEndpointsList {
	_init_.Initialize()
...
func NewFsxOntapFileSystemEndpointsList_Override(f FsxOntapFileSystemEndpointsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_FsxOntapFileSystemEndpointsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (f *jsiiProxy_FsxOntapFileSystemEndpointsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (f *jsiiProxy_FsxOntapFileSystemEndpointsList) Resolve(context cdktn.IResolveContext) interface{} {
