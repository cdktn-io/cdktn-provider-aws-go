...
func (j *jsiiProxy_FsxOntapFileSystemEndpointsManagementList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewFsxOntapFileSystemEndpointsManagementList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) FsxOntapFileSystemEndpointsManagementList {
	_init_.Initialize()
...
func NewFsxOntapFileSystemEndpointsManagementList_Override(f FsxOntapFileSystemEndpointsManagementList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_FsxOntapFileSystemEndpointsManagementList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (f *jsiiProxy_FsxOntapFileSystemEndpointsManagementList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (f *jsiiProxy_FsxOntapFileSystemEndpointsManagementList) Resolve(context cdktn.IResolveContext) interface{} {
