...
func (j *jsiiProxy_FsxOntapFileSystemEndpointsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewFsxOntapFileSystemEndpointsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) FsxOntapFileSystemEndpointsOutputReference {
	_init_.Initialize()
...
func NewFsxOntapFileSystemEndpointsOutputReference_Override(f FsxOntapFileSystemEndpointsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_FsxOntapFileSystemEndpointsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (f *jsiiProxy_FsxOntapFileSystemEndpointsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (f *jsiiProxy_FsxOntapFileSystemEndpointsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (f *jsiiProxy_FsxOntapFileSystemEndpointsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (f *jsiiProxy_FsxOntapFileSystemEndpointsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
