...
func (f *jsiiProxy_FsxOntapFileSystemTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (f *jsiiProxy_FsxOntapFileSystemTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
