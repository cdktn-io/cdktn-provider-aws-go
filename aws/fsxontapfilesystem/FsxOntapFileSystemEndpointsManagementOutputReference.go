...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v24/fsxontapfilesystem/internal"
...
func (j *jsiiProxy_FsxOntapFileSystemEndpointsManagementOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewFsxOntapFileSystemEndpointsManagementOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) FsxOntapFileSystemEndpointsManagementOutputReference {
	_init_.Initialize()

	if err := validateNewFsxOntapFileSystemEndpointsManagementOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func NewFsxOntapFileSystemEndpointsManagementOutputReference_Override(f FsxOntapFileSystemEndpointsManagementOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_FsxOntapFileSystemEndpointsManagementOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (f *jsiiProxy_FsxOntapFileSystemEndpointsManagementOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (f *jsiiProxy_FsxOntapFileSystemEndpointsManagementOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (f *jsiiProxy_FsxOntapFileSystemEndpointsManagementOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (f *jsiiProxy_FsxOntapFileSystemEndpointsManagementOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
