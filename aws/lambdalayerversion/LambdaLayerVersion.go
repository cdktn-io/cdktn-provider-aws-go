...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/lambdalayerversion/internal"
...
func (j *jsiiProxy_LambdaLayerVersion) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_LambdaLayerVersion) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_LambdaLayerVersion) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_LambdaLayerVersion) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_LambdaLayerVersion) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/lambda_layer_version aws_lambda_layer_version} Resource.
...
func (j *jsiiProxy_LambdaLayerVersion)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_LambdaLayerVersion)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_LambdaLayerVersion)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func LambdaLayerVersion_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (l *jsiiProxy_LambdaLayerVersion) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LambdaLayerVersion) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (l *jsiiProxy_LambdaLayerVersion) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LambdaLayerVersion) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (l *jsiiProxy_LambdaLayerVersion) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (l *jsiiProxy_LambdaLayerVersion) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
