...
func (j *jsiiProxy_DataAwsCloudfrontResponseHeadersPolicyServerTimingHeadersConfigList) TerraformResource() cdktf.IInterpolatingParent {
...
func (j *jsiiProxy_DataAwsCloudfrontResponseHeadersPolicyServerTimingHeadersConfigList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsCloudfrontResponseHeadersPolicyServerTimingHeadersConfigList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsCloudfrontResponseHeadersPolicyServerTimingHeadersConfigList) Resolve(context cdktf.IResolveContext) interface{} {
