...
func (j *jsiiProxy_DataAwsCloudfrontResponseHeadersPolicyRemoveHeadersConfigList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsCloudfrontResponseHeadersPolicyRemoveHeadersConfigList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsCloudfrontResponseHeadersPolicyRemoveHeadersConfigList {
	_init_.Initialize()
...
func NewDataAwsCloudfrontResponseHeadersPolicyRemoveHeadersConfigList_Override(d DataAwsCloudfrontResponseHeadersPolicyRemoveHeadersConfigList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsCloudfrontResponseHeadersPolicyRemoveHeadersConfigList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsCloudfrontResponseHeadersPolicyRemoveHeadersConfigList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsCloudfrontResponseHeadersPolicyRemoveHeadersConfigList) Resolve(context cdktn.IResolveContext) interface{} {
