...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/dataawscognitouserpoolsigningcertificate/internal"
...
func (j *jsiiProxy_DataAwsCognitoUserPoolSigningCertificate) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsCognitoUserPoolSigningCertificate) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsCognitoUserPoolSigningCertificate) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsCognitoUserPoolSigningCertificate) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsCognitoUserPoolSigningCertificate) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DataAwsCognitoUserPoolSigningCertificate)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsCognitoUserPoolSigningCertificate)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsCognitoUserPoolSigningCertificate)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsCognitoUserPoolSigningCertificate_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsCognitoUserPoolSigningCertificate) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsCognitoUserPoolSigningCertificate) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsCognitoUserPoolSigningCertificate) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsCognitoUserPoolSigningCertificate) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
