...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/dataawsbackupselection/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/data-sources/backup_selection aws_backup_selection}.
...
func (j *jsiiProxy_DataAwsBackupSelection) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsBackupSelection) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsBackupSelection) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_DataAwsBackupSelection) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsBackupSelection) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsBackupSelection) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DataAwsBackupSelection) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_DataAwsBackupSelection) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/data-sources/backup_selection aws_backup_selection} Data Source.
func NewDataAwsBackupSelection(scope constructs.Construct, id *string, config *DataAwsBackupSelectionConfig) DataAwsBackupSelection {
	...
	if err := validateNewDataAwsBackupSelectionParameters(scope, id, config); err != nil {
		panic(err)
	}
	j := jsiiProxy_DataAwsBackupSelection{}

	_jsii_.Create(
		"@cdktn/provider-aws.dataAwsBackupSelection.DataAwsBackupSelection",
...
func (j *jsiiProxy_DataAwsBackupSelection)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsBackupSelection)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsBackupSelection)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_DataAwsBackupSelection)SetRegion(val *string) {
...
func DataAwsBackupSelection_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateDataAwsBackupSelection_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataAwsBackupSelection) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsBackupSelection) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsBackupSelection) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsBackupSelection) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsBackupSelection) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsBackupSelection) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
