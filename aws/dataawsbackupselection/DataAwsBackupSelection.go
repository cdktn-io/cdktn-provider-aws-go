...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v21/dataawsbackupselection/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.28.0/docs/data-sources/backup_selection aws_backup_selection}.
...
func (j *jsiiProxy_DataAwsBackupSelection) ForEach() cdktf.ITerraformIterator {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.28.0/docs/data-sources/backup_selection aws_backup_selection} Data Source.
...
func DataAwsBackupSelection_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
