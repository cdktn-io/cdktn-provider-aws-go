...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/servicediscoveryprivatednsnamespace/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/service_discovery_private_dns_namespace aws_service_discovery_private_dns_namespace}.
...
func (j *jsiiProxy_ServiceDiscoveryPrivateDnsNamespace) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_ServiceDiscoveryPrivateDnsNamespace) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_ServiceDiscoveryPrivateDnsNamespace) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_ServiceDiscoveryPrivateDnsNamespace) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_ServiceDiscoveryPrivateDnsNamespace) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_ServiceDiscoveryPrivateDnsNamespace) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_ServiceDiscoveryPrivateDnsNamespace) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/service_discovery_private_dns_namespace aws_service_discovery_private_dns_namespace} Resource.
func NewServiceDiscoveryPrivateDnsNamespace(scope constructs.Construct, id *string, config *ServiceDiscoveryPrivateDnsNamespaceConfig) ServiceDiscoveryPrivateDnsNamespace {
	...
	_jsii_.Create(
		"@cdktn/provider-aws.serviceDiscoveryPrivateDnsNamespace.ServiceDiscoveryPrivateDnsNamespace",
...
func (j *jsiiProxy_ServiceDiscoveryPrivateDnsNamespace)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_ServiceDiscoveryPrivateDnsNamespace)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_ServiceDiscoveryPrivateDnsNamespace)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_ServiceDiscoveryPrivateDnsNamespace)SetRegion(val *string) {
...
func ServiceDiscoveryPrivateDnsNamespace_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (s *jsiiProxy_ServiceDiscoveryPrivateDnsNamespace) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_ServiceDiscoveryPrivateDnsNamespace) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_ServiceDiscoveryPrivateDnsNamespace) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_ServiceDiscoveryPrivateDnsNamespace) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_ServiceDiscoveryPrivateDnsNamespace) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_ServiceDiscoveryPrivateDnsNamespace) ResetRegion() {
	_jsii_.InvokeVoid(
		s,
		"resetRegion",
		nil, // no parameters
...
func (s *jsiiProxy_ServiceDiscoveryPrivateDnsNamespace) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
