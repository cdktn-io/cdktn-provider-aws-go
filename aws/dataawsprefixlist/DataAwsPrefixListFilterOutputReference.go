...
func (j *jsiiProxy_DataAwsPrefixListFilterOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsPrefixListFilterOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) DataAwsPrefixListFilterOutputReference {
	_init_.Initialize()
...
func NewDataAwsPrefixListFilterOutputReference_Override(d DataAwsPrefixListFilterOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsPrefixListFilterOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsPrefixListFilterOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsPrefixListFilterOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (d *jsiiProxy_DataAwsPrefixListFilterOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsPrefixListFilterOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
