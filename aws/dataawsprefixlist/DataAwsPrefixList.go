...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.39.0/docs/data-sources/prefix_list aws_prefix_list}.
...
func (j *jsiiProxy_DataAwsPrefixList) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsPrefixList) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsPrefixList) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsPrefixList) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsPrefixList) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.39.0/docs/data-sources/prefix_list aws_prefix_list} Data Source.
...
func (j *jsiiProxy_DataAwsPrefixList)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsPrefixList)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsPrefixList)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsPrefixList_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsPrefixList) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsPrefixList) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsPrefixList) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
