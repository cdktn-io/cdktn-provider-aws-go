...
func (j *jsiiProxy_DataAwsPrefixListFilterList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsPrefixListFilterList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsPrefixListFilterList {
	_init_.Initialize()
...
func NewDataAwsPrefixListFilterList_Override(d DataAwsPrefixListFilterList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsPrefixListFilterList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsPrefixListFilterList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsPrefixListFilterList) Resolve(context cdktn.IResolveContext) interface{} {
