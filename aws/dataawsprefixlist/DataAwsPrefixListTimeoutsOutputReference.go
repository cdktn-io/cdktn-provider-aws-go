...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v22/dataawsprefixlist/internal"
...
func (d *jsiiProxy_DataAwsPrefixListTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataAwsPrefixListTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
