...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/route53_zone aws_route53_zone}.
...
func (j *jsiiProxy_Route53Zone) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_Route53Zone) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_Route53Zone) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_Route53Zone) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_Route53Zone) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/route53_zone aws_route53_zone} Resource.
...
func (j *jsiiProxy_Route53Zone)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_Route53Zone)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_Route53Zone)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func Route53Zone_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateRoute53Zone_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (r *jsiiProxy_Route53Zone) AddMoveTarget(moveTarget *string) {
...
func (r *jsiiProxy_Route53Zone) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (r *jsiiProxy_Route53Zone) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (r *jsiiProxy_Route53Zone) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (r *jsiiProxy_Route53Zone) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (r *jsiiProxy_Route53Zone) MoveFromId(id *string) {
...
func (r *jsiiProxy_Route53Zone) MoveToId(id *string) {
...
func (r *jsiiProxy_Route53Zone) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (r *jsiiProxy_Route53Zone) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
