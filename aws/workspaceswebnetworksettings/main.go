...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*WorkspaceswebNetworkSettings)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-aws.workspaceswebNetworkSettings.WorkspaceswebNetworkSettingsConfig",
		reflect.TypeOf((*WorkspaceswebNetworkSettingsConfig)(nil)).Elem(),
	)
}
