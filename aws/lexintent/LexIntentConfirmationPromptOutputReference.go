...
func (l *jsiiProxy_LexIntentConfirmationPromptOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LexIntentConfirmationPromptOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
