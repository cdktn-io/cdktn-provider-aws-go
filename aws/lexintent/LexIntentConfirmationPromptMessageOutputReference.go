...
func (l *jsiiProxy_LexIntentConfirmationPromptMessageOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LexIntentConfirmationPromptMessageOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
