...
func (l *jsiiProxy_LexIntentTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LexIntentTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
