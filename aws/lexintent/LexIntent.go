...
func (j *jsiiProxy_LexIntent) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_LexIntent) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_LexIntent) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_LexIntent) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_LexIntent) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/lex_intent aws_lex_intent} Resource.
...
func (j *jsiiProxy_LexIntent)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_LexIntent)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_LexIntent)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func LexIntent_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (l *jsiiProxy_LexIntent) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LexIntent) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (l *jsiiProxy_LexIntent) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LexIntent) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (l *jsiiProxy_LexIntent) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (l *jsiiProxy_LexIntent) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
