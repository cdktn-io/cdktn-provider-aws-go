...
func (j *jsiiProxy_LexIntentConclusionStatementMessageList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewLexIntentConclusionStatementMessageList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) LexIntentConclusionStatementMessageList {
	_init_.Initialize()
...
func NewLexIntentConclusionStatementMessageList_Override(l LexIntentConclusionStatementMessageList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_LexIntentConclusionStatementMessageList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (l *jsiiProxy_LexIntentConclusionStatementMessageList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (l *jsiiProxy_LexIntentConclusionStatementMessageList) Resolve(context cdktn.IResolveContext) interface{} {
