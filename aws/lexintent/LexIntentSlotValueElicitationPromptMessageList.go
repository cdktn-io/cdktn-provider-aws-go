...
func (j *jsiiProxy_LexIntentSlotValueElicitationPromptMessageList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewLexIntentSlotValueElicitationPromptMessageList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) LexIntentSlotValueElicitationPromptMessageList {
	_init_.Initialize()
...
func NewLexIntentSlotValueElicitationPromptMessageList_Override(l LexIntentSlotValueElicitationPromptMessageList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_LexIntentSlotValueElicitationPromptMessageList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (l *jsiiProxy_LexIntentSlotValueElicitationPromptMessageList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (l *jsiiProxy_LexIntentSlotValueElicitationPromptMessageList) Resolve(context cdktn.IResolveContext) interface{} {
