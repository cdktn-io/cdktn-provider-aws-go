...
func (l *jsiiProxy_LexIntentFulfillmentActivityCodeHookOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LexIntentFulfillmentActivityCodeHookOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
