...
func (l *jsiiProxy_LexIntentDialogCodeHookOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LexIntentDialogCodeHookOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
