...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v24/lexintent/internal"
...
func (j *jsiiProxy_LexIntentSlotValueElicitationPromptMessageOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewLexIntentSlotValueElicitationPromptMessageOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) LexIntentSlotValueElicitationPromptMessageOutputReference {
	_init_.Initialize()

	if err := validateNewLexIntentSlotValueElicitationPromptMessageOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func NewLexIntentSlotValueElicitationPromptMessageOutputReference_Override(l LexIntentSlotValueElicitationPromptMessageOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_LexIntentSlotValueElicitationPromptMessageOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (l *jsiiProxy_LexIntentSlotValueElicitationPromptMessageOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LexIntentSlotValueElicitationPromptMessageOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (l *jsiiProxy_LexIntentSlotValueElicitationPromptMessageOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LexIntentSlotValueElicitationPromptMessageOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
