...
func (j *jsiiProxy_LexIntentConclusionStatementMessageOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewLexIntentConclusionStatementMessageOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) LexIntentConclusionStatementMessageOutputReference {
	_init_.Initialize()

	if err := validateNewLexIntentConclusionStatementMessageOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func NewLexIntentConclusionStatementMessageOutputReference_Override(l LexIntentConclusionStatementMessageOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_LexIntentConclusionStatementMessageOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (l *jsiiProxy_LexIntentConclusionStatementMessageOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LexIntentConclusionStatementMessageOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (l *jsiiProxy_LexIntentConclusionStatementMessageOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LexIntentConclusionStatementMessageOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
