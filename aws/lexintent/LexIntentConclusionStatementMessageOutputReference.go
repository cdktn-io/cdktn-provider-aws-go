...
func (l *jsiiProxy_LexIntentConclusionStatementMessageOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LexIntentConclusionStatementMessageOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
