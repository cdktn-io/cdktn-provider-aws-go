...
func (l *jsiiProxy_LexIntentFollowUpPromptOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LexIntentFollowUpPromptOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
