...
func (l *jsiiProxy_LexIntentConclusionStatementOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LexIntentConclusionStatementOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
