...
func (l *jsiiProxy_LexIntentRejectionStatementMessageOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LexIntentRejectionStatementMessageOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
