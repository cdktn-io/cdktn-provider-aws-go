...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/s3controlmultiregionaccesspointpolicy/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/s3control_multi_region_access_point_policy aws_s3control_multi_region_access_point_policy}.
...
func (j *jsiiProxy_S3ControlMultiRegionAccessPointPolicy) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_S3ControlMultiRegionAccessPointPolicy) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_S3ControlMultiRegionAccessPointPolicy) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_S3ControlMultiRegionAccessPointPolicy) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_S3ControlMultiRegionAccessPointPolicy) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_S3ControlMultiRegionAccessPointPolicy) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_S3ControlMultiRegionAccessPointPolicy) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/s3control_multi_region_access_point_policy aws_s3control_multi_region_access_point_policy} Resource.
func NewS3ControlMultiRegionAccessPointPolicy(scope constructs.Construct, id *string, config *S3ControlMultiRegionAccessPointPolicyConfig) S3ControlMultiRegionAccessPointPolicy {
	...
	_jsii_.Create(
		"@cdktn/provider-aws.s3ControlMultiRegionAccessPointPolicy.S3ControlMultiRegionAccessPointPolicy",
...
func (j *jsiiProxy_S3ControlMultiRegionAccessPointPolicy)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_S3ControlMultiRegionAccessPointPolicy)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_S3ControlMultiRegionAccessPointPolicy)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_S3ControlMultiRegionAccessPointPolicy)SetRegion(val *string) {
...
func S3ControlMultiRegionAccessPointPolicy_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateS3ControlMultiRegionAccessPointPolicy_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
// Experimental.
func S3ControlMultiRegionAccessPointPolicy_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateS3ControlMultiRegionAccessPointPolicy_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func S3ControlMultiRegionAccessPointPolicy_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateS3ControlMultiRegionAccessPointPolicy_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (s *jsiiProxy_S3ControlMultiRegionAccessPointPolicy) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_S3ControlMultiRegionAccessPointPolicy) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_S3ControlMultiRegionAccessPointPolicy) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_S3ControlMultiRegionAccessPointPolicy) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_S3ControlMultiRegionAccessPointPolicy) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_S3ControlMultiRegionAccessPointPolicy) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_S3ControlMultiRegionAccessPointPolicy) ResetRegion() {
	_jsii_.InvokeVoid(
		s,
		"resetRegion",
		nil, // no parameters
...
func (s *jsiiProxy_S3ControlMultiRegionAccessPointPolicy) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (s *jsiiProxy_S3ControlMultiRegionAccessPointPolicy) ToHclTerraform() interface{} {
	var returns interface{}
...
func (s *jsiiProxy_S3ControlMultiRegionAccessPointPolicy) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
