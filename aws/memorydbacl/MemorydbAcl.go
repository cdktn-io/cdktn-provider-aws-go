...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/memorydbacl/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/memorydb_acl aws_memorydb_acl}.
...
func (j *jsiiProxy_MemorydbAcl) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_MemorydbAcl) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_MemorydbAcl) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_MemorydbAcl) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_MemorydbAcl) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_MemorydbAcl) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_MemorydbAcl) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_MemorydbAcl) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/memorydb_acl aws_memorydb_acl} Resource.
func NewMemorydbAcl(scope constructs.Construct, id *string, config *MemorydbAclConfig) MemorydbAcl {
	_init_.Initialize()

	if err := validateNewMemorydbAclParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_MemorydbAcl)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_MemorydbAcl)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_MemorydbAcl)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_MemorydbAcl)SetRegion(val *string) {
...
func MemorydbAcl_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateMemorydbAcl_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (m *jsiiProxy_MemorydbAcl) AddMoveTarget(moveTarget *string) {
...
func (m *jsiiProxy_MemorydbAcl) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MemorydbAcl) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (m *jsiiProxy_MemorydbAcl) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MemorydbAcl) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (m *jsiiProxy_MemorydbAcl) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (m *jsiiProxy_MemorydbAcl) ResetId() {
	_jsii_.InvokeVoid(
		m,
		"resetId",
		nil, // no parameters
...
func (m *jsiiProxy_MemorydbAcl) ResetRegion() {
	_jsii_.InvokeVoid(
		m,
		"resetRegion",
		nil, // no parameters
...
func (m *jsiiProxy_MemorydbAcl) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
