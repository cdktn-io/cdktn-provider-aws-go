...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v22/memorydbacl/internal"
...
func (j *jsiiProxy_MemorydbAcl) ForEach() cdktf.ITerraformIterator {
...
func MemorydbAcl_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
