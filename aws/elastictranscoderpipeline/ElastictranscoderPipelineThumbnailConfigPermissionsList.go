...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/elastictranscoderpipeline/internal"
...
func (j *jsiiProxy_ElastictranscoderPipelineThumbnailConfigPermissionsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewElastictranscoderPipelineThumbnailConfigPermissionsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ElastictranscoderPipelineThumbnailConfigPermissionsList {
	_init_.Initialize()
...
func NewElastictranscoderPipelineThumbnailConfigPermissionsList_Override(e ElastictranscoderPipelineThumbnailConfigPermissionsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ElastictranscoderPipelineThumbnailConfigPermissionsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (e *jsiiProxy_ElastictranscoderPipelineThumbnailConfigPermissionsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (e *jsiiProxy_ElastictranscoderPipelineThumbnailConfigPermissionsList) Resolve(context cdktn.IResolveContext) interface{} {
