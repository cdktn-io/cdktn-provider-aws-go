...
func (e *jsiiProxy_ElastictranscoderPipeline) validateAddMoveTargetParameters(moveTarget *string) error {
	if moveTarget == nil {
...
func (e *jsiiProxy_ElastictranscoderPipeline) validateImportFromParameters(id *string) error {
	if id == nil {
...
func (e *jsiiProxy_ElastictranscoderPipeline) validatePutContentConfigPermissionsParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*ElastictranscoderPipelineContentConfigPermissions; received %#v (a %T)", value, value)
		}
	}
...
func validateElastictranscoderPipeline_GenerateConfigForImportParameters(scope constructs.Construct, importToId *string, importFromId *string) error {
	if scope == nil {
