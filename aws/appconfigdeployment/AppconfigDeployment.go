...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/appconfigdeployment/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/appconfig_deployment aws_appconfig_deployment}.
...
func (j *jsiiProxy_AppconfigDeployment) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_AppconfigDeployment) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_AppconfigDeployment) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_AppconfigDeployment) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_AppconfigDeployment) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_AppconfigDeployment) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_AppconfigDeployment) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/appconfig_deployment aws_appconfig_deployment} Resource.
...
func (j *jsiiProxy_AppconfigDeployment)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_AppconfigDeployment)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_AppconfigDeployment)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_AppconfigDeployment)SetRegion(val *string) {
...
func AppconfigDeployment_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (a *jsiiProxy_AppconfigDeployment) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AppconfigDeployment) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (a *jsiiProxy_AppconfigDeployment) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AppconfigDeployment) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (a *jsiiProxy_AppconfigDeployment) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (a *jsiiProxy_AppconfigDeployment) ResetRegion() {
	_jsii_.InvokeVoid(
		a,
		"resetRegion",
		nil, // no parameters
...
func (a *jsiiProxy_AppconfigDeployment) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
