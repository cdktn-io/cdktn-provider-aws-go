...
func (j *jsiiProxy_ApiGatewayUsagePlanApiStagesList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewApiGatewayUsagePlanApiStagesList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ApiGatewayUsagePlanApiStagesList {
	_init_.Initialize()
...
func NewApiGatewayUsagePlanApiStagesList_Override(a ApiGatewayUsagePlanApiStagesList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ApiGatewayUsagePlanApiStagesList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (a *jsiiProxy_ApiGatewayUsagePlanApiStagesList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (a *jsiiProxy_ApiGatewayUsagePlanApiStagesList) Resolve(context cdktn.IResolveContext) interface{} {
