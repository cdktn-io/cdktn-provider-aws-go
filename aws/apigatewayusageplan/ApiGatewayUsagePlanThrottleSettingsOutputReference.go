...
func (a *jsiiProxy_ApiGatewayUsagePlanThrottleSettingsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_ApiGatewayUsagePlanThrottleSettingsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
