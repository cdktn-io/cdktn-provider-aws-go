...
func (j *jsiiProxy_ApiGatewayUsagePlanApiStagesThrottleList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewApiGatewayUsagePlanApiStagesThrottleList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ApiGatewayUsagePlanApiStagesThrottleList {
	_init_.Initialize()
...
func NewApiGatewayUsagePlanApiStagesThrottleList_Override(a ApiGatewayUsagePlanApiStagesThrottleList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ApiGatewayUsagePlanApiStagesThrottleList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (a *jsiiProxy_ApiGatewayUsagePlanApiStagesThrottleList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (a *jsiiProxy_ApiGatewayUsagePlanApiStagesThrottleList) Resolve(context cdktn.IResolveContext) interface{} {
