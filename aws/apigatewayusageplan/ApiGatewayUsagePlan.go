...
func (j *jsiiProxy_ApiGatewayUsagePlan) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_ApiGatewayUsagePlan) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_ApiGatewayUsagePlan) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_ApiGatewayUsagePlan) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_ApiGatewayUsagePlan) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/api_gateway_usage_plan aws_api_gateway_usage_plan} Resource.
...
func (j *jsiiProxy_ApiGatewayUsagePlan)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_ApiGatewayUsagePlan)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_ApiGatewayUsagePlan)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func ApiGatewayUsagePlan_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (a *jsiiProxy_ApiGatewayUsagePlan) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_ApiGatewayUsagePlan) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (a *jsiiProxy_ApiGatewayUsagePlan) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_ApiGatewayUsagePlan) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (a *jsiiProxy_ApiGatewayUsagePlan) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (a *jsiiProxy_ApiGatewayUsagePlan) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
