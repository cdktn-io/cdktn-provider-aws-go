...
func (j *jsiiProxy_CodedeployDeploymentGroupLoadBalancerInfoElbInfoList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewCodedeployDeploymentGroupLoadBalancerInfoElbInfoList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) CodedeployDeploymentGroupLoadBalancerInfoElbInfoList {
	_init_.Initialize()
...
func NewCodedeployDeploymentGroupLoadBalancerInfoElbInfoList_Override(c CodedeployDeploymentGroupLoadBalancerInfoElbInfoList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_CodedeployDeploymentGroupLoadBalancerInfoElbInfoList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_CodedeployDeploymentGroupLoadBalancerInfoElbInfoList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (c *jsiiProxy_CodedeployDeploymentGroupLoadBalancerInfoElbInfoList) Resolve(context cdktn.IResolveContext) interface{} {
