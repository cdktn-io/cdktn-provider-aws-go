...
func (c *jsiiProxy_CodedeployDeploymentGroupEcsServiceOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CodedeployDeploymentGroupEcsServiceOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
