...
func (j *jsiiProxy_CodedeployDeploymentGroupTriggerConfigurationList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewCodedeployDeploymentGroupTriggerConfigurationList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) CodedeployDeploymentGroupTriggerConfigurationList {
	_init_.Initialize()
...
func NewCodedeployDeploymentGroupTriggerConfigurationList_Override(c CodedeployDeploymentGroupTriggerConfigurationList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_CodedeployDeploymentGroupTriggerConfigurationList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_CodedeployDeploymentGroupTriggerConfigurationList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (c *jsiiProxy_CodedeployDeploymentGroupTriggerConfigurationList) Resolve(context cdktn.IResolveContext) interface{} {
