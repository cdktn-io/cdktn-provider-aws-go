...
func (j *jsiiProxy_CodedeployDeploymentGroupDeploymentStyleOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewCodedeployDeploymentGroupDeploymentStyleOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) CodedeployDeploymentGroupDeploymentStyleOutputReference {
	_init_.Initialize()
...
func NewCodedeployDeploymentGroupDeploymentStyleOutputReference_Override(c CodedeployDeploymentGroupDeploymentStyleOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_CodedeployDeploymentGroupDeploymentStyleOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_CodedeployDeploymentGroupDeploymentStyleOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CodedeployDeploymentGroupDeploymentStyleOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (c *jsiiProxy_CodedeployDeploymentGroupDeploymentStyleOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CodedeployDeploymentGroupDeploymentStyleOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
