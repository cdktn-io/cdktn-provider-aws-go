...
func (c *jsiiProxy_CodedeployDeploymentGroupDeploymentStyleOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CodedeployDeploymentGroupDeploymentStyleOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
