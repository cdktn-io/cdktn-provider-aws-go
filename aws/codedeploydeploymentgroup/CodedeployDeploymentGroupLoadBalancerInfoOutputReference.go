...
func (j *jsiiProxy_CodedeployDeploymentGroupLoadBalancerInfoOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewCodedeployDeploymentGroupLoadBalancerInfoOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) CodedeployDeploymentGroupLoadBalancerInfoOutputReference {
	_init_.Initialize()
...
func NewCodedeployDeploymentGroupLoadBalancerInfoOutputReference_Override(c CodedeployDeploymentGroupLoadBalancerInfoOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_CodedeployDeploymentGroupLoadBalancerInfoOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_CodedeployDeploymentGroupLoadBalancerInfoOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CodedeployDeploymentGroupLoadBalancerInfoOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (c *jsiiProxy_CodedeployDeploymentGroupLoadBalancerInfoOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CodedeployDeploymentGroupLoadBalancerInfoOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
