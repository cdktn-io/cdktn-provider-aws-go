...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetTerminationHookEnabled", GoMethod: "ResetTerminationHookEnabled"},
			...
			_jsii_.MemberProperty{JsiiProperty: "terminationHookEnabledInput", GoGetter: "TerminationHookEnabledInput"},
