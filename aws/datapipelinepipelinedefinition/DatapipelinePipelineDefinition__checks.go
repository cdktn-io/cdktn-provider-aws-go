...
func (d *jsiiProxy_DatapipelinePipelineDefinition) validatePutParameterObjectParameters(value interface{}) error {
	...
	case cdktn.IResolvable:
		// ok
	case *[]*DatapipelinePipelineDefinitionParameterObject:
		value := value.(*[]*DatapipelinePipelineDefinitionParameterObject)
	...
	case []*DatapipelinePipelineDefinitionParameterObject:
		value_ := value.([]*DatapipelinePipelineDefinitionParameterObject)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*DatapipelinePipelineDefinitionParameterObject; received %#v (a %T)", value, value)
		}
	}
...
func (d *jsiiProxy_DatapipelinePipelineDefinition) validatePutParameterValueParameters(value interface{}) error {
	...
	case cdktn.IResolvable:
		// ok
	case *[]*DatapipelinePipelineDefinitionParameterValue:
		value := value.(*[]*DatapipelinePipelineDefinitionParameterValue)
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
			}
	...
	case []*DatapipelinePipelineDefinitionParameterValue:
		value_ := value.([]*DatapipelinePipelineDefinitionParameterValue)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*DatapipelinePipelineDefinitionParameterValue; received %#v (a %T)", value, value)
		}
	}
...
func (d *jsiiProxy_DatapipelinePipelineDefinition) validatePutPipelineObjectParameters(value interface{}) error {
	...
	case cdktn.IResolvable:
		// ok
	case *[]*DatapipelinePipelineDefinitionPipelineObject:
		value := value.(*[]*DatapipelinePipelineDefinitionPipelineObject)
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
			}
	...
	case []*DatapipelinePipelineDefinitionPipelineObject:
		value_ := value.([]*DatapipelinePipelineDefinitionPipelineObject)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*DatapipelinePipelineDefinitionPipelineObject; received %#v (a %T)", value, value)
		}
	}
