...
func (j *jsiiProxy_DatapipelinePipelineDefinitionParameterObjectList) validateSetInternalValueParameters(val interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktf.IResolvable, *[]*DatapipelinePipelineDefinitionParameterObject; received %#v (a %T)", val, val)
		}
	}
