...
func (d *jsiiProxy_DatapipelinePipelineDefinitionPipelineObjectList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DatapipelinePipelineDefinitionPipelineObjectList) Resolve(context cdktf.IResolveContext) interface{} {
