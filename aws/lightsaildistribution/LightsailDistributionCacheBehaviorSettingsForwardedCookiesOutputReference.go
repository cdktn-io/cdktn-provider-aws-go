...
func (l *jsiiProxy_LightsailDistributionCacheBehaviorSettingsForwardedCookiesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LightsailDistributionCacheBehaviorSettingsForwardedCookiesOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
