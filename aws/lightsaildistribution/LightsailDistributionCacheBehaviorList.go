...
func (j *jsiiProxy_LightsailDistributionCacheBehaviorList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewLightsailDistributionCacheBehaviorList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) LightsailDistributionCacheBehaviorList {
	_init_.Initialize()
...
func NewLightsailDistributionCacheBehaviorList_Override(l LightsailDistributionCacheBehaviorList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_LightsailDistributionCacheBehaviorList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (l *jsiiProxy_LightsailDistributionCacheBehaviorList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (l *jsiiProxy_LightsailDistributionCacheBehaviorList) Resolve(context cdktn.IResolveContext) interface{} {
