...
func (j *jsiiProxy_LightsailDistributionCacheBehaviorSettingsForwardedQueryStringsOutputReference) validateSetInternalValueParameters(val *LightsailDistributionCacheBehaviorSettingsForwardedQueryStrings) error {
...
func (j *jsiiProxy_LightsailDistributionCacheBehaviorSettingsForwardedQueryStringsOutputReference) validateSetQueryStringsAllowedListParameters(val *[]*string) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
