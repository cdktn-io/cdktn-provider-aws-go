...
func (s *jsiiProxy_SagemakerDomainRetentionPolicyOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_SagemakerDomainRetentionPolicyOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
