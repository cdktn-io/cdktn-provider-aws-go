...
func (s *jsiiProxy_SagemakerDomainDefaultUserSettingsOutputReference) validatePutCustomFileSystemConfigParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*SagemakerDomainDefaultUserSettingsCustomFileSystemConfig; received %#v (a %T)", value, value)
		}
	}
