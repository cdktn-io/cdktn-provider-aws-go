...
func (s *jsiiProxy_SagemakerDomainDomainSettingsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_SagemakerDomainDomainSettingsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
