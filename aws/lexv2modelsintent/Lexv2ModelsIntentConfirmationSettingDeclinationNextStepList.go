...
func (j *jsiiProxy_Lexv2ModelsIntentConfirmationSettingDeclinationNextStepList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewLexv2ModelsIntentConfirmationSettingDeclinationNextStepList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) Lexv2ModelsIntentConfirmationSettingDeclinationNextStepList {
	_init_.Initialize()
...
func NewLexv2ModelsIntentConfirmationSettingDeclinationNextStepList_Override(l Lexv2ModelsIntentConfirmationSettingDeclinationNextStepList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_Lexv2ModelsIntentConfirmationSettingDeclinationNextStepList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (l *jsiiProxy_Lexv2ModelsIntentConfirmationSettingDeclinationNextStepList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (l *jsiiProxy_Lexv2ModelsIntentConfirmationSettingDeclinationNextStepList) Resolve(context cdktf.IResolveContext) interface{} {
