...
func (l *jsiiProxy_Lexv2ModelsIntentClosingSettingNextStepOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (l *jsiiProxy_Lexv2ModelsIntentClosingSettingNextStepOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
