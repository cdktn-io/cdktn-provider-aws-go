...
func (l *jsiiProxy_Lexv2ModelsIntentInitialResponseSettingConditionalConditionalBranchResponseMessageGroupVariationList) Resolve(context cdktf.IResolveContext) interface{} {
