...
func (l *jsiiProxy_Lexv2ModelsIntentClosingSettingConditionalConditionalBranchResponseMessageGroupVariationSsmlMessageList) Resolve(context cdktf.IResolveContext) interface{} {
