...
func (l *jsiiProxy_Lexv2ModelsIntentConfirmationSettingDeclinationResponseMessageGroupVariationPlainTextMessageList) Resolve(context cdktf.IResolveContext) interface{} {
