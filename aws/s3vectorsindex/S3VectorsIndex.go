...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/s3vectors_index aws_s3vectors_index}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/s3vectors_index aws_s3vectors_index} Resource.
...
func (s *jsiiProxy_S3VectorsIndex) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_S3VectorsIndex) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_S3VectorsIndex) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
