...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v24/sesemailidentity/internal"
...
func (j *jsiiProxy_SesEmailIdentity) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_SesEmailIdentity) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_SesEmailIdentity)SetRegion(val *string) {
...
func (s *jsiiProxy_SesEmailIdentity) ResetRegion() {
	_jsii_.InvokeVoid(
		s,
		"resetRegion",
		nil, // no parameters
