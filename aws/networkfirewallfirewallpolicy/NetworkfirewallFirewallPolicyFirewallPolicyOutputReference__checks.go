...
func (n *jsiiProxy_NetworkfirewallFirewallPolicyFirewallPolicyOutputReference) validatePutStatefulRuleGroupReferenceParameters(value interface{}) error {
	...
	case []*NetworkfirewallFirewallPolicyFirewallPolicyStatefulRuleGroupReference:
		value_ := value.([]*NetworkfirewallFirewallPolicyFirewallPolicyStatefulRuleGroupReference)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
...
func (n *jsiiProxy_NetworkfirewallFirewallPolicyFirewallPolicyOutputReference) validatePutStatelessCustomActionParameters(value interface{}) error {
	...
	case []*NetworkfirewallFirewallPolicyFirewallPolicyStatelessCustomAction:
		value_ := value.([]*NetworkfirewallFirewallPolicyFirewallPolicyStatelessCustomAction)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
...
func (n *jsiiProxy_NetworkfirewallFirewallPolicyFirewallPolicyOutputReference) validatePutStatelessRuleGroupReferenceParameters(value interface{}) error {
	...
	case []*NetworkfirewallFirewallPolicyFirewallPolicyStatelessRuleGroupReference:
		value_ := value.([]*NetworkfirewallFirewallPolicyFirewallPolicyStatelessRuleGroupReference)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
