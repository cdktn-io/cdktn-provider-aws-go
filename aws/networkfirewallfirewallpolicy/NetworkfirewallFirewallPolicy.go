...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/networkfirewall_firewall_policy aws_networkfirewall_firewall_policy}.
...
func (j *jsiiProxy_NetworkfirewallFirewallPolicy) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_NetworkfirewallFirewallPolicy) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_NetworkfirewallFirewallPolicy) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_NetworkfirewallFirewallPolicy) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_NetworkfirewallFirewallPolicy) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_NetworkfirewallFirewallPolicy) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_NetworkfirewallFirewallPolicy) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/networkfirewall_firewall_policy aws_networkfirewall_firewall_policy} Resource.
...
func (j *jsiiProxy_NetworkfirewallFirewallPolicy)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_NetworkfirewallFirewallPolicy)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_NetworkfirewallFirewallPolicy)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_NetworkfirewallFirewallPolicy)SetRegion(val *string) {
...
func NetworkfirewallFirewallPolicy_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (n *jsiiProxy_NetworkfirewallFirewallPolicy) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (n *jsiiProxy_NetworkfirewallFirewallPolicy) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (n *jsiiProxy_NetworkfirewallFirewallPolicy) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (n *jsiiProxy_NetworkfirewallFirewallPolicy) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (n *jsiiProxy_NetworkfirewallFirewallPolicy) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (n *jsiiProxy_NetworkfirewallFirewallPolicy) ResetRegion() {
	_jsii_.InvokeVoid(
		n,
		"resetRegion",
		nil, // no parameters
...
func (n *jsiiProxy_NetworkfirewallFirewallPolicy) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
