...
func (f *jsiiProxy_FsxOntapVolumeTieringPolicyOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (f *jsiiProxy_FsxOntapVolumeTieringPolicyOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
