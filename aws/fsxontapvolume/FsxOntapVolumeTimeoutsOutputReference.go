...
func (f *jsiiProxy_FsxOntapVolumeTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (f *jsiiProxy_FsxOntapVolumeTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
