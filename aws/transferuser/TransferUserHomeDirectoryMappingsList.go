...
func (j *jsiiProxy_TransferUserHomeDirectoryMappingsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewTransferUserHomeDirectoryMappingsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) TransferUserHomeDirectoryMappingsList {
	_init_.Initialize()
...
func NewTransferUserHomeDirectoryMappingsList_Override(t TransferUserHomeDirectoryMappingsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_TransferUserHomeDirectoryMappingsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (t *jsiiProxy_TransferUserHomeDirectoryMappingsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (t *jsiiProxy_TransferUserHomeDirectoryMappingsList) Resolve(context cdktn.IResolveContext) interface{} {
