...
func (t *jsiiProxy_TransferUserPosixProfileOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (t *jsiiProxy_TransferUserPosixProfileOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
