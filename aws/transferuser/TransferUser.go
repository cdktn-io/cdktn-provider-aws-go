...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/transferuser/internal"
...
func (j *jsiiProxy_TransferUser) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_TransferUser) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_TransferUser) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_TransferUser) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_TransferUser) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_TransferUser)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_TransferUser)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_TransferUser)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func TransferUser_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (t *jsiiProxy_TransferUser) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (t *jsiiProxy_TransferUser) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (t *jsiiProxy_TransferUser) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (t *jsiiProxy_TransferUser) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (t *jsiiProxy_TransferUser) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (t *jsiiProxy_TransferUser) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
