...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v22/transferuser/internal"
...
func (t *jsiiProxy_TransferUserHomeDirectoryMappingsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (t *jsiiProxy_TransferUserHomeDirectoryMappingsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
