...
func (c *jsiiProxy_CloudwatchEventEndpointRoutingConfigFailoverConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CloudwatchEventEndpointRoutingConfigFailoverConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
