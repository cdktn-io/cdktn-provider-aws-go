...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/servicediscoverypublicdnsnamespace/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/service_discovery_public_dns_namespace aws_service_discovery_public_dns_namespace}.
...
func (j *jsiiProxy_ServiceDiscoveryPublicDnsNamespace) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_ServiceDiscoveryPublicDnsNamespace) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_ServiceDiscoveryPublicDnsNamespace) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_ServiceDiscoveryPublicDnsNamespace) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_ServiceDiscoveryPublicDnsNamespace) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/service_discovery_public_dns_namespace aws_service_discovery_public_dns_namespace} Resource.
...
func (j *jsiiProxy_ServiceDiscoveryPublicDnsNamespace)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_ServiceDiscoveryPublicDnsNamespace)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_ServiceDiscoveryPublicDnsNamespace)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func ServiceDiscoveryPublicDnsNamespace_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (s *jsiiProxy_ServiceDiscoveryPublicDnsNamespace) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_ServiceDiscoveryPublicDnsNamespace) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_ServiceDiscoveryPublicDnsNamespace) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_ServiceDiscoveryPublicDnsNamespace) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_ServiceDiscoveryPublicDnsNamespace) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_ServiceDiscoveryPublicDnsNamespace) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
