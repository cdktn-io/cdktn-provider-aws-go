...
func (j *jsiiProxy_DataAwsIdentitystoreUser) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsIdentitystoreUser) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsIdentitystoreUser) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsIdentitystoreUser) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsIdentitystoreUser) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DataAwsIdentitystoreUser) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_DataAwsIdentitystoreUser) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DataAwsIdentitystoreUser) UserStatus() *string {
	var returns *string
	_jsii_.Get(
		j,
		"userStatus",
...
func (j *jsiiProxy_DataAwsIdentitystoreUser)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsIdentitystoreUser)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsIdentitystoreUser)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_DataAwsIdentitystoreUser)SetRegion(val *string) {
...
func DataAwsIdentitystoreUser_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsIdentitystoreUser) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsIdentitystoreUser) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsIdentitystoreUser) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsIdentitystoreUser) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
