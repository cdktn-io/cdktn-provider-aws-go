...
func (j *jsiiProxy_SecurityGroupEgressOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewSecurityGroupEgressOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) SecurityGroupEgressOutputReference {
	_init_.Initialize()
...
func NewSecurityGroupEgressOutputReference_Override(s SecurityGroupEgressOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_SecurityGroupEgressOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_SecurityGroupEgressOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SecurityGroupEgressOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (s *jsiiProxy_SecurityGroupEgressOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SecurityGroupEgressOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
