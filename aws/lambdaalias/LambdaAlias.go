...
func (j *jsiiProxy_LambdaAlias) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_LambdaAlias) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_LambdaAlias) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_LambdaAlias) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_LambdaAlias) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_LambdaAlias) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_LambdaAlias) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/lambda_alias aws_lambda_alias} Resource.
...
func (j *jsiiProxy_LambdaAlias)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_LambdaAlias)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_LambdaAlias)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_LambdaAlias)SetRegion(val *string) {
...
func LambdaAlias_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (l *jsiiProxy_LambdaAlias) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LambdaAlias) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (l *jsiiProxy_LambdaAlias) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LambdaAlias) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (l *jsiiProxy_LambdaAlias) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (l *jsiiProxy_LambdaAlias) ResetRegion() {
	_jsii_.InvokeVoid(
		l,
		"resetRegion",
		nil, // no parameters
...
func (l *jsiiProxy_LambdaAlias) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
