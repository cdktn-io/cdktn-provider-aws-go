...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-aws.lambdaAlias.LambdaAliasConfig",
		reflect.TypeOf((*LambdaAliasConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-aws.lambdaAlias.LambdaAliasRoutingConfig",
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-aws.lambdaAlias.LambdaAliasTimeouts",
		reflect.TypeOf((*LambdaAliasTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-aws.lambdaAlias.LambdaAliasTimeoutsOutputReference",
		reflect.TypeOf((*LambdaAliasTimeoutsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
