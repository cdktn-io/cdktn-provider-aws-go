...
func (w *jsiiProxy_WafregionalWebAclRuleActionOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (w *jsiiProxy_WafregionalWebAclRuleActionOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
