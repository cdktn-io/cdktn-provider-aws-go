...
func (w *jsiiProxy_WafregionalWebAclRuleOverrideActionOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (w *jsiiProxy_WafregionalWebAclRuleOverrideActionOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
