...
func (w *jsiiProxy_WafregionalWebAclRuleList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
	return nil
}
...
func (w *jsiiProxy_WafregionalWebAclRuleList) validateResolveParameters(context cdktf.IResolveContext) error {
	return nil
}
