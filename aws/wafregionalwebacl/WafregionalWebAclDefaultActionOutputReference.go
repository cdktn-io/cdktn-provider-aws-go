...
func (w *jsiiProxy_WafregionalWebAclDefaultActionOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (w *jsiiProxy_WafregionalWebAclDefaultActionOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
