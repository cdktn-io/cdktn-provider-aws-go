...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/wafregionalwebacl/internal"
...
func (j *jsiiProxy_WafregionalWebAclLoggingConfigurationRedactedFieldsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewWafregionalWebAclLoggingConfigurationRedactedFieldsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) WafregionalWebAclLoggingConfigurationRedactedFieldsOutputReference {
	_init_.Initialize()

	if err := validateNewWafregionalWebAclLoggingConfigurationRedactedFieldsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewWafregionalWebAclLoggingConfigurationRedactedFieldsOutputReference_Override(w WafregionalWebAclLoggingConfigurationRedactedFieldsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_WafregionalWebAclLoggingConfigurationRedactedFieldsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (w *jsiiProxy_WafregionalWebAclLoggingConfigurationRedactedFieldsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_WafregionalWebAclLoggingConfigurationRedactedFieldsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (w *jsiiProxy_WafregionalWebAclLoggingConfigurationRedactedFieldsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_WafregionalWebAclLoggingConfigurationRedactedFieldsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
