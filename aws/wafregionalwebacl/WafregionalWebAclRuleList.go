...
func (w *jsiiProxy_WafregionalWebAclRuleList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (w *jsiiProxy_WafregionalWebAclRuleList) Resolve(context cdktf.IResolveContext) interface{} {
