...
func (j *jsiiProxy_WafregionalWebAclRuleList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewWafregionalWebAclRuleList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) WafregionalWebAclRuleList {
	_init_.Initialize()

	if err := validateNewWafregionalWebAclRuleListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewWafregionalWebAclRuleList_Override(w WafregionalWebAclRuleList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_WafregionalWebAclRuleList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (w *jsiiProxy_WafregionalWebAclRuleList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (w *jsiiProxy_WafregionalWebAclRuleList) Resolve(context cdktn.IResolveContext) interface{} {
