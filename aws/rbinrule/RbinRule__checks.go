...
func (r *jsiiProxy_RbinRule) validatePutExcludeResourceTagsParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*RbinRuleExcludeResourceTags; received %#v (a %T)", value, value)
		}
	}
...
func (r *jsiiProxy_RbinRule) validatePutResourceTagsParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*RbinRuleResourceTags; received %#v (a %T)", value, value)
		}
	}
...
func (j *jsiiProxy_RbinRule) validateSetLifecycleParameters(val *cdktn.TerraformResourceLifecycle) error {
	if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
		return err
	}
...
func (j *jsiiProxy_RbinRule) validateSetRegionParameters(val *string) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
