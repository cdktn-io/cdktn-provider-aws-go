...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/secretsmanagersecret/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/secretsmanager_secret aws_secretsmanager_secret}.
...
func (j *jsiiProxy_SecretsmanagerSecret) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_SecretsmanagerSecret) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_SecretsmanagerSecret) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_SecretsmanagerSecret) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_SecretsmanagerSecret) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_SecretsmanagerSecret) Type() *string {
	var returns *string
	_jsii_.Get(
		j,
		"type",
...
func (j *jsiiProxy_SecretsmanagerSecret) TypeInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"typeInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/secretsmanager_secret aws_secretsmanager_secret} Resource.
...
func (j *jsiiProxy_SecretsmanagerSecret)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_SecretsmanagerSecret)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_SecretsmanagerSecret)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_SecretsmanagerSecret)SetType(val *string) {
...
func SecretsmanagerSecret_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (s *jsiiProxy_SecretsmanagerSecret) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SecretsmanagerSecret) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_SecretsmanagerSecret) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SecretsmanagerSecret) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_SecretsmanagerSecret) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_SecretsmanagerSecret) ResetType() {
	_jsii_.InvokeVoid(
		s,
		"resetType",
		nil, // no parameters
...
func (s *jsiiProxy_SecretsmanagerSecret) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
