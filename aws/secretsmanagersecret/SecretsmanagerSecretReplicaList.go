...
func (s *jsiiProxy_SecretsmanagerSecretReplicaList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (s *jsiiProxy_SecretsmanagerSecretReplicaList) Resolve(context cdktf.IResolveContext) interface{} {
