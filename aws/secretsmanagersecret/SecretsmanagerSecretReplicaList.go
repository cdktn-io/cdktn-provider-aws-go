...
func (j *jsiiProxy_SecretsmanagerSecretReplicaList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewSecretsmanagerSecretReplicaList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) SecretsmanagerSecretReplicaList {
	_init_.Initialize()
...
func NewSecretsmanagerSecretReplicaList_Override(s SecretsmanagerSecretReplicaList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_SecretsmanagerSecretReplicaList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_SecretsmanagerSecretReplicaList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (s *jsiiProxy_SecretsmanagerSecretReplicaList) Resolve(context cdktn.IResolveContext) interface{} {
