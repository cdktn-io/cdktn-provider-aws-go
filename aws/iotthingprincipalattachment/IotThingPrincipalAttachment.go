...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v21/iotthingprincipalattachment/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.28.0/docs/resources/iot_thing_principal_attachment aws_iot_thing_principal_attachment}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.28.0/docs/resources/iot_thing_principal_attachment aws_iot_thing_principal_attachment} Resource.
...
func IotThingPrincipalAttachment_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (i *jsiiProxy_IotThingPrincipalAttachment) ImportFrom(id *string, provider cdktf.TerraformProvider) {
