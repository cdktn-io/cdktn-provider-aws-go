...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/iotthingprincipalattachment/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/iot_thing_principal_attachment aws_iot_thing_principal_attachment}.
...
func (j *jsiiProxy_IotThingPrincipalAttachment) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_IotThingPrincipalAttachment) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_IotThingPrincipalAttachment) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_IotThingPrincipalAttachment) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_IotThingPrincipalAttachment) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_IotThingPrincipalAttachment) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_IotThingPrincipalAttachment) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/iot_thing_principal_attachment aws_iot_thing_principal_attachment} Resource.
...
func (j *jsiiProxy_IotThingPrincipalAttachment)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_IotThingPrincipalAttachment)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_IotThingPrincipalAttachment)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_IotThingPrincipalAttachment)SetRegion(val *string) {
...
func IotThingPrincipalAttachment_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateIotThingPrincipalAttachment_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (i *jsiiProxy_IotThingPrincipalAttachment) AddMoveTarget(moveTarget *string) {
...
func (i *jsiiProxy_IotThingPrincipalAttachment) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (i *jsiiProxy_IotThingPrincipalAttachment) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (i *jsiiProxy_IotThingPrincipalAttachment) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (i *jsiiProxy_IotThingPrincipalAttachment) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (i *jsiiProxy_IotThingPrincipalAttachment) MoveFromId(id *string) {
...
func (i *jsiiProxy_IotThingPrincipalAttachment) MoveToId(id *string) {
...
func (i *jsiiProxy_IotThingPrincipalAttachment) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (i *jsiiProxy_IotThingPrincipalAttachment) ResetRegion() {
	_jsii_.InvokeVoid(
		i,
		"resetRegion",
		nil, // no parameters
...
func (i *jsiiProxy_IotThingPrincipalAttachment) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
