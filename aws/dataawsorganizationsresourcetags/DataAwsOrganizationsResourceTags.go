...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/dataawsorganizationsresourcetags/internal"
...
func (j *jsiiProxy_DataAwsOrganizationsResourceTags) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsOrganizationsResourceTags) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsOrganizationsResourceTags) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsOrganizationsResourceTags) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsOrganizationsResourceTags) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func NewDataAwsOrganizationsResourceTags(scope constructs.Construct, id *string, config *DataAwsOrganizationsResourceTagsConfig) DataAwsOrganizationsResourceTags {
	...
	_jsii_.Create(
		"@cdktn/provider-aws.dataAwsOrganizationsResourceTags.DataAwsOrganizationsResourceTags",
...
func (j *jsiiProxy_DataAwsOrganizationsResourceTags)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsOrganizationsResourceTags)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsOrganizationsResourceTags)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsOrganizationsResourceTags_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsOrganizationsResourceTags) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsOrganizationsResourceTags) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsOrganizationsResourceTags) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsOrganizationsResourceTags) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
