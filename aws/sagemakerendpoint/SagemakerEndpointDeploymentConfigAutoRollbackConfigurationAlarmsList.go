...
func (j *jsiiProxy_SagemakerEndpointDeploymentConfigAutoRollbackConfigurationAlarmsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewSagemakerEndpointDeploymentConfigAutoRollbackConfigurationAlarmsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) SagemakerEndpointDeploymentConfigAutoRollbackConfigurationAlarmsList {
	_init_.Initialize()
...
func NewSagemakerEndpointDeploymentConfigAutoRollbackConfigurationAlarmsList_Override(s SagemakerEndpointDeploymentConfigAutoRollbackConfigurationAlarmsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_SagemakerEndpointDeploymentConfigAutoRollbackConfigurationAlarmsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_SagemakerEndpointDeploymentConfigAutoRollbackConfigurationAlarmsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (s *jsiiProxy_SagemakerEndpointDeploymentConfigAutoRollbackConfigurationAlarmsList) Resolve(context cdktn.IResolveContext) interface{} {
