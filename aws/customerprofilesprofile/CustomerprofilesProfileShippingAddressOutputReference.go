...
func (c *jsiiProxy_CustomerprofilesProfileShippingAddressOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CustomerprofilesProfileShippingAddressOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
