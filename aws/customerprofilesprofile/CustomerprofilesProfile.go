...
func (j *jsiiProxy_CustomerprofilesProfile) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_CustomerprofilesProfile) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_CustomerprofilesProfile) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_CustomerprofilesProfile) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_CustomerprofilesProfile) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/customerprofiles_profile aws_customerprofiles_profile} Resource.
...
func (j *jsiiProxy_CustomerprofilesProfile)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_CustomerprofilesProfile)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_CustomerprofilesProfile)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func CustomerprofilesProfile_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (c *jsiiProxy_CustomerprofilesProfile) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CustomerprofilesProfile) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (c *jsiiProxy_CustomerprofilesProfile) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CustomerprofilesProfile) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_CustomerprofilesProfile) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (c *jsiiProxy_CustomerprofilesProfile) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
