...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/sesdomainidentityverification/internal"
...
func (j *jsiiProxy_SesDomainIdentityVerification) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_SesDomainIdentityVerification) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_SesDomainIdentityVerification) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_SesDomainIdentityVerification) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_SesDomainIdentityVerification) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_SesDomainIdentityVerification)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_SesDomainIdentityVerification)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_SesDomainIdentityVerification)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func SesDomainIdentityVerification_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (s *jsiiProxy_SesDomainIdentityVerification) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SesDomainIdentityVerification) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_SesDomainIdentityVerification) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SesDomainIdentityVerification) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_SesDomainIdentityVerification) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_SesDomainIdentityVerification) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
