...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v21/quicksightiprestriction/internal"
...
func (j *jsiiProxy_QuicksightIpRestriction) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_QuicksightIpRestriction) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_QuicksightIpRestriction) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_QuicksightIpRestriction) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_QuicksightIpRestriction) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_QuicksightIpRestriction)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_QuicksightIpRestriction)SetLifecycle(val *cdktf.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_QuicksightIpRestriction)SetProvider(val cdktf.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func QuicksightIpRestriction_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (q *jsiiProxy_QuicksightIpRestriction) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (q *jsiiProxy_QuicksightIpRestriction) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (q *jsiiProxy_QuicksightIpRestriction) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
