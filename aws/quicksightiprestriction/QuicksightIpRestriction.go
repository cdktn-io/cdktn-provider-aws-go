...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/quicksightiprestriction/internal"
...
func (q *jsiiProxy_QuicksightIpRestriction) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (q *jsiiProxy_QuicksightIpRestriction) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
