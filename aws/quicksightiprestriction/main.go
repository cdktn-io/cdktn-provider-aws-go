...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "ipRestrictionRuleMap", GoGetter: "IpRestrictionRuleMap"},
			_jsii_.MemberProperty{JsiiProperty: "ipRestrictionRuleMapInput", GoGetter: "IpRestrictionRuleMapInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetIpRestrictionRuleMap", GoMethod: "ResetIpRestrictionRuleMap"},
			_jsii_.MemberMethod{JsiiMethod: "resetOverrideLogicalId", GoMethod: "ResetOverrideLogicalId"},
			_jsii_.MemberMethod{JsiiMethod: "resetRegion", GoMethod: "ResetRegion"},
			_jsii_.MemberMethod{JsiiMethod: "resetVpcEndpointIdRestrictionRuleMap", GoMethod: "ResetVpcEndpointIdRestrictionRuleMap"},
			_jsii_.MemberMethod{JsiiMethod: "resetVpcIdRestrictionRuleMap", GoMethod: "ResetVpcIdRestrictionRuleMap"},
			...
			_jsii_.MemberProperty{JsiiProperty: "vpcEndpointIdRestrictionRuleMap", GoGetter: "VpcEndpointIdRestrictionRuleMap"},
