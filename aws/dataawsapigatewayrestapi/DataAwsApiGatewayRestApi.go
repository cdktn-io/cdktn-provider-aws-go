...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/dataawsapigatewayrestapi/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/data-sources/api_gateway_rest_api aws_api_gateway_rest_api}.
...
func (j *jsiiProxy_DataAwsApiGatewayRestApi) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsApiGatewayRestApi) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsApiGatewayRestApi) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsApiGatewayRestApi) MinimumCompressionSize() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataAwsApiGatewayRestApi) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsApiGatewayRestApi) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DataAwsApiGatewayRestApi) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_DataAwsApiGatewayRestApi) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/data-sources/api_gateway_rest_api aws_api_gateway_rest_api} Data Source.
func NewDataAwsApiGatewayRestApi(scope constructs.Construct, id *string, config *DataAwsApiGatewayRestApiConfig) DataAwsApiGatewayRestApi {
	...
	_jsii_.Create(
		"@cdktn/provider-aws.dataAwsApiGatewayRestApi.DataAwsApiGatewayRestApi",
...
func (j *jsiiProxy_DataAwsApiGatewayRestApi)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsApiGatewayRestApi)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsApiGatewayRestApi)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_DataAwsApiGatewayRestApi)SetRegion(val *string) {
...
func DataAwsApiGatewayRestApi_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateDataAwsApiGatewayRestApi_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataAwsApiGatewayRestApi) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsApiGatewayRestApi) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsApiGatewayRestApi) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsApiGatewayRestApi) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsApiGatewayRestApi) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
