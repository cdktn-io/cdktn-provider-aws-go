...
func (j *jsiiProxy_DataAwsApiGatewayRestApiEndpointConfigurationList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsApiGatewayRestApiEndpointConfigurationList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsApiGatewayRestApiEndpointConfigurationList {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-aws.dataAwsApiGatewayRestApi.DataAwsApiGatewayRestApiEndpointConfigurationList",
...
func NewDataAwsApiGatewayRestApiEndpointConfigurationList_Override(d DataAwsApiGatewayRestApiEndpointConfigurationList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsApiGatewayRestApiEndpointConfigurationList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsApiGatewayRestApiEndpointConfigurationList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsApiGatewayRestApiEndpointConfigurationList) Resolve(context cdktn.IResolveContext) interface{} {
