...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/configaggregateauthorization/internal"
...
func (j *jsiiProxy_ConfigAggregateAuthorization) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_ConfigAggregateAuthorization) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_ConfigAggregateAuthorization) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_ConfigAggregateAuthorization) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_ConfigAggregateAuthorization) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/config_aggregate_authorization aws_config_aggregate_authorization} Resource.
...
func (j *jsiiProxy_ConfigAggregateAuthorization)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_ConfigAggregateAuthorization)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_ConfigAggregateAuthorization)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func ConfigAggregateAuthorization_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (c *jsiiProxy_ConfigAggregateAuthorization) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_ConfigAggregateAuthorization) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (c *jsiiProxy_ConfigAggregateAuthorization) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_ConfigAggregateAuthorization) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_ConfigAggregateAuthorization) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (c *jsiiProxy_ConfigAggregateAuthorization) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
