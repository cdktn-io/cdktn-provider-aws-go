...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/ssmactivation/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/ssm_activation aws_ssm_activation}.
...
func (j *jsiiProxy_SsmActivation) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_SsmActivation) Expired() cdktn.IResolvable {
...
func (j *jsiiProxy_SsmActivation) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_SsmActivation) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_SsmActivation) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_SsmActivation) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/ssm_activation aws_ssm_activation} Resource.
func NewSsmActivation(scope constructs.Construct, id *string, config *SsmActivationConfig) SsmActivation {
	...
	_jsii_.Create(
		"@cdktn/provider-aws.ssmActivation.SsmActivation",
...
func (j *jsiiProxy_SsmActivation)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_SsmActivation)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_SsmActivation)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func SsmActivation_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (s *jsiiProxy_SsmActivation) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SsmActivation) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_SsmActivation) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SsmActivation) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_SsmActivation) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_SsmActivation) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
