...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v22/connectuser/internal"
...
func (c *jsiiProxy_ConnectUserPhoneConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ConnectUserPhoneConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
