...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v23/connectuser/internal"
...
func (j *jsiiProxy_ConnectUserPhoneConfigOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewConnectUserPhoneConfigOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) ConnectUserPhoneConfigOutputReference {
	_init_.Initialize()
...
func NewConnectUserPhoneConfigOutputReference_Override(c ConnectUserPhoneConfigOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_ConnectUserPhoneConfigOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_ConnectUserPhoneConfigOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_ConnectUserPhoneConfigOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (c *jsiiProxy_ConnectUserPhoneConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_ConnectUserPhoneConfigOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
