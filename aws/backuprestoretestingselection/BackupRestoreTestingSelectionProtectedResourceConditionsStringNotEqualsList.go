...
func (j *jsiiProxy_BackupRestoreTestingSelectionProtectedResourceConditionsStringNotEqualsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewBackupRestoreTestingSelectionProtectedResourceConditionsStringNotEqualsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) BackupRestoreTestingSelectionProtectedResourceConditionsStringNotEqualsList {
	_init_.Initialize()
...
func NewBackupRestoreTestingSelectionProtectedResourceConditionsStringNotEqualsList_Override(b BackupRestoreTestingSelectionProtectedResourceConditionsStringNotEqualsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_BackupRestoreTestingSelectionProtectedResourceConditionsStringNotEqualsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (b *jsiiProxy_BackupRestoreTestingSelectionProtectedResourceConditionsStringNotEqualsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (b *jsiiProxy_BackupRestoreTestingSelectionProtectedResourceConditionsStringNotEqualsList) Resolve(context cdktn.IResolveContext) interface{} {
