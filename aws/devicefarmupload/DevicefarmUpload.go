...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/devicefarmupload/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/devicefarm_upload aws_devicefarm_upload}.
...
func (j *jsiiProxy_DevicefarmUpload) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DevicefarmUpload) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DevicefarmUpload) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DevicefarmUpload) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DevicefarmUpload) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/devicefarm_upload aws_devicefarm_upload} Resource.
...
func (j *jsiiProxy_DevicefarmUpload)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DevicefarmUpload)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DevicefarmUpload)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DevicefarmUpload_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DevicefarmUpload) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DevicefarmUpload) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (d *jsiiProxy_DevicefarmUpload) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DevicefarmUpload) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (d *jsiiProxy_DevicefarmUpload) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DevicefarmUpload) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
