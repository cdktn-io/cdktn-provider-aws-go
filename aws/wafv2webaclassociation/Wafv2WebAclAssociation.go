...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/wafv2webaclassociation/internal"
...
func (j *jsiiProxy_Wafv2WebAclAssociation) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_Wafv2WebAclAssociation) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_Wafv2WebAclAssociation) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_Wafv2WebAclAssociation) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_Wafv2WebAclAssociation) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/wafv2_web_acl_association aws_wafv2_web_acl_association} Resource.
...
func (j *jsiiProxy_Wafv2WebAclAssociation)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_Wafv2WebAclAssociation)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_Wafv2WebAclAssociation)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func Wafv2WebAclAssociation_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (w *jsiiProxy_Wafv2WebAclAssociation) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_Wafv2WebAclAssociation) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (w *jsiiProxy_Wafv2WebAclAssociation) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_Wafv2WebAclAssociation) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (w *jsiiProxy_Wafv2WebAclAssociation) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
