...
func (o *jsiiProxy_OdbCloudAutonomousVmClusterMaintenanceWindowList) validateGetParameters(index *float64) error {
	if index == nil {
...
func (j *jsiiProxy_OdbCloudAutonomousVmClusterMaintenanceWindowList) validateSetInternalValueParameters(val interface{}) error {
	...
	case []*OdbCloudAutonomousVmClusterMaintenanceWindow:
		val_ := val.([]*OdbCloudAutonomousVmClusterMaintenanceWindow)
		val := &val_
		for idx_97dfc6, v := range *val {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
				return err
...
func (j *jsiiProxy_OdbCloudAutonomousVmClusterMaintenanceWindowList) validateSetTerraformAttributeParameters(val *string) error {
	if val == nil {
...
func (j *jsiiProxy_OdbCloudAutonomousVmClusterMaintenanceWindowList) validateSetWrapsSetParameters(val *bool) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
