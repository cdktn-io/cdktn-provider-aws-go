...
func (o *jsiiProxy_OdbCloudAutonomousVmClusterMaintenanceWindowDaysOfWeekList) validateResolveParameters(context cdktn.IResolveContext) error {
	if context == nil {
...
func (j *jsiiProxy_OdbCloudAutonomousVmClusterMaintenanceWindowDaysOfWeekList) validateSetTerraformResourceParameters(val cdktn.IInterpolatingParent) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func validateNewOdbCloudAutonomousVmClusterMaintenanceWindowDaysOfWeekListParameters(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) error {
