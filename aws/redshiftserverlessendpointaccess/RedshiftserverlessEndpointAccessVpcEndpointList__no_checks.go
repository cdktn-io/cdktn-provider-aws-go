...
func (j *jsiiProxy_RedshiftserverlessEndpointAccessVpcEndpointList) validateSetTerraformAttributeParameters(val *string) error {
	return nil
}
...
func (j *jsiiProxy_RedshiftserverlessEndpointAccessVpcEndpointList) validateSetWrapsSetParameters(val *bool) error {
	return nil
}
