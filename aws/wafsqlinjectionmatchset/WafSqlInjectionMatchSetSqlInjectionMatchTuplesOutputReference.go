...
func (j *jsiiProxy_WafSqlInjectionMatchSetSqlInjectionMatchTuplesOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewWafSqlInjectionMatchSetSqlInjectionMatchTuplesOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) WafSqlInjectionMatchSetSqlInjectionMatchTuplesOutputReference {
	_init_.Initialize()
...
func NewWafSqlInjectionMatchSetSqlInjectionMatchTuplesOutputReference_Override(w WafSqlInjectionMatchSetSqlInjectionMatchTuplesOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_WafSqlInjectionMatchSetSqlInjectionMatchTuplesOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (w *jsiiProxy_WafSqlInjectionMatchSetSqlInjectionMatchTuplesOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_WafSqlInjectionMatchSetSqlInjectionMatchTuplesOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (w *jsiiProxy_WafSqlInjectionMatchSetSqlInjectionMatchTuplesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_WafSqlInjectionMatchSetSqlInjectionMatchTuplesOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
