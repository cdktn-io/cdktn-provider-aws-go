...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/wafsqlinjectionmatchset/internal"
...
func (j *jsiiProxy_WafSqlInjectionMatchSet) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_WafSqlInjectionMatchSet) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_WafSqlInjectionMatchSet) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_WafSqlInjectionMatchSet) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_WafSqlInjectionMatchSet) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_WafSqlInjectionMatchSet)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_WafSqlInjectionMatchSet)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_WafSqlInjectionMatchSet)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func WafSqlInjectionMatchSet_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (w *jsiiProxy_WafSqlInjectionMatchSet) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_WafSqlInjectionMatchSet) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (w *jsiiProxy_WafSqlInjectionMatchSet) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_WafSqlInjectionMatchSet) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (w *jsiiProxy_WafSqlInjectionMatchSet) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (w *jsiiProxy_WafSqlInjectionMatchSet) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
