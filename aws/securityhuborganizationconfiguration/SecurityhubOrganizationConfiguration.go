...
func (j *jsiiProxy_SecurityhubOrganizationConfiguration) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_SecurityhubOrganizationConfiguration) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_SecurityhubOrganizationConfiguration) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_SecurityhubOrganizationConfiguration) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_SecurityhubOrganizationConfiguration) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_SecurityhubOrganizationConfiguration) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_SecurityhubOrganizationConfiguration) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/securityhub_organization_configuration aws_securityhub_organization_configuration} Resource.
func NewSecurityhubOrganizationConfiguration(scope constructs.Construct, id *string, config *SecurityhubOrganizationConfigurationConfig) SecurityhubOrganizationConfiguration {
	...
	_jsii_.Create(
		"@cdktn/provider-aws.securityhubOrganizationConfiguration.SecurityhubOrganizationConfiguration",
...
func (j *jsiiProxy_SecurityhubOrganizationConfiguration)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_SecurityhubOrganizationConfiguration)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_SecurityhubOrganizationConfiguration)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_SecurityhubOrganizationConfiguration)SetRegion(val *string) {
...
func SecurityhubOrganizationConfiguration_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (s *jsiiProxy_SecurityhubOrganizationConfiguration) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SecurityhubOrganizationConfiguration) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_SecurityhubOrganizationConfiguration) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SecurityhubOrganizationConfiguration) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_SecurityhubOrganizationConfiguration) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_SecurityhubOrganizationConfiguration) ResetRegion() {
	_jsii_.InvokeVoid(
		s,
		"resetRegion",
		nil, // no parameters
...
func (s *jsiiProxy_SecurityhubOrganizationConfiguration) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
