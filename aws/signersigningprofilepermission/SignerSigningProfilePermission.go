...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/signersigningprofilepermission/internal"
...
func (j *jsiiProxy_SignerSigningProfilePermission) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_SignerSigningProfilePermission) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_SignerSigningProfilePermission) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_SignerSigningProfilePermission) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_SignerSigningProfilePermission) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_SignerSigningProfilePermission) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_SignerSigningProfilePermission) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_SignerSigningProfilePermission)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_SignerSigningProfilePermission)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_SignerSigningProfilePermission)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_SignerSigningProfilePermission)SetRegion(val *string) {
...
func SignerSigningProfilePermission_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (s *jsiiProxy_SignerSigningProfilePermission) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SignerSigningProfilePermission) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_SignerSigningProfilePermission) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SignerSigningProfilePermission) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_SignerSigningProfilePermission) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_SignerSigningProfilePermission) ResetRegion() {
	_jsii_.InvokeVoid(
		s,
		"resetRegion",
		nil, // no parameters
...
func (s *jsiiProxy_SignerSigningProfilePermission) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
