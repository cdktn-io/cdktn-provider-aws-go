...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/dataawspricingproduct/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/data-sources/pricing_product aws_pricing_product}.
...
func (j *jsiiProxy_DataAwsPricingProduct) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsPricingProduct) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsPricingProduct) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsPricingProduct) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsPricingProduct) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/data-sources/pricing_product aws_pricing_product} Data Source.
...
func (j *jsiiProxy_DataAwsPricingProduct)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsPricingProduct)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsPricingProduct)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsPricingProduct_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsPricingProduct) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsPricingProduct) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsPricingProduct) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsPricingProduct) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
