...
func (j *jsiiProxy_ServiceDiscoveryServiceDnsConfigOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewServiceDiscoveryServiceDnsConfigOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) ServiceDiscoveryServiceDnsConfigOutputReference {
	_init_.Initialize()
...
func NewServiceDiscoveryServiceDnsConfigOutputReference_Override(s ServiceDiscoveryServiceDnsConfigOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_ServiceDiscoveryServiceDnsConfigOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_ServiceDiscoveryServiceDnsConfigOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_ServiceDiscoveryServiceDnsConfigOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (s *jsiiProxy_ServiceDiscoveryServiceDnsConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_ServiceDiscoveryServiceDnsConfigOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
