...
func (j *jsiiProxy_ServiceDiscoveryServiceDnsConfigDnsRecordsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewServiceDiscoveryServiceDnsConfigDnsRecordsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ServiceDiscoveryServiceDnsConfigDnsRecordsList {
	_init_.Initialize()
...
func NewServiceDiscoveryServiceDnsConfigDnsRecordsList_Override(s ServiceDiscoveryServiceDnsConfigDnsRecordsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ServiceDiscoveryServiceDnsConfigDnsRecordsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_ServiceDiscoveryServiceDnsConfigDnsRecordsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (s *jsiiProxy_ServiceDiscoveryServiceDnsConfigDnsRecordsList) Resolve(context cdktn.IResolveContext) interface{} {
