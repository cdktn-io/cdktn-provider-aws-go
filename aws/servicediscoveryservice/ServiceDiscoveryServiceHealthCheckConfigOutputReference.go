...
func (s *jsiiProxy_ServiceDiscoveryServiceHealthCheckConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_ServiceDiscoveryServiceHealthCheckConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
