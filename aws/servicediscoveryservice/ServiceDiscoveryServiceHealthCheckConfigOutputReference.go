...
func (j *jsiiProxy_ServiceDiscoveryServiceHealthCheckConfigOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewServiceDiscoveryServiceHealthCheckConfigOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) ServiceDiscoveryServiceHealthCheckConfigOutputReference {
	_init_.Initialize()
...
func NewServiceDiscoveryServiceHealthCheckConfigOutputReference_Override(s ServiceDiscoveryServiceHealthCheckConfigOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_ServiceDiscoveryServiceHealthCheckConfigOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_ServiceDiscoveryServiceHealthCheckConfigOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_ServiceDiscoveryServiceHealthCheckConfigOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (s *jsiiProxy_ServiceDiscoveryServiceHealthCheckConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_ServiceDiscoveryServiceHealthCheckConfigOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
