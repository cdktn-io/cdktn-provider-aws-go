...
func (s *jsiiProxy_ServiceDiscoveryServiceHealthCheckCustomConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_ServiceDiscoveryServiceHealthCheckCustomConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
