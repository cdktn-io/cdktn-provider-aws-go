...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v21/servicediscoveryservice/internal"
...
func (s *jsiiProxy_ServiceDiscoveryServiceDnsConfigDnsRecordsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_ServiceDiscoveryServiceDnsConfigDnsRecordsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
