...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/servicediscoveryservice/internal"
...
func (j *jsiiProxy_ServiceDiscoveryServiceDnsConfigDnsRecordsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewServiceDiscoveryServiceDnsConfigDnsRecordsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) ServiceDiscoveryServiceDnsConfigDnsRecordsOutputReference {
	_init_.Initialize()
...
func NewServiceDiscoveryServiceDnsConfigDnsRecordsOutputReference_Override(s ServiceDiscoveryServiceDnsConfigDnsRecordsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ServiceDiscoveryServiceDnsConfigDnsRecordsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_ServiceDiscoveryServiceDnsConfigDnsRecordsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_ServiceDiscoveryServiceDnsConfigDnsRecordsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (s *jsiiProxy_ServiceDiscoveryServiceDnsConfigDnsRecordsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_ServiceDiscoveryServiceDnsConfigDnsRecordsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
