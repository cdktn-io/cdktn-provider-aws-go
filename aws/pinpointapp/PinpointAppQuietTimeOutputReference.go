...
func (p *jsiiProxy_PinpointAppQuietTimeOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (p *jsiiProxy_PinpointAppQuietTimeOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
