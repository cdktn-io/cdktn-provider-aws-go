...
func (p *jsiiProxy_PinpointAppLimitsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (p *jsiiProxy_PinpointAppLimitsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
