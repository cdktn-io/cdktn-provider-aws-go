...
func (j *jsiiProxy_PinpointAppLimitsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewPinpointAppLimitsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) PinpointAppLimitsOutputReference {
	_init_.Initialize()
...
func NewPinpointAppLimitsOutputReference_Override(p PinpointAppLimitsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_PinpointAppLimitsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (p *jsiiProxy_PinpointAppLimitsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PinpointAppLimitsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (p *jsiiProxy_PinpointAppLimitsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PinpointAppLimitsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
