...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/pinpointapp/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/pinpoint_app aws_pinpoint_app}.
...
func (j *jsiiProxy_PinpointApp) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_PinpointApp) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_PinpointApp) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_PinpointApp) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_PinpointApp) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/pinpoint_app aws_pinpoint_app} Resource.
...
func (j *jsiiProxy_PinpointApp)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_PinpointApp)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_PinpointApp)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func PinpointApp_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (p *jsiiProxy_PinpointApp) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PinpointApp) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (p *jsiiProxy_PinpointApp) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PinpointApp) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (p *jsiiProxy_PinpointApp) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (p *jsiiProxy_PinpointApp) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
