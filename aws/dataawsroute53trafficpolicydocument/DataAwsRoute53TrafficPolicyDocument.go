...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/data-sources/route53_traffic_policy_document aws_route53_traffic_policy_document}.
...
func (j *jsiiProxy_DataAwsRoute53TrafficPolicyDocument) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsRoute53TrafficPolicyDocument) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsRoute53TrafficPolicyDocument) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsRoute53TrafficPolicyDocument) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsRoute53TrafficPolicyDocument) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/data-sources/route53_traffic_policy_document aws_route53_traffic_policy_document} Data Source.
...
func (j *jsiiProxy_DataAwsRoute53TrafficPolicyDocument)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsRoute53TrafficPolicyDocument)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsRoute53TrafficPolicyDocument)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsRoute53TrafficPolicyDocument_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsRoute53TrafficPolicyDocument) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsRoute53TrafficPolicyDocument) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsRoute53TrafficPolicyDocument) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
