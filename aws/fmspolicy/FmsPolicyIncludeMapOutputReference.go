...
func (j *jsiiProxy_FmsPolicyIncludeMapOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewFmsPolicyIncludeMapOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) FmsPolicyIncludeMapOutputReference {
	_init_.Initialize()
...
func NewFmsPolicyIncludeMapOutputReference_Override(f FmsPolicyIncludeMapOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_FmsPolicyIncludeMapOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (f *jsiiProxy_FmsPolicyIncludeMapOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (f *jsiiProxy_FmsPolicyIncludeMapOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (f *jsiiProxy_FmsPolicyIncludeMapOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (f *jsiiProxy_FmsPolicyIncludeMapOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
