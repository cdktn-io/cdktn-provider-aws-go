...
func (f *jsiiProxy_FmsPolicyIncludeMapOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (f *jsiiProxy_FmsPolicyIncludeMapOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
