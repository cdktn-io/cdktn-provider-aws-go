...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/fms_policy aws_fms_policy}.
...
func (j *jsiiProxy_FmsPolicy) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_FmsPolicy) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/fms_policy aws_fms_policy} Resource.
...
func (j *jsiiProxy_FmsPolicy)SetRegion(val *string) {
...
func (f *jsiiProxy_FmsPolicy) ResetRegion() {
	_jsii_.InvokeVoid(
		f,
		"resetRegion",
		nil, // no parameters
