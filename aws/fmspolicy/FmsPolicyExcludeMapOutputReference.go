...
func (j *jsiiProxy_FmsPolicyExcludeMapOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewFmsPolicyExcludeMapOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) FmsPolicyExcludeMapOutputReference {
	_init_.Initialize()
...
func NewFmsPolicyExcludeMapOutputReference_Override(f FmsPolicyExcludeMapOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_FmsPolicyExcludeMapOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (f *jsiiProxy_FmsPolicyExcludeMapOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (f *jsiiProxy_FmsPolicyExcludeMapOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (f *jsiiProxy_FmsPolicyExcludeMapOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (f *jsiiProxy_FmsPolicyExcludeMapOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
