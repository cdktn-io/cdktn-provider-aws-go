...
func (f *jsiiProxy_FmsPolicyExcludeMapOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (f *jsiiProxy_FmsPolicyExcludeMapOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
