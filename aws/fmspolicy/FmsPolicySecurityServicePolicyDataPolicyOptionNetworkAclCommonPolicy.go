...
type FmsPolicySecurityServicePolicyDataPolicyOptionNetworkAclCommonPolicy struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.40.0/docs/resources/fms_policy#network_acl_entry_set FmsPolicy#network_acl_entry_set}
