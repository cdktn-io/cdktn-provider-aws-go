...
func (r *jsiiProxy_RdsClusterRoleAssociation) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (r *jsiiProxy_RdsClusterRoleAssociation) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
