...
func (i *jsiiProxy_IotTopicRuleErrorActionIotEventsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (i *jsiiProxy_IotTopicRuleErrorActionIotEventsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
