...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/iot_topic_rule aws_iot_topic_rule}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/iot_topic_rule aws_iot_topic_rule} Resource.
...
func (i *jsiiProxy_IotTopicRule) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (i *jsiiProxy_IotTopicRule) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (i *jsiiProxy_IotTopicRule) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
