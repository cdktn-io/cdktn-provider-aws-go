...
func (i *jsiiProxy_IotTopicRuleCloudwatchAlarmOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (i *jsiiProxy_IotTopicRuleCloudwatchAlarmOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
