...
func (j *jsiiProxy_IotTopicRuleCloudwatchAlarmOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewIotTopicRuleCloudwatchAlarmOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) IotTopicRuleCloudwatchAlarmOutputReference {
	_init_.Initialize()
...
func NewIotTopicRuleCloudwatchAlarmOutputReference_Override(i IotTopicRuleCloudwatchAlarmOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_IotTopicRuleCloudwatchAlarmOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (i *jsiiProxy_IotTopicRuleCloudwatchAlarmOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (i *jsiiProxy_IotTopicRuleCloudwatchAlarmOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (i *jsiiProxy_IotTopicRuleCloudwatchAlarmOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (i *jsiiProxy_IotTopicRuleCloudwatchAlarmOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
