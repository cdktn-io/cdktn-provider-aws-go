...
func NewIotTopicRuleDynamodbv2PutItemOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) IotTopicRuleDynamodbv2PutItemOutputReference {
	_init_.Initialize()
...
func NewIotTopicRuleDynamodbv2PutItemOutputReference_Override(i IotTopicRuleDynamodbv2PutItemOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (i *jsiiProxy_IotTopicRuleDynamodbv2PutItemOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (i *jsiiProxy_IotTopicRuleDynamodbv2PutItemOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
