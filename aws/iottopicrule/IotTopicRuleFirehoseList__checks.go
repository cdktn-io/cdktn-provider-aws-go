...
func (i *jsiiProxy_IotTopicRuleFirehoseList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (i *jsiiProxy_IotTopicRuleFirehoseList) validateResolveParameters(context cdktf.IResolveContext) error {
	if context == nil {
...
func (j *jsiiProxy_IotTopicRuleFirehoseList) validateSetInternalValueParameters(val interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktf.IResolvable, *[]*IotTopicRuleFirehose; received %#v (a %T)", val, val)
		}
	}
