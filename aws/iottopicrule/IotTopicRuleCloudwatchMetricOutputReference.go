...
func (i *jsiiProxy_IotTopicRuleCloudwatchMetricOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (i *jsiiProxy_IotTopicRuleCloudwatchMetricOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
