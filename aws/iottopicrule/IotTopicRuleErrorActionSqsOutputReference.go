...
type IotTopicRuleErrorActionSqsOutputReference interface {
	...
	// Experimental.
	Fqn() *string
	InternalValue() *IotTopicRuleErrorActionSqs
	SetInternalValue(val *IotTopicRuleErrorActionSqs)
	QueueUrl() *string
...
func (j *jsiiProxy_IotTopicRuleErrorActionSqsOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_IotTopicRuleErrorActionSqsOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_IotTopicRuleErrorActionSqsOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_IotTopicRuleErrorActionSqsOutputReference) InternalValue() *IotTopicRuleErrorActionSqs {
...
func (j *jsiiProxy_IotTopicRuleErrorActionSqsOutputReference)SetComplexObjectIndex(val interface{}) {
...
func (j *jsiiProxy_IotTopicRuleErrorActionSqsOutputReference)SetComplexObjectIsFromSet(val *bool) {
...
func (j *jsiiProxy_IotTopicRuleErrorActionSqsOutputReference)SetInternalValue(val *IotTopicRuleErrorActionSqs) {
...
func (i *jsiiProxy_IotTopicRuleErrorActionSqsOutputReference) ComputeFqn() *string {
	var returns *string
...
func (i *jsiiProxy_IotTopicRuleErrorActionSqsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (i *jsiiProxy_IotTopicRuleErrorActionSqsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
...
func (i *jsiiProxy_IotTopicRuleErrorActionSqsOutputReference) ToString() *string {
	var returns *string
