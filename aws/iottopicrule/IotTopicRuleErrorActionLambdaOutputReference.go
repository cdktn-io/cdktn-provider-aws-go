...
func (i *jsiiProxy_IotTopicRuleErrorActionLambdaOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (i *jsiiProxy_IotTopicRuleErrorActionLambdaOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
