...
func (i *jsiiProxy_IotTopicRuleErrorActionCloudwatchMetricOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (i *jsiiProxy_IotTopicRuleErrorActionCloudwatchMetricOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
