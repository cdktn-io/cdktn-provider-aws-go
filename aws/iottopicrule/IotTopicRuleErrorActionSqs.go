...
type IotTopicRuleErrorActionSqs struct {
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.32.1/docs/resources/iot_topic_rule#queue_url IotTopicRule#queue_url}.
