...
type IotTopicRuleErrorActionIotAnalyticsOutputReference interface {
	...
	// Experimental.
	Fqn() *string
	InternalValue() *IotTopicRuleErrorActionIotAnalytics
	SetInternalValue(val *IotTopicRuleErrorActionIotAnalytics)
	RoleArn() *string
...
func (j *jsiiProxy_IotTopicRuleErrorActionIotAnalyticsOutputReference) ComplexObjectIndex() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"complexObjectIndex",
...
func (j *jsiiProxy_IotTopicRuleErrorActionIotAnalyticsOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_IotTopicRuleErrorActionIotAnalyticsOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_IotTopicRuleErrorActionIotAnalyticsOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_IotTopicRuleErrorActionIotAnalyticsOutputReference) InternalValue() *IotTopicRuleErrorActionIotAnalytics {
...
func (j *jsiiProxy_IotTopicRuleErrorActionIotAnalyticsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewIotTopicRuleErrorActionIotAnalyticsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) IotTopicRuleErrorActionIotAnalyticsOutputReference {
	_init_.Initialize()

	if err := validateNewIotTopicRuleErrorActionIotAnalyticsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewIotTopicRuleErrorActionIotAnalyticsOutputReference_Override(i IotTopicRuleErrorActionIotAnalyticsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_IotTopicRuleErrorActionIotAnalyticsOutputReference)SetComplexObjectIndex(val interface{}) {
...
func (j *jsiiProxy_IotTopicRuleErrorActionIotAnalyticsOutputReference)SetComplexObjectIsFromSet(val *bool) {
...
func (j *jsiiProxy_IotTopicRuleErrorActionIotAnalyticsOutputReference)SetInternalValue(val *IotTopicRuleErrorActionIotAnalytics) {
...
func (j *jsiiProxy_IotTopicRuleErrorActionIotAnalyticsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (i *jsiiProxy_IotTopicRuleErrorActionIotAnalyticsOutputReference) ComputeFqn() *string {
	var returns *string
...
func (i *jsiiProxy_IotTopicRuleErrorActionIotAnalyticsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (i *jsiiProxy_IotTopicRuleErrorActionIotAnalyticsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (i *jsiiProxy_IotTopicRuleErrorActionIotAnalyticsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (i *jsiiProxy_IotTopicRuleErrorActionIotAnalyticsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
...
func (i *jsiiProxy_IotTopicRuleErrorActionIotAnalyticsOutputReference) ToString() *string {
	var returns *string
