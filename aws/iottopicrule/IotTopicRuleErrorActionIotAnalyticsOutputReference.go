...
func NewIotTopicRuleErrorActionIotAnalyticsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) IotTopicRuleErrorActionIotAnalyticsOutputReference {
	_init_.Initialize()
...
func NewIotTopicRuleErrorActionIotAnalyticsOutputReference_Override(i IotTopicRuleErrorActionIotAnalyticsOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (i *jsiiProxy_IotTopicRuleErrorActionIotAnalyticsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (i *jsiiProxy_IotTopicRuleErrorActionIotAnalyticsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
