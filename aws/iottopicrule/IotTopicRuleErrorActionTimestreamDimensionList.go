...
func (j *jsiiProxy_IotTopicRuleErrorActionTimestreamDimensionList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewIotTopicRuleErrorActionTimestreamDimensionList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) IotTopicRuleErrorActionTimestreamDimensionList {
	_init_.Initialize()
...
func NewIotTopicRuleErrorActionTimestreamDimensionList_Override(i IotTopicRuleErrorActionTimestreamDimensionList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_IotTopicRuleErrorActionTimestreamDimensionList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (i *jsiiProxy_IotTopicRuleErrorActionTimestreamDimensionList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (i *jsiiProxy_IotTopicRuleErrorActionTimestreamDimensionList) Resolve(context cdktf.IResolveContext) interface{} {
