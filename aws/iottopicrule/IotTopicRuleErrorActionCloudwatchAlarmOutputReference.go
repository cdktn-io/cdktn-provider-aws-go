...
func (i *jsiiProxy_IotTopicRuleErrorActionCloudwatchAlarmOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (i *jsiiProxy_IotTopicRuleErrorActionCloudwatchAlarmOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
