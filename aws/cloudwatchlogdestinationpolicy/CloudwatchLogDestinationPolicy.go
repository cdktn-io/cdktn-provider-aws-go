...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/cloudwatchlogdestinationpolicy/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/cloudwatch_log_destination_policy aws_cloudwatch_log_destination_policy}.
...
func (j *jsiiProxy_CloudwatchLogDestinationPolicy) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_CloudwatchLogDestinationPolicy) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_CloudwatchLogDestinationPolicy) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_CloudwatchLogDestinationPolicy) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_CloudwatchLogDestinationPolicy) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_CloudwatchLogDestinationPolicy) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_CloudwatchLogDestinationPolicy) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/cloudwatch_log_destination_policy aws_cloudwatch_log_destination_policy} Resource.
...
func (j *jsiiProxy_CloudwatchLogDestinationPolicy)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_CloudwatchLogDestinationPolicy)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_CloudwatchLogDestinationPolicy)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_CloudwatchLogDestinationPolicy)SetRegion(val *string) {
...
func CloudwatchLogDestinationPolicy_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateCloudwatchLogDestinationPolicy_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
// Experimental.
func CloudwatchLogDestinationPolicy_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCloudwatchLogDestinationPolicy_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func CloudwatchLogDestinationPolicy_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCloudwatchLogDestinationPolicy_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CloudwatchLogDestinationPolicy) AddMoveTarget(moveTarget *string) {
...
func (c *jsiiProxy_CloudwatchLogDestinationPolicy) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CloudwatchLogDestinationPolicy) HasResourceMove() interface{} {
	var returns interface{}
...
func (c *jsiiProxy_CloudwatchLogDestinationPolicy) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (c *jsiiProxy_CloudwatchLogDestinationPolicy) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CloudwatchLogDestinationPolicy) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_CloudwatchLogDestinationPolicy) MoveFromId(id *string) {
...
func (c *jsiiProxy_CloudwatchLogDestinationPolicy) MoveTo(moveTarget *string, index interface{}) {
...
func (c *jsiiProxy_CloudwatchLogDestinationPolicy) MoveToId(id *string) {
...
func (c *jsiiProxy_CloudwatchLogDestinationPolicy) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (c *jsiiProxy_CloudwatchLogDestinationPolicy) ResetRegion() {
	_jsii_.InvokeVoid(
		c,
		"resetRegion",
		nil, // no parameters
...
func (c *jsiiProxy_CloudwatchLogDestinationPolicy) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (c *jsiiProxy_CloudwatchLogDestinationPolicy) ToHclTerraform() interface{} {
	var returns interface{}
...
func (c *jsiiProxy_CloudwatchLogDestinationPolicy) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
