...
func (j *jsiiProxy_Instance) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_Instance) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_Instance) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_Instance) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_Instance) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_Instance)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_Instance)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_Instance)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func Instance_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (i *jsiiProxy_Instance) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (i *jsiiProxy_Instance) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (i *jsiiProxy_Instance) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (i *jsiiProxy_Instance) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (i *jsiiProxy_Instance) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
