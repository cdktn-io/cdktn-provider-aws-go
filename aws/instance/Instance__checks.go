...
func (i *jsiiProxy_Instance) validatePutEbsBlockDeviceParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*InstanceEbsBlockDevice; received %#v (a %T)", value, value)
		}
	}
...
func (i *jsiiProxy_Instance) validatePutEphemeralBlockDeviceParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*InstanceEphemeralBlockDevice; received %#v (a %T)", value, value)
		}
	}
...
func (i *jsiiProxy_Instance) validatePutNetworkInterfaceParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*InstanceNetworkInterface; received %#v (a %T)", value, value)
		}
	}
...
func (i *jsiiProxy_Instance) validatePutSecondaryNetworkInterfaceParameters(value interface{}) error {
	...
	case *[]*InstanceSecondaryNetworkInterface:
		value := value.(*[]*InstanceSecondaryNetworkInterface)
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
			}
	...
	case []*InstanceSecondaryNetworkInterface:
		value_ := value.([]*InstanceSecondaryNetworkInterface)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*InstanceSecondaryNetworkInterface; received %#v (a %T)", value, value)
		}
	}
...
func (j *jsiiProxy_Instance) validateSetForceDestroyParameters(val interface{}) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
	switch val.(type) {
