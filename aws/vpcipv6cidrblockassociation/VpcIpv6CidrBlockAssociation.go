...
func (j *jsiiProxy_VpcIpv6CidrBlockAssociation) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_VpcIpv6CidrBlockAssociation) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/vpc_ipv6_cidr_block_association aws_vpc_ipv6_cidr_block_association} Resource.
...
func (j *jsiiProxy_VpcIpv6CidrBlockAssociation)SetRegion(val *string) {
...
func (v *jsiiProxy_VpcIpv6CidrBlockAssociation) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (v *jsiiProxy_VpcIpv6CidrBlockAssociation) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (v *jsiiProxy_VpcIpv6CidrBlockAssociation) ResetRegion() {
	_jsii_.InvokeVoid(
		v,
		"resetRegion",
		nil, // no parameters
...
func (v *jsiiProxy_VpcIpv6CidrBlockAssociation) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
