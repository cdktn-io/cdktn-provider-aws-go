...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/detectiveinvitationaccepter/internal"
...
func (j *jsiiProxy_DetectiveInvitationAccepter) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DetectiveInvitationAccepter) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DetectiveInvitationAccepter) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DetectiveInvitationAccepter) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DetectiveInvitationAccepter) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/detective_invitation_accepter aws_detective_invitation_accepter} Resource.
...
func (j *jsiiProxy_DetectiveInvitationAccepter)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DetectiveInvitationAccepter)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DetectiveInvitationAccepter)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DetectiveInvitationAccepter_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DetectiveInvitationAccepter) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DetectiveInvitationAccepter) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (d *jsiiProxy_DetectiveInvitationAccepter) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DetectiveInvitationAccepter) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (d *jsiiProxy_DetectiveInvitationAccepter) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DetectiveInvitationAccepter) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
