...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/lightsaildomain/internal"
...
func (j *jsiiProxy_LightsailDomain) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_LightsailDomain) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_LightsailDomain) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_LightsailDomain) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_LightsailDomain) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func NewLightsailDomain(scope constructs.Construct, id *string, config *LightsailDomainConfig) LightsailDomain {
	...
	_jsii_.Create(
		"@cdktn/provider-aws.lightsailDomain.LightsailDomain",
...
func (j *jsiiProxy_LightsailDomain)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_LightsailDomain)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_LightsailDomain)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func LightsailDomain_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (l *jsiiProxy_LightsailDomain) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LightsailDomain) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (l *jsiiProxy_LightsailDomain) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LightsailDomain) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (l *jsiiProxy_LightsailDomain) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (l *jsiiProxy_LightsailDomain) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
