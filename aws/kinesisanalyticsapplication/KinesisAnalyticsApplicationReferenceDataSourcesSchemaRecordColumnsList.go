...
func (j *jsiiProxy_KinesisAnalyticsApplicationReferenceDataSourcesSchemaRecordColumnsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewKinesisAnalyticsApplicationReferenceDataSourcesSchemaRecordColumnsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) KinesisAnalyticsApplicationReferenceDataSourcesSchemaRecordColumnsList {
	_init_.Initialize()
...
func NewKinesisAnalyticsApplicationReferenceDataSourcesSchemaRecordColumnsList_Override(k KinesisAnalyticsApplicationReferenceDataSourcesSchemaRecordColumnsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_KinesisAnalyticsApplicationReferenceDataSourcesSchemaRecordColumnsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (k *jsiiProxy_KinesisAnalyticsApplicationReferenceDataSourcesSchemaRecordColumnsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (k *jsiiProxy_KinesisAnalyticsApplicationReferenceDataSourcesSchemaRecordColumnsList) Resolve(context cdktn.IResolveContext) interface{} {
