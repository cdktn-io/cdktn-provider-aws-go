...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/dataawskendraquerysuggestionsblocklist/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/data-sources/kendra_query_suggestions_block_list aws_kendra_query_suggestions_block_list}.
...
func (j *jsiiProxy_DataAwsKendraQuerySuggestionsBlockList) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsKendraQuerySuggestionsBlockList) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsKendraQuerySuggestionsBlockList) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsKendraQuerySuggestionsBlockList) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsKendraQuerySuggestionsBlockList) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/data-sources/kendra_query_suggestions_block_list aws_kendra_query_suggestions_block_list} Data Source.
...
func (j *jsiiProxy_DataAwsKendraQuerySuggestionsBlockList)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsKendraQuerySuggestionsBlockList)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsKendraQuerySuggestionsBlockList)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
// Generates CDKTN code for importing a DataAwsKendraQuerySuggestionsBlockList resource upon running "cdktn plan <stack-name>".
func DataAwsKendraQuerySuggestionsBlockList_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsKendraQuerySuggestionsBlockList) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsKendraQuerySuggestionsBlockList) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsKendraQuerySuggestionsBlockList) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsKendraQuerySuggestionsBlockList) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
