...
func (j *jsiiProxy_OrganizationsOrganizationalUnit) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_OrganizationsOrganizationalUnit) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_OrganizationsOrganizationalUnit) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_OrganizationsOrganizationalUnit) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_OrganizationsOrganizationalUnit) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_OrganizationsOrganizationalUnit)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_OrganizationsOrganizationalUnit)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_OrganizationsOrganizationalUnit)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func OrganizationsOrganizationalUnit_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (o *jsiiProxy_OrganizationsOrganizationalUnit) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (o *jsiiProxy_OrganizationsOrganizationalUnit) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (o *jsiiProxy_OrganizationsOrganizationalUnit) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (o *jsiiProxy_OrganizationsOrganizationalUnit) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (o *jsiiProxy_OrganizationsOrganizationalUnit) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (o *jsiiProxy_OrganizationsOrganizationalUnit) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
