...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/dataawselasticbeanstalksolutionstack/internal"
...
func (j *jsiiProxy_DataAwsElasticBeanstalkSolutionStack) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsElasticBeanstalkSolutionStack) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsElasticBeanstalkSolutionStack) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsElasticBeanstalkSolutionStack) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsElasticBeanstalkSolutionStack) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/data-sources/elastic_beanstalk_solution_stack aws_elastic_beanstalk_solution_stack} Data Source.
func NewDataAwsElasticBeanstalkSolutionStack(scope constructs.Construct, id *string, config *DataAwsElasticBeanstalkSolutionStackConfig) DataAwsElasticBeanstalkSolutionStack {
	...
	_jsii_.Create(
		"@cdktn/provider-aws.dataAwsElasticBeanstalkSolutionStack.DataAwsElasticBeanstalkSolutionStack",
...
func (j *jsiiProxy_DataAwsElasticBeanstalkSolutionStack)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsElasticBeanstalkSolutionStack)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsElasticBeanstalkSolutionStack)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsElasticBeanstalkSolutionStack_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsElasticBeanstalkSolutionStack) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsElasticBeanstalkSolutionStack) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsElasticBeanstalkSolutionStack) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsElasticBeanstalkSolutionStack) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
