...
func (s *jsiiProxy_SsmPatchBaseline) validatePutApprovalRuleParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*SsmPatchBaselineApprovalRule; received %#v (a %T)", value, value)
		}
	}
...
func (s *jsiiProxy_SsmPatchBaseline) validatePutGlobalFilterParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*SsmPatchBaselineGlobalFilter; received %#v (a %T)", value, value)
		}
	}
...
func (s *jsiiProxy_SsmPatchBaseline) validatePutSourceParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*SsmPatchBaselineSource; received %#v (a %T)", value, value)
		}
	}
