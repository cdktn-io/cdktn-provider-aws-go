...
func (j *jsiiProxy_SsmPatchBaselineGlobalFilterList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewSsmPatchBaselineGlobalFilterList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) SsmPatchBaselineGlobalFilterList {
	_init_.Initialize()

	if err := validateNewSsmPatchBaselineGlobalFilterListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewSsmPatchBaselineGlobalFilterList_Override(s SsmPatchBaselineGlobalFilterList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_SsmPatchBaselineGlobalFilterList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_SsmPatchBaselineGlobalFilterList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (s *jsiiProxy_SsmPatchBaselineGlobalFilterList) Resolve(context cdktn.IResolveContext) interface{} {
