...
func (s *jsiiProxy_SsmPatchBaselineGlobalFilterList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (s *jsiiProxy_SsmPatchBaselineGlobalFilterList) Resolve(context cdktf.IResolveContext) interface{} {
