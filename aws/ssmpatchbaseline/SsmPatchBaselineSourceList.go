...
func (j *jsiiProxy_SsmPatchBaselineSourceList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewSsmPatchBaselineSourceList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) SsmPatchBaselineSourceList {
	_init_.Initialize()
...
func NewSsmPatchBaselineSourceList_Override(s SsmPatchBaselineSourceList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_SsmPatchBaselineSourceList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_SsmPatchBaselineSourceList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (s *jsiiProxy_SsmPatchBaselineSourceList) Resolve(context cdktn.IResolveContext) interface{} {
