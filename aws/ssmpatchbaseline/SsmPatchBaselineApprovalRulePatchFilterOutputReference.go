...
func (s *jsiiProxy_SsmPatchBaselineApprovalRulePatchFilterOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_SsmPatchBaselineApprovalRulePatchFilterOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
