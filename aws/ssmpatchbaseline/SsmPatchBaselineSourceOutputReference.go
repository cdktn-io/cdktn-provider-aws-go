...
func (j *jsiiProxy_SsmPatchBaselineSourceOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewSsmPatchBaselineSourceOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) SsmPatchBaselineSourceOutputReference {
	_init_.Initialize()
...
func NewSsmPatchBaselineSourceOutputReference_Override(s SsmPatchBaselineSourceOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_SsmPatchBaselineSourceOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_SsmPatchBaselineSourceOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SsmPatchBaselineSourceOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (s *jsiiProxy_SsmPatchBaselineSourceOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SsmPatchBaselineSourceOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
