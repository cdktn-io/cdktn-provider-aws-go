...
func (s *jsiiProxy_SsmPatchBaselineSourceOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_SsmPatchBaselineSourceOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
