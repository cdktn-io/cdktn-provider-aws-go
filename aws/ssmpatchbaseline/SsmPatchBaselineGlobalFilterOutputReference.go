...
func (j *jsiiProxy_SsmPatchBaselineGlobalFilterOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewSsmPatchBaselineGlobalFilterOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) SsmPatchBaselineGlobalFilterOutputReference {
	_init_.Initialize()
...
func NewSsmPatchBaselineGlobalFilterOutputReference_Override(s SsmPatchBaselineGlobalFilterOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_SsmPatchBaselineGlobalFilterOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_SsmPatchBaselineGlobalFilterOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SsmPatchBaselineGlobalFilterOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (s *jsiiProxy_SsmPatchBaselineGlobalFilterOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SsmPatchBaselineGlobalFilterOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
