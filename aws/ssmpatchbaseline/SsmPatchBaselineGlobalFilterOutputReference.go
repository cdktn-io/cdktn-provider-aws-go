...
func (s *jsiiProxy_SsmPatchBaselineGlobalFilterOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_SsmPatchBaselineGlobalFilterOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
