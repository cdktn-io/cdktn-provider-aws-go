...
func (j *jsiiProxy_SsmPatchBaselineApprovalRulePatchFilterList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewSsmPatchBaselineApprovalRulePatchFilterList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) SsmPatchBaselineApprovalRulePatchFilterList {
	_init_.Initialize()
...
func NewSsmPatchBaselineApprovalRulePatchFilterList_Override(s SsmPatchBaselineApprovalRulePatchFilterList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_SsmPatchBaselineApprovalRulePatchFilterList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_SsmPatchBaselineApprovalRulePatchFilterList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (s *jsiiProxy_SsmPatchBaselineApprovalRulePatchFilterList) Resolve(context cdktn.IResolveContext) interface{} {
