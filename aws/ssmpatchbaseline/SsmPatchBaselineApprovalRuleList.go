...
func (j *jsiiProxy_SsmPatchBaselineApprovalRuleList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewSsmPatchBaselineApprovalRuleList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) SsmPatchBaselineApprovalRuleList {
	_init_.Initialize()
...
func NewSsmPatchBaselineApprovalRuleList_Override(s SsmPatchBaselineApprovalRuleList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_SsmPatchBaselineApprovalRuleList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_SsmPatchBaselineApprovalRuleList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (s *jsiiProxy_SsmPatchBaselineApprovalRuleList) Resolve(context cdktn.IResolveContext) interface{} {
