...
func (t *jsiiProxy_TimestreamwriteTableRetentionPropertiesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (t *jsiiProxy_TimestreamwriteTableRetentionPropertiesOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
