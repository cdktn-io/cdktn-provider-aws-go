...
func (t *jsiiProxy_TimestreamwriteTableMagneticStoreWritePropertiesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (t *jsiiProxy_TimestreamwriteTableMagneticStoreWritePropertiesOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
