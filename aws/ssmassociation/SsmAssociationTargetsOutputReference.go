...
func (s *jsiiProxy_SsmAssociationTargetsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_SsmAssociationTargetsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
