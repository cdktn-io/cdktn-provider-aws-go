...
func (m *jsiiProxy_MedialiveChannelDestinationsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (m *jsiiProxy_MedialiveChannelDestinationsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
