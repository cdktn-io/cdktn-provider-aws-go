...
func (m *jsiiProxy_MedialiveChannelInputSpecificationOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (m *jsiiProxy_MedialiveChannelInputSpecificationOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
