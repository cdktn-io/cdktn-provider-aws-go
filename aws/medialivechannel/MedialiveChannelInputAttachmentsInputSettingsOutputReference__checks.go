...
func (m *jsiiProxy_MedialiveChannelInputAttachmentsInputSettingsOutputReference) validatePutAudioSelectorParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*MedialiveChannelInputAttachmentsInputSettingsAudioSelector; received %#v (a %T)", value, value)
		}
	}
...
func (m *jsiiProxy_MedialiveChannelInputAttachmentsInputSettingsOutputReference) validatePutCaptionSelectorParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*MedialiveChannelInputAttachmentsInputSettingsCaptionSelector; received %#v (a %T)", value, value)
		}
	}
