...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/medialive_channel aws_medialive_channel}.
...
func (j *jsiiProxy_MedialiveChannel) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_MedialiveChannel) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/medialive_channel aws_medialive_channel} Resource.
...
func (j *jsiiProxy_MedialiveChannel)SetRegion(val *string) {
...
func (m *jsiiProxy_MedialiveChannel) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (m *jsiiProxy_MedialiveChannel) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (m *jsiiProxy_MedialiveChannel) ResetRegion() {
	_jsii_.InvokeVoid(
		m,
		"resetRegion",
		nil, // no parameters
...
func (m *jsiiProxy_MedialiveChannel) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
