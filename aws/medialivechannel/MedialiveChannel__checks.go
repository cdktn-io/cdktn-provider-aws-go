...
func (m *jsiiProxy_MedialiveChannel) validatePutDestinationsParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*MedialiveChannelDestinations; received %#v (a %T)", value, value)
		}
	}
...
func (m *jsiiProxy_MedialiveChannel) validatePutInputAttachmentsParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*MedialiveChannelInputAttachments; received %#v (a %T)", value, value)
		}
	}
...
func (j *jsiiProxy_MedialiveChannel) validateSetLifecycleParameters(val *cdktn.TerraformResourceLifecycle) error {
	if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
		return err
	}
