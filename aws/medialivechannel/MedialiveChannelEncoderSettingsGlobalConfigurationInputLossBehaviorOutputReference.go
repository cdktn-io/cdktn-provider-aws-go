...
func (m *jsiiProxy_MedialiveChannelEncoderSettingsGlobalConfigurationInputLossBehaviorOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (m *jsiiProxy_MedialiveChannelEncoderSettingsGlobalConfigurationInputLossBehaviorOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
