...
func (g *jsiiProxy_GlueConnectionPhysicalConnectionRequirementsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GlueConnectionPhysicalConnectionRequirementsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
