...
func (r *jsiiProxy_RedshiftScheduledActionTargetActionPauseClusterOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (r *jsiiProxy_RedshiftScheduledActionTargetActionPauseClusterOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
