...
func (j *jsiiProxy_RedshiftScheduledAction) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_RedshiftScheduledAction) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_RedshiftScheduledAction) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_RedshiftScheduledAction) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_RedshiftScheduledAction) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_RedshiftScheduledAction) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_RedshiftScheduledAction) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/redshift_scheduled_action aws_redshift_scheduled_action} Resource.
...
func (j *jsiiProxy_RedshiftScheduledAction)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_RedshiftScheduledAction)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_RedshiftScheduledAction)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_RedshiftScheduledAction)SetRegion(val *string) {
...
func RedshiftScheduledAction_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (r *jsiiProxy_RedshiftScheduledAction) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (r *jsiiProxy_RedshiftScheduledAction) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (r *jsiiProxy_RedshiftScheduledAction) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (r *jsiiProxy_RedshiftScheduledAction) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (r *jsiiProxy_RedshiftScheduledAction) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (r *jsiiProxy_RedshiftScheduledAction) ResetRegion() {
	_jsii_.InvokeVoid(
		r,
		"resetRegion",
		nil, // no parameters
...
func (r *jsiiProxy_RedshiftScheduledAction) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
