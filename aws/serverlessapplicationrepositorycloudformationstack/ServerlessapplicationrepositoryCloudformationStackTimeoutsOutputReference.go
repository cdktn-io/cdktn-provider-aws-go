...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v21/serverlessapplicationrepositorycloudformationstack/internal"
...
func (s *jsiiProxy_ServerlessapplicationrepositoryCloudformationStackTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_ServerlessapplicationrepositoryCloudformationStackTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
