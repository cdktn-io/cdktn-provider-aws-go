...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/serverlessapplicationrepository_cloudformation_stack aws_serverlessapplicationrepository_cloudformation_stack} Resource.
...
func (s *jsiiProxy_ServerlessapplicationrepositoryCloudformationStack) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_ServerlessapplicationrepositoryCloudformationStack) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_ServerlessapplicationrepositoryCloudformationStack) ResetCapabilities() {
	_jsii_.InvokeVoid(
		s,
		"resetCapabilities",
		nil, // no parameters
...
func (s *jsiiProxy_ServerlessapplicationrepositoryCloudformationStack) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
