...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/dataawsworkspacesimage/internal"
...
func (j *jsiiProxy_DataAwsWorkspacesImage) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsWorkspacesImage) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsWorkspacesImage) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsWorkspacesImage) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsWorkspacesImage) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DataAwsWorkspacesImage)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsWorkspacesImage)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsWorkspacesImage)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsWorkspacesImage_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsWorkspacesImage) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsWorkspacesImage) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsWorkspacesImage) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
