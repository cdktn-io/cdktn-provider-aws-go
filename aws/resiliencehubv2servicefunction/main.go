...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*Resiliencehubv2ServiceFunction)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-aws.resiliencehubv2ServiceFunction.Resiliencehubv2ServiceFunctionConfig",
		reflect.TypeOf((*Resiliencehubv2ServiceFunctionConfig)(nil)).Elem(),
	)
}
