...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/guarddutydetector/internal"
...
func (j *jsiiProxy_GuarddutyDetector) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_GuarddutyDetector) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_GuarddutyDetector) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_GuarddutyDetector) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_GuarddutyDetector) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_GuarddutyDetector) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_GuarddutyDetector) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/guardduty_detector aws_guardduty_detector} Resource.
func NewGuarddutyDetector(scope constructs.Construct, id *string, config *GuarddutyDetectorConfig) GuarddutyDetector {
	_init_.Initialize()

	if err := validateNewGuarddutyDetectorParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_GuarddutyDetector)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_GuarddutyDetector)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_GuarddutyDetector)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_GuarddutyDetector)SetRegion(val *string) {
...
func GuarddutyDetector_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateGuarddutyDetector_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (g *jsiiProxy_GuarddutyDetector) AddMoveTarget(moveTarget *string) {
...
func (g *jsiiProxy_GuarddutyDetector) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GuarddutyDetector) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (g *jsiiProxy_GuarddutyDetector) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GuarddutyDetector) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GuarddutyDetector) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (g *jsiiProxy_GuarddutyDetector) ResetRegion() {
	_jsii_.InvokeVoid(
		g,
		"resetRegion",
		nil, // no parameters
...
func (g *jsiiProxy_GuarddutyDetector) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
