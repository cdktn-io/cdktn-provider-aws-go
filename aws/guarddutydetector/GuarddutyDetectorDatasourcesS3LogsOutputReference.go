...
func (j *jsiiProxy_GuarddutyDetectorDatasourcesS3LogsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewGuarddutyDetectorDatasourcesS3LogsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) GuarddutyDetectorDatasourcesS3LogsOutputReference {
	_init_.Initialize()
...
func NewGuarddutyDetectorDatasourcesS3LogsOutputReference_Override(g GuarddutyDetectorDatasourcesS3LogsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_GuarddutyDetectorDatasourcesS3LogsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (g *jsiiProxy_GuarddutyDetectorDatasourcesS3LogsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GuarddutyDetectorDatasourcesS3LogsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (g *jsiiProxy_GuarddutyDetectorDatasourcesS3LogsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GuarddutyDetectorDatasourcesS3LogsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
