...
func (g *jsiiProxy_GuarddutyDetectorDatasourcesOutputReference) validateResolveParameters(context cdktf.IResolveContext) error {
	if context == nil {
...
func (j *jsiiProxy_GuarddutyDetectorDatasourcesOutputReference) validateSetInternalValueParameters(val *GuarddutyDetectorDatasources) error {
...
func (j *jsiiProxy_GuarddutyDetectorDatasourcesOutputReference) validateSetTerraformResourceParameters(val cdktf.IInterpolatingParent) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func validateNewGuarddutyDetectorDatasourcesOutputReferenceParameters(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) error {
