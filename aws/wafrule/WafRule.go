...
func (j *jsiiProxy_WafRule) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_WafRule) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_WafRule) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_WafRule) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_WafRule) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/waf_rule aws_waf_rule} Resource.
...
func (j *jsiiProxy_WafRule)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_WafRule)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_WafRule)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func WafRule_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (w *jsiiProxy_WafRule) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_WafRule) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (w *jsiiProxy_WafRule) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_WafRule) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (w *jsiiProxy_WafRule) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
