...
func (j *jsiiProxy_WafSizeConstraintSet) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_WafSizeConstraintSet) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_WafSizeConstraintSet) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_WafSizeConstraintSet) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_WafSizeConstraintSet) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/waf_size_constraint_set aws_waf_size_constraint_set} Resource.
...
func (j *jsiiProxy_WafSizeConstraintSet)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_WafSizeConstraintSet)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_WafSizeConstraintSet)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func WafSizeConstraintSet_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (w *jsiiProxy_WafSizeConstraintSet) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_WafSizeConstraintSet) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (w *jsiiProxy_WafSizeConstraintSet) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_WafSizeConstraintSet) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (w *jsiiProxy_WafSizeConstraintSet) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (w *jsiiProxy_WafSizeConstraintSet) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
