...
type WafSizeConstraintSetConfig struct {
	...
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.32.1/docs/resources/waf_size_constraint_set#name WafSizeConstraintSet#name}.
