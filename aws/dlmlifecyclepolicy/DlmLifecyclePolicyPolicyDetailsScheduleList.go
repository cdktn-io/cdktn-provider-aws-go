...
func (j *jsiiProxy_DlmLifecyclePolicyPolicyDetailsScheduleList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDlmLifecyclePolicyPolicyDetailsScheduleList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DlmLifecyclePolicyPolicyDetailsScheduleList {
	_init_.Initialize()
...
func NewDlmLifecyclePolicyPolicyDetailsScheduleList_Override(d DlmLifecyclePolicyPolicyDetailsScheduleList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DlmLifecyclePolicyPolicyDetailsScheduleList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DlmLifecyclePolicyPolicyDetailsScheduleList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DlmLifecyclePolicyPolicyDetailsScheduleList) Resolve(context cdktn.IResolveContext) interface{} {
