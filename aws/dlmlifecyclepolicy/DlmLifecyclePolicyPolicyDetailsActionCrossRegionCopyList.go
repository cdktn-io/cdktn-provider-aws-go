...
func (j *jsiiProxy_DlmLifecyclePolicyPolicyDetailsActionCrossRegionCopyList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDlmLifecyclePolicyPolicyDetailsActionCrossRegionCopyList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DlmLifecyclePolicyPolicyDetailsActionCrossRegionCopyList {
	_init_.Initialize()
...
func NewDlmLifecyclePolicyPolicyDetailsActionCrossRegionCopyList_Override(d DlmLifecyclePolicyPolicyDetailsActionCrossRegionCopyList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DlmLifecyclePolicyPolicyDetailsActionCrossRegionCopyList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DlmLifecyclePolicyPolicyDetailsActionCrossRegionCopyList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DlmLifecyclePolicyPolicyDetailsActionCrossRegionCopyList) Resolve(context cdktn.IResolveContext) interface{} {
