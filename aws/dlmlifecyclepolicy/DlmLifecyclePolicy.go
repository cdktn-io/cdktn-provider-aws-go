...
func (j *jsiiProxy_DlmLifecyclePolicy) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DlmLifecyclePolicy) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DlmLifecyclePolicy) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DlmLifecyclePolicy) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DlmLifecyclePolicy) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DlmLifecyclePolicy) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_DlmLifecyclePolicy) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DlmLifecyclePolicy)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DlmLifecyclePolicy)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DlmLifecyclePolicy)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_DlmLifecyclePolicy)SetRegion(val *string) {
...
func DlmLifecyclePolicy_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DlmLifecyclePolicy) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DlmLifecyclePolicy) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (d *jsiiProxy_DlmLifecyclePolicy) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DlmLifecyclePolicy) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (d *jsiiProxy_DlmLifecyclePolicy) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DlmLifecyclePolicy) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
...
func (d *jsiiProxy_DlmLifecyclePolicy) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
