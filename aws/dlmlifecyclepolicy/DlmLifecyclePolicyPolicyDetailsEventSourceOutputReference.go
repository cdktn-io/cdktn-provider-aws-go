...
func (j *jsiiProxy_DlmLifecyclePolicyPolicyDetailsEventSourceOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDlmLifecyclePolicyPolicyDetailsEventSourceOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) DlmLifecyclePolicyPolicyDetailsEventSourceOutputReference {
	_init_.Initialize()
...
func NewDlmLifecyclePolicyPolicyDetailsEventSourceOutputReference_Override(d DlmLifecyclePolicyPolicyDetailsEventSourceOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_DlmLifecyclePolicyPolicyDetailsEventSourceOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DlmLifecyclePolicyPolicyDetailsEventSourceOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DlmLifecyclePolicyPolicyDetailsEventSourceOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (d *jsiiProxy_DlmLifecyclePolicyPolicyDetailsEventSourceOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DlmLifecyclePolicyPolicyDetailsEventSourceOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
