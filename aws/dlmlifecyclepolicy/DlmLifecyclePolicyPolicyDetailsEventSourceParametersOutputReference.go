...
func (j *jsiiProxy_DlmLifecyclePolicyPolicyDetailsEventSourceParametersOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDlmLifecyclePolicyPolicyDetailsEventSourceParametersOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) DlmLifecyclePolicyPolicyDetailsEventSourceParametersOutputReference {
	_init_.Initialize()

	if err := validateNewDlmLifecyclePolicyPolicyDetailsEventSourceParametersOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewDlmLifecyclePolicyPolicyDetailsEventSourceParametersOutputReference_Override(d DlmLifecyclePolicyPolicyDetailsEventSourceParametersOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_DlmLifecyclePolicyPolicyDetailsEventSourceParametersOutputReference)SetDescriptionRegex(val *string) {
	if err := j.validateSetDescriptionRegexParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_DlmLifecyclePolicyPolicyDetailsEventSourceParametersOutputReference)SetSnapshotOwner(val *[]*string) {
	if err := j.validateSetSnapshotOwnerParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_DlmLifecyclePolicyPolicyDetailsEventSourceParametersOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DlmLifecyclePolicyPolicyDetailsEventSourceParametersOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DlmLifecyclePolicyPolicyDetailsEventSourceParametersOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (d *jsiiProxy_DlmLifecyclePolicyPolicyDetailsEventSourceParametersOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DlmLifecyclePolicyPolicyDetailsEventSourceParametersOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
