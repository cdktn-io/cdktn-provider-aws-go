...
func init() {
	_jsii_.RegisterClass(
		"@cdktn/provider-aws.sagemakerModelPackageGroup.SagemakerModelPackageGroup",
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-aws.sagemakerModelPackageGroup.SagemakerModelPackageGroupConfig",
