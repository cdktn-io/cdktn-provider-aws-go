...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/datasync_task aws_datasync_task}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/datasync_task aws_datasync_task} Resource.
...
func (d *jsiiProxy_DatasyncTask) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (d *jsiiProxy_DatasyncTask) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DatasyncTask) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
