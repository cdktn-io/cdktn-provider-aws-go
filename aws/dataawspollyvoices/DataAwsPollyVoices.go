...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/data-sources/polly_voices aws_polly_voices}.
...
func (j *jsiiProxy_DataAwsPollyVoices) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsPollyVoices) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsPollyVoices) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsPollyVoices) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsPollyVoices) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DataAwsPollyVoices) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_DataAwsPollyVoices) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/data-sources/polly_voices aws_polly_voices} Data Source.
...
func (j *jsiiProxy_DataAwsPollyVoices)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsPollyVoices)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsPollyVoices)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_DataAwsPollyVoices)SetRegion(val *string) {
...
func DataAwsPollyVoices_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsPollyVoices) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsPollyVoices) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsPollyVoices) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsPollyVoices) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsPollyVoices) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
