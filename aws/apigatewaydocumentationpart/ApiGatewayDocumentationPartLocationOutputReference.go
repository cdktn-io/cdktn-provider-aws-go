...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v24/apigatewaydocumentationpart/internal"
...
func (j *jsiiProxy_ApiGatewayDocumentationPartLocationOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewApiGatewayDocumentationPartLocationOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) ApiGatewayDocumentationPartLocationOutputReference {
	_init_.Initialize()

	if err := validateNewApiGatewayDocumentationPartLocationOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewApiGatewayDocumentationPartLocationOutputReference_Override(a ApiGatewayDocumentationPartLocationOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_ApiGatewayDocumentationPartLocationOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (a *jsiiProxy_ApiGatewayDocumentationPartLocationOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_ApiGatewayDocumentationPartLocationOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (a *jsiiProxy_ApiGatewayDocumentationPartLocationOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_ApiGatewayDocumentationPartLocationOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
