...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v22/kinesisstreamconsumer/internal"
...
func (j *jsiiProxy_KinesisStreamConsumer) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_KinesisStreamConsumer) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_KinesisStreamConsumer) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_KinesisStreamConsumer) Provider() cdktf.TerraformProvider {
...
func KinesisStreamConsumer_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (k *jsiiProxy_KinesisStreamConsumer) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (k *jsiiProxy_KinesisStreamConsumer) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
