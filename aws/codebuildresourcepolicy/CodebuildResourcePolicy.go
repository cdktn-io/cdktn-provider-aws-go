...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/codebuildresourcepolicy/internal"
...
func (j *jsiiProxy_CodebuildResourcePolicy) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_CodebuildResourcePolicy) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_CodebuildResourcePolicy) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_CodebuildResourcePolicy) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_CodebuildResourcePolicy) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_CodebuildResourcePolicy) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_CodebuildResourcePolicy) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/codebuild_resource_policy aws_codebuild_resource_policy} Resource.
func NewCodebuildResourcePolicy(scope constructs.Construct, id *string, config *CodebuildResourcePolicyConfig) CodebuildResourcePolicy {
	...
	_jsii_.Create(
		"@cdktn/provider-aws.codebuildResourcePolicy.CodebuildResourcePolicy",
...
func (j *jsiiProxy_CodebuildResourcePolicy)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_CodebuildResourcePolicy)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_CodebuildResourcePolicy)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_CodebuildResourcePolicy)SetRegion(val *string) {
...
func CodebuildResourcePolicy_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (c *jsiiProxy_CodebuildResourcePolicy) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CodebuildResourcePolicy) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (c *jsiiProxy_CodebuildResourcePolicy) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CodebuildResourcePolicy) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_CodebuildResourcePolicy) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (c *jsiiProxy_CodebuildResourcePolicy) ResetRegion() {
	_jsii_.InvokeVoid(
		c,
		"resetRegion",
		nil, // no parameters
...
func (c *jsiiProxy_CodebuildResourcePolicy) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
