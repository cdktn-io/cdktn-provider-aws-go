...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v23/applicationinsightsapplication/internal"
...
func (j *jsiiProxy_ApplicationinsightsApplication) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_ApplicationinsightsApplication) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.32.1/docs/resources/applicationinsights_application aws_applicationinsights_application} Resource.
...
func (j *jsiiProxy_ApplicationinsightsApplication)SetRegion(val *string) {
...
func (a *jsiiProxy_ApplicationinsightsApplication) ResetRegion() {
	_jsii_.InvokeVoid(
		a,
		"resetRegion",
		nil, // no parameters
