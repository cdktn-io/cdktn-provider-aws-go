...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/dataawsiaminstanceprofile/internal"
...
func (j *jsiiProxy_DataAwsIamInstanceProfile) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsIamInstanceProfile) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsIamInstanceProfile) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsIamInstanceProfile) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsIamInstanceProfile) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/data-sources/iam_instance_profile aws_iam_instance_profile} Data Source.
...
func (j *jsiiProxy_DataAwsIamInstanceProfile)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsIamInstanceProfile)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsIamInstanceProfile)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsIamInstanceProfile_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateDataAwsIamInstanceProfile_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
// Experimental.
func DataAwsIamInstanceProfile_IsTerraformDataSource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataAwsIamInstanceProfile_IsTerraformDataSourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataAwsIamInstanceProfile_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataAwsIamInstanceProfile_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (d *jsiiProxy_DataAwsIamInstanceProfile) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsIamInstanceProfile) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsIamInstanceProfile) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsIamInstanceProfile) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataAwsIamInstanceProfile) ToHclTerraform() interface{} {
	var returns interface{}
...
func (d *jsiiProxy_DataAwsIamInstanceProfile) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
