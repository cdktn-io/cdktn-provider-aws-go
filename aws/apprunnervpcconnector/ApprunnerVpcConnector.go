...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/apprunnervpcconnector/internal"
...
func (j *jsiiProxy_ApprunnerVpcConnector) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_ApprunnerVpcConnector) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_ApprunnerVpcConnector) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_ApprunnerVpcConnector) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_ApprunnerVpcConnector) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_ApprunnerVpcConnector) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_ApprunnerVpcConnector) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_ApprunnerVpcConnector)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_ApprunnerVpcConnector)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_ApprunnerVpcConnector)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_ApprunnerVpcConnector)SetRegion(val *string) {
...
func ApprunnerVpcConnector_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (a *jsiiProxy_ApprunnerVpcConnector) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_ApprunnerVpcConnector) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (a *jsiiProxy_ApprunnerVpcConnector) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_ApprunnerVpcConnector) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (a *jsiiProxy_ApprunnerVpcConnector) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (a *jsiiProxy_ApprunnerVpcConnector) ResetRegion() {
	_jsii_.InvokeVoid(
		a,
		"resetRegion",
		nil, // no parameters
...
func (a *jsiiProxy_ApprunnerVpcConnector) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
