...
func (e *jsiiProxy_EmrClusterMasterInstanceFleetInstanceTypeConfigsConfigurationsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (e *jsiiProxy_EmrClusterMasterInstanceFleetInstanceTypeConfigsConfigurationsList) Resolve(context cdktf.IResolveContext) interface{} {
