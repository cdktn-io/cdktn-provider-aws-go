...
func (j *jsiiProxy_EmrClusterMasterInstanceFleetInstanceTypeConfigsList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_EmrClusterMasterInstanceFleetInstanceTypeConfigsList) InternalValue() interface{} {
...
func (j *jsiiProxy_EmrClusterMasterInstanceFleetInstanceTypeConfigsList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_EmrClusterMasterInstanceFleetInstanceTypeConfigsList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (j *jsiiProxy_EmrClusterMasterInstanceFleetInstanceTypeConfigsList)SetInternalValue(val interface{}) {
...
func (j *jsiiProxy_EmrClusterMasterInstanceFleetInstanceTypeConfigsList)SetTerraformAttribute(val *string) {
...
func (j *jsiiProxy_EmrClusterMasterInstanceFleetInstanceTypeConfigsList)SetWrapsSet(val *bool) {
...
func (e *jsiiProxy_EmrClusterMasterInstanceFleetInstanceTypeConfigsList) ComputeFqn() *string {
	var returns *string
...
func (e *jsiiProxy_EmrClusterMasterInstanceFleetInstanceTypeConfigsList) Get(index *float64) EmrClusterMasterInstanceFleetInstanceTypeConfigsOutputReference {
	if err := e.validateGetParameters(index); err != nil {
		panic(err)
	}
	var returns EmrClusterMasterInstanceFleetInstanceTypeConfigsOutputReference
...
func (e *jsiiProxy_EmrClusterMasterInstanceFleetInstanceTypeConfigsList) ToString() *string {
	var returns *string
