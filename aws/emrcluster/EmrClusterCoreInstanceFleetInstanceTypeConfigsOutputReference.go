...
func (j *jsiiProxy_EmrClusterCoreInstanceFleetInstanceTypeConfigsOutputReference) ComplexObjectIndex() interface{} {
...
func (j *jsiiProxy_EmrClusterCoreInstanceFleetInstanceTypeConfigsOutputReference) ConfigurationsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"configurationsInput",
...
func (j *jsiiProxy_EmrClusterCoreInstanceFleetInstanceTypeConfigsOutputReference) EbsConfigInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"ebsConfigInput",
...
func (j *jsiiProxy_EmrClusterCoreInstanceFleetInstanceTypeConfigsOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_EmrClusterCoreInstanceFleetInstanceTypeConfigsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewEmrClusterCoreInstanceFleetInstanceTypeConfigsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) EmrClusterCoreInstanceFleetInstanceTypeConfigsOutputReference {
	_init_.Initialize()
...
func NewEmrClusterCoreInstanceFleetInstanceTypeConfigsOutputReference_Override(e EmrClusterCoreInstanceFleetInstanceTypeConfigsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_EmrClusterCoreInstanceFleetInstanceTypeConfigsOutputReference)SetComplexObjectIndex(val interface{}) {
...
func (j *jsiiProxy_EmrClusterCoreInstanceFleetInstanceTypeConfigsOutputReference)SetInternalValue(val interface{}) {
...
func (j *jsiiProxy_EmrClusterCoreInstanceFleetInstanceTypeConfigsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (e *jsiiProxy_EmrClusterCoreInstanceFleetInstanceTypeConfigsOutputReference) GetAnyMapAttribute(terraformAttribute *string) *map[string]interface{} {
...
func (e *jsiiProxy_EmrClusterCoreInstanceFleetInstanceTypeConfigsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (e *jsiiProxy_EmrClusterCoreInstanceFleetInstanceTypeConfigsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (e *jsiiProxy_EmrClusterCoreInstanceFleetInstanceTypeConfigsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (e *jsiiProxy_EmrClusterCoreInstanceFleetInstanceTypeConfigsOutputReference) PutConfigurations(value interface{}) {
...
func (e *jsiiProxy_EmrClusterCoreInstanceFleetInstanceTypeConfigsOutputReference) PutEbsConfig(value interface{}) {
...
func (e *jsiiProxy_EmrClusterCoreInstanceFleetInstanceTypeConfigsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
