...
func (j *jsiiProxy_EmrClusterStepHadoopJarStepList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewEmrClusterStepHadoopJarStepList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) EmrClusterStepHadoopJarStepList {
	_init_.Initialize()
...
func NewEmrClusterStepHadoopJarStepList_Override(e EmrClusterStepHadoopJarStepList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_EmrClusterStepHadoopJarStepList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (e *jsiiProxy_EmrClusterStepHadoopJarStepList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (e *jsiiProxy_EmrClusterStepHadoopJarStepList) Resolve(context cdktn.IResolveContext) interface{} {
