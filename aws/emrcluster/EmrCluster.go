...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/emr_cluster aws_emr_cluster}.
...
func (j *jsiiProxy_EmrCluster) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_EmrCluster) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/emr_cluster aws_emr_cluster} Resource.
...
func (j *jsiiProxy_EmrCluster)SetRegion(val *string) {
...
func (e *jsiiProxy_EmrCluster) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (e *jsiiProxy_EmrCluster) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (e *jsiiProxy_EmrCluster) ResetRegion() {
	_jsii_.InvokeVoid(
		e,
		"resetRegion",
		nil, // no parameters
...
func (e *jsiiProxy_EmrCluster) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
