...
func (e *jsiiProxy_EmrClusterCoreInstanceFleetInstanceTypeConfigsList) validateResolveParameters(context cdktf.IResolveContext) error {
	if context == nil {
...
func (j *jsiiProxy_EmrClusterCoreInstanceFleetInstanceTypeConfigsList) validateSetInternalValueParameters(val interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktf.IResolvable, *[]*EmrClusterCoreInstanceFleetInstanceTypeConfigs; received %#v (a %T)", val, val)
		}
	}
