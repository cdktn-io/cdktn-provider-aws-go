...
func (e *jsiiProxy_EmrClusterMasterInstanceFleetInstanceTypeConfigsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (e *jsiiProxy_EmrClusterMasterInstanceFleetInstanceTypeConfigsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
