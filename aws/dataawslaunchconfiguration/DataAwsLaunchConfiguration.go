...
type DataAwsLaunchConfiguration interface {
	...
	EnableMonitoring() cdktn.IResolvable
...
func (j *jsiiProxy_DataAwsLaunchConfiguration) AssociatePublicIpAddress() cdktn.IResolvable {
...
func (j *jsiiProxy_DataAwsLaunchConfiguration) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsLaunchConfiguration) EbsOptimized() cdktn.IResolvable {
	var returns cdktn.IResolvable
	_jsii_.Get(
		j,
		"ebsOptimized",
...
func (j *jsiiProxy_DataAwsLaunchConfiguration) EnableMonitoring() cdktn.IResolvable {
	var returns cdktn.IResolvable
	_jsii_.Get(
		j,
		"enableMonitoring",
...
func (j *jsiiProxy_DataAwsLaunchConfiguration) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsLaunchConfiguration) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsLaunchConfiguration) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsLaunchConfiguration) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DataAwsLaunchConfiguration) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_DataAwsLaunchConfiguration) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DataAwsLaunchConfiguration)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsLaunchConfiguration)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsLaunchConfiguration)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_DataAwsLaunchConfiguration)SetRegion(val *string) {
...
func DataAwsLaunchConfiguration_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsLaunchConfiguration) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsLaunchConfiguration) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsLaunchConfiguration) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsLaunchConfiguration) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsLaunchConfiguration) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
