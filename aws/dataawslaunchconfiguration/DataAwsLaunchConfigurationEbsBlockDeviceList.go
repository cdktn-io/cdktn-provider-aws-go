...
func (d *jsiiProxy_DataAwsLaunchConfigurationEbsBlockDeviceList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsLaunchConfigurationEbsBlockDeviceList) Resolve(context cdktf.IResolveContext) interface{} {
