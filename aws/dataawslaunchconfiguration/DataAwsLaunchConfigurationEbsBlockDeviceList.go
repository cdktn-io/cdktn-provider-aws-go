...
func (j *jsiiProxy_DataAwsLaunchConfigurationEbsBlockDeviceList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsLaunchConfigurationEbsBlockDeviceList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsLaunchConfigurationEbsBlockDeviceList {
	_init_.Initialize()
...
func NewDataAwsLaunchConfigurationEbsBlockDeviceList_Override(d DataAwsLaunchConfigurationEbsBlockDeviceList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsLaunchConfigurationEbsBlockDeviceList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsLaunchConfigurationEbsBlockDeviceList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsLaunchConfigurationEbsBlockDeviceList) Resolve(context cdktn.IResolveContext) interface{} {
