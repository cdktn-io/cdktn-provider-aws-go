...
func (j *jsiiProxy_DataAwsLaunchConfigurationMetadataOptionsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsLaunchConfigurationMetadataOptionsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsLaunchConfigurationMetadataOptionsList {
	_init_.Initialize()
...
func NewDataAwsLaunchConfigurationMetadataOptionsList_Override(d DataAwsLaunchConfigurationMetadataOptionsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsLaunchConfigurationMetadataOptionsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsLaunchConfigurationMetadataOptionsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsLaunchConfigurationMetadataOptionsList) Resolve(context cdktn.IResolveContext) interface{} {
