...
func (d *jsiiProxy_DataAwsLaunchConfigurationEphemeralBlockDeviceOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataAwsLaunchConfigurationEphemeralBlockDeviceOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
