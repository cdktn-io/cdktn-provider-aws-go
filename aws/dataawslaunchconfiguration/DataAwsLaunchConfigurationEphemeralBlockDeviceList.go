...
func (j *jsiiProxy_DataAwsLaunchConfigurationEphemeralBlockDeviceList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsLaunchConfigurationEphemeralBlockDeviceList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsLaunchConfigurationEphemeralBlockDeviceList {
	_init_.Initialize()
...
func NewDataAwsLaunchConfigurationEphemeralBlockDeviceList_Override(d DataAwsLaunchConfigurationEphemeralBlockDeviceList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsLaunchConfigurationEphemeralBlockDeviceList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsLaunchConfigurationEphemeralBlockDeviceList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsLaunchConfigurationEphemeralBlockDeviceList) Resolve(context cdktn.IResolveContext) interface{} {
