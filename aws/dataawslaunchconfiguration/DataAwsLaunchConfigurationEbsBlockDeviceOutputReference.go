...
func (d *jsiiProxy_DataAwsLaunchConfigurationEbsBlockDeviceOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataAwsLaunchConfigurationEbsBlockDeviceOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
