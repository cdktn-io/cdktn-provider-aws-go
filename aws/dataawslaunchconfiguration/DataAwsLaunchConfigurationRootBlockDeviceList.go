...
func (j *jsiiProxy_DataAwsLaunchConfigurationRootBlockDeviceList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsLaunchConfigurationRootBlockDeviceList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsLaunchConfigurationRootBlockDeviceList {
	_init_.Initialize()
...
func NewDataAwsLaunchConfigurationRootBlockDeviceList_Override(d DataAwsLaunchConfigurationRootBlockDeviceList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsLaunchConfigurationRootBlockDeviceList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsLaunchConfigurationRootBlockDeviceList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsLaunchConfigurationRootBlockDeviceList) Resolve(context cdktn.IResolveContext) interface{} {
