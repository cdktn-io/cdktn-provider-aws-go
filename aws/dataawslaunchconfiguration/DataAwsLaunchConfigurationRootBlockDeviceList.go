...
func (d *jsiiProxy_DataAwsLaunchConfigurationRootBlockDeviceList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsLaunchConfigurationRootBlockDeviceList) Resolve(context cdktf.IResolveContext) interface{} {
