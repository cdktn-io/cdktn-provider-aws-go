...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v24/ecscluster/internal"
...
func (j *jsiiProxy_EcsClusterSettingList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewEcsClusterSettingList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) EcsClusterSettingList {
	_init_.Initialize()

	if err := validateNewEcsClusterSettingListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewEcsClusterSettingList_Override(e EcsClusterSettingList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_EcsClusterSettingList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (e *jsiiProxy_EcsClusterSettingList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (e *jsiiProxy_EcsClusterSettingList) Resolve(context cdktn.IResolveContext) interface{} {
