...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v21/ecscluster/internal"
...
func (e *jsiiProxy_EcsClusterSettingList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (e *jsiiProxy_EcsClusterSettingList) Resolve(context cdktf.IResolveContext) interface{} {
