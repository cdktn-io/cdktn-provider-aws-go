...
func (o *jsiiProxy_ObservabilityadminCentralizationRuleForOrganizationRuleList) validateResolveParameters(context cdktn.IResolveContext) error {
	if context == nil {
...
func (j *jsiiProxy_ObservabilityadminCentralizationRuleForOrganizationRuleList) validateSetTerraformResourceParameters(val cdktn.IInterpolatingParent) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func validateNewObservabilityadminCentralizationRuleForOrganizationRuleListParameters(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) error {
