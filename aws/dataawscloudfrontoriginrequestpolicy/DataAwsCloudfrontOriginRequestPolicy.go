...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/data-sources/cloudfront_origin_request_policy aws_cloudfront_origin_request_policy}.
...
func (j *jsiiProxy_DataAwsCloudfrontOriginRequestPolicy) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsCloudfrontOriginRequestPolicy) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsCloudfrontOriginRequestPolicy) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsCloudfrontOriginRequestPolicy) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsCloudfrontOriginRequestPolicy) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/data-sources/cloudfront_origin_request_policy aws_cloudfront_origin_request_policy} Data Source.
...
func (j *jsiiProxy_DataAwsCloudfrontOriginRequestPolicy)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsCloudfrontOriginRequestPolicy)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsCloudfrontOriginRequestPolicy)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsCloudfrontOriginRequestPolicy_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsCloudfrontOriginRequestPolicy) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsCloudfrontOriginRequestPolicy) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsCloudfrontOriginRequestPolicy) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsCloudfrontOriginRequestPolicy) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
