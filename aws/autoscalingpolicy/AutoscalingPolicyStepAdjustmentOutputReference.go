...
func (a *jsiiProxy_AutoscalingPolicyStepAdjustmentOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_AutoscalingPolicyStepAdjustmentOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
