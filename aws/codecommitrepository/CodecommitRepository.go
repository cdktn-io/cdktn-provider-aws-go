...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/codecommitrepository/internal"
...
func (j *jsiiProxy_CodecommitRepository) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_CodecommitRepository) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_CodecommitRepository) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_CodecommitRepository) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_CodecommitRepository) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/codecommit_repository aws_codecommit_repository} Resource.
...
func (j *jsiiProxy_CodecommitRepository)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_CodecommitRepository)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_CodecommitRepository)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func CodecommitRepository_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (c *jsiiProxy_CodecommitRepository) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CodecommitRepository) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (c *jsiiProxy_CodecommitRepository) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CodecommitRepository) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_CodecommitRepository) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (c *jsiiProxy_CodecommitRepository) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
