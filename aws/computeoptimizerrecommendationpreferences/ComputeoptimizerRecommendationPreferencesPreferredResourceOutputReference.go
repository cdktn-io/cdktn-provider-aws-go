...
func (c *jsiiProxy_ComputeoptimizerRecommendationPreferencesPreferredResourceOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ComputeoptimizerRecommendationPreferencesPreferredResourceOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
