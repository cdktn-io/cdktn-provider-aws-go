...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/glaciervault/internal"
...
func (j *jsiiProxy_GlacierVault) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_GlacierVault) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_GlacierVault) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_GlacierVault) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_GlacierVault) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_GlacierVault) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_GlacierVault) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_GlacierVault)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_GlacierVault)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_GlacierVault)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_GlacierVault)SetRegion(val *string) {
...
func GlacierVault_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (g *jsiiProxy_GlacierVault) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GlacierVault) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (g *jsiiProxy_GlacierVault) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GlacierVault) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GlacierVault) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (g *jsiiProxy_GlacierVault) ResetRegion() {
	_jsii_.InvokeVoid(
		g,
		"resetRegion",
		nil, // no parameters
...
func (g *jsiiProxy_GlacierVault) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
