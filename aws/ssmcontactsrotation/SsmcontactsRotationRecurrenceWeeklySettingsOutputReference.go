...
func (j *jsiiProxy_SsmcontactsRotationRecurrenceWeeklySettingsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewSsmcontactsRotationRecurrenceWeeklySettingsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) SsmcontactsRotationRecurrenceWeeklySettingsOutputReference {
	_init_.Initialize()
...
func NewSsmcontactsRotationRecurrenceWeeklySettingsOutputReference_Override(s SsmcontactsRotationRecurrenceWeeklySettingsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_SsmcontactsRotationRecurrenceWeeklySettingsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_SsmcontactsRotationRecurrenceWeeklySettingsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SsmcontactsRotationRecurrenceWeeklySettingsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (s *jsiiProxy_SsmcontactsRotationRecurrenceWeeklySettingsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SsmcontactsRotationRecurrenceWeeklySettingsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
