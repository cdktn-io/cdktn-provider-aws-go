...
func (s *jsiiProxy_SsmcontactsRotation) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_SsmcontactsRotation) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
