...
func (j *jsiiProxy_SsmcontactsRotationRecurrenceShiftCoveragesOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewSsmcontactsRotationRecurrenceShiftCoveragesOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) SsmcontactsRotationRecurrenceShiftCoveragesOutputReference {
	_init_.Initialize()
...
func NewSsmcontactsRotationRecurrenceShiftCoveragesOutputReference_Override(s SsmcontactsRotationRecurrenceShiftCoveragesOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_SsmcontactsRotationRecurrenceShiftCoveragesOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_SsmcontactsRotationRecurrenceShiftCoveragesOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SsmcontactsRotationRecurrenceShiftCoveragesOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (s *jsiiProxy_SsmcontactsRotationRecurrenceShiftCoveragesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SsmcontactsRotationRecurrenceShiftCoveragesOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
