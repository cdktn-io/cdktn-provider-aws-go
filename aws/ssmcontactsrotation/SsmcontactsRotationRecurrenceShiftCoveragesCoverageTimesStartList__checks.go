...
func (s *jsiiProxy_SsmcontactsRotationRecurrenceShiftCoveragesCoverageTimesStartList) validateResolveParameters(context cdktn.IResolveContext) error {
	if context == nil {
...
func (j *jsiiProxy_SsmcontactsRotationRecurrenceShiftCoveragesCoverageTimesStartList) validateSetTerraformResourceParameters(val cdktn.IInterpolatingParent) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func validateNewSsmcontactsRotationRecurrenceShiftCoveragesCoverageTimesStartListParameters(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) error {
