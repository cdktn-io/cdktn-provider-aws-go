...
func (j *jsiiProxy_SsmcontactsRotationRecurrenceShiftCoveragesCoverageTimesEndOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewSsmcontactsRotationRecurrenceShiftCoveragesCoverageTimesEndOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) SsmcontactsRotationRecurrenceShiftCoveragesCoverageTimesEndOutputReference {
	_init_.Initialize()
...
func NewSsmcontactsRotationRecurrenceShiftCoveragesCoverageTimesEndOutputReference_Override(s SsmcontactsRotationRecurrenceShiftCoveragesCoverageTimesEndOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_SsmcontactsRotationRecurrenceShiftCoveragesCoverageTimesEndOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_SsmcontactsRotationRecurrenceShiftCoveragesCoverageTimesEndOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SsmcontactsRotationRecurrenceShiftCoveragesCoverageTimesEndOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (s *jsiiProxy_SsmcontactsRotationRecurrenceShiftCoveragesCoverageTimesEndOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SsmcontactsRotationRecurrenceShiftCoveragesCoverageTimesEndOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
