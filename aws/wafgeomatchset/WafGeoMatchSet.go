...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/wafgeomatchset/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/waf_geo_match_set aws_waf_geo_match_set}.
...
func (j *jsiiProxy_WafGeoMatchSet) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_WafGeoMatchSet) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_WafGeoMatchSet) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_WafGeoMatchSet) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_WafGeoMatchSet) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/waf_geo_match_set aws_waf_geo_match_set} Resource.
...
func (j *jsiiProxy_WafGeoMatchSet)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_WafGeoMatchSet)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_WafGeoMatchSet)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func WafGeoMatchSet_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (w *jsiiProxy_WafGeoMatchSet) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_WafGeoMatchSet) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (w *jsiiProxy_WafGeoMatchSet) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_WafGeoMatchSet) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (w *jsiiProxy_WafGeoMatchSet) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (w *jsiiProxy_WafGeoMatchSet) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
