...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v23/globalacceleratorlistener/internal"
...
func (j *jsiiProxy_GlobalacceleratorListenerPortRangeList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewGlobalacceleratorListenerPortRangeList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) GlobalacceleratorListenerPortRangeList {
	_init_.Initialize()

	if err := validateNewGlobalacceleratorListenerPortRangeListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewGlobalacceleratorListenerPortRangeList_Override(g GlobalacceleratorListenerPortRangeList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_GlobalacceleratorListenerPortRangeList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (g *jsiiProxy_GlobalacceleratorListenerPortRangeList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (g *jsiiProxy_GlobalacceleratorListenerPortRangeList) Resolve(context cdktn.IResolveContext) interface{} {
