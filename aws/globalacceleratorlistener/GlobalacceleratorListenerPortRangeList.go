...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v21/globalacceleratorlistener/internal"
...
func (g *jsiiProxy_GlobalacceleratorListenerPortRangeList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (g *jsiiProxy_GlobalacceleratorListenerPortRangeList) Resolve(context cdktf.IResolveContext) interface{} {
