...
func (g *jsiiProxy_GlobalacceleratorListener) validatePutPortRangeParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*GlobalacceleratorListenerPortRange; received %#v (a %T)", value, value)
		}
	}
...
func (j *jsiiProxy_GlobalacceleratorListener) validateSetLifecycleParameters(val *cdktn.TerraformResourceLifecycle) error {
	if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
		return err
	}
