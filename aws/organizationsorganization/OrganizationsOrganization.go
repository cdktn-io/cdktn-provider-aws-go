...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/organizationsorganization/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/organizations_organization aws_organizations_organization}.
...
func (j *jsiiProxy_OrganizationsOrganization) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_OrganizationsOrganization) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_OrganizationsOrganization) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_OrganizationsOrganization) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_OrganizationsOrganization) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/organizations_organization aws_organizations_organization} Resource.
...
func (j *jsiiProxy_OrganizationsOrganization)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_OrganizationsOrganization)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_OrganizationsOrganization)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func OrganizationsOrganization_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (o *jsiiProxy_OrganizationsOrganization) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (o *jsiiProxy_OrganizationsOrganization) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (o *jsiiProxy_OrganizationsOrganization) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (o *jsiiProxy_OrganizationsOrganization) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (o *jsiiProxy_OrganizationsOrganization) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (o *jsiiProxy_OrganizationsOrganization) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
