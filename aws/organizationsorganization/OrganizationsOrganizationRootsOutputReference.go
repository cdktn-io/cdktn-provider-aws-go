...
func (o *jsiiProxy_OrganizationsOrganizationRootsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (o *jsiiProxy_OrganizationsOrganizationRootsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
