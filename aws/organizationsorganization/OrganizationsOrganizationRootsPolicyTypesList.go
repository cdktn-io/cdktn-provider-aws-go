...
func (o *jsiiProxy_OrganizationsOrganizationRootsPolicyTypesList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (o *jsiiProxy_OrganizationsOrganizationRootsPolicyTypesList) Resolve(context cdktf.IResolveContext) interface{} {
