...
func (j *jsiiProxy_OrganizationsOrganizationRootsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewOrganizationsOrganizationRootsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) OrganizationsOrganizationRootsList {
	_init_.Initialize()

	if err := validateNewOrganizationsOrganizationRootsListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewOrganizationsOrganizationRootsList_Override(o OrganizationsOrganizationRootsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_OrganizationsOrganizationRootsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (o *jsiiProxy_OrganizationsOrganizationRootsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (o *jsiiProxy_OrganizationsOrganizationRootsList) Resolve(context cdktn.IResolveContext) interface{} {
