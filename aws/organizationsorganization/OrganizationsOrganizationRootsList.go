...
func (o *jsiiProxy_OrganizationsOrganizationRootsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (o *jsiiProxy_OrganizationsOrganizationRootsList) Resolve(context cdktf.IResolveContext) interface{} {
