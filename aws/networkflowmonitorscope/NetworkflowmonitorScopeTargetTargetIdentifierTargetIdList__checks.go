...
func (n *jsiiProxy_NetworkflowmonitorScopeTargetTargetIdentifierTargetIdList) validateResolveParameters(context cdktn.IResolveContext) error {
	if context == nil {
...
func (j *jsiiProxy_NetworkflowmonitorScopeTargetTargetIdentifierTargetIdList) validateSetTerraformResourceParameters(val cdktn.IInterpolatingParent) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func validateNewNetworkflowmonitorScopeTargetTargetIdentifierTargetIdListParameters(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) error {
