...
func (j *jsiiProxy_NetworkflowmonitorScopeTargetList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewNetworkflowmonitorScopeTargetList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) NetworkflowmonitorScopeTargetList {
	_init_.Initialize()
...
func NewNetworkflowmonitorScopeTargetList_Override(n NetworkflowmonitorScopeTargetList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_NetworkflowmonitorScopeTargetList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (n *jsiiProxy_NetworkflowmonitorScopeTargetList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (n *jsiiProxy_NetworkflowmonitorScopeTargetList) Resolve(context cdktn.IResolveContext) interface{} {
