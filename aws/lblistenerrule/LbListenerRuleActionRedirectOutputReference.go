...
func (l *jsiiProxy_LbListenerRuleActionRedirectOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LbListenerRuleActionRedirectOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
