...
func (j *jsiiProxy_LbListenerRule) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_LbListenerRule) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_LbListenerRule) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_LbListenerRule) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_LbListenerRule) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_LbListenerRule) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_LbListenerRule) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_LbListenerRule)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_LbListenerRule)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_LbListenerRule)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_LbListenerRule)SetRegion(val *string) {
...
func LbListenerRule_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (l *jsiiProxy_LbListenerRule) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LbListenerRule) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (l *jsiiProxy_LbListenerRule) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LbListenerRule) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (l *jsiiProxy_LbListenerRule) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (l *jsiiProxy_LbListenerRule) ResetRegion() {
	_jsii_.InvokeVoid(
		l,
		"resetRegion",
		nil, // no parameters
...
func (l *jsiiProxy_LbListenerRule) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
