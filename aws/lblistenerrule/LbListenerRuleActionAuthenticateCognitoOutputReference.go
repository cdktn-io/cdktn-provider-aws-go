...
func (l *jsiiProxy_LbListenerRuleActionAuthenticateCognitoOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LbListenerRuleActionAuthenticateCognitoOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
