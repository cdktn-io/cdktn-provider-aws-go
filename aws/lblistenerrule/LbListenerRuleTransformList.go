...
func (j *jsiiProxy_LbListenerRuleTransformList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewLbListenerRuleTransformList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) LbListenerRuleTransformList {
	_init_.Initialize()
...
func NewLbListenerRuleTransformList_Override(l LbListenerRuleTransformList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_LbListenerRuleTransformList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (l *jsiiProxy_LbListenerRuleTransformList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (l *jsiiProxy_LbListenerRuleTransformList) Resolve(context cdktn.IResolveContext) interface{} {
