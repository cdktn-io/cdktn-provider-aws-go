...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/dataawsiotendpoint/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/iot_endpoint aws_iot_endpoint}.
...
func (j *jsiiProxy_DataAwsIotEndpoint) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsIotEndpoint) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsIotEndpoint) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_DataAwsIotEndpoint) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsIotEndpoint) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsIotEndpoint) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DataAwsIotEndpoint) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_DataAwsIotEndpoint) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/iot_endpoint aws_iot_endpoint} Data Source.
func NewDataAwsIotEndpoint(scope constructs.Construct, id *string, config *DataAwsIotEndpointConfig) DataAwsIotEndpoint {
	_init_.Initialize()

	if err := validateNewDataAwsIotEndpointParameters(scope, id, config); err != nil {
		panic(err)
	}
	j := jsiiProxy_DataAwsIotEndpoint{}

	_jsii_.Create(
		"@cdktn/provider-aws.dataAwsIotEndpoint.DataAwsIotEndpoint",
...
func (j *jsiiProxy_DataAwsIotEndpoint)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsIotEndpoint)SetId(val *string) {
...
func (j *jsiiProxy_DataAwsIotEndpoint)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsIotEndpoint)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_DataAwsIotEndpoint)SetRegion(val *string) {
...
func DataAwsIotEndpoint_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateDataAwsIotEndpoint_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func DataAwsIotEndpoint_IsConstruct(x interface{}) *bool {
	...
	if err := validateDataAwsIotEndpoint_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataAwsIotEndpoint_IsTerraformDataSource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataAwsIotEndpoint_IsTerraformDataSourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataAwsIotEndpoint_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataAwsIotEndpoint_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (d *jsiiProxy_DataAwsIotEndpoint) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsIotEndpoint) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsIotEndpoint) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsIotEndpoint) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsIotEndpoint) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsIotEndpoint) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataAwsIotEndpoint) ToHclTerraform() interface{} {
	var returns interface{}
...
func (d *jsiiProxy_DataAwsIotEndpoint) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
