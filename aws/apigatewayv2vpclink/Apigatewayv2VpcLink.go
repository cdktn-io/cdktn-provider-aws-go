...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/apigatewayv2vpclink/internal"
...
func (j *jsiiProxy_Apigatewayv2VpcLink) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_Apigatewayv2VpcLink) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_Apigatewayv2VpcLink) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_Apigatewayv2VpcLink) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_Apigatewayv2VpcLink) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/apigatewayv2_vpc_link aws_apigatewayv2_vpc_link} Resource.
...
func (j *jsiiProxy_Apigatewayv2VpcLink)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_Apigatewayv2VpcLink)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_Apigatewayv2VpcLink)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func Apigatewayv2VpcLink_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (a *jsiiProxy_Apigatewayv2VpcLink) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_Apigatewayv2VpcLink) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (a *jsiiProxy_Apigatewayv2VpcLink) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_Apigatewayv2VpcLink) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (a *jsiiProxy_Apigatewayv2VpcLink) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (a *jsiiProxy_Apigatewayv2VpcLink) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
