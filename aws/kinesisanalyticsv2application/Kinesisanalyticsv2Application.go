...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/kinesisanalyticsv2_application aws_kinesisanalyticsv2_application}.
...
func (j *jsiiProxy_Kinesisanalyticsv2Application) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_Kinesisanalyticsv2Application) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/kinesisanalyticsv2_application aws_kinesisanalyticsv2_application} Resource.
...
func (j *jsiiProxy_Kinesisanalyticsv2Application)SetRegion(val *string) {
...
func (k *jsiiProxy_Kinesisanalyticsv2Application) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (k *jsiiProxy_Kinesisanalyticsv2Application) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (k *jsiiProxy_Kinesisanalyticsv2Application) ResetRegion() {
	_jsii_.InvokeVoid(
		k,
		"resetRegion",
		nil, // no parameters
...
func (k *jsiiProxy_Kinesisanalyticsv2Application) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
