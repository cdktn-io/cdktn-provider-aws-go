...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/dataawsservicequotasservice/internal"
...
func (j *jsiiProxy_DataAwsServicequotasService) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsServicequotasService) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsServicequotasService) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsServicequotasService) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsServicequotasService) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/data-sources/servicequotas_service aws_servicequotas_service} Data Source.
func NewDataAwsServicequotasService(scope constructs.Construct, id *string, config *DataAwsServicequotasServiceConfig) DataAwsServicequotasService {
	...
	_jsii_.Create(
		"@cdktn/provider-aws.dataAwsServicequotasService.DataAwsServicequotasService",
...
func (j *jsiiProxy_DataAwsServicequotasService)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsServicequotasService)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsServicequotasService)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsServicequotasService_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsServicequotasService) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsServicequotasService) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsServicequotasService) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsServicequotasService) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
