...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/route53resolverfirewallrule/internal"
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/route53_resolver_firewall_rule aws_route53_resolver_firewall_rule} Resource.
...
func (r *jsiiProxy_Route53ResolverFirewallRule) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (r *jsiiProxy_Route53ResolverFirewallRule) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (r *jsiiProxy_Route53ResolverFirewallRule) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
