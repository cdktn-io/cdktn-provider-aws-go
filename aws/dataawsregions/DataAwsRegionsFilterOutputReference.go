...
func (d *jsiiProxy_DataAwsRegionsFilterOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataAwsRegionsFilterOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
