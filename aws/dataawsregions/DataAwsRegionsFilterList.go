...
func (j *jsiiProxy_DataAwsRegionsFilterList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsRegionsFilterList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsRegionsFilterList {
	_init_.Initialize()

	if err := validateNewDataAwsRegionsFilterListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewDataAwsRegionsFilterList_Override(d DataAwsRegionsFilterList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsRegionsFilterList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsRegionsFilterList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsRegionsFilterList) Resolve(context cdktn.IResolveContext) interface{} {
