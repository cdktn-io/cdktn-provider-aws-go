...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v22/dataawsregions/internal"
...
func (d *jsiiProxy_DataAwsRegionsFilterList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsRegionsFilterList) Resolve(context cdktf.IResolveContext) interface{} {
