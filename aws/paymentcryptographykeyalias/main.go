...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*PaymentcryptographyKeyAlias)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-aws.paymentcryptographyKeyAlias.PaymentcryptographyKeyAliasConfig",
		reflect.TypeOf((*PaymentcryptographyKeyAliasConfig)(nil)).Elem(),
	)
}
