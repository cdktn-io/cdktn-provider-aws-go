...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/apigatewaydocumentationversion/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/api_gateway_documentation_version aws_api_gateway_documentation_version}.
...
func (j *jsiiProxy_ApiGatewayDocumentationVersion) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_ApiGatewayDocumentationVersion) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_ApiGatewayDocumentationVersion) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_ApiGatewayDocumentationVersion) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_ApiGatewayDocumentationVersion) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_ApiGatewayDocumentationVersion) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_ApiGatewayDocumentationVersion) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/api_gateway_documentation_version aws_api_gateway_documentation_version} Resource.
func NewApiGatewayDocumentationVersion(scope constructs.Construct, id *string, config *ApiGatewayDocumentationVersionConfig) ApiGatewayDocumentationVersion {
	...
	if err := validateNewApiGatewayDocumentationVersionParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_ApiGatewayDocumentationVersion)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_ApiGatewayDocumentationVersion)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_ApiGatewayDocumentationVersion)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_ApiGatewayDocumentationVersion)SetRegion(val *string) {
...
func ApiGatewayDocumentationVersion_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateApiGatewayDocumentationVersion_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func ApiGatewayDocumentationVersion_IsConstruct(x interface{}) *bool {
	...
	if err := validateApiGatewayDocumentationVersion_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func ApiGatewayDocumentationVersion_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateApiGatewayDocumentationVersion_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func ApiGatewayDocumentationVersion_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateApiGatewayDocumentationVersion_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (a *jsiiProxy_ApiGatewayDocumentationVersion) AddMoveTarget(moveTarget *string) {
...
func (a *jsiiProxy_ApiGatewayDocumentationVersion) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_ApiGatewayDocumentationVersion) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (a *jsiiProxy_ApiGatewayDocumentationVersion) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_ApiGatewayDocumentationVersion) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (a *jsiiProxy_ApiGatewayDocumentationVersion) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (a *jsiiProxy_ApiGatewayDocumentationVersion) ResetRegion() {
	_jsii_.InvokeVoid(
		a,
		"resetRegion",
		nil, // no parameters
...
func (a *jsiiProxy_ApiGatewayDocumentationVersion) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
