...
func (j *jsiiProxy_DataAwsAutoscalingGroupMixedInstancesPolicyList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsAutoscalingGroupMixedInstancesPolicyList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsAutoscalingGroupMixedInstancesPolicyList {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-aws.dataAwsAutoscalingGroup.DataAwsAutoscalingGroupMixedInstancesPolicyList",
...
func NewDataAwsAutoscalingGroupMixedInstancesPolicyList_Override(d DataAwsAutoscalingGroupMixedInstancesPolicyList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsAutoscalingGroupMixedInstancesPolicyList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsAutoscalingGroupMixedInstancesPolicyList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsAutoscalingGroupMixedInstancesPolicyList) Resolve(context cdktn.IResolveContext) interface{} {
