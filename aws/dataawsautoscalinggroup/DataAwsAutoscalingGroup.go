...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.39.0/docs/data-sources/autoscaling_group aws_autoscaling_group}.
type DataAwsAutoscalingGroup interface {
	...
	SetName(val *string)
	NameInput() *string
	NewInstancesProtectedFromScaleIn() cdktn.IResolvable
	// The tree node.
...
func (j *jsiiProxy_DataAwsAutoscalingGroup) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsAutoscalingGroup) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsAutoscalingGroup) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsAutoscalingGroup) NewInstancesProtectedFromScaleIn() cdktn.IResolvable {
...
func (j *jsiiProxy_DataAwsAutoscalingGroup) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsAutoscalingGroup) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.39.0/docs/data-sources/autoscaling_group aws_autoscaling_group} Data Source.
...
func (j *jsiiProxy_DataAwsAutoscalingGroup)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsAutoscalingGroup)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsAutoscalingGroup)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsAutoscalingGroup_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsAutoscalingGroup) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsAutoscalingGroup) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsAutoscalingGroup) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
