...
func (d *jsiiProxy_DataAwsAutoscalingGroupWarmPoolList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsAutoscalingGroupWarmPoolList) Resolve(context cdktf.IResolveContext) interface{} {
