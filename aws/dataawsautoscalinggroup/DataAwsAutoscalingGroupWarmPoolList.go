...
func (j *jsiiProxy_DataAwsAutoscalingGroupWarmPoolList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsAutoscalingGroupWarmPoolList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsAutoscalingGroupWarmPoolList {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-aws.dataAwsAutoscalingGroup.DataAwsAutoscalingGroupWarmPoolList",
...
func NewDataAwsAutoscalingGroupWarmPoolList_Override(d DataAwsAutoscalingGroupWarmPoolList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsAutoscalingGroupWarmPoolList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsAutoscalingGroupWarmPoolList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsAutoscalingGroupWarmPoolList) Resolve(context cdktn.IResolveContext) interface{} {
