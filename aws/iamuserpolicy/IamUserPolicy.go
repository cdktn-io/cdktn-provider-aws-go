...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v22/iamuserpolicy/internal"
...
func (j *jsiiProxy_IamUserPolicy) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_IamUserPolicy)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func IamUserPolicy_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (i *jsiiProxy_IamUserPolicy) ImportFrom(id *string, provider cdktf.TerraformProvider) {
