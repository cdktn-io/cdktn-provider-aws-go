...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/iamuserpolicy/internal"
...
func (j *jsiiProxy_IamUserPolicy) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_IamUserPolicy) Connection() interface{} {
...
func (j *jsiiProxy_IamUserPolicy) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_IamUserPolicy) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_IamUserPolicy) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_IamUserPolicy) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_IamUserPolicy) Provisioners() *[]interface{} {
	var returns *[]interface{}
	_jsii_.Get(
		j,
		"provisioners",
...
func (j *jsiiProxy_IamUserPolicy) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func NewIamUserPolicy(scope constructs.Construct, id *string, config *IamUserPolicyConfig) IamUserPolicy {
	...
	if err := validateNewIamUserPolicyParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_IamUserPolicy)SetConnection(val interface{}) {
...
func (j *jsiiProxy_IamUserPolicy)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_IamUserPolicy)SetId(val *string) {
...
func (j *jsiiProxy_IamUserPolicy)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_IamUserPolicy)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_IamUserPolicy)SetProvisioners(val *[]interface{}) {
...
func IamUserPolicy_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateIamUserPolicy_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func IamUserPolicy_IsConstruct(x interface{}) *bool {
	...
	if err := validateIamUserPolicy_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func IamUserPolicy_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateIamUserPolicy_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func IamUserPolicy_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateIamUserPolicy_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (i *jsiiProxy_IamUserPolicy) AddMoveTarget(moveTarget *string) {
...
func (i *jsiiProxy_IamUserPolicy) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (i *jsiiProxy_IamUserPolicy) HasResourceMove() interface{} {
	var returns interface{}
...
func (i *jsiiProxy_IamUserPolicy) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (i *jsiiProxy_IamUserPolicy) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (i *jsiiProxy_IamUserPolicy) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (i *jsiiProxy_IamUserPolicy) MoveFromId(id *string) {
...
func (i *jsiiProxy_IamUserPolicy) MoveTo(moveTarget *string, index interface{}) {
...
func (i *jsiiProxy_IamUserPolicy) MoveToId(id *string) {
...
func (i *jsiiProxy_IamUserPolicy) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (i *jsiiProxy_IamUserPolicy) ResetId() {
	_jsii_.InvokeVoid(
		i,
		"resetId",
		nil, // no parameters
...
func (i *jsiiProxy_IamUserPolicy) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (i *jsiiProxy_IamUserPolicy) ToHclTerraform() interface{} {
	var returns interface{}
...
func (i *jsiiProxy_IamUserPolicy) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
