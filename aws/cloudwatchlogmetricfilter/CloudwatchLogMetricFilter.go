...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/cloudwatch_log_metric_filter aws_cloudwatch_log_metric_filter}.
...
func (j *jsiiProxy_CloudwatchLogMetricFilter) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_CloudwatchLogMetricFilter) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_CloudwatchLogMetricFilter) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_CloudwatchLogMetricFilter) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_CloudwatchLogMetricFilter) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/cloudwatch_log_metric_filter aws_cloudwatch_log_metric_filter} Resource.
...
func (j *jsiiProxy_CloudwatchLogMetricFilter)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_CloudwatchLogMetricFilter)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_CloudwatchLogMetricFilter)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func CloudwatchLogMetricFilter_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (c *jsiiProxy_CloudwatchLogMetricFilter) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CloudwatchLogMetricFilter) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (c *jsiiProxy_CloudwatchLogMetricFilter) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CloudwatchLogMetricFilter) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_CloudwatchLogMetricFilter) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (c *jsiiProxy_CloudwatchLogMetricFilter) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
