...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.40.0/docs/data-sources/vpc aws_vpc} Data Source.
...
func (d *jsiiProxy_DataAwsVpc) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
