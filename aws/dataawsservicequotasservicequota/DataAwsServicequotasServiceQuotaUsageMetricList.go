...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v21/dataawsservicequotasservicequota/internal"
...
func (d *jsiiProxy_DataAwsServicequotasServiceQuotaUsageMetricList) Resolve(context cdktf.IResolveContext) interface{} {
