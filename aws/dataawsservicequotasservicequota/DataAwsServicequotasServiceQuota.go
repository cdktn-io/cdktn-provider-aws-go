...
func (j *jsiiProxy_DataAwsServicequotasServiceQuota) Adjustable() cdktn.IResolvable {
...
func (j *jsiiProxy_DataAwsServicequotasServiceQuota) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsServicequotasServiceQuota) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsServicequotasServiceQuota) GlobalQuota() cdktn.IResolvable {
	var returns cdktn.IResolvable
	_jsii_.Get(
		j,
		"globalQuota",
...
func (j *jsiiProxy_DataAwsServicequotasServiceQuota) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsServicequotasServiceQuota) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsServicequotasServiceQuota) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DataAwsServicequotasServiceQuota)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsServicequotasServiceQuota)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsServicequotasServiceQuota)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsServicequotasServiceQuota_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsServicequotasServiceQuota) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsServicequotasServiceQuota) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsServicequotasServiceQuota) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsServicequotasServiceQuota) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
