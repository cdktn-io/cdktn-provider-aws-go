...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/cloudwatchquerydefinition/internal"
...
func (j *jsiiProxy_CloudwatchQueryDefinition) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_CloudwatchQueryDefinition) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_CloudwatchQueryDefinition) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_CloudwatchQueryDefinition) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/cloudwatch_query_definition aws_cloudwatch_query_definition} Resource.
...
func (j *jsiiProxy_CloudwatchQueryDefinition)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_CloudwatchQueryDefinition)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_CloudwatchQueryDefinition)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func CloudwatchQueryDefinition_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (c *jsiiProxy_CloudwatchQueryDefinition) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CloudwatchQueryDefinition) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (c *jsiiProxy_CloudwatchQueryDefinition) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CloudwatchQueryDefinition) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_CloudwatchQueryDefinition) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (c *jsiiProxy_CloudwatchQueryDefinition) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
