...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/dataawscodeartifactauthorizationtoken/internal"
...
func (j *jsiiProxy_DataAwsCodeartifactAuthorizationToken) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsCodeartifactAuthorizationToken) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsCodeartifactAuthorizationToken) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsCodeartifactAuthorizationToken) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsCodeartifactAuthorizationToken) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/data-sources/codeartifact_authorization_token aws_codeartifact_authorization_token} Data Source.
...
func (j *jsiiProxy_DataAwsCodeartifactAuthorizationToken)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsCodeartifactAuthorizationToken)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsCodeartifactAuthorizationToken)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsCodeartifactAuthorizationToken_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsCodeartifactAuthorizationToken) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsCodeartifactAuthorizationToken) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsCodeartifactAuthorizationToken) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsCodeartifactAuthorizationToken) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
