...
func (j *jsiiProxy_LightsailContainerServiceDeploymentVersion) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_LightsailContainerServiceDeploymentVersion) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_LightsailContainerServiceDeploymentVersion) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_LightsailContainerServiceDeploymentVersion) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_LightsailContainerServiceDeploymentVersion) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/lightsail_container_service_deployment_version aws_lightsail_container_service_deployment_version} Resource.
...
func (j *jsiiProxy_LightsailContainerServiceDeploymentVersion)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_LightsailContainerServiceDeploymentVersion)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_LightsailContainerServiceDeploymentVersion)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func LightsailContainerServiceDeploymentVersion_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (l *jsiiProxy_LightsailContainerServiceDeploymentVersion) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LightsailContainerServiceDeploymentVersion) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (l *jsiiProxy_LightsailContainerServiceDeploymentVersion) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LightsailContainerServiceDeploymentVersion) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (l *jsiiProxy_LightsailContainerServiceDeploymentVersion) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (l *jsiiProxy_LightsailContainerServiceDeploymentVersion) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
