...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/lightsailcontainerservicedeploymentversion/internal"
...
func (j *jsiiProxy_LightsailContainerServiceDeploymentVersionTimeoutsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewLightsailContainerServiceDeploymentVersionTimeoutsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) LightsailContainerServiceDeploymentVersionTimeoutsOutputReference {
	_init_.Initialize()

	if err := validateNewLightsailContainerServiceDeploymentVersionTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewLightsailContainerServiceDeploymentVersionTimeoutsOutputReference_Override(l LightsailContainerServiceDeploymentVersionTimeoutsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_LightsailContainerServiceDeploymentVersionTimeoutsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (l *jsiiProxy_LightsailContainerServiceDeploymentVersionTimeoutsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LightsailContainerServiceDeploymentVersionTimeoutsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (l *jsiiProxy_LightsailContainerServiceDeploymentVersionTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LightsailContainerServiceDeploymentVersionTimeoutsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
