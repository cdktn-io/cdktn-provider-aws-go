...
func (l *jsiiProxy_LightsailContainerServiceDeploymentVersionTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LightsailContainerServiceDeploymentVersionTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
