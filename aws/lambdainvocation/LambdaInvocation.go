...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/lambdainvocation/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/lambda_invocation aws_lambda_invocation}.
...
func (j *jsiiProxy_LambdaInvocation) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_LambdaInvocation) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_LambdaInvocation) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_LambdaInvocation) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_LambdaInvocation) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_LambdaInvocation) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_LambdaInvocation) TenantId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"tenantId",
...
func (j *jsiiProxy_LambdaInvocation) TenantIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"tenantIdInput",
...
func (j *jsiiProxy_LambdaInvocation) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/lambda_invocation aws_lambda_invocation} Resource.
...
func (j *jsiiProxy_LambdaInvocation)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_LambdaInvocation)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_LambdaInvocation)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_LambdaInvocation)SetRegion(val *string) {
...
func (j *jsiiProxy_LambdaInvocation)SetTenantId(val *string) {
...
func LambdaInvocation_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (l *jsiiProxy_LambdaInvocation) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LambdaInvocation) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (l *jsiiProxy_LambdaInvocation) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LambdaInvocation) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (l *jsiiProxy_LambdaInvocation) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (l *jsiiProxy_LambdaInvocation) ResetRegion() {
	_jsii_.InvokeVoid(
		l,
		"resetRegion",
		nil, // no parameters
...
func (l *jsiiProxy_LambdaInvocation) ResetTenantId() {
	_jsii_.InvokeVoid(
		l,
		"resetTenantId",
		nil, // no parameters
...
func (l *jsiiProxy_LambdaInvocation) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
