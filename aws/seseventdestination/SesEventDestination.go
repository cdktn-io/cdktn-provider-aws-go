...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/seseventdestination/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/ses_event_destination aws_ses_event_destination}.
...
func (j *jsiiProxy_SesEventDestination) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_SesEventDestination) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_SesEventDestination) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_SesEventDestination) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_SesEventDestination) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/ses_event_destination aws_ses_event_destination} Resource.
...
func (j *jsiiProxy_SesEventDestination)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_SesEventDestination)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_SesEventDestination)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func SesEventDestination_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (s *jsiiProxy_SesEventDestination) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SesEventDestination) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_SesEventDestination) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SesEventDestination) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_SesEventDestination) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_SesEventDestination) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
