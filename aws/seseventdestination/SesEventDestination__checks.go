...
func (s *jsiiProxy_SesEventDestination) validatePutCloudwatchDestinationParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*SesEventDestinationCloudwatchDestination; received %#v (a %T)", value, value)
		}
	}
