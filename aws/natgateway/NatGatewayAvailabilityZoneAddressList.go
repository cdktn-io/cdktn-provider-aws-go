...
func (j *jsiiProxy_NatGatewayAvailabilityZoneAddressList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewNatGatewayAvailabilityZoneAddressList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) NatGatewayAvailabilityZoneAddressList {
	_init_.Initialize()
...
func NewNatGatewayAvailabilityZoneAddressList_Override(n NatGatewayAvailabilityZoneAddressList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_NatGatewayAvailabilityZoneAddressList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (n *jsiiProxy_NatGatewayAvailabilityZoneAddressList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (n *jsiiProxy_NatGatewayAvailabilityZoneAddressList) Resolve(context cdktn.IResolveContext) interface{} {
