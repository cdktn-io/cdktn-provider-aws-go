...
func (j *jsiiProxy_NatGateway) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_NatGateway) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_NatGateway) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_NatGateway) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_NatGateway) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/nat_gateway aws_nat_gateway} Resource.
...
func (j *jsiiProxy_NatGateway)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_NatGateway)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_NatGateway)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func NatGateway_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (n *jsiiProxy_NatGateway) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (n *jsiiProxy_NatGateway) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (n *jsiiProxy_NatGateway) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (n *jsiiProxy_NatGateway) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (n *jsiiProxy_NatGateway) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (n *jsiiProxy_NatGateway) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
