...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v24/acmpcacertificateauthority/internal"
...
func (j *jsiiProxy_AcmpcaCertificateAuthorityRevocationConfigurationOcspConfigurationOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewAcmpcaCertificateAuthorityRevocationConfigurationOcspConfigurationOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) AcmpcaCertificateAuthorityRevocationConfigurationOcspConfigurationOutputReference {
	_init_.Initialize()

	if err := validateNewAcmpcaCertificateAuthorityRevocationConfigurationOcspConfigurationOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewAcmpcaCertificateAuthorityRevocationConfigurationOcspConfigurationOutputReference_Override(a AcmpcaCertificateAuthorityRevocationConfigurationOcspConfigurationOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_AcmpcaCertificateAuthorityRevocationConfigurationOcspConfigurationOutputReference)SetOcspCustomCname(val *string) {
	if err := j.validateSetOcspCustomCnameParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_AcmpcaCertificateAuthorityRevocationConfigurationOcspConfigurationOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (a *jsiiProxy_AcmpcaCertificateAuthorityRevocationConfigurationOcspConfigurationOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AcmpcaCertificateAuthorityRevocationConfigurationOcspConfigurationOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (a *jsiiProxy_AcmpcaCertificateAuthorityRevocationConfigurationOcspConfigurationOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AcmpcaCertificateAuthorityRevocationConfigurationOcspConfigurationOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
