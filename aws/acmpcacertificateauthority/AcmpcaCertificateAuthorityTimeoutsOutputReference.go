...
func (a *jsiiProxy_AcmpcaCertificateAuthorityTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_AcmpcaCertificateAuthorityTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
