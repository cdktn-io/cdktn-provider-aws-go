...
func (a *jsiiProxy_AcmpcaCertificateAuthority) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (a *jsiiProxy_AcmpcaCertificateAuthority) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (a *jsiiProxy_AcmpcaCertificateAuthority) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
