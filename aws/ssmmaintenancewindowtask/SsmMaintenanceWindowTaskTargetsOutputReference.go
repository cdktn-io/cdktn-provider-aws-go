...
func (j *jsiiProxy_SsmMaintenanceWindowTaskTargetsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewSsmMaintenanceWindowTaskTargetsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) SsmMaintenanceWindowTaskTargetsOutputReference {
	_init_.Initialize()
...
func NewSsmMaintenanceWindowTaskTargetsOutputReference_Override(s SsmMaintenanceWindowTaskTargetsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_SsmMaintenanceWindowTaskTargetsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_SsmMaintenanceWindowTaskTargetsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SsmMaintenanceWindowTaskTargetsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (s *jsiiProxy_SsmMaintenanceWindowTaskTargetsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SsmMaintenanceWindowTaskTargetsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
