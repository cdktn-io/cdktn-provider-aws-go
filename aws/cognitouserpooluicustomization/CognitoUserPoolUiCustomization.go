...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/cognitouserpooluicustomization/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/cognito_user_pool_ui_customization aws_cognito_user_pool_ui_customization}.
...
func (j *jsiiProxy_CognitoUserPoolUiCustomization) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_CognitoUserPoolUiCustomization) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_CognitoUserPoolUiCustomization) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_CognitoUserPoolUiCustomization) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_CognitoUserPoolUiCustomization) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_CognitoUserPoolUiCustomization) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_CognitoUserPoolUiCustomization) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/cognito_user_pool_ui_customization aws_cognito_user_pool_ui_customization} Resource.
func NewCognitoUserPoolUiCustomization(scope constructs.Construct, id *string, config *CognitoUserPoolUiCustomizationConfig) CognitoUserPoolUiCustomization {
	...
	if err := validateNewCognitoUserPoolUiCustomizationParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CognitoUserPoolUiCustomization)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_CognitoUserPoolUiCustomization)SetImageFile(val *string) {
	if err := j.validateSetImageFileParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CognitoUserPoolUiCustomization)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_CognitoUserPoolUiCustomization)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_CognitoUserPoolUiCustomization)SetRegion(val *string) {
...
func CognitoUserPoolUiCustomization_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateCognitoUserPoolUiCustomization_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func CognitoUserPoolUiCustomization_IsConstruct(x interface{}) *bool {
	...
	if err := validateCognitoUserPoolUiCustomization_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func CognitoUserPoolUiCustomization_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCognitoUserPoolUiCustomization_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func CognitoUserPoolUiCustomization_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCognitoUserPoolUiCustomization_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CognitoUserPoolUiCustomization) AddMoveTarget(moveTarget *string) {
...
func (c *jsiiProxy_CognitoUserPoolUiCustomization) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CognitoUserPoolUiCustomization) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (c *jsiiProxy_CognitoUserPoolUiCustomization) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CognitoUserPoolUiCustomization) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_CognitoUserPoolUiCustomization) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (c *jsiiProxy_CognitoUserPoolUiCustomization) ResetRegion() {
	_jsii_.InvokeVoid(
		c,
		"resetRegion",
		nil, // no parameters
...
func (c *jsiiProxy_CognitoUserPoolUiCustomization) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (c *jsiiProxy_CognitoUserPoolUiCustomization) ToHclTerraform() interface{} {
	var returns interface{}
...
func (c *jsiiProxy_CognitoUserPoolUiCustomization) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
