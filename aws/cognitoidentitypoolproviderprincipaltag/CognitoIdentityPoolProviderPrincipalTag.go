...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/cognitoidentitypoolproviderprincipaltag/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/cognito_identity_pool_provider_principal_tag aws_cognito_identity_pool_provider_principal_tag}.
...
func (j *jsiiProxy_CognitoIdentityPoolProviderPrincipalTag) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_CognitoIdentityPoolProviderPrincipalTag) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_CognitoIdentityPoolProviderPrincipalTag) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_CognitoIdentityPoolProviderPrincipalTag) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_CognitoIdentityPoolProviderPrincipalTag) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/cognito_identity_pool_provider_principal_tag aws_cognito_identity_pool_provider_principal_tag} Resource.
func NewCognitoIdentityPoolProviderPrincipalTag(scope constructs.Construct, id *string, config *CognitoIdentityPoolProviderPrincipalTagConfig) CognitoIdentityPoolProviderPrincipalTag {
	...
	_jsii_.Create(
		"@cdktn/provider-aws.cognitoIdentityPoolProviderPrincipalTag.CognitoIdentityPoolProviderPrincipalTag",
...
func (j *jsiiProxy_CognitoIdentityPoolProviderPrincipalTag)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_CognitoIdentityPoolProviderPrincipalTag)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_CognitoIdentityPoolProviderPrincipalTag)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func CognitoIdentityPoolProviderPrincipalTag_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (c *jsiiProxy_CognitoIdentityPoolProviderPrincipalTag) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CognitoIdentityPoolProviderPrincipalTag) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (c *jsiiProxy_CognitoIdentityPoolProviderPrincipalTag) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CognitoIdentityPoolProviderPrincipalTag) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_CognitoIdentityPoolProviderPrincipalTag) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (c *jsiiProxy_CognitoIdentityPoolProviderPrincipalTag) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
