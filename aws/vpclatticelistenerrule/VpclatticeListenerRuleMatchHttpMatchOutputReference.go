...
func (v *jsiiProxy_VpclatticeListenerRuleMatchHttpMatchOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (v *jsiiProxy_VpclatticeListenerRuleMatchHttpMatchOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
