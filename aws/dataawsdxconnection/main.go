...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-aws.dataAwsDxConnection.DataAwsDxConnectionRateLimiterStatus",
		reflect.TypeOf((*DataAwsDxConnectionRateLimiterStatus)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-aws.dataAwsDxConnection.DataAwsDxConnectionRateLimiterStatusList",
		reflect.TypeOf((*DataAwsDxConnectionRateLimiterStatusList)(nil)).Elem(),
		[]_jsii_.Member{
		...
		func() interface{} {
			j := jsiiProxy_DataAwsDxConnectionRateLimiterStatusList{}
			_jsii_.InitJsiiProxy(&j.Type__cdktnComplexList)
			return &j
		},
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-aws.dataAwsDxConnection.DataAwsDxConnectionRateLimiterStatusOutputReference",
		reflect.TypeOf((*DataAwsDxConnectionRateLimiterStatusOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
		...
		func() interface{} {
			j := jsiiProxy_DataAwsDxConnectionRateLimiterStatusOutputReference{}
