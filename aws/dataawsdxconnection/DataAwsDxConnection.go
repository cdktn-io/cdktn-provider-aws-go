...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/dataawsdxconnection/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.66.0/docs/data-sources/dx_connection aws_dx_connection}.
type DataAwsDxConnection interface {
	...
	ProviderName() *string
	RateLimiterStatus() DataAwsDxConnectionRateLimiterStatusList
	// Experimental.
...
func (j *jsiiProxy_DataAwsDxConnection) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsDxConnection) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsDxConnection) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsDxConnection) PrefixPoolSizeIpv4() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"prefixPoolSizeIpv4",
...
func (j *jsiiProxy_DataAwsDxConnection) PrefixPoolSizeIpv6() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"prefixPoolSizeIpv6",
...
func (j *jsiiProxy_DataAwsDxConnection) PrefixPoolUnallocatedCountIpv4() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataAwsDxConnection) PrefixPoolUnallocatedCountIpv6() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataAwsDxConnection) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsDxConnection) RateLimiterStatus() DataAwsDxConnectionRateLimiterStatusList {
	var returns DataAwsDxConnectionRateLimiterStatusList
	_jsii_.Get(
		j,
		"rateLimiterStatus",
		&returns,
...
func (j *jsiiProxy_DataAwsDxConnection) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DataAwsDxConnection) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_DataAwsDxConnection) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.66.0/docs/data-sources/dx_connection aws_dx_connection} Data Source.
...
func (j *jsiiProxy_DataAwsDxConnection)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsDxConnection)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsDxConnection)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_DataAwsDxConnection)SetRegion(val *string) {
...
func DataAwsDxConnection_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsDxConnection) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsDxConnection) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsDxConnection) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsDxConnection) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsDxConnection) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
