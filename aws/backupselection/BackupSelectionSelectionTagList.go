...
func (j *jsiiProxy_BackupSelectionSelectionTagList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewBackupSelectionSelectionTagList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) BackupSelectionSelectionTagList {
	_init_.Initialize()
...
func NewBackupSelectionSelectionTagList_Override(b BackupSelectionSelectionTagList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_BackupSelectionSelectionTagList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (b *jsiiProxy_BackupSelectionSelectionTagList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (b *jsiiProxy_BackupSelectionSelectionTagList) Resolve(context cdktn.IResolveContext) interface{} {
