...
func (j *jsiiProxy_BackupSelection) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_BackupSelection) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_BackupSelection) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_BackupSelection) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_BackupSelection) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_BackupSelection) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_BackupSelection) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/backup_selection aws_backup_selection} Resource.
...
func (j *jsiiProxy_BackupSelection)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_BackupSelection)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_BackupSelection)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_BackupSelection)SetRegion(val *string) {
...
func BackupSelection_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (b *jsiiProxy_BackupSelection) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (b *jsiiProxy_BackupSelection) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (b *jsiiProxy_BackupSelection) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (b *jsiiProxy_BackupSelection) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (b *jsiiProxy_BackupSelection) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (b *jsiiProxy_BackupSelection) ResetRegion() {
	_jsii_.InvokeVoid(
		b,
		"resetRegion",
		nil, // no parameters
...
func (b *jsiiProxy_BackupSelection) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
