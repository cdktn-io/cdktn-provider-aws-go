...
func (b *jsiiProxy_BackupSelectionConditionOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (b *jsiiProxy_BackupSelectionConditionOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
