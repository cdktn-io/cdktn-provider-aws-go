...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/dataawselbhostedzoneid/internal"
...
func (j *jsiiProxy_DataAwsElbHostedZoneId) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsElbHostedZoneId) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsElbHostedZoneId) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsElbHostedZoneId) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsElbHostedZoneId) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/data-sources/elb_hosted_zone_id aws_elb_hosted_zone_id} Data Source.
...
func (j *jsiiProxy_DataAwsElbHostedZoneId)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsElbHostedZoneId)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsElbHostedZoneId)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsElbHostedZoneId_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsElbHostedZoneId) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsElbHostedZoneId) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsElbHostedZoneId) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsElbHostedZoneId) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
