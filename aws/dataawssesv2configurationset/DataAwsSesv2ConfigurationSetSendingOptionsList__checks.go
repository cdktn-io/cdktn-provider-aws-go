...
func (j *jsiiProxy_DataAwsSesv2ConfigurationSetSendingOptionsList) validateSetTerraformAttributeParameters(val *string) error {
	if val == nil {
...
func (j *jsiiProxy_DataAwsSesv2ConfigurationSetSendingOptionsList) validateSetWrapsSetParameters(val *bool) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
