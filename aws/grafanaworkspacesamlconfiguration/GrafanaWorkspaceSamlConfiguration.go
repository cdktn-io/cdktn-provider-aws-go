...
func (g *jsiiProxy_GrafanaWorkspaceSamlConfiguration) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GrafanaWorkspaceSamlConfiguration) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (g *jsiiProxy_GrafanaWorkspaceSamlConfiguration) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
