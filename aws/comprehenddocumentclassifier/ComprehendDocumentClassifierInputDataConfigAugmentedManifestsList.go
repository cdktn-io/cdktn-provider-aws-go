...
func (j *jsiiProxy_ComprehendDocumentClassifierInputDataConfigAugmentedManifestsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewComprehendDocumentClassifierInputDataConfigAugmentedManifestsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ComprehendDocumentClassifierInputDataConfigAugmentedManifestsList {
	_init_.Initialize()
...
func NewComprehendDocumentClassifierInputDataConfigAugmentedManifestsList_Override(c ComprehendDocumentClassifierInputDataConfigAugmentedManifestsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ComprehendDocumentClassifierInputDataConfigAugmentedManifestsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_ComprehendDocumentClassifierInputDataConfigAugmentedManifestsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (c *jsiiProxy_ComprehendDocumentClassifierInputDataConfigAugmentedManifestsList) Resolve(context cdktn.IResolveContext) interface{} {
