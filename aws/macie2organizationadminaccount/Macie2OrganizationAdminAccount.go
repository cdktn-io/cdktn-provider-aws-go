...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/macie2organizationadminaccount/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/macie2_organization_admin_account aws_macie2_organization_admin_account}.
...
func (j *jsiiProxy_Macie2OrganizationAdminAccount) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_Macie2OrganizationAdminAccount) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_Macie2OrganizationAdminAccount) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_Macie2OrganizationAdminAccount) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_Macie2OrganizationAdminAccount) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/macie2_organization_admin_account aws_macie2_organization_admin_account} Resource.
...
func (j *jsiiProxy_Macie2OrganizationAdminAccount)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_Macie2OrganizationAdminAccount)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_Macie2OrganizationAdminAccount)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
// Generates CDKTN code for importing a Macie2OrganizationAdminAccount resource upon running "cdktn plan <stack-name>".
func Macie2OrganizationAdminAccount_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (m *jsiiProxy_Macie2OrganizationAdminAccount) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_Macie2OrganizationAdminAccount) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (m *jsiiProxy_Macie2OrganizationAdminAccount) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_Macie2OrganizationAdminAccount) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (m *jsiiProxy_Macie2OrganizationAdminAccount) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
