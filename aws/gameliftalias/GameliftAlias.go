...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/gameliftalias/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/gamelift_alias aws_gamelift_alias}.
...
func (j *jsiiProxy_GameliftAlias) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_GameliftAlias) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_GameliftAlias) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_GameliftAlias) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_GameliftAlias) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/gamelift_alias aws_gamelift_alias} Resource.
...
func (j *jsiiProxy_GameliftAlias)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_GameliftAlias)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_GameliftAlias)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func GameliftAlias_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (g *jsiiProxy_GameliftAlias) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GameliftAlias) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (g *jsiiProxy_GameliftAlias) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GameliftAlias) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GameliftAlias) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (g *jsiiProxy_GameliftAlias) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
