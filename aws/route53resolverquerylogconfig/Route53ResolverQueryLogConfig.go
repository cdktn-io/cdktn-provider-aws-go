...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/route53resolverquerylogconfig/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/route53_resolver_query_log_config aws_route53_resolver_query_log_config}.
...
func (j *jsiiProxy_Route53ResolverQueryLogConfig) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_Route53ResolverQueryLogConfig) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_Route53ResolverQueryLogConfig) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_Route53ResolverQueryLogConfig) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_Route53ResolverQueryLogConfig) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/route53_resolver_query_log_config aws_route53_resolver_query_log_config} Resource.
func NewRoute53ResolverQueryLogConfig(scope constructs.Construct, id *string, config *Route53ResolverQueryLogConfigConfig) Route53ResolverQueryLogConfig {
	...
	_jsii_.Create(
		"@cdktn/provider-aws.route53ResolverQueryLogConfig.Route53ResolverQueryLogConfig",
...
func (j *jsiiProxy_Route53ResolverQueryLogConfig)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_Route53ResolverQueryLogConfig)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_Route53ResolverQueryLogConfig)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func Route53ResolverQueryLogConfig_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateRoute53ResolverQueryLogConfig_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (r *jsiiProxy_Route53ResolverQueryLogConfig) AddMoveTarget(moveTarget *string) {
...
func (r *jsiiProxy_Route53ResolverQueryLogConfig) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (r *jsiiProxy_Route53ResolverQueryLogConfig) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (r *jsiiProxy_Route53ResolverQueryLogConfig) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (r *jsiiProxy_Route53ResolverQueryLogConfig) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (r *jsiiProxy_Route53ResolverQueryLogConfig) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
