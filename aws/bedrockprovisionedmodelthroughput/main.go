...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "commitmentDuration", GoGetter: "CommitmentDuration"},
			_jsii_.MemberProperty{JsiiProperty: "commitmentDurationInput", GoGetter: "CommitmentDurationInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "modelUnits", GoGetter: "ModelUnits"},
			_jsii_.MemberProperty{JsiiProperty: "modelUnitsInput", GoGetter: "ModelUnitsInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "provisionedModelArn", GoGetter: "ProvisionedModelArn"},
			_jsii_.MemberProperty{JsiiProperty: "provisionedModelName", GoGetter: "ProvisionedModelName"},
			_jsii_.MemberProperty{JsiiProperty: "provisionedModelNameInput", GoGetter: "ProvisionedModelNameInput"},
			_jsii_.MemberProperty{JsiiProperty: "provisioners", GoGetter: "Provisioners"},
			_jsii_.MemberMethod{JsiiMethod: "putTimeouts", GoMethod: "PutTimeouts"},
			_jsii_.MemberProperty{JsiiProperty: "rawOverrides", GoGetter: "RawOverrides"},
			_jsii_.MemberProperty{JsiiProperty: "region", GoGetter: "Region"},
			_jsii_.MemberProperty{JsiiProperty: "regionInput", GoGetter: "RegionInput"},
			_jsii_.MemberMethod{JsiiMethod: "resetCommitmentDuration", GoMethod: "ResetCommitmentDuration"},
