...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/dataawsdxlocation/internal"
...
func (j *jsiiProxy_DataAwsDxLocation) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsDxLocation) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsDxLocation) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsDxLocation) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsDxLocation) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DataAwsDxLocation) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_DataAwsDxLocation) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func NewDataAwsDxLocation(scope constructs.Construct, id *string, config *DataAwsDxLocationConfig) DataAwsDxLocation {
	...
	_jsii_.Create(
		"@cdktn/provider-aws.dataAwsDxLocation.DataAwsDxLocation",
...
func (j *jsiiProxy_DataAwsDxLocation)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsDxLocation)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsDxLocation)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_DataAwsDxLocation)SetRegion(val *string) {
...
func DataAwsDxLocation_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsDxLocation) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsDxLocation) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsDxLocation) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsDxLocation) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsDxLocation) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
