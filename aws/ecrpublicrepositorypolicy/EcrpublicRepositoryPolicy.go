...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/ecrpublicrepositorypolicy/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/ecrpublic_repository_policy aws_ecrpublic_repository_policy}.
...
func (j *jsiiProxy_EcrpublicRepositoryPolicy) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_EcrpublicRepositoryPolicy) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_EcrpublicRepositoryPolicy) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_EcrpublicRepositoryPolicy) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_EcrpublicRepositoryPolicy) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/ecrpublic_repository_policy aws_ecrpublic_repository_policy} Resource.
...
func (j *jsiiProxy_EcrpublicRepositoryPolicy)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_EcrpublicRepositoryPolicy)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_EcrpublicRepositoryPolicy)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func EcrpublicRepositoryPolicy_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (e *jsiiProxy_EcrpublicRepositoryPolicy) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (e *jsiiProxy_EcrpublicRepositoryPolicy) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (e *jsiiProxy_EcrpublicRepositoryPolicy) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (e *jsiiProxy_EcrpublicRepositoryPolicy) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (e *jsiiProxy_EcrpublicRepositoryPolicy) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (e *jsiiProxy_EcrpublicRepositoryPolicy) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
