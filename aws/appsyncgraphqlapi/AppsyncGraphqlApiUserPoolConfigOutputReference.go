...
func (a *jsiiProxy_AppsyncGraphqlApiUserPoolConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_AppsyncGraphqlApiUserPoolConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
