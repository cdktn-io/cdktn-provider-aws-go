...
func (a *jsiiProxy_AppsyncGraphqlApiOpenidConnectConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_AppsyncGraphqlApiOpenidConnectConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
