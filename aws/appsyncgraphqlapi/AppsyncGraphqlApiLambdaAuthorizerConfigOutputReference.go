...
func (a *jsiiProxy_AppsyncGraphqlApiLambdaAuthorizerConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_AppsyncGraphqlApiLambdaAuthorizerConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
