...
func (j *jsiiProxy_AppsyncGraphqlApiLambdaAuthorizerConfigOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewAppsyncGraphqlApiLambdaAuthorizerConfigOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) AppsyncGraphqlApiLambdaAuthorizerConfigOutputReference {
	_init_.Initialize()
...
func NewAppsyncGraphqlApiLambdaAuthorizerConfigOutputReference_Override(a AppsyncGraphqlApiLambdaAuthorizerConfigOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_AppsyncGraphqlApiLambdaAuthorizerConfigOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (a *jsiiProxy_AppsyncGraphqlApiLambdaAuthorizerConfigOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AppsyncGraphqlApiLambdaAuthorizerConfigOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (a *jsiiProxy_AppsyncGraphqlApiLambdaAuthorizerConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AppsyncGraphqlApiLambdaAuthorizerConfigOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
