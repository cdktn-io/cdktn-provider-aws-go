...
func (a *jsiiProxy_AppsyncGraphqlApiAdditionalAuthenticationProviderOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_AppsyncGraphqlApiAdditionalAuthenticationProviderOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
