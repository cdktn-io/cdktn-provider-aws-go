...
func (j *jsiiProxy_AppsyncGraphqlApiAdditionalAuthenticationProviderList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewAppsyncGraphqlApiAdditionalAuthenticationProviderList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) AppsyncGraphqlApiAdditionalAuthenticationProviderList {
	_init_.Initialize()
...
func NewAppsyncGraphqlApiAdditionalAuthenticationProviderList_Override(a AppsyncGraphqlApiAdditionalAuthenticationProviderList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_AppsyncGraphqlApiAdditionalAuthenticationProviderList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (a *jsiiProxy_AppsyncGraphqlApiAdditionalAuthenticationProviderList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (a *jsiiProxy_AppsyncGraphqlApiAdditionalAuthenticationProviderList) Resolve(context cdktn.IResolveContext) interface{} {
