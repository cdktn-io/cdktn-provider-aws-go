...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/backupvaultlockconfiguration/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/backup_vault_lock_configuration aws_backup_vault_lock_configuration}.
...
func (j *jsiiProxy_BackupVaultLockConfiguration) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_BackupVaultLockConfiguration) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_BackupVaultLockConfiguration) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_BackupVaultLockConfiguration) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_BackupVaultLockConfiguration) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_BackupVaultLockConfiguration) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_BackupVaultLockConfiguration) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/backup_vault_lock_configuration aws_backup_vault_lock_configuration} Resource.
func NewBackupVaultLockConfiguration(scope constructs.Construct, id *string, config *BackupVaultLockConfigurationConfig) BackupVaultLockConfiguration {
	...
	_jsii_.Create(
		"@cdktn/provider-aws.backupVaultLockConfiguration.BackupVaultLockConfiguration",
...
func (j *jsiiProxy_BackupVaultLockConfiguration)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_BackupVaultLockConfiguration)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_BackupVaultLockConfiguration)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_BackupVaultLockConfiguration)SetRegion(val *string) {
...
func BackupVaultLockConfiguration_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (b *jsiiProxy_BackupVaultLockConfiguration) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (b *jsiiProxy_BackupVaultLockConfiguration) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (b *jsiiProxy_BackupVaultLockConfiguration) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (b *jsiiProxy_BackupVaultLockConfiguration) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (b *jsiiProxy_BackupVaultLockConfiguration) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (b *jsiiProxy_BackupVaultLockConfiguration) ResetRegion() {
	_jsii_.InvokeVoid(
		b,
		"resetRegion",
		nil, // no parameters
...
func (b *jsiiProxy_BackupVaultLockConfiguration) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
