...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/docdbclustersnapshot/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/docdb_cluster_snapshot aws_docdb_cluster_snapshot}.
...
func (j *jsiiProxy_DocdbClusterSnapshot) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DocdbClusterSnapshot) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DocdbClusterSnapshot) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_DocdbClusterSnapshot) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DocdbClusterSnapshot) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DocdbClusterSnapshot) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DocdbClusterSnapshot) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_DocdbClusterSnapshot) StorageEncrypted() cdktn.IResolvable {
...
func (j *jsiiProxy_DocdbClusterSnapshot) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/docdb_cluster_snapshot aws_docdb_cluster_snapshot} Resource.
func NewDocdbClusterSnapshot(scope constructs.Construct, id *string, config *DocdbClusterSnapshotConfig) DocdbClusterSnapshot {
	_init_.Initialize()

	if err := validateNewDocdbClusterSnapshotParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_DocdbClusterSnapshot)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DocdbClusterSnapshot)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DocdbClusterSnapshot)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_DocdbClusterSnapshot)SetRegion(val *string) {
...
func DocdbClusterSnapshot_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateDocdbClusterSnapshot_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DocdbClusterSnapshot) AddMoveTarget(moveTarget *string) {
...
func (d *jsiiProxy_DocdbClusterSnapshot) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DocdbClusterSnapshot) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (d *jsiiProxy_DocdbClusterSnapshot) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DocdbClusterSnapshot) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (d *jsiiProxy_DocdbClusterSnapshot) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DocdbClusterSnapshot) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
...
func (d *jsiiProxy_DocdbClusterSnapshot) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
...
func (d *jsiiProxy_DocdbClusterSnapshot) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
