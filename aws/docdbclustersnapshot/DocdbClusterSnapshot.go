...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v22/docdbclustersnapshot/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.31.0/docs/resources/docdb_cluster_snapshot aws_docdb_cluster_snapshot}.
...
func (j *jsiiProxy_DocdbClusterSnapshot) ForEach() cdktf.ITerraformIterator {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.31.0/docs/resources/docdb_cluster_snapshot aws_docdb_cluster_snapshot} Resource.
...
func DocdbClusterSnapshot_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
