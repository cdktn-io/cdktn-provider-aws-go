...
func (d *jsiiProxy_DocdbClusterSnapshotTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DocdbClusterSnapshotTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
