...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*Resiliencehubv2UserJourney)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-aws.resiliencehubv2UserJourney.Resiliencehubv2UserJourneyConfig",
		reflect.TypeOf((*Resiliencehubv2UserJourneyConfig)(nil)).Elem(),
	)
}
