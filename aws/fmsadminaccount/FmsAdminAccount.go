...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/fmsadminaccount/internal"
...
func (j *jsiiProxy_FmsAdminAccount) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_FmsAdminAccount) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_FmsAdminAccount) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_FmsAdminAccount) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_FmsAdminAccount) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/fms_admin_account aws_fms_admin_account} Resource.
...
func (j *jsiiProxy_FmsAdminAccount)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_FmsAdminAccount)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_FmsAdminAccount)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func FmsAdminAccount_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (f *jsiiProxy_FmsAdminAccount) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (f *jsiiProxy_FmsAdminAccount) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (f *jsiiProxy_FmsAdminAccount) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (f *jsiiProxy_FmsAdminAccount) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (f *jsiiProxy_FmsAdminAccount) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (f *jsiiProxy_FmsAdminAccount) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
