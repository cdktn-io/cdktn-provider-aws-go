...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/dataawsecrauthorizationtoken/internal"
...
func (j *jsiiProxy_DataAwsEcrAuthorizationToken) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsEcrAuthorizationToken) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsEcrAuthorizationToken) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsEcrAuthorizationToken) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsEcrAuthorizationToken) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DataAwsEcrAuthorizationToken)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsEcrAuthorizationToken)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsEcrAuthorizationToken)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsEcrAuthorizationToken_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsEcrAuthorizationToken) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsEcrAuthorizationToken) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsEcrAuthorizationToken) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsEcrAuthorizationToken) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
