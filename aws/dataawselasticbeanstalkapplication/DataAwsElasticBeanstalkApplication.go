...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/dataawselasticbeanstalkapplication/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/data-sources/elastic_beanstalk_application aws_elastic_beanstalk_application}.
...
func (j *jsiiProxy_DataAwsElasticBeanstalkApplication) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsElasticBeanstalkApplication) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsElasticBeanstalkApplication) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsElasticBeanstalkApplication) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsElasticBeanstalkApplication) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DataAwsElasticBeanstalkApplication) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_DataAwsElasticBeanstalkApplication) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/data-sources/elastic_beanstalk_application aws_elastic_beanstalk_application} Data Source.
...
func (j *jsiiProxy_DataAwsElasticBeanstalkApplication)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsElasticBeanstalkApplication)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsElasticBeanstalkApplication)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_DataAwsElasticBeanstalkApplication)SetRegion(val *string) {
...
func DataAwsElasticBeanstalkApplication_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsElasticBeanstalkApplication) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsElasticBeanstalkApplication) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsElasticBeanstalkApplication) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsElasticBeanstalkApplication) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsElasticBeanstalkApplication) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
