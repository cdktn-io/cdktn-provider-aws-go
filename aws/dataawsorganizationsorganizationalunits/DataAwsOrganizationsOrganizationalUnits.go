...
func (j *jsiiProxy_DataAwsOrganizationsOrganizationalUnits) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsOrganizationsOrganizationalUnits) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsOrganizationsOrganizationalUnits) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsOrganizationsOrganizationalUnits) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsOrganizationsOrganizationalUnits) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/data-sources/organizations_organizational_units aws_organizations_organizational_units} Data Source.
...
func (j *jsiiProxy_DataAwsOrganizationsOrganizationalUnits)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsOrganizationsOrganizationalUnits)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsOrganizationsOrganizationalUnits)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsOrganizationsOrganizationalUnits_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsOrganizationsOrganizationalUnits) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsOrganizationsOrganizationalUnits) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsOrganizationsOrganizationalUnits) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsOrganizationsOrganizationalUnits) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
