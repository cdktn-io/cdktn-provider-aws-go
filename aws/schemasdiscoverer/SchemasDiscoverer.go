...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/schemasdiscoverer/internal"
...
func (j *jsiiProxy_SchemasDiscoverer) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_SchemasDiscoverer) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_SchemasDiscoverer) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_SchemasDiscoverer) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_SchemasDiscoverer) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/schemas_discoverer aws_schemas_discoverer} Resource.
...
func (j *jsiiProxy_SchemasDiscoverer)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_SchemasDiscoverer)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_SchemasDiscoverer)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func SchemasDiscoverer_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (s *jsiiProxy_SchemasDiscoverer) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SchemasDiscoverer) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_SchemasDiscoverer) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SchemasDiscoverer) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_SchemasDiscoverer) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_SchemasDiscoverer) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
