...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*CloudwatchLogAnomalyDetector)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-aws.cloudwatchLogAnomalyDetector.CloudwatchLogAnomalyDetectorConfig",
		reflect.TypeOf((*CloudwatchLogAnomalyDetectorConfig)(nil)).Elem(),
	)
}
