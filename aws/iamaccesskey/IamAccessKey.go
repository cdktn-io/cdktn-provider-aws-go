...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/iamaccesskey/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/iam_access_key aws_iam_access_key}.
...
func (j *jsiiProxy_IamAccessKey) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_IamAccessKey) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_IamAccessKey) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_IamAccessKey) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_IamAccessKey) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/iam_access_key aws_iam_access_key} Resource.
...
func (j *jsiiProxy_IamAccessKey)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_IamAccessKey)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_IamAccessKey)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func IamAccessKey_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (i *jsiiProxy_IamAccessKey) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (i *jsiiProxy_IamAccessKey) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (i *jsiiProxy_IamAccessKey) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (i *jsiiProxy_IamAccessKey) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (i *jsiiProxy_IamAccessKey) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
