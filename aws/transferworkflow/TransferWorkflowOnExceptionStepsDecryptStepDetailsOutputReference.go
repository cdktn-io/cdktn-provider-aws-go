...
func (t *jsiiProxy_TransferWorkflowOnExceptionStepsDecryptStepDetailsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (t *jsiiProxy_TransferWorkflowOnExceptionStepsDecryptStepDetailsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
