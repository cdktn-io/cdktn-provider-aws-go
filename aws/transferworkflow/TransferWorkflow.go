...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/transfer_workflow aws_transfer_workflow}.
...
func (j *jsiiProxy_TransferWorkflow) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_TransferWorkflow) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_TransferWorkflow) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_TransferWorkflow) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_TransferWorkflow) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_TransferWorkflow) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_TransferWorkflow) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/transfer_workflow aws_transfer_workflow} Resource.
...
func (j *jsiiProxy_TransferWorkflow)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_TransferWorkflow)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_TransferWorkflow)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_TransferWorkflow)SetRegion(val *string) {
...
func TransferWorkflow_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (t *jsiiProxy_TransferWorkflow) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (t *jsiiProxy_TransferWorkflow) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (t *jsiiProxy_TransferWorkflow) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (t *jsiiProxy_TransferWorkflow) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (t *jsiiProxy_TransferWorkflow) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (t *jsiiProxy_TransferWorkflow) ResetRegion() {
	_jsii_.InvokeVoid(
		t,
		"resetRegion",
		nil, // no parameters
...
func (t *jsiiProxy_TransferWorkflow) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
