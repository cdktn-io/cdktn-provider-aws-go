...
func (j *jsiiProxy_TransferWorkflowOnExceptionStepsTagStepDetailsTagsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewTransferWorkflowOnExceptionStepsTagStepDetailsTagsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) TransferWorkflowOnExceptionStepsTagStepDetailsTagsOutputReference {
	_init_.Initialize()
...
func NewTransferWorkflowOnExceptionStepsTagStepDetailsTagsOutputReference_Override(t TransferWorkflowOnExceptionStepsTagStepDetailsTagsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_TransferWorkflowOnExceptionStepsTagStepDetailsTagsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (t *jsiiProxy_TransferWorkflowOnExceptionStepsTagStepDetailsTagsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (t *jsiiProxy_TransferWorkflowOnExceptionStepsTagStepDetailsTagsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (t *jsiiProxy_TransferWorkflowOnExceptionStepsTagStepDetailsTagsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (t *jsiiProxy_TransferWorkflowOnExceptionStepsTagStepDetailsTagsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
