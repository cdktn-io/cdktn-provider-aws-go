...
func (j *jsiiProxy_TransferWorkflowOnExceptionStepsTagStepDetailsTagsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewTransferWorkflowOnExceptionStepsTagStepDetailsTagsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) TransferWorkflowOnExceptionStepsTagStepDetailsTagsList {
	_init_.Initialize()
...
func NewTransferWorkflowOnExceptionStepsTagStepDetailsTagsList_Override(t TransferWorkflowOnExceptionStepsTagStepDetailsTagsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_TransferWorkflowOnExceptionStepsTagStepDetailsTagsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (t *jsiiProxy_TransferWorkflowOnExceptionStepsTagStepDetailsTagsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (t *jsiiProxy_TransferWorkflowOnExceptionStepsTagStepDetailsTagsList) Resolve(context cdktn.IResolveContext) interface{} {
