...
func (j *jsiiProxy_TransferWorkflowOnExceptionStepsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewTransferWorkflowOnExceptionStepsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) TransferWorkflowOnExceptionStepsList {
	_init_.Initialize()
...
func NewTransferWorkflowOnExceptionStepsList_Override(t TransferWorkflowOnExceptionStepsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_TransferWorkflowOnExceptionStepsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (t *jsiiProxy_TransferWorkflowOnExceptionStepsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (t *jsiiProxy_TransferWorkflowOnExceptionStepsList) Resolve(context cdktn.IResolveContext) interface{} {
