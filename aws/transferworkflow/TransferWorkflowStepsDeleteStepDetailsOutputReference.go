...
func (t *jsiiProxy_TransferWorkflowStepsDeleteStepDetailsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (t *jsiiProxy_TransferWorkflowStepsDeleteStepDetailsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
