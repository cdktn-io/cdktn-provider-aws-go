...
func (j *jsiiProxy_TransferWorkflowStepsDeleteStepDetailsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewTransferWorkflowStepsDeleteStepDetailsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) TransferWorkflowStepsDeleteStepDetailsOutputReference {
	_init_.Initialize()
...
func NewTransferWorkflowStepsDeleteStepDetailsOutputReference_Override(t TransferWorkflowStepsDeleteStepDetailsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_TransferWorkflowStepsDeleteStepDetailsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (t *jsiiProxy_TransferWorkflowStepsDeleteStepDetailsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (t *jsiiProxy_TransferWorkflowStepsDeleteStepDetailsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (t *jsiiProxy_TransferWorkflowStepsDeleteStepDetailsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (t *jsiiProxy_TransferWorkflowStepsDeleteStepDetailsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
