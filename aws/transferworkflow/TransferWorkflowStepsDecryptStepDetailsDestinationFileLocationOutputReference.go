...
type TransferWorkflowStepsDecryptStepDetailsDestinationFileLocationOutputReference interface {
	...
	EfsFileLocationInput() *TransferWorkflowStepsDecryptStepDetailsDestinationFileLocationEfsFileLocation
	// Experimental.
	Fqn() *string
	InternalValue() *TransferWorkflowStepsDecryptStepDetailsDestinationFileLocation
	SetInternalValue(val *TransferWorkflowStepsDecryptStepDetailsDestinationFileLocation)
	S3FileLocation() TransferWorkflowStepsDecryptStepDetailsDestinationFileLocationS3FileLocationOutputReference
	S3FileLocationInput() *TransferWorkflowStepsDecryptStepDetailsDestinationFileLocationS3FileLocation
	// Experimental.
...
func (j *jsiiProxy_TransferWorkflowStepsDecryptStepDetailsDestinationFileLocationOutputReference) EfsFileLocationInput() *TransferWorkflowStepsDecryptStepDetailsDestinationFileLocationEfsFileLocation {
	var returns *TransferWorkflowStepsDecryptStepDetailsDestinationFileLocationEfsFileLocation
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_TransferWorkflowStepsDecryptStepDetailsDestinationFileLocationOutputReference) InternalValue() *TransferWorkflowStepsDecryptStepDetailsDestinationFileLocation {
...
func (j *jsiiProxy_TransferWorkflowStepsDecryptStepDetailsDestinationFileLocationOutputReference) S3FileLocationInput() *TransferWorkflowStepsDecryptStepDetailsDestinationFileLocationS3FileLocation {
	var returns *TransferWorkflowStepsDecryptStepDetailsDestinationFileLocationS3FileLocation
	_jsii_.Get(
		j,
		"s3FileLocationInput",
		&returns,
...
func (j *jsiiProxy_TransferWorkflowStepsDecryptStepDetailsDestinationFileLocationOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewTransferWorkflowStepsDecryptStepDetailsDestinationFileLocationOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) TransferWorkflowStepsDecryptStepDetailsDestinationFileLocationOutputReference {
	_init_.Initialize()
...
func NewTransferWorkflowStepsDecryptStepDetailsDestinationFileLocationOutputReference_Override(t TransferWorkflowStepsDecryptStepDetailsDestinationFileLocationOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_TransferWorkflowStepsDecryptStepDetailsDestinationFileLocationOutputReference)SetInternalValue(val *TransferWorkflowStepsDecryptStepDetailsDestinationFileLocation) {
...
func (j *jsiiProxy_TransferWorkflowStepsDecryptStepDetailsDestinationFileLocationOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (t *jsiiProxy_TransferWorkflowStepsDecryptStepDetailsDestinationFileLocationOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (t *jsiiProxy_TransferWorkflowStepsDecryptStepDetailsDestinationFileLocationOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (t *jsiiProxy_TransferWorkflowStepsDecryptStepDetailsDestinationFileLocationOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (t *jsiiProxy_TransferWorkflowStepsDecryptStepDetailsDestinationFileLocationOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
