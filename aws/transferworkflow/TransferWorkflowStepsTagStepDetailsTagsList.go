...
func (j *jsiiProxy_TransferWorkflowStepsTagStepDetailsTagsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewTransferWorkflowStepsTagStepDetailsTagsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) TransferWorkflowStepsTagStepDetailsTagsList {
	_init_.Initialize()
...
func NewTransferWorkflowStepsTagStepDetailsTagsList_Override(t TransferWorkflowStepsTagStepDetailsTagsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_TransferWorkflowStepsTagStepDetailsTagsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (t *jsiiProxy_TransferWorkflowStepsTagStepDetailsTagsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (t *jsiiProxy_TransferWorkflowStepsTagStepDetailsTagsList) Resolve(context cdktn.IResolveContext) interface{} {
