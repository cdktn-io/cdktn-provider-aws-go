...
func (j *jsiiProxy_TransferWorkflowOnExceptionStepsDeleteStepDetailsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewTransferWorkflowOnExceptionStepsDeleteStepDetailsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) TransferWorkflowOnExceptionStepsDeleteStepDetailsOutputReference {
	_init_.Initialize()

	if err := validateNewTransferWorkflowOnExceptionStepsDeleteStepDetailsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewTransferWorkflowOnExceptionStepsDeleteStepDetailsOutputReference_Override(t TransferWorkflowOnExceptionStepsDeleteStepDetailsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_TransferWorkflowOnExceptionStepsDeleteStepDetailsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (t *jsiiProxy_TransferWorkflowOnExceptionStepsDeleteStepDetailsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (t *jsiiProxy_TransferWorkflowOnExceptionStepsDeleteStepDetailsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (t *jsiiProxy_TransferWorkflowOnExceptionStepsDeleteStepDetailsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (t *jsiiProxy_TransferWorkflowOnExceptionStepsDeleteStepDetailsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
