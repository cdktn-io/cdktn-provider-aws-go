...
func (j *jsiiProxy_TransferWorkflowStepsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewTransferWorkflowStepsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) TransferWorkflowStepsList {
	_init_.Initialize()

	if err := validateNewTransferWorkflowStepsListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewTransferWorkflowStepsList_Override(t TransferWorkflowStepsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_TransferWorkflowStepsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (t *jsiiProxy_TransferWorkflowStepsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (t *jsiiProxy_TransferWorkflowStepsList) Resolve(context cdktn.IResolveContext) interface{} {
