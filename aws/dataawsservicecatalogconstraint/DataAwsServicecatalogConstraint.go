...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.36.0/docs/data-sources/servicecatalog_constraint aws_servicecatalog_constraint}.
...
func (j *jsiiProxy_DataAwsServicecatalogConstraint) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsServicecatalogConstraint) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsServicecatalogConstraint) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsServicecatalogConstraint) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsServicecatalogConstraint) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DataAwsServicecatalogConstraint) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_DataAwsServicecatalogConstraint) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DataAwsServicecatalogConstraint) Timeouts() DataAwsServicecatalogConstraintTimeoutsOutputReference {
	var returns DataAwsServicecatalogConstraintTimeoutsOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.36.0/docs/data-sources/servicecatalog_constraint aws_servicecatalog_constraint} Data Source.
func NewDataAwsServicecatalogConstraint(scope constructs.Construct, id *string, config *DataAwsServicecatalogConstraintConfig) DataAwsServicecatalogConstraint {
	...
	if err := validateNewDataAwsServicecatalogConstraintParameters(scope, id, config); err != nil {
		panic(err)
	}
	j := jsiiProxy_DataAwsServicecatalogConstraint{}

	_jsii_.Create(
		"@cdktn/provider-aws.dataAwsServicecatalogConstraint.DataAwsServicecatalogConstraint",
...
func (j *jsiiProxy_DataAwsServicecatalogConstraint)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsServicecatalogConstraint)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsServicecatalogConstraint)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_DataAwsServicecatalogConstraint)SetRegion(val *string) {
...
func DataAwsServicecatalogConstraint_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateDataAwsServicecatalogConstraint_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataAwsServicecatalogConstraint) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsServicecatalogConstraint) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsServicecatalogConstraint) PutTimeouts(value *DataAwsServicecatalogConstraintTimeouts) {
...
func (d *jsiiProxy_DataAwsServicecatalogConstraint) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsServicecatalogConstraint) ResetTimeouts() {
	_jsii_.InvokeVoid(
		d,
		"resetTimeouts",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsServicecatalogConstraint) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
