...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/dataawsefsaccesspoints/internal"
...
func (j *jsiiProxy_DataAwsEfsAccessPoints) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsEfsAccessPoints) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsEfsAccessPoints) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsEfsAccessPoints) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsEfsAccessPoints) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func NewDataAwsEfsAccessPoints(scope constructs.Construct, id *string, config *DataAwsEfsAccessPointsConfig) DataAwsEfsAccessPoints {
	...
	_jsii_.Create(
		"@cdktn/provider-aws.dataAwsEfsAccessPoints.DataAwsEfsAccessPoints",
...
func (j *jsiiProxy_DataAwsEfsAccessPoints)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsEfsAccessPoints)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsEfsAccessPoints)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsEfsAccessPoints_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsEfsAccessPoints) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsEfsAccessPoints) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsEfsAccessPoints) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsEfsAccessPoints) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
