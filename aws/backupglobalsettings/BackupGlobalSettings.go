...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v22/backupglobalsettings/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.31.0/docs/resources/backup_global_settings aws_backup_global_settings}.
...
func (j *jsiiProxy_BackupGlobalSettings) ForEach() cdktf.ITerraformIterator {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.31.0/docs/resources/backup_global_settings aws_backup_global_settings} Resource.
...
func BackupGlobalSettings_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
