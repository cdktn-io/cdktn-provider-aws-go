...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/backupglobalsettings/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/backup_global_settings aws_backup_global_settings}.
...
func (j *jsiiProxy_BackupGlobalSettings) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_BackupGlobalSettings) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_BackupGlobalSettings) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_BackupGlobalSettings) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_BackupGlobalSettings) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_BackupGlobalSettings) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/backup_global_settings aws_backup_global_settings} Resource.
func NewBackupGlobalSettings(scope constructs.Construct, id *string, config *BackupGlobalSettingsConfig) BackupGlobalSettings {
	_init_.Initialize()

	if err := validateNewBackupGlobalSettingsParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_BackupGlobalSettings)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_BackupGlobalSettings)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_BackupGlobalSettings)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func BackupGlobalSettings_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateBackupGlobalSettings_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (b *jsiiProxy_BackupGlobalSettings) AddMoveTarget(moveTarget *string) {
...
func (b *jsiiProxy_BackupGlobalSettings) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (b *jsiiProxy_BackupGlobalSettings) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (b *jsiiProxy_BackupGlobalSettings) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (b *jsiiProxy_BackupGlobalSettings) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (b *jsiiProxy_BackupGlobalSettings) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (b *jsiiProxy_BackupGlobalSettings) ResetId() {
	_jsii_.InvokeVoid(
		b,
		"resetId",
		nil, // no parameters
...
func (b *jsiiProxy_BackupGlobalSettings) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
