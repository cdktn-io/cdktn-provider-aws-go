...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/lightsailstaticip/internal"
...
func (j *jsiiProxy_LightsailStaticIp) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_LightsailStaticIp) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_LightsailStaticIp) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_LightsailStaticIp) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_LightsailStaticIp) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/lightsail_static_ip aws_lightsail_static_ip} Resource.
...
func (j *jsiiProxy_LightsailStaticIp)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_LightsailStaticIp)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_LightsailStaticIp)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func LightsailStaticIp_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (l *jsiiProxy_LightsailStaticIp) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LightsailStaticIp) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (l *jsiiProxy_LightsailStaticIp) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LightsailStaticIp) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (l *jsiiProxy_LightsailStaticIp) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (l *jsiiProxy_LightsailStaticIp) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
