...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/amplifywebhook/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/amplify_webhook aws_amplify_webhook}.
...
func (j *jsiiProxy_AmplifyWebhook) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_AmplifyWebhook) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_AmplifyWebhook) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_AmplifyWebhook) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_AmplifyWebhook) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_AmplifyWebhook) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_AmplifyWebhook) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/amplify_webhook aws_amplify_webhook} Resource.
func NewAmplifyWebhook(scope constructs.Construct, id *string, config *AmplifyWebhookConfig) AmplifyWebhook {
	_init_.Initialize()

	if err := validateNewAmplifyWebhookParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_AmplifyWebhook)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_AmplifyWebhook)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_AmplifyWebhook)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_AmplifyWebhook)SetRegion(val *string) {
...
func AmplifyWebhook_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateAmplifyWebhook_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (a *jsiiProxy_AmplifyWebhook) AddMoveTarget(moveTarget *string) {
...
func (a *jsiiProxy_AmplifyWebhook) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AmplifyWebhook) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (a *jsiiProxy_AmplifyWebhook) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AmplifyWebhook) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (a *jsiiProxy_AmplifyWebhook) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (a *jsiiProxy_AmplifyWebhook) ResetRegion() {
	_jsii_.InvokeVoid(
		a,
		"resetRegion",
		nil, // no parameters
...
func (a *jsiiProxy_AmplifyWebhook) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
