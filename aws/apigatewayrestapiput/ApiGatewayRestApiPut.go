...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v22/apigatewayrestapiput/internal"
...
func (j *jsiiProxy_ApiGatewayRestApiPut) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_ApiGatewayRestApiPut) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_ApiGatewayRestApiPut) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_ApiGatewayRestApiPut) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_ApiGatewayRestApiPut) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_ApiGatewayRestApiPut)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_ApiGatewayRestApiPut)SetLifecycle(val *cdktf.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_ApiGatewayRestApiPut)SetProvider(val cdktf.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func ApiGatewayRestApiPut_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (a *jsiiProxy_ApiGatewayRestApiPut) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_ApiGatewayRestApiPut) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (a *jsiiProxy_ApiGatewayRestApiPut) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
