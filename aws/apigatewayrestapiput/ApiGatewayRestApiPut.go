...
func (a *jsiiProxy_ApiGatewayRestApiPut) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (a *jsiiProxy_ApiGatewayRestApiPut) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
