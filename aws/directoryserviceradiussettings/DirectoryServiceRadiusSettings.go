...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/directoryserviceradiussettings/internal"
...
func (d *jsiiProxy_DirectoryServiceRadiusSettings) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (d *jsiiProxy_DirectoryServiceRadiusSettings) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DirectoryServiceRadiusSettings) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
