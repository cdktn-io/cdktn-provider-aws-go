...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/neptuneclusterinstance/internal"
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/neptune_cluster_instance aws_neptune_cluster_instance} Resource.
...
func (n *jsiiProxy_NeptuneClusterInstance) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (n *jsiiProxy_NeptuneClusterInstance) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (n *jsiiProxy_NeptuneClusterInstance) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
