...
func (n *jsiiProxy_NeptuneClusterInstanceTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (n *jsiiProxy_NeptuneClusterInstanceTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
