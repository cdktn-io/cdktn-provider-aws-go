...
func (c *jsiiProxy_ControltowerControl) validateMarkWriteOnlyAttributeParameters(value interface{}) error {
	if value == nil {
		return fmt.Errorf("parameter value is required, but nil was provided")
	}
...
func (c *jsiiProxy_ControltowerControl) validatePutParametersParameters(value interface{}) error {
	...
	case *[]*ControltowerControlParameters:
		value := value.(*[]*ControltowerControlParameters)
	...
	case []*ControltowerControlParameters:
		value_ := value.([]*ControltowerControlParameters)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*ControltowerControlParameters; received %#v (a %T)", value, value)
		}
	}
...
func (c *jsiiProxy_ControltowerControl) validateRegisterProviderFeatureUsageParameters(feature cdktn.ProviderFeature) error {
	if feature == "" {
...
func (j *jsiiProxy_ControltowerControl) validateSetLifecycleParameters(val *cdktn.TerraformResourceLifecycle) error {
	if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
		return err
	}
