...
func (d *jsiiProxy_DataAwsIdentitystoreUsersUsersNameList) validateGetParameters(index *float64) error {
	return nil
}
...
func (j *jsiiProxy_DataAwsIdentitystoreUsersUsersNameList) validateSetTerraformAttributeParameters(val *string) error {
	return nil
}
...
func (j *jsiiProxy_DataAwsIdentitystoreUsersUsersNameList) validateSetWrapsSetParameters(val *bool) error {
	return nil
}
