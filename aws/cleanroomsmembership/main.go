...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "collaborationCreatorDisplayName", GoGetter: "CollaborationCreatorDisplayName"},
			_jsii_.MemberProperty{JsiiProperty: "collaborationId", GoGetter: "CollaborationId"},
			_jsii_.MemberProperty{JsiiProperty: "collaborationIdInput", GoGetter: "CollaborationIdInput"},
			_jsii_.MemberProperty{JsiiProperty: "collaborationName", GoGetter: "CollaborationName"},
