...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/glueworkflow/internal"
...
func (j *jsiiProxy_GlueWorkflow) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_GlueWorkflow) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_GlueWorkflow) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_GlueWorkflow) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_GlueWorkflow) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_GlueWorkflow) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_GlueWorkflow) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/glue_workflow aws_glue_workflow} Resource.
func NewGlueWorkflow(scope constructs.Construct, id *string, config *GlueWorkflowConfig) GlueWorkflow {
	...
	_jsii_.Create(
		"@cdktn/provider-aws.glueWorkflow.GlueWorkflow",
...
func (j *jsiiProxy_GlueWorkflow)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_GlueWorkflow)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_GlueWorkflow)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_GlueWorkflow)SetRegion(val *string) {
...
func GlueWorkflow_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (g *jsiiProxy_GlueWorkflow) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GlueWorkflow) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (g *jsiiProxy_GlueWorkflow) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GlueWorkflow) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GlueWorkflow) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (g *jsiiProxy_GlueWorkflow) ResetRegion() {
	_jsii_.InvokeVoid(
		g,
		"resetRegion",
		nil, // no parameters
...
func (g *jsiiProxy_GlueWorkflow) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
