...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/kmsciphertext/internal"
...
func (j *jsiiProxy_KmsCiphertext) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_KmsCiphertext) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_KmsCiphertext) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_KmsCiphertext) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_KmsCiphertext) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_KmsCiphertext) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_KmsCiphertext) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/kms_ciphertext aws_kms_ciphertext} Resource.
...
func (j *jsiiProxy_KmsCiphertext)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_KmsCiphertext)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_KmsCiphertext)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_KmsCiphertext)SetRegion(val *string) {
...
func KmsCiphertext_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (k *jsiiProxy_KmsCiphertext) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (k *jsiiProxy_KmsCiphertext) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (k *jsiiProxy_KmsCiphertext) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (k *jsiiProxy_KmsCiphertext) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (k *jsiiProxy_KmsCiphertext) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (k *jsiiProxy_KmsCiphertext) ResetRegion() {
	_jsii_.InvokeVoid(
		k,
		"resetRegion",
		nil, // no parameters
...
func (k *jsiiProxy_KmsCiphertext) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
