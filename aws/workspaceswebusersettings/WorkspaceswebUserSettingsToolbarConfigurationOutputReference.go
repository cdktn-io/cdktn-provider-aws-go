...
func (j *jsiiProxy_WorkspaceswebUserSettingsToolbarConfigurationOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewWorkspaceswebUserSettingsToolbarConfigurationOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) WorkspaceswebUserSettingsToolbarConfigurationOutputReference {
	_init_.Initialize()
...
func NewWorkspaceswebUserSettingsToolbarConfigurationOutputReference_Override(w WorkspaceswebUserSettingsToolbarConfigurationOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_WorkspaceswebUserSettingsToolbarConfigurationOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (w *jsiiProxy_WorkspaceswebUserSettingsToolbarConfigurationOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_WorkspaceswebUserSettingsToolbarConfigurationOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (w *jsiiProxy_WorkspaceswebUserSettingsToolbarConfigurationOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_WorkspaceswebUserSettingsToolbarConfigurationOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
