...
func NewWorkspaceswebUserSettingsCookieSynchronizationConfigurationOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) WorkspaceswebUserSettingsCookieSynchronizationConfigurationOutputReference {
	_init_.Initialize()
...
func NewWorkspaceswebUserSettingsCookieSynchronizationConfigurationOutputReference_Override(w WorkspaceswebUserSettingsCookieSynchronizationConfigurationOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
