...
func (w *jsiiProxy_WorkspaceswebUserSettingsCookieSynchronizationConfigurationOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (w *jsiiProxy_WorkspaceswebUserSettingsCookieSynchronizationConfigurationOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
