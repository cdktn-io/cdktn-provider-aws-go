...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v23/dataawsssmpatchbaseline/internal"
...
type DataAwsSsmPatchBaselineApprovalRuleOutputReference interface {
	...
	EnableNonSecurity() cdktn.IResolvable
	// Experimental.
	Fqn() *string
...
func (j *jsiiProxy_DataAwsSsmPatchBaselineApprovalRuleOutputReference) EnableNonSecurity() cdktn.IResolvable {
...
func (j *jsiiProxy_DataAwsSsmPatchBaselineApprovalRuleOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsSsmPatchBaselineApprovalRuleOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) DataAwsSsmPatchBaselineApprovalRuleOutputReference {
	_init_.Initialize()

	if err := validateNewDataAwsSsmPatchBaselineApprovalRuleOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func NewDataAwsSsmPatchBaselineApprovalRuleOutputReference_Override(d DataAwsSsmPatchBaselineApprovalRuleOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsSsmPatchBaselineApprovalRuleOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsSsmPatchBaselineApprovalRuleOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsSsmPatchBaselineApprovalRuleOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (d *jsiiProxy_DataAwsSsmPatchBaselineApprovalRuleOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsSsmPatchBaselineApprovalRuleOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
