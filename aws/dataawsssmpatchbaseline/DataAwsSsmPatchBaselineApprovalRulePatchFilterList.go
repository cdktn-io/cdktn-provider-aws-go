...
func (d *jsiiProxy_DataAwsSsmPatchBaselineApprovalRulePatchFilterList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsSsmPatchBaselineApprovalRulePatchFilterList) Resolve(context cdktf.IResolveContext) interface{} {
