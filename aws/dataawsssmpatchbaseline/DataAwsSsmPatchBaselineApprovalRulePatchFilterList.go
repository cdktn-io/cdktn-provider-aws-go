...
func (j *jsiiProxy_DataAwsSsmPatchBaselineApprovalRulePatchFilterList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsSsmPatchBaselineApprovalRulePatchFilterList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsSsmPatchBaselineApprovalRulePatchFilterList {
	_init_.Initialize()

	if err := validateNewDataAwsSsmPatchBaselineApprovalRulePatchFilterListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewDataAwsSsmPatchBaselineApprovalRulePatchFilterList_Override(d DataAwsSsmPatchBaselineApprovalRulePatchFilterList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsSsmPatchBaselineApprovalRulePatchFilterList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsSsmPatchBaselineApprovalRulePatchFilterList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsSsmPatchBaselineApprovalRulePatchFilterList) Resolve(context cdktn.IResolveContext) interface{} {
