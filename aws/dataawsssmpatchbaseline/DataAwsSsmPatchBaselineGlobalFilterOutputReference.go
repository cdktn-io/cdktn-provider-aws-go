...
func (d *jsiiProxy_DataAwsSsmPatchBaselineGlobalFilterOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataAwsSsmPatchBaselineGlobalFilterOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
