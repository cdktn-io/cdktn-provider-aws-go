...
func (j *jsiiProxy_DataAwsSsmPatchBaselineSourceList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsSsmPatchBaselineSourceList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsSsmPatchBaselineSourceList {
	_init_.Initialize()
...
func NewDataAwsSsmPatchBaselineSourceList_Override(d DataAwsSsmPatchBaselineSourceList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsSsmPatchBaselineSourceList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsSsmPatchBaselineSourceList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsSsmPatchBaselineSourceList) Resolve(context cdktn.IResolveContext) interface{} {
