...
func (j *jsiiProxy_DataAwsSsmPatchBaselineGlobalFilterList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsSsmPatchBaselineGlobalFilterList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsSsmPatchBaselineGlobalFilterList {
	_init_.Initialize()
...
func NewDataAwsSsmPatchBaselineGlobalFilterList_Override(d DataAwsSsmPatchBaselineGlobalFilterList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsSsmPatchBaselineGlobalFilterList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsSsmPatchBaselineGlobalFilterList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsSsmPatchBaselineGlobalFilterList) Resolve(context cdktn.IResolveContext) interface{} {
