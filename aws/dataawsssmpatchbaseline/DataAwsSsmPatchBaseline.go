...
type DataAwsSsmPatchBaseline interface {
	...
	ApprovedPatchesEnableNonSecurity() cdktn.IResolvable
...
func (j *jsiiProxy_DataAwsSsmPatchBaseline) ApprovedPatchesEnableNonSecurity() cdktn.IResolvable {
...
func (j *jsiiProxy_DataAwsSsmPatchBaseline) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsSsmPatchBaseline) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsSsmPatchBaseline) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsSsmPatchBaseline) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsSsmPatchBaseline) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.34.0/docs/data-sources/ssm_patch_baseline aws_ssm_patch_baseline} Data Source.
...
func (j *jsiiProxy_DataAwsSsmPatchBaseline)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsSsmPatchBaseline)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsSsmPatchBaseline)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsSsmPatchBaseline_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsSsmPatchBaseline) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsSsmPatchBaseline) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsSsmPatchBaseline) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
