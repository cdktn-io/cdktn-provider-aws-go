...
func (b *jsiiProxy_BedrockagentAgentCollaborator) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (b *jsiiProxy_BedrockagentAgentCollaborator) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
