...
func (b *jsiiProxy_BedrockagentAgentCollaboratorAgentDescriptorList) validateGetParameters(index *float64) error {
	return nil
}
...
func (j *jsiiProxy_BedrockagentAgentCollaboratorAgentDescriptorList) validateSetTerraformAttributeParameters(val *string) error {
	return nil
}
...
func (j *jsiiProxy_BedrockagentAgentCollaboratorAgentDescriptorList) validateSetWrapsSetParameters(val *bool) error {
	return nil
}
