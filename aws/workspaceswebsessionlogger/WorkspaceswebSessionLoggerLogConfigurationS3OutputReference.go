...
func (w *jsiiProxy_WorkspaceswebSessionLoggerLogConfigurationS3OutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (w *jsiiProxy_WorkspaceswebSessionLoggerLogConfigurationS3OutputReference) Resolve(context cdktf.IResolveContext) interface{} {
