...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/vpcipamorganizationadminaccount/internal"
...
func (v *jsiiProxy_VpcIpamOrganizationAdminAccount) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (v *jsiiProxy_VpcIpamOrganizationAdminAccount) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (v *jsiiProxy_VpcIpamOrganizationAdminAccount) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
