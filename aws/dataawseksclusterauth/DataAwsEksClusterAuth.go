...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/dataawseksclusterauth/internal"
...
func (j *jsiiProxy_DataAwsEksClusterAuth) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsEksClusterAuth) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsEksClusterAuth) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsEksClusterAuth) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsEksClusterAuth) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DataAwsEksClusterAuth)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsEksClusterAuth)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsEksClusterAuth)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsEksClusterAuth_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsEksClusterAuth) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsEksClusterAuth) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsEksClusterAuth) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsEksClusterAuth) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
