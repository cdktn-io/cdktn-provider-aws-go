...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.31.0/docs/resources/s3control_object_lambda_access_point aws_s3control_object_lambda_access_point}.
...
func (j *jsiiProxy_S3ControlObjectLambdaAccessPoint) ForEach() cdktf.ITerraformIterator {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.31.0/docs/resources/s3control_object_lambda_access_point aws_s3control_object_lambda_access_point} Resource.
...
func S3ControlObjectLambdaAccessPoint_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (s *jsiiProxy_S3ControlObjectLambdaAccessPoint) ImportFrom(id *string, provider cdktf.TerraformProvider) {
