...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/s3controlobjectlambdaaccesspoint/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/s3control_object_lambda_access_point aws_s3control_object_lambda_access_point}.
...
func (j *jsiiProxy_S3ControlObjectLambdaAccessPoint) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_S3ControlObjectLambdaAccessPoint) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_S3ControlObjectLambdaAccessPoint) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_S3ControlObjectLambdaAccessPoint) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_S3ControlObjectLambdaAccessPoint) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_S3ControlObjectLambdaAccessPoint) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_S3ControlObjectLambdaAccessPoint) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_S3ControlObjectLambdaAccessPoint) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/s3control_object_lambda_access_point aws_s3control_object_lambda_access_point} Resource.
func NewS3ControlObjectLambdaAccessPoint(scope constructs.Construct, id *string, config *S3ControlObjectLambdaAccessPointConfig) S3ControlObjectLambdaAccessPoint {
	...
	if err := validateNewS3ControlObjectLambdaAccessPointParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_S3ControlObjectLambdaAccessPoint)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_S3ControlObjectLambdaAccessPoint)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_S3ControlObjectLambdaAccessPoint)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_S3ControlObjectLambdaAccessPoint)SetRegion(val *string) {
...
// Generates CDKTN code for importing a S3ControlObjectLambdaAccessPoint resource upon running "cdktn plan <stack-name>".
func S3ControlObjectLambdaAccessPoint_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateS3ControlObjectLambdaAccessPoint_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_S3ControlObjectLambdaAccessPoint) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_S3ControlObjectLambdaAccessPoint) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_S3ControlObjectLambdaAccessPoint) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_S3ControlObjectLambdaAccessPoint) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_S3ControlObjectLambdaAccessPoint) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_S3ControlObjectLambdaAccessPoint) MoveFromId(id *string) {
...
func (s *jsiiProxy_S3ControlObjectLambdaAccessPoint) MoveToId(id *string) {
...
func (s *jsiiProxy_S3ControlObjectLambdaAccessPoint) PutConfiguration(value *S3ControlObjectLambdaAccessPointConfiguration) {
	if err := s.validatePutConfigurationParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		s,
...
func (s *jsiiProxy_S3ControlObjectLambdaAccessPoint) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_S3ControlObjectLambdaAccessPoint) ResetId() {
	_jsii_.InvokeVoid(
		s,
		"resetId",
		nil, // no parameters
...
func (s *jsiiProxy_S3ControlObjectLambdaAccessPoint) ResetRegion() {
	_jsii_.InvokeVoid(
		s,
		"resetRegion",
		nil, // no parameters
...
func (s *jsiiProxy_S3ControlObjectLambdaAccessPoint) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
