...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*LambdaResourcePolicy)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-aws.lambdaResourcePolicy.LambdaResourcePolicyConfig",
		reflect.TypeOf((*LambdaResourcePolicyConfig)(nil)).Elem(),
	)
}
