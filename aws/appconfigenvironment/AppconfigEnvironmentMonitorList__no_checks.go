...
func (a *jsiiProxy_AppconfigEnvironmentMonitorList) validateGetParameters(index *float64) error {
	return nil
}

func (a *jsiiProxy_AppconfigEnvironmentMonitorList) validateResolveParameters(context cdktf.IResolveContext) error {
	return nil
}
...
func (j *jsiiProxy_AppconfigEnvironmentMonitorList) validateSetTerraformAttributeParameters(val *string) error {
	return nil
}
...
func (j *jsiiProxy_AppconfigEnvironmentMonitorList) validateSetWrapsSetParameters(val *bool) error {
	return nil
}
