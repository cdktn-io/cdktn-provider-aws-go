...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/appconfigenvironment/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/appconfig_environment aws_appconfig_environment}.
...
func (j *jsiiProxy_AppconfigEnvironment) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_AppconfigEnvironment) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_AppconfigEnvironment) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_AppconfigEnvironment) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_AppconfigEnvironment) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_AppconfigEnvironment) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_AppconfigEnvironment) TagsAll() cdktn.StringMap {
...
func (j *jsiiProxy_AppconfigEnvironment) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/appconfig_environment aws_appconfig_environment} Resource.
...
func (j *jsiiProxy_AppconfigEnvironment)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_AppconfigEnvironment)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_AppconfigEnvironment)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_AppconfigEnvironment)SetRegion(val *string) {
...
func AppconfigEnvironment_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateAppconfigEnvironment_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (a *jsiiProxy_AppconfigEnvironment) AddMoveTarget(moveTarget *string) {
...
func (a *jsiiProxy_AppconfigEnvironment) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AppconfigEnvironment) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (a *jsiiProxy_AppconfigEnvironment) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AppconfigEnvironment) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (a *jsiiProxy_AppconfigEnvironment) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (a *jsiiProxy_AppconfigEnvironment) ResetRegion() {
	_jsii_.InvokeVoid(
		a,
		"resetRegion",
		nil, // no parameters
...
func (a *jsiiProxy_AppconfigEnvironment) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
