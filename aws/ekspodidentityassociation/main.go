...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "disableSessionTags", GoGetter: "DisableSessionTags"},
			_jsii_.MemberProperty{JsiiProperty: "disableSessionTagsInput", GoGetter: "DisableSessionTagsInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetDisableSessionTags", GoMethod: "ResetDisableSessionTags"},
