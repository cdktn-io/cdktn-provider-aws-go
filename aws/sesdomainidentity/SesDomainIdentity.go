...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v22/sesdomainidentity/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.31.0/docs/resources/ses_domain_identity aws_ses_domain_identity}.
...
func (j *jsiiProxy_SesDomainIdentity) ForEach() cdktf.ITerraformIterator {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.31.0/docs/resources/ses_domain_identity aws_ses_domain_identity} Resource.
...
func SesDomainIdentity_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (s *jsiiProxy_SesDomainIdentity) ImportFrom(id *string, provider cdktf.TerraformProvider) {
