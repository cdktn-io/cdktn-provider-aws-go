...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/sesdomainidentity/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/ses_domain_identity aws_ses_domain_identity}.
...
func (j *jsiiProxy_SesDomainIdentity) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_SesDomainIdentity) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_SesDomainIdentity) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_SesDomainIdentity) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_SesDomainIdentity) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_SesDomainIdentity) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_SesDomainIdentity) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_SesDomainIdentity) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/ses_domain_identity aws_ses_domain_identity} Resource.
func NewSesDomainIdentity(scope constructs.Construct, id *string, config *SesDomainIdentityConfig) SesDomainIdentity {
	_init_.Initialize()

	if err := validateNewSesDomainIdentityParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_SesDomainIdentity)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_SesDomainIdentity)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_SesDomainIdentity)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_SesDomainIdentity)SetRegion(val *string) {
...
func SesDomainIdentity_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateSesDomainIdentity_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_SesDomainIdentity) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_SesDomainIdentity) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SesDomainIdentity) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (s *jsiiProxy_SesDomainIdentity) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (s *jsiiProxy_SesDomainIdentity) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (s *jsiiProxy_SesDomainIdentity) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (s *jsiiProxy_SesDomainIdentity) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_SesDomainIdentity) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SesDomainIdentity) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_SesDomainIdentity) MoveFromId(id *string) {
...
func (s *jsiiProxy_SesDomainIdentity) MoveToId(id *string) {
...
func (s *jsiiProxy_SesDomainIdentity) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_SesDomainIdentity) ResetId() {
	_jsii_.InvokeVoid(
		s,
		"resetId",
		nil, // no parameters
...
func (s *jsiiProxy_SesDomainIdentity) ResetRegion() {
	_jsii_.InvokeVoid(
		s,
		"resetRegion",
		nil, // no parameters
