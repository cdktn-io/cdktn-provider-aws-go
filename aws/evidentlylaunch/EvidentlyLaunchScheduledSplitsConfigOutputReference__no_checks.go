...
func (e *jsiiProxy_EvidentlyLaunchScheduledSplitsConfigOutputReference) validatePutStepsParameters(value interface{}) error {
	return nil
}
...
func (j *jsiiProxy_EvidentlyLaunchScheduledSplitsConfigOutputReference) validateSetInternalValueParameters(val *EvidentlyLaunchScheduledSplitsConfig) error {
	return nil
}
