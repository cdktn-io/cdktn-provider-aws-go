...
type EvidentlyLaunchScheduledSplitsConfigSteps struct {
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.41.0/docs/resources/evidently_launch#group_weights EvidentlyLaunch#group_weights}.
	GroupWeights *map[string]*float64 `field:"required" json:"groupWeights" yaml:"groupWeights"`
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.41.0/docs/resources/evidently_launch#start_time EvidentlyLaunch#start_time}.
