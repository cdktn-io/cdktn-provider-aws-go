...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/data-sources/mq_broker_instance_type_offerings aws_mq_broker_instance_type_offerings} Data Source.
...
func (d *jsiiProxy_DataAwsMqBrokerInstanceTypeOfferings) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsMqBrokerInstanceTypeOfferings) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
