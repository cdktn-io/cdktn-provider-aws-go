...
type DataAwsOdbNetworkPeeringConnectionsConfig struct {
	// Experimental.
	...
	OdbPeeringConnections interface{} `field:"optional" json:"odbPeeringConnections" yaml:"odbPeeringConnections"`
