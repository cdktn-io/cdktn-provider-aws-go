...
func (l *jsiiProxy_LambdaFunctionImageConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LambdaFunctionImageConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
