...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/lambda_function aws_lambda_function}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/lambda_function aws_lambda_function} Resource.
...
func (l *jsiiProxy_LambdaFunction) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (l *jsiiProxy_LambdaFunction) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (l *jsiiProxy_LambdaFunction) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
