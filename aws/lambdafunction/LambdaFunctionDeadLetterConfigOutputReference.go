...
func (l *jsiiProxy_LambdaFunctionDeadLetterConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LambdaFunctionDeadLetterConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
