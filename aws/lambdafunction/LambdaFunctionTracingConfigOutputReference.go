...
func (l *jsiiProxy_LambdaFunctionTracingConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LambdaFunctionTracingConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
