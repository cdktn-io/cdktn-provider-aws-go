...
func (j *jsiiProxy_LambdaFunctionTracingConfigOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewLambdaFunctionTracingConfigOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) LambdaFunctionTracingConfigOutputReference {
	_init_.Initialize()
...
func NewLambdaFunctionTracingConfigOutputReference_Override(l LambdaFunctionTracingConfigOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_LambdaFunctionTracingConfigOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (l *jsiiProxy_LambdaFunctionTracingConfigOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LambdaFunctionTracingConfigOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (l *jsiiProxy_LambdaFunctionTracingConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LambdaFunctionTracingConfigOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
