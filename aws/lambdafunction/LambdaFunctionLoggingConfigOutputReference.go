...
func (j *jsiiProxy_LambdaFunctionLoggingConfigOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewLambdaFunctionLoggingConfigOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) LambdaFunctionLoggingConfigOutputReference {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-aws.lambdaFunction.LambdaFunctionLoggingConfigOutputReference",
...
func NewLambdaFunctionLoggingConfigOutputReference_Override(l LambdaFunctionLoggingConfigOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_LambdaFunctionLoggingConfigOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (l *jsiiProxy_LambdaFunctionLoggingConfigOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LambdaFunctionLoggingConfigOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (l *jsiiProxy_LambdaFunctionLoggingConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LambdaFunctionLoggingConfigOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
