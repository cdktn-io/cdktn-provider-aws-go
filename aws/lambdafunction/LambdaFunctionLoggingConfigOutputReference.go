...
func (l *jsiiProxy_LambdaFunctionLoggingConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LambdaFunctionLoggingConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
