...
func (l *jsiiProxy_LambdaFunctionEnvironmentOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LambdaFunctionEnvironmentOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
