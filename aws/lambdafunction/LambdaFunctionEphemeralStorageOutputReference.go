...
func (l *jsiiProxy_LambdaFunctionEphemeralStorageOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LambdaFunctionEphemeralStorageOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
