...
func (j *jsiiProxy_LambdaFunctionEphemeralStorageOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewLambdaFunctionEphemeralStorageOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) LambdaFunctionEphemeralStorageOutputReference {
	_init_.Initialize()
...
func NewLambdaFunctionEphemeralStorageOutputReference_Override(l LambdaFunctionEphemeralStorageOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_LambdaFunctionEphemeralStorageOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (l *jsiiProxy_LambdaFunctionEphemeralStorageOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LambdaFunctionEphemeralStorageOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (l *jsiiProxy_LambdaFunctionEphemeralStorageOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LambdaFunctionEphemeralStorageOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
