...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v22/glueregistry/internal"
...
func (j *jsiiProxy_GlueRegistry) ForEach() cdktf.ITerraformIterator {
...
func GlueRegistry_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (g *jsiiProxy_GlueRegistry) ImportFrom(id *string, provider cdktf.TerraformProvider) {
