...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/glueregistry/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/glue_registry aws_glue_registry}.
...
func (j *jsiiProxy_GlueRegistry) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_GlueRegistry) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_GlueRegistry) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_GlueRegistry) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_GlueRegistry) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_GlueRegistry) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/glue_registry aws_glue_registry} Resource.
func NewGlueRegistry(scope constructs.Construct, id *string, config *GlueRegistryConfig) GlueRegistry {
	_init_.Initialize()

	if err := validateNewGlueRegistryParameters(scope, id, config); err != nil {
		panic(err)
	}
	j := jsiiProxy_GlueRegistry{}

	_jsii_.Create(
		"@cdktn/provider-aws.glueRegistry.GlueRegistry",
...
func (j *jsiiProxy_GlueRegistry)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_GlueRegistry)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_GlueRegistry)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func GlueRegistry_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateGlueRegistry_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (g *jsiiProxy_GlueRegistry) AddMoveTarget(moveTarget *string) {
...
func (g *jsiiProxy_GlueRegistry) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GlueRegistry) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (g *jsiiProxy_GlueRegistry) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GlueRegistry) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GlueRegistry) MoveFromId(id *string) {
...
func (g *jsiiProxy_GlueRegistry) MoveToId(id *string) {
...
func (g *jsiiProxy_GlueRegistry) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (g *jsiiProxy_GlueRegistry) ResetId() {
	_jsii_.InvokeVoid(
		g,
		"resetId",
		nil, // no parameters
