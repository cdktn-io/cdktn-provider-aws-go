...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/route53recoveryreadinesscell/internal"
...
func (j *jsiiProxy_Route53RecoveryreadinessCell) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_Route53RecoveryreadinessCell) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_Route53RecoveryreadinessCell) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_Route53RecoveryreadinessCell) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_Route53RecoveryreadinessCell) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_Route53RecoveryreadinessCell)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_Route53RecoveryreadinessCell)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_Route53RecoveryreadinessCell)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func Route53RecoveryreadinessCell_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (r *jsiiProxy_Route53RecoveryreadinessCell) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (r *jsiiProxy_Route53RecoveryreadinessCell) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (r *jsiiProxy_Route53RecoveryreadinessCell) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (r *jsiiProxy_Route53RecoveryreadinessCell) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (r *jsiiProxy_Route53RecoveryreadinessCell) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (r *jsiiProxy_Route53RecoveryreadinessCell) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
