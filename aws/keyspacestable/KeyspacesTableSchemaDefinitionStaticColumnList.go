...
func (j *jsiiProxy_KeyspacesTableSchemaDefinitionStaticColumnList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewKeyspacesTableSchemaDefinitionStaticColumnList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) KeyspacesTableSchemaDefinitionStaticColumnList {
	_init_.Initialize()
...
func NewKeyspacesTableSchemaDefinitionStaticColumnList_Override(k KeyspacesTableSchemaDefinitionStaticColumnList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_KeyspacesTableSchemaDefinitionStaticColumnList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (k *jsiiProxy_KeyspacesTableSchemaDefinitionStaticColumnList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (k *jsiiProxy_KeyspacesTableSchemaDefinitionStaticColumnList) Resolve(context cdktn.IResolveContext) interface{} {
