...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v23/dataawsconnectquickconnect/internal"
...
func (j *jsiiProxy_DataAwsConnectQuickConnect) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsConnectQuickConnect) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsConnectQuickConnect) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsConnectQuickConnect) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsConnectQuickConnect) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DataAwsConnectQuickConnect) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_DataAwsConnectQuickConnect) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DataAwsConnectQuickConnect)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsConnectQuickConnect)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsConnectQuickConnect)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_DataAwsConnectQuickConnect)SetRegion(val *string) {
...
func DataAwsConnectQuickConnect_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsConnectQuickConnect) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsConnectQuickConnect) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsConnectQuickConnect) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsConnectQuickConnect) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
