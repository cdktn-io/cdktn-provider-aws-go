...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/data-sources/lb_target_group aws_lb_target_group}.
type DataAwsLbTargetGroup interface {
	...
	ConnectionTermination() cdktn.IResolvable
	// Experimental.
	...
	HealthCheck() DataAwsLbTargetGroupHealthCheckList
	Id() *string
	SetId(val *string)
	IdInput() *string
	LambdaMultiValueHeadersEnabled() cdktn.IResolvable
	// Experimental.
	...
	ProxyProtocolV2() cdktn.IResolvable
	// Experimental.
...
func (j *jsiiProxy_DataAwsLbTargetGroup) ArnInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"arnInput",
...
func (j *jsiiProxy_DataAwsLbTargetGroup) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsLbTargetGroup) ConnectionTermination() cdktn.IResolvable {
...
func (j *jsiiProxy_DataAwsLbTargetGroup) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsLbTargetGroup) HealthCheck() DataAwsLbTargetGroupHealthCheckList {
	var returns DataAwsLbTargetGroupHealthCheckList
	_jsii_.Get(
		j,
		"healthCheck",
		&returns,
...
func (j *jsiiProxy_DataAwsLbTargetGroup) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_DataAwsLbTargetGroup) LambdaMultiValueHeadersEnabled() cdktn.IResolvable {
	var returns cdktn.IResolvable
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataAwsLbTargetGroup) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsLbTargetGroup) LoadBalancerArns() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"loadBalancerArns",
...
func (j *jsiiProxy_DataAwsLbTargetGroup) LoadBalancingCrossZoneEnabled() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataAwsLbTargetGroup) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsLbTargetGroup) ProxyProtocolV2() cdktn.IResolvable {
	var returns cdktn.IResolvable
	_jsii_.Get(
		j,
		"proxyProtocolV2",
...
func (j *jsiiProxy_DataAwsLbTargetGroup) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DataAwsLbTargetGroup) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_DataAwsLbTargetGroup) Stickiness() DataAwsLbTargetGroupStickinessList {
	var returns DataAwsLbTargetGroupStickinessList
	_jsii_.Get(
		j,
		"stickiness",
		&returns,
...
func (j *jsiiProxy_DataAwsLbTargetGroup) Tags() *map[string]*string {
...
func (j *jsiiProxy_DataAwsLbTargetGroup) TagsInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsInput",
...
func (j *jsiiProxy_DataAwsLbTargetGroup) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DataAwsLbTargetGroup) Timeouts() DataAwsLbTargetGroupTimeoutsOutputReference {
	var returns DataAwsLbTargetGroupTimeoutsOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/data-sources/lb_target_group aws_lb_target_group} Data Source.
func NewDataAwsLbTargetGroup(scope constructs.Construct, id *string, config *DataAwsLbTargetGroupConfig) DataAwsLbTargetGroup {
	_init_.Initialize()

	if err := validateNewDataAwsLbTargetGroupParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_DataAwsLbTargetGroup)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsLbTargetGroup)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsLbTargetGroup)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_DataAwsLbTargetGroup)SetRegion(val *string) {
...
func DataAwsLbTargetGroup_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateDataAwsLbTargetGroup_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataAwsLbTargetGroup) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsLbTargetGroup) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (d *jsiiProxy_DataAwsLbTargetGroup) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (d *jsiiProxy_DataAwsLbTargetGroup) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (d *jsiiProxy_DataAwsLbTargetGroup) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (d *jsiiProxy_DataAwsLbTargetGroup) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsLbTargetGroup) PutTimeouts(value *DataAwsLbTargetGroupTimeouts) {
...
func (d *jsiiProxy_DataAwsLbTargetGroup) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsLbTargetGroup) ResetArn() {
	_jsii_.InvokeVoid(
		d,
		"resetArn",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsLbTargetGroup) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsLbTargetGroup) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsLbTargetGroup) ResetTimeouts() {
	_jsii_.InvokeVoid(
		d,
		"resetTimeouts",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsLbTargetGroup) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
