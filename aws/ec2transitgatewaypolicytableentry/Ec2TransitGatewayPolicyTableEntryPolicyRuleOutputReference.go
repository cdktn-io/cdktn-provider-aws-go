...
type Ec2TransitGatewayPolicyTableEntryPolicyRuleOutputReference interface {
	...
	Metadata() Ec2TransitGatewayPolicyTableEntryPolicyRuleMetadataList
...
func (j *jsiiProxy_Ec2TransitGatewayPolicyTableEntryPolicyRuleOutputReference) Metadata() Ec2TransitGatewayPolicyTableEntryPolicyRuleMetadataList {
	var returns Ec2TransitGatewayPolicyTableEntryPolicyRuleMetadataList
	_jsii_.Get(
		j,
		"metadata",
		&returns,
...
func (j *jsiiProxy_Ec2TransitGatewayPolicyTableEntryPolicyRuleOutputReference) MetadataInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"metadataInput",
...
func NewEc2TransitGatewayPolicyTableEntryPolicyRuleOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) Ec2TransitGatewayPolicyTableEntryPolicyRuleOutputReference {
	_init_.Initialize()

	if err := validateNewEc2TransitGatewayPolicyTableEntryPolicyRuleOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func NewEc2TransitGatewayPolicyTableEntryPolicyRuleOutputReference_Override(e Ec2TransitGatewayPolicyTableEntryPolicyRuleOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (e *jsiiProxy_Ec2TransitGatewayPolicyTableEntryPolicyRuleOutputReference) PutMetadata(value interface{}) {
...
func (e *jsiiProxy_Ec2TransitGatewayPolicyTableEntryPolicyRuleOutputReference) ResetMetadata() {
	_jsii_.InvokeVoid(
		e,
		"resetMetadata",
		nil, // no parameters
