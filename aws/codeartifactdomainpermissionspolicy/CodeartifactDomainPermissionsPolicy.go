...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/codeartifactdomainpermissionspolicy/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/codeartifact_domain_permissions_policy aws_codeartifact_domain_permissions_policy}.
...
func (j *jsiiProxy_CodeartifactDomainPermissionsPolicy) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_CodeartifactDomainPermissionsPolicy) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_CodeartifactDomainPermissionsPolicy) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_CodeartifactDomainPermissionsPolicy) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_CodeartifactDomainPermissionsPolicy) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/codeartifact_domain_permissions_policy aws_codeartifact_domain_permissions_policy} Resource.
func NewCodeartifactDomainPermissionsPolicy(scope constructs.Construct, id *string, config *CodeartifactDomainPermissionsPolicyConfig) CodeartifactDomainPermissionsPolicy {
	...
	if err := validateNewCodeartifactDomainPermissionsPolicyParameters(scope, id, config); err != nil {
		panic(err)
	}
	j := jsiiProxy_CodeartifactDomainPermissionsPolicy{}

	_jsii_.Create(
		"@cdktn/provider-aws.codeartifactDomainPermissionsPolicy.CodeartifactDomainPermissionsPolicy",
...
func (j *jsiiProxy_CodeartifactDomainPermissionsPolicy)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_CodeartifactDomainPermissionsPolicy)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_CodeartifactDomainPermissionsPolicy)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
// Generates CDKTN code for importing a CodeartifactDomainPermissionsPolicy resource upon running "cdktn plan <stack-name>".
func CodeartifactDomainPermissionsPolicy_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateCodeartifactDomainPermissionsPolicy_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func CodeartifactDomainPermissionsPolicy_IsConstruct(x interface{}) *bool {
	...
	if err := validateCodeartifactDomainPermissionsPolicy_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func CodeartifactDomainPermissionsPolicy_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCodeartifactDomainPermissionsPolicy_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func CodeartifactDomainPermissionsPolicy_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCodeartifactDomainPermissionsPolicy_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CodeartifactDomainPermissionsPolicy) AddMoveTarget(moveTarget *string) {
...
func (c *jsiiProxy_CodeartifactDomainPermissionsPolicy) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CodeartifactDomainPermissionsPolicy) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (c *jsiiProxy_CodeartifactDomainPermissionsPolicy) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CodeartifactDomainPermissionsPolicy) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_CodeartifactDomainPermissionsPolicy) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (c *jsiiProxy_CodeartifactDomainPermissionsPolicy) ResetPolicyDocument() {
	_jsii_.InvokeVoid(
		c,
		"resetPolicyDocument",
		nil, // no parameters
...
func (c *jsiiProxy_CodeartifactDomainPermissionsPolicy) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (c *jsiiProxy_CodeartifactDomainPermissionsPolicy) ToHclTerraform() interface{} {
	var returns interface{}
...
func (c *jsiiProxy_CodeartifactDomainPermissionsPolicy) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
