...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/dxhostedprivatevirtualinterface/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.66.0/docs/resources/dx_hosted_private_virtual_interface aws_dx_hosted_private_virtual_interface}.
...
func (j *jsiiProxy_DxHostedPrivateVirtualInterface) BgpAsnLong() *string {
	var returns *string
	_jsii_.Get(
		j,
		"bgpAsnLong",
...
func (j *jsiiProxy_DxHostedPrivateVirtualInterface) BgpAsnLongInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"bgpAsnLongInput",
...
func (j *jsiiProxy_DxHostedPrivateVirtualInterface) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DxHostedPrivateVirtualInterface) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DxHostedPrivateVirtualInterface) JumboFrameCapable() cdktn.IResolvable {
...
func (j *jsiiProxy_DxHostedPrivateVirtualInterface) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DxHostedPrivateVirtualInterface) PrefixPoolAllocatedCountIpv4() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DxHostedPrivateVirtualInterface) PrefixPoolAllocatedCountIpv6() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DxHostedPrivateVirtualInterface) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DxHostedPrivateVirtualInterface) RateLimit() *string {
	var returns *string
	_jsii_.Get(
		j,
		"rateLimit",
...
func (j *jsiiProxy_DxHostedPrivateVirtualInterface) RateLimitInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"rateLimitInput",
...
func (j *jsiiProxy_DxHostedPrivateVirtualInterface) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DxHostedPrivateVirtualInterface) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_DxHostedPrivateVirtualInterface) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.66.0/docs/resources/dx_hosted_private_virtual_interface aws_dx_hosted_private_virtual_interface} Resource.
...
func (j *jsiiProxy_DxHostedPrivateVirtualInterface)SetBgpAsnLong(val *string) {
...
func (j *jsiiProxy_DxHostedPrivateVirtualInterface)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DxHostedPrivateVirtualInterface)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DxHostedPrivateVirtualInterface)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_DxHostedPrivateVirtualInterface)SetRateLimit(val *string) {
...
func (j *jsiiProxy_DxHostedPrivateVirtualInterface)SetRegion(val *string) {
...
func DxHostedPrivateVirtualInterface_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DxHostedPrivateVirtualInterface) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DxHostedPrivateVirtualInterface) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (d *jsiiProxy_DxHostedPrivateVirtualInterface) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DxHostedPrivateVirtualInterface) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (d *jsiiProxy_DxHostedPrivateVirtualInterface) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DxHostedPrivateVirtualInterface) ResetBgpAsn() {
	_jsii_.InvokeVoid(
		d,
		"resetBgpAsn",
		nil, // no parameters
...
func (d *jsiiProxy_DxHostedPrivateVirtualInterface) ResetBgpAsnLong() {
	_jsii_.InvokeVoid(
		d,
		"resetBgpAsnLong",
		nil, // no parameters
...
func (d *jsiiProxy_DxHostedPrivateVirtualInterface) ResetRateLimit() {
	_jsii_.InvokeVoid(
		d,
		"resetRateLimit",
		nil, // no parameters
...
func (d *jsiiProxy_DxHostedPrivateVirtualInterface) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
...
func (d *jsiiProxy_DxHostedPrivateVirtualInterface) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
