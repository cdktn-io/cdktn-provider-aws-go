...
func (j *jsiiProxy_DxHostedPrivateVirtualInterfaceTimeoutsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDxHostedPrivateVirtualInterfaceTimeoutsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) DxHostedPrivateVirtualInterfaceTimeoutsOutputReference {
	_init_.Initialize()

	if err := validateNewDxHostedPrivateVirtualInterfaceTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewDxHostedPrivateVirtualInterfaceTimeoutsOutputReference_Override(d DxHostedPrivateVirtualInterfaceTimeoutsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_DxHostedPrivateVirtualInterfaceTimeoutsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DxHostedPrivateVirtualInterfaceTimeoutsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DxHostedPrivateVirtualInterfaceTimeoutsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (d *jsiiProxy_DxHostedPrivateVirtualInterfaceTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DxHostedPrivateVirtualInterfaceTimeoutsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
