...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/wafwebacl/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/waf_web_acl aws_waf_web_acl}.
...
func (j *jsiiProxy_WafWebAcl) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_WafWebAcl) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_WafWebAcl) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_WafWebAcl) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_WafWebAcl) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_WafWebAcl) Rules() WafWebAclRulesList {
	var returns WafWebAclRulesList
	_jsii_.Get(
		j,
		"rules",
		&returns,
...
func (j *jsiiProxy_WafWebAcl) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/waf_web_acl aws_waf_web_acl} Resource.
func NewWafWebAcl(scope constructs.Construct, id *string, config *WafWebAclConfig) WafWebAcl {
	_init_.Initialize()

	if err := validateNewWafWebAclParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_WafWebAcl)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_WafWebAcl)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_WafWebAcl)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func WafWebAcl_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateWafWebAcl_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (w *jsiiProxy_WafWebAcl) AddMoveTarget(moveTarget *string) {
...
func (w *jsiiProxy_WafWebAcl) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_WafWebAcl) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (w *jsiiProxy_WafWebAcl) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_WafWebAcl) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (w *jsiiProxy_WafWebAcl) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (w *jsiiProxy_WafWebAcl) ResetId() {
	_jsii_.InvokeVoid(
		w,
		"resetId",
		nil, // no parameters
...
func (w *jsiiProxy_WafWebAcl) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
