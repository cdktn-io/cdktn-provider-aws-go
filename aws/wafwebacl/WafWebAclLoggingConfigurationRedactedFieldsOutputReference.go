...
func (w *jsiiProxy_WafWebAclLoggingConfigurationRedactedFieldsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (w *jsiiProxy_WafWebAclLoggingConfigurationRedactedFieldsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
