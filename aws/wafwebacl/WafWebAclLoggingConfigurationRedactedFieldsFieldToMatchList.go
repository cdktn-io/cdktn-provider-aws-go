...
func (j *jsiiProxy_WafWebAclLoggingConfigurationRedactedFieldsFieldToMatchList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewWafWebAclLoggingConfigurationRedactedFieldsFieldToMatchList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) WafWebAclLoggingConfigurationRedactedFieldsFieldToMatchList {
	_init_.Initialize()
...
func NewWafWebAclLoggingConfigurationRedactedFieldsFieldToMatchList_Override(w WafWebAclLoggingConfigurationRedactedFieldsFieldToMatchList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_WafWebAclLoggingConfigurationRedactedFieldsFieldToMatchList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (w *jsiiProxy_WafWebAclLoggingConfigurationRedactedFieldsFieldToMatchList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (w *jsiiProxy_WafWebAclLoggingConfigurationRedactedFieldsFieldToMatchList) Resolve(context cdktn.IResolveContext) interface{} {
