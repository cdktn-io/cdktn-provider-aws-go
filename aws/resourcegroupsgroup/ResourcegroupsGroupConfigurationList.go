...
func (j *jsiiProxy_ResourcegroupsGroupConfigurationList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewResourcegroupsGroupConfigurationList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ResourcegroupsGroupConfigurationList {
	_init_.Initialize()
...
func NewResourcegroupsGroupConfigurationList_Override(r ResourcegroupsGroupConfigurationList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ResourcegroupsGroupConfigurationList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (r *jsiiProxy_ResourcegroupsGroupConfigurationList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (r *jsiiProxy_ResourcegroupsGroupConfigurationList) Resolve(context cdktf.IResolveContext) interface{} {
