...
func (j *jsiiProxy_ResourcegroupsGroup) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_ResourcegroupsGroup) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_ResourcegroupsGroup) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_ResourcegroupsGroup) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_ResourcegroupsGroup) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/resourcegroups_group aws_resourcegroups_group} Resource.
...
func (j *jsiiProxy_ResourcegroupsGroup)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_ResourcegroupsGroup)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_ResourcegroupsGroup)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func ResourcegroupsGroup_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (r *jsiiProxy_ResourcegroupsGroup) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (r *jsiiProxy_ResourcegroupsGroup) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (r *jsiiProxy_ResourcegroupsGroup) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (r *jsiiProxy_ResourcegroupsGroup) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (r *jsiiProxy_ResourcegroupsGroup) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (r *jsiiProxy_ResourcegroupsGroup) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
