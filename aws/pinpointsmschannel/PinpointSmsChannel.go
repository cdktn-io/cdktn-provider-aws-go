...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/pinpointsmschannel/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/pinpoint_sms_channel aws_pinpoint_sms_channel}.
...
func (j *jsiiProxy_PinpointSmsChannel) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_PinpointSmsChannel) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_PinpointSmsChannel) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_PinpointSmsChannel) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_PinpointSmsChannel) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_PinpointSmsChannel) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_PinpointSmsChannel) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/pinpoint_sms_channel aws_pinpoint_sms_channel} Resource.
...
func (j *jsiiProxy_PinpointSmsChannel)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_PinpointSmsChannel)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_PinpointSmsChannel)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_PinpointSmsChannel)SetRegion(val *string) {
...
func PinpointSmsChannel_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validatePinpointSmsChannel_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (p *jsiiProxy_PinpointSmsChannel) AddMoveTarget(moveTarget *string) {
...
func (p *jsiiProxy_PinpointSmsChannel) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PinpointSmsChannel) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (p *jsiiProxy_PinpointSmsChannel) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PinpointSmsChannel) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (p *jsiiProxy_PinpointSmsChannel) MoveFromId(id *string) {
...
func (p *jsiiProxy_PinpointSmsChannel) MoveToId(id *string) {
...
func (p *jsiiProxy_PinpointSmsChannel) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (p *jsiiProxy_PinpointSmsChannel) ResetRegion() {
	_jsii_.InvokeVoid(
		p,
		"resetRegion",
		nil, // no parameters
...
func (p *jsiiProxy_PinpointSmsChannel) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
