...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/dataawsssmmaintenancewindows/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/data-sources/ssm_maintenance_windows aws_ssm_maintenance_windows}.
...
func (j *jsiiProxy_DataAwsSsmMaintenanceWindows) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsSsmMaintenanceWindows) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsSsmMaintenanceWindows) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsSsmMaintenanceWindows) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsSsmMaintenanceWindows) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DataAwsSsmMaintenanceWindows) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_DataAwsSsmMaintenanceWindows) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/data-sources/ssm_maintenance_windows aws_ssm_maintenance_windows} Data Source.
...
func (j *jsiiProxy_DataAwsSsmMaintenanceWindows)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsSsmMaintenanceWindows)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsSsmMaintenanceWindows)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_DataAwsSsmMaintenanceWindows)SetRegion(val *string) {
...
// Generates CDKTN code for importing a DataAwsSsmMaintenanceWindows resource upon running "cdktn plan <stack-name>".
func DataAwsSsmMaintenanceWindows_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateDataAwsSsmMaintenanceWindows_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
// Experimental.
func DataAwsSsmMaintenanceWindows_IsTerraformDataSource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataAwsSsmMaintenanceWindows_IsTerraformDataSourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataAwsSsmMaintenanceWindows_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataAwsSsmMaintenanceWindows_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (d *jsiiProxy_DataAwsSsmMaintenanceWindows) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsSsmMaintenanceWindows) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsSsmMaintenanceWindows) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsSsmMaintenanceWindows) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsSsmMaintenanceWindows) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataAwsSsmMaintenanceWindows) ToHclTerraform() interface{} {
	var returns interface{}
