...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v24/ec2transitgateway/internal"
...
func (j *jsiiProxy_Ec2TransitGateway) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_Ec2TransitGateway) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.46.0/docs/resources/ec2_transit_gateway aws_ec2_transit_gateway} Resource.
...
func (j *jsiiProxy_Ec2TransitGateway)SetRegion(val *string) {
...
func (e *jsiiProxy_Ec2TransitGateway) ResetRegion() {
	_jsii_.InvokeVoid(
		e,
		"resetRegion",
		nil, // no parameters
