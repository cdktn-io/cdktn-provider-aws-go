...
func (s *jsiiProxy_SagemakerWorkteamNotificationConfigurationOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_SagemakerWorkteamNotificationConfigurationOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
