...
func (j *jsiiProxy_SagemakerWorkteam) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_SagemakerWorkteam) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_SagemakerWorkteam) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_SagemakerWorkteam) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_SagemakerWorkteam) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_SagemakerWorkteam) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_SagemakerWorkteam) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/sagemaker_workteam aws_sagemaker_workteam} Resource.
...
func (j *jsiiProxy_SagemakerWorkteam)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_SagemakerWorkteam)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_SagemakerWorkteam)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_SagemakerWorkteam)SetRegion(val *string) {
...
func SagemakerWorkteam_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (s *jsiiProxy_SagemakerWorkteam) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SagemakerWorkteam) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_SagemakerWorkteam) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SagemakerWorkteam) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_SagemakerWorkteam) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_SagemakerWorkteam) ResetRegion() {
	_jsii_.InvokeVoid(
		s,
		"resetRegion",
		nil, // no parameters
...
func (s *jsiiProxy_SagemakerWorkteam) ResetWorkforceName() {
	_jsii_.InvokeVoid(
		s,
		"resetWorkforceName",
		nil, // no parameters
...
func (s *jsiiProxy_SagemakerWorkteam) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
