...
func (s *jsiiProxy_SagemakerWorkteamNotificationConfigurationOutputReference) validateResolveParameters(context cdktf.IResolveContext) error {
	return nil
}
...
func (j *jsiiProxy_SagemakerWorkteamNotificationConfigurationOutputReference) validateSetInternalValueParameters(val *SagemakerWorkteamNotificationConfiguration) error {
	return nil
}
