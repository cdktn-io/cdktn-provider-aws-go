...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v24/storagegatewaygateway/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.45.0/docs/resources/storagegateway_gateway aws_storagegateway_gateway}.
...
func (j *jsiiProxy_StoragegatewayGateway) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_StoragegatewayGateway) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.45.0/docs/resources/storagegateway_gateway aws_storagegateway_gateway} Resource.
...
func (j *jsiiProxy_StoragegatewayGateway)SetRegion(val *string) {
...
func (s *jsiiProxy_StoragegatewayGateway) ResetRegion() {
	_jsii_.InvokeVoid(
		s,
		"resetRegion",
		nil, // no parameters
