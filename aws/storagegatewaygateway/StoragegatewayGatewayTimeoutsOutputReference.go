...
func (j *jsiiProxy_StoragegatewayGatewayTimeoutsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewStoragegatewayGatewayTimeoutsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) StoragegatewayGatewayTimeoutsOutputReference {
	_init_.Initialize()
...
func NewStoragegatewayGatewayTimeoutsOutputReference_Override(s StoragegatewayGatewayTimeoutsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_StoragegatewayGatewayTimeoutsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_StoragegatewayGatewayTimeoutsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_StoragegatewayGatewayTimeoutsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (s *jsiiProxy_StoragegatewayGatewayTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_StoragegatewayGatewayTimeoutsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
