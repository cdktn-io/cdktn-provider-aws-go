...
func (j *jsiiProxy_StoragegatewayGatewayGatewayNetworkInterfaceOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewStoragegatewayGatewayGatewayNetworkInterfaceOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) StoragegatewayGatewayGatewayNetworkInterfaceOutputReference {
	_init_.Initialize()
...
func NewStoragegatewayGatewayGatewayNetworkInterfaceOutputReference_Override(s StoragegatewayGatewayGatewayNetworkInterfaceOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_StoragegatewayGatewayGatewayNetworkInterfaceOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_StoragegatewayGatewayGatewayNetworkInterfaceOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_StoragegatewayGatewayGatewayNetworkInterfaceOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (s *jsiiProxy_StoragegatewayGatewayGatewayNetworkInterfaceOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_StoragegatewayGatewayGatewayNetworkInterfaceOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
