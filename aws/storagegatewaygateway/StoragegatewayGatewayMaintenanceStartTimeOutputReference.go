...
func (s *jsiiProxy_StoragegatewayGatewayMaintenanceStartTimeOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_StoragegatewayGatewayMaintenanceStartTimeOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
