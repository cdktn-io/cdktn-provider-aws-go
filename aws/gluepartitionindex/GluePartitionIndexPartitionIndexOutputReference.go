...
func (g *jsiiProxy_GluePartitionIndexPartitionIndexOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GluePartitionIndexPartitionIndexOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
