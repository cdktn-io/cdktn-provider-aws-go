...
func (d *jsiiProxy_DataAwsLakeformationPermissionsDatabaseOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataAwsLakeformationPermissionsDatabaseOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
