...
func (d *jsiiProxy_DataAwsLakeformationPermissionsDataCellsFilterOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataAwsLakeformationPermissionsDataCellsFilterOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
