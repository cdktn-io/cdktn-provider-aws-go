...
func (d *jsiiProxy_DataAwsLakeformationPermissionsLfTagOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataAwsLakeformationPermissionsLfTagOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
