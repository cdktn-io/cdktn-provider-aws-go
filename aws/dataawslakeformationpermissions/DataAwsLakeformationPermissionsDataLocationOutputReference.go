...
func (d *jsiiProxy_DataAwsLakeformationPermissionsDataLocationOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataAwsLakeformationPermissionsDataLocationOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
