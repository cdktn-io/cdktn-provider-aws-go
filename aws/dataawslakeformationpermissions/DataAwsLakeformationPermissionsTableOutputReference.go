...
func (d *jsiiProxy_DataAwsLakeformationPermissionsTableOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataAwsLakeformationPermissionsTableOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
