...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/lb_listener aws_lb_listener}.
...
func (j *jsiiProxy_LbListener) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_LbListener) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_LbListener) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_LbListener) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_LbListener) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/lb_listener aws_lb_listener} Resource.
...
func (j *jsiiProxy_LbListener)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_LbListener)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_LbListener)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
// Generates CDKTN code for importing a LbListener resource upon running "cdktn plan <stack-name>".
func LbListener_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (l *jsiiProxy_LbListener) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LbListener) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (l *jsiiProxy_LbListener) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LbListener) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (l *jsiiProxy_LbListener) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
