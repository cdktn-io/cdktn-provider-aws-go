...
func (l *jsiiProxy_LbListener) validatePutDefaultActionParameters(value interface{}) error {
	...
	case cdktn.IResolvable:
		// ok
	case *[]*LbListenerDefaultAction:
		value := value.(*[]*LbListenerDefaultAction)
	...
	case []*LbListenerDefaultAction:
		value_ := value.([]*LbListenerDefaultAction)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*LbListenerDefaultAction; received %#v (a %T)", value, value)
		}
	}
...
func (j *jsiiProxy_LbListener) validateSetRegionParameters(val *string) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
