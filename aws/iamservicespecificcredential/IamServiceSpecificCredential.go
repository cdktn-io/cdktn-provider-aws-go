...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/iamservicespecificcredential/internal"
...
func (j *jsiiProxy_IamServiceSpecificCredential) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_IamServiceSpecificCredential) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_IamServiceSpecificCredential) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_IamServiceSpecificCredential) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_IamServiceSpecificCredential) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_IamServiceSpecificCredential)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_IamServiceSpecificCredential)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_IamServiceSpecificCredential)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func IamServiceSpecificCredential_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (i *jsiiProxy_IamServiceSpecificCredential) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (i *jsiiProxy_IamServiceSpecificCredential) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (i *jsiiProxy_IamServiceSpecificCredential) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (i *jsiiProxy_IamServiceSpecificCredential) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (i *jsiiProxy_IamServiceSpecificCredential) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
