...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/cloud9environmentec2/internal"
...
func (j *jsiiProxy_Cloud9EnvironmentEc2) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_Cloud9EnvironmentEc2) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_Cloud9EnvironmentEc2) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_Cloud9EnvironmentEc2) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_Cloud9EnvironmentEc2) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/cloud9_environment_ec2 aws_cloud9_environment_ec2} Resource.
...
func (j *jsiiProxy_Cloud9EnvironmentEc2)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_Cloud9EnvironmentEc2)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_Cloud9EnvironmentEc2)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func Cloud9EnvironmentEc2_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (c *jsiiProxy_Cloud9EnvironmentEc2) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_Cloud9EnvironmentEc2) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (c *jsiiProxy_Cloud9EnvironmentEc2) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_Cloud9EnvironmentEc2) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_Cloud9EnvironmentEc2) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (c *jsiiProxy_Cloud9EnvironmentEc2) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
