...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/apigatewayv2api/internal"
...
func (j *jsiiProxy_Apigatewayv2Api) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_Apigatewayv2Api) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_Apigatewayv2Api) IpAddressType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ipAddressType",
...
func (j *jsiiProxy_Apigatewayv2Api) IpAddressTypeInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ipAddressTypeInput",
...
func (j *jsiiProxy_Apigatewayv2Api) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_Apigatewayv2Api) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_Apigatewayv2Api) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_Apigatewayv2Api) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_Apigatewayv2Api) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/apigatewayv2_api aws_apigatewayv2_api} Resource.
...
func (j *jsiiProxy_Apigatewayv2Api)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_Apigatewayv2Api)SetIpAddressType(val *string) {
...
func (j *jsiiProxy_Apigatewayv2Api)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_Apigatewayv2Api)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_Apigatewayv2Api)SetRegion(val *string) {
...
func Apigatewayv2Api_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (a *jsiiProxy_Apigatewayv2Api) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_Apigatewayv2Api) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (a *jsiiProxy_Apigatewayv2Api) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_Apigatewayv2Api) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (a *jsiiProxy_Apigatewayv2Api) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (a *jsiiProxy_Apigatewayv2Api) ResetIpAddressType() {
	_jsii_.InvokeVoid(
		a,
		"resetIpAddressType",
		nil, // no parameters
...
func (a *jsiiProxy_Apigatewayv2Api) ResetRegion() {
	_jsii_.InvokeVoid(
		a,
		"resetRegion",
		nil, // no parameters
...
func (a *jsiiProxy_Apigatewayv2Api) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
