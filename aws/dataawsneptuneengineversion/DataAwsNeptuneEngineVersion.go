...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/dataawsneptuneengineversion/internal"
...
func (d *jsiiProxy_DataAwsNeptuneEngineVersion) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsNeptuneEngineVersion) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
