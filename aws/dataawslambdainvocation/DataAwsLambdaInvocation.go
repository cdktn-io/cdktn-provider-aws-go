...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/dataawslambdainvocation/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/data-sources/lambda_invocation aws_lambda_invocation}.
...
func (j *jsiiProxy_DataAwsLambdaInvocation) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsLambdaInvocation) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsLambdaInvocation) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsLambdaInvocation) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsLambdaInvocation) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/data-sources/lambda_invocation aws_lambda_invocation} Data Source.
...
func (j *jsiiProxy_DataAwsLambdaInvocation)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsLambdaInvocation)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsLambdaInvocation)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsLambdaInvocation_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsLambdaInvocation) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsLambdaInvocation) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsLambdaInvocation) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsLambdaInvocation) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
