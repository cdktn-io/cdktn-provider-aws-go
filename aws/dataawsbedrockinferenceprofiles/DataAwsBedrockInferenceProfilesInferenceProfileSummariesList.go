...
func (j *jsiiProxy_DataAwsBedrockInferenceProfilesInferenceProfileSummariesList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsBedrockInferenceProfilesInferenceProfileSummariesList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsBedrockInferenceProfilesInferenceProfileSummariesList {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-aws.dataAwsBedrockInferenceProfiles.DataAwsBedrockInferenceProfilesInferenceProfileSummariesList",
...
func NewDataAwsBedrockInferenceProfilesInferenceProfileSummariesList_Override(d DataAwsBedrockInferenceProfilesInferenceProfileSummariesList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsBedrockInferenceProfilesInferenceProfileSummariesList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsBedrockInferenceProfilesInferenceProfileSummariesList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsBedrockInferenceProfilesInferenceProfileSummariesList) Resolve(context cdktn.IResolveContext) interface{} {
