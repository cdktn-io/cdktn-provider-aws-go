...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/xraygroup/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/xray_group aws_xray_group}.
...
func (j *jsiiProxy_XrayGroup) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_XrayGroup) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_XrayGroup) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_XrayGroup) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_XrayGroup) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_XrayGroup) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_XrayGroup) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/xray_group aws_xray_group} Resource.
...
func (j *jsiiProxy_XrayGroup)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_XrayGroup)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_XrayGroup)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_XrayGroup)SetRegion(val *string) {
...
func XrayGroup_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (x *jsiiProxy_XrayGroup) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (x *jsiiProxy_XrayGroup) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (x *jsiiProxy_XrayGroup) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (x *jsiiProxy_XrayGroup) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (x *jsiiProxy_XrayGroup) MoveFromId(id *string) {
...
func (x *jsiiProxy_XrayGroup) MoveToId(id *string) {
...
func (x *jsiiProxy_XrayGroup) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (x *jsiiProxy_XrayGroup) ResetRegion() {
	_jsii_.InvokeVoid(
		x,
		"resetRegion",
		nil, // no parameters
