...
func (j *jsiiProxy_DataAwsKeyPair) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsKeyPair) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsKeyPair) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsKeyPair) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsKeyPair) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DataAwsKeyPair)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsKeyPair)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsKeyPair)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsKeyPair_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsKeyPair) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsKeyPair) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsKeyPair) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
