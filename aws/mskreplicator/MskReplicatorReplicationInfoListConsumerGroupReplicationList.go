...
func (j *jsiiProxy_MskReplicatorReplicationInfoListConsumerGroupReplicationList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewMskReplicatorReplicationInfoListConsumerGroupReplicationList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) MskReplicatorReplicationInfoListConsumerGroupReplicationList {
	_init_.Initialize()
...
func NewMskReplicatorReplicationInfoListConsumerGroupReplicationList_Override(m MskReplicatorReplicationInfoListConsumerGroupReplicationList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_MskReplicatorReplicationInfoListConsumerGroupReplicationList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (m *jsiiProxy_MskReplicatorReplicationInfoListConsumerGroupReplicationList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (m *jsiiProxy_MskReplicatorReplicationInfoListConsumerGroupReplicationList) Resolve(context cdktn.IResolveContext) interface{} {
