...
func (c *jsiiProxy_CloudwatchEventTargetRunCommandTargetsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CloudwatchEventTargetRunCommandTargetsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
