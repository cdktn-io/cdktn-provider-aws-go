...
func (c *jsiiProxy_CloudwatchEventTargetRedshiftTargetOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CloudwatchEventTargetRedshiftTargetOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
