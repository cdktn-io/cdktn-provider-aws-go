...
func (c *jsiiProxy_CloudwatchEventTargetDeadLetterConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CloudwatchEventTargetDeadLetterConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
