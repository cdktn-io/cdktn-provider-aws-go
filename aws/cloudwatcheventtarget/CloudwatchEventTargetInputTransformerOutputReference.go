...
func (c *jsiiProxy_CloudwatchEventTargetInputTransformerOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CloudwatchEventTargetInputTransformerOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
