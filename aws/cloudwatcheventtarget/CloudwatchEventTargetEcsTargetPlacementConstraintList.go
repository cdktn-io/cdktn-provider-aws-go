...
func (j *jsiiProxy_CloudwatchEventTargetEcsTargetPlacementConstraintList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewCloudwatchEventTargetEcsTargetPlacementConstraintList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) CloudwatchEventTargetEcsTargetPlacementConstraintList {
	_init_.Initialize()

	if err := validateNewCloudwatchEventTargetEcsTargetPlacementConstraintListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewCloudwatchEventTargetEcsTargetPlacementConstraintList_Override(c CloudwatchEventTargetEcsTargetPlacementConstraintList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_CloudwatchEventTargetEcsTargetPlacementConstraintList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_CloudwatchEventTargetEcsTargetPlacementConstraintList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (c *jsiiProxy_CloudwatchEventTargetEcsTargetPlacementConstraintList) Resolve(context cdktn.IResolveContext) interface{} {
