...
func (c *jsiiProxy_CloudwatchEventTargetSqsTargetOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CloudwatchEventTargetSqsTargetOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
