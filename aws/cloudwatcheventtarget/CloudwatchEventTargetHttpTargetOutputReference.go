...
func (c *jsiiProxy_CloudwatchEventTargetHttpTargetOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CloudwatchEventTargetHttpTargetOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
