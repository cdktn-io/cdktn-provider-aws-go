...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/apigatewaymethodresponse/internal"
...
func (j *jsiiProxy_ApiGatewayMethodResponse) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_ApiGatewayMethodResponse) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_ApiGatewayMethodResponse) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_ApiGatewayMethodResponse) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_ApiGatewayMethodResponse) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_ApiGatewayMethodResponse) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_ApiGatewayMethodResponse) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/api_gateway_method_response aws_api_gateway_method_response} Resource.
func NewApiGatewayMethodResponse(scope constructs.Construct, id *string, config *ApiGatewayMethodResponseConfig) ApiGatewayMethodResponse {
	...
	_jsii_.Create(
		"@cdktn/provider-aws.apiGatewayMethodResponse.ApiGatewayMethodResponse",
...
func (j *jsiiProxy_ApiGatewayMethodResponse)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_ApiGatewayMethodResponse)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_ApiGatewayMethodResponse)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_ApiGatewayMethodResponse)SetRegion(val *string) {
...
func ApiGatewayMethodResponse_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (a *jsiiProxy_ApiGatewayMethodResponse) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_ApiGatewayMethodResponse) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (a *jsiiProxy_ApiGatewayMethodResponse) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_ApiGatewayMethodResponse) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (a *jsiiProxy_ApiGatewayMethodResponse) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (a *jsiiProxy_ApiGatewayMethodResponse) ResetRegion() {
	_jsii_.InvokeVoid(
		a,
		"resetRegion",
		nil, // no parameters
...
func (a *jsiiProxy_ApiGatewayMethodResponse) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
