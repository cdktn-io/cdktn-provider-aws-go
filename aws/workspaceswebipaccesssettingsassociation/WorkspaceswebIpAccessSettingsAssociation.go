...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/workspaceswebipaccesssettingsassociation/internal"
...
func (j *jsiiProxy_WorkspaceswebIpAccessSettingsAssociation) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_WorkspaceswebIpAccessSettingsAssociation) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_WorkspaceswebIpAccessSettingsAssociation) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_WorkspaceswebIpAccessSettingsAssociation) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_WorkspaceswebIpAccessSettingsAssociation) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/workspacesweb_ip_access_settings_association aws_workspacesweb_ip_access_settings_association} Resource.
...
func (j *jsiiProxy_WorkspaceswebIpAccessSettingsAssociation)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_WorkspaceswebIpAccessSettingsAssociation)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_WorkspaceswebIpAccessSettingsAssociation)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func WorkspaceswebIpAccessSettingsAssociation_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (w *jsiiProxy_WorkspaceswebIpAccessSettingsAssociation) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_WorkspaceswebIpAccessSettingsAssociation) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (w *jsiiProxy_WorkspaceswebIpAccessSettingsAssociation) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_WorkspaceswebIpAccessSettingsAssociation) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (w *jsiiProxy_WorkspaceswebIpAccessSettingsAssociation) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (w *jsiiProxy_WorkspaceswebIpAccessSettingsAssociation) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
