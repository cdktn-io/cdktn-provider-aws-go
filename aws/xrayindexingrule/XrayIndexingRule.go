...
func (x *jsiiProxy_XrayIndexingRule) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (x *jsiiProxy_XrayIndexingRule) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
