...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v23/dataawsstoragegatewaylocaldisk/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.35.0/docs/data-sources/storagegateway_local_disk aws_storagegateway_local_disk}.
...
func (j *jsiiProxy_DataAwsStoragegatewayLocalDisk) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsStoragegatewayLocalDisk) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsStoragegatewayLocalDisk) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsStoragegatewayLocalDisk) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsStoragegatewayLocalDisk) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DataAwsStoragegatewayLocalDisk) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_DataAwsStoragegatewayLocalDisk) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.35.0/docs/data-sources/storagegateway_local_disk aws_storagegateway_local_disk} Data Source.
...
func (j *jsiiProxy_DataAwsStoragegatewayLocalDisk)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsStoragegatewayLocalDisk)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsStoragegatewayLocalDisk)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_DataAwsStoragegatewayLocalDisk)SetRegion(val *string) {
...
func DataAwsStoragegatewayLocalDisk_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsStoragegatewayLocalDisk) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsStoragegatewayLocalDisk) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsStoragegatewayLocalDisk) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsStoragegatewayLocalDisk) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
