...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.31.0/docs/resources/kms_custom_key_store aws_kms_custom_key_store}.
...
func (j *jsiiProxy_KmsCustomKeyStore) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_KmsCustomKeyStore) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_KmsCustomKeyStore) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_KmsCustomKeyStore) Provider() cdktf.TerraformProvider {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.31.0/docs/resources/kms_custom_key_store aws_kms_custom_key_store} Resource.
...
func KmsCustomKeyStore_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (k *jsiiProxy_KmsCustomKeyStore) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (k *jsiiProxy_KmsCustomKeyStore) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (k *jsiiProxy_KmsCustomKeyStore) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
