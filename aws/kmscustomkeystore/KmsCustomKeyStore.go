...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/kmscustomkeystore/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/kms_custom_key_store aws_kms_custom_key_store}.
...
type jsiiProxy_KmsCustomKeyStore struct {
	internal.Type__cdktnTerraformResource
}

func (j *jsiiProxy_KmsCustomKeyStore) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_KmsCustomKeyStore) CloudHsmClusterId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cloudHsmClusterId",
...
func (j *jsiiProxy_KmsCustomKeyStore) CloudHsmClusterIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_KmsCustomKeyStore) CustomKeyStoreName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"customKeyStoreName",
...
func (j *jsiiProxy_KmsCustomKeyStore) CustomKeyStoreNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_KmsCustomKeyStore) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_KmsCustomKeyStore) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_KmsCustomKeyStore) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_KmsCustomKeyStore) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_KmsCustomKeyStore) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_KmsCustomKeyStore) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_KmsCustomKeyStore) KeyStorePassword() *string {
	var returns *string
	_jsii_.Get(
		j,
		"keyStorePassword",
...
func (j *jsiiProxy_KmsCustomKeyStore) KeyStorePasswordInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_KmsCustomKeyStore) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_KmsCustomKeyStore) Node() constructs.Node {
...
func (j *jsiiProxy_KmsCustomKeyStore) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_KmsCustomKeyStore) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_KmsCustomKeyStore) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_KmsCustomKeyStore) Timeouts() KmsCustomKeyStoreTimeoutsOutputReference {
	var returns KmsCustomKeyStoreTimeoutsOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
func (j *jsiiProxy_KmsCustomKeyStore) TrustAnchorCertificate() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_KmsCustomKeyStore) TrustAnchorCertificateInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/kms_custom_key_store aws_kms_custom_key_store} Resource.
func NewKmsCustomKeyStore(scope constructs.Construct, id *string, config *KmsCustomKeyStoreConfig) KmsCustomKeyStore {
	_init_.Initialize()

	if err := validateNewKmsCustomKeyStoreParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_KmsCustomKeyStore)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_KmsCustomKeyStore)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_KmsCustomKeyStore)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func KmsCustomKeyStore_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateKmsCustomKeyStore_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func KmsCustomKeyStore_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktn/provider-aws.kmsCustomKeyStore.KmsCustomKeyStore",
...
func (k *jsiiProxy_KmsCustomKeyStore) AddMoveTarget(moveTarget *string) {
...
func (k *jsiiProxy_KmsCustomKeyStore) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (k *jsiiProxy_KmsCustomKeyStore) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (k *jsiiProxy_KmsCustomKeyStore) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (k *jsiiProxy_KmsCustomKeyStore) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (k *jsiiProxy_KmsCustomKeyStore) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (k *jsiiProxy_KmsCustomKeyStore) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (k *jsiiProxy_KmsCustomKeyStore) GetStringAttribute(terraformAttribute *string) *string {
...
func (k *jsiiProxy_KmsCustomKeyStore) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (k *jsiiProxy_KmsCustomKeyStore) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (k *jsiiProxy_KmsCustomKeyStore) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (k *jsiiProxy_KmsCustomKeyStore) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (k *jsiiProxy_KmsCustomKeyStore) MoveFromId(id *string) {
...
func (k *jsiiProxy_KmsCustomKeyStore) MoveToId(id *string) {
...
func (k *jsiiProxy_KmsCustomKeyStore) OverrideLogicalId(newLogicalId *string) {
...
func (k *jsiiProxy_KmsCustomKeyStore) PutTimeouts(value *KmsCustomKeyStoreTimeouts) {
...
func (k *jsiiProxy_KmsCustomKeyStore) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (k *jsiiProxy_KmsCustomKeyStore) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		k,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (k *jsiiProxy_KmsCustomKeyStore) ResetTimeouts() {
	_jsii_.InvokeVoid(
		k,
		"resetTimeouts",
		nil, // no parameters
...
func (k *jsiiProxy_KmsCustomKeyStore) ToString() *string {
	var returns *string
...
func (k *jsiiProxy_KmsCustomKeyStore) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
