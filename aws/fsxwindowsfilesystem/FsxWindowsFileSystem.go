...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/fsxwindowsfilesystem/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/fsx_windows_file_system aws_fsx_windows_file_system}.
...
func (j *jsiiProxy_FsxWindowsFileSystem) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_FsxWindowsFileSystem) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_FsxWindowsFileSystem) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_FsxWindowsFileSystem) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_FsxWindowsFileSystem) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_FsxWindowsFileSystem) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_FsxWindowsFileSystem) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/fsx_windows_file_system aws_fsx_windows_file_system} Resource.
func NewFsxWindowsFileSystem(scope constructs.Construct, id *string, config *FsxWindowsFileSystemConfig) FsxWindowsFileSystem {
	...
	_jsii_.Create(
		"@cdktn/provider-aws.fsxWindowsFileSystem.FsxWindowsFileSystem",
...
func (j *jsiiProxy_FsxWindowsFileSystem)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_FsxWindowsFileSystem)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_FsxWindowsFileSystem)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_FsxWindowsFileSystem)SetRegion(val *string) {
...
func FsxWindowsFileSystem_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateFsxWindowsFileSystem_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (f *jsiiProxy_FsxWindowsFileSystem) AddMoveTarget(moveTarget *string) {
...
func (f *jsiiProxy_FsxWindowsFileSystem) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (f *jsiiProxy_FsxWindowsFileSystem) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (f *jsiiProxy_FsxWindowsFileSystem) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (f *jsiiProxy_FsxWindowsFileSystem) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (f *jsiiProxy_FsxWindowsFileSystem) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (f *jsiiProxy_FsxWindowsFileSystem) ResetRegion() {
	_jsii_.InvokeVoid(
		f,
		"resetRegion",
		nil, // no parameters
...
func (f *jsiiProxy_FsxWindowsFileSystem) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
