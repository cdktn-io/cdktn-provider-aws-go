...
func (j *jsiiProxy_FsxWindowsFileSystemTimeoutsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewFsxWindowsFileSystemTimeoutsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) FsxWindowsFileSystemTimeoutsOutputReference {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-aws.fsxWindowsFileSystem.FsxWindowsFileSystemTimeoutsOutputReference",
...
func NewFsxWindowsFileSystemTimeoutsOutputReference_Override(f FsxWindowsFileSystemTimeoutsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_FsxWindowsFileSystemTimeoutsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (f *jsiiProxy_FsxWindowsFileSystemTimeoutsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (f *jsiiProxy_FsxWindowsFileSystemTimeoutsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (f *jsiiProxy_FsxWindowsFileSystemTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (f *jsiiProxy_FsxWindowsFileSystemTimeoutsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
