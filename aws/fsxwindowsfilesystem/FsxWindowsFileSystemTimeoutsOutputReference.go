...
func (f *jsiiProxy_FsxWindowsFileSystemTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (f *jsiiProxy_FsxWindowsFileSystemTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
