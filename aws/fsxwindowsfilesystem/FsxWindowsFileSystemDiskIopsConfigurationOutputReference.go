...
func (f *jsiiProxy_FsxWindowsFileSystemDiskIopsConfigurationOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (f *jsiiProxy_FsxWindowsFileSystemDiskIopsConfigurationOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
