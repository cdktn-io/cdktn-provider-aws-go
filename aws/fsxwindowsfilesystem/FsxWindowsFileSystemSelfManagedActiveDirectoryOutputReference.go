...
func (f *jsiiProxy_FsxWindowsFileSystemSelfManagedActiveDirectoryOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (f *jsiiProxy_FsxWindowsFileSystemSelfManagedActiveDirectoryOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
