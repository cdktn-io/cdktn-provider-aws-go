...
func (j *jsiiProxy_DataAwsElasticacheReplicationGroupLogDeliveryConfigurationList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsElasticacheReplicationGroupLogDeliveryConfigurationList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsElasticacheReplicationGroupLogDeliveryConfigurationList {
	_init_.Initialize()

	if err := validateNewDataAwsElasticacheReplicationGroupLogDeliveryConfigurationListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewDataAwsElasticacheReplicationGroupLogDeliveryConfigurationList_Override(d DataAwsElasticacheReplicationGroupLogDeliveryConfigurationList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsElasticacheReplicationGroupLogDeliveryConfigurationList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsElasticacheReplicationGroupLogDeliveryConfigurationList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsElasticacheReplicationGroupLogDeliveryConfigurationList) Resolve(context cdktn.IResolveContext) interface{} {
