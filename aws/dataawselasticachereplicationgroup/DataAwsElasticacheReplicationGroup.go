...
func (j *jsiiProxy_DataAwsElasticacheReplicationGroup) AuthTokenEnabled() cdktn.IResolvable {
...
func (j *jsiiProxy_DataAwsElasticacheReplicationGroup) AutomaticFailoverEnabled() cdktn.IResolvable {
	var returns cdktn.IResolvable
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataAwsElasticacheReplicationGroup) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsElasticacheReplicationGroup) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsElasticacheReplicationGroup) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsElasticacheReplicationGroup) MultiAzEnabled() cdktn.IResolvable {
	var returns cdktn.IResolvable
	_jsii_.Get(
		j,
		"multiAzEnabled",
...
func (j *jsiiProxy_DataAwsElasticacheReplicationGroup) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsElasticacheReplicationGroup) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/data-sources/elasticache_replication_group aws_elasticache_replication_group} Data Source.
...
func (j *jsiiProxy_DataAwsElasticacheReplicationGroup)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsElasticacheReplicationGroup)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsElasticacheReplicationGroup)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsElasticacheReplicationGroup_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsElasticacheReplicationGroup) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsElasticacheReplicationGroup) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsElasticacheReplicationGroup) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsElasticacheReplicationGroup) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
