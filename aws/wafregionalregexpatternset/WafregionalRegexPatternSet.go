...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/wafregionalregexpatternset/internal"
...
func (j *jsiiProxy_WafregionalRegexPatternSet) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_WafregionalRegexPatternSet) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_WafregionalRegexPatternSet) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_WafregionalRegexPatternSet) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_WafregionalRegexPatternSet) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/wafregional_regex_pattern_set aws_wafregional_regex_pattern_set} Resource.
...
func (j *jsiiProxy_WafregionalRegexPatternSet)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_WafregionalRegexPatternSet)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_WafregionalRegexPatternSet)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func WafregionalRegexPatternSet_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (w *jsiiProxy_WafregionalRegexPatternSet) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_WafregionalRegexPatternSet) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (w *jsiiProxy_WafregionalRegexPatternSet) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_WafregionalRegexPatternSet) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (w *jsiiProxy_WafregionalRegexPatternSet) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (w *jsiiProxy_WafregionalRegexPatternSet) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
