...
func (j *jsiiProxy_AppsyncResolverSyncConfigLambdaConflictHandlerConfigOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewAppsyncResolverSyncConfigLambdaConflictHandlerConfigOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) AppsyncResolverSyncConfigLambdaConflictHandlerConfigOutputReference {
	_init_.Initialize()
...
func NewAppsyncResolverSyncConfigLambdaConflictHandlerConfigOutputReference_Override(a AppsyncResolverSyncConfigLambdaConflictHandlerConfigOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_AppsyncResolverSyncConfigLambdaConflictHandlerConfigOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (a *jsiiProxy_AppsyncResolverSyncConfigLambdaConflictHandlerConfigOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AppsyncResolverSyncConfigLambdaConflictHandlerConfigOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (a *jsiiProxy_AppsyncResolverSyncConfigLambdaConflictHandlerConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AppsyncResolverSyncConfigLambdaConflictHandlerConfigOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
