...
func (a *jsiiProxy_AppsyncResolverSyncConfigLambdaConflictHandlerConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_AppsyncResolverSyncConfigLambdaConflictHandlerConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
