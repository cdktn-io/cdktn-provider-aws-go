...
func (j *jsiiProxy_AppsyncResolverSyncConfigOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewAppsyncResolverSyncConfigOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) AppsyncResolverSyncConfigOutputReference {
	_init_.Initialize()
...
func NewAppsyncResolverSyncConfigOutputReference_Override(a AppsyncResolverSyncConfigOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_AppsyncResolverSyncConfigOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (a *jsiiProxy_AppsyncResolverSyncConfigOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AppsyncResolverSyncConfigOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (a *jsiiProxy_AppsyncResolverSyncConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AppsyncResolverSyncConfigOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
