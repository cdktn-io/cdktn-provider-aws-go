...
func (a *jsiiProxy_AppsyncResolverSyncConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_AppsyncResolverSyncConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
