...
func (j *jsiiProxy_AppsyncResolverSyncConfigLambdaConflictHandlerConfigOutputReference) validateSetInternalValueParameters(val *AppsyncResolverSyncConfigLambdaConflictHandlerConfig) error {
