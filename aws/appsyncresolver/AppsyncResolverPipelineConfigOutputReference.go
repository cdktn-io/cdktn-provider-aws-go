...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v24/appsyncresolver/internal"
...
func (j *jsiiProxy_AppsyncResolverPipelineConfigOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewAppsyncResolverPipelineConfigOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) AppsyncResolverPipelineConfigOutputReference {
	_init_.Initialize()
...
func NewAppsyncResolverPipelineConfigOutputReference_Override(a AppsyncResolverPipelineConfigOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_AppsyncResolverPipelineConfigOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (a *jsiiProxy_AppsyncResolverPipelineConfigOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AppsyncResolverPipelineConfigOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (a *jsiiProxy_AppsyncResolverPipelineConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AppsyncResolverPipelineConfigOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
