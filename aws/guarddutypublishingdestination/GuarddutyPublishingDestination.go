...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/guarddutypublishingdestination/internal"
...
func (j *jsiiProxy_GuarddutyPublishingDestination) Arn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"arn",
...
func (j *jsiiProxy_GuarddutyPublishingDestination) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_GuarddutyPublishingDestination) DestinationId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"destinationId",
...
func (j *jsiiProxy_GuarddutyPublishingDestination) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_GuarddutyPublishingDestination) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_GuarddutyPublishingDestination) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_GuarddutyPublishingDestination) Tags() *map[string]*string {
...
func (j *jsiiProxy_GuarddutyPublishingDestination) TagsAll() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsAll",
...
func (j *jsiiProxy_GuarddutyPublishingDestination) TagsAllInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsAllInput",
...
func (j *jsiiProxy_GuarddutyPublishingDestination) TagsInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsInput",
...
func (j *jsiiProxy_GuarddutyPublishingDestination) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/guardduty_publishing_destination aws_guardduty_publishing_destination} Resource.
...
func (j *jsiiProxy_GuarddutyPublishingDestination)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_GuarddutyPublishingDestination)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_GuarddutyPublishingDestination)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_GuarddutyPublishingDestination)SetTags(val *map[string]*string) {
...
func (j *jsiiProxy_GuarddutyPublishingDestination)SetTagsAll(val *map[string]*string) {
...
func GuarddutyPublishingDestination_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (g *jsiiProxy_GuarddutyPublishingDestination) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GuarddutyPublishingDestination) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (g *jsiiProxy_GuarddutyPublishingDestination) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GuarddutyPublishingDestination) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GuarddutyPublishingDestination) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (g *jsiiProxy_GuarddutyPublishingDestination) ResetTagsAll() {
	_jsii_.InvokeVoid(
		g,
		"resetTagsAll",
		nil, // no parameters
...
func (g *jsiiProxy_GuarddutyPublishingDestination) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
