...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/servicequotas_service_quota aws_servicequotas_service_quota}.
type ServicequotasServiceQuota interface {
	...
	UsageMetric() ServicequotasServiceQuotaUsageMetricList
	Value() *float64
...
func (j *jsiiProxy_ServicequotasServiceQuota) Adjustable() cdktn.IResolvable {
...
func (j *jsiiProxy_ServicequotasServiceQuota) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_ServicequotasServiceQuota) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_ServicequotasServiceQuota) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_ServicequotasServiceQuota) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_ServicequotasServiceQuota) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_ServicequotasServiceQuota) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_ServicequotasServiceQuota) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_ServicequotasServiceQuota) UsageMetric() ServicequotasServiceQuotaUsageMetricList {
	var returns ServicequotasServiceQuotaUsageMetricList
	_jsii_.Get(
		j,
		"usageMetric",
		&returns,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/servicequotas_service_quota aws_servicequotas_service_quota} Resource.
...
func (j *jsiiProxy_ServicequotasServiceQuota)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_ServicequotasServiceQuota)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_ServicequotasServiceQuota)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_ServicequotasServiceQuota)SetRegion(val *string) {
...
// Generates CDKTN code for importing a ServicequotasServiceQuota resource upon running "cdktn plan <stack-name>".
func ServicequotasServiceQuota_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (s *jsiiProxy_ServicequotasServiceQuota) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_ServicequotasServiceQuota) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_ServicequotasServiceQuota) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_ServicequotasServiceQuota) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_ServicequotasServiceQuota) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_ServicequotasServiceQuota) ResetRegion() {
	_jsii_.InvokeVoid(
		s,
		"resetRegion",
		nil, // no parameters
...
func (s *jsiiProxy_ServicequotasServiceQuota) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
