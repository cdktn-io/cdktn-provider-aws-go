...
func (c *jsiiProxy_ConfigOrganizationCustomRuleTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ConfigOrganizationCustomRuleTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
