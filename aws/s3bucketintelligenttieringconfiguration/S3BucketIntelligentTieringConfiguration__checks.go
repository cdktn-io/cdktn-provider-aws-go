...
func (s *jsiiProxy_S3BucketIntelligentTieringConfiguration) validatePutTieringParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*S3BucketIntelligentTieringConfigurationTiering; received %#v (a %T)", value, value)
		}
	}
