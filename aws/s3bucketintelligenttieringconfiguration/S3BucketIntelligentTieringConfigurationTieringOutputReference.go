...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v22/s3bucketintelligenttieringconfiguration/internal"
...
func (s *jsiiProxy_S3BucketIntelligentTieringConfigurationTieringOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_S3BucketIntelligentTieringConfigurationTieringOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
