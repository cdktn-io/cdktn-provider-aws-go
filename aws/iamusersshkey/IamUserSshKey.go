...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/iamusersshkey/internal"
...
func (j *jsiiProxy_IamUserSshKey) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_IamUserSshKey) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_IamUserSshKey) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_IamUserSshKey) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_IamUserSshKey) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/iam_user_ssh_key aws_iam_user_ssh_key} Resource.
func NewIamUserSshKey(scope constructs.Construct, id *string, config *IamUserSshKeyConfig) IamUserSshKey {
	...
	_jsii_.Create(
		"@cdktn/provider-aws.iamUserSshKey.IamUserSshKey",
...
func (j *jsiiProxy_IamUserSshKey)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_IamUserSshKey)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_IamUserSshKey)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func IamUserSshKey_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (i *jsiiProxy_IamUserSshKey) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (i *jsiiProxy_IamUserSshKey) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (i *jsiiProxy_IamUserSshKey) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (i *jsiiProxy_IamUserSshKey) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (i *jsiiProxy_IamUserSshKey) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (i *jsiiProxy_IamUserSshKey) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
