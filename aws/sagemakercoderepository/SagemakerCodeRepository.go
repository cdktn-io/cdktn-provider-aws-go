...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/sagemakercoderepository/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/sagemaker_code_repository aws_sagemaker_code_repository}.
...
func (j *jsiiProxy_SagemakerCodeRepository) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_SagemakerCodeRepository) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_SagemakerCodeRepository) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_SagemakerCodeRepository) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_SagemakerCodeRepository) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/sagemaker_code_repository aws_sagemaker_code_repository} Resource.
...
func (j *jsiiProxy_SagemakerCodeRepository)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_SagemakerCodeRepository)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_SagemakerCodeRepository)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func SagemakerCodeRepository_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateSagemakerCodeRepository_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
// Experimental.
func SagemakerCodeRepository_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateSagemakerCodeRepository_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func SagemakerCodeRepository_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateSagemakerCodeRepository_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (s *jsiiProxy_SagemakerCodeRepository) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_SagemakerCodeRepository) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SagemakerCodeRepository) HasResourceMove() interface{} {
	var returns interface{}
...
func (s *jsiiProxy_SagemakerCodeRepository) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_SagemakerCodeRepository) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SagemakerCodeRepository) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_SagemakerCodeRepository) MoveFromId(id *string) {
...
func (s *jsiiProxy_SagemakerCodeRepository) MoveTo(moveTarget *string, index interface{}) {
...
func (s *jsiiProxy_SagemakerCodeRepository) MoveToId(id *string) {
...
func (s *jsiiProxy_SagemakerCodeRepository) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_SagemakerCodeRepository) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (s *jsiiProxy_SagemakerCodeRepository) ToHclTerraform() interface{} {
	var returns interface{}
...
func (s *jsiiProxy_SagemakerCodeRepository) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
