...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v22/sagemakercoderepository/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.31.0/docs/resources/sagemaker_code_repository aws_sagemaker_code_repository}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.31.0/docs/resources/sagemaker_code_repository aws_sagemaker_code_repository} Resource.
...
func SagemakerCodeRepository_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (s *jsiiProxy_SagemakerCodeRepository) ImportFrom(id *string, provider cdktf.TerraformProvider) {
