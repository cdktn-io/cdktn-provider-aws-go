...
func (j *jsiiProxy_DataAwsWorkspacesDirectory) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsWorkspacesDirectory) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsWorkspacesDirectory) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsWorkspacesDirectory) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsWorkspacesDirectory) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DataAwsWorkspacesDirectory)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsWorkspacesDirectory)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsWorkspacesDirectory)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsWorkspacesDirectory_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsWorkspacesDirectory) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsWorkspacesDirectory) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsWorkspacesDirectory) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsWorkspacesDirectory) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
