...
func (j *jsiiProxy_DataAwsWorkspacesDirectoryWorkspaceAccessPropertiesList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsWorkspacesDirectoryWorkspaceAccessPropertiesList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsWorkspacesDirectoryWorkspaceAccessPropertiesList {
	_init_.Initialize()
...
func NewDataAwsWorkspacesDirectoryWorkspaceAccessPropertiesList_Override(d DataAwsWorkspacesDirectoryWorkspaceAccessPropertiesList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsWorkspacesDirectoryWorkspaceAccessPropertiesList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsWorkspacesDirectoryWorkspaceAccessPropertiesList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsWorkspacesDirectoryWorkspaceAccessPropertiesList) Resolve(context cdktn.IResolveContext) interface{} {
