...
func (d *jsiiProxy_DataAwsWorkspacesDirectoryWorkspaceCreationPropertiesList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsWorkspacesDirectoryWorkspaceCreationPropertiesList) Resolve(context cdktf.IResolveContext) interface{} {
