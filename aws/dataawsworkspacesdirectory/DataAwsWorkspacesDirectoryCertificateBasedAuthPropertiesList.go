...
func (j *jsiiProxy_DataAwsWorkspacesDirectoryCertificateBasedAuthPropertiesList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewDataAwsWorkspacesDirectoryCertificateBasedAuthPropertiesList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsWorkspacesDirectoryCertificateBasedAuthPropertiesList {
	_init_.Initialize()
...
func NewDataAwsWorkspacesDirectoryCertificateBasedAuthPropertiesList_Override(d DataAwsWorkspacesDirectoryCertificateBasedAuthPropertiesList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsWorkspacesDirectoryCertificateBasedAuthPropertiesList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsWorkspacesDirectoryCertificateBasedAuthPropertiesList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsWorkspacesDirectoryCertificateBasedAuthPropertiesList) Resolve(context cdktf.IResolveContext) interface{} {
