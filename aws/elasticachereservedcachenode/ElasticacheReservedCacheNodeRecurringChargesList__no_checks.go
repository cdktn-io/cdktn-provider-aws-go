...
func (e *jsiiProxy_ElasticacheReservedCacheNodeRecurringChargesList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
	return nil
}

func (e *jsiiProxy_ElasticacheReservedCacheNodeRecurringChargesList) validateGetParameters(index *float64) error {
	return nil
}
...
func (j *jsiiProxy_ElasticacheReservedCacheNodeRecurringChargesList) validateSetTerraformAttributeParameters(val *string) error {
	return nil
}
...
func (j *jsiiProxy_ElasticacheReservedCacheNodeRecurringChargesList) validateSetWrapsSetParameters(val *bool) error {
	return nil
}
