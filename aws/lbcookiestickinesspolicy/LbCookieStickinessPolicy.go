...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v22/lbcookiestickinesspolicy/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.31.0/docs/resources/lb_cookie_stickiness_policy aws_lb_cookie_stickiness_policy}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.31.0/docs/resources/lb_cookie_stickiness_policy aws_lb_cookie_stickiness_policy} Resource.
...
func LbCookieStickinessPolicy_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (l *jsiiProxy_LbCookieStickinessPolicy) ImportFrom(id *string, provider cdktf.TerraformProvider) {
