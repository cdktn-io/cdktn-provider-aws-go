...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/lbcookiestickinesspolicy/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/lb_cookie_stickiness_policy aws_lb_cookie_stickiness_policy}.
...
func (j *jsiiProxy_LbCookieStickinessPolicy) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_LbCookieStickinessPolicy) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_LbCookieStickinessPolicy) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_LbCookieStickinessPolicy) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_LbCookieStickinessPolicy) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_LbCookieStickinessPolicy) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_LbCookieStickinessPolicy) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/lb_cookie_stickiness_policy aws_lb_cookie_stickiness_policy} Resource.
func NewLbCookieStickinessPolicy(scope constructs.Construct, id *string, config *LbCookieStickinessPolicyConfig) LbCookieStickinessPolicy {
	...
	_jsii_.Create(
		"@cdktn/provider-aws.lbCookieStickinessPolicy.LbCookieStickinessPolicy",
...
func (j *jsiiProxy_LbCookieStickinessPolicy)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_LbCookieStickinessPolicy)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_LbCookieStickinessPolicy)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_LbCookieStickinessPolicy)SetRegion(val *string) {
...
func LbCookieStickinessPolicy_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateLbCookieStickinessPolicy_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (l *jsiiProxy_LbCookieStickinessPolicy) AddMoveTarget(moveTarget *string) {
...
func (l *jsiiProxy_LbCookieStickinessPolicy) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LbCookieStickinessPolicy) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (l *jsiiProxy_LbCookieStickinessPolicy) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LbCookieStickinessPolicy) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (l *jsiiProxy_LbCookieStickinessPolicy) MoveFromId(id *string) {
...
func (l *jsiiProxy_LbCookieStickinessPolicy) MoveToId(id *string) {
...
func (l *jsiiProxy_LbCookieStickinessPolicy) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (l *jsiiProxy_LbCookieStickinessPolicy) ResetRegion() {
	_jsii_.InvokeVoid(
		l,
		"resetRegion",
		nil, // no parameters
...
func (l *jsiiProxy_LbCookieStickinessPolicy) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
