...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/dataawscanonicaluserid/internal"
...
func (j *jsiiProxy_DataAwsCanonicalUserId) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsCanonicalUserId) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsCanonicalUserId) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsCanonicalUserId) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsCanonicalUserId) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/data-sources/canonical_user_id aws_canonical_user_id} Data Source.
...
func (j *jsiiProxy_DataAwsCanonicalUserId)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsCanonicalUserId)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsCanonicalUserId)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsCanonicalUserId_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsCanonicalUserId) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsCanonicalUserId) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsCanonicalUserId) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsCanonicalUserId) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
