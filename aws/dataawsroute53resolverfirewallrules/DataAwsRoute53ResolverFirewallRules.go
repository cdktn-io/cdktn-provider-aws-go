...
func (j *jsiiProxy_DataAwsRoute53ResolverFirewallRules) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsRoute53ResolverFirewallRules) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsRoute53ResolverFirewallRules) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsRoute53ResolverFirewallRules) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsRoute53ResolverFirewallRules) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func NewDataAwsRoute53ResolverFirewallRules(scope constructs.Construct, id *string, config *DataAwsRoute53ResolverFirewallRulesConfig) DataAwsRoute53ResolverFirewallRules {
	...
	_jsii_.Create(
		"@cdktn/provider-aws.dataAwsRoute53ResolverFirewallRules.DataAwsRoute53ResolverFirewallRules",
...
func (j *jsiiProxy_DataAwsRoute53ResolverFirewallRules)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsRoute53ResolverFirewallRules)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsRoute53ResolverFirewallRules)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsRoute53ResolverFirewallRules_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsRoute53ResolverFirewallRules) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsRoute53ResolverFirewallRules) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsRoute53ResolverFirewallRules) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsRoute53ResolverFirewallRules) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
