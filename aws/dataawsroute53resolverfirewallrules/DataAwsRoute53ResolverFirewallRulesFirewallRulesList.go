...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v22/dataawsroute53resolverfirewallrules/internal"
...
func (j *jsiiProxy_DataAwsRoute53ResolverFirewallRulesFirewallRulesList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewDataAwsRoute53ResolverFirewallRulesFirewallRulesList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsRoute53ResolverFirewallRulesFirewallRulesList {
	_init_.Initialize()
...
func NewDataAwsRoute53ResolverFirewallRulesFirewallRulesList_Override(d DataAwsRoute53ResolverFirewallRulesFirewallRulesList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsRoute53ResolverFirewallRulesFirewallRulesList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsRoute53ResolverFirewallRulesFirewallRulesList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsRoute53ResolverFirewallRulesFirewallRulesList) Resolve(context cdktf.IResolveContext) interface{} {
