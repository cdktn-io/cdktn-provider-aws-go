...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/securityhubactiontarget/internal"
...
func (j *jsiiProxy_SecurityhubActionTarget) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_SecurityhubActionTarget) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_SecurityhubActionTarget) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_SecurityhubActionTarget) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_SecurityhubActionTarget) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_SecurityhubActionTarget) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/securityhub_action_target aws_securityhub_action_target} Resource.
func NewSecurityhubActionTarget(scope constructs.Construct, id *string, config *SecurityhubActionTargetConfig) SecurityhubActionTarget {
	...
	if err := validateNewSecurityhubActionTargetParameters(scope, id, config); err != nil {
		panic(err)
	}
	j := jsiiProxy_SecurityhubActionTarget{}

	_jsii_.Create(
		"@cdktn/provider-aws.securityhubActionTarget.SecurityhubActionTarget",
...
func (j *jsiiProxy_SecurityhubActionTarget)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_SecurityhubActionTarget)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_SecurityhubActionTarget)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func SecurityhubActionTarget_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateSecurityhubActionTarget_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_SecurityhubActionTarget) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_SecurityhubActionTarget) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SecurityhubActionTarget) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_SecurityhubActionTarget) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SecurityhubActionTarget) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_SecurityhubActionTarget) MoveFromId(id *string) {
...
func (s *jsiiProxy_SecurityhubActionTarget) MoveToId(id *string) {
...
func (s *jsiiProxy_SecurityhubActionTarget) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_SecurityhubActionTarget) ResetId() {
	_jsii_.InvokeVoid(
		s,
		"resetId",
		nil, // no parameters
...
func (s *jsiiProxy_SecurityhubActionTarget) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
