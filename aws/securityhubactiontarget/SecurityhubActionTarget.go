...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v21/securityhubactiontarget/internal"
...
func (j *jsiiProxy_SecurityhubActionTarget) ForEach() cdktf.ITerraformIterator {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.28.0/docs/resources/securityhub_action_target aws_securityhub_action_target} Resource.
...
func SecurityhubActionTarget_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (s *jsiiProxy_SecurityhubActionTarget) ImportFrom(id *string, provider cdktf.TerraformProvider) {
