...
func (j *jsiiProxy_VerifiedaccessInstanceVerifiedAccessTrustProvidersList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewVerifiedaccessInstanceVerifiedAccessTrustProvidersList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) VerifiedaccessInstanceVerifiedAccessTrustProvidersList {
	_init_.Initialize()
...
func NewVerifiedaccessInstanceVerifiedAccessTrustProvidersList_Override(v VerifiedaccessInstanceVerifiedAccessTrustProvidersList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_VerifiedaccessInstanceVerifiedAccessTrustProvidersList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (v *jsiiProxy_VerifiedaccessInstanceVerifiedAccessTrustProvidersList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (v *jsiiProxy_VerifiedaccessInstanceVerifiedAccessTrustProvidersList) Resolve(context cdktn.IResolveContext) interface{} {
