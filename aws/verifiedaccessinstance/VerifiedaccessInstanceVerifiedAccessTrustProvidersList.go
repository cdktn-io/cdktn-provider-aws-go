...
func (v *jsiiProxy_VerifiedaccessInstanceVerifiedAccessTrustProvidersList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (v *jsiiProxy_VerifiedaccessInstanceVerifiedAccessTrustProvidersList) Resolve(context cdktf.IResolveContext) interface{} {
