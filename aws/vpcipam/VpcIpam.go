...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/vpcipam/internal"
...
func (j *jsiiProxy_VpcIpam) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_VpcIpam) DefaultResourceDiscoveryAssociationId() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_VpcIpam) DefaultResourceDiscoveryId() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_VpcIpam) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_VpcIpam) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_VpcIpam) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_VpcIpam) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_VpcIpam) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_VpcIpam) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_VpcIpam) Tier() *string {
	var returns *string
	_jsii_.Get(
		j,
		"tier",
...
func (j *jsiiProxy_VpcIpam) TierInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"tierInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/vpc_ipam aws_vpc_ipam} Resource.
...
func (j *jsiiProxy_VpcIpam)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_VpcIpam)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_VpcIpam)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_VpcIpam)SetRegion(val *string) {
...
func (j *jsiiProxy_VpcIpam)SetTier(val *string) {
...
func VpcIpam_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateVpcIpam_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (v *jsiiProxy_VpcIpam) AddMoveTarget(moveTarget *string) {
...
func (v *jsiiProxy_VpcIpam) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (v *jsiiProxy_VpcIpam) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (v *jsiiProxy_VpcIpam) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (v *jsiiProxy_VpcIpam) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (v *jsiiProxy_VpcIpam) MoveFromId(id *string) {
...
func (v *jsiiProxy_VpcIpam) MoveToId(id *string) {
...
func (v *jsiiProxy_VpcIpam) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (v *jsiiProxy_VpcIpam) ResetRegion() {
	_jsii_.InvokeVoid(
		v,
		"resetRegion",
		nil, // no parameters
...
func (v *jsiiProxy_VpcIpam) ResetTier() {
	_jsii_.InvokeVoid(
		v,
		"resetTier",
		nil, // no parameters
...
func (v *jsiiProxy_VpcIpam) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
