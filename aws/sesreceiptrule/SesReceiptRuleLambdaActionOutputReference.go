...
func (j *jsiiProxy_SesReceiptRuleLambdaActionOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewSesReceiptRuleLambdaActionOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) SesReceiptRuleLambdaActionOutputReference {
	_init_.Initialize()
...
func NewSesReceiptRuleLambdaActionOutputReference_Override(s SesReceiptRuleLambdaActionOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_SesReceiptRuleLambdaActionOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_SesReceiptRuleLambdaActionOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SesReceiptRuleLambdaActionOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (s *jsiiProxy_SesReceiptRuleLambdaActionOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SesReceiptRuleLambdaActionOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
