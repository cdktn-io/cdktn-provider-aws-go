...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/ses_receipt_rule aws_ses_receipt_rule}.
...
func (j *jsiiProxy_SesReceiptRule) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_SesReceiptRule) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_SesReceiptRule) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_SesReceiptRule) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_SesReceiptRule) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/ses_receipt_rule aws_ses_receipt_rule} Resource.
...
func (j *jsiiProxy_SesReceiptRule)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_SesReceiptRule)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_SesReceiptRule)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func SesReceiptRule_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (s *jsiiProxy_SesReceiptRule) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SesReceiptRule) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_SesReceiptRule) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SesReceiptRule) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_SesReceiptRule) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_SesReceiptRule) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
