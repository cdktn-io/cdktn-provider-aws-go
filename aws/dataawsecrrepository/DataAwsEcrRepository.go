...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v22/dataawsecrrepository/internal"
...
func (j *jsiiProxy_DataAwsEcrRepository) ForEach() cdktf.ITerraformIterator {
...
func DataAwsEcrRepository_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
