...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/dataawsecrrepository/internal"
...
type DataAwsEcrRepository interface {
	...
	EncryptionConfiguration() DataAwsEcrRepositoryEncryptionConfigurationList
	// Experimental.
...
func (j *jsiiProxy_DataAwsEcrRepository) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsEcrRepository) EncryptionConfiguration() DataAwsEcrRepositoryEncryptionConfigurationList {
	var returns DataAwsEcrRepositoryEncryptionConfigurationList
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataAwsEcrRepository) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsEcrRepository) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_DataAwsEcrRepository) ImageScanningConfiguration() DataAwsEcrRepositoryImageScanningConfigurationList {
	var returns DataAwsEcrRepositoryImageScanningConfigurationList
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataAwsEcrRepository) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsEcrRepository) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsEcrRepository) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DataAwsEcrRepository) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_DataAwsEcrRepository) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func NewDataAwsEcrRepository(scope constructs.Construct, id *string, config *DataAwsEcrRepositoryConfig) DataAwsEcrRepository {
	...
	if err := validateNewDataAwsEcrRepositoryParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_DataAwsEcrRepository)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsEcrRepository)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsEcrRepository)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_DataAwsEcrRepository)SetRegion(val *string) {
...
func DataAwsEcrRepository_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateDataAwsEcrRepository_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataAwsEcrRepository) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsEcrRepository) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsEcrRepository) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsEcrRepository) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsEcrRepository) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsEcrRepository) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
