...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "keyRegistration", GoGetter: "KeyRegistration"},
			_jsii_.MemberProperty{JsiiProperty: "keyRegistrationInput", GoGetter: "KeyRegistrationInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "putKeyRegistration", GoMethod: "PutKeyRegistration"},
			_jsii_.MemberProperty{JsiiProperty: "rawOverrides", GoGetter: "RawOverrides"},
			_jsii_.MemberProperty{JsiiProperty: "region", GoGetter: "Region"},
			_jsii_.MemberProperty{JsiiProperty: "regionInput", GoGetter: "RegionInput"},
			_jsii_.MemberMethod{JsiiMethod: "resetAwsAccountId", GoMethod: "ResetAwsAccountId"},
			_jsii_.MemberMethod{JsiiMethod: "resetKeyRegistration", GoMethod: "ResetKeyRegistration"},
