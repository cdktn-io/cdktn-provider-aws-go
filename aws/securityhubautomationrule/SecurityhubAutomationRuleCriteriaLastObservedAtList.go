...
func (j *jsiiProxy_SecurityhubAutomationRuleCriteriaLastObservedAtList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewSecurityhubAutomationRuleCriteriaLastObservedAtList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) SecurityhubAutomationRuleCriteriaLastObservedAtList {
	_init_.Initialize()
...
func NewSecurityhubAutomationRuleCriteriaLastObservedAtList_Override(s SecurityhubAutomationRuleCriteriaLastObservedAtList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_SecurityhubAutomationRuleCriteriaLastObservedAtList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_SecurityhubAutomationRuleCriteriaLastObservedAtList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (s *jsiiProxy_SecurityhubAutomationRuleCriteriaLastObservedAtList) Resolve(context cdktn.IResolveContext) interface{} {
