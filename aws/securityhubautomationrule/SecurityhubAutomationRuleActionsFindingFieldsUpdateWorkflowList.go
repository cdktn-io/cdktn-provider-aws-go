...
func (j *jsiiProxy_SecurityhubAutomationRuleActionsFindingFieldsUpdateWorkflowList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewSecurityhubAutomationRuleActionsFindingFieldsUpdateWorkflowList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) SecurityhubAutomationRuleActionsFindingFieldsUpdateWorkflowList {
	_init_.Initialize()
...
func NewSecurityhubAutomationRuleActionsFindingFieldsUpdateWorkflowList_Override(s SecurityhubAutomationRuleActionsFindingFieldsUpdateWorkflowList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_SecurityhubAutomationRuleActionsFindingFieldsUpdateWorkflowList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_SecurityhubAutomationRuleActionsFindingFieldsUpdateWorkflowList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (s *jsiiProxy_SecurityhubAutomationRuleActionsFindingFieldsUpdateWorkflowList) Resolve(context cdktn.IResolveContext) interface{} {
