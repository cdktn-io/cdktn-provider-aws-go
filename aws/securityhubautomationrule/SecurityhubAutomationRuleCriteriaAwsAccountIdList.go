...
func (j *jsiiProxy_SecurityhubAutomationRuleCriteriaAwsAccountIdList) TerraformResource() cdktf.IInterpolatingParent {
...
func (j *jsiiProxy_SecurityhubAutomationRuleCriteriaAwsAccountIdList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (s *jsiiProxy_SecurityhubAutomationRuleCriteriaAwsAccountIdList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (s *jsiiProxy_SecurityhubAutomationRuleCriteriaAwsAccountIdList) Resolve(context cdktf.IResolveContext) interface{} {
