...
func (j *jsiiProxy_SecurityhubAutomationRuleCriteriaSourceUrlList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_SecurityhubAutomationRuleCriteriaSourceUrlList) InternalValue() interface{} {
...
func (j *jsiiProxy_SecurityhubAutomationRuleCriteriaSourceUrlList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_SecurityhubAutomationRuleCriteriaSourceUrlList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (j *jsiiProxy_SecurityhubAutomationRuleCriteriaSourceUrlList)SetInternalValue(val interface{}) {
...
func (j *jsiiProxy_SecurityhubAutomationRuleCriteriaSourceUrlList)SetTerraformAttribute(val *string) {
...
func (j *jsiiProxy_SecurityhubAutomationRuleCriteriaSourceUrlList)SetWrapsSet(val *bool) {
...
func (s *jsiiProxy_SecurityhubAutomationRuleCriteriaSourceUrlList) ComputeFqn() *string {
	var returns *string
...
func (s *jsiiProxy_SecurityhubAutomationRuleCriteriaSourceUrlList) Get(index *float64) SecurityhubAutomationRuleCriteriaSourceUrlOutputReference {
	if err := s.validateGetParameters(index); err != nil {
		panic(err)
	}
	var returns SecurityhubAutomationRuleCriteriaSourceUrlOutputReference
...
func (s *jsiiProxy_SecurityhubAutomationRuleCriteriaSourceUrlList) ToString() *string {
	var returns *string
