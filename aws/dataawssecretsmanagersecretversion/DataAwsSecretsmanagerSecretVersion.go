...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/dataawssecretsmanagersecretversion/internal"
...
func (j *jsiiProxy_DataAwsSecretsmanagerSecretVersion) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsSecretsmanagerSecretVersion) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsSecretsmanagerSecretVersion) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsSecretsmanagerSecretVersion) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsSecretsmanagerSecretVersion) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DataAwsSecretsmanagerSecretVersion) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_DataAwsSecretsmanagerSecretVersion) SecretArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"secretArn",
...
func (j *jsiiProxy_DataAwsSecretsmanagerSecretVersion) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DataAwsSecretsmanagerSecretVersion)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsSecretsmanagerSecretVersion)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsSecretsmanagerSecretVersion)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_DataAwsSecretsmanagerSecretVersion)SetRegion(val *string) {
...
func DataAwsSecretsmanagerSecretVersion_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsSecretsmanagerSecretVersion) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsSecretsmanagerSecretVersion) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsSecretsmanagerSecretVersion) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsSecretsmanagerSecretVersion) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsSecretsmanagerSecretVersion) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
