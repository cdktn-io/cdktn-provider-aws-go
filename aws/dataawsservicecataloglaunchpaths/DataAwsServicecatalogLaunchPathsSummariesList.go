...
func (j *jsiiProxy_DataAwsServicecatalogLaunchPathsSummariesList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsServicecatalogLaunchPathsSummariesList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsServicecatalogLaunchPathsSummariesList {
	_init_.Initialize()
...
func NewDataAwsServicecatalogLaunchPathsSummariesList_Override(d DataAwsServicecatalogLaunchPathsSummariesList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsServicecatalogLaunchPathsSummariesList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsServicecatalogLaunchPathsSummariesList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsServicecatalogLaunchPathsSummariesList) Resolve(context cdktn.IResolveContext) interface{} {
