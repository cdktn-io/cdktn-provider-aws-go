...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "caCertificatesBundleS3BucketInput", GoGetter: "CaCertificatesBundleS3BucketInput"},
			_jsii_.MemberProperty{JsiiProperty: "caCertificatesBundleS3Key", GoGetter: "CaCertificatesBundleS3Key"},
			_jsii_.MemberProperty{JsiiProperty: "caCertificatesBundleS3KeyInput", GoGetter: "CaCertificatesBundleS3KeyInput"},
			_jsii_.MemberProperty{JsiiProperty: "caCertificatesBundleS3ObjectVersion", GoGetter: "CaCertificatesBundleS3ObjectVersion"},
			_jsii_.MemberProperty{JsiiProperty: "caCertificatesBundleS3ObjectVersionInput", GoGetter: "CaCertificatesBundleS3ObjectVersionInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetCaCertificatesBundleS3ObjectVersion", GoMethod: "ResetCaCertificatesBundleS3ObjectVersion"},
	...
	_jsii_.RegisterClass(
		...
		func() interface{} {
			j := jsiiProxy_LbTrustStoreTimeoutsOutputReference{}
