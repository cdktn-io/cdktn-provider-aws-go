...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.38.0/docs/data-sources/vpc_ipam_pool aws_vpc_ipam_pool}.
type DataAwsVpcIpamPool interface {
	...
	SourceResource() DataAwsVpcIpamPoolSourceResourceList
	State() *string
...
func (j *jsiiProxy_DataAwsVpcIpamPool) AutoImport() cdktn.IResolvable {
...
func (j *jsiiProxy_DataAwsVpcIpamPool) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsVpcIpamPool) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsVpcIpamPool) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsVpcIpamPool) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsVpcIpamPool) PubliclyAdvertisable() cdktn.IResolvable {
	var returns cdktn.IResolvable
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataAwsVpcIpamPool) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DataAwsVpcIpamPool) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_DataAwsVpcIpamPool) SourceResource() DataAwsVpcIpamPoolSourceResourceList {
	var returns DataAwsVpcIpamPoolSourceResourceList
	_jsii_.Get(
		j,
		"sourceResource",
		&returns,
...
func (j *jsiiProxy_DataAwsVpcIpamPool) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.38.0/docs/data-sources/vpc_ipam_pool aws_vpc_ipam_pool} Data Source.
...
func (j *jsiiProxy_DataAwsVpcIpamPool)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsVpcIpamPool)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsVpcIpamPool)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_DataAwsVpcIpamPool)SetRegion(val *string) {
...
func DataAwsVpcIpamPool_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsVpcIpamPool) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsVpcIpamPool) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsVpcIpamPool) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsVpcIpamPool) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
