...
func (j *jsiiProxy_DataAwsKmsSecret) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsKmsSecret) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsKmsSecret) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsKmsSecret) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsKmsSecret) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/data-sources/kms_secret aws_kms_secret} Data Source.
...
func (j *jsiiProxy_DataAwsKmsSecret)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsKmsSecret)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsKmsSecret)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsKmsSecret_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsKmsSecret) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsKmsSecret) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsKmsSecret) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsKmsSecret) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
