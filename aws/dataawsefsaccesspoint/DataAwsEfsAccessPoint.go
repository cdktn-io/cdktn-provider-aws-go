...
func (j *jsiiProxy_DataAwsEfsAccessPoint) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsEfsAccessPoint) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsEfsAccessPoint) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsEfsAccessPoint) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsEfsAccessPoint) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/data-sources/efs_access_point aws_efs_access_point} Data Source.
...
func (j *jsiiProxy_DataAwsEfsAccessPoint)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsEfsAccessPoint)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsEfsAccessPoint)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsEfsAccessPoint_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsEfsAccessPoint) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsEfsAccessPoint) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsEfsAccessPoint) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsEfsAccessPoint) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
