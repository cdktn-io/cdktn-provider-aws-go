...
func (j *jsiiProxy_S3BucketWebsiteOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewS3BucketWebsiteOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) S3BucketWebsiteOutputReference {
	_init_.Initialize()
...
func NewS3BucketWebsiteOutputReference_Override(s S3BucketWebsiteOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_S3BucketWebsiteOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_S3BucketWebsiteOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_S3BucketWebsiteOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (s *jsiiProxy_S3BucketWebsiteOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_S3BucketWebsiteOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
