...
func (s *jsiiProxy_S3BucketWebsiteOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_S3BucketWebsiteOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
