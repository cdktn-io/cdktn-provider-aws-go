...
func (j *jsiiProxy_S3BucketLifecycleRuleNoncurrentVersionExpirationOutputReference) ComplexObjectIndex() interface{} {
...
func (j *jsiiProxy_S3BucketLifecycleRuleNoncurrentVersionExpirationOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_S3BucketLifecycleRuleNoncurrentVersionExpirationOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_S3BucketLifecycleRuleNoncurrentVersionExpirationOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_S3BucketLifecycleRuleNoncurrentVersionExpirationOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewS3BucketLifecycleRuleNoncurrentVersionExpirationOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) S3BucketLifecycleRuleNoncurrentVersionExpirationOutputReference {
	_init_.Initialize()

	if err := validateNewS3BucketLifecycleRuleNoncurrentVersionExpirationOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewS3BucketLifecycleRuleNoncurrentVersionExpirationOutputReference_Override(s S3BucketLifecycleRuleNoncurrentVersionExpirationOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_S3BucketLifecycleRuleNoncurrentVersionExpirationOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_S3BucketLifecycleRuleNoncurrentVersionExpirationOutputReference) ComputeFqn() *string {
	var returns *string
...
func (s *jsiiProxy_S3BucketLifecycleRuleNoncurrentVersionExpirationOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_S3BucketLifecycleRuleNoncurrentVersionExpirationOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (s *jsiiProxy_S3BucketLifecycleRuleNoncurrentVersionExpirationOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_S3BucketLifecycleRuleNoncurrentVersionExpirationOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
...
func (s *jsiiProxy_S3BucketLifecycleRuleNoncurrentVersionExpirationOutputReference) ToString() *string {
	var returns *string
