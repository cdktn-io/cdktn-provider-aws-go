...
func (s *jsiiProxy_S3BucketVersioningOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_S3BucketVersioningOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
