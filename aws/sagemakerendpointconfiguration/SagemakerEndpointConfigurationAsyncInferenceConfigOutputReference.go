...
func (s *jsiiProxy_SagemakerEndpointConfigurationAsyncInferenceConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_SagemakerEndpointConfigurationAsyncInferenceConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
