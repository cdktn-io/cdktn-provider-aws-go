...
func (j *jsiiProxy_SagemakerEndpointConfiguration) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_SagemakerEndpointConfiguration) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_SagemakerEndpointConfiguration)SetRegion(val *string) {
...
func (s *jsiiProxy_SagemakerEndpointConfiguration) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_SagemakerEndpointConfiguration) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_SagemakerEndpointConfiguration) MoveFromId(id *string) {
...
func (s *jsiiProxy_SagemakerEndpointConfiguration) MoveToId(id *string) {
...
func (s *jsiiProxy_SagemakerEndpointConfiguration) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_SagemakerEndpointConfiguration) ResetRegion() {
	_jsii_.InvokeVoid(
		s,
		"resetRegion",
		nil, // no parameters
...
func (s *jsiiProxy_SagemakerEndpointConfiguration) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
