...
func (j *jsiiProxy_SagemakerEndpointConfigurationDataCaptureConfigOutputReference) CaptureOptions() SagemakerEndpointConfigurationDataCaptureConfigCaptureOptionsList {
	var returns SagemakerEndpointConfigurationDataCaptureConfigCaptureOptionsList
	_jsii_.Get(
		j,
		"captureOptions",
		&returns,
...
func (j *jsiiProxy_SagemakerEndpointConfigurationDataCaptureConfigOutputReference) ComplexObjectIndex() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"complexObjectIndex",
...
func (j *jsiiProxy_SagemakerEndpointConfigurationDataCaptureConfigOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_SagemakerEndpointConfigurationDataCaptureConfigOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_SagemakerEndpointConfigurationDataCaptureConfigOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_SagemakerEndpointConfigurationDataCaptureConfigOutputReference)SetComplexObjectIndex(val interface{}) {
...
func (j *jsiiProxy_SagemakerEndpointConfigurationDataCaptureConfigOutputReference)SetComplexObjectIsFromSet(val *bool) {
...
func (s *jsiiProxy_SagemakerEndpointConfigurationDataCaptureConfigOutputReference) ComputeFqn() *string {
	var returns *string
...
func (s *jsiiProxy_SagemakerEndpointConfigurationDataCaptureConfigOutputReference) PutCaptureOptions(value interface{}) {
...
func (s *jsiiProxy_SagemakerEndpointConfigurationDataCaptureConfigOutputReference) ToString() *string {
	var returns *string
