...
func (s *jsiiProxy_SagemakerEndpointConfigurationProductionVariantsServerlessConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_SagemakerEndpointConfigurationProductionVariantsServerlessConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
