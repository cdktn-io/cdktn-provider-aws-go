...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "deletePropagationPolicyInput", GoGetter: "DeletePropagationPolicyInput"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "idcRegion", GoGetter: "IdcRegion"},
			_jsii_.MemberProperty{JsiiProperty: "idcRegionInput", GoGetter: "IdcRegionInput"},
			_jsii_.MemberProperty{JsiiProperty: "internalValue", GoGetter: "InternalValue"},
			_jsii_.MemberMethod{JsiiMethod: "interpolationAsList", GoMethod: "InterpolationAsList"},
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "resetIdcRegion", GoMethod: "ResetIdcRegion"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "awsIdcInput", GoGetter: "AwsIdcInput"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
			...
			_jsii_.MemberMethod{JsiiMethod: "putAwsIdc", GoMethod: "PutAwsIdc"},
			_jsii_.MemberMethod{JsiiMethod: "putNetworkAccess", GoMethod: "PutNetworkAccess"},
			_jsii_.MemberMethod{JsiiMethod: "putRbacRoleMapping", GoMethod: "PutRbacRoleMapping"},
			_jsii_.MemberProperty{JsiiProperty: "rbacRoleMapping", GoGetter: "RbacRoleMapping"},
			_jsii_.MemberProperty{JsiiProperty: "rbacRoleMappingInput", GoGetter: "RbacRoleMappingInput"},
			_jsii_.MemberMethod{JsiiMethod: "resetAwsIdc", GoMethod: "ResetAwsIdc"},
			_jsii_.MemberMethod{JsiiMethod: "resetNamespace", GoMethod: "ResetNamespace"},
			_jsii_.MemberMethod{JsiiMethod: "resetNetworkAccess", GoMethod: "ResetNetworkAccess"},
			_jsii_.MemberMethod{JsiiMethod: "resetRbacRoleMapping", GoMethod: "ResetRbacRoleMapping"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
