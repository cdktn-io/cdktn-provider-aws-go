...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/guarddutyinviteaccepter/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/guardduty_invite_accepter aws_guardduty_invite_accepter}.
...
func (j *jsiiProxy_GuarddutyInviteAccepter) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_GuarddutyInviteAccepter) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_GuarddutyInviteAccepter) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_GuarddutyInviteAccepter) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_GuarddutyInviteAccepter) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_GuarddutyInviteAccepter) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_GuarddutyInviteAccepter) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/guardduty_invite_accepter aws_guardduty_invite_accepter} Resource.
...
func (j *jsiiProxy_GuarddutyInviteAccepter)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_GuarddutyInviteAccepter)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_GuarddutyInviteAccepter)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_GuarddutyInviteAccepter)SetRegion(val *string) {
...
func GuarddutyInviteAccepter_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (g *jsiiProxy_GuarddutyInviteAccepter) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GuarddutyInviteAccepter) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (g *jsiiProxy_GuarddutyInviteAccepter) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GuarddutyInviteAccepter) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GuarddutyInviteAccepter) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (g *jsiiProxy_GuarddutyInviteAccepter) ResetRegion() {
	_jsii_.InvokeVoid(
		g,
		"resetRegion",
		nil, // no parameters
...
func (g *jsiiProxy_GuarddutyInviteAccepter) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
