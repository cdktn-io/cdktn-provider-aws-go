...
func (k *jsiiProxy_KendraIndexDocumentMetadataConfigurationUpdatesRelevanceOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (k *jsiiProxy_KendraIndexDocumentMetadataConfigurationUpdatesRelevanceOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
