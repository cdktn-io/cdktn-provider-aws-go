...
func (k *jsiiProxy_KendraIndex) validatePutDocumentMetadataConfigurationUpdatesParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*KendraIndexDocumentMetadataConfigurationUpdates; received %#v (a %T)", value, value)
		}
	}
...
func (j *jsiiProxy_KendraIndex) validateSetRegionParameters(val *string) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
