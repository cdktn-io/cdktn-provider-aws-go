...
func (k *jsiiProxy_KendraIndexDocumentMetadataConfigurationUpdatesSearchOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (k *jsiiProxy_KendraIndexDocumentMetadataConfigurationUpdatesSearchOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
