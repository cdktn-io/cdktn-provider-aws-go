...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/kendra_index aws_kendra_index}.
...
func (j *jsiiProxy_KendraIndex) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_KendraIndex) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/kendra_index aws_kendra_index} Resource.
...
func (j *jsiiProxy_KendraIndex)SetRegion(val *string) {
...
func (k *jsiiProxy_KendraIndex) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (k *jsiiProxy_KendraIndex) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (k *jsiiProxy_KendraIndex) ResetRegion() {
	_jsii_.InvokeVoid(
		k,
		"resetRegion",
		nil, // no parameters
