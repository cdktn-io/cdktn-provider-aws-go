...
func (j *jsiiProxy_NetworkmanagerConnectAttachment) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_NetworkmanagerConnectAttachment) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_NetworkmanagerConnectAttachment) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_NetworkmanagerConnectAttachment) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_NetworkmanagerConnectAttachment) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/networkmanager_connect_attachment aws_networkmanager_connect_attachment} Resource.
...
func (j *jsiiProxy_NetworkmanagerConnectAttachment)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_NetworkmanagerConnectAttachment)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_NetworkmanagerConnectAttachment)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func NetworkmanagerConnectAttachment_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (n *jsiiProxy_NetworkmanagerConnectAttachment) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (n *jsiiProxy_NetworkmanagerConnectAttachment) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (n *jsiiProxy_NetworkmanagerConnectAttachment) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (n *jsiiProxy_NetworkmanagerConnectAttachment) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (n *jsiiProxy_NetworkmanagerConnectAttachment) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (n *jsiiProxy_NetworkmanagerConnectAttachment) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
