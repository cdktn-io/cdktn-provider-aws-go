...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/elasticachesubnetgroup/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/elasticache_subnet_group aws_elasticache_subnet_group}.
...
func (j *jsiiProxy_ElasticacheSubnetGroup) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_ElasticacheSubnetGroup) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_ElasticacheSubnetGroup) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_ElasticacheSubnetGroup) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_ElasticacheSubnetGroup) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_ElasticacheSubnetGroup) VpcId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"vpcId",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/elasticache_subnet_group aws_elasticache_subnet_group} Resource.
func NewElasticacheSubnetGroup(scope constructs.Construct, id *string, config *ElasticacheSubnetGroupConfig) ElasticacheSubnetGroup {
	...
	if err := validateNewElasticacheSubnetGroupParameters(scope, id, config); err != nil {
		panic(err)
	}
	j := jsiiProxy_ElasticacheSubnetGroup{}

	_jsii_.Create(
		"@cdktn/provider-aws.elasticacheSubnetGroup.ElasticacheSubnetGroup",
...
func (j *jsiiProxy_ElasticacheSubnetGroup)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_ElasticacheSubnetGroup)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_ElasticacheSubnetGroup)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func ElasticacheSubnetGroup_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateElasticacheSubnetGroup_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func ElasticacheSubnetGroup_IsConstruct(x interface{}) *bool {
	...
	if err := validateElasticacheSubnetGroup_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func ElasticacheSubnetGroup_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateElasticacheSubnetGroup_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func ElasticacheSubnetGroup_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateElasticacheSubnetGroup_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (e *jsiiProxy_ElasticacheSubnetGroup) AddMoveTarget(moveTarget *string) {
...
func (e *jsiiProxy_ElasticacheSubnetGroup) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (e *jsiiProxy_ElasticacheSubnetGroup) HasResourceMove() interface{} {
	var returns interface{}
...
func (e *jsiiProxy_ElasticacheSubnetGroup) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (e *jsiiProxy_ElasticacheSubnetGroup) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (e *jsiiProxy_ElasticacheSubnetGroup) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (e *jsiiProxy_ElasticacheSubnetGroup) MoveFromId(id *string) {
...
func (e *jsiiProxy_ElasticacheSubnetGroup) MoveTo(moveTarget *string, index interface{}) {
...
func (e *jsiiProxy_ElasticacheSubnetGroup) MoveToId(id *string) {
...
func (e *jsiiProxy_ElasticacheSubnetGroup) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (e *jsiiProxy_ElasticacheSubnetGroup) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (e *jsiiProxy_ElasticacheSubnetGroup) ToHclTerraform() interface{} {
	var returns interface{}
...
func (e *jsiiProxy_ElasticacheSubnetGroup) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
