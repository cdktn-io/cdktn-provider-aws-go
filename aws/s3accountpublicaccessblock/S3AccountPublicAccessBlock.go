...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/s3accountpublicaccessblock/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/s3_account_public_access_block aws_s3_account_public_access_block}.
...
func (j *jsiiProxy_S3AccountPublicAccessBlock) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_S3AccountPublicAccessBlock) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_S3AccountPublicAccessBlock) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_S3AccountPublicAccessBlock) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_S3AccountPublicAccessBlock) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/s3_account_public_access_block aws_s3_account_public_access_block} Resource.
func NewS3AccountPublicAccessBlock(scope constructs.Construct, id *string, config *S3AccountPublicAccessBlockConfig) S3AccountPublicAccessBlock {
	...
	_jsii_.Create(
		"@cdktn/provider-aws.s3AccountPublicAccessBlock.S3AccountPublicAccessBlock",
...
func (j *jsiiProxy_S3AccountPublicAccessBlock)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_S3AccountPublicAccessBlock)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_S3AccountPublicAccessBlock)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func S3AccountPublicAccessBlock_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (s *jsiiProxy_S3AccountPublicAccessBlock) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_S3AccountPublicAccessBlock) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_S3AccountPublicAccessBlock) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_S3AccountPublicAccessBlock) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_S3AccountPublicAccessBlock) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_S3AccountPublicAccessBlock) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
