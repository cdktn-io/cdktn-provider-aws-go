...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v23/dataawswafregionalipset/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.34.0/docs/data-sources/wafregional_ipset aws_wafregional_ipset}.
...
func (j *jsiiProxy_DataAwsWafregionalIpset) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsWafregionalIpset) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsWafregionalIpset) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsWafregionalIpset) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsWafregionalIpset) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DataAwsWafregionalIpset) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_DataAwsWafregionalIpset) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.34.0/docs/data-sources/wafregional_ipset aws_wafregional_ipset} Data Source.
func NewDataAwsWafregionalIpset(scope constructs.Construct, id *string, config *DataAwsWafregionalIpsetConfig) DataAwsWafregionalIpset {
	...
	_jsii_.Create(
		"@cdktn/provider-aws.dataAwsWafregionalIpset.DataAwsWafregionalIpset",
...
func (j *jsiiProxy_DataAwsWafregionalIpset)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsWafregionalIpset)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsWafregionalIpset)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_DataAwsWafregionalIpset)SetRegion(val *string) {
...
// Generates CDKTN code for importing a DataAwsWafregionalIpset resource upon running "cdktn plan <stack-name>".
func DataAwsWafregionalIpset_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsWafregionalIpset) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsWafregionalIpset) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsWafregionalIpset) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsWafregionalIpset) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
