...
func (g *jsiiProxy_GlobalacceleratorEndpointGroupTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GlobalacceleratorEndpointGroupTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
