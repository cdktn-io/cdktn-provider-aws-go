...
func (g *jsiiProxy_GlobalacceleratorEndpointGroupEndpointConfigurationOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GlobalacceleratorEndpointGroupEndpointConfigurationOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
