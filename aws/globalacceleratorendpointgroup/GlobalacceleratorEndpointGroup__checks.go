...
func (g *jsiiProxy_GlobalacceleratorEndpointGroup) validatePutEndpointConfigurationParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*GlobalacceleratorEndpointGroupEndpointConfiguration; received %#v (a %T)", value, value)
		}
	}
...
func (g *jsiiProxy_GlobalacceleratorEndpointGroup) validatePutPortOverrideParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*GlobalacceleratorEndpointGroupPortOverride; received %#v (a %T)", value, value)
		}
	}
