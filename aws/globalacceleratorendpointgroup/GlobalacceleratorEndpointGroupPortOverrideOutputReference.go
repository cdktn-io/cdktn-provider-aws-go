...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v22/globalacceleratorendpointgroup/internal"
...
func (g *jsiiProxy_GlobalacceleratorEndpointGroupPortOverrideOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GlobalacceleratorEndpointGroupPortOverrideOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
