...
func (a *jsiiProxy_ApprunnerServiceSourceConfigurationOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_ApprunnerServiceSourceConfigurationOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
