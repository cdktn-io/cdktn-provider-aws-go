...
func (a *jsiiProxy_ApprunnerServiceSourceConfigurationAuthenticationConfigurationOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_ApprunnerServiceSourceConfigurationAuthenticationConfigurationOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
