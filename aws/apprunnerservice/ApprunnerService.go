...
func (j *jsiiProxy_ApprunnerService) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_ApprunnerService) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_ApprunnerService) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_ApprunnerService) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_ApprunnerService) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_ApprunnerService) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_ApprunnerService) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/apprunner_service aws_apprunner_service} Resource.
...
func (j *jsiiProxy_ApprunnerService)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_ApprunnerService)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_ApprunnerService)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_ApprunnerService)SetRegion(val *string) {
...
func ApprunnerService_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (a *jsiiProxy_ApprunnerService) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_ApprunnerService) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (a *jsiiProxy_ApprunnerService) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_ApprunnerService) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (a *jsiiProxy_ApprunnerService) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (a *jsiiProxy_ApprunnerService) ResetRegion() {
	_jsii_.InvokeVoid(
		a,
		"resetRegion",
		nil, // no parameters
...
func (a *jsiiProxy_ApprunnerService) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
