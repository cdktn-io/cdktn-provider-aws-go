...
func (a *jsiiProxy_ApprunnerServiceObservabilityConfigurationOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_ApprunnerServiceObservabilityConfigurationOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
