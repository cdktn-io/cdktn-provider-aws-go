...
func (b *jsiiProxy_BedrockGuardrailContextualGroundingPolicyConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (b *jsiiProxy_BedrockGuardrailContextualGroundingPolicyConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
