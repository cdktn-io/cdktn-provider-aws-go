...
func (j *jsiiProxy_BedrockGuardrailContextualGroundingPolicyConfigOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewBedrockGuardrailContextualGroundingPolicyConfigOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) BedrockGuardrailContextualGroundingPolicyConfigOutputReference {
	_init_.Initialize()
...
func NewBedrockGuardrailContextualGroundingPolicyConfigOutputReference_Override(b BedrockGuardrailContextualGroundingPolicyConfigOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_BedrockGuardrailContextualGroundingPolicyConfigOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (b *jsiiProxy_BedrockGuardrailContextualGroundingPolicyConfigOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (b *jsiiProxy_BedrockGuardrailContextualGroundingPolicyConfigOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (b *jsiiProxy_BedrockGuardrailContextualGroundingPolicyConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (b *jsiiProxy_BedrockGuardrailContextualGroundingPolicyConfigOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
