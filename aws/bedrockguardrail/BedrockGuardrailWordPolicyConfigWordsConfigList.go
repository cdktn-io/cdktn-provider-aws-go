...
func (j *jsiiProxy_BedrockGuardrailWordPolicyConfigWordsConfigList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewBedrockGuardrailWordPolicyConfigWordsConfigList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) BedrockGuardrailWordPolicyConfigWordsConfigList {
	_init_.Initialize()
...
func NewBedrockGuardrailWordPolicyConfigWordsConfigList_Override(b BedrockGuardrailWordPolicyConfigWordsConfigList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_BedrockGuardrailWordPolicyConfigWordsConfigList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (b *jsiiProxy_BedrockGuardrailWordPolicyConfigWordsConfigList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (b *jsiiProxy_BedrockGuardrailWordPolicyConfigWordsConfigList) Resolve(context cdktn.IResolveContext) interface{} {
