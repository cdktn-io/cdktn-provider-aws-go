...
func (j *jsiiProxy_BedrockGuardrailWordPolicyConfigManagedWordListsConfigOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewBedrockGuardrailWordPolicyConfigManagedWordListsConfigOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) BedrockGuardrailWordPolicyConfigManagedWordListsConfigOutputReference {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-aws.bedrockGuardrail.BedrockGuardrailWordPolicyConfigManagedWordListsConfigOutputReference",
...
func NewBedrockGuardrailWordPolicyConfigManagedWordListsConfigOutputReference_Override(b BedrockGuardrailWordPolicyConfigManagedWordListsConfigOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_BedrockGuardrailWordPolicyConfigManagedWordListsConfigOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (b *jsiiProxy_BedrockGuardrailWordPolicyConfigManagedWordListsConfigOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (b *jsiiProxy_BedrockGuardrailWordPolicyConfigManagedWordListsConfigOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (b *jsiiProxy_BedrockGuardrailWordPolicyConfigManagedWordListsConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (b *jsiiProxy_BedrockGuardrailWordPolicyConfigManagedWordListsConfigOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
