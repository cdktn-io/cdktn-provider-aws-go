...
func (e *jsiiProxy_EcsServiceDeploymentControllerOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (e *jsiiProxy_EcsServiceDeploymentControllerOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
