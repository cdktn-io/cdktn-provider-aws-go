...
func (j *jsiiProxy_EcsServiceNetworkConfigurationOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewEcsServiceNetworkConfigurationOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) EcsServiceNetworkConfigurationOutputReference {
	_init_.Initialize()

	if err := validateNewEcsServiceNetworkConfigurationOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewEcsServiceNetworkConfigurationOutputReference_Override(e EcsServiceNetworkConfigurationOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_EcsServiceNetworkConfigurationOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (e *jsiiProxy_EcsServiceNetworkConfigurationOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (e *jsiiProxy_EcsServiceNetworkConfigurationOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (e *jsiiProxy_EcsServiceNetworkConfigurationOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (e *jsiiProxy_EcsServiceNetworkConfigurationOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
