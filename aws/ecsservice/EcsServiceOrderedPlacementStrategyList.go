...
func (j *jsiiProxy_EcsServiceOrderedPlacementStrategyList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewEcsServiceOrderedPlacementStrategyList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) EcsServiceOrderedPlacementStrategyList {
	_init_.Initialize()

	if err := validateNewEcsServiceOrderedPlacementStrategyListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewEcsServiceOrderedPlacementStrategyList_Override(e EcsServiceOrderedPlacementStrategyList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_EcsServiceOrderedPlacementStrategyList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (e *jsiiProxy_EcsServiceOrderedPlacementStrategyList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (e *jsiiProxy_EcsServiceOrderedPlacementStrategyList) Resolve(context cdktn.IResolveContext) interface{} {
