...
func (j *jsiiProxy_EcsServiceLoadBalancerList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewEcsServiceLoadBalancerList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) EcsServiceLoadBalancerList {
	_init_.Initialize()
...
func NewEcsServiceLoadBalancerList_Override(e EcsServiceLoadBalancerList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_EcsServiceLoadBalancerList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (e *jsiiProxy_EcsServiceLoadBalancerList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (e *jsiiProxy_EcsServiceLoadBalancerList) Resolve(context cdktn.IResolveContext) interface{} {
