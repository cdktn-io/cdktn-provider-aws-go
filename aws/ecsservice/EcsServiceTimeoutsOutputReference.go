...
func (e *jsiiProxy_EcsServiceTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (e *jsiiProxy_EcsServiceTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
