...
func (e *jsiiProxy_EcsServiceDeploymentCircuitBreakerOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (e *jsiiProxy_EcsServiceDeploymentCircuitBreakerOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
