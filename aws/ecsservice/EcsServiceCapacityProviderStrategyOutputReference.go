...
func (e *jsiiProxy_EcsServiceCapacityProviderStrategyOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (e *jsiiProxy_EcsServiceCapacityProviderStrategyOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
