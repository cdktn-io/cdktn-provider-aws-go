...
func (j *jsiiProxy_ConfigConfigurationRecorder) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_ConfigConfigurationRecorder) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_ConfigConfigurationRecorder) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_ConfigConfigurationRecorder) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_ConfigConfigurationRecorder) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_ConfigConfigurationRecorder)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_ConfigConfigurationRecorder)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_ConfigConfigurationRecorder)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func ConfigConfigurationRecorder_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (c *jsiiProxy_ConfigConfigurationRecorder) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_ConfigConfigurationRecorder) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (c *jsiiProxy_ConfigConfigurationRecorder) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_ConfigConfigurationRecorder) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_ConfigConfigurationRecorder) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (c *jsiiProxy_ConfigConfigurationRecorder) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
