...
func (c *jsiiProxy_ConfigConfigurationRecorderRecordingModeOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ConfigConfigurationRecorderRecordingModeOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
