...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v23/dataawsiamservercertificate/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.36.0/docs/data-sources/iam_server_certificate aws_iam_server_certificate}.
...
func (j *jsiiProxy_DataAwsIamServerCertificate) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsIamServerCertificate) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsIamServerCertificate) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsIamServerCertificate) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsIamServerCertificate) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.36.0/docs/data-sources/iam_server_certificate aws_iam_server_certificate} Data Source.
...
func (j *jsiiProxy_DataAwsIamServerCertificate)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsIamServerCertificate)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsIamServerCertificate)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsIamServerCertificate_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsIamServerCertificate) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsIamServerCertificate) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsIamServerCertificate) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
