...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/dataawsiamservercertificate/internal"
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/data-sources/iam_server_certificate aws_iam_server_certificate} Data Source.
...
func (d *jsiiProxy_DataAwsIamServerCertificate) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
