...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/data-sources/signer_signing_profile aws_signer_signing_profile}.
type DataAwsSignerSigningProfile interface {
	...
	SigningParameters() cdktn.StringMap
	Status() *string
...
func (j *jsiiProxy_DataAwsSignerSigningProfile) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsSignerSigningProfile) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsSignerSigningProfile) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsSignerSigningProfile) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsSignerSigningProfile) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DataAwsSignerSigningProfile) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_DataAwsSignerSigningProfile) SigningParameters() cdktn.StringMap {
...
func (j *jsiiProxy_DataAwsSignerSigningProfile) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/data-sources/signer_signing_profile aws_signer_signing_profile} Data Source.
...
func (j *jsiiProxy_DataAwsSignerSigningProfile)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsSignerSigningProfile)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsSignerSigningProfile)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_DataAwsSignerSigningProfile)SetRegion(val *string) {
...
// Generates CDKTN code for importing a DataAwsSignerSigningProfile resource upon running "cdktn plan <stack-name>".
func DataAwsSignerSigningProfile_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateDataAwsSignerSigningProfile_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataAwsSignerSigningProfile) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsSignerSigningProfile) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsSignerSigningProfile) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsSignerSigningProfile) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsSignerSigningProfile) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
