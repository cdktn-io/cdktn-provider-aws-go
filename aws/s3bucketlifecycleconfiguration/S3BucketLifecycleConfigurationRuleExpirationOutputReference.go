...
func (j *jsiiProxy_S3BucketLifecycleConfigurationRuleExpirationOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewS3BucketLifecycleConfigurationRuleExpirationOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) S3BucketLifecycleConfigurationRuleExpirationOutputReference {
	_init_.Initialize()
...
func NewS3BucketLifecycleConfigurationRuleExpirationOutputReference_Override(s S3BucketLifecycleConfigurationRuleExpirationOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_S3BucketLifecycleConfigurationRuleExpirationOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_S3BucketLifecycleConfigurationRuleExpirationOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_S3BucketLifecycleConfigurationRuleExpirationOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (s *jsiiProxy_S3BucketLifecycleConfigurationRuleExpirationOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_S3BucketLifecycleConfigurationRuleExpirationOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
