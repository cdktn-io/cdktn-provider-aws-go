...
func (j *jsiiProxy_S3BucketLifecycleConfigurationRuleTransitionList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewS3BucketLifecycleConfigurationRuleTransitionList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) S3BucketLifecycleConfigurationRuleTransitionList {
	_init_.Initialize()
...
func NewS3BucketLifecycleConfigurationRuleTransitionList_Override(s S3BucketLifecycleConfigurationRuleTransitionList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_S3BucketLifecycleConfigurationRuleTransitionList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_S3BucketLifecycleConfigurationRuleTransitionList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (s *jsiiProxy_S3BucketLifecycleConfigurationRuleTransitionList) Resolve(context cdktn.IResolveContext) interface{} {
