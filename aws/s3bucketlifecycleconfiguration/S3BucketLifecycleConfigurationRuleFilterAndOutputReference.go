...
func (j *jsiiProxy_S3BucketLifecycleConfigurationRuleFilterAndOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_S3BucketLifecycleConfigurationRuleFilterAndOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewS3BucketLifecycleConfigurationRuleFilterAndOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) S3BucketLifecycleConfigurationRuleFilterAndOutputReference {
	_init_.Initialize()

	if err := validateNewS3BucketLifecycleConfigurationRuleFilterAndOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func NewS3BucketLifecycleConfigurationRuleFilterAndOutputReference_Override(s S3BucketLifecycleConfigurationRuleFilterAndOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_S3BucketLifecycleConfigurationRuleFilterAndOutputReference)SetInternalValue(val interface{}) {
...
func (j *jsiiProxy_S3BucketLifecycleConfigurationRuleFilterAndOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_S3BucketLifecycleConfigurationRuleFilterAndOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_S3BucketLifecycleConfigurationRuleFilterAndOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (s *jsiiProxy_S3BucketLifecycleConfigurationRuleFilterAndOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_S3BucketLifecycleConfigurationRuleFilterAndOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
