...
func (j *jsiiProxy_ImagebuilderImagePipeline) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_ImagebuilderImagePipeline) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_ImagebuilderImagePipeline) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_ImagebuilderImagePipeline) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_ImagebuilderImagePipeline) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_ImagebuilderImagePipeline) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_ImagebuilderImagePipeline) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_ImagebuilderImagePipeline) Workflow() ImagebuilderImagePipelineWorkflowList {
	var returns ImagebuilderImagePipelineWorkflowList
	_jsii_.Get(
		j,
		"workflow",
		&returns,
...
func (j *jsiiProxy_ImagebuilderImagePipeline) WorkflowInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"workflowInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/imagebuilder_image_pipeline aws_imagebuilder_image_pipeline} Resource.
...
func (j *jsiiProxy_ImagebuilderImagePipeline)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_ImagebuilderImagePipeline)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_ImagebuilderImagePipeline)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_ImagebuilderImagePipeline)SetRegion(val *string) {
...
func ImagebuilderImagePipeline_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (i *jsiiProxy_ImagebuilderImagePipeline) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (i *jsiiProxy_ImagebuilderImagePipeline) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (i *jsiiProxy_ImagebuilderImagePipeline) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (i *jsiiProxy_ImagebuilderImagePipeline) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (i *jsiiProxy_ImagebuilderImagePipeline) PutWorkflow(value interface{}) {
...
func (i *jsiiProxy_ImagebuilderImagePipeline) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (i *jsiiProxy_ImagebuilderImagePipeline) ResetRegion() {
	_jsii_.InvokeVoid(
		i,
		"resetRegion",
		nil, // no parameters
...
func (i *jsiiProxy_ImagebuilderImagePipeline) ResetWorkflow() {
	_jsii_.InvokeVoid(
		i,
		"resetWorkflow",
		nil, // no parameters
...
func (i *jsiiProxy_ImagebuilderImagePipeline) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
