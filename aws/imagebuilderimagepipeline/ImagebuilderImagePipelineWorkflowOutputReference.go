...
func (i *jsiiProxy_ImagebuilderImagePipelineWorkflowOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (i *jsiiProxy_ImagebuilderImagePipelineWorkflowOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
