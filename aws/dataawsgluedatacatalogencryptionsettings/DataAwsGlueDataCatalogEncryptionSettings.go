...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/dataawsgluedatacatalogencryptionsettings/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/data-sources/glue_data_catalog_encryption_settings aws_glue_data_catalog_encryption_settings}.
type DataAwsGlueDataCatalogEncryptionSettings interface {
	...
	DataCatalogEncryptionSettings() DataAwsGlueDataCatalogEncryptionSettingsDataCatalogEncryptionSettingsList
	// Experimental.
	DependsOn() *[]*string
	// Experimental.
...
func (j *jsiiProxy_DataAwsGlueDataCatalogEncryptionSettings) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsGlueDataCatalogEncryptionSettings) DataCatalogEncryptionSettings() DataAwsGlueDataCatalogEncryptionSettingsDataCatalogEncryptionSettingsList {
	var returns DataAwsGlueDataCatalogEncryptionSettingsDataCatalogEncryptionSettingsList
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataAwsGlueDataCatalogEncryptionSettings) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsGlueDataCatalogEncryptionSettings) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_DataAwsGlueDataCatalogEncryptionSettings) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsGlueDataCatalogEncryptionSettings) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsGlueDataCatalogEncryptionSettings) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DataAwsGlueDataCatalogEncryptionSettings) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_DataAwsGlueDataCatalogEncryptionSettings) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/data-sources/glue_data_catalog_encryption_settings aws_glue_data_catalog_encryption_settings} Data Source.
func NewDataAwsGlueDataCatalogEncryptionSettings(scope constructs.Construct, id *string, config *DataAwsGlueDataCatalogEncryptionSettingsConfig) DataAwsGlueDataCatalogEncryptionSettings {
	...
	if err := validateNewDataAwsGlueDataCatalogEncryptionSettingsParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_DataAwsGlueDataCatalogEncryptionSettings)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsGlueDataCatalogEncryptionSettings)SetId(val *string) {
...
func (j *jsiiProxy_DataAwsGlueDataCatalogEncryptionSettings)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsGlueDataCatalogEncryptionSettings)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_DataAwsGlueDataCatalogEncryptionSettings)SetRegion(val *string) {
...
func DataAwsGlueDataCatalogEncryptionSettings_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateDataAwsGlueDataCatalogEncryptionSettings_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func DataAwsGlueDataCatalogEncryptionSettings_IsConstruct(x interface{}) *bool {
	...
	if err := validateDataAwsGlueDataCatalogEncryptionSettings_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataAwsGlueDataCatalogEncryptionSettings_IsTerraformDataSource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataAwsGlueDataCatalogEncryptionSettings_IsTerraformDataSourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataAwsGlueDataCatalogEncryptionSettings_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataAwsGlueDataCatalogEncryptionSettings_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (d *jsiiProxy_DataAwsGlueDataCatalogEncryptionSettings) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsGlueDataCatalogEncryptionSettings) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsGlueDataCatalogEncryptionSettings) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsGlueDataCatalogEncryptionSettings) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsGlueDataCatalogEncryptionSettings) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsGlueDataCatalogEncryptionSettings) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataAwsGlueDataCatalogEncryptionSettings) ToHclTerraform() interface{} {
	var returns interface{}
...
func (d *jsiiProxy_DataAwsGlueDataCatalogEncryptionSettings) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
