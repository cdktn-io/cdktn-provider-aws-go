...
func (d *jsiiProxy_DataAwsGlueDataCatalogEncryptionSettingsDataCatalogEncryptionSettingsEncryptionAtRestList) Resolve(context cdktf.IResolveContext) interface{} {
