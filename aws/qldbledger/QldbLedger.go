...
func (j *jsiiProxy_QldbLedger) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_QldbLedger) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_QldbLedger) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_QldbLedger) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_QldbLedger) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_QldbLedger) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_QldbLedger) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/qldb_ledger aws_qldb_ledger} Resource.
...
func (j *jsiiProxy_QldbLedger)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_QldbLedger)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_QldbLedger)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_QldbLedger)SetRegion(val *string) {
...
func QldbLedger_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (q *jsiiProxy_QldbLedger) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (q *jsiiProxy_QldbLedger) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (q *jsiiProxy_QldbLedger) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (q *jsiiProxy_QldbLedger) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (q *jsiiProxy_QldbLedger) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (q *jsiiProxy_QldbLedger) ResetRegion() {
	_jsii_.InvokeVoid(
		q,
		"resetRegion",
		nil, // no parameters
...
func (q *jsiiProxy_QldbLedger) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
