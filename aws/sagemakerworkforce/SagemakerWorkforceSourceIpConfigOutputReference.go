...
func (j *jsiiProxy_SagemakerWorkforceSourceIpConfigOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewSagemakerWorkforceSourceIpConfigOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) SagemakerWorkforceSourceIpConfigOutputReference {
	_init_.Initialize()
...
func NewSagemakerWorkforceSourceIpConfigOutputReference_Override(s SagemakerWorkforceSourceIpConfigOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_SagemakerWorkforceSourceIpConfigOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_SagemakerWorkforceSourceIpConfigOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SagemakerWorkforceSourceIpConfigOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (s *jsiiProxy_SagemakerWorkforceSourceIpConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SagemakerWorkforceSourceIpConfigOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
