...
func (j *jsiiProxy_SagemakerWorkforce) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_SagemakerWorkforce) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_SagemakerWorkforce) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_SagemakerWorkforce) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_SagemakerWorkforce) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/sagemaker_workforce aws_sagemaker_workforce} Resource.
...
func (j *jsiiProxy_SagemakerWorkforce)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_SagemakerWorkforce)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_SagemakerWorkforce)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func SagemakerWorkforce_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (s *jsiiProxy_SagemakerWorkforce) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SagemakerWorkforce) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_SagemakerWorkforce) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SagemakerWorkforce) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_SagemakerWorkforce) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_SagemakerWorkforce) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
