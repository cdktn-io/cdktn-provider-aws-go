...
func (s *jsiiProxy_SagemakerWorkforceOidcConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_SagemakerWorkforceOidcConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
