...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/organizationspolicy/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/organizations_policy aws_organizations_policy}.
...
func (j *jsiiProxy_OrganizationsPolicy) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_OrganizationsPolicy) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_OrganizationsPolicy) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_OrganizationsPolicy) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_OrganizationsPolicy) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/organizations_policy aws_organizations_policy} Resource.
...
func (j *jsiiProxy_OrganizationsPolicy)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_OrganizationsPolicy)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_OrganizationsPolicy)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func OrganizationsPolicy_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (o *jsiiProxy_OrganizationsPolicy) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (o *jsiiProxy_OrganizationsPolicy) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (o *jsiiProxy_OrganizationsPolicy) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (o *jsiiProxy_OrganizationsPolicy) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (o *jsiiProxy_OrganizationsPolicy) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (o *jsiiProxy_OrganizationsPolicy) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
