...
func (j *jsiiProxy_DataAwsVpcPeeringConnectionIpv6CidrBlockSetList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsVpcPeeringConnectionIpv6CidrBlockSetList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsVpcPeeringConnectionIpv6CidrBlockSetList {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-aws.dataAwsVpcPeeringConnection.DataAwsVpcPeeringConnectionIpv6CidrBlockSetList",
...
func NewDataAwsVpcPeeringConnectionIpv6CidrBlockSetList_Override(d DataAwsVpcPeeringConnectionIpv6CidrBlockSetList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsVpcPeeringConnectionIpv6CidrBlockSetList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsVpcPeeringConnectionIpv6CidrBlockSetList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsVpcPeeringConnectionIpv6CidrBlockSetList) Resolve(context cdktn.IResolveContext) interface{} {
