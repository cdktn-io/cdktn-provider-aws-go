...
func (c *jsiiProxy_CodepipelineStageOnFailureOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CodepipelineStageOnFailureOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
