...
func (j *jsiiProxy_CodepipelineStageOnFailureOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewCodepipelineStageOnFailureOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) CodepipelineStageOnFailureOutputReference {
	_init_.Initialize()
...
func NewCodepipelineStageOnFailureOutputReference_Override(c CodepipelineStageOnFailureOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_CodepipelineStageOnFailureOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_CodepipelineStageOnFailureOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CodepipelineStageOnFailureOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (c *jsiiProxy_CodepipelineStageOnFailureOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CodepipelineStageOnFailureOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
