...
func (j *jsiiProxy_CodepipelineStageBeforeEntryConditionRuleOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewCodepipelineStageBeforeEntryConditionRuleOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) CodepipelineStageBeforeEntryConditionRuleOutputReference {
	_init_.Initialize()
...
func NewCodepipelineStageBeforeEntryConditionRuleOutputReference_Override(c CodepipelineStageBeforeEntryConditionRuleOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_CodepipelineStageBeforeEntryConditionRuleOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_CodepipelineStageBeforeEntryConditionRuleOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CodepipelineStageBeforeEntryConditionRuleOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (c *jsiiProxy_CodepipelineStageBeforeEntryConditionRuleOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CodepipelineStageBeforeEntryConditionRuleOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
