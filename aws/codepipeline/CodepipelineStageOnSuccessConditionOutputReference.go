...
func (c *jsiiProxy_CodepipelineStageOnSuccessConditionOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CodepipelineStageOnSuccessConditionOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
