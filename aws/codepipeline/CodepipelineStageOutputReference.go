...
func (j *jsiiProxy_CodepipelineStageOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewCodepipelineStageOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) CodepipelineStageOutputReference {
	_init_.Initialize()
...
func NewCodepipelineStageOutputReference_Override(c CodepipelineStageOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_CodepipelineStageOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_CodepipelineStageOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CodepipelineStageOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (c *jsiiProxy_CodepipelineStageOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CodepipelineStageOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
