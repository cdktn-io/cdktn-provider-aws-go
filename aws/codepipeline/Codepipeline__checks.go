...
func (c *jsiiProxy_Codepipeline) validatePutArtifactStoreParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*CodepipelineArtifactStore; received %#v (a %T)", value, value)
		}
	}
...
func (c *jsiiProxy_Codepipeline) validatePutStageParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*CodepipelineStage; received %#v (a %T)", value, value)
		}
	}
...
func (c *jsiiProxy_Codepipeline) validatePutTriggerParameters(value interface{}) error {
	...
	case *[]*CodepipelineTrigger:
		value := value.(*[]*CodepipelineTrigger)
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
			}
	...
	case []*CodepipelineTrigger:
		value_ := value.([]*CodepipelineTrigger)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*CodepipelineTrigger; received %#v (a %T)", value, value)
		}
	}
...
func (c *jsiiProxy_Codepipeline) validatePutVariableParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*CodepipelineVariable; received %#v (a %T)", value, value)
		}
	}
