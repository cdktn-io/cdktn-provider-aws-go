...
func (c *jsiiProxy_CodepipelineTriggerGitConfigurationPullRequestBranchesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CodepipelineTriggerGitConfigurationPullRequestBranchesOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
