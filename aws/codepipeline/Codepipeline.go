...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/codepipeline aws_codepipeline}.
...
func (j *jsiiProxy_Codepipeline) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_Codepipeline) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_Codepipeline) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_Codepipeline) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_Codepipeline) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/codepipeline aws_codepipeline} Resource.
...
func (j *jsiiProxy_Codepipeline)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_Codepipeline)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_Codepipeline)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func Codepipeline_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (c *jsiiProxy_Codepipeline) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_Codepipeline) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (c *jsiiProxy_Codepipeline) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_Codepipeline) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_Codepipeline) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (c *jsiiProxy_Codepipeline) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
