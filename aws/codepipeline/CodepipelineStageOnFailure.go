...
type CodepipelineStageOnFailure struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.35.1/docs/resources/codepipeline#retry_configuration Codepipeline#retry_configuration}
