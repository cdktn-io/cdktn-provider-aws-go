...
func (c *jsiiProxy_CodepipelineStageList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (c *jsiiProxy_CodepipelineStageList) Resolve(context cdktf.IResolveContext) interface{} {
