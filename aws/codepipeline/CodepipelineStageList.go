...
func (j *jsiiProxy_CodepipelineStageList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewCodepipelineStageList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) CodepipelineStageList {
	_init_.Initialize()

	if err := validateNewCodepipelineStageListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewCodepipelineStageList_Override(c CodepipelineStageList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_CodepipelineStageList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_CodepipelineStageList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (c *jsiiProxy_CodepipelineStageList) Resolve(context cdktn.IResolveContext) interface{} {
