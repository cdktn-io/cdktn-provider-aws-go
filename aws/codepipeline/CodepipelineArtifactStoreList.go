...
func (j *jsiiProxy_CodepipelineArtifactStoreList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewCodepipelineArtifactStoreList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) CodepipelineArtifactStoreList {
	_init_.Initialize()
...
func NewCodepipelineArtifactStoreList_Override(c CodepipelineArtifactStoreList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_CodepipelineArtifactStoreList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_CodepipelineArtifactStoreList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (c *jsiiProxy_CodepipelineArtifactStoreList) Resolve(context cdktn.IResolveContext) interface{} {
