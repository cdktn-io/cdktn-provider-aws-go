...
func (c *jsiiProxy_CodepipelineArtifactStoreEncryptionKeyOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CodepipelineArtifactStoreEncryptionKeyOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
