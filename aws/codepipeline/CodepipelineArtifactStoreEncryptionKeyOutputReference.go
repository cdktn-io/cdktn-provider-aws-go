...
func (j *jsiiProxy_CodepipelineArtifactStoreEncryptionKeyOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewCodepipelineArtifactStoreEncryptionKeyOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) CodepipelineArtifactStoreEncryptionKeyOutputReference {
	_init_.Initialize()
...
func NewCodepipelineArtifactStoreEncryptionKeyOutputReference_Override(c CodepipelineArtifactStoreEncryptionKeyOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_CodepipelineArtifactStoreEncryptionKeyOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_CodepipelineArtifactStoreEncryptionKeyOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CodepipelineArtifactStoreEncryptionKeyOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (c *jsiiProxy_CodepipelineArtifactStoreEncryptionKeyOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CodepipelineArtifactStoreEncryptionKeyOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
