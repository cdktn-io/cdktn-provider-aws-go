...
func (j *jsiiProxy_CodepipelineStageActionList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewCodepipelineStageActionList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) CodepipelineStageActionList {
	_init_.Initialize()

	if err := validateNewCodepipelineStageActionListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewCodepipelineStageActionList_Override(c CodepipelineStageActionList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_CodepipelineStageActionList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_CodepipelineStageActionList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (c *jsiiProxy_CodepipelineStageActionList) Resolve(context cdktn.IResolveContext) interface{} {
