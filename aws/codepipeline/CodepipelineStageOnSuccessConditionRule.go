...
type CodepipelineStageOnSuccessConditionRule struct {
	...
	RuleTypeId *CodepipelineStageOnSuccessConditionRuleRuleTypeId `field:"required" json:"ruleTypeId" yaml:"ruleTypeId"`
