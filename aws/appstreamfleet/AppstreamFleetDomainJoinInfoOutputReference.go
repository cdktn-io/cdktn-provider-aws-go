...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v24/appstreamfleet/internal"
...
func (j *jsiiProxy_AppstreamFleetDomainJoinInfoOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewAppstreamFleetDomainJoinInfoOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) AppstreamFleetDomainJoinInfoOutputReference {
	_init_.Initialize()

	if err := validateNewAppstreamFleetDomainJoinInfoOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewAppstreamFleetDomainJoinInfoOutputReference_Override(a AppstreamFleetDomainJoinInfoOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_AppstreamFleetDomainJoinInfoOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (a *jsiiProxy_AppstreamFleetDomainJoinInfoOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AppstreamFleetDomainJoinInfoOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (a *jsiiProxy_AppstreamFleetDomainJoinInfoOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AppstreamFleetDomainJoinInfoOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
