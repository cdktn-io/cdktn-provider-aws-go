...
func (a *jsiiProxy_AppstreamFleetDomainJoinInfoOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_AppstreamFleetDomainJoinInfoOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
