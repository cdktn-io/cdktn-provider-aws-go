...
func (a *jsiiProxy_AppstreamFleetComputeCapacityOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_AppstreamFleetComputeCapacityOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
