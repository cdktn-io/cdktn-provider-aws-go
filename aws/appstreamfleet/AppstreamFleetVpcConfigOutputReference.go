...
func (a *jsiiProxy_AppstreamFleetVpcConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_AppstreamFleetVpcConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
