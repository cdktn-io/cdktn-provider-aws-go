...
func (j *jsiiProxy_AppstreamFleetVpcConfigOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewAppstreamFleetVpcConfigOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) AppstreamFleetVpcConfigOutputReference {
	_init_.Initialize()

	if err := validateNewAppstreamFleetVpcConfigOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewAppstreamFleetVpcConfigOutputReference_Override(a AppstreamFleetVpcConfigOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_AppstreamFleetVpcConfigOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (a *jsiiProxy_AppstreamFleetVpcConfigOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AppstreamFleetVpcConfigOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (a *jsiiProxy_AppstreamFleetVpcConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AppstreamFleetVpcConfigOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
