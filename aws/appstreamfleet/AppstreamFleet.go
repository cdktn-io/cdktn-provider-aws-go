...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.39.0/docs/resources/appstream_fleet aws_appstream_fleet}.
...
func (j *jsiiProxy_AppstreamFleet) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_AppstreamFleet) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.39.0/docs/resources/appstream_fleet aws_appstream_fleet} Resource.
...
func (j *jsiiProxy_AppstreamFleet)SetRegion(val *string) {
...
func (a *jsiiProxy_AppstreamFleet) ResetRegion() {
	_jsii_.InvokeVoid(
		a,
		"resetRegion",
		nil, // no parameters
