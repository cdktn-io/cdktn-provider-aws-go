...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*VpcSecurityGroupEgressRule)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "addMoveTarget", GoMethod: "AddMoveTarget"},
			_jsii_.MemberMethod{JsiiMethod: "addOverride", GoMethod: "AddOverride"},
			_jsii_.MemberProperty{JsiiProperty: "arn", GoGetter: "Arn"},
			_jsii_.MemberProperty{JsiiProperty: "cdktfStack", GoGetter: "CdktfStack"},
			_jsii_.MemberProperty{JsiiProperty: "cidrIpv4", GoGetter: "CidrIpv4"},
			_jsii_.MemberProperty{JsiiProperty: "cidrIpv4Input", GoGetter: "CidrIpv4Input"},
			...
			_jsii_.MemberProperty{JsiiProperty: "referencedSecurityGroupId", GoGetter: "ReferencedSecurityGroupId"},
			_jsii_.MemberProperty{JsiiProperty: "referencedSecurityGroupIdInput", GoGetter: "ReferencedSecurityGroupIdInput"},
			_jsii_.MemberProperty{JsiiProperty: "region", GoGetter: "Region"},
			_jsii_.MemberProperty{JsiiProperty: "regionInput", GoGetter: "RegionInput"},
			_jsii_.MemberMethod{JsiiMethod: "resetCidrIpv4", GoMethod: "ResetCidrIpv4"},
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-aws.vpcSecurityGroupEgressRule.VpcSecurityGroupEgressRuleConfig",
		reflect.TypeOf((*VpcSecurityGroupEgressRuleConfig)(nil)).Elem(),
	)
}
