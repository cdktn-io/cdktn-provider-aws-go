...
func (b *jsiiProxy_BackupFrameworkControlScopeOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (b *jsiiProxy_BackupFrameworkControlScopeOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
