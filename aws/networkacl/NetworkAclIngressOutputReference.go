...
func (n *jsiiProxy_NetworkAclIngressOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (n *jsiiProxy_NetworkAclIngressOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
