...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/datasynclocations3/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/datasync_location_s3 aws_datasync_location_s3}.
...
func (j *jsiiProxy_DatasyncLocationS3) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DatasyncLocationS3) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DatasyncLocationS3) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_DatasyncLocationS3) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DatasyncLocationS3) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DatasyncLocationS3) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DatasyncLocationS3) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_DatasyncLocationS3) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/datasync_location_s3 aws_datasync_location_s3} Resource.
func NewDatasyncLocationS3(scope constructs.Construct, id *string, config *DatasyncLocationS3Config) DatasyncLocationS3 {
	_init_.Initialize()

	if err := validateNewDatasyncLocationS3Parameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_DatasyncLocationS3)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DatasyncLocationS3)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DatasyncLocationS3)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_DatasyncLocationS3)SetRegion(val *string) {
...
func DatasyncLocationS3_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateDatasyncLocationS3_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DatasyncLocationS3) AddMoveTarget(moveTarget *string) {
...
func (d *jsiiProxy_DatasyncLocationS3) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DatasyncLocationS3) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (d *jsiiProxy_DatasyncLocationS3) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DatasyncLocationS3) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (d *jsiiProxy_DatasyncLocationS3) PutS3Config(value *DatasyncLocationS3S3Config) {
	if err := d.validatePutS3ConfigParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		d,
...
func (d *jsiiProxy_DatasyncLocationS3) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DatasyncLocationS3) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
...
func (d *jsiiProxy_DatasyncLocationS3) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
...
func (d *jsiiProxy_DatasyncLocationS3) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
