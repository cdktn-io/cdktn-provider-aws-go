...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/iamaccountalias/internal"
...
func (j *jsiiProxy_IamAccountAlias) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_IamAccountAlias) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_IamAccountAlias) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_IamAccountAlias) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_IamAccountAlias) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/iam_account_alias aws_iam_account_alias} Resource.
...
func (j *jsiiProxy_IamAccountAlias)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_IamAccountAlias)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_IamAccountAlias)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func IamAccountAlias_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (i *jsiiProxy_IamAccountAlias) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (i *jsiiProxy_IamAccountAlias) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (i *jsiiProxy_IamAccountAlias) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (i *jsiiProxy_IamAccountAlias) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (i *jsiiProxy_IamAccountAlias) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (i *jsiiProxy_IamAccountAlias) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
