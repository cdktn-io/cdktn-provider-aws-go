...
func (j *jsiiProxy_LightsailCertificateDomainValidationOptionsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewLightsailCertificateDomainValidationOptionsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) LightsailCertificateDomainValidationOptionsList {
	_init_.Initialize()
...
func NewLightsailCertificateDomainValidationOptionsList_Override(l LightsailCertificateDomainValidationOptionsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_LightsailCertificateDomainValidationOptionsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (l *jsiiProxy_LightsailCertificateDomainValidationOptionsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (l *jsiiProxy_LightsailCertificateDomainValidationOptionsList) Resolve(context cdktn.IResolveContext) interface{} {
