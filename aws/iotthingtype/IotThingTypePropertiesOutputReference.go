...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v22/iotthingtype/internal"
...
func (i *jsiiProxy_IotThingTypePropertiesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (i *jsiiProxy_IotThingTypePropertiesOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
