...
func (j *jsiiProxy_IotThingType) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_IotThingType) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_IotThingType) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_IotThingType) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_IotThingType) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/iot_thing_type aws_iot_thing_type} Resource.
...
func (j *jsiiProxy_IotThingType)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_IotThingType)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_IotThingType)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func IotThingType_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (i *jsiiProxy_IotThingType) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (i *jsiiProxy_IotThingType) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (i *jsiiProxy_IotThingType) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (i *jsiiProxy_IotThingType) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (i *jsiiProxy_IotThingType) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (i *jsiiProxy_IotThingType) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
