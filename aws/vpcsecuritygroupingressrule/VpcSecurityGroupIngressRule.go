...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/vpcsecuritygroupingressrule/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/vpc_security_group_ingress_rule aws_vpc_security_group_ingress_rule}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/vpc_security_group_ingress_rule aws_vpc_security_group_ingress_rule} Resource.
...
func (v *jsiiProxy_VpcSecurityGroupIngressRule) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (v *jsiiProxy_VpcSecurityGroupIngressRule) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (v *jsiiProxy_VpcSecurityGroupIngressRule) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
