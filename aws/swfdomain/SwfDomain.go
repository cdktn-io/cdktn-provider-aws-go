...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/swfdomain/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/swf_domain aws_swf_domain}.
...
func (j *jsiiProxy_SwfDomain) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_SwfDomain) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_SwfDomain) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_SwfDomain) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_SwfDomain) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_SwfDomain) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_SwfDomain) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/swf_domain aws_swf_domain} Resource.
...
func (j *jsiiProxy_SwfDomain)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_SwfDomain)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_SwfDomain)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_SwfDomain)SetRegion(val *string) {
...
func SwfDomain_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (s *jsiiProxy_SwfDomain) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SwfDomain) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_SwfDomain) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SwfDomain) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_SwfDomain) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_SwfDomain) ResetRegion() {
	_jsii_.InvokeVoid(
		s,
		"resetRegion",
		nil, // no parameters
...
func (s *jsiiProxy_SwfDomain) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
