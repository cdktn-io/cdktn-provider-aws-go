...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v22/dataawsssminstances/internal"
...
func (d *jsiiProxy_DataAwsSsmInstancesFilterOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataAwsSsmInstancesFilterOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
