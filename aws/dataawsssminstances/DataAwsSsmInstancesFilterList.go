...
func (j *jsiiProxy_DataAwsSsmInstancesFilterList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsSsmInstancesFilterList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsSsmInstancesFilterList {
	_init_.Initialize()
...
func NewDataAwsSsmInstancesFilterList_Override(d DataAwsSsmInstancesFilterList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsSsmInstancesFilterList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsSsmInstancesFilterList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsSsmInstancesFilterList) Resolve(context cdktn.IResolveContext) interface{} {
