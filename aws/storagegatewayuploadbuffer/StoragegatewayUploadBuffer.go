...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/storagegatewayuploadbuffer/internal"
...
func (j *jsiiProxy_StoragegatewayUploadBuffer) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_StoragegatewayUploadBuffer) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_StoragegatewayUploadBuffer) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_StoragegatewayUploadBuffer) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_StoragegatewayUploadBuffer) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_StoragegatewayUploadBuffer) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_StoragegatewayUploadBuffer) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/storagegateway_upload_buffer aws_storagegateway_upload_buffer} Resource.
...
func (j *jsiiProxy_StoragegatewayUploadBuffer)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_StoragegatewayUploadBuffer)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_StoragegatewayUploadBuffer)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_StoragegatewayUploadBuffer)SetRegion(val *string) {
...
func StoragegatewayUploadBuffer_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (s *jsiiProxy_StoragegatewayUploadBuffer) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_StoragegatewayUploadBuffer) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_StoragegatewayUploadBuffer) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_StoragegatewayUploadBuffer) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_StoragegatewayUploadBuffer) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_StoragegatewayUploadBuffer) ResetRegion() {
	_jsii_.InvokeVoid(
		s,
		"resetRegion",
		nil, // no parameters
...
func (s *jsiiProxy_StoragegatewayUploadBuffer) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
