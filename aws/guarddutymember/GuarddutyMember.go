...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v22/guarddutymember/internal"
...
func GuarddutyMember_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (g *jsiiProxy_GuarddutyMember) ImportFrom(id *string, provider cdktf.TerraformProvider) {
