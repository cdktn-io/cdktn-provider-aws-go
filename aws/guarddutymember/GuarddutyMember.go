...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/guarddutymember/internal"
...
func (j *jsiiProxy_GuarddutyMember) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_GuarddutyMember) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_GuarddutyMember) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_GuarddutyMember) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_GuarddutyMember) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_GuarddutyMember) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_GuarddutyMember) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_GuarddutyMember)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_GuarddutyMember)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_GuarddutyMember)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_GuarddutyMember)SetRegion(val *string) {
...
func GuarddutyMember_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateGuarddutyMember_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
// Experimental.
func GuarddutyMember_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateGuarddutyMember_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func GuarddutyMember_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateGuarddutyMember_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (g *jsiiProxy_GuarddutyMember) AddMoveTarget(moveTarget *string) {
...
func (g *jsiiProxy_GuarddutyMember) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GuarddutyMember) HasResourceMove() interface{} {
	var returns interface{}
...
func (g *jsiiProxy_GuarddutyMember) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (g *jsiiProxy_GuarddutyMember) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GuarddutyMember) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GuarddutyMember) MoveFromId(id *string) {
...
func (g *jsiiProxy_GuarddutyMember) MoveTo(moveTarget *string, index interface{}) {
...
func (g *jsiiProxy_GuarddutyMember) MoveToId(id *string) {
...
func (g *jsiiProxy_GuarddutyMember) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (g *jsiiProxy_GuarddutyMember) ResetRegion() {
	_jsii_.InvokeVoid(
		g,
		"resetRegion",
		nil, // no parameters
...
func (g *jsiiProxy_GuarddutyMember) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (g *jsiiProxy_GuarddutyMember) ToHclTerraform() interface{} {
	var returns interface{}
...
func (g *jsiiProxy_GuarddutyMember) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
