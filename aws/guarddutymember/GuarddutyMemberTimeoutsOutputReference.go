...
func (g *jsiiProxy_GuarddutyMemberTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GuarddutyMemberTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
