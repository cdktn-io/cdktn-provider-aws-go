...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/ec2transitgatewaymulticastdomainassociation/internal"
...
func (j *jsiiProxy_Ec2TransitGatewayMulticastDomainAssociation) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_Ec2TransitGatewayMulticastDomainAssociation) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_Ec2TransitGatewayMulticastDomainAssociation) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_Ec2TransitGatewayMulticastDomainAssociation) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_Ec2TransitGatewayMulticastDomainAssociation) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/ec2_transit_gateway_multicast_domain_association aws_ec2_transit_gateway_multicast_domain_association} Resource.
...
func (j *jsiiProxy_Ec2TransitGatewayMulticastDomainAssociation)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_Ec2TransitGatewayMulticastDomainAssociation)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_Ec2TransitGatewayMulticastDomainAssociation)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func Ec2TransitGatewayMulticastDomainAssociation_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (e *jsiiProxy_Ec2TransitGatewayMulticastDomainAssociation) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (e *jsiiProxy_Ec2TransitGatewayMulticastDomainAssociation) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (e *jsiiProxy_Ec2TransitGatewayMulticastDomainAssociation) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (e *jsiiProxy_Ec2TransitGatewayMulticastDomainAssociation) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (e *jsiiProxy_Ec2TransitGatewayMulticastDomainAssociation) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (e *jsiiProxy_Ec2TransitGatewayMulticastDomainAssociation) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
