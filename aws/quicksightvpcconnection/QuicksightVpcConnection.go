...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v22/quicksightvpcconnection/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.31.0/docs/resources/quicksight_vpc_connection aws_quicksight_vpc_connection}.
...
func (j *jsiiProxy_QuicksightVpcConnection) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_QuicksightVpcConnection) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_QuicksightVpcConnection) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_QuicksightVpcConnection) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_QuicksightVpcConnection) TagsAll() cdktf.StringMap {
...
func (j *jsiiProxy_QuicksightVpcConnection) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.31.0/docs/resources/quicksight_vpc_connection aws_quicksight_vpc_connection} Resource.
...
func (j *jsiiProxy_QuicksightVpcConnection)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_QuicksightVpcConnection)SetLifecycle(val *cdktf.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_QuicksightVpcConnection)SetProvider(val cdktf.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func QuicksightVpcConnection_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (q *jsiiProxy_QuicksightVpcConnection) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (q *jsiiProxy_QuicksightVpcConnection) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (q *jsiiProxy_QuicksightVpcConnection) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
