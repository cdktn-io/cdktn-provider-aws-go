...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/dataawsmskbrokernodes/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/data-sources/msk_broker_nodes aws_msk_broker_nodes}.
...
func (j *jsiiProxy_DataAwsMskBrokerNodes) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsMskBrokerNodes) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsMskBrokerNodes) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsMskBrokerNodes) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsMskBrokerNodes) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/data-sources/msk_broker_nodes aws_msk_broker_nodes} Data Source.
func NewDataAwsMskBrokerNodes(scope constructs.Construct, id *string, config *DataAwsMskBrokerNodesConfig) DataAwsMskBrokerNodes {
	...
	_jsii_.Create(
		"@cdktn/provider-aws.dataAwsMskBrokerNodes.DataAwsMskBrokerNodes",
...
func (j *jsiiProxy_DataAwsMskBrokerNodes)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsMskBrokerNodes)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsMskBrokerNodes)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsMskBrokerNodes_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateDataAwsMskBrokerNodes_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
// Experimental.
func DataAwsMskBrokerNodes_IsTerraformDataSource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataAwsMskBrokerNodes_IsTerraformDataSourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataAwsMskBrokerNodes_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataAwsMskBrokerNodes_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (d *jsiiProxy_DataAwsMskBrokerNodes) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsMskBrokerNodes) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsMskBrokerNodes) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsMskBrokerNodes) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataAwsMskBrokerNodes) ToHclTerraform() interface{} {
	var returns interface{}
