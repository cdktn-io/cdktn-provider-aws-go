...
func (j *jsiiProxy_FsxFileCacheLustreConfigurationMetadataConfigurationList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewFsxFileCacheLustreConfigurationMetadataConfigurationList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) FsxFileCacheLustreConfigurationMetadataConfigurationList {
	_init_.Initialize()
...
func NewFsxFileCacheLustreConfigurationMetadataConfigurationList_Override(f FsxFileCacheLustreConfigurationMetadataConfigurationList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_FsxFileCacheLustreConfigurationMetadataConfigurationList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (f *jsiiProxy_FsxFileCacheLustreConfigurationMetadataConfigurationList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (f *jsiiProxy_FsxFileCacheLustreConfigurationMetadataConfigurationList) Resolve(context cdktn.IResolveContext) interface{} {
