...
func (j *jsiiProxy_BedrockagentcoreOauth2CredentialProviderClientSecretArnList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewBedrockagentcoreOauth2CredentialProviderClientSecretArnList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) BedrockagentcoreOauth2CredentialProviderClientSecretArnList {
	_init_.Initialize()
...
func NewBedrockagentcoreOauth2CredentialProviderClientSecretArnList_Override(b BedrockagentcoreOauth2CredentialProviderClientSecretArnList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_BedrockagentcoreOauth2CredentialProviderClientSecretArnList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (b *jsiiProxy_BedrockagentcoreOauth2CredentialProviderClientSecretArnList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (b *jsiiProxy_BedrockagentcoreOauth2CredentialProviderClientSecretArnList) Resolve(context cdktn.IResolveContext) interface{} {
