...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/mskscramsecretassociation/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/msk_scram_secret_association aws_msk_scram_secret_association}.
...
func (j *jsiiProxy_MskScramSecretAssociation) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_MskScramSecretAssociation) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_MskScramSecretAssociation) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_MskScramSecretAssociation) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_MskScramSecretAssociation) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_MskScramSecretAssociation) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_MskScramSecretAssociation) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/msk_scram_secret_association aws_msk_scram_secret_association} Resource.
...
func (j *jsiiProxy_MskScramSecretAssociation)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_MskScramSecretAssociation)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_MskScramSecretAssociation)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_MskScramSecretAssociation)SetRegion(val *string) {
...
func MskScramSecretAssociation_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (m *jsiiProxy_MskScramSecretAssociation) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MskScramSecretAssociation) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (m *jsiiProxy_MskScramSecretAssociation) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MskScramSecretAssociation) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (m *jsiiProxy_MskScramSecretAssociation) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (m *jsiiProxy_MskScramSecretAssociation) ResetRegion() {
	_jsii_.InvokeVoid(
		m,
		"resetRegion",
		nil, // no parameters
...
func (m *jsiiProxy_MskScramSecretAssociation) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
