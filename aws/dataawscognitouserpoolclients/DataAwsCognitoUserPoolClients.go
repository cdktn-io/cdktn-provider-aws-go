...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/dataawscognitouserpoolclients/internal"
...
func (j *jsiiProxy_DataAwsCognitoUserPoolClients) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsCognitoUserPoolClients) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsCognitoUserPoolClients) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsCognitoUserPoolClients) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsCognitoUserPoolClients) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DataAwsCognitoUserPoolClients)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsCognitoUserPoolClients)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsCognitoUserPoolClients)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsCognitoUserPoolClients_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsCognitoUserPoolClients) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsCognitoUserPoolClients) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsCognitoUserPoolClients) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsCognitoUserPoolClients) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
