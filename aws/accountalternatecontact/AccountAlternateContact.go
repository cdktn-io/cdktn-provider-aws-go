...
func (j *jsiiProxy_AccountAlternateContact) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_AccountAlternateContact) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_AccountAlternateContact) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_AccountAlternateContact) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_AccountAlternateContact) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/account_alternate_contact aws_account_alternate_contact} Resource.
func NewAccountAlternateContact(scope constructs.Construct, id *string, config *AccountAlternateContactConfig) AccountAlternateContact {
	...
	_jsii_.Create(
		"@cdktn/provider-aws.accountAlternateContact.AccountAlternateContact",
...
func (j *jsiiProxy_AccountAlternateContact)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_AccountAlternateContact)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_AccountAlternateContact)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func AccountAlternateContact_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (a *jsiiProxy_AccountAlternateContact) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AccountAlternateContact) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (a *jsiiProxy_AccountAlternateContact) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AccountAlternateContact) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (a *jsiiProxy_AccountAlternateContact) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (a *jsiiProxy_AccountAlternateContact) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
