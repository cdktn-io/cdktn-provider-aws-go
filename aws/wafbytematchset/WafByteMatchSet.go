...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/wafbytematchset/internal"
...
func (j *jsiiProxy_WafByteMatchSet) ByteMatchTuples() WafByteMatchSetByteMatchTuplesList {
	var returns WafByteMatchSetByteMatchTuplesList
	_jsii_.Get(
		j,
		"byteMatchTuples",
		&returns,
...
func (j *jsiiProxy_WafByteMatchSet) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_WafByteMatchSet) Connection() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"connection",
...
func (j *jsiiProxy_WafByteMatchSet) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_WafByteMatchSet) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_WafByteMatchSet) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_WafByteMatchSet) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_WafByteMatchSet) Provisioners() *[]interface{} {
	var returns *[]interface{}
	_jsii_.Get(
		j,
		"provisioners",
...
func (j *jsiiProxy_WafByteMatchSet) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/waf_byte_match_set aws_waf_byte_match_set} Resource.
func NewWafByteMatchSet(scope constructs.Construct, id *string, config *WafByteMatchSetConfig) WafByteMatchSet {
	_init_.Initialize()

	if err := validateNewWafByteMatchSetParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_WafByteMatchSet)SetConnection(val interface{}) {
...
func (j *jsiiProxy_WafByteMatchSet)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_WafByteMatchSet)SetId(val *string) {
...
func (j *jsiiProxy_WafByteMatchSet)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_WafByteMatchSet)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_WafByteMatchSet)SetProvisioners(val *[]interface{}) {
...
func WafByteMatchSet_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateWafByteMatchSet_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func WafByteMatchSet_IsConstruct(x interface{}) *bool {
	...
	if err := validateWafByteMatchSet_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func WafByteMatchSet_IsTerraformElement(x interface{}) *bool {
	...
	if err := validateWafByteMatchSet_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func WafByteMatchSet_IsTerraformResource(x interface{}) *bool {
	...
	if err := validateWafByteMatchSet_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (w *jsiiProxy_WafByteMatchSet) AddMoveTarget(moveTarget *string) {
...
func (w *jsiiProxy_WafByteMatchSet) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_WafByteMatchSet) HasResourceMove() interface{} {
	var returns interface{}
...
func (w *jsiiProxy_WafByteMatchSet) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (w *jsiiProxy_WafByteMatchSet) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_WafByteMatchSet) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (w *jsiiProxy_WafByteMatchSet) MoveFromId(id *string) {
...
func (w *jsiiProxy_WafByteMatchSet) MoveTo(moveTarget *string, index interface{}) {
...
func (w *jsiiProxy_WafByteMatchSet) MoveToId(id *string) {
...
func (w *jsiiProxy_WafByteMatchSet) PutByteMatchTuples(value interface{}) {
...
func (w *jsiiProxy_WafByteMatchSet) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (w *jsiiProxy_WafByteMatchSet) ResetId() {
	_jsii_.InvokeVoid(
		w,
		"resetId",
		nil, // no parameters
...
func (w *jsiiProxy_WafByteMatchSet) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (w *jsiiProxy_WafByteMatchSet) ToHclTerraform() interface{} {
	var returns interface{}
...
func (w *jsiiProxy_WafByteMatchSet) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
