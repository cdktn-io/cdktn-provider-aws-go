...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v22/wafbytematchset/internal"
...
func (j *jsiiProxy_WafByteMatchSet) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_WafByteMatchSet)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (w *jsiiProxy_WafByteMatchSet) ImportFrom(id *string, provider cdktf.TerraformProvider) {
