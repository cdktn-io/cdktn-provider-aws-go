...
func (j *jsiiProxy_WafByteMatchSetByteMatchTuplesFieldToMatchOutputReference) ComplexObjectIndex() interface{} {
...
func (j *jsiiProxy_WafByteMatchSetByteMatchTuplesFieldToMatchOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_WafByteMatchSetByteMatchTuplesFieldToMatchOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_WafByteMatchSetByteMatchTuplesFieldToMatchOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_WafByteMatchSetByteMatchTuplesFieldToMatchOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewWafByteMatchSetByteMatchTuplesFieldToMatchOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) WafByteMatchSetByteMatchTuplesFieldToMatchOutputReference {
	_init_.Initialize()

	if err := validateNewWafByteMatchSetByteMatchTuplesFieldToMatchOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
	j := jsiiProxy_WafByteMatchSetByteMatchTuplesFieldToMatchOutputReference{}

	_jsii_.Create(
		"@cdktn/provider-aws.wafByteMatchSet.WafByteMatchSetByteMatchTuplesFieldToMatchOutputReference",
...
func NewWafByteMatchSetByteMatchTuplesFieldToMatchOutputReference_Override(w WafByteMatchSetByteMatchTuplesFieldToMatchOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_WafByteMatchSetByteMatchTuplesFieldToMatchOutputReference)SetComplexObjectIndex(val interface{}) {
...
func (j *jsiiProxy_WafByteMatchSetByteMatchTuplesFieldToMatchOutputReference)SetComplexObjectIsFromSet(val *bool) {
...
func (j *jsiiProxy_WafByteMatchSetByteMatchTuplesFieldToMatchOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (w *jsiiProxy_WafByteMatchSetByteMatchTuplesFieldToMatchOutputReference) ComputeFqn() *string {
	var returns *string
...
func (w *jsiiProxy_WafByteMatchSetByteMatchTuplesFieldToMatchOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_WafByteMatchSetByteMatchTuplesFieldToMatchOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (w *jsiiProxy_WafByteMatchSetByteMatchTuplesFieldToMatchOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_WafByteMatchSetByteMatchTuplesFieldToMatchOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
...
func (w *jsiiProxy_WafByteMatchSetByteMatchTuplesFieldToMatchOutputReference) ToString() *string {
	var returns *string
