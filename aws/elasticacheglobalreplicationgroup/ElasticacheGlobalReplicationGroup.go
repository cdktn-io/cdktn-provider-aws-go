...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.44.0/docs/resources/elasticache_global_replication_group aws_elasticache_global_replication_group}.
...
func (j *jsiiProxy_ElasticacheGlobalReplicationGroup) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_ElasticacheGlobalReplicationGroup) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.44.0/docs/resources/elasticache_global_replication_group aws_elasticache_global_replication_group} Resource.
...
func (j *jsiiProxy_ElasticacheGlobalReplicationGroup)SetRegion(val *string) {
...
func (e *jsiiProxy_ElasticacheGlobalReplicationGroup) ResetRegion() {
	_jsii_.InvokeVoid(
		e,
		"resetRegion",
		nil, // no parameters
