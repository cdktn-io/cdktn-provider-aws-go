...
func (j *jsiiProxy_PaymentcryptographyKeyKeyAttributesKeyModesOfUseOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewPaymentcryptographyKeyKeyAttributesKeyModesOfUseOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) PaymentcryptographyKeyKeyAttributesKeyModesOfUseOutputReference {
	_init_.Initialize()
...
func NewPaymentcryptographyKeyKeyAttributesKeyModesOfUseOutputReference_Override(p PaymentcryptographyKeyKeyAttributesKeyModesOfUseOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_PaymentcryptographyKeyKeyAttributesKeyModesOfUseOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (p *jsiiProxy_PaymentcryptographyKeyKeyAttributesKeyModesOfUseOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PaymentcryptographyKeyKeyAttributesKeyModesOfUseOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (p *jsiiProxy_PaymentcryptographyKeyKeyAttributesKeyModesOfUseOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PaymentcryptographyKeyKeyAttributesKeyModesOfUseOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
