...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/dataawsroute53zone/internal"
...
func (j *jsiiProxy_DataAwsRoute53Zone) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsRoute53Zone) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsRoute53Zone) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsRoute53Zone) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsRoute53Zone) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/data-sources/route53_zone aws_route53_zone} Data Source.
...
func (j *jsiiProxy_DataAwsRoute53Zone)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsRoute53Zone)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsRoute53Zone)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsRoute53Zone_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsRoute53Zone) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsRoute53Zone) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsRoute53Zone) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsRoute53Zone) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
