...
func (v *jsiiProxy_VpcPeeringConnectionAccepterOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (v *jsiiProxy_VpcPeeringConnectionAccepterOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
