...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/vpcpeeringconnection/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/vpc_peering_connection aws_vpc_peering_connection}.
...
func (j *jsiiProxy_VpcPeeringConnection) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_VpcPeeringConnection) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_VpcPeeringConnection) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_VpcPeeringConnection) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_VpcPeeringConnection) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/vpc_peering_connection aws_vpc_peering_connection} Resource.
...
func (j *jsiiProxy_VpcPeeringConnection)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_VpcPeeringConnection)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_VpcPeeringConnection)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func VpcPeeringConnection_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (v *jsiiProxy_VpcPeeringConnection) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (v *jsiiProxy_VpcPeeringConnection) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (v *jsiiProxy_VpcPeeringConnection) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (v *jsiiProxy_VpcPeeringConnection) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (v *jsiiProxy_VpcPeeringConnection) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (v *jsiiProxy_VpcPeeringConnection) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
