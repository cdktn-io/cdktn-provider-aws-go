...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/mskconfiguration/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/msk_configuration aws_msk_configuration}.
...
func (j *jsiiProxy_MskConfiguration) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_MskConfiguration) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_MskConfiguration) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_MskConfiguration) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_MskConfiguration) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_MskConfiguration) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_MskConfiguration) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/msk_configuration aws_msk_configuration} Resource.
func NewMskConfiguration(scope constructs.Construct, id *string, config *MskConfigurationConfig) MskConfiguration {
	...
	_jsii_.Create(
		"@cdktn/provider-aws.mskConfiguration.MskConfiguration",
...
func (j *jsiiProxy_MskConfiguration)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_MskConfiguration)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_MskConfiguration)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_MskConfiguration)SetRegion(val *string) {
...
func MskConfiguration_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateMskConfiguration_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
// Experimental.
func MskConfiguration_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateMskConfiguration_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func MskConfiguration_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateMskConfiguration_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (m *jsiiProxy_MskConfiguration) AddMoveTarget(moveTarget *string) {
...
func (m *jsiiProxy_MskConfiguration) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MskConfiguration) HasResourceMove() interface{} {
	var returns interface{}
...
func (m *jsiiProxy_MskConfiguration) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (m *jsiiProxy_MskConfiguration) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MskConfiguration) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (m *jsiiProxy_MskConfiguration) MoveFromId(id *string) {
...
func (m *jsiiProxy_MskConfiguration) MoveTo(moveTarget *string, index interface{}) {
...
func (m *jsiiProxy_MskConfiguration) MoveToId(id *string) {
...
func (m *jsiiProxy_MskConfiguration) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (m *jsiiProxy_MskConfiguration) ResetRegion() {
	_jsii_.InvokeVoid(
		m,
		"resetRegion",
		nil, // no parameters
...
func (m *jsiiProxy_MskConfiguration) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (m *jsiiProxy_MskConfiguration) ToHclTerraform() interface{} {
	var returns interface{}
...
func (m *jsiiProxy_MskConfiguration) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
