...
func (e *jsiiProxy_ElasticacheServerlessCacheReaderEndpointList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (e *jsiiProxy_ElasticacheServerlessCacheReaderEndpointList) validateGetParameters(index *float64) error {
	if index == nil {
...
func (j *jsiiProxy_ElasticacheServerlessCacheReaderEndpointList) validateSetTerraformAttributeParameters(val *string) error {
	if val == nil {
...
func (j *jsiiProxy_ElasticacheServerlessCacheReaderEndpointList) validateSetWrapsSetParameters(val *bool) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
