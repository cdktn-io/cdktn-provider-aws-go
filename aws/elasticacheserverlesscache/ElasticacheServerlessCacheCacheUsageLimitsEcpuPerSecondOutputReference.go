...
func NewElasticacheServerlessCacheCacheUsageLimitsEcpuPerSecondOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) ElasticacheServerlessCacheCacheUsageLimitsEcpuPerSecondOutputReference {
	_init_.Initialize()
...
func NewElasticacheServerlessCacheCacheUsageLimitsEcpuPerSecondOutputReference_Override(e ElasticacheServerlessCacheCacheUsageLimitsEcpuPerSecondOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
