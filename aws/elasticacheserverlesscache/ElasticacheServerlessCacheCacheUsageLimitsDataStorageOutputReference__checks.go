...
func (e *jsiiProxy_ElasticacheServerlessCacheCacheUsageLimitsDataStorageOutputReference) validateResolveParameters(context cdktf.IResolveContext) error {
	if context == nil {
...
func (j *jsiiProxy_ElasticacheServerlessCacheCacheUsageLimitsDataStorageOutputReference) validateSetInternalValueParameters(val interface{}) error {
	...
	case cdktf.IResolvable:
		// ok
	case *ElasticacheServerlessCacheCacheUsageLimitsDataStorage:
		val := val.(*ElasticacheServerlessCacheCacheUsageLimitsDataStorage)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case ElasticacheServerlessCacheCacheUsageLimitsDataStorage:
		val_ := val.(ElasticacheServerlessCacheCacheUsageLimitsDataStorage)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktf.IResolvable, *ElasticacheServerlessCacheCacheUsageLimitsDataStorage; received %#v (a %T)", val, val)
		}
	}
...
func (j *jsiiProxy_ElasticacheServerlessCacheCacheUsageLimitsDataStorageOutputReference) validateSetTerraformResourceParameters(val cdktf.IInterpolatingParent) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func validateNewElasticacheServerlessCacheCacheUsageLimitsDataStorageOutputReferenceParameters(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) error {
