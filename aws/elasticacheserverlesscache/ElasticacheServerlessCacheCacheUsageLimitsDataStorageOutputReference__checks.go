...
func (j *jsiiProxy_ElasticacheServerlessCacheCacheUsageLimitsDataStorageOutputReference) validateSetInternalValueParameters(val interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktn.IResolvable, *ElasticacheServerlessCacheCacheUsageLimitsDataStorage; received %#v (a %T)", val, val)
		}
	}
...
func validateNewElasticacheServerlessCacheCacheUsageLimitsDataStorageOutputReferenceParameters(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) error {
