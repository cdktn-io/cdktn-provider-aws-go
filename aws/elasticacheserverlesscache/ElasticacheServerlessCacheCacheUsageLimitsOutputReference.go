...
func NewElasticacheServerlessCacheCacheUsageLimitsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) ElasticacheServerlessCacheCacheUsageLimitsOutputReference {
	_init_.Initialize()
...
func NewElasticacheServerlessCacheCacheUsageLimitsOutputReference_Override(e ElasticacheServerlessCacheCacheUsageLimitsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
