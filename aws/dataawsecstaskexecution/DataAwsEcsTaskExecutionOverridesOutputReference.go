...
func (d *jsiiProxy_DataAwsEcsTaskExecutionOverridesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataAwsEcsTaskExecutionOverridesOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
