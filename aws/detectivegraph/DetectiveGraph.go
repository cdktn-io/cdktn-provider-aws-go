...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/detectivegraph/internal"
...
func (j *jsiiProxy_DetectiveGraph) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DetectiveGraph) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DetectiveGraph) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DetectiveGraph) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DetectiveGraph) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DetectiveGraph)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DetectiveGraph)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DetectiveGraph)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DetectiveGraph_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DetectiveGraph) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DetectiveGraph) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (d *jsiiProxy_DetectiveGraph) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DetectiveGraph) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (d *jsiiProxy_DetectiveGraph) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DetectiveGraph) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
