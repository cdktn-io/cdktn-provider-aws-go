...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/dataawsmskconnectcustomplugin/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/data-sources/mskconnect_custom_plugin aws_mskconnect_custom_plugin}.
...
func (j *jsiiProxy_DataAwsMskconnectCustomPlugin) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsMskconnectCustomPlugin) Count() interface{} {
...
func (j *jsiiProxy_DataAwsMskconnectCustomPlugin) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsMskconnectCustomPlugin) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsMskconnectCustomPlugin) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsMskconnectCustomPlugin) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DataAwsMskconnectCustomPlugin) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_DataAwsMskconnectCustomPlugin) Tags() *map[string]*string {
...
func (j *jsiiProxy_DataAwsMskconnectCustomPlugin) TagsInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsInput",
...
func (j *jsiiProxy_DataAwsMskconnectCustomPlugin) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/data-sources/mskconnect_custom_plugin aws_mskconnect_custom_plugin} Data Source.
...
func (j *jsiiProxy_DataAwsMskconnectCustomPlugin)SetCount(val interface{}) {
...
func (j *jsiiProxy_DataAwsMskconnectCustomPlugin)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsMskconnectCustomPlugin)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsMskconnectCustomPlugin)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_DataAwsMskconnectCustomPlugin)SetRegion(val *string) {
...
func (j *jsiiProxy_DataAwsMskconnectCustomPlugin)SetTags(val *map[string]*string) {
...
// Generates CDKTN code for importing a DataAwsMskconnectCustomPlugin resource upon running "cdktn plan <stack-name>".
func DataAwsMskconnectCustomPlugin_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateDataAwsMskconnectCustomPlugin_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
// Experimental.
func DataAwsMskconnectCustomPlugin_IsTerraformDataSource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataAwsMskconnectCustomPlugin_IsTerraformDataSourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataAwsMskconnectCustomPlugin_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataAwsMskconnectCustomPlugin_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (d *jsiiProxy_DataAwsMskconnectCustomPlugin) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsMskconnectCustomPlugin) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsMskconnectCustomPlugin) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsMskconnectCustomPlugin) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsMskconnectCustomPlugin) ResetTags() {
	_jsii_.InvokeVoid(
		d,
		"resetTags",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsMskconnectCustomPlugin) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataAwsMskconnectCustomPlugin) ToHclTerraform() interface{} {
	var returns interface{}
...
func (d *jsiiProxy_DataAwsMskconnectCustomPlugin) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
