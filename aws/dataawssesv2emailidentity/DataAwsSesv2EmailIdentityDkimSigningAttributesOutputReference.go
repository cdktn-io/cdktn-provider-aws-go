...
func (d *jsiiProxy_DataAwsSesv2EmailIdentityDkimSigningAttributesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataAwsSesv2EmailIdentityDkimSigningAttributesOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
