...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v21/dmsreplicationinstance/internal"
...
func (d *jsiiProxy_DmsReplicationInstanceKerberosAuthenticationSettingsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DmsReplicationInstanceKerberosAuthenticationSettingsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
