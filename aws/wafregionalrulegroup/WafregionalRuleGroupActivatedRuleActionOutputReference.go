...
func (w *jsiiProxy_WafregionalRuleGroupActivatedRuleActionOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (w *jsiiProxy_WafregionalRuleGroupActivatedRuleActionOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
