...
func (j *jsiiProxy_WafregionalRuleGroupActivatedRuleList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewWafregionalRuleGroupActivatedRuleList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) WafregionalRuleGroupActivatedRuleList {
	_init_.Initialize()
...
func NewWafregionalRuleGroupActivatedRuleList_Override(w WafregionalRuleGroupActivatedRuleList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_WafregionalRuleGroupActivatedRuleList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (w *jsiiProxy_WafregionalRuleGroupActivatedRuleList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (w *jsiiProxy_WafregionalRuleGroupActivatedRuleList) Resolve(context cdktn.IResolveContext) interface{} {
