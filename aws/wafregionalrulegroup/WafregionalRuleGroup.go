...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/wafregional_rule_group aws_wafregional_rule_group}.
...
func (j *jsiiProxy_WafregionalRuleGroup) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_WafregionalRuleGroup) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/wafregional_rule_group aws_wafregional_rule_group} Resource.
...
func (j *jsiiProxy_WafregionalRuleGroup)SetRegion(val *string) {
...
func (w *jsiiProxy_WafregionalRuleGroup) AddMoveTarget(moveTarget *string) {
...
func (w *jsiiProxy_WafregionalRuleGroup) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (w *jsiiProxy_WafregionalRuleGroup) MoveFromId(id *string) {
...
func (w *jsiiProxy_WafregionalRuleGroup) MoveToId(id *string) {
...
func (w *jsiiProxy_WafregionalRuleGroup) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (w *jsiiProxy_WafregionalRuleGroup) ResetRegion() {
	_jsii_.InvokeVoid(
		w,
		"resetRegion",
		nil, // no parameters
...
func (w *jsiiProxy_WafregionalRuleGroup) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
