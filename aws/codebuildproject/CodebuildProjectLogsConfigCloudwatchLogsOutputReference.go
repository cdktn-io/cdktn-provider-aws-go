...
func (c *jsiiProxy_CodebuildProjectLogsConfigCloudwatchLogsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CodebuildProjectLogsConfigCloudwatchLogsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
