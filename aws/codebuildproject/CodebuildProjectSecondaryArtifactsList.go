...
func (j *jsiiProxy_CodebuildProjectSecondaryArtifactsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewCodebuildProjectSecondaryArtifactsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) CodebuildProjectSecondaryArtifactsList {
	_init_.Initialize()
...
func NewCodebuildProjectSecondaryArtifactsList_Override(c CodebuildProjectSecondaryArtifactsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_CodebuildProjectSecondaryArtifactsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_CodebuildProjectSecondaryArtifactsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (c *jsiiProxy_CodebuildProjectSecondaryArtifactsList) Resolve(context cdktn.IResolveContext) interface{} {
