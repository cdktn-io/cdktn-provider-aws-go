...
func (c *jsiiProxy_CodebuildProjectSourceBuildStatusConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CodebuildProjectSourceBuildStatusConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
