...
func (j *jsiiProxy_CodebuildProjectFileSystemLocationsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewCodebuildProjectFileSystemLocationsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) CodebuildProjectFileSystemLocationsList {
	_init_.Initialize()
...
func NewCodebuildProjectFileSystemLocationsList_Override(c CodebuildProjectFileSystemLocationsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_CodebuildProjectFileSystemLocationsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_CodebuildProjectFileSystemLocationsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (c *jsiiProxy_CodebuildProjectFileSystemLocationsList) Resolve(context cdktn.IResolveContext) interface{} {
