...
func (c *jsiiProxy_CodebuildProjectEnvironmentEnvironmentVariableList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (c *jsiiProxy_CodebuildProjectEnvironmentEnvironmentVariableList) Resolve(context cdktf.IResolveContext) interface{} {
