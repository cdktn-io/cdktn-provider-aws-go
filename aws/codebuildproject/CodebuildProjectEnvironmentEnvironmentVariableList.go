...
func (j *jsiiProxy_CodebuildProjectEnvironmentEnvironmentVariableList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewCodebuildProjectEnvironmentEnvironmentVariableList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) CodebuildProjectEnvironmentEnvironmentVariableList {
	_init_.Initialize()
...
func NewCodebuildProjectEnvironmentEnvironmentVariableList_Override(c CodebuildProjectEnvironmentEnvironmentVariableList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_CodebuildProjectEnvironmentEnvironmentVariableList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_CodebuildProjectEnvironmentEnvironmentVariableList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (c *jsiiProxy_CodebuildProjectEnvironmentEnvironmentVariableList) Resolve(context cdktn.IResolveContext) interface{} {
