...
func (j *jsiiProxy_CodebuildProjectSecondarySourceVersionList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewCodebuildProjectSecondarySourceVersionList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) CodebuildProjectSecondarySourceVersionList {
	_init_.Initialize()
...
func NewCodebuildProjectSecondarySourceVersionList_Override(c CodebuildProjectSecondarySourceVersionList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_CodebuildProjectSecondarySourceVersionList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_CodebuildProjectSecondarySourceVersionList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (c *jsiiProxy_CodebuildProjectSecondarySourceVersionList) Resolve(context cdktn.IResolveContext) interface{} {
