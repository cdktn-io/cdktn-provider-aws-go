...
func (j *jsiiProxy_CodebuildProjectSourceGitSubmodulesConfigOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewCodebuildProjectSourceGitSubmodulesConfigOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) CodebuildProjectSourceGitSubmodulesConfigOutputReference {
	_init_.Initialize()

	if err := validateNewCodebuildProjectSourceGitSubmodulesConfigOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewCodebuildProjectSourceGitSubmodulesConfigOutputReference_Override(c CodebuildProjectSourceGitSubmodulesConfigOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_CodebuildProjectSourceGitSubmodulesConfigOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_CodebuildProjectSourceGitSubmodulesConfigOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CodebuildProjectSourceGitSubmodulesConfigOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (c *jsiiProxy_CodebuildProjectSourceGitSubmodulesConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CodebuildProjectSourceGitSubmodulesConfigOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
