...
func (c *jsiiProxy_CodebuildProjectSourceGitSubmodulesConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CodebuildProjectSourceGitSubmodulesConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
