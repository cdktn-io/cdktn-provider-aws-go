...
func (j *jsiiProxy_CodebuildProjectSecondarySourcesList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewCodebuildProjectSecondarySourcesList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) CodebuildProjectSecondarySourcesList {
	_init_.Initialize()
...
func NewCodebuildProjectSecondarySourcesList_Override(c CodebuildProjectSecondarySourcesList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_CodebuildProjectSecondarySourcesList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_CodebuildProjectSecondarySourcesList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (c *jsiiProxy_CodebuildProjectSecondarySourcesList) Resolve(context cdktn.IResolveContext) interface{} {
