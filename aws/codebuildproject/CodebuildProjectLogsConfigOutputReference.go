...
func (j *jsiiProxy_CodebuildProjectLogsConfigOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewCodebuildProjectLogsConfigOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) CodebuildProjectLogsConfigOutputReference {
	_init_.Initialize()
...
func NewCodebuildProjectLogsConfigOutputReference_Override(c CodebuildProjectLogsConfigOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_CodebuildProjectLogsConfigOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_CodebuildProjectLogsConfigOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CodebuildProjectLogsConfigOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (c *jsiiProxy_CodebuildProjectLogsConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CodebuildProjectLogsConfigOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
