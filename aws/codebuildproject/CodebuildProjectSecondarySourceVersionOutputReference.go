...
func (c *jsiiProxy_CodebuildProjectSecondarySourceVersionOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CodebuildProjectSecondarySourceVersionOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
