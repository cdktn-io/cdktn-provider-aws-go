...
func (c *jsiiProxy_CodebuildProjectEnvironmentEnvironmentVariableOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CodebuildProjectEnvironmentEnvironmentVariableOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
