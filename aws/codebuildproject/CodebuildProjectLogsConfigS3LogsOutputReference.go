...
func (c *jsiiProxy_CodebuildProjectLogsConfigS3LogsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CodebuildProjectLogsConfigS3LogsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
