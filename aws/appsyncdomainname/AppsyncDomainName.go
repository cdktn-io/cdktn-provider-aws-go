...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/appsyncdomainname/internal"
...
func (j *jsiiProxy_AppsyncDomainName) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_AppsyncDomainName) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_AppsyncDomainName) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_AppsyncDomainName) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_AppsyncDomainName) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_AppsyncDomainName) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_AppsyncDomainName) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_AppsyncDomainName)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_AppsyncDomainName)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_AppsyncDomainName)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_AppsyncDomainName)SetRegion(val *string) {
...
func AppsyncDomainName_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (a *jsiiProxy_AppsyncDomainName) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AppsyncDomainName) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (a *jsiiProxy_AppsyncDomainName) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AppsyncDomainName) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (a *jsiiProxy_AppsyncDomainName) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (a *jsiiProxy_AppsyncDomainName) ResetRegion() {
	_jsii_.InvokeVoid(
		a,
		"resetRegion",
		nil, // no parameters
...
func (a *jsiiProxy_AppsyncDomainName) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
