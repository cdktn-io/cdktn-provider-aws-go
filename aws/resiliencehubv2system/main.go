...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*Resiliencehubv2System)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-aws.resiliencehubv2System.Resiliencehubv2SystemConfig",
		reflect.TypeOf((*Resiliencehubv2SystemConfig)(nil)).Elem(),
	)
}
