...
func (a *jsiiProxy_AccessanalyzerAnalyzerConfigurationUnusedAccessOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_AccessanalyzerAnalyzerConfigurationUnusedAccessOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
