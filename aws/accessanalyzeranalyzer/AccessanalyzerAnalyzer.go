...
func (j *jsiiProxy_AccessanalyzerAnalyzer) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_AccessanalyzerAnalyzer) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_AccessanalyzerAnalyzer) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_AccessanalyzerAnalyzer) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_AccessanalyzerAnalyzer) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_AccessanalyzerAnalyzer) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_AccessanalyzerAnalyzer) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_AccessanalyzerAnalyzer)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_AccessanalyzerAnalyzer)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_AccessanalyzerAnalyzer)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_AccessanalyzerAnalyzer)SetRegion(val *string) {
...
func AccessanalyzerAnalyzer_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (a *jsiiProxy_AccessanalyzerAnalyzer) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AccessanalyzerAnalyzer) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (a *jsiiProxy_AccessanalyzerAnalyzer) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AccessanalyzerAnalyzer) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (a *jsiiProxy_AccessanalyzerAnalyzer) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (a *jsiiProxy_AccessanalyzerAnalyzer) ResetRegion() {
	_jsii_.InvokeVoid(
		a,
		"resetRegion",
		nil, // no parameters
...
func (a *jsiiProxy_AccessanalyzerAnalyzer) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
