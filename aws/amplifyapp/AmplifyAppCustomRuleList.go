...
func (j *jsiiProxy_AmplifyAppCustomRuleList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewAmplifyAppCustomRuleList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) AmplifyAppCustomRuleList {
	_init_.Initialize()
...
func NewAmplifyAppCustomRuleList_Override(a AmplifyAppCustomRuleList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_AmplifyAppCustomRuleList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (a *jsiiProxy_AmplifyAppCustomRuleList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (a *jsiiProxy_AmplifyAppCustomRuleList) Resolve(context cdktn.IResolveContext) interface{} {
