...
func (j *jsiiProxy_AmplifyAppCustomRuleOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewAmplifyAppCustomRuleOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) AmplifyAppCustomRuleOutputReference {
	_init_.Initialize()

	if err := validateNewAmplifyAppCustomRuleOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func NewAmplifyAppCustomRuleOutputReference_Override(a AmplifyAppCustomRuleOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_AmplifyAppCustomRuleOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (a *jsiiProxy_AmplifyAppCustomRuleOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AmplifyAppCustomRuleOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (a *jsiiProxy_AmplifyAppCustomRuleOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AmplifyAppCustomRuleOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
