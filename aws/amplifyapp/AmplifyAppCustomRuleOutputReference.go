...
func (a *jsiiProxy_AmplifyAppCustomRuleOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_AmplifyAppCustomRuleOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
