...
func (a *jsiiProxy_AmplifyAppProductionBranchOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_AmplifyAppProductionBranchOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
