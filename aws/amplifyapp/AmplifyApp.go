...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/amplify_app aws_amplify_app}.
...
func (j *jsiiProxy_AmplifyApp) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_AmplifyApp) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/amplify_app aws_amplify_app} Resource.
...
func (j *jsiiProxy_AmplifyApp)SetRegion(val *string) {
...
func (a *jsiiProxy_AmplifyApp) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (a *jsiiProxy_AmplifyApp) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (a *jsiiProxy_AmplifyApp) ResetRegion() {
	_jsii_.InvokeVoid(
		a,
		"resetRegion",
		nil, // no parameters
...
func (a *jsiiProxy_AmplifyApp) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
