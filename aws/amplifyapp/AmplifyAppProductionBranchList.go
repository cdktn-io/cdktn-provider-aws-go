...
func (j *jsiiProxy_AmplifyAppProductionBranchList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewAmplifyAppProductionBranchList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) AmplifyAppProductionBranchList {
	_init_.Initialize()
...
func NewAmplifyAppProductionBranchList_Override(a AmplifyAppProductionBranchList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_AmplifyAppProductionBranchList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (a *jsiiProxy_AmplifyAppProductionBranchList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (a *jsiiProxy_AmplifyAppProductionBranchList) Resolve(context cdktn.IResolveContext) interface{} {
