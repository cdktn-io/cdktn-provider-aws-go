...
func (a *jsiiProxy_AmplifyAppProductionBranchList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (a *jsiiProxy_AmplifyAppProductionBranchList) Resolve(context cdktf.IResolveContext) interface{} {
