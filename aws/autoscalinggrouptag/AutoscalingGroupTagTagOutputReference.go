...
func (a *jsiiProxy_AutoscalingGroupTagTagOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_AutoscalingGroupTagTagOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
