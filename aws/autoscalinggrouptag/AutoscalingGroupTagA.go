...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/autoscalinggrouptag/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/autoscaling_group_tag aws_autoscaling_group_tag}.
...
func (j *jsiiProxy_AutoscalingGroupTagA) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_AutoscalingGroupTagA) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_AutoscalingGroupTagA) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_AutoscalingGroupTagA) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_AutoscalingGroupTagA) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_AutoscalingGroupTagA) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_AutoscalingGroupTagA) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/autoscaling_group_tag aws_autoscaling_group_tag} Resource.
...
func (j *jsiiProxy_AutoscalingGroupTagA)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_AutoscalingGroupTagA)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_AutoscalingGroupTagA)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_AutoscalingGroupTagA)SetRegion(val *string) {
...
func AutoscalingGroupTagA_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (a *jsiiProxy_AutoscalingGroupTagA) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AutoscalingGroupTagA) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (a *jsiiProxy_AutoscalingGroupTagA) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AutoscalingGroupTagA) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (a *jsiiProxy_AutoscalingGroupTagA) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (a *jsiiProxy_AutoscalingGroupTagA) ResetRegion() {
	_jsii_.InvokeVoid(
		a,
		"resetRegion",
		nil, // no parameters
