...
func (j *jsiiProxy_VpclatticeTargetGroupAttachment) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_VpclatticeTargetGroupAttachment) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_VpclatticeTargetGroupAttachment) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_VpclatticeTargetGroupAttachment) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_VpclatticeTargetGroupAttachment) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/vpclattice_target_group_attachment aws_vpclattice_target_group_attachment} Resource.
...
func (j *jsiiProxy_VpclatticeTargetGroupAttachment)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_VpclatticeTargetGroupAttachment)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_VpclatticeTargetGroupAttachment)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func VpclatticeTargetGroupAttachment_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (v *jsiiProxy_VpclatticeTargetGroupAttachment) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (v *jsiiProxy_VpclatticeTargetGroupAttachment) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (v *jsiiProxy_VpclatticeTargetGroupAttachment) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (v *jsiiProxy_VpclatticeTargetGroupAttachment) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (v *jsiiProxy_VpclatticeTargetGroupAttachment) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (v *jsiiProxy_VpclatticeTargetGroupAttachment) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
