...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/ecstag/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/ecs_tag aws_ecs_tag}.
...
func (j *jsiiProxy_EcsTag) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_EcsTag) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_EcsTag) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_EcsTag) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_EcsTag) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/ecs_tag aws_ecs_tag} Resource.
...
func (j *jsiiProxy_EcsTag)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_EcsTag)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_EcsTag)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func EcsTag_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (e *jsiiProxy_EcsTag) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (e *jsiiProxy_EcsTag) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (e *jsiiProxy_EcsTag) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (e *jsiiProxy_EcsTag) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (e *jsiiProxy_EcsTag) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (e *jsiiProxy_EcsTag) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
