...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/cloudformationtype/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/cloudformation_type aws_cloudformation_type}.
type CloudformationType interface {
	...
	SetId(val *string)
	IdInput() *string
	IsDefaultVersion() cdktn.IResolvable
	// Experimental.
...
func (j *jsiiProxy_CloudformationType) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_CloudformationType) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_CloudformationType) IsDefaultVersion() cdktn.IResolvable {
...
func (j *jsiiProxy_CloudformationType) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_CloudformationType) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_CloudformationType) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_CloudformationType) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_CloudformationType) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/cloudformation_type aws_cloudformation_type} Resource.
...
func (j *jsiiProxy_CloudformationType)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_CloudformationType)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_CloudformationType)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_CloudformationType)SetRegion(val *string) {
...
func CloudformationType_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (c *jsiiProxy_CloudformationType) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CloudformationType) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (c *jsiiProxy_CloudformationType) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CloudformationType) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_CloudformationType) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (c *jsiiProxy_CloudformationType) ResetRegion() {
	_jsii_.InvokeVoid(
		c,
		"resetRegion",
		nil, // no parameters
...
func (c *jsiiProxy_CloudformationType) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
