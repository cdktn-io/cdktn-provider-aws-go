...
func (c *jsiiProxy_CloudformationTypeLoggingConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CloudformationTypeLoggingConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
