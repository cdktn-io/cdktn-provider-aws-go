...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v23/dataawsredshiftorderablecluster/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.34.0/docs/data-sources/redshift_orderable_cluster aws_redshift_orderable_cluster}.
...
func (j *jsiiProxy_DataAwsRedshiftOrderableCluster) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsRedshiftOrderableCluster) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsRedshiftOrderableCluster) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsRedshiftOrderableCluster) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsRedshiftOrderableCluster) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.34.0/docs/data-sources/redshift_orderable_cluster aws_redshift_orderable_cluster} Data Source.
...
func (j *jsiiProxy_DataAwsRedshiftOrderableCluster)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsRedshiftOrderableCluster)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsRedshiftOrderableCluster)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsRedshiftOrderableCluster_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsRedshiftOrderableCluster) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsRedshiftOrderableCluster) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsRedshiftOrderableCluster) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
