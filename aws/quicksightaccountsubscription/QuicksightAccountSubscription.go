...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/quicksightaccountsubscription/internal"
...
func (j *jsiiProxy_QuicksightAccountSubscription) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_QuicksightAccountSubscription) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_QuicksightAccountSubscription) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_QuicksightAccountSubscription) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_QuicksightAccountSubscription) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_QuicksightAccountSubscription) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_QuicksightAccountSubscription) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/quicksight_account_subscription aws_quicksight_account_subscription} Resource.
...
func (j *jsiiProxy_QuicksightAccountSubscription)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_QuicksightAccountSubscription)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_QuicksightAccountSubscription)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_QuicksightAccountSubscription)SetRegion(val *string) {
...
func QuicksightAccountSubscription_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (q *jsiiProxy_QuicksightAccountSubscription) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (q *jsiiProxy_QuicksightAccountSubscription) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (q *jsiiProxy_QuicksightAccountSubscription) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (q *jsiiProxy_QuicksightAccountSubscription) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (q *jsiiProxy_QuicksightAccountSubscription) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (q *jsiiProxy_QuicksightAccountSubscription) ResetRegion() {
	_jsii_.InvokeVoid(
		q,
		"resetRegion",
		nil, // no parameters
...
func (q *jsiiProxy_QuicksightAccountSubscription) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
