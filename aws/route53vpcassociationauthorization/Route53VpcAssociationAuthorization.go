...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/route53vpcassociationauthorization/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/route53_vpc_association_authorization aws_route53_vpc_association_authorization}.
type Route53VpcAssociationAuthorization interface {
	...
	PutTimeouts(value *Route53VpcAssociationAuthorizationTimeouts)
...
func (j *jsiiProxy_Route53VpcAssociationAuthorization) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_Route53VpcAssociationAuthorization) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_Route53VpcAssociationAuthorization) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_Route53VpcAssociationAuthorization) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_Route53VpcAssociationAuthorization) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_Route53VpcAssociationAuthorization) Timeouts() Route53VpcAssociationAuthorizationTimeoutsOutputReference {
	var returns Route53VpcAssociationAuthorizationTimeoutsOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
func (j *jsiiProxy_Route53VpcAssociationAuthorization) TimeoutsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"timeoutsInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/route53_vpc_association_authorization aws_route53_vpc_association_authorization} Resource.
...
func (j *jsiiProxy_Route53VpcAssociationAuthorization)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_Route53VpcAssociationAuthorization)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_Route53VpcAssociationAuthorization)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func Route53VpcAssociationAuthorization_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (r *jsiiProxy_Route53VpcAssociationAuthorization) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (r *jsiiProxy_Route53VpcAssociationAuthorization) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (r *jsiiProxy_Route53VpcAssociationAuthorization) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (r *jsiiProxy_Route53VpcAssociationAuthorization) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (r *jsiiProxy_Route53VpcAssociationAuthorization) PutTimeouts(value *Route53VpcAssociationAuthorizationTimeouts) {
...
func (r *jsiiProxy_Route53VpcAssociationAuthorization) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (r *jsiiProxy_Route53VpcAssociationAuthorization) ResetTimeouts() {
	_jsii_.InvokeVoid(
		r,
		"resetTimeouts",
		nil, // no parameters
...
func (r *jsiiProxy_Route53VpcAssociationAuthorization) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
