...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/cloudwatchloggroup/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/cloudwatch_log_group aws_cloudwatch_log_group}.
...
func (j *jsiiProxy_CloudwatchLogGroup) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_CloudwatchLogGroup) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_CloudwatchLogGroup) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_CloudwatchLogGroup) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_CloudwatchLogGroup) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/cloudwatch_log_group aws_cloudwatch_log_group} Resource.
...
func (j *jsiiProxy_CloudwatchLogGroup)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_CloudwatchLogGroup)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_CloudwatchLogGroup)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func CloudwatchLogGroup_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateCloudwatchLogGroup_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (c *jsiiProxy_CloudwatchLogGroup) AddMoveTarget(moveTarget *string) {
...
func (c *jsiiProxy_CloudwatchLogGroup) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CloudwatchLogGroup) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (c *jsiiProxy_CloudwatchLogGroup) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CloudwatchLogGroup) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_CloudwatchLogGroup) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (c *jsiiProxy_CloudwatchLogGroup) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
