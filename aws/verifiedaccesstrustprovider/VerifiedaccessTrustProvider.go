...
func (j *jsiiProxy_VerifiedaccessTrustProvider) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_VerifiedaccessTrustProvider) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_VerifiedaccessTrustProvider) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_VerifiedaccessTrustProvider) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_VerifiedaccessTrustProvider) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/verifiedaccess_trust_provider aws_verifiedaccess_trust_provider} Resource.
...
func (j *jsiiProxy_VerifiedaccessTrustProvider)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_VerifiedaccessTrustProvider)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_VerifiedaccessTrustProvider)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func VerifiedaccessTrustProvider_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (v *jsiiProxy_VerifiedaccessTrustProvider) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (v *jsiiProxy_VerifiedaccessTrustProvider) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (v *jsiiProxy_VerifiedaccessTrustProvider) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (v *jsiiProxy_VerifiedaccessTrustProvider) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (v *jsiiProxy_VerifiedaccessTrustProvider) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (v *jsiiProxy_VerifiedaccessTrustProvider) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
