...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/chatbot_slack_channel_configuration aws_chatbot_slack_channel_configuration}.
...
func (j *jsiiProxy_ChatbotSlackChannelConfiguration) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_ChatbotSlackChannelConfiguration) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_ChatbotSlackChannelConfiguration) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_ChatbotSlackChannelConfiguration) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_ChatbotSlackChannelConfiguration) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_ChatbotSlackChannelConfiguration) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_ChatbotSlackChannelConfiguration) TagsAll() cdktn.StringMap {
...
func (j *jsiiProxy_ChatbotSlackChannelConfiguration) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/chatbot_slack_channel_configuration aws_chatbot_slack_channel_configuration} Resource.
...
func (j *jsiiProxy_ChatbotSlackChannelConfiguration)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_ChatbotSlackChannelConfiguration)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_ChatbotSlackChannelConfiguration)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_ChatbotSlackChannelConfiguration)SetRegion(val *string) {
...
func ChatbotSlackChannelConfiguration_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (c *jsiiProxy_ChatbotSlackChannelConfiguration) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_ChatbotSlackChannelConfiguration) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (c *jsiiProxy_ChatbotSlackChannelConfiguration) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_ChatbotSlackChannelConfiguration) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_ChatbotSlackChannelConfiguration) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (c *jsiiProxy_ChatbotSlackChannelConfiguration) ResetRegion() {
	_jsii_.InvokeVoid(
		c,
		"resetRegion",
		nil, // no parameters
...
func (c *jsiiProxy_ChatbotSlackChannelConfiguration) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
