...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "slackChannelName", GoGetter: "SlackChannelName"},
			_jsii_.MemberProperty{JsiiProperty: "slackTeamId", GoGetter: "SlackTeamId"},
			_jsii_.MemberProperty{JsiiProperty: "slackTeamIdInput", GoGetter: "SlackTeamIdInput"},
			_jsii_.MemberProperty{JsiiProperty: "slackTeamName", GoGetter: "SlackTeamName"},
