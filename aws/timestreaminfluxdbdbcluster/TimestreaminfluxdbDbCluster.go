...
func (t *jsiiProxy_TimestreaminfluxdbDbCluster) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (t *jsiiProxy_TimestreaminfluxdbDbCluster) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
