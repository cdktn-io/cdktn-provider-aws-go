...
func (j *jsiiProxy_DataAwsVerifiedpermissionsPolicyStoreValidationSettingsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsVerifiedpermissionsPolicyStoreValidationSettingsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsVerifiedpermissionsPolicyStoreValidationSettingsList {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-aws.dataAwsVerifiedpermissionsPolicyStore.DataAwsVerifiedpermissionsPolicyStoreValidationSettingsList",
...
func NewDataAwsVerifiedpermissionsPolicyStoreValidationSettingsList_Override(d DataAwsVerifiedpermissionsPolicyStoreValidationSettingsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsVerifiedpermissionsPolicyStoreValidationSettingsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsVerifiedpermissionsPolicyStoreValidationSettingsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsVerifiedpermissionsPolicyStoreValidationSettingsList) Resolve(context cdktn.IResolveContext) interface{} {
