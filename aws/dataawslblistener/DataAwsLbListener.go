...
func (j *jsiiProxy_DataAwsLbListener) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsLbListener) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsLbListener) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsLbListener) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsLbListener) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.50.0/docs/data-sources/lb_listener aws_lb_listener} Data Source.
...
func (j *jsiiProxy_DataAwsLbListener)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsLbListener)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsLbListener)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsLbListener_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsLbListener) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsLbListener) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsLbListener) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
