...
func (d *jsiiProxy_DataAwsLbListenerDefaultActionAuthenticateCognitoOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataAwsLbListenerDefaultActionAuthenticateCognitoOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
