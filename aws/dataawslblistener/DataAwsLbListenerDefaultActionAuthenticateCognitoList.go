...
func (j *jsiiProxy_DataAwsLbListenerDefaultActionAuthenticateCognitoList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsLbListenerDefaultActionAuthenticateCognitoList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsLbListenerDefaultActionAuthenticateCognitoList {
	_init_.Initialize()
...
func NewDataAwsLbListenerDefaultActionAuthenticateCognitoList_Override(d DataAwsLbListenerDefaultActionAuthenticateCognitoList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsLbListenerDefaultActionAuthenticateCognitoList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsLbListenerDefaultActionAuthenticateCognitoList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsLbListenerDefaultActionAuthenticateCognitoList) Resolve(context cdktn.IResolveContext) interface{} {
