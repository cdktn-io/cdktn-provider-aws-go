...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/dataawsmskconnectconnector/internal"
...
func (j *jsiiProxy_DataAwsMskconnectConnector) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsMskconnectConnector) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsMskconnectConnector) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsMskconnectConnector) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsMskconnectConnector) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DataAwsMskconnectConnector) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_DataAwsMskconnectConnector) Tags() *map[string]*string {
...
func (j *jsiiProxy_DataAwsMskconnectConnector) TagsInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsInput",
...
func (j *jsiiProxy_DataAwsMskconnectConnector) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/data-sources/mskconnect_connector aws_mskconnect_connector} Data Source.
...
func (j *jsiiProxy_DataAwsMskconnectConnector)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsMskconnectConnector)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsMskconnectConnector)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_DataAwsMskconnectConnector)SetRegion(val *string) {
...
func (j *jsiiProxy_DataAwsMskconnectConnector)SetTags(val *map[string]*string) {
...
func DataAwsMskconnectConnector_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsMskconnectConnector) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsMskconnectConnector) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsMskconnectConnector) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsMskconnectConnector) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsMskconnectConnector) ResetTags() {
	_jsii_.InvokeVoid(
		d,
		"resetTags",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsMskconnectConnector) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
