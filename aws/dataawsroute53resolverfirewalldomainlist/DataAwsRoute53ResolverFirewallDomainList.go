...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.36.0/docs/data-sources/route53_resolver_firewall_domain_list aws_route53_resolver_firewall_domain_list}.
...
func (j *jsiiProxy_DataAwsRoute53ResolverFirewallDomainList) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DataAwsRoute53ResolverFirewallDomainList) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.36.0/docs/data-sources/route53_resolver_firewall_domain_list aws_route53_resolver_firewall_domain_list} Data Source.
...
func (j *jsiiProxy_DataAwsRoute53ResolverFirewallDomainList)SetRegion(val *string) {
...
func (d *jsiiProxy_DataAwsRoute53ResolverFirewallDomainList) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsRoute53ResolverFirewallDomainList) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
