...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/dataawskmsciphertext/internal"
...
func (j *jsiiProxy_DataAwsKmsCiphertext) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsKmsCiphertext) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsKmsCiphertext) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsKmsCiphertext) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsKmsCiphertext) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DataAwsKmsCiphertext) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_DataAwsKmsCiphertext) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/data-sources/kms_ciphertext aws_kms_ciphertext} Data Source.
...
func (j *jsiiProxy_DataAwsKmsCiphertext)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsKmsCiphertext)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsKmsCiphertext)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_DataAwsKmsCiphertext)SetRegion(val *string) {
...
func DataAwsKmsCiphertext_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsKmsCiphertext) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsKmsCiphertext) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsKmsCiphertext) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsKmsCiphertext) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsKmsCiphertext) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
