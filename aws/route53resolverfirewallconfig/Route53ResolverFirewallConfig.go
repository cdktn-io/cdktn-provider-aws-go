...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/route53resolverfirewallconfig/internal"
...
func (j *jsiiProxy_Route53ResolverFirewallConfig) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_Route53ResolverFirewallConfig) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_Route53ResolverFirewallConfig) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_Route53ResolverFirewallConfig) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_Route53ResolverFirewallConfig) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_Route53ResolverFirewallConfig) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_Route53ResolverFirewallConfig) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/route53_resolver_firewall_config aws_route53_resolver_firewall_config} Resource.
func NewRoute53ResolverFirewallConfig(scope constructs.Construct, id *string, config *Route53ResolverFirewallConfigConfig) Route53ResolverFirewallConfig {
	...
	_jsii_.Create(
		"@cdktn/provider-aws.route53ResolverFirewallConfig.Route53ResolverFirewallConfig",
...
func (j *jsiiProxy_Route53ResolverFirewallConfig)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_Route53ResolverFirewallConfig)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_Route53ResolverFirewallConfig)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_Route53ResolverFirewallConfig)SetRegion(val *string) {
...
func Route53ResolverFirewallConfig_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (r *jsiiProxy_Route53ResolverFirewallConfig) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (r *jsiiProxy_Route53ResolverFirewallConfig) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (r *jsiiProxy_Route53ResolverFirewallConfig) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (r *jsiiProxy_Route53ResolverFirewallConfig) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (r *jsiiProxy_Route53ResolverFirewallConfig) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (r *jsiiProxy_Route53ResolverFirewallConfig) ResetRegion() {
	_jsii_.InvokeVoid(
		r,
		"resetRegion",
		nil, // no parameters
...
func (r *jsiiProxy_Route53ResolverFirewallConfig) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
