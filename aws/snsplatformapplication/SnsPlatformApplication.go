...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/snsplatformapplication/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/sns_platform_application aws_sns_platform_application}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/sns_platform_application aws_sns_platform_application} Resource.
...
func (s *jsiiProxy_SnsPlatformApplication) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_SnsPlatformApplication) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_SnsPlatformApplication) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_SnsPlatformApplication) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
