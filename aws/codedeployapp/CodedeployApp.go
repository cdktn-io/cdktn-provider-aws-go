...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/codedeployapp/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/codedeploy_app aws_codedeploy_app}.
type CodedeployApp interface {
	...
	LinkedToGithub() cdktn.IResolvable
	Name() *string
	SetName(val *string)
	NameInput() *string
	// The tree node.
...
func (j *jsiiProxy_CodedeployApp) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_CodedeployApp) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_CodedeployApp) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_CodedeployApp) LinkedToGithub() cdktn.IResolvable {
...
func (j *jsiiProxy_CodedeployApp) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_CodedeployApp) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_CodedeployApp) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_CodedeployApp) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/codedeploy_app aws_codedeploy_app} Resource.
func NewCodedeployApp(scope constructs.Construct, id *string, config *CodedeployAppConfig) CodedeployApp {
	_init_.Initialize()

	if err := validateNewCodedeployAppParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CodedeployApp)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_CodedeployApp)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_CodedeployApp)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_CodedeployApp)SetRegion(val *string) {
...
func CodedeployApp_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateCodedeployApp_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func CodedeployApp_IsConstruct(x interface{}) *bool {
	...
	if err := validateCodedeployApp_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func CodedeployApp_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCodedeployApp_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func CodedeployApp_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCodedeployApp_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CodedeployApp) AddMoveTarget(moveTarget *string) {
...
func (c *jsiiProxy_CodedeployApp) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CodedeployApp) HasResourceMove() interface{} {
	var returns interface{}
...
func (c *jsiiProxy_CodedeployApp) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (c *jsiiProxy_CodedeployApp) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CodedeployApp) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_CodedeployApp) MoveFromId(id *string) {
...
func (c *jsiiProxy_CodedeployApp) MoveTo(moveTarget *string, index interface{}) {
...
func (c *jsiiProxy_CodedeployApp) MoveToId(id *string) {
...
func (c *jsiiProxy_CodedeployApp) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (c *jsiiProxy_CodedeployApp) ResetRegion() {
	_jsii_.InvokeVoid(
		c,
		"resetRegion",
		nil, // no parameters
...
func (c *jsiiProxy_CodedeployApp) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (c *jsiiProxy_CodedeployApp) ToHclTerraform() interface{} {
	var returns interface{}
...
func (c *jsiiProxy_CodedeployApp) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
