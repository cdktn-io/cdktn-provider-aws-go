...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/workspacesworkspace/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/workspaces_workspace aws_workspaces_workspace}.
...
func (j *jsiiProxy_WorkspacesWorkspace) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_WorkspacesWorkspace) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_WorkspacesWorkspace) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_WorkspacesWorkspace) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_WorkspacesWorkspace) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/workspaces_workspace aws_workspaces_workspace} Resource.
...
func (j *jsiiProxy_WorkspacesWorkspace)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_WorkspacesWorkspace)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_WorkspacesWorkspace)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func WorkspacesWorkspace_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (w *jsiiProxy_WorkspacesWorkspace) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_WorkspacesWorkspace) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (w *jsiiProxy_WorkspacesWorkspace) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_WorkspacesWorkspace) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (w *jsiiProxy_WorkspacesWorkspace) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (w *jsiiProxy_WorkspacesWorkspace) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
