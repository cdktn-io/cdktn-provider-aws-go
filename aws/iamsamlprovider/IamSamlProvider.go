...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/iamsamlprovider/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/iam_saml_provider aws_iam_saml_provider}.
...
func (j *jsiiProxy_IamSamlProvider) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_IamSamlProvider) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_IamSamlProvider) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_IamSamlProvider) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_IamSamlProvider) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/iam_saml_provider aws_iam_saml_provider} Resource.
...
func (j *jsiiProxy_IamSamlProvider)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_IamSamlProvider)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_IamSamlProvider)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func IamSamlProvider_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateIamSamlProvider_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (i *jsiiProxy_IamSamlProvider) AddMoveTarget(moveTarget *string) {
...
func (i *jsiiProxy_IamSamlProvider) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (i *jsiiProxy_IamSamlProvider) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (i *jsiiProxy_IamSamlProvider) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (i *jsiiProxy_IamSamlProvider) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (i *jsiiProxy_IamSamlProvider) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
