# CDKTN Go bindings for hashicorp/aws provider version 6.63.0

This repo builds and publishes the [Terraform aws provider](https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs) bindings for [CDK Terrain](https://cdktn.io).
...
Find auto-generated docs for this provider [here](https://github.com/cdktn-io/cdktn-provider-aws/blob/main/docs/API.go.md).
...
* [Terraform aws provider](https://registry.terraform.io/providers/hashicorp/aws/6.63.0)
