# CDKTN Go bindings for hashicorp/aws provider version 6.51.0

This repo builds and publishes the [Terraform aws provider](https://registry.terraform.io/providers/hashicorp/aws/6.51.0/docs) bindings for [CDK Terrain](https://cdktn.io).
...
* [Terraform aws provider](https://registry.terraform.io/providers/hashicorp/aws/6.51.0)
