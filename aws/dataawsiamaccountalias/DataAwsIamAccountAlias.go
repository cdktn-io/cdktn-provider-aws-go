...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/data-sources/iam_account_alias aws_iam_account_alias}.
...
func (j *jsiiProxy_DataAwsIamAccountAlias) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsIamAccountAlias) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsIamAccountAlias) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsIamAccountAlias) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsIamAccountAlias) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/data-sources/iam_account_alias aws_iam_account_alias} Data Source.
func NewDataAwsIamAccountAlias(scope constructs.Construct, id *string, config *DataAwsIamAccountAliasConfig) DataAwsIamAccountAlias {
	...
	_jsii_.Create(
		"@cdktn/provider-aws.dataAwsIamAccountAlias.DataAwsIamAccountAlias",
...
func (j *jsiiProxy_DataAwsIamAccountAlias)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsIamAccountAlias)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsIamAccountAlias)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
// Generates CDKTN code for importing a DataAwsIamAccountAlias resource upon running "cdktn plan <stack-name>".
func DataAwsIamAccountAlias_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsIamAccountAlias) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsIamAccountAlias) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsIamAccountAlias) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
