...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/dataawsconnectlambdafunctionassociation/internal"
...
func (j *jsiiProxy_DataAwsConnectLambdaFunctionAssociation) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsConnectLambdaFunctionAssociation) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsConnectLambdaFunctionAssociation) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsConnectLambdaFunctionAssociation) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsConnectLambdaFunctionAssociation) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/data-sources/connect_lambda_function_association aws_connect_lambda_function_association} Data Source.
...
func (j *jsiiProxy_DataAwsConnectLambdaFunctionAssociation)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsConnectLambdaFunctionAssociation)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsConnectLambdaFunctionAssociation)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsConnectLambdaFunctionAssociation_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsConnectLambdaFunctionAssociation) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsConnectLambdaFunctionAssociation) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsConnectLambdaFunctionAssociation) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsConnectLambdaFunctionAssociation) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
