...
func (e *jsiiProxy_EfsAccessPointPosixUserOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (e *jsiiProxy_EfsAccessPointPosixUserOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
