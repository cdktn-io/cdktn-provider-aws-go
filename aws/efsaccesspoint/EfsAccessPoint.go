...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/efsaccesspoint/internal"
...
func (j *jsiiProxy_EfsAccessPoint) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_EfsAccessPoint) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_EfsAccessPoint) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_EfsAccessPoint) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_EfsAccessPoint) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/efs_access_point aws_efs_access_point} Resource.
...
func (j *jsiiProxy_EfsAccessPoint)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_EfsAccessPoint)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_EfsAccessPoint)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func EfsAccessPoint_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (e *jsiiProxy_EfsAccessPoint) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (e *jsiiProxy_EfsAccessPoint) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (e *jsiiProxy_EfsAccessPoint) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (e *jsiiProxy_EfsAccessPoint) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (e *jsiiProxy_EfsAccessPoint) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (e *jsiiProxy_EfsAccessPoint) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
