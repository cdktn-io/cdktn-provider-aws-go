...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/cloudwatch_composite_alarm aws_cloudwatch_composite_alarm}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/cloudwatch_composite_alarm aws_cloudwatch_composite_alarm} Resource.
...
func (c *jsiiProxy_CloudwatchCompositeAlarm) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_CloudwatchCompositeAlarm) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (c *jsiiProxy_CloudwatchCompositeAlarm) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
