...
func (d *jsiiProxy_DataAwsCodeguruprofilerProfilingGroupProfilingStatusOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataAwsCodeguruprofilerProfilingGroupProfilingStatusOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
