...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v22/redshiftendpointaccess/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.31.0/docs/resources/redshift_endpoint_access aws_redshift_endpoint_access}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.31.0/docs/resources/redshift_endpoint_access aws_redshift_endpoint_access} Resource.
...
func RedshiftEndpointAccess_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (r *jsiiProxy_RedshiftEndpointAccess) ImportFrom(id *string, provider cdktf.TerraformProvider) {
