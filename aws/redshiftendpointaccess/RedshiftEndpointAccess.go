...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/redshiftendpointaccess/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/redshift_endpoint_access aws_redshift_endpoint_access}.
...
func (j *jsiiProxy_RedshiftEndpointAccess) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_RedshiftEndpointAccess) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_RedshiftEndpointAccess) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_RedshiftEndpointAccess) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_RedshiftEndpointAccess) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_RedshiftEndpointAccess) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_RedshiftEndpointAccess) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/redshift_endpoint_access aws_redshift_endpoint_access} Resource.
...
func (j *jsiiProxy_RedshiftEndpointAccess)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_RedshiftEndpointAccess)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_RedshiftEndpointAccess)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_RedshiftEndpointAccess)SetRegion(val *string) {
...
func RedshiftEndpointAccess_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateRedshiftEndpointAccess_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (r *jsiiProxy_RedshiftEndpointAccess) AddMoveTarget(moveTarget *string) {
...
func (r *jsiiProxy_RedshiftEndpointAccess) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (r *jsiiProxy_RedshiftEndpointAccess) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (r *jsiiProxy_RedshiftEndpointAccess) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (r *jsiiProxy_RedshiftEndpointAccess) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (r *jsiiProxy_RedshiftEndpointAccess) MoveFromId(id *string) {
...
func (r *jsiiProxy_RedshiftEndpointAccess) MoveToId(id *string) {
...
func (r *jsiiProxy_RedshiftEndpointAccess) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (r *jsiiProxy_RedshiftEndpointAccess) ResetRegion() {
	_jsii_.InvokeVoid(
		r,
		"resetRegion",
		nil, // no parameters
...
func (r *jsiiProxy_RedshiftEndpointAccess) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
