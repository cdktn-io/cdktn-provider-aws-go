...
func (j *jsiiProxy_RedshiftEndpointAccessVpcEndpointNetworkInterfaceList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewRedshiftEndpointAccessVpcEndpointNetworkInterfaceList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) RedshiftEndpointAccessVpcEndpointNetworkInterfaceList {
	_init_.Initialize()
...
func NewRedshiftEndpointAccessVpcEndpointNetworkInterfaceList_Override(r RedshiftEndpointAccessVpcEndpointNetworkInterfaceList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_RedshiftEndpointAccessVpcEndpointNetworkInterfaceList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (r *jsiiProxy_RedshiftEndpointAccessVpcEndpointNetworkInterfaceList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (r *jsiiProxy_RedshiftEndpointAccessVpcEndpointNetworkInterfaceList) Resolve(context cdktn.IResolveContext) interface{} {
