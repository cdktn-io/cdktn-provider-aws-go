...
func (j *jsiiProxy_RedshiftEndpointAccessVpcEndpointOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewRedshiftEndpointAccessVpcEndpointOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) RedshiftEndpointAccessVpcEndpointOutputReference {
	_init_.Initialize()
...
func NewRedshiftEndpointAccessVpcEndpointOutputReference_Override(r RedshiftEndpointAccessVpcEndpointOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_RedshiftEndpointAccessVpcEndpointOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (r *jsiiProxy_RedshiftEndpointAccessVpcEndpointOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (r *jsiiProxy_RedshiftEndpointAccessVpcEndpointOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (r *jsiiProxy_RedshiftEndpointAccessVpcEndpointOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (r *jsiiProxy_RedshiftEndpointAccessVpcEndpointOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
