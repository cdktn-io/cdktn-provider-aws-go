...
func (j *jsiiProxy_RedshiftEndpointAccessVpcEndpointList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewRedshiftEndpointAccessVpcEndpointList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) RedshiftEndpointAccessVpcEndpointList {
	_init_.Initialize()
...
func NewRedshiftEndpointAccessVpcEndpointList_Override(r RedshiftEndpointAccessVpcEndpointList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_RedshiftEndpointAccessVpcEndpointList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (r *jsiiProxy_RedshiftEndpointAccessVpcEndpointList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (r *jsiiProxy_RedshiftEndpointAccessVpcEndpointList) Resolve(context cdktn.IResolveContext) interface{} {
