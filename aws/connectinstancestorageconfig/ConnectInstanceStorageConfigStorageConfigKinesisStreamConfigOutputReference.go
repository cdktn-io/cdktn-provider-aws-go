...
func (c *jsiiProxy_ConnectInstanceStorageConfigStorageConfigKinesisStreamConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ConnectInstanceStorageConfigStorageConfigKinesisStreamConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
