...
func (j *jsiiProxy_ConnectInstanceStorageConfig) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_ConnectInstanceStorageConfig) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_ConnectInstanceStorageConfig) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_ConnectInstanceStorageConfig) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_ConnectInstanceStorageConfig) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/connect_instance_storage_config aws_connect_instance_storage_config} Resource.
...
func (j *jsiiProxy_ConnectInstanceStorageConfig)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_ConnectInstanceStorageConfig)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_ConnectInstanceStorageConfig)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func ConnectInstanceStorageConfig_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (c *jsiiProxy_ConnectInstanceStorageConfig) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_ConnectInstanceStorageConfig) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (c *jsiiProxy_ConnectInstanceStorageConfig) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_ConnectInstanceStorageConfig) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_ConnectInstanceStorageConfig) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (c *jsiiProxy_ConnectInstanceStorageConfig) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
