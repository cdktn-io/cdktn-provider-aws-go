...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/gluedevendpoint/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/glue_dev_endpoint aws_glue_dev_endpoint}.
...
func (j *jsiiProxy_GlueDevEndpoint) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_GlueDevEndpoint) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_GlueDevEndpoint) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_GlueDevEndpoint) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_GlueDevEndpoint) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/glue_dev_endpoint aws_glue_dev_endpoint} Resource.
...
func (j *jsiiProxy_GlueDevEndpoint)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_GlueDevEndpoint)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_GlueDevEndpoint)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func GlueDevEndpoint_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (g *jsiiProxy_GlueDevEndpoint) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GlueDevEndpoint) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (g *jsiiProxy_GlueDevEndpoint) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GlueDevEndpoint) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GlueDevEndpoint) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (g *jsiiProxy_GlueDevEndpoint) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
