...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/s3bucketpolicy/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/s3_bucket_policy aws_s3_bucket_policy}.
...
func (j *jsiiProxy_S3BucketPolicy) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_S3BucketPolicy) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_S3BucketPolicy) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_S3BucketPolicy) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_S3BucketPolicy) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_S3BucketPolicy) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_S3BucketPolicy) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/s3_bucket_policy aws_s3_bucket_policy} Resource.
...
func (j *jsiiProxy_S3BucketPolicy)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_S3BucketPolicy)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_S3BucketPolicy)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_S3BucketPolicy)SetRegion(val *string) {
...
func S3BucketPolicy_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateS3BucketPolicy_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
// Experimental.
func S3BucketPolicy_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateS3BucketPolicy_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func S3BucketPolicy_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateS3BucketPolicy_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (s *jsiiProxy_S3BucketPolicy) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_S3BucketPolicy) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_S3BucketPolicy) HasResourceMove() interface{} {
	var returns interface{}
...
func (s *jsiiProxy_S3BucketPolicy) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_S3BucketPolicy) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_S3BucketPolicy) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_S3BucketPolicy) MoveFromId(id *string) {
...
func (s *jsiiProxy_S3BucketPolicy) MoveTo(moveTarget *string, index interface{}) {
...
func (s *jsiiProxy_S3BucketPolicy) MoveToId(id *string) {
...
func (s *jsiiProxy_S3BucketPolicy) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_S3BucketPolicy) ResetRegion() {
	_jsii_.InvokeVoid(
		s,
		"resetRegion",
		nil, // no parameters
...
func (s *jsiiProxy_S3BucketPolicy) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (s *jsiiProxy_S3BucketPolicy) ToHclTerraform() interface{} {
	var returns interface{}
...
func (s *jsiiProxy_S3BucketPolicy) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
