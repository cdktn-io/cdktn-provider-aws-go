...
func (d *jsiiProxy_DataAwsOpensearchDomainSnapshotOptionsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsOpensearchDomainSnapshotOptionsList) Resolve(context cdktf.IResolveContext) interface{} {
