...
func (d *jsiiProxy_DataAwsOpensearchDomainEncryptionAtRestList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
	return nil
}

func (d *jsiiProxy_DataAwsOpensearchDomainEncryptionAtRestList) validateGetParameters(index *float64) error {
	return nil
}
...
func (j *jsiiProxy_DataAwsOpensearchDomainEncryptionAtRestList) validateSetTerraformAttributeParameters(val *string) error {
	return nil
}
...
func (j *jsiiProxy_DataAwsOpensearchDomainEncryptionAtRestList) validateSetWrapsSetParameters(val *bool) error {
	return nil
}
