...
func (j *jsiiProxy_DataAwsOpensearchDomainAutoTuneOptionsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsOpensearchDomainAutoTuneOptionsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsOpensearchDomainAutoTuneOptionsList {
	_init_.Initialize()
...
func NewDataAwsOpensearchDomainAutoTuneOptionsList_Override(d DataAwsOpensearchDomainAutoTuneOptionsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsOpensearchDomainAutoTuneOptionsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsOpensearchDomainAutoTuneOptionsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsOpensearchDomainAutoTuneOptionsList) Resolve(context cdktn.IResolveContext) interface{} {
