...
func (j *jsiiProxy_DataAwsOpensearchDomainClusterConfigOutputReference) NodeOptions() DataAwsOpensearchDomainClusterConfigNodeOptionsList {
	var returns DataAwsOpensearchDomainClusterConfigNodeOptionsList
	_jsii_.Get(
		j,
		"nodeOptions",
		&returns,
