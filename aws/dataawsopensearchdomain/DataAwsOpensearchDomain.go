...
type DataAwsOpensearchDomain interface {
	...
	DeploymentStrategyOptions() DataAwsOpensearchDomainDeploymentStrategyOptionsList
...
func (j *jsiiProxy_DataAwsOpensearchDomain) DeploymentStrategyOptions() DataAwsOpensearchDomainDeploymentStrategyOptionsList {
	var returns DataAwsOpensearchDomainDeploymentStrategyOptionsList
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataAwsOpensearchDomain) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DataAwsOpensearchDomain) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/data-sources/opensearch_domain aws_opensearch_domain} Data Source.
...
func (j *jsiiProxy_DataAwsOpensearchDomain)SetRegion(val *string) {
...
func (d *jsiiProxy_DataAwsOpensearchDomain) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsOpensearchDomain) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsOpensearchDomain) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
