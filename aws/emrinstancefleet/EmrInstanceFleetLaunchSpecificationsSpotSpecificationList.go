...
func (e *jsiiProxy_EmrInstanceFleetLaunchSpecificationsSpotSpecificationList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (e *jsiiProxy_EmrInstanceFleetLaunchSpecificationsSpotSpecificationList) Resolve(context cdktf.IResolveContext) interface{} {
