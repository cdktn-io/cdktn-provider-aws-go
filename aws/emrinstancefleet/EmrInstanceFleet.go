...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/emrinstancefleet/internal"
...
func (j *jsiiProxy_EmrInstanceFleet) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_EmrInstanceFleet) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_EmrInstanceFleet) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_EmrInstanceFleet) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_EmrInstanceFleet) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/emr_instance_fleet aws_emr_instance_fleet} Resource.
...
func (j *jsiiProxy_EmrInstanceFleet)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_EmrInstanceFleet)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_EmrInstanceFleet)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func EmrInstanceFleet_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateEmrInstanceFleet_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (e *jsiiProxy_EmrInstanceFleet) AddMoveTarget(moveTarget *string) {
...
func (e *jsiiProxy_EmrInstanceFleet) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (e *jsiiProxy_EmrInstanceFleet) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (e *jsiiProxy_EmrInstanceFleet) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (e *jsiiProxy_EmrInstanceFleet) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (e *jsiiProxy_EmrInstanceFleet) MoveFromId(id *string) {
...
func (e *jsiiProxy_EmrInstanceFleet) MoveToId(id *string) {
...
func (e *jsiiProxy_EmrInstanceFleet) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (e *jsiiProxy_EmrInstanceFleet) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
