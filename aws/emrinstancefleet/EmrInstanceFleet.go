...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.31.0/docs/resources/emr_instance_fleet aws_emr_instance_fleet} Resource.
...
func EmrInstanceFleet_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (e *jsiiProxy_EmrInstanceFleet) ImportFrom(id *string, provider cdktf.TerraformProvider) {
