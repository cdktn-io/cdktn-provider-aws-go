...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/datasynclocationefs/internal"
...
func (j *jsiiProxy_DatasyncLocationEfsEc2ConfigOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDatasyncLocationEfsEc2ConfigOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) DatasyncLocationEfsEc2ConfigOutputReference {
	_init_.Initialize()
...
func NewDatasyncLocationEfsEc2ConfigOutputReference_Override(d DatasyncLocationEfsEc2ConfigOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_DatasyncLocationEfsEc2ConfigOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DatasyncLocationEfsEc2ConfigOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DatasyncLocationEfsEc2ConfigOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (d *jsiiProxy_DatasyncLocationEfsEc2ConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DatasyncLocationEfsEc2ConfigOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
