...
func (j *jsiiProxy_DataAwsAmi) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsAmi) EnaSupport() cdktn.IResolvable {
...
func (j *jsiiProxy_DataAwsAmi) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsAmi) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsAmi) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsAmi) Public() cdktn.IResolvable {
	var returns cdktn.IResolvable
	_jsii_.Get(
		j,
		"public",
...
func (j *jsiiProxy_DataAwsAmi) StateReason() cdktn.StringMap {
...
func (j *jsiiProxy_DataAwsAmi) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DataAwsAmi)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsAmi)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsAmi)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsAmi_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsAmi) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsAmi) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsAmi) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
