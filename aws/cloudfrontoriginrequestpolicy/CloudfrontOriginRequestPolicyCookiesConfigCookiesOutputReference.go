...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/cloudfrontoriginrequestpolicy/internal"
...
func (j *jsiiProxy_CloudfrontOriginRequestPolicyCookiesConfigCookiesOutputReference) ComplexObjectIndex() interface{} {
...
func (j *jsiiProxy_CloudfrontOriginRequestPolicyCookiesConfigCookiesOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CloudfrontOriginRequestPolicyCookiesConfigCookiesOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CloudfrontOriginRequestPolicyCookiesConfigCookiesOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_CloudfrontOriginRequestPolicyCookiesConfigCookiesOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewCloudfrontOriginRequestPolicyCookiesConfigCookiesOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) CloudfrontOriginRequestPolicyCookiesConfigCookiesOutputReference {
	_init_.Initialize()

	if err := validateNewCloudfrontOriginRequestPolicyCookiesConfigCookiesOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewCloudfrontOriginRequestPolicyCookiesConfigCookiesOutputReference_Override(c CloudfrontOriginRequestPolicyCookiesConfigCookiesOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_CloudfrontOriginRequestPolicyCookiesConfigCookiesOutputReference)SetComplexObjectIndex(val interface{}) {
...
func (j *jsiiProxy_CloudfrontOriginRequestPolicyCookiesConfigCookiesOutputReference)SetComplexObjectIsFromSet(val *bool) {
...
func (j *jsiiProxy_CloudfrontOriginRequestPolicyCookiesConfigCookiesOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_CloudfrontOriginRequestPolicyCookiesConfigCookiesOutputReference) ComputeFqn() *string {
	var returns *string
...
func (c *jsiiProxy_CloudfrontOriginRequestPolicyCookiesConfigCookiesOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CloudfrontOriginRequestPolicyCookiesConfigCookiesOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (c *jsiiProxy_CloudfrontOriginRequestPolicyCookiesConfigCookiesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CloudfrontOriginRequestPolicyCookiesConfigCookiesOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
...
func (c *jsiiProxy_CloudfrontOriginRequestPolicyCookiesConfigCookiesOutputReference) ToString() *string {
	var returns *string
