...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/cloudfront_origin_request_policy aws_cloudfront_origin_request_policy}.
...
func (j *jsiiProxy_CloudfrontOriginRequestPolicy) Arn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"arn",
...
func (j *jsiiProxy_CloudfrontOriginRequestPolicy) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_CloudfrontOriginRequestPolicy) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_CloudfrontOriginRequestPolicy) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_CloudfrontOriginRequestPolicy) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_CloudfrontOriginRequestPolicy) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/cloudfront_origin_request_policy aws_cloudfront_origin_request_policy} Resource.
...
func (j *jsiiProxy_CloudfrontOriginRequestPolicy)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_CloudfrontOriginRequestPolicy)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_CloudfrontOriginRequestPolicy)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func CloudfrontOriginRequestPolicy_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateCloudfrontOriginRequestPolicy_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (c *jsiiProxy_CloudfrontOriginRequestPolicy) AddMoveTarget(moveTarget *string) {
...
func (c *jsiiProxy_CloudfrontOriginRequestPolicy) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CloudfrontOriginRequestPolicy) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (c *jsiiProxy_CloudfrontOriginRequestPolicy) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CloudfrontOriginRequestPolicy) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_CloudfrontOriginRequestPolicy) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (c *jsiiProxy_CloudfrontOriginRequestPolicy) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
