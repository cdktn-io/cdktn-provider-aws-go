...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/datazoneenvironmentprofile/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/datazone_environment_profile aws_datazone_environment_profile}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/datazone_environment_profile aws_datazone_environment_profile} Resource.
...
func (d *jsiiProxy_DatazoneEnvironmentProfile) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (d *jsiiProxy_DatazoneEnvironmentProfile) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DatazoneEnvironmentProfile) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
