...
func (j *jsiiProxy_RedshiftserverlessWorkgroupEndpointVpcEndpointList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewRedshiftserverlessWorkgroupEndpointVpcEndpointList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) RedshiftserverlessWorkgroupEndpointVpcEndpointList {
	_init_.Initialize()
...
func NewRedshiftserverlessWorkgroupEndpointVpcEndpointList_Override(r RedshiftserverlessWorkgroupEndpointVpcEndpointList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_RedshiftserverlessWorkgroupEndpointVpcEndpointList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (r *jsiiProxy_RedshiftserverlessWorkgroupEndpointVpcEndpointList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (r *jsiiProxy_RedshiftserverlessWorkgroupEndpointVpcEndpointList) Resolve(context cdktn.IResolveContext) interface{} {
