...
func (j *jsiiProxy_RedshiftserverlessWorkgroupConfigParameterList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewRedshiftserverlessWorkgroupConfigParameterList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) RedshiftserverlessWorkgroupConfigParameterList {
	_init_.Initialize()
...
func NewRedshiftserverlessWorkgroupConfigParameterList_Override(r RedshiftserverlessWorkgroupConfigParameterList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_RedshiftserverlessWorkgroupConfigParameterList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (r *jsiiProxy_RedshiftserverlessWorkgroupConfigParameterList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (r *jsiiProxy_RedshiftserverlessWorkgroupConfigParameterList) Resolve(context cdktn.IResolveContext) interface{} {
