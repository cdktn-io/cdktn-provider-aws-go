...
func (r *jsiiProxy_RedshiftserverlessWorkgroup) validatePutConfigParameterParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*RedshiftserverlessWorkgroupConfigParameter; received %#v (a %T)", value, value)
		}
	}
