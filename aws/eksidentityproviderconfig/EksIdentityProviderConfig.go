...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/eksidentityproviderconfig/internal"
...
func (j *jsiiProxy_EksIdentityProviderConfig) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_EksIdentityProviderConfig) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_EksIdentityProviderConfig) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_EksIdentityProviderConfig) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_EksIdentityProviderConfig) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_EksIdentityProviderConfig) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_EksIdentityProviderConfig) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/eks_identity_provider_config aws_eks_identity_provider_config} Resource.
...
func (j *jsiiProxy_EksIdentityProviderConfig)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_EksIdentityProviderConfig)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_EksIdentityProviderConfig)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_EksIdentityProviderConfig)SetRegion(val *string) {
...
func EksIdentityProviderConfig_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (e *jsiiProxy_EksIdentityProviderConfig) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (e *jsiiProxy_EksIdentityProviderConfig) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (e *jsiiProxy_EksIdentityProviderConfig) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (e *jsiiProxy_EksIdentityProviderConfig) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (e *jsiiProxy_EksIdentityProviderConfig) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (e *jsiiProxy_EksIdentityProviderConfig) ResetRegion() {
	_jsii_.InvokeVoid(
		e,
		"resetRegion",
		nil, // no parameters
...
func (e *jsiiProxy_EksIdentityProviderConfig) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
