...
func (j *jsiiProxy_S3AccessPoint) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_S3AccessPoint) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_S3AccessPoint) Tags() *map[string]*string {
...
func (j *jsiiProxy_S3AccessPoint) TagsAll() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsAll",
...
func (j *jsiiProxy_S3AccessPoint) TagsAllInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsAllInput",
...
func (j *jsiiProxy_S3AccessPoint) TagsInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/s3_access_point aws_s3_access_point} Resource.
...
func (j *jsiiProxy_S3AccessPoint)SetRegion(val *string) {
...
func (j *jsiiProxy_S3AccessPoint)SetTags(val *map[string]*string) {
...
func (j *jsiiProxy_S3AccessPoint)SetTagsAll(val *map[string]*string) {
...
func (s *jsiiProxy_S3AccessPoint) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_S3AccessPoint) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_S3AccessPoint) MoveFromId(id *string) {
...
func (s *jsiiProxy_S3AccessPoint) MoveToId(id *string) {
...
func (s *jsiiProxy_S3AccessPoint) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_S3AccessPoint) ResetRegion() {
	_jsii_.InvokeVoid(
		s,
		"resetRegion",
		nil, // no parameters
...
func (s *jsiiProxy_S3AccessPoint) ResetTags() {
	_jsii_.InvokeVoid(
		s,
		"resetTags",
		nil, // no parameters
...
func (s *jsiiProxy_S3AccessPoint) ResetTagsAll() {
	_jsii_.InvokeVoid(
		s,
		"resetTagsAll",
		nil, // no parameters
...
func (s *jsiiProxy_S3AccessPoint) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
