...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v24/s3accesspoint/internal"
...
func (j *jsiiProxy_S3AccessPointVpcConfigurationOutputReference) ComplexObjectIndex() interface{} {
...
func (j *jsiiProxy_S3AccessPointVpcConfigurationOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_S3AccessPointVpcConfigurationOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_S3AccessPointVpcConfigurationOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_S3AccessPointVpcConfigurationOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewS3AccessPointVpcConfigurationOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) S3AccessPointVpcConfigurationOutputReference {
	_init_.Initialize()

	if err := validateNewS3AccessPointVpcConfigurationOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewS3AccessPointVpcConfigurationOutputReference_Override(s S3AccessPointVpcConfigurationOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_S3AccessPointVpcConfigurationOutputReference)SetComplexObjectIndex(val interface{}) {
...
func (j *jsiiProxy_S3AccessPointVpcConfigurationOutputReference)SetComplexObjectIsFromSet(val *bool) {
...
func (j *jsiiProxy_S3AccessPointVpcConfigurationOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_S3AccessPointVpcConfigurationOutputReference) ComputeFqn() *string {
	var returns *string
...
func (s *jsiiProxy_S3AccessPointVpcConfigurationOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_S3AccessPointVpcConfigurationOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (s *jsiiProxy_S3AccessPointVpcConfigurationOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_S3AccessPointVpcConfigurationOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
...
func (s *jsiiProxy_S3AccessPointVpcConfigurationOutputReference) ToString() *string {
	var returns *string
