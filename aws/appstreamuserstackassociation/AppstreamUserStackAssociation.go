...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/appstreamuserstackassociation/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/appstream_user_stack_association aws_appstream_user_stack_association}.
...
func (j *jsiiProxy_AppstreamUserStackAssociation) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_AppstreamUserStackAssociation) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_AppstreamUserStackAssociation) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_AppstreamUserStackAssociation) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_AppstreamUserStackAssociation) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/appstream_user_stack_association aws_appstream_user_stack_association} Resource.
...
func (j *jsiiProxy_AppstreamUserStackAssociation)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_AppstreamUserStackAssociation)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_AppstreamUserStackAssociation)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func AppstreamUserStackAssociation_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (a *jsiiProxy_AppstreamUserStackAssociation) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AppstreamUserStackAssociation) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (a *jsiiProxy_AppstreamUserStackAssociation) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AppstreamUserStackAssociation) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (a *jsiiProxy_AppstreamUserStackAssociation) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (a *jsiiProxy_AppstreamUserStackAssociation) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
