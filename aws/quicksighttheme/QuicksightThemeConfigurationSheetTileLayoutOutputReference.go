...
func (q *jsiiProxy_QuicksightThemeConfigurationSheetTileLayoutOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (q *jsiiProxy_QuicksightThemeConfigurationSheetTileLayoutOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
