...
type QuicksightThemeConfigurationSheetTileLayoutOutputReference interface {
	...
	GutterInput() *QuicksightThemeConfigurationSheetTileLayoutGutter
	InternalValue() *QuicksightThemeConfigurationSheetTileLayout
	SetInternalValue(val *QuicksightThemeConfigurationSheetTileLayout)
	Margin() QuicksightThemeConfigurationSheetTileLayoutMarginOutputReference
	MarginInput() *QuicksightThemeConfigurationSheetTileLayoutMargin
	// Experimental.
...
func (j *jsiiProxy_QuicksightThemeConfigurationSheetTileLayoutOutputReference) GutterInput() *QuicksightThemeConfigurationSheetTileLayoutGutter {
...
func (j *jsiiProxy_QuicksightThemeConfigurationSheetTileLayoutOutputReference) InternalValue() *QuicksightThemeConfigurationSheetTileLayout {
	var returns *QuicksightThemeConfigurationSheetTileLayout
	_jsii_.Get(
		j,
		"internalValue",
		&returns,
...
func (j *jsiiProxy_QuicksightThemeConfigurationSheetTileLayoutOutputReference) MarginInput() *QuicksightThemeConfigurationSheetTileLayoutMargin {
...
func (j *jsiiProxy_QuicksightThemeConfigurationSheetTileLayoutOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewQuicksightThemeConfigurationSheetTileLayoutOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) QuicksightThemeConfigurationSheetTileLayoutOutputReference {
	_init_.Initialize()
...
func NewQuicksightThemeConfigurationSheetTileLayoutOutputReference_Override(q QuicksightThemeConfigurationSheetTileLayoutOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_QuicksightThemeConfigurationSheetTileLayoutOutputReference)SetInternalValue(val *QuicksightThemeConfigurationSheetTileLayout) {
...
func (j *jsiiProxy_QuicksightThemeConfigurationSheetTileLayoutOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (q *jsiiProxy_QuicksightThemeConfigurationSheetTileLayoutOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (q *jsiiProxy_QuicksightThemeConfigurationSheetTileLayoutOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (q *jsiiProxy_QuicksightThemeConfigurationSheetTileLayoutOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (q *jsiiProxy_QuicksightThemeConfigurationSheetTileLayoutOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
