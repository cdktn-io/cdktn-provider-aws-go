...
func (j *jsiiProxy_QuicksightThemeConfigurationTypographyFontFamiliesList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewQuicksightThemeConfigurationTypographyFontFamiliesList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) QuicksightThemeConfigurationTypographyFontFamiliesList {
	_init_.Initialize()
...
func NewQuicksightThemeConfigurationTypographyFontFamiliesList_Override(q QuicksightThemeConfigurationTypographyFontFamiliesList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_QuicksightThemeConfigurationTypographyFontFamiliesList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (q *jsiiProxy_QuicksightThemeConfigurationTypographyFontFamiliesList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (q *jsiiProxy_QuicksightThemeConfigurationTypographyFontFamiliesList) Resolve(context cdktn.IResolveContext) interface{} {
