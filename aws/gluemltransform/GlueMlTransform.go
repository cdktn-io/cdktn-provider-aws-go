...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.34.0/docs/resources/glue_ml_transform aws_glue_ml_transform}.
...
func (j *jsiiProxy_GlueMlTransform) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_GlueMlTransform) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.34.0/docs/resources/glue_ml_transform aws_glue_ml_transform} Resource.
...
func (j *jsiiProxy_GlueMlTransform)SetRegion(val *string) {
...
func (g *jsiiProxy_GlueMlTransform) ResetRegion() {
	_jsii_.InvokeVoid(
		g,
		"resetRegion",
		nil, // no parameters
