...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/macie2account/internal"
...
func (j *jsiiProxy_Macie2Account) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_Macie2Account) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_Macie2Account) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_Macie2Account) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_Macie2Account) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/macie2_account aws_macie2_account} Resource.
...
func (j *jsiiProxy_Macie2Account)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_Macie2Account)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_Macie2Account)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func Macie2Account_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (m *jsiiProxy_Macie2Account) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_Macie2Account) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (m *jsiiProxy_Macie2Account) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_Macie2Account) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (m *jsiiProxy_Macie2Account) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
