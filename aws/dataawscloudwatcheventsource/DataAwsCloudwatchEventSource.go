...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/dataawscloudwatcheventsource/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/data-sources/cloudwatch_event_source aws_cloudwatch_event_source}.
...
func (j *jsiiProxy_DataAwsCloudwatchEventSource) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsCloudwatchEventSource) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsCloudwatchEventSource) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsCloudwatchEventSource) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsCloudwatchEventSource) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DataAwsCloudwatchEventSource) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_DataAwsCloudwatchEventSource) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/data-sources/cloudwatch_event_source aws_cloudwatch_event_source} Data Source.
...
func (j *jsiiProxy_DataAwsCloudwatchEventSource)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsCloudwatchEventSource)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsCloudwatchEventSource)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_DataAwsCloudwatchEventSource)SetRegion(val *string) {
...
func DataAwsCloudwatchEventSource_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsCloudwatchEventSource) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsCloudwatchEventSource) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsCloudwatchEventSource) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsCloudwatchEventSource) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsCloudwatchEventSource) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
