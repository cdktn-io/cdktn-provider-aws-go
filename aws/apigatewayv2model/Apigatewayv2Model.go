...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/apigatewayv2model/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/apigatewayv2_model aws_apigatewayv2_model}.
...
func (j *jsiiProxy_Apigatewayv2Model) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_Apigatewayv2Model) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_Apigatewayv2Model) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_Apigatewayv2Model) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_Apigatewayv2Model) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_Apigatewayv2Model) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_Apigatewayv2Model) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/apigatewayv2_model aws_apigatewayv2_model} Resource.
func NewApigatewayv2Model(scope constructs.Construct, id *string, config *Apigatewayv2ModelConfig) Apigatewayv2Model {
	_init_.Initialize()

	if err := validateNewApigatewayv2ModelParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_Apigatewayv2Model)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_Apigatewayv2Model)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_Apigatewayv2Model)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_Apigatewayv2Model)SetRegion(val *string) {
...
func Apigatewayv2Model_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateApigatewayv2Model_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (a *jsiiProxy_Apigatewayv2Model) AddMoveTarget(moveTarget *string) {
...
func (a *jsiiProxy_Apigatewayv2Model) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_Apigatewayv2Model) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (a *jsiiProxy_Apigatewayv2Model) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_Apigatewayv2Model) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (a *jsiiProxy_Apigatewayv2Model) MoveFromId(id *string) {
...
func (a *jsiiProxy_Apigatewayv2Model) MoveToId(id *string) {
...
func (a *jsiiProxy_Apigatewayv2Model) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (a *jsiiProxy_Apigatewayv2Model) ResetRegion() {
	_jsii_.InvokeVoid(
		a,
		"resetRegion",
		nil, // no parameters
...
func (a *jsiiProxy_Apigatewayv2Model) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
