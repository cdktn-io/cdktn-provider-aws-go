...
func (j *jsiiProxy_DataAwsGuarddutyDetector) Arn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"arn",
...
func (j *jsiiProxy_DataAwsGuarddutyDetector) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsGuarddutyDetector) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsGuarddutyDetector) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsGuarddutyDetector) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsGuarddutyDetector) Tags() *map[string]*string {
...
func (j *jsiiProxy_DataAwsGuarddutyDetector) TagsInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsInput",
...
func (j *jsiiProxy_DataAwsGuarddutyDetector) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DataAwsGuarddutyDetector)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsGuarddutyDetector)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsGuarddutyDetector)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_DataAwsGuarddutyDetector)SetTags(val *map[string]*string) {
...
func DataAwsGuarddutyDetector_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsGuarddutyDetector) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsGuarddutyDetector) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsGuarddutyDetector) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsGuarddutyDetector) ResetTags() {
	_jsii_.InvokeVoid(
		d,
		"resetTags",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsGuarddutyDetector) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
