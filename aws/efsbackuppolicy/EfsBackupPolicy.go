...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/efsbackuppolicy/internal"
...
func (j *jsiiProxy_EfsBackupPolicy) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_EfsBackupPolicy) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_EfsBackupPolicy) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_EfsBackupPolicy) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_EfsBackupPolicy) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_EfsBackupPolicy) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_EfsBackupPolicy) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/efs_backup_policy aws_efs_backup_policy} Resource.
...
func (j *jsiiProxy_EfsBackupPolicy)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_EfsBackupPolicy)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_EfsBackupPolicy)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_EfsBackupPolicy)SetRegion(val *string) {
...
func EfsBackupPolicy_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (e *jsiiProxy_EfsBackupPolicy) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (e *jsiiProxy_EfsBackupPolicy) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (e *jsiiProxy_EfsBackupPolicy) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (e *jsiiProxy_EfsBackupPolicy) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (e *jsiiProxy_EfsBackupPolicy) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (e *jsiiProxy_EfsBackupPolicy) ResetRegion() {
	_jsii_.InvokeVoid(
		e,
		"resetRegion",
		nil, // no parameters
...
func (e *jsiiProxy_EfsBackupPolicy) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
