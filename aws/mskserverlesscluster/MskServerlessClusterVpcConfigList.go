...
func (j *jsiiProxy_MskServerlessClusterVpcConfigList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewMskServerlessClusterVpcConfigList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) MskServerlessClusterVpcConfigList {
	_init_.Initialize()
...
func NewMskServerlessClusterVpcConfigList_Override(m MskServerlessClusterVpcConfigList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_MskServerlessClusterVpcConfigList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (m *jsiiProxy_MskServerlessClusterVpcConfigList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (m *jsiiProxy_MskServerlessClusterVpcConfigList) Resolve(context cdktn.IResolveContext) interface{} {
