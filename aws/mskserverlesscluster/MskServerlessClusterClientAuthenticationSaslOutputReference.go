...
func (m *jsiiProxy_MskServerlessClusterClientAuthenticationSaslOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (m *jsiiProxy_MskServerlessClusterClientAuthenticationSaslOutputReference) PutIam(value *MskServerlessClusterClientAuthenticationSaslIam) {
	if err := m.validatePutIamParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		m,
...
func (m *jsiiProxy_MskServerlessClusterClientAuthenticationSaslOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
