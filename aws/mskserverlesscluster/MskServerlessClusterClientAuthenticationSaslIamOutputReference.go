...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/mskserverlesscluster/internal"
...
func (j *jsiiProxy_MskServerlessClusterClientAuthenticationSaslIamOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewMskServerlessClusterClientAuthenticationSaslIamOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) MskServerlessClusterClientAuthenticationSaslIamOutputReference {
	_init_.Initialize()

	if err := validateNewMskServerlessClusterClientAuthenticationSaslIamOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewMskServerlessClusterClientAuthenticationSaslIamOutputReference_Override(m MskServerlessClusterClientAuthenticationSaslIamOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_MskServerlessClusterClientAuthenticationSaslIamOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (m *jsiiProxy_MskServerlessClusterClientAuthenticationSaslIamOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MskServerlessClusterClientAuthenticationSaslIamOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (m *jsiiProxy_MskServerlessClusterClientAuthenticationSaslIamOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MskServerlessClusterClientAuthenticationSaslIamOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
