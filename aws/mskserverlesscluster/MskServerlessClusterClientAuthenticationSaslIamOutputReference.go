...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v22/mskserverlesscluster/internal"
...
func (m *jsiiProxy_MskServerlessClusterClientAuthenticationSaslIamOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (m *jsiiProxy_MskServerlessClusterClientAuthenticationSaslIamOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
