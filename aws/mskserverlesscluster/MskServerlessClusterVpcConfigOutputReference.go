...
func (m *jsiiProxy_MskServerlessClusterVpcConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (m *jsiiProxy_MskServerlessClusterVpcConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
