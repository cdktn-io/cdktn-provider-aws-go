...
func (j *jsiiProxy_MskServerlessClusterVpcConfigOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewMskServerlessClusterVpcConfigOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) MskServerlessClusterVpcConfigOutputReference {
	_init_.Initialize()
...
func NewMskServerlessClusterVpcConfigOutputReference_Override(m MskServerlessClusterVpcConfigOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_MskServerlessClusterVpcConfigOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (m *jsiiProxy_MskServerlessClusterVpcConfigOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MskServerlessClusterVpcConfigOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (m *jsiiProxy_MskServerlessClusterVpcConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MskServerlessClusterVpcConfigOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
