...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v22/docdbglobalcluster/internal"
...
func (d *jsiiProxy_DocdbGlobalClusterGlobalClusterMembersList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DocdbGlobalClusterGlobalClusterMembersList) Resolve(context cdktf.IResolveContext) interface{} {
