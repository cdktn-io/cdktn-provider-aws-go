...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v23/dataawsqldbledger/internal"
...
func (j *jsiiProxy_DataAwsQldbLedger) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsQldbLedger) DeletionProtection() cdktn.IResolvable {
...
func (j *jsiiProxy_DataAwsQldbLedger) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsQldbLedger) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsQldbLedger) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsQldbLedger) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DataAwsQldbLedger)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsQldbLedger)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsQldbLedger)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsQldbLedger_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsQldbLedger) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsQldbLedger) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsQldbLedger) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
