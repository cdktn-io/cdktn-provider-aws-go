...
func (d *jsiiProxy_DataAwsBatchJobQueueComputeEnvironmentOrderOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataAwsBatchJobQueueComputeEnvironmentOrderOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
