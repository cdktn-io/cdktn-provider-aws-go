...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/data-sources/batch_job_queue aws_batch_job_queue}.
type DataAwsBatchJobQueue interface {
	...
	SetId(val *string)
	IdInput() *string
	JobStateTimeLimitAction() DataAwsBatchJobQueueJobStateTimeLimitActionList
	// Experimental.
...
func (j *jsiiProxy_DataAwsBatchJobQueue) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsBatchJobQueue) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsBatchJobQueue) JobStateTimeLimitAction() DataAwsBatchJobQueueJobStateTimeLimitActionList {
	var returns DataAwsBatchJobQueueJobStateTimeLimitActionList
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataAwsBatchJobQueue) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsBatchJobQueue) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsBatchJobQueue) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DataAwsBatchJobQueue) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_DataAwsBatchJobQueue) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/data-sources/batch_job_queue aws_batch_job_queue} Data Source.
...
func (j *jsiiProxy_DataAwsBatchJobQueue)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsBatchJobQueue)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsBatchJobQueue)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_DataAwsBatchJobQueue)SetRegion(val *string) {
...
func DataAwsBatchJobQueue_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsBatchJobQueue) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsBatchJobQueue) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsBatchJobQueue) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsBatchJobQueue) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsBatchJobQueue) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
