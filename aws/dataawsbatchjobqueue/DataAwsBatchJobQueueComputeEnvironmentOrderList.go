...
func (j *jsiiProxy_DataAwsBatchJobQueueComputeEnvironmentOrderList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsBatchJobQueueComputeEnvironmentOrderList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsBatchJobQueueComputeEnvironmentOrderList {
	_init_.Initialize()
...
func NewDataAwsBatchJobQueueComputeEnvironmentOrderList_Override(d DataAwsBatchJobQueueComputeEnvironmentOrderList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsBatchJobQueueComputeEnvironmentOrderList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsBatchJobQueueComputeEnvironmentOrderList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsBatchJobQueueComputeEnvironmentOrderList) Resolve(context cdktn.IResolveContext) interface{} {
