...
func (c *jsiiProxy_CognitoRiskConfigurationAccountTakeoverRiskConfigurationActionsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CognitoRiskConfigurationAccountTakeoverRiskConfigurationActionsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
