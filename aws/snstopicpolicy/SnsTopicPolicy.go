...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/snstopicpolicy/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/sns_topic_policy aws_sns_topic_policy}.
...
func (j *jsiiProxy_SnsTopicPolicy) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_SnsTopicPolicy) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_SnsTopicPolicy) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_SnsTopicPolicy) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_SnsTopicPolicy) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_SnsTopicPolicy) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_SnsTopicPolicy) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/sns_topic_policy aws_sns_topic_policy} Resource.
func NewSnsTopicPolicy(scope constructs.Construct, id *string, config *SnsTopicPolicyConfig) SnsTopicPolicy {
	...
	_jsii_.Create(
		"@cdktn/provider-aws.snsTopicPolicy.SnsTopicPolicy",
...
func (j *jsiiProxy_SnsTopicPolicy)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_SnsTopicPolicy)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_SnsTopicPolicy)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_SnsTopicPolicy)SetRegion(val *string) {
...
// Generates CDKTN code for importing a SnsTopicPolicy resource upon running "cdktn plan <stack-name>".
func SnsTopicPolicy_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (s *jsiiProxy_SnsTopicPolicy) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SnsTopicPolicy) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_SnsTopicPolicy) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SnsTopicPolicy) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_SnsTopicPolicy) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_SnsTopicPolicy) ResetRegion() {
	_jsii_.InvokeVoid(
		s,
		"resetRegion",
		nil, // no parameters
...
func (s *jsiiProxy_SnsTopicPolicy) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
