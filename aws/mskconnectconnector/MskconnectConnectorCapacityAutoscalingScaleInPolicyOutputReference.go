...
func (m *jsiiProxy_MskconnectConnectorCapacityAutoscalingScaleInPolicyOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (m *jsiiProxy_MskconnectConnectorCapacityAutoscalingScaleInPolicyOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
