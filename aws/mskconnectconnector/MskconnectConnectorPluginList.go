...
func (j *jsiiProxy_MskconnectConnectorPluginList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewMskconnectConnectorPluginList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) MskconnectConnectorPluginList {
	_init_.Initialize()
...
func NewMskconnectConnectorPluginList_Override(m MskconnectConnectorPluginList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_MskconnectConnectorPluginList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (m *jsiiProxy_MskconnectConnectorPluginList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (m *jsiiProxy_MskconnectConnectorPluginList) Resolve(context cdktn.IResolveContext) interface{} {
