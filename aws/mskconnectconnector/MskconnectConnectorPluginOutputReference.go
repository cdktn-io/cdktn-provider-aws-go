...
func (m *jsiiProxy_MskconnectConnectorPluginOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (m *jsiiProxy_MskconnectConnectorPluginOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
