...
func (j *jsiiProxy_MskconnectConnectorPluginOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewMskconnectConnectorPluginOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) MskconnectConnectorPluginOutputReference {
	_init_.Initialize()
...
func NewMskconnectConnectorPluginOutputReference_Override(m MskconnectConnectorPluginOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_MskconnectConnectorPluginOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (m *jsiiProxy_MskconnectConnectorPluginOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MskconnectConnectorPluginOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (m *jsiiProxy_MskconnectConnectorPluginOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MskconnectConnectorPluginOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
