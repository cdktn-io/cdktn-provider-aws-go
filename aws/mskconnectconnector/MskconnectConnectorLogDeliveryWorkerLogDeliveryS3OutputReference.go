...
func (j *jsiiProxy_MskconnectConnectorLogDeliveryWorkerLogDeliveryS3OutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewMskconnectConnectorLogDeliveryWorkerLogDeliveryS3OutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) MskconnectConnectorLogDeliveryWorkerLogDeliveryS3OutputReference {
	_init_.Initialize()

	if err := validateNewMskconnectConnectorLogDeliveryWorkerLogDeliveryS3OutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewMskconnectConnectorLogDeliveryWorkerLogDeliveryS3OutputReference_Override(m MskconnectConnectorLogDeliveryWorkerLogDeliveryS3OutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_MskconnectConnectorLogDeliveryWorkerLogDeliveryS3OutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (m *jsiiProxy_MskconnectConnectorLogDeliveryWorkerLogDeliveryS3OutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MskconnectConnectorLogDeliveryWorkerLogDeliveryS3OutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (m *jsiiProxy_MskconnectConnectorLogDeliveryWorkerLogDeliveryS3OutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MskconnectConnectorLogDeliveryWorkerLogDeliveryS3OutputReference) Resolve(context cdktn.IResolveContext) interface{} {
