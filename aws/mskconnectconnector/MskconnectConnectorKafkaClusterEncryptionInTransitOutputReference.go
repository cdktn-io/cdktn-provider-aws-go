...
func (j *jsiiProxy_MskconnectConnectorKafkaClusterEncryptionInTransitOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewMskconnectConnectorKafkaClusterEncryptionInTransitOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) MskconnectConnectorKafkaClusterEncryptionInTransitOutputReference {
	_init_.Initialize()

	if err := validateNewMskconnectConnectorKafkaClusterEncryptionInTransitOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewMskconnectConnectorKafkaClusterEncryptionInTransitOutputReference_Override(m MskconnectConnectorKafkaClusterEncryptionInTransitOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_MskconnectConnectorKafkaClusterEncryptionInTransitOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (m *jsiiProxy_MskconnectConnectorKafkaClusterEncryptionInTransitOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MskconnectConnectorKafkaClusterEncryptionInTransitOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (m *jsiiProxy_MskconnectConnectorKafkaClusterEncryptionInTransitOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MskconnectConnectorKafkaClusterEncryptionInTransitOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
