...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/dataawsserverlessapplicationrepositoryapplication/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/data-sources/serverlessapplicationrepository_application aws_serverlessapplicationrepository_application}.
...
func (j *jsiiProxy_DataAwsServerlessapplicationrepositoryApplication) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsServerlessapplicationrepositoryApplication) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsServerlessapplicationrepositoryApplication) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsServerlessapplicationrepositoryApplication) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsServerlessapplicationrepositoryApplication) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/data-sources/serverlessapplicationrepository_application aws_serverlessapplicationrepository_application} Data Source.
func NewDataAwsServerlessapplicationrepositoryApplication(scope constructs.Construct, id *string, config *DataAwsServerlessapplicationrepositoryApplicationConfig) DataAwsServerlessapplicationrepositoryApplication {
	...
	_jsii_.Create(
		"@cdktn/provider-aws.dataAwsServerlessapplicationrepositoryApplication.DataAwsServerlessapplicationrepositoryApplication",
...
func (j *jsiiProxy_DataAwsServerlessapplicationrepositoryApplication)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsServerlessapplicationrepositoryApplication)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsServerlessapplicationrepositoryApplication)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsServerlessapplicationrepositoryApplication_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsServerlessapplicationrepositoryApplication) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsServerlessapplicationrepositoryApplication) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsServerlessapplicationrepositoryApplication) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsServerlessapplicationrepositoryApplication) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
