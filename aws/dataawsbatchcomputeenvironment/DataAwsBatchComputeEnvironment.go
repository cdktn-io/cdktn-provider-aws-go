...
func (j *jsiiProxy_DataAwsBatchComputeEnvironment) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsBatchComputeEnvironment) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsBatchComputeEnvironment) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsBatchComputeEnvironment) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsBatchComputeEnvironment) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/data-sources/batch_compute_environment aws_batch_compute_environment} Data Source.
...
func (j *jsiiProxy_DataAwsBatchComputeEnvironment)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsBatchComputeEnvironment)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsBatchComputeEnvironment)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsBatchComputeEnvironment_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsBatchComputeEnvironment) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsBatchComputeEnvironment) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsBatchComputeEnvironment) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsBatchComputeEnvironment) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
