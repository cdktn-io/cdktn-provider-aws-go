...
func (s *jsiiProxy_SecurityhubAutomationRuleV2) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_SecurityhubAutomationRuleV2) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
