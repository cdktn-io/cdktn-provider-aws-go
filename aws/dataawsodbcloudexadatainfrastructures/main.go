...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "cloudExadataInfrastructures", GoGetter: "CloudExadataInfrastructures"},
	...
	_jsii_.RegisterClass(
		...
		func() interface{} {
			j := jsiiProxy_DataAwsOdbCloudExadataInfrastructuresCloudExadataInfrastructuresList{}
