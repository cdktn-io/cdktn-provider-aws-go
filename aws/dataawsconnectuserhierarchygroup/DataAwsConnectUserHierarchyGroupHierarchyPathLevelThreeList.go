...
func (j *jsiiProxy_DataAwsConnectUserHierarchyGroupHierarchyPathLevelThreeList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsConnectUserHierarchyGroupHierarchyPathLevelThreeList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsConnectUserHierarchyGroupHierarchyPathLevelThreeList {
	_init_.Initialize()
...
func NewDataAwsConnectUserHierarchyGroupHierarchyPathLevelThreeList_Override(d DataAwsConnectUserHierarchyGroupHierarchyPathLevelThreeList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsConnectUserHierarchyGroupHierarchyPathLevelThreeList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsConnectUserHierarchyGroupHierarchyPathLevelThreeList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsConnectUserHierarchyGroupHierarchyPathLevelThreeList) Resolve(context cdktn.IResolveContext) interface{} {
