...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/cloudtrail aws_cloudtrail}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/cloudtrail aws_cloudtrail} Resource.
...
func (c *jsiiProxy_Cloudtrail) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_Cloudtrail) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (c *jsiiProxy_Cloudtrail) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
