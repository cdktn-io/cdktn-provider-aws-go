...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/cloudtrail/internal"
...
func (j *jsiiProxy_CloudtrailAdvancedEventSelectorOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewCloudtrailAdvancedEventSelectorOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) CloudtrailAdvancedEventSelectorOutputReference {
	_init_.Initialize()

	if err := validateNewCloudtrailAdvancedEventSelectorOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func NewCloudtrailAdvancedEventSelectorOutputReference_Override(c CloudtrailAdvancedEventSelectorOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_CloudtrailAdvancedEventSelectorOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_CloudtrailAdvancedEventSelectorOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CloudtrailAdvancedEventSelectorOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (c *jsiiProxy_CloudtrailAdvancedEventSelectorOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CloudtrailAdvancedEventSelectorOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
