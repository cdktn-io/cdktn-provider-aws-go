...
func (j *jsiiProxy_CloudtrailEventSelectorDataResourceList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewCloudtrailEventSelectorDataResourceList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) CloudtrailEventSelectorDataResourceList {
	_init_.Initialize()
...
func NewCloudtrailEventSelectorDataResourceList_Override(c CloudtrailEventSelectorDataResourceList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_CloudtrailEventSelectorDataResourceList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_CloudtrailEventSelectorDataResourceList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (c *jsiiProxy_CloudtrailEventSelectorDataResourceList) Resolve(context cdktn.IResolveContext) interface{} {
