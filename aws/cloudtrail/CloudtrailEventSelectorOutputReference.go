...
func (c *jsiiProxy_CloudtrailEventSelectorOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CloudtrailEventSelectorOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
