...
func (c *jsiiProxy_CloudtrailEventSelectorDataResourceOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CloudtrailEventSelectorDataResourceOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
