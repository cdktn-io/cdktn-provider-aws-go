...
func (j *jsiiProxy_CloudtrailInsightSelectorList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewCloudtrailInsightSelectorList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) CloudtrailInsightSelectorList {
	_init_.Initialize()
...
func NewCloudtrailInsightSelectorList_Override(c CloudtrailInsightSelectorList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_CloudtrailInsightSelectorList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_CloudtrailInsightSelectorList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (c *jsiiProxy_CloudtrailInsightSelectorList) Resolve(context cdktn.IResolveContext) interface{} {
