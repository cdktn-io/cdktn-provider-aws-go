...
func (j *jsiiProxy_CloudtrailAdvancedEventSelectorFieldSelectorList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewCloudtrailAdvancedEventSelectorFieldSelectorList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) CloudtrailAdvancedEventSelectorFieldSelectorList {
	_init_.Initialize()
...
func NewCloudtrailAdvancedEventSelectorFieldSelectorList_Override(c CloudtrailAdvancedEventSelectorFieldSelectorList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_CloudtrailAdvancedEventSelectorFieldSelectorList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_CloudtrailAdvancedEventSelectorFieldSelectorList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (c *jsiiProxy_CloudtrailAdvancedEventSelectorFieldSelectorList) Resolve(context cdktn.IResolveContext) interface{} {
