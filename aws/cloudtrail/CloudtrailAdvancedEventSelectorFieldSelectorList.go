...
func (c *jsiiProxy_CloudtrailAdvancedEventSelectorFieldSelectorList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (c *jsiiProxy_CloudtrailAdvancedEventSelectorFieldSelectorList) Resolve(context cdktf.IResolveContext) interface{} {
