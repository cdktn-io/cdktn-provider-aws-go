...
func (j *jsiiProxy_CloudtrailAdvancedEventSelectorList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewCloudtrailAdvancedEventSelectorList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) CloudtrailAdvancedEventSelectorList {
	_init_.Initialize()

	if err := validateNewCloudtrailAdvancedEventSelectorListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewCloudtrailAdvancedEventSelectorList_Override(c CloudtrailAdvancedEventSelectorList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_CloudtrailAdvancedEventSelectorList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_CloudtrailAdvancedEventSelectorList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (c *jsiiProxy_CloudtrailAdvancedEventSelectorList) Resolve(context cdktn.IResolveContext) interface{} {
