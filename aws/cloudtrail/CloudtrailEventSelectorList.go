...
func (j *jsiiProxy_CloudtrailEventSelectorList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewCloudtrailEventSelectorList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) CloudtrailEventSelectorList {
	_init_.Initialize()
...
func NewCloudtrailEventSelectorList_Override(c CloudtrailEventSelectorList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_CloudtrailEventSelectorList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_CloudtrailEventSelectorList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (c *jsiiProxy_CloudtrailEventSelectorList) Resolve(context cdktn.IResolveContext) interface{} {
