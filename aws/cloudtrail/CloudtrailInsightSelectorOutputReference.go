...
func (c *jsiiProxy_CloudtrailInsightSelectorOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CloudtrailInsightSelectorOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
