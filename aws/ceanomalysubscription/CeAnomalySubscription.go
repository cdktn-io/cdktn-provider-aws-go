...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/ce_anomaly_subscription aws_ce_anomaly_subscription}.
...
func (j *jsiiProxy_CeAnomalySubscription) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_CeAnomalySubscription) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_CeAnomalySubscription) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_CeAnomalySubscription) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_CeAnomalySubscription) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/ce_anomaly_subscription aws_ce_anomaly_subscription} Resource.
...
func (j *jsiiProxy_CeAnomalySubscription)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_CeAnomalySubscription)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_CeAnomalySubscription)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func CeAnomalySubscription_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (c *jsiiProxy_CeAnomalySubscription) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CeAnomalySubscription) HasResourceMove() interface{} {
	var returns interface{}
...
func (c *jsiiProxy_CeAnomalySubscription) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (c *jsiiProxy_CeAnomalySubscription) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CeAnomalySubscription) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_CeAnomalySubscription) MoveFromId(id *string) {
...
func (c *jsiiProxy_CeAnomalySubscription) MoveToId(id *string) {
...
func (c *jsiiProxy_CeAnomalySubscription) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (c *jsiiProxy_CeAnomalySubscription) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (c *jsiiProxy_CeAnomalySubscription) ToHclTerraform() interface{} {
	var returns interface{}
...
func (c *jsiiProxy_CeAnomalySubscription) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
