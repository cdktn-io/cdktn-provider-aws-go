...
func (c *jsiiProxy_CeAnomalySubscriptionThresholdExpressionAndCostCategoryOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CeAnomalySubscriptionThresholdExpressionAndCostCategoryOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
