...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/daxparametergroup/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/dax_parameter_group aws_dax_parameter_group}.
...
func (j *jsiiProxy_DaxParameterGroup) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DaxParameterGroup) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DaxParameterGroup) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DaxParameterGroup) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DaxParameterGroup) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/dax_parameter_group aws_dax_parameter_group} Resource.
...
func (j *jsiiProxy_DaxParameterGroup)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DaxParameterGroup)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DaxParameterGroup)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DaxParameterGroup_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DaxParameterGroup) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DaxParameterGroup) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (d *jsiiProxy_DaxParameterGroup) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DaxParameterGroup) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (d *jsiiProxy_DaxParameterGroup) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DaxParameterGroup) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
