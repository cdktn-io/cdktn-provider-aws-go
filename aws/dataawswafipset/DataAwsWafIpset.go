...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/dataawswafipset/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/data-sources/waf_ipset aws_waf_ipset}.
...
func (j *jsiiProxy_DataAwsWafIpset) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsWafIpset) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsWafIpset) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsWafIpset) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsWafIpset) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/data-sources/waf_ipset aws_waf_ipset} Data Source.
...
func (j *jsiiProxy_DataAwsWafIpset)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsWafIpset)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsWafIpset)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
// Generates CDKTN code for importing a DataAwsWafIpset resource upon running "cdktn plan <stack-name>".
func DataAwsWafIpset_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsWafIpset) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsWafIpset) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsWafIpset) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsWafIpset) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
