...
func (j *jsiiProxy_BedrockagentcoreAgentRuntime) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_BedrockagentcoreAgentRuntime) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_BedrockagentcoreAgentRuntime) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_BedrockagentcoreAgentRuntime) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_BedrockagentcoreAgentRuntime) TagsAll() cdktn.StringMap {
...
func (j *jsiiProxy_BedrockagentcoreAgentRuntime) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_BedrockagentcoreAgentRuntime)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_BedrockagentcoreAgentRuntime)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_BedrockagentcoreAgentRuntime)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func BedrockagentcoreAgentRuntime_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (b *jsiiProxy_BedrockagentcoreAgentRuntime) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (b *jsiiProxy_BedrockagentcoreAgentRuntime) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (b *jsiiProxy_BedrockagentcoreAgentRuntime) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (b *jsiiProxy_BedrockagentcoreAgentRuntime) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (b *jsiiProxy_BedrockagentcoreAgentRuntime) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (b *jsiiProxy_BedrockagentcoreAgentRuntime) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
