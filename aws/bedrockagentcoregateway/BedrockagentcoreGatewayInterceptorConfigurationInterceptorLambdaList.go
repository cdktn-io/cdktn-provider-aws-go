...
func (j *jsiiProxy_BedrockagentcoreGatewayInterceptorConfigurationInterceptorLambdaList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewBedrockagentcoreGatewayInterceptorConfigurationInterceptorLambdaList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) BedrockagentcoreGatewayInterceptorConfigurationInterceptorLambdaList {
	_init_.Initialize()
...
func NewBedrockagentcoreGatewayInterceptorConfigurationInterceptorLambdaList_Override(b BedrockagentcoreGatewayInterceptorConfigurationInterceptorLambdaList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_BedrockagentcoreGatewayInterceptorConfigurationInterceptorLambdaList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (b *jsiiProxy_BedrockagentcoreGatewayInterceptorConfigurationInterceptorLambdaList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (b *jsiiProxy_BedrockagentcoreGatewayInterceptorConfigurationInterceptorLambdaList) Resolve(context cdktn.IResolveContext) interface{} {
