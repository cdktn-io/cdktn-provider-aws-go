...
func (j *jsiiProxy_BedrockagentcoreGatewayProtocolConfigurationMcpOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewBedrockagentcoreGatewayProtocolConfigurationMcpOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) BedrockagentcoreGatewayProtocolConfigurationMcpOutputReference {
	_init_.Initialize()
...
func NewBedrockagentcoreGatewayProtocolConfigurationMcpOutputReference_Override(b BedrockagentcoreGatewayProtocolConfigurationMcpOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_BedrockagentcoreGatewayProtocolConfigurationMcpOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (b *jsiiProxy_BedrockagentcoreGatewayProtocolConfigurationMcpOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (b *jsiiProxy_BedrockagentcoreGatewayProtocolConfigurationMcpOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (b *jsiiProxy_BedrockagentcoreGatewayProtocolConfigurationMcpOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (b *jsiiProxy_BedrockagentcoreGatewayProtocolConfigurationMcpOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
