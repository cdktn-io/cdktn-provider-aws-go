...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/directoryserviceregion/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/directory_service_region aws_directory_service_region}.
...
func (j *jsiiProxy_DirectoryServiceRegion) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DirectoryServiceRegion) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DirectoryServiceRegion) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DirectoryServiceRegion) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DirectoryServiceRegion) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/directory_service_region aws_directory_service_region} Resource.
...
func (j *jsiiProxy_DirectoryServiceRegion)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DirectoryServiceRegion)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DirectoryServiceRegion)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DirectoryServiceRegion_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DirectoryServiceRegion) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DirectoryServiceRegion) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (d *jsiiProxy_DirectoryServiceRegion) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DirectoryServiceRegion) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (d *jsiiProxy_DirectoryServiceRegion) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DirectoryServiceRegion) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
