...
func (d *jsiiProxy_DirectoryServiceRegionTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DirectoryServiceRegionTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
