...
func (d *jsiiProxy_DirectoryServiceRegionVpcSettingsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DirectoryServiceRegionVpcSettingsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
