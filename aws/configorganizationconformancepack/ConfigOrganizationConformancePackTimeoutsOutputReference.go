...
func (c *jsiiProxy_ConfigOrganizationConformancePackTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ConfigOrganizationConformancePackTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
