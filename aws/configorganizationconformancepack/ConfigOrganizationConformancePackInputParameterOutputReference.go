...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v24/configorganizationconformancepack/internal"
...
func (j *jsiiProxy_ConfigOrganizationConformancePackInputParameterOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewConfigOrganizationConformancePackInputParameterOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) ConfigOrganizationConformancePackInputParameterOutputReference {
	_init_.Initialize()

	if err := validateNewConfigOrganizationConformancePackInputParameterOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func NewConfigOrganizationConformancePackInputParameterOutputReference_Override(c ConfigOrganizationConformancePackInputParameterOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ConfigOrganizationConformancePackInputParameterOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_ConfigOrganizationConformancePackInputParameterOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_ConfigOrganizationConformancePackInputParameterOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (c *jsiiProxy_ConfigOrganizationConformancePackInputParameterOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_ConfigOrganizationConformancePackInputParameterOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
