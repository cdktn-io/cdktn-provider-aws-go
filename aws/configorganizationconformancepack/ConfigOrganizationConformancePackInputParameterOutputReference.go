...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v22/configorganizationconformancepack/internal"
...
func (c *jsiiProxy_ConfigOrganizationConformancePackInputParameterOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ConfigOrganizationConformancePackInputParameterOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
