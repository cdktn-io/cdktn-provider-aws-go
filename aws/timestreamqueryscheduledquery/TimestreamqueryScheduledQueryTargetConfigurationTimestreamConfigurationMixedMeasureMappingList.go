...
func (t *jsiiProxy_TimestreamqueryScheduledQueryTargetConfigurationTimestreamConfigurationMixedMeasureMappingList) Resolve(context cdktf.IResolveContext) interface{} {
