...
func (t *jsiiProxy_TimestreamqueryScheduledQueryNotificationConfigurationOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (t *jsiiProxy_TimestreamqueryScheduledQueryNotificationConfigurationOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
