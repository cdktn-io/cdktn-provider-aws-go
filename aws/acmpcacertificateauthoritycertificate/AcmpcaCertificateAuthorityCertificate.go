...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/acmpcacertificateauthoritycertificate/internal"
...
func (j *jsiiProxy_AcmpcaCertificateAuthorityCertificate) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_AcmpcaCertificateAuthorityCertificate) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_AcmpcaCertificateAuthorityCertificate) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_AcmpcaCertificateAuthorityCertificate) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_AcmpcaCertificateAuthorityCertificate) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_AcmpcaCertificateAuthorityCertificate) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_AcmpcaCertificateAuthorityCertificate) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/acmpca_certificate_authority_certificate aws_acmpca_certificate_authority_certificate} Resource.
func NewAcmpcaCertificateAuthorityCertificate(scope constructs.Construct, id *string, config *AcmpcaCertificateAuthorityCertificateConfig) AcmpcaCertificateAuthorityCertificate {
	...
	_jsii_.Create(
		"@cdktn/provider-aws.acmpcaCertificateAuthorityCertificate.AcmpcaCertificateAuthorityCertificate",
...
func (j *jsiiProxy_AcmpcaCertificateAuthorityCertificate)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_AcmpcaCertificateAuthorityCertificate)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_AcmpcaCertificateAuthorityCertificate)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_AcmpcaCertificateAuthorityCertificate)SetRegion(val *string) {
...
func AcmpcaCertificateAuthorityCertificate_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (a *jsiiProxy_AcmpcaCertificateAuthorityCertificate) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AcmpcaCertificateAuthorityCertificate) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (a *jsiiProxy_AcmpcaCertificateAuthorityCertificate) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AcmpcaCertificateAuthorityCertificate) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (a *jsiiProxy_AcmpcaCertificateAuthorityCertificate) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (a *jsiiProxy_AcmpcaCertificateAuthorityCertificate) ResetRegion() {
	_jsii_.InvokeVoid(
		a,
		"resetRegion",
		nil, // no parameters
...
func (a *jsiiProxy_AcmpcaCertificateAuthorityCertificate) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
