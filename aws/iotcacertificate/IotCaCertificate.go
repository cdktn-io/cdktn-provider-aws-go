...
func (j *jsiiProxy_IotCaCertificate) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_IotCaCertificate) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_IotCaCertificate) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_IotCaCertificate) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_IotCaCertificate) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_IotCaCertificate)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_IotCaCertificate)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_IotCaCertificate)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func IotCaCertificate_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (i *jsiiProxy_IotCaCertificate) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (i *jsiiProxy_IotCaCertificate) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (i *jsiiProxy_IotCaCertificate) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (i *jsiiProxy_IotCaCertificate) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (i *jsiiProxy_IotCaCertificate) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (i *jsiiProxy_IotCaCertificate) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
