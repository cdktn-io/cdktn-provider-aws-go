...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/apprunnerconnection/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/apprunner_connection aws_apprunner_connection}.
...
func (j *jsiiProxy_ApprunnerConnection) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_ApprunnerConnection) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_ApprunnerConnection) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_ApprunnerConnection) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_ApprunnerConnection) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/apprunner_connection aws_apprunner_connection} Resource.
...
func (j *jsiiProxy_ApprunnerConnection)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_ApprunnerConnection)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_ApprunnerConnection)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
// Generates CDKTN code for importing a ApprunnerConnection resource upon running "cdktn plan <stack-name>".
func ApprunnerConnection_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (a *jsiiProxy_ApprunnerConnection) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_ApprunnerConnection) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (a *jsiiProxy_ApprunnerConnection) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_ApprunnerConnection) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (a *jsiiProxy_ApprunnerConnection) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (a *jsiiProxy_ApprunnerConnection) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
