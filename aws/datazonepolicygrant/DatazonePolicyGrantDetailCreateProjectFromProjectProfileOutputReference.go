...
func NewDatazonePolicyGrantDetailCreateProjectFromProjectProfileOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) DatazonePolicyGrantDetailCreateProjectFromProjectProfileOutputReference {
	_init_.Initialize()

	if err := validateNewDatazonePolicyGrantDetailCreateProjectFromProjectProfileOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
	j := jsiiProxy_DatazonePolicyGrantDetailCreateProjectFromProjectProfileOutputReference{}

	_jsii_.Create(
		"@cdktn/provider-aws.datazonePolicyGrant.DatazonePolicyGrantDetailCreateProjectFromProjectProfileOutputReference",
...
func NewDatazonePolicyGrantDetailCreateProjectFromProjectProfileOutputReference_Override(d DatazonePolicyGrantDetailCreateProjectFromProjectProfileOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
