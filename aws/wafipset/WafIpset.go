...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/waf_ipset aws_waf_ipset}.
type WafIpset interface {
	...
	SetId(val *string)
	IdInput() *string
	IpSetDescriptors() WafIpsetIpSetDescriptorsList
	...
	PutIpSetDescriptors(value interface{})
...
func (j *jsiiProxy_WafIpset) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_WafIpset) Connection() interface{} {
...
func (j *jsiiProxy_WafIpset) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_WafIpset) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_WafIpset) IpSetDescriptors() WafIpsetIpSetDescriptorsList {
	var returns WafIpsetIpSetDescriptorsList
	_jsii_.Get(
		j,
		"ipSetDescriptors",
		&returns,
...
func (j *jsiiProxy_WafIpset) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_WafIpset) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_WafIpset) Provisioners() *[]interface{} {
	var returns *[]interface{}
	_jsii_.Get(
		j,
		"provisioners",
...
func (j *jsiiProxy_WafIpset) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/waf_ipset aws_waf_ipset} Resource.
func NewWafIpset(scope constructs.Construct, id *string, config *WafIpsetConfig) WafIpset {
	_init_.Initialize()

	if err := validateNewWafIpsetParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_WafIpset)SetConnection(val interface{}) {
...
func (j *jsiiProxy_WafIpset)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_WafIpset)SetId(val *string) {
...
func (j *jsiiProxy_WafIpset)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_WafIpset)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_WafIpset)SetProvisioners(val *[]interface{}) {
...
func WafIpset_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateWafIpset_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func WafIpset_IsConstruct(x interface{}) *bool {
	...
	if err := validateWafIpset_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func WafIpset_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateWafIpset_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func WafIpset_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateWafIpset_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (w *jsiiProxy_WafIpset) AddMoveTarget(moveTarget *string) {
...
func (w *jsiiProxy_WafIpset) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_WafIpset) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (w *jsiiProxy_WafIpset) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_WafIpset) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (w *jsiiProxy_WafIpset) PutIpSetDescriptors(value interface{}) {
	if err := w.validatePutIpSetDescriptorsParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		w,
...
func (w *jsiiProxy_WafIpset) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (w *jsiiProxy_WafIpset) ResetId() {
	_jsii_.InvokeVoid(
		w,
		"resetId",
		nil, // no parameters
...
func (w *jsiiProxy_WafIpset) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (w *jsiiProxy_WafIpset) ToHclTerraform() interface{} {
	var returns interface{}
...
func (w *jsiiProxy_WafIpset) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
