...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/dxconnectionassociation/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/dx_connection_association aws_dx_connection_association}.
...
func (j *jsiiProxy_DxConnectionAssociation) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DxConnectionAssociation) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DxConnectionAssociation) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DxConnectionAssociation) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DxConnectionAssociation) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DxConnectionAssociation) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_DxConnectionAssociation) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/dx_connection_association aws_dx_connection_association} Resource.
func NewDxConnectionAssociation(scope constructs.Construct, id *string, config *DxConnectionAssociationConfig) DxConnectionAssociation {
	...
	_jsii_.Create(
		"@cdktn/provider-aws.dxConnectionAssociation.DxConnectionAssociation",
...
func (j *jsiiProxy_DxConnectionAssociation)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DxConnectionAssociation)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DxConnectionAssociation)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_DxConnectionAssociation)SetRegion(val *string) {
...
func DxConnectionAssociation_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateDxConnectionAssociation_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
// Experimental.
func DxConnectionAssociation_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDxConnectionAssociation_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DxConnectionAssociation_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDxConnectionAssociation_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (d *jsiiProxy_DxConnectionAssociation) AddMoveTarget(moveTarget *string) {
...
func (d *jsiiProxy_DxConnectionAssociation) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DxConnectionAssociation) HasResourceMove() interface{} {
	var returns interface{}
...
func (d *jsiiProxy_DxConnectionAssociation) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (d *jsiiProxy_DxConnectionAssociation) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DxConnectionAssociation) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (d *jsiiProxy_DxConnectionAssociation) MoveFromId(id *string) {
...
func (d *jsiiProxy_DxConnectionAssociation) MoveTo(moveTarget *string, index interface{}) {
...
func (d *jsiiProxy_DxConnectionAssociation) MoveToId(id *string) {
...
func (d *jsiiProxy_DxConnectionAssociation) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DxConnectionAssociation) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
...
func (d *jsiiProxy_DxConnectionAssociation) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DxConnectionAssociation) ToHclTerraform() interface{} {
	var returns interface{}
...
func (d *jsiiProxy_DxConnectionAssociation) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
