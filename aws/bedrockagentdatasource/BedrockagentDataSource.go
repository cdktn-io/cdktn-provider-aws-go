...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/bedrockagent_data_source aws_bedrockagent_data_source}.
...
func (j *jsiiProxy_BedrockagentDataSource) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_BedrockagentDataSource) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_BedrockagentDataSource) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_BedrockagentDataSource) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_BedrockagentDataSource) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/bedrockagent_data_source aws_bedrockagent_data_source} Resource.
...
func (j *jsiiProxy_BedrockagentDataSource)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_BedrockagentDataSource)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_BedrockagentDataSource)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func BedrockagentDataSource_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (b *jsiiProxy_BedrockagentDataSource) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (b *jsiiProxy_BedrockagentDataSource) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (b *jsiiProxy_BedrockagentDataSource) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (b *jsiiProxy_BedrockagentDataSource) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (b *jsiiProxy_BedrockagentDataSource) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (b *jsiiProxy_BedrockagentDataSource) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
