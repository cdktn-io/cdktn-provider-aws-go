...
func (b *jsiiProxy_BedrockagentDataSourceVectorIngestionConfigurationCustomTransformationConfigurationTransformationList) Resolve(context cdktf.IResolveContext) interface{} {
