...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/dataawsautoscalinggroups/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/data-sources/autoscaling_groups aws_autoscaling_groups}.
...
func (j *jsiiProxy_DataAwsAutoscalingGroups) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsAutoscalingGroups) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsAutoscalingGroups) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsAutoscalingGroups) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsAutoscalingGroups) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DataAwsAutoscalingGroups) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_DataAwsAutoscalingGroups) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/data-sources/autoscaling_groups aws_autoscaling_groups} Data Source.
...
func (j *jsiiProxy_DataAwsAutoscalingGroups)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsAutoscalingGroups)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsAutoscalingGroups)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_DataAwsAutoscalingGroups)SetRegion(val *string) {
...
func DataAwsAutoscalingGroups_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsAutoscalingGroups) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsAutoscalingGroups) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsAutoscalingGroups) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsAutoscalingGroups) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsAutoscalingGroups) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
