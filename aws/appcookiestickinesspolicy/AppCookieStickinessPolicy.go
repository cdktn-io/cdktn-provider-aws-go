...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/appcookiestickinesspolicy/internal"
...
func (j *jsiiProxy_AppCookieStickinessPolicy) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_AppCookieStickinessPolicy) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_AppCookieStickinessPolicy) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_AppCookieStickinessPolicy) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_AppCookieStickinessPolicy) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_AppCookieStickinessPolicy) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_AppCookieStickinessPolicy) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/app_cookie_stickiness_policy aws_app_cookie_stickiness_policy} Resource.
...
func (j *jsiiProxy_AppCookieStickinessPolicy)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_AppCookieStickinessPolicy)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_AppCookieStickinessPolicy)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_AppCookieStickinessPolicy)SetRegion(val *string) {
...
func AppCookieStickinessPolicy_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (a *jsiiProxy_AppCookieStickinessPolicy) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AppCookieStickinessPolicy) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (a *jsiiProxy_AppCookieStickinessPolicy) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AppCookieStickinessPolicy) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (a *jsiiProxy_AppCookieStickinessPolicy) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (a *jsiiProxy_AppCookieStickinessPolicy) ResetRegion() {
	_jsii_.InvokeVoid(
		a,
		"resetRegion",
		nil, // no parameters
...
func (a *jsiiProxy_AppCookieStickinessPolicy) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
