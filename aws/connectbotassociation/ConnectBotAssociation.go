...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v22/connectbotassociation/internal"
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.31.0/docs/resources/connect_bot_association aws_connect_bot_association} Resource.
...
func ConnectBotAssociation_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (c *jsiiProxy_ConnectBotAssociation) ImportFrom(id *string, provider cdktf.TerraformProvider) {
