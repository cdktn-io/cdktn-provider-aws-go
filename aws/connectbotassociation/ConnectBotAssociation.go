...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/connectbotassociation/internal"
...
func (j *jsiiProxy_ConnectBotAssociation) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_ConnectBotAssociation) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_ConnectBotAssociation) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_ConnectBotAssociation) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_ConnectBotAssociation) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_ConnectBotAssociation) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_ConnectBotAssociation) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/connect_bot_association aws_connect_bot_association} Resource.
...
func (j *jsiiProxy_ConnectBotAssociation)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_ConnectBotAssociation)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_ConnectBotAssociation)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_ConnectBotAssociation)SetRegion(val *string) {
...
func ConnectBotAssociation_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateConnectBotAssociation_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (c *jsiiProxy_ConnectBotAssociation) AddMoveTarget(moveTarget *string) {
...
func (c *jsiiProxy_ConnectBotAssociation) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_ConnectBotAssociation) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (c *jsiiProxy_ConnectBotAssociation) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_ConnectBotAssociation) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_ConnectBotAssociation) MoveFromId(id *string) {
...
func (c *jsiiProxy_ConnectBotAssociation) MoveToId(id *string) {
...
func (c *jsiiProxy_ConnectBotAssociation) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (c *jsiiProxy_ConnectBotAssociation) ResetRegion() {
	_jsii_.InvokeVoid(
		c,
		"resetRegion",
		nil, // no parameters
...
func (c *jsiiProxy_ConnectBotAssociation) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
