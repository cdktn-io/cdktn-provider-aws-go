...
func (d *jsiiProxy_DataAwsOrganizationsOrganizationRootsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsOrganizationsOrganizationRootsList) Resolve(context cdktf.IResolveContext) interface{} {
