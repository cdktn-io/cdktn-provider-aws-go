...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v24/dataawsorganizationsorganization/internal"
...
func (j *jsiiProxy_DataAwsOrganizationsOrganizationRootsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsOrganizationsOrganizationRootsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsOrganizationsOrganizationRootsList {
	_init_.Initialize()

	if err := validateNewDataAwsOrganizationsOrganizationRootsListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewDataAwsOrganizationsOrganizationRootsList_Override(d DataAwsOrganizationsOrganizationRootsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsOrganizationsOrganizationRootsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsOrganizationsOrganizationRootsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsOrganizationsOrganizationRootsList) Resolve(context cdktn.IResolveContext) interface{} {
