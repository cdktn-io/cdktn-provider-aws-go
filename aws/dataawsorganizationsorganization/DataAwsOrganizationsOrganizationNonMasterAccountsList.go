...
func (j *jsiiProxy_DataAwsOrganizationsOrganizationNonMasterAccountsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsOrganizationsOrganizationNonMasterAccountsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsOrganizationsOrganizationNonMasterAccountsList {
	_init_.Initialize()
...
func NewDataAwsOrganizationsOrganizationNonMasterAccountsList_Override(d DataAwsOrganizationsOrganizationNonMasterAccountsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsOrganizationsOrganizationNonMasterAccountsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsOrganizationsOrganizationNonMasterAccountsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsOrganizationsOrganizationNonMasterAccountsList) Resolve(context cdktn.IResolveContext) interface{} {
