...
func (s *jsiiProxy_ServicecatalogProductProvisioningArtifactParametersOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_ServicecatalogProductProvisioningArtifactParametersOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
