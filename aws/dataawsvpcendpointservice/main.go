...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "privateDnsNames", GoGetter: "PrivateDnsNames"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetServiceRegions", GoMethod: "ResetServiceRegions"},
