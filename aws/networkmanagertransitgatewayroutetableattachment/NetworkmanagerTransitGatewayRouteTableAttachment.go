...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/networkmanagertransitgatewayroutetableattachment/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/networkmanager_transit_gateway_route_table_attachment aws_networkmanager_transit_gateway_route_table_attachment}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/networkmanager_transit_gateway_route_table_attachment aws_networkmanager_transit_gateway_route_table_attachment} Resource.
...
func (n *jsiiProxy_NetworkmanagerTransitGatewayRouteTableAttachment) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (n *jsiiProxy_NetworkmanagerTransitGatewayRouteTableAttachment) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (n *jsiiProxy_NetworkmanagerTransitGatewayRouteTableAttachment) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
