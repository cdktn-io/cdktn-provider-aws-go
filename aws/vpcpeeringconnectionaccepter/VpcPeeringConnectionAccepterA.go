...
func (j *jsiiProxy_VpcPeeringConnectionAccepterA) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_VpcPeeringConnectionAccepterA) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_VpcPeeringConnectionAccepterA) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_VpcPeeringConnectionAccepterA) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_VpcPeeringConnectionAccepterA) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_VpcPeeringConnectionAccepterA) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_VpcPeeringConnectionAccepterA) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/vpc_peering_connection_accepter aws_vpc_peering_connection_accepter} Resource.
...
func (j *jsiiProxy_VpcPeeringConnectionAccepterA)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_VpcPeeringConnectionAccepterA)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_VpcPeeringConnectionAccepterA)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_VpcPeeringConnectionAccepterA)SetRegion(val *string) {
...
func VpcPeeringConnectionAccepterA_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (v *jsiiProxy_VpcPeeringConnectionAccepterA) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (v *jsiiProxy_VpcPeeringConnectionAccepterA) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (v *jsiiProxy_VpcPeeringConnectionAccepterA) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (v *jsiiProxy_VpcPeeringConnectionAccepterA) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (v *jsiiProxy_VpcPeeringConnectionAccepterA) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (v *jsiiProxy_VpcPeeringConnectionAccepterA) ResetRegion() {
	_jsii_.InvokeVoid(
		v,
		"resetRegion",
		nil, // no parameters
...
func (v *jsiiProxy_VpcPeeringConnectionAccepterA) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
