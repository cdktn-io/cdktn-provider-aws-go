...
func (s *jsiiProxy_SubnetTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_SubnetTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
