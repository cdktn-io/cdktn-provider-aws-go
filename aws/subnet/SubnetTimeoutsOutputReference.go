...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v24/subnet/internal"
...
func (j *jsiiProxy_SubnetTimeoutsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewSubnetTimeoutsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) SubnetTimeoutsOutputReference {
	_init_.Initialize()
...
func NewSubnetTimeoutsOutputReference_Override(s SubnetTimeoutsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_SubnetTimeoutsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_SubnetTimeoutsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SubnetTimeoutsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (s *jsiiProxy_SubnetTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SubnetTimeoutsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
