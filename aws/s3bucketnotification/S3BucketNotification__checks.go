...
func (s *jsiiProxy_S3BucketNotification) validatePutLambdaFunctionParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*S3BucketNotificationLambdaFunction; received %#v (a %T)", value, value)
		}
	}
...
func (s *jsiiProxy_S3BucketNotification) validatePutQueueParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*S3BucketNotificationQueue; received %#v (a %T)", value, value)
		}
	}
