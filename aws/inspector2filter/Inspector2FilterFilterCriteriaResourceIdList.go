...
func (j *jsiiProxy_Inspector2FilterFilterCriteriaResourceIdList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_Inspector2FilterFilterCriteriaResourceIdList) InternalValue() interface{} {
...
func (j *jsiiProxy_Inspector2FilterFilterCriteriaResourceIdList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_Inspector2FilterFilterCriteriaResourceIdList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (j *jsiiProxy_Inspector2FilterFilterCriteriaResourceIdList)SetInternalValue(val interface{}) {
...
func (j *jsiiProxy_Inspector2FilterFilterCriteriaResourceIdList)SetTerraformAttribute(val *string) {
...
func (j *jsiiProxy_Inspector2FilterFilterCriteriaResourceIdList)SetWrapsSet(val *bool) {
...
func (i *jsiiProxy_Inspector2FilterFilterCriteriaResourceIdList) ComputeFqn() *string {
	var returns *string
...
func (i *jsiiProxy_Inspector2FilterFilterCriteriaResourceIdList) Get(index *float64) Inspector2FilterFilterCriteriaResourceIdOutputReference {
	if err := i.validateGetParameters(index); err != nil {
		panic(err)
	}
	var returns Inspector2FilterFilterCriteriaResourceIdOutputReference
...
func (i *jsiiProxy_Inspector2FilterFilterCriteriaResourceIdList) ToString() *string {
	var returns *string
