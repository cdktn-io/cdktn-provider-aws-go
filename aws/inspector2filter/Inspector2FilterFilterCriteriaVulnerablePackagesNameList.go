...
func (j *jsiiProxy_Inspector2FilterFilterCriteriaVulnerablePackagesNameList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewInspector2FilterFilterCriteriaVulnerablePackagesNameList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) Inspector2FilterFilterCriteriaVulnerablePackagesNameList {
	_init_.Initialize()
...
func NewInspector2FilterFilterCriteriaVulnerablePackagesNameList_Override(i Inspector2FilterFilterCriteriaVulnerablePackagesNameList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_Inspector2FilterFilterCriteriaVulnerablePackagesNameList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (i *jsiiProxy_Inspector2FilterFilterCriteriaVulnerablePackagesNameList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (i *jsiiProxy_Inspector2FilterFilterCriteriaVulnerablePackagesNameList) Resolve(context cdktn.IResolveContext) interface{} {
