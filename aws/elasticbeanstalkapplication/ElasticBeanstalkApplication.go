...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/elasticbeanstalkapplication/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/elastic_beanstalk_application aws_elastic_beanstalk_application}.
...
func (j *jsiiProxy_ElasticBeanstalkApplication) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_ElasticBeanstalkApplication) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_ElasticBeanstalkApplication) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_ElasticBeanstalkApplication) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_ElasticBeanstalkApplication) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_ElasticBeanstalkApplication) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_ElasticBeanstalkApplication) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/elastic_beanstalk_application aws_elastic_beanstalk_application} Resource.
func NewElasticBeanstalkApplication(scope constructs.Construct, id *string, config *ElasticBeanstalkApplicationConfig) ElasticBeanstalkApplication {
	...
	if err := validateNewElasticBeanstalkApplicationParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_ElasticBeanstalkApplication)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_ElasticBeanstalkApplication)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_ElasticBeanstalkApplication)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_ElasticBeanstalkApplication)SetRegion(val *string) {
...
func ElasticBeanstalkApplication_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateElasticBeanstalkApplication_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (e *jsiiProxy_ElasticBeanstalkApplication) AddMoveTarget(moveTarget *string) {
...
func (e *jsiiProxy_ElasticBeanstalkApplication) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (e *jsiiProxy_ElasticBeanstalkApplication) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (e *jsiiProxy_ElasticBeanstalkApplication) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (e *jsiiProxy_ElasticBeanstalkApplication) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (e *jsiiProxy_ElasticBeanstalkApplication) MoveFromId(id *string) {
...
func (e *jsiiProxy_ElasticBeanstalkApplication) MoveToId(id *string) {
...
func (e *jsiiProxy_ElasticBeanstalkApplication) PutAppversionLifecycle(value *ElasticBeanstalkApplicationAppversionLifecycle) {
	if err := e.validatePutAppversionLifecycleParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		e,
...
func (e *jsiiProxy_ElasticBeanstalkApplication) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (e *jsiiProxy_ElasticBeanstalkApplication) ResetRegion() {
	_jsii_.InvokeVoid(
		e,
		"resetRegion",
		nil, // no parameters
...
func (e *jsiiProxy_ElasticBeanstalkApplication) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
