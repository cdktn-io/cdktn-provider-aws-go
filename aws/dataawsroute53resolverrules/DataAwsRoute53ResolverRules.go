...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/dataawsroute53resolverrules/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/data-sources/route53_resolver_rules aws_route53_resolver_rules}.
...
func (j *jsiiProxy_DataAwsRoute53ResolverRules) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsRoute53ResolverRules) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsRoute53ResolverRules) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_DataAwsRoute53ResolverRules) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsRoute53ResolverRules) NameRegex() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nameRegex",
...
func (j *jsiiProxy_DataAwsRoute53ResolverRules) NameRegexInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nameRegexInput",
...
func (j *jsiiProxy_DataAwsRoute53ResolverRules) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsRoute53ResolverRules) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DataAwsRoute53ResolverRules) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_DataAwsRoute53ResolverRules) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/data-sources/route53_resolver_rules aws_route53_resolver_rules} Data Source.
func NewDataAwsRoute53ResolverRules(scope constructs.Construct, id *string, config *DataAwsRoute53ResolverRulesConfig) DataAwsRoute53ResolverRules {
	...
	if err := validateNewDataAwsRoute53ResolverRulesParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_DataAwsRoute53ResolverRules)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsRoute53ResolverRules)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsRoute53ResolverRules)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_DataAwsRoute53ResolverRules)SetRegion(val *string) {
...
func DataAwsRoute53ResolverRules_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateDataAwsRoute53ResolverRules_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataAwsRoute53ResolverRules) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsRoute53ResolverRules) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsRoute53ResolverRules) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsRoute53ResolverRules) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsRoute53ResolverRules) ResetNameRegex() {
	_jsii_.InvokeVoid(
		d,
		"resetNameRegex",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsRoute53ResolverRules) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsRoute53ResolverRules) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
