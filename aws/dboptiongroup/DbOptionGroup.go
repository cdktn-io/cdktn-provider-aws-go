...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/db_option_group aws_db_option_group}.
...
func (j *jsiiProxy_DbOptionGroup) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DbOptionGroup) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DbOptionGroup) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DbOptionGroup) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DbOptionGroup) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DbOptionGroup) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_DbOptionGroup) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/db_option_group aws_db_option_group} Resource.
...
func (j *jsiiProxy_DbOptionGroup)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DbOptionGroup)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DbOptionGroup)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_DbOptionGroup)SetRegion(val *string) {
...
func DbOptionGroup_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DbOptionGroup) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DbOptionGroup) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (d *jsiiProxy_DbOptionGroup) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DbOptionGroup) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (d *jsiiProxy_DbOptionGroup) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DbOptionGroup) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
...
func (d *jsiiProxy_DbOptionGroup) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
