...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/servicecatalogtagoptionresourceassociation/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/servicecatalog_tag_option_resource_association aws_servicecatalog_tag_option_resource_association}.
...
func (j *jsiiProxy_ServicecatalogTagOptionResourceAssociation) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_ServicecatalogTagOptionResourceAssociation) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_ServicecatalogTagOptionResourceAssociation) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_ServicecatalogTagOptionResourceAssociation) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_ServicecatalogTagOptionResourceAssociation) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_ServicecatalogTagOptionResourceAssociation) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_ServicecatalogTagOptionResourceAssociation) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/servicecatalog_tag_option_resource_association aws_servicecatalog_tag_option_resource_association} Resource.
func NewServicecatalogTagOptionResourceAssociation(scope constructs.Construct, id *string, config *ServicecatalogTagOptionResourceAssociationConfig) ServicecatalogTagOptionResourceAssociation {
	...
	_jsii_.Create(
		"@cdktn/provider-aws.servicecatalogTagOptionResourceAssociation.ServicecatalogTagOptionResourceAssociation",
...
func (j *jsiiProxy_ServicecatalogTagOptionResourceAssociation)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_ServicecatalogTagOptionResourceAssociation)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_ServicecatalogTagOptionResourceAssociation)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_ServicecatalogTagOptionResourceAssociation)SetRegion(val *string) {
...
func ServicecatalogTagOptionResourceAssociation_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (s *jsiiProxy_ServicecatalogTagOptionResourceAssociation) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_ServicecatalogTagOptionResourceAssociation) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_ServicecatalogTagOptionResourceAssociation) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_ServicecatalogTagOptionResourceAssociation) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_ServicecatalogTagOptionResourceAssociation) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_ServicecatalogTagOptionResourceAssociation) ResetRegion() {
	_jsii_.InvokeVoid(
		s,
		"resetRegion",
		nil, // no parameters
...
func (s *jsiiProxy_ServicecatalogTagOptionResourceAssociation) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
