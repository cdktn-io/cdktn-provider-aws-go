...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*S3FilesMountTarget)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-aws.s3FilesMountTarget.S3FilesMountTargetConfig",
		reflect.TypeOf((*S3FilesMountTargetConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-aws.s3FilesMountTarget.S3FilesMountTargetTimeouts",
		reflect.TypeOf((*S3FilesMountTargetTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-aws.s3FilesMountTarget.S3FilesMountTargetTimeoutsOutputReference",
		reflect.TypeOf((*S3FilesMountTargetTimeoutsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
