...
func (s *jsiiProxy_SagemakerUserProfileUserSettingsOutputReference) validatePutCanvasAppSettingsParameters(value *SagemakerUserProfileUserSettingsCanvasAppSettings) error {
	if value == nil {
...
func (s *jsiiProxy_SagemakerUserProfileUserSettingsOutputReference) validatePutCustomFileSystemConfigParameters(value interface{}) error {
	...
	case []*SagemakerUserProfileUserSettingsCustomFileSystemConfig:
		value_ := value.([]*SagemakerUserProfileUserSettingsCustomFileSystemConfig)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
...
func (s *jsiiProxy_SagemakerUserProfileUserSettingsOutputReference) validatePutRSessionAppSettingsParameters(value *SagemakerUserProfileUserSettingsRSessionAppSettings) error {
	if value == nil {
		return fmt.Errorf("parameter value is required, but nil was provided")
	}
	if err := _jsii_.ValidateStruct(value, func() string { return "parameter value" }); err != nil {
...
func (j *jsiiProxy_SagemakerUserProfileUserSettingsOutputReference) validateSetInternalValueParameters(val *SagemakerUserProfileUserSettings) error {
