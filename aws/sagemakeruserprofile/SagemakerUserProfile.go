...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/sagemaker_user_profile aws_sagemaker_user_profile}.
...
func (j *jsiiProxy_SagemakerUserProfile) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_SagemakerUserProfile) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_SagemakerUserProfile) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_SagemakerUserProfile) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_SagemakerUserProfile) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/sagemaker_user_profile aws_sagemaker_user_profile} Resource.
...
func (j *jsiiProxy_SagemakerUserProfile)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_SagemakerUserProfile)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_SagemakerUserProfile)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func SagemakerUserProfile_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateSagemakerUserProfile_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_SagemakerUserProfile) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_SagemakerUserProfile) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SagemakerUserProfile) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_SagemakerUserProfile) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SagemakerUserProfile) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_SagemakerUserProfile) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_SagemakerUserProfile) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
