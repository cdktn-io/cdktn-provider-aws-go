...
func (j *jsiiProxy_SagemakerUserProfileUserSettingsStudioWebPortalSettingsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewSagemakerUserProfileUserSettingsStudioWebPortalSettingsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) SagemakerUserProfileUserSettingsStudioWebPortalSettingsOutputReference {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-aws.sagemakerUserProfile.SagemakerUserProfileUserSettingsStudioWebPortalSettingsOutputReference",
...
func NewSagemakerUserProfileUserSettingsStudioWebPortalSettingsOutputReference_Override(s SagemakerUserProfileUserSettingsStudioWebPortalSettingsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_SagemakerUserProfileUserSettingsStudioWebPortalSettingsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_SagemakerUserProfileUserSettingsStudioWebPortalSettingsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SagemakerUserProfileUserSettingsStudioWebPortalSettingsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (s *jsiiProxy_SagemakerUserProfileUserSettingsStudioWebPortalSettingsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SagemakerUserProfileUserSettingsStudioWebPortalSettingsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
