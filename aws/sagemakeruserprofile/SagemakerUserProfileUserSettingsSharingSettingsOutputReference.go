...
func (j *jsiiProxy_SagemakerUserProfileUserSettingsSharingSettingsOutputReference) ComplexObjectIndex() interface{} {
...
func (j *jsiiProxy_SagemakerUserProfileUserSettingsSharingSettingsOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_SagemakerUserProfileUserSettingsSharingSettingsOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_SagemakerUserProfileUserSettingsSharingSettingsOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_SagemakerUserProfileUserSettingsSharingSettingsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewSagemakerUserProfileUserSettingsSharingSettingsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) SagemakerUserProfileUserSettingsSharingSettingsOutputReference {
	_init_.Initialize()

	if err := validateNewSagemakerUserProfileUserSettingsSharingSettingsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewSagemakerUserProfileUserSettingsSharingSettingsOutputReference_Override(s SagemakerUserProfileUserSettingsSharingSettingsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_SagemakerUserProfileUserSettingsSharingSettingsOutputReference)SetComplexObjectIndex(val interface{}) {
...
func (j *jsiiProxy_SagemakerUserProfileUserSettingsSharingSettingsOutputReference)SetComplexObjectIsFromSet(val *bool) {
...
func (j *jsiiProxy_SagemakerUserProfileUserSettingsSharingSettingsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_SagemakerUserProfileUserSettingsSharingSettingsOutputReference) ComputeFqn() *string {
	var returns *string
...
func (s *jsiiProxy_SagemakerUserProfileUserSettingsSharingSettingsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SagemakerUserProfileUserSettingsSharingSettingsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (s *jsiiProxy_SagemakerUserProfileUserSettingsSharingSettingsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SagemakerUserProfileUserSettingsSharingSettingsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
...
func (s *jsiiProxy_SagemakerUserProfileUserSettingsSharingSettingsOutputReference) ToString() *string {
	var returns *string
