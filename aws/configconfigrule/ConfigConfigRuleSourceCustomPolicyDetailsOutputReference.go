...
func (j *jsiiProxy_ConfigConfigRuleSourceCustomPolicyDetailsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewConfigConfigRuleSourceCustomPolicyDetailsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) ConfigConfigRuleSourceCustomPolicyDetailsOutputReference {
	_init_.Initialize()
...
func NewConfigConfigRuleSourceCustomPolicyDetailsOutputReference_Override(c ConfigConfigRuleSourceCustomPolicyDetailsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_ConfigConfigRuleSourceCustomPolicyDetailsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_ConfigConfigRuleSourceCustomPolicyDetailsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_ConfigConfigRuleSourceCustomPolicyDetailsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (c *jsiiProxy_ConfigConfigRuleSourceCustomPolicyDetailsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_ConfigConfigRuleSourceCustomPolicyDetailsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
