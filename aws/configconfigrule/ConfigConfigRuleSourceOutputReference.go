...
func (j *jsiiProxy_ConfigConfigRuleSourceOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewConfigConfigRuleSourceOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) ConfigConfigRuleSourceOutputReference {
	_init_.Initialize()
...
func NewConfigConfigRuleSourceOutputReference_Override(c ConfigConfigRuleSourceOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_ConfigConfigRuleSourceOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_ConfigConfigRuleSourceOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_ConfigConfigRuleSourceOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (c *jsiiProxy_ConfigConfigRuleSourceOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_ConfigConfigRuleSourceOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
