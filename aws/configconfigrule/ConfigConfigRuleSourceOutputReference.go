...
func (c *jsiiProxy_ConfigConfigRuleSourceOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ConfigConfigRuleSourceOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
