...
func (j *jsiiProxy_ConfigConfigRuleSourceSourceDetailList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewConfigConfigRuleSourceSourceDetailList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ConfigConfigRuleSourceSourceDetailList {
	_init_.Initialize()
...
func NewConfigConfigRuleSourceSourceDetailList_Override(c ConfigConfigRuleSourceSourceDetailList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ConfigConfigRuleSourceSourceDetailList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_ConfigConfigRuleSourceSourceDetailList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (c *jsiiProxy_ConfigConfigRuleSourceSourceDetailList) Resolve(context cdktn.IResolveContext) interface{} {
