...
func (j *jsiiProxy_ConfigConfigRuleScopeOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewConfigConfigRuleScopeOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) ConfigConfigRuleScopeOutputReference {
	_init_.Initialize()
...
func NewConfigConfigRuleScopeOutputReference_Override(c ConfigConfigRuleScopeOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_ConfigConfigRuleScopeOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_ConfigConfigRuleScopeOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_ConfigConfigRuleScopeOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (c *jsiiProxy_ConfigConfigRuleScopeOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_ConfigConfigRuleScopeOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
