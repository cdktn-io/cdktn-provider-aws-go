...
func (c *jsiiProxy_ConfigConfigRuleSourceSourceDetailOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ConfigConfigRuleSourceSourceDetailOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
