...
func (m *jsiiProxy_Macie2InvitationAccepterTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (m *jsiiProxy_Macie2InvitationAccepterTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
