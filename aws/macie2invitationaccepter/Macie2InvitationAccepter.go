...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/macie2invitationaccepter/internal"
...
func (j *jsiiProxy_Macie2InvitationAccepter) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_Macie2InvitationAccepter) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_Macie2InvitationAccepter) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_Macie2InvitationAccepter) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_Macie2InvitationAccepter) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_Macie2InvitationAccepter) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_Macie2InvitationAccepter) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/macie2_invitation_accepter aws_macie2_invitation_accepter} Resource.
...
func (j *jsiiProxy_Macie2InvitationAccepter)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_Macie2InvitationAccepter)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_Macie2InvitationAccepter)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_Macie2InvitationAccepter)SetRegion(val *string) {
...
func Macie2InvitationAccepter_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (m *jsiiProxy_Macie2InvitationAccepter) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_Macie2InvitationAccepter) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (m *jsiiProxy_Macie2InvitationAccepter) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_Macie2InvitationAccepter) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (m *jsiiProxy_Macie2InvitationAccepter) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (m *jsiiProxy_Macie2InvitationAccepter) ResetRegion() {
	_jsii_.InvokeVoid(
		m,
		"resetRegion",
		nil, // no parameters
...
func (m *jsiiProxy_Macie2InvitationAccepter) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
