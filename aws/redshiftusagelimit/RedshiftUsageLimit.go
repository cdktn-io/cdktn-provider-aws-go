...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/redshiftusagelimit/internal"
...
func (j *jsiiProxy_RedshiftUsageLimit) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_RedshiftUsageLimit) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_RedshiftUsageLimit) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_RedshiftUsageLimit) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_RedshiftUsageLimit) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/redshift_usage_limit aws_redshift_usage_limit} Resource.
...
func (j *jsiiProxy_RedshiftUsageLimit)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_RedshiftUsageLimit)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_RedshiftUsageLimit)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func RedshiftUsageLimit_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (r *jsiiProxy_RedshiftUsageLimit) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (r *jsiiProxy_RedshiftUsageLimit) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (r *jsiiProxy_RedshiftUsageLimit) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (r *jsiiProxy_RedshiftUsageLimit) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (r *jsiiProxy_RedshiftUsageLimit) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (r *jsiiProxy_RedshiftUsageLimit) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
