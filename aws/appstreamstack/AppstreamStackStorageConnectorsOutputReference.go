...
func (a *jsiiProxy_AppstreamStackStorageConnectorsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_AppstreamStackStorageConnectorsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
