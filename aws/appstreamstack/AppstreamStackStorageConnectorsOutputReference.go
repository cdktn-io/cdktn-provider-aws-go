...
func (j *jsiiProxy_AppstreamStackStorageConnectorsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewAppstreamStackStorageConnectorsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) AppstreamStackStorageConnectorsOutputReference {
	_init_.Initialize()
...
func NewAppstreamStackStorageConnectorsOutputReference_Override(a AppstreamStackStorageConnectorsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_AppstreamStackStorageConnectorsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (a *jsiiProxy_AppstreamStackStorageConnectorsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AppstreamStackStorageConnectorsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (a *jsiiProxy_AppstreamStackStorageConnectorsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AppstreamStackStorageConnectorsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
