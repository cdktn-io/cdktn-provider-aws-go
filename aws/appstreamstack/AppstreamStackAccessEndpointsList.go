...
func (j *jsiiProxy_AppstreamStackAccessEndpointsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewAppstreamStackAccessEndpointsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) AppstreamStackAccessEndpointsList {
	_init_.Initialize()
...
func NewAppstreamStackAccessEndpointsList_Override(a AppstreamStackAccessEndpointsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_AppstreamStackAccessEndpointsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (a *jsiiProxy_AppstreamStackAccessEndpointsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (a *jsiiProxy_AppstreamStackAccessEndpointsList) Resolve(context cdktn.IResolveContext) interface{} {
