...
func (j *jsiiProxy_AppstreamStackUserSettingsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewAppstreamStackUserSettingsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) AppstreamStackUserSettingsList {
	_init_.Initialize()
...
func NewAppstreamStackUserSettingsList_Override(a AppstreamStackUserSettingsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_AppstreamStackUserSettingsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (a *jsiiProxy_AppstreamStackUserSettingsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (a *jsiiProxy_AppstreamStackUserSettingsList) Resolve(context cdktn.IResolveContext) interface{} {
