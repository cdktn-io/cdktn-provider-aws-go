...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/appstreamstack/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/appstream_stack aws_appstream_stack}.
...
func (j *jsiiProxy_AppstreamStack) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_AppstreamStack) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_AppstreamStack) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_AppstreamStack) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_AppstreamStack) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/appstream_stack aws_appstream_stack} Resource.
...
func (j *jsiiProxy_AppstreamStack)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_AppstreamStack)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_AppstreamStack)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func AppstreamStack_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (a *jsiiProxy_AppstreamStack) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AppstreamStack) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (a *jsiiProxy_AppstreamStack) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AppstreamStack) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (a *jsiiProxy_AppstreamStack) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (a *jsiiProxy_AppstreamStack) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
