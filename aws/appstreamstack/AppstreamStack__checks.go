...
func (a *jsiiProxy_AppstreamStack) validatePutAccessEndpointsParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*AppstreamStackAccessEndpoints; received %#v (a %T)", value, value)
		}
	}
...
func (a *jsiiProxy_AppstreamStack) validatePutStorageConnectorsParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*AppstreamStackStorageConnectors; received %#v (a %T)", value, value)
		}
	}
...
func (a *jsiiProxy_AppstreamStack) validatePutUserSettingsParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*AppstreamStackUserSettings; received %#v (a %T)", value, value)
		}
	}
...
func (j *jsiiProxy_AppstreamStack) validateSetLifecycleParameters(val *cdktn.TerraformResourceLifecycle) error {
	if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
		return err
	}
