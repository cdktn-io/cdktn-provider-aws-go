...
func (s *jsiiProxy_SpotInstanceRequestEphemeralBlockDeviceList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
	return nil
}
...
func (s *jsiiProxy_SpotInstanceRequestEphemeralBlockDeviceList) validateResolveParameters(context cdktf.IResolveContext) error {
	return nil
}
