...
func (s *jsiiProxy_SpotInstanceRequest) validatePutEbsBlockDeviceParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*SpotInstanceRequestEbsBlockDevice; received %#v (a %T)", value, value)
		}
	}
...
func (s *jsiiProxy_SpotInstanceRequest) validatePutEphemeralBlockDeviceParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*SpotInstanceRequestEphemeralBlockDevice; received %#v (a %T)", value, value)
		}
	}
...
func (s *jsiiProxy_SpotInstanceRequest) validatePutNetworkInterfaceParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*SpotInstanceRequestNetworkInterface; received %#v (a %T)", value, value)
		}
	}
...
func (s *jsiiProxy_SpotInstanceRequest) validatePutSecondaryNetworkInterfaceParameters(value interface{}) error {
	...
	case *[]*SpotInstanceRequestSecondaryNetworkInterface:
		value := value.(*[]*SpotInstanceRequestSecondaryNetworkInterface)
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
			}
	...
	case []*SpotInstanceRequestSecondaryNetworkInterface:
		value_ := value.([]*SpotInstanceRequestSecondaryNetworkInterface)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*SpotInstanceRequestSecondaryNetworkInterface; received %#v (a %T)", value, value)
		}
	}
