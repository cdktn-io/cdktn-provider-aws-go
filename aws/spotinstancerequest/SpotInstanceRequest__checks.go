...
func (s *jsiiProxy_SpotInstanceRequest) validatePutSecondaryNetworkInterfaceParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*SpotInstanceRequestSecondaryNetworkInterface; received %#v (a %T)", value, value)
		}
	}
