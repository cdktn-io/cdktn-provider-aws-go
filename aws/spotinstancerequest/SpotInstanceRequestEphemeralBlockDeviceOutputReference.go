...
func (s *jsiiProxy_SpotInstanceRequestEphemeralBlockDeviceOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_SpotInstanceRequestEphemeralBlockDeviceOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
