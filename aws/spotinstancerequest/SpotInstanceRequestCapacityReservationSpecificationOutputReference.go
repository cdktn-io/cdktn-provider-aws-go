...
func (s *jsiiProxy_SpotInstanceRequestCapacityReservationSpecificationOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_SpotInstanceRequestCapacityReservationSpecificationOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
