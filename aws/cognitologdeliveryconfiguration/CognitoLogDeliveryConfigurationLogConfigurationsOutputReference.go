...
func (j *jsiiProxy_CognitoLogDeliveryConfigurationLogConfigurationsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewCognitoLogDeliveryConfigurationLogConfigurationsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) CognitoLogDeliveryConfigurationLogConfigurationsOutputReference {
	_init_.Initialize()
...
func NewCognitoLogDeliveryConfigurationLogConfigurationsOutputReference_Override(c CognitoLogDeliveryConfigurationLogConfigurationsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_CognitoLogDeliveryConfigurationLogConfigurationsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_CognitoLogDeliveryConfigurationLogConfigurationsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CognitoLogDeliveryConfigurationLogConfigurationsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (c *jsiiProxy_CognitoLogDeliveryConfigurationLogConfigurationsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CognitoLogDeliveryConfigurationLogConfigurationsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
