...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v22/inspectorassessmenttarget/internal"
...
func (j *jsiiProxy_InspectorAssessmentTarget) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_InspectorAssessmentTarget)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func InspectorAssessmentTarget_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (i *jsiiProxy_InspectorAssessmentTarget) ImportFrom(id *string, provider cdktf.TerraformProvider) {
