...
func (j *jsiiProxy_Wafv2WebAclLoggingConfiguration) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_Wafv2WebAclLoggingConfiguration) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_Wafv2WebAclLoggingConfiguration) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_Wafv2WebAclLoggingConfiguration) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_Wafv2WebAclLoggingConfiguration) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_Wafv2WebAclLoggingConfiguration) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_Wafv2WebAclLoggingConfiguration) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/wafv2_web_acl_logging_configuration aws_wafv2_web_acl_logging_configuration} Resource.
...
func (j *jsiiProxy_Wafv2WebAclLoggingConfiguration)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_Wafv2WebAclLoggingConfiguration)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_Wafv2WebAclLoggingConfiguration)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_Wafv2WebAclLoggingConfiguration)SetRegion(val *string) {
...
func Wafv2WebAclLoggingConfiguration_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (w *jsiiProxy_Wafv2WebAclLoggingConfiguration) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_Wafv2WebAclLoggingConfiguration) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (w *jsiiProxy_Wafv2WebAclLoggingConfiguration) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_Wafv2WebAclLoggingConfiguration) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (w *jsiiProxy_Wafv2WebAclLoggingConfiguration) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (w *jsiiProxy_Wafv2WebAclLoggingConfiguration) ResetRegion() {
	_jsii_.InvokeVoid(
		w,
		"resetRegion",
		nil, // no parameters
...
func (w *jsiiProxy_Wafv2WebAclLoggingConfiguration) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
