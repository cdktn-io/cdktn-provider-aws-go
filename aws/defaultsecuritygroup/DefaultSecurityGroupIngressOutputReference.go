...
func (d *jsiiProxy_DefaultSecurityGroupIngressOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DefaultSecurityGroupIngressOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
