...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/autoscalingnotification/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/autoscaling_notification aws_autoscaling_notification}.
...
func (j *jsiiProxy_AutoscalingNotification) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_AutoscalingNotification) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_AutoscalingNotification) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_AutoscalingNotification) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_AutoscalingNotification) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_AutoscalingNotification) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_AutoscalingNotification) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/autoscaling_notification aws_autoscaling_notification} Resource.
...
func (j *jsiiProxy_AutoscalingNotification)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_AutoscalingNotification)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_AutoscalingNotification)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_AutoscalingNotification)SetRegion(val *string) {
...
func AutoscalingNotification_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
// Experimental.
func AutoscalingNotification_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()
...
// Experimental.
func AutoscalingNotification_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()
...
func (a *jsiiProxy_AutoscalingNotification) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AutoscalingNotification) HasResourceMove() interface{} {
	var returns interface{}
...
func (a *jsiiProxy_AutoscalingNotification) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (a *jsiiProxy_AutoscalingNotification) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AutoscalingNotification) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (a *jsiiProxy_AutoscalingNotification) MoveTo(moveTarget *string, index interface{}) {
...
func (a *jsiiProxy_AutoscalingNotification) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (a *jsiiProxy_AutoscalingNotification) ResetRegion() {
	_jsii_.InvokeVoid(
		a,
		"resetRegion",
		nil, // no parameters
...
func (a *jsiiProxy_AutoscalingNotification) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (a *jsiiProxy_AutoscalingNotification) ToHclTerraform() interface{} {
	var returns interface{}
...
func (a *jsiiProxy_AutoscalingNotification) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
