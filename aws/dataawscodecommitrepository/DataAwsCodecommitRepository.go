...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/dataawscodecommitrepository/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/data-sources/codecommit_repository aws_codecommit_repository}.
...
func (j *jsiiProxy_DataAwsCodecommitRepository) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsCodecommitRepository) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsCodecommitRepository) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsCodecommitRepository) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsCodecommitRepository) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DataAwsCodecommitRepository) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_DataAwsCodecommitRepository) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/data-sources/codecommit_repository aws_codecommit_repository} Data Source.
...
func (j *jsiiProxy_DataAwsCodecommitRepository)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsCodecommitRepository)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsCodecommitRepository)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_DataAwsCodecommitRepository)SetRegion(val *string) {
...
func DataAwsCodecommitRepository_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsCodecommitRepository) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsCodecommitRepository) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsCodecommitRepository) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsCodecommitRepository) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsCodecommitRepository) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
