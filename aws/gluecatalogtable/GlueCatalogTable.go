...
func (j *jsiiProxy_GlueCatalogTable) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_GlueCatalogTable) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_GlueCatalogTable) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_GlueCatalogTable) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_GlueCatalogTable) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/glue_catalog_table aws_glue_catalog_table} Resource.
...
func (j *jsiiProxy_GlueCatalogTable)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_GlueCatalogTable)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_GlueCatalogTable)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func GlueCatalogTable_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (g *jsiiProxy_GlueCatalogTable) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GlueCatalogTable) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (g *jsiiProxy_GlueCatalogTable) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GlueCatalogTable) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GlueCatalogTable) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (g *jsiiProxy_GlueCatalogTable) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
