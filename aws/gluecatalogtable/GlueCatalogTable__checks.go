...
func (g *jsiiProxy_GlueCatalogTable) validatePutPartitionIndexParameters(value interface{}) error {
	...
	case *[]*GlueCatalogTablePartitionIndex:
		value := value.(*[]*GlueCatalogTablePartitionIndex)
	...
	case []*GlueCatalogTablePartitionIndex:
		value_ := value.([]*GlueCatalogTablePartitionIndex)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*GlueCatalogTablePartitionIndex; received %#v (a %T)", value, value)
		}
	}
...
func (g *jsiiProxy_GlueCatalogTable) validatePutPartitionKeysParameters(value interface{}) error {
	...
	case cdktn.IResolvable:
		// ok
	case *[]*GlueCatalogTablePartitionKeys:
		value := value.(*[]*GlueCatalogTablePartitionKeys)
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
			}
	...
	case []*GlueCatalogTablePartitionKeys:
		value_ := value.([]*GlueCatalogTablePartitionKeys)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*GlueCatalogTablePartitionKeys; received %#v (a %T)", value, value)
		}
	}
