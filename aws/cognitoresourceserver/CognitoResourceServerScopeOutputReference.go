...
func (c *jsiiProxy_CognitoResourceServerScopeOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CognitoResourceServerScopeOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
