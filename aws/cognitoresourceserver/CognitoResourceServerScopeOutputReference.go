...
func (j *jsiiProxy_CognitoResourceServerScopeOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewCognitoResourceServerScopeOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) CognitoResourceServerScopeOutputReference {
	_init_.Initialize()

	if err := validateNewCognitoResourceServerScopeOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func NewCognitoResourceServerScopeOutputReference_Override(c CognitoResourceServerScopeOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_CognitoResourceServerScopeOutputReference)SetScopeDescription(val *string) {
	if err := j.validateSetScopeDescriptionParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CognitoResourceServerScopeOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_CognitoResourceServerScopeOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CognitoResourceServerScopeOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (c *jsiiProxy_CognitoResourceServerScopeOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CognitoResourceServerScopeOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
