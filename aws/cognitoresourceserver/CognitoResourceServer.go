...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/cognitoresourceserver/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/cognito_resource_server aws_cognito_resource_server}.
...
func (j *jsiiProxy_CognitoResourceServer) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_CognitoResourceServer) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_CognitoResourceServer) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_CognitoResourceServer) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_CognitoResourceServer) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_CognitoResourceServer) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_CognitoResourceServer) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/cognito_resource_server aws_cognito_resource_server} Resource.
...
func (j *jsiiProxy_CognitoResourceServer)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_CognitoResourceServer)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_CognitoResourceServer)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_CognitoResourceServer)SetRegion(val *string) {
...
func CognitoResourceServer_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (c *jsiiProxy_CognitoResourceServer) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CognitoResourceServer) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (c *jsiiProxy_CognitoResourceServer) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CognitoResourceServer) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_CognitoResourceServer) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (c *jsiiProxy_CognitoResourceServer) ResetRegion() {
	_jsii_.InvokeVoid(
		c,
		"resetRegion",
		nil, // no parameters
...
func (c *jsiiProxy_CognitoResourceServer) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
