...
func (c *jsiiProxy_CognitoResourceServerScopeList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (c *jsiiProxy_CognitoResourceServerScopeList) Resolve(context cdktf.IResolveContext) interface{} {
