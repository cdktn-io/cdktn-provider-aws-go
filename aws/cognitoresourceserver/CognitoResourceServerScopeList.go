...
func (j *jsiiProxy_CognitoResourceServerScopeList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewCognitoResourceServerScopeList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) CognitoResourceServerScopeList {
	_init_.Initialize()
...
func NewCognitoResourceServerScopeList_Override(c CognitoResourceServerScopeList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_CognitoResourceServerScopeList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_CognitoResourceServerScopeList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (c *jsiiProxy_CognitoResourceServerScopeList) Resolve(context cdktn.IResolveContext) interface{} {
