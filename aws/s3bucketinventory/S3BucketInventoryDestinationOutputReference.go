...
func (j *jsiiProxy_S3BucketInventoryDestinationOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_S3BucketInventoryDestinationOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_S3BucketInventoryDestinationOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (s *jsiiProxy_S3BucketInventoryDestinationOutputReference) ComputeFqn() *string {
	var returns *string
...
func (s *jsiiProxy_S3BucketInventoryDestinationOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_S3BucketInventoryDestinationOutputReference) PutBucket(value *S3BucketInventoryDestinationBucket) {
	if err := s.validatePutBucketParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		s,
...
func (s *jsiiProxy_S3BucketInventoryDestinationOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
...
func (s *jsiiProxy_S3BucketInventoryDestinationOutputReference) ToString() *string {
	var returns *string
