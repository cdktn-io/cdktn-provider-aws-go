...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/s3bucketinventory/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/s3_bucket_inventory aws_s3_bucket_inventory}.
...
func (j *jsiiProxy_S3BucketInventory) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_S3BucketInventory) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_S3BucketInventory) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_S3BucketInventory) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_S3BucketInventory) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/s3_bucket_inventory aws_s3_bucket_inventory} Resource.
...
func (j *jsiiProxy_S3BucketInventory)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_S3BucketInventory)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_S3BucketInventory)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func S3BucketInventory_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (s *jsiiProxy_S3BucketInventory) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_S3BucketInventory) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_S3BucketInventory) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_S3BucketInventory) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_S3BucketInventory) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_S3BucketInventory) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
