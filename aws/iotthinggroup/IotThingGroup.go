...
func (j *jsiiProxy_IotThingGroup) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_IotThingGroup) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_IotThingGroup) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_IotThingGroup) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_IotThingGroup) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/iot_thing_group aws_iot_thing_group} Resource.
...
func (j *jsiiProxy_IotThingGroup)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_IotThingGroup)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_IotThingGroup)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func IotThingGroup_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (i *jsiiProxy_IotThingGroup) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (i *jsiiProxy_IotThingGroup) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (i *jsiiProxy_IotThingGroup) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (i *jsiiProxy_IotThingGroup) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (i *jsiiProxy_IotThingGroup) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (i *jsiiProxy_IotThingGroup) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
