...
func (j *jsiiProxy_LambdaEventSourceMappingFilterCriteriaOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewLambdaEventSourceMappingFilterCriteriaOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) LambdaEventSourceMappingFilterCriteriaOutputReference {
	_init_.Initialize()

	if err := validateNewLambdaEventSourceMappingFilterCriteriaOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewLambdaEventSourceMappingFilterCriteriaOutputReference_Override(l LambdaEventSourceMappingFilterCriteriaOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_LambdaEventSourceMappingFilterCriteriaOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (l *jsiiProxy_LambdaEventSourceMappingFilterCriteriaOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LambdaEventSourceMappingFilterCriteriaOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (l *jsiiProxy_LambdaEventSourceMappingFilterCriteriaOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LambdaEventSourceMappingFilterCriteriaOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
