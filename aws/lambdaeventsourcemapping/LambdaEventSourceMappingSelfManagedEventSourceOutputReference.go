...
func (l *jsiiProxy_LambdaEventSourceMappingSelfManagedEventSourceOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LambdaEventSourceMappingSelfManagedEventSourceOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
