...
func (j *jsiiProxy_LambdaEventSourceMappingSelfManagedEventSourceOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewLambdaEventSourceMappingSelfManagedEventSourceOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) LambdaEventSourceMappingSelfManagedEventSourceOutputReference {
	_init_.Initialize()
...
func NewLambdaEventSourceMappingSelfManagedEventSourceOutputReference_Override(l LambdaEventSourceMappingSelfManagedEventSourceOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_LambdaEventSourceMappingSelfManagedEventSourceOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (l *jsiiProxy_LambdaEventSourceMappingSelfManagedEventSourceOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LambdaEventSourceMappingSelfManagedEventSourceOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (l *jsiiProxy_LambdaEventSourceMappingSelfManagedEventSourceOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LambdaEventSourceMappingSelfManagedEventSourceOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
