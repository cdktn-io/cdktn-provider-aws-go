...
func (j *jsiiProxy_LambdaEventSourceMappingDestinationConfigOnFailureOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewLambdaEventSourceMappingDestinationConfigOnFailureOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) LambdaEventSourceMappingDestinationConfigOnFailureOutputReference {
	_init_.Initialize()
...
func NewLambdaEventSourceMappingDestinationConfigOnFailureOutputReference_Override(l LambdaEventSourceMappingDestinationConfigOnFailureOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_LambdaEventSourceMappingDestinationConfigOnFailureOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (l *jsiiProxy_LambdaEventSourceMappingDestinationConfigOnFailureOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LambdaEventSourceMappingDestinationConfigOnFailureOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (l *jsiiProxy_LambdaEventSourceMappingDestinationConfigOnFailureOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LambdaEventSourceMappingDestinationConfigOnFailureOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
