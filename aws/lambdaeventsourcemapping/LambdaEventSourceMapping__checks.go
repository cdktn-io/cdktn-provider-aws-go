...
func (l *jsiiProxy_LambdaEventSourceMapping) validatePutSourceAccessConfigurationParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*LambdaEventSourceMappingSourceAccessConfiguration; received %#v (a %T)", value, value)
		}
	}
