...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/lambda_event_source_mapping aws_lambda_event_source_mapping}.
...
func (j *jsiiProxy_LambdaEventSourceMapping) Arn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"arn",
...
func (j *jsiiProxy_LambdaEventSourceMapping) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_LambdaEventSourceMapping) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_LambdaEventSourceMapping) Tags() *map[string]*string {
...
func (j *jsiiProxy_LambdaEventSourceMapping) TagsAll() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsAll",
...
func (j *jsiiProxy_LambdaEventSourceMapping) TagsAllInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsAllInput",
...
func (j *jsiiProxy_LambdaEventSourceMapping) TagsInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/lambda_event_source_mapping aws_lambda_event_source_mapping} Resource.
...
func (j *jsiiProxy_LambdaEventSourceMapping)SetRegion(val *string) {
...
func (j *jsiiProxy_LambdaEventSourceMapping)SetTags(val *map[string]*string) {
...
func (j *jsiiProxy_LambdaEventSourceMapping)SetTagsAll(val *map[string]*string) {
...
func (l *jsiiProxy_LambdaEventSourceMapping) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (l *jsiiProxy_LambdaEventSourceMapping) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (l *jsiiProxy_LambdaEventSourceMapping) ResetRegion() {
	_jsii_.InvokeVoid(
		l,
		"resetRegion",
		nil, // no parameters
...
func (l *jsiiProxy_LambdaEventSourceMapping) ResetTagsAll() {
	_jsii_.InvokeVoid(
		l,
		"resetTagsAll",
		nil, // no parameters
...
func (l *jsiiProxy_LambdaEventSourceMapping) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
