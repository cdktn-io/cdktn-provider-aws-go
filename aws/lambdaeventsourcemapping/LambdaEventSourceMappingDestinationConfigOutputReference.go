...
func (j *jsiiProxy_LambdaEventSourceMappingDestinationConfigOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewLambdaEventSourceMappingDestinationConfigOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) LambdaEventSourceMappingDestinationConfigOutputReference {
	_init_.Initialize()
...
func NewLambdaEventSourceMappingDestinationConfigOutputReference_Override(l LambdaEventSourceMappingDestinationConfigOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_LambdaEventSourceMappingDestinationConfigOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (l *jsiiProxy_LambdaEventSourceMappingDestinationConfigOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LambdaEventSourceMappingDestinationConfigOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (l *jsiiProxy_LambdaEventSourceMappingDestinationConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LambdaEventSourceMappingDestinationConfigOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
