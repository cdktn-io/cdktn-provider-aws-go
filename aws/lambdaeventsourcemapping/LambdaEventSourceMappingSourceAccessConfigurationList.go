...
func (j *jsiiProxy_LambdaEventSourceMappingSourceAccessConfigurationList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewLambdaEventSourceMappingSourceAccessConfigurationList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) LambdaEventSourceMappingSourceAccessConfigurationList {
	_init_.Initialize()
...
func NewLambdaEventSourceMappingSourceAccessConfigurationList_Override(l LambdaEventSourceMappingSourceAccessConfigurationList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_LambdaEventSourceMappingSourceAccessConfigurationList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (l *jsiiProxy_LambdaEventSourceMappingSourceAccessConfigurationList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (l *jsiiProxy_LambdaEventSourceMappingSourceAccessConfigurationList) Resolve(context cdktn.IResolveContext) interface{} {
