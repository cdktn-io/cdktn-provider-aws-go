...
type LambdaEventSourceMappingProvisionedPollerConfigOutputReference interface {
	...
	// Experimental.
	Fqn() *string
	InternalValue() *LambdaEventSourceMappingProvisionedPollerConfig
	SetInternalValue(val *LambdaEventSourceMappingProvisionedPollerConfig)
...
func (j *jsiiProxy_LambdaEventSourceMappingProvisionedPollerConfigOutputReference) InternalValue() *LambdaEventSourceMappingProvisionedPollerConfig {
...
func (j *jsiiProxy_LambdaEventSourceMappingProvisionedPollerConfigOutputReference) TerraformResource() cdktf.IInterpolatingParent {
...
func NewLambdaEventSourceMappingProvisionedPollerConfigOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) LambdaEventSourceMappingProvisionedPollerConfigOutputReference {
	_init_.Initialize()
...
func NewLambdaEventSourceMappingProvisionedPollerConfigOutputReference_Override(l LambdaEventSourceMappingProvisionedPollerConfigOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_LambdaEventSourceMappingProvisionedPollerConfigOutputReference)SetInternalValue(val *LambdaEventSourceMappingProvisionedPollerConfig) {
...
func (j *jsiiProxy_LambdaEventSourceMappingProvisionedPollerConfigOutputReference)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (l *jsiiProxy_LambdaEventSourceMappingProvisionedPollerConfigOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LambdaEventSourceMappingProvisionedPollerConfigOutputReference) InterpolationAsList() cdktf.IResolvable {
	var returns cdktf.IResolvable
...
func (l *jsiiProxy_LambdaEventSourceMappingProvisionedPollerConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LambdaEventSourceMappingProvisionedPollerConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
