...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/backupvaultnotifications/internal"
...
func (j *jsiiProxy_BackupVaultNotifications) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_BackupVaultNotifications) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_BackupVaultNotifications) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_BackupVaultNotifications) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_BackupVaultNotifications) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_BackupVaultNotifications)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_BackupVaultNotifications)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_BackupVaultNotifications)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func BackupVaultNotifications_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateBackupVaultNotifications_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (b *jsiiProxy_BackupVaultNotifications) AddMoveTarget(moveTarget *string) {
...
func (b *jsiiProxy_BackupVaultNotifications) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (b *jsiiProxy_BackupVaultNotifications) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (b *jsiiProxy_BackupVaultNotifications) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (b *jsiiProxy_BackupVaultNotifications) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (b *jsiiProxy_BackupVaultNotifications) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (b *jsiiProxy_BackupVaultNotifications) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
