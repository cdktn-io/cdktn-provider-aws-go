...
func (j *jsiiProxy_CloudfrontRealtimeLogConfig) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_CloudfrontRealtimeLogConfig) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_CloudfrontRealtimeLogConfig) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_CloudfrontRealtimeLogConfig) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_CloudfrontRealtimeLogConfig) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_CloudfrontRealtimeLogConfig)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_CloudfrontRealtimeLogConfig)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_CloudfrontRealtimeLogConfig)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func CloudfrontRealtimeLogConfig_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (c *jsiiProxy_CloudfrontRealtimeLogConfig) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CloudfrontRealtimeLogConfig) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (c *jsiiProxy_CloudfrontRealtimeLogConfig) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CloudfrontRealtimeLogConfig) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_CloudfrontRealtimeLogConfig) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (c *jsiiProxy_CloudfrontRealtimeLogConfig) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
