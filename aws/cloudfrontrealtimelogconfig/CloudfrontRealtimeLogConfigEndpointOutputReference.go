...
func (c *jsiiProxy_CloudfrontRealtimeLogConfigEndpointOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CloudfrontRealtimeLogConfigEndpointOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
