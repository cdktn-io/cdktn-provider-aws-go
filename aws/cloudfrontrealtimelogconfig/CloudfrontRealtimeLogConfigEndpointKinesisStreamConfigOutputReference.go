...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v24/cloudfrontrealtimelogconfig/internal"
...
func (j *jsiiProxy_CloudfrontRealtimeLogConfigEndpointKinesisStreamConfigOutputReference) ComplexObjectIndex() interface{} {
...
func (j *jsiiProxy_CloudfrontRealtimeLogConfigEndpointKinesisStreamConfigOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CloudfrontRealtimeLogConfigEndpointKinesisStreamConfigOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CloudfrontRealtimeLogConfigEndpointKinesisStreamConfigOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_CloudfrontRealtimeLogConfigEndpointKinesisStreamConfigOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewCloudfrontRealtimeLogConfigEndpointKinesisStreamConfigOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) CloudfrontRealtimeLogConfigEndpointKinesisStreamConfigOutputReference {
	_init_.Initialize()

	if err := validateNewCloudfrontRealtimeLogConfigEndpointKinesisStreamConfigOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewCloudfrontRealtimeLogConfigEndpointKinesisStreamConfigOutputReference_Override(c CloudfrontRealtimeLogConfigEndpointKinesisStreamConfigOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_CloudfrontRealtimeLogConfigEndpointKinesisStreamConfigOutputReference)SetComplexObjectIndex(val interface{}) {
...
func (j *jsiiProxy_CloudfrontRealtimeLogConfigEndpointKinesisStreamConfigOutputReference)SetComplexObjectIsFromSet(val *bool) {
...
func (j *jsiiProxy_CloudfrontRealtimeLogConfigEndpointKinesisStreamConfigOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_CloudfrontRealtimeLogConfigEndpointKinesisStreamConfigOutputReference) ComputeFqn() *string {
	var returns *string
...
func (c *jsiiProxy_CloudfrontRealtimeLogConfigEndpointKinesisStreamConfigOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CloudfrontRealtimeLogConfigEndpointKinesisStreamConfigOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (c *jsiiProxy_CloudfrontRealtimeLogConfigEndpointKinesisStreamConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CloudfrontRealtimeLogConfigEndpointKinesisStreamConfigOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
...
func (c *jsiiProxy_CloudfrontRealtimeLogConfigEndpointKinesisStreamConfigOutputReference) ToString() *string {
	var returns *string
