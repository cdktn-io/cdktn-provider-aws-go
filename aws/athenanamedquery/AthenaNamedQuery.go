...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/athenanamedquery/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/athena_named_query aws_athena_named_query}.
...
func (j *jsiiProxy_AthenaNamedQuery) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_AthenaNamedQuery) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_AthenaNamedQuery) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_AthenaNamedQuery) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_AthenaNamedQuery) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_AthenaNamedQuery) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_AthenaNamedQuery) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/athena_named_query aws_athena_named_query} Resource.
func NewAthenaNamedQuery(scope constructs.Construct, id *string, config *AthenaNamedQueryConfig) AthenaNamedQuery {
	...
	_jsii_.Create(
		"@cdktn/provider-aws.athenaNamedQuery.AthenaNamedQuery",
...
func (j *jsiiProxy_AthenaNamedQuery)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_AthenaNamedQuery)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_AthenaNamedQuery)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_AthenaNamedQuery)SetRegion(val *string) {
...
func AthenaNamedQuery_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (a *jsiiProxy_AthenaNamedQuery) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AthenaNamedQuery) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (a *jsiiProxy_AthenaNamedQuery) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AthenaNamedQuery) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (a *jsiiProxy_AthenaNamedQuery) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (a *jsiiProxy_AthenaNamedQuery) ResetRegion() {
	_jsii_.InvokeVoid(
		a,
		"resetRegion",
		nil, // no parameters
...
func (a *jsiiProxy_AthenaNamedQuery) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
