...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/licensemanagergrant/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/licensemanager_grant aws_licensemanager_grant}.
...
func (j *jsiiProxy_LicensemanagerGrant) Arn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"arn",
...
func (j *jsiiProxy_LicensemanagerGrant) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_LicensemanagerGrant) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_LicensemanagerGrant) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_LicensemanagerGrant) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_LicensemanagerGrant) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_LicensemanagerGrant) NameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nameInput",
...
func (j *jsiiProxy_LicensemanagerGrant) ParentArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"parentArn",
...
func (j *jsiiProxy_LicensemanagerGrant) Principal() *string {
	var returns *string
	_jsii_.Get(
		j,
		"principal",
...
func (j *jsiiProxy_LicensemanagerGrant) PrincipalInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"principalInput",
...
func (j *jsiiProxy_LicensemanagerGrant) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_LicensemanagerGrant) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/licensemanager_grant aws_licensemanager_grant} Resource.
...
func (j *jsiiProxy_LicensemanagerGrant)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_LicensemanagerGrant)SetId(val *string) {
...
func (j *jsiiProxy_LicensemanagerGrant)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_LicensemanagerGrant)SetName(val *string) {
...
func (j *jsiiProxy_LicensemanagerGrant)SetPrincipal(val *string) {
...
func (j *jsiiProxy_LicensemanagerGrant)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func LicensemanagerGrant_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (l *jsiiProxy_LicensemanagerGrant) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LicensemanagerGrant) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (l *jsiiProxy_LicensemanagerGrant) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LicensemanagerGrant) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (l *jsiiProxy_LicensemanagerGrant) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (l *jsiiProxy_LicensemanagerGrant) ResetId() {
	_jsii_.InvokeVoid(
		l,
		"resetId",
		nil, // no parameters
...
func (l *jsiiProxy_LicensemanagerGrant) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
