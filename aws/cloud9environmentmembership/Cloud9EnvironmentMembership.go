...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/cloud9environmentmembership/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/cloud9_environment_membership aws_cloud9_environment_membership}.
...
func (j *jsiiProxy_Cloud9EnvironmentMembership) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_Cloud9EnvironmentMembership) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_Cloud9EnvironmentMembership) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_Cloud9EnvironmentMembership) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_Cloud9EnvironmentMembership) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_Cloud9EnvironmentMembership) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_Cloud9EnvironmentMembership) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/cloud9_environment_membership aws_cloud9_environment_membership} Resource.
...
func (j *jsiiProxy_Cloud9EnvironmentMembership)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_Cloud9EnvironmentMembership)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_Cloud9EnvironmentMembership)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_Cloud9EnvironmentMembership)SetRegion(val *string) {
...
func Cloud9EnvironmentMembership_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateCloud9EnvironmentMembership_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
// Experimental.
func Cloud9EnvironmentMembership_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCloud9EnvironmentMembership_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func Cloud9EnvironmentMembership_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCloud9EnvironmentMembership_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_Cloud9EnvironmentMembership) AddMoveTarget(moveTarget *string) {
...
func (c *jsiiProxy_Cloud9EnvironmentMembership) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_Cloud9EnvironmentMembership) HasResourceMove() interface{} {
	var returns interface{}
...
func (c *jsiiProxy_Cloud9EnvironmentMembership) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (c *jsiiProxy_Cloud9EnvironmentMembership) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_Cloud9EnvironmentMembership) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_Cloud9EnvironmentMembership) MoveFromId(id *string) {
...
func (c *jsiiProxy_Cloud9EnvironmentMembership) MoveTo(moveTarget *string, index interface{}) {
...
func (c *jsiiProxy_Cloud9EnvironmentMembership) MoveToId(id *string) {
...
func (c *jsiiProxy_Cloud9EnvironmentMembership) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (c *jsiiProxy_Cloud9EnvironmentMembership) ResetRegion() {
	_jsii_.InvokeVoid(
		c,
		"resetRegion",
		nil, // no parameters
...
func (c *jsiiProxy_Cloud9EnvironmentMembership) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (c *jsiiProxy_Cloud9EnvironmentMembership) ToHclTerraform() interface{} {
	var returns interface{}
...
func (c *jsiiProxy_Cloud9EnvironmentMembership) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
