...
func (j *jsiiProxy_DataAwsLicensemanagerReceivedLicense) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsLicensemanagerReceivedLicense) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsLicensemanagerReceivedLicense) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsLicensemanagerReceivedLicense) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsLicensemanagerReceivedLicense) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/data-sources/licensemanager_received_license aws_licensemanager_received_license} Data Source.
...
func (j *jsiiProxy_DataAwsLicensemanagerReceivedLicense)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsLicensemanagerReceivedLicense)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsLicensemanagerReceivedLicense)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsLicensemanagerReceivedLicense_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsLicensemanagerReceivedLicense) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsLicensemanagerReceivedLicense) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsLicensemanagerReceivedLicense) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsLicensemanagerReceivedLicense) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
