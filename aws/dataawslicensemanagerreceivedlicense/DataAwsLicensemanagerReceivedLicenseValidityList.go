...
func (j *jsiiProxy_DataAwsLicensemanagerReceivedLicenseValidityList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsLicensemanagerReceivedLicenseValidityList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsLicensemanagerReceivedLicenseValidityList {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-aws.dataAwsLicensemanagerReceivedLicense.DataAwsLicensemanagerReceivedLicenseValidityList",
...
func NewDataAwsLicensemanagerReceivedLicenseValidityList_Override(d DataAwsLicensemanagerReceivedLicenseValidityList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsLicensemanagerReceivedLicenseValidityList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsLicensemanagerReceivedLicenseValidityList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsLicensemanagerReceivedLicenseValidityList) Resolve(context cdktn.IResolveContext) interface{} {
