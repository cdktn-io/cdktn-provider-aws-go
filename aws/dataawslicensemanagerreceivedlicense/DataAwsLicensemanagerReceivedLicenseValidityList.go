...
func (d *jsiiProxy_DataAwsLicensemanagerReceivedLicenseValidityList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsLicensemanagerReceivedLicenseValidityList) Resolve(context cdktf.IResolveContext) interface{} {
