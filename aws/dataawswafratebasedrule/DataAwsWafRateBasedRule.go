...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/dataawswafratebasedrule/internal"
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/data-sources/waf_rate_based_rule aws_waf_rate_based_rule} Data Source.
...
func (d *jsiiProxy_DataAwsWafRateBasedRule) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
