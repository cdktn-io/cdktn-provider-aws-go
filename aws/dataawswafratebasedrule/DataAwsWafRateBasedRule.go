...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v23/dataawswafratebasedrule/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.40.0/docs/data-sources/waf_rate_based_rule aws_waf_rate_based_rule}.
...
func (j *jsiiProxy_DataAwsWafRateBasedRule) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsWafRateBasedRule) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsWafRateBasedRule) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsWafRateBasedRule) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsWafRateBasedRule) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.40.0/docs/data-sources/waf_rate_based_rule aws_waf_rate_based_rule} Data Source.
...
func (j *jsiiProxy_DataAwsWafRateBasedRule)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsWafRateBasedRule)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsWafRateBasedRule)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsWafRateBasedRule_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsWafRateBasedRule) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsWafRateBasedRule) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsWafRateBasedRule) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
