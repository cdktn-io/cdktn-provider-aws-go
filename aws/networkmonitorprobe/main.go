...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "packetSize", GoGetter: "PacketSize"},
			_jsii_.MemberProperty{JsiiProperty: "packetSizeInput", GoGetter: "PacketSizeInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetPacketSize", GoMethod: "ResetPacketSize"},
