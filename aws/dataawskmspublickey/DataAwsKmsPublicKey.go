...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/dataawskmspublickey/internal"
...
func (j *jsiiProxy_DataAwsKmsPublicKey) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsKmsPublicKey) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsKmsPublicKey) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsKmsPublicKey) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsKmsPublicKey) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DataAwsKmsPublicKey)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsKmsPublicKey)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsKmsPublicKey)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsKmsPublicKey_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsKmsPublicKey) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsKmsPublicKey) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsKmsPublicKey) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsKmsPublicKey) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
