...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/redshiftpartner/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/redshift_partner aws_redshift_partner}.
...
func (j *jsiiProxy_RedshiftPartner) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_RedshiftPartner) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_RedshiftPartner) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_RedshiftPartner) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_RedshiftPartner) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/redshift_partner aws_redshift_partner} Resource.
...
func (j *jsiiProxy_RedshiftPartner)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_RedshiftPartner)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_RedshiftPartner)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
// Generates CDKTN code for importing a RedshiftPartner resource upon running "cdktn plan <stack-name>".
func RedshiftPartner_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (r *jsiiProxy_RedshiftPartner) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (r *jsiiProxy_RedshiftPartner) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (r *jsiiProxy_RedshiftPartner) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (r *jsiiProxy_RedshiftPartner) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (r *jsiiProxy_RedshiftPartner) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (r *jsiiProxy_RedshiftPartner) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
