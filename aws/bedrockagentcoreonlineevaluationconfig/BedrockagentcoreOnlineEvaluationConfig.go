...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.51.0/docs/resources/bedrockagentcore_online_evaluation_config aws_bedrockagentcore_online_evaluation_config}.
type BedrockagentcoreOnlineEvaluationConfig interface {
	...
	DataSourceConfig() BedrockagentcoreOnlineEvaluationConfigDataSourceConfigList
	...
	OutputConfig() BedrockagentcoreOnlineEvaluationConfigOutputConfigList
	// Experimental.
	...
	PutTimeouts(value *BedrockagentcoreOnlineEvaluationConfigTimeouts)
...
func (j *jsiiProxy_BedrockagentcoreOnlineEvaluationConfig) DataSourceConfig() BedrockagentcoreOnlineEvaluationConfigDataSourceConfigList {
	var returns BedrockagentcoreOnlineEvaluationConfigDataSourceConfigList
	_jsii_.Get(
		j,
		"dataSourceConfig",
		&returns,
...
func (j *jsiiProxy_BedrockagentcoreOnlineEvaluationConfig) EnableOnCreate() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"enableOnCreate",
...
func (j *jsiiProxy_BedrockagentcoreOnlineEvaluationConfig) EnableOnCreateInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"enableOnCreateInput",
...
func (j *jsiiProxy_BedrockagentcoreOnlineEvaluationConfig) Evaluator() BedrockagentcoreOnlineEvaluationConfigEvaluatorList {
	var returns BedrockagentcoreOnlineEvaluationConfigEvaluatorList
	_jsii_.Get(
		j,
		"evaluator",
		&returns,
...
func (j *jsiiProxy_BedrockagentcoreOnlineEvaluationConfig) EvaluatorInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"evaluatorInput",
...
func (j *jsiiProxy_BedrockagentcoreOnlineEvaluationConfig) OutputConfig() BedrockagentcoreOnlineEvaluationConfigOutputConfigList {
	var returns BedrockagentcoreOnlineEvaluationConfigOutputConfigList
	_jsii_.Get(
		j,
		"outputConfig",
		&returns,
...
func (j *jsiiProxy_BedrockagentcoreOnlineEvaluationConfig) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_BedrockagentcoreOnlineEvaluationConfig) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_BedrockagentcoreOnlineEvaluationConfig) Rule() BedrockagentcoreOnlineEvaluationConfigRuleList {
	var returns BedrockagentcoreOnlineEvaluationConfigRuleList
	_jsii_.Get(
		j,
		"rule",
		&returns,
...
func (j *jsiiProxy_BedrockagentcoreOnlineEvaluationConfig) Tags() *map[string]*string {
...
func (j *jsiiProxy_BedrockagentcoreOnlineEvaluationConfig) TagsAll() cdktn.StringMap {
...
func (j *jsiiProxy_BedrockagentcoreOnlineEvaluationConfig) TagsInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsInput",
...
func (j *jsiiProxy_BedrockagentcoreOnlineEvaluationConfig) Timeouts() BedrockagentcoreOnlineEvaluationConfigTimeoutsOutputReference {
	var returns BedrockagentcoreOnlineEvaluationConfigTimeoutsOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
func (j *jsiiProxy_BedrockagentcoreOnlineEvaluationConfig) TimeoutsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"timeoutsInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.51.0/docs/resources/bedrockagentcore_online_evaluation_config aws_bedrockagentcore_online_evaluation_config} Resource.
func NewBedrockagentcoreOnlineEvaluationConfig(scope constructs.Construct, id *string, config *BedrockagentcoreOnlineEvaluationConfigConfig) BedrockagentcoreOnlineEvaluationConfig {
	...
	_jsii_.Create(
		"@cdktn/provider-aws.bedrockagentcoreOnlineEvaluationConfig.BedrockagentcoreOnlineEvaluationConfig",
...
func (j *jsiiProxy_BedrockagentcoreOnlineEvaluationConfig)SetEnableOnCreate(val interface{}) {
...
func (j *jsiiProxy_BedrockagentcoreOnlineEvaluationConfig)SetRegion(val *string) {
...
func (j *jsiiProxy_BedrockagentcoreOnlineEvaluationConfig)SetTags(val *map[string]*string) {
...
func (b *jsiiProxy_BedrockagentcoreOnlineEvaluationConfig) PutDataSourceConfig(value interface{}) {
...
func (b *jsiiProxy_BedrockagentcoreOnlineEvaluationConfig) PutEvaluator(value interface{}) {
	if err := b.validatePutEvaluatorParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		b,
...
func (b *jsiiProxy_BedrockagentcoreOnlineEvaluationConfig) PutRule(value interface{}) {
...
func (b *jsiiProxy_BedrockagentcoreOnlineEvaluationConfig) PutTimeouts(value *BedrockagentcoreOnlineEvaluationConfigTimeouts) {
...
func (b *jsiiProxy_BedrockagentcoreOnlineEvaluationConfig) ResetDataSourceConfig() {
	_jsii_.InvokeVoid(
		b,
		"resetDataSourceConfig",
		nil, // no parameters
...
func (b *jsiiProxy_BedrockagentcoreOnlineEvaluationConfig) ResetEvaluator() {
	_jsii_.InvokeVoid(
		b,
		"resetEvaluator",
		nil, // no parameters
...
func (b *jsiiProxy_BedrockagentcoreOnlineEvaluationConfig) ResetRegion() {
	_jsii_.InvokeVoid(
		b,
		"resetRegion",
		nil, // no parameters
...
func (b *jsiiProxy_BedrockagentcoreOnlineEvaluationConfig) ResetRule() {
	_jsii_.InvokeVoid(
		b,
		"resetRule",
		nil, // no parameters
...
func (b *jsiiProxy_BedrockagentcoreOnlineEvaluationConfig) ResetTimeouts() {
	_jsii_.InvokeVoid(
		b,
		"resetTimeouts",
		nil, // no parameters
