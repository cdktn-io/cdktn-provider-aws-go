...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v23/dataawsconnectcontactflowmodule/internal"
...
func (j *jsiiProxy_DataAwsConnectContactFlowModule) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsConnectContactFlowModule) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsConnectContactFlowModule) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsConnectContactFlowModule) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsConnectContactFlowModule) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.35.1/docs/data-sources/connect_contact_flow_module aws_connect_contact_flow_module} Data Source.
...
func (j *jsiiProxy_DataAwsConnectContactFlowModule)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsConnectContactFlowModule)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsConnectContactFlowModule)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsConnectContactFlowModule_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsConnectContactFlowModule) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsConnectContactFlowModule) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
