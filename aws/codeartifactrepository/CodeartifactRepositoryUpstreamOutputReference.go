...
func (c *jsiiProxy_CodeartifactRepositoryUpstreamOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CodeartifactRepositoryUpstreamOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
