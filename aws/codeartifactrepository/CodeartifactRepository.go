...
func (j *jsiiProxy_CodeartifactRepository) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_CodeartifactRepository) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_CodeartifactRepository) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_CodeartifactRepository) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_CodeartifactRepository) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_CodeartifactRepository) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_CodeartifactRepository) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_CodeartifactRepository)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_CodeartifactRepository)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_CodeartifactRepository)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_CodeartifactRepository)SetRegion(val *string) {
...
func CodeartifactRepository_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (c *jsiiProxy_CodeartifactRepository) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CodeartifactRepository) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (c *jsiiProxy_CodeartifactRepository) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CodeartifactRepository) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_CodeartifactRepository) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (c *jsiiProxy_CodeartifactRepository) ResetRegion() {
	_jsii_.InvokeVoid(
		c,
		"resetRegion",
		nil, // no parameters
...
func (c *jsiiProxy_CodeartifactRepository) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
