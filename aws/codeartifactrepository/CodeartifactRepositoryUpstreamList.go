...
func (j *jsiiProxy_CodeartifactRepositoryUpstreamList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewCodeartifactRepositoryUpstreamList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) CodeartifactRepositoryUpstreamList {
	_init_.Initialize()
...
func NewCodeartifactRepositoryUpstreamList_Override(c CodeartifactRepositoryUpstreamList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_CodeartifactRepositoryUpstreamList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_CodeartifactRepositoryUpstreamList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (c *jsiiProxy_CodeartifactRepositoryUpstreamList) Resolve(context cdktn.IResolveContext) interface{} {
