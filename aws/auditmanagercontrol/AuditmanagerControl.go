...
func (j *jsiiProxy_AuditmanagerControl) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_AuditmanagerControl) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_AuditmanagerControl) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_AuditmanagerControl) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_AuditmanagerControl) TagsAll() cdktn.StringMap {
...
func (j *jsiiProxy_AuditmanagerControl) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/auditmanager_control aws_auditmanager_control} Resource.
...
func (j *jsiiProxy_AuditmanagerControl)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_AuditmanagerControl)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_AuditmanagerControl)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func AuditmanagerControl_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (a *jsiiProxy_AuditmanagerControl) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AuditmanagerControl) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (a *jsiiProxy_AuditmanagerControl) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AuditmanagerControl) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (a *jsiiProxy_AuditmanagerControl) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
