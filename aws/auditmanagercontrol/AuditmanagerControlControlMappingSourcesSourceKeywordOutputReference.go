...
func (a *jsiiProxy_AuditmanagerControlControlMappingSourcesSourceKeywordOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_AuditmanagerControlControlMappingSourcesSourceKeywordOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
