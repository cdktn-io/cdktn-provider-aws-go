...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v22/storagegatewaytapepool/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.31.0/docs/resources/storagegateway_tape_pool aws_storagegateway_tape_pool}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.31.0/docs/resources/storagegateway_tape_pool aws_storagegateway_tape_pool} Resource.
...
func StoragegatewayTapePool_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
