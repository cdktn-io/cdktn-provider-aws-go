...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/storagegatewaytapepool/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/storagegateway_tape_pool aws_storagegateway_tape_pool}.
...
func (j *jsiiProxy_StoragegatewayTapePool) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_StoragegatewayTapePool) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_StoragegatewayTapePool) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_StoragegatewayTapePool) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_StoragegatewayTapePool) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_StoragegatewayTapePool) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_StoragegatewayTapePool) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/storagegateway_tape_pool aws_storagegateway_tape_pool} Resource.
func NewStoragegatewayTapePool(scope constructs.Construct, id *string, config *StoragegatewayTapePoolConfig) StoragegatewayTapePool {
	...
	if err := validateNewStoragegatewayTapePoolParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_StoragegatewayTapePool)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_StoragegatewayTapePool)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_StoragegatewayTapePool)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_StoragegatewayTapePool)SetRegion(val *string) {
...
func StoragegatewayTapePool_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateStoragegatewayTapePool_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_StoragegatewayTapePool) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_StoragegatewayTapePool) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_StoragegatewayTapePool) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_StoragegatewayTapePool) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_StoragegatewayTapePool) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_StoragegatewayTapePool) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_StoragegatewayTapePool) ResetRegion() {
	_jsii_.InvokeVoid(
		s,
		"resetRegion",
		nil, // no parameters
...
func (s *jsiiProxy_StoragegatewayTapePool) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
