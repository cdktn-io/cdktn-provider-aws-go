...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/iamusergroupmembership/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/iam_user_group_membership aws_iam_user_group_membership}.
...
func (j *jsiiProxy_IamUserGroupMembership) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_IamUserGroupMembership) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_IamUserGroupMembership) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_IamUserGroupMembership) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_IamUserGroupMembership) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/iam_user_group_membership aws_iam_user_group_membership} Resource.
func NewIamUserGroupMembership(scope constructs.Construct, id *string, config *IamUserGroupMembershipConfig) IamUserGroupMembership {
	...
	_jsii_.Create(
		"@cdktn/provider-aws.iamUserGroupMembership.IamUserGroupMembership",
...
func (j *jsiiProxy_IamUserGroupMembership)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_IamUserGroupMembership)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_IamUserGroupMembership)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func IamUserGroupMembership_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (i *jsiiProxy_IamUserGroupMembership) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (i *jsiiProxy_IamUserGroupMembership) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (i *jsiiProxy_IamUserGroupMembership) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (i *jsiiProxy_IamUserGroupMembership) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (i *jsiiProxy_IamUserGroupMembership) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (i *jsiiProxy_IamUserGroupMembership) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
