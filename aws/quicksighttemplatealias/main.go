...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*QuicksightTemplateAlias)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "templateVersionNumber", GoGetter: "TemplateVersionNumber"},
			_jsii_.MemberProperty{JsiiProperty: "templateVersionNumberInput", GoGetter: "TemplateVersionNumberInput"},
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-aws.quicksightTemplateAlias.QuicksightTemplateAliasConfig",
		reflect.TypeOf((*QuicksightTemplateAliasConfig)(nil)).Elem(),
	)
}
