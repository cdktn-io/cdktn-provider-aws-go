...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/curreportdefinition/internal"
...
func (j *jsiiProxy_CurReportDefinition) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_CurReportDefinition) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_CurReportDefinition) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_CurReportDefinition) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_CurReportDefinition) Tags() *map[string]*string {
...
func (j *jsiiProxy_CurReportDefinition) TagsAll() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsAll",
...
func (j *jsiiProxy_CurReportDefinition) TagsAllInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsAllInput",
...
func (j *jsiiProxy_CurReportDefinition) TagsInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsInput",
...
func (j *jsiiProxy_CurReportDefinition) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_CurReportDefinition)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_CurReportDefinition)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_CurReportDefinition)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_CurReportDefinition)SetTags(val *map[string]*string) {
...
func (j *jsiiProxy_CurReportDefinition)SetTagsAll(val *map[string]*string) {
...
func CurReportDefinition_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (c *jsiiProxy_CurReportDefinition) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CurReportDefinition) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (c *jsiiProxy_CurReportDefinition) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CurReportDefinition) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_CurReportDefinition) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (c *jsiiProxy_CurReportDefinition) ResetTags() {
	_jsii_.InvokeVoid(
		c,
		"resetTags",
		nil, // no parameters
...
func (c *jsiiProxy_CurReportDefinition) ResetTagsAll() {
	_jsii_.InvokeVoid(
		c,
		"resetTagsAll",
		nil, // no parameters
...
func (c *jsiiProxy_CurReportDefinition) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
