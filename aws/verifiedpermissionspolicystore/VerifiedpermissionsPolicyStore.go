...
func (j *jsiiProxy_VerifiedpermissionsPolicyStore) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_VerifiedpermissionsPolicyStore) DeletionProtection() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionProtection",
...
func (j *jsiiProxy_VerifiedpermissionsPolicyStore) DeletionProtectionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_VerifiedpermissionsPolicyStore) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_VerifiedpermissionsPolicyStore) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_VerifiedpermissionsPolicyStore) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_VerifiedpermissionsPolicyStore) TagsAll() cdktn.StringMap {
...
func (j *jsiiProxy_VerifiedpermissionsPolicyStore) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/verifiedpermissions_policy_store aws_verifiedpermissions_policy_store} Resource.
func NewVerifiedpermissionsPolicyStore(scope constructs.Construct, id *string, config *VerifiedpermissionsPolicyStoreConfig) VerifiedpermissionsPolicyStore {
	...
	_jsii_.Create(
		"@cdktn/provider-aws.verifiedpermissionsPolicyStore.VerifiedpermissionsPolicyStore",
...
func (j *jsiiProxy_VerifiedpermissionsPolicyStore)SetDeletionProtection(val *string) {
...
func (j *jsiiProxy_VerifiedpermissionsPolicyStore)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_VerifiedpermissionsPolicyStore)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_VerifiedpermissionsPolicyStore)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func VerifiedpermissionsPolicyStore_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (v *jsiiProxy_VerifiedpermissionsPolicyStore) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (v *jsiiProxy_VerifiedpermissionsPolicyStore) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (v *jsiiProxy_VerifiedpermissionsPolicyStore) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (v *jsiiProxy_VerifiedpermissionsPolicyStore) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (v *jsiiProxy_VerifiedpermissionsPolicyStore) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (v *jsiiProxy_VerifiedpermissionsPolicyStore) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
