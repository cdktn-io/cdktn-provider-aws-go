...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/dataawsecscontainerdefinition/internal"
...
func (j *jsiiProxy_DataAwsEcsContainerDefinition) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsEcsContainerDefinition) DisableNetworking() cdktn.IResolvable {
...
func (j *jsiiProxy_DataAwsEcsContainerDefinition) DockerLabels() cdktn.StringMap {
...
func (j *jsiiProxy_DataAwsEcsContainerDefinition) Environment() cdktn.StringMap {
	var returns cdktn.StringMap
	_jsii_.Get(
		j,
		"environment",
...
func (j *jsiiProxy_DataAwsEcsContainerDefinition) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsEcsContainerDefinition) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsEcsContainerDefinition) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsEcsContainerDefinition) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/data-sources/ecs_container_definition aws_ecs_container_definition} Data Source.
...
func (j *jsiiProxy_DataAwsEcsContainerDefinition)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsEcsContainerDefinition)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsEcsContainerDefinition)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsEcsContainerDefinition_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsEcsContainerDefinition) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsEcsContainerDefinition) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsEcsContainerDefinition) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsEcsContainerDefinition) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
