...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/emrstudiosessionmapping/internal"
...
func (j *jsiiProxy_EmrStudioSessionMapping) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_EmrStudioSessionMapping) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_EmrStudioSessionMapping) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_EmrStudioSessionMapping) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_EmrStudioSessionMapping) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/emr_studio_session_mapping aws_emr_studio_session_mapping} Resource.
...
func (j *jsiiProxy_EmrStudioSessionMapping)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_EmrStudioSessionMapping)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_EmrStudioSessionMapping)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func EmrStudioSessionMapping_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (e *jsiiProxy_EmrStudioSessionMapping) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (e *jsiiProxy_EmrStudioSessionMapping) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (e *jsiiProxy_EmrStudioSessionMapping) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (e *jsiiProxy_EmrStudioSessionMapping) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (e *jsiiProxy_EmrStudioSessionMapping) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (e *jsiiProxy_EmrStudioSessionMapping) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
