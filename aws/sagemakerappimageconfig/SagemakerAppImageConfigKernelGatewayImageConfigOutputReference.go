...
func (j *jsiiProxy_SagemakerAppImageConfigKernelGatewayImageConfigOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewSagemakerAppImageConfigKernelGatewayImageConfigOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) SagemakerAppImageConfigKernelGatewayImageConfigOutputReference {
	_init_.Initialize()
...
func NewSagemakerAppImageConfigKernelGatewayImageConfigOutputReference_Override(s SagemakerAppImageConfigKernelGatewayImageConfigOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_SagemakerAppImageConfigKernelGatewayImageConfigOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_SagemakerAppImageConfigKernelGatewayImageConfigOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SagemakerAppImageConfigKernelGatewayImageConfigOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (s *jsiiProxy_SagemakerAppImageConfigKernelGatewayImageConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SagemakerAppImageConfigKernelGatewayImageConfigOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
