...
func (j *jsiiProxy_SagemakerAppImageConfigCodeEditorAppImageConfigContainerConfigOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewSagemakerAppImageConfigCodeEditorAppImageConfigContainerConfigOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) SagemakerAppImageConfigCodeEditorAppImageConfigContainerConfigOutputReference {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-aws.sagemakerAppImageConfig.SagemakerAppImageConfigCodeEditorAppImageConfigContainerConfigOutputReference",
...
func NewSagemakerAppImageConfigCodeEditorAppImageConfigContainerConfigOutputReference_Override(s SagemakerAppImageConfigCodeEditorAppImageConfigContainerConfigOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_SagemakerAppImageConfigCodeEditorAppImageConfigContainerConfigOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_SagemakerAppImageConfigCodeEditorAppImageConfigContainerConfigOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SagemakerAppImageConfigCodeEditorAppImageConfigContainerConfigOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (s *jsiiProxy_SagemakerAppImageConfigCodeEditorAppImageConfigContainerConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SagemakerAppImageConfigCodeEditorAppImageConfigContainerConfigOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
