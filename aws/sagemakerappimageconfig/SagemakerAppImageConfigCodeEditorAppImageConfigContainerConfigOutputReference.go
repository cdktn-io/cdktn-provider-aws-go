...
func (s *jsiiProxy_SagemakerAppImageConfigCodeEditorAppImageConfigContainerConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_SagemakerAppImageConfigCodeEditorAppImageConfigContainerConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
