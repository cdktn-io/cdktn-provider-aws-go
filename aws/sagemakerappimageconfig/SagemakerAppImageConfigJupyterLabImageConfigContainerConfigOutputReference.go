...
func (s *jsiiProxy_SagemakerAppImageConfigJupyterLabImageConfigContainerConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_SagemakerAppImageConfigJupyterLabImageConfigContainerConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
