...
func (s *jsiiProxy_S3FilesAccessPoint) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_S3FilesAccessPoint) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
