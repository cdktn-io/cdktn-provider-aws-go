...
func (j *jsiiProxy_DataAwsWafv2ManagedRuleGroup) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_DataAwsWafv2ManagedRuleGroup) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsWafv2ManagedRuleGroup) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsWafv2ManagedRuleGroup) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_DataAwsWafv2ManagedRuleGroup) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.32.1/docs/data-sources/wafv2_managed_rule_group aws_wafv2_managed_rule_group} Data Source.
...
func (j *jsiiProxy_DataAwsWafv2ManagedRuleGroup)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsWafv2ManagedRuleGroup)SetLifecycle(val *cdktf.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsWafv2ManagedRuleGroup)SetProvider(val cdktf.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsWafv2ManagedRuleGroup_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsWafv2ManagedRuleGroup) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataAwsWafv2ManagedRuleGroup) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
