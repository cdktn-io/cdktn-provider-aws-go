...
func (j *jsiiProxy_DataAwsEc2TransitGatewayRouteTablePropagations) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsEc2TransitGatewayRouteTablePropagations) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsEc2TransitGatewayRouteTablePropagations) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsEc2TransitGatewayRouteTablePropagations) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsEc2TransitGatewayRouteTablePropagations) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DataAwsEc2TransitGatewayRouteTablePropagations) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_DataAwsEc2TransitGatewayRouteTablePropagations) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func NewDataAwsEc2TransitGatewayRouteTablePropagations(scope constructs.Construct, id *string, config *DataAwsEc2TransitGatewayRouteTablePropagationsConfig) DataAwsEc2TransitGatewayRouteTablePropagations {
	...
	_jsii_.Create(
		"@cdktn/provider-aws.dataAwsEc2TransitGatewayRouteTablePropagations.DataAwsEc2TransitGatewayRouteTablePropagations",
...
func (j *jsiiProxy_DataAwsEc2TransitGatewayRouteTablePropagations)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsEc2TransitGatewayRouteTablePropagations)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsEc2TransitGatewayRouteTablePropagations)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_DataAwsEc2TransitGatewayRouteTablePropagations)SetRegion(val *string) {
...
func DataAwsEc2TransitGatewayRouteTablePropagations_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsEc2TransitGatewayRouteTablePropagations) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsEc2TransitGatewayRouteTablePropagations) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsEc2TransitGatewayRouteTablePropagations) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsEc2TransitGatewayRouteTablePropagations) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsEc2TransitGatewayRouteTablePropagations) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
