...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/ec2tag/internal"
...
func (j *jsiiProxy_Ec2Tag) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_Ec2Tag) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_Ec2Tag) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_Ec2Tag) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_Ec2Tag) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/ec2_tag aws_ec2_tag} Resource.
...
func (j *jsiiProxy_Ec2Tag)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_Ec2Tag)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_Ec2Tag)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func Ec2Tag_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (e *jsiiProxy_Ec2Tag) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (e *jsiiProxy_Ec2Tag) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (e *jsiiProxy_Ec2Tag) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (e *jsiiProxy_Ec2Tag) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (e *jsiiProxy_Ec2Tag) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (e *jsiiProxy_Ec2Tag) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
