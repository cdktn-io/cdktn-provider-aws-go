...
func (j *jsiiProxy_Route53RecoverycontrolconfigCluster) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_Route53RecoverycontrolconfigCluster) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_Route53RecoverycontrolconfigCluster) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_Route53RecoverycontrolconfigCluster) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_Route53RecoverycontrolconfigCluster) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/route53recoverycontrolconfig_cluster aws_route53recoverycontrolconfig_cluster} Resource.
func NewRoute53RecoverycontrolconfigCluster(scope constructs.Construct, id *string, config *Route53RecoverycontrolconfigClusterConfig) Route53RecoverycontrolconfigCluster {
	...
	_jsii_.Create(
		"@cdktn/provider-aws.route53RecoverycontrolconfigCluster.Route53RecoverycontrolconfigCluster",
...
func (j *jsiiProxy_Route53RecoverycontrolconfigCluster)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_Route53RecoverycontrolconfigCluster)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_Route53RecoverycontrolconfigCluster)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func Route53RecoverycontrolconfigCluster_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (r *jsiiProxy_Route53RecoverycontrolconfigCluster) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (r *jsiiProxy_Route53RecoverycontrolconfigCluster) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (r *jsiiProxy_Route53RecoverycontrolconfigCluster) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (r *jsiiProxy_Route53RecoverycontrolconfigCluster) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (r *jsiiProxy_Route53RecoverycontrolconfigCluster) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (r *jsiiProxy_Route53RecoverycontrolconfigCluster) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
