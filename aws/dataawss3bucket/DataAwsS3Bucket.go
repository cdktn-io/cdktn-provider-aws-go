...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/dataawss3bucket/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/data-sources/s3_bucket aws_s3_bucket}.
...
func (j *jsiiProxy_DataAwsS3Bucket) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsS3Bucket) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsS3Bucket) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsS3Bucket) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsS3Bucket) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/data-sources/s3_bucket aws_s3_bucket} Data Source.
...
func (j *jsiiProxy_DataAwsS3Bucket)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsS3Bucket)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsS3Bucket)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
// Generates CDKTN code for importing a DataAwsS3Bucket resource upon running "cdktn plan <stack-name>".
func DataAwsS3Bucket_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsS3Bucket) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsS3Bucket) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsS3Bucket) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsS3Bucket) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
