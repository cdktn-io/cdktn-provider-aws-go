...
func (j *jsiiProxy_S3OutpostsEndpointNetworkInterfacesList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewS3OutpostsEndpointNetworkInterfacesList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) S3OutpostsEndpointNetworkInterfacesList {
	_init_.Initialize()
...
func NewS3OutpostsEndpointNetworkInterfacesList_Override(s S3OutpostsEndpointNetworkInterfacesList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_S3OutpostsEndpointNetworkInterfacesList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_S3OutpostsEndpointNetworkInterfacesList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (s *jsiiProxy_S3OutpostsEndpointNetworkInterfacesList) Resolve(context cdktn.IResolveContext) interface{} {
