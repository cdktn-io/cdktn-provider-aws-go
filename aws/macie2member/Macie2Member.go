...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/macie2member/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/macie2_member aws_macie2_member}.
...
func (j *jsiiProxy_Macie2Member) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_Macie2Member) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_Macie2Member) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_Macie2Member) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_Macie2Member) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_Macie2Member) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_Macie2Member) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/macie2_member aws_macie2_member} Resource.
...
func (j *jsiiProxy_Macie2Member)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_Macie2Member)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_Macie2Member)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_Macie2Member)SetRegion(val *string) {
...
func Macie2Member_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (m *jsiiProxy_Macie2Member) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_Macie2Member) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (m *jsiiProxy_Macie2Member) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_Macie2Member) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (m *jsiiProxy_Macie2Member) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (m *jsiiProxy_Macie2Member) ResetRegion() {
	_jsii_.InvokeVoid(
		m,
		"resetRegion",
		nil, // no parameters
...
func (m *jsiiProxy_Macie2Member) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
