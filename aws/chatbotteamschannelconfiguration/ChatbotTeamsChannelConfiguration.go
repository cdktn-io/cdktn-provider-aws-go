...
func (c *jsiiProxy_ChatbotTeamsChannelConfiguration) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_ChatbotTeamsChannelConfiguration) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
