...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/signer_signing_profile aws_signer_signing_profile}.
...
func (j *jsiiProxy_SignerSigningProfile) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_SignerSigningProfile) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_SignerSigningProfile) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_SignerSigningProfile) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_SignerSigningProfile) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_SignerSigningProfile) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_SignerSigningProfile) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/signer_signing_profile aws_signer_signing_profile} Resource.
...
func (j *jsiiProxy_SignerSigningProfile)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_SignerSigningProfile)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_SignerSigningProfile)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_SignerSigningProfile)SetRegion(val *string) {
...
func SignerSigningProfile_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (s *jsiiProxy_SignerSigningProfile) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SignerSigningProfile) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_SignerSigningProfile) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SignerSigningProfile) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_SignerSigningProfile) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_SignerSigningProfile) ResetRegion() {
	_jsii_.InvokeVoid(
		s,
		"resetRegion",
		nil, // no parameters
...
func (s *jsiiProxy_SignerSigningProfile) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
