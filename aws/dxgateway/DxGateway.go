...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/dxgateway/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/dx_gateway aws_dx_gateway}.
...
func (j *jsiiProxy_DxGateway) Arn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"arn",
...
func (j *jsiiProxy_DxGateway) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DxGateway) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DxGateway) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DxGateway) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DxGateway) Tags() *map[string]*string {
...
func (j *jsiiProxy_DxGateway) TagsAll() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsAll",
...
func (j *jsiiProxy_DxGateway) TagsAllInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsAllInput",
...
func (j *jsiiProxy_DxGateway) TagsInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsInput",
...
func (j *jsiiProxy_DxGateway) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/dx_gateway aws_dx_gateway} Resource.
func NewDxGateway(scope constructs.Construct, id *string, config *DxGatewayConfig) DxGateway {
	...
	_jsii_.Create(
		"@cdktn/provider-aws.dxGateway.DxGateway",
...
func (j *jsiiProxy_DxGateway)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DxGateway)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DxGateway)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_DxGateway)SetTags(val *map[string]*string) {
...
func (j *jsiiProxy_DxGateway)SetTagsAll(val *map[string]*string) {
...
func DxGateway_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DxGateway) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DxGateway) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (d *jsiiProxy_DxGateway) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DxGateway) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (d *jsiiProxy_DxGateway) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DxGateway) ResetTags() {
	_jsii_.InvokeVoid(
		d,
		"resetTags",
		nil, // no parameters
...
func (d *jsiiProxy_DxGateway) ResetTagsAll() {
	_jsii_.InvokeVoid(
		d,
		"resetTagsAll",
		nil, // no parameters
...
func (d *jsiiProxy_DxGateway) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
