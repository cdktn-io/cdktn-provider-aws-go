...
func (m *jsiiProxy_MskconnectCustomPluginLocationS3OutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (m *jsiiProxy_MskconnectCustomPluginLocationS3OutputReference) Resolve(context cdktf.IResolveContext) interface{} {
