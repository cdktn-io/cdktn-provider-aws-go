...
func (m *jsiiProxy_MskconnectCustomPluginTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (m *jsiiProxy_MskconnectCustomPluginTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
