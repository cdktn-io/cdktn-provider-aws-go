...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/mskconnectcustomplugin/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/mskconnect_custom_plugin aws_mskconnect_custom_plugin}.
...
func (j *jsiiProxy_MskconnectCustomPlugin) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_MskconnectCustomPlugin) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_MskconnectCustomPlugin) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_MskconnectCustomPlugin) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_MskconnectCustomPlugin) Tags() *map[string]*string {
...
func (j *jsiiProxy_MskconnectCustomPlugin) TagsAll() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsAll",
...
func (j *jsiiProxy_MskconnectCustomPlugin) TagsAllInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsAllInput",
...
func (j *jsiiProxy_MskconnectCustomPlugin) TagsInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsInput",
...
func (j *jsiiProxy_MskconnectCustomPlugin) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/mskconnect_custom_plugin aws_mskconnect_custom_plugin} Resource.
...
func (j *jsiiProxy_MskconnectCustomPlugin)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_MskconnectCustomPlugin)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_MskconnectCustomPlugin)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_MskconnectCustomPlugin)SetTags(val *map[string]*string) {
...
func (j *jsiiProxy_MskconnectCustomPlugin)SetTagsAll(val *map[string]*string) {
...
func MskconnectCustomPlugin_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateMskconnectCustomPlugin_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (m *jsiiProxy_MskconnectCustomPlugin) AddMoveTarget(moveTarget *string) {
...
func (m *jsiiProxy_MskconnectCustomPlugin) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MskconnectCustomPlugin) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (m *jsiiProxy_MskconnectCustomPlugin) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MskconnectCustomPlugin) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (m *jsiiProxy_MskconnectCustomPlugin) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (m *jsiiProxy_MskconnectCustomPlugin) ResetTags() {
	_jsii_.InvokeVoid(
		m,
		"resetTags",
		nil, // no parameters
...
func (m *jsiiProxy_MskconnectCustomPlugin) ResetTagsAll() {
	_jsii_.InvokeVoid(
		m,
		"resetTagsAll",
		nil, // no parameters
...
func (m *jsiiProxy_MskconnectCustomPlugin) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
