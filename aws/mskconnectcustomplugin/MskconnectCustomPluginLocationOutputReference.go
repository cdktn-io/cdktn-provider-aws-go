...
func (j *jsiiProxy_MskconnectCustomPluginLocationOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewMskconnectCustomPluginLocationOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) MskconnectCustomPluginLocationOutputReference {
	_init_.Initialize()

	if err := validateNewMskconnectCustomPluginLocationOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewMskconnectCustomPluginLocationOutputReference_Override(m MskconnectCustomPluginLocationOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_MskconnectCustomPluginLocationOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (m *jsiiProxy_MskconnectCustomPluginLocationOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MskconnectCustomPluginLocationOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (m *jsiiProxy_MskconnectCustomPluginLocationOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MskconnectCustomPluginLocationOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
