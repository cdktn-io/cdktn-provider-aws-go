...
func (m *jsiiProxy_MskconnectCustomPluginLocationOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (m *jsiiProxy_MskconnectCustomPluginLocationOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
