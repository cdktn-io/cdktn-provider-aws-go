...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/dataawsiamsessioncontext/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/data-sources/iam_session_context aws_iam_session_context}.
...
func (j *jsiiProxy_DataAwsIamSessionContext) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsIamSessionContext) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsIamSessionContext) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsIamSessionContext) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsIamSessionContext) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/data-sources/iam_session_context aws_iam_session_context} Data Source.
...
func (j *jsiiProxy_DataAwsIamSessionContext)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsIamSessionContext)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsIamSessionContext)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsIamSessionContext_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateDataAwsIamSessionContext_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataAwsIamSessionContext) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsIamSessionContext) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsIamSessionContext) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsIamSessionContext) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataAwsIamSessionContext) ToHclTerraform() interface{} {
	var returns interface{}
...
func (d *jsiiProxy_DataAwsIamSessionContext) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
