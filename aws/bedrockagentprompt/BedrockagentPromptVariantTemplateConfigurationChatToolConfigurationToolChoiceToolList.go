...
func (b *jsiiProxy_BedrockagentPromptVariantTemplateConfigurationChatToolConfigurationToolChoiceToolList) Resolve(context cdktf.IResolveContext) interface{} {
