...
func (b *jsiiProxy_BedrockagentPromptVariantInferenceConfigurationTextOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (b *jsiiProxy_BedrockagentPromptVariantInferenceConfigurationTextOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
