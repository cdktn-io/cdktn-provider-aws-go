...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-aws.dataAwsArcregionswitchRoute53HealthChecks.DataAwsArcregionswitchRoute53HealthChecksConfig",
		reflect.TypeOf((*DataAwsArcregionswitchRoute53HealthChecksConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-aws.dataAwsArcregionswitchRoute53HealthChecks.DataAwsArcregionswitchRoute53HealthChecksHealthChecks",
		reflect.TypeOf((*DataAwsArcregionswitchRoute53HealthChecksHealthChecks)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-aws.dataAwsArcregionswitchRoute53HealthChecks.DataAwsArcregionswitchRoute53HealthChecksHealthChecksList",
		reflect.TypeOf((*DataAwsArcregionswitchRoute53HealthChecksHealthChecksList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsArcregionswitchRoute53HealthChecksHealthChecksOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
