...
func (g *jsiiProxy_GlueCatalogTableOptimizerConfigurationOrphanFileDeletionConfigurationList) validateResolveParameters(context cdktn.IResolveContext) error {
	if context == nil {
...
func (j *jsiiProxy_GlueCatalogTableOptimizerConfigurationOrphanFileDeletionConfigurationList) validateSetTerraformResourceParameters(val cdktn.IInterpolatingParent) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func validateNewGlueCatalogTableOptimizerConfigurationOrphanFileDeletionConfigurationListParameters(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) error {
