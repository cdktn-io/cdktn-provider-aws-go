...
func (c *jsiiProxy_CloudsearchDomainEndpointOptionsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CloudsearchDomainEndpointOptionsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
