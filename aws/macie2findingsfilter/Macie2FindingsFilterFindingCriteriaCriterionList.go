...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/macie2findingsfilter/internal"
...
func (j *jsiiProxy_Macie2FindingsFilterFindingCriteriaCriterionList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewMacie2FindingsFilterFindingCriteriaCriterionList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) Macie2FindingsFilterFindingCriteriaCriterionList {
	_init_.Initialize()
...
func NewMacie2FindingsFilterFindingCriteriaCriterionList_Override(m Macie2FindingsFilterFindingCriteriaCriterionList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_Macie2FindingsFilterFindingCriteriaCriterionList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (m *jsiiProxy_Macie2FindingsFilterFindingCriteriaCriterionList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (m *jsiiProxy_Macie2FindingsFilterFindingCriteriaCriterionList) Resolve(context cdktn.IResolveContext) interface{} {
