...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v22/macie2findingsfilter/internal"
...
func (m *jsiiProxy_Macie2FindingsFilterFindingCriteriaCriterionList) Resolve(context cdktf.IResolveContext) interface{} {
