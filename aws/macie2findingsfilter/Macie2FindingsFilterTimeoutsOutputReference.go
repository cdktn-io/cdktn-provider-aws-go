...
func (m *jsiiProxy_Macie2FindingsFilterTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (m *jsiiProxy_Macie2FindingsFilterTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
