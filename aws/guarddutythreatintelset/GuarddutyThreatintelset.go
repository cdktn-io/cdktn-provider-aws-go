...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/guarddutythreatintelset/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/guardduty_threatintelset aws_guardduty_threatintelset}.
...
func (j *jsiiProxy_GuarddutyThreatintelset) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_GuarddutyThreatintelset) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_GuarddutyThreatintelset) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_GuarddutyThreatintelset) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_GuarddutyThreatintelset) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_GuarddutyThreatintelset) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_GuarddutyThreatintelset) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/guardduty_threatintelset aws_guardduty_threatintelset} Resource.
func NewGuarddutyThreatintelset(scope constructs.Construct, id *string, config *GuarddutyThreatintelsetConfig) GuarddutyThreatintelset {
	...
	_jsii_.Create(
		"@cdktn/provider-aws.guarddutyThreatintelset.GuarddutyThreatintelset",
...
func (j *jsiiProxy_GuarddutyThreatintelset)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_GuarddutyThreatintelset)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_GuarddutyThreatintelset)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_GuarddutyThreatintelset)SetRegion(val *string) {
...
func GuarddutyThreatintelset_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (g *jsiiProxy_GuarddutyThreatintelset) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GuarddutyThreatintelset) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (g *jsiiProxy_GuarddutyThreatintelset) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GuarddutyThreatintelset) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GuarddutyThreatintelset) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (g *jsiiProxy_GuarddutyThreatintelset) ResetRegion() {
	_jsii_.InvokeVoid(
		g,
		"resetRegion",
		nil, // no parameters
...
func (g *jsiiProxy_GuarddutyThreatintelset) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
