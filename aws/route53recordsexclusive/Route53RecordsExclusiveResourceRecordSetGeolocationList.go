...
func (j *jsiiProxy_Route53RecordsExclusiveResourceRecordSetGeolocationList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewRoute53RecordsExclusiveResourceRecordSetGeolocationList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) Route53RecordsExclusiveResourceRecordSetGeolocationList {
	_init_.Initialize()
...
func NewRoute53RecordsExclusiveResourceRecordSetGeolocationList_Override(r Route53RecordsExclusiveResourceRecordSetGeolocationList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_Route53RecordsExclusiveResourceRecordSetGeolocationList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (r *jsiiProxy_Route53RecordsExclusiveResourceRecordSetGeolocationList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (r *jsiiProxy_Route53RecordsExclusiveResourceRecordSetGeolocationList) Resolve(context cdktn.IResolveContext) interface{} {
