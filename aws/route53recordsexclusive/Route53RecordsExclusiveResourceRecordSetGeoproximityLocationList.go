...
func (j *jsiiProxy_Route53RecordsExclusiveResourceRecordSetGeoproximityLocationList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewRoute53RecordsExclusiveResourceRecordSetGeoproximityLocationList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) Route53RecordsExclusiveResourceRecordSetGeoproximityLocationList {
	_init_.Initialize()
...
func NewRoute53RecordsExclusiveResourceRecordSetGeoproximityLocationList_Override(r Route53RecordsExclusiveResourceRecordSetGeoproximityLocationList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_Route53RecordsExclusiveResourceRecordSetGeoproximityLocationList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (r *jsiiProxy_Route53RecordsExclusiveResourceRecordSetGeoproximityLocationList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (r *jsiiProxy_Route53RecordsExclusiveResourceRecordSetGeoproximityLocationList) Resolve(context cdktf.IResolveContext) interface{} {
