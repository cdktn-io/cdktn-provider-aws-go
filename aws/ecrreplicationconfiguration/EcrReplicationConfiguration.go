...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/ecr_replication_configuration aws_ecr_replication_configuration}.
...
func (j *jsiiProxy_EcrReplicationConfiguration) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_EcrReplicationConfiguration) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_EcrReplicationConfiguration) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_EcrReplicationConfiguration) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_EcrReplicationConfiguration) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_EcrReplicationConfiguration) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_EcrReplicationConfiguration) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/ecr_replication_configuration aws_ecr_replication_configuration} Resource.
...
func (j *jsiiProxy_EcrReplicationConfiguration)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_EcrReplicationConfiguration)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_EcrReplicationConfiguration)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_EcrReplicationConfiguration)SetRegion(val *string) {
...
func EcrReplicationConfiguration_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateEcrReplicationConfiguration_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (e *jsiiProxy_EcrReplicationConfiguration) AddMoveTarget(moveTarget *string) {
...
func (e *jsiiProxy_EcrReplicationConfiguration) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (e *jsiiProxy_EcrReplicationConfiguration) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (e *jsiiProxy_EcrReplicationConfiguration) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (e *jsiiProxy_EcrReplicationConfiguration) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (e *jsiiProxy_EcrReplicationConfiguration) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (e *jsiiProxy_EcrReplicationConfiguration) ResetRegion() {
	_jsii_.InvokeVoid(
		e,
		"resetRegion",
		nil, // no parameters
...
func (e *jsiiProxy_EcrReplicationConfiguration) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
