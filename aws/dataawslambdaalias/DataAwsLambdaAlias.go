...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v23/dataawslambdaalias/internal"
...
func (j *jsiiProxy_DataAwsLambdaAlias) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsLambdaAlias) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsLambdaAlias) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsLambdaAlias) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsLambdaAlias) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DataAwsLambdaAlias) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_DataAwsLambdaAlias) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DataAwsLambdaAlias)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsLambdaAlias)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsLambdaAlias)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_DataAwsLambdaAlias)SetRegion(val *string) {
...
func DataAwsLambdaAlias_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsLambdaAlias) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsLambdaAlias) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsLambdaAlias) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsLambdaAlias) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
