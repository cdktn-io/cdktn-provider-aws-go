...
func (j *jsiiProxy_ImagebuilderImage) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_ImagebuilderImage) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_ImagebuilderImage) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_ImagebuilderImage) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_ImagebuilderImage) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_ImagebuilderImage) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_ImagebuilderImage) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_ImagebuilderImage)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_ImagebuilderImage)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_ImagebuilderImage)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_ImagebuilderImage)SetRegion(val *string) {
...
func ImagebuilderImage_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (i *jsiiProxy_ImagebuilderImage) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (i *jsiiProxy_ImagebuilderImage) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (i *jsiiProxy_ImagebuilderImage) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (i *jsiiProxy_ImagebuilderImage) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (i *jsiiProxy_ImagebuilderImage) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (i *jsiiProxy_ImagebuilderImage) ResetRegion() {
	_jsii_.InvokeVoid(
		i,
		"resetRegion",
		nil, // no parameters
...
func (i *jsiiProxy_ImagebuilderImage) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
