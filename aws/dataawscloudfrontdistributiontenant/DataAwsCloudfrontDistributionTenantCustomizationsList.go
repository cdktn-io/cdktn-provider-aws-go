...
func (j *jsiiProxy_DataAwsCloudfrontDistributionTenantCustomizationsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsCloudfrontDistributionTenantCustomizationsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsCloudfrontDistributionTenantCustomizationsList {
	_init_.Initialize()
...
func NewDataAwsCloudfrontDistributionTenantCustomizationsList_Override(d DataAwsCloudfrontDistributionTenantCustomizationsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsCloudfrontDistributionTenantCustomizationsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsCloudfrontDistributionTenantCustomizationsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsCloudfrontDistributionTenantCustomizationsList) Resolve(context cdktn.IResolveContext) interface{} {
