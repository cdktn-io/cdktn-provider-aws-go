...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/quicksightuser/internal"
...
func (j *jsiiProxy_QuicksightUser) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_QuicksightUser) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_QuicksightUser) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_QuicksightUser) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_QuicksightUser) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/quicksight_user aws_quicksight_user} Resource.
func NewQuicksightUser(scope constructs.Construct, id *string, config *QuicksightUserConfig) QuicksightUser {
	...
	_jsii_.Create(
		"@cdktn/provider-aws.quicksightUser.QuicksightUser",
...
func (j *jsiiProxy_QuicksightUser)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_QuicksightUser)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_QuicksightUser)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func QuicksightUser_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (q *jsiiProxy_QuicksightUser) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (q *jsiiProxy_QuicksightUser) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (q *jsiiProxy_QuicksightUser) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (q *jsiiProxy_QuicksightUser) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (q *jsiiProxy_QuicksightUser) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (q *jsiiProxy_QuicksightUser) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
