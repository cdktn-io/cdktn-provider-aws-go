...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*MskTopic)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-aws.mskTopic.MskTopicConfig",
		reflect.TypeOf((*MskTopicConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-aws.mskTopic.MskTopicTimeouts",
		reflect.TypeOf((*MskTopicTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-aws.mskTopic.MskTopicTimeoutsOutputReference",
		reflect.TypeOf((*MskTopicTimeoutsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
		...
		func() interface{} {
			j := jsiiProxy_MskTopicTimeoutsOutputReference{}
