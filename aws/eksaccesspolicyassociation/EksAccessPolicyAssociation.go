...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/eks_access_policy_association aws_eks_access_policy_association}.
...
func (j *jsiiProxy_EksAccessPolicyAssociation) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_EksAccessPolicyAssociation) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_EksAccessPolicyAssociation) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_EksAccessPolicyAssociation) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_EksAccessPolicyAssociation) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/eks_access_policy_association aws_eks_access_policy_association} Resource.
...
func (j *jsiiProxy_EksAccessPolicyAssociation)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_EksAccessPolicyAssociation)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_EksAccessPolicyAssociation)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func EksAccessPolicyAssociation_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (e *jsiiProxy_EksAccessPolicyAssociation) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (e *jsiiProxy_EksAccessPolicyAssociation) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (e *jsiiProxy_EksAccessPolicyAssociation) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (e *jsiiProxy_EksAccessPolicyAssociation) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (e *jsiiProxy_EksAccessPolicyAssociation) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (e *jsiiProxy_EksAccessPolicyAssociation) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
