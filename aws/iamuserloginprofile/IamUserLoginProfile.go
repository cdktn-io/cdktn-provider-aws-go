...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/iamuserloginprofile/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/iam_user_login_profile aws_iam_user_login_profile}.
...
func (j *jsiiProxy_IamUserLoginProfile) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_IamUserLoginProfile) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_IamUserLoginProfile) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_IamUserLoginProfile) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_IamUserLoginProfile) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/iam_user_login_profile aws_iam_user_login_profile} Resource.
...
func (j *jsiiProxy_IamUserLoginProfile)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_IamUserLoginProfile)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_IamUserLoginProfile)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func IamUserLoginProfile_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateIamUserLoginProfile_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (i *jsiiProxy_IamUserLoginProfile) AddMoveTarget(moveTarget *string) {
...
func (i *jsiiProxy_IamUserLoginProfile) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (i *jsiiProxy_IamUserLoginProfile) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (i *jsiiProxy_IamUserLoginProfile) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (i *jsiiProxy_IamUserLoginProfile) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (i *jsiiProxy_IamUserLoginProfile) MoveFromId(id *string) {
...
func (i *jsiiProxy_IamUserLoginProfile) MoveToId(id *string) {
...
func (i *jsiiProxy_IamUserLoginProfile) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (i *jsiiProxy_IamUserLoginProfile) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
