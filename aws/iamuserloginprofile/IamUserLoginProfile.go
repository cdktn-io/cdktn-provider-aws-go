...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v22/iamuserloginprofile/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.31.0/docs/resources/iam_user_login_profile aws_iam_user_login_profile}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.31.0/docs/resources/iam_user_login_profile aws_iam_user_login_profile} Resource.
...
func IamUserLoginProfile_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (i *jsiiProxy_IamUserLoginProfile) ImportFrom(id *string, provider cdktf.TerraformProvider) {
