...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/dmsreplicationsubnetgroup/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/dms_replication_subnet_group aws_dms_replication_subnet_group}.
...
func (j *jsiiProxy_DmsReplicationSubnetGroup) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DmsReplicationSubnetGroup) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DmsReplicationSubnetGroup) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DmsReplicationSubnetGroup) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DmsReplicationSubnetGroup) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DmsReplicationSubnetGroup) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_DmsReplicationSubnetGroup) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/dms_replication_subnet_group aws_dms_replication_subnet_group} Resource.
...
func (j *jsiiProxy_DmsReplicationSubnetGroup)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DmsReplicationSubnetGroup)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DmsReplicationSubnetGroup)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_DmsReplicationSubnetGroup)SetRegion(val *string) {
...
func DmsReplicationSubnetGroup_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DmsReplicationSubnetGroup) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DmsReplicationSubnetGroup) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (d *jsiiProxy_DmsReplicationSubnetGroup) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DmsReplicationSubnetGroup) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (d *jsiiProxy_DmsReplicationSubnetGroup) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DmsReplicationSubnetGroup) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
...
func (d *jsiiProxy_DmsReplicationSubnetGroup) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
