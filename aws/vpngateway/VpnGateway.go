...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v24/vpngateway/internal"
...
func (j *jsiiProxy_VpnGateway) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_VpnGateway) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.45.0/docs/resources/vpn_gateway aws_vpn_gateway} Resource.
func NewVpnGateway(scope constructs.Construct, id *string, config *VpnGatewayConfig) VpnGateway {
	...
	_jsii_.Create(
		"@cdktn/provider-aws.vpnGateway.VpnGateway",
...
func (j *jsiiProxy_VpnGateway)SetRegion(val *string) {
...
func (v *jsiiProxy_VpnGateway) ResetRegion() {
	_jsii_.InvokeVoid(
		v,
		"resetRegion",
		nil, // no parameters
