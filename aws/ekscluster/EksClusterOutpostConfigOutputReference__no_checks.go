...
func (e *jsiiProxy_EksClusterOutpostConfigOutputReference) validateResolveParameters(context cdktf.IResolveContext) error {
	return nil
}
...
func (j *jsiiProxy_EksClusterOutpostConfigOutputReference) validateSetInternalValueParameters(val *EksClusterOutpostConfig) error {
	return nil
}
...
func (j *jsiiProxy_EksClusterOutpostConfigOutputReference) validateSetTerraformResourceParameters(val cdktf.IInterpolatingParent) error {
	return nil
}

func validateNewEksClusterOutpostConfigOutputReferenceParameters(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) error {
	return nil
}
