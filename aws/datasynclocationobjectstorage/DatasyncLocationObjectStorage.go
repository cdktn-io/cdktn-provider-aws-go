...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/datasynclocationobjectstorage/internal"
...
func (j *jsiiProxy_DatasyncLocationObjectStorage) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DatasyncLocationObjectStorage) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DatasyncLocationObjectStorage) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DatasyncLocationObjectStorage) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DatasyncLocationObjectStorage) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DatasyncLocationObjectStorage) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_DatasyncLocationObjectStorage) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/datasync_location_object_storage aws_datasync_location_object_storage} Resource.
...
func (j *jsiiProxy_DatasyncLocationObjectStorage)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DatasyncLocationObjectStorage)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DatasyncLocationObjectStorage)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_DatasyncLocationObjectStorage)SetRegion(val *string) {
...
func DatasyncLocationObjectStorage_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DatasyncLocationObjectStorage) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DatasyncLocationObjectStorage) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (d *jsiiProxy_DatasyncLocationObjectStorage) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DatasyncLocationObjectStorage) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (d *jsiiProxy_DatasyncLocationObjectStorage) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DatasyncLocationObjectStorage) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
...
func (d *jsiiProxy_DatasyncLocationObjectStorage) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
