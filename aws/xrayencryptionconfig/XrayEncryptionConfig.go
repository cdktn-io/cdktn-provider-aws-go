...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/xrayencryptionconfig/internal"
...
func (j *jsiiProxy_XrayEncryptionConfig) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_XrayEncryptionConfig) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_XrayEncryptionConfig) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_XrayEncryptionConfig) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_XrayEncryptionConfig) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/xray_encryption_config aws_xray_encryption_config} Resource.
...
func (j *jsiiProxy_XrayEncryptionConfig)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_XrayEncryptionConfig)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_XrayEncryptionConfig)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func XrayEncryptionConfig_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (x *jsiiProxy_XrayEncryptionConfig) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (x *jsiiProxy_XrayEncryptionConfig) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (x *jsiiProxy_XrayEncryptionConfig) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (x *jsiiProxy_XrayEncryptionConfig) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (x *jsiiProxy_XrayEncryptionConfig) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (x *jsiiProxy_XrayEncryptionConfig) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
