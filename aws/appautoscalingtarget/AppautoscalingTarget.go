...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/appautoscalingtarget/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/appautoscaling_target aws_appautoscaling_target}.
...
func (j *jsiiProxy_AppautoscalingTarget) Arn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"arn",
...
func (j *jsiiProxy_AppautoscalingTarget) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_AppautoscalingTarget) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_AppautoscalingTarget) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_AppautoscalingTarget) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_AppautoscalingTarget) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_AppautoscalingTarget) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_AppautoscalingTarget) TagsAll() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsAll",
...
func (j *jsiiProxy_AppautoscalingTarget) TagsAllInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsAllInput",
...
func (j *jsiiProxy_AppautoscalingTarget) TagsInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsInput",
...
func (j *jsiiProxy_AppautoscalingTarget) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/appautoscaling_target aws_appautoscaling_target} Resource.
...
func (j *jsiiProxy_AppautoscalingTarget)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_AppautoscalingTarget)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_AppautoscalingTarget)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_AppautoscalingTarget)SetRegion(val *string) {
...
func (j *jsiiProxy_AppautoscalingTarget)SetTags(val *map[string]*string) {
...
func (j *jsiiProxy_AppautoscalingTarget)SetTagsAll(val *map[string]*string) {
...
func AppautoscalingTarget_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (a *jsiiProxy_AppautoscalingTarget) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AppautoscalingTarget) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (a *jsiiProxy_AppautoscalingTarget) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AppautoscalingTarget) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (a *jsiiProxy_AppautoscalingTarget) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (a *jsiiProxy_AppautoscalingTarget) ResetRegion() {
	_jsii_.InvokeVoid(
		a,
		"resetRegion",
		nil, // no parameters
...
func (a *jsiiProxy_AppautoscalingTarget) ResetTags() {
	_jsii_.InvokeVoid(
		a,
		"resetTags",
		nil, // no parameters
...
func (a *jsiiProxy_AppautoscalingTarget) ResetTagsAll() {
	_jsii_.InvokeVoid(
		a,
		"resetTagsAll",
		nil, // no parameters
...
func (a *jsiiProxy_AppautoscalingTarget) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
