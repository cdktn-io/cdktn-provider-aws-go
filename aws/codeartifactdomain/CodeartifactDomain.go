...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/codeartifactdomain/internal"
...
func (j *jsiiProxy_CodeartifactDomain) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_CodeartifactDomain) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_CodeartifactDomain) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_CodeartifactDomain) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_CodeartifactDomain) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_CodeartifactDomain) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_CodeartifactDomain) S3BucketArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"s3BucketArn",
...
func (j *jsiiProxy_CodeartifactDomain) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_CodeartifactDomain)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_CodeartifactDomain)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_CodeartifactDomain)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_CodeartifactDomain)SetRegion(val *string) {
...
func CodeartifactDomain_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (c *jsiiProxy_CodeartifactDomain) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CodeartifactDomain) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (c *jsiiProxy_CodeartifactDomain) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CodeartifactDomain) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_CodeartifactDomain) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (c *jsiiProxy_CodeartifactDomain) ResetRegion() {
	_jsii_.InvokeVoid(
		c,
		"resetRegion",
		nil, // no parameters
...
func (c *jsiiProxy_CodeartifactDomain) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
