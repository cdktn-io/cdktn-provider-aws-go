...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/dataawsservicediscoveryhttpnamespace/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/data-sources/service_discovery_http_namespace aws_service_discovery_http_namespace}.
...
func (j *jsiiProxy_DataAwsServiceDiscoveryHttpNamespace) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsServiceDiscoveryHttpNamespace) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsServiceDiscoveryHttpNamespace) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsServiceDiscoveryHttpNamespace) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsServiceDiscoveryHttpNamespace) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/data-sources/service_discovery_http_namespace aws_service_discovery_http_namespace} Data Source.
func NewDataAwsServiceDiscoveryHttpNamespace(scope constructs.Construct, id *string, config *DataAwsServiceDiscoveryHttpNamespaceConfig) DataAwsServiceDiscoveryHttpNamespace {
	...
	_jsii_.Create(
		"@cdktn/provider-aws.dataAwsServiceDiscoveryHttpNamespace.DataAwsServiceDiscoveryHttpNamespace",
...
func (j *jsiiProxy_DataAwsServiceDiscoveryHttpNamespace)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsServiceDiscoveryHttpNamespace)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsServiceDiscoveryHttpNamespace)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsServiceDiscoveryHttpNamespace_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsServiceDiscoveryHttpNamespace) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsServiceDiscoveryHttpNamespace) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsServiceDiscoveryHttpNamespace) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
