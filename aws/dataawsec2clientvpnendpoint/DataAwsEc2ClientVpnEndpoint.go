...
type DataAwsEc2ClientVpnEndpoint interface {
	...
	TransitGatewayConfiguration() DataAwsEc2ClientVpnEndpointTransitGatewayConfigurationList
...
func (j *jsiiProxy_DataAwsEc2ClientVpnEndpoint) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsEc2ClientVpnEndpoint) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsEc2ClientVpnEndpoint) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsEc2ClientVpnEndpoint) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsEc2ClientVpnEndpoint) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DataAwsEc2ClientVpnEndpoint) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_DataAwsEc2ClientVpnEndpoint) SplitTunnel() cdktn.IResolvable {
...
func (j *jsiiProxy_DataAwsEc2ClientVpnEndpoint) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DataAwsEc2ClientVpnEndpoint) TransitGatewayConfiguration() DataAwsEc2ClientVpnEndpointTransitGatewayConfigurationList {
	var returns DataAwsEc2ClientVpnEndpointTransitGatewayConfigurationList
	_jsii_.Get(
		j,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/data-sources/ec2_client_vpn_endpoint aws_ec2_client_vpn_endpoint} Data Source.
...
func (j *jsiiProxy_DataAwsEc2ClientVpnEndpoint)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsEc2ClientVpnEndpoint)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsEc2ClientVpnEndpoint)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_DataAwsEc2ClientVpnEndpoint)SetRegion(val *string) {
...
func DataAwsEc2ClientVpnEndpoint_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsEc2ClientVpnEndpoint) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsEc2ClientVpnEndpoint) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsEc2ClientVpnEndpoint) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsEc2ClientVpnEndpoint) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
