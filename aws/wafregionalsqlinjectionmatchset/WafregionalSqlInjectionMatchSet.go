...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/wafregional_sql_injection_match_set aws_wafregional_sql_injection_match_set}.
...
func (j *jsiiProxy_WafregionalSqlInjectionMatchSet) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_WafregionalSqlInjectionMatchSet) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_WafregionalSqlInjectionMatchSet) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_WafregionalSqlInjectionMatchSet) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_WafregionalSqlInjectionMatchSet) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_WafregionalSqlInjectionMatchSet) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_WafregionalSqlInjectionMatchSet) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/wafregional_sql_injection_match_set aws_wafregional_sql_injection_match_set} Resource.
func NewWafregionalSqlInjectionMatchSet(scope constructs.Construct, id *string, config *WafregionalSqlInjectionMatchSetConfig) WafregionalSqlInjectionMatchSet {
	...
	_jsii_.Create(
		"@cdktn/provider-aws.wafregionalSqlInjectionMatchSet.WafregionalSqlInjectionMatchSet",
...
func (j *jsiiProxy_WafregionalSqlInjectionMatchSet)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_WafregionalSqlInjectionMatchSet)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_WafregionalSqlInjectionMatchSet)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_WafregionalSqlInjectionMatchSet)SetRegion(val *string) {
...
func WafregionalSqlInjectionMatchSet_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (w *jsiiProxy_WafregionalSqlInjectionMatchSet) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_WafregionalSqlInjectionMatchSet) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (w *jsiiProxy_WafregionalSqlInjectionMatchSet) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_WafregionalSqlInjectionMatchSet) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (w *jsiiProxy_WafregionalSqlInjectionMatchSet) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (w *jsiiProxy_WafregionalSqlInjectionMatchSet) ResetRegion() {
	_jsii_.InvokeVoid(
		w,
		"resetRegion",
		nil, // no parameters
...
func (w *jsiiProxy_WafregionalSqlInjectionMatchSet) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
