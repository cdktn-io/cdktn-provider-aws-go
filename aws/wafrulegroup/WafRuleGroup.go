...
func (j *jsiiProxy_WafRuleGroup) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_WafRuleGroup) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_WafRuleGroup) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_WafRuleGroup) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_WafRuleGroup) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/waf_rule_group aws_waf_rule_group} Resource.
...
func (j *jsiiProxy_WafRuleGroup)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_WafRuleGroup)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_WafRuleGroup)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func WafRuleGroup_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (w *jsiiProxy_WafRuleGroup) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_WafRuleGroup) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (w *jsiiProxy_WafRuleGroup) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_WafRuleGroup) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (w *jsiiProxy_WafRuleGroup) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (w *jsiiProxy_WafRuleGroup) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
