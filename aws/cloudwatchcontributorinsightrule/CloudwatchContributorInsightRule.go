...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/cloudwatchcontributorinsightrule/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/cloudwatch_contributor_insight_rule aws_cloudwatch_contributor_insight_rule}.
...
func (j *jsiiProxy_CloudwatchContributorInsightRule) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_CloudwatchContributorInsightRule) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_CloudwatchContributorInsightRule) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_CloudwatchContributorInsightRule) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_CloudwatchContributorInsightRule) TagsAll() cdktn.StringMap {
...
func (j *jsiiProxy_CloudwatchContributorInsightRule) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/cloudwatch_contributor_insight_rule aws_cloudwatch_contributor_insight_rule} Resource.
func NewCloudwatchContributorInsightRule(scope constructs.Construct, id *string, config *CloudwatchContributorInsightRuleConfig) CloudwatchContributorInsightRule {
	...
	_jsii_.Create(
		"@cdktn/provider-aws.cloudwatchContributorInsightRule.CloudwatchContributorInsightRule",
...
func (j *jsiiProxy_CloudwatchContributorInsightRule)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_CloudwatchContributorInsightRule)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_CloudwatchContributorInsightRule)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
// Generates CDKTN code for importing a CloudwatchContributorInsightRule resource upon running "cdktn plan <stack-name>".
func CloudwatchContributorInsightRule_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (c *jsiiProxy_CloudwatchContributorInsightRule) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CloudwatchContributorInsightRule) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (c *jsiiProxy_CloudwatchContributorInsightRule) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CloudwatchContributorInsightRule) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_CloudwatchContributorInsightRule) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (c *jsiiProxy_CloudwatchContributorInsightRule) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
