...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*CloudwatchContributorInsightRule)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-aws.cloudwatchContributorInsightRule.CloudwatchContributorInsightRuleConfig",
		reflect.TypeOf((*CloudwatchContributorInsightRuleConfig)(nil)).Elem(),
	)
}
