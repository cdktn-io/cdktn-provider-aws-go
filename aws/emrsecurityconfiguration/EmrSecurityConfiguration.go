...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/emrsecurityconfiguration/internal"
...
func (j *jsiiProxy_EmrSecurityConfiguration) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_EmrSecurityConfiguration) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_EmrSecurityConfiguration) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_EmrSecurityConfiguration) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_EmrSecurityConfiguration) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_EmrSecurityConfiguration)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_EmrSecurityConfiguration)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_EmrSecurityConfiguration)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func EmrSecurityConfiguration_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (e *jsiiProxy_EmrSecurityConfiguration) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (e *jsiiProxy_EmrSecurityConfiguration) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (e *jsiiProxy_EmrSecurityConfiguration) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (e *jsiiProxy_EmrSecurityConfiguration) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (e *jsiiProxy_EmrSecurityConfiguration) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (e *jsiiProxy_EmrSecurityConfiguration) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
