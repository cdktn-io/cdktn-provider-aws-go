...
func (m *jsiiProxy_Macie2ClassificationJobScheduleFrequencyOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (m *jsiiProxy_Macie2ClassificationJobScheduleFrequencyOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
