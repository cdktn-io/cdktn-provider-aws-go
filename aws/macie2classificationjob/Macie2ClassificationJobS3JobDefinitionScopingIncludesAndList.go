...
func (j *jsiiProxy_Macie2ClassificationJobS3JobDefinitionScopingIncludesAndList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewMacie2ClassificationJobS3JobDefinitionScopingIncludesAndList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) Macie2ClassificationJobS3JobDefinitionScopingIncludesAndList {
	_init_.Initialize()
...
func NewMacie2ClassificationJobS3JobDefinitionScopingIncludesAndList_Override(m Macie2ClassificationJobS3JobDefinitionScopingIncludesAndList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_Macie2ClassificationJobS3JobDefinitionScopingIncludesAndList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (m *jsiiProxy_Macie2ClassificationJobS3JobDefinitionScopingIncludesAndList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (m *jsiiProxy_Macie2ClassificationJobS3JobDefinitionScopingIncludesAndList) Resolve(context cdktn.IResolveContext) interface{} {
