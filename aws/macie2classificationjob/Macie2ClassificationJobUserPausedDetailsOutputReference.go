...
func (m *jsiiProxy_Macie2ClassificationJobUserPausedDetailsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (m *jsiiProxy_Macie2ClassificationJobUserPausedDetailsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
