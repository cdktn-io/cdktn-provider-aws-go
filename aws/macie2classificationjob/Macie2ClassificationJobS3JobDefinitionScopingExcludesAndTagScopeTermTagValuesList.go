...
func (j *jsiiProxy_Macie2ClassificationJobS3JobDefinitionScopingExcludesAndTagScopeTermTagValuesList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewMacie2ClassificationJobS3JobDefinitionScopingExcludesAndTagScopeTermTagValuesList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) Macie2ClassificationJobS3JobDefinitionScopingExcludesAndTagScopeTermTagValuesList {
	_init_.Initialize()

	if err := validateNewMacie2ClassificationJobS3JobDefinitionScopingExcludesAndTagScopeTermTagValuesListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewMacie2ClassificationJobS3JobDefinitionScopingExcludesAndTagScopeTermTagValuesList_Override(m Macie2ClassificationJobS3JobDefinitionScopingExcludesAndTagScopeTermTagValuesList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_Macie2ClassificationJobS3JobDefinitionScopingExcludesAndTagScopeTermTagValuesList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (m *jsiiProxy_Macie2ClassificationJobS3JobDefinitionScopingExcludesAndTagScopeTermTagValuesList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (m *jsiiProxy_Macie2ClassificationJobS3JobDefinitionScopingExcludesAndTagScopeTermTagValuesList) Resolve(context cdktn.IResolveContext) interface{} {
