...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-aws.macie2ClassificationJob.Macie2ClassificationJobTimeouts",
		reflect.TypeOf((*Macie2ClassificationJobTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-aws.macie2ClassificationJob.Macie2ClassificationJobTimeoutsOutputReference",
		reflect.TypeOf((*Macie2ClassificationJobTimeoutsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
