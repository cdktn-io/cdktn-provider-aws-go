...
func (m *jsiiProxy_Macie2ClassificationJobS3JobDefinitionBucketDefinitionsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (m *jsiiProxy_Macie2ClassificationJobS3JobDefinitionBucketDefinitionsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
