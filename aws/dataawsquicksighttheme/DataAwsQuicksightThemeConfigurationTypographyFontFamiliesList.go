...
func (d *jsiiProxy_DataAwsQuicksightThemeConfigurationTypographyFontFamiliesList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsQuicksightThemeConfigurationTypographyFontFamiliesList) Resolve(context cdktf.IResolveContext) interface{} {
