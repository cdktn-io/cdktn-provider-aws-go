...
func (j *jsiiProxy_DataAwsQuicksightThemeConfigurationTypographyFontFamiliesList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsQuicksightThemeConfigurationTypographyFontFamiliesList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsQuicksightThemeConfigurationTypographyFontFamiliesList {
	_init_.Initialize()
...
func NewDataAwsQuicksightThemeConfigurationTypographyFontFamiliesList_Override(d DataAwsQuicksightThemeConfigurationTypographyFontFamiliesList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsQuicksightThemeConfigurationTypographyFontFamiliesList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsQuicksightThemeConfigurationTypographyFontFamiliesList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsQuicksightThemeConfigurationTypographyFontFamiliesList) Resolve(context cdktn.IResolveContext) interface{} {
