...
func (j *jsiiProxy_DataAwsQuicksightThemeConfigurationTypographyList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsQuicksightThemeConfigurationTypographyList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsQuicksightThemeConfigurationTypographyList {
	_init_.Initialize()
...
func NewDataAwsQuicksightThemeConfigurationTypographyList_Override(d DataAwsQuicksightThemeConfigurationTypographyList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsQuicksightThemeConfigurationTypographyList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsQuicksightThemeConfigurationTypographyList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsQuicksightThemeConfigurationTypographyList) Resolve(context cdktn.IResolveContext) interface{} {
