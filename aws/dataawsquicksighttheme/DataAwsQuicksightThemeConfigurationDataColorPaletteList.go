...
func (j *jsiiProxy_DataAwsQuicksightThemeConfigurationDataColorPaletteList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsQuicksightThemeConfigurationDataColorPaletteList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsQuicksightThemeConfigurationDataColorPaletteList {
	_init_.Initialize()
...
func NewDataAwsQuicksightThemeConfigurationDataColorPaletteList_Override(d DataAwsQuicksightThemeConfigurationDataColorPaletteList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsQuicksightThemeConfigurationDataColorPaletteList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsQuicksightThemeConfigurationDataColorPaletteList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsQuicksightThemeConfigurationDataColorPaletteList) Resolve(context cdktn.IResolveContext) interface{} {
