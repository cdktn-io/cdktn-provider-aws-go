...
func (d *jsiiProxy_DataAwsQuicksightThemeConfigurationDataColorPaletteList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsQuicksightThemeConfigurationDataColorPaletteList) Resolve(context cdktf.IResolveContext) interface{} {
