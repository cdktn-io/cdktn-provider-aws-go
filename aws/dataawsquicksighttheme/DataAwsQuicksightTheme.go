...
func (j *jsiiProxy_DataAwsQuicksightTheme) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsQuicksightTheme) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsQuicksightTheme) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsQuicksightTheme) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsQuicksightTheme) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/data-sources/quicksight_theme aws_quicksight_theme} Data Source.
...
func (j *jsiiProxy_DataAwsQuicksightTheme)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsQuicksightTheme)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsQuicksightTheme)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsQuicksightTheme_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsQuicksightTheme) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsQuicksightTheme) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsQuicksightTheme) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
