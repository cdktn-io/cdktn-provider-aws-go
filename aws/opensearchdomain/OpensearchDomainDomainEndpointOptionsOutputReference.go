...
func (o *jsiiProxy_OpensearchDomainDomainEndpointOptionsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (o *jsiiProxy_OpensearchDomainDomainEndpointOptionsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
