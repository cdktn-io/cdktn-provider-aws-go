...
func (j *jsiiProxy_OpensearchDomain) DashboardEndpointV2() *string {
	var returns *string
	_jsii_.Get(
		j,
		"dashboardEndpointV2",
...
func (j *jsiiProxy_OpensearchDomain) DomainEndpointV2HostedZoneId() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_OpensearchDomain) EndpointV2() *string {
	var returns *string
	_jsii_.Get(
		j,
		"endpointV2",
...
func (j *jsiiProxy_OpensearchDomain) IpAddressType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ipAddressType",
...
func (j *jsiiProxy_OpensearchDomain) IpAddressTypeInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ipAddressTypeInput",
...
func (j *jsiiProxy_OpensearchDomain) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_OpensearchDomain) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/opensearch_domain aws_opensearch_domain} Resource.
...
func (j *jsiiProxy_OpensearchDomain)SetIpAddressType(val *string) {
...
func (j *jsiiProxy_OpensearchDomain)SetRegion(val *string) {
...
func (o *jsiiProxy_OpensearchDomain) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (o *jsiiProxy_OpensearchDomain) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (o *jsiiProxy_OpensearchDomain) ResetIpAddressType() {
	_jsii_.InvokeVoid(
		o,
		"resetIpAddressType",
		nil, // no parameters
...
func (o *jsiiProxy_OpensearchDomain) ResetRegion() {
	_jsii_.InvokeVoid(
		o,
		"resetRegion",
		nil, // no parameters
...
func (o *jsiiProxy_OpensearchDomain) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
