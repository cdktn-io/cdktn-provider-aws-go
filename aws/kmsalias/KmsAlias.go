...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/kmsalias/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/kms_alias aws_kms_alias}.
...
func (j *jsiiProxy_KmsAlias) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_KmsAlias) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_KmsAlias) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_KmsAlias) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_KmsAlias) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/kms_alias aws_kms_alias} Resource.
...
func (j *jsiiProxy_KmsAlias)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_KmsAlias)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_KmsAlias)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func KmsAlias_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (k *jsiiProxy_KmsAlias) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (k *jsiiProxy_KmsAlias) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (k *jsiiProxy_KmsAlias) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (k *jsiiProxy_KmsAlias) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (k *jsiiProxy_KmsAlias) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (k *jsiiProxy_KmsAlias) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
