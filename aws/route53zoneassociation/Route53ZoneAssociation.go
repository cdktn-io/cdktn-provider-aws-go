...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/route53_zone_association aws_route53_zone_association}.
type Route53ZoneAssociation interface {
	...
	Timeouts() Route53ZoneAssociationTimeoutsOutputReference
	...
	PutTimeouts(value *Route53ZoneAssociationTimeouts)
...
func (j *jsiiProxy_Route53ZoneAssociation) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_Route53ZoneAssociation) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_Route53ZoneAssociation) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_Route53ZoneAssociation) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_Route53ZoneAssociation) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_Route53ZoneAssociation) Timeouts() Route53ZoneAssociationTimeoutsOutputReference {
	var returns Route53ZoneAssociationTimeoutsOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
func (j *jsiiProxy_Route53ZoneAssociation) TimeoutsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"timeoutsInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/route53_zone_association aws_route53_zone_association} Resource.
...
func (j *jsiiProxy_Route53ZoneAssociation)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_Route53ZoneAssociation)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_Route53ZoneAssociation)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func Route53ZoneAssociation_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (r *jsiiProxy_Route53ZoneAssociation) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (r *jsiiProxy_Route53ZoneAssociation) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (r *jsiiProxy_Route53ZoneAssociation) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (r *jsiiProxy_Route53ZoneAssociation) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (r *jsiiProxy_Route53ZoneAssociation) PutTimeouts(value *Route53ZoneAssociationTimeouts) {
...
func (r *jsiiProxy_Route53ZoneAssociation) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (r *jsiiProxy_Route53ZoneAssociation) ResetTimeouts() {
	_jsii_.InvokeVoid(
		r,
		"resetTimeouts",
		nil, // no parameters
