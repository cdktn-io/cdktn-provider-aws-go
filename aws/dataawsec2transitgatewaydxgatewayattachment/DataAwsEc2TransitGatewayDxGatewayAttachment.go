...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/data-sources/ec2_transit_gateway_dx_gateway_attachment aws_ec2_transit_gateway_dx_gateway_attachment}.
...
func (j *jsiiProxy_DataAwsEc2TransitGatewayDxGatewayAttachment) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DataAwsEc2TransitGatewayDxGatewayAttachment) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/data-sources/ec2_transit_gateway_dx_gateway_attachment aws_ec2_transit_gateway_dx_gateway_attachment} Data Source.
...
func (j *jsiiProxy_DataAwsEc2TransitGatewayDxGatewayAttachment)SetRegion(val *string) {
...
func (d *jsiiProxy_DataAwsEc2TransitGatewayDxGatewayAttachment) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsEc2TransitGatewayDxGatewayAttachment) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsEc2TransitGatewayDxGatewayAttachment) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
