...
func (s *jsiiProxy_S3BucketServerSideEncryptionConfigurationA) validatePutRuleParameters(value interface{}) error {
	...
	case *[]*S3BucketServerSideEncryptionConfigurationRuleA:
		value := value.(*[]*S3BucketServerSideEncryptionConfigurationRuleA)
	...
	case []*S3BucketServerSideEncryptionConfigurationRuleA:
		value_ := value.([]*S3BucketServerSideEncryptionConfigurationRuleA)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*S3BucketServerSideEncryptionConfigurationRuleA; received %#v (a %T)", value, value)
		}
	}
