...
func NewOpensearchserverlessSecurityConfigIamFederationOptionsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) OpensearchserverlessSecurityConfigIamFederationOptionsOutputReference {
	_init_.Initialize()

	if err := validateNewOpensearchserverlessSecurityConfigIamFederationOptionsOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
	j := jsiiProxy_OpensearchserverlessSecurityConfigIamFederationOptionsOutputReference{}

	_jsii_.Create(
		"@cdktn/provider-aws.opensearchserverlessSecurityConfig.OpensearchserverlessSecurityConfigIamFederationOptionsOutputReference",
...
func NewOpensearchserverlessSecurityConfigIamFederationOptionsOutputReference_Override(o OpensearchserverlessSecurityConfigIamFederationOptionsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
