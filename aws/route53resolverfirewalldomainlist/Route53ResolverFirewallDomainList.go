...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/route53resolverfirewalldomainlist/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/route53_resolver_firewall_domain_list aws_route53_resolver_firewall_domain_list}.
...
func (j *jsiiProxy_Route53ResolverFirewallDomainList) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_Route53ResolverFirewallDomainList) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_Route53ResolverFirewallDomainList) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_Route53ResolverFirewallDomainList) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_Route53ResolverFirewallDomainList) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_Route53ResolverFirewallDomainList) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_Route53ResolverFirewallDomainList) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/route53_resolver_firewall_domain_list aws_route53_resolver_firewall_domain_list} Resource.
...
func (j *jsiiProxy_Route53ResolverFirewallDomainList)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_Route53ResolverFirewallDomainList)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_Route53ResolverFirewallDomainList)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_Route53ResolverFirewallDomainList)SetRegion(val *string) {
...
func Route53ResolverFirewallDomainList_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateRoute53ResolverFirewallDomainList_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
// Experimental.
func Route53ResolverFirewallDomainList_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateRoute53ResolverFirewallDomainList_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func Route53ResolverFirewallDomainList_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateRoute53ResolverFirewallDomainList_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (r *jsiiProxy_Route53ResolverFirewallDomainList) AddMoveTarget(moveTarget *string) {
...
func (r *jsiiProxy_Route53ResolverFirewallDomainList) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (r *jsiiProxy_Route53ResolverFirewallDomainList) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (r *jsiiProxy_Route53ResolverFirewallDomainList) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (r *jsiiProxy_Route53ResolverFirewallDomainList) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (r *jsiiProxy_Route53ResolverFirewallDomainList) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (r *jsiiProxy_Route53ResolverFirewallDomainList) ResetRegion() {
	_jsii_.InvokeVoid(
		r,
		"resetRegion",
		nil, // no parameters
...
func (r *jsiiProxy_Route53ResolverFirewallDomainList) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (r *jsiiProxy_Route53ResolverFirewallDomainList) ToHclTerraform() interface{} {
	var returns interface{}
...
func (r *jsiiProxy_Route53ResolverFirewallDomainList) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
