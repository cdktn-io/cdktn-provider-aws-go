...
func (j *jsiiProxy_DataAwsNetworkmanagerCoreNetworkPolicyDocument) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsNetworkmanagerCoreNetworkPolicyDocument) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsNetworkmanagerCoreNetworkPolicyDocument) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsNetworkmanagerCoreNetworkPolicyDocument) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsNetworkmanagerCoreNetworkPolicyDocument) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.45.0/docs/data-sources/networkmanager_core_network_policy_document aws_networkmanager_core_network_policy_document} Data Source.
...
func (j *jsiiProxy_DataAwsNetworkmanagerCoreNetworkPolicyDocument)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsNetworkmanagerCoreNetworkPolicyDocument)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsNetworkmanagerCoreNetworkPolicyDocument)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsNetworkmanagerCoreNetworkPolicyDocument_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsNetworkmanagerCoreNetworkPolicyDocument) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsNetworkmanagerCoreNetworkPolicyDocument) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsNetworkmanagerCoreNetworkPolicyDocument) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
