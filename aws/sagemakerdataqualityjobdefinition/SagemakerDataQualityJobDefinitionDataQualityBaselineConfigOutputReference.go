...
func (j *jsiiProxy_SagemakerDataQualityJobDefinitionDataQualityBaselineConfigOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewSagemakerDataQualityJobDefinitionDataQualityBaselineConfigOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) SagemakerDataQualityJobDefinitionDataQualityBaselineConfigOutputReference {
	_init_.Initialize()
...
func NewSagemakerDataQualityJobDefinitionDataQualityBaselineConfigOutputReference_Override(s SagemakerDataQualityJobDefinitionDataQualityBaselineConfigOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_SagemakerDataQualityJobDefinitionDataQualityBaselineConfigOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_SagemakerDataQualityJobDefinitionDataQualityBaselineConfigOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SagemakerDataQualityJobDefinitionDataQualityBaselineConfigOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (s *jsiiProxy_SagemakerDataQualityJobDefinitionDataQualityBaselineConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SagemakerDataQualityJobDefinitionDataQualityBaselineConfigOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
