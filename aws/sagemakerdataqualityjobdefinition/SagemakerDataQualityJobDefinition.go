...
func (j *jsiiProxy_SagemakerDataQualityJobDefinition) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_SagemakerDataQualityJobDefinition) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_SagemakerDataQualityJobDefinition) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_SagemakerDataQualityJobDefinition) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_SagemakerDataQualityJobDefinition) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_SagemakerDataQualityJobDefinition) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_SagemakerDataQualityJobDefinition) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/sagemaker_data_quality_job_definition aws_sagemaker_data_quality_job_definition} Resource.
...
func (j *jsiiProxy_SagemakerDataQualityJobDefinition)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_SagemakerDataQualityJobDefinition)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_SagemakerDataQualityJobDefinition)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_SagemakerDataQualityJobDefinition)SetRegion(val *string) {
...
func SagemakerDataQualityJobDefinition_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (s *jsiiProxy_SagemakerDataQualityJobDefinition) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SagemakerDataQualityJobDefinition) HasResourceMove() interface{} {
	var returns interface{}
...
func (s *jsiiProxy_SagemakerDataQualityJobDefinition) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_SagemakerDataQualityJobDefinition) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SagemakerDataQualityJobDefinition) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_SagemakerDataQualityJobDefinition) MoveFromId(id *string) {
...
func (s *jsiiProxy_SagemakerDataQualityJobDefinition) MoveToId(id *string) {
...
func (s *jsiiProxy_SagemakerDataQualityJobDefinition) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_SagemakerDataQualityJobDefinition) ResetRegion() {
	_jsii_.InvokeVoid(
		s,
		"resetRegion",
		nil, // no parameters
...
func (s *jsiiProxy_SagemakerDataQualityJobDefinition) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (s *jsiiProxy_SagemakerDataQualityJobDefinition) ToHclTerraform() interface{} {
	var returns interface{}
...
func (s *jsiiProxy_SagemakerDataQualityJobDefinition) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
