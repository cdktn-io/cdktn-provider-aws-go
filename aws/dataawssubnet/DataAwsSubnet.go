...
func (d *jsiiProxy_DataAwsSubnet) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsSubnet) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
