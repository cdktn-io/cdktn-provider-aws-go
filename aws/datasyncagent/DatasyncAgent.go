...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/datasyncagent/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/datasync_agent aws_datasync_agent}.
...
func (j *jsiiProxy_DatasyncAgent) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DatasyncAgent) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DatasyncAgent) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DatasyncAgent) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DatasyncAgent) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/datasync_agent aws_datasync_agent} Resource.
...
func (j *jsiiProxy_DatasyncAgent)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DatasyncAgent)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DatasyncAgent)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DatasyncAgent_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DatasyncAgent) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DatasyncAgent) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (d *jsiiProxy_DatasyncAgent) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DatasyncAgent) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (d *jsiiProxy_DatasyncAgent) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DatasyncAgent) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
