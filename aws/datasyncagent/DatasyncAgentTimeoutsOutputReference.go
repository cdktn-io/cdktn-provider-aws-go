...
func (d *jsiiProxy_DatasyncAgentTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DatasyncAgentTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
