...
func (j *jsiiProxy_DataAwsSsmincidentsResponsePlanIntegrationList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsSsmincidentsResponsePlanIntegrationList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsSsmincidentsResponsePlanIntegrationList {
	_init_.Initialize()
...
func NewDataAwsSsmincidentsResponsePlanIntegrationList_Override(d DataAwsSsmincidentsResponsePlanIntegrationList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsSsmincidentsResponsePlanIntegrationList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsSsmincidentsResponsePlanIntegrationList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsSsmincidentsResponsePlanIntegrationList) Resolve(context cdktn.IResolveContext) interface{} {
