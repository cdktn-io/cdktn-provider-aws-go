...
func (j *jsiiProxy_DataAwsSsmincidentsResponsePlanIntegrationPagerdutyList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsSsmincidentsResponsePlanIntegrationPagerdutyList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsSsmincidentsResponsePlanIntegrationPagerdutyList {
	_init_.Initialize()
...
func NewDataAwsSsmincidentsResponsePlanIntegrationPagerdutyList_Override(d DataAwsSsmincidentsResponsePlanIntegrationPagerdutyList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsSsmincidentsResponsePlanIntegrationPagerdutyList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsSsmincidentsResponsePlanIntegrationPagerdutyList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsSsmincidentsResponsePlanIntegrationPagerdutyList) Resolve(context cdktn.IResolveContext) interface{} {
