...
func (f *jsiiProxy_FinspaceKxClusterDatabaseCacheConfigurationsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (f *jsiiProxy_FinspaceKxClusterDatabaseCacheConfigurationsList) Resolve(context cdktf.IResolveContext) interface{} {
