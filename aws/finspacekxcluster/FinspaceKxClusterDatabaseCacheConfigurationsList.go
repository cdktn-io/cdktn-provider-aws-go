...
func (j *jsiiProxy_FinspaceKxClusterDatabaseCacheConfigurationsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewFinspaceKxClusterDatabaseCacheConfigurationsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) FinspaceKxClusterDatabaseCacheConfigurationsList {
	_init_.Initialize()
...
func NewFinspaceKxClusterDatabaseCacheConfigurationsList_Override(f FinspaceKxClusterDatabaseCacheConfigurationsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_FinspaceKxClusterDatabaseCacheConfigurationsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (f *jsiiProxy_FinspaceKxClusterDatabaseCacheConfigurationsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (f *jsiiProxy_FinspaceKxClusterDatabaseCacheConfigurationsList) Resolve(context cdktn.IResolveContext) interface{} {
