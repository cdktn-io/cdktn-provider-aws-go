...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/finspace_kx_cluster aws_finspace_kx_cluster}.
...
func (j *jsiiProxy_FinspaceKxCluster) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_FinspaceKxCluster) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_FinspaceKxCluster) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_FinspaceKxCluster) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_FinspaceKxCluster) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_FinspaceKxCluster) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_FinspaceKxCluster) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/finspace_kx_cluster aws_finspace_kx_cluster} Resource.
...
func (j *jsiiProxy_FinspaceKxCluster)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_FinspaceKxCluster)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_FinspaceKxCluster)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_FinspaceKxCluster)SetRegion(val *string) {
...
func FinspaceKxCluster_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateFinspaceKxCluster_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (f *jsiiProxy_FinspaceKxCluster) AddMoveTarget(moveTarget *string) {
...
func (f *jsiiProxy_FinspaceKxCluster) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (f *jsiiProxy_FinspaceKxCluster) HasResourceMove() interface{} {
	var returns interface{}
...
func (f *jsiiProxy_FinspaceKxCluster) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (f *jsiiProxy_FinspaceKxCluster) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (f *jsiiProxy_FinspaceKxCluster) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (f *jsiiProxy_FinspaceKxCluster) MoveFromId(id *string) {
...
func (f *jsiiProxy_FinspaceKxCluster) MoveTo(moveTarget *string, index interface{}) {
...
func (f *jsiiProxy_FinspaceKxCluster) MoveToId(id *string) {
...
func (f *jsiiProxy_FinspaceKxCluster) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (f *jsiiProxy_FinspaceKxCluster) ResetRegion() {
	_jsii_.InvokeVoid(
		f,
		"resetRegion",
		nil, // no parameters
...
func (f *jsiiProxy_FinspaceKxCluster) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (f *jsiiProxy_FinspaceKxCluster) ToHclTerraform() interface{} {
	var returns interface{}
