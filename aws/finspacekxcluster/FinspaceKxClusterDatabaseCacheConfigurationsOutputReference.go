...
func (j *jsiiProxy_FinspaceKxClusterDatabaseCacheConfigurationsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewFinspaceKxClusterDatabaseCacheConfigurationsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) FinspaceKxClusterDatabaseCacheConfigurationsOutputReference {
	_init_.Initialize()
...
func NewFinspaceKxClusterDatabaseCacheConfigurationsOutputReference_Override(f FinspaceKxClusterDatabaseCacheConfigurationsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_FinspaceKxClusterDatabaseCacheConfigurationsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (f *jsiiProxy_FinspaceKxClusterDatabaseCacheConfigurationsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (f *jsiiProxy_FinspaceKxClusterDatabaseCacheConfigurationsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (f *jsiiProxy_FinspaceKxClusterDatabaseCacheConfigurationsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (f *jsiiProxy_FinspaceKxClusterDatabaseCacheConfigurationsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
