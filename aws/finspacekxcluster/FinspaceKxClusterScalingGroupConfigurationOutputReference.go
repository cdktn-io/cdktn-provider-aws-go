...
func (f *jsiiProxy_FinspaceKxClusterScalingGroupConfigurationOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (f *jsiiProxy_FinspaceKxClusterScalingGroupConfigurationOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
