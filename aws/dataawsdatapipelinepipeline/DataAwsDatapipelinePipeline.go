...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/dataawsdatapipelinepipeline/internal"
...
func (j *jsiiProxy_DataAwsDatapipelinePipeline) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsDatapipelinePipeline) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsDatapipelinePipeline) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsDatapipelinePipeline) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsDatapipelinePipeline) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/data-sources/datapipeline_pipeline aws_datapipeline_pipeline} Data Source.
...
func (j *jsiiProxy_DataAwsDatapipelinePipeline)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsDatapipelinePipeline)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsDatapipelinePipeline)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsDatapipelinePipeline_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsDatapipelinePipeline) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsDatapipelinePipeline) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsDatapipelinePipeline) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsDatapipelinePipeline) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
