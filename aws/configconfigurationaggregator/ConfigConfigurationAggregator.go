...
func (j *jsiiProxy_ConfigConfigurationAggregator) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_ConfigConfigurationAggregator) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_ConfigConfigurationAggregator) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_ConfigConfigurationAggregator) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_ConfigConfigurationAggregator) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_ConfigConfigurationAggregator)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_ConfigConfigurationAggregator)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_ConfigConfigurationAggregator)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func ConfigConfigurationAggregator_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (c *jsiiProxy_ConfigConfigurationAggregator) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_ConfigConfigurationAggregator) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (c *jsiiProxy_ConfigConfigurationAggregator) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_ConfigConfigurationAggregator) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_ConfigConfigurationAggregator) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (c *jsiiProxy_ConfigConfigurationAggregator) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
