...
func (d *jsiiProxy_DataAwsCodecatalystDevEnvironmentPersistentStorageList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsCodecatalystDevEnvironmentPersistentStorageList) Resolve(context cdktf.IResolveContext) interface{} {
