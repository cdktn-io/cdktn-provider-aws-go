...
func (j *jsiiProxy_DataAwsCodecatalystDevEnvironmentPersistentStorageList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsCodecatalystDevEnvironmentPersistentStorageList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsCodecatalystDevEnvironmentPersistentStorageList {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-aws.dataAwsCodecatalystDevEnvironment.DataAwsCodecatalystDevEnvironmentPersistentStorageList",
...
func NewDataAwsCodecatalystDevEnvironmentPersistentStorageList_Override(d DataAwsCodecatalystDevEnvironmentPersistentStorageList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsCodecatalystDevEnvironmentPersistentStorageList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsCodecatalystDevEnvironmentPersistentStorageList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsCodecatalystDevEnvironmentPersistentStorageList) Resolve(context cdktn.IResolveContext) interface{} {
