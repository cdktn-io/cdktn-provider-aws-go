...
func (j *jsiiProxy_AcmCertificateValidationOptionList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewAcmCertificateValidationOptionList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) AcmCertificateValidationOptionList {
	_init_.Initialize()
...
func NewAcmCertificateValidationOptionList_Override(a AcmCertificateValidationOptionList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_AcmCertificateValidationOptionList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (a *jsiiProxy_AcmCertificateValidationOptionList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (a *jsiiProxy_AcmCertificateValidationOptionList) Resolve(context cdktn.IResolveContext) interface{} {
