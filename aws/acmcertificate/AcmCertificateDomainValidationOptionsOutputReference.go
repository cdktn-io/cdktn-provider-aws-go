...
func (a *jsiiProxy_AcmCertificateDomainValidationOptionsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_AcmCertificateDomainValidationOptionsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
