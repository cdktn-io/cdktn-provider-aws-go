...
func (j *jsiiProxy_AcmCertificateDomainValidationOptionsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewAcmCertificateDomainValidationOptionsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) AcmCertificateDomainValidationOptionsList {
	_init_.Initialize()
...
func NewAcmCertificateDomainValidationOptionsList_Override(a AcmCertificateDomainValidationOptionsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_AcmCertificateDomainValidationOptionsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (a *jsiiProxy_AcmCertificateDomainValidationOptionsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (a *jsiiProxy_AcmCertificateDomainValidationOptionsList) Resolve(context cdktn.IResolveContext) interface{} {
