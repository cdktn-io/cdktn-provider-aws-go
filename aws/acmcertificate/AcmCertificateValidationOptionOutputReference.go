...
func (a *jsiiProxy_AcmCertificateValidationOptionOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_AcmCertificateValidationOptionOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
