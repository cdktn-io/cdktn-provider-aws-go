...
func (j *jsiiProxy_AcmCertificateValidationOptionOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewAcmCertificateValidationOptionOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) AcmCertificateValidationOptionOutputReference {
	_init_.Initialize()

	if err := validateNewAcmCertificateValidationOptionOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func NewAcmCertificateValidationOptionOutputReference_Override(a AcmCertificateValidationOptionOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_AcmCertificateValidationOptionOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (j *jsiiProxy_AcmCertificateValidationOptionOutputReference)SetValidationDomain(val *string) {
	if err := j.validateSetValidationDomainParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (a *jsiiProxy_AcmCertificateValidationOptionOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AcmCertificateValidationOptionOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (a *jsiiProxy_AcmCertificateValidationOptionOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AcmCertificateValidationOptionOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
