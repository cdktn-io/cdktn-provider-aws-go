...
func (j *jsiiProxy_AcmCertificateRenewalSummaryList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewAcmCertificateRenewalSummaryList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) AcmCertificateRenewalSummaryList {
	_init_.Initialize()
...
func NewAcmCertificateRenewalSummaryList_Override(a AcmCertificateRenewalSummaryList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_AcmCertificateRenewalSummaryList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (a *jsiiProxy_AcmCertificateRenewalSummaryList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (a *jsiiProxy_AcmCertificateRenewalSummaryList) Resolve(context cdktn.IResolveContext) interface{} {
