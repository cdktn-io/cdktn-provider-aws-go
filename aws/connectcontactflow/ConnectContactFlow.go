...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/connectcontactflow/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/connect_contact_flow aws_connect_contact_flow}.
...
func (j *jsiiProxy_ConnectContactFlow) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_ConnectContactFlow) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_ConnectContactFlow) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_ConnectContactFlow) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_ConnectContactFlow) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_ConnectContactFlow) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_ConnectContactFlow) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/connect_contact_flow aws_connect_contact_flow} Resource.
func NewConnectContactFlow(scope constructs.Construct, id *string, config *ConnectContactFlowConfig) ConnectContactFlow {
	...
	_jsii_.Create(
		"@cdktn/provider-aws.connectContactFlow.ConnectContactFlow",
...
func (j *jsiiProxy_ConnectContactFlow)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_ConnectContactFlow)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_ConnectContactFlow)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_ConnectContactFlow)SetRegion(val *string) {
...
func ConnectContactFlow_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (c *jsiiProxy_ConnectContactFlow) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_ConnectContactFlow) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (c *jsiiProxy_ConnectContactFlow) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_ConnectContactFlow) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_ConnectContactFlow) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (c *jsiiProxy_ConnectContactFlow) ResetRegion() {
	_jsii_.InvokeVoid(
		c,
		"resetRegion",
		nil, // no parameters
...
func (c *jsiiProxy_ConnectContactFlow) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
