...
func (j *jsiiProxy_ArcregionswitchPlanWorkflowList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewArcregionswitchPlanWorkflowList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ArcregionswitchPlanWorkflowList {
	_init_.Initialize()
...
func NewArcregionswitchPlanWorkflowList_Override(a ArcregionswitchPlanWorkflowList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ArcregionswitchPlanWorkflowList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (a *jsiiProxy_ArcregionswitchPlanWorkflowList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (a *jsiiProxy_ArcregionswitchPlanWorkflowList) Resolve(context cdktf.IResolveContext) interface{} {
