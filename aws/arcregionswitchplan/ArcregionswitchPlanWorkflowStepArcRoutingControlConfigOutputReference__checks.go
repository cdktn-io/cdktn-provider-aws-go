...
func (a *jsiiProxy_ArcregionswitchPlanWorkflowStepArcRoutingControlConfigOutputReference) validatePutRegionAndRoutingControlsParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*ArcregionswitchPlanWorkflowStepArcRoutingControlConfigRegionAndRoutingControls; received %#v (a %T)", value, value)
		}
	}
...
func (a *jsiiProxy_ArcregionswitchPlanWorkflowStepArcRoutingControlConfigOutputReference) validateResolveParameters(context cdktf.IResolveContext) error {
	if context == nil {
...
func (j *jsiiProxy_ArcregionswitchPlanWorkflowStepArcRoutingControlConfigOutputReference) validateSetInternalValueParameters(val interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktf.IResolvable, *ArcregionswitchPlanWorkflowStepArcRoutingControlConfig; received %#v (a %T)", val, val)
		}
	}
...
func (j *jsiiProxy_ArcregionswitchPlanWorkflowStepArcRoutingControlConfigOutputReference) validateSetTerraformResourceParameters(val cdktf.IInterpolatingParent) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func validateNewArcregionswitchPlanWorkflowStepArcRoutingControlConfigOutputReferenceParameters(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) error {
