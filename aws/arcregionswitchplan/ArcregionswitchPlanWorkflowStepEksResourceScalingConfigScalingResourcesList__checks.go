...
func (a *jsiiProxy_ArcregionswitchPlanWorkflowStepEksResourceScalingConfigScalingResourcesList) validateResolveParameters(context cdktf.IResolveContext) error {
	if context == nil {
...
func (j *jsiiProxy_ArcregionswitchPlanWorkflowStepEksResourceScalingConfigScalingResourcesList) validateSetInternalValueParameters(val interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktf.IResolvable, *[]*ArcregionswitchPlanWorkflowStepEksResourceScalingConfigScalingResources; received %#v (a %T)", val, val)
		}
	}
...
func (j *jsiiProxy_ArcregionswitchPlanWorkflowStepEksResourceScalingConfigScalingResourcesList) validateSetTerraformResourceParameters(val cdktf.IInterpolatingParent) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func validateNewArcregionswitchPlanWorkflowStepEksResourceScalingConfigScalingResourcesListParameters(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) error {
