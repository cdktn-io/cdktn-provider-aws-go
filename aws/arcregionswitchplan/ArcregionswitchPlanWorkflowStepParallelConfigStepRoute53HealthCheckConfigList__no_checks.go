...
func (a *jsiiProxy_ArcregionswitchPlanWorkflowStepParallelConfigStepRoute53HealthCheckConfigList) validateResolveParameters(context cdktf.IResolveContext) error {
	return nil
}
...
func (j *jsiiProxy_ArcregionswitchPlanWorkflowStepParallelConfigStepRoute53HealthCheckConfigList) validateSetTerraformResourceParameters(val cdktf.IInterpolatingParent) error {
	return nil
}
...
func validateNewArcregionswitchPlanWorkflowStepParallelConfigStepRoute53HealthCheckConfigListParameters(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) error {
	return nil
}
