...
func (j *jsiiProxy_DataAwsLbListenerRuleActionJwtValidationAdditionalClaimList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsLbListenerRuleActionJwtValidationAdditionalClaimList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsLbListenerRuleActionJwtValidationAdditionalClaimList {
	_init_.Initialize()
...
func NewDataAwsLbListenerRuleActionJwtValidationAdditionalClaimList_Override(d DataAwsLbListenerRuleActionJwtValidationAdditionalClaimList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsLbListenerRuleActionJwtValidationAdditionalClaimList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsLbListenerRuleActionJwtValidationAdditionalClaimList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsLbListenerRuleActionJwtValidationAdditionalClaimList) Resolve(context cdktn.IResolveContext) interface{} {
