...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/data-sources/fsx_ontap_file_system aws_fsx_ontap_file_system}.
...
func (j *jsiiProxy_DataAwsFsxOntapFileSystem) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsFsxOntapFileSystem) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsFsxOntapFileSystem) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsFsxOntapFileSystem) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsFsxOntapFileSystem) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/data-sources/fsx_ontap_file_system aws_fsx_ontap_file_system} Data Source.
...
func (j *jsiiProxy_DataAwsFsxOntapFileSystem)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsFsxOntapFileSystem)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsFsxOntapFileSystem)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsFsxOntapFileSystem_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsFsxOntapFileSystem) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsFsxOntapFileSystem) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsFsxOntapFileSystem) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsFsxOntapFileSystem) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
