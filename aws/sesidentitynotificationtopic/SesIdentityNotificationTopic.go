...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/sesidentitynotificationtopic/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/ses_identity_notification_topic aws_ses_identity_notification_topic}.
...
func (j *jsiiProxy_SesIdentityNotificationTopic) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_SesIdentityNotificationTopic) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_SesIdentityNotificationTopic) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_SesIdentityNotificationTopic) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_SesIdentityNotificationTopic) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_SesIdentityNotificationTopic) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_SesIdentityNotificationTopic) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/ses_identity_notification_topic aws_ses_identity_notification_topic} Resource.
func NewSesIdentityNotificationTopic(scope constructs.Construct, id *string, config *SesIdentityNotificationTopicConfig) SesIdentityNotificationTopic {
	...
	_jsii_.Create(
		"@cdktn/provider-aws.sesIdentityNotificationTopic.SesIdentityNotificationTopic",
...
func (j *jsiiProxy_SesIdentityNotificationTopic)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_SesIdentityNotificationTopic)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_SesIdentityNotificationTopic)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_SesIdentityNotificationTopic)SetRegion(val *string) {
...
func SesIdentityNotificationTopic_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (s *jsiiProxy_SesIdentityNotificationTopic) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SesIdentityNotificationTopic) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_SesIdentityNotificationTopic) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SesIdentityNotificationTopic) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_SesIdentityNotificationTopic) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_SesIdentityNotificationTopic) ResetRegion() {
	_jsii_.InvokeVoid(
		s,
		"resetRegion",
		nil, // no parameters
