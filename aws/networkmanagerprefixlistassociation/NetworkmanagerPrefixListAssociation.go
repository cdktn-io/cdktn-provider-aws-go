...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/networkmanagerprefixlistassociation/internal"
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/networkmanager_prefix_list_association aws_networkmanager_prefix_list_association} Resource.
...
func (n *jsiiProxy_NetworkmanagerPrefixListAssociation) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (n *jsiiProxy_NetworkmanagerPrefixListAssociation) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
