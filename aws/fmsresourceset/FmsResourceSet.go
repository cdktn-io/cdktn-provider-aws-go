...
func (j *jsiiProxy_FmsResourceSet) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_FmsResourceSet) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_FmsResourceSet) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_FmsResourceSet) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_FmsResourceSet) TagsAll() cdktn.StringMap {
...
func (j *jsiiProxy_FmsResourceSet) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/fms_resource_set aws_fms_resource_set} Resource.
...
func (j *jsiiProxy_FmsResourceSet)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_FmsResourceSet)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_FmsResourceSet)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func FmsResourceSet_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (f *jsiiProxy_FmsResourceSet) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (f *jsiiProxy_FmsResourceSet) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (f *jsiiProxy_FmsResourceSet) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (f *jsiiProxy_FmsResourceSet) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (f *jsiiProxy_FmsResourceSet) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (f *jsiiProxy_FmsResourceSet) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
