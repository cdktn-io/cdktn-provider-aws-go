...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "putResourceSet", GoMethod: "PutResourceSet"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetResourceSet", GoMethod: "ResetResourceSet"},
			_jsii_.MemberMethod{JsiiMethod: "resetTags", GoMethod: "ResetTags"},
			_jsii_.MemberMethod{JsiiMethod: "resetTimeouts", GoMethod: "ResetTimeouts"},
			_jsii_.MemberProperty{JsiiProperty: "resourceSet", GoGetter: "ResourceSet"},
			_jsii_.MemberProperty{JsiiProperty: "resourceSetInput", GoGetter: "ResourceSetInput"},
	...
	_jsii_.RegisterClass(
		...
		func() interface{} {
			j := jsiiProxy_FmsResourceSetResourceSetList{}
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetResourceSetStatus", GoMethod: "ResetResourceSetStatus"},
			_jsii_.MemberMethod{JsiiMethod: "resetResourceTypeList", GoMethod: "ResetResourceTypeList"},
			_jsii_.MemberMethod{JsiiMethod: "resetUpdateToken", GoMethod: "ResetUpdateToken"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "resourceSetStatus", GoGetter: "ResourceSetStatus"},
			_jsii_.MemberProperty{JsiiProperty: "resourceSetStatusInput", GoGetter: "ResourceSetStatusInput"},
