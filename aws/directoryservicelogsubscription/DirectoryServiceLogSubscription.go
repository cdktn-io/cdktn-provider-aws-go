...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/directoryservicelogsubscription/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/directory_service_log_subscription aws_directory_service_log_subscription}.
...
func (j *jsiiProxy_DirectoryServiceLogSubscription) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DirectoryServiceLogSubscription) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DirectoryServiceLogSubscription) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DirectoryServiceLogSubscription) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DirectoryServiceLogSubscription) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DirectoryServiceLogSubscription) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_DirectoryServiceLogSubscription) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/directory_service_log_subscription aws_directory_service_log_subscription} Resource.
func NewDirectoryServiceLogSubscription(scope constructs.Construct, id *string, config *DirectoryServiceLogSubscriptionConfig) DirectoryServiceLogSubscription {
	...
	if err := validateNewDirectoryServiceLogSubscriptionParameters(scope, id, config); err != nil {
		panic(err)
	}
	j := jsiiProxy_DirectoryServiceLogSubscription{}

	_jsii_.Create(
		"@cdktn/provider-aws.directoryServiceLogSubscription.DirectoryServiceLogSubscription",
...
func (j *jsiiProxy_DirectoryServiceLogSubscription)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DirectoryServiceLogSubscription)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DirectoryServiceLogSubscription)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_DirectoryServiceLogSubscription)SetRegion(val *string) {
...
// Generates CDKTN code for importing a DirectoryServiceLogSubscription resource upon running "cdktn plan <stack-name>".
func DirectoryServiceLogSubscription_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateDirectoryServiceLogSubscription_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func DirectoryServiceLogSubscription_IsConstruct(x interface{}) *bool {
	...
	if err := validateDirectoryServiceLogSubscription_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DirectoryServiceLogSubscription_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDirectoryServiceLogSubscription_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DirectoryServiceLogSubscription_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDirectoryServiceLogSubscription_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (d *jsiiProxy_DirectoryServiceLogSubscription) AddMoveTarget(moveTarget *string) {
...
func (d *jsiiProxy_DirectoryServiceLogSubscription) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DirectoryServiceLogSubscription) HasResourceMove() interface{} {
	var returns interface{}
...
func (d *jsiiProxy_DirectoryServiceLogSubscription) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (d *jsiiProxy_DirectoryServiceLogSubscription) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DirectoryServiceLogSubscription) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (d *jsiiProxy_DirectoryServiceLogSubscription) MoveFromId(id *string) {
...
func (d *jsiiProxy_DirectoryServiceLogSubscription) MoveTo(moveTarget *string, index interface{}) {
...
func (d *jsiiProxy_DirectoryServiceLogSubscription) MoveToId(id *string) {
...
func (d *jsiiProxy_DirectoryServiceLogSubscription) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DirectoryServiceLogSubscription) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
...
func (d *jsiiProxy_DirectoryServiceLogSubscription) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DirectoryServiceLogSubscription) ToHclTerraform() interface{} {
	var returns interface{}
...
func (d *jsiiProxy_DirectoryServiceLogSubscription) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
