...
func (e *jsiiProxy_EcsCapacityProviderAutoScalingGroupProviderOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (e *jsiiProxy_EcsCapacityProviderAutoScalingGroupProviderOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
