...
func (j *jsiiProxy_EcsCapacityProvider) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_EcsCapacityProvider) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_EcsCapacityProvider) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_EcsCapacityProvider) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_EcsCapacityProvider) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_EcsCapacityProvider)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_EcsCapacityProvider)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_EcsCapacityProvider)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func EcsCapacityProvider_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (e *jsiiProxy_EcsCapacityProvider) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (e *jsiiProxy_EcsCapacityProvider) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (e *jsiiProxy_EcsCapacityProvider) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (e *jsiiProxy_EcsCapacityProvider) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (e *jsiiProxy_EcsCapacityProvider) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (e *jsiiProxy_EcsCapacityProvider) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
