...
func (j *jsiiProxy_EcsCapacityProviderAutoScalingGroupProviderManagedScalingOutputReference) validateSetInternalValueParameters(val *EcsCapacityProviderAutoScalingGroupProviderManagedScaling) error {
