...
func (j *jsiiProxy_DataAwsServiceDiscoveryServiceDnsConfigList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsServiceDiscoveryServiceDnsConfigList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsServiceDiscoveryServiceDnsConfigList {
	_init_.Initialize()
...
func NewDataAwsServiceDiscoveryServiceDnsConfigList_Override(d DataAwsServiceDiscoveryServiceDnsConfigList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsServiceDiscoveryServiceDnsConfigList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsServiceDiscoveryServiceDnsConfigList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsServiceDiscoveryServiceDnsConfigList) Resolve(context cdktn.IResolveContext) interface{} {
