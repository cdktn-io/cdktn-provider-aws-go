...
func (j *jsiiProxy_DataAwsServiceDiscoveryService) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsServiceDiscoveryService) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsServiceDiscoveryService) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsServiceDiscoveryService) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsServiceDiscoveryService) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/data-sources/service_discovery_service aws_service_discovery_service} Data Source.
...
func (j *jsiiProxy_DataAwsServiceDiscoveryService)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsServiceDiscoveryService)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsServiceDiscoveryService)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsServiceDiscoveryService_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsServiceDiscoveryService) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsServiceDiscoveryService) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsServiceDiscoveryService) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsServiceDiscoveryService) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
