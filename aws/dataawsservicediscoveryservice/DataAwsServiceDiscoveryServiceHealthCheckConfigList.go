...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v22/dataawsservicediscoveryservice/internal"
...
func (d *jsiiProxy_DataAwsServiceDiscoveryServiceHealthCheckConfigList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsServiceDiscoveryServiceHealthCheckConfigList) Resolve(context cdktf.IResolveContext) interface{} {
