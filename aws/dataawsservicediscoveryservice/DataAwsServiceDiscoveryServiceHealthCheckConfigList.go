...
func (j *jsiiProxy_DataAwsServiceDiscoveryServiceHealthCheckConfigList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsServiceDiscoveryServiceHealthCheckConfigList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsServiceDiscoveryServiceHealthCheckConfigList {
	_init_.Initialize()

	if err := validateNewDataAwsServiceDiscoveryServiceHealthCheckConfigListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewDataAwsServiceDiscoveryServiceHealthCheckConfigList_Override(d DataAwsServiceDiscoveryServiceHealthCheckConfigList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsServiceDiscoveryServiceHealthCheckConfigList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsServiceDiscoveryServiceHealthCheckConfigList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsServiceDiscoveryServiceHealthCheckConfigList) Resolve(context cdktn.IResolveContext) interface{} {
