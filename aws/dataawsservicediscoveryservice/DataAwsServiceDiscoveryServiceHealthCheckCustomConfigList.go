...
func (j *jsiiProxy_DataAwsServiceDiscoveryServiceHealthCheckCustomConfigList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsServiceDiscoveryServiceHealthCheckCustomConfigList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsServiceDiscoveryServiceHealthCheckCustomConfigList {
	_init_.Initialize()
...
func NewDataAwsServiceDiscoveryServiceHealthCheckCustomConfigList_Override(d DataAwsServiceDiscoveryServiceHealthCheckCustomConfigList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsServiceDiscoveryServiceHealthCheckCustomConfigList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsServiceDiscoveryServiceHealthCheckCustomConfigList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsServiceDiscoveryServiceHealthCheckCustomConfigList) Resolve(context cdktn.IResolveContext) interface{} {
