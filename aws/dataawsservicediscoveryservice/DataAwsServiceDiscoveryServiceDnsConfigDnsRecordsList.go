...
func (d *jsiiProxy_DataAwsServiceDiscoveryServiceDnsConfigDnsRecordsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsServiceDiscoveryServiceDnsConfigDnsRecordsList) Resolve(context cdktf.IResolveContext) interface{} {
