...
func (j *jsiiProxy_DataAwsServiceDiscoveryServiceDnsConfigDnsRecordsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsServiceDiscoveryServiceDnsConfigDnsRecordsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsServiceDiscoveryServiceDnsConfigDnsRecordsList {
	_init_.Initialize()
...
func NewDataAwsServiceDiscoveryServiceDnsConfigDnsRecordsList_Override(d DataAwsServiceDiscoveryServiceDnsConfigDnsRecordsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsServiceDiscoveryServiceDnsConfigDnsRecordsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsServiceDiscoveryServiceDnsConfigDnsRecordsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsServiceDiscoveryServiceDnsConfigDnsRecordsList) Resolve(context cdktn.IResolveContext) interface{} {
