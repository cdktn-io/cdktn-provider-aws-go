...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/backupvault/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/backup_vault aws_backup_vault}.
...
func (j *jsiiProxy_BackupVault) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_BackupVault) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_BackupVault) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_BackupVault) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_BackupVault) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_BackupVault) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_BackupVault) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/backup_vault aws_backup_vault} Resource.
...
func (j *jsiiProxy_BackupVault)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_BackupVault)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_BackupVault)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_BackupVault)SetRegion(val *string) {
...
func BackupVault_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
// Experimental.
func BackupVault_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateBackupVault_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func BackupVault_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateBackupVault_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (b *jsiiProxy_BackupVault) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (b *jsiiProxy_BackupVault) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (b *jsiiProxy_BackupVault) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (b *jsiiProxy_BackupVault) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (b *jsiiProxy_BackupVault) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (b *jsiiProxy_BackupVault) ResetRegion() {
	_jsii_.InvokeVoid(
		b,
		"resetRegion",
		nil, // no parameters
...
func (b *jsiiProxy_BackupVault) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (b *jsiiProxy_BackupVault) ToHclTerraform() interface{} {
	var returns interface{}
...
func (b *jsiiProxy_BackupVault) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
