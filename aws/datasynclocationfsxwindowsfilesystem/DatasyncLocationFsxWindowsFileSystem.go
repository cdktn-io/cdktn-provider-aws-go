...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/datasynclocationfsxwindowsfilesystem/internal"
...
func (j *jsiiProxy_DatasyncLocationFsxWindowsFileSystem) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DatasyncLocationFsxWindowsFileSystem) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/datasync_location_fsx_windows_file_system aws_datasync_location_fsx_windows_file_system} Resource.
...
func (j *jsiiProxy_DatasyncLocationFsxWindowsFileSystem)SetRegion(val *string) {
...
func (d *jsiiProxy_DatasyncLocationFsxWindowsFileSystem) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (d *jsiiProxy_DatasyncLocationFsxWindowsFileSystem) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DatasyncLocationFsxWindowsFileSystem) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
...
func (d *jsiiProxy_DatasyncLocationFsxWindowsFileSystem) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
