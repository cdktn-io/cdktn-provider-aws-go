...
func (j *jsiiProxy_NetworkmanagerCoreNetwork) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_NetworkmanagerCoreNetwork) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_NetworkmanagerCoreNetwork) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_NetworkmanagerCoreNetwork) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_NetworkmanagerCoreNetwork) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/networkmanager_core_network aws_networkmanager_core_network} Resource.
...
func (j *jsiiProxy_NetworkmanagerCoreNetwork)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_NetworkmanagerCoreNetwork)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_NetworkmanagerCoreNetwork)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func NetworkmanagerCoreNetwork_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (n *jsiiProxy_NetworkmanagerCoreNetwork) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (n *jsiiProxy_NetworkmanagerCoreNetwork) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (n *jsiiProxy_NetworkmanagerCoreNetwork) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (n *jsiiProxy_NetworkmanagerCoreNetwork) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (n *jsiiProxy_NetworkmanagerCoreNetwork) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (n *jsiiProxy_NetworkmanagerCoreNetwork) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
