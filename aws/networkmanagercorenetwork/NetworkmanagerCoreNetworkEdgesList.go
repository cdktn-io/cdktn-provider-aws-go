...
func (j *jsiiProxy_NetworkmanagerCoreNetworkEdgesList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewNetworkmanagerCoreNetworkEdgesList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) NetworkmanagerCoreNetworkEdgesList {
	_init_.Initialize()
...
func NewNetworkmanagerCoreNetworkEdgesList_Override(n NetworkmanagerCoreNetworkEdgesList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_NetworkmanagerCoreNetworkEdgesList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (n *jsiiProxy_NetworkmanagerCoreNetworkEdgesList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (n *jsiiProxy_NetworkmanagerCoreNetworkEdgesList) Resolve(context cdktf.IResolveContext) interface{} {
