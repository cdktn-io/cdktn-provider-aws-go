...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/medialivemultiplex/internal"
...
func (j *jsiiProxy_MedialiveMultiplex) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_MedialiveMultiplex) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_MedialiveMultiplex) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_MedialiveMultiplex) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_MedialiveMultiplex) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/medialive_multiplex aws_medialive_multiplex} Resource.
...
func (j *jsiiProxy_MedialiveMultiplex)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_MedialiveMultiplex)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_MedialiveMultiplex)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func MedialiveMultiplex_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (m *jsiiProxy_MedialiveMultiplex) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MedialiveMultiplex) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (m *jsiiProxy_MedialiveMultiplex) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MedialiveMultiplex) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (m *jsiiProxy_MedialiveMultiplex) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (m *jsiiProxy_MedialiveMultiplex) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
