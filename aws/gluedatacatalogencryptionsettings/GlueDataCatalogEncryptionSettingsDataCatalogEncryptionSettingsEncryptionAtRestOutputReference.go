...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v21/gluedatacatalogencryptionsettings/internal"
...
func (g *jsiiProxy_GlueDataCatalogEncryptionSettingsDataCatalogEncryptionSettingsEncryptionAtRestOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GlueDataCatalogEncryptionSettingsDataCatalogEncryptionSettingsEncryptionAtRestOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
