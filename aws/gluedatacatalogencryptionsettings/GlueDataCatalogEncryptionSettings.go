...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/gluedatacatalogencryptionsettings/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/glue_data_catalog_encryption_settings aws_glue_data_catalog_encryption_settings}.
...
func (j *jsiiProxy_GlueDataCatalogEncryptionSettings) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_GlueDataCatalogEncryptionSettings) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_GlueDataCatalogEncryptionSettings) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_GlueDataCatalogEncryptionSettings) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_GlueDataCatalogEncryptionSettings) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_GlueDataCatalogEncryptionSettings) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_GlueDataCatalogEncryptionSettings) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/glue_data_catalog_encryption_settings aws_glue_data_catalog_encryption_settings} Resource.
...
func (j *jsiiProxy_GlueDataCatalogEncryptionSettings)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_GlueDataCatalogEncryptionSettings)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_GlueDataCatalogEncryptionSettings)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_GlueDataCatalogEncryptionSettings)SetRegion(val *string) {
...
func GlueDataCatalogEncryptionSettings_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (g *jsiiProxy_GlueDataCatalogEncryptionSettings) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GlueDataCatalogEncryptionSettings) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (g *jsiiProxy_GlueDataCatalogEncryptionSettings) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GlueDataCatalogEncryptionSettings) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GlueDataCatalogEncryptionSettings) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (g *jsiiProxy_GlueDataCatalogEncryptionSettings) ResetRegion() {
	_jsii_.InvokeVoid(
		g,
		"resetRegion",
		nil, // no parameters
...
func (g *jsiiProxy_GlueDataCatalogEncryptionSettings) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
