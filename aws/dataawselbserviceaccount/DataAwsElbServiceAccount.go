...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/dataawselbserviceaccount/internal"
...
func (j *jsiiProxy_DataAwsElbServiceAccount) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsElbServiceAccount) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsElbServiceAccount) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsElbServiceAccount) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsElbServiceAccount) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DataAwsElbServiceAccount)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsElbServiceAccount)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsElbServiceAccount)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsElbServiceAccount_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsElbServiceAccount) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsElbServiceAccount) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsElbServiceAccount) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsElbServiceAccount) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
