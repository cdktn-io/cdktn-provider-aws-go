...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/dataawslambdalayerversion/internal"
...
func (j *jsiiProxy_DataAwsLambdaLayerVersion) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsLambdaLayerVersion) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsLambdaLayerVersion) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsLambdaLayerVersion) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsLambdaLayerVersion) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/data-sources/lambda_layer_version aws_lambda_layer_version} Data Source.
...
func (j *jsiiProxy_DataAwsLambdaLayerVersion)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsLambdaLayerVersion)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsLambdaLayerVersion)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsLambdaLayerVersion_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsLambdaLayerVersion) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsLambdaLayerVersion) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsLambdaLayerVersion) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsLambdaLayerVersion) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
