...
func (d *jsiiProxy_DataAwsGlobalacceleratorAcceleratorAttributesList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsGlobalacceleratorAcceleratorAttributesList) Resolve(context cdktf.IResolveContext) interface{} {
