...
func (j *jsiiProxy_DataAwsGlobalacceleratorAcceleratorAttributesList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsGlobalacceleratorAcceleratorAttributesList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsGlobalacceleratorAcceleratorAttributesList {
	_init_.Initialize()

	if err := validateNewDataAwsGlobalacceleratorAcceleratorAttributesListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewDataAwsGlobalacceleratorAcceleratorAttributesList_Override(d DataAwsGlobalacceleratorAcceleratorAttributesList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsGlobalacceleratorAcceleratorAttributesList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsGlobalacceleratorAcceleratorAttributesList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsGlobalacceleratorAcceleratorAttributesList) Resolve(context cdktn.IResolveContext) interface{} {
