...
func (d *jsiiProxy_DataAwsGlobalacceleratorAcceleratorIpSetsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataAwsGlobalacceleratorAcceleratorIpSetsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
