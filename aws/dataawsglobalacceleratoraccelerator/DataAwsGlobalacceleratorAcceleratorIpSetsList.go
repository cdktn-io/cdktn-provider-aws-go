...
func (j *jsiiProxy_DataAwsGlobalacceleratorAcceleratorIpSetsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsGlobalacceleratorAcceleratorIpSetsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsGlobalacceleratorAcceleratorIpSetsList {
	_init_.Initialize()
...
func NewDataAwsGlobalacceleratorAcceleratorIpSetsList_Override(d DataAwsGlobalacceleratorAcceleratorIpSetsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsGlobalacceleratorAcceleratorIpSetsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsGlobalacceleratorAcceleratorIpSetsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsGlobalacceleratorAcceleratorIpSetsList) Resolve(context cdktn.IResolveContext) interface{} {
