...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/data-sources/globalaccelerator_accelerator aws_globalaccelerator_accelerator} Data Source.
...
func (d *jsiiProxy_DataAwsGlobalacceleratorAccelerator) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsGlobalacceleratorAccelerator) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
