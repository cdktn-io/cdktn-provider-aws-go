...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/memorydbuser/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/memorydb_user aws_memorydb_user}.
...
func (j *jsiiProxy_MemorydbUser) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_MemorydbUser) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_MemorydbUser) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_MemorydbUser) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_MemorydbUser) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_MemorydbUser) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_MemorydbUser) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/memorydb_user aws_memorydb_user} Resource.
...
func (j *jsiiProxy_MemorydbUser)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_MemorydbUser)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_MemorydbUser)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_MemorydbUser)SetRegion(val *string) {
...
func MemorydbUser_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (m *jsiiProxy_MemorydbUser) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MemorydbUser) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (m *jsiiProxy_MemorydbUser) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MemorydbUser) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (m *jsiiProxy_MemorydbUser) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (m *jsiiProxy_MemorydbUser) ResetRegion() {
	_jsii_.InvokeVoid(
		m,
		"resetRegion",
		nil, // no parameters
...
func (m *jsiiProxy_MemorydbUser) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
