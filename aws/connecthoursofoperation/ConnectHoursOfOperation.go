...
func (j *jsiiProxy_ConnectHoursOfOperation) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_ConnectHoursOfOperation) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_ConnectHoursOfOperation) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_ConnectHoursOfOperation) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_ConnectHoursOfOperation) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/connect_hours_of_operation aws_connect_hours_of_operation} Resource.
...
func (j *jsiiProxy_ConnectHoursOfOperation)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_ConnectHoursOfOperation)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_ConnectHoursOfOperation)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func ConnectHoursOfOperation_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (c *jsiiProxy_ConnectHoursOfOperation) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_ConnectHoursOfOperation) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (c *jsiiProxy_ConnectHoursOfOperation) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_ConnectHoursOfOperation) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_ConnectHoursOfOperation) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (c *jsiiProxy_ConnectHoursOfOperation) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
