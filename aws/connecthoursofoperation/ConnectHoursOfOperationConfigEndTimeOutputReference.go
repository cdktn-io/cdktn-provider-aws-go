...
func (j *jsiiProxy_ConnectHoursOfOperationConfigEndTimeOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewConnectHoursOfOperationConfigEndTimeOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) ConnectHoursOfOperationConfigEndTimeOutputReference {
	_init_.Initialize()
...
func NewConnectHoursOfOperationConfigEndTimeOutputReference_Override(c ConnectHoursOfOperationConfigEndTimeOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_ConnectHoursOfOperationConfigEndTimeOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_ConnectHoursOfOperationConfigEndTimeOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_ConnectHoursOfOperationConfigEndTimeOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (c *jsiiProxy_ConnectHoursOfOperationConfigEndTimeOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_ConnectHoursOfOperationConfigEndTimeOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
