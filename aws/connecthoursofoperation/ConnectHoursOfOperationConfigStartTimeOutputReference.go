...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v21/connecthoursofoperation/internal"
...
func NewConnectHoursOfOperationConfigStartTimeOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) ConnectHoursOfOperationConfigStartTimeOutputReference {
	_init_.Initialize()
...
func NewConnectHoursOfOperationConfigStartTimeOutputReference_Override(c ConnectHoursOfOperationConfigStartTimeOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (c *jsiiProxy_ConnectHoursOfOperationConfigStartTimeOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ConnectHoursOfOperationConfigStartTimeOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
