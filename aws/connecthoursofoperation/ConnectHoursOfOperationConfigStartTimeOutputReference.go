...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v24/connecthoursofoperation/internal"
...
func (j *jsiiProxy_ConnectHoursOfOperationConfigStartTimeOutputReference) ComplexObjectIndex() interface{} {
...
func (j *jsiiProxy_ConnectHoursOfOperationConfigStartTimeOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ConnectHoursOfOperationConfigStartTimeOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_ConnectHoursOfOperationConfigStartTimeOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_ConnectHoursOfOperationConfigStartTimeOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewConnectHoursOfOperationConfigStartTimeOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) ConnectHoursOfOperationConfigStartTimeOutputReference {
	_init_.Initialize()

	if err := validateNewConnectHoursOfOperationConfigStartTimeOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewConnectHoursOfOperationConfigStartTimeOutputReference_Override(c ConnectHoursOfOperationConfigStartTimeOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_ConnectHoursOfOperationConfigStartTimeOutputReference)SetComplexObjectIndex(val interface{}) {
...
func (j *jsiiProxy_ConnectHoursOfOperationConfigStartTimeOutputReference)SetComplexObjectIsFromSet(val *bool) {
...
func (j *jsiiProxy_ConnectHoursOfOperationConfigStartTimeOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_ConnectHoursOfOperationConfigStartTimeOutputReference) ComputeFqn() *string {
	var returns *string
...
func (c *jsiiProxy_ConnectHoursOfOperationConfigStartTimeOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_ConnectHoursOfOperationConfigStartTimeOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (c *jsiiProxy_ConnectHoursOfOperationConfigStartTimeOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_ConnectHoursOfOperationConfigStartTimeOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
...
func (c *jsiiProxy_ConnectHoursOfOperationConfigStartTimeOutputReference) ToString() *string {
	var returns *string
