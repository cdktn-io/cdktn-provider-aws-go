...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/dataawsapigatewayv2apis/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/data-sources/apigatewayv2_apis aws_apigatewayv2_apis}.
...
func (j *jsiiProxy_DataAwsApigatewayv2Apis) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsApigatewayv2Apis) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsApigatewayv2Apis) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsApigatewayv2Apis) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsApigatewayv2Apis) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DataAwsApigatewayv2Apis) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_DataAwsApigatewayv2Apis) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/data-sources/apigatewayv2_apis aws_apigatewayv2_apis} Data Source.
func NewDataAwsApigatewayv2Apis(scope constructs.Construct, id *string, config *DataAwsApigatewayv2ApisConfig) DataAwsApigatewayv2Apis {
	...
	_jsii_.Create(
		"@cdktn/provider-aws.dataAwsApigatewayv2Apis.DataAwsApigatewayv2Apis",
...
func (j *jsiiProxy_DataAwsApigatewayv2Apis)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsApigatewayv2Apis)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsApigatewayv2Apis)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_DataAwsApigatewayv2Apis)SetRegion(val *string) {
...
// Generates CDKTN code for importing a DataAwsApigatewayv2Apis resource upon running "cdktn plan <stack-name>".
func DataAwsApigatewayv2Apis_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateDataAwsApigatewayv2Apis_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
// Experimental.
func DataAwsApigatewayv2Apis_IsTerraformDataSource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataAwsApigatewayv2Apis_IsTerraformDataSourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataAwsApigatewayv2Apis_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataAwsApigatewayv2Apis_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (d *jsiiProxy_DataAwsApigatewayv2Apis) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsApigatewayv2Apis) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsApigatewayv2Apis) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsApigatewayv2Apis) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsApigatewayv2Apis) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataAwsApigatewayv2Apis) ToHclTerraform() interface{} {
	var returns interface{}
...
func (d *jsiiProxy_DataAwsApigatewayv2Apis) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
