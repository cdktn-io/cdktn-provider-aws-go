...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/lambdaprovisionedconcurrencyconfig/internal"
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/lambda_provisioned_concurrency_config aws_lambda_provisioned_concurrency_config} Resource.
...
func (l *jsiiProxy_LambdaProvisionedConcurrencyConfig) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (l *jsiiProxy_LambdaProvisionedConcurrencyConfig) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
