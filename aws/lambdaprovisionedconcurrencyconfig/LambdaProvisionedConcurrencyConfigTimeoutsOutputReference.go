...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v21/lambdaprovisionedconcurrencyconfig/internal"
...
func (l *jsiiProxy_LambdaProvisionedConcurrencyConfigTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LambdaProvisionedConcurrencyConfigTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
