...
func (s *jsiiProxy_SagemakerSpaceSpaceSettingsJupyterServerAppSettingsOutputReference) validateInterpolationForAttributeParameters(terraformAttribute *string) error {
	if terraformAttribute == nil {
		return fmt.Errorf("parameter terraformAttribute is required, but nil was provided")
	}
...
func (s *jsiiProxy_SagemakerSpaceSpaceSettingsJupyterServerAppSettingsOutputReference) validatePutCodeRepositoryParameters(value interface{}) error {
	if value == nil {
	...
	case *[]*SagemakerSpaceSpaceSettingsJupyterServerAppSettingsCodeRepository:
		value := value.(*[]*SagemakerSpaceSpaceSettingsJupyterServerAppSettingsCodeRepository)
	...
	case []*SagemakerSpaceSpaceSettingsJupyterServerAppSettingsCodeRepository:
		value_ := value.([]*SagemakerSpaceSpaceSettingsJupyterServerAppSettingsCodeRepository)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*SagemakerSpaceSpaceSettingsJupyterServerAppSettingsCodeRepository; received %#v (a %T)", value, value)
		}
	}
...
func (s *jsiiProxy_SagemakerSpaceSpaceSettingsJupyterServerAppSettingsOutputReference) validateResolveParameters(context cdktn.IResolveContext) error {
	if context == nil {
...
func (j *jsiiProxy_SagemakerSpaceSpaceSettingsJupyterServerAppSettingsOutputReference) validateSetInternalValueParameters(val *SagemakerSpaceSpaceSettingsJupyterServerAppSettings) error {
...
func (j *jsiiProxy_SagemakerSpaceSpaceSettingsJupyterServerAppSettingsOutputReference) validateSetTerraformResourceParameters(val cdktn.IInterpolatingParent) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func validateNewSagemakerSpaceSpaceSettingsJupyterServerAppSettingsOutputReferenceParameters(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) error {
