...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v24/ivschatloggingconfiguration/internal"
...
func (j *jsiiProxy_IvschatLoggingConfigurationDestinationConfigurationFirehoseOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewIvschatLoggingConfigurationDestinationConfigurationFirehoseOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) IvschatLoggingConfigurationDestinationConfigurationFirehoseOutputReference {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-aws.ivschatLoggingConfiguration.IvschatLoggingConfigurationDestinationConfigurationFirehoseOutputReference",
...
func NewIvschatLoggingConfigurationDestinationConfigurationFirehoseOutputReference_Override(i IvschatLoggingConfigurationDestinationConfigurationFirehoseOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_IvschatLoggingConfigurationDestinationConfigurationFirehoseOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (i *jsiiProxy_IvschatLoggingConfigurationDestinationConfigurationFirehoseOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (i *jsiiProxy_IvschatLoggingConfigurationDestinationConfigurationFirehoseOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (i *jsiiProxy_IvschatLoggingConfigurationDestinationConfigurationFirehoseOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (i *jsiiProxy_IvschatLoggingConfigurationDestinationConfigurationFirehoseOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
