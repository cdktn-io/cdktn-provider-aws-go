...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v21/ivschatloggingconfiguration/internal"
...
func (i *jsiiProxy_IvschatLoggingConfigurationDestinationConfigurationFirehoseOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (i *jsiiProxy_IvschatLoggingConfigurationDestinationConfigurationFirehoseOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
