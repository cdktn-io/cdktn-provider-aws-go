...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/iamgrouppolicyattachment/internal"
...
func (j *jsiiProxy_IamGroupPolicyAttachment) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_IamGroupPolicyAttachment) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_IamGroupPolicyAttachment) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_IamGroupPolicyAttachment) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_IamGroupPolicyAttachment) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_IamGroupPolicyAttachment)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_IamGroupPolicyAttachment)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_IamGroupPolicyAttachment)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func IamGroupPolicyAttachment_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (i *jsiiProxy_IamGroupPolicyAttachment) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (i *jsiiProxy_IamGroupPolicyAttachment) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (i *jsiiProxy_IamGroupPolicyAttachment) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (i *jsiiProxy_IamGroupPolicyAttachment) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (i *jsiiProxy_IamGroupPolicyAttachment) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (i *jsiiProxy_IamGroupPolicyAttachment) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
