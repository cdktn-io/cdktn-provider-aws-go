...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/dxtransitvirtualinterface/internal"
...
func (j *jsiiProxy_DxTransitVirtualInterface) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DxTransitVirtualInterface) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DxTransitVirtualInterface) JumboFrameCapable() cdktn.IResolvable {
...
func (j *jsiiProxy_DxTransitVirtualInterface) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DxTransitVirtualInterface) PrefixPoolAllocatedCountIpv4() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DxTransitVirtualInterface) PrefixPoolAllocatedCountIpv4Input() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DxTransitVirtualInterface) PrefixPoolAllocatedCountIpv6() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DxTransitVirtualInterface) PrefixPoolAllocatedCountIpv6Input() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DxTransitVirtualInterface) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DxTransitVirtualInterface) RateLimit() *string {
	var returns *string
	_jsii_.Get(
		j,
		"rateLimit",
...
func (j *jsiiProxy_DxTransitVirtualInterface) RateLimitInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"rateLimitInput",
...
func (j *jsiiProxy_DxTransitVirtualInterface) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DxTransitVirtualInterface) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_DxTransitVirtualInterface) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.66.0/docs/resources/dx_transit_virtual_interface aws_dx_transit_virtual_interface} Resource.
func NewDxTransitVirtualInterface(scope constructs.Construct, id *string, config *DxTransitVirtualInterfaceConfig) DxTransitVirtualInterface {
	...
	_jsii_.Create(
		"@cdktn/provider-aws.dxTransitVirtualInterface.DxTransitVirtualInterface",
...
func (j *jsiiProxy_DxTransitVirtualInterface)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DxTransitVirtualInterface)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DxTransitVirtualInterface)SetPrefixPoolAllocatedCountIpv4(val *float64) {
...
func (j *jsiiProxy_DxTransitVirtualInterface)SetPrefixPoolAllocatedCountIpv6(val *float64) {
...
func (j *jsiiProxy_DxTransitVirtualInterface)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_DxTransitVirtualInterface)SetRateLimit(val *string) {
...
func (j *jsiiProxy_DxTransitVirtualInterface)SetRegion(val *string) {
...
func DxTransitVirtualInterface_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DxTransitVirtualInterface) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DxTransitVirtualInterface) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (d *jsiiProxy_DxTransitVirtualInterface) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DxTransitVirtualInterface) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (d *jsiiProxy_DxTransitVirtualInterface) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DxTransitVirtualInterface) ResetPrefixPoolAllocatedCountIpv4() {
	_jsii_.InvokeVoid(
		d,
		"resetPrefixPoolAllocatedCountIpv4",
		nil, // no parameters
...
func (d *jsiiProxy_DxTransitVirtualInterface) ResetPrefixPoolAllocatedCountIpv6() {
	_jsii_.InvokeVoid(
		d,
		"resetPrefixPoolAllocatedCountIpv6",
		nil, // no parameters
...
func (d *jsiiProxy_DxTransitVirtualInterface) ResetRateLimit() {
	_jsii_.InvokeVoid(
		d,
		"resetRateLimit",
		nil, // no parameters
...
func (d *jsiiProxy_DxTransitVirtualInterface) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
...
func (d *jsiiProxy_DxTransitVirtualInterface) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
