...
func (j *jsiiProxy_DxTransitVirtualInterfaceTimeoutsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDxTransitVirtualInterfaceTimeoutsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) DxTransitVirtualInterfaceTimeoutsOutputReference {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-aws.dxTransitVirtualInterface.DxTransitVirtualInterfaceTimeoutsOutputReference",
...
func NewDxTransitVirtualInterfaceTimeoutsOutputReference_Override(d DxTransitVirtualInterfaceTimeoutsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_DxTransitVirtualInterfaceTimeoutsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DxTransitVirtualInterfaceTimeoutsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DxTransitVirtualInterfaceTimeoutsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (d *jsiiProxy_DxTransitVirtualInterfaceTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DxTransitVirtualInterfaceTimeoutsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
