...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v23/dataawsimagebuilderimagerecipes/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.41.0/docs/data-sources/imagebuilder_image_recipes aws_imagebuilder_image_recipes}.
...
func (j *jsiiProxy_DataAwsImagebuilderImageRecipes) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsImagebuilderImageRecipes) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsImagebuilderImageRecipes) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsImagebuilderImageRecipes) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsImagebuilderImageRecipes) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DataAwsImagebuilderImageRecipes) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_DataAwsImagebuilderImageRecipes) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.41.0/docs/data-sources/imagebuilder_image_recipes aws_imagebuilder_image_recipes} Data Source.
func NewDataAwsImagebuilderImageRecipes(scope constructs.Construct, id *string, config *DataAwsImagebuilderImageRecipesConfig) DataAwsImagebuilderImageRecipes {
	...
	_jsii_.Create(
		"@cdktn/provider-aws.dataAwsImagebuilderImageRecipes.DataAwsImagebuilderImageRecipes",
...
func (j *jsiiProxy_DataAwsImagebuilderImageRecipes)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsImagebuilderImageRecipes)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsImagebuilderImageRecipes)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_DataAwsImagebuilderImageRecipes)SetRegion(val *string) {
...
func DataAwsImagebuilderImageRecipes_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsImagebuilderImageRecipes) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsImagebuilderImageRecipes) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsImagebuilderImageRecipes) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsImagebuilderImageRecipes) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
