...
func (j *jsiiProxy_ImagebuilderInfrastructureConfigurationLoggingOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ImagebuilderInfrastructureConfigurationLoggingOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_ImagebuilderInfrastructureConfigurationLoggingOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (i *jsiiProxy_ImagebuilderInfrastructureConfigurationLoggingOutputReference) ComputeFqn() *string {
	var returns *string
...
func (i *jsiiProxy_ImagebuilderInfrastructureConfigurationLoggingOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (i *jsiiProxy_ImagebuilderInfrastructureConfigurationLoggingOutputReference) PutS3Logs(value *ImagebuilderInfrastructureConfigurationLoggingS3Logs) {
	if err := i.validatePutS3LogsParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		i,
...
func (i *jsiiProxy_ImagebuilderInfrastructureConfigurationLoggingOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
...
func (i *jsiiProxy_ImagebuilderInfrastructureConfigurationLoggingOutputReference) ToString() *string {
	var returns *string
