...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/glue_user_defined_function aws_glue_user_defined_function} Resource.
...
func (g *jsiiProxy_GlueUserDefinedFunction) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GlueUserDefinedFunction) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (g *jsiiProxy_GlueUserDefinedFunction) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
