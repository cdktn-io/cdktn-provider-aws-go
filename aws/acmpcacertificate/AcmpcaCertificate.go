...
func (j *jsiiProxy_AcmpcaCertificate) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_AcmpcaCertificate) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_AcmpcaCertificate) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_AcmpcaCertificate) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_AcmpcaCertificate) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/acmpca_certificate aws_acmpca_certificate} Resource.
...
func (j *jsiiProxy_AcmpcaCertificate)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_AcmpcaCertificate)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_AcmpcaCertificate)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func AcmpcaCertificate_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (a *jsiiProxy_AcmpcaCertificate) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AcmpcaCertificate) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (a *jsiiProxy_AcmpcaCertificate) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AcmpcaCertificate) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (a *jsiiProxy_AcmpcaCertificate) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (a *jsiiProxy_AcmpcaCertificate) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
