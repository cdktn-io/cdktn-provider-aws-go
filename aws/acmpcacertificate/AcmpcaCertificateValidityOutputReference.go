...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v23/acmpcacertificate/internal"
...
func (j *jsiiProxy_AcmpcaCertificateValidityOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewAcmpcaCertificateValidityOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) AcmpcaCertificateValidityOutputReference {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-aws.acmpcaCertificate.AcmpcaCertificateValidityOutputReference",
...
func NewAcmpcaCertificateValidityOutputReference_Override(a AcmpcaCertificateValidityOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_AcmpcaCertificateValidityOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (a *jsiiProxy_AcmpcaCertificateValidityOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AcmpcaCertificateValidityOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (a *jsiiProxy_AcmpcaCertificateValidityOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AcmpcaCertificateValidityOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
