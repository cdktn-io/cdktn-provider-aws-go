...
func (j *jsiiProxy_DataAwsEksClusterRemoteNetworkConfigRemotePodNetworksList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsEksClusterRemoteNetworkConfigRemotePodNetworksList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsEksClusterRemoteNetworkConfigRemotePodNetworksList {
	_init_.Initialize()
...
func NewDataAwsEksClusterRemoteNetworkConfigRemotePodNetworksList_Override(d DataAwsEksClusterRemoteNetworkConfigRemotePodNetworksList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsEksClusterRemoteNetworkConfigRemotePodNetworksList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsEksClusterRemoteNetworkConfigRemotePodNetworksList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsEksClusterRemoteNetworkConfigRemotePodNetworksList) Resolve(context cdktn.IResolveContext) interface{} {
