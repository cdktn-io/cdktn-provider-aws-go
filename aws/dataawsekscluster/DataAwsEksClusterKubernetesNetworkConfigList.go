...
func (d *jsiiProxy_DataAwsEksClusterKubernetesNetworkConfigList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsEksClusterKubernetesNetworkConfigList) Resolve(context cdktf.IResolveContext) interface{} {
