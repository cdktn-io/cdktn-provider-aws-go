...
func (j *jsiiProxy_DataAwsEksClusterControlPlaneScalingConfigList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewDataAwsEksClusterControlPlaneScalingConfigList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsEksClusterControlPlaneScalingConfigList {
	_init_.Initialize()
...
func NewDataAwsEksClusterControlPlaneScalingConfigList_Override(d DataAwsEksClusterControlPlaneScalingConfigList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsEksClusterControlPlaneScalingConfigList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsEksClusterControlPlaneScalingConfigList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsEksClusterControlPlaneScalingConfigList) Resolve(context cdktf.IResolveContext) interface{} {
