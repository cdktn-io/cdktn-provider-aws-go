...
type DataAwsEksCluster interface {
	...
	IdInput() *string
	KubeApiServerConfig() DataAwsEksClusterKubeApiServerConfigList
	KubeControllerManagerConfig() DataAwsEksClusterKubeControllerManagerConfigList
	KubernetesNetworkConfig() DataAwsEksClusterKubernetesNetworkConfigList
	KubeSchedulerConfig() DataAwsEksClusterKubeSchedulerConfigList
	// Experimental.
...
func (j *jsiiProxy_DataAwsEksCluster) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsEksCluster) DeletionProtection() cdktn.IResolvable {
...
func (j *jsiiProxy_DataAwsEksCluster) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsEksCluster) KubeApiServerConfig() DataAwsEksClusterKubeApiServerConfigList {
	var returns DataAwsEksClusterKubeApiServerConfigList
	_jsii_.Get(
		j,
		"kubeApiServerConfig",
		&returns,
...
func (j *jsiiProxy_DataAwsEksCluster) KubeControllerManagerConfig() DataAwsEksClusterKubeControllerManagerConfigList {
	var returns DataAwsEksClusterKubeControllerManagerConfigList
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataAwsEksCluster) KubeSchedulerConfig() DataAwsEksClusterKubeSchedulerConfigList {
	var returns DataAwsEksClusterKubeSchedulerConfigList
	_jsii_.Get(
		j,
		"kubeSchedulerConfig",
		&returns,
...
func (j *jsiiProxy_DataAwsEksCluster) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsEksCluster) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsEksCluster) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DataAwsEksCluster) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_DataAwsEksCluster) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DataAwsEksCluster) UpgradePolicy() DataAwsEksClusterUpgradePolicyList {
	var returns DataAwsEksClusterUpgradePolicyList
	_jsii_.Get(
		j,
		"upgradePolicy",
		&returns,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/data-sources/eks_cluster aws_eks_cluster} Data Source.
...
func (j *jsiiProxy_DataAwsEksCluster)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsEksCluster)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsEksCluster)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_DataAwsEksCluster)SetRegion(val *string) {
...
func DataAwsEksCluster_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsEksCluster) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsEksCluster) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsEksCluster) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsEksCluster) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsEksCluster) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
