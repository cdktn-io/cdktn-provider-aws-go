...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/redshiftsnapshotcopygrant/internal"
...
func (j *jsiiProxy_RedshiftSnapshotCopyGrant) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_RedshiftSnapshotCopyGrant) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_RedshiftSnapshotCopyGrant) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_RedshiftSnapshotCopyGrant) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_RedshiftSnapshotCopyGrant) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/redshift_snapshot_copy_grant aws_redshift_snapshot_copy_grant} Resource.
...
func (j *jsiiProxy_RedshiftSnapshotCopyGrant)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_RedshiftSnapshotCopyGrant)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_RedshiftSnapshotCopyGrant)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func RedshiftSnapshotCopyGrant_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (r *jsiiProxy_RedshiftSnapshotCopyGrant) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (r *jsiiProxy_RedshiftSnapshotCopyGrant) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (r *jsiiProxy_RedshiftSnapshotCopyGrant) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (r *jsiiProxy_RedshiftSnapshotCopyGrant) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (r *jsiiProxy_RedshiftSnapshotCopyGrant) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (r *jsiiProxy_RedshiftSnapshotCopyGrant) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
