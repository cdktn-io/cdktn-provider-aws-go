...
func (j *jsiiProxy_ServicecatalogTagOption) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_ServicecatalogTagOption) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_ServicecatalogTagOption) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_ServicecatalogTagOption) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_ServicecatalogTagOption) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/servicecatalog_tag_option aws_servicecatalog_tag_option} Resource.
...
func (j *jsiiProxy_ServicecatalogTagOption)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_ServicecatalogTagOption)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_ServicecatalogTagOption)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func ServicecatalogTagOption_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (s *jsiiProxy_ServicecatalogTagOption) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_ServicecatalogTagOption) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_ServicecatalogTagOption) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_ServicecatalogTagOption) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_ServicecatalogTagOption) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_ServicecatalogTagOption) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
