...
func (a *jsiiProxy_ApiGatewayAccountThrottleSettingsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_ApiGatewayAccountThrottleSettingsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
