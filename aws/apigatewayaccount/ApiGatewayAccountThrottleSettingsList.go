...
func (j *jsiiProxy_ApiGatewayAccountThrottleSettingsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewApiGatewayAccountThrottleSettingsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ApiGatewayAccountThrottleSettingsList {
	_init_.Initialize()

	if err := validateNewApiGatewayAccountThrottleSettingsListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewApiGatewayAccountThrottleSettingsList_Override(a ApiGatewayAccountThrottleSettingsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ApiGatewayAccountThrottleSettingsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (a *jsiiProxy_ApiGatewayAccountThrottleSettingsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (a *jsiiProxy_ApiGatewayAccountThrottleSettingsList) Resolve(context cdktn.IResolveContext) interface{} {
