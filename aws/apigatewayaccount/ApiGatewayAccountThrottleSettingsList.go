...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v22/apigatewayaccount/internal"
...
func (a *jsiiProxy_ApiGatewayAccountThrottleSettingsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (a *jsiiProxy_ApiGatewayAccountThrottleSettingsList) Resolve(context cdktf.IResolveContext) interface{} {
