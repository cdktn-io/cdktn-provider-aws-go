...
type DataAwsServicecatalogProduct interface {
	...
	HasDefaultPath() cdktn.IResolvable
	Id() *string
	SetId(val *string)
	IdInput() *string
	// Experimental.
...
func (j *jsiiProxy_DataAwsServicecatalogProduct) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsServicecatalogProduct) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsServicecatalogProduct) HasDefaultPath() cdktn.IResolvable {
...
func (j *jsiiProxy_DataAwsServicecatalogProduct) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsServicecatalogProduct) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsServicecatalogProduct) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DataAwsServicecatalogProduct) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_DataAwsServicecatalogProduct) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DataAwsServicecatalogProduct)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsServicecatalogProduct)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsServicecatalogProduct)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_DataAwsServicecatalogProduct)SetRegion(val *string) {
...
func DataAwsServicecatalogProduct_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsServicecatalogProduct) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsServicecatalogProduct) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsServicecatalogProduct) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsServicecatalogProduct) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsServicecatalogProduct) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
