...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/cloudwatchlogsubscriptionfilter/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/cloudwatch_log_subscription_filter aws_cloudwatch_log_subscription_filter}.
...
func (j *jsiiProxy_CloudwatchLogSubscriptionFilter) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_CloudwatchLogSubscriptionFilter) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/cloudwatch_log_subscription_filter aws_cloudwatch_log_subscription_filter} Resource.
...
func (j *jsiiProxy_CloudwatchLogSubscriptionFilter)SetRegion(val *string) {
...
func (c *jsiiProxy_CloudwatchLogSubscriptionFilter) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_CloudwatchLogSubscriptionFilter) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (c *jsiiProxy_CloudwatchLogSubscriptionFilter) ResetRegion() {
	_jsii_.InvokeVoid(
		c,
		"resetRegion",
		nil, // no parameters
...
func (c *jsiiProxy_CloudwatchLogSubscriptionFilter) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
