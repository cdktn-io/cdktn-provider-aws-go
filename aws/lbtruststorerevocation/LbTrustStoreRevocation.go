...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/lbtruststorerevocation/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/lb_trust_store_revocation aws_lb_trust_store_revocation}.
...
func (j *jsiiProxy_LbTrustStoreRevocation) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_LbTrustStoreRevocation) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_LbTrustStoreRevocation) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_LbTrustStoreRevocation) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_LbTrustStoreRevocation) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/lb_trust_store_revocation aws_lb_trust_store_revocation} Resource.
...
func (j *jsiiProxy_LbTrustStoreRevocation)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_LbTrustStoreRevocation)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_LbTrustStoreRevocation)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func LbTrustStoreRevocation_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (l *jsiiProxy_LbTrustStoreRevocation) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LbTrustStoreRevocation) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (l *jsiiProxy_LbTrustStoreRevocation) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LbTrustStoreRevocation) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (l *jsiiProxy_LbTrustStoreRevocation) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (l *jsiiProxy_LbTrustStoreRevocation) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
