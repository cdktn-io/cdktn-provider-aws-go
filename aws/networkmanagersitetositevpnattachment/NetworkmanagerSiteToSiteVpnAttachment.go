...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/networkmanager_site_to_site_vpn_attachment aws_networkmanager_site_to_site_vpn_attachment}.
type NetworkmanagerSiteToSiteVpnAttachment interface {
	...
	PutTimeouts(value *NetworkmanagerSiteToSiteVpnAttachmentTimeouts)
...
func (j *jsiiProxy_NetworkmanagerSiteToSiteVpnAttachment) AttachmentPolicyRuleNumber() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_NetworkmanagerSiteToSiteVpnAttachment) AttachmentType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attachmentType",
...
func (j *jsiiProxy_NetworkmanagerSiteToSiteVpnAttachment) CoreNetworkArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"coreNetworkArn",
...
func (j *jsiiProxy_NetworkmanagerSiteToSiteVpnAttachment) CoreNetworkId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"coreNetworkId",
...
func (j *jsiiProxy_NetworkmanagerSiteToSiteVpnAttachment) CoreNetworkIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"coreNetworkIdInput",
...
func (j *jsiiProxy_NetworkmanagerSiteToSiteVpnAttachment) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_NetworkmanagerSiteToSiteVpnAttachment) EdgeLocation() *string {
	var returns *string
	_jsii_.Get(
		j,
		"edgeLocation",
...
func (j *jsiiProxy_NetworkmanagerSiteToSiteVpnAttachment) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_NetworkmanagerSiteToSiteVpnAttachment) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_NetworkmanagerSiteToSiteVpnAttachment) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_NetworkmanagerSiteToSiteVpnAttachment) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_NetworkmanagerSiteToSiteVpnAttachment) OwnerAccountId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ownerAccountId",
...
func (j *jsiiProxy_NetworkmanagerSiteToSiteVpnAttachment) ResourceArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"resourceArn",
...
func (j *jsiiProxy_NetworkmanagerSiteToSiteVpnAttachment) RoutingPolicyLabel() *string {
	var returns *string
	_jsii_.Get(
		j,
		"routingPolicyLabel",
...
func (j *jsiiProxy_NetworkmanagerSiteToSiteVpnAttachment) RoutingPolicyLabelInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_NetworkmanagerSiteToSiteVpnAttachment) SegmentName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"segmentName",
...
func (j *jsiiProxy_NetworkmanagerSiteToSiteVpnAttachment) State() *string {
	var returns *string
	_jsii_.Get(
		j,
		"state",
...
func (j *jsiiProxy_NetworkmanagerSiteToSiteVpnAttachment) Tags() *map[string]*string {
...
func (j *jsiiProxy_NetworkmanagerSiteToSiteVpnAttachment) TagsAll() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsAll",
...
func (j *jsiiProxy_NetworkmanagerSiteToSiteVpnAttachment) TagsAllInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsAllInput",
...
func (j *jsiiProxy_NetworkmanagerSiteToSiteVpnAttachment) TagsInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsInput",
...
func (j *jsiiProxy_NetworkmanagerSiteToSiteVpnAttachment) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_NetworkmanagerSiteToSiteVpnAttachment) Timeouts() NetworkmanagerSiteToSiteVpnAttachmentTimeoutsOutputReference {
	var returns NetworkmanagerSiteToSiteVpnAttachmentTimeoutsOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
func (j *jsiiProxy_NetworkmanagerSiteToSiteVpnAttachment) VpnConnectionArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"vpnConnectionArn",
...
func (j *jsiiProxy_NetworkmanagerSiteToSiteVpnAttachment) VpnConnectionArnInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"vpnConnectionArnInput",
		&returns,
	)
	return returns
}
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/networkmanager_site_to_site_vpn_attachment aws_networkmanager_site_to_site_vpn_attachment} Resource.
func NewNetworkmanagerSiteToSiteVpnAttachment(scope constructs.Construct, id *string, config *NetworkmanagerSiteToSiteVpnAttachmentConfig) NetworkmanagerSiteToSiteVpnAttachment {
	...
	if err := validateNewNetworkmanagerSiteToSiteVpnAttachmentParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_NetworkmanagerSiteToSiteVpnAttachment)SetRoutingPolicyLabel(val *string) {
...
func NetworkmanagerSiteToSiteVpnAttachment_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktn/provider-aws.networkmanagerSiteToSiteVpnAttachment.NetworkmanagerSiteToSiteVpnAttachment",
...
func (n *jsiiProxy_NetworkmanagerSiteToSiteVpnAttachment) AddMoveTarget(moveTarget *string) {
...
func (n *jsiiProxy_NetworkmanagerSiteToSiteVpnAttachment) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (n *jsiiProxy_NetworkmanagerSiteToSiteVpnAttachment) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (n *jsiiProxy_NetworkmanagerSiteToSiteVpnAttachment) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (n *jsiiProxy_NetworkmanagerSiteToSiteVpnAttachment) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (n *jsiiProxy_NetworkmanagerSiteToSiteVpnAttachment) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (n *jsiiProxy_NetworkmanagerSiteToSiteVpnAttachment) GetStringAttribute(terraformAttribute *string) *string {
...
func (n *jsiiProxy_NetworkmanagerSiteToSiteVpnAttachment) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (n *jsiiProxy_NetworkmanagerSiteToSiteVpnAttachment) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (n *jsiiProxy_NetworkmanagerSiteToSiteVpnAttachment) PutTimeouts(value *NetworkmanagerSiteToSiteVpnAttachmentTimeouts) {
...
func (n *jsiiProxy_NetworkmanagerSiteToSiteVpnAttachment) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (n *jsiiProxy_NetworkmanagerSiteToSiteVpnAttachment) ResetId() {
	_jsii_.InvokeVoid(
		n,
		"resetId",
		nil, // no parameters
...
func (n *jsiiProxy_NetworkmanagerSiteToSiteVpnAttachment) ResetRoutingPolicyLabel() {
	_jsii_.InvokeVoid(
		n,
		"resetRoutingPolicyLabel",
		nil, // no parameters
...
func (n *jsiiProxy_NetworkmanagerSiteToSiteVpnAttachment) ResetTags() {
	_jsii_.InvokeVoid(
		n,
		"resetTags",
		nil, // no parameters
...
func (n *jsiiProxy_NetworkmanagerSiteToSiteVpnAttachment) ResetTagsAll() {
	_jsii_.InvokeVoid(
		n,
		"resetTagsAll",
		nil, // no parameters
...
func (n *jsiiProxy_NetworkmanagerSiteToSiteVpnAttachment) ResetTimeouts() {
	_jsii_.InvokeVoid(
		n,
		"resetTimeouts",
		nil, // no parameters
...
func (n *jsiiProxy_NetworkmanagerSiteToSiteVpnAttachment) ToString() *string {
	var returns *string
...
func (n *jsiiProxy_NetworkmanagerSiteToSiteVpnAttachment) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
