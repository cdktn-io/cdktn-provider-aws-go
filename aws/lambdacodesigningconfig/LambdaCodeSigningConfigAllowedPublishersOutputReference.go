...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v22/lambdacodesigningconfig/internal"
...
func (l *jsiiProxy_LambdaCodeSigningConfigAllowedPublishersOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LambdaCodeSigningConfigAllowedPublishersOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
