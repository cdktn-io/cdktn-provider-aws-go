...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/lambda_code_signing_config aws_lambda_code_signing_config}.
...
func (j *jsiiProxy_LambdaCodeSigningConfig) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_LambdaCodeSigningConfig) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_LambdaCodeSigningConfig) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_LambdaCodeSigningConfig) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_LambdaCodeSigningConfig) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/lambda_code_signing_config aws_lambda_code_signing_config} Resource.
...
func (j *jsiiProxy_LambdaCodeSigningConfig)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_LambdaCodeSigningConfig)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_LambdaCodeSigningConfig)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func LambdaCodeSigningConfig_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (l *jsiiProxy_LambdaCodeSigningConfig) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LambdaCodeSigningConfig) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (l *jsiiProxy_LambdaCodeSigningConfig) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LambdaCodeSigningConfig) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (l *jsiiProxy_LambdaCodeSigningConfig) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (l *jsiiProxy_LambdaCodeSigningConfig) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
