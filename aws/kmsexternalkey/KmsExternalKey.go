...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/kmsexternalkey/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/kms_external_key aws_kms_external_key}.
...
func (j *jsiiProxy_KmsExternalKey) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_KmsExternalKey) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/kms_external_key aws_kms_external_key} Resource.
...
func (j *jsiiProxy_KmsExternalKey)SetRegion(val *string) {
...
func (k *jsiiProxy_KmsExternalKey) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (k *jsiiProxy_KmsExternalKey) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (k *jsiiProxy_KmsExternalKey) ResetRegion() {
	_jsii_.InvokeVoid(
		k,
		"resetRegion",
		nil, // no parameters
...
func (k *jsiiProxy_KmsExternalKey) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
