...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/s3controlbucket/internal"
...
type S3ControlBucket interface {
	...
	PublicAccessBlockEnabled() cdktn.IResolvable
	// Experimental.
...
func (j *jsiiProxy_S3ControlBucket) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_S3ControlBucket) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_S3ControlBucket) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_S3ControlBucket) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_S3ControlBucket) PublicAccessBlockEnabled() cdktn.IResolvable {
...
func (j *jsiiProxy_S3ControlBucket) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_S3ControlBucket)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_S3ControlBucket)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_S3ControlBucket)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func S3ControlBucket_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (s *jsiiProxy_S3ControlBucket) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_S3ControlBucket) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_S3ControlBucket) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_S3ControlBucket) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_S3ControlBucket) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_S3ControlBucket) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
