...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/dataawsemrreleaselabels/internal"
...
func (j *jsiiProxy_DataAwsEmrReleaseLabels) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsEmrReleaseLabels) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsEmrReleaseLabels) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsEmrReleaseLabels) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsEmrReleaseLabels) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/data-sources/emr_release_labels aws_emr_release_labels} Data Source.
func NewDataAwsEmrReleaseLabels(scope constructs.Construct, id *string, config *DataAwsEmrReleaseLabelsConfig) DataAwsEmrReleaseLabels {
	...
	_jsii_.Create(
		"@cdktn/provider-aws.dataAwsEmrReleaseLabels.DataAwsEmrReleaseLabels",
...
func (j *jsiiProxy_DataAwsEmrReleaseLabels)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsEmrReleaseLabels)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsEmrReleaseLabels)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsEmrReleaseLabels_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsEmrReleaseLabels) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsEmrReleaseLabels) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsEmrReleaseLabels) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsEmrReleaseLabels) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
