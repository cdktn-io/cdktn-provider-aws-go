...
func (j *jsiiProxy_DataAwsLakeformationDataLakeSettings) AuthorizedSessionTagValueList() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataAwsLakeformationDataLakeSettings) ExternalDataFilteringAllowList() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataAwsLakeformationDataLakeSettings) ReadOnlyAdmins() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"readOnlyAdmins",
...
func (j *jsiiProxy_DataAwsLakeformationDataLakeSettings) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DataAwsLakeformationDataLakeSettings) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/data-sources/lakeformation_data_lake_settings aws_lakeformation_data_lake_settings} Data Source.
...
func (j *jsiiProxy_DataAwsLakeformationDataLakeSettings)SetRegion(val *string) {
...
func (d *jsiiProxy_DataAwsLakeformationDataLakeSettings) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsLakeformationDataLakeSettings) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsLakeformationDataLakeSettings) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
