...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/dataawslakeformationdatalakesettings/internal"
...
func (j *jsiiProxy_DataAwsLakeformationDataLakeSettingsCreateDatabaseDefaultPermissionsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsLakeformationDataLakeSettingsCreateDatabaseDefaultPermissionsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsLakeformationDataLakeSettingsCreateDatabaseDefaultPermissionsList {
	_init_.Initialize()
...
func NewDataAwsLakeformationDataLakeSettingsCreateDatabaseDefaultPermissionsList_Override(d DataAwsLakeformationDataLakeSettingsCreateDatabaseDefaultPermissionsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsLakeformationDataLakeSettingsCreateDatabaseDefaultPermissionsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsLakeformationDataLakeSettingsCreateDatabaseDefaultPermissionsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsLakeformationDataLakeSettingsCreateDatabaseDefaultPermissionsList) Resolve(context cdktn.IResolveContext) interface{} {
