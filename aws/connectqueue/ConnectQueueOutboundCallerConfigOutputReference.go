...
func (c *jsiiProxy_ConnectQueueOutboundCallerConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ConnectQueueOutboundCallerConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
