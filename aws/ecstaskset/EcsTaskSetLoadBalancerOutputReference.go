...
func (e *jsiiProxy_EcsTaskSetLoadBalancerOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (e *jsiiProxy_EcsTaskSetLoadBalancerOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
