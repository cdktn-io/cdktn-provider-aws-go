...
func (e *jsiiProxy_EcsTaskSet) validatePutCapacityProviderStrategyParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*EcsTaskSetCapacityProviderStrategy; received %#v (a %T)", value, value)
		}
	}
...
func (e *jsiiProxy_EcsTaskSet) validatePutLoadBalancerParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*EcsTaskSetLoadBalancer; received %#v (a %T)", value, value)
		}
	}
