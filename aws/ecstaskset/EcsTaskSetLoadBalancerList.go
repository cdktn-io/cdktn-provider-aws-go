...
func (j *jsiiProxy_EcsTaskSetLoadBalancerList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewEcsTaskSetLoadBalancerList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) EcsTaskSetLoadBalancerList {
	_init_.Initialize()

	if err := validateNewEcsTaskSetLoadBalancerListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewEcsTaskSetLoadBalancerList_Override(e EcsTaskSetLoadBalancerList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_EcsTaskSetLoadBalancerList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (e *jsiiProxy_EcsTaskSetLoadBalancerList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (e *jsiiProxy_EcsTaskSetLoadBalancerList) Resolve(context cdktn.IResolveContext) interface{} {
