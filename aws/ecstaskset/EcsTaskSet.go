...
func (j *jsiiProxy_EcsTaskSet) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_EcsTaskSet) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_EcsTaskSet) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_EcsTaskSet) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_EcsTaskSet) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/ecs_task_set aws_ecs_task_set} Resource.
...
func (j *jsiiProxy_EcsTaskSet)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_EcsTaskSet)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_EcsTaskSet)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func EcsTaskSet_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (e *jsiiProxy_EcsTaskSet) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (e *jsiiProxy_EcsTaskSet) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (e *jsiiProxy_EcsTaskSet) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (e *jsiiProxy_EcsTaskSet) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (e *jsiiProxy_EcsTaskSet) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (e *jsiiProxy_EcsTaskSet) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
