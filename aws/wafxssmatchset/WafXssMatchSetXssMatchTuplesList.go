...
func (j *jsiiProxy_WafXssMatchSetXssMatchTuplesList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewWafXssMatchSetXssMatchTuplesList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) WafXssMatchSetXssMatchTuplesList {
	_init_.Initialize()
...
func NewWafXssMatchSetXssMatchTuplesList_Override(w WafXssMatchSetXssMatchTuplesList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_WafXssMatchSetXssMatchTuplesList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (w *jsiiProxy_WafXssMatchSetXssMatchTuplesList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (w *jsiiProxy_WafXssMatchSetXssMatchTuplesList) Resolve(context cdktn.IResolveContext) interface{} {
