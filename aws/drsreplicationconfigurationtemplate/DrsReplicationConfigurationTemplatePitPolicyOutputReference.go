...
func NewDrsReplicationConfigurationTemplatePitPolicyOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) DrsReplicationConfigurationTemplatePitPolicyOutputReference {
	...
	_jsii_.Create(
		"@cdktn/provider-aws.drsReplicationConfigurationTemplate.DrsReplicationConfigurationTemplatePitPolicyOutputReference",
...
func (d *jsiiProxy_DrsReplicationConfigurationTemplatePitPolicyOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DrsReplicationConfigurationTemplatePitPolicyOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
