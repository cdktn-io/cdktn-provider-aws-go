...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/shieldprotectiongroup/internal"
...
func (j *jsiiProxy_ShieldProtectionGroup) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_ShieldProtectionGroup) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_ShieldProtectionGroup) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_ShieldProtectionGroup) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_ShieldProtectionGroup) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/shield_protection_group aws_shield_protection_group} Resource.
...
func (j *jsiiProxy_ShieldProtectionGroup)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_ShieldProtectionGroup)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_ShieldProtectionGroup)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func ShieldProtectionGroup_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateShieldProtectionGroup_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_ShieldProtectionGroup) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_ShieldProtectionGroup) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_ShieldProtectionGroup) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_ShieldProtectionGroup) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_ShieldProtectionGroup) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_ShieldProtectionGroup) MoveFromId(id *string) {
...
func (s *jsiiProxy_ShieldProtectionGroup) MoveToId(id *string) {
...
func (s *jsiiProxy_ShieldProtectionGroup) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_ShieldProtectionGroup) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
