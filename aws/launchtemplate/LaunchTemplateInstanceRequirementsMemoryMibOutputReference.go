...
func (l *jsiiProxy_LaunchTemplateInstanceRequirementsMemoryMibOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LaunchTemplateInstanceRequirementsMemoryMibOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
