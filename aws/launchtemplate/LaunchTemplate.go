...
func (l *jsiiProxy_LaunchTemplate) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (l *jsiiProxy_LaunchTemplate) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (l *jsiiProxy_LaunchTemplate) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
