...
func (l *jsiiProxy_LaunchTemplateCapacityReservationSpecificationOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LaunchTemplateCapacityReservationSpecificationOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
