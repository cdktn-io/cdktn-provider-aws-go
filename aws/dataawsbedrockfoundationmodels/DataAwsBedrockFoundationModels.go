...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.52.0/docs/data-sources/bedrock_foundation_models aws_bedrock_foundation_models}.
...
func (j *jsiiProxy_DataAwsBedrockFoundationModels) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsBedrockFoundationModels) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsBedrockFoundationModels) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsBedrockFoundationModels) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsBedrockFoundationModels) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.52.0/docs/data-sources/bedrock_foundation_models aws_bedrock_foundation_models} Data Source.
func NewDataAwsBedrockFoundationModels(scope constructs.Construct, id *string, config *DataAwsBedrockFoundationModelsConfig) DataAwsBedrockFoundationModels {
	...
	_jsii_.Create(
		"@cdktn/provider-aws.dataAwsBedrockFoundationModels.DataAwsBedrockFoundationModels",
...
func (j *jsiiProxy_DataAwsBedrockFoundationModels)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsBedrockFoundationModels)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsBedrockFoundationModels)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsBedrockFoundationModels_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsBedrockFoundationModels) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsBedrockFoundationModels) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsBedrockFoundationModels) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
