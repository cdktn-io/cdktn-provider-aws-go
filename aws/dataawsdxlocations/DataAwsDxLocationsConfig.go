...
type DataAwsDxLocationsConfig struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.32.1/docs/data-sources/dx_locations#region DataAwsDxLocations#region}
