...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/dataawseksnodegroups/internal"
...
func (j *jsiiProxy_DataAwsEksNodeGroups) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsEksNodeGroups) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsEksNodeGroups) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsEksNodeGroups) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsEksNodeGroups) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DataAwsEksNodeGroups)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsEksNodeGroups)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsEksNodeGroups)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsEksNodeGroups_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsEksNodeGroups) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsEksNodeGroups) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsEksNodeGroups) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsEksNodeGroups) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
