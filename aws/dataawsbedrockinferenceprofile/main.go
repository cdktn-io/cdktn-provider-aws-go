...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "inferenceProfileIdInput", GoGetter: "InferenceProfileIdInput"},
	...
	_jsii_.RegisterClass(
		...
		func() interface{} {
			j := jsiiProxy_DataAwsBedrockInferenceProfileModelsOutputReference{}
