...
func (j *jsiiProxy_DataAwsFsxWindowsFileSystemAuditLogConfigurationList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsFsxWindowsFileSystemAuditLogConfigurationList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsFsxWindowsFileSystemAuditLogConfigurationList {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-aws.dataAwsFsxWindowsFileSystem.DataAwsFsxWindowsFileSystemAuditLogConfigurationList",
...
func NewDataAwsFsxWindowsFileSystemAuditLogConfigurationList_Override(d DataAwsFsxWindowsFileSystemAuditLogConfigurationList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsFsxWindowsFileSystemAuditLogConfigurationList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsFsxWindowsFileSystemAuditLogConfigurationList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsFsxWindowsFileSystemAuditLogConfigurationList) Resolve(context cdktn.IResolveContext) interface{} {
