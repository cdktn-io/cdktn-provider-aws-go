...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-aws.ssmResourceDataSync.SsmResourceDataSyncConfig",
		reflect.TypeOf((*SsmResourceDataSyncConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-aws.ssmResourceDataSync.SsmResourceDataSyncS3Destination",
		reflect.TypeOf((*SsmResourceDataSyncS3Destination)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-aws.ssmResourceDataSync.SsmResourceDataSyncS3DestinationDestinationDataSharing",
		reflect.TypeOf((*SsmResourceDataSyncS3DestinationDestinationDataSharing)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-aws.ssmResourceDataSync.SsmResourceDataSyncS3DestinationDestinationDataSharingOutputReference",
		reflect.TypeOf((*SsmResourceDataSyncS3DestinationDestinationDataSharingOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
