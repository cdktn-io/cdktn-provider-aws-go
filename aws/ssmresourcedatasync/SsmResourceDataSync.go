...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/ssm_resource_data_sync aws_ssm_resource_data_sync}.
...
func (j *jsiiProxy_SsmResourceDataSync) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_SsmResourceDataSync) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_SsmResourceDataSync) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_SsmResourceDataSync) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_SsmResourceDataSync) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/ssm_resource_data_sync aws_ssm_resource_data_sync} Resource.
...
func (j *jsiiProxy_SsmResourceDataSync)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_SsmResourceDataSync)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_SsmResourceDataSync)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func SsmResourceDataSync_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (s *jsiiProxy_SsmResourceDataSync) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SsmResourceDataSync) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_SsmResourceDataSync) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SsmResourceDataSync) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_SsmResourceDataSync) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_SsmResourceDataSync) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
