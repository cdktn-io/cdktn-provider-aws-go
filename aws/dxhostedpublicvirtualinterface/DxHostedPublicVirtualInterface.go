...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/dxhostedpublicvirtualinterface/internal"
...
func (j *jsiiProxy_DxHostedPublicVirtualInterface) BgpAsnLong() *string {
	var returns *string
	_jsii_.Get(
		j,
		"bgpAsnLong",
...
func (j *jsiiProxy_DxHostedPublicVirtualInterface) BgpAsnLongInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"bgpAsnLongInput",
...
func (j *jsiiProxy_DxHostedPublicVirtualInterface) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DxHostedPublicVirtualInterface) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DxHostedPublicVirtualInterface) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DxHostedPublicVirtualInterface) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DxHostedPublicVirtualInterface) RateLimit() *string {
	var returns *string
	_jsii_.Get(
		j,
		"rateLimit",
...
func (j *jsiiProxy_DxHostedPublicVirtualInterface) RateLimitInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"rateLimitInput",
...
func (j *jsiiProxy_DxHostedPublicVirtualInterface) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.65.0/docs/resources/dx_hosted_public_virtual_interface aws_dx_hosted_public_virtual_interface} Resource.
...
func (j *jsiiProxy_DxHostedPublicVirtualInterface)SetBgpAsnLong(val *string) {
...
func (j *jsiiProxy_DxHostedPublicVirtualInterface)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DxHostedPublicVirtualInterface)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DxHostedPublicVirtualInterface)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_DxHostedPublicVirtualInterface)SetRateLimit(val *string) {
...
func DxHostedPublicVirtualInterface_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DxHostedPublicVirtualInterface) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DxHostedPublicVirtualInterface) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (d *jsiiProxy_DxHostedPublicVirtualInterface) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DxHostedPublicVirtualInterface) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (d *jsiiProxy_DxHostedPublicVirtualInterface) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DxHostedPublicVirtualInterface) ResetBgpAsn() {
	_jsii_.InvokeVoid(
		d,
		"resetBgpAsn",
		nil, // no parameters
...
func (d *jsiiProxy_DxHostedPublicVirtualInterface) ResetBgpAsnLong() {
	_jsii_.InvokeVoid(
		d,
		"resetBgpAsnLong",
		nil, // no parameters
...
func (d *jsiiProxy_DxHostedPublicVirtualInterface) ResetRateLimit() {
	_jsii_.InvokeVoid(
		d,
		"resetRateLimit",
		nil, // no parameters
...
func (d *jsiiProxy_DxHostedPublicVirtualInterface) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
