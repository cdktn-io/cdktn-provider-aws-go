...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-aws.lambdaPermission.LambdaPermissionTimeouts",
		reflect.TypeOf((*LambdaPermissionTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-aws.lambdaPermission.LambdaPermissionTimeoutsOutputReference",
		reflect.TypeOf((*LambdaPermissionTimeoutsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
