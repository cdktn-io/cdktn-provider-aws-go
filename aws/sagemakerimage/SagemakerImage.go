...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/sagemakerimage/internal"
...
func (j *jsiiProxy_SagemakerImage) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_SagemakerImage) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_SagemakerImage) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_SagemakerImage) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_SagemakerImage) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/sagemaker_image aws_sagemaker_image} Resource.
...
func (j *jsiiProxy_SagemakerImage)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_SagemakerImage)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_SagemakerImage)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func SagemakerImage_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (s *jsiiProxy_SagemakerImage) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SagemakerImage) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_SagemakerImage) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SagemakerImage) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_SagemakerImage) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_SagemakerImage) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
