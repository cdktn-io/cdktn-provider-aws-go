...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/codebuildsourcecredential/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/codebuild_source_credential aws_codebuild_source_credential}.
...
func (j *jsiiProxy_CodebuildSourceCredential) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_CodebuildSourceCredential) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_CodebuildSourceCredential) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_CodebuildSourceCredential) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_CodebuildSourceCredential) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_CodebuildSourceCredential) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_CodebuildSourceCredential) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/codebuild_source_credential aws_codebuild_source_credential} Resource.
func NewCodebuildSourceCredential(scope constructs.Construct, id *string, config *CodebuildSourceCredentialConfig) CodebuildSourceCredential {
	...
	if err := validateNewCodebuildSourceCredentialParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CodebuildSourceCredential)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_CodebuildSourceCredential)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_CodebuildSourceCredential)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_CodebuildSourceCredential)SetRegion(val *string) {
...
func CodebuildSourceCredential_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateCodebuildSourceCredential_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func CodebuildSourceCredential_IsConstruct(x interface{}) *bool {
	...
	if err := validateCodebuildSourceCredential_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func CodebuildSourceCredential_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCodebuildSourceCredential_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func CodebuildSourceCredential_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCodebuildSourceCredential_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CodebuildSourceCredential) AddMoveTarget(moveTarget *string) {
...
func (c *jsiiProxy_CodebuildSourceCredential) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CodebuildSourceCredential) HasResourceMove() interface{} {
	var returns interface{}
...
func (c *jsiiProxy_CodebuildSourceCredential) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (c *jsiiProxy_CodebuildSourceCredential) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CodebuildSourceCredential) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_CodebuildSourceCredential) MoveFromId(id *string) {
...
func (c *jsiiProxy_CodebuildSourceCredential) MoveTo(moveTarget *string, index interface{}) {
...
func (c *jsiiProxy_CodebuildSourceCredential) MoveToId(id *string) {
...
func (c *jsiiProxy_CodebuildSourceCredential) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (c *jsiiProxy_CodebuildSourceCredential) ResetRegion() {
	_jsii_.InvokeVoid(
		c,
		"resetRegion",
		nil, // no parameters
...
func (c *jsiiProxy_CodebuildSourceCredential) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (c *jsiiProxy_CodebuildSourceCredential) ToHclTerraform() interface{} {
	var returns interface{}
...
func (c *jsiiProxy_CodebuildSourceCredential) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
