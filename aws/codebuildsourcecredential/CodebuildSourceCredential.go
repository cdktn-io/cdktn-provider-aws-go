...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v22/codebuildsourcecredential/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.31.0/docs/resources/codebuild_source_credential aws_codebuild_source_credential}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.31.0/docs/resources/codebuild_source_credential aws_codebuild_source_credential} Resource.
...
func CodebuildSourceCredential_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (c *jsiiProxy_CodebuildSourceCredential) ImportFrom(id *string, provider cdktf.TerraformProvider) {
