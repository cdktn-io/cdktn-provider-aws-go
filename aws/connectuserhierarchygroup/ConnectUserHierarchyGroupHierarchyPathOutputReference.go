...
func (c *jsiiProxy_ConnectUserHierarchyGroupHierarchyPathOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ConnectUserHierarchyGroupHierarchyPathOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
