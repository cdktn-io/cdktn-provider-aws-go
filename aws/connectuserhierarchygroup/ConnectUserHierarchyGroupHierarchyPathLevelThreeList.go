...
func (j *jsiiProxy_ConnectUserHierarchyGroupHierarchyPathLevelThreeList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewConnectUserHierarchyGroupHierarchyPathLevelThreeList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ConnectUserHierarchyGroupHierarchyPathLevelThreeList {
	_init_.Initialize()
...
func NewConnectUserHierarchyGroupHierarchyPathLevelThreeList_Override(c ConnectUserHierarchyGroupHierarchyPathLevelThreeList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ConnectUserHierarchyGroupHierarchyPathLevelThreeList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_ConnectUserHierarchyGroupHierarchyPathLevelThreeList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (c *jsiiProxy_ConnectUserHierarchyGroupHierarchyPathLevelThreeList) Resolve(context cdktn.IResolveContext) interface{} {
