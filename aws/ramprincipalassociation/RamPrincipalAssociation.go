...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/ramprincipalassociation/internal"
...
func (j *jsiiProxy_RamPrincipalAssociation) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_RamPrincipalAssociation) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_RamPrincipalAssociation) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_RamPrincipalAssociation) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_RamPrincipalAssociation) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_RamPrincipalAssociation) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func NewRamPrincipalAssociation(scope constructs.Construct, id *string, config *RamPrincipalAssociationConfig) RamPrincipalAssociation {
	...
	if err := validateNewRamPrincipalAssociationParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_RamPrincipalAssociation)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_RamPrincipalAssociation)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_RamPrincipalAssociation)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func RamPrincipalAssociation_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateRamPrincipalAssociation_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (r *jsiiProxy_RamPrincipalAssociation) AddMoveTarget(moveTarget *string) {
...
func (r *jsiiProxy_RamPrincipalAssociation) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (r *jsiiProxy_RamPrincipalAssociation) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (r *jsiiProxy_RamPrincipalAssociation) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (r *jsiiProxy_RamPrincipalAssociation) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (r *jsiiProxy_RamPrincipalAssociation) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (r *jsiiProxy_RamPrincipalAssociation) ResetId() {
	_jsii_.InvokeVoid(
		r,
		"resetId",
		nil, // no parameters
...
func (r *jsiiProxy_RamPrincipalAssociation) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
