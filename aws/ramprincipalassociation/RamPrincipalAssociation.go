...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v21/ramprincipalassociation/internal"
...
func (j *jsiiProxy_RamPrincipalAssociation) ForEach() cdktf.ITerraformIterator {
...
func RamPrincipalAssociation_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
