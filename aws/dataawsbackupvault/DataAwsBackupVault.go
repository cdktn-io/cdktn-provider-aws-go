...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/dataawsbackupvault/internal"
...
func (j *jsiiProxy_DataAwsBackupVault) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsBackupVault) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsBackupVault) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsBackupVault) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsBackupVault) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/data-sources/backup_vault aws_backup_vault} Data Source.
...
func (j *jsiiProxy_DataAwsBackupVault)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsBackupVault)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsBackupVault)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsBackupVault_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsBackupVault) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsBackupVault) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsBackupVault) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsBackupVault) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
