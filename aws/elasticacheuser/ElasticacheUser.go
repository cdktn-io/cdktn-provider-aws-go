...
func (e *jsiiProxy_ElasticacheUser) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (e *jsiiProxy_ElasticacheUser) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
