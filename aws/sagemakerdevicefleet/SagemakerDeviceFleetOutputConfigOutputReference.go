...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v22/sagemakerdevicefleet/internal"
...
func NewSagemakerDeviceFleetOutputConfigOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) SagemakerDeviceFleetOutputConfigOutputReference {
	_init_.Initialize()
...
func NewSagemakerDeviceFleetOutputConfigOutputReference_Override(s SagemakerDeviceFleetOutputConfigOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (s *jsiiProxy_SagemakerDeviceFleetOutputConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_SagemakerDeviceFleetOutputConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
