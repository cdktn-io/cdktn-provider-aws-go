...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/sagemakerdevicefleet/internal"
...
func (j *jsiiProxy_SagemakerDeviceFleetOutputConfigOutputReference) ComplexObjectIndex() interface{} {
...
func (j *jsiiProxy_SagemakerDeviceFleetOutputConfigOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_SagemakerDeviceFleetOutputConfigOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_SagemakerDeviceFleetOutputConfigOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_SagemakerDeviceFleetOutputConfigOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewSagemakerDeviceFleetOutputConfigOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) SagemakerDeviceFleetOutputConfigOutputReference {
	_init_.Initialize()

	if err := validateNewSagemakerDeviceFleetOutputConfigOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
	j := jsiiProxy_SagemakerDeviceFleetOutputConfigOutputReference{}

	_jsii_.Create(
		"@cdktn/provider-aws.sagemakerDeviceFleet.SagemakerDeviceFleetOutputConfigOutputReference",
...
func NewSagemakerDeviceFleetOutputConfigOutputReference_Override(s SagemakerDeviceFleetOutputConfigOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_SagemakerDeviceFleetOutputConfigOutputReference)SetComplexObjectIndex(val interface{}) {
...
func (j *jsiiProxy_SagemakerDeviceFleetOutputConfigOutputReference)SetComplexObjectIsFromSet(val *bool) {
...
func (j *jsiiProxy_SagemakerDeviceFleetOutputConfigOutputReference)SetS3OutputLocation(val *string) {
	if err := j.validateSetS3OutputLocationParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_SagemakerDeviceFleetOutputConfigOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_SagemakerDeviceFleetOutputConfigOutputReference) ComputeFqn() *string {
	var returns *string
...
func (s *jsiiProxy_SagemakerDeviceFleetOutputConfigOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SagemakerDeviceFleetOutputConfigOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (s *jsiiProxy_SagemakerDeviceFleetOutputConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SagemakerDeviceFleetOutputConfigOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
...
func (s *jsiiProxy_SagemakerDeviceFleetOutputConfigOutputReference) ToString() *string {
	var returns *string
