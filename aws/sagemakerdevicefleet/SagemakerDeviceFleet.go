...
func (j *jsiiProxy_SagemakerDeviceFleet) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_SagemakerDeviceFleet) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_SagemakerDeviceFleet) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_SagemakerDeviceFleet) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_SagemakerDeviceFleet) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/sagemaker_device_fleet aws_sagemaker_device_fleet} Resource.
...
func (j *jsiiProxy_SagemakerDeviceFleet)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_SagemakerDeviceFleet)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_SagemakerDeviceFleet)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func SagemakerDeviceFleet_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (s *jsiiProxy_SagemakerDeviceFleet) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SagemakerDeviceFleet) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_SagemakerDeviceFleet) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SagemakerDeviceFleet) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_SagemakerDeviceFleet) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_SagemakerDeviceFleet) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
