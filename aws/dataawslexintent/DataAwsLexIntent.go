...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/dataawslexintent/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/data-sources/lex_intent aws_lex_intent}.
...
func (j *jsiiProxy_DataAwsLexIntent) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsLexIntent) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsLexIntent) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsLexIntent) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsLexIntent) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DataAwsLexIntent) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_DataAwsLexIntent) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/data-sources/lex_intent aws_lex_intent} Data Source.
...
func (j *jsiiProxy_DataAwsLexIntent)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsLexIntent)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsLexIntent)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_DataAwsLexIntent)SetRegion(val *string) {
...
// Generates CDKTN code for importing a DataAwsLexIntent resource upon running "cdktn plan <stack-name>".
func DataAwsLexIntent_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateDataAwsLexIntent_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
// Experimental.
func DataAwsLexIntent_IsTerraformDataSource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataAwsLexIntent_IsTerraformDataSourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataAwsLexIntent_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataAwsLexIntent_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (d *jsiiProxy_DataAwsLexIntent) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsLexIntent) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsLexIntent) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsLexIntent) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsLexIntent) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataAwsLexIntent) ToHclTerraform() interface{} {
	var returns interface{}
...
func (d *jsiiProxy_DataAwsLexIntent) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
