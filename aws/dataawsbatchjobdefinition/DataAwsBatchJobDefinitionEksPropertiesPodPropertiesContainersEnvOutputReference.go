...
func (d *jsiiProxy_DataAwsBatchJobDefinitionEksPropertiesPodPropertiesContainersEnvOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataAwsBatchJobDefinitionEksPropertiesPodPropertiesContainersEnvOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
