...
func (j *jsiiProxy_DataAwsBatchJobDefinitionEksPropertiesPodPropertiesVolumesHostPathList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsBatchJobDefinitionEksPropertiesPodPropertiesVolumesHostPathList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsBatchJobDefinitionEksPropertiesPodPropertiesVolumesHostPathList {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-aws.dataAwsBatchJobDefinition.DataAwsBatchJobDefinitionEksPropertiesPodPropertiesVolumesHostPathList",
...
func NewDataAwsBatchJobDefinitionEksPropertiesPodPropertiesVolumesHostPathList_Override(d DataAwsBatchJobDefinitionEksPropertiesPodPropertiesVolumesHostPathList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsBatchJobDefinitionEksPropertiesPodPropertiesVolumesHostPathList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsBatchJobDefinitionEksPropertiesPodPropertiesVolumesHostPathList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsBatchJobDefinitionEksPropertiesPodPropertiesVolumesHostPathList) Resolve(context cdktn.IResolveContext) interface{} {
