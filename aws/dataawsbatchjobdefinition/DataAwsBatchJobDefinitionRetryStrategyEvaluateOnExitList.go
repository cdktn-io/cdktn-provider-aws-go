...
func (j *jsiiProxy_DataAwsBatchJobDefinitionRetryStrategyEvaluateOnExitList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsBatchJobDefinitionRetryStrategyEvaluateOnExitList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsBatchJobDefinitionRetryStrategyEvaluateOnExitList {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-aws.dataAwsBatchJobDefinition.DataAwsBatchJobDefinitionRetryStrategyEvaluateOnExitList",
...
func NewDataAwsBatchJobDefinitionRetryStrategyEvaluateOnExitList_Override(d DataAwsBatchJobDefinitionRetryStrategyEvaluateOnExitList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsBatchJobDefinitionRetryStrategyEvaluateOnExitList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsBatchJobDefinitionRetryStrategyEvaluateOnExitList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsBatchJobDefinitionRetryStrategyEvaluateOnExitList) Resolve(context cdktn.IResolveContext) interface{} {
