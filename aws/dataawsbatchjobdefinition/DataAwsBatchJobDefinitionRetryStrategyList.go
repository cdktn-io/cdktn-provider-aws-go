...
func (j *jsiiProxy_DataAwsBatchJobDefinitionRetryStrategyList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewDataAwsBatchJobDefinitionRetryStrategyList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsBatchJobDefinitionRetryStrategyList {
	_init_.Initialize()
...
func NewDataAwsBatchJobDefinitionRetryStrategyList_Override(d DataAwsBatchJobDefinitionRetryStrategyList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsBatchJobDefinitionRetryStrategyList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsBatchJobDefinitionRetryStrategyList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsBatchJobDefinitionRetryStrategyList) Resolve(context cdktf.IResolveContext) interface{} {
