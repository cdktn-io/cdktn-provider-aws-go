...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/storagegatewayworkingstorage/internal"
...
func (j *jsiiProxy_StoragegatewayWorkingStorage) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_StoragegatewayWorkingStorage) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_StoragegatewayWorkingStorage) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_StoragegatewayWorkingStorage) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_StoragegatewayWorkingStorage) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/storagegateway_working_storage aws_storagegateway_working_storage} Resource.
func NewStoragegatewayWorkingStorage(scope constructs.Construct, id *string, config *StoragegatewayWorkingStorageConfig) StoragegatewayWorkingStorage {
	...
	_jsii_.Create(
		"@cdktn/provider-aws.storagegatewayWorkingStorage.StoragegatewayWorkingStorage",
...
func (j *jsiiProxy_StoragegatewayWorkingStorage)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_StoragegatewayWorkingStorage)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_StoragegatewayWorkingStorage)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func StoragegatewayWorkingStorage_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (s *jsiiProxy_StoragegatewayWorkingStorage) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_StoragegatewayWorkingStorage) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_StoragegatewayWorkingStorage) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_StoragegatewayWorkingStorage) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_StoragegatewayWorkingStorage) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_StoragegatewayWorkingStorage) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
