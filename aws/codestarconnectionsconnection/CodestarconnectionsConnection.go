...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/codestarconnectionsconnection/internal"
...
func (j *jsiiProxy_CodestarconnectionsConnection) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_CodestarconnectionsConnection) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_CodestarconnectionsConnection) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_CodestarconnectionsConnection) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_CodestarconnectionsConnection) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/codestarconnections_connection aws_codestarconnections_connection} Resource.
...
func (j *jsiiProxy_CodestarconnectionsConnection)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_CodestarconnectionsConnection)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_CodestarconnectionsConnection)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func CodestarconnectionsConnection_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (c *jsiiProxy_CodestarconnectionsConnection) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CodestarconnectionsConnection) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (c *jsiiProxy_CodestarconnectionsConnection) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CodestarconnectionsConnection) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_CodestarconnectionsConnection) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (c *jsiiProxy_CodestarconnectionsConnection) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
