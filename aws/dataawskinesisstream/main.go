...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-aws.dataAwsKinesisStream.DataAwsKinesisStreamWarmThroughput",
		reflect.TypeOf((*DataAwsKinesisStreamWarmThroughput)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-aws.dataAwsKinesisStream.DataAwsKinesisStreamWarmThroughputList",
		reflect.TypeOf((*DataAwsKinesisStreamWarmThroughputList)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "allWithMapKey", GoMethod: "AllWithMapKey"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
		...
		func() interface{} {
			j := jsiiProxy_DataAwsKinesisStreamWarmThroughputList{}
			_jsii_.InitJsiiProxy(&j.Type__cdktnComplexList)
			return &j
		},
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-aws.dataAwsKinesisStream.DataAwsKinesisStreamWarmThroughputOutputReference",
		reflect.TypeOf((*DataAwsKinesisStreamWarmThroughputOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
		...
		func() interface{} {
			j := jsiiProxy_DataAwsKinesisStreamWarmThroughputOutputReference{}
			_jsii_.InitJsiiProxy(&j.Type__cdktnComplexObject)
			return &j
		},
	)
