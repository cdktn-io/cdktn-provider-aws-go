...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/dataawsconnectinstance/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/data-sources/connect_instance aws_connect_instance}.
type DataAwsConnectInstance interface {
	cdktn.TerraformDataSource
	Arn() *string
	AutoResolveBestVoicesEnabled() cdktn.IResolvable
	// Experimental.
	CdktfStack() cdktn.TerraformStack
	// Experimental.
	ConstructNodeMetadata() *map[string]interface{}
	ContactFlowLogsEnabled() cdktn.IResolvable
	ContactLensEnabled() cdktn.IResolvable
	// Experimental.
	Count() interface{}
	// Experimental.
	...
	EarlyMediaEnabled() cdktn.IResolvable
	// Experimental.
	...
	IdInput() *string
	InboundCallsEnabled() cdktn.IResolvable
	...
	MultiPartyConferenceEnabled() cdktn.IResolvable
	// The tree node.
	Node() constructs.Node
	OutboundCallsEnabled() cdktn.IResolvable
	// Experimental.
...
func (j *jsiiProxy_DataAwsConnectInstance) AutoResolveBestVoicesEnabled() cdktn.IResolvable {
...
func (j *jsiiProxy_DataAwsConnectInstance) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsConnectInstance) ContactFlowLogsEnabled() cdktn.IResolvable {
	var returns cdktn.IResolvable
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataAwsConnectInstance) ContactLensEnabled() cdktn.IResolvable {
	var returns cdktn.IResolvable
	_jsii_.Get(
		j,
		"contactLensEnabled",
...
func (j *jsiiProxy_DataAwsConnectInstance) EarlyMediaEnabled() cdktn.IResolvable {
	var returns cdktn.IResolvable
	_jsii_.Get(
		j,
		"earlyMediaEnabled",
...
func (j *jsiiProxy_DataAwsConnectInstance) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsConnectInstance) InboundCallsEnabled() cdktn.IResolvable {
	var returns cdktn.IResolvable
	_jsii_.Get(
		j,
		"inboundCallsEnabled",
...
func (j *jsiiProxy_DataAwsConnectInstance) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsConnectInstance) MultiPartyConferenceEnabled() cdktn.IResolvable {
	var returns cdktn.IResolvable
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataAwsConnectInstance) OutboundCallsEnabled() cdktn.IResolvable {
	var returns cdktn.IResolvable
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataAwsConnectInstance) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsConnectInstance) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DataAwsConnectInstance) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_DataAwsConnectInstance) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/data-sources/connect_instance aws_connect_instance} Data Source.
...
func (j *jsiiProxy_DataAwsConnectInstance)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsConnectInstance)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsConnectInstance)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_DataAwsConnectInstance)SetRegion(val *string) {
...
func DataAwsConnectInstance_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsConnectInstance) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsConnectInstance) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsConnectInstance) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsConnectInstance) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsConnectInstance) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
