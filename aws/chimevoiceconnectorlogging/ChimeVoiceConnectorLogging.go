...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/chimevoiceconnectorlogging/internal"
...
func (j *jsiiProxy_ChimeVoiceConnectorLogging) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_ChimeVoiceConnectorLogging) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_ChimeVoiceConnectorLogging) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_ChimeVoiceConnectorLogging) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_ChimeVoiceConnectorLogging) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_ChimeVoiceConnectorLogging)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_ChimeVoiceConnectorLogging)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_ChimeVoiceConnectorLogging)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func ChimeVoiceConnectorLogging_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (c *jsiiProxy_ChimeVoiceConnectorLogging) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_ChimeVoiceConnectorLogging) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (c *jsiiProxy_ChimeVoiceConnectorLogging) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_ChimeVoiceConnectorLogging) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_ChimeVoiceConnectorLogging) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (c *jsiiProxy_ChimeVoiceConnectorLogging) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
