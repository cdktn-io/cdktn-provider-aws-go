...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/dynamodbtag/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/dynamodb_tag aws_dynamodb_tag}.
...
func (j *jsiiProxy_DynamodbTag) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DynamodbTag) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DynamodbTag) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DynamodbTag) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DynamodbTag) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DynamodbTag) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_DynamodbTag) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/dynamodb_tag aws_dynamodb_tag} Resource.
func NewDynamodbTag(scope constructs.Construct, id *string, config *DynamodbTagConfig) DynamodbTag {
	...
	_jsii_.Create(
		"@cdktn/provider-aws.dynamodbTag.DynamodbTag",
...
func (j *jsiiProxy_DynamodbTag)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DynamodbTag)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DynamodbTag)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_DynamodbTag)SetRegion(val *string) {
...
// Generates CDKTN code for importing a DynamodbTag resource upon running "cdktn plan <stack-name>".
func DynamodbTag_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateDynamodbTag_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DynamodbTag) AddMoveTarget(moveTarget *string) {
...
func (d *jsiiProxy_DynamodbTag) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DynamodbTag) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (d *jsiiProxy_DynamodbTag) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DynamodbTag) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (d *jsiiProxy_DynamodbTag) MoveFromId(id *string) {
...
func (d *jsiiProxy_DynamodbTag) MoveToId(id *string) {
...
func (d *jsiiProxy_DynamodbTag) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DynamodbTag) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
...
func (d *jsiiProxy_DynamodbTag) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
