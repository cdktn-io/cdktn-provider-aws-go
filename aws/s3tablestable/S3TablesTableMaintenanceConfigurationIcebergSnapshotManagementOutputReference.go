...
func (j *jsiiProxy_S3TablesTableMaintenanceConfigurationIcebergSnapshotManagementOutputReference) TerraformResource() cdktf.IInterpolatingParent {
...
func NewS3TablesTableMaintenanceConfigurationIcebergSnapshotManagementOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) S3TablesTableMaintenanceConfigurationIcebergSnapshotManagementOutputReference {
	_init_.Initialize()
...
func NewS3TablesTableMaintenanceConfigurationIcebergSnapshotManagementOutputReference_Override(s S3TablesTableMaintenanceConfigurationIcebergSnapshotManagementOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_S3TablesTableMaintenanceConfigurationIcebergSnapshotManagementOutputReference)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (s *jsiiProxy_S3TablesTableMaintenanceConfigurationIcebergSnapshotManagementOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_S3TablesTableMaintenanceConfigurationIcebergSnapshotManagementOutputReference) InterpolationAsList() cdktf.IResolvable {
	var returns cdktf.IResolvable
