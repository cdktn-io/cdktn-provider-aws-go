...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/dataawscurreportdefinition/internal"
...
type DataAwsCurReportDefinition interface {
	...
	RefreshClosedReports() cdktn.IResolvable
	ReportName() *string
...
func (j *jsiiProxy_DataAwsCurReportDefinition) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsCurReportDefinition) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsCurReportDefinition) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsCurReportDefinition) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsCurReportDefinition) RefreshClosedReports() cdktn.IResolvable {
...
func (j *jsiiProxy_DataAwsCurReportDefinition) Tags() *map[string]*string {
...
func (j *jsiiProxy_DataAwsCurReportDefinition) TagsInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsInput",
...
func (j *jsiiProxy_DataAwsCurReportDefinition) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func NewDataAwsCurReportDefinition(scope constructs.Construct, id *string, config *DataAwsCurReportDefinitionConfig) DataAwsCurReportDefinition {
	...
	if err := validateNewDataAwsCurReportDefinitionParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_DataAwsCurReportDefinition)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsCurReportDefinition)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsCurReportDefinition)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_DataAwsCurReportDefinition)SetTags(val *map[string]*string) {
...
func DataAwsCurReportDefinition_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateDataAwsCurReportDefinition_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataAwsCurReportDefinition) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsCurReportDefinition) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsCurReportDefinition) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsCurReportDefinition) ResetTags() {
	_jsii_.InvokeVoid(
		d,
		"resetTags",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsCurReportDefinition) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
