...
func (d *jsiiProxy_DataAwsElasticsearchDomainAdvancedSecurityOptionsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataAwsElasticsearchDomainAdvancedSecurityOptionsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
