...
func (d *jsiiProxy_DataAwsElasticsearchDomainEncryptionAtRestOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataAwsElasticsearchDomainEncryptionAtRestOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
