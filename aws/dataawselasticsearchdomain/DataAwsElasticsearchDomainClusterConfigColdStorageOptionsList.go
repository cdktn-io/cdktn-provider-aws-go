...
func (j *jsiiProxy_DataAwsElasticsearchDomainClusterConfigColdStorageOptionsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsElasticsearchDomainClusterConfigColdStorageOptionsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsElasticsearchDomainClusterConfigColdStorageOptionsList {
	_init_.Initialize()
...
func NewDataAwsElasticsearchDomainClusterConfigColdStorageOptionsList_Override(d DataAwsElasticsearchDomainClusterConfigColdStorageOptionsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsElasticsearchDomainClusterConfigColdStorageOptionsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsElasticsearchDomainClusterConfigColdStorageOptionsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsElasticsearchDomainClusterConfigColdStorageOptionsList) Resolve(context cdktn.IResolveContext) interface{} {
