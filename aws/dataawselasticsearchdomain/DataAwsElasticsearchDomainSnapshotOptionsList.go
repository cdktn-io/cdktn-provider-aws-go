...
func (j *jsiiProxy_DataAwsElasticsearchDomainSnapshotOptionsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsElasticsearchDomainSnapshotOptionsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsElasticsearchDomainSnapshotOptionsList {
	_init_.Initialize()
...
func NewDataAwsElasticsearchDomainSnapshotOptionsList_Override(d DataAwsElasticsearchDomainSnapshotOptionsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsElasticsearchDomainSnapshotOptionsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsElasticsearchDomainSnapshotOptionsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsElasticsearchDomainSnapshotOptionsList) Resolve(context cdktn.IResolveContext) interface{} {
