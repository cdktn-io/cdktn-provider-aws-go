...
func (d *jsiiProxy_DataAwsElasticsearchDomainNodeToNodeEncryptionOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataAwsElasticsearchDomainNodeToNodeEncryptionOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
