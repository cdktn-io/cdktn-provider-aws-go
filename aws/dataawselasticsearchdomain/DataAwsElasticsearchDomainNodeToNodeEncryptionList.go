...
func (j *jsiiProxy_DataAwsElasticsearchDomainNodeToNodeEncryptionList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsElasticsearchDomainNodeToNodeEncryptionList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsElasticsearchDomainNodeToNodeEncryptionList {
	_init_.Initialize()
...
func NewDataAwsElasticsearchDomainNodeToNodeEncryptionList_Override(d DataAwsElasticsearchDomainNodeToNodeEncryptionList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsElasticsearchDomainNodeToNodeEncryptionList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsElasticsearchDomainNodeToNodeEncryptionList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsElasticsearchDomainNodeToNodeEncryptionList) Resolve(context cdktn.IResolveContext) interface{} {
