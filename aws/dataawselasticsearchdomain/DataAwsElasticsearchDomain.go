...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/data-sources/elasticsearch_domain aws_elasticsearch_domain} Data Source.
...
func (d *jsiiProxy_DataAwsElasticsearchDomain) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsElasticsearchDomain) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
