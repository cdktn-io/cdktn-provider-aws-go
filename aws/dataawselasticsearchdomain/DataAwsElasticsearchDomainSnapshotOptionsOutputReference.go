...
func (d *jsiiProxy_DataAwsElasticsearchDomainSnapshotOptionsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataAwsElasticsearchDomainSnapshotOptionsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
