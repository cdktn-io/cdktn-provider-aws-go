...
func (j *jsiiProxy_DataAwsElasticsearchDomainEncryptionAtRestList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsElasticsearchDomainEncryptionAtRestList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsElasticsearchDomainEncryptionAtRestList {
	_init_.Initialize()
...
func NewDataAwsElasticsearchDomainEncryptionAtRestList_Override(d DataAwsElasticsearchDomainEncryptionAtRestList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsElasticsearchDomainEncryptionAtRestList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsElasticsearchDomainEncryptionAtRestList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsElasticsearchDomainEncryptionAtRestList) Resolve(context cdktn.IResolveContext) interface{} {
