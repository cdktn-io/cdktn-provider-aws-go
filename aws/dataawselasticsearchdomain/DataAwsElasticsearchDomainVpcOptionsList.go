...
func (j *jsiiProxy_DataAwsElasticsearchDomainVpcOptionsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsElasticsearchDomainVpcOptionsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsElasticsearchDomainVpcOptionsList {
	_init_.Initialize()
...
func NewDataAwsElasticsearchDomainVpcOptionsList_Override(d DataAwsElasticsearchDomainVpcOptionsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsElasticsearchDomainVpcOptionsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsElasticsearchDomainVpcOptionsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsElasticsearchDomainVpcOptionsList) Resolve(context cdktn.IResolveContext) interface{} {
