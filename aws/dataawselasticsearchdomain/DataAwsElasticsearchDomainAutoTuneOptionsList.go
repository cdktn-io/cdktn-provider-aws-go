...
func (j *jsiiProxy_DataAwsElasticsearchDomainAutoTuneOptionsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsElasticsearchDomainAutoTuneOptionsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsElasticsearchDomainAutoTuneOptionsList {
	_init_.Initialize()

	if err := validateNewDataAwsElasticsearchDomainAutoTuneOptionsListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewDataAwsElasticsearchDomainAutoTuneOptionsList_Override(d DataAwsElasticsearchDomainAutoTuneOptionsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsElasticsearchDomainAutoTuneOptionsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsElasticsearchDomainAutoTuneOptionsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsElasticsearchDomainAutoTuneOptionsList) Resolve(context cdktn.IResolveContext) interface{} {
