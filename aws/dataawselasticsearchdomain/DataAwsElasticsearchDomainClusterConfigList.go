...
func (j *jsiiProxy_DataAwsElasticsearchDomainClusterConfigList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsElasticsearchDomainClusterConfigList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsElasticsearchDomainClusterConfigList {
	_init_.Initialize()
...
func NewDataAwsElasticsearchDomainClusterConfigList_Override(d DataAwsElasticsearchDomainClusterConfigList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsElasticsearchDomainClusterConfigList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsElasticsearchDomainClusterConfigList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsElasticsearchDomainClusterConfigList) Resolve(context cdktn.IResolveContext) interface{} {
