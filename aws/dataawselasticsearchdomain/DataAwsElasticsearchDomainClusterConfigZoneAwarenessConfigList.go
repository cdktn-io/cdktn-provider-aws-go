...
func (j *jsiiProxy_DataAwsElasticsearchDomainClusterConfigZoneAwarenessConfigList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsElasticsearchDomainClusterConfigZoneAwarenessConfigList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsElasticsearchDomainClusterConfigZoneAwarenessConfigList {
	_init_.Initialize()
...
func NewDataAwsElasticsearchDomainClusterConfigZoneAwarenessConfigList_Override(d DataAwsElasticsearchDomainClusterConfigZoneAwarenessConfigList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsElasticsearchDomainClusterConfigZoneAwarenessConfigList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsElasticsearchDomainClusterConfigZoneAwarenessConfigList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsElasticsearchDomainClusterConfigZoneAwarenessConfigList) Resolve(context cdktn.IResolveContext) interface{} {
