...
func (j *jsiiProxy_DataAwsElasticsearchDomainCognitoOptionsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsElasticsearchDomainCognitoOptionsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsElasticsearchDomainCognitoOptionsList {
	_init_.Initialize()
...
func NewDataAwsElasticsearchDomainCognitoOptionsList_Override(d DataAwsElasticsearchDomainCognitoOptionsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsElasticsearchDomainCognitoOptionsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsElasticsearchDomainCognitoOptionsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsElasticsearchDomainCognitoOptionsList) Resolve(context cdktn.IResolveContext) interface{} {
