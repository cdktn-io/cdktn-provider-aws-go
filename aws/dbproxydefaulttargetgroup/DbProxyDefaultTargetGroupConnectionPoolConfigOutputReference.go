...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v22/dbproxydefaulttargetgroup/internal"
...
func (d *jsiiProxy_DbProxyDefaultTargetGroupConnectionPoolConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DbProxyDefaultTargetGroupConnectionPoolConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
