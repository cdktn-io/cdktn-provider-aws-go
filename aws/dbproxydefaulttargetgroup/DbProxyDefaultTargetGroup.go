...
func (j *jsiiProxy_DbProxyDefaultTargetGroup) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DbProxyDefaultTargetGroup) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DbProxyDefaultTargetGroup) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DbProxyDefaultTargetGroup) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DbProxyDefaultTargetGroup) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/db_proxy_default_target_group aws_db_proxy_default_target_group} Resource.
...
func (j *jsiiProxy_DbProxyDefaultTargetGroup)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DbProxyDefaultTargetGroup)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DbProxyDefaultTargetGroup)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DbProxyDefaultTargetGroup_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DbProxyDefaultTargetGroup) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DbProxyDefaultTargetGroup) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (d *jsiiProxy_DbProxyDefaultTargetGroup) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DbProxyDefaultTargetGroup) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (d *jsiiProxy_DbProxyDefaultTargetGroup) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DbProxyDefaultTargetGroup) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
