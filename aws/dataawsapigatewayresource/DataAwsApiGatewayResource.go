...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/dataawsapigatewayresource/internal"
...
func (j *jsiiProxy_DataAwsApiGatewayResource) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsApiGatewayResource) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsApiGatewayResource) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsApiGatewayResource) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsApiGatewayResource) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DataAwsApiGatewayResource) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_DataAwsApiGatewayResource) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/data-sources/api_gateway_resource aws_api_gateway_resource} Data Source.
...
func (j *jsiiProxy_DataAwsApiGatewayResource)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsApiGatewayResource)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsApiGatewayResource)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_DataAwsApiGatewayResource)SetRegion(val *string) {
...
func DataAwsApiGatewayResource_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsApiGatewayResource) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsApiGatewayResource) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsApiGatewayResource) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsApiGatewayResource) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsApiGatewayResource) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
