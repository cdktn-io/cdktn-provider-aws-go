...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/data-sources/imagebuilder_image_pipeline aws_imagebuilder_image_pipeline}.
type DataAwsImagebuilderImagePipeline interface {
	...
	EnhancedImageMetadataEnabled() cdktn.IResolvable
	// Experimental.
...
func (j *jsiiProxy_DataAwsImagebuilderImagePipeline) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsImagebuilderImagePipeline) ContainerRecipeArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"containerRecipeArn",
...
func (j *jsiiProxy_DataAwsImagebuilderImagePipeline) EnhancedImageMetadataEnabled() cdktn.IResolvable {
...
func (j *jsiiProxy_DataAwsImagebuilderImagePipeline) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsImagebuilderImagePipeline) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_DataAwsImagebuilderImagePipeline) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsImagebuilderImagePipeline) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsImagebuilderImagePipeline) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/data-sources/imagebuilder_image_pipeline aws_imagebuilder_image_pipeline} Data Source.
func NewDataAwsImagebuilderImagePipeline(scope constructs.Construct, id *string, config *DataAwsImagebuilderImagePipelineConfig) DataAwsImagebuilderImagePipeline {
	...
	if err := validateNewDataAwsImagebuilderImagePipelineParameters(scope, id, config); err != nil {
		panic(err)
	}
	j := jsiiProxy_DataAwsImagebuilderImagePipeline{}

	_jsii_.Create(
		"@cdktn/provider-aws.dataAwsImagebuilderImagePipeline.DataAwsImagebuilderImagePipeline",
...
func (j *jsiiProxy_DataAwsImagebuilderImagePipeline)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsImagebuilderImagePipeline)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsImagebuilderImagePipeline)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsImagebuilderImagePipeline_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateDataAwsImagebuilderImagePipeline_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataAwsImagebuilderImagePipeline) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsImagebuilderImagePipeline) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsImagebuilderImagePipeline) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsImagebuilderImagePipeline) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsImagebuilderImagePipeline) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
