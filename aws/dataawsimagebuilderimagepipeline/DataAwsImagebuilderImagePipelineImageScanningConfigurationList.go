...
func (j *jsiiProxy_DataAwsImagebuilderImagePipelineImageScanningConfigurationList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsImagebuilderImagePipelineImageScanningConfigurationList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsImagebuilderImagePipelineImageScanningConfigurationList {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-aws.dataAwsImagebuilderImagePipeline.DataAwsImagebuilderImagePipelineImageScanningConfigurationList",
...
func NewDataAwsImagebuilderImagePipelineImageScanningConfigurationList_Override(d DataAwsImagebuilderImagePipelineImageScanningConfigurationList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsImagebuilderImagePipelineImageScanningConfigurationList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsImagebuilderImagePipelineImageScanningConfigurationList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsImagebuilderImagePipelineImageScanningConfigurationList) Resolve(context cdktn.IResolveContext) interface{} {
