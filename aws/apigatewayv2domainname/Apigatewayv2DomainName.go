...
func (j *jsiiProxy_Apigatewayv2DomainName) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_Apigatewayv2DomainName) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_Apigatewayv2DomainName) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_Apigatewayv2DomainName) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_Apigatewayv2DomainName) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_Apigatewayv2DomainName) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_Apigatewayv2DomainName) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_Apigatewayv2DomainName)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_Apigatewayv2DomainName)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_Apigatewayv2DomainName)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_Apigatewayv2DomainName)SetRegion(val *string) {
...
func Apigatewayv2DomainName_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (a *jsiiProxy_Apigatewayv2DomainName) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_Apigatewayv2DomainName) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (a *jsiiProxy_Apigatewayv2DomainName) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_Apigatewayv2DomainName) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (a *jsiiProxy_Apigatewayv2DomainName) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (a *jsiiProxy_Apigatewayv2DomainName) ResetRegion() {
	_jsii_.InvokeVoid(
		a,
		"resetRegion",
		nil, // no parameters
...
func (a *jsiiProxy_Apigatewayv2DomainName) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
