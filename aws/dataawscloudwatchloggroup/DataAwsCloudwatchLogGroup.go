...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/dataawscloudwatchloggroup/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/data-sources/cloudwatch_log_group aws_cloudwatch_log_group}.
...
func (j *jsiiProxy_DataAwsCloudwatchLogGroup) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsCloudwatchLogGroup) DeletionProtectionEnabled() cdktn.IResolvable {
...
func (j *jsiiProxy_DataAwsCloudwatchLogGroup) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsCloudwatchLogGroup) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsCloudwatchLogGroup) LogGroupClass() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logGroupClass",
...
func (j *jsiiProxy_DataAwsCloudwatchLogGroup) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsCloudwatchLogGroup) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DataAwsCloudwatchLogGroup) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_DataAwsCloudwatchLogGroup) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/data-sources/cloudwatch_log_group aws_cloudwatch_log_group} Data Source.
func NewDataAwsCloudwatchLogGroup(scope constructs.Construct, id *string, config *DataAwsCloudwatchLogGroupConfig) DataAwsCloudwatchLogGroup {
	...
	_jsii_.Create(
		"@cdktn/provider-aws.dataAwsCloudwatchLogGroup.DataAwsCloudwatchLogGroup",
...
func (j *jsiiProxy_DataAwsCloudwatchLogGroup)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsCloudwatchLogGroup)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsCloudwatchLogGroup)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_DataAwsCloudwatchLogGroup)SetRegion(val *string) {
...
// Generates CDKTN code for importing a DataAwsCloudwatchLogGroup resource upon running "cdktn plan <stack-name>".
func DataAwsCloudwatchLogGroup_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsCloudwatchLogGroup) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsCloudwatchLogGroup) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsCloudwatchLogGroup) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsCloudwatchLogGroup) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsCloudwatchLogGroup) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
