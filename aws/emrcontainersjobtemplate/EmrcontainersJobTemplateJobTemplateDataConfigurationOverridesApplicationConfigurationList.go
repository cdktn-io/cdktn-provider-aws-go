...
func (e *jsiiProxy_EmrcontainersJobTemplateJobTemplateDataConfigurationOverridesApplicationConfigurationList) Resolve(context cdktf.IResolveContext) interface{} {
