...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/data-sources/glue_catalog_table aws_glue_catalog_table}.
...
func (j *jsiiProxy_DataAwsGlueCatalogTable) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsGlueCatalogTable) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsGlueCatalogTable) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsGlueCatalogTable) Parameters() cdktn.StringMap {
...
func (j *jsiiProxy_DataAwsGlueCatalogTable) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsGlueCatalogTable) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/data-sources/glue_catalog_table aws_glue_catalog_table} Data Source.
...
func (j *jsiiProxy_DataAwsGlueCatalogTable)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsGlueCatalogTable)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsGlueCatalogTable)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsGlueCatalogTable_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateDataAwsGlueCatalogTable_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataAwsGlueCatalogTable) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsGlueCatalogTable) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsGlueCatalogTable) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsGlueCatalogTable) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
