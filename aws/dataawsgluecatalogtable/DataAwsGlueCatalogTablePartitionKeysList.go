...
func (j *jsiiProxy_DataAwsGlueCatalogTablePartitionKeysList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsGlueCatalogTablePartitionKeysList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsGlueCatalogTablePartitionKeysList {
	_init_.Initialize()
...
func NewDataAwsGlueCatalogTablePartitionKeysList_Override(d DataAwsGlueCatalogTablePartitionKeysList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsGlueCatalogTablePartitionKeysList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsGlueCatalogTablePartitionKeysList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsGlueCatalogTablePartitionKeysList) Resolve(context cdktn.IResolveContext) interface{} {
