...
func (j *jsiiProxy_DataAwsGlueCatalogTableStorageDescriptorColumnsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsGlueCatalogTableStorageDescriptorColumnsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsGlueCatalogTableStorageDescriptorColumnsList {
	_init_.Initialize()
...
func NewDataAwsGlueCatalogTableStorageDescriptorColumnsList_Override(d DataAwsGlueCatalogTableStorageDescriptorColumnsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsGlueCatalogTableStorageDescriptorColumnsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsGlueCatalogTableStorageDescriptorColumnsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsGlueCatalogTableStorageDescriptorColumnsList) Resolve(context cdktn.IResolveContext) interface{} {
