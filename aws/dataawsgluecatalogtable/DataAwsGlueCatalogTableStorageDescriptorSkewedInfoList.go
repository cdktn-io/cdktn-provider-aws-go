...
func (d *jsiiProxy_DataAwsGlueCatalogTableStorageDescriptorSkewedInfoList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsGlueCatalogTableStorageDescriptorSkewedInfoList) Resolve(context cdktf.IResolveContext) interface{} {
