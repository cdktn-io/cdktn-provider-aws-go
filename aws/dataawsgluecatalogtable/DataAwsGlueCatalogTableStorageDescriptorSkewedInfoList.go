...
func (j *jsiiProxy_DataAwsGlueCatalogTableStorageDescriptorSkewedInfoList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsGlueCatalogTableStorageDescriptorSkewedInfoList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsGlueCatalogTableStorageDescriptorSkewedInfoList {
	_init_.Initialize()
...
func NewDataAwsGlueCatalogTableStorageDescriptorSkewedInfoList_Override(d DataAwsGlueCatalogTableStorageDescriptorSkewedInfoList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsGlueCatalogTableStorageDescriptorSkewedInfoList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsGlueCatalogTableStorageDescriptorSkewedInfoList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsGlueCatalogTableStorageDescriptorSkewedInfoList) Resolve(context cdktn.IResolveContext) interface{} {
