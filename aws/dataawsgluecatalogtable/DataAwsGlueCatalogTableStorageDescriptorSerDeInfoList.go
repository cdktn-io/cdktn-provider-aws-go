...
func (j *jsiiProxy_DataAwsGlueCatalogTableStorageDescriptorSerDeInfoList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsGlueCatalogTableStorageDescriptorSerDeInfoList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsGlueCatalogTableStorageDescriptorSerDeInfoList {
	_init_.Initialize()
...
func NewDataAwsGlueCatalogTableStorageDescriptorSerDeInfoList_Override(d DataAwsGlueCatalogTableStorageDescriptorSerDeInfoList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsGlueCatalogTableStorageDescriptorSerDeInfoList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsGlueCatalogTableStorageDescriptorSerDeInfoList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsGlueCatalogTableStorageDescriptorSerDeInfoList) Resolve(context cdktn.IResolveContext) interface{} {
