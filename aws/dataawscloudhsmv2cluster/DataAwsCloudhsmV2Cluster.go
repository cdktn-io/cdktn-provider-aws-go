...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/dataawscloudhsmv2cluster/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/data-sources/cloudhsm_v2_cluster aws_cloudhsm_v2_cluster}.
...
func (j *jsiiProxy_DataAwsCloudhsmV2Cluster) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsCloudhsmV2Cluster) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsCloudhsmV2Cluster) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsCloudhsmV2Cluster) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsCloudhsmV2Cluster) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DataAwsCloudhsmV2Cluster) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_DataAwsCloudhsmV2Cluster) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/data-sources/cloudhsm_v2_cluster aws_cloudhsm_v2_cluster} Data Source.
...
func (j *jsiiProxy_DataAwsCloudhsmV2Cluster)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsCloudhsmV2Cluster)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsCloudhsmV2Cluster)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_DataAwsCloudhsmV2Cluster)SetRegion(val *string) {
...
// Generates CDKTN code for importing a DataAwsCloudhsmV2Cluster resource upon running "cdktn plan <stack-name>".
func DataAwsCloudhsmV2Cluster_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateDataAwsCloudhsmV2Cluster_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataAwsCloudhsmV2Cluster) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsCloudhsmV2Cluster) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsCloudhsmV2Cluster) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsCloudhsmV2Cluster) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsCloudhsmV2Cluster) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
