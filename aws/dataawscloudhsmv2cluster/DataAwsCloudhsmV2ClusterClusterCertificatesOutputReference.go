...
func (d *jsiiProxy_DataAwsCloudhsmV2ClusterClusterCertificatesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataAwsCloudhsmV2ClusterClusterCertificatesOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
