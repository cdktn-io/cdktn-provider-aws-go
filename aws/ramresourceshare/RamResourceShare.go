...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/ram_resource_share aws_ram_resource_share}.
...
func (j *jsiiProxy_RamResourceShare) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_RamResourceShare) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_RamResourceShare) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_RamResourceShare) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_RamResourceShare) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/ram_resource_share aws_ram_resource_share} Resource.
func NewRamResourceShare(scope constructs.Construct, id *string, config *RamResourceShareConfig) RamResourceShare {
	...
	_jsii_.Create(
		"@cdktn/provider-aws.ramResourceShare.RamResourceShare",
...
func (j *jsiiProxy_RamResourceShare)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_RamResourceShare)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_RamResourceShare)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func RamResourceShare_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (r *jsiiProxy_RamResourceShare) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (r *jsiiProxy_RamResourceShare) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (r *jsiiProxy_RamResourceShare) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (r *jsiiProxy_RamResourceShare) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (r *jsiiProxy_RamResourceShare) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (r *jsiiProxy_RamResourceShare) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
