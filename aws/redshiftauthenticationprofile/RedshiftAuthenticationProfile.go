...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/redshiftauthenticationprofile/internal"
...
func (j *jsiiProxy_RedshiftAuthenticationProfile) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_RedshiftAuthenticationProfile) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_RedshiftAuthenticationProfile) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_RedshiftAuthenticationProfile) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_RedshiftAuthenticationProfile) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/redshift_authentication_profile aws_redshift_authentication_profile} Resource.
...
func (j *jsiiProxy_RedshiftAuthenticationProfile)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_RedshiftAuthenticationProfile)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_RedshiftAuthenticationProfile)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func RedshiftAuthenticationProfile_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (r *jsiiProxy_RedshiftAuthenticationProfile) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (r *jsiiProxy_RedshiftAuthenticationProfile) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (r *jsiiProxy_RedshiftAuthenticationProfile) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (r *jsiiProxy_RedshiftAuthenticationProfile) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (r *jsiiProxy_RedshiftAuthenticationProfile) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (r *jsiiProxy_RedshiftAuthenticationProfile) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
