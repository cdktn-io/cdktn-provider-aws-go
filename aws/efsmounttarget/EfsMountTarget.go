...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/efsmounttarget/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/efs_mount_target aws_efs_mount_target}.
...
func (j *jsiiProxy_EfsMountTarget) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_EfsMountTarget) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_EfsMountTarget) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_EfsMountTarget) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_EfsMountTarget) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_EfsMountTarget) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_EfsMountTarget) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/efs_mount_target aws_efs_mount_target} Resource.
...
func (j *jsiiProxy_EfsMountTarget)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_EfsMountTarget)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_EfsMountTarget)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_EfsMountTarget)SetRegion(val *string) {
...
func EfsMountTarget_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (e *jsiiProxy_EfsMountTarget) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (e *jsiiProxy_EfsMountTarget) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (e *jsiiProxy_EfsMountTarget) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (e *jsiiProxy_EfsMountTarget) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (e *jsiiProxy_EfsMountTarget) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (e *jsiiProxy_EfsMountTarget) ResetRegion() {
	_jsii_.InvokeVoid(
		e,
		"resetRegion",
		nil, // no parameters
...
func (e *jsiiProxy_EfsMountTarget) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
