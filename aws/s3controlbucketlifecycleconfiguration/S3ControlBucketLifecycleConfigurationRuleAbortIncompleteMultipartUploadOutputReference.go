...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v21/s3controlbucketlifecycleconfiguration/internal"
...
func (s *jsiiProxy_S3ControlBucketLifecycleConfigurationRuleAbortIncompleteMultipartUploadOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_S3ControlBucketLifecycleConfigurationRuleAbortIncompleteMultipartUploadOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
