...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/appsyncapicache/internal"
...
func (j *jsiiProxy_AppsyncApiCache) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_AppsyncApiCache) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_AppsyncApiCache) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_AppsyncApiCache) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_AppsyncApiCache) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_AppsyncApiCache) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_AppsyncApiCache) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/appsync_api_cache aws_appsync_api_cache} Resource.
...
func (j *jsiiProxy_AppsyncApiCache)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_AppsyncApiCache)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_AppsyncApiCache)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_AppsyncApiCache)SetRegion(val *string) {
...
func AppsyncApiCache_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (a *jsiiProxy_AppsyncApiCache) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AppsyncApiCache) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (a *jsiiProxy_AppsyncApiCache) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AppsyncApiCache) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (a *jsiiProxy_AppsyncApiCache) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (a *jsiiProxy_AppsyncApiCache) ResetRegion() {
	_jsii_.InvokeVoid(
		a,
		"resetRegion",
		nil, // no parameters
...
func (a *jsiiProxy_AppsyncApiCache) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
