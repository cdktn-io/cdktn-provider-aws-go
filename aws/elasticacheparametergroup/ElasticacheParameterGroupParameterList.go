...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v23/elasticacheparametergroup/internal"
...
func (j *jsiiProxy_ElasticacheParameterGroupParameterList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewElasticacheParameterGroupParameterList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ElasticacheParameterGroupParameterList {
	_init_.Initialize()

	if err := validateNewElasticacheParameterGroupParameterListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewElasticacheParameterGroupParameterList_Override(e ElasticacheParameterGroupParameterList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ElasticacheParameterGroupParameterList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (e *jsiiProxy_ElasticacheParameterGroupParameterList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (e *jsiiProxy_ElasticacheParameterGroupParameterList) Resolve(context cdktn.IResolveContext) interface{} {
