...
type CustomerprofilesDomainMatching struct {
	...
	// auto_merging block.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.32.1/docs/resources/customerprofiles_domain#auto_merging CustomerprofilesDomain#auto_merging}
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.32.1/docs/resources/customerprofiles_domain#exporting_config CustomerprofilesDomain#exporting_config}
	ExportingConfig *CustomerprofilesDomainMatchingExportingConfig `field:"optional" json:"exportingConfig" yaml:"exportingConfig"`
	// job_schedule block.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.32.1/docs/resources/customerprofiles_domain#job_schedule CustomerprofilesDomain#job_schedule}
