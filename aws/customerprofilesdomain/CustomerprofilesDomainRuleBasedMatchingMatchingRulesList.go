...
func (j *jsiiProxy_CustomerprofilesDomainRuleBasedMatchingMatchingRulesList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewCustomerprofilesDomainRuleBasedMatchingMatchingRulesList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) CustomerprofilesDomainRuleBasedMatchingMatchingRulesList {
	_init_.Initialize()
...
func NewCustomerprofilesDomainRuleBasedMatchingMatchingRulesList_Override(c CustomerprofilesDomainRuleBasedMatchingMatchingRulesList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_CustomerprofilesDomainRuleBasedMatchingMatchingRulesList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_CustomerprofilesDomainRuleBasedMatchingMatchingRulesList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (c *jsiiProxy_CustomerprofilesDomainRuleBasedMatchingMatchingRulesList) Resolve(context cdktn.IResolveContext) interface{} {
