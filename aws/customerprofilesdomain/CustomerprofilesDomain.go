...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/customerprofiles_domain aws_customerprofiles_domain}.
...
func (j *jsiiProxy_CustomerprofilesDomain) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_CustomerprofilesDomain) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_CustomerprofilesDomain) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_CustomerprofilesDomain) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_CustomerprofilesDomain) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/customerprofiles_domain aws_customerprofiles_domain} Resource.
...
func (j *jsiiProxy_CustomerprofilesDomain)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_CustomerprofilesDomain)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_CustomerprofilesDomain)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func CustomerprofilesDomain_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (c *jsiiProxy_CustomerprofilesDomain) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CustomerprofilesDomain) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (c *jsiiProxy_CustomerprofilesDomain) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CustomerprofilesDomain) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_CustomerprofilesDomain) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (c *jsiiProxy_CustomerprofilesDomain) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
