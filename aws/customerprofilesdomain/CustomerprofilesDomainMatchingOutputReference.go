...
func (c *jsiiProxy_CustomerprofilesDomainMatchingOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CustomerprofilesDomainMatchingOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
