...
func (c *jsiiProxy_CustomerprofilesDomainRuleBasedMatchingConflictResolutionOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CustomerprofilesDomainRuleBasedMatchingConflictResolutionOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
