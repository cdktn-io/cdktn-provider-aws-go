...
func (j *jsiiProxy_DataAwsRedshiftserverlessWorkgroupEndpointList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsRedshiftserverlessWorkgroupEndpointList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsRedshiftserverlessWorkgroupEndpointList {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-aws.dataAwsRedshiftserverlessWorkgroup.DataAwsRedshiftserverlessWorkgroupEndpointList",
...
func NewDataAwsRedshiftserverlessWorkgroupEndpointList_Override(d DataAwsRedshiftserverlessWorkgroupEndpointList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsRedshiftserverlessWorkgroupEndpointList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsRedshiftserverlessWorkgroupEndpointList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsRedshiftserverlessWorkgroupEndpointList) Resolve(context cdktn.IResolveContext) interface{} {
