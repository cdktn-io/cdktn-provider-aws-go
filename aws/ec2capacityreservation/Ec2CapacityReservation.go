...
func (j *jsiiProxy_Ec2CapacityReservation) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_Ec2CapacityReservation) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.39.0/docs/resources/ec2_capacity_reservation aws_ec2_capacity_reservation} Resource.
...
func (j *jsiiProxy_Ec2CapacityReservation)SetRegion(val *string) {
...
func (e *jsiiProxy_Ec2CapacityReservation) ResetRegion() {
	_jsii_.InvokeVoid(
		e,
		"resetRegion",
		nil, // no parameters
