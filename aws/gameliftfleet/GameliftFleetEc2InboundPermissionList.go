...
func (j *jsiiProxy_GameliftFleetEc2InboundPermissionList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewGameliftFleetEc2InboundPermissionList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) GameliftFleetEc2InboundPermissionList {
	_init_.Initialize()
...
func NewGameliftFleetEc2InboundPermissionList_Override(g GameliftFleetEc2InboundPermissionList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_GameliftFleetEc2InboundPermissionList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (g *jsiiProxy_GameliftFleetEc2InboundPermissionList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (g *jsiiProxy_GameliftFleetEc2InboundPermissionList) Resolve(context cdktn.IResolveContext) interface{} {
