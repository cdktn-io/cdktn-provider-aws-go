...
func (g *jsiiProxy_GameliftFleetTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GameliftFleetTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
