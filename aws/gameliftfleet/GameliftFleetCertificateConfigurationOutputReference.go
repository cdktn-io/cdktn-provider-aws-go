...
func (g *jsiiProxy_GameliftFleetCertificateConfigurationOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GameliftFleetCertificateConfigurationOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
