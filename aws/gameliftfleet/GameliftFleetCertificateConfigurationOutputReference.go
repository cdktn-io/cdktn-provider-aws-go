...
func (j *jsiiProxy_GameliftFleetCertificateConfigurationOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewGameliftFleetCertificateConfigurationOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) GameliftFleetCertificateConfigurationOutputReference {
	_init_.Initialize()
...
func NewGameliftFleetCertificateConfigurationOutputReference_Override(g GameliftFleetCertificateConfigurationOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_GameliftFleetCertificateConfigurationOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (g *jsiiProxy_GameliftFleetCertificateConfigurationOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GameliftFleetCertificateConfigurationOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (g *jsiiProxy_GameliftFleetCertificateConfigurationOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GameliftFleetCertificateConfigurationOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
