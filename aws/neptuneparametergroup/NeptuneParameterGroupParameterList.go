...
func (j *jsiiProxy_NeptuneParameterGroupParameterList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewNeptuneParameterGroupParameterList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) NeptuneParameterGroupParameterList {
	_init_.Initialize()
...
func NewNeptuneParameterGroupParameterList_Override(n NeptuneParameterGroupParameterList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_NeptuneParameterGroupParameterList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (n *jsiiProxy_NeptuneParameterGroupParameterList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (n *jsiiProxy_NeptuneParameterGroupParameterList) Resolve(context cdktn.IResolveContext) interface{} {
