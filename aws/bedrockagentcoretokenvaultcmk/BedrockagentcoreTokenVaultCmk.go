...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v22/bedrockagentcoretokenvaultcmk/internal"
...
func (j *jsiiProxy_BedrockagentcoreTokenVaultCmk) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_BedrockagentcoreTokenVaultCmk) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_BedrockagentcoreTokenVaultCmk) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_BedrockagentcoreTokenVaultCmk) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_BedrockagentcoreTokenVaultCmk) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.32.1/docs/resources/bedrockagentcore_token_vault_cmk aws_bedrockagentcore_token_vault_cmk} Resource.
...
func (j *jsiiProxy_BedrockagentcoreTokenVaultCmk)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_BedrockagentcoreTokenVaultCmk)SetLifecycle(val *cdktf.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_BedrockagentcoreTokenVaultCmk)SetProvider(val cdktf.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func BedrockagentcoreTokenVaultCmk_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (b *jsiiProxy_BedrockagentcoreTokenVaultCmk) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (b *jsiiProxy_BedrockagentcoreTokenVaultCmk) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (b *jsiiProxy_BedrockagentcoreTokenVaultCmk) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
