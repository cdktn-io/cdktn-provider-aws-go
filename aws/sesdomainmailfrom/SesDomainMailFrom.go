...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/sesdomainmailfrom/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/ses_domain_mail_from aws_ses_domain_mail_from}.
...
func (j *jsiiProxy_SesDomainMailFrom) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_SesDomainMailFrom) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_SesDomainMailFrom) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_SesDomainMailFrom) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_SesDomainMailFrom) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_SesDomainMailFrom) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_SesDomainMailFrom) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/ses_domain_mail_from aws_ses_domain_mail_from} Resource.
...
func (j *jsiiProxy_SesDomainMailFrom)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_SesDomainMailFrom)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_SesDomainMailFrom)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_SesDomainMailFrom)SetRegion(val *string) {
...
func SesDomainMailFrom_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateSesDomainMailFrom_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_SesDomainMailFrom) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_SesDomainMailFrom) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SesDomainMailFrom) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_SesDomainMailFrom) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SesDomainMailFrom) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_SesDomainMailFrom) MoveFromId(id *string) {
...
func (s *jsiiProxy_SesDomainMailFrom) MoveToId(id *string) {
...
func (s *jsiiProxy_SesDomainMailFrom) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_SesDomainMailFrom) ResetRegion() {
	_jsii_.InvokeVoid(
		s,
		"resetRegion",
		nil, // no parameters
...
func (s *jsiiProxy_SesDomainMailFrom) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
