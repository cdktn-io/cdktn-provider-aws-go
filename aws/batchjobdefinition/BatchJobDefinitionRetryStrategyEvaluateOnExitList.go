...
func (j *jsiiProxy_BatchJobDefinitionRetryStrategyEvaluateOnExitList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewBatchJobDefinitionRetryStrategyEvaluateOnExitList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) BatchJobDefinitionRetryStrategyEvaluateOnExitList {
	_init_.Initialize()
...
func NewBatchJobDefinitionRetryStrategyEvaluateOnExitList_Override(b BatchJobDefinitionRetryStrategyEvaluateOnExitList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_BatchJobDefinitionRetryStrategyEvaluateOnExitList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (b *jsiiProxy_BatchJobDefinitionRetryStrategyEvaluateOnExitList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (b *jsiiProxy_BatchJobDefinitionRetryStrategyEvaluateOnExitList) Resolve(context cdktn.IResolveContext) interface{} {
