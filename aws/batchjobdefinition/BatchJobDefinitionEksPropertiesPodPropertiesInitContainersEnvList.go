...
func (j *jsiiProxy_BatchJobDefinitionEksPropertiesPodPropertiesInitContainersEnvList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewBatchJobDefinitionEksPropertiesPodPropertiesInitContainersEnvList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) BatchJobDefinitionEksPropertiesPodPropertiesInitContainersEnvList {
	_init_.Initialize()
...
func NewBatchJobDefinitionEksPropertiesPodPropertiesInitContainersEnvList_Override(b BatchJobDefinitionEksPropertiesPodPropertiesInitContainersEnvList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_BatchJobDefinitionEksPropertiesPodPropertiesInitContainersEnvList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (b *jsiiProxy_BatchJobDefinitionEksPropertiesPodPropertiesInitContainersEnvList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (b *jsiiProxy_BatchJobDefinitionEksPropertiesPodPropertiesInitContainersEnvList) Resolve(context cdktn.IResolveContext) interface{} {
