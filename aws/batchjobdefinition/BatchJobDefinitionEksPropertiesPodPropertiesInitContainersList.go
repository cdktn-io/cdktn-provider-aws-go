...
func (j *jsiiProxy_BatchJobDefinitionEksPropertiesPodPropertiesInitContainersList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewBatchJobDefinitionEksPropertiesPodPropertiesInitContainersList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) BatchJobDefinitionEksPropertiesPodPropertiesInitContainersList {
	_init_.Initialize()
...
func NewBatchJobDefinitionEksPropertiesPodPropertiesInitContainersList_Override(b BatchJobDefinitionEksPropertiesPodPropertiesInitContainersList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_BatchJobDefinitionEksPropertiesPodPropertiesInitContainersList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (b *jsiiProxy_BatchJobDefinitionEksPropertiesPodPropertiesInitContainersList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (b *jsiiProxy_BatchJobDefinitionEksPropertiesPodPropertiesInitContainersList) Resolve(context cdktf.IResolveContext) interface{} {
