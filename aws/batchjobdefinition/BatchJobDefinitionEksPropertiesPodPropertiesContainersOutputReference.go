...
func (j *jsiiProxy_BatchJobDefinitionEksPropertiesPodPropertiesContainersOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewBatchJobDefinitionEksPropertiesPodPropertiesContainersOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) BatchJobDefinitionEksPropertiesPodPropertiesContainersOutputReference {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-aws.batchJobDefinition.BatchJobDefinitionEksPropertiesPodPropertiesContainersOutputReference",
...
func NewBatchJobDefinitionEksPropertiesPodPropertiesContainersOutputReference_Override(b BatchJobDefinitionEksPropertiesPodPropertiesContainersOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_BatchJobDefinitionEksPropertiesPodPropertiesContainersOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (b *jsiiProxy_BatchJobDefinitionEksPropertiesPodPropertiesContainersOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (b *jsiiProxy_BatchJobDefinitionEksPropertiesPodPropertiesContainersOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (b *jsiiProxy_BatchJobDefinitionEksPropertiesPodPropertiesContainersOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (b *jsiiProxy_BatchJobDefinitionEksPropertiesPodPropertiesContainersOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
