...
func (j *jsiiProxy_BatchJobDefinitionEksPropertiesPodPropertiesContainersEnvList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewBatchJobDefinitionEksPropertiesPodPropertiesContainersEnvList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) BatchJobDefinitionEksPropertiesPodPropertiesContainersEnvList {
	_init_.Initialize()
...
func NewBatchJobDefinitionEksPropertiesPodPropertiesContainersEnvList_Override(b BatchJobDefinitionEksPropertiesPodPropertiesContainersEnvList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_BatchJobDefinitionEksPropertiesPodPropertiesContainersEnvList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (b *jsiiProxy_BatchJobDefinitionEksPropertiesPodPropertiesContainersEnvList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (b *jsiiProxy_BatchJobDefinitionEksPropertiesPodPropertiesContainersEnvList) Resolve(context cdktn.IResolveContext) interface{} {
