...
func (j *jsiiProxy_BatchJobDefinitionTimeoutOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewBatchJobDefinitionTimeoutOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) BatchJobDefinitionTimeoutOutputReference {
	_init_.Initialize()
...
func NewBatchJobDefinitionTimeoutOutputReference_Override(b BatchJobDefinitionTimeoutOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_BatchJobDefinitionTimeoutOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (b *jsiiProxy_BatchJobDefinitionTimeoutOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (b *jsiiProxy_BatchJobDefinitionTimeoutOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (b *jsiiProxy_BatchJobDefinitionTimeoutOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (b *jsiiProxy_BatchJobDefinitionTimeoutOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
