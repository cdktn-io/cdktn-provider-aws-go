...
func (b *jsiiProxy_BatchJobDefinitionTimeoutOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (b *jsiiProxy_BatchJobDefinitionTimeoutOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
