...
func (j *jsiiProxy_BatchJobDefinitionEksPropertiesPodPropertiesContainersList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewBatchJobDefinitionEksPropertiesPodPropertiesContainersList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) BatchJobDefinitionEksPropertiesPodPropertiesContainersList {
	_init_.Initialize()
...
func NewBatchJobDefinitionEksPropertiesPodPropertiesContainersList_Override(b BatchJobDefinitionEksPropertiesPodPropertiesContainersList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_BatchJobDefinitionEksPropertiesPodPropertiesContainersList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (b *jsiiProxy_BatchJobDefinitionEksPropertiesPodPropertiesContainersList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (b *jsiiProxy_BatchJobDefinitionEksPropertiesPodPropertiesContainersList) Resolve(context cdktn.IResolveContext) interface{} {
