...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/apprunnerautoscalingconfigurationversion/internal"
...
type ApprunnerAutoScalingConfigurationVersion interface {
	...
	HasAssociatedService() cdktn.IResolvable
	Id() *string
	SetId(val *string)
	IdInput() *string
...
func (j *jsiiProxy_ApprunnerAutoScalingConfigurationVersion) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_ApprunnerAutoScalingConfigurationVersion) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_ApprunnerAutoScalingConfigurationVersion) HasAssociatedService() cdktn.IResolvable {
...
func (j *jsiiProxy_ApprunnerAutoScalingConfigurationVersion) IsDefault() cdktn.IResolvable {
	var returns cdktn.IResolvable
	_jsii_.Get(
		j,
		"isDefault",
...
func (j *jsiiProxy_ApprunnerAutoScalingConfigurationVersion) Latest() cdktn.IResolvable {
	var returns cdktn.IResolvable
	_jsii_.Get(
		j,
		"latest",
...
func (j *jsiiProxy_ApprunnerAutoScalingConfigurationVersion) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_ApprunnerAutoScalingConfigurationVersion) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_ApprunnerAutoScalingConfigurationVersion) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func NewApprunnerAutoScalingConfigurationVersion(scope constructs.Construct, id *string, config *ApprunnerAutoScalingConfigurationVersionConfig) ApprunnerAutoScalingConfigurationVersion {
	...
	_jsii_.Create(
		"@cdktn/provider-aws.apprunnerAutoScalingConfigurationVersion.ApprunnerAutoScalingConfigurationVersion",
...
func (j *jsiiProxy_ApprunnerAutoScalingConfigurationVersion)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_ApprunnerAutoScalingConfigurationVersion)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_ApprunnerAutoScalingConfigurationVersion)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func ApprunnerAutoScalingConfigurationVersion_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (a *jsiiProxy_ApprunnerAutoScalingConfigurationVersion) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_ApprunnerAutoScalingConfigurationVersion) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (a *jsiiProxy_ApprunnerAutoScalingConfigurationVersion) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_ApprunnerAutoScalingConfigurationVersion) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (a *jsiiProxy_ApprunnerAutoScalingConfigurationVersion) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (a *jsiiProxy_ApprunnerAutoScalingConfigurationVersion) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
