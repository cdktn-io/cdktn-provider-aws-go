...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v24/dxhostedpublicvirtualinterfaceaccepter/internal"
...
func (j *jsiiProxy_DxHostedPublicVirtualInterfaceAccepterTimeoutsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDxHostedPublicVirtualInterfaceAccepterTimeoutsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) DxHostedPublicVirtualInterfaceAccepterTimeoutsOutputReference {
	_init_.Initialize()

	if err := validateNewDxHostedPublicVirtualInterfaceAccepterTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
	j := jsiiProxy_DxHostedPublicVirtualInterfaceAccepterTimeoutsOutputReference{}

	_jsii_.Create(
		"@cdktn/provider-aws.dxHostedPublicVirtualInterfaceAccepter.DxHostedPublicVirtualInterfaceAccepterTimeoutsOutputReference",
...
func NewDxHostedPublicVirtualInterfaceAccepterTimeoutsOutputReference_Override(d DxHostedPublicVirtualInterfaceAccepterTimeoutsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_DxHostedPublicVirtualInterfaceAccepterTimeoutsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DxHostedPublicVirtualInterfaceAccepterTimeoutsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DxHostedPublicVirtualInterfaceAccepterTimeoutsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (d *jsiiProxy_DxHostedPublicVirtualInterfaceAccepterTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DxHostedPublicVirtualInterfaceAccepterTimeoutsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
