...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/dataawslambdafunctionurl/internal"
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/data-sources/lambda_function_url aws_lambda_function_url} Data Source.
...
func (d *jsiiProxy_DataAwsLambdaFunctionUrl) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
