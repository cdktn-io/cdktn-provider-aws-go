...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v23/dataawslambdafunctionurl/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.37.0/docs/data-sources/lambda_function_url aws_lambda_function_url}.
...
func (j *jsiiProxy_DataAwsLambdaFunctionUrl) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsLambdaFunctionUrl) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsLambdaFunctionUrl) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsLambdaFunctionUrl) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsLambdaFunctionUrl) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.37.0/docs/data-sources/lambda_function_url aws_lambda_function_url} Data Source.
...
func (j *jsiiProxy_DataAwsLambdaFunctionUrl)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsLambdaFunctionUrl)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsLambdaFunctionUrl)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsLambdaFunctionUrl_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsLambdaFunctionUrl) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsLambdaFunctionUrl) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsLambdaFunctionUrl) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
