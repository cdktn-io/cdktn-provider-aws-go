...
func (j *jsiiProxy_DataAwsLambdaFunctionUrlCorsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsLambdaFunctionUrlCorsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsLambdaFunctionUrlCorsList {
	_init_.Initialize()
...
func NewDataAwsLambdaFunctionUrlCorsList_Override(d DataAwsLambdaFunctionUrlCorsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsLambdaFunctionUrlCorsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsLambdaFunctionUrlCorsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsLambdaFunctionUrlCorsList) Resolve(context cdktn.IResolveContext) interface{} {
