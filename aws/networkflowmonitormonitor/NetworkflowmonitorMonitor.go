...
func (j *jsiiProxy_NetworkflowmonitorMonitor) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_NetworkflowmonitorMonitor) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_NetworkflowmonitorMonitor) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_NetworkflowmonitorMonitor) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_NetworkflowmonitorMonitor) TagsAll() cdktn.StringMap {
...
func (j *jsiiProxy_NetworkflowmonitorMonitor) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/networkflowmonitor_monitor aws_networkflowmonitor_monitor} Resource.
func NewNetworkflowmonitorMonitor(scope constructs.Construct, id *string, config *NetworkflowmonitorMonitorConfig) NetworkflowmonitorMonitor {
	...
	_jsii_.Create(
		"@cdktn/provider-aws.networkflowmonitorMonitor.NetworkflowmonitorMonitor",
...
func (j *jsiiProxy_NetworkflowmonitorMonitor)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_NetworkflowmonitorMonitor)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_NetworkflowmonitorMonitor)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func NetworkflowmonitorMonitor_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (n *jsiiProxy_NetworkflowmonitorMonitor) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (n *jsiiProxy_NetworkflowmonitorMonitor) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (n *jsiiProxy_NetworkflowmonitorMonitor) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (n *jsiiProxy_NetworkflowmonitorMonitor) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (n *jsiiProxy_NetworkflowmonitorMonitor) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (n *jsiiProxy_NetworkflowmonitorMonitor) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
