...
func (j *jsiiProxy_ChimeVoiceConnectorTerminationCredentials) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_ChimeVoiceConnectorTerminationCredentials) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_ChimeVoiceConnectorTerminationCredentials) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_ChimeVoiceConnectorTerminationCredentials) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_ChimeVoiceConnectorTerminationCredentials) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/chime_voice_connector_termination_credentials aws_chime_voice_connector_termination_credentials} Resource.
...
func (j *jsiiProxy_ChimeVoiceConnectorTerminationCredentials)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_ChimeVoiceConnectorTerminationCredentials)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_ChimeVoiceConnectorTerminationCredentials)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func ChimeVoiceConnectorTerminationCredentials_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (c *jsiiProxy_ChimeVoiceConnectorTerminationCredentials) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_ChimeVoiceConnectorTerminationCredentials) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (c *jsiiProxy_ChimeVoiceConnectorTerminationCredentials) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_ChimeVoiceConnectorTerminationCredentials) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_ChimeVoiceConnectorTerminationCredentials) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (c *jsiiProxy_ChimeVoiceConnectorTerminationCredentials) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
