...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v24/chimevoiceconnectorterminationcredentials/internal"
...
func (j *jsiiProxy_ChimeVoiceConnectorTerminationCredentialsCredentialsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewChimeVoiceConnectorTerminationCredentialsCredentialsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ChimeVoiceConnectorTerminationCredentialsCredentialsList {
	_init_.Initialize()

	if err := validateNewChimeVoiceConnectorTerminationCredentialsCredentialsListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewChimeVoiceConnectorTerminationCredentialsCredentialsList_Override(c ChimeVoiceConnectorTerminationCredentialsCredentialsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ChimeVoiceConnectorTerminationCredentialsCredentialsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_ChimeVoiceConnectorTerminationCredentialsCredentialsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (c *jsiiProxy_ChimeVoiceConnectorTerminationCredentialsCredentialsList) Resolve(context cdktn.IResolveContext) interface{} {
