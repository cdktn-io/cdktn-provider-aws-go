...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v21/chimevoiceconnectorterminationcredentials/internal"
...
func (c *jsiiProxy_ChimeVoiceConnectorTerminationCredentialsCredentialsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (c *jsiiProxy_ChimeVoiceConnectorTerminationCredentialsCredentialsList) Resolve(context cdktf.IResolveContext) interface{} {
