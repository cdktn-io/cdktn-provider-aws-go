...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/wafregionalsizeconstraintset/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/wafregional_size_constraint_set aws_wafregional_size_constraint_set}.
...
func (j *jsiiProxy_WafregionalSizeConstraintSet) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_WafregionalSizeConstraintSet) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_WafregionalSizeConstraintSet) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_WafregionalSizeConstraintSet) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_WafregionalSizeConstraintSet) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/wafregional_size_constraint_set aws_wafregional_size_constraint_set} Resource.
...
func (j *jsiiProxy_WafregionalSizeConstraintSet)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_WafregionalSizeConstraintSet)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_WafregionalSizeConstraintSet)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
// Generates CDKTN code for importing a WafregionalSizeConstraintSet resource upon running "cdktn plan <stack-name>".
func WafregionalSizeConstraintSet_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateWafregionalSizeConstraintSet_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (w *jsiiProxy_WafregionalSizeConstraintSet) AddMoveTarget(moveTarget *string) {
...
func (w *jsiiProxy_WafregionalSizeConstraintSet) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_WafregionalSizeConstraintSet) HasResourceMove() interface{} {
	var returns interface{}
...
func (w *jsiiProxy_WafregionalSizeConstraintSet) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (w *jsiiProxy_WafregionalSizeConstraintSet) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_WafregionalSizeConstraintSet) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (w *jsiiProxy_WafregionalSizeConstraintSet) MoveFromId(id *string) {
...
func (w *jsiiProxy_WafregionalSizeConstraintSet) MoveTo(moveTarget *string, index interface{}) {
...
func (w *jsiiProxy_WafregionalSizeConstraintSet) MoveToId(id *string) {
...
func (w *jsiiProxy_WafregionalSizeConstraintSet) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (w *jsiiProxy_WafregionalSizeConstraintSet) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (w *jsiiProxy_WafregionalSizeConstraintSet) ToHclTerraform() interface{} {
	var returns interface{}
...
func (w *jsiiProxy_WafregionalSizeConstraintSet) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
