...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v22/wafregionalsizeconstraintset/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.31.0/docs/resources/wafregional_size_constraint_set aws_wafregional_size_constraint_set}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.31.0/docs/resources/wafregional_size_constraint_set aws_wafregional_size_constraint_set} Resource.
...
func WafregionalSizeConstraintSet_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (w *jsiiProxy_WafregionalSizeConstraintSet) ImportFrom(id *string, provider cdktf.TerraformProvider) {
