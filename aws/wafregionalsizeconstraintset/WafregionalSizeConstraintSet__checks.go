...
func (w *jsiiProxy_WafregionalSizeConstraintSet) validatePutSizeConstraintsParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*WafregionalSizeConstraintSetSizeConstraints; received %#v (a %T)", value, value)
		}
	}
