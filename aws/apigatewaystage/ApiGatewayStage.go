...
func (j *jsiiProxy_ApiGatewayStage) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_ApiGatewayStage) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.50.0/docs/resources/api_gateway_stage aws_api_gateway_stage} Resource.
...
func (j *jsiiProxy_ApiGatewayStage)SetRegion(val *string) {
...
func (a *jsiiProxy_ApiGatewayStage) ResetRegion() {
	_jsii_.InvokeVoid(
		a,
		"resetRegion",
		nil, // no parameters
