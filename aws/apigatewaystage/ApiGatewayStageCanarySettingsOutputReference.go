...
func (a *jsiiProxy_ApiGatewayStageCanarySettingsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_ApiGatewayStageCanarySettingsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
