...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/apigatewaystage/internal"
...
func (j *jsiiProxy_ApiGatewayStageAccessLogSettingsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewApiGatewayStageAccessLogSettingsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) ApiGatewayStageAccessLogSettingsOutputReference {
	_init_.Initialize()

	if err := validateNewApiGatewayStageAccessLogSettingsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewApiGatewayStageAccessLogSettingsOutputReference_Override(a ApiGatewayStageAccessLogSettingsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_ApiGatewayStageAccessLogSettingsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (a *jsiiProxy_ApiGatewayStageAccessLogSettingsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_ApiGatewayStageAccessLogSettingsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (a *jsiiProxy_ApiGatewayStageAccessLogSettingsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_ApiGatewayStageAccessLogSettingsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
