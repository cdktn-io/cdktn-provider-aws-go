...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/iamuser/internal"
...
func (j *jsiiProxy_IamUser) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_IamUser) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_IamUser) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_IamUser) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_IamUser) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func NewIamUser(scope constructs.Construct, id *string, config *IamUserConfig) IamUser {
	...
	_jsii_.Create(
		"@cdktn/provider-aws.iamUser.IamUser",
...
func (j *jsiiProxy_IamUser)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_IamUser)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_IamUser)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func IamUser_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (i *jsiiProxy_IamUser) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (i *jsiiProxy_IamUser) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (i *jsiiProxy_IamUser) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (i *jsiiProxy_IamUser) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (i *jsiiProxy_IamUser) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (i *jsiiProxy_IamUser) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
