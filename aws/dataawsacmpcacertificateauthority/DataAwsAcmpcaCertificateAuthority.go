...
func (j *jsiiProxy_DataAwsAcmpcaCertificateAuthority) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsAcmpcaCertificateAuthority) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsAcmpcaCertificateAuthority) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsAcmpcaCertificateAuthority) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsAcmpcaCertificateAuthority) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DataAwsAcmpcaCertificateAuthority) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_DataAwsAcmpcaCertificateAuthority) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DataAwsAcmpcaCertificateAuthority)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsAcmpcaCertificateAuthority)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsAcmpcaCertificateAuthority)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_DataAwsAcmpcaCertificateAuthority)SetRegion(val *string) {
...
func DataAwsAcmpcaCertificateAuthority_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsAcmpcaCertificateAuthority) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsAcmpcaCertificateAuthority) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsAcmpcaCertificateAuthority) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsAcmpcaCertificateAuthority) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsAcmpcaCertificateAuthority) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
