...
func (j *jsiiProxy_DataAwsAcmpcaCertificateAuthorityRevocationConfigurationList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsAcmpcaCertificateAuthorityRevocationConfigurationList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsAcmpcaCertificateAuthorityRevocationConfigurationList {
	_init_.Initialize()

	if err := validateNewDataAwsAcmpcaCertificateAuthorityRevocationConfigurationListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewDataAwsAcmpcaCertificateAuthorityRevocationConfigurationList_Override(d DataAwsAcmpcaCertificateAuthorityRevocationConfigurationList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsAcmpcaCertificateAuthorityRevocationConfigurationList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsAcmpcaCertificateAuthorityRevocationConfigurationList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsAcmpcaCertificateAuthorityRevocationConfigurationList) Resolve(context cdktn.IResolveContext) interface{} {
