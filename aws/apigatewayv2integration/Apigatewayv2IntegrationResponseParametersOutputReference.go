...
func (j *jsiiProxy_Apigatewayv2IntegrationResponseParametersOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewApigatewayv2IntegrationResponseParametersOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) Apigatewayv2IntegrationResponseParametersOutputReference {
	_init_.Initialize()

	if err := validateNewApigatewayv2IntegrationResponseParametersOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func NewApigatewayv2IntegrationResponseParametersOutputReference_Override(a Apigatewayv2IntegrationResponseParametersOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_Apigatewayv2IntegrationResponseParametersOutputReference)SetMappings(val *map[string]*string) {
	if err := j.validateSetMappingsParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_Apigatewayv2IntegrationResponseParametersOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (a *jsiiProxy_Apigatewayv2IntegrationResponseParametersOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_Apigatewayv2IntegrationResponseParametersOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (a *jsiiProxy_Apigatewayv2IntegrationResponseParametersOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_Apigatewayv2IntegrationResponseParametersOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
