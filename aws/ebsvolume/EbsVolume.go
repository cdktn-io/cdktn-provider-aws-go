...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/ebsvolume/internal"
...
func (j *jsiiProxy_EbsVolume) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_EbsVolume) CreateTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"createTime",
...
func (j *jsiiProxy_EbsVolume) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_EbsVolume) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_EbsVolume) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_EbsVolume) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/ebs_volume aws_ebs_volume} Resource.
...
func (j *jsiiProxy_EbsVolume)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_EbsVolume)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_EbsVolume)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func EbsVolume_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (e *jsiiProxy_EbsVolume) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (e *jsiiProxy_EbsVolume) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (e *jsiiProxy_EbsVolume) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (e *jsiiProxy_EbsVolume) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (e *jsiiProxy_EbsVolume) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (e *jsiiProxy_EbsVolume) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
