...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/eksfargateprofile/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/eks_fargate_profile aws_eks_fargate_profile}.
...
func (j *jsiiProxy_EksFargateProfile) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_EksFargateProfile) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_EksFargateProfile) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_EksFargateProfile) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_EksFargateProfile) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/eks_fargate_profile aws_eks_fargate_profile} Resource.
...
func (j *jsiiProxy_EksFargateProfile)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_EksFargateProfile)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_EksFargateProfile)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func EksFargateProfile_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (e *jsiiProxy_EksFargateProfile) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (e *jsiiProxy_EksFargateProfile) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (e *jsiiProxy_EksFargateProfile) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (e *jsiiProxy_EksFargateProfile) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (e *jsiiProxy_EksFargateProfile) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (e *jsiiProxy_EksFargateProfile) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
