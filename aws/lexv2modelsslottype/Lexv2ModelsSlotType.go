...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/lexv2models_slot_type aws_lexv2models_slot_type}.
...
func (j *jsiiProxy_Lexv2ModelsSlotType) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_Lexv2ModelsSlotType) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/lexv2models_slot_type aws_lexv2models_slot_type} Resource.
...
func (j *jsiiProxy_Lexv2ModelsSlotType)SetRegion(val *string) {
...
func (l *jsiiProxy_Lexv2ModelsSlotType) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (l *jsiiProxy_Lexv2ModelsSlotType) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (l *jsiiProxy_Lexv2ModelsSlotType) ResetRegion() {
	_jsii_.InvokeVoid(
		l,
		"resetRegion",
		nil, // no parameters
