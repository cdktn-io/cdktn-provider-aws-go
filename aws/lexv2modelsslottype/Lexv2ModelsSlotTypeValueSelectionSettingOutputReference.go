...
func (l *jsiiProxy_Lexv2ModelsSlotTypeValueSelectionSettingOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (l *jsiiProxy_Lexv2ModelsSlotTypeValueSelectionSettingOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
