...
func (j *jsiiProxy_ResiliencehubResiliencyPolicyPolicyHardwareList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_ResiliencehubResiliencyPolicyPolicyHardwareList) InternalValue() interface{} {
...
func (j *jsiiProxy_ResiliencehubResiliencyPolicyPolicyHardwareList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_ResiliencehubResiliencyPolicyPolicyHardwareList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (j *jsiiProxy_ResiliencehubResiliencyPolicyPolicyHardwareList)SetInternalValue(val interface{}) {
...
func (j *jsiiProxy_ResiliencehubResiliencyPolicyPolicyHardwareList)SetTerraformAttribute(val *string) {
...
func (j *jsiiProxy_ResiliencehubResiliencyPolicyPolicyHardwareList)SetWrapsSet(val *bool) {
...
func (r *jsiiProxy_ResiliencehubResiliencyPolicyPolicyHardwareList) ComputeFqn() *string {
	var returns *string
...
func (r *jsiiProxy_ResiliencehubResiliencyPolicyPolicyHardwareList) Get(index *float64) ResiliencehubResiliencyPolicyPolicyHardwareOutputReference {
...
func (r *jsiiProxy_ResiliencehubResiliencyPolicyPolicyHardwareList) ToString() *string {
	var returns *string
