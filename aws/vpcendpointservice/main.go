...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetSupportedRegions", GoMethod: "ResetSupportedRegions"},
			...
			_jsii_.MemberProperty{JsiiProperty: "supportedRegionsInput", GoGetter: "SupportedRegionsInput"},
