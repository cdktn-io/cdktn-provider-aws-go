...
func (j *jsiiProxy_VpcEndpointServicePrivateDnsNameConfigurationList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewVpcEndpointServicePrivateDnsNameConfigurationList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) VpcEndpointServicePrivateDnsNameConfigurationList {
	_init_.Initialize()
...
func NewVpcEndpointServicePrivateDnsNameConfigurationList_Override(v VpcEndpointServicePrivateDnsNameConfigurationList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_VpcEndpointServicePrivateDnsNameConfigurationList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (v *jsiiProxy_VpcEndpointServicePrivateDnsNameConfigurationList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (v *jsiiProxy_VpcEndpointServicePrivateDnsNameConfigurationList) Resolve(context cdktn.IResolveContext) interface{} {
