...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/kms_key aws_kms_key}.
...
func (j *jsiiProxy_KmsKey) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_KmsKey) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_KmsKey) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_KmsKey) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_KmsKey) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_KmsKey) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/kms_key aws_kms_key} Resource.
func NewKmsKey(scope constructs.Construct, id *string, config *KmsKeyConfig) KmsKey {
	_init_.Initialize()

	if err := validateNewKmsKeyParameters(scope, id, config); err != nil {
		panic(err)
	}
	j := jsiiProxy_KmsKey{}
...
func (j *jsiiProxy_KmsKey)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_KmsKey)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_KmsKey)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func KmsKey_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateKmsKey_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (k *jsiiProxy_KmsKey) AddMoveTarget(moveTarget *string) {
...
func (k *jsiiProxy_KmsKey) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (k *jsiiProxy_KmsKey) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (k *jsiiProxy_KmsKey) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (k *jsiiProxy_KmsKey) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (k *jsiiProxy_KmsKey) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (k *jsiiProxy_KmsKey) ResetId() {
	_jsii_.InvokeVoid(
		k,
		"resetId",
		nil, // no parameters
...
func (k *jsiiProxy_KmsKey) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
