...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/neptuneeventsubscription/internal"
...
func (j *jsiiProxy_NeptuneEventSubscription) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_NeptuneEventSubscription) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_NeptuneEventSubscription) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_NeptuneEventSubscription) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_NeptuneEventSubscription) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/neptune_event_subscription aws_neptune_event_subscription} Resource.
...
func (j *jsiiProxy_NeptuneEventSubscription)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_NeptuneEventSubscription)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_NeptuneEventSubscription)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func NeptuneEventSubscription_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (n *jsiiProxy_NeptuneEventSubscription) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (n *jsiiProxy_NeptuneEventSubscription) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (n *jsiiProxy_NeptuneEventSubscription) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (n *jsiiProxy_NeptuneEventSubscription) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (n *jsiiProxy_NeptuneEventSubscription) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (n *jsiiProxy_NeptuneEventSubscription) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
