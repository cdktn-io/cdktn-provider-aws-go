...
func (j *jsiiProxy_ServicecatalogPrincipalPortfolioAssociation) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_ServicecatalogPrincipalPortfolioAssociation) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_ServicecatalogPrincipalPortfolioAssociation) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_ServicecatalogPrincipalPortfolioAssociation) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_ServicecatalogPrincipalPortfolioAssociation) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_ServicecatalogPrincipalPortfolioAssociation) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_ServicecatalogPrincipalPortfolioAssociation) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/servicecatalog_principal_portfolio_association aws_servicecatalog_principal_portfolio_association} Resource.
...
func (j *jsiiProxy_ServicecatalogPrincipalPortfolioAssociation)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_ServicecatalogPrincipalPortfolioAssociation)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_ServicecatalogPrincipalPortfolioAssociation)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_ServicecatalogPrincipalPortfolioAssociation)SetRegion(val *string) {
...
func ServicecatalogPrincipalPortfolioAssociation_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (s *jsiiProxy_ServicecatalogPrincipalPortfolioAssociation) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_ServicecatalogPrincipalPortfolioAssociation) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_ServicecatalogPrincipalPortfolioAssociation) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_ServicecatalogPrincipalPortfolioAssociation) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_ServicecatalogPrincipalPortfolioAssociation) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_ServicecatalogPrincipalPortfolioAssociation) ResetRegion() {
	_jsii_.InvokeVoid(
		s,
		"resetRegion",
		nil, // no parameters
...
func (s *jsiiProxy_ServicecatalogPrincipalPortfolioAssociation) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
