...
func (j *jsiiProxy_SecuritylakeDataLakeConfigurationLifecycleConfigurationExpirationList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewSecuritylakeDataLakeConfigurationLifecycleConfigurationExpirationList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) SecuritylakeDataLakeConfigurationLifecycleConfigurationExpirationList {
	_init_.Initialize()
...
func NewSecuritylakeDataLakeConfigurationLifecycleConfigurationExpirationList_Override(s SecuritylakeDataLakeConfigurationLifecycleConfigurationExpirationList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_SecuritylakeDataLakeConfigurationLifecycleConfigurationExpirationList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_SecuritylakeDataLakeConfigurationLifecycleConfigurationExpirationList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (s *jsiiProxy_SecuritylakeDataLakeConfigurationLifecycleConfigurationExpirationList) Resolve(context cdktn.IResolveContext) interface{} {
