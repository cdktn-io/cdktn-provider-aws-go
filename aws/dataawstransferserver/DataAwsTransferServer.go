...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/dataawstransferserver/internal"
...
func (j *jsiiProxy_DataAwsTransferServer) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsTransferServer) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsTransferServer) IpAddressType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ipAddressType",
...
func (j *jsiiProxy_DataAwsTransferServer) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsTransferServer) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsTransferServer) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DataAwsTransferServer)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsTransferServer)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsTransferServer)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsTransferServer_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsTransferServer) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsTransferServer) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsTransferServer) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsTransferServer) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
