...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/emrinstancegroup/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/emr_instance_group aws_emr_instance_group}.
...
func (j *jsiiProxy_EmrInstanceGroup) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_EmrInstanceGroup) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_EmrInstanceGroup) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_EmrInstanceGroup) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_EmrInstanceGroup) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_EmrInstanceGroup) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_EmrInstanceGroup) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/emr_instance_group aws_emr_instance_group} Resource.
...
func (j *jsiiProxy_EmrInstanceGroup)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_EmrInstanceGroup)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_EmrInstanceGroup)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_EmrInstanceGroup)SetRegion(val *string) {
...
func EmrInstanceGroup_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateEmrInstanceGroup_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (e *jsiiProxy_EmrInstanceGroup) AddMoveTarget(moveTarget *string) {
...
func (e *jsiiProxy_EmrInstanceGroup) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (e *jsiiProxy_EmrInstanceGroup) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (e *jsiiProxy_EmrInstanceGroup) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (e *jsiiProxy_EmrInstanceGroup) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (e *jsiiProxy_EmrInstanceGroup) MoveFromId(id *string) {
...
func (e *jsiiProxy_EmrInstanceGroup) MoveToId(id *string) {
...
func (e *jsiiProxy_EmrInstanceGroup) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (e *jsiiProxy_EmrInstanceGroup) ResetRegion() {
	_jsii_.InvokeVoid(
		e,
		"resetRegion",
		nil, // no parameters
...
func (e *jsiiProxy_EmrInstanceGroup) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
