...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/dataawswafregionalwebacl/internal"
...
func (j *jsiiProxy_DataAwsWafregionalWebAcl) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsWafregionalWebAcl) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsWafregionalWebAcl) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsWafregionalWebAcl) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsWafregionalWebAcl) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DataAwsWafregionalWebAcl) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_DataAwsWafregionalWebAcl) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func NewDataAwsWafregionalWebAcl(scope constructs.Construct, id *string, config *DataAwsWafregionalWebAclConfig) DataAwsWafregionalWebAcl {
	...
	if err := validateNewDataAwsWafregionalWebAclParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_DataAwsWafregionalWebAcl)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsWafregionalWebAcl)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsWafregionalWebAcl)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_DataAwsWafregionalWebAcl)SetRegion(val *string) {
...
func DataAwsWafregionalWebAcl_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateDataAwsWafregionalWebAcl_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func DataAwsWafregionalWebAcl_IsConstruct(x interface{}) *bool {
	...
	if err := validateDataAwsWafregionalWebAcl_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (d *jsiiProxy_DataAwsWafregionalWebAcl) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsWafregionalWebAcl) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsWafregionalWebAcl) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsWafregionalWebAcl) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsWafregionalWebAcl) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataAwsWafregionalWebAcl) ToHclTerraform() interface{} {
	var returns interface{}
...
func (d *jsiiProxy_DataAwsWafregionalWebAcl) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
