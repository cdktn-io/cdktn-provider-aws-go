...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v21/servicecatalogprovisionedproduct/internal"
...
func (s *jsiiProxy_ServicecatalogProvisionedProductStackSetProvisioningPreferencesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_ServicecatalogProvisionedProductStackSetProvisioningPreferencesOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
