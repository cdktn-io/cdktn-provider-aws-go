...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/s3_bucket_acl aws_s3_bucket_acl}.
...
func (j *jsiiProxy_S3BucketAcl) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_S3BucketAcl) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_S3BucketAcl) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_S3BucketAcl) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_S3BucketAcl) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/s3_bucket_acl aws_s3_bucket_acl} Resource.
...
func (j *jsiiProxy_S3BucketAcl)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_S3BucketAcl)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_S3BucketAcl)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func S3BucketAcl_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (s *jsiiProxy_S3BucketAcl) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_S3BucketAcl) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_S3BucketAcl) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_S3BucketAcl) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_S3BucketAcl) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
