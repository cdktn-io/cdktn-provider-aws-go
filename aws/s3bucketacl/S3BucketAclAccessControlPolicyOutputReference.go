...
func (s *jsiiProxy_S3BucketAclAccessControlPolicyOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_S3BucketAclAccessControlPolicyOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
