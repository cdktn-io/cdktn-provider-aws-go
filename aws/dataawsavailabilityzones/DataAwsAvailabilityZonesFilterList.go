...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v21/dataawsavailabilityzones/internal"
...
func (d *jsiiProxy_DataAwsAvailabilityZonesFilterList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsAvailabilityZonesFilterList) Resolve(context cdktf.IResolveContext) interface{} {
