...
func (j *jsiiProxy_DataAwsAvailabilityZonesFilterList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsAvailabilityZonesFilterList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsAvailabilityZonesFilterList {
	_init_.Initialize()

	if err := validateNewDataAwsAvailabilityZonesFilterListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewDataAwsAvailabilityZonesFilterList_Override(d DataAwsAvailabilityZonesFilterList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsAvailabilityZonesFilterList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsAvailabilityZonesFilterList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsAvailabilityZonesFilterList) Resolve(context cdktn.IResolveContext) interface{} {
