...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v22/dataawsavailabilityzones/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.31.0/docs/data-sources/availability_zones aws_availability_zones}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.31.0/docs/data-sources/availability_zones aws_availability_zones} Data Source.
...
func DataAwsAvailabilityZones_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
