...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/dataawsavailabilityzones/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/data-sources/availability_zones aws_availability_zones}.
...
func (j *jsiiProxy_DataAwsAvailabilityZones) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsAvailabilityZones) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsAvailabilityZones) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsAvailabilityZones) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsAvailabilityZones) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/data-sources/availability_zones aws_availability_zones} Data Source.
...
func (j *jsiiProxy_DataAwsAvailabilityZones)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsAvailabilityZones)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsAvailabilityZones)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsAvailabilityZones_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateDataAwsAvailabilityZones_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataAwsAvailabilityZones) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsAvailabilityZones) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsAvailabilityZones) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsAvailabilityZones) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
