...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/configremediationconfiguration/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/config_remediation_configuration aws_config_remediation_configuration}.
...
func (j *jsiiProxy_ConfigRemediationConfiguration) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_ConfigRemediationConfiguration) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_ConfigRemediationConfiguration) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_ConfigRemediationConfiguration) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_ConfigRemediationConfiguration) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_ConfigRemediationConfiguration) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_ConfigRemediationConfiguration) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/config_remediation_configuration aws_config_remediation_configuration} Resource.
...
func (j *jsiiProxy_ConfigRemediationConfiguration)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_ConfigRemediationConfiguration)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_ConfigRemediationConfiguration)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_ConfigRemediationConfiguration)SetRegion(val *string) {
...
func ConfigRemediationConfiguration_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (c *jsiiProxy_ConfigRemediationConfiguration) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_ConfigRemediationConfiguration) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (c *jsiiProxy_ConfigRemediationConfiguration) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_ConfigRemediationConfiguration) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_ConfigRemediationConfiguration) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (c *jsiiProxy_ConfigRemediationConfiguration) ResetRegion() {
	_jsii_.InvokeVoid(
		c,
		"resetRegion",
		nil, // no parameters
...
func (c *jsiiProxy_ConfigRemediationConfiguration) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
