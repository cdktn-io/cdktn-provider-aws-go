...
func (j *jsiiProxy_ConfigRemediationConfigurationParameterList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewConfigRemediationConfigurationParameterList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ConfigRemediationConfigurationParameterList {
	_init_.Initialize()
...
func NewConfigRemediationConfigurationParameterList_Override(c ConfigRemediationConfigurationParameterList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ConfigRemediationConfigurationParameterList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_ConfigRemediationConfigurationParameterList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (c *jsiiProxy_ConfigRemediationConfigurationParameterList) Resolve(context cdktn.IResolveContext) interface{} {
