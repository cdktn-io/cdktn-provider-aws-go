...
func (j *jsiiProxy_ConfigRemediationConfigurationParameterOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewConfigRemediationConfigurationParameterOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) ConfigRemediationConfigurationParameterOutputReference {
	_init_.Initialize()
...
func NewConfigRemediationConfigurationParameterOutputReference_Override(c ConfigRemediationConfigurationParameterOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ConfigRemediationConfigurationParameterOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_ConfigRemediationConfigurationParameterOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_ConfigRemediationConfigurationParameterOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (c *jsiiProxy_ConfigRemediationConfigurationParameterOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_ConfigRemediationConfigurationParameterOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
