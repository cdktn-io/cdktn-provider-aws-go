...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/apigatewayclientcertificate/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/api_gateway_client_certificate aws_api_gateway_client_certificate}.
...
func (j *jsiiProxy_ApiGatewayClientCertificate) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_ApiGatewayClientCertificate) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_ApiGatewayClientCertificate) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_ApiGatewayClientCertificate) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_ApiGatewayClientCertificate) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_ApiGatewayClientCertificate) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_ApiGatewayClientCertificate) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/api_gateway_client_certificate aws_api_gateway_client_certificate} Resource.
func NewApiGatewayClientCertificate(scope constructs.Construct, id *string, config *ApiGatewayClientCertificateConfig) ApiGatewayClientCertificate {
	...
	_jsii_.Create(
		"@cdktn/provider-aws.apiGatewayClientCertificate.ApiGatewayClientCertificate",
...
func (j *jsiiProxy_ApiGatewayClientCertificate)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_ApiGatewayClientCertificate)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_ApiGatewayClientCertificate)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_ApiGatewayClientCertificate)SetRegion(val *string) {
...
func ApiGatewayClientCertificate_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateApiGatewayClientCertificate_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (a *jsiiProxy_ApiGatewayClientCertificate) AddMoveTarget(moveTarget *string) {
...
func (a *jsiiProxy_ApiGatewayClientCertificate) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_ApiGatewayClientCertificate) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (a *jsiiProxy_ApiGatewayClientCertificate) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_ApiGatewayClientCertificate) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (a *jsiiProxy_ApiGatewayClientCertificate) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (a *jsiiProxy_ApiGatewayClientCertificate) ResetRegion() {
	_jsii_.InvokeVoid(
		a,
		"resetRegion",
		nil, // no parameters
...
func (a *jsiiProxy_ApiGatewayClientCertificate) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
