...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/dataawsrdscertificate/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/data-sources/rds_certificate aws_rds_certificate}.
type DataAwsRdsCertificate interface {
	...
	CustomerOverride() cdktn.IResolvable
...
func (j *jsiiProxy_DataAwsRdsCertificate) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsRdsCertificate) CustomerOverride() cdktn.IResolvable {
...
func (j *jsiiProxy_DataAwsRdsCertificate) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsRdsCertificate) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsRdsCertificate) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsRdsCertificate) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DataAwsRdsCertificate) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_DataAwsRdsCertificate) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/data-sources/rds_certificate aws_rds_certificate} Data Source.
...
func (j *jsiiProxy_DataAwsRdsCertificate)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsRdsCertificate)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsRdsCertificate)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_DataAwsRdsCertificate)SetRegion(val *string) {
...
func DataAwsRdsCertificate_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsRdsCertificate) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsRdsCertificate) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsRdsCertificate) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsRdsCertificate) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsRdsCertificate) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
