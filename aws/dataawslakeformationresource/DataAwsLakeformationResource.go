...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/dataawslakeformationresource/internal"
...
type DataAwsLakeformationResource interface {
	...
	HybridAccessEnabled() cdktn.IResolvable
	Id() *string
	SetId(val *string)
	IdInput() *string
	LastModified() *string
	...
	WithFederation() cdktn.IResolvable
	WithPrivilegedAccess() cdktn.IResolvable
	// Experimental.
...
func (j *jsiiProxy_DataAwsLakeformationResource) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsLakeformationResource) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsLakeformationResource) HybridAccessEnabled() cdktn.IResolvable {
...
func (j *jsiiProxy_DataAwsLakeformationResource) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsLakeformationResource) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsLakeformationResource) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DataAwsLakeformationResource) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_DataAwsLakeformationResource) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DataAwsLakeformationResource) WithFederation() cdktn.IResolvable {
	var returns cdktn.IResolvable
	_jsii_.Get(
		j,
		"withFederation",
...
func (j *jsiiProxy_DataAwsLakeformationResource) WithPrivilegedAccess() cdktn.IResolvable {
	var returns cdktn.IResolvable
	_jsii_.Get(
		j,
...
func NewDataAwsLakeformationResource(scope constructs.Construct, id *string, config *DataAwsLakeformationResourceConfig) DataAwsLakeformationResource {
	...
	_jsii_.Create(
		"@cdktn/provider-aws.dataAwsLakeformationResource.DataAwsLakeformationResource",
...
func (j *jsiiProxy_DataAwsLakeformationResource)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsLakeformationResource)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsLakeformationResource)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_DataAwsLakeformationResource)SetRegion(val *string) {
...
func DataAwsLakeformationResource_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsLakeformationResource) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsLakeformationResource) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsLakeformationResource) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsLakeformationResource) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsLakeformationResource) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
