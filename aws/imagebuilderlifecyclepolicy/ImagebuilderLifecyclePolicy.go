...
type ImagebuilderLifecyclePolicy interface {
	...
	PutPolicyDetail(value interface{})
	PutResourceSelection(value interface{})
...
func (j *jsiiProxy_ImagebuilderLifecyclePolicy) PolicyDetail() ImagebuilderLifecyclePolicyPolicyDetailList {
	var returns ImagebuilderLifecyclePolicyPolicyDetailList
	_jsii_.Get(
		j,
		"policyDetail",
		&returns,
...
func (j *jsiiProxy_ImagebuilderLifecyclePolicy) PolicyDetailInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"policyDetailInput",
...
func (i *jsiiProxy_ImagebuilderLifecyclePolicy) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (i *jsiiProxy_ImagebuilderLifecyclePolicy) PutPolicyDetail(value interface{}) {
	if err := i.validatePutPolicyDetailParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		i,
...
func (i *jsiiProxy_ImagebuilderLifecyclePolicy) PutResourceSelection(value interface{}) {
...
func (i *jsiiProxy_ImagebuilderLifecyclePolicy) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (i *jsiiProxy_ImagebuilderLifecyclePolicy) ResetPolicyDetail() {
	_jsii_.InvokeVoid(
		i,
		"resetPolicyDetail",
		nil, // no parameters
...
func (i *jsiiProxy_ImagebuilderLifecyclePolicy) ResetResourceSelection() {
	_jsii_.InvokeVoid(
		i,
		"resetResourceSelection",
		nil, // no parameters
...
func (i *jsiiProxy_ImagebuilderLifecyclePolicy) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
