...
func (j *jsiiProxy_ImagebuilderLifecyclePolicyResourceSelectionList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_ImagebuilderLifecyclePolicyResourceSelectionList) InternalValue() interface{} {
...
func (j *jsiiProxy_ImagebuilderLifecyclePolicyResourceSelectionList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_ImagebuilderLifecyclePolicyResourceSelectionList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (j *jsiiProxy_ImagebuilderLifecyclePolicyResourceSelectionList)SetInternalValue(val interface{}) {
...
func (j *jsiiProxy_ImagebuilderLifecyclePolicyResourceSelectionList)SetTerraformAttribute(val *string) {
...
func (j *jsiiProxy_ImagebuilderLifecyclePolicyResourceSelectionList)SetWrapsSet(val *bool) {
...
func (i *jsiiProxy_ImagebuilderLifecyclePolicyResourceSelectionList) ComputeFqn() *string {
	var returns *string
...
func (i *jsiiProxy_ImagebuilderLifecyclePolicyResourceSelectionList) Get(index *float64) ImagebuilderLifecyclePolicyResourceSelectionOutputReference {
...
func (i *jsiiProxy_ImagebuilderLifecyclePolicyResourceSelectionList) ToString() *string {
	var returns *string
