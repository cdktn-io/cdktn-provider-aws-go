...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*RamResourceShareAssociationsExclusive)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-aws.ramResourceShareAssociationsExclusive.RamResourceShareAssociationsExclusiveConfig",
		reflect.TypeOf((*RamResourceShareAssociationsExclusiveConfig)(nil)).Elem(),
	)
}
