...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/ramresourceshareassociationsexclusive/internal"
...
func (r *jsiiProxy_RamResourceShareAssociationsExclusive) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (r *jsiiProxy_RamResourceShareAssociationsExclusive) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (r *jsiiProxy_RamResourceShareAssociationsExclusive) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
