...
func (q *jsiiProxy_QuicksightCustomPermissions) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (q *jsiiProxy_QuicksightCustomPermissions) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
