...
func (j *jsiiProxy_DataAwsSecretsmanagerSecrets) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsSecretsmanagerSecrets) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsSecretsmanagerSecrets) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsSecretsmanagerSecrets) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsSecretsmanagerSecrets) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/data-sources/secretsmanager_secrets aws_secretsmanager_secrets} Data Source.
...
func (j *jsiiProxy_DataAwsSecretsmanagerSecrets)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsSecretsmanagerSecrets)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsSecretsmanagerSecrets)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsSecretsmanagerSecrets_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsSecretsmanagerSecrets) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsSecretsmanagerSecrets) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsSecretsmanagerSecrets) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsSecretsmanagerSecrets) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
