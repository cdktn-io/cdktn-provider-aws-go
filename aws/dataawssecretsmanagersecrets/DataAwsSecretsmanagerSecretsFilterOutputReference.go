...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/dataawssecretsmanagersecrets/internal"
...
func (j *jsiiProxy_DataAwsSecretsmanagerSecretsFilterOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsSecretsmanagerSecretsFilterOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) DataAwsSecretsmanagerSecretsFilterOutputReference {
	_init_.Initialize()

	if err := validateNewDataAwsSecretsmanagerSecretsFilterOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
	j := jsiiProxy_DataAwsSecretsmanagerSecretsFilterOutputReference{}

	_jsii_.Create(
		"@cdktn/provider-aws.dataAwsSecretsmanagerSecrets.DataAwsSecretsmanagerSecretsFilterOutputReference",
...
func NewDataAwsSecretsmanagerSecretsFilterOutputReference_Override(d DataAwsSecretsmanagerSecretsFilterOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsSecretsmanagerSecretsFilterOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsSecretsmanagerSecretsFilterOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsSecretsmanagerSecretsFilterOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (d *jsiiProxy_DataAwsSecretsmanagerSecretsFilterOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsSecretsmanagerSecretsFilterOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
