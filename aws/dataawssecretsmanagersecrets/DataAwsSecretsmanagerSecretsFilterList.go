...
func (j *jsiiProxy_DataAwsSecretsmanagerSecretsFilterList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsSecretsmanagerSecretsFilterList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsSecretsmanagerSecretsFilterList {
	_init_.Initialize()

	if err := validateNewDataAwsSecretsmanagerSecretsFilterListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
	j := jsiiProxy_DataAwsSecretsmanagerSecretsFilterList{}

	_jsii_.Create(
		"@cdktn/provider-aws.dataAwsSecretsmanagerSecrets.DataAwsSecretsmanagerSecretsFilterList",
...
func NewDataAwsSecretsmanagerSecretsFilterList_Override(d DataAwsSecretsmanagerSecretsFilterList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsSecretsmanagerSecretsFilterList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsSecretsmanagerSecretsFilterList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsSecretsmanagerSecretsFilterList) Resolve(context cdktn.IResolveContext) interface{} {
