...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/lambdafunctionurl/internal"
...
func (j *jsiiProxy_LambdaFunctionUrl) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_LambdaFunctionUrl) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_LambdaFunctionUrl) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_LambdaFunctionUrl) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_LambdaFunctionUrl) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_LambdaFunctionUrl) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_LambdaFunctionUrl) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/lambda_function_url aws_lambda_function_url} Resource.
...
func (j *jsiiProxy_LambdaFunctionUrl)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_LambdaFunctionUrl)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_LambdaFunctionUrl)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_LambdaFunctionUrl)SetRegion(val *string) {
...
func LambdaFunctionUrl_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (l *jsiiProxy_LambdaFunctionUrl) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LambdaFunctionUrl) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (l *jsiiProxy_LambdaFunctionUrl) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LambdaFunctionUrl) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (l *jsiiProxy_LambdaFunctionUrl) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (l *jsiiProxy_LambdaFunctionUrl) ResetRegion() {
	_jsii_.InvokeVoid(
		l,
		"resetRegion",
		nil, // no parameters
...
func (l *jsiiProxy_LambdaFunctionUrl) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
