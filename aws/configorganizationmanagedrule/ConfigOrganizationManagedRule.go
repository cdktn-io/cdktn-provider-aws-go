...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/config_organization_managed_rule aws_config_organization_managed_rule} Resource.
...
func (c *jsiiProxy_ConfigOrganizationManagedRule) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_ConfigOrganizationManagedRule) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (c *jsiiProxy_ConfigOrganizationManagedRule) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
