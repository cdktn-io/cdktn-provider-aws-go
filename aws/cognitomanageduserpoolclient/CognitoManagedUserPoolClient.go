...
func (j *jsiiProxy_CognitoManagedUserPoolClient) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_CognitoManagedUserPoolClient) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_CognitoManagedUserPoolClient) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_CognitoManagedUserPoolClient) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_CognitoManagedUserPoolClient) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_CognitoManagedUserPoolClient)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_CognitoManagedUserPoolClient)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_CognitoManagedUserPoolClient)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func CognitoManagedUserPoolClient_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (c *jsiiProxy_CognitoManagedUserPoolClient) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CognitoManagedUserPoolClient) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (c *jsiiProxy_CognitoManagedUserPoolClient) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CognitoManagedUserPoolClient) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_CognitoManagedUserPoolClient) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (c *jsiiProxy_CognitoManagedUserPoolClient) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
