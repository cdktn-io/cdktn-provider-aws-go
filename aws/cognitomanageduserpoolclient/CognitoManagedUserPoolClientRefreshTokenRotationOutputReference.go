...
func (c *jsiiProxy_CognitoManagedUserPoolClientRefreshTokenRotationOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CognitoManagedUserPoolClientRefreshTokenRotationOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
