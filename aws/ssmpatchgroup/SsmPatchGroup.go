...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/ssmpatchgroup/internal"
...
func (j *jsiiProxy_SsmPatchGroup) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_SsmPatchGroup) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_SsmPatchGroup) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_SsmPatchGroup) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_SsmPatchGroup) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_SsmPatchGroup) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_SsmPatchGroup) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/ssm_patch_group aws_ssm_patch_group} Resource.
...
func (j *jsiiProxy_SsmPatchGroup)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_SsmPatchGroup)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_SsmPatchGroup)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_SsmPatchGroup)SetRegion(val *string) {
...
func SsmPatchGroup_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (s *jsiiProxy_SsmPatchGroup) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SsmPatchGroup) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_SsmPatchGroup) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SsmPatchGroup) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_SsmPatchGroup) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_SsmPatchGroup) ResetRegion() {
	_jsii_.InvokeVoid(
		s,
		"resetRegion",
		nil, // no parameters
...
func (s *jsiiProxy_SsmPatchGroup) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
