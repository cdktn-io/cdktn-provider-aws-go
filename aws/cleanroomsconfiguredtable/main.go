...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "allowedColumnsInput", GoGetter: "AllowedColumnsInput"},
			_jsii_.MemberProperty{JsiiProperty: "analysisMethod", GoGetter: "AnalysisMethod"},
			_jsii_.MemberProperty{JsiiProperty: "analysisMethodInput", GoGetter: "AnalysisMethodInput"},
	...
	_jsii_.RegisterClass(
		...
		func() interface{} {
			j := jsiiProxy_CleanroomsConfiguredTableTableReferenceOutputReference{}
