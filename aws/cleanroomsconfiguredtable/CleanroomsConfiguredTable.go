...
type CleanroomsConfiguredTable interface {
	...
	PutTimeouts(value *CleanroomsConfiguredTableTimeouts)
...
func (j *jsiiProxy_CleanroomsConfiguredTable) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_CleanroomsConfiguredTable) CreateTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"createTime",
...
func (j *jsiiProxy_CleanroomsConfiguredTable) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_CleanroomsConfiguredTable) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_CleanroomsConfiguredTable) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_CleanroomsConfiguredTable) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_CleanroomsConfiguredTable) TableReferenceInput() *CleanroomsConfiguredTableTableReference {
	var returns *CleanroomsConfiguredTableTableReference
	_jsii_.Get(
		j,
		"tableReferenceInput",
		&returns,
...
func (j *jsiiProxy_CleanroomsConfiguredTable) Tags() *map[string]*string {
...
func (j *jsiiProxy_CleanroomsConfiguredTable) TagsAll() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsAll",
...
func (j *jsiiProxy_CleanroomsConfiguredTable) TagsAllInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsAllInput",
...
func (j *jsiiProxy_CleanroomsConfiguredTable) TagsInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsInput",
...
func (j *jsiiProxy_CleanroomsConfiguredTable) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_CleanroomsConfiguredTable) Timeouts() CleanroomsConfiguredTableTimeoutsOutputReference {
	var returns CleanroomsConfiguredTableTimeoutsOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
func (j *jsiiProxy_CleanroomsConfiguredTable) TimeoutsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"timeoutsInput",
...
func (j *jsiiProxy_CleanroomsConfiguredTable) UpdateTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"updateTime",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/cleanrooms_configured_table aws_cleanrooms_configured_table} Resource.
...
func (j *jsiiProxy_CleanroomsConfiguredTable)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_CleanroomsConfiguredTable)SetId(val *string) {
...
func (j *jsiiProxy_CleanroomsConfiguredTable)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_CleanroomsConfiguredTable)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_CleanroomsConfiguredTable)SetTags(val *map[string]*string) {
...
func (j *jsiiProxy_CleanroomsConfiguredTable)SetTagsAll(val *map[string]*string) {
...
func CleanroomsConfiguredTable_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (c *jsiiProxy_CleanroomsConfiguredTable) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CleanroomsConfiguredTable) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (c *jsiiProxy_CleanroomsConfiguredTable) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CleanroomsConfiguredTable) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_CleanroomsConfiguredTable) PutTimeouts(value *CleanroomsConfiguredTableTimeouts) {
...
func (c *jsiiProxy_CleanroomsConfiguredTable) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (c *jsiiProxy_CleanroomsConfiguredTable) ResetId() {
	_jsii_.InvokeVoid(
		c,
		"resetId",
		nil, // no parameters
...
func (c *jsiiProxy_CleanroomsConfiguredTable) ResetTagsAll() {
	_jsii_.InvokeVoid(
		c,
		"resetTagsAll",
		nil, // no parameters
...
func (c *jsiiProxy_CleanroomsConfiguredTable) ResetTimeouts() {
	_jsii_.InvokeVoid(
		c,
		"resetTimeouts",
		nil, // no parameters
...
func (c *jsiiProxy_CleanroomsConfiguredTable) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
