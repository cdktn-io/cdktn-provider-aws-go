...
func (j *jsiiProxy_Route53ResolverRuleTargetIpOutputReference) Ipv6() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ipv6",
...
func (j *jsiiProxy_Route53ResolverRuleTargetIpOutputReference) Ipv6Input() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ipv6Input",
...
func (j *jsiiProxy_Route53ResolverRuleTargetIpOutputReference)SetIpv6(val *string) {
...
func (r *jsiiProxy_Route53ResolverRuleTargetIpOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (r *jsiiProxy_Route53ResolverRuleTargetIpOutputReference) ResetIp() {
	_jsii_.InvokeVoid(
		r,
		"resetIp",
		nil, // no parameters
...
func (r *jsiiProxy_Route53ResolverRuleTargetIpOutputReference) ResetIpv6() {
	_jsii_.InvokeVoid(
		r,
		"resetIpv6",
		nil, // no parameters
...
func (r *jsiiProxy_Route53ResolverRuleTargetIpOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
