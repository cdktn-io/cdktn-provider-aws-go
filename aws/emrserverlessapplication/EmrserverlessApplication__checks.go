...
func (e *jsiiProxy_EmrserverlessApplication) validatePutInitialCapacityParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*EmrserverlessApplicationInitialCapacity; received %#v (a %T)", value, value)
		}
	}
...
func (e *jsiiProxy_EmrserverlessApplication) validatePutRuntimeConfigurationParameters(value interface{}) error {
	...
	case cdktn.IResolvable:
		// ok
	case *[]*EmrserverlessApplicationRuntimeConfiguration:
		value := value.(*[]*EmrserverlessApplicationRuntimeConfiguration)
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
			}
	...
	case []*EmrserverlessApplicationRuntimeConfiguration:
		value_ := value.([]*EmrserverlessApplicationRuntimeConfiguration)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*EmrserverlessApplicationRuntimeConfiguration; received %#v (a %T)", value, value)
		}
	}
