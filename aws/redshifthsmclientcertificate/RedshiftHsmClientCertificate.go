...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/redshifthsmclientcertificate/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/redshift_hsm_client_certificate aws_redshift_hsm_client_certificate}.
...
func (j *jsiiProxy_RedshiftHsmClientCertificate) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_RedshiftHsmClientCertificate) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_RedshiftHsmClientCertificate) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_RedshiftHsmClientCertificate) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_RedshiftHsmClientCertificate) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/redshift_hsm_client_certificate aws_redshift_hsm_client_certificate} Resource.
func NewRedshiftHsmClientCertificate(scope constructs.Construct, id *string, config *RedshiftHsmClientCertificateConfig) RedshiftHsmClientCertificate {
	...
	if err := validateNewRedshiftHsmClientCertificateParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_RedshiftHsmClientCertificate)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_RedshiftHsmClientCertificate)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_RedshiftHsmClientCertificate)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func RedshiftHsmClientCertificate_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateRedshiftHsmClientCertificate_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (r *jsiiProxy_RedshiftHsmClientCertificate) AddMoveTarget(moveTarget *string) {
...
func (r *jsiiProxy_RedshiftHsmClientCertificate) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (r *jsiiProxy_RedshiftHsmClientCertificate) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (r *jsiiProxy_RedshiftHsmClientCertificate) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (r *jsiiProxy_RedshiftHsmClientCertificate) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (r *jsiiProxy_RedshiftHsmClientCertificate) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (r *jsiiProxy_RedshiftHsmClientCertificate) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
