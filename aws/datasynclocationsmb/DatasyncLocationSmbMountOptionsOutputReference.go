...
func (j *jsiiProxy_DatasyncLocationSmbMountOptionsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDatasyncLocationSmbMountOptionsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) DatasyncLocationSmbMountOptionsOutputReference {
	_init_.Initialize()
...
func NewDatasyncLocationSmbMountOptionsOutputReference_Override(d DatasyncLocationSmbMountOptionsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_DatasyncLocationSmbMountOptionsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DatasyncLocationSmbMountOptionsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DatasyncLocationSmbMountOptionsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (d *jsiiProxy_DatasyncLocationSmbMountOptionsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DatasyncLocationSmbMountOptionsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
