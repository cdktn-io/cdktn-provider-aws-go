...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/dxconnectionconfirmation/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/dx_connection_confirmation aws_dx_connection_confirmation}.
...
func (j *jsiiProxy_DxConnectionConfirmation) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DxConnectionConfirmation) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DxConnectionConfirmation) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DxConnectionConfirmation) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DxConnectionConfirmation) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/dx_connection_confirmation aws_dx_connection_confirmation} Resource.
...
func (j *jsiiProxy_DxConnectionConfirmation)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DxConnectionConfirmation)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DxConnectionConfirmation)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DxConnectionConfirmation_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DxConnectionConfirmation) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DxConnectionConfirmation) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (d *jsiiProxy_DxConnectionConfirmation) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DxConnectionConfirmation) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (d *jsiiProxy_DxConnectionConfirmation) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DxConnectionConfirmation) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
