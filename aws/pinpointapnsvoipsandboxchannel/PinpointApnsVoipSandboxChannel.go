...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/pinpointapnsvoipsandboxchannel/internal"
...
func (j *jsiiProxy_PinpointApnsVoipSandboxChannel) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_PinpointApnsVoipSandboxChannel) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_PinpointApnsVoipSandboxChannel) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_PinpointApnsVoipSandboxChannel) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_PinpointApnsVoipSandboxChannel) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/pinpoint_apns_voip_sandbox_channel aws_pinpoint_apns_voip_sandbox_channel} Resource.
...
func (j *jsiiProxy_PinpointApnsVoipSandboxChannel)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_PinpointApnsVoipSandboxChannel)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_PinpointApnsVoipSandboxChannel)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func PinpointApnsVoipSandboxChannel_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (p *jsiiProxy_PinpointApnsVoipSandboxChannel) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PinpointApnsVoipSandboxChannel) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (p *jsiiProxy_PinpointApnsVoipSandboxChannel) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PinpointApnsVoipSandboxChannel) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (p *jsiiProxy_PinpointApnsVoipSandboxChannel) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (p *jsiiProxy_PinpointApnsVoipSandboxChannel) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
