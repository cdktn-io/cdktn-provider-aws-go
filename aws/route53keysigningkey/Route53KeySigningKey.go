...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.31.0/docs/resources/route53_key_signing_key aws_route53_key_signing_key}.
...
func (j *jsiiProxy_Route53KeySigningKey) ForEach() cdktf.ITerraformIterator {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.31.0/docs/resources/route53_key_signing_key aws_route53_key_signing_key} Resource.
...
func Route53KeySigningKey_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (r *jsiiProxy_Route53KeySigningKey) ImportFrom(id *string, provider cdktf.TerraformProvider) {
