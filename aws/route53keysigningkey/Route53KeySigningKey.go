...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/route53_key_signing_key aws_route53_key_signing_key}.
...
func (j *jsiiProxy_Route53KeySigningKey) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_Route53KeySigningKey) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_Route53KeySigningKey) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_Route53KeySigningKey) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_Route53KeySigningKey) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_Route53KeySigningKey) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/route53_key_signing_key aws_route53_key_signing_key} Resource.
func NewRoute53KeySigningKey(scope constructs.Construct, id *string, config *Route53KeySigningKeyConfig) Route53KeySigningKey {
	_init_.Initialize()

	if err := validateNewRoute53KeySigningKeyParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_Route53KeySigningKey)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_Route53KeySigningKey)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_Route53KeySigningKey)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func Route53KeySigningKey_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateRoute53KeySigningKey_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (r *jsiiProxy_Route53KeySigningKey) AddMoveTarget(moveTarget *string) {
...
func (r *jsiiProxy_Route53KeySigningKey) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (r *jsiiProxy_Route53KeySigningKey) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (r *jsiiProxy_Route53KeySigningKey) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (r *jsiiProxy_Route53KeySigningKey) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (r *jsiiProxy_Route53KeySigningKey) MoveFromId(id *string) {
...
func (r *jsiiProxy_Route53KeySigningKey) MoveToId(id *string) {
...
func (r *jsiiProxy_Route53KeySigningKey) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
