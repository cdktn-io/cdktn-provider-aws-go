...
func (j *jsiiProxy_DataAwsCloudformationType) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsCloudformationType) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsCloudformationType) IsDefaultVersion() cdktn.IResolvable {
...
func (j *jsiiProxy_DataAwsCloudformationType) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsCloudformationType) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsCloudformationType) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DataAwsCloudformationType)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsCloudformationType)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsCloudformationType)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsCloudformationType_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsCloudformationType) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsCloudformationType) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsCloudformationType) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
