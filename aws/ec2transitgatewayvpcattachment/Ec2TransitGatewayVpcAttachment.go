...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/ec2transitgatewayvpcattachment/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/ec2_transit_gateway_vpc_attachment aws_ec2_transit_gateway_vpc_attachment}.
...
func (j *jsiiProxy_Ec2TransitGatewayVpcAttachment) Arn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"arn",
...
func (j *jsiiProxy_Ec2TransitGatewayVpcAttachment) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_Ec2TransitGatewayVpcAttachment) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_Ec2TransitGatewayVpcAttachment) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_Ec2TransitGatewayVpcAttachment) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_Ec2TransitGatewayVpcAttachment) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_Ec2TransitGatewayVpcAttachment) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_Ec2TransitGatewayVpcAttachment) SecurityGroupReferencingSupport() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_Ec2TransitGatewayVpcAttachment) SecurityGroupReferencingSupportInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_Ec2TransitGatewayVpcAttachment) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/ec2_transit_gateway_vpc_attachment aws_ec2_transit_gateway_vpc_attachment} Resource.
...
func (j *jsiiProxy_Ec2TransitGatewayVpcAttachment)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_Ec2TransitGatewayVpcAttachment)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_Ec2TransitGatewayVpcAttachment)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_Ec2TransitGatewayVpcAttachment)SetRegion(val *string) {
...
func (j *jsiiProxy_Ec2TransitGatewayVpcAttachment)SetSecurityGroupReferencingSupport(val *string) {
...
func Ec2TransitGatewayVpcAttachment_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (e *jsiiProxy_Ec2TransitGatewayVpcAttachment) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (e *jsiiProxy_Ec2TransitGatewayVpcAttachment) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (e *jsiiProxy_Ec2TransitGatewayVpcAttachment) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (e *jsiiProxy_Ec2TransitGatewayVpcAttachment) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (e *jsiiProxy_Ec2TransitGatewayVpcAttachment) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (e *jsiiProxy_Ec2TransitGatewayVpcAttachment) ResetRegion() {
	_jsii_.InvokeVoid(
		e,
		"resetRegion",
		nil, // no parameters
...
func (e *jsiiProxy_Ec2TransitGatewayVpcAttachment) ResetSecurityGroupReferencingSupport() {
	_jsii_.InvokeVoid(
		e,
		"resetSecurityGroupReferencingSupport",
		nil, // no parameters
...
func (e *jsiiProxy_Ec2TransitGatewayVpcAttachment) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
