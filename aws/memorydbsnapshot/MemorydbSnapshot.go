...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/memorydbsnapshot/internal"
...
type MemorydbSnapshot interface {
	...
	ClusterConfiguration() MemorydbSnapshotClusterConfigurationList
	ClusterName() *string
...
func (j *jsiiProxy_MemorydbSnapshot) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_MemorydbSnapshot) ClusterConfiguration() MemorydbSnapshotClusterConfigurationList {
	var returns MemorydbSnapshotClusterConfigurationList
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_MemorydbSnapshot) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_MemorydbSnapshot) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_MemorydbSnapshot) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_MemorydbSnapshot) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_MemorydbSnapshot) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func NewMemorydbSnapshot(scope constructs.Construct, id *string, config *MemorydbSnapshotConfig) MemorydbSnapshot {
	...
	if err := validateNewMemorydbSnapshotParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_MemorydbSnapshot)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_MemorydbSnapshot)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_MemorydbSnapshot)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func MemorydbSnapshot_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateMemorydbSnapshot_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (m *jsiiProxy_MemorydbSnapshot) AddMoveTarget(moveTarget *string) {
...
func (m *jsiiProxy_MemorydbSnapshot) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MemorydbSnapshot) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (m *jsiiProxy_MemorydbSnapshot) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MemorydbSnapshot) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (m *jsiiProxy_MemorydbSnapshot) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (m *jsiiProxy_MemorydbSnapshot) ResetId() {
	_jsii_.InvokeVoid(
		m,
		"resetId",
		nil, // no parameters
...
func (m *jsiiProxy_MemorydbSnapshot) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
