...
func (j *jsiiProxy_MemorydbSnapshot) ForEach() cdktf.ITerraformIterator {
...
func MemorydbSnapshot_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
