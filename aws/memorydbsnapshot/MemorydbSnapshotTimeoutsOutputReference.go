...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v21/memorydbsnapshot/internal"
...
func (j *jsiiProxy_MemorydbSnapshotTimeoutsOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_MemorydbSnapshotTimeoutsOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_MemorydbSnapshotTimeoutsOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_MemorydbSnapshotTimeoutsOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_MemorydbSnapshotTimeoutsOutputReference)SetComplexObjectIndex(val interface{}) {
...
func (j *jsiiProxy_MemorydbSnapshotTimeoutsOutputReference)SetComplexObjectIsFromSet(val *bool) {
...
func (j *jsiiProxy_MemorydbSnapshotTimeoutsOutputReference)SetInternalValue(val interface{}) {
...
func (m *jsiiProxy_MemorydbSnapshotTimeoutsOutputReference) ComputeFqn() *string {
	var returns *string
...
func (m *jsiiProxy_MemorydbSnapshotTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (m *jsiiProxy_MemorydbSnapshotTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
...
func (m *jsiiProxy_MemorydbSnapshotTimeoutsOutputReference) ToString() *string {
	var returns *string
