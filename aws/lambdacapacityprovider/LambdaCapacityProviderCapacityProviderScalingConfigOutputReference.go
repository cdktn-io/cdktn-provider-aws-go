...
func NewLambdaCapacityProviderCapacityProviderScalingConfigOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) LambdaCapacityProviderCapacityProviderScalingConfigOutputReference {
	_init_.Initialize()
...
func NewLambdaCapacityProviderCapacityProviderScalingConfigOutputReference_Override(l LambdaCapacityProviderCapacityProviderScalingConfigOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
