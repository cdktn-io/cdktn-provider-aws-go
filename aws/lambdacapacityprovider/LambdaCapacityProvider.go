...
func (l *jsiiProxy_LambdaCapacityProvider) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (l *jsiiProxy_LambdaCapacityProvider) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
