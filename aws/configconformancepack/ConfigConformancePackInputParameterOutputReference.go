...
func (c *jsiiProxy_ConfigConformancePackInputParameterOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ConfigConformancePackInputParameterOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
