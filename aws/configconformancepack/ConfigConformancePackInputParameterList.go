...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v22/configconformancepack/internal"
...
func (c *jsiiProxy_ConfigConformancePackInputParameterList) Resolve(context cdktf.IResolveContext) interface{} {
