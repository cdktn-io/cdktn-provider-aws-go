...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/configconformancepack/internal"
...
func (j *jsiiProxy_ConfigConformancePackInputParameterList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewConfigConformancePackInputParameterList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ConfigConformancePackInputParameterList {
	_init_.Initialize()
...
func NewConfigConformancePackInputParameterList_Override(c ConfigConformancePackInputParameterList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ConfigConformancePackInputParameterList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_ConfigConformancePackInputParameterList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (c *jsiiProxy_ConfigConformancePackInputParameterList) Resolve(context cdktn.IResolveContext) interface{} {
