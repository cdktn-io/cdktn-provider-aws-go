...
func (j *jsiiProxy_DataAwsNetworkfirewallFirewallFirewallStatusSyncStatesList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsNetworkfirewallFirewallFirewallStatusSyncStatesList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsNetworkfirewallFirewallFirewallStatusSyncStatesList {
	_init_.Initialize()
...
func NewDataAwsNetworkfirewallFirewallFirewallStatusSyncStatesList_Override(d DataAwsNetworkfirewallFirewallFirewallStatusSyncStatesList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsNetworkfirewallFirewallFirewallStatusSyncStatesList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsNetworkfirewallFirewallFirewallStatusSyncStatesList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsNetworkfirewallFirewallFirewallStatusSyncStatesList) Resolve(context cdktn.IResolveContext) interface{} {
