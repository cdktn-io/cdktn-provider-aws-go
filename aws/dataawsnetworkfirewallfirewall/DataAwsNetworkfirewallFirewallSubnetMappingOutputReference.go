...
func (d *jsiiProxy_DataAwsNetworkfirewallFirewallSubnetMappingOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataAwsNetworkfirewallFirewallSubnetMappingOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
