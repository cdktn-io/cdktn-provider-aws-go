...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/dataawscognitoidentitypool/internal"
...
func (j *jsiiProxy_DataAwsCognitoIdentityPoolCognitoIdentityProvidersList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsCognitoIdentityPoolCognitoIdentityProvidersList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsCognitoIdentityPoolCognitoIdentityProvidersList {
	_init_.Initialize()
...
func NewDataAwsCognitoIdentityPoolCognitoIdentityProvidersList_Override(d DataAwsCognitoIdentityPoolCognitoIdentityProvidersList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsCognitoIdentityPoolCognitoIdentityProvidersList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsCognitoIdentityPoolCognitoIdentityProvidersList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsCognitoIdentityPoolCognitoIdentityProvidersList) Resolve(context cdktn.IResolveContext) interface{} {
