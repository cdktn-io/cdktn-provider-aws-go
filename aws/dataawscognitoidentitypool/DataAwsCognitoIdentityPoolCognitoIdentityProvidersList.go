...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v22/dataawscognitoidentitypool/internal"
...
func (d *jsiiProxy_DataAwsCognitoIdentityPoolCognitoIdentityProvidersList) Resolve(context cdktf.IResolveContext) interface{} {
