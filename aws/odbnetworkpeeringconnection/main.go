...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "peerNetworkIdInput", GoGetter: "PeerNetworkIdInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetPeerNetworkCidrs", GoMethod: "ResetPeerNetworkCidrs"},
