...
func (j *jsiiProxy_DataAwsIdentitystoreGroupsGroupsExternalIdsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsIdentitystoreGroupsGroupsExternalIdsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsIdentitystoreGroupsGroupsExternalIdsList {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-aws.dataAwsIdentitystoreGroups.DataAwsIdentitystoreGroupsGroupsExternalIdsList",
...
func NewDataAwsIdentitystoreGroupsGroupsExternalIdsList_Override(d DataAwsIdentitystoreGroupsGroupsExternalIdsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsIdentitystoreGroupsGroupsExternalIdsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsIdentitystoreGroupsGroupsExternalIdsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsIdentitystoreGroupsGroupsExternalIdsList) Resolve(context cdktn.IResolveContext) interface{} {
