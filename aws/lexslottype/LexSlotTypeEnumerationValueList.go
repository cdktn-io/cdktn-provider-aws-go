...
func (j *jsiiProxy_LexSlotTypeEnumerationValueList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewLexSlotTypeEnumerationValueList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) LexSlotTypeEnumerationValueList {
	_init_.Initialize()
...
func NewLexSlotTypeEnumerationValueList_Override(l LexSlotTypeEnumerationValueList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_LexSlotTypeEnumerationValueList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (l *jsiiProxy_LexSlotTypeEnumerationValueList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (l *jsiiProxy_LexSlotTypeEnumerationValueList) Resolve(context cdktn.IResolveContext) interface{} {
