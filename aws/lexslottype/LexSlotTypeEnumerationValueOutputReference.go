...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v24/lexslottype/internal"
...
func (j *jsiiProxy_LexSlotTypeEnumerationValueOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewLexSlotTypeEnumerationValueOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) LexSlotTypeEnumerationValueOutputReference {
	_init_.Initialize()
...
func NewLexSlotTypeEnumerationValueOutputReference_Override(l LexSlotTypeEnumerationValueOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_LexSlotTypeEnumerationValueOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (l *jsiiProxy_LexSlotTypeEnumerationValueOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LexSlotTypeEnumerationValueOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (l *jsiiProxy_LexSlotTypeEnumerationValueOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LexSlotTypeEnumerationValueOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
