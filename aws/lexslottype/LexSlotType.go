...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/lexslottype/internal"
...
func (j *jsiiProxy_LexSlotType) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_LexSlotType) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_LexSlotType) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_LexSlotType) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_LexSlotType) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_LexSlotType)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_LexSlotType)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_LexSlotType)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func LexSlotType_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (l *jsiiProxy_LexSlotType) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LexSlotType) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (l *jsiiProxy_LexSlotType) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LexSlotType) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (l *jsiiProxy_LexSlotType) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (l *jsiiProxy_LexSlotType) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
