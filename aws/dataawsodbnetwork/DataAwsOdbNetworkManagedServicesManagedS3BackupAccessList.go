...
func (j *jsiiProxy_DataAwsOdbNetworkManagedServicesManagedS3BackupAccessList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsOdbNetworkManagedServicesManagedS3BackupAccessList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsOdbNetworkManagedServicesManagedS3BackupAccessList {
	_init_.Initialize()
...
func NewDataAwsOdbNetworkManagedServicesManagedS3BackupAccessList_Override(d DataAwsOdbNetworkManagedServicesManagedS3BackupAccessList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsOdbNetworkManagedServicesManagedS3BackupAccessList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsOdbNetworkManagedServicesManagedS3BackupAccessList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsOdbNetworkManagedServicesManagedS3BackupAccessList) Resolve(context cdktn.IResolveContext) interface{} {
