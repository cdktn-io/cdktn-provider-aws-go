...
func (j *jsiiProxy_DataAwsOdbNetwork) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_DataAwsOdbNetwork) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsOdbNetwork) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsOdbNetwork) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_DataAwsOdbNetwork) Tags() cdktf.StringMap {
...
func (j *jsiiProxy_DataAwsOdbNetwork) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.32.1/docs/data-sources/odb_network aws_odb_network} Data Source.
...
func (j *jsiiProxy_DataAwsOdbNetwork)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsOdbNetwork)SetLifecycle(val *cdktf.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsOdbNetwork)SetProvider(val cdktf.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsOdbNetwork_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsOdbNetwork) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataAwsOdbNetwork) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
