...
func (c *jsiiProxy_CodegurureviewerRepositoryAssociationRepositoryBitbucketOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CodegurureviewerRepositoryAssociationRepositoryBitbucketOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
