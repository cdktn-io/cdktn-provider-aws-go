...
func (c *jsiiProxy_CodegurureviewerRepositoryAssociationKmsKeyDetailsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CodegurureviewerRepositoryAssociationKmsKeyDetailsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
