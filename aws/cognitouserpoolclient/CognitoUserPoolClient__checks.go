...
func (c *jsiiProxy_CognitoUserPoolClient) validatePutAnalyticsConfigurationParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*CognitoUserPoolClientAnalyticsConfiguration; received %#v (a %T)", value, value)
		}
	}
...
func (c *jsiiProxy_CognitoUserPoolClient) validatePutRefreshTokenRotationParameters(value interface{}) error {
	if value == nil {
		return fmt.Errorf("parameter value is required, but nil was provided")
	}
	switch value.(type) {
	...
	case *[]*CognitoUserPoolClientRefreshTokenRotation:
		value := value.(*[]*CognitoUserPoolClientRefreshTokenRotation)
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
			}
	...
	case []*CognitoUserPoolClientRefreshTokenRotation:
		value_ := value.([]*CognitoUserPoolClientRefreshTokenRotation)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*CognitoUserPoolClientRefreshTokenRotation; received %#v (a %T)", value, value)
		}
	}
...
func (c *jsiiProxy_CognitoUserPoolClient) validatePutTokenValidityUnitsParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*CognitoUserPoolClientTokenValidityUnits; received %#v (a %T)", value, value)
		}
	}
