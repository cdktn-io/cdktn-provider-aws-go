...
func (j *jsiiProxy_CognitoUserPoolClientRefreshTokenRotationOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewCognitoUserPoolClientRefreshTokenRotationOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) CognitoUserPoolClientRefreshTokenRotationOutputReference {
	_init_.Initialize()
...
func NewCognitoUserPoolClientRefreshTokenRotationOutputReference_Override(c CognitoUserPoolClientRefreshTokenRotationOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_CognitoUserPoolClientRefreshTokenRotationOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_CognitoUserPoolClientRefreshTokenRotationOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CognitoUserPoolClientRefreshTokenRotationOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (c *jsiiProxy_CognitoUserPoolClientRefreshTokenRotationOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CognitoUserPoolClientRefreshTokenRotationOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
