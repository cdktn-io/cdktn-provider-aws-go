...
func (c *jsiiProxy_CognitoUserPoolClientTokenValidityUnitsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CognitoUserPoolClientTokenValidityUnitsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
