...
func (j *jsiiProxy_CognitoUserPoolClientTokenValidityUnitsOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_CognitoUserPoolClientTokenValidityUnitsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewCognitoUserPoolClientTokenValidityUnitsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) CognitoUserPoolClientTokenValidityUnitsOutputReference {
	_init_.Initialize()

	if err := validateNewCognitoUserPoolClientTokenValidityUnitsOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func NewCognitoUserPoolClientTokenValidityUnitsOutputReference_Override(c CognitoUserPoolClientTokenValidityUnitsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_CognitoUserPoolClientTokenValidityUnitsOutputReference)SetInternalValue(val interface{}) {
...
func (j *jsiiProxy_CognitoUserPoolClientTokenValidityUnitsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_CognitoUserPoolClientTokenValidityUnitsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CognitoUserPoolClientTokenValidityUnitsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (c *jsiiProxy_CognitoUserPoolClientTokenValidityUnitsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CognitoUserPoolClientTokenValidityUnitsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
