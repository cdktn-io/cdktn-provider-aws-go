...
func (j *jsiiProxy_IamRole) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_IamRole) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_IamRole) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_IamRole) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_IamRole) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/iam_role aws_iam_role} Resource.
...
func (j *jsiiProxy_IamRole)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_IamRole)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_IamRole)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func IamRole_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (i *jsiiProxy_IamRole) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (i *jsiiProxy_IamRole) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (i *jsiiProxy_IamRole) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (i *jsiiProxy_IamRole) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (i *jsiiProxy_IamRole) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (i *jsiiProxy_IamRole) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
