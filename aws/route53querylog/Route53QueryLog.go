...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/route53querylog/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/route53_query_log aws_route53_query_log}.
...
func (j *jsiiProxy_Route53QueryLog) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_Route53QueryLog) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_Route53QueryLog) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_Route53QueryLog) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_Route53QueryLog) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/route53_query_log aws_route53_query_log} Resource.
func NewRoute53QueryLog(scope constructs.Construct, id *string, config *Route53QueryLogConfig) Route53QueryLog {
	...
	_jsii_.Create(
		"@cdktn/provider-aws.route53QueryLog.Route53QueryLog",
...
func (j *jsiiProxy_Route53QueryLog)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_Route53QueryLog)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_Route53QueryLog)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
// Generates CDKTN code for importing a Route53QueryLog resource upon running "cdktn plan <stack-name>".
func Route53QueryLog_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateRoute53QueryLog_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (r *jsiiProxy_Route53QueryLog) AddMoveTarget(moveTarget *string) {
...
func (r *jsiiProxy_Route53QueryLog) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (r *jsiiProxy_Route53QueryLog) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (r *jsiiProxy_Route53QueryLog) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (r *jsiiProxy_Route53QueryLog) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (r *jsiiProxy_Route53QueryLog) MoveFromId(id *string) {
...
func (r *jsiiProxy_Route53QueryLog) MoveToId(id *string) {
...
func (r *jsiiProxy_Route53QueryLog) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
