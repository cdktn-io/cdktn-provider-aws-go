...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v21/route53querylog/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.28.0/docs/resources/route53_query_log aws_route53_query_log}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.28.0/docs/resources/route53_query_log aws_route53_query_log} Resource.
...
func Route53QueryLog_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (r *jsiiProxy_Route53QueryLog) ImportFrom(id *string, provider cdktf.TerraformProvider) {
