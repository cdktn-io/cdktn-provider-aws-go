...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/datazoneenvironmentblueprintconfiguration/internal"
...
func (j *jsiiProxy_DatazoneEnvironmentBlueprintConfiguration) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DatazoneEnvironmentBlueprintConfiguration) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DatazoneEnvironmentBlueprintConfiguration) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DatazoneEnvironmentBlueprintConfiguration) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DatazoneEnvironmentBlueprintConfiguration)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DatazoneEnvironmentBlueprintConfiguration)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DatazoneEnvironmentBlueprintConfiguration)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DatazoneEnvironmentBlueprintConfiguration_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DatazoneEnvironmentBlueprintConfiguration) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DatazoneEnvironmentBlueprintConfiguration) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (d *jsiiProxy_DatazoneEnvironmentBlueprintConfiguration) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DatazoneEnvironmentBlueprintConfiguration) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (d *jsiiProxy_DatazoneEnvironmentBlueprintConfiguration) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DatazoneEnvironmentBlueprintConfiguration) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
