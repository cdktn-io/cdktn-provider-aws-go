...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/redshiftsnapshotschedule/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/redshift_snapshot_schedule aws_redshift_snapshot_schedule}.
...
func (j *jsiiProxy_RedshiftSnapshotSchedule) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_RedshiftSnapshotSchedule) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_RedshiftSnapshotSchedule) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_RedshiftSnapshotSchedule) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_RedshiftSnapshotSchedule) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/redshift_snapshot_schedule aws_redshift_snapshot_schedule} Resource.
...
func (j *jsiiProxy_RedshiftSnapshotSchedule)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_RedshiftSnapshotSchedule)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_RedshiftSnapshotSchedule)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func RedshiftSnapshotSchedule_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (r *jsiiProxy_RedshiftSnapshotSchedule) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (r *jsiiProxy_RedshiftSnapshotSchedule) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (r *jsiiProxy_RedshiftSnapshotSchedule) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (r *jsiiProxy_RedshiftSnapshotSchedule) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (r *jsiiProxy_RedshiftSnapshotSchedule) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (r *jsiiProxy_RedshiftSnapshotSchedule) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
