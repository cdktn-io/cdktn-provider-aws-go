...
func (j *jsiiProxy_GuarddutyOrganizationConfigurationFeatureAdditionalConfigurationList) validateSetInternalValueParameters(val interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktn.IResolvable, *[]*GuarddutyOrganizationConfigurationFeatureAdditionalConfiguration; received %#v (a %T)", val, val)
		}
	}
