...
func (j *jsiiProxy_DatasyncLocationFsxOntapFileSystem) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DatasyncLocationFsxOntapFileSystem) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DatasyncLocationFsxOntapFileSystem) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DatasyncLocationFsxOntapFileSystem) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DatasyncLocationFsxOntapFileSystem) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/datasync_location_fsx_ontap_file_system aws_datasync_location_fsx_ontap_file_system} Resource.
...
func (j *jsiiProxy_DatasyncLocationFsxOntapFileSystem)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DatasyncLocationFsxOntapFileSystem)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DatasyncLocationFsxOntapFileSystem)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DatasyncLocationFsxOntapFileSystem_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DatasyncLocationFsxOntapFileSystem) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DatasyncLocationFsxOntapFileSystem) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (d *jsiiProxy_DatasyncLocationFsxOntapFileSystem) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DatasyncLocationFsxOntapFileSystem) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (d *jsiiProxy_DatasyncLocationFsxOntapFileSystem) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DatasyncLocationFsxOntapFileSystem) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
