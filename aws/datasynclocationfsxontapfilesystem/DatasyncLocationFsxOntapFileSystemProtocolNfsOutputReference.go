...
func (d *jsiiProxy_DatasyncLocationFsxOntapFileSystemProtocolNfsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DatasyncLocationFsxOntapFileSystemProtocolNfsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
