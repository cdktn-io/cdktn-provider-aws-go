...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v21/cloudwatchlogresourcepolicy/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.28.0/docs/resources/cloudwatch_log_resource_policy aws_cloudwatch_log_resource_policy}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.28.0/docs/resources/cloudwatch_log_resource_policy aws_cloudwatch_log_resource_policy} Resource.
...
func CloudwatchLogResourcePolicy_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (c *jsiiProxy_CloudwatchLogResourcePolicy) ImportFrom(id *string, provider cdktf.TerraformProvider) {
