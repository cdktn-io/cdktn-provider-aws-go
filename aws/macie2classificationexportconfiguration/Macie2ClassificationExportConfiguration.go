...
func (j *jsiiProxy_Macie2ClassificationExportConfiguration) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_Macie2ClassificationExportConfiguration) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_Macie2ClassificationExportConfiguration) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_Macie2ClassificationExportConfiguration) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_Macie2ClassificationExportConfiguration) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_Macie2ClassificationExportConfiguration)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_Macie2ClassificationExportConfiguration)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_Macie2ClassificationExportConfiguration)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func Macie2ClassificationExportConfiguration_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (m *jsiiProxy_Macie2ClassificationExportConfiguration) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_Macie2ClassificationExportConfiguration) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (m *jsiiProxy_Macie2ClassificationExportConfiguration) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_Macie2ClassificationExportConfiguration) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (m *jsiiProxy_Macie2ClassificationExportConfiguration) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
