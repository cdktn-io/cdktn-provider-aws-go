...
func (e *jsiiProxy_Ec2NetworkInsightsAnalysisForwardPathComponentsOutboundHeaderDestinationPortRangesList) Resolve(context cdktf.IResolveContext) interface{} {
