...
func (e *jsiiProxy_Ec2NetworkInsightsAnalysisReturnPathComponentsSubnetList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (e *jsiiProxy_Ec2NetworkInsightsAnalysisReturnPathComponentsSubnetList) Resolve(context cdktf.IResolveContext) interface{} {
