...
func (s *jsiiProxy_SecuritylakeSubscriberSourceCustomLogSourceResourceOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_SecuritylakeSubscriberSourceCustomLogSourceResourceOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
