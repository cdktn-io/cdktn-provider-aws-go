...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/securitylake_subscriber aws_securitylake_subscriber}.
...
func (j *jsiiProxy_SecuritylakeSubscriber) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_SecuritylakeSubscriber) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_SecuritylakeSubscriber) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_SecuritylakeSubscriber) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_SecuritylakeSubscriber) TagsAll() cdktn.StringMap {
...
func (j *jsiiProxy_SecuritylakeSubscriber) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/securitylake_subscriber aws_securitylake_subscriber} Resource.
...
func (j *jsiiProxy_SecuritylakeSubscriber)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_SecuritylakeSubscriber)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_SecuritylakeSubscriber)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func SecuritylakeSubscriber_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (s *jsiiProxy_SecuritylakeSubscriber) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SecuritylakeSubscriber) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_SecuritylakeSubscriber) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SecuritylakeSubscriber) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_SecuritylakeSubscriber) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_SecuritylakeSubscriber) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
