...
func (j *jsiiProxy_CloudfrontFieldLevelEncryptionConfig) ForEach() cdktf.ITerraformIterator {
...
func CloudfrontFieldLevelEncryptionConfig_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (c *jsiiProxy_CloudfrontFieldLevelEncryptionConfig) ImportFrom(id *string, provider cdktf.TerraformProvider) {
