...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/dataawsapigatewayvpclink/internal"
...
func (j *jsiiProxy_DataAwsApiGatewayVpcLink) Arn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"arn",
...
func (j *jsiiProxy_DataAwsApiGatewayVpcLink) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsApiGatewayVpcLink) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsApiGatewayVpcLink) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsApiGatewayVpcLink) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsApiGatewayVpcLink) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DataAwsApiGatewayVpcLink) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_DataAwsApiGatewayVpcLink) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/data-sources/api_gateway_vpc_link aws_api_gateway_vpc_link} Data Source.
...
func (j *jsiiProxy_DataAwsApiGatewayVpcLink)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsApiGatewayVpcLink)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsApiGatewayVpcLink)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_DataAwsApiGatewayVpcLink)SetRegion(val *string) {
...
func DataAwsApiGatewayVpcLink_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsApiGatewayVpcLink) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsApiGatewayVpcLink) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsApiGatewayVpcLink) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsApiGatewayVpcLink) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsApiGatewayVpcLink) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
