...
func (j *jsiiProxy_MskClusterBrokerNodeGroupInfoStorageInfoOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewMskClusterBrokerNodeGroupInfoStorageInfoOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) MskClusterBrokerNodeGroupInfoStorageInfoOutputReference {
	_init_.Initialize()
...
func NewMskClusterBrokerNodeGroupInfoStorageInfoOutputReference_Override(m MskClusterBrokerNodeGroupInfoStorageInfoOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_MskClusterBrokerNodeGroupInfoStorageInfoOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (m *jsiiProxy_MskClusterBrokerNodeGroupInfoStorageInfoOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MskClusterBrokerNodeGroupInfoStorageInfoOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (m *jsiiProxy_MskClusterBrokerNodeGroupInfoStorageInfoOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MskClusterBrokerNodeGroupInfoStorageInfoOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
