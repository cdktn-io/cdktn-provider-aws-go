...
func (m *jsiiProxy_MskClusterEncryptionInfoEncryptionInTransitOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (m *jsiiProxy_MskClusterEncryptionInfoEncryptionInTransitOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
