...
func (m *jsiiProxy_MskClusterClientAuthenticationTlsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (m *jsiiProxy_MskClusterClientAuthenticationTlsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
