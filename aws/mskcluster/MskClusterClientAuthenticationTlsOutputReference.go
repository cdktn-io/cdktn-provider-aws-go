...
func (j *jsiiProxy_MskClusterClientAuthenticationTlsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewMskClusterClientAuthenticationTlsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) MskClusterClientAuthenticationTlsOutputReference {
	_init_.Initialize()

	if err := validateNewMskClusterClientAuthenticationTlsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewMskClusterClientAuthenticationTlsOutputReference_Override(m MskClusterClientAuthenticationTlsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_MskClusterClientAuthenticationTlsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (m *jsiiProxy_MskClusterClientAuthenticationTlsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MskClusterClientAuthenticationTlsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (m *jsiiProxy_MskClusterClientAuthenticationTlsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MskClusterClientAuthenticationTlsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
