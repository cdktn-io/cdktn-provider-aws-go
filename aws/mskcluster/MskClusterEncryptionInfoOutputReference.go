...
func (j *jsiiProxy_MskClusterEncryptionInfoOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewMskClusterEncryptionInfoOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) MskClusterEncryptionInfoOutputReference {
	_init_.Initialize()
...
func NewMskClusterEncryptionInfoOutputReference_Override(m MskClusterEncryptionInfoOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_MskClusterEncryptionInfoOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (m *jsiiProxy_MskClusterEncryptionInfoOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MskClusterEncryptionInfoOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (m *jsiiProxy_MskClusterEncryptionInfoOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MskClusterEncryptionInfoOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
