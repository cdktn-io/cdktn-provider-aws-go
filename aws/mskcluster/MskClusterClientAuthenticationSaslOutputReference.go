...
func (j *jsiiProxy_MskClusterClientAuthenticationSaslOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewMskClusterClientAuthenticationSaslOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) MskClusterClientAuthenticationSaslOutputReference {
	_init_.Initialize()
...
func NewMskClusterClientAuthenticationSaslOutputReference_Override(m MskClusterClientAuthenticationSaslOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_MskClusterClientAuthenticationSaslOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (m *jsiiProxy_MskClusterClientAuthenticationSaslOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MskClusterClientAuthenticationSaslOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (m *jsiiProxy_MskClusterClientAuthenticationSaslOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MskClusterClientAuthenticationSaslOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
