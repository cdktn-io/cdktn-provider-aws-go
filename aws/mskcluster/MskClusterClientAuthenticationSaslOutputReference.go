...
func (m *jsiiProxy_MskClusterClientAuthenticationSaslOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (m *jsiiProxy_MskClusterClientAuthenticationSaslOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
