...
func (j *jsiiProxy_MskClusterLoggingInfoBrokerLogsCloudwatchLogsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewMskClusterLoggingInfoBrokerLogsCloudwatchLogsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) MskClusterLoggingInfoBrokerLogsCloudwatchLogsOutputReference {
	_init_.Initialize()

	if err := validateNewMskClusterLoggingInfoBrokerLogsCloudwatchLogsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewMskClusterLoggingInfoBrokerLogsCloudwatchLogsOutputReference_Override(m MskClusterLoggingInfoBrokerLogsCloudwatchLogsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_MskClusterLoggingInfoBrokerLogsCloudwatchLogsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (m *jsiiProxy_MskClusterLoggingInfoBrokerLogsCloudwatchLogsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MskClusterLoggingInfoBrokerLogsCloudwatchLogsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (m *jsiiProxy_MskClusterLoggingInfoBrokerLogsCloudwatchLogsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MskClusterLoggingInfoBrokerLogsCloudwatchLogsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
