...
func (j *jsiiProxy_MskClusterOpenMonitoringPrometheusJmxExporterOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewMskClusterOpenMonitoringPrometheusJmxExporterOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) MskClusterOpenMonitoringPrometheusJmxExporterOutputReference {
	_init_.Initialize()
...
func NewMskClusterOpenMonitoringPrometheusJmxExporterOutputReference_Override(m MskClusterOpenMonitoringPrometheusJmxExporterOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_MskClusterOpenMonitoringPrometheusJmxExporterOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (m *jsiiProxy_MskClusterOpenMonitoringPrometheusJmxExporterOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MskClusterOpenMonitoringPrometheusJmxExporterOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (m *jsiiProxy_MskClusterOpenMonitoringPrometheusJmxExporterOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MskClusterOpenMonitoringPrometheusJmxExporterOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
