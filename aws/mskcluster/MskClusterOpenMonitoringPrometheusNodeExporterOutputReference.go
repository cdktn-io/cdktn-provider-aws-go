...
func (j *jsiiProxy_MskClusterOpenMonitoringPrometheusNodeExporterOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewMskClusterOpenMonitoringPrometheusNodeExporterOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) MskClusterOpenMonitoringPrometheusNodeExporterOutputReference {
	_init_.Initialize()
...
func NewMskClusterOpenMonitoringPrometheusNodeExporterOutputReference_Override(m MskClusterOpenMonitoringPrometheusNodeExporterOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_MskClusterOpenMonitoringPrometheusNodeExporterOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (m *jsiiProxy_MskClusterOpenMonitoringPrometheusNodeExporterOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MskClusterOpenMonitoringPrometheusNodeExporterOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (m *jsiiProxy_MskClusterOpenMonitoringPrometheusNodeExporterOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MskClusterOpenMonitoringPrometheusNodeExporterOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
