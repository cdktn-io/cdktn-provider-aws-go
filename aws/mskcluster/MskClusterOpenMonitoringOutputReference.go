...
func (m *jsiiProxy_MskClusterOpenMonitoringOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (m *jsiiProxy_MskClusterOpenMonitoringOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
