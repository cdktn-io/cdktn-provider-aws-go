...
func (j *jsiiProxy_MskClusterOpenMonitoringOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewMskClusterOpenMonitoringOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) MskClusterOpenMonitoringOutputReference {
	_init_.Initialize()
...
func NewMskClusterOpenMonitoringOutputReference_Override(m MskClusterOpenMonitoringOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_MskClusterOpenMonitoringOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (m *jsiiProxy_MskClusterOpenMonitoringOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MskClusterOpenMonitoringOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (m *jsiiProxy_MskClusterOpenMonitoringOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MskClusterOpenMonitoringOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
