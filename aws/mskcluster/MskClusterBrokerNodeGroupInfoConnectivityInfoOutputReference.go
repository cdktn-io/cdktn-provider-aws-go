...
func (j *jsiiProxy_MskClusterBrokerNodeGroupInfoConnectivityInfoOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewMskClusterBrokerNodeGroupInfoConnectivityInfoOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) MskClusterBrokerNodeGroupInfoConnectivityInfoOutputReference {
	_init_.Initialize()
...
func NewMskClusterBrokerNodeGroupInfoConnectivityInfoOutputReference_Override(m MskClusterBrokerNodeGroupInfoConnectivityInfoOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_MskClusterBrokerNodeGroupInfoConnectivityInfoOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (m *jsiiProxy_MskClusterBrokerNodeGroupInfoConnectivityInfoOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MskClusterBrokerNodeGroupInfoConnectivityInfoOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (m *jsiiProxy_MskClusterBrokerNodeGroupInfoConnectivityInfoOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MskClusterBrokerNodeGroupInfoConnectivityInfoOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
