...
func (j *jsiiProxy_MskClusterConfigurationInfoOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewMskClusterConfigurationInfoOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) MskClusterConfigurationInfoOutputReference {
	_init_.Initialize()
...
func NewMskClusterConfigurationInfoOutputReference_Override(m MskClusterConfigurationInfoOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_MskClusterConfigurationInfoOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (m *jsiiProxy_MskClusterConfigurationInfoOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MskClusterConfigurationInfoOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (m *jsiiProxy_MskClusterConfigurationInfoOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MskClusterConfigurationInfoOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
