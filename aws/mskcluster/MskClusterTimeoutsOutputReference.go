...
func (m *jsiiProxy_MskClusterTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (m *jsiiProxy_MskClusterTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
