...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/dataawsroute53resolverendpoint/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/data-sources/route53_resolver_endpoint aws_route53_resolver_endpoint}.
...
func (j *jsiiProxy_DataAwsRoute53ResolverEndpoint) Protocols() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"protocols",
...
func (j *jsiiProxy_DataAwsRoute53ResolverEndpoint) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DataAwsRoute53ResolverEndpoint) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_DataAwsRoute53ResolverEndpoint) ResolverEndpointType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/data-sources/route53_resolver_endpoint aws_route53_resolver_endpoint} Data Source.
...
func (j *jsiiProxy_DataAwsRoute53ResolverEndpoint)SetRegion(val *string) {
...
func (d *jsiiProxy_DataAwsRoute53ResolverEndpoint) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsRoute53ResolverEndpoint) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsRoute53ResolverEndpoint) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
