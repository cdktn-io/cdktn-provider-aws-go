...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/organizationspolicyattachment/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/organizations_policy_attachment aws_organizations_policy_attachment}.
...
func (j *jsiiProxy_OrganizationsPolicyAttachment) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_OrganizationsPolicyAttachment) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_OrganizationsPolicyAttachment) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_OrganizationsPolicyAttachment) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_OrganizationsPolicyAttachment) SkipDestroy() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"skipDestroy",
...
func (j *jsiiProxy_OrganizationsPolicyAttachment) SkipDestroyInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"skipDestroyInput",
...
func (j *jsiiProxy_OrganizationsPolicyAttachment) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/organizations_policy_attachment aws_organizations_policy_attachment} Resource.
...
func (j *jsiiProxy_OrganizationsPolicyAttachment)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_OrganizationsPolicyAttachment)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_OrganizationsPolicyAttachment)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_OrganizationsPolicyAttachment)SetSkipDestroy(val interface{}) {
...
func OrganizationsPolicyAttachment_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (o *jsiiProxy_OrganizationsPolicyAttachment) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (o *jsiiProxy_OrganizationsPolicyAttachment) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (o *jsiiProxy_OrganizationsPolicyAttachment) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (o *jsiiProxy_OrganizationsPolicyAttachment) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (o *jsiiProxy_OrganizationsPolicyAttachment) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (o *jsiiProxy_OrganizationsPolicyAttachment) ResetSkipDestroy() {
	_jsii_.InvokeVoid(
		o,
		"resetSkipDestroy",
		nil, // no parameters
...
func (o *jsiiProxy_OrganizationsPolicyAttachment) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
