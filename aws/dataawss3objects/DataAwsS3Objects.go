...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/dataawss3objects/internal"
...
func (j *jsiiProxy_DataAwsS3Objects) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsS3Objects) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsS3Objects) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsS3Objects) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsS3Objects) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/data-sources/s3_objects aws_s3_objects} Data Source.
func NewDataAwsS3Objects(scope constructs.Construct, id *string, config *DataAwsS3ObjectsConfig) DataAwsS3Objects {
	...
	_jsii_.Create(
		"@cdktn/provider-aws.dataAwsS3Objects.DataAwsS3Objects",
...
func (j *jsiiProxy_DataAwsS3Objects)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsS3Objects)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsS3Objects)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsS3Objects_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsS3Objects) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsS3Objects) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsS3Objects) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsS3Objects) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
