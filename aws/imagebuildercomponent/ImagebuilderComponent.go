...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/imagebuildercomponent/internal"
...
func (j *jsiiProxy_ImagebuilderComponent) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_ImagebuilderComponent) Encrypted() cdktn.IResolvable {
...
func (j *jsiiProxy_ImagebuilderComponent) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_ImagebuilderComponent) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_ImagebuilderComponent) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_ImagebuilderComponent) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/imagebuilder_component aws_imagebuilder_component} Resource.
...
func (j *jsiiProxy_ImagebuilderComponent)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_ImagebuilderComponent)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_ImagebuilderComponent)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func ImagebuilderComponent_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (i *jsiiProxy_ImagebuilderComponent) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (i *jsiiProxy_ImagebuilderComponent) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (i *jsiiProxy_ImagebuilderComponent) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (i *jsiiProxy_ImagebuilderComponent) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (i *jsiiProxy_ImagebuilderComponent) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
