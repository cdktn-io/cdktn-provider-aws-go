...
func (v *jsiiProxy_VpcEndpoint) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (v *jsiiProxy_VpcEndpoint) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
