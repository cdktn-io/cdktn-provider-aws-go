...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/dataawsssmdocument/internal"
...
func (j *jsiiProxy_DataAwsSsmDocument) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsSsmDocument) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsSsmDocument) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsSsmDocument) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsSsmDocument) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DataAwsSsmDocument)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsSsmDocument)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsSsmDocument)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsSsmDocument_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsSsmDocument) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsSsmDocument) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsSsmDocument) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsSsmDocument) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
