...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/appsyncdomainnameapiassociation/internal"
...
func (j *jsiiProxy_AppsyncDomainNameApiAssociation) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_AppsyncDomainNameApiAssociation) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_AppsyncDomainNameApiAssociation) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_AppsyncDomainNameApiAssociation) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_AppsyncDomainNameApiAssociation) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/appsync_domain_name_api_association aws_appsync_domain_name_api_association} Resource.
...
func (j *jsiiProxy_AppsyncDomainNameApiAssociation)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_AppsyncDomainNameApiAssociation)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_AppsyncDomainNameApiAssociation)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func AppsyncDomainNameApiAssociation_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (a *jsiiProxy_AppsyncDomainNameApiAssociation) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AppsyncDomainNameApiAssociation) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (a *jsiiProxy_AppsyncDomainNameApiAssociation) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AppsyncDomainNameApiAssociation) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (a *jsiiProxy_AppsyncDomainNameApiAssociation) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (a *jsiiProxy_AppsyncDomainNameApiAssociation) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
