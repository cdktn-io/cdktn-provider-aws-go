...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/apigatewaygatewayresponse/internal"
...
func (j *jsiiProxy_ApiGatewayGatewayResponse) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_ApiGatewayGatewayResponse) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_ApiGatewayGatewayResponse) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_ApiGatewayGatewayResponse) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_ApiGatewayGatewayResponse) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/api_gateway_gateway_response aws_api_gateway_gateway_response} Resource.
...
func (j *jsiiProxy_ApiGatewayGatewayResponse)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_ApiGatewayGatewayResponse)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_ApiGatewayGatewayResponse)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func ApiGatewayGatewayResponse_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (a *jsiiProxy_ApiGatewayGatewayResponse) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_ApiGatewayGatewayResponse) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (a *jsiiProxy_ApiGatewayGatewayResponse) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_ApiGatewayGatewayResponse) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (a *jsiiProxy_ApiGatewayGatewayResponse) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (a *jsiiProxy_ApiGatewayGatewayResponse) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
