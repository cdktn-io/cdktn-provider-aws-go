...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/route53resolverfirewallrulegroupassociation/internal"
...
func (j *jsiiProxy_Route53ResolverFirewallRuleGroupAssociation) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_Route53ResolverFirewallRuleGroupAssociation) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_Route53ResolverFirewallRuleGroupAssociation) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_Route53ResolverFirewallRuleGroupAssociation) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_Route53ResolverFirewallRuleGroupAssociation) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_Route53ResolverFirewallRuleGroupAssociation) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_Route53ResolverFirewallRuleGroupAssociation) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/route53_resolver_firewall_rule_group_association aws_route53_resolver_firewall_rule_group_association} Resource.
...
func (j *jsiiProxy_Route53ResolverFirewallRuleGroupAssociation)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_Route53ResolverFirewallRuleGroupAssociation)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_Route53ResolverFirewallRuleGroupAssociation)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_Route53ResolverFirewallRuleGroupAssociation)SetRegion(val *string) {
...
func Route53ResolverFirewallRuleGroupAssociation_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (r *jsiiProxy_Route53ResolverFirewallRuleGroupAssociation) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (r *jsiiProxy_Route53ResolverFirewallRuleGroupAssociation) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (r *jsiiProxy_Route53ResolverFirewallRuleGroupAssociation) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (r *jsiiProxy_Route53ResolverFirewallRuleGroupAssociation) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (r *jsiiProxy_Route53ResolverFirewallRuleGroupAssociation) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (r *jsiiProxy_Route53ResolverFirewallRuleGroupAssociation) ResetRegion() {
	_jsii_.InvokeVoid(
		r,
		"resetRegion",
		nil, // no parameters
...
func (r *jsiiProxy_Route53ResolverFirewallRuleGroupAssociation) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
