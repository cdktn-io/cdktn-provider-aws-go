...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/secretsmanagersecretpolicy/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/secretsmanager_secret_policy aws_secretsmanager_secret_policy}.
...
func (j *jsiiProxy_SecretsmanagerSecretPolicy) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_SecretsmanagerSecretPolicy) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_SecretsmanagerSecretPolicy) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_SecretsmanagerSecretPolicy) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_SecretsmanagerSecretPolicy) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_SecretsmanagerSecretPolicy) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_SecretsmanagerSecretPolicy) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/secretsmanager_secret_policy aws_secretsmanager_secret_policy} Resource.
...
func (j *jsiiProxy_SecretsmanagerSecretPolicy)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_SecretsmanagerSecretPolicy)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_SecretsmanagerSecretPolicy)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_SecretsmanagerSecretPolicy)SetRegion(val *string) {
...
func SecretsmanagerSecretPolicy_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (s *jsiiProxy_SecretsmanagerSecretPolicy) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SecretsmanagerSecretPolicy) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_SecretsmanagerSecretPolicy) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SecretsmanagerSecretPolicy) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_SecretsmanagerSecretPolicy) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_SecretsmanagerSecretPolicy) ResetRegion() {
	_jsii_.InvokeVoid(
		s,
		"resetRegion",
		nil, // no parameters
...
func (s *jsiiProxy_SecretsmanagerSecretPolicy) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
