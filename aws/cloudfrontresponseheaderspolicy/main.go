...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-aws.cloudfrontResponseHeadersPolicy.CloudfrontResponseHeadersPolicyRemoveHeadersConfig",
		reflect.TypeOf((*CloudfrontResponseHeadersPolicyRemoveHeadersConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-aws.cloudfrontResponseHeadersPolicy.CloudfrontResponseHeadersPolicyRemoveHeadersConfigItems",
