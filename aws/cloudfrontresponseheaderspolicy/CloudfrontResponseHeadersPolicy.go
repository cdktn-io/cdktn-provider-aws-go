...
func (j *jsiiProxy_CloudfrontResponseHeadersPolicy) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_CloudfrontResponseHeadersPolicy) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_CloudfrontResponseHeadersPolicy) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_CloudfrontResponseHeadersPolicy) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_CloudfrontResponseHeadersPolicy) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.50.0/docs/resources/cloudfront_response_headers_policy aws_cloudfront_response_headers_policy} Resource.
...
func (j *jsiiProxy_CloudfrontResponseHeadersPolicy)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_CloudfrontResponseHeadersPolicy)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_CloudfrontResponseHeadersPolicy)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func CloudfrontResponseHeadersPolicy_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (c *jsiiProxy_CloudfrontResponseHeadersPolicy) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CloudfrontResponseHeadersPolicy) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (c *jsiiProxy_CloudfrontResponseHeadersPolicy) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CloudfrontResponseHeadersPolicy) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
