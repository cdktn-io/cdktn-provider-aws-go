...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.40.0/docs/data-sources/networkfirewall_firewall_policy aws_networkfirewall_firewall_policy}.
...
func (j *jsiiProxy_DataAwsNetworkfirewallFirewallPolicy) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsNetworkfirewallFirewallPolicy) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsNetworkfirewallFirewallPolicy) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsNetworkfirewallFirewallPolicy) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsNetworkfirewallFirewallPolicy) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DataAwsNetworkfirewallFirewallPolicy) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_DataAwsNetworkfirewallFirewallPolicy) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.40.0/docs/data-sources/networkfirewall_firewall_policy aws_networkfirewall_firewall_policy} Data Source.
...
func (j *jsiiProxy_DataAwsNetworkfirewallFirewallPolicy)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsNetworkfirewallFirewallPolicy)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsNetworkfirewallFirewallPolicy)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_DataAwsNetworkfirewallFirewallPolicy)SetRegion(val *string) {
...
func DataAwsNetworkfirewallFirewallPolicy_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsNetworkfirewallFirewallPolicy) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsNetworkfirewallFirewallPolicy) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsNetworkfirewallFirewallPolicy) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsNetworkfirewallFirewallPolicy) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
