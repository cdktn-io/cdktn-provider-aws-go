...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/amplifybranch/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/amplify_branch aws_amplify_branch}.
...
func (j *jsiiProxy_AmplifyBranch) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_AmplifyBranch) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_AmplifyBranch) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_AmplifyBranch) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_AmplifyBranch) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/amplify_branch aws_amplify_branch} Resource.
...
func (j *jsiiProxy_AmplifyBranch)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_AmplifyBranch)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_AmplifyBranch)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func AmplifyBranch_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (a *jsiiProxy_AmplifyBranch) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AmplifyBranch) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (a *jsiiProxy_AmplifyBranch) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AmplifyBranch) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (a *jsiiProxy_AmplifyBranch) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (a *jsiiProxy_AmplifyBranch) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
