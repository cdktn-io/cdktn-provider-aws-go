...
func (s *jsiiProxy_StoragegatewayNfsFileShareCacheAttributesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_StoragegatewayNfsFileShareCacheAttributesOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
