...
func (s *jsiiProxy_StoragegatewayNfsFileShareTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_StoragegatewayNfsFileShareTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
