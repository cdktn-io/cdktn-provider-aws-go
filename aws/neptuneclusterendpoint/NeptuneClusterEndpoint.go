...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v22/neptuneclusterendpoint/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.31.0/docs/resources/neptune_cluster_endpoint aws_neptune_cluster_endpoint}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.31.0/docs/resources/neptune_cluster_endpoint aws_neptune_cluster_endpoint} Resource.
...
func NeptuneClusterEndpoint_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (n *jsiiProxy_NeptuneClusterEndpoint) ImportFrom(id *string, provider cdktf.TerraformProvider) {
