...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/neptuneclusterendpoint/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/neptune_cluster_endpoint aws_neptune_cluster_endpoint}.
...
func (j *jsiiProxy_NeptuneClusterEndpoint) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_NeptuneClusterEndpoint) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_NeptuneClusterEndpoint) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_NeptuneClusterEndpoint) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_NeptuneClusterEndpoint) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/neptune_cluster_endpoint aws_neptune_cluster_endpoint} Resource.
...
func (j *jsiiProxy_NeptuneClusterEndpoint)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_NeptuneClusterEndpoint)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_NeptuneClusterEndpoint)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func NeptuneClusterEndpoint_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateNeptuneClusterEndpoint_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (n *jsiiProxy_NeptuneClusterEndpoint) AddMoveTarget(moveTarget *string) {
...
func (n *jsiiProxy_NeptuneClusterEndpoint) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (n *jsiiProxy_NeptuneClusterEndpoint) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (n *jsiiProxy_NeptuneClusterEndpoint) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (n *jsiiProxy_NeptuneClusterEndpoint) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (n *jsiiProxy_NeptuneClusterEndpoint) MoveFromId(id *string) {
...
func (n *jsiiProxy_NeptuneClusterEndpoint) MoveToId(id *string) {
...
func (n *jsiiProxy_NeptuneClusterEndpoint) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
