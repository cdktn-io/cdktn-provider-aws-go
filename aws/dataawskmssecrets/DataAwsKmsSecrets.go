...
func (j *jsiiProxy_DataAwsKmsSecrets) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsKmsSecrets) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsKmsSecrets) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsKmsSecrets) Plaintext() cdktn.StringMap {
...
func (j *jsiiProxy_DataAwsKmsSecrets) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsKmsSecrets) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/data-sources/kms_secrets aws_kms_secrets} Data Source.
...
func (j *jsiiProxy_DataAwsKmsSecrets)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsKmsSecrets)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsKmsSecrets)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsKmsSecrets_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsKmsSecrets) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsKmsSecrets) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsKmsSecrets) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsKmsSecrets) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
