...
func (c *jsiiProxy_CloudwatchLogTransformerTransformerConfigSubstituteStringEntryList) validateResolveParameters(context cdktn.IResolveContext) error {
	if context == nil {
...
func (j *jsiiProxy_CloudwatchLogTransformerTransformerConfigSubstituteStringEntryList) validateSetTerraformResourceParameters(val cdktn.IInterpolatingParent) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func validateNewCloudwatchLogTransformerTransformerConfigSubstituteStringEntryListParameters(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) error {
