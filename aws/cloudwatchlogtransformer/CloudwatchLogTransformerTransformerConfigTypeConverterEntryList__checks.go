...
func (c *jsiiProxy_CloudwatchLogTransformerTransformerConfigTypeConverterEntryList) validateResolveParameters(context cdktn.IResolveContext) error {
	if context == nil {
...
func (j *jsiiProxy_CloudwatchLogTransformerTransformerConfigTypeConverterEntryList) validateSetTerraformResourceParameters(val cdktn.IInterpolatingParent) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func validateNewCloudwatchLogTransformerTransformerConfigTypeConverterEntryListParameters(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) error {
