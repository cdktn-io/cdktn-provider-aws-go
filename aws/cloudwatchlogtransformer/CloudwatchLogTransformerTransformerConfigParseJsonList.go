...
func (j *jsiiProxy_CloudwatchLogTransformerTransformerConfigParseJsonList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewCloudwatchLogTransformerTransformerConfigParseJsonList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) CloudwatchLogTransformerTransformerConfigParseJsonList {
	_init_.Initialize()
...
func NewCloudwatchLogTransformerTransformerConfigParseJsonList_Override(c CloudwatchLogTransformerTransformerConfigParseJsonList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_CloudwatchLogTransformerTransformerConfigParseJsonList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (c *jsiiProxy_CloudwatchLogTransformerTransformerConfigParseJsonList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (c *jsiiProxy_CloudwatchLogTransformerTransformerConfigParseJsonList) Resolve(context cdktf.IResolveContext) interface{} {
