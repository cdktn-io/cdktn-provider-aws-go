...
func (j *jsiiProxy_CloudwatchLogTransformerTransformerConfigMoveKeysEntryList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewCloudwatchLogTransformerTransformerConfigMoveKeysEntryList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) CloudwatchLogTransformerTransformerConfigMoveKeysEntryList {
	_init_.Initialize()
...
func NewCloudwatchLogTransformerTransformerConfigMoveKeysEntryList_Override(c CloudwatchLogTransformerTransformerConfigMoveKeysEntryList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_CloudwatchLogTransformerTransformerConfigMoveKeysEntryList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (c *jsiiProxy_CloudwatchLogTransformerTransformerConfigMoveKeysEntryList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (c *jsiiProxy_CloudwatchLogTransformerTransformerConfigMoveKeysEntryList) Resolve(context cdktf.IResolveContext) interface{} {
