...
func (j *jsiiProxy_CloudwatchLogTransformerTransformerConfigParsePostgresList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewCloudwatchLogTransformerTransformerConfigParsePostgresList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) CloudwatchLogTransformerTransformerConfigParsePostgresList {
	_init_.Initialize()
...
func NewCloudwatchLogTransformerTransformerConfigParsePostgresList_Override(c CloudwatchLogTransformerTransformerConfigParsePostgresList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_CloudwatchLogTransformerTransformerConfigParsePostgresList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_CloudwatchLogTransformerTransformerConfigParsePostgresList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (c *jsiiProxy_CloudwatchLogTransformerTransformerConfigParsePostgresList) Resolve(context cdktn.IResolveContext) interface{} {
