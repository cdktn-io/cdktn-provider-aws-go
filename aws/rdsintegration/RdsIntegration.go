...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/rds_integration aws_rds_integration} Resource.
...
func (r *jsiiProxy_RdsIntegration) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (r *jsiiProxy_RdsIntegration) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
