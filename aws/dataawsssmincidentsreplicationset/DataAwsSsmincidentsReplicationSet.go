...
func (j *jsiiProxy_DataAwsSsmincidentsReplicationSet) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsSsmincidentsReplicationSet) DeletionProtected() cdktn.IResolvable {
...
func (j *jsiiProxy_DataAwsSsmincidentsReplicationSet) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsSsmincidentsReplicationSet) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsSsmincidentsReplicationSet) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsSsmincidentsReplicationSet) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/data-sources/ssmincidents_replication_set aws_ssmincidents_replication_set} Data Source.
...
func (j *jsiiProxy_DataAwsSsmincidentsReplicationSet)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsSsmincidentsReplicationSet)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsSsmincidentsReplicationSet)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsSsmincidentsReplicationSet_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsSsmincidentsReplicationSet) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsSsmincidentsReplicationSet) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsSsmincidentsReplicationSet) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsSsmincidentsReplicationSet) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
