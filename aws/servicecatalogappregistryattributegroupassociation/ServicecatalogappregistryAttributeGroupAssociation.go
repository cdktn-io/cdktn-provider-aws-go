...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/servicecatalogappregistryattributegroupassociation/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/servicecatalogappregistry_attribute_group_association aws_servicecatalogappregistry_attribute_group_association}.
type ServicecatalogappregistryAttributeGroupAssociation interface {
	...
	SetAttributeGroupId(val *string)
	AttributeGroupIdInput() *string
	// Experimental.
...
func (j *jsiiProxy_ServicecatalogappregistryAttributeGroupAssociation) ApplicationId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"applicationId",
...
func (j *jsiiProxy_ServicecatalogappregistryAttributeGroupAssociation) ApplicationIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"applicationIdInput",
...
func (j *jsiiProxy_ServicecatalogappregistryAttributeGroupAssociation) AttributeGroupId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attributeGroupId",
...
func (j *jsiiProxy_ServicecatalogappregistryAttributeGroupAssociation) AttributeGroupIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attributeGroupIdInput",
		&returns,
	)
	return returns
}

func (j *jsiiProxy_ServicecatalogappregistryAttributeGroupAssociation) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_ServicecatalogappregistryAttributeGroupAssociation) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_ServicecatalogappregistryAttributeGroupAssociation) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_ServicecatalogappregistryAttributeGroupAssociation) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_ServicecatalogappregistryAttributeGroupAssociation) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_ServicecatalogappregistryAttributeGroupAssociation) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_ServicecatalogappregistryAttributeGroupAssociation) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/servicecatalogappregistry_attribute_group_association aws_servicecatalogappregistry_attribute_group_association} Resource.
func NewServicecatalogappregistryAttributeGroupAssociation(scope constructs.Construct, id *string, config *ServicecatalogappregistryAttributeGroupAssociationConfig) ServicecatalogappregistryAttributeGroupAssociation {
	...
	_jsii_.Create(
		"@cdktn/provider-aws.servicecatalogappregistryAttributeGroupAssociation.ServicecatalogappregistryAttributeGroupAssociation",
...
func (j *jsiiProxy_ServicecatalogappregistryAttributeGroupAssociation)SetApplicationId(val *string) {
...
func (j *jsiiProxy_ServicecatalogappregistryAttributeGroupAssociation)SetAttributeGroupId(val *string) {
	if err := j.validateSetAttributeGroupIdParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_ServicecatalogappregistryAttributeGroupAssociation)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_ServicecatalogappregistryAttributeGroupAssociation)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_ServicecatalogappregistryAttributeGroupAssociation)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_ServicecatalogappregistryAttributeGroupAssociation)SetRegion(val *string) {
...
func ServicecatalogappregistryAttributeGroupAssociation_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (s *jsiiProxy_ServicecatalogappregistryAttributeGroupAssociation) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_ServicecatalogappregistryAttributeGroupAssociation) HasResourceMove() interface{} {
	var returns interface{}
...
func (s *jsiiProxy_ServicecatalogappregistryAttributeGroupAssociation) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_ServicecatalogappregistryAttributeGroupAssociation) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_ServicecatalogappregistryAttributeGroupAssociation) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_ServicecatalogappregistryAttributeGroupAssociation) MoveFromId(id *string) {
...
func (s *jsiiProxy_ServicecatalogappregistryAttributeGroupAssociation) MoveToId(id *string) {
...
func (s *jsiiProxy_ServicecatalogappregistryAttributeGroupAssociation) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_ServicecatalogappregistryAttributeGroupAssociation) ResetRegion() {
	_jsii_.InvokeVoid(
		s,
		"resetRegion",
		nil, // no parameters
...
func (s *jsiiProxy_ServicecatalogappregistryAttributeGroupAssociation) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (s *jsiiProxy_ServicecatalogappregistryAttributeGroupAssociation) ToHclTerraform() interface{} {
	var returns interface{}
...
func (s *jsiiProxy_ServicecatalogappregistryAttributeGroupAssociation) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
