...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/qldbstream/internal"
...
func (j *jsiiProxy_QldbStream) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_QldbStream) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_QldbStream) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_QldbStream) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_QldbStream) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/qldb_stream aws_qldb_stream} Resource.
...
func (j *jsiiProxy_QldbStream)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_QldbStream)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_QldbStream)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func QldbStream_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (q *jsiiProxy_QldbStream) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (q *jsiiProxy_QldbStream) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (q *jsiiProxy_QldbStream) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (q *jsiiProxy_QldbStream) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (q *jsiiProxy_QldbStream) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (q *jsiiProxy_QldbStream) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
