...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/finspace_kx_dataview aws_finspace_kx_dataview}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/finspace_kx_dataview aws_finspace_kx_dataview} Resource.
...
func (f *jsiiProxy_FinspaceKxDataview) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (f *jsiiProxy_FinspaceKxDataview) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (f *jsiiProxy_FinspaceKxDataview) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
