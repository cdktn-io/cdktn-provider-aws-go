...
func (j *jsiiProxy_FinspaceKxDataviewSegmentConfigurationsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewFinspaceKxDataviewSegmentConfigurationsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) FinspaceKxDataviewSegmentConfigurationsOutputReference {
	_init_.Initialize()
...
func NewFinspaceKxDataviewSegmentConfigurationsOutputReference_Override(f FinspaceKxDataviewSegmentConfigurationsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_FinspaceKxDataviewSegmentConfigurationsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (f *jsiiProxy_FinspaceKxDataviewSegmentConfigurationsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (f *jsiiProxy_FinspaceKxDataviewSegmentConfigurationsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (f *jsiiProxy_FinspaceKxDataviewSegmentConfigurationsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (f *jsiiProxy_FinspaceKxDataviewSegmentConfigurationsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
