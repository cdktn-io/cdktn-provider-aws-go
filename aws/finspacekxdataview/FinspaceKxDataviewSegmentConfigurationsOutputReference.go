...
func (f *jsiiProxy_FinspaceKxDataviewSegmentConfigurationsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (f *jsiiProxy_FinspaceKxDataviewSegmentConfigurationsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
