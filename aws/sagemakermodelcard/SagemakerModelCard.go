...
func (j *jsiiProxy_SagemakerModelCard) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_SagemakerModelCard) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_SagemakerModelCard) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_SagemakerModelCard) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_SagemakerModelCard) TagsAll() cdktf.StringMap {
...
func (j *jsiiProxy_SagemakerModelCard) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_SagemakerModelCard)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_SagemakerModelCard)SetLifecycle(val *cdktf.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_SagemakerModelCard)SetProvider(val cdktf.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func SagemakerModelCard_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (s *jsiiProxy_SagemakerModelCard) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_SagemakerModelCard) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (s *jsiiProxy_SagemakerModelCard) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
