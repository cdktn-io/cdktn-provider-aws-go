...
func (s *jsiiProxy_SagemakerModelCard) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_SagemakerModelCard) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
