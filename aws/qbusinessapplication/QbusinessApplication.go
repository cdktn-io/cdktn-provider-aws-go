...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/qbusiness_application aws_qbusiness_application}.
...
func (j *jsiiProxy_QbusinessApplication) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_QbusinessApplication) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_QbusinessApplication) TagsAll() cdktn.StringMap {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/qbusiness_application aws_qbusiness_application} Resource.
...
func (j *jsiiProxy_QbusinessApplication)SetRegion(val *string) {
...
func (q *jsiiProxy_QbusinessApplication) ResetRegion() {
	_jsii_.InvokeVoid(
		q,
		"resetRegion",
		nil, // no parameters
