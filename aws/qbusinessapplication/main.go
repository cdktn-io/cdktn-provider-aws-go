...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "attachmentsConfigurationInput", GoGetter: "AttachmentsConfigurationInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "putAttachmentsConfiguration", GoMethod: "PutAttachmentsConfiguration"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetAttachmentsConfiguration", GoMethod: "ResetAttachmentsConfiguration"},
	...
	_jsii_.RegisterClass(
		...
		func() interface{} {
			j := jsiiProxy_QbusinessApplicationAttachmentsConfigurationOutputReference{}
	...
	_jsii_.RegisterClass(
		...
		func() interface{} {
			j := jsiiProxy_QbusinessApplicationEncryptionConfigurationList{}
			_jsii_.InitJsiiProxy(&j.Type__cdktfComplexList)
			return &j
		},
	)
