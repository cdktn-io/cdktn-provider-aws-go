...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/dbproxytarget/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/db_proxy_target aws_db_proxy_target}.
...
func (j *jsiiProxy_DbProxyTarget) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DbProxyTarget) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DbProxyTarget) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DbProxyTarget) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DbProxyTarget) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/db_proxy_target aws_db_proxy_target} Resource.
...
func (j *jsiiProxy_DbProxyTarget)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DbProxyTarget)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DbProxyTarget)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DbProxyTarget_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DbProxyTarget) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DbProxyTarget) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (d *jsiiProxy_DbProxyTarget) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DbProxyTarget) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (d *jsiiProxy_DbProxyTarget) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DbProxyTarget) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
