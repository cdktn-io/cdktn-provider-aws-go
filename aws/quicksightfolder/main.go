...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "folderPath", GoGetter: "FolderPath"},
			_jsii_.MemberProperty{JsiiProperty: "folderType", GoGetter: "FolderType"},
			_jsii_.MemberProperty{JsiiProperty: "folderTypeInput", GoGetter: "FolderTypeInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "parentFolderArn", GoGetter: "ParentFolderArn"},
			_jsii_.MemberProperty{JsiiProperty: "parentFolderArnInput", GoGetter: "ParentFolderArnInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetFolderType", GoMethod: "ResetFolderType"},
			_jsii_.MemberMethod{JsiiMethod: "resetId", GoMethod: "ResetId"},
			_jsii_.MemberMethod{JsiiMethod: "resetName", GoMethod: "ResetName"},
			_jsii_.MemberMethod{JsiiMethod: "resetOverrideLogicalId", GoMethod: "ResetOverrideLogicalId"},
			_jsii_.MemberMethod{JsiiMethod: "resetParentFolderArn", GoMethod: "ResetParentFolderArn"},
	...
	_jsii_.RegisterClass(
		...
		func() interface{} {
			j := jsiiProxy_QuicksightFolderPermissionsList{}
	...
	_jsii_.RegisterClass(
		...
		func() interface{} {
			j := jsiiProxy_QuicksightFolderPermissionsOutputReference{}
