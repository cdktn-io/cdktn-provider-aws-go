...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/dataawsredshiftsubnetgroup/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/data-sources/redshift_subnet_group aws_redshift_subnet_group}.
...
func (j *jsiiProxy_DataAwsRedshiftSubnetGroup) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsRedshiftSubnetGroup) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsRedshiftSubnetGroup) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsRedshiftSubnetGroup) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsRedshiftSubnetGroup) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DataAwsRedshiftSubnetGroup) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_DataAwsRedshiftSubnetGroup) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/data-sources/redshift_subnet_group aws_redshift_subnet_group} Data Source.
func NewDataAwsRedshiftSubnetGroup(scope constructs.Construct, id *string, config *DataAwsRedshiftSubnetGroupConfig) DataAwsRedshiftSubnetGroup {
	...
	_jsii_.Create(
		"@cdktn/provider-aws.dataAwsRedshiftSubnetGroup.DataAwsRedshiftSubnetGroup",
...
func (j *jsiiProxy_DataAwsRedshiftSubnetGroup)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsRedshiftSubnetGroup)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsRedshiftSubnetGroup)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_DataAwsRedshiftSubnetGroup)SetRegion(val *string) {
...
func DataAwsRedshiftSubnetGroup_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsRedshiftSubnetGroup) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsRedshiftSubnetGroup) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsRedshiftSubnetGroup) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsRedshiftSubnetGroup) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsRedshiftSubnetGroup) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
