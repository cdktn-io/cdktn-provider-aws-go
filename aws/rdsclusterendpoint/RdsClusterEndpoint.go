...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/rdsclusterendpoint/internal"
...
func (j *jsiiProxy_RdsClusterEndpoint) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_RdsClusterEndpoint) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_RdsClusterEndpoint) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_RdsClusterEndpoint) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_RdsClusterEndpoint) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_RdsClusterEndpoint) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_RdsClusterEndpoint) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/rds_cluster_endpoint aws_rds_cluster_endpoint} Resource.
...
func (j *jsiiProxy_RdsClusterEndpoint)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_RdsClusterEndpoint)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_RdsClusterEndpoint)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_RdsClusterEndpoint)SetRegion(val *string) {
...
func RdsClusterEndpoint_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (r *jsiiProxy_RdsClusterEndpoint) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (r *jsiiProxy_RdsClusterEndpoint) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (r *jsiiProxy_RdsClusterEndpoint) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (r *jsiiProxy_RdsClusterEndpoint) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (r *jsiiProxy_RdsClusterEndpoint) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (r *jsiiProxy_RdsClusterEndpoint) ResetRegion() {
	_jsii_.InvokeVoid(
		r,
		"resetRegion",
		nil, // no parameters
...
func (r *jsiiProxy_RdsClusterEndpoint) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
