...
func (j *jsiiProxy_PrometheusWorkspaceConfigurationLimitsPerLabelSetLimitsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewPrometheusWorkspaceConfigurationLimitsPerLabelSetLimitsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) PrometheusWorkspaceConfigurationLimitsPerLabelSetLimitsList {
	_init_.Initialize()
...
func NewPrometheusWorkspaceConfigurationLimitsPerLabelSetLimitsList_Override(p PrometheusWorkspaceConfigurationLimitsPerLabelSetLimitsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_PrometheusWorkspaceConfigurationLimitsPerLabelSetLimitsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (p *jsiiProxy_PrometheusWorkspaceConfigurationLimitsPerLabelSetLimitsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (p *jsiiProxy_PrometheusWorkspaceConfigurationLimitsPerLabelSetLimitsList) Resolve(context cdktn.IResolveContext) interface{} {
