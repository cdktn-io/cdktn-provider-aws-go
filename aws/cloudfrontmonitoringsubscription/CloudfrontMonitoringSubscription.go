...
func (j *jsiiProxy_CloudfrontMonitoringSubscription) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_CloudfrontMonitoringSubscription) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_CloudfrontMonitoringSubscription) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_CloudfrontMonitoringSubscription) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_CloudfrontMonitoringSubscription) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/cloudfront_monitoring_subscription aws_cloudfront_monitoring_subscription} Resource.
...
func (j *jsiiProxy_CloudfrontMonitoringSubscription)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_CloudfrontMonitoringSubscription)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_CloudfrontMonitoringSubscription)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func CloudfrontMonitoringSubscription_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateCloudfrontMonitoringSubscription_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
// Experimental.
func CloudfrontMonitoringSubscription_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCloudfrontMonitoringSubscription_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func CloudfrontMonitoringSubscription_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCloudfrontMonitoringSubscription_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CloudfrontMonitoringSubscription) AddMoveTarget(moveTarget *string) {
...
func (c *jsiiProxy_CloudfrontMonitoringSubscription) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CloudfrontMonitoringSubscription) HasResourceMove() interface{} {
	var returns interface{}
...
func (c *jsiiProxy_CloudfrontMonitoringSubscription) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (c *jsiiProxy_CloudfrontMonitoringSubscription) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CloudfrontMonitoringSubscription) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_CloudfrontMonitoringSubscription) MoveFromId(id *string) {
...
func (c *jsiiProxy_CloudfrontMonitoringSubscription) MoveTo(moveTarget *string, index interface{}) {
...
func (c *jsiiProxy_CloudfrontMonitoringSubscription) MoveToId(id *string) {
...
func (c *jsiiProxy_CloudfrontMonitoringSubscription) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (c *jsiiProxy_CloudfrontMonitoringSubscription) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (c *jsiiProxy_CloudfrontMonitoringSubscription) ToHclTerraform() interface{} {
	var returns interface{}
...
func (c *jsiiProxy_CloudfrontMonitoringSubscription) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
