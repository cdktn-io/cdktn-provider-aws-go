...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/iamgroupmembership/internal"
...
func (j *jsiiProxy_IamGroupMembership) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_IamGroupMembership) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_IamGroupMembership) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_IamGroupMembership) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_IamGroupMembership) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/iam_group_membership aws_iam_group_membership} Resource.
...
func (j *jsiiProxy_IamGroupMembership)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_IamGroupMembership)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_IamGroupMembership)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func IamGroupMembership_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (i *jsiiProxy_IamGroupMembership) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (i *jsiiProxy_IamGroupMembership) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (i *jsiiProxy_IamGroupMembership) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (i *jsiiProxy_IamGroupMembership) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (i *jsiiProxy_IamGroupMembership) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (i *jsiiProxy_IamGroupMembership) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
