...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v22/pinpointeventstream/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.31.0/docs/resources/pinpoint_event_stream aws_pinpoint_event_stream}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.31.0/docs/resources/pinpoint_event_stream aws_pinpoint_event_stream} Resource.
...
func PinpointEventStream_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (p *jsiiProxy_PinpointEventStream) ImportFrom(id *string, provider cdktf.TerraformProvider) {
