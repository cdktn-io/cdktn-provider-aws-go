...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/pinpointeventstream/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/pinpoint_event_stream aws_pinpoint_event_stream}.
...
func (j *jsiiProxy_PinpointEventStream) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_PinpointEventStream) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_PinpointEventStream) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_PinpointEventStream) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_PinpointEventStream) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/pinpoint_event_stream aws_pinpoint_event_stream} Resource.
func NewPinpointEventStream(scope constructs.Construct, id *string, config *PinpointEventStreamConfig) PinpointEventStream {
	...
	_jsii_.Create(
		"@cdktn/provider-aws.pinpointEventStream.PinpointEventStream",
...
func (j *jsiiProxy_PinpointEventStream)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_PinpointEventStream)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_PinpointEventStream)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func PinpointEventStream_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validatePinpointEventStream_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (p *jsiiProxy_PinpointEventStream) AddMoveTarget(moveTarget *string) {
...
func (p *jsiiProxy_PinpointEventStream) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PinpointEventStream) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (p *jsiiProxy_PinpointEventStream) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PinpointEventStream) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (p *jsiiProxy_PinpointEventStream) MoveFromId(id *string) {
...
func (p *jsiiProxy_PinpointEventStream) MoveToId(id *string) {
...
func (p *jsiiProxy_PinpointEventStream) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (p *jsiiProxy_PinpointEventStream) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
