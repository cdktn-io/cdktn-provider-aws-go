...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v21/dataawssesv2dedicatedippool/internal"
...
func (d *jsiiProxy_DataAwsSesv2DedicatedIpPoolDedicatedIpsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsSesv2DedicatedIpPoolDedicatedIpsList) Resolve(context cdktf.IResolveContext) interface{} {
