...
func (c *jsiiProxy_CloudformationStackInstancesOperationPreferencesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CloudformationStackInstancesOperationPreferencesOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
