...
func (a *jsiiProxy_AppsyncApiEventConfigAuthProviderLambdaAuthorizerConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_AppsyncApiEventConfigAuthProviderLambdaAuthorizerConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
