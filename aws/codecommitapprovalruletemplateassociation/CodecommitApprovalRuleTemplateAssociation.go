...
import (
	...
	"github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/codecommitapprovalruletemplateassociation/internal"
...
func (j *jsiiProxy_CodecommitApprovalRuleTemplateAssociation) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_CodecommitApprovalRuleTemplateAssociation) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_CodecommitApprovalRuleTemplateAssociation) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_CodecommitApprovalRuleTemplateAssociation) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_CodecommitApprovalRuleTemplateAssociation) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/codecommit_approval_rule_template_association aws_codecommit_approval_rule_template_association} Resource.
...
func (j *jsiiProxy_CodecommitApprovalRuleTemplateAssociation)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_CodecommitApprovalRuleTemplateAssociation)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_CodecommitApprovalRuleTemplateAssociation)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func CodecommitApprovalRuleTemplateAssociation_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (c *jsiiProxy_CodecommitApprovalRuleTemplateAssociation) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CodecommitApprovalRuleTemplateAssociation) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (c *jsiiProxy_CodecommitApprovalRuleTemplateAssociation) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CodecommitApprovalRuleTemplateAssociation) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_CodecommitApprovalRuleTemplateAssociation) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (c *jsiiProxy_CodecommitApprovalRuleTemplateAssociation) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
