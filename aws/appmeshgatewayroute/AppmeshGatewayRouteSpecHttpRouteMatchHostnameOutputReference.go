...
func (a *jsiiProxy_AppmeshGatewayRouteSpecHttpRouteMatchHostnameOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_AppmeshGatewayRouteSpecHttpRouteMatchHostnameOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
