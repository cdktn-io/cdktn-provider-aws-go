...
func (a *jsiiProxy_AppmeshGatewayRouteSpecGrpcRouteOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_AppmeshGatewayRouteSpecGrpcRouteOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
